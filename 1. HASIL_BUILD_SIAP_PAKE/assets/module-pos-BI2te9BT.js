...
import{a as ee,A as ca,d as $,_ as pa}from"./module-member-Dzxl4LrI.js";import{e as i,t as v,a as x,i as d,ar as Y,x as Re,b as ba,f as xa}from"./module-print-C2-MjUR_.js";import{f as Be}from"./vendor-firebase-core-D2OF5R23.js";let ie=null;const Q=()=>{if(ie)return ie;try{const e=sessionStorage.getItem("pos_cashier_session");if(e)return ie=JSON.parse(e),ie}catch{}return null},ua=e=>{ie=e;try{e?sessionStorage.setItem("pos_cashier_session",JSON.stringify(e)):sessionStorage.removeItem("pos_cashier_session")}catch{}},Tt=()=>{ie=null;try{sessionStorage.removeItem("pos_cashier_session")}catch{}},$t=()=>!!Q(),Ct=async()=>{if(Q()||window.isAdm||window.__localIsAdm||x&&(x.hasCashier===!0||x.store?.posEnabled===!0))return!0;const e=localStorage.getItem("pos_has_cashier");if(e==="true")return!0;const t=!!(window.isAdm||window.__localIsAdm||ee.currentUser&&ee.currentUser.uid===ca);try{if(t){const s=!(await $.collection("freshmart").doc("cms_data").collection("cashier_accounts").where("isActive","==",!0).limit(1).get()).empty;try{localStorage.setItem("pos_has_cashier",s?"true":"false"),$.collection("freshmart").doc("cms_data").set({hasCashier:s},{merge:!0}).catch(()=>{})}catch{}return s}else{const a=await $.collection("freshmart").doc("cms_data").get();if(a.exists){const s=a.data();if(s.hasCashier!==void 0){const r=!!s.hasCashier;try{localStorage.setItem("pos_has_cashier",r?"true":"false")}catch{}return r}}return e!=="false"}}catch{return e!=="false"}},Me=async()=>{const e=i("pos-cashier-header-btn");if(!e)return;const t=!!Q(),a=!!(window.isAdm||window.__localIsAdm),s=localStorage.getItem("pos_has_cashier"),r=x?x.hasCashier??!0:!0;t||a||s==="true"||s===null&&r!==!1?e.classList.remove("hidden"):s==="false"&&e.classList.add("hidden");try{await Ct()||t||a?e.classList.remove("hidden"):e.classList.add("hidden")}catch{(t||a||s!=="false")&&e.classList.remove("hidden")}},Mt=async()=>{typeof window.triggerHaptic=="function"&&window.triggerHaptic("medium"),Q()?(typeof window.changeView=="function"&&window.changeView("view-pos-cashier"),typeof window.renderPOSStorefront=="function"&&window.renderPOSStorefront()):Ke()},Ke=()=>{const e=i("pos-login-modal");e&&(e.classList.remove("hidden"),setTimeout(()=>{e.classList.remove("opacity-0");const t=i("pos-login-modal-box");t&&t.classList.remove("translate-y-full","scale-95")},10),setTimeout(()=>{const t=i("pos-login-email");t&&t.focus()},300),typeof window.triggerHaptic=="function"&&window.triggerHaptic("light"))},_e=()=>{const e=i("pos-login-modal"),t=i("pos-login-modal-box");e&&e.classList.add("opacity-0"),t&&t.classList.add("translate-y-full"),setTimeout(()=>{e&&e.classList.add("hidden");const a=i("pos-login-email"),s=i("pos-login-password"),r=i("pos-login-error");a&&(a.value=""),s&&(s.value=""),r&&(r.textContent="",r.classList.add("hidden"))},300)},At=async()=>{const e=i("pos-login-email"),t=i("pos-login-password"),a=i("pos-login-error"),s=i("pos-login-btn"),r=e?.value?.trim()||"",n=t?.value||"",o=p=>{if(a){a.classList.remove("hidden");const b=a.querySelector("span");b?b.textContent=p:a.textContent=p}typeof window.triggerHaptic=="function"&&window.triggerHaptic("error")};if((()=>{if(a){a.classList.add("hidden");const p=a.querySelector("span");p&&(p.textContent="")}})(),!r||!n){o("Email dan password wajib diisi.");return}s&&(s.disabled=!0,s.innerHTML='<i class="fa-solid fa-spinner fa-spin mr-2"></i>Memverifikasi...');try{const b=(await ee.signInWithEmailAndPassword(r,n)).user?.uid;if(!b)throw new Error("UID tidak ditemukan");const y=await $.collection("freshmart").doc("cms_data").collection("cashier_accounts").doc(b).get();if(!y.exists){await ee.signOut(),o("Akun ini bukan akun kasir yang terdaftar di toko ini.");return}const k=y.data();if(k.role!=="cashier"){await ee.signOut(),o("Akun ini tidak memiliki akses kasir.");return}if(!k.isActive){await ee.signOut(),o("Akun kasir ini telah dinonaktifkan. Hubungi admin toko.");return}ua({uid:b,name:k.name||r,email:k.email||r,role:"cashier"});try{localStorage.setItem("pos_has_cashier","true")}catch{}Me(),_e(),v(`Selamat datang, ${k.name||"Kasir"}! 👋`,"success"),typeof window.changeView=="function"&&window.changeView("view-pos-cashier"),setTimeout(()=>{typeof window.renderPOSStorefront=="function"&&window.renderPOSStorefront()},100),typeof window.triggerHaptic=="function"&&window.triggerHaptic("success")}catch(p){console.error("[POS Auth] Login error:",p);const b=p.code||"";o(b==="auth/user-not-found"||b==="auth/wrong-password"||b==="auth/invalid-credential"?"Email atau password salah.":b==="auth/too-many-requests"?"Terlalu banyak percobaan. Coba lagi beberapa saat.":b==="auth/network-request-failed"?"Koneksi gagal. Periksa jaringan internet.":"Login gagal: "+(p.message||"Kesalahan tidak diketahui"))}finally{s&&(s.disabled=!1,s.innerHTML='<i class="fa-solid fa-right-to-bracket mr-2"></i>Masuk Kasir')}},qe=async(e=!1)=>{if(!e&&typeof window.getActiveShift=="function"){const a=window.getActiveShift();if(a&&a.status==="open"){document.getElementById("pos-logout-shift-modal")?.remove();const s=typeof window.fRp=="function"?window.fRp(a.startingCash):"Rp "+a.startingCash;document.body.insertAdjacentHTML("beforeend",`
    ...
    </div>`;document.body.insertAdjacentHTML("beforeend",s)},Qe=(e,t=!1)=>{if(!e){v("Data shift tidak ditemukan.","warning");return}const a=typeof Y=="function"?Y():{paperSize:"58mm"},s=a.paperSize==="80mm",r=a.headerText||x.store?.name||"TOKO PUTRI",n=x.store?.address||"",o=x.store?.wa||"",c=a.footerText||"Laporan Kasir Resmi Toko Putri",p=t?"RINGKASAN SHIFT (X-REPORT)":"REKAP TUTUP SHIFT (Z-REPORT)",b=new Date(e.startTime).toLocaleString("id-ID",{dateStyle:"short",timeStyle:"short"}),u=e.endTime?new Date(e.endTime).toLocaleString("id-ID",{dateStyle:"short",timeStyle:"short"}):new Date().toLocaleString("id-ID",{dateStyle:"short",timeStyle:"short"}),y=e.duration||Ue(e.startTime,e.endTime||Date.now()),k=(parseFloat(e.startingCash)||0)+(parseFloat(e.cashSales)||0),l=e.actualCash!==void 0?parseFloat(e.actualCash):k,w=l-k,M=w===0?"SEIMBANG (PAS)":w>0?`LEBIH (+${f(w)})`:`KURANG (-${f(Math.abs(w))})`,O=window.open("","_blank",`width=${s?460:360},height=740`);if(!O){document.getElementById("pos-shift-receipt-modal")?.remove(),document.body.insertAdjacentHTML("beforeend",`
        <div id="pos-shift-receipt-modal" class="fixed inset-0 z-[10003] flex items-center justify-center p-3 sm:p-4" style="background:rgba(15,23,42,0.7);backdrop-filter:blur(4px)">
            <div class="bg-white dark:bg-slate-900 rounded-3xl shadow-2xl w-full ${s?"max-w-md":"max-w-sm"} border border-slate-200 dark:border-slate-800 overflow-hidden flex flex-col max-h-[90vh]">
                ...
                <div id="pos-shift-receipt-paper-box" class="p-4 overflow-y-auto flex-1 font-mono text-[11px] bg-slate-50/60 dark:bg-slate-950 text-slate-800 dark:text-slate-200 space-y-1.5 select-text">
                    ...
                    ${t?"":`
                    <div class="flex justify-between font-bold"><span>Kas Fisik Dihitung</span><span>${f(l)}</span></div>
                    <div class="border-t border-dashed border-slate-300 dark:border-slate-700 my-1"></div>
    ...
    ${t?"":`
    <tr style="font-weight:bold"><td>Kas Fisik Laci</td><td style="text-align:right">${f(l)}</td></tr>
    <tr><td colspan="2"><div class="line"></div></td></tr>
    ...
    </body></html>`),O.document.close()},We=()=>{const e=typeof Y=="function"?Y():{deviceType:"system"},t=i("pos-shift-receipt-paper-box");if(t)if(e.deviceType==="rawbt"&&window.AndroidNativeApp&&typeof window.AndroidNativeApp.printRawBT=="function"){const a=t.innerText,s=btoa(unescape(encodeURIComponent(a)));window.AndroidNativeApp.printRawBT(s)}else window.AndroidNativeApp&&typeof window.AndroidNativeApp.print=="function"?window.AndroidNativeApp.print():window.print()},me=()=>{const e=[i("pos-shift-btn-storefront"),i("pos-shift-btn-admin")],t=R();e.forEach(a=>{a&&(t&&t.status==="open"?a.id==="pos-shift-btn-storefront"?a.innerHTML=`
    ...
    <div class="space-y-4">
    ...
    </div>`,await Rt())},Rt=async()=>{const e=i("admin-shift-list-target");if(e)try{const t=await $.collection("freshmart").doc("cms_data").collection("pos_shifts").orderBy("startTime","desc").limit(50).get();if(t.empty){e.innerHTML=`
        ...
        <div class="text-center py-10 text-rose-500 text-xs">
            ...
            </button>`)},He=()=>{if(g.length===0){v("Keranjang masih kosong, tidak ada transaksi untuk ditahan.","warning");return}const e=m?.name?`Antrean #${P.length+1} — ${m.name}`:`Antrean #${P.length+1}`,t=g.reduce((s,r)=>s+(r.qty||1),0),a=I();xe(!0),typeof window.pushModalHistory=="function"&&window.pushModalHistory("posHoldPrompt"),document.getElementById("pos-hold-prompt-modal")?.remove(),document.body.insertAdjacentHTML("beforeend",`
    ...
    <div id="pos-delete-confirm-modal" class="fixed inset-0 z-[10005] flex items-center justify-center p-4" style="background:rgba(15,23,42,0.75);backdrop-filter:blur(4px)">
        <div class="bg-white dark:bg-slate-900 rounded-3xl shadow-2xl w-full max-w-xs border border-slate-200 dark:border-slate-800 p-6 text-center transform transition-all">
            ...
            <div class="flex gap-2.5">
               ...
               </div>`:t.map(o=>{if(!o)return"";const c=!!(o.img&&typeof o.img=="string"&&o.img.trim()),p=c?Re(o.img,"w300-rw"):"",b=Array.isArray(o.variants)&&o.variants.length>0,u=Array.isArray(o.wholesale)&&o.wholesale.length>0,k=g.filter(S=>S&&String(S.id)===String(o.id)).reduce((S,D)=>S+(D&&D.qty?D.qty:0),0),l=d(String(o.id!=null?o.id:"")),w=be(o),M=d(String(o.name||"Produk")),O=d(String(o.category||"")),ye=parseFloat(o.price)||0;return U==="list"?`
            ...
            <div class="group flex items-start gap-2.5 p-2.5 bg-white dark:bg-slate-800/90 rounded-2xl border border-slate-200/90 dark:border-slate-700/80 shadow-xs hover:border-[var(--color-primary)] transition-all">
                ...
                <div class="w-11 h-11 rounded-xl overflow-hidden bg-slate-100 dark:bg-slate-700 shrink-0 border border-slate-200/60 dark:border-slate-700 flex items-center justify-center">
                    ${M?`<img width="44" height="44" loading="lazy" src="${d(M)}" alt="${d(l.name)}" onerror="this.onerror=null; this.style.display='none'; this.nextElementSibling.style.display='flex';" class="w-full h-full object-cover">
        ...
        ${p.map(l=>{const w=u(l,"percent");return`<button onclick="window.posApplyQuickDiscount(${l},'percent')" 
                ...
                style="${w?"background:var(--color-primary);border:1px solid var(--color-primary);":""}">${l}%</button>`}).join("")}
        ...
        `:`
        ${b.map(l=>{const w=u(l,"rp"),M=`${l/1e3}rb`;return`<button onclick="window.posApplyQuickDiscount(${l},'rp')" 
                class="px-2.5 py-1 rounded-lg text-[10px] cursor-pointer transition-all active:scale-95 ${w?"text-white shadow-xs font-black":"bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 border border-slate-200/80 dark:border-slate-700 font-bold"}"
    ...
    <div id="pos-pay-modal" class="fixed inset-0 z-[9999] flex items-end sm:items-center justify-center p-0 sm:p-4" style="background:rgba(15,23,42,0.65);backdrop-filter:blur(4px)">
      ...
      <div class="flex justify-between items-center py-2 px-3 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-100 dark:border-slate-700/60 mb-2.5 text-xs">
        ...
        `}else if(e==="qris"){const r=x.payment?.qrisUrl||"";t.innerHTML=`
          ...
          <input id="pos-dp-input" type="number" min="0" placeholder="0" value="0" class="w-full border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2 text-xs font-black text-right bg-white dark:bg-slate-800 focus:outline-none focus:border-[var(--color-primary)]">`)},Xt=e=>{m.isMember=e==="member",m.isNewTempo=e==="tempo",Zt("pos-ctype",e,["umum","member","tempo"]);const t=i("pos-customer-fields");t&&(e==="umum"?(m.name="",m.phone="",m.memberId=null,m.points=0,t.innerHTML='<input id="pos-cust-name" type="text" placeholder="Nama pembeli (opsional)" class="w-full border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2 text-xs bg-slate-50 dark:bg-slate-800 text-slate-800 dark:text-slate-100 focus:outline-none focus:border-[var(--color-primary)] focus:bg-white">'):e==="member"?(t.innerHTML=`
          <div class="space-y-2">
          ...
          </div>`,X().then(()=>{i("pos-cust-phone")?.value?.trim()&&ve()})):e==="tempo"&&(m.isMember=!1,nt("tempo"),t.innerHTML=`
          <div class="space-y-2">
          ...
          </div>`))},nt=e=>{j=e,Zt("pos-pay",e,["cash","qris","transfer","tempo"]),Fe(e),e==="transfer"&&(!x.banks||!x.banks.length)&&ke().then(t=>{j==="transfer"&&t&&t.length>0&&Fe("transfer")})},it=e=>{B=J(e);const t=I(),a=B-t,s=i("pos-change-display"),r=i("pos-change-label"),n=i("pos-change-box"),o=i("pos-process-btn");s&&(s.textContent=h(Math.abs(a))),r&&(r.textContent=a>=0?"Kembalian Uang Pembeli:":"Uang Masih Kurang:"),s&&(s.className=`text-base font-black ${a>=0?"text-emerald-700 dark:text-emerald-400":"text-rose-600 dark:text-rose-400"}`),n&&(n.className=`mt-2.5 p-3 rounded-2xl border transition-all flex items-center justify-between ${a>=0?"bg-emerald-50 dark:bg-emerald-950/30 border-emerald-200 dark:border-emerald-800":"bg-rose-50 dark:bg-rose-950/30 border-rose-200 dark:border-rose-800"}`),o&&j==="cash"&&(o.disabled=a<0,o.classList.toggle("opacity-50",a<0))},lt=e=>{const t=i("pos-paid-input");t&&(t.value=e,it(e),typeof window.triggerHaptic=="function"&&window.triggerHaptic("light"))},ke=async()=>{if(Array.isArray(x.banks)&&x.banks.length>0)return x.banks;try{const e=await $.collection("freshmart").doc("cms_data").get();if(e.exists){const t=e.data();if(Array.isArray(t?.banks)&&t.banks.length>0)return x.banks=t.banks,x.banks}}catch{}return x.banks||[]},X=async()=>{if(x.customers&&x.customers.length>0)return x.customers;try{const e=await $.collection("freshmart").doc("cms_data").collection("customers").get();return x.customers=e.docs.map(t=>({...t.data(),id:t.id,_docId:t.id})),x.customers}catch{return x.customers||[]}},ea=(e,t)=>{if(!e||!t||!t.length)return[];const a=e.trim().toLowerCase(),s=a.replace(/\D/g,"");let r=s;r.startsWith("62")?r=r.slice(2):r.startsWith("0")&&(r=r.slice(1));const n=[],o=new Set;return t.forEach(c=>{if(!c)return;const p=String(c.id||c._docId||c.phone||"");if(o.has(p))return;const b=String(c.phone||"").replace(/\D/g,"");let u=b;u.startsWith("62")?u=u.slice(2):u.startsWith("0")&&(u=u.slice(1));const y=String(c.name||"").toLowerCase();let k=!1;r.length>=4&&u&&(u===r||u.endsWith(r)||r.endsWith(u)||b.includes(s))&&(k=!0),!k&&(p.toLowerCase()===a||p===s)&&(k=!0),!k&&a.length>=2&&y.includes(a)&&(k=!0),k&&(o.add(p),n.push(c))}),n},Ma=async e=>{if(!e)return null;const t=e.trim(),a=t.replace(/\D/g,"");let s=a;s.startsWith("62")?s=s.slice(2):s.startsWith("0")&&(s=s.slice(1));const r=$.collection("freshmart").doc("cms_data").collection("customers"),o=Array.from(new Set([s?"62"+s:null,s?"0"+s:null,s||null,s?"+62"+s:null,a||null,t].filter(Boolean))).map(async b=>{try{const u=await r.doc(b).get();if(u&&u.exists)return{...u.data(),id:u.id,_docId:u.id}}catch{}return null}),p=(await Promise.all(o)).find(Boolean);if(p){x.customers||(x.customers=[]);const b=x.customers.findIndex(u=>String(u.id||u.phone)===String(p.id||p.phone));return b>-1?x.customers[b]=p:x.customers.push(p),p}try{const b=await r.limit(300).get();if(!b.empty){x.customers=b.docs.map(y=>({...y.data(),id:y.id,_docId:y.id}));const u=ea(e,x.customers);if(u.length>0)return u[0]}}catch{}return null},$e=e=>{m.isMember=!0,m.name=e.name||"Member Toko",m.phone=e.phone||"",m.memberId=e.id||e._docId||e.phone,m.points=parseFloat(e.points)||0;const t=i("pos-cust-phone");t&&(t.value=e.phone||e.name||"");const a=m.points,s=typeof window.getMemberTier=="function"?window.getMemberTier(a):{badge:"MEMBER RESMI"},r=i("pos-member-result");r&&(r.innerHTML=`
        <div class="p-3 bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-950/40 dark:to-teal-950/30 rounded-2xl border border-emerald-300 dark:border-emerald-700/60 shadow-xs flex items-center justify-between gap-2.5">
          ...
          <button onclick="window.resetPosMember()" type="button" class="shrink-0 px-2.5 py-1.5 rounded-xl text-[10px] font-bold text-slate-600 hover:text-rose-600 dark:text-slate-300 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 transition-all cursor-pointer" title="Ganti Member">
        ...
        </div>`),v(`Member terdeteksi: ${e.name} (${a} Poin)`,"success")},dt=e=>{const a=(x.customers||[]).find(s=>s&&String(s.id||s._docId||s.phone)===String(e));a&&$e(a)},ct=()=>{m.isMember=!1,m.name="",m.phone="",m.memberId=null,m.points=0;const e=i("pos-cust-phone");e&&(e.value="",e.focus());const t=i("pos-member-result");t&&(t.innerHTML="")};let Pt=null;const pt=()=>{clearTimeout(Pt);const e=i("pos-cust-phone")?.value?.trim()||"";if(!e){if(!m.memberId){const s=i("pos-member-result");s&&(s.innerHTML="")}return}const t=e.replace(/\D/g,"");!(Array.isArray(x.customers)&&x.customers.length>0)&&t.length<10&&e.length<8||(Pt=setTimeout(()=>{ve()},350))},ve=async()=>{const t=i("pos-cust-phone")?.value?.trim()||"";if(!t){v("Masukkan nomor HP atau nama member","warning");return}const a=i("pos-member-result"),s=i("pos-member-lookup-btn");s&&(s.disabled=!0,s.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>'),a&&(a.innerHTML='<div class="p-2.5 text-center text-xs text-slate-400"><i class="fa-solid fa-spinner fa-spin mr-1.5"></i>Memeriksa database member...</div>');try{await X();const r=ea(t,x.customers||[]);if(r.length===1)$e(r[0]);else if(r.length>1)a.innerHTML=`
            ...
            `;else{const n=await Ma(t);if(n)$e(n);else{m.isMember=!1,m.name="",m.memberId=null,m.points=0;const c=t.replace(/\D/g,"").length>=8;a.innerHTML=`
                  <div class="p-3 bg-amber-50 dark:bg-amber-950/30 rounded-xl border border-amber-200 dark:border-amber-800 text-amber-800 dark:text-amber-300 text-xs space-y-1">
                    ...
                    `}
                  </div>`}}}catch(r){console.error("[POS] Error lookupPosMember:",r),a&&(a.innerHTML=`<p class="text-xs text-rose-500 p-2">Gagal memeriksa data: ${d(r.message||"Koneksi error")}</p>`)}finally{s&&(s.disabled=!1,s.innerHTML='<i class="fa-solid fa-magnifying-glass mr-1.5"></i><span>Cek</span>')}},ta=async()=>{if(g.length===0){v("Keranjang kosong!","warning");return}const e=m.isMember?m.name||"Member Toko":i("pos-cust-name")?.value?.trim()||"Pelanggan Umum",t=m.isMember?m.phone||i("pos-cust-phone")?.value?.trim()||"":i("pos-cust-phone")?.value?.trim()||"";if(m.isNewTempo&&!t){v("No. HP wajib diisi untuk tempo!","warning");return}if(j==="cash"&&(B=J(i("pos-paid-input")?.value||0),B<I())){v(`Uang kurang! Minimal ${h(I())}`,"warning");return}m.name=e,m.phone=t;const a=j==="tempo"?J(i("pos-dp-input")?.value||0):0,s=j==="transfer"&&i("pos-bank-sel")?.value||"",r=i("pos-process-btn");r&&(r.disabled=!0,r.innerHTML='<i class="fa-solid fa-spinner fa-spin mr-2"></i>Memproses...');const n=x.store?.useStock===!0||x.store?.useStock==="true";if(n)for(const o of g){const c=(x.products||[]).find(b=>String(b.id)===String(o.id));if(!c)continue;const p=parseFloat(o.qty)||0;if(o.variantName&&c.variants){const b=(c.variants||[]).find(y=>y.name===o.variantName),u=parseFloat(b&&b.stock!==void 0?b.stock:0);if(u<p){v(`Stok ${o.name} (${o.variantName}) tidak cukup! Sisa: ${u}`,"warning"),r&&(r.disabled=!1,r.innerHTML='<i class="fa-solid fa-check-circle mr-2"></i>Selesaikan Transaksi');return}}else{const b=parseFloat(c.stock!==void 0?c.stock:0);if(b<p){v(`Stok ${o.name} tidak cukup! Sisa: ${b}`,"warning"),r&&(r.disabled=!1,r.innerHTML='<i class="fa-solid fa-check-circle mr-2"></i>Selesaikan Transaksi');return}}}try{const o=Ta(),c=typeof window.getCashierSession=="function"?window.getCashierSession():null,p=c?.name||x.store?.name||"Kasir",b=c?.uid||window.__currentAdminUid||"admin",u=new Date().toISOString(),y=Be.firestore.FieldValue.serverTimestamp(),k=j==="tempo"?"Diproses":"Selesai",l=R(),w=l&&l.status==="open"?l.id:null,M=l&&l.status==="open"?l.shiftNo||l.id:null,O={orderId:o,txId:o,source:"pos",channel:"pos",status:k,timestamp:y,dateString:u,dateMs:Date.now(),shiftId:w,shiftNo:M,cashier:b,cashierName:p,customer:{name:e,phone:t,wa:t,address:"Beli Langsung di Kasir (POS)",deliveryMethod:"takeaway",isMember:!!m.isMember,memberId:m.memberId||null},customerName:e,customerPhone:t,customerType:m.isMember?"Member":"Pelanggan Umum",items:g.map(S=>({id:S.id,name:S.name,price:parseFloat(S.price)||0,basePrice:parseFloat(S.basePrice||S.price)||0,qty:parseFloat(S.qty)||1,discount:parseFloat(S.discount)||0,subtotal:parseFloat(S.subtotal)||0,variantName:S.variantName||"",isVariant:!!S.isVariant,isWholesale:!!S.isWholesale,effectivePrice:parseFloat(S.price)||0})),payment:{method:j,subtotal:Z(),productDiscount:J(E),shippingCost:0,grandTotal:I(),paid:j==="cash"?B:j==="tempo"?a:I(),change:j==="cash"?Ft():0,bank:s,paymentStatus:j==="tempo"?"hutang":"lunas",tempoDp:a,tempoBalance:j==="tempo"?I()-a:0,tempoDueDate:Date.now()+30*24*60*60*1e3,tempoPenaltyRate:1,tempoPenaltyStopped:!1},subtotal:Z(),globalDiscount:F(),discountType:H,discountVal:A,total:I(),isTempo:j==="tempo",pointsEarned:0,notes:""};if(m.isMember&&t){const D=(typeof window.calculateCartPoints=="function"?window.calculateCartPoints(g,x.store):{totalPoints:0}).totalPoints||0;if(D>0){O.pointsEarned=D;try{const _=t.replace(/\D/g,""),T=String(m.memberId||_);if(await $.collection("freshmart").doc("cms_data").collection("customers").doc(T).set({points:Be.firestore.FieldValue.increment(D),lastOrderAt:u},{merge:!0}),x.customers){const q=x.customers.find(L=>L&&(String(L.id)===T||String(L.phone).replace(/\D/g,"")===_));q&&(q.points=(parseFloat(q.points)||0)+D)}}catch(_){console.warn("[POS] Gagal update poin member:",_)}}}if(await $.collection("freshmart_orders").doc(o).set(O),Dt(O),n){const S=[];for(const D of g){const _=String(D.id),T=(x.products||[]).find(L=>String(L.id)===_);if(!T)continue;const ue=parseFloat(D.qty)||0,q={};if(D.variantName&&T.variants){const L=T.variants.findIndex(da=>da.name===D.variantName);L>-1&&(T.variants[L].stock=Math.max(0,(parseFloat(T.variants[L].stock)||0)-ue),T.variants[L].stock===0&&(T.variants[L].isActive=!1),T.variants[L].totalSold=(parseFloat(T.variants[L].totalSold)||0)+ue,q.variants=T.variants)}else T.stock=Math.max(0,(parseFloat(T.stock)||0)-ue),q.stock=T.stock,T.stock===0&&(T.isActive="false",q.isActive="false"),T.totalSold=(parseFloat(T.totalSold)||0)+ue,q.totalSold=T.totalSold;try{await $.collection("freshmart").doc("cms_data").collection("products").doc(_).update(q),S.push(_)}catch(L){console.warn("[POS] Gagal update stok produk di Firestore:",_,L)}}if(S.length>0)try{await $.collection("freshmart").doc("cms_data").update({lastUpdate:Be.firestore.FieldValue.increment(1),updateType:"stock_change",updatedProductIds:S})}catch{}}ot(),xe(!0);const ye={...O};g=[],E=0,A=0,H="rp",C(),N(),Aa(ye)}catch(o){console.error("[POS] Error:",o),v("Gagal menyimpan transaksi. Coba lagi.","error"),r&&(r.disabled=!1,r.innerHTML='<i class="fa-solid fa-check-circle mr-2"></i>Selesaikan Transaksi')}},Aa=e=>{const t=e.payment.method==="cash"?`<p class="text-sm text-slate-500">Kembalian: <span class="font-black text-emerald-600">${h(e.payment.change)}</span></p>`:e.payment.method==="tempo"?'<p class="text-sm text-amber-600 font-semibold">⚠️ Dicatat sebagai Piutang Tempo</p>':`<p class="text-sm text-slate-500">Metode: ${e.payment.method.toUpperCase()}</p>`,a=JSON.stringify(e).replace(/"/g,"&quot;"),s=!!document.getElementById("pos-admin-container")||typeof window.cTab=="function"&&window.cTab()==="pos";document.body.insertAdjacentHTML("beforeend",`
    ...
    </div>`)},aa=e=>{document.getElementById("pos-success-modal")?.remove();const t=typeof Y=="function"?Y():{paperSize:"58mm"},a=t.paperSize==="80mm",s=t.headerText||x.store?.name||"TOKO PUTRI",r=x.store?.wa||"",n=x.store?.address||"",o=t.footerText||"Terima Kasih Atas Kunjungan Anda!",c=new Date(e.dateMs||Date.now()).toLocaleString("id-ID"),p=(e.items||[]).map(y=>`<tr><td style="padding:2px 0;word-wrap:break-word">${d(y.name)}</td><td style="text-align:right;padding:2px 4px;white-space:nowrap">${y.qty}x ${h(y.price)}</td><td style="text-align:right;padding:2px 0;white-space:nowrap;font-weight:bold">${h(y.subtotal)}</td></tr>`).join(""),b=e.discountType==="percent"&&e.discountVal?`Diskon (${e.discountVal}%)`:"Diskon",u=window.open("","_blank",`width=${a?460:360},height=720`);if(!u){document.getElementById("pos-receipt-fallback-modal")?.remove(),document.body.insertAdjacentHTML("beforeend",`
    ...
    <script>window.onload=()=>{window.print();setTimeout(()=>window.close(),800)}<\/script>
    </body></html>`),u.document.close()},bt=()=>{const e=typeof Y=="function"?Y():{deviceType:"system"},t=i("pos-receipt-paper-box");if(t)if(e.deviceType==="rawbt"&&window.AndroidNativeApp&&typeof window.AndroidNativeApp.printRawBT=="function"){const a=t.innerText,s=btoa(unescape(encodeURIComponent(a)));window.AndroidNativeApp.printRawBT(s)}else window.AndroidNativeApp&&typeof window.AndroidNativeApp.print=="function"?window.AndroidNativeApp.print():window.print()},sa=({isStorefront:e})=>{const a=(typeof window.getCashierSession=="function"?window.getCashierSession():null)?.name||(e?"Kasir":"Admin Seller"),s=d(x.store?.name||"Toko Putri");return`
    ...
    `},ra=()=>{try{z="",te="",g=[],E=0;const e=i("view-pos-cashier");if(!e)return;const t=i("admin-content"),a=i("view-admin");t&&a?.classList.contains("admin-pos-mode")&&(t.innerHTML="",a.classList.remove("admin-pos-mode")),e.innerHTML=sa({isStorefront:!0}),N(),C(),ne(),me(),qt(),Kt(),X(),na(),setTimeout(()=>{pe()||oe()},350)}catch(e){console.error("Gagal render POS Storefront:",e)}},oa=()=>{try{z="",te="";const e=i("view-admin");e&&e.classList.add("admin-pos-mode");const t=i("view-pos-cashier");if(t&&(t.innerHTML=""),!i("admin-content"))return;ba("admin-content",`
        ...
        `),N(),C(),ne(),me(),qt(),Kt(),X(),na(),setTimeout(()=>{pe()||oe()},350)}catch(e){console.error("Gagal render POS Admin:",e);const t=i("admin-content");t&&(t.innerHTML=`
