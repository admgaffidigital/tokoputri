...
import{a as o,c as I,s as wt,b as K,d as F,f as k,e as x,g as R,h as B,i as T,j as c,w as te,k as g,l as we,m as ne,n as Q,o as v,p as O,q as ra,r as Z,t as It,u as yt,v as Da,x as Ea,y as Se,z as oa,A as _a,B as ye,C as xe,D as $e,E as Ge,F as pe,G as We,H as Yt,I as ia,J as jt,K as na,L as la,M as Ra,N as Na,O as P,P as j,Q as C,R as Me,S as Xe,T as Te,U as ze,V as Ce,W as Qe,X as Fa,Y as Oa,Z as me,_ as da,$ as Ha,a0 as Ka,a1 as dt,a2 as Ie,a3 as Va,a4 as Xt,a5 as N,a6 as Lt,a7 as qa,a8 as Ua,a9 as Ga,aa as Wa,ab as Bt,ac as Pe,ad as ie,ae as za,af as Qa,ag as Ja}from"./module-print-DcJCoQbO.js";import{f as X}from"./vendor-firebase-core-D2OF5R23.js";import"./vendor-firebase-db-BIUZcnOd.js";const Ya="modulepreload",Xa=function(e){return"/"+e},Zt={},Za=function(t,a,r){let s=Promise.resolve();if(a&&a.length>0){document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),d=n?.nonce||n?.getAttribute("nonce");s=Promise.allSettled(a.map(l=>{if(l=Xa(l),l in Zt)return;Zt[l]=!0;const p=l.endsWith(".css"),m=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${m}`))return;const u=document.createElement("link");if(u.rel=p?"stylesheet":Ya,p||(u.as="script"),u.crossOrigin="",u.href=l,d&&u.setAttribute("nonce",d),document.head.appendChild(u),p)return new Promise((b,h)=>{u.addEventListener("load",b),u.addEventListener("error",()=>h(new Error(`Unable to preload CSS for ${l}`)))})}))}function i(n){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=n,window.dispatchEvent(d),!d.defaultPrevented)throw n}return s.then(n=>{for(const d of n||[])d.status==="rejected"&&i(d.reason);return t().catch(i)})},es={apiKey:"AIzaSyCOjrhMP52TGbiOyQLY92NDYE26N6d9hJM",authDomain:"restu-karya-utama.firebaseapp.com",databaseURL:"https://restu-karya-utama-default-rtdb.asia-southeast1.firebasedatabase.app",projectId:"restu-karya-utama",storageBucket:"restu-karya-utama.firebasestorage.app",messagingSenderId:"858310421352",appId:"1:858310421352:web:e20a833875e8d5c19944dd",measurementId:"G-PHDG2LJ8PM"};try{localStorage.removeItem("freshmart_fb_config")}catch{}const ca=window.FIREBASE_CONFIG||es;X.apps.length||X.initializeApp(ca);const y=X.firestore(),ee=X.auth();typeof window<"u"&&(window.firebase=X,window.db=y,window.auth=ee);try{y.settings({ignoreUndefinedProperties:!0,experimentalAutoDetectLongPolling:!0,merge:!0})}catch{}let ts=null;const no=()=>{Za(()=>import("./vendor-firebase-analytics-Jm19L5g2.js"),__vite__mapDeps([0,1])).then(()=>{try{ts=X.analytics()}catch{}}).catch(()=>{})},as="K2ijSERTT2dg27yYGTEgn6XHSnW2",Oe={emerald:{50:"#ecfdf5",100:"#d1fae5",200:"#a7f3d0",300:"#6ee7b7",400:"#34d399",500:"#10b981",600:"#059669",700:"#047857",800:"#065f46",900:"#064e3b"},teal:{50:"#f0fdfa",100:"#ccfbf1",200:"#99f6e4",300:"#5eead4",400:"#2dd4bf",500:"#14b8a6",600:"#0d9488",700:"#0f766e",800:"#115e59",900:"#134e4a"},cyan:{50:"#ecfeff",100:"#cffafe",200:"#a5f3fc",300:"#67e8f9",400:"#22d3ee",500:"#06b6d4",600:"#0891b2",700:"#0e7490",800:"#155e75",900:"#164e63"},sky:{50:"#f0f9ff",100:"#e0f2fe",200:"#bae6fd",300:"#7dd3fc",400:"#38bdf8",500:"#0ea5e9",600:"#0284c7",700:"#0369a1",800:"#075985",900:"#0c4a6e"},blue:{50:"#eff6ff",100:"#dbeafe",200:"#bfdbfe",300:"#93c5fd",400:"#60a5fa",500:"#3b82f6",600:"#2563eb",700:"#1d4ed8",800:"#1e40af",900:"#1e3a8a"},indigo:{50:"#eef2ff",100:"#e0e7ff",200:"#c7d2fe",300:"#a5b4fc",400:"#818cf8",500:"#6366f1",600:"#4f46e5",700:"#4338ca",800:"#3730a3",900:"#312e81"},violet:{50:"#f5f3ff",100:"#ede9fe",200:"#ddd6fe",300:"#c4b5fd",400:"#a78bfa",500:"#8b5cf6",600:"#7c3aed",700:"#6d28d9",800:"#5b21b6",900:"#4c1d95"},purple:{50:"#faf5ff",100:"#f3e8ff",200:"#e9d5ff",300:"#d8b4fe",400:"#c084fc",500:"#a855f7",600:"#9333ea",700:"#7e22ce",800:"#6b21a8",900:"#581c87"},fuchsia:{50:"#fdf4ff",100:"#fae8ff",200:"#f5d0fe",300:"#f0abfc",400:"#e879f9",500:"#d946ef",600:"#c026d3",700:"#a21caf",800:"#86198f",900:"#701a75"},pink:{50:"#fdf2f8",100:"#fce7f3",200:"#fbcfe8",300:"#f9a8d4",400:"#f472b6",500:"#ec4899",600:"#db2777",700:"#be185d",800:"#9d174d",900:"#831843"},rose:{50:"#fff1f2",100:"#ffe4e6",200:"#fecdd3",300:"#fda4af",400:"#fb7185",500:"#f43f5e",600:"#e11d48",700:"#be123c",800:"#9f1239",900:"#881337"},red:{50:"#fef2f2",100:"#fee2e2",200:"#fecaca",300:"#fca5a5",400:"#f87171",500:"#dc2626",600:"#b91c1c",700:"#991b1b",800:"#7f1d1d",900:"#450a0a"},orange:{50:"#fff7ed",100:"#ffedd5",200:"#fed7aa",300:"#fdba74",400:"#fb923c",500:"#ea580c",600:"#c2410c",700:"#9a3412",800:"#7c2d12",900:"#431407"},amber:{50:"#fffbeb",100:"#fef3c7",200:"#fde68a",300:"#fcd34d",400:"#fbbf24",500:"#d97706",600:"#b45309",700:"#92400e",800:"#78350f",900:"#451a03"},yellow:{50:"#fefce8",100:"#fef9c3",200:"#fef08a",300:"#fde047",400:"#eab308",500:"#d97706",600:"#b45309",700:"#854d0e",800:"#713f12",900:"#3f1d0b"},lime:{50:"#f7fee7",100:"#ecfccb",200:"#d9f99d",300:"#bef264",400:"#a3e635",500:"#65a30d",600:"#4d7c0f",700:"#3f6212",800:"#365314",900:"#1a2e05"},green:{50:"#f0fdf4",100:"#dcfce7",200:"#bbf7d0",300:"#86efac",400:"#4ade80",500:"#16a34a",600:"#15803d",700:"#166534",800:"#14532d",900:"#052e16"},slate:{50:"#f8fafc",100:"#f1f5f9",200:"#e2e8f0",300:"#cbd5e1",400:"#94a3b8",500:"#475569",600:"#334155",700:"#1e293b",800:"#0f172a",900:"#020617"},stone:{50:"#fafaf9",100:"#f5f5f4",200:"#e7e5e4",300:"#d6d3d1",400:"#a8a29e",500:"#57534e",600:"#44403c",700:"#292524",800:"#1c1917",900:"#0c0a09"}},ss=e=>{let t=parseInt(e.replace("#",""),16);return(t>>16&255)+","+(t>>8&255)+","+(t&255)},ea=(e,t)=>{let a=parseInt(e.slice(1,3),16),r=parseInt(e.slice(3,5),16),s=parseInt(e.slice(5,7),16);return a=Math.max(0,Math.min(255,a+t)),r=Math.max(0,Math.min(255,r+t)),s=Math.max(0,Math.min(255,s+t)),"#"+[a,r,s].map(i=>i.toString(16).padStart(2,"0")).join("")},rs=e=>{if(!e)return;try{document.querySelectorAll('meta[name="theme-color"]').forEach(l=>l.remove())}catch{}const t=document.createElement("meta");t.setAttribute("name","theme-color"),t.setAttribute("content",e),document.head.appendChild(t);try{document.querySelectorAll('meta[name="msapplication-navbutton-color"], meta[name="msapplication-TileColor"]').forEach(l=>l.remove())}catch{}const a=document.createElement("meta");a.setAttribute("name","msapplication-navbutton-color"),a.setAttribute("content",e),document.head.appendChild(a);const r=document.createElement("meta");r.setAttribute("name","msapplication-TileColor"),r.setAttribute("content",e),document.head.appendChild(r);let s=document.querySelector('meta[name="apple-mobile-web-app-capable"]');s||(s=document.createElement("meta"),s.setAttribute("name","apple-mobile-web-app-capable"),document.head.appendChild(s)),s.setAttribute("content","yes");let i=document.querySelector('meta[name="mobile-web-app-capable"]');i||(i=document.createElement("meta"),i.setAttribute("name","mobile-web-app-capable"),document.head.appendChild(i)),i.setAttribute("content","yes");let n=document.querySelector('meta[name="apple-mobile-web-app-status-bar-style"]');n||(n=document.createElement("meta"),n.setAttribute("name","apple-mobile-web-app-status-bar-style"),document.head.appendChild(n)),n.setAttribute("content","default"),typeof window.updatePwaManifest=="function"&&window.updatePwaManifest(e)},Ke=(e,t)=>{const a=e||localStorage.getItem("freshmart_ui_theme")||"emerald",r=Oe[a]||Oe.emerald;e&&localStorage.setItem("freshmart_ui_theme",a);const s=t||localStorage.getItem("freshmart_theme_color")||r[500];t&&localStorage.setItem("freshmart_theme_color",s);const i=ss(s),n=ea(s,-30),d=ea(s,150);return document.documentElement.style.setProperty("--color-primary",s),document.documentElement.style.setProperty("--color-primary-dark",n),document.documentElement.style.setProperty("--color-primary-light",d),document.documentElement.style.setProperty("--color-primary-rgb",i),rs(s),r},lo=()=>{const e=localStorage.getItem("freshmart_theme"),t=window.matchMedia("(prefers-color-scheme: dark)").matches;(e==="dark"||!e&&t)&&document.documentElement.classList.add("dark")},co=()=>{const e=document.documentElement.classList.toggle("dark");localStorage.setItem("freshmart_theme",e?"dark":"light");const t=document.getElementById("icon-theme")||document.getElementById("theme-toggle-icon");t&&(t.className=e?"fa-solid fa-sun text-sm text-amber-400":"fa-solid fa-moon text-sm text-slate-600 dark:text-slate-300")},po=()=>{const e=document.documentElement.classList.contains("dark"),t=document.getElementById("icon-theme")||document.getElementById("theme-toggle-icon");t&&(t.className=e?"fa-solid fa-sun text-sm text-amber-400":"fa-solid fa-moon text-sm text-slate-600 dark:text-slate-300")},Ve=(e="minimalist",t="")=>{let a=e||localStorage.getItem("freshmart_bg_style")||"minimalist";a==="dual_tone"&&(a="aurora_glow"),a==="geometric_3d"&&(a="tech_grid"),a==="diagonal_skew"&&(a="glass_studio");const r=t??(localStorage.getItem("freshmart_bg_custom_url")||"");e&&localStorage.setItem("freshmart_bg_style",a),t!=null&&localStorage.setItem("freshmart_bg_custom_url",r);const i=(p=>{if(!p||typeof p!="string")return"";const m=p.match(/drive\.google\.com.*(?:id=|\/d\/)([a-zA-Z0-9_-]+)/);return m?`https://lh3.googleusercontent.com/d/${m[1]}`:p.trim()})(r);document.documentElement.setAttribute("data-bg-style",a),document.body?.setAttribute("data-bg-style",a);const n=document.getElementById("app-container");n&&(n.setAttribute("data-bg-style",a),i?n.setAttribute("data-has-custom-bg","true"):n.removeAttribute("data-has-custom-bg"));const d=document.getElementById("dynamic-bg-container");if(!d)return;if(d.innerHTML="",d.className="pointer-events-none fixed inset-0 z-0 overflow-hidden",i){const p=document.createElement("div");p.className="absolute inset-0 z-0 bg-cover bg-center bg-no-repeat bg-fixed opacity-35 dark:opacity-25 pointer-events-none transition-all duration-500",p.style.backgroundImage=`url('${i}')`,d.appendChild(p);const m=document.createElement("div");m.className="absolute inset-0 z-0 bg-slate-50/70 dark:bg-[#0b1120]/80 pointer-events-none",d.appendChild(m)}let l="";if(a==="hero_arch"?l=`
        ...
        </div>`}).join("")),F("cart-subtotal",k(r));const s=o.store.freeShippingMinSpendEnabled===!0||o.store.freeShippingMinSpendEnabled==="true",i=parseFloat(o.store.freeShippingMinSpendAmount)||0;if(e)if(s&&i>0){e.classList.remove("hidden");const n=Math.min(100,Math.round(r/i*100)),d=Math.max(0,i-r),l=r>=i;e.innerHTML=`
                    ...
                    <div class="flex items-center gap-2.5 min-w-0">
                        ...
                        <div class="min-w-0">
                            ...
                            <p class="text-[10px] ${l?"text-white/85":"text-slate-400 dark:text-slate-500"} mt-0.5">
                                ${l?"Ongkos kirim otomatis dipotong Rp 0 saat checkout.":`Min. belanja ${k(i)} untuk pengiriman ke alamat.`}
                            </p>
                        </div>
                    </div>
        ...
        `,r.innerHTML=s,a.classList.contains("hidden")&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("variantPreview"),R("variant-preview-modal"),setTimeout(()=>{a.classList.remove("opacity-0"),r.classList.remove("scale-95")},10)},bs=()=>{if(!v)return;const e=x("variant-preview-modal"),t=x("variant-preview-content");if(!e||!t)return;const a=v.variants&&O!==null?v.variants[O]:null,r=a?.img||v.img||"",s=a?`${c(v.name)} - ${c(a.name)}`:c(v.name),i=k(a?.price??v.price);let n=`
        <div class="relative w-full aspect-square bg-white rounded-3xl overflow-hidden shadow-2xl border border-slate-200 dark:border-slate-800 flex items-center justify-center">
    ...
    <div class="flex gap-2.5 overflow-x-auto pb-2 pt-1 hide-scrollbar -mx-1 px-1 snap-x snap-mandatory">
        ${p}
            ...
            </a>`}).join(""),d.length<i.length?R("load-more-container"):B("load-more-container")},Ms=(e,t)=>{e&&(e.preventDefault(),e.stopPropagation());const a=o.products.find(l=>String(l.id)===String(t));if(!a)return;if(a.variants&&a.variants.length>0){typeof St=="function"?St(t):typeof window.openQuickVariantSheet=="function"?window.openQuickVariantSheet(t):pa(t);return}const r=o.store.useStock===!0||o.store.useStock==="true",s=parseFloat(a.stock)||0;if(r&&s<=0)return g("Stok produk ini sedang kosong");const i=I.find(l=>l.id===a.id&&!l.variantName),n=i&&parseFloat(i.qty)||0;if(r&&n+1>s)return g(`Maksimal stok tercapai: ${s}`);if(i)i.qty=parseFloat((i.qty+1).toFixed(2));else{const l=parseFloat(a.poin)>0?parseFloat(a.poin):0;I.push({id:a.id,name:a.name,variantName:null,price:a.price,img:a.img,qty:1,unit:a.unit||"pcs",poTime:a.poTime||"",colorCode:"",poin:l})}J();const d=e?.currentTarget||e?.target;typeof window.flyToCartAnimation=="function"?window.flyToCartAnimation(d,"#bnav-cart",a.img):typeof window.triggerHaptic=="function"&&window.triggerHaptic("medium"),g(`+1 ${a.name} Masuk Keranjang`,"success")},Is=()=>{const e=x("product-container");if(!e)return;const t=6;let a="";for(let r=0;r<t;r++)a+=`
            ...
            <div class="bg-slate-900 p-6 sm:p-7 rounded-[1.5rem] text-white shadow-xl shadow-slate-900/20 border border-slate-700/60 relative overflow-hidden group mt-2">
                ...
                <div class="space-y-3 font-medium text-sm text-slate-300 relative z-10">
                    ...
                    ${(()=>{if(!t.payment?.ppnAmount||t.payment.ppnAmount<=0)return"";const s=t.payment.ppnType==="inclusive",i=t.payment.ppnRate||11,n=t.payment.ppnAmount,d=(t.payment.subtotal||0)-(t.payment.productDiscount||0)+(t.payment.shippingCost||0)-(t.payment.shippingDiscount||0),l=t.payment.dppAmount||(s?Math.round(d*100/(100+i)):Math.max(0,d));return`
                        ...
                        <div class="flex justify-between items-center text-amber-400 bg-amber-900/20 px-2 py-1 -mx-2 rounded-xl"><span>${s?"Termasuk PPN":"PPN"} (${i}%)</span><span class="font-bold">${s?"":"+"}${k(n)}</span></div>
                        `})()}
                </div>
...
Kami akan segera memproses pesanan Anda. Terima kasih! 🙏`;window.open(`https://wa.me/${r}?text=${encodeURIComponent(p)}`,"_blank")}catch{C(),g("Gagal memuat data pesanan!")}},Xs=e=>{we("Hapus Pesanan","Yakin ingin hapus permanen?",async()=>{if(!dt){Ie(!0),j("Menghapus...");try{await y.collection("freshmart_orders").doc(e).delete(),g("Terhapus!"),Va===e&&ka()}catch{g("Gagal!")}finally{Ie(!1),C()}}})};window.exportOrdersToExcel=Us;window.rAdmOrd=Ws;window.openOrderDetail=Nt;window.saveOrderCustomerToDB=zs;window.ackRewardClaim=Qs;window.closeOrderDetailModal=ka;window.updateOrderStatus=Js;window.konfirmasiKeWA=Ys;window.deleteOrder=Xs;const Zs=()=>{const e=o.store.name||"Toko Grosir",t=o.store.themeColor||"#10b981",a=(i,n,d=!1)=>{let l=document.querySelector(`meta[${d?"property":"name"}="${i}"]`);l||(l=document.createElement("meta"),d?l.setAttribute("property",i):l.setAttribute("name",i),document.head.appendChild(l)),l.setAttribute("content",n)};a("theme-color",t),a("mobile-web-app-capable","yes"),a("apple-mobile-web-app-capable","yes"),a("apple-mobile-web-app-status-bar-style","black-translucent"),a("apple-mobile-web-app-title",e),a("application-name",e),a("msapplication-TileColor",t),document.title=e,localStorage.setItem("freshmart_theme_color",t),o.store.uiTheme&&o.store.uiTheme!==localStorage.getItem("freshmart_ui_theme")&&(localStorage.setItem("freshmart_ui_theme",o.store.uiTheme),Ke(o.store.uiTheme));const r=o.store.bgStyle||localStorage.getItem("freshmart_bg_style")||"minimalist",s=o.store.bgCustomUrl!==void 0?o.store.bgCustomUrl:localStorage.getItem("freshmart_bg_custom_url")||"";Ve(r,s)},va=()=>{T("admin-content",`
    ...
    `)},Vt=()=>{const e=tt(),t=z===0?`Tahun ${W}`:`${ve[z-1]} ${W}`,a=e.omset-e.disc-e.hpp,r=z===0?null:`${W}-${z}`,s=Ht(),i=a-s,n=o.taxSettings?.taxScheme||"umkm_final";let d,l,p;n==="umkm_final"?(d=.5,l=e.omset,p="PPh Final UMKM (0,5% × Omset)"):n==="badan_normal"?(d=22,l=Math.max(0,i),p="PPh Badan (22% × Laba Bersih)"):(d=parseFloat(o.taxSettings?.customTaxRate)||0,l=Math.max(0,i),p=`PPh Custom (${d}% × Laba Bersih)`);const m=l*(d/100),u=i-m;let b="";if(z===0)b=Array.from({length:12},(h,f)=>f+1).map(h=>{const f=`${W}-${h}`,S=(o.taxSettings?.monthlyExpenses||{})[f]||0;return`<div class="flex items-center justify-between gap-2 py-2 border-b border-slate-100 dark:border-slate-700/50 last:border-0">
    ...
    `;e.length===0?a+=`<div class="bg-white dark:bg-slate-800 p-8 text-center rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm">
              ...
              </div>`:(a+='<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">',e.forEach(r=>{let s=r.payment?.tempoBalance||0,i=r.payment?.tempoPenaltyRate!==void 0?parseFloat(r.payment.tempoPenaltyRate):1,n=r.payment?.tempoPenaltyStopped===!0,d=0,l=r.payment?.tempoDueDate||0,p=0,m=!1;n?(d=parseFloat(r.payment?.tempoFixedPenalty)||0,Date.now()>l&&(p=Math.floor((Date.now()-l)/(24*60*60*1e3)),p>0&&(m=!0))):Date.now()>l&&(p=Math.floor((Date.now()-l)/(24*60*60*1e3)),p>0&&(m=!0,d=i/100*s*p));let u=s+d;t+=u;let b=window.normalizeWA?window.normalizeWA(r.customer?.wa):r.customer?.wa||"";a+=`
    ...
    <div class="relative group/banner-wrapper w-full">
        <div id="banner-slider" class="flex overflow-x-auto gap-4 sm:gap-6 pb-4 pt-2 snap-x hide-scrollbar scroll-smooth" ontouchstart="clearInterval(window.bannerTmr)" ontouchend="setTimeout(() => window.startBannerAutoSlide?.(), 8000)" onmouseenter="clearInterval(window.bannerTmr)" onmouseleave="window.startBannerAutoSlide?.()" onscroll="window.onBannerScroll && window.onBannerScroll()">
            ${o.banners.map((n,d)=>{const l=n.type==="video"&&n.videoUrl,p=!l&&n.link?`onclick="window.open('${c(n.link)}', '_self')"`:"";if(l){const m=Ga(n.videoUrl)||{type:"direct",directUrl:Bt(n.videoUrl),embedUrl:Wa(n.videoUrl)};let u="";return m.type==="youtube"?u=`
                <iframe
        ...
        `:""}
    </div>`:"";T("dynamic-banners-container",e),setTimeout(st,500);const t=(o.vouchers||[]).filter(n=>n.isShow==="true"||n.isShow===!0),a=x("dynamic-vouchers-container");if(t.length>0&&a){a.classList.remove("hidden");let n=`
...
>`;s+="</div>"}),s=`<div class="grid grid-cols-1 lg:grid-cols-2 gap-x-5 gap-y-5 items-start">${s}</div>`,T("admin-modal-form",s),e==="products"&&(window.rVarsB?.(),window.rWholB?.(),window.rSpecB?.());const l=x("admin-modal");l&&l.classList.contains("hidden")&&Fr("admin"),R("admin-modal"),setTimeout(()=>{x("admin-modal").classList.remove("opacity-0"),x("admin-modal-box").classList.remove("scale-95")},10)};window.submitAdminForm=async()=>{if(_e)return;V(!0);const e=Wt||window.cTab||"products";let t={},a=_t[e]||[];for(let s of a)if(s.type==="variants_builder")t.variants=se.filter(i=>i.name.trim()!=="");else if(s.type==="wholesale_builder")t.wholesale=je.filter(i=>parseFloat(i.minQty)>.01&&i.price>0);else if(s.type==="spec_table_builder")t.specTable=ge.filter(i=>i.key.trim()!=="");else{let i="";if(s.type==="richtext"){const n=x(`af-${s.key}-editor`);i=n?n.innerHTML:""}else i=P(`af-${s.key}`);if(typeof i=="string"){if(i.startsWith("data:image/")&&i.length>3e5)return V(!1),g("Gambar Base64 terlalu besar! Upload file.");s.key==="img"&&(i=N(i))}t[s.key]=s.type==="number"?parseFloat(i)||0:i}if(!t.name&&!t.title&&!t.bankName&&!t.code)return V(!1),g("Judul/Nama/Kode wajib diisi!");if(e==="products"&&!t.sku&&(t.sku="SKU"+Date.now().toString().slice(-6)),e==="customers"){const s=window.normalizeWA?window.normalizeWA(t.phone):(t.phone||"").replace(/\D/g,"").replace(/^0/,"62");if(!s||s.length<10)return V(!1),g("Nomor WhatsApp tidak valid!");t.phone=s,t.points=parseFloat(t.points)||0,t.id=parseInt(s,10)}let r=null;if(e==="customers")if(o.customers||(o.customers=[]),be){r=be;let s=o.customers.findIndex(i=>i&&i.id!=null&&String(i.id)===String(be));s>-1?o.customers[s]=t:o.customers.unshift(t)}else o.customers.unshift(t);else if(e==="rewards")if(o.rewards||(o.rewards=[]),be){let s=o.rewards.findIndex(i=>i&&i.id!=null&&String(i.id)===String(be));s>-1?(t.id=o.rewards[s].id,o.rewards[s]=t):t.id=be}else t.id=Date.now(),o.rewards.unshift(t);else if(be){o[e]||(o[e]=[]);let s=o[e].findIndex(i=>i&&i.id!=null&&String(i.id)===String(be));if(s>-1){if(t.id=o[e][s].id,e==="products"){const i=o[e][s];t.totalSold=i.totalSold||0,t.variants&&t.variants.length&&i.variants&&t.variants.forEach(n=>{const d=i.variants.find(l=>l.name===n.name);d&&d.totalSold&&(n.totalSold=d.totalSold)})}o[e][s]=t}else t.id=be,o[e].push(t)}else t.id=Date.now(),o[e]||(o[e]=[]),o[e].unshift(t);j("Menyimpan...");try{const s=typeof y<"u"&&y?y:window.db,i=typeof q=="function"?q:window.saveApp||(async()=>{});if(!s)throw new Error("Database Firebase belum terhubung");if(e==="products")await s.collection("freshmart").doc("cms_data").collection("products").doc(t.id.toString()).set(t),await i([],{updateType:"product_single",updatedProductIds:[t.id.toString()]});else if(e==="customers"){const n=s.collection("freshmart").doc("cms_data").collection("customers");r!==null&&r!==t.id&&await n.doc(r.toString()).delete().catch(()=>{}),await n.doc(t.phone).set(t,{merge:!0})}else if(e==="rewards"){await s.collection("freshmart").doc("cms_data").collection("rewards").doc(t.id.toString()).set(t);try{localStorage.setItem("freshmart_rewards",JSON.stringify(o.rewards))}catch{}typeof window.renderRewardCatalog=="function"&&window.renderRewardCatalog()}else await i([e]);window.closeAdminModal?.(),window.rAdmItms?.(e),g("Tersimpan!")}catch(s){console.error("Gagal simpan admin data:",s),g("Gagal menyimpan: "+(s.message||""))}finally{V(!1),C()}};window.oADel=async(e,t)=>{window.showConfirm?.("Hapus Data","Data yang dihapus tidak bisa dikembalikan lagi.",async()=>{if(_e)return;V(!0);const a=typeof y<"u"&&y?y:window.db,r=typeof q=="function"?q:window.saveApp||(async()=>{}),s=o[e]&&o[e].find(i=>i&&i.id!=null&&String(i.id)===String(t));o[e]=(o[e]||[]).filter(i=>!i||i.id==null||String(i.id)!==String(t)),j("Menghapus...");try{if(!a)throw new Error("Database Firebase belum terhubung");if(e==="products")await a.collection("freshmart").doc("cms_data").collection("products").doc(t.toString()).delete(),await r([],{updateType:"product_delete",updatedProductIds:[t.toString()]});else if(e==="customers"){const i=s?s.phone:t.toString();await a.collection("freshmart").doc("cms_data").collection("customers").doc(i).delete()}else if(e==="rewards"){await a.collection("freshmart").doc("cms_data").collection("rewards").doc(t.toString()).delete();try{localStorage.setItem("freshmart_rewards",JSON.stringify(o.rewards))}catch{}typeof window.renderRewardCatalog=="function"&&window.renderRewardCatalog()}else await r([e]);window.rAdmItms?.(e),g("Berhasil Dihapus!")}catch(i){g("Gagal menghapus: "+(i.message||""))}finally{V(!1),C()}})};window.duplicateProduct=async e=>{window.showConfirm?.("Duplikat Produk","Menyalin data produk ini ke item baru?",async()=>{if(_e)return;V(!0);const t=typeof y<"u"&&y?y:window.db,a=typeof q=="function"?q:window.saveApp||(async()=>{}),r=o.products.find(i=>i&&i.id!=null&&String(i.id)===String(e));if(!r){V(!1);return}let s=JSON.parse(JSON.stringify(r));s.id=Date.now()+Math.floor(Math.random()*1e3),s.name=s.name+" COPY",s.sku="",s.totalSold=0,s.variants&&s.variants.length>0&&(s.variants=s.variants.map(i=>(i.sku="",i.totalSold=0,i))),o.products.unshift(s),j("Menyalin...");try{if(!t)throw new Error("Database Firebase belum terhubung");await t.collection("freshmart").doc("cms_data").collection("products").doc(s.id.toString()).set(s),await a([],{updateType:"product_single",updatedProductIds:[s.id.toString()]}),window.rAdmItms?.("products"),g("Produk berhasil disalin!")}catch(i){g("Gagal menyalin: "+(i.message||""))}finally{V(!1),C()}},"Ya, Salin",!1)};window.rSpecB=()=>{const e=document.getElementById("spec-table-builder-container");if(!e)return;let t="";ge.length>0?t+=`<div class="overflow-hidden rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm mb-3">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-4">
        ...
        </div>`)};window.confirmImportFromProducts=async()=>{const e=window._pendingImportVariants||[];window._pendingImportVariants=null;const t=(document.getElementById("impprod-catalog")?.value||"").trim();o.colors||(o.colors=[]);const a=new Set(o.colors.map(s=>s.name.toLowerCase()));let r=0;if(e.forEach((s,i)=>{const n=document.getElementById(`imp-chk-${i}`);n&&n.checked&&!a.has(s.varName.toLowerCase())&&(o.colors.push({id:Date.now()+r,name:s.varName,hex:s.hex||"",catalog:t}),a.add(s.varName.toLowerCase()),r++)}),_closeColorFloatModal(),!r){g("Tidak ada warna baru yang ditambahkan!");return}j("Menyimpan...");try{await q(["colors"]),g(`${r} warna berhasil diimpor ke Database Warna! 🎨`),window.cTab==="colors"&&window.rAdmItms?.("colors")}catch{g("Gagal menyimpan!")}finally{C()}};const Or=e=>window.pushModalHistory?.(e),Ta=(e,t,a)=>window.requestCloseModal?.(e,t,a);window.openRestockModal=e=>{const t=o.products.find(i=>i&&i.id!=null&&String(i.id)===String(e));if(!t)return;const a=t.variants&&t.variants.length>0;let r="";a?r=t.variants.map((i,n)=>`
        ...
        <div class="bg-white dark:bg-slate-900 w-full max-w-lg rounded-t-3xl sm:rounded-2xl max-h-[85vh] flex flex-col shadow-2xl border border-slate-200 dark:border-slate-700">
            ...
            <div class="bg-slate-50 dark:bg-slate-900/50 p-4 rounded-2xl border border-slate-200 dark:border-slate-700 space-y-3">
                ...
                <div class="grid grid-cols-4 gap-2.5">
                    ...
                    <div><label class="block text-[9px] font-bold text-[var(--color-primary)] mb-1 uppercase tracking-widest"><i class="fa-solid fa-star"></i> Poin</label><input type="number" min="0" id="qp-var-poin-${n}" value="${i.poin||0}" class="admin-input !py-2.5 !px-2.5 text-xs text-center bg-white dark:bg-slate-800"></div>
                </div>
            </div>`).join(""):r=`
            <div class="grid grid-cols-4 gap-2.5">
        ...
        </div>`;return}let r="";a.forEach((s,i)=>{const n=i===0&&Ye==="all",d=zr(s.category),l=Wr(s.date),p=(s.items||[]).map(m=>`
        ...
        </div>`:i=a.map(n=>{const d=t.some(b=>b.id===n.id),l=n.version===r,p=(n.items||[]).map(b=>`
    ...
    </div>`},Xr=(e=null)=>{He=e!==null?e:!He,He||(Fe=null),Re()},Zr=e=>{const t=(o.changelog||[]).find(s=>s.id===e);if(!t)return;Fe=e,He=!0,Re(),ne("form-log-version",t.version||""),ne("form-log-category",t.category||"feature"),ne("form-log-date",t.date||Jt()),ne("form-log-title",t.title||""),ne("form-log-items",(t.items||[]).join(`
