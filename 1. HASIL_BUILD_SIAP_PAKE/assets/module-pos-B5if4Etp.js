...
import{a as K,A as va,d as P,_ as ya}from"./module-member-DmgtiHXM.js";import{e as i,t as k,a as u,i as c,ar as te,x as Ye,b as Sa,f as Pa}from"./module-print-C2-MjUR_.js";import{f as Je}from"./vendor-firebase-core-D2OF5R23.js";let be=null;const Y=()=>{if(be)return be;try{const e=sessionStorage.getItem("pos_cashier_session");if(e)return be=JSON.parse(e),be}catch{}return null},Ta=e=>{be=e;try{e?sessionStorage.setItem("pos_cashier_session",JSON.stringify(e)):sessionStorage.removeItem("pos_cashier_session")}catch{}},Ft=()=>{be=null;try{sessionStorage.removeItem("pos_cashier_session")}catch{}},Rt=()=>!!Y(),_t=async()=>{if(Y()||window.isAdm||window.__localIsAdm||u&&(u.hasCashier===!0||u.store?.posEnabled===!0))return!0;const e=localStorage.getItem("pos_has_cashier");if(e==="true")return!0;const t=!!(window.isAdm||window.__localIsAdm||K.currentUser&&K.currentUser.uid===va);try{if(t){const s=!(await P.collection("freshmart").doc("cms_data").collection("cashier_accounts").where("isActive","==",!0).limit(1).get()).empty;try{localStorage.setItem("pos_has_cashier",s?"true":"false"),P.collection("freshmart").doc("cms_data").set({hasCashier:s},{merge:!0}).catch(()=>{})}catch{}return s}else{const a=await P.collection("freshmart").doc("cms_data").get();if(a.exists){const s=a.data();if(s.hasCashier!==void 0){const r=!!s.hasCashier;try{localStorage.setItem("pos_has_cashier",r?"true":"false")}catch{}return r}}return e!=="false"}}catch{return e!=="false"}},Re=async()=>{const e=i("pos-cashier-header-btn");if(!e)return;const t=!!Y(),a=!!(window.isAdm||window.__localIsAdm),s=localStorage.getItem("pos_has_cashier"),r=u?u.hasCashier??!0:!0;t||a||s==="true"||s===null&&r!==!1?e.classList.remove("hidden"):s==="false"&&e.classList.add("hidden");try{await _t()||t||a?e.classList.remove("hidden"):e.classList.add("hidden")}catch{(t||a||s!=="false")&&e.classList.remove("hidden")}},Et=async()=>{typeof window.triggerHaptic=="function"&&window.triggerHaptic("medium"),Y()?(typeof window.changeView=="function"&&window.changeView("view-pos-cashier"),typeof window.renderPOSStorefront=="function"&&window.renderPOSStorefront()):tt()},tt=()=>{const e=i("pos-login-modal");e&&(e.classList.remove("hidden"),setTimeout(()=>{e.classList.remove("opacity-0");const t=i("pos-login-modal-box");t&&t.classList.remove("translate-y-full","scale-95")},10),setTimeout(()=>{const t=i("pos-login-email");t&&t.focus()},300),typeof window.triggerHaptic=="function"&&window.triggerHaptic("light"))},at=()=>{const e=i("pos-login-modal"),t=i("pos-login-modal-box");e&&e.classList.add("opacity-0"),t&&t.classList.add("translate-y-full"),setTimeout(()=>{e&&e.classList.add("hidden");const a=i("pos-login-email"),s=i("pos-login-password"),r=i("pos-login-error");a&&(a.value=""),s&&(s.value=""),r&&(r.textContent="",r.classList.add("hidden"))},300)},Kt=async()=>{const e=i("pos-login-email"),t=i("pos-login-password"),a=i("pos-login-error"),s=i("pos-login-btn"),r=e?.value?.trim()||"",o=t?.value||"",n=b=>{if(a){a.classList.remove("hidden");const p=a.querySelector("span");p?p.textContent=b:a.textContent=b}typeof window.triggerHaptic=="function"&&window.triggerHaptic("error")};if((()=>{if(a){a.classList.add("hidden");const b=a.querySelector("span");b&&(b.textContent="")}})(),!r||!o){n("Email dan password wajib diisi.");return}s&&(s.disabled=!0,s.innerHTML='<i class="fa-solid fa-spinner fa-spin mr-2"></i>Memverifikasi...');try{const p=(await K.signInWithEmailAndPassword(r,o)).user?.uid;if(!p)throw new Error("UID tidak ditemukan");const y=await P.collection("freshmart").doc("cms_data").collection("cashier_accounts").doc(p).get();if(!y.exists){await K.signOut(),n("Akun ini bukan akun kasir yang terdaftar di toko ini.");return}const v=y.data();if(v.role!=="cashier"){await K.signOut(),n("Akun ini tidak memiliki akses kasir.");return}if(!v.isActive){await K.signOut(),n("Akun kasir ini telah dinonaktifkan. Hubungi admin toko.");return}Ta({uid:p,name:v.name||r,email:v.email||r,role:"cashier"});try{localStorage.setItem("pos_has_cashier","true")}catch{}Re(),typeof window.syncActiveShiftFromCloud=="function"&&window.syncActiveShiftFromCloud().catch(()=>{}),at(),k(`Selamat datang, ${v.name||"Kasir"}! 👋`,"success"),typeof window.changeView=="function"&&window.changeView("view-pos-cashier"),setTimeout(()=>{typeof window.renderPOSStorefront=="function"&&window.renderPOSStorefront()},100),typeof window.triggerHaptic=="function"&&window.triggerHaptic("success")}catch(b){console.error("[POS Auth] Login error:",b);const p=b.code||"";n(p==="auth/user-not-found"||p==="auth/wrong-password"||p==="auth/invalid-credential"?"Email atau password salah.":p==="auth/too-many-requests"?"Terlalu banyak percobaan. Coba lagi beberapa saat.":p==="auth/network-request-failed"?"Koneksi gagal. Periksa jaringan internet.":"Login gagal: "+(b.message||"Kesalahan tidak diketahui"))}finally{s&&(s.disabled=!1,s.innerHTML='<i class="fa-solid fa-right-to-bracket mr-2"></i>Masuk Kasir')}},st=async(e=!1)=>{if(!e&&typeof window.getActiveShift=="function"){const a=window.getActiveShift();if(a&&a.status==="open"){document.getElementById("pos-logout-shift-modal")?.remove();const s=typeof window.fRp=="function"?window.fRp(a.startingCash):"Rp "+a.startingCash;document.body.insertAdjacentHTML("beforeend",`
                ...
                <div class="p-3 rounded-2xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200/60 dark:border-slate-700/60 flex items-center justify-between text-xs">
                    <div class="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <span class="font-bold text-slate-800 dark:text-slate-200">${c(a)}</span>
                        </div>
                    </div>
                    <div class="text-right">
                        <span class="text-[10px] text-slate-400 block font-medium">Waktu Buka</span>
                        <span class="font-bold text-slate-700 dark:text-slate-300 text-[11px]">${c(s)}</span>
                    </div>
                </div>
        ...
        <div id="pos-shift-receipt-modal" class="fixed inset-0 z-[10003] flex items-center justify-center p-3 sm:p-4" style="background:rgba(15,23,42,0.7);backdrop-filter:blur(4px)">
            <div class="bg-white dark:bg-slate-900 rounded-3xl shadow-2xl w-full ${s?"max-w-md":"max-w-sm"} border border-slate-200 dark:border-slate-800 overflow-hidden flex flex-col max-h-[90vh]">
                ...
                <div id="pos-shift-receipt-paper-box" class="p-4 overflow-y-auto flex-1 font-mono text-[11px] bg-slate-50/60 dark:bg-slate-950 text-slate-800 dark:text-slate-200 space-y-1.5 select-text">
                    ...
                    ${o?`<div class="text-center text-[10px] text-slate-500">${c(o)}</div>`:""}
                    ${n?`<div class="text-center text-[10px] text-slate-500">WA: ${c(n)}</div>`:""}
                    <div class="border-t border-dashed border-slate-300 dark:border-slate-700 my-2"></div>
                    <div class="text-center font-black text-xs uppercase">${c(b)}</div>
                    <div class="border-t border-dashed border-slate-300 dark:border-slate-700 my-2"></div>
                    ...
                    ${t?"":`
                    <div class="flex justify-between font-bold"><span>Kas Fisik Dihitung</span><span>${x(d)}</span></div>
                    <div class="border-t border-dashed border-slate-300 dark:border-slate-700 my-1"></div>
    ...
    <h2>${r}</h2>${o?`<p>${c(o)}</p>`:""}${n?`<p>WA: ${c(n)}</p>`:""}
    <div class="line"></div>
    ...
    <p class="left">Mulai   : ${c(p)}</p>
    <p class="left">Selesai : ${c(f)}</p>
    ...
    ${t?"":`
    <tr style="font-weight:bold"><td>Kas Fisik Laci</td><td style="text-align:right">${x(d)}</td></tr>
    <tr><td colspan="2"><div class="line"></div></td></tr>
    ...
    <script>window.onload=()=>{window.print();setTimeout(()=>window.close(),800)}<\/script>
                ...
                </button>`)})},Ha=async e=>{const t=typeof e=="string"?i(e):e;t&&(t.innerHTML=`
    <div class="space-y-4">
    ...
    </div>`,await Jt())},Jt=async()=>{const e=i("admin-shift-list-target");if(e)try{const t=await P.collection("freshmart").doc("cms_data").collection("pos_shifts").orderBy("startTime","desc").limit(50).get();if(t.empty){e.innerHTML=`
    ...
    <div id="pos-hold-prompt-modal" class="fixed inset-0 z-[9999] flex items-center justify-center p-4" style="background:rgba(15,23,42,0.65);backdrop-filter:blur(4px)">
        ...
        <div class="divide-y divide-slate-100 dark:divide-slate-800">
            ${T.map((s,r)=>{const o=c(s.id),n=(s.cart||[]).slice(0,3).map(b=>`${c(b.name)} (${O(b.qty)}x)`).join(", "),l=(s.cart||[]).length>3?` +${s.cart.length-3} lainnya`:"";return`
                <div class="p-3.5 sm:p-4 hover:bg-slate-50/80 dark:hover:bg-slate-800/40 transition-colors flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    <div class="min-w-0 flex-1">
                        <div class="flex items-center gap-2 mb-1 flex-wrap">
                            ...
                            <span class="text-[10px] text-slate-400">• ${Ba(s.time)}</span>
                        </div>
    ...
    <div id="pos-held-list-modal" class="fixed inset-0 z-[9999] flex items-end sm:items-center justify-center p-0 sm:p-4" style="background:rgba(15,23,42,0.65);backdrop-filter:blur(4px)">
    ...
    </div>`)},Me=(e=!1)=>{const t=i("pos-held-list-modal");t&&(!e&&typeof window.requestCloseModal=="function"?window.requestCloseModal("posHeldModal",!1,()=>t.remove()):t.remove())},pt=e=>{const t=T.findIndex(a=>a.id===e);if(t===-1){k("Transaksi tertahan tidak ditemukan.","warning");return}if(h.length>0){document.getElementById("pos-recall-confirm-modal")?.remove(),document.body.insertAdjacentHTML("beforeend",`
        ...
        </div>`);return}bt(t)},bt=e=>{const t=T[e];t&&(h=JSON.parse(JSON.stringify(t.cart||[])),D=t.discountType||"rp",A=t.discountVal!==void 0?t.discountVal:t.globalDisc||0,q=V(),m=t.customer?{...t.customer}:{name:"",phone:"",isMember:!1,memberId:null,isNewTempo:!1},T.splice(e,1),ze(),Me(),$(),F(),Ce("recall"),k(`Antrean "${t.note}" berhasil dipanggil kembali!`,"success"))},ut=e=>{document.getElementById("pos-recall-confirm-modal")?.remove();const t=m?.name?`Antrean #${T.length+1} — ${m.name}`:`Antrean #${T.length+1}`,a={id:`HELD-${Date.now().toString(36).toUpperCase()}`,time:Date.now(),note:t,cart:JSON.parse(JSON.stringify(h)),globalDisc:V(),discountType:D,discountVal:A,customer:{...m},total:I(),subtotal:re(),itemCount:parseFloat(h.reduce((r,o)=>r+(parseFloat(o.qty)||0),0).toFixed(3))};T.unshift(a);const s=T.findIndex(r=>r.id===e);s!==-1?bt(s):(ze(),Me())},ft=e=>{document.getElementById("pos-recall-confirm-modal")?.remove();const t=T.findIndex(a=>a.id===e);t!==-1&&bt(t)},xt=e=>{const t=T.find(a=>a.id===e);t&&(document.getElementById("pos-delete-confirm-modal")?.remove(),document.body.insertAdjacentHTML("beforeend",`
    <div id="pos-delete-confirm-modal" class="fixed inset-0 z-[10005] flex items-center justify-center p-4" style="background:rgba(15,23,42,0.75);backdrop-filter:blur(4px)">
        <div class="bg-white dark:bg-slate-900 rounded-3xl shadow-2xl w-full max-w-xs border border-slate-200 dark:border-slate-800 p-6 text-center transform transition-all">
            ...
            <p class="text-xs text-slate-500 dark:text-slate-400 mb-5 leading-relaxed">
                Antrean <span class="font-bold text-slate-800 dark:text-slate-200">"${c(t.note)}"</span> (${t.itemCount} item • ${g(t.total)}) akan dihapus permanen.
            </p>
            <div class="flex gap-2.5">
               ...
               </div>`:t.map(n=>{if(!n)return"";const l=!!(n.img&&typeof n.img=="string"&&n.img.trim()),b=l?Ye(n.img,"w300-rw"):"",p=Array.isArray(n.variants)&&n.variants.length>0,f=Array.isArray(n.wholesale)&&n.wholesale.length>0,y=h.filter(S=>S&&String(S.id)===String(n.id)),v=parseFloat(y.reduce((S,B)=>S+(B&&B.qty&&parseFloat(B.qty)||0),0).toFixed(3)),d=c(String(n.id!=null?n.id:"")),w=we(n),M=c(String(n.name||"Produk")),L=c(String(n.category||"")),Le=parseFloat(n.price)||0;return W==="list"?`
                    <div class="pos-list-item${v>0?" in-cart":""}${w.isOutOfStock?" opacity-75":""}" onclick="window.posAddToCart('${d}')">
                        <div class="pos-list-thumb">
                            ${l?`<img width="52" height="52" loading="lazy" decoding="async" src="${c(b)}" alt="${M}" onerror="this.onerror=null;this.style.display='none';this.nextElementSibling.style.display='flex';">
                ...
                <div class="pos-product-card${v>0?" in-cart":""}${w.isOutOfStock?" opacity-75":""}" onclick="window.posAddToCart('${d}')">
                    ...
                    <div class="pos-img-box">
                        ...
                        ${l?`<img width="300" height="300" loading="lazy" decoding="async" src="${c(b)}" alt="${M}"
                                 onerror="this.onerror=null;this.style.display='none';this.nextElementSibling.style.display='flex';">
                               <div class="pos-img-placeholder" style="display:none">
                                 <i class="fa-solid fa-box-open"></i>
                                 <span>${c(n.category||"Toko")}</span>
                               </div>`:`<div class="pos-img-placeholder">
                                 <i class="fa-solid fa-box-open"></i>
                                 <span>${c(n.category||"Produk")}</span>
                               </div>`}
                    </div>
                    <!-- Info Produk -->
                ...
                </div>`})}},$=()=>{const e=parseFloat(h.reduce((d,w)=>d+(parseFloat(w.qty)||0),0).toFixed(3)),t=re(),a=I(),s=g(a),r=g(t),o=h.length===0?`<div class="flex flex-col items-center justify-center h-full py-12 text-slate-300 dark:text-slate-600 select-none">
            <div class="w-16 h-16 rounded-3xl bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-slate-400 mb-3 shadow-inner">
           ...
           </div>`:h.map(d=>{const w=c(String(d.cartKey||d.id)),M=Na(d),L=d.isVariant&&d.variantName?c(d.name.replace(` — ${d.variantName}`,"")):c(d.name);return`
                ...
                <div class="flex-1 min-w-0 pr-1">
                    ...
                    <div class="flex items-center gap-1.5 mt-0.5 flex-wrap">
                        ...
                        <span class="text-[10px] text-slate-500 font-medium">
                            ${d.isWholesale&&d.basePrice?`<span class="line-through text-slate-400">${g(d.basePrice)}</span> <span class="font-bold" style="color:var(--color-primary)">${g(d.price)}</span>`:g(d.price)}
                        </span>
                    </div>
        ...
        `:`
        ${p.map(d=>{const w=f(d,"rp"),M=`${d/1e3}rb`;return`<button onclick="window.posApplyQuickDiscount(${d},'rp')" 
                class="px-2.5 py-1 rounded-lg text-[10px] cursor-pointer transition-all active:scale-95 ${w?"text-white shadow-xs font-black":"bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 border border-slate-200/80 dark:border-slate-700 font-bold"}"
    ...
    <div id="pos-pay-modal" class="fixed inset-0 z-[9999] flex items-end sm:items-center justify-center p-0 sm:p-4" style="background:rgba(15,23,42,0.65);backdrop-filter:blur(4px)">
      ...
      <div class="flex justify-between items-center py-2 px-3 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-100 dark:border-slate-700/60 mb-2.5 text-xs">
        ...
        `}else if(e==="qris"){const r=u.payment?.qrisUrl||"";t.innerHTML=`
          ...
          </div>`,oe().then(()=>{i("pos-cust-phone")?.value?.trim()&&Oe()})):e==="tempo"&&(m.isMember=!1,wt("tempo"),t.innerHTML=`
          <div class="space-y-2">
        ...
        <div class="p-3 bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-950/40 dark:to-teal-950/30 rounded-2xl border border-emerald-300 dark:border-emerald-700/60 shadow-xs flex items-center justify-between gap-2.5">
          ...
          <button onclick="window.resetPosMember()" type="button" class="shrink-0 px-2.5 py-1.5 rounded-xl text-[10px] font-bold text-slate-600 hover:text-rose-600 dark:text-slate-300 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 transition-all cursor-pointer" title="Ganti Member">
        ...
        </div>`),k(`Member terdeteksi: ${e.name} (${a} Poin)`,"success")},yt=e=>{const a=(u.customers||[]).find(s=>s&&String(s.id||s._docId||s.phone)===String(e));a&&Ne(a)},St=()=>{m.isMember=!1,m.name="",m.phone="",m.memberId=null,m.points=0;const e=i("pos-cust-phone");e&&(e.value="",e.focus());const t=i("pos-member-result");t&&(t.innerHTML="")};let Nt=null;const Pt=()=>{clearTimeout(Nt);const e=i("pos-cust-phone")?.value?.trim()||"";if(!e){if(!m.memberId){const s=i("pos-member-result");s&&(s.innerHTML="")}return}const t=e.replace(/\D/g,"");!(Array.isArray(u.customers)&&u.customers.length>0)&&t.length<10&&e.length<8||(Nt=setTimeout(()=>{Oe()},350))},Oe=async()=>{const t=i("pos-cust-phone")?.value?.trim()||"";if(!t){k("Masukkan nomor HP atau nama member","warning");return}const a=i("pos-member-result"),s=i("pos-member-lookup-btn");s&&(s.disabled=!0,s.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>'),a&&(a.innerHTML='<div class="p-2.5 text-center text-xs text-slate-400"><i class="fa-solid fa-spinner fa-spin mr-1.5"></i>Memeriksa database member...</div>');try{await oe();const r=pa(t,u.customers||[]);if(r.length===1)Ne(r[0]);else if(r.length>1)a.innerHTML=`
              <div class="space-y-1.5 max-h-44 overflow-y-auto pr-1">
                <p class="text-[10px] font-bold text-slate-500 mb-1">Ditemukan ${r.length} member (klik untuk memilih):</p>
                ${r.map(o=>`
                  <button onclick="window.selectPosMember('${c(o.id||o._docId||o.phone)}')" type="button"
                    ...
                    <div class="min-w-0">
                      <p class="text-xs font-bold text-slate-800 dark:text-white truncate">${c(o.name||"Member")}</p>
                      <p class="text-[10px] text-slate-500 dark:text-slate-400 font-mono">${c(o.phone||"")}</p>
                    </div>
            ...
            `;else{const o=await Fa(t);if(o)Ne(o);else{m.isMember=!1,m.name="",m.memberId=null,m.points=0;const l=t.replace(/\D/g,"").length>=8;a.innerHTML=`
                  <div class="p-3 bg-amber-50 dark:bg-amber-950/30 rounded-xl border border-amber-200 dark:border-amber-800 text-amber-800 dark:text-amber-300 text-xs space-y-1">
                    ...
                    `}
                  </div>`}}}catch(r){console.error("[POS] Error lookupPosMember:",r),a&&(a.innerHTML=`<p class="text-xs text-rose-500 p-2">Gagal memeriksa data: ${c(r.message||"Koneksi error")}</p>`)}finally{s&&(s.disabled=!1,s.innerHTML='<i class="fa-solid fa-magnifying-glass mr-1.5"></i><span>Cek</span>')}},ba=async()=>{if(h.length===0){k("Keranjang kosong!","warning");return}const e=m.isMember?m.name||"Member Toko":i("pos-cust-name")?.value?.trim()||"Pelanggan Umum",t=m.isMember?m.phone||i("pos-cust-phone")?.value?.trim()||"":i("pos-cust-phone")?.value?.trim()||"";if(m.isNewTempo&&!t){k("No. HP wajib diisi untuk tempo!","warning");return}if(H==="cash"&&(_=de(i("pos-paid-input")?.value||0),_<I())){k(`Uang kurang! Minimal ${g(I())}`,"warning");return}m.name=e,m.phone=t;const a=H==="tempo"?de(i("pos-dp-input")?.value||0):0,s=H==="transfer"&&i("pos-bank-sel")?.value||"",r=i("pos-process-btn");r&&(r.disabled=!0,r.innerHTML='<i class="fa-solid fa-spinner fa-spin mr-2"></i>Memproses...');const o=u.store?.useStock===!0||u.store?.useStock==="true";if(o)for(const n of h){const l=(u.products||[]).find(p=>String(p.id)===String(n.id));if(!l)continue;const b=parseFloat(n.qty)||0;if(n.variantName&&l.variants){const p=(l.variants||[]).find(y=>y.name===n.variantName),f=parseFloat(p&&p.stock!==void 0?p.stock:0);if(f<b){k(`Stok ${n.name} (${n.variantName}) tidak cukup! Sisa: ${f}`,"warning"),r&&(r.disabled=!1,r.innerHTML='<i class="fa-solid fa-check-circle mr-2"></i>Selesaikan Transaksi');return}}else{const p=parseFloat(l.stock!==void 0?l.stock:0);if(p<b){k(`Stok ${n.name} tidak cukup! Sisa: ${p}`,"warning"),r&&(r.disabled=!1,r.innerHTML='<i class="fa-solid fa-check-circle mr-2"></i>Selesaikan Transaksi');return}}}try{const n=Da(),l=typeof window.getCashierSession=="function"?window.getCashierSession():null,b=l?.name||u.store?.name||"Kasir",p=l?.uid||window.__currentAdminUid||"admin",f=new Date().toISOString(),y=Je.firestore.FieldValue.serverTimestamp(),v=H==="tempo"?"Diproses":"Selesai",d=N(),w=d&&d.status==="open"?d.id:null,M=d&&d.status==="open"?d.shiftNo||d.id:null,L={orderId:n,txId:n,source:"pos",channel:"pos",status:v,timestamp:y,dateString:f,dateMs:Date.now(),shiftId:w,shiftNo:M,cashier:p,cashierName:b,customer:{name:e,phone:t,wa:t,address:"Beli Langsung di Kasir (POS)",deliveryMethod:"takeaway",isMember:!!m.isMember,memberId:m.memberId||null},customerName:e,customerPhone:t,customerType:m.isMember?"Member":"Pelanggan Umum",items:h.map(S=>({id:S.id,name:S.name,price:parseFloat(S.price)||0,basePrice:parseFloat(S.basePrice||S.price)||0,qty:parseFloat(S.qty)||1,discount:parseFloat(S.discount)||0,subtotal:parseFloat(S.subtotal)||0,variantName:S.variantName||"",isVariant:!!S.isVariant,isWholesale:!!S.isWholesale,effectivePrice:parseFloat(S.price)||0})),payment:{method:H,subtotal:re(),productDiscount:de(q),shippingCost:0,grandTotal:I(),paid:H==="cash"?_:H==="tempo"?a:I(),change:H==="cash"?Zt():0,bank:s,paymentStatus:H==="tempo"?"hutang":"lunas",tempoDp:a,tempoBalance:H==="tempo"?I()-a:0,tempoDueDate:Date.now()+30*24*60*60*1e3,tempoPenaltyRate:1,tempoPenaltyStopped:!1},subtotal:re(),globalDiscount:V(),discountType:D,discountVal:A,total:I(),isTempo:H==="tempo",pointsEarned:0,notes:""};if(m.isMember&&t){const B=(typeof window.calculateCartPoints=="function"?window.calculateCartPoints(h,u.store):{totalPoints:0}).totalPoints||0;if(B>0){L.pointsEarned=B;try{const z=t.replace(/\D/g,""),C=String(m.memberId||z);if(await P.collection("freshmart").doc("cms_data").collection("customers").doc(C).set({points:Je.firestore.FieldValue.increment(B),lastOrderAt:f},{merge:!0}),u.customers){const Q=u.customers.find(j=>j&&(String(j.id)===C||String(j.phone).replace(/\D/g,"")===z));Q&&(Q.points=(parseFloat(Q.points)||0)+B)}}catch(z){console.warn("[POS] Gagal update poin member:",z)}}}if(await P.collection("freshmart_orders").doc(n).set(L),Qt(L),o){const S=[];for(const B of h){const z=String(B.id),C=(u.products||[]).find(j=>String(j.id)===z);if(!C)continue;const ve=parseFloat(B.qty)||0,Q={};if(B.variantName&&C.variants){const j=C.variants.findIndex(ka=>ka.name===B.variantName);j>-1&&(C.variants[j].stock=Math.max(0,(parseFloat(C.variants[j].stock)||0)-ve),C.variants[j].stock===0&&(C.variants[j].isActive=!1),C.variants[j].totalSold=(parseFloat(C.variants[j].totalSold)||0)+ve,Q.variants=C.variants)}else C.stock=Math.max(0,(parseFloat(C.stock)||0)-ve),Q.stock=C.stock,C.stock===0&&(C.isActive="false",Q.isActive="false"),C.totalSold=(parseFloat(C.totalSold)||0)+ve,Q.totalSold=C.totalSold;try{await P.collection("freshmart").doc("cms_data").collection("products").doc(z).update(Q),S.push(z)}catch(j){console.warn("[POS] Gagal update stok produk di Firestore:",z,j)}}if(S.length>0)try{await P.collection("freshmart").doc("cms_data").update({lastUpdate:Je.firestore.FieldValue.increment(1),updateType:"stock_change",updatedProductIds:S})}catch{}}gt(),ke(!0);const Le={...L};h=[],q=0,A=0,D="rp",$(),F(),Ra(Le)}catch(n){console.error("[POS] Error:",n),k("Gagal menyimpan transaksi. Coba lagi.","error"),r&&(r.disabled=!1,r.innerHTML='<i class="fa-solid fa-check-circle mr-2"></i>Selesaikan Transaksi')}},Ra=e=>{const t=e.payment.method==="cash"?`<p class="text-sm text-slate-500">Kembalian: <span class="font-black text-emerald-600">${g(e.payment.change)}</span></p>`:e.payment.method==="tempo"?'<p class="text-sm text-amber-600 font-semibold">⚠️ Dicatat sebagai Piutang Tempo</p>':`<p class="text-sm text-slate-500">Metode: ${e.payment.method.toUpperCase()}</p>`,a=JSON.stringify(e).replace(/"/g,"&quot;"),s=!!document.getElementById("pos-admin-container")||typeof window.cTab=="function"&&window.cTab()==="pos";document.body.insertAdjacentHTML("beforeend",`
        ...
        <div id="pos-receipt-fallback-modal" class="fixed inset-0 z-[10000] flex items-center justify-center p-3 sm:p-4" style="background:rgba(15,23,42,0.7);backdrop-filter:blur(4px)">
            <div class="bg-white dark:bg-slate-900 rounded-3xl shadow-2xl w-full ${a?"max-w-md":"max-w-sm"} border border-slate-200 dark:border-slate-800 overflow-hidden flex flex-col max-h-[90vh]">
                ...
                <div id="pos-receipt-paper-box" class="p-4 overflow-y-auto flex-1 font-mono text-[11px] bg-slate-50/60 dark:bg-slate-950 text-slate-800 dark:text-slate-200 space-y-2 select-text">
                    ...
                    <div class="border-t border-dashed border-slate-300 dark:border-slate-700 my-2"></div>
                    <div class="text-center text-[10px] text-slate-400 my-1">${c(n)}</div>
                </div>
                <div class="p-3 border-t border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/40 flex gap-2">
    ...
    <h2>${s}</h2>${o?`<p>${c(o)}</p>`:""}${r?`<p>WA: ${c(r)}</p>`:""}
    <div class="line"></div>
    ...
    <p style="text-align:center;font-size:10px">${c(n)}</p>
    <p style="text-align:center;font-size:9px">Barang yang sudah dibeli tidak dapat ditukar/dikembalikan</p>
    <script>window.onload=()=>{window.print();setTimeout(()=>window.close(),800)}<\/script>
    </body></html>`),f.document.close()},Tt=()=>{const e=typeof te=="function"?te():{deviceType:"system"},t=i("pos-receipt-paper-box");if(t)if(e.deviceType==="rawbt"&&window.AndroidNativeApp&&typeof window.AndroidNativeApp.printRawBT=="function"){const a=t.innerText,s=btoa(unescape(encodeURIComponent(a)));window.AndroidNativeApp.printRawBT(s)}else window.AndroidNativeApp&&typeof window.AndroidNativeApp.print=="function"?window.AndroidNativeApp.print():window.print()},fa=({isStorefront:e})=>{const a=(typeof window.getCashierSession=="function"?window.getCashierSession():null)?.name||(e?"Kasir":"Admin Seller"),s=c(u.store?.name||"Toko Putri");return`
    ...
    `},xa=()=>{try{J="",ne="",h=[],q=0;const e=i("view-pos-cashier");if(!e)return;const t=i("admin-content"),a=i("view-admin");t&&a?.classList.contains("admin-pos-mode")&&(t.innerHTML="",a.classList.remove("admin-pos-mode")),e.innerHTML=fa({isStorefront:!0}),F(),$(),pe(),Te(),ta(),Xt(),oe(),ha(),typeof Z=="function"?Z().then(s=>{(!s||s.status!=="open")&&R()}).catch(()=>{se()||R()}):setTimeout(()=>{se()||R()},350)}catch(e){console.error("Gagal render POS Storefront:",e)}},ma=()=>{try{J="",ne="";const e=i("view-admin");e&&e.classList.add("admin-pos-mode");const t=i("view-pos-cashier");if(t&&(t.innerHTML=""),!i("admin-content"))return;Sa("admin-content",`
        ...
        `),F(),$(),pe(),Te(),ta(),Xt(),oe(),ha(),typeof Z=="function"?Z().then(s=>{(!s||s.status!=="open")&&R()}).catch(()=>{se()||R()}):setTimeout(()=>{se()||R()},350)}catch(e){console.error("Gagal render POS Admin:",e);const t=i("admin-content");t&&(t.innerHTML=`
            ...
            `)}},ha=()=>{window.setPOSViewMode=dt,window.posAddToCart=Ve,window.posAddToCartQty=aa,window.addToCartPOSWithVariant=sa,window.posUpdateQty=ra,window.posSetQty=oa,window.posFormatQty=O,window.posFQty=Ke,window.posSetItemDisc=na,window.posRemoveItem=Ue,window.posClearCart=ia,window.openPayModal=la,window.closePayModal=gt,window.setPosCustomerType=ca,window.setPosPayMethod=wt,window.updatePosChange=kt,window.posSetQuickCash=vt,window.ensureCustomersLoaded=oe,window.ensureBanksLoaded=Ae,window.lookupPosMember=Oe,window.debouncedLookupPosMember=Pt,window.selectPosMember=yt,window.resetPosMember=St,window.processPOSTx=ba,window.printPOSReceipt=ua,window.posSetGlobalDisc=e=>{Fe(e)},window.posSetDiscountType=Ct,window.posSetDiscountVal=Fe,window.posApplyQuickDiscount=$t,window.openPOSCameraScanner=We,window.closePOSCameraScanner=ce,window.togglePOSScannerFacing=At,window.togglePOSScannerTorch=Mt,window.togglePOSScannerMode=Ot,window.posProcessManualBarcode=Lt,window.posSearchScannedCode=jt,window.executePOSPrintDirect=Tt,window.getActiveShift=N,window.isShiftActive=se,window.syncActiveShiftFromCloud=Z,window.openPOSOpenShiftModal=R,window.closePOSOpenShiftModal=he,window.openPOSShiftModal=E,window.openPOSShiftSummaryModal=E,window.closePOSShiftSummaryModal=Ee,window.openPOSCloseShiftModal=nt,window.closePOSCloseShiftModal=Pe,window.renderShiftHeaderBadge=Te,window.printShiftSettlementReceipt=it,window.executeShiftPrintDirect=lt,window.posCatFilter=e=>{ne=e,F()},window.posSearchFn=e=>{J=typeof e=="string"?e:e?.value||"",document.querySelectorAll("#pos-search-input").forEach(t=>{t.value!==J&&(t.value=J)}),F()},window.renderCatalog=F,window.renderCart=$,window.refreshPOSCatalog=()=>{try{F()}catch(e){console.warn("refreshPOSCatalog error:",e)}},window.openPOSCartDrawer=ht,window.closePOSCartDrawer=ke,window.playCashierBeep=U,window.openPOSHistory=()=>{typeof window.openAdminTab=="function"?window.openAdminTab("orders"):typeof window.showToast=="function"&&window.showToast("Semua transaksi kasir terpusat di menu Pesanan CMS Admin")},window.destroyBarcodeListener=qe,window.playCashierChime=Ce,window.posHoldCurrentCart=Qe,window.closePOSHoldPrompt=Ge,window.posConfirmHoldCart=ct,window.openPOSHeldModal=$e,window.closePOSHeldModal=Me,window.posRecallHeldCart=pt,window.posHoldCurrentAndRecall=ut,window.posOverwriteAndRecall=ft,window.posDeleteHeldCart=xt,window.posExecuteDeleteHeld=mt,window.renderHeldBadges=pe},Ct=e=>{D=e==="percent"?"percent":"rp",q=V(),$()},Fe=e=>{A=Math.max(0,parseFloat(e)||0),q=V(),$()},$t=(e,t)=>{t&&(D=t),A=e,q=V(),$(),U()},We=async()=>{if(i("pos-camera-scanner-modal"))return;typeof window.pushModalHistory=="function"&&window.pushModalHistory("posCameraScanner"),document.body.insertAdjacentHTML("beforeend",`
    ...
    </div>`),await ga()},ga=async()=>{const e=i("pos-camera-video");if(e)try{const t={video:{facingMode:{ideal:Xe},width:{ideal:1280},height:{ideal:720}},audio:!1},a=await navigator.mediaDevices.getUserMedia(t);le=a,e.srcObject=a,await e.play();const s=a.getVideoTracks();if(s.length>0){ee=s[0];const r=ee.getCapabilities?ee.getCapabilities():{},o=i("pos-scanner-torch-btn");o&&(r.torch?o.classList.remove("hidden"):o.classList.add("opacity-40"))}if(typeof window.BarcodeDetector<"u")try{je=new BarcodeDetector({formats:["ean_13","ean_8","upc_a","upc_e","code_128","code_39","code_93","qr_code","data_matrix"]})}catch{je=null}xe&&clearInterval(xe),xe=setInterval(async()=>{if(!(!je||!e||e.readyState<2))try{const r=await je.detect(e);if(r&&r.length>0){const o=r[0].rawValue?.trim();o&&wa(o)}}catch{}},180)}catch(t){console.warn("[POS Scanner] Gagal akses kamera:",t);const a=i("pos-scanner-status-pill");a&&(a.innerHTML='<span class="text-rose-400 font-bold"><i class="fa-solid fa-triangle-exclamation mr-1"></i>Kamera tidak dapat diakses</span>'),k("Izin kamera ditolak atau kamera sedang digunakan aplikasi lain.","warning")}},wa=e=>{const t=Date.now();if(e===Dt&&t-Bt<1800)return;Dt=e,Bt=t;const a=e.toLowerCase(),s=(u.products||[]).find(p=>p&&p.isActive!=="false"&&p.isActive!==!1&&(p.barcode&&p.barcode.toLowerCase()===a||p.sku&&p.sku.toLowerCase()===a||p.id&&String(p.id).toLowerCase()===a)),r=i("pos-scanner-reticle"),o=i("pos-scanner-status-pill"),n=i("pos-last-scanned-banner"),l=i("pos-last-scanned-text"),b=i("pos-last-scanned-price");if(s){if(r&&(r.classList.add("border-emerald-300","scale-105","bg-emerald-500/20"),setTimeout(()=>{r.classList.remove("border-emerald-300","scale-105","bg-emerald-500/20")},300)),U(),s.variants&&s.variants.length>0){o&&(o.innerHTML='<span class="text-amber-300 font-bold">Buka pilihan varian...</span>'),ce(),Yt().then(()=>{typeof window.openPOSVariantSheet=="function"&&window.openPOSVariantSheet(s.id)});return}Ve(s.id),n&&l&&b&&(l.textContent=s.name,b.textContent=g(parseFloat(s.price)||0),n.classList.remove("hidden")),o&&(o.innerHTML=`<span class="text-emerald-300 font-black"><i class="fa-solid fa-check mr-1"></i>${c(s.name)} (+1)</span>`,setTimeout(()=>{o&&(o.innerHTML='<span class="w-2 h-2 rounded-full bg-emerald-400 animate-ping"></span><span>Menunggu barcode...</span>')},1500)),Ie||(ce(),k(`Ditambahkan: ${s.name}`,"success"))}else r&&(r.classList.add("border-rose-500","bg-rose-500/20"),setTimeout(()=>{r.classList.remove("border-rose-500","bg-rose-500/20")},400)),o&&(o.innerHTML=`<span class="text-rose-400 font-bold"><i class="fa-solid fa-xmark mr-1"></i>Barcode "${e}" tidak ditemukan</span>`)},ce=(e=!1)=>{if(xe&&(clearInterval(xe),xe=null),le){try{le.getTracks().forEach(a=>a.stop())}catch{}le=null}ee=null,ye=!1;const t=i("pos-camera-scanner-modal");t&&(!e&&typeof window.requestCloseModal=="function"?window.requestCloseModal("posCameraScanner",!1,()=>t.remove()):t.remove())},Mt=async()=>{if(ee)try{if(!(ee.getCapabilities?ee.getCapabilities():{}).torch){k("Lampu senter (torch) tidak didukung kamera ini.");return}ye=!ye,await ee.applyConstraints({advanced:[{torch:ye}]});const t=i("pos-scanner-torch-btn");t&&(ye?(t.classList.add("bg-amber-500","text-white"),t.classList.remove("bg-slate-800","text-slate-300")):(t.classList.remove("bg-amber-500","text-white"),t.classList.add("bg-slate-800","text-slate-300")))}catch(e){console.warn("Gagal toggle torch:",e)}},At=async()=>{Xe=Xe==="environment"?"user":"environment",le&&(le.getTracks().forEach(e=>e.stop()),le=null),await ga()},Ot=()=>{Ie=!Ie;const e=i("pos-scanner-mode-btn");e&&(Ie?(e.textContent="Terus-menerus",e.className="px-2.5 py-1 rounded-lg bg-emerald-950/60 border border-emerald-600/60 text-emerald-400 text-[10px] font-black tracking-wider uppercase transition-all cursor-pointer"):(e.textContent="Scan Sekali",e.className="px-2.5 py-1 rounded-lg bg-slate-800 border border-slate-700 text-slate-300 text-[10px] font-black tracking-wider uppercase transition-all cursor-pointer"))},Lt=e=>{if(!e||!e.trim())return;wa(e.trim());const t=i("pos-manual-barcode-input");t&&(t.value="")},jt=e=>{ce();const t=i("pos-search-input");t&&(t.value=e,J=e,F())};window.setPOSViewMode=dt;window.renderPOSStorefront=xa;window.renderPOS=ma;window.destroyBarcodeListener=qe;window.openPOSCartDrawer=ht;window.closePOSCartDrawer=ke;window.posSetQuickCash=vt;window.playCashierBeep=U;window.playCashierChime=Ce;window.posHoldCurrentCart=Qe;window.closePOSHoldPrompt=Ge;window.posConfirmHoldCart=ct;window.openPOSHeldModal=$e;window.closePOSHeldModal=Me;window.posRecallHeldCart=pt;window.posHoldCurrentAndRecall=ut;window.posOverwriteAndRecall=ft;window.posDeleteHeldCart=xt;window.posExecuteDeleteHeld=mt;window.renderHeldBadges=pe;window.ensureCustomersLoaded=oe;window.ensureBanksLoaded=Ae;window.lookupPosMember=Oe;window.debouncedLookupPosMember=Pt;window.selectPosMember=yt;window.resetPosMember=St;window.posSetDiscountType=Ct;window.posSetDiscountVal=Fe;window.posApplyQuickDiscount=$t;window.openPOSCameraScanner=We;window.closePOSCameraScanner=ce;window.togglePOSScannerFacing=At;window.togglePOSScannerTorch=Mt;window.togglePOSScannerMode=Ot;window.posProcessManualBarcode=Lt;window.posSearchScannedCode=jt;window.executePOSPrintDirect=Tt;window.getActiveShift=N;window.isShiftActive=se;window.syncActiveShiftFromCloud=Z;window.openPOSOpenShiftModal=R;window.closePOSOpenShiftModal=he;window.openPOSShiftModal=E;window.openPOSShiftSummaryModal=E;window.closePOSShiftSummaryModal=Ee;window.openPOSCloseShiftModal=nt;window.closePOSCloseShiftModal=Pe;window.renderShiftHeaderBadge=Te;window.printShiftSettlementReceipt=it;window.executeShiftPrintDirect=lt;const Va=Object.freeze(Object.defineProperty({__proto__:null,addToCart:Ve,addToCartWithVariant:sa,applyMemberToPos:Ne,clearCart:ia,closePOSCameraScanner:ce,closePOSCartDrawer:ke,closePOSHeldModal:Me,closePOSHoldPrompt:Ge,closePayModal:gt,debouncedLookupPosMember:Pt,destroyBarcodeListener:qe,ensureBanksLoaded:Ae,ensureCustomersLoaded:oe,executePOSPrintDirect:Tt,formatQty:O,getProductStockInfo:we,lookupPosMember:Oe,openPOSCameraScanner:We,openPOSCartDrawer:ht,openPOSHeldModal:$e,openPayModal:la,playCashierBeep:U,playCashierChime:Ce,posAddToCartQty:aa,posApplyQuickDiscount:$t,posConfirmHoldCart:ct,posDeleteHeldCart:xt,posDiscountAmount:V,posExecuteDeleteHeld:mt,posHoldCurrentAndRecall:ut,posHoldCurrentCart:Qe,posOverwriteAndRecall:ft,posProcessManualBarcode:Lt,posRecallHeldCart:pt,posSearchScannedCode:jt,posSetDiscountType:Ct,posSetDiscountVal:Fe,posSetQuickCash:vt,printPOSReceipt:ua,processPOSTx:ba,removeFromCart:Ue,renderCatalog:F,renderHeldBadges:pe,renderPOS:ma,renderPOSStorefront:xa,resetPosMember:St,selectPosMember:yt,setItemDisc:na,setPOSViewMode:dt,setPosCustomerType:ca,setPosPayMethod:wt,setQty:oa,stopClock:ea,togglePOSScannerFacing:At,togglePOSScannerMode:Ot,togglePOSScannerTorch:Mt,updatePosChange:kt,updateQty:ra},Symbol.toStringTag,{value:"Module"}));export{Va as a,qa as p,Ha as r};
