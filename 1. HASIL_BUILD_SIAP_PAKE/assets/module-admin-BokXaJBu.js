...
import{a as r,c as M,s as Qe,b as N,d as H,f as x,e as h,g as F,h as O,i as S,j as c,w as Z,k as b,l as we,t as re,m as Tt,n as Wt,o as ge,p as be,q as ue,r as oe,u as Ce,v as je,x as wt,y as At,z as Ct,A as jt,B as zt,C as Jt,D as fe,E as $,F as T,G as P,H as ce,I as Le,J as ne,K as Ie,L as de,M as De,N as Qt,O as Yt,P as J,Q as It,R as Xt,S as Zt,T as Ue,U as pe,V as ea,W as vt,X as j,Y as tt,Z as ta,_ as aa,$ as sa,a0 as ra,a1 as at,a2 as le,a3 as G,a4 as oa,a5 as la,a6 as ia}from"./module-print-BNRNvO6h.js";import{f as W}from"./vendor-firebase-core-D2OF5R23.js";import"./vendor-firebase-db-BIUZcnOd.js";const na="modulepreload",da=function(e){return"/"+e},kt={},ca=function(t,a,o){let s=Promise.resolve();if(a&&a.length>0){document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),l=n?.nonce||n?.getAttribute("nonce");s=Promise.allSettled(a.map(d=>{if(d=da(d),d in kt)return;kt[d]=!0;const p=d.endsWith(".css"),m=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${m}`))return;const u=document.createElement("link");if(u.rel=p?"stylesheet":na,p||(u.as="script"),u.crossOrigin="",u.href=d,l&&u.setAttribute("nonce",l),document.head.appendChild(u),p)return new Promise((g,w)=>{u.addEventListener("load",g),u.addEventListener("error",()=>w(new Error(`Unable to preload CSS for ${d}`)))})}))}function i(n){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=n,window.dispatchEvent(l),!l.defaultPrevented)throw n}return s.then(n=>{for(const l of n||[])l.status==="rejected"&&i(l.reason);return t().catch(i)})},pa={apiKey:"AIzaSyCOjrhMP52TGbiOyQLY92NDYE26N6d9hJM",authDomain:"restu-karya-utama.firebaseapp.com",databaseURL:"https://restu-karya-utama-default-rtdb.asia-southeast1.firebasedatabase.app",projectId:"restu-karya-utama",storageBucket:"restu-karya-utama.firebasestorage.app",messagingSenderId:"858310421352",appId:"1:858310421352:web:e20a833875e8d5c19944dd",measurementId:"G-PHDG2LJ8PM"};try{localStorage.removeItem("freshmart_fb_config")}catch{}const Dt=window.FIREBASE_CONFIG||pa;W.apps.length||W.initializeApp(Dt);const k=W.firestore(),Q=W.auth();typeof window<"u"&&(window.firebase=W,window.db=k,window.auth=Q);try{k.settings({ignoreUndefinedProperties:!0,experimentalAutoDetectLongPolling:!0,merge:!0})}catch{}let ma=null;const qs=()=>{ca(()=>import("./vendor-firebase-analytics-Jm19L5g2.js"),__vite__mapDeps([0,1])).then(()=>{try{ma=W.analytics()}catch{}}).catch(()=>{})},ba="K2ijSERTT2dg27yYGTEgn6XHSnW2",$e={emerald:{50:"#ecfdf5",100:"#d1fae5",200:"#a7f3d0",300:"#6ee7b7",400:"#34d399",500:"#10b981",600:"#059669",700:"#047857",800:"#065f46",900:"#064e3b"},teal:{50:"#f0fdfa",100:"#ccfbf1",200:"#99f6e4",300:"#5eead4",400:"#2dd4bf",500:"#14b8a6",600:"#0d9488",700:"#0f766e",800:"#115e59",900:"#134e4a"},cyan:{50:"#ecfeff",100:"#cffafe",200:"#a5f3fc",300:"#67e8f9",400:"#22d3ee",500:"#06b6d4",600:"#0891b2",700:"#0e7490",800:"#155e75",900:"#164e63"},sky:{50:"#f0f9ff",100:"#e0f2fe",200:"#bae6fd",300:"#7dd3fc",400:"#38bdf8",500:"#0ea5e9",600:"#0284c7",700:"#0369a1",800:"#075985",900:"#0c4a6e"},blue:{50:"#eff6ff",100:"#dbeafe",200:"#bfdbfe",300:"#93c5fd",400:"#60a5fa",500:"#3b82f6",600:"#2563eb",700:"#1d4ed8",800:"#1e40af",900:"#1e3a8a"},indigo:{50:"#eef2ff",100:"#e0e7ff",200:"#c7d2fe",300:"#a5b4fc",400:"#818cf8",500:"#6366f1",600:"#4f46e5",700:"#4338ca",800:"#3730a3",900:"#312e81"},violet:{50:"#f5f3ff",100:"#ede9fe",200:"#ddd6fe",300:"#c4b5fd",400:"#a78bfa",500:"#8b5cf6",600:"#7c3aed",700:"#6d28d9",800:"#5b21b6",900:"#4c1d95"},purple:{50:"#faf5ff",100:"#f3e8ff",200:"#e9d5ff",300:"#d8b4fe",400:"#c084fc",500:"#a855f7",600:"#9333ea",700:"#7e22ce",800:"#6b21a8",900:"#581c87"},fuchsia:{50:"#fdf4ff",100:"#fae8ff",200:"#f5d0fe",300:"#f0abfc",400:"#e879f9",500:"#d946ef",600:"#c026d3",700:"#a21caf",800:"#86198f",900:"#701a75"},pink:{50:"#fdf2f8",100:"#fce7f3",200:"#fbcfe8",300:"#f9a8d4",400:"#f472b6",500:"#ec4899",600:"#db2777",700:"#be185d",800:"#9d174d",900:"#831843"},rose:{50:"#fff1f2",100:"#ffe4e6",200:"#fecdd3",300:"#fda4af",400:"#fb7185",500:"#f43f5e",600:"#e11d48",700:"#be123c",800:"#9f1239",900:"#881337"},red:{50:"#fef2f2",100:"#fee2e2",200:"#fecaca",300:"#fca5a5",400:"#f87171",500:"#dc2626",600:"#b91c1c",700:"#991b1b",800:"#7f1d1d",900:"#450a0a"},orange:{50:"#fff7ed",100:"#ffedd5",200:"#fed7aa",300:"#fdba74",400:"#fb923c",500:"#ea580c",600:"#c2410c",700:"#9a3412",800:"#7c2d12",900:"#431407"},amber:{50:"#fffbeb",100:"#fef3c7",200:"#fde68a",300:"#fcd34d",400:"#fbbf24",500:"#d97706",600:"#b45309",700:"#92400e",800:"#78350f",900:"#451a03"},yellow:{50:"#fefce8",100:"#fef9c3",200:"#fef08a",300:"#fde047",400:"#eab308",500:"#d97706",600:"#b45309",700:"#854d0e",800:"#713f12",900:"#3f1d0b"},lime:{50:"#f7fee7",100:"#ecfccb",200:"#d9f99d",300:"#bef264",400:"#a3e635",500:"#65a30d",600:"#4d7c0f",700:"#3f6212",800:"#365314",900:"#1a2e05"},green:{50:"#f0fdf4",100:"#dcfce7",200:"#bbf7d0",300:"#86efac",400:"#4ade80",500:"#16a34a",600:"#15803d",700:"#166534",800:"#14532d",900:"#052e16"},slate:{50:"#f8fafc",100:"#f1f5f9",200:"#e2e8f0",300:"#cbd5e1",400:"#94a3b8",500:"#475569",600:"#334155",700:"#1e293b",800:"#0f172a",900:"#020617"},stone:{50:"#fafaf9",100:"#f5f5f4",200:"#e7e5e4",300:"#d6d3d1",400:"#a8a29e",500:"#57534e",600:"#44403c",700:"#292524",800:"#1c1917",900:"#0c0a09"}},ua=e=>{let t=parseInt(e.replace("#",""),16);return(t>>16&255)+","+(t>>8&255)+","+(t&255)},yt=(e,t)=>{let a=parseInt(e.slice(1,3),16),o=parseInt(e.slice(3,5),16),s=parseInt(e.slice(5,7),16);return a=Math.max(0,Math.min(255,a+t)),o=Math.max(0,Math.min(255,o+t)),s=Math.max(0,Math.min(255,s+t)),"#"+[a,o,s].map(i=>i.toString(16).padStart(2,"0")).join("")},fa=e=>{if(!e)return;try{document.querySelectorAll('meta[name="theme-color"]').forEach(d=>d.remove())}catch{}const t=document.createElement("meta");t.setAttribute("name","theme-color"),t.setAttribute("content",e),document.head.appendChild(t);try{document.querySelectorAll('meta[name="msapplication-navbutton-color"], meta[name="msapplication-TileColor"]').forEach(d=>d.remove())}catch{}const a=document.createElement("meta");a.setAttribute("name","msapplication-navbutton-color"),a.setAttribute("content",e),document.head.appendChild(a);const o=document.createElement("meta");o.setAttribute("name","msapplication-TileColor"),o.setAttribute("content",e),document.head.appendChild(o);let s=document.querySelector('meta[name="apple-mobile-web-app-capable"]');s||(s=document.createElement("meta"),s.setAttribute("name","apple-mobile-web-app-capable"),document.head.appendChild(s)),s.setAttribute("content","yes");let i=document.querySelector('meta[name="mobile-web-app-capable"]');i||(i=document.createElement("meta"),i.setAttribute("name","mobile-web-app-capable"),document.head.appendChild(i)),i.setAttribute("content","yes");let n=document.querySelector('meta[name="apple-mobile-web-app-status-bar-style"]');n||(n=document.createElement("meta"),n.setAttribute("name","apple-mobile-web-app-status-bar-style"),document.head.appendChild(n)),n.setAttribute("content","default"),typeof window.updatePwaManifest=="function"&&window.updatePwaManifest(e)},Pe=(e,t)=>{const a=e||localStorage.getItem("freshmart_ui_theme")||"emerald",o=$e[a]||$e.emerald;e&&localStorage.setItem("freshmart_ui_theme",a);const s=t||localStorage.getItem("freshmart_theme_color")||o[500];t&&localStorage.setItem("freshmart_theme_color",s);const i=ua(s),n=yt(s,-30),l=yt(s,150);return document.documentElement.style.setProperty("--color-primary",s),document.documentElement.style.setProperty("--color-primary-dark",n),document.documentElement.style.setProperty("--color-primary-light",l),document.documentElement.style.setProperty("--color-primary-rgb",i),fa(s),o},Ks=()=>{const e=localStorage.getItem("freshmart_theme"),t=window.matchMedia("(prefers-color-scheme: dark)").matches;(e==="dark"||!e&&t)&&document.documentElement.classList.add("dark")},Gs=()=>{const e=document.documentElement.classList.toggle("dark");localStorage.setItem("freshmart_theme",e?"dark":"light");const t=document.getElementById("icon-theme")||document.getElementById("theme-toggle-icon");t&&(t.className=e?"fa-solid fa-sun text-sm text-amber-400":"fa-solid fa-moon text-sm text-slate-600 dark:text-slate-300")},Ws=()=>{const e=document.documentElement.classList.contains("dark"),t=document.getElementById("icon-theme")||document.getElementById("theme-toggle-icon");t&&(t.className=e?"fa-solid fa-sun text-sm text-amber-400":"fa-solid fa-moon text-sm text-slate-600 dark:text-slate-300")},Te=(e="minimalist",t="")=>{const a=e||localStorage.getItem("freshmart_bg_style")||"minimalist",o=t??(localStorage.getItem("freshmart_bg_custom_url")||"");e&&localStorage.setItem("freshmart_bg_style",a),t!=null&&localStorage.setItem("freshmart_bg_custom_url",o);const i=(p=>{if(!p||typeof p!="string")return"";const m=p.match(/drive\.google\.com.*(?:id=|\/d\/)([a-zA-Z0-9_-]+)/);return m?`https://lh3.googleusercontent.com/d/${m[1]}`:p.trim()})(o);document.documentElement.setAttribute("data-bg-style",a),document.body?.setAttribute("data-bg-style",a);const n=document.getElementById("app-container");n&&(n.setAttribute("data-bg-style",a),i?n.setAttribute("data-has-custom-bg","true"):n.removeAttribute("data-has-custom-bg"));const l=document.getElementById("dynamic-bg-container");if(!l)return;if(l.innerHTML="",l.className="pointer-events-none fixed inset-0 z-0 overflow-hidden",i){const p=document.createElement("div");p.className="absolute inset-0 z-0 bg-cover bg-center bg-no-repeat bg-fixed opacity-35 dark:opacity-25 pointer-events-none transition-all duration-500",p.style.backgroundImage=`url('${i}')`,l.appendChild(p);const m=document.createElement("div");m.className="absolute inset-0 z-0 bg-slate-50/70 dark:bg-[#0b1120]/80 pointer-events-none backdrop-blur-[0.5px]",l.appendChild(m)}let d="";if(a==="hero_arch"?d=`
        ...
        </div>`}).join("")),H("cart-subtotal",x(t))},ga=(e,t)=>{let a=parseFloat(t);if(isNaN(a)||a<=0)M.splice(e,1);else{if(r.store.useStock===!0||r.store.useStock==="true"){const s=M[e],i=r.products.find(n=>n.id===s.id);if(i){const n=s.variantName?parseFloat(((i.variants||[]).find(l=>l.name===s.variantName)||{}).stock)||0:parseFloat(i.stock)||0;a>n&&(a=n,typeof window.showToast=="function"&&window.showToast(`Maks stok: ${n}`))}}M[e].qty=parseFloat(a.toFixed(2))}xe(),Y()},xa=(e,t)=>{let a=parseFloat((parseFloat(M[e].qty)+t).toFixed(2));if(a<=0)M.splice(e,1);else{if((r.store.useStock===!0||r.store.useStock==="true")&&t>0){const s=M[e],i=r.products.find(n=>n.id===s.id);if(i){const n=s.variantName?parseFloat(((i.variants||[]).find(l=>l.name===s.variantName)||{}).stock)||0:parseFloat(i.stock)||0;a>n&&(a=n,typeof window.showToast=="function"&&window.showToast(`Maks stok: ${n}`))}}M[e].qty=a}xe(),Y()},ha=e=>{M.splice(e,1),xe(),Y()},wa=()=>{typeof window.showConfirm=="function"?window.showConfirm("Kosongkan Keranjang","Semua barang akan dihapus. Lanjutkan?",()=>{Qe([]),Y(),xe(),typeof window.showToast=="function"&&window.showToast("Dibersihkan")}):(Qe([]),Y(),xe())},va=()=>{if(window.isAdm){typeof window.showConfirm=="function"&&window.showConfirm("Akses Ditolak","Anda sedang login sebagai Seller. Silakan logout terlebih dahulu untuk membuat pesanan sebagai pelanggan.",()=>{typeof window.logoutAdmin=="function"&&window.logoutAdmin()},"Logout Sekarang",!1);return}M.length&&typeof window.changeView=="function"&&window.changeView("view-checkout")};window.sanitizeCart=Be;window.updCart=Y;window.renderCart=xe;window.setCQty=ga;window.updCQty=xa;window.rmCart=ha;window.clearCart=wa;window.validateCartToCheckout=va;const _e=()=>{const e=h("wishlist-badge");e&&(e.innerText=Z.length,e.classList.toggle("scale-0",!Z.length))},ka=e=>{Z.splice(e,1),N("freshmart_wishlist",JSON.stringify(Z)),_e(),st()},ya=e=>{const t=Z[e],a=r.products?.find(n=>n.id===t.id);if(!a||a.isActive==="false"||a.isActive===!1)return b(`${t.name} sudah tidak tersedia.`);const o=t.variantName?(a.variants||[]).find(n=>n.name===t.variantName):null;if(r.store?.useStock===!0||r.store?.useStock==="true"){if(t.variantName&&(!o||o.isActive===!1||o.isActive==="false"))return b(`Varian ${t.variantName} sudah tidak tersedia.`);const n=o?parseFloat(o.stock)||0:parseFloat(a.stock)||0,l=M.find(p=>p.id===t.id&&p.variantName===t.variantName),d=l&&parseFloat(l.qty)||0;if(n<=0||d>=n)return b(`Stok ${t.name} tidak mencukupi!`)}const i=M.find(n=>n.id===t.id&&n.variantName===t.variantName);if(i)i.qty=parseFloat((i.qty+1).toFixed(2));else{const n=o&&parseFloat(o.poin)>0?parseFloat(o.poin):parseFloat(a.poin)||0;M.push({id:a.id,name:a.name,variantName:t.variantName||"",price:o?o.price:a.price,img:o?.img||a.img,qty:1,unit:a.unit||"pcs",poTime:a.poTime||"",colorCode:o?.colorCode||"",poin:n})}Y(),b("Ke Keranjang!"),typeof window.curViewName<"u"&&window.curViewName==="view-cart"&&xe()},$a=()=>{we("Hapus Favorit","Yakin ingin menghapus semua?",()=>{Z.length=0,N("freshmart_wishlist",JSON.stringify(Z)),_e(),st(),b("Dibersihkan")})},st=()=>{if(!Z.length){F("wishlist-empty-state"),O("btn-clear-wishlist"),F("spacer-wishlist"),S("wishlist-items-container","");return}O("wishlist-empty-state"),F("btn-clear-wishlist"),O("spacer-wishlist"),S("wishlist-items-container",Z.map((e,t)=>{let a=e.colorCode?`<span class="w-3.5 h-3.5 rounded-full shadow-inner border border-slate-300 dark:border-slate-600 shrink-0" style="background-color: ${c(e.colorCode)};"></span>`:"";return`
        ...
        </div>`}).join(""))};window.updWish=_e;window.rmWish=ka;window.moveWish=ya;window.clearWishlist=$a;window.renderWish=st;let $t=null;const z=()=>{const e=ue!=="Semua Produk"||oe!=="Semua Merek"||Ce!=="";re("dynamic-banners-container","hidden",e),re("reward-catalog-container","hidden",e),re("dynamic-vouchers-container","hidden",e),re("dynamic-categories-container","hidden",e),re("dynamic-brands-container","hidden",e);const t=r.store.showCategories!==!1&&r.store.showCategories!=="false",a=r.store.showBrands!==!1&&r.store.showBrands!=="false";re("sec-categories","hidden",e||!t),re("sec-brands","hidden",e||!a);let o=h("dynamic-active-filter");if(!o){let l=h("product-container");l&&(l.insertAdjacentHTML("beforebegin",'<div id="dynamic-active-filter" class="transition-all w-full"></div>'),o=h("dynamic-active-filter"))}if(o)if(e){let l="Menampilkan",d="",p="fa-filter",m="text-[var(--color-primary)] bg-[var(--color-primary-light)] dark:bg-[var(--color-primary-dark)]/30";Ce!==""?(l="Hasil Pencarian",d=`"${Ce}"`,p="fa-magnifying-glass",m="text-rose-500 bg-rose-50 dark:bg-rose-900/30"):ue!=="Semua Produk"?(l="Kategori Pilihan",d=ue,p="fa-layer-group",m="text-[var(--color-primary)] bg-[var(--color-primary-light)] dark:bg-[var(--color-primary-dark)]/30"):oe!=="Semua Merek"&&(l="Merek Pilihan",d=oe,p="fa-tag",m="text-[var(--color-primary)] bg-[var(--color-primary-light)] dark:bg-[var(--color-primary-dark)]/30"),o.innerHTML=`
        ...
        </div>`,B=`<span class="text-[9px] text-slate-600 dark:text-slate-400 font-bold ml-0.5 mb-0.5 uppercase tracking-wide">/${c(l.unit||"PCS")}</span>`;return wt==="grid"?`
                ...
                <div class="flex-1 flex flex-col p-3 sm:p-4 min-w-0 bg-white dark:bg-slate-800 relative z-10">
                    ...
                    <div class="flex items-end justify-between mt-auto pt-1">
                        <div>
                            ...
                            ${l.variants&&l.variants.length>0?"":B}
                        </div>
        ...
        `)},o=St.get(e);if(o&&Date.now()-o.timestamp<Ma){a(o.data);return}S("admin-report-container",'<div class="text-center py-10"><i class="fa-solid fa-spinner fa-spin text-2xl text-slate-300"></i></div>');let s=null;const i=new Date;if(e==="today")s=new Date(i.getFullYear(),i.getMonth(),i.getDate());else if(e==="week"){const u=i.getDay(),g=u===0?6:u-1;s=new Date(i.getFullYear(),i.getMonth(),i.getDate()-g)}else e==="month"&&(s=new Date(i.getFullYear(),i.getMonth(),1));let n=0,l=0,d=0,p=0,m=!1;try{if(!Q.currentUser){S("admin-report-container",'<div class="text-center py-10 text-slate-400"><i class="fa-solid fa-lock text-2xl mb-3"></i><p class="text-xs font-bold">Login terlebih dahulu untuk melihat laporan.</p></div>');return}let u=k.collection("freshmart_orders");s&&(u=u.where("timestamp",">=",W.firestore.Timestamp.fromDate(s)));const g=await u.limit(3e3).get();m=g.size>=3e3,g.forEach(f=>{const y=f.data();y.status!=="Dibatalkan"&&(p++,n+=parseFloat(y.payment?.subtotal)||0,d+=parseFloat(y.payment?.productDiscount)||0,(y.items||[]).forEach(C=>{const A=C.hpp!==void 0&&C.hpp!==null?parseFloat(C.hpp):typeof window.getEffHpp=="function"?window.getEffHpp(C):0;l+=(parseFloat(A)||0)*(parseFloat(C.qty)||0)}))});const w={totalPenjualan:n,totalHppTerjual:l,totalDiskonProduk:d,orderCount:p,truncated:m};St.set(e,{data:w,timestamp:Date.now()}),a(w)}catch(u){console.error("Gagal memuat laporan penjualan:",u)}},La=async()=>{const e=$("login-username"),t=$("login-password");if(!e||!t)return b("Email & Password wajib diisi!");T("Verifikasi Login...");try{if(await Q.signInWithEmailAndPassword(e,t),!Q.currentUser||Q.currentUser.uid!==ba){const a=Q.currentUser?Q.currentUser.uid:"null";throw await Q.signOut(),new Error("UID_MISMATCH: "+a)}window.isAdm=!0,history.replaceState({view:"view-admin"},"",window.location.href),typeof window.changeView=="function"&&window.changeView("view-admin",!0),Oe(),b("Login Berhasil!")}catch(a){if(console.error(a),a.message&&a.message.startsWith("UID_MISMATCH:")){const o=a.message.replace("UID_MISMATCH: ","");b("Login Ditolak: UID Anda ("+o+") tidak cocok dengan ADMIN_UID!")}else b("Login Ditolak: Email atau Password salah!")}finally{P()}},Lt=async()=>{T("Keluar...");try{await Q.signOut(),window.isAdm=!1,window.__localIsAdm=!1,window.isPro=!1,typeof window.updateProBadge=="function"&&window.updateProBadge(),ce&&(ce(),Le(null)),ne&&(ne(),Ie(null)),de&&(de(),De(null)),b("Berhasil Logout"),typeof window.changeView=="function"&&window.changeView("view-catalog")}catch{b("Gagal Logout")}finally{P()}},Ba=()=>{we("Keluar Seller","Apakah anda akan keluar dari dashboard seller?",()=>{Lt()},"Ya, Keluar")};window.checkAdminAccess=Da;window.openAdminMenu=Oe;window.toggleTaxMenuVisibility=ot;window.computeInventoryStats=Ve;window.loadAdminReport=Mt;window.processAdminLogin=La;window.logoutAdmin=Lt;window.confirmLogoutAdmin=Ba;const _a=async()=>{if(!J||J.length===0)return b("Belum ada data pesanan!");T("Menyiapkan modul Excel...");try{await It("https://cdn.sheetjs.com/xlsx-0.20.3/package/dist/xlsx.full.min.js",()=>typeof XLSX<"u")}catch{P(),b("Gagal memuat modul Excel. Cek koneksi internet Anda.");return}P();let e=[];J.forEach((i,n)=>{let l=i.dateString?new Date(i.dateString).toLocaleString("id-ID"):"-",d=i.customer?.name||"Anonim",p=i.customer?.deliveryMethod==="delivery"?"Dikirim":"Ambil di Toko",m=i.status||"-",u=i.items?i.items.reduce((w,f)=>w+(parseFloat(f.qty)||0),0):0,g=i.payment?.grandTotal||0;e.push({No:n+1,"ID Pesanan":i.orderId,Tanggal:l,"Nama Pelanggan":d,"Metode Kirim":p,Status:m,"Total Item":u,"Total Tagihan (Rp)":g})});const t=XLSX.utils.json_to_sheet(e),a=XLSX.utils.book_new();XLSX.utils.book_append_sheet(a,t,"Laporan Pesanan");const o=[{wch:5},{wch:25},{wch:22},{wch:25},{wch:15},{wch:15},{wch:12},{wch:20}];t["!cols"]=o;const s=new Date().toISOString().split("T")[0];XLSX.writeFile(a,`Laporan_Pesanan_${s}.xlsx`),b("Laporan Excel (.xlsx) berhasil diunduh!")},Ea=()=>{try{const e=new(window.AudioContext||window.webkitAudioContext),t=e.createOscillator(),a=e.createGain();t.connect(a),a.connect(e.destination),t.type="sine",t.frequency.setValueAtTime(800,e.currentTime),a.gain.setValueAtTime(1,e.currentTime),t.frequency.setValueAtTime(600,e.currentTime+.2),t.frequency.setValueAtTime(800,e.currentTime+.6),a.gain.setValueAtTime(1,e.currentTime+.6),t.frequency.setValueAtTime(600,e.currentTime+.8),a.gain.exponentialRampToValueAtTime(1e-5,e.currentTime+1.5),t.start(e.currentTime),t.stop(e.currentTime+1.5)}catch{}},Ra=()=>{S("admin-content",`
    ...
    `);const e=()=>{ce&&(ce(),Le(null));let t=!0;const a=k.collection("freshmart_orders").orderBy("timestamp","desc").limit(100).onSnapshot(o=>{if(vt([]),!t){let i=!1;o.docChanges().forEach(n=>{n.type==="added"&&n.doc.data().status==="Baru"&&(i=!0)}),i&&(b("🔔 Pesanan Baru Masuk!"),Ea())}if(t=!1,o.empty){S("admin-orders-list",'<div class="flex flex-col items-center justify-center py-20 text-slate-400 font-bold bg-white dark:bg-slate-800 rounded-[1.5rem] border border-slate-200 dark:border-slate-700 shadow-sm text-center"><i class="fa-solid fa-receipt text-5xl mb-4 opacity-30"></i>Belum ada pesanan</div>'),H("stat-orders",0);return}H("stat-orders",o.size+(o.size===100?"+":""));const s=[];S("admin-orders-list",o.docs.map(i=>{const n=i.data();s.push(n);let l="text-slate-500 border-slate-200 dark:border-slate-600",d="fa-clock",p="bg-slate-50 dark:bg-slate-700/50",m="text-slate-400";n.status==="Baru"?(l="text-rose-500 border-rose-200 bg-rose-50 dark:bg-rose-900/20 dark:border-rose-800 animate-pulse",d="fa-asterisk",p="bg-rose-500",m="text-white shadow-md shadow-rose-500/30"):n.status==="Diproses"?(l="text-[var(--color-primary)] border-[var(--color-primary)]/30 bg-[rgba(var(--color-primary-rgb),0.06)] dark:bg-[rgba(var(--color-primary-rgb),0.10)] dark:border-[var(--color-primary)]/30",d="fa-spinner fa-spin",p="primary-bg",m="shadow-sm"):n.status==="Selesai"?(l="text-[var(--color-primary)] border-[var(--color-primary)]/30 bg-[rgba(var(--color-primary-rgb),0.06)] dark:bg-[rgba(var(--color-primary-rgb),0.10)] dark:border-[var(--color-primary)]/30",d="fa-check-double",p="primary-bg-soft",m="primary-text"):n.status==="Dibatalkan"&&(l="text-slate-400 border-slate-200 bg-slate-50 dark:bg-slate-800 dark:border-slate-700",d="fa-xmark",p="bg-slate-100 dark:bg-slate-800",m="text-slate-400");let u="fa-wallet text-slate-400",g=n.payment?.method||"";g==="transfer"?u="fa-building-columns text-[var(--color-primary)]":g==="qris"?u="fa-qrcode text-purple-500":g==="cod"?u="fa-hand-holding-dollar text-[var(--color-primary)]":g==="cashier"&&(u="fa-cash-register text-amber-500");let w=n.items?parseFloat(n.items.reduce((C,A)=>C+(parseFloat(A.qty)||0),0).toFixed(2)):0;const f=n.dateString?new Date(n.dateString).toLocaleDateString("id-ID",{day:"numeric",month:"short"}):"",y=(n.orderId||"").split("-").pop();return`
        ...
        <div class="flex flex-col gap-4 text-sm pb-2">
            ...
            <div class="bg-violet-50 dark:bg-violet-900/10 p-5 sm:p-6 rounded-[1.5rem] border border-violet-200 dark:border-violet-800 shadow-sm">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex justify-between items-center"><span class="text-slate-500 dark:text-slate-400 font-bold text-xs">Status</span><span class="font-bold text-xs px-2 py-1 rounded-xl ${t.claimedReward.status==="ready"?"bg-emerald-100 text-emerald-600":t.claimedReward.status==="waiting_stock"?"bg-amber-100 text-amber-600":"bg-slate-200 text-slate-600"}">${Zt(t.claimedReward)}</span></div>
        ...
        </div>`);const o=h("admin-order-modal");o&&o.classList.contains("hidden")&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("adminOrder"),F("admin-order-modal"),setTimeout(()=>{h("admin-order-modal")&&h("admin-order-modal").classList.remove("opacity-0"),h("admin-order-modal-box")&&h("admin-order-modal-box").classList.remove("scale-95")},10)},Na=async(e,t)=>{const o=(typeof window.normalizeWA=="function"?window.normalizeWA:s=>String(s||"").replace(/\D/g,"").replace(/^0/,"62"))(t);if(!o||o.length<10)return b("Nomor WA tidak valid!");T("Menyimpan...");try{const s=k.collection("freshmart").doc("cms_data").collection("customers").doc(o),i=await s.get();i.exists?(await s.set({name:e||i.data().name},{merge:!0}),b("Data pelanggan sudah ada, nama diperbarui.")):(await s.set({id:parseInt(o,10),name:e||"-",phone:o,points:0}),b("✅ Pelanggan baru disimpan ke database!"))}catch(s){console.error("Gagal simpan pelanggan:",s),b("Gagal menyimpan data pelanggan: "+(s.message||""))}finally{P()}},Fa=async(e,t)=>{if(t==="waiting_stock"&&typeof window.customPrompt=="function"){window.customPrompt("Catatan untuk pelanggan:","Stok hadiah kosong, akan kami kirim susulan begitu stok tersedia kembali.",async o=>{if(o!==null){T("Menyimpan...");try{await k.collection("freshmart_orders").doc(e).update({"claimedReward.status":t,"claimedReward.note":o||""}),b("Status klaim hadiah diperbarui!");let s=J.findIndex(i=>i.orderId===e);s!==-1&&(J[s].claimedReward||(J[s].claimedReward={}),J[s].claimedReward.status=t,J[s].claimedReward.note=o||""),typeof window.openCustomerOrderDetail=="function"&&window.openCustomerOrderDetail(e)}catch(s){b("Gagal update klaim: "+s.message)}finally{P()}}});return}let a="";T("Menyimpan...");try{await k.collection("freshmart_orders").doc(e).update({"claimedReward.status":t,"claimedReward.note":a});const o=J.find(s=>s.orderId===e);o&&(o.claimedReward.status=t,o.claimedReward.note=a,lt(e)),b("Status hadiah diperbarui!")}catch(o){console.error("Gagal update status hadiah:",o),b("Gagal update status hadiah: "+(o.message||""))}finally{P()}},Bt=(e=!1)=>{const t=()=>{h("admin-order-modal")&&h("admin-order-modal").classList.add("opacity-0"),h("admin-order-modal-box")&&h("admin-order-modal-box").classList.add("scale-95"),setTimeout(()=>O("admin-order-modal"),300)};typeof window.requestCloseModal=="function"?window.requestCloseModal("adminOrder",e,t):t()},Oa=async(e,t)=>{if(!Ue){pe(!0),T("Update...");try{await k.collection("freshmart_orders").doc(e).update({status:t});let a=J.find(o=>o.orderId===e);a&&(a.status=t),lt(e),b("Status diupdate!")}catch{b("Gagal!")}finally{pe(!1),P()}}},Ha=async e=>{if(!e)return b("ID pesanan tidak valid!");T("Memuat data...");try{const t=await k.collection("freshmart_orders").doc(e).get();if(P(),!t.exists)return b("Data pesanan tidak ditemukan!");const a=t.data(),o=a.customer&&a.customer.wa;if(!o)return b("Nomor WhatsApp pelanggan tidak tersedia!");const s=r&&r.store&&r.store.name?r.store.name:"Toko Kami",i=a.customer&&a.customer.name?a.customer.name:"Pelanggan",n=a.status||"Baru",l=a.payment&&a.payment.grandTotal?x(a.payment.grandTotal):"-",d=a.payment&&a.payment.method?a.payment.method.toUpperCase():"-",p=`Halo *${i}*! 👋
...
Kami akan segera memproses pesanan Anda. Terima kasih! 🙏`;window.open(`https://wa.me/${o}?text=${encodeURIComponent(p)}`,"_blank")}catch{P(),b("Gagal memuat data pesanan!")}},Ua=e=>{we("Hapus Pesanan","Yakin ingin hapus permanen?",async()=>{if(!Ue){pe(!0),T("Menghapus...");try{await k.collection("freshmart_orders").doc(e).delete(),b("Terhapus!"),ea===e&&Bt()}catch{b("Gagal!")}finally{pe(!1),P()}}})};window.exportOrdersToExcel=_a;window.rAdmOrd=Ra;window.openOrderDetail=lt;window.saveOrderCustomerToDB=Na;window.ackRewardClaim=Fa;window.closeOrderDetailModal=Bt;window.updateOrderStatus=Oa;window.konfirmasiKeWA=Ha;window.deleteOrder=Ua;const Va=()=>{const e=r.store.name||"Toko Grosir",t=r.store.themeColor||"#10b981",a=(i,n,l=!1)=>{let d=document.querySelector(`meta[${l?"property":"name"}="${i}"]`);d||(d=document.createElement("meta"),l?d.setAttribute("property",i):d.setAttribute("name",i),document.head.appendChild(d)),d.setAttribute("content",n)};a("theme-color",t),a("mobile-web-app-capable","yes"),a("apple-mobile-web-app-capable","yes"),a("apple-mobile-web-app-status-bar-style","black-translucent"),a("apple-mobile-web-app-title",e),a("application-name",e),a("msapplication-TileColor",t),document.title=e,localStorage.setItem("freshmart_theme_color",t),r.store.uiTheme&&r.store.uiTheme!==localStorage.getItem("freshmart_ui_theme")&&(localStorage.setItem("freshmart_ui_theme",r.store.uiTheme),Pe(r.store.uiTheme));const o=r.store.bgStyle||localStorage.getItem("freshmart_bg_style")||"minimalist",s=r.store.bgCustomUrl!==void 0?r.store.bgCustomUrl:localStorage.getItem("freshmart_bg_custom_url")||"";Te(o,s)},_t=()=>{S("admin-content",`
    ...
    `)},qa=e=>{const t=$e[e][500],a=document.getElementById("set-ui-theme"),o=document.getElementById("set-theme-color"),s=document.getElementById("set-theme-color-picker");a&&(a.value=e),o&&(o.value=t),s&&(s.value=t),document.querySelectorAll(".preset-color-chip").forEach(l=>{l.classList.remove("ring-4","ring-offset-2","ring-slate-400","dark:ring-slate-500","scale-110"),l.querySelector(".check-icon")?.classList.add("hidden")});const i=document.getElementById(`preset-chip-${e}`);i&&(i.classList.add("ring-4","ring-offset-2","ring-slate-400","dark:ring-slate-500","scale-110"),i.querySelector(".check-icon")?.classList.remove("hidden"));const n=document.getElementById("custom-color-chip");if(n){n.style.background="";const l=n.querySelector("i");l&&(l.style.color="")}Pe(e,t)},Ka=e=>{const t=document.getElementById("set-bg-style");t&&(t.value=e);const a=document.getElementById("set-bg-custom-url")?.value||"";document.querySelectorAll(".bg-style-card").forEach(s=>{s.classList.remove("border-[var(--color-primary)]","shadow-md","ring-2","ring-[var(--color-primary)]/20"),s.classList.add("border-slate-200","dark:border-slate-700");const i=s.querySelector(".bg-icon-wrap");i&&(i.className="bg-icon-wrap w-10 h-10 rounded-xl flex items-center justify-center mb-2 text-base transition-transform bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300")});const o=document.getElementById(`bg-opt-${e}`);if(o){o.classList.add("border-[var(--color-primary)]","shadow-md","ring-2","ring-[var(--color-primary)]/20"),o.classList.remove("border-slate-200","dark:border-slate-700");const s=o.querySelector(".bg-icon-wrap");s&&(s.className="bg-icon-wrap w-10 h-10 rounded-xl flex items-center justify-center mb-2 text-base transition-transform bg-[var(--color-primary)] text-white shadow-sm")}Te(e,a)},Ga=e=>{let t,a,o,s;if(e==="profile"){t="Profil Toko & Tampilan Visual",a="fa-store",o={line:"bg-[var(--color-primary)]",box:"bg-[rgba(var(--color-primary-rgb),0.08)] text-[var(--color-primary)]"};const n=r.store.uiTheme||"emerald",l=r.store.bgStyle||localStorage.getItem("freshmart_bg_style")||"minimalist",d={emerald:"Emerald",teal:"Teal",lime:"Lime",cyan:"Cyan",sky:"Sky",blue:"Blue",indigo:"Indigo",violet:"Violet",purple:"Purple",fuchsia:"Fuchsia",pink:"Pink",rose:"Rose",red:"Red",orange:"Orange",amber:"Amber",yellow:"Yellow",green:"Green",slate:"Slate",stone:"Stone"},p=Object.keys($e).map(m=>{const u=$e[m][500],g=d[m]||m,w=n===m;return`
                <button type="button" id="preset-chip-${m}" onclick="selectPresetTheme('${m}')" 
                        ...
                        style="background-color: ${u}; border: 1.5px solid rgba(0,0,0,0.08)" 
                        title="${g}">
    ...
    `;if(S("admin-content",i),e==="profile"){const n=r.store.uiTheme||"",l=r.store.themeColor||"#10b981";(n==="custom"||!$e?.[n])&&setTimeout(()=>{const p=document.getElementById("custom-color-chip");if(p){p.style.background=l;const m=p.querySelector("i");m&&(m.style.color="#fff")}},50)}},Wa=async e=>{if(!Ue){pe(!0),T("Menyimpan...");try{e==="profile"?(r.store.name=$("set-name"),r.store.slogan=$("set-slogan"),r.store.logo=j($("set-logo")),r.store.description=$("set-description"),r.store.email=$("set-email"),r.store.showRewardCatalog=$("set-show-reward-catalog")==="true",r.store.operationalHours=$("set-hours"),r.store.footerCredit=$("set-credit"),r.store.themeColor=$("set-theme-color"),r.store.uiTheme=$("set-ui-theme"),r.store.bgStyle=$("set-bg-style")||"minimalist",r.store.bgCustomUrl=j($("set-bg-custom-url")),localStorage.setItem("freshmart_theme_color",r.store.themeColor),localStorage.setItem("freshmart_ui_theme",r.store.uiTheme),localStorage.setItem("freshmart_bg_style",r.store.bgStyle),localStorage.setItem("freshmart_bg_custom_url",r.store.bgCustomUrl||""),Pe(r.store.uiTheme,r.store.themeColor),Te(r.store.bgStyle,r.store.bgCustomUrl)):e==="catalog"?(r.store.categoryStyle=$("set-category-style"),r.store.brandStyle=$("set-brand-style"),r.store.showCategories=$("set-show-categories")==="true",r.store.showBrands=$("set-show-brands")==="true"):e==="shipping"?(r.store.wa=$("set-wa").replace(/\D/g,""),r.store.address=$("set-address"),r.store.costPerKm=$("set-cost"),r.store.isDeliveryEnabled=$("set-delivery-enabled")==="true",r.store.isPickupEnabled=$("set-pickup-enabled")==="true",r.store.lat=$("set-lat"),r.store.lng=$("set-lng")):e==="payment"?(r.payment||(r.payment={}),r.payment.qrisUrl=j($("set-qris-url"))):e==="config"?(r.config||(r.config={}),r.config.gasUrl=$("set-gas-url"),b("Pengaturan GAS URL tersimpan.")):e==="operasional"&&(r.store.useStock=$("set-use-stock")==="true",r.store.ppnEnabled=$("set-ppn-enabled")==="true",r.store.ppnType=$("set-ppn-type")||"exclusive",r.store.ppnRate=parseFloat($("set-ppn-rate"))||11,ot());const t={profile:"store",catalog:"store",shipping:"store",operasional:"store",payment:"payment",config:"config"};typeof window.saveApp=="function"&&await window.saveApp([t[e]||"store"]),e==="profile"||e==="config"?(b(e==="config"?"Sistem Diperbarui! Memuat Ulang...":"Warna Berubah! Memuat Ulang..."),setTimeout(()=>location.reload(),1500)):(b("Tersimpan!"),_t())}catch{b("Gagal menyimpan pengaturan")}finally{pe(!1),P()}}},za=()=>{const e="data:text/json;charset=utf-8,"+encodeURIComponent(JSON.stringify(r,null,2)),t=document.createElement("a");t.href=e,t.download=`backup_freshmart_${new Date().toISOString().slice(0,10)}.json`,document.body.appendChild(t),t.click(),t.remove(),b("Backup diunduh!")},Ja=e=>{const t=e.target.files[0];if(!t)return;const a=new FileReader;a.onload=async o=>{try{const s=JSON.parse(o.target.result);Object.assign(r,s),typeof window.saveApp=="function"&&await window.saveApp(),b("Data dipulihkan!"),setTimeout(()=>location.reload(),1e3)}catch{b("Gagal memulihkan data!")}},a.readAsText(t)};window.syncAppMeta=Va;window.rAdmSet=_t;window.selectPresetTheme=qa;window.selectBgStyle=Ka;window.openSettingForm=Ga;window.saveAdminSettings=Wa;window.backupData=za;window.restoreData=Ja;let E=new Date().getFullYear(),R=0,te="menu",ae=null;const se=["Jan","Feb","Mar","Apr","Mei","Jun","Jul","Agu","Sep","Okt","Nov","Des"],Qa=e=>{if(typeof window.getEffHpp=="function")return window.getEffHpp(e);const t=r.products?.find(a=>a.id===e.id);if(!t)return 0;if(e.variantName&&t.variants){const a=t.variants.find(o=>o.name===e.variantName);if(a&&a.hpp!=null)return parseFloat(a.hpp)||0}return parseFloat(t.hpp)||0},Pt=new Map,Ya=2*60*1e3,it=async e=>{const t=Pt.get(e);if(t&&Date.now()-t.timestamp<Ya)return t.data;const a={};for(let o=1;o<=12;o++)a[o]={omset:0,ppn:0,hpp:0,disc:0,orderCount:0};try{const o=new Date(e,0,1),s=new Date(e+1,0,1);(await k.collection("freshmart_orders").where("timestamp",">=",W.firestore.Timestamp.fromDate(o)).where("timestamp","<",W.firestore.Timestamp.fromDate(s)).limit(5e3).get()).forEach(l=>{const d=l.data();if(d.status==="Dibatalkan"||!d.timestamp||!d.timestamp.toDate)return;const p=d.timestamp.toDate().getMonth()+1;if(!a[p])return;const m=d.payment?.dppAmount!==void 0&&d.payment?.dppAmount!==null?parseFloat(d.payment.dppAmount):parseFloat(d.payment?.subtotal)||0;a[p].omset+=m,a[p].ppn+=parseFloat(d.payment?.ppnAmount)||0,a[p].disc+=parseFloat(d.payment?.productDiscount)||0,a[p].orderCount++,(d.items||[]).forEach(u=>{const g=u.hpp!==void 0&&u.hpp!==null?parseFloat(u.hpp):Qa(u);a[p].hpp+=(parseFloat(g)||0)*(parseFloat(u.qty)||0)})})}catch(o){console.error("Gagal memuat data pajak:",o),b("Gagal memuat data periode ini!")}return Pt.set(e,{data:a,timestamp:Date.now()}),a},Ee=()=>ae?(R===0?Object.keys(ae):[R]).reduce((t,a)=>{const o=ae[a];return t.omset+=o.omset,t.ppn+=o.ppn,t.hpp+=o.hpp,t.disc+=o.disc,t.orderCount+=o.orderCount,t},{omset:0,ppn:0,hpp:0,disc:0,orderCount:0}):{omset:0,ppn:0,hpp:0,disc:0,orderCount:0},nt=()=>{const e=r.taxSettings?.monthlyExpenses||{};return(R===0?Array.from({length:12},(a,o)=>o+1):[R]).reduce((a,o)=>a+(parseFloat(e[`${E}-${o}`])||0),0)},Xa=async()=>{S("admin-content",'<div class="text-center py-16"><i class="fa-solid fa-spinner fa-spin text-3xl text-slate-300"></i></div>'),ae=await it(E),dt()},dt=()=>{const e=Array.from({length:6},(o,s)=>new Date().getFullYear()-4+s),t=[{k:"summary",l:"Ringkasan PPN",i:"fa-receipt"},{k:"income",l:"Laba Rugi",i:"fa-chart-pie"},{k:"balance",l:"Neraca",i:"fa-scale-balanced"},{k:"settings",l:"Pengaturan",i:"fa-gear"}];te==="menu"&&(te="summary");const a=`
    <div class="mb-5 flex flex-wrap items-center justify-between gap-3 bg-white dark:bg-slate-800 p-4 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm">
        ...
        <div class="flex items-center gap-2">
            <select id="tax-year-select" onchange="changeTaxYear(this.value)" class="admin-input !py-2 !px-3 text-xs font-bold bg-slate-50 dark:bg-slate-900 text-slate-800 dark:text-slate-100 border border-slate-200 dark:border-slate-700 rounded-xl focus:border-[var(--color-primary)] cursor-pointer">
                ${e.map(o=>`<option value="${o}" ${o===E?"selected":""}>${o}</option>`).join("")}
            </select>
            <select id="tax-month-select" onchange="changeTaxMonth(this.value)" class="admin-input !py-2 !px-3 text-xs font-bold bg-slate-50 dark:bg-slate-900 text-slate-800 dark:text-slate-100 border border-slate-200 dark:border-slate-700 rounded-xl focus:border-[var(--color-primary)] cursor-pointer">
                ...
                ${se.map((o,s)=>`<option value="${s+1}" ${R===s+1?"selected":""}>${o} ${E}</option>`).join("")}
            </select>
        </div>
        `}
    </div>
    ...
    </div>`),qe()},Za=e=>{te=e,dt()},es=async e=>{E=parseInt(e,10),S("tax-content",'<div class="text-center py-16"><i class="fa-solid fa-spinner fa-spin text-3xl text-slate-300"></i></div>'),ae=await it(E),qe()},ts=e=>{R=parseInt(e,10),qe()},qe=()=>{te==="summary"?Et():te==="income"?ct():te==="balance"?pt():te==="settings"&&Rt()},Et=()=>{const e=Ee(),t=R===0?`Tahun ${E}`:`${se[R-1]} ${E}`,a=e.omset-e.disc,o=Array.from({length:12},(s,i)=>i+1).map(s=>{const i=ae?ae[s]:{omset:0,ppn:0,orderCount:0};return`<tr class="${R===s?"bg-[rgba(var(--color-primary-rgb),0.08)] dark:bg-[rgba(var(--color-primary-rgb),0.14)] font-bold":"hover:bg-slate-50 dark:hover:bg-slate-700/30"} border-b border-slate-100 dark:border-slate-700/50 last:border-0 transition-colors">
    ...
    `)},ct=()=>{const e=Ee(),t=R===0?`Tahun ${E}`:`${se[R-1]} ${E}`,a=e.omset-e.disc-e.hpp,o=R===0?null:`${E}-${R}`,s=nt(),i=a-s,n=r.taxSettings?.taxScheme||"umkm_final";let l,d,p;n==="umkm_final"?(l=.5,d=e.omset,p="PPh Final UMKM (0,5% × Omset)"):n==="badan_normal"?(l=22,d=Math.max(0,i),p="PPh Badan (22% × Laba Bersih)"):(l=parseFloat(r.taxSettings?.customTaxRate)||0,d=Math.max(0,i),p=`PPh Custom (${l}% × Laba Bersih)`);const m=d*(l/100),u=i-m;let g="";if(R===0)g=Array.from({length:12},(w,f)=>f+1).map(w=>{const f=`${E}-${w}`,y=(r.taxSettings?.monthlyExpenses||{})[f]||0;return`<div class="flex items-center justify-between gap-2 py-2 border-b border-slate-100 dark:border-slate-700/50 last:border-0">
                <span class="text-xs font-bold text-slate-600 dark:text-slate-300">${se[w-1]} ${E}</span>
            ...
            </div>`}).join("");else{const w=(r.taxSettings?.monthlyExpenses||{})[o]||0;g=`<div class="flex items-center justify-between gap-2 py-2">
            <span class="text-xs font-bold text-slate-600 dark:text-slate-300">${se[R-1]} ${E}</span>
    ...
    `)},as=async(e,t)=>{const a=parseFloat(t)||0;r.taxSettings||(r.taxSettings={}),r.taxSettings.monthlyExpenses||(r.taxSettings.monthlyExpenses={}),r.taxSettings.monthlyExpenses[e]=a;try{typeof window.saveApp=="function"&&await window.saveApp(["taxSettings"]),ct()}catch{b("Gagal menyimpan biaya operasional!")}},pt=()=>{const e=Ve(),t=r.taxSettings?.balanceSheet||{kas:0,piutang:0,hutang:0},a=(parseFloat(t.kas)||0)+(parseFloat(t.piutang)||0)+e.assetHpp,o=parseFloat(t.hutang)||0,s=a-o;S("tax-content",`
    ...
    `)},ss=async(e,t)=>{const a=parseFloat(t)||0;r.taxSettings||(r.taxSettings={}),r.taxSettings.balanceSheet||(r.taxSettings.balanceSheet={kas:0,piutang:0,hutang:0,modalDisetor:0}),r.taxSettings.balanceSheet[e]=a;try{typeof window.saveApp=="function"&&await window.saveApp(["taxSettings"]),pt()}catch{b("Gagal menyimpan data neraca!")}},Rt=()=>{const e=r.taxSettings||{};S("tax-content",`
    ...
    `)},rs=e=>{re("tax-custom-rate-wrap","hidden",e!=="custom")},os=async()=>{if(!Ue){pe(!0),T("Menyimpan...");try{r.taxSettings||(r.taxSettings={}),r.taxSettings.companyName=$("tax-company-name"),r.taxSettings.npwp=$("tax-npwp"),r.taxSettings.taxScheme=$("tax-scheme"),r.taxSettings.customTaxRate=parseFloat($("tax-custom-rate"))||.5,typeof window.saveApp=="function"&&await window.saveApp(["taxSettings"]),b("Pengaturan pajak tersimpan!")}catch{b("Gagal menyimpan pengaturan pajak!")}finally{pe(!1),P()}}},ls=e=>{const t=R===0?`Tahun ${E}`:`${se[R-1]} ${E}`,a=r.taxSettings||{},o=new Date().toLocaleDateString("id-ID",{day:"2-digit",month:"long",year:"numeric"});let s="";r.store.logo&&(r.store.logo.includes("http")||r.store.logo.includes("data:"))?s=`<img loading="eager" src="${c(r.store.logo)}" class="w-16 h-16 object-contain">`:s='<div class="w-16 h-16 bg-slate-700 text-white flex items-center justify-center rounded-xl"><i class="fa-solid fa-store text-3xl"></i></div>';const n={summary:"LAPORAN PPN & OMSET",income:"LAPORAN LABA RUGI",balance:"NERACA"}[e]||"LAPORAN";let l=`
    ...
    <div class="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-6 text-[11px] font-bold text-amber-700 leading-relaxed">
    ...
    </div>`,d="";if(e==="summary"){const m=Ee(),u=m.omset-m.disc,g=Array.from({length:12},(w,f)=>f+1).map(w=>{const f=ae?ae[w]:{omset:0,ppn:0,orderCount:0};return`<tr class="border-b border-slate-200"><td class="py-2.5 px-3 font-bold text-slate-700">${se[w-1]} ${E}</td><td class="py-2.5 px-3 text-right font-bold text-slate-700">${x(f.omset)}</td><td class="py-2.5 px-3 text-right font-bold text-slate-900">${x(f.ppn)}</td><td class="py-2.5 px-3 text-right font-bold text-slate-500">${f.orderCount}</td></tr>`}).join("");d=`
        ...
        <table class="w-full text-xs"><thead><tr class="bg-slate-100 text-left"><th class="py-2.5 px-3 font-bold text-slate-500 uppercase text-[9px]">Bulan</th><th class="py-2.5 px-3 font-bold text-slate-500 uppercase text-[9px] text-right">Omset</th><th class="py-2.5 px-3 font-bold text-slate-500 uppercase text-[9px] text-right">PPN Keluaran</th><th class="py-2.5 px-3 font-bold text-slate-500 uppercase text-[9px] text-right">Pesanan</th></tr></thead><tbody>${g}</tbody></table>`}else if(e==="income"){const m=Ee(),u=m.omset-m.disc-m.hpp,g=nt(),w=u-g,f=a.taxScheme||"umkm_final";let y,C,A;f==="umkm_final"?(y=.5,C=m.omset,A="PPh Final UMKM (0,5% × Omset)"):f==="badan_normal"?(y=22,C=Math.max(0,w),A="PPh Badan (22% × Laba Bersih)"):(y=parseFloat(a.customTaxRate)||0,C=Math.max(0,w),A=`PPh Custom (${y}% × Laba Bersih)`);const v=C*(y/100),q=w-v,L=(B,I,_,We)=>`<div class="flex justify-between py-2 ${_?"border-t-2 border-slate-800 mt-1 pt-3":"border-b border-slate-100"}"><span class="${_?"font-bold text-slate-900":"font-bold text-slate-600"}">${B}</span><span class="font-bold ${We||"text-slate-900"}">${I}</span></div>`;d=`<div class="max-w-xl">
            ...
            ${L("(−) Estimasi "+A,"-"+x(v),!1,"text-rose-600")}
            ${L("Laba Bersih Setelah Pajak (Estimasi)",x(q),!0)}
        </div>`}else if(e==="balance"){const m=Ve(),u=a.balanceSheet||{kas:0,piutang:0,hutang:0},g=(parseFloat(u.kas)||0)+(parseFloat(u.piutang)||0)+m.assetHpp,w=parseFloat(u.hutang)||0,f=g-w;d=`
        ...
        </div>`}H("doc-modal-title","Preview "+n),S("doc-paper-content",l+d);const p=h("doc-preview-modal");p&&p.classList.contains("hidden")&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("docPreview"),F("doc-preview-modal"),setTimeout(()=>{h("doc-preview-modal")&&h("doc-preview-modal").classList.remove("opacity-0"),h("doc-preview-modal-box")&&h("doc-preview-modal-box").classList.remove("scale-95"),typeof window.fitDocPreview=="function"&&window.fitDocPreview()},10)};window.fetchTaxPeriodData=it;window.getTaxPeriodTotals=Ee;window.getTaxPeriodExpenses=nt;window.rTaxPanel=Xa;window.rTaxRenderShell=dt;window.switchTaxTab=Za;window.changeTaxYear=es;window.changeTaxMonth=ts;window.rTaxSubContent=qe;window.rTaxSummary=Et;window.rTaxIncome=ct;window.saveMonthlyExpense=as;window.rTaxBalance=pt;window.saveBalanceField=ss;window.rTaxSettingsPanel=Rt;window.toggleCustomTaxRateInput=rs;window.saveTaxSettingsPanel=os;window.openTaxDocPreview=ls;window.MONTH_NAMES=se;window.editTempoPenalty=(e,t)=>{window.customPrompt("Persentase Denda Baru",t,async a=>{if(!a)return;let o=parseFloat(a.replace(",","."));if(isNaN(o)||o<0)return b("Persentase tidak valid!");T("Menyimpan...");try{await k.collection("freshmart_orders").doc(e).update({"payment.tempoPenaltyRate":o}),b("Persentase denda berhasil diubah!"),window.rAdmPiutang()}catch(s){b("Gagal mengubah denda: "+s.message)}P()})};window.stopTempoPenalty=(e,t,a)=>{let o="Konfirmasi Denda",s=a?"Lanjutkan perhitungan denda otomatis?":"Hentikan denda berjalan sekarang? (Nominal denda akan dibekukan di "+x(t)+")";we(o,s,async()=>{T("Menyimpan...");try{await k.collection("freshmart_orders").doc(e).update({"payment.tempoPenaltyStopped":!a,"payment.tempoFixedPenalty":a?null:t}),b(a?"Denda dilanjutkan!":"Denda berhasil dibekukan!"),window.rAdmPiutang()}catch(n){b("Gagal mengubah status denda: "+n.message)}P()},a?"Lanjutkan":"Bekukan")};window.payTempoInstallment=e=>{window.customPrompt("Masukkan Nominal Cicilan (Rp)","",async t=>{if(!t)return;let a=parseFloat(t.replace(/[^0-9]/g,""));if(isNaN(a)||a<=0)return b("Nominal tidak valid!");T("Menyimpan cicilan...");try{const s=(await k.collection("freshmart_orders").doc(e).get()).data();let i=(s.payment.tempoBalance||0)-a,n=s.payment.installments||[];n.push({date:Date.now(),amount:a,note:"Cicilan"});let l={"payment.tempoBalance":Math.max(0,i),"payment.installments":n};i<=0&&(l["payment.paymentStatus"]="lunas",l.status="Selesai"),await k.collection("freshmart_orders").doc(e).update(l),b("Cicilan berhasil ditambahkan!"),window.rAdmPiutang&&window.rAdmPiutang()}catch(o){b("Gagal memproses cicilan: "+o.message)}P()})};window.previewTempoReceipt=async e=>{T("Memuat data struk...");try{const t=await k.collection("freshmart_orders").doc(e).get();if(!t.exists)return P(),b("Pesanan tidak ditemukan");const a=t.data();P();const o=a.dateString?new Date(a.dateString).toLocaleString("id-ID",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}):"",s=r.store.name||"Toko",i=r.store.wa||"",n=(v,q,L=32)=>{const B=L-v.length-q.length;return v+(B>0?" ".repeat(B):" ")+q};let l=`<div class="text-center font-bold" style="font-size:13px;margin-bottom:2px;">${c(s)}</div>`;i&&(l+=`<div class="text-center" style="margin-bottom:4px;">WA: ${c(i)}</div>`),l+=`<div class="text-center font-bold uppercase my-2" style="font-size:14px;border-bottom:1px solid #000;border-top:1px solid #000;padding:2px 0;">NOTA TEMPO${a.payment?.paymentStatus==="lunas"?" - LUNAS":""}</div>`,l+=`<div style="white-space:pre;">Order: #${a.orderId}</div><div style="white-space:pre;">Tgl  : ${o}</div><div style="white-space:pre;">Plg  : ${c(a.customer?.name||"Guest").substring(0,20)}</div>`,a.payment?.tempoDueDate&&(l+=`<div style="white-space:pre;">J.Tmp: ${new Date(a.payment.tempoDueDate).toLocaleDateString("id-ID")}</div>`),l+='<div class="border-b border-dashed border-black my-2"></div>';let d=0;if(a.items.forEach(v=>{let q=v.variantName?` (${c(v.variantName)}${v.colorCode?" "+c(v.colorCode):""})`:"";const L=(c(v.name)+q+(v.poTime?" [PO]":"")).substring(0,32),B=`${parseFloat(v.qty)} ${c(v.unit||"pcs")} x ${v.effectivePrice.toLocaleString("id-ID")}`,I=(parseFloat(v.qty)*v.effectivePrice).toLocaleString("id-ID");l+=`<div style="white-space:pre-wrap;font-weight:bold;word-break:break-all;">${L}</div><div style="white-space:pre;font-size:11px;">${n(B,I)}</div>`,v.poTime&&(l+=`<div style="white-space:pre;font-size:10px;font-style:italic;color:#4b5563;">* Estimasi PO: ${c(v.poTime)}</div>`),d+=parseFloat(v.qty)*v.effectivePrice}),l+='<div class="border-b border-dashed border-black my-2"></div>',l+=`<div style="white-space:pre;font-weight:bold;">${n("Subtotal",d.toLocaleString("id-ID"))}</div>`,a.payment?.grandTotal&&a.payment.grandTotal!==d){let v=a.payment.grandTotal-d;v>0?l+=`<div style="white-space:pre;">${n("Ongkir/Biaya",v.toLocaleString("id-ID"))}</div>`:l+=`<div style="white-space:pre;">${n("Diskon",Math.abs(v).toLocaleString("id-ID"))}</div>`}l+=`<div style="white-space:pre;font-weight:bold;margin-top:4px;">${n("TOTAL KREDIT",(a.payment?.grandTotal||d).toLocaleString("id-ID"))}</div>`,l+='<div class="border-b border-black my-2" style="border-width:1px;"></div>';let p=0;a.payment?.installments&&a.payment.installments.length>0&&(l+='<div style="white-space:pre;font-weight:bold;margin-bottom:2px;">HISTORI CICILAN:</div>',a.payment.installments.forEach((v,q)=>{let L=new Date(v.date).toLocaleDateString("id-ID",{day:"2-digit",month:"short"}),B=v.amount.toLocaleString("id-ID");l+=`<div style="white-space:pre;">${n(`${q+1}. ${L}`,B)}</div>`,p+=v.amount}),l+=`<div style="white-space:pre;font-weight:bold;margin-top:2px;">${n("TOTAL DIBAYAR",p.toLocaleString("id-ID"))}</div>`,l+='<div class="border-b border-dashed border-black my-2"></div>');let m=a.payment?.tempoBalance||0,u=0,g=a.payment?.tempoPenaltyStopped===!0,w=a.payment?.tempoDueDate||0,f=a.payment?.tempoPenaltyRate!==void 0?parseFloat(a.payment.tempoPenaltyRate):1;if(a.payment?.paymentStatus!=="lunas"){if(g)u=parseFloat(a.payment?.tempoFixedPenalty)||0;else if(Date.now()>w){let v=Math.floor((Date.now()-w)/864e5);v>0&&(u=f/100*m*v)}}l+=`<div style="white-space:pre;font-weight:bold;">${n("SISA POKOK",m.toLocaleString("id-ID"))}</div>`,u>0&&(l+=`<div style="white-space:pre;">${n("DENDA",Math.round(u).toLocaleString("id-ID"))}</div>`);let y=m+u;l+='<div class="border-b border-black my-2" style="border-width:1px;"></div>',l+=`<div style="white-space:pre;font-weight:black;">${n("SISA TAGIHAN",Math.round(y).toLocaleString("id-ID"))}</div>`,a.items.some(v=>v.poTime&&v.poTime!=="")&&(l+='<div class="border-b border-dashed border-black my-2"></div><div style="white-space:pre-wrap;font-size:9px;text-align:center;line-height:1.2;font-style:italic;color:#4b5563;margin-bottom:4px;">* Catatan: Untuk pesanan gabungan, produk PO akan dikirimkan menyusul (estimasi sesuai label) tanpa dikenakan biaya tambahan.</div>'),l+='<div class="border-b border-dashed border-black my-2"></div><div class="text-center my-2" style="font-size:10px;">Terima kasih atas kepercayaannya.</div><div class="border-b border-dashed border-black my-2"></div><div style="height:20px;"></div>',S("receipt-paper-content",l);const A=h("receipt-preview-modal");A&&A.classList.contains("hidden")&&pushModalHistory("receipt"),show("receipt-preview-modal"),setTimeout(()=>{h("receipt-preview-modal").classList.remove("opacity-0"),h("receipt-preview-modal-box").classList.remove("scale-95")},10)}catch(t){P(),b("Gagal memuat struk: "+t.message)}};window.markTempoPaid=async e=>{we("Konfirmasi","Tandai tagihan tempo ini sebagai LUNAS?",async()=>{try{await k.collection("freshmart_orders").doc(e).update({"payment.paymentStatus":"lunas","payment.tempoBalance":0,status:"Selesai"}),b("Tagihan berhasil dilunasi!");let t=gOrds.findIndex(a=>a.orderId===e);t!==-1&&(gOrds[t].payment.paymentStatus="lunas",gOrds[t].payment.tempoBalance=0,gOrds[t].status="Selesai"),window.rAdmPiutang()}catch(t){b("Gagal mengubah status: "+t.message)}})};window.rAdmPiutang=async()=>{T("Memuat data piutang...");let e=[];try{(await k.collection("freshmart_orders").where("payment.method","==","tempo").where("payment.paymentStatus","==","hutang").get()).forEach(s=>{e.push(s.data())})}catch(o){P(),b("Gagal memuat piutang: "+o.message);return}P();let t=0,a=`
    ...
    `;e.length===0?a+=`<div class="bg-white dark:bg-slate-800 p-8 text-center rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm">
              ...
              </div>`:(a+='<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">',e.forEach(o=>{let s=o.payment?.tempoBalance||0,i=o.payment?.tempoPenaltyRate!==void 0?parseFloat(o.payment.tempoPenaltyRate):1,n=o.payment?.tempoPenaltyStopped===!0,l=0,d=o.payment?.tempoDueDate||0,p=0,m=!1;n?(l=parseFloat(o.payment?.tempoFixedPenalty)||0,Date.now()>d&&(p=Math.floor((Date.now()-d)/(24*60*60*1e3)),p>0&&(m=!0))):Date.now()>d&&(p=Math.floor((Date.now()-d)/(24*60*60*1e3)),p>0&&(m=!0,l=i/100*s*p));let u=s+l;t+=u;let g=window.normalizeWA?window.normalizeWA(o.customer?.wa):o.customer?.wa||"";a+=`
            <div class="bg-white dark:bg-slate-800 p-5 rounded-2xl border ${m?"border-rose-300 dark:border-rose-700 shadow-[0_0_15px_rgba(225,29,72,0.1)]":"border-slate-200 dark:border-slate-700 shadow-sm"} relative overflow-hidden group hover:-translate-y-1 transition-all">
                ...
                <div class="mb-3 space-y-1.5 bg-slate-50 dark:bg-slate-900/30 p-3 rounded-xl border border-slate-100 dark:border-slate-800">
                    <div class="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-2 flex justify-between">
                        ...
                        <span>Total: ${x(o.payment.installments.reduce((w,f)=>w+(parseFloat(f.amount)||0),0))}</span>
                    </div>
                ...
                <div class="flex gap-2 mb-2">
                    <a href="https://wa.me/${g}?text=Halo%20kak%20${c(o.customer?.name||"")},%20mengingatkan%20bahwa%20sisa%20tagihan%20Tempo%20untuk%20pesanan%20${o.orderId}%20sebesar%20${x(u)}%20sudah%20jatuh%20tempo.%20Mohon%20segera%20dilunasi." target="_blank" class="flex-1 bg-[rgba(var(--color-primary-rgb),0.06)] dark:bg-[rgba(var(--color-primary-rgb),0.10)] hover:bg-[rgba(var(--color-primary-rgb),0.12)] dark:hover:bg-[rgba(var(--color-primary-rgb),0.16)] text-[var(--color-primary)] border border-[var(--color-primary)]/25 rounded-xl py-2 flex items-center justify-center gap-1.5 text-[10px] font-bold uppercase tracking-widest transition-all">
            ...
            </div>`}),a+="</div>"),a+="</div>",S("admin-content",a),setTimeout(()=>{h("total-piutang-header")&&(h("total-piutang-header").innerText=x(t))},100)};const is=e=>{aa(e),Nt()},Nt=()=>{const e=ta||"all",t=(tt||[]).filter(i=>e==="visible"?i.isVisible!==!1:e==="hidden"?i.isVisible===!1:!0),a=`
        ...
        </div>`}).join("");S("admin-content",a+s)},ns=async e=>{const t=(tt||[]).find(a=>a.id===e);t&&typeof window.customPrompt=="function"&&window.customPrompt("Tulis balasan untuk ulasan ini:",t.adminReply||"",async a=>{T("Menyimpan balasan...");try{await k.collection("freshmart").doc("cms_data").collection("reviews").doc(e.toString()).update({adminReply:a}),b("Balasan tersimpan!")}catch{b("Gagal menyimpan balasan!")}finally{P()}})},ds=async e=>{const t=(tt||[]).find(o=>o.id===e);if(!t)return;const a=t.isVisible===!1;T("Menyimpan...");try{await k.collection("freshmart").doc("cms_data").collection("reviews").doc(e.toString()).update({isVisible:a}),b(a?"Ulasan ditampilkan lagi!":"Ulasan disembunyikan dari halaman produk!")}catch{b("Gagal mengubah status ulasan!")}finally{P()}},cs=e=>{we("Hapus Ulasan","Ulasan yang dihapus tidak bisa dikembalikan lagi.",async()=>{T("Menghapus...");try{await k.collection("freshmart").doc("cms_data").collection("reviews").doc(e.toString()).delete(),b("Ulasan dihapus!")}catch{b("Gagal menghapus ulasan!")}finally{P()}})};window.filterReviews=is;window.rAdmReviews=Nt;window.replyToReview=ns;window.toggleReviewVisibility=ds;window.deleteReview=cs;window.rAdmL=e=>{Ke(e),typeof window.setCTab=="function"&&window.setCTab(e),window.cTab=e,S("admin-content",`
    ...
    `),rAdmItms(e)};window.rAdmItms=e=>{e&&(Ke(e),typeof window.setCTab=="function"&&window.setCTab(e),window.cTab=e);const t=h("admin-list-container"),a=t?t.closest(".scroll-content"):null,o=a?a.scrollTop:0;if(e==="products"&&h("admin-product-stats")){const l=Ve();S("admin-product-stats",`
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                <div class="card-modern p-5 sm:p-5">
        ...
        <div class="p-4 sm:p-5 md:p-6 lg:p-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4 rounded-[1.5rem] border shadow-sm cursor-pointer hover:shadow-md hover:-translate-y-1 hover:border-[var(--color-primary)]/40 dark:hover:border-[var(--color-primary)]/40 transition-all duration-300 ${m}" onclick="oAEd('${e}','${l.id}')">
            <div class="flex items-start sm:items-center gap-4 min-w-0 w-full">
                ...
                <div class="min-w-0 flex flex-col justify-center py-1">
                    ...
                    ${d&&w&&C?`<p class="text-[10px] font-bold mt-1 ${(l.variants&&l.variants.length?l.variants.reduce((B,I)=>B+(parseFloat(I.stock)||0),0):parseFloat(l.stock)||0)===0?"text-rose-500 animate-pulse":"text-blue-500"}"><i class="fa-solid fa-boxes-stacked mr-1"></i>Stok: ${l.variants&&l.variants.length?l.variants.reduce((B,I)=>B+(parseFloat(I.stock)||0),0).toFixed(2).replace(/\.?0+$/,""):parseFloat(l.stock)||0}</p>`:""}
                    ${d&&w&&l.hpp?`<p class="text-[10px] font-bold text-amber-500 mt-0.5"><i class="fa-solid fa-coins mr-1"></i>HPP: ${x(l.hpp)}</p>`:""}
                    ${d?(()=>{const B=l.variants&&l.variants.length?l.variants.reduce((I,_)=>I+(parseFloat(_.totalSold)||0),0):parseFloat(l.totalSold)||0;return B>0?`<p class="text-[10px] font-bold text-orange-400 mt-0.5"><i class="fa-solid fa-fire-flame-curved mr-1"></i>Terjual: ${B}</p>`:""})():""}
          ...
          <div class="grid grid-cols-2 gap-4 md:contents">
            ...
            <div class="flex flex-col items-start text-left md:col-span-3 lg:col-span-2">
              ...
              <ul class="space-y-2.5 w-full text-xs font-semibold text-white/85">
                ...
                <li><a class="flex items-center gap-1.5 hover:text-white transition-colors cursor-pointer" onclick="if(typeof window.openChangelogModal==='function') window.openChangelogModal();"><i class="fa-solid fa-clock-rotate-left text-[9px] text-[var(--color-primary)]"></i> Log Pembaruan &amp; Versi</a></li>
    ...
    `},xs=()=>{let e=document.getElementById("guarantee-modal");e||(e=document.createElement("div"),e.id="guarantee-modal",e.className="fixed inset-0 z-[115] bg-slate-900/70 backdrop-blur-sm flex items-end sm:items-center justify-center p-0 sm:p-5",e.onclick=t=>{t.target===e&&Ot()},document.body.appendChild(e)),e.innerHTML=`
        ...
        </div>`,e.style.opacity="0",e.style.display="flex",requestAnimationFrame(()=>{e.style.transition="opacity 0.25s ease",e.style.opacity="1"})},Ot=()=>{const e=document.getElementById("guarantee-modal");!e||e.style.display==="none"||(e.style.opacity="0",e.style.transition="opacity 0.25s ease",setTimeout(()=>{e.style.display="none",e.style.opacity="",e.style.transition=""},250))},hs=()=>{let e=document.getElementById("security-modal");e||(e=document.createElement("div"),e.id="security-modal",e.className="fixed inset-0 z-[115] bg-slate-900/70 backdrop-blur-sm flex items-end sm:items-center justify-center p-0 sm:p-5",e.onclick=t=>{t.target===e&&Ht()},document.body.appendChild(e)),e.innerHTML=`
        <div class="bg-white dark:bg-slate-900 w-full max-w-md rounded-t-[2rem] sm:rounded-[2rem] p-6 shadow-2xl border border-slate-200 dark:border-slate-700 space-y-4">
            <div class="flex justify-between items-center border-b border-slate-100 dark:border-slate-800 pb-4">
                <h3 class="font-bold text-slate-800 dark:text-white text-base flex items-center gap-2">
        ...
        </div>`,e.style.opacity="0",e.style.display="flex",requestAnimationFrame(()=>{e.style.transition="opacity 0.25s ease",e.style.opacity="1"})},Ht=()=>{const e=document.getElementById("security-modal");!e||e.style.display==="none"||(e.style.opacity="0",e.style.transition="opacity 0.25s ease",setTimeout(()=>{e.style.display="none",e.style.opacity="",e.style.transition=""},250))};window.renderStorefrontFooter=Ft;window.openQualityGuaranteeModal=xs;window.closeQualityGuaranteeModal=Ot;window.openSecurityModal=hs;window.closeSecurityModal=Ht;const he=()=>{if(Ft(),H("dyn-store-name",r.store.name||"Toko Putri"),H("dyn-store-slogan",r.store.slogan||r.store.tagline||r.store.desc||r.store.description||"Toko Online & Kasir Resmi"),r.store.logo){const n=h("dyn-store-logo-img"),l=h("dyn-store-logo-icon");r.store.logo.includes("http")||r.store.logo.includes("data:")?n&&(n.src=r.store.logo,n.onerror=()=>{n.onerror=null,n.src="https://placehold.co/100?text=Logo"},F("dyn-store-logo-img"),O("dyn-store-logo-icon")):l&&(l.className=`fa-solid ${c(r.store.logo)} text-xl text-[var(--color-primary)]`,F("dyn-store-logo-icon"),O("dyn-store-logo-img"))}let e=r.banners&&r.banners.length?`
    <div class="relative group/banner-wrapper w-full">
        <div id="banner-slider" class="flex overflow-x-auto gap-4 sm:gap-6 pb-4 pt-2 snap-x hide-scrollbar scroll-smooth" ontouchstart="clearInterval(window.bannerTmr)" ontouchend="setTimeout(() => window.startBannerAutoSlide?.(), 8000)" onmouseenter="clearInterval(window.bannerTmr)" onmouseleave="window.startBannerAutoSlide?.()" onscroll="window.onBannerScroll && window.onBannerScroll()">
            ${r.banners.map((n,l)=>{const d=n.type==="video"&&n.videoUrl,p=!d&&n.link?`onclick="window.open('${c(n.link)}', '_self')"`:"";if(d){const m=sa(n.videoUrl)||{type:"direct",directUrl:at(n.videoUrl),embedUrl:ra(n.videoUrl)};let u="";return m.type==="youtube"?u=`
                <iframe
        ...
        `:""}
    </div>`:"";S("dynamic-banners-container",e),setTimeout(Ne,500);const t=(r.vouchers||[]).filter(n=>n.isShow==="true"||n.isShow===!0),a=h("dynamic-vouchers-container");if(t.length>0&&a){a.classList.remove("hidden");let n=`
        ...
        <div class="flex gap-2.5 sm:gap-3 overflow-x-auto hide-scrollbar snap-x pb-3 pt-1">
            ${t.map(l=>{let d=l.type==="shipping_free"?"Gratis Ongkir":l.type==="percent"?`Diskon ${c(String(parseFloat(l.value)||0))}%`:`Diskon ${x(l.value)}`,p=[];l.minPurchase>0&&p.push(`Min. Blj ${x(l.minPurchase)}`),l.maxDiscount>0&&p.push(`Maks. ptg ${x(l.maxDiscount)}`),l.targetProduct&&p.push("Produk Khusus");let m=p.length>0?c(p.join(" • ")):"Tanpa min. belanja";return`
        ...
        </div>`;a.innerHTML=n}else a&&(a.classList.add("hidden"),a.innerHTML="");const o=[...r.categories||[]];S("dynamic-categories-container",o.map(n=>{const l=ue===n.name,d=decodeURIComponent(encodeURIComponent(n.name).replace(/'/g,"%27"));if(r.store.categoryStyle==="text"||!r.store.categoryStyle)return`<div onclick="filterCategory('${d}')" class="cursor-pointer shrink-0 snap-start group py-0.5"><div class="px-3.5 py-1.5 rounded-xl border transition-all duration-200 flex items-center gap-2 ${l?"bg-[var(--color-primary)] border-transparent text-white shadow-xs":"bg-slate-50 dark:bg-slate-800/90 border-slate-200/80 dark:border-slate-700 text-slate-700 dark:text-slate-300 hover:border-[var(--color-primary)]/50 hover:bg-white dark:hover:bg-slate-800"}"><div class="w-5 h-5 rounded-md flex items-center justify-center ${l?"bg-white/20 text-white":"bg-white dark:bg-slate-700 text-slate-400 group-hover:text-[var(--color-primary)]"} transition-colors"><i class="fa-solid fa-layer-group text-[9px]"></i></div><span class="font-bold text-[10px] sm:text-[11px] uppercase tracking-wider">${c(n.name)}</span></div></div>`;{const p=n.img&&!n.img.includes("10b981")?ge(n.img,"w150-rw"):"https://placehold.co/150/f1f5f9/64748b?text=Cat";return`<div onclick="filterCategory('${d}')" class="flex flex-col items-center gap-1.5 cursor-pointer shrink-0 w-[64px] sm:w-[72px] group snap-start py-0.5"><div class="relative w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-slate-50 dark:bg-slate-800 flex items-center justify-center p-1.5 transition-all duration-200 ${l?"bg-[var(--color-primary-light)] border-2 border-[var(--color-primary)] shadow-xs dark:bg-[var(--color-primary-dark)]/20":"border border-slate-200 dark:border-slate-700 shadow-2xs group-hover:border-[var(--color-primary)] group-hover:-translate-y-0.5"} overflow-hidden"><img loading="lazy" src="${c(p)}" alt="${c(n.name)}" onerror="this.onerror=null;this.src='https://placehold.co/150/f1f5f9/64748b?text=Cat'" class="w-full h-full object-cover rounded-lg transition-transform duration-300 group-hover:scale-105"></div><span class="text-[8.5px] sm:text-[9px] text-center w-full line-clamp-1 leading-tight px-0.5 ${l?"font-bold text-[var(--color-primary)]":"font-semibold text-slate-600 dark:text-slate-300 group-hover:text-[var(--color-primary)]"} uppercase tracking-wider transition-colors">${c(n.name)}</span></div>`}}).join(""));const s=[...r.brands||[]],i=[{name:"Semua Merek",img:r.store.allBrandsIcon&&!r.store.allBrandsIcon.includes("10b981")?r.store.allBrandsIcon:"https://placehold.co/150/f1f5f9/475569?text=Semua+Merek"},...r.brands||[]];S("dynamic-brands-container",s.map(n=>{const l=oe===n.name,d=decodeURIComponent(encodeURIComponent(n.name).replace(/'/g,"%27"));if(r.store.brandStyle==="text")return`<div onclick="filterBrand('${d}')" class="cursor-pointer shrink-0 snap-start group py-0.5"><div class="px-3.5 py-1.5 rounded-xl border transition-all duration-200 flex items-center gap-2 ${l?"bg-[var(--color-primary)] border-transparent text-white shadow-xs":"bg-slate-50 dark:bg-slate-800/90 border-slate-200/80 dark:border-slate-700 text-slate-700 dark:text-slate-300 hover:border-[var(--color-primary)]/50 hover:bg-white dark:hover:bg-slate-800"}"><div class="w-5 h-5 rounded-md flex items-center justify-center ${l?"bg-white/20 text-white":"bg-white dark:bg-slate-700 text-slate-400 group-hover:text-[var(--color-primary)]"} transition-colors"><i class="fa-solid fa-copyright text-[9px]"></i></div><span class="font-bold text-[10px] sm:text-[11px] uppercase tracking-wider">${c(n.name)}</span></div></div>`;{const p=n.img&&!n.img.includes("10b981")?ge(n.img,"w150-rw"):"https://placehold.co/150/f1f5f9/64748b?text=Brand";return`<div onclick="filterBrand('${d}')" class="flex flex-col items-center gap-1.5 cursor-pointer shrink-0 w-[64px] sm:w-[72px] group snap-start py-0.5"><div class="relative w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-white flex items-center justify-center overflow-hidden p-1.5 transition-all duration-200 ${l?"ring-2 ring-[var(--color-primary)] ring-offset-1 ring-offset-slate-50 dark:ring-offset-slate-800 shadow-xs":"border border-slate-200 dark:border-slate-700 shadow-2xs group-hover:border-[var(--color-primary)]/50 group-hover:-translate-y-0.5"}"><img loading="lazy" src="${c(p)}" alt="${c(n.name)}" onerror="this.onerror=null;this.src='https://placehold.co/150/f1f5f9/64748b?text=Brand'" class="w-full h-full object-contain transition-transform duration-300 group-hover:scale-105"></div><span class="text-[8.5px] sm:text-[9px] text-center w-full line-clamp-1 leading-tight px-0.5 ${l?"font-bold text-[var(--color-primary)]":"font-semibold text-slate-600 dark:text-slate-300 group-hover:text-[var(--color-primary)]"} uppercase tracking-wider transition-colors">${c(n.name)}</span></div>`}}).join("")),S("modal-brand-grid",i.map(n=>{const l=oe===n.name,d=decodeURIComponent(encodeURIComponent(n.name).replace(/'/g,"%27")),p=n.img&&!n.img.includes("10b981")?ge(n.img,"w150-rw"):"https://placehold.co/150/f1f5f9/64748b?text=Brand";return`<button onclick="filterBrand('${d}'); closeBrandModal();" class="flex flex-col items-center gap-3 p-4 rounded-2xl border ${l?"border-[var(--color-primary)] bg-[rgba(var(--color-primary-rgb),0.07)] dark:bg-[rgba(var(--color-primary-rgb),0.12)] shadow-sm":"border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 hover:border-[var(--color-primary)]/40 hover:shadow-sm"} transition-all active:scale-[0.96]"><div class="w-14 h-14 rounded-2xl flex items-center justify-center bg-white border border-slate-100 dark:border-slate-600 shadow-inner overflow-hidden p-1.5"><img loading="lazy" src="${c(p)}" alt="${c(n.name)}" class="w-full h-full object-contain" onerror="this.src='https://placehold.co/150/f1f5f9/64748b?text=Brand'"></div> <span class="text-[10px] sm:text-xs font-bold ${l?"text-[var(--color-primary)]":"text-slate-700 dark:text-slate-300"} text-center leading-tight line-clamp-2 uppercase tracking-widest">${c(n.name)}</span></button>`}).join("")),h("dyn-qris-img")&&r.payment&&(h("dyn-qris-img").src=r.payment.qrisUrl),typeof window.renderRewardCatalog=="function"&&window.renderRewardCatalog(),typeof window.applyBackgroundStyle=="function"&&window.applyBackgroundStyle(r.store.bgStyle,r.store.bgCustomUrl),be(1),z()};window.rDyn=he;const ws=async()=>{if(document.documentElement.classList.contains("dark")){const f=h("icon-theme");f&&(f.className="fa-solid fa-sun text-sm text-amber-500")}const e=()=>{r.products=r.products||[],r.categories=r.categories||[],r.brands=r.brands||[],r.vouchers=r.vouchers||[],r.changelog=r.changelog||[],r.products.forEach(f=>{f.img&&(f.img=j(f.img)),f.variants&&f.variants.forEach(y=>{y.img&&(y.img=j(y.img))})}),r.banners&&r.banners.forEach(f=>{f.img&&(f.img=j(f.img)),f.videoUrl&&(f.videoUrl=at(f.videoUrl))}),r.categories&&r.categories.forEach(f=>{f.img&&(f.img=j(f.img),f.img.includes("10b981")&&(f.img="https://placehold.co/150/f1f5f9/64748b?text=Cat"))}),r.brands&&r.brands.forEach(f=>{f.img&&(f.img=j(f.img),f.img.includes("10b981")&&(f.img="https://placehold.co/150/f1f5f9/64748b?text=Brand"))}),r.store.logo&&(r.store.logo=j(r.store.logo)),r.store.allProductsIcon&&(r.store.allProductsIcon=j(r.store.allProductsIcon)),r.store.allBrandsIcon&&(r.store.allBrandsIcon=j(r.store.allBrandsIcon),r.store.allBrandsIcon.includes("10b981")&&(r.store.allBrandsIcon="https://placehold.co/150/f1f5f9/475569?text=Semua+Merek")),r.payment.qrisUrl&&(r.payment.qrisUrl=j(r.payment.qrisUrl)),M.forEach(f=>{f.img&&(f.img=j(f.img))}),Z.forEach(f=>{f.img&&(f.img=j(f.img))})},t=Dt?.projectId||"default",a=le("freshmart_active_project");if(a&&a!==t)try{localStorage.removeItem("freshmart_cms_data"),localStorage.removeItem("freshmart_products"),localStorage.removeItem("freshmart_rewards"),localStorage.removeItem("freshmart_last_update"),localStorage.removeItem("freshmart_cart"),localStorage.removeItem("freshmart_wishlist")}catch{}N("freshmart_active_project",t);let o=JSON.parse(le("freshmart_cms_data")||"null"),s=JSON.parse(le("freshmart_products")||"null"),i=JSON.parse(le("freshmart_rewards")||"null");parseInt(le("freshmart_last_update")||"0");let n=!1;if(o?(Object.assign(r,G,o),r.store={...G.store,...o.store||{}},r.payment={...G.payment,...o.payment||{}},r.config={...G.config,...o.config||{}},r.config&&r.config.gasUrl&&(window.GAS_UPLOAD_URL=r.config.gasUrl),s&&(r.products=s),i&&(r.rewards=i),e(),r.store&&(Pe(r.store.uiTheme,r.store.themeColor),Te(r.store.bgStyle,r.store.bgCustomUrl)),Be(),Y(),_e(),he(),z(),H("stat-products",r.products.filter(f=>f.isActive!=="false"&&f.isActive!==!1).length),P(),n=!0):T("Memuat Toko..."),!n)try{const f=await k.collection("freshmart").doc("cms_data").get();if(f.exists){const y=f.data(),C=y.lastUpdate||0;N("freshmart_cms_data",JSON.stringify(y)),Object.assign(r,G,y),r.store={...G.store,...y.store||{}},r.payment={...G.payment,...y.payment||{}},r.config={...G.config,...y.config||{}},r.config&&r.config.gasUrl&&(window.GAS_UPLOAD_URL=r.config.gasUrl);const A=await k.collection("freshmart").doc("cms_data").collection("products").get();r.products=A.docs.map(v=>v.data()).sort((v,q)=>(q.id||0)-(v.id||0)),N("freshmart_products",JSON.stringify(r.products)),N("freshmart_last_update",C.toString()),e(),r.store&&(Pe(r.store.uiTheme,r.store.themeColor),Te(r.store.bgStyle,r.store.bgCustomUrl)),Be(),Y(),_e(),he(),z(),H("stat-products",r.products.filter(v=>v.isActive!=="false"&&v.isActive!==!1).length)}}catch{b("Mode Offline (Data Lokal)")}finally{P()}H("stat-products",r.products.filter(f=>f.isActive!=="false"&&f.isActive!==!1).length);const l=h("loader-store-name"),d=h("loader-tagline");l&&(l.textContent=(r.store.name||"").toUpperCase()),d&&(d.textContent=r.store.tagline||r.store.desc||r.store.address||"");const p=h("loader-logo-icon"),m=h("loader-logo-img"),u=r.store.logo&&r.store.logo!=="fa-store"?r.store.logo:"";u&&(p&&(p.style.display="none"),m&&(m.src=u,m.style.display="block")),ut(),window.injectJSONLD("seo-website",{"@context":"https://schema.org","@type":"WebSite",name:"Toko Putri",url:window.location.origin}),window.injectJSONLD("seo-localbusiness",{"@context":"https://schema.org","@type":"HardwareStore",name:"Toko Putri",image:ge(r.store.logo,"w300-rw"),description:"Solusi grosir dan e-commerce terpercaya untuk alat teknik, perkakas, dan perlengkapan pertukangan berkualitas.",url:window.location.origin,telephone:r.store.phone||"",address:{"@type":"PostalAddress",streetAddress:r.store.address||"",addressCountry:"ID"}});const w=new URLSearchParams(window.location.search).get("p");if(w&&r.products.find(f=>f.id==parseInt(w))){const f=new URLSearchParams(window.location.search);f.delete("p");let y=window.location.pathname;f.toString()&&(y+="?"+f.toString()),window.history.replaceState({},document.title,y),setTimeout(()=>openProductModal(parseInt(w)),600)}P()},U=async(e=null,t=null)=>{try{if(Array.isArray(e)){const o={lastUpdate:W.firestore.FieldValue.increment(1),updateType:t?.updateType||(e.length?"settings_change":"full"),changedKeys:e};t?.updatedProductIds&&Array.isArray(t.updatedProductIds)?o.updatedProductIds=t.updatedProductIds:o.updatedProductIds=W.firestore.FieldValue.delete(),e.forEach(s=>{s&&(o[s]=r[s])}),await k.collection("freshmart").doc("cms_data").set(o,{merge:!0})}else{const o={...r};delete o.products,delete o.auth,o.lastUpdate=W.firestore.FieldValue.increment(1),o.updateType="full",await k.collection("freshmart").doc("cms_data").set(o)}r.lastUpdate=(parseInt(le("freshmart_last_update"))||r.lastUpdate||0)+1;const a={...r};delete a.products,delete a.auth,N("freshmart_cms_data",JSON.stringify(a)),N("freshmart_last_update",r.lastUpdate.toString()),N("freshmart_products",JSON.stringify(r.products))}catch{b("Tersimpan secara Lokal")}};let Je=!1,ie=null,Xe=typeof document<"u"?document.hidden:!1,Ze=!1,ke=!1;typeof document<"u"&&document.addEventListener("visibilitychange",()=>{if(Xe=document.hidden,!Xe&&Ze&&ie){Ze=!1;const e=ie;ie=null,typeof window._doSyncCmsData=="function"&&window._doSyncCmsData(e)}});const et=e=>{if(!e)return e;const t={...e};return t.id==null&&(t.id=0),typeof t.id=="string"&&!isNaN(t.id)&&(t.id=Number(t.id)),t.img&&(t.img=j(t.img)),t.variants&&t.variants.forEach(a=>{a.img&&(a.img=j(a.img))}),t},He=()=>{if(H("stat-products",r.products.filter(a=>a.isActive!=="false"&&a.isActive!==!1).length),Be(),Y(),typeof he=="function"?he():typeof window.rDyn=="function"&&window.rDyn(),typeof z=="function"?z():typeof window.rCat=="function"&&window.rCat(),document.getElementById("admin-list-container")&&typeof window.rAdmItms=="function"){const a=window.cTab||"products";["products","colors"].includes(a)&&window.rAdmItms(a)}const t=window.cProd;if(t){const a=r.products.find(o=>o.id===t.id);if(a&&(window.cProd=a,typeof window.rProdMod=="function")){const o=document.getElementById("product-modal");o&&!o.classList.contains("hidden")&&!o.classList.contains("opacity-0")&&window.rProdMod()}}},vs=()=>{if(window.unsubCmsRealtime)return;const e=async t=>{if(!t.exists)return;const a=t.data(),o=a.lastUpdate||0,s=parseInt(le("freshmart_last_update")||"0");if(Xe){ie=t,Ze=!0;return}if(!(o===s&&o>0&&ke&&r.products&&r.products.length>0)){Je=!0;try{const i=a.updateType||"full",n=Array.isArray(a.updatedProductIds)?a.updatedProductIds.map(String):[];if(r.store={...G.store,...a.store||{}},a.categories&&(r.categories=a.categories),a.vouchers&&(r.vouchers=a.vouchers),a.banners&&(r.banners=a.banners),a.brands&&(r.brands=a.brands),a.banks&&(r.banks=a.banks),a.faqs&&(r.faqs=a.faqs),r.payment={...G.payment,...a.payment||{}},r.config={...G.config,...a.config||{}},r.taxSettings={...G.taxSettings,...a.taxSettings||{}},r.config&&r.config.gasUrl&&(window.GAS_UPLOAD_URL=r.config.gasUrl),r.banners&&r.banners.forEach(d=>{d.img&&(d.img=j(d.img)),d.videoUrl&&(d.videoUrl=at(d.videoUrl))}),r.categories&&r.categories.forEach(d=>{d.img&&(d.img=j(d.img),d.img.includes("10b981")&&(d.img="https://placehold.co/150/f1f5f9/64748b?text=Cat"))}),r.brands&&r.brands.forEach(d=>{d.img&&(d.img=j(d.img),d.img.includes("10b981")&&(d.img="https://placehold.co/150/f1f5f9/64748b?text=Brand"))}),i==="product_delete"&&n.length>0)n.forEach(d=>{const p=r.products.findIndex(m=>(m.id!=null?m.id.toString():"")===d);p>-1&&r.products.splice(p,1)}),N("freshmart_products",JSON.stringify(r.products)),ke=!0,He();else if(!ke&&(!r.products||r.products.length===0)){const d=await k.collection("freshmart").doc("cms_data").collection("products").get();r.products=d.docs.map(p=>et(p.data())).sort((p,m)=>(m.id||0)-(p.id||0)),N("freshmart_products",JSON.stringify(r.products)),ke=!0,He()}else ke=!0;if(N("freshmart_cms_data",JSON.stringify(a)),N("freshmart_last_update",o.toString()),r.store&&(Pe(r.store.uiTheme,r.store.themeColor),Te(r.store.bgStyle,r.store.bgCustomUrl)),ut(),H("stat-products",r.products.filter(d=>d.isActive!=="false"&&d.isActive!==!1).length),typeof he=="function"?he():typeof window.rDyn=="function"&&window.rDyn(),typeof z=="function"?z():typeof window.rCat=="function"&&window.rCat(),Be(),Y(),(window.isAdm||window.__localIsAdm)&&typeof window.rAdmItms=="function"){const d=window.cTab||"products";["categories","vouchers","banners","brands","banks","colors"].includes(d)&&window.rAdmItms(d)}}catch(i){console.error("Gagal sinkron realtime settings:",i)}finally{if(Je=!1,ie){const i=ie;ie=null,e(i)}}}};window._doSyncCmsData=e,window.unsubCmsRealtime=k.collection("freshmart").doc("cms_data").onSnapshot(async t=>{if(Je){ie=t;return}await e(t)},t=>{console.warn("Realtime listener error:",t)})},ks=()=>{if(window.unsubProductsRealtime)return;let e=!0;window.unsubProductsRealtime=k.collection("freshmart").doc("cms_data").collection("products").onSnapshot(t=>{if(e){e=!1,ke=!0,r.products=t.docs.map(o=>et(o.data())).sort((o,s)=>(s.id||0)-(o.id||0)),N("freshmart_products",JSON.stringify(r.products)),He();return}let a=!1;t.docChanges().forEach(o=>{const s=et(o.doc.data()),i=o.doc.id;if(o.type==="added"||o.type==="modified"){const n=r.products.findIndex(l=>(l.id!=null?l.id.toString():"")===i);n>-1?r.products[n]=s:(r.products.unshift(s),r.products.sort((l,d)=>(d.id||0)-(l.id||0))),a=!0}else if(o.type==="removed"){const n=r.products.findIndex(l=>(l.id!=null?l.id.toString():"")===i);n>-1&&(r.products.splice(n,1),a=!0)}}),a&&(N("freshmart_products",JSON.stringify(r.products)),He())},t=>{console.warn("Realtime products listener error:",t)})},ys=()=>{if(!window.unsubRewardsRealtime){if(!r.rewards||!r.rewards.length)try{const e=JSON.parse(le("freshmart_rewards")||"null");e&&Array.isArray(e)&&(r.rewards=e,r.rewards.forEach(t=>{t.img&&(t.img=j(t.img))}))}catch{}window.unsubRewardsRealtime=k.collection("freshmart").doc("cms_data").collection("rewards").onSnapshot(e=>{r.rewards=e.docs.map(a=>a.data()).sort((a,o)=>(o.id||0)-(a.id||0)),r.rewards.forEach(a=>{a.img&&(a.img=j(a.img))}),N("freshmart_rewards",JSON.stringify(r.rewards)),window.isAdm&&window.cTab==="rewards"&&typeof window.rAdmItms=="function"&&window.rAdmItms("rewards"),typeof window.renderRewardCatalog=="function"&&window.renderRewardCatalog();const t=document.getElementById("member-modal");t&&t.style.display==="flex"&&currentMember&&typeof window.rMemberModalBody=="function"&&window.rMemberModalBody()},e=>{console.warn("Realtime hadiah gagal:",e)})}},ut=e=>{try{const t=r.store?.name||"Toko Putri",a=r.store?.logo||"",o=/^(https?:|data:)/i.test(a)?a:"https://placehold.co/192x192?text=Logo",s=document.documentElement.classList.contains("dark")?"#0b1120":"#ffffff",i=e||r.store?.themeColor||localStorage.getItem("freshmart_theme_color")||"#10b981";let n=document.getElementById("dynamic-manifest");n||(n=document.createElement("link"),n.id="dynamic-manifest",n.rel="manifest",document.head.appendChild(n));let l=document.getElementById("dynamic-apple-icon");l||(l=document.createElement("link"),l.id="dynamic-apple-icon",l.rel="apple-touch-icon",document.head.appendChild(l)),l.href=o;let d=document.getElementById("dynamic-favicon");d||(d=document.createElement("link"),d.id="dynamic-favicon",d.rel="icon",document.head.appendChild(d)),d.href=o;const p={id:window.location.origin+"/",name:t,short_name:t,description:r.store?.slogan||t+" - Belanja online lebih mudah",start_url:window.location.origin+"/",scope:window.location.origin+"/",lang:"id",dir:"ltr",display:"standalone",display_override:["standalone","minimal-ui"],orientation:"portrait",categories:["shopping","business"],background_color:s,theme_color:i,icons:[{src:o,sizes:"192x192",type:"image/png",purpose:"any"},{src:o,sizes:"512x512",type:"image/png",purpose:"any"}]};if(n.dataset.blobUrl)try{URL.revokeObjectURL(n.dataset.blobUrl)}catch{}const m=URL.createObjectURL(new Blob([JSON.stringify(p)],{type:"application/manifest+json"}));n.dataset.blobUrl=m,n.href=m}catch(t){console.error("PWA Manifest Update Error: ",t)}};window.loadAppData=ws;window.saveApp=U;window.attachRealtimeStockSync=vs;window.attachRealtimeProductsSync=ks;window.attachRewardsRealtime=ys;window.updatePwaManifest=ut;function $s(e){if(!e)return"";const t=e.match(/\/d\/([a-zA-Z0-9_-]+)/);return t?`https://drive.google.com/file/d/${t[1]}/preview`:e}const Ss=e=>window.pushModalHistory?.(e);window.oAAdd=()=>{window.oAEd(ft||window.cTab||"products",null)};window.oAEd=(e,t)=>{Ke(e),typeof window.setCTab=="function"&&window.setCTab(e),window.cTab=e,qt(t),typeof window.setEId=="function"&&window.setEId(t),window.eId=t;let a=t?(r[e]||[]).find(p=>p.id===t):null;H("admin-modal-title",t?"Edit Data":"Tambah Data");let o=rt[e]||[],s="";e==="products"&&(Ge(a&&a.variants?JSON.parse(JSON.stringify(a.variants)):[]),gt(a&&a.wholesale?JSON.parse(JSON.stringify(a.wholesale)):[]),xt(a&&a.specTable?JSON.parse(JSON.stringify(a.specTable)):[]));const i=["textarea","richtext","variants_builder","wholesale_builder","spec_table_builder"],n=["img","desc","name","isActive","tag","poTime","video"],l=p=>i.includes(p.type)||n.includes(p.key);o.forEach(p=>{let m=a?p.type==="number"&&a[p.key]!==void 0?a[p.key]:a[p.key]||"":"";const u=l(p)?"lg:col-span-2":"";s+=`<div class="flex flex-col gap-1.5 ${u}"><label class="block text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest flex items-center gap-1.5">${p.label}</label>`,p.type==="textarea"?s+=`<textarea autocomplete='off' id="af-${p.key}" class="admin-input resize-none shadow-sm bg-slate-50 dark:bg-slate-900" rows="3">${c(m)}</textarea>`:p.type==="select"?(s+=`<div class="relative"><select id="af-${p.key}" class="admin-input shadow-sm cursor-pointer appearance-none pr-10 bg-slate-50 dark:bg-slate-900" onchange="if(window.rVarsB) window.rVarsB();">`,p.options.forEach(g=>{s+=`<option value="${g.val}" ${m==g.val||m==="true"&&g.val==="true"||m==="false"&&g.val==="false"?"selected":""} class="font-bold">${g.text}</option>`}),s+='</select><i class="fa-solid fa-chevron-down absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 pointer-events-none text-[10px]"></i></div>'):p.type==="dynamic_select_category"?(s+=`<div class="relative"><select id="af-${p.key}" class="admin-input shadow-sm cursor-pointer appearance-none pr-10 bg-slate-50 dark:bg-slate-900" onchange="if(window.rVarsB) window.rVarsB();"><option value="" class="font-bold">Pilih Kategori</option>`,r.categories.forEach(g=>{s+=`<option value="${c(g.name)}" ${m===g.name?"selected":""} class="font-bold">${c(g.name)}</option>`}),s+='</select><i class="fa-solid fa-chevron-down absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 pointer-events-none text-[10px]"></i></div>'):p.type==="dynamic_select_brand"?(s+=`<div class="relative"><select id="af-${p.key}" class="admin-input shadow-sm cursor-pointer appearance-none pr-10 bg-slate-50 dark:bg-slate-900" onchange="if(window.rVarsB) window.rVarsB();"><option value="" class="font-bold">Tanpa Merek</option>`,(r.brands||[]).forEach(g=>{s+=`<option value="${c(g.name)}" ${m===g.name?"selected":""} class="font-bold">${c(g.name)}</option>`}),s+='</select><i class="fa-solid fa-chevron-down absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 pointer-events-none text-[10px]"></i></div>'):p.type==="dynamic_select_products"?(s+=`<div class="relative"><select id="af-${p.key}" class="admin-input shadow-sm cursor-pointer appearance-none pr-10 bg-slate-50 dark:bg-slate-900" onchange="if(window.rVarsB) window.rVarsB();"><option value="" class="font-bold primary-text">-- Semua Produk (Tanpa Batasan) --</option>`,(r.products||[]).forEach(g=>{s+=`<option value="${g.id}" ${m==g.id?"selected":""} class="font-bold">${c(g.name)}</option>`}),s+='</select><i class="fa-solid fa-chevron-down absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 pointer-events-none text-[10px]"></i></div>'):p.type==="variants_builder"?s+='<div id="variants-builder-container" class="bg-slate-50/50 dark:bg-slate-900/30 p-4 sm:p-5 md:p-6 lg:p-8 lg:p-6 rounded-[1.5rem] border border-slate-200 dark:border-slate-700 shadow-inner min-h-[60px]"></div>':p.type==="wholesale_builder"?s+='<div id="wholesale-builder-container" class="bg-slate-50/50 dark:bg-slate-900/30 p-4 sm:p-5 md:p-6 lg:p-8 lg:p-6 rounded-[1.5rem] border border-slate-200 dark:border-slate-700 shadow-inner min-h-[60px]"></div>':p.type==="spec_table_builder"?s+='<div id="spec-table-builder-container" class="bg-slate-50/50 dark:bg-slate-900/30 p-4 sm:p-5 md:p-6 rounded-[1.5rem] border border-slate-200 dark:border-slate-700 shadow-inner min-h-[60px]"></div>':p.key==="sku"?s+=`<div class="relative flex items-center"><input autocomplete='off' type="${p.type}" id="af-${p.key}" value="${c(m)}" class="admin-input shadow-sm bg-slate-50 dark:bg-slate-900 !pr-12" placeholder="Scan atau ketik..." ><button type="button" onclick="openCameraScanner('af-${p.key}')" class="absolute right-2 w-9 h-9 flex items-center justify-center text-slate-400 hover:bg-slate-200 hover:text-[var(--color-primary)] rounded-xl transition-all" title="Scan Barcode via HP"><i class="fa-solid fa-qrcode text-lg"></i></button></div>`:p.key==="img"?s+=`<div class="flex gap-3"><input autocomplete='off' type="text" id="af-${p.key}" value="${c(m)}" class="admin-input shadow-sm flex-1 bg-slate-50 dark:bg-slate-900" placeholder="URL Gambar" ><label class="primary-bg-soft border primary-border text-[var(--color-primary)] font-bold rounded-xl px-5 flex items-center justify-center cursor-pointer hover:bg-[rgba(var(--color-primary-rgb),0.2)] transition-all shrink-0 active:scale-95 shadow-sm" title="Upload dari Galeri"><i class="fa-solid fa-cloud-arrow-up sm:mr-2"></i><span class="hidden sm:inline">Upload</span><input type="file" accept="image/*" class="hidden" onchange="handleImageUpload(this, 'af-${p.key}')" ></label><label class="bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 text-blue-600 dark:text-blue-400 font-bold rounded-xl px-5 flex items-center justify-center cursor-pointer hover:bg-blue-100 transition-all shrink-0 active:scale-95 shadow-sm" title="Ambil Foto Langsung"><i class="fa-solid fa-camera"></i><input type="file" accept="image/*" capture="environment" class="hidden" onchange="handleImageUpload(this, 'af-${p.key}')" ></label></div>`:p.key==="videoUrl"?s+=`<div class="flex flex-col gap-2">
                <div class="flex gap-3">
                ...
                ${m?`<div class="rounded-xl overflow-hidden border border-slate-200 dark:border-slate-700 bg-black aspect-video w-full max-w-xs"><iframe src="${c($s(m))}" class="w-full h-full" frameborder="0" allow="autoplay; fullscreen" loading="lazy"></iframe></div>`:""}
...
>`,s+="</div>"}),s=`<div class="grid grid-cols-1 lg:grid-cols-2 gap-x-5 gap-y-5 items-start">${s}</div>`,S("admin-modal-form",s),e==="products"&&(window.rVarsB?.(),window.rWholB?.(),window.rSpecB?.());const d=h("admin-modal");d&&d.classList.contains("hidden")&&Ss("admin"),F("admin-modal"),setTimeout(()=>{h("admin-modal").classList.remove("opacity-0"),h("admin-modal-box").classList.remove("scale-95")},10)};window.submitAdminForm=async()=>{if(ve)return;D(!0);const e=ft||window.cTab||"products";let t={},a=rt[e]||[];for(let s of a)if(s.type==="variants_builder")t.variants=K.filter(i=>i.name.trim()!=="");else if(s.type==="wholesale_builder")t.wholesale=me.filter(i=>parseFloat(i.minQty)>.01&&i.price>0);else if(s.type==="spec_table_builder")t.specTable=ee.filter(i=>i.key.trim()!=="");else{let i="";if(s.type==="richtext"){const n=h(`af-${s.key}-editor`);i=n?n.innerHTML:""}else i=$(`af-${s.key}`);if(typeof i=="string"){if(i.startsWith("data:image/")&&i.length>3e5)return D(!1),b("Gambar Base64 terlalu besar! Upload file.");s.key==="img"&&(i=j(i))}t[s.key]=s.type==="number"?parseFloat(i)||0:i}if(!t.name&&!t.title&&!t.bankName&&!t.code)return D(!1),b("Judul/Nama/Kode wajib diisi!");if(e==="products"&&!t.sku&&(t.sku="SKU"+Date.now().toString().slice(-6)),e==="customers"){const s=window.normalizeWA?window.normalizeWA(t.phone):(t.phone||"").replace(/\D/g,"").replace(/^0/,"62");if(!s||s.length<10)return D(!1),b("Nomor WhatsApp tidak valid!");t.phone=s,t.points=parseFloat(t.points)||0,t.id=parseInt(s,10)}let o=null;if(e==="customers")if(r.customers||(r.customers=[]),X){o=X;let s=r.customers.findIndex(i=>i.id===X);s>-1?r.customers[s]=t:r.customers.unshift(t)}else r.customers.unshift(t);else if(e==="rewards")if(r.rewards||(r.rewards=[]),X){t.id=X;let s=r.rewards.findIndex(i=>i.id===X);s>-1&&(r.rewards[s]=t)}else t.id=Date.now(),r.rewards.unshift(t);else if(X){t.id=X,r[e]||(r[e]=[]);let s=r[e].findIndex(i=>i.id===X);if(e==="products"&&s>-1){const i=r[e][s];t.totalSold=i.totalSold||0,t.variants&&t.variants.length&&i.variants&&t.variants.forEach(n=>{const l=i.variants.find(d=>d.name===n.name);l&&l.totalSold&&(n.totalSold=l.totalSold)})}s>-1&&(r[e][s]=t)}else t.id=Date.now(),r[e]||(r[e]=[]),r[e].unshift(t);T("Menyimpan...");try{const s=typeof k<"u"&&k?k:window.db,i=typeof U=="function"?U:window.saveApp||(async()=>{});if(!s)throw new Error("Database Firebase belum terhubung");if(e==="products")await s.collection("freshmart").doc("cms_data").collection("products").doc(t.id.toString()).set(t),await i([],{updateType:"product_single",updatedProductIds:[t.id.toString()]});else if(e==="customers"){const n=s.collection("freshmart").doc("cms_data").collection("customers");o!==null&&o!==t.id&&await n.doc(o.toString()).delete().catch(()=>{}),await n.doc(t.phone).set(t,{merge:!0})}else e==="rewards"?await s.collection("freshmart").doc("cms_data").collection("rewards").doc(t.id.toString()).set(t):await i([e]);window.closeAdminModal?.(),window.rAdmItms?.(e),b("Tersimpan!")}catch(s){console.error("Gagal simpan admin data:",s),b("Gagal menyimpan: "+(s.message||""))}finally{D(!1),P()}};window.oADel=async(e,t)=>{window.showConfirm?.("Hapus Data","Data yang dihapus tidak bisa dikembalikan lagi.",async()=>{if(ve)return;D(!0);const a=typeof k<"u"&&k?k:window.db,o=typeof U=="function"?U:window.saveApp||(async()=>{}),s=r[e]&&r[e].find(i=>i.id===t);r[e]=r[e].filter(i=>i.id!==t),T("Menghapus...");try{if(!a)throw new Error("Database Firebase belum terhubung");if(e==="products")await a.collection("freshmart").doc("cms_data").collection("products").doc(t.toString()).delete(),await o([],{updateType:"product_delete",updatedProductIds:[t.toString()]});else if(e==="customers"){const i=s?s.phone:t.toString();await a.collection("freshmart").doc("cms_data").collection("customers").doc(i).delete()}else e==="rewards"?await a.collection("freshmart").doc("cms_data").collection("rewards").doc(t.toString()).delete():await o([e]);window.rAdmItms?.(e),b("Berhasil Dihapus!")}catch(i){b("Gagal menghapus: "+(i.message||""))}finally{D(!1),P()}})};window.duplicateProduct=async e=>{window.showConfirm?.("Duplikat Produk","Menyalin data produk ini ke item baru?",async()=>{if(ve)return;D(!0);const t=typeof k<"u"&&k?k:window.db,a=typeof U=="function"?U:window.saveApp||(async()=>{}),o=r.products.find(i=>i.id===e);if(!o){D(!1);return}let s=JSON.parse(JSON.stringify(o));s.id=Date.now()+Math.floor(Math.random()*1e3),s.name=s.name+" COPY",s.sku="",s.totalSold=0,s.variants&&s.variants.length>0&&(s.variants=s.variants.map(i=>(i.sku="",i.totalSold=0,i))),r.products.unshift(s),T("Menyalin...");try{if(!t)throw new Error("Database Firebase belum terhubung");await t.collection("freshmart").doc("cms_data").collection("products").doc(s.id.toString()).set(s),await a([],{updateType:"product_single",updatedProductIds:[s.id.toString()]}),window.rAdmItms?.("products"),b("Produk berhasil disalin!")}catch(i){b("Gagal menyalin: "+(i.message||""))}finally{D(!1),P()}},"Ya, Salin",!1)};window.rSpecB=()=>{const e=document.getElementById("spec-table-builder-container");if(!e)return;let t="";ee.length>0?t+=`<div class="overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm mb-4">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-4">
        ...
        </div>`;a+="</div></div>",_openColorFloatModal(a)};window.importColorToVariant=(e,t)=>{K.push({name:e,price:0,priceNormal:0,hpp:0,stock:0,sku:"",img:"",unit:"",colorCode:t||"",poin:0,isActive:!0}),Ge(K),window.rVarsB(),_closeColorFloatModal(),b("Warna ditambahkan!")};window.exportVariantToColorDB=async e=>{const t=K[e];if(!t||!t.name.trim()){b("Nama varian kosong!");return}if((r.colors||[]).find(i=>i.name.toLowerCase()===t.name.trim().toLowerCase())){b(`"${t.name}" sudah ada di Database Warna.`);return}let s=[...new Set((r.colors||[]).map(i=>i.catalog).filter(Boolean))].map(i=>`<option value="${c(i)}">${c(i)}</option>`).join("");_openColorFloatModal(`
        <div class="p-6">
        ...
        </div>`)};window.confirmExportAllVariants=async()=>{const e=(document.getElementById("expall-catalog")?.value||"").trim(),t=K.filter(s=>s.name.trim());r.colors||(r.colors=[]);const a=new Set(r.colors.map(s=>s.name.toLowerCase()));let o=0;if(t.forEach(s=>{a.has(s.name.trim().toLowerCase())||(r.colors.push({id:Date.now()+o,name:s.name.trim(),hex:s.colorCode||"",catalog:e}),a.add(s.name.trim().toLowerCase()),o++)}),_closeColorFloatModal(),!o){b("Semua varian sudah ada di Database Warna!");return}T("Menyimpan...");try{await U(["colors"]),b(`${o} warna berhasil diekspor ke Database Warna! 🎨`)}catch{b("Gagal menyimpan!")}finally{P()}};window.openImportFromProductsModal=async()=>{const e=[];if((r.products||[]).forEach(i=>{(i.variants||[]).forEach(n=>{n.name&&n.name.trim()&&e.push({varName:n.name.trim(),hex:n.colorCode||"",prodName:i.name||""})})}),!e.length){b("Tidak ada varian produk yang ditemukan!");return}const t=new Set((r.colors||[]).map(i=>i.name.toLowerCase())),a=e.filter(i=>!t.has(i.varName.toLowerCase()));if(!a.length){b("Semua varian produk sudah ada di Database Warna!");return}let s=[...new Set((r.colors||[]).map(i=>i.catalog).filter(Boolean))].map(i=>`<option value="${c(i)}">${c(i)}</option>`).join("");window._pendingImportVariants=a,_openColorFloatModal(`
        <div class="p-6">
        ...
        </div>`)};window.confirmImportFromProducts=async()=>{const e=window._pendingImportVariants||[];window._pendingImportVariants=null;const t=(document.getElementById("impprod-catalog")?.value||"").trim();r.colors||(r.colors=[]);const a=new Set(r.colors.map(s=>s.name.toLowerCase()));let o=0;if(e.forEach((s,i)=>{const n=document.getElementById(`imp-chk-${i}`);n&&n.checked&&!a.has(s.varName.toLowerCase())&&(r.colors.push({id:Date.now()+o,name:s.varName,hex:s.hex||"",catalog:t}),a.add(s.varName.toLowerCase()),o++)}),_closeColorFloatModal(),!o){b("Tidak ada warna baru yang ditambahkan!");return}T("Menyimpan...");try{await U(["colors"]),b(`${o} warna berhasil diimpor ke Database Warna! 🎨`),window.cTab==="colors"&&window.rAdmItms?.("colors")}catch{b("Gagal menyimpan!")}finally{P()}};const Ps=e=>window.pushModalHistory?.(e),Ut=(e,t,a)=>window.requestCloseModal?.(e,t,a);window.openRestockModal=e=>{const t=r.products.find(i=>i.id===e);if(!t)return;const a=t.variants&&t.variants.length>0;let o="";a?o=t.variants.map((i,n)=>`
        ...
        </div>`,s.style.opacity="0",s.style.display="flex",requestAnimationFrame(()=>{s.style.transition="opacity 0.25s ease",s.style.opacity="1"}),Ps("restock")};window.closeRestockModal=(e=!1)=>{Ut("restock",e,()=>{const t=document.getElementById("restock-modal");!t||t.style.display==="none"||(t.style.opacity="0",t.style.transition="opacity 0.25s ease",setTimeout(()=>{t.style.display="none",t.style.opacity="",t.style.transition=""},250))})};window.processRestock=async e=>{if(ve)return;D(!0);const t=r.products.findIndex(n=>n.id===e);if(t<0){D(!1);return}const a=r.products[t],o=a.variants&&a.variants.length>0;let s=JSON.parse(JSON.stringify(a)),i=0;if(o)s.variants=s.variants.map((l,d)=>{const p=parseFloat(document.getElementById("restock-var-"+d)?.value)||0;return p>0&&(l.stock=(parseFloat(l.stock)||0)+p,i+=p,l.stock>0&&(l.isActive===!1||l.isActive==="false")&&(l.isActive=!0)),l}),s.variants.some(l=>(parseFloat(l.stock)||0)>0&&l.isActive!==!1&&l.isActive!=="false")&&(s.isActive===!1||s.isActive==="false")&&(s.isActive="true");else{const n=parseFloat(document.getElementById("restock-main")?.value)||0;n>0&&(s.stock=(parseFloat(s.stock)||0)+n,i+=n,s.stock>0&&(s.isActive===!1||s.isActive==="false")&&(s.isActive="true"))}if(i<=0)return D(!1),b("Masukkan jumlah restock terlebih dahulu!");T("Menyimpan Restock...");try{const n=typeof k<"u"&&k?k:window.db,l=typeof U=="function"?U:window.saveApp||(async()=>{});if(!n)throw new Error("Database Firebase belum terhubung");const d=n.collection("freshmart").doc("cms_data").collection("products").doc(e.toString());let p=0;await n.runTransaction(async m=>{const u=await m.get(d);if(!u.exists)throw new Error("Produk tidak ditemukan di server");const g=JSON.parse(JSON.stringify(u.data()));if(o)a.variants.forEach((f,y)=>{const C=parseFloat(document.getElementById("restock-var-"+y)?.value)||0;if(C<=0)return;const A=(g.variants||[]).findIndex(v=>v.name===f.name);A>-1&&(g.variants[A].stock=(parseFloat(g.variants[A].stock)||0)+C,g.variants[A].stock>0&&(g.variants[A].isActive===!1||g.variants[A].isActive==="false")&&(g.variants[A].isActive=!0))}),g.variants.some(f=>(parseFloat(f.stock)||0)>0&&f.isActive!==!1&&f.isActive!=="false")&&(g.isActive===!1||g.isActive==="false")&&(g.isActive="true"),p=g.variants.reduce((f,y)=>f+(parseFloat(y.stock)||0),0);else{const w=parseFloat(document.getElementById("restock-main")?.value)||0;g.stock=(parseFloat(g.stock)||0)+w,g.stock>0&&(g.isActive===!1||g.isActive==="false")&&(g.isActive="true"),p=g.stock}m.set(d,g),Object.assign(s,g)}),r.products[t]=s,await l([],{updateType:"stock_change",updatedProductIds:[e.toString()]}),closeRestockModal(),window.rAdmItms?.("products"),H("stat-products",r.products.filter(m=>m.isActive!=="false"&&m.isActive!==!1).length),b(`✅ Restock +${i} berhasil! Total stok: ${p}`)}catch(n){b("Gagal restock: "+(n.message||""))}finally{D(!1),P()}};window.toggleProductStatus=async(e,t)=>{if(ve)return;D(!0);const a=r.products.findIndex(o=>o.id!=null&&o.id.toString()===e.toString());if(a>-1){r.products[a].isActive=t?"true":"false",T(t?"Mengaktifkan...":"Menonaktifkan...");try{const o=typeof k<"u"&&k?k:window.db,s=typeof U=="function"?U:window.saveApp||(async()=>{});if(!o)throw new Error("Database Firebase belum terhubung");await o.collection("freshmart").doc("cms_data").collection("products").doc(e.toString()).update({isActive:t?"true":"false"}),await s([],{updateType:"stock_change",updatedProductIds:[e.toString()]}),H("stat-products",r.products.filter(i=>i.isActive!=="false"&&i.isActive!==!1).length),window.rAdmItms?.("products"),b(t?"Produk Aktif!":"Stok Dikosongkan!")}catch(o){b("Gagal update status: "+(o.message||""))}finally{D(!1),P()}}else D(!1)};window.closeAdminModal=(e=!1)=>{Ut("admin",e,()=>{h("admin-modal").classList.add("opacity-0"),h("admin-modal-box").classList.add("scale-95"),setTimeout(()=>O("admin-modal"),300)})};const Ts=e=>window.pushModalHistory?.(e),As=(e,t,a)=>window.requestCloseModal?.(e,t,a);let V;window.openCameraScanner=async(e="search-input")=>{const t=h("scanner-modal");t&&t.classList.contains("hidden")&&Ts("scanner"),F("scanner-modal"),setTimeout(()=>{h("scanner-modal").classList.remove("opacity-0")},10);try{await It("https://cdnjs.cloudflare.com/ajax/libs/html5-qrcode/2.3.8/html5-qrcode.min.js",()=>typeof Html5Qrcode<"u")}catch{b("Gagal memuat modul kamera. Cek koneksi internet Anda."),closeCameraScanner();return}V||(V=new Html5Qrcode("reader"));const a={fps:10,qrbox:{width:250,height:250}};setTimeout(()=>{V&&V.start({facingMode:"environment"},a,o=>{let s=h(e);s&&(s.value=o,e==="search-input"?window.handleSearch?.(o):(s.dispatchEvent(new Event("input",{bubbles:!0})),s.dispatchEvent(new Event("change",{bubbles:!0})))),b("Barcode discan!"),closeCameraScanner()},o=>{}).catch(o=>{b("Akses kamera ditolak/gagal!"),closeCameraScanner()})},100)};window.closeCameraScanner=(e=!1)=>{As("scanner",e,()=>{if(h("scanner-modal").classList.add("opacity-0"),V)try{V.getState()===2||V.getState()===3?V.stop().then(()=>{V.clear(),V=null}).catch(t=>{V.clear(),V=null}):(V.clear(),V=null)}catch{V=null}setTimeout(()=>O("scanner-modal"),300)})};const Cs=e=>window.pushModalHistory?.(e),js=(e,t,a)=>window.requestCloseModal?.(e,t,a);let Re=[];window.openQuickPriceModal=e=>{const t=r.products.find(i=>i.id===e);if(!t)return;const a=t.variants&&t.variants.length>0;Re=!a&&t.wholesale?JSON.parse(JSON.stringify(t.wholesale)):[];let o="";a?o=t.variants.map((i,n)=>`
        ...
        </div>`,a||rQpWhol(),s.style.opacity="0",s.style.display="flex",requestAnimationFrame(()=>{s.style.transition="opacity 0.25s ease",s.style.opacity="1"}),Cs("quickprice")};window.rQpWhol=()=>{S("qp-whol-container",Re.length?Re.map((e,t)=>`
        <div class="flex items-center gap-2">
        ...
        </div>`).join(""):'<p class="text-[11px] font-bold text-slate-400 text-center py-2">Belum ada tingkat harga grosir.</p>')};window.qpAddWhol=()=>{Re.push({minQty:0,price:0}),rQpWhol()};window.closeQuickPriceModal=(e=!1)=>{js("quickprice",e,()=>{const t=document.getElementById("quickprice-modal");!t||t.style.display==="none"||(t.style.opacity="0",t.style.transition="opacity 0.25s ease",setTimeout(()=>{t.style.display="none",t.style.opacity="",t.style.transition=""},250))})};window.processQuickPrice=async e=>{if(ve)return;D(!0);const t=r.products.findIndex(s=>s.id===e);if(t<0){D(!1);return}const a=r.products[t],o=a.variants&&a.variants.length>0;T("Menyimpan Harga...");try{const s=typeof k<"u"&&k?k:window.db,i=typeof U=="function"?U:window.saveApp||(async()=>{});if(!s)throw new Error("Database Firebase belum terhubung");const n=s.collection("freshmart").doc("cms_data").collection("products").doc(e.toString());let l=null;await s.runTransaction(async d=>{const p=await d.get(n);if(!p.exists)throw new Error("Produk tidak ditemukan di server");const m=JSON.parse(JSON.stringify(p.data()));o?a.variants.forEach((u,g)=>{const w=(m.variants||[]).findIndex(f=>f.name===u.name);w<0||(m.variants[w].hpp=parseFloat(document.getElementById("qp-var-hpp-"+g)?.value)||0,m.variants[w].price=parseFloat(document.getElementById("qp-var-price-"+g)?.value)||0,m.variants[w].priceNormal=parseFloat(document.getElementById("qp-var-normal-"+g)?.value)||0,m.variants[w].poin=parseFloat(document.getElementById("qp-var-poin-"+g)?.value)||0)}):(m.hpp=parseFloat(document.getElementById("qp-hpp")?.value)||0,m.price=parseFloat(document.getElementById("qp-price")?.value)||0,m.priceNormal=parseFloat(document.getElementById("qp-normal")?.value)||0,m.poin=parseFloat(document.getElementById("qp-poin")?.value)||0,m.wholesale=Re.filter(u=>parseFloat(u.minQty)>.01&&u.price>0)),d.set(n,m),l=m}),r.products[t]=l,await i([],{updateType:"stock_change",updatedProductIds:[e.toString()]}),closeQuickPriceModal(),window.rAdmItms?.("products"),b("✅ Harga berhasil diperbarui!")}catch(s){b("Gagal simpan harga: "+(s.message||""))}finally{D(!1),P()}};window.rWholB=()=>{let e=`<div class="space-y-4 mb-4">${me.map((a,o)=>`
        ...
        <button onclick="addWhol()" class="w-full py-4 bg-amber-50 dark:bg-amber-900/20 text-amber-600 font-bold rounded-[1.5rem] text-sm border-2 border-amber-200 border-dashed hover:bg-amber-100 transition-all flex items-center justify-center gap-2 active:scale-95 shadow-sm"><i class="fa-solid fa-tags"></i> Tambah Tingkatan Grosir</button>`;const t=document.getElementById("wholesale-builder-container");t&&(t.innerHTML=e)};window.addWhol=()=>{me.push({minQty:2,price:0}),gt(me),window.rWholB()};window.rmWhol=e=>{me.splice(e,1),gt(me),window.rWholB()};window.uWhol=(e,t,a)=>{me[e][t]=parseFloat(a)||0};let ft="products";const Ke=e=>{ft=e,window.cTab=e};let Vt="";const Is=e=>{Vt=e,window.aSq=e};let X=null;const qt=e=>{X=e,window.eId=e};let ve=!1;const D=e=>{ve=e};let K=[];const Ge=e=>{K=e};let me=[];const gt=e=>{me=e};let ee=[];const xt=e=>{ee=e};window.setCTab=Ke;window.setASq=Is;window.setEId=qt;const Ds=(e,t=!1)=>{const a=document.querySelector("#view-admin .scroll-content");if(a&&(a.scrollTop=0),la(e),ia(""),!t){const s=history.state;s&&s.view==="view-admin"&&s.tab?history.replaceState({view:"view-admin",tab:e},"",window.location.href):history.pushState({view:"view-admin",tab:e},"",window.location.href)}if(O("admin-dashboard-view"),F("admin-content-view"),F("btn-admin-back"),O("admin-logo-box"),H("admin-header-title",{orders:"Pesanan",settings:"Toko",products:"Produk",categories:"Kategori",brands:"Merek",banks:"Rekening",banners:"Banner",vouchers:"Voucher",customers:"Database Pelanggan",rewards:"Program Hadiah",reviews:"Ulasan Pelanggan",faqs:"Tanya Jawab / Q&A",tax:"Pajak & Keuangan",piutang:"Piutang Tempo",colors:"Database Warna",changelog:"Log Pembaruan Sistem"}[e]||"CMS"),e!=="orders"&&ce&&(ce(),Le(null)),e!=="customers"&&ne&&(ne(),Ie(null)),e!=="reviews"&&de&&(de(),De(null)),e==="settings")typeof window.rAdmSet=="function"&&window.rAdmSet();else if(e==="orders")typeof window.rAdmOrd=="function"&&window.rAdmOrd();else if(e==="tax")typeof window.rTaxPanel=="function"&&window.rTaxPanel();else if(e==="piutang")typeof window.rAdmPiutang=="function"&&window.rAdmPiutang();else if(e==="customers"){S("admin-content",'<div class="text-center py-16"><i class="fa-solid fa-spinner fa-spin text-3xl text-slate-300"></i></div>'),ne&&(ne(),Ie(null));const s=k.collection("freshmart").doc("cms_data").collection("customers").onSnapshot(i=>{r.customers=i.docs.map(n=>n.data()),typeof window.rAdmL=="function"&&window.rAdmL("customers")},()=>{b("Gagal memuat data pelanggan!"),typeof window.rAdmL=="function"&&window.rAdmL("customers")});Ie(s)}else if(e==="reviews"){S("admin-content",'<div class="text-center py-16"><i class="fa-solid fa-spinner fa-spin text-3xl text-slate-300"></i></div>'),de&&(de(),De(null));const s=k.collection("freshmart").doc("cms_data").collection("reviews").onSnapshot(i=>{const n=i.docs.map(l=>l.data());n.sort((l,d)=>{const p=l.createdAt&&l.createdAt.toMillis?l.createdAt.toMillis():0;return(d.createdAt&&d.createdAt.toMillis?d.createdAt.toMillis():0)-p}),oa(n),typeof window.rAdmReviews=="function"&&window.rAdmReviews()},()=>{b("Gagal memuat ulasan!")});De(s)}else e==="faqs"?typeof window.rAdmFAQ=="function"&&window.rAdmFAQ():e==="changelog"?typeof window.rAdmChangelog=="function"&&window.rAdmChangelog():typeof window.rAdmL=="function"&&window.rAdmL(e)};window.openAdminTab=Ds;let Me="all";const Ms=e=>{if(!e)return"";try{const t=e.split("-");return t.length===3?new Date(parseInt(t[0]),parseInt(t[1])-1,parseInt(t[2])).toLocaleDateString("id-ID",{day:"numeric",month:"short",year:"numeric"}):e}catch{return e}},Ls=e=>{switch(e){case"feature":return{label:"Fitur Baru",icon:"fa-rocket",colorClass:"bg-slate-100 dark:bg-slate-800/90 text-slate-700 dark:text-slate-300 border-slate-200/80 dark:border-slate-700/80",iconColor:"text-[var(--color-primary)]"};case"optimization":return{label:"Optimasi",icon:"fa-bolt-lightning",colorClass:"bg-slate-100 dark:bg-slate-800/90 text-slate-700 dark:text-slate-300 border-slate-200/80 dark:border-slate-700/80",iconColor:"text-[var(--color-primary)]"};case"maintenance":return{label:"Maintenance",icon:"fa-wrench",colorClass:"bg-slate-100 dark:bg-slate-800/90 text-slate-700 dark:text-slate-300 border-slate-200/80 dark:border-slate-700/80",iconColor:"text-[var(--color-primary)]"};case"bugfix":return{label:"Perbaikan",icon:"fa-bug-slash",colorClass:"bg-slate-100 dark:bg-slate-800/90 text-slate-700 dark:text-slate-300 border-slate-200/80 dark:border-slate-700/80",iconColor:"text-[var(--color-primary)]"};default:return{label:"Update",icon:"fa-tag",colorClass:"bg-slate-100 dark:bg-slate-800/90 text-slate-700 dark:text-slate-300 border-slate-200/80 dark:border-slate-700/80",iconColor:"text-[var(--color-primary)]"}}},Bs=()=>{const e=h("changelog-items-container");if(!e)return;const t=mt(r),a=Me==="all"?t:t.filter(s=>s.category===Me);if(a.length===0){e.innerHTML=`
        ...
        </div>`;return}let o="";a.forEach((s,i)=>{const n=i===0&&Me==="all",l=Ls(s.category),d=Ms(s.date),p=(s.items||[]).map(m=>`
        ...
        </div>`,document.body.appendChild(t));const a=bt(r),o=h("changelog-header-ver");o&&(o.textContent=a),Me=e,Kt(e),t.style.display="flex",requestAnimationFrame(()=>{t.classList.remove("opacity-0");const s=h("changelog-modal-box");s&&s.classList.remove("translate-y-full","sm:translate-y-8")})},Gt=()=>{const e=h("changelog-modal");if(!e||e.style.display==="none")return;e.classList.add("opacity-0");const t=h("changelog-modal-box");t&&t.classList.add("translate-y-full","sm:translate-y-8"),setTimeout(()=>{e.style.display="none"},300)};window.openChangelogModal=_s;window.closeChangelogModal=Gt;window.filterChangelog=Kt;let Se=!1,ye=null;const ht=()=>{const e=new Date,t=e.getFullYear(),a=String(e.getMonth()+1).padStart(2,"0"),o=String(e.getDate()).padStart(2,"0");return`${t}-${a}-${o}`},Es=e=>{if(!e)return"";try{const t=e.split("-");return t.length===3?new Date(parseInt(t[0]),parseInt(t[1])-1,parseInt(t[2])).toLocaleDateString("id-ID",{day:"numeric",month:"short",year:"numeric"}):e}catch{return e}},Fe=()=>{const e=h("admin-content");if(!e)return;const t=r.changelog||[],a=mt(r),o=bt(r);let s="";a.length===0?s=`
        ...
        </div>`:s=a.map(i=>{const n=t.some(u=>u.id===i.id),l=i.version===o,d=(i.items||[]).map(u=>`
                ...
                <div class="flex flex-wrap items-center justify-between gap-2 border-b border-slate-100 dark:border-slate-800 pb-3">
                    ...
                    <div class="flex items-center gap-2">
                        <span class="text-[10px] font-bold text-slate-400 dark:text-slate-500">
                            <i class="fa-regular fa-calendar mr-1"></i> ${c(Es(i.date))}
                        </span>
                        ${n?`
        ...
        <div id="changelog-form-box" class="${Se?"block":"hidden"} p-5 sm:p-6 rounded-2xl bg-white dark:bg-slate-900 border-2 border-[var(--color-primary)]/40 shadow-lg space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3.5">
                ...
                <div>
                    ...
                    <input id="form-log-date" type="date" value="${ht()}" class="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-xs font-bold text-slate-800 dark:text-white focus:border-[var(--color-primary)] focus:outline-none" />
                </div>
            </div>
    ...
    </div>`},Rs=(e=null)=>{Se=e!==null?e:!Se,Se||(ye=null),Fe()},Ns=e=>{const t=(r.changelog||[]).find(s=>s.id===e);if(!t)return;ye=e,Se=!0,Fe(),fe("form-log-version",t.version||""),fe("form-log-category",t.category||"feature"),fe("form-log-date",t.date||ht()),fe("form-log-title",t.title||""),fe("form-log-items",(t.items||[]).join(`
`));const a=h("changelog-form-title");a&&(a.innerHTML=`<i class="fa-solid fa-pen text-[var(--color-primary)]"></i> Edit Catatan Pembaruan (${c(t.version)})`);const o=h("changelog-form-box");o&&o.scrollIntoView({behavior:"smooth"})},Fs=async()=>{const e=($("form-log-version")||"").trim(),t=$("form-log-category")||"feature",a=$("form-log-date")||ht(),o=($("form-log-title")||"").trim(),s=($("form-log-items")||"").trim();if(!e)return b("Nomor versi harus diisi (contoh: v1.2.1)!");if(!o)return b("Judul pembaruan harus diisi!");if(!s)return b("Tuliskan minimal 1 poin rincian perubahan!");const i=s.split(`
`).map(l=>l.replace(/^[-*•]\s*/,"").trim()).filter(l=>l.length>0);if(i.length===0)return b("Rincian perubahan tidak boleh kosong!");T("Menyimpan catatan pembaruan...");const n={id:ye||"log-"+Date.now().toString(36),version:e.startsWith("v")?e:"v"+e,category:t,date:a,title:o,items:i,updatedAt:new Date().toISOString()};if(r.changelog=r.changelog||[],ye){const l=r.changelog.findIndex(d=>d.id===ye);l!==-1?r.changelog[l]=n:r.changelog.unshift(n)}else r.changelog.unshift(n);try{await U(["changelog"]),b("Catatan pembaruan berhasil dipublikasikan secara real-time!","success"),Se=!1,ye=null,Fe()}catch(l){b("Gagal menyimpan log pembaruan: "+l.message,"error")}finally{P()}},Os=e=>{const t=(r.changelog||[]).find(a=>a.id===e);t&&we(`Hapus catatan pembaruan versi "${t.version}"?`,async()=>{T("Menghapus catatan..."),r.changelog=(r.changelog||[]).filter(a=>a.id!==e);try{await U(["changelog"]),b("Catatan berhasil dihapus!","success"),Fe()}catch(a){b("Gagal menghapus catatan: "+a.message,"error")}finally{P()}},"Ya, Hapus","Konfirmasi Hapus")};window.rAdmChangelog=Fe;window.toggleChangelogForm=Rs;window.editChangelogEntry=Ns;window.saveChangelogEntry=Fs;window.deleteChangelogEntry=Os;export{ba as A,$e as a,Pe as b,Te as c,k as d,ws as e,vs as f,ks as g,ua as h,Ks as i,ys as j,Q as k,qs as l,Dt as m,Be as n,Ws as o,Ft as r,Va as s,Gs as t,Y as u};
