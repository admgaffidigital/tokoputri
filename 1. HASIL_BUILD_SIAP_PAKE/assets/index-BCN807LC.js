...
import{f as ue}from"./vendor-firebase-core-D2OF5R23.js";import{p as or,a as ir}from"./vendor-firebase-db-BHlQMNP0.js";import{p as lr}from"./vendor-utils-bRchjNq8.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&r(i)}).observe(document,{childList:!0,subtree:!0});function a(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(s){if(s.ep)return;s.ep=!0;const o=a(s);fetch(s.href,o)}})();const nr="modulepreload",dr=function(e){return"/"+e},ja={},cr=function(t,a,r){let s=Promise.resolve();if(a&&a.length>0){document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),l=i?.nonce||i?.getAttribute("nonce");s=Promise.allSettled(a.map(d=>{if(d=dr(d),d in ja)return;ja[d]=!0;const p=d.endsWith(".css"),f=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${f}`))return;const g=document.createElement("link");if(g.rel=p?"stylesheet":nr,p||(g.as="script"),g.crossOrigin="",g.href=d,l&&g.setAttribute("nonce",l),document.head.appendChild(g),p)return new Promise((u,w)=>{g.addEventListener("load",u),g.addEventListener("error",()=>w(new Error(`Unable to preload CSS for ${d}`)))})}))}function o(i){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=i,window.dispatchEvent(l),!l.defaultPrevented)throw i}return s.then(i=>{for(const l of i||[])l.status==="rejected"&&o(l.reason);return t().catch(o)})},pr={apiKey:"AIzaSyCOjrhMP52TGbiOyQLY92NDYE26N6d9hJM",authDomain:"restu-karya-utama.firebaseapp.com",databaseURL:"https://restu-karya-utama-default-rtdb.asia-southeast1.firebasedatabase.app",projectId:"restu-karya-utama",storageBucket:"restu-karya-utama.firebasestorage.app",messagingSenderId:"858310421352",appId:"1:858310421352:web:e20a833875e8d5c19944dd",measurementId:"G-PHDG2LJ8PM"};try{localStorage.removeItem("freshmart_fb_config")}catch{}const na=window.FIREBASE_CONFIG||pr;ue.apps.length||ue.initializeApp(na);const k=ue.firestore(),ge=ue.auth();typeof window<"u"&&(window.firebase=ue,window.db=k,window.auth=ge);try{k.settings({localCache:or({tabManager:ir()}),ignoreUndefinedProperties:!0,merge:!0,experimentalForceLongPolling:!0,experimentalAutoDetectLongPolling:!1})}catch{try{k.settings({ignoreUndefinedProperties:!0,merge:!0,experimentalForceLongPolling:!0,experimentalAutoDetectLongPolling:!1})}catch{}}let mr=null;const Ea=()=>{cr(()=>import("./vendor-firebase-analytics-Jm19L5g2.js"),__vite__mapDeps([0,1])).then(()=>{try{mr=ue.analytics()}catch{}}).catch(()=>{})},da="K2ijSERTT2dg27yYGTEgn6XHSnW2",Ye={emerald:{50:"#ecfdf5",100:"#d1fae5",200:"#a7f3d0",300:"#6ee7b7",400:"#34d399",500:"#10b981",600:"#059669",700:"#047857",800:"#065f46",900:"#064e3b"},teal:{50:"#f0fdfa",100:"#ccfbf1",200:"#99f6e4",300:"#5eead4",400:"#2dd4bf",500:"#14b8a6",600:"#0d9488",700:"#0f766e",800:"#115e59",900:"#134e4a"},cyan:{50:"#ecfeff",100:"#cffafe",200:"#a5f3fc",300:"#67e8f9",400:"#22d3ee",500:"#06b6d4",600:"#0891b2",700:"#0e7490",800:"#155e75",900:"#164e63"},sky:{50:"#f0f9ff",100:"#e0f2fe",200:"#bae6fd",300:"#7dd3fc",400:"#38bdf8",500:"#0ea5e9",600:"#0284c7",700:"#0369a1",800:"#075985",900:"#0c4a6e"},blue:{50:"#eff6ff",100:"#dbeafe",200:"#bfdbfe",300:"#93c5fd",400:"#60a5fa",500:"#3b82f6",600:"#2563eb",700:"#1d4ed8",800:"#1e40af",900:"#1e3a8a"},indigo:{50:"#eef2ff",100:"#e0e7ff",200:"#c7d2fe",300:"#a5b4fc",400:"#818cf8",500:"#6366f1",600:"#4f46e5",700:"#4338ca",800:"#3730a3",900:"#312e81"},violet:{50:"#f5f3ff",100:"#ede9fe",200:"#ddd6fe",300:"#c4b5fd",400:"#a78bfa",500:"#8b5cf6",600:"#7c3aed",700:"#6d28d9",800:"#5b21b6",900:"#4c1d95"},purple:{50:"#faf5ff",100:"#f3e8ff",200:"#e9d5ff",300:"#d8b4fe",400:"#c084fc",500:"#a855f7",600:"#9333ea",700:"#7e22ce",800:"#6b21a8",900:"#581c87"},fuchsia:{50:"#fdf4ff",100:"#fae8ff",200:"#f5d0fe",300:"#f0abfc",400:"#e879f9",500:"#d946ef",600:"#c026d3",700:"#a21caf",800:"#86198f",900:"#701a75"},pink:{50:"#fdf2f8",100:"#fce7f3",200:"#fbcfe8",300:"#f9a8d4",400:"#f472b6",500:"#ec4899",600:"#db2777",700:"#be185d",800:"#9d174d",900:"#831843"},rose:{50:"#fff1f2",100:"#ffe4e6",200:"#fecdd3",300:"#fda4af",400:"#fb7185",500:"#f43f5e",600:"#e11d48",700:"#be123c",800:"#9f1239",900:"#881337"},red:{50:"#fef2f2",100:"#fee2e2",200:"#fecaca",300:"#fca5a5",400:"#f87171",500:"#dc2626",600:"#b91c1c",700:"#991b1b",800:"#7f1d1d",900:"#450a0a"},orange:{50:"#fff7ed",100:"#ffedd5",200:"#fed7aa",300:"#fdba74",400:"#fb923c",500:"#ea580c",600:"#c2410c",700:"#9a3412",800:"#7c2d12",900:"#431407"},amber:{50:"#fffbeb",100:"#fef3c7",200:"#fde68a",300:"#fcd34d",400:"#fbbf24",500:"#d97706",600:"#b45309",700:"#92400e",800:"#78350f",900:"#451a03"},yellow:{50:"#fefce8",100:"#fef9c3",200:"#fef08a",300:"#fde047",400:"#eab308",500:"#d97706",600:"#b45309",700:"#854d0e",800:"#713f12",900:"#3f1d0b"},lime:{50:"#f7fee7",100:"#ecfccb",200:"#d9f99d",300:"#bef264",400:"#a3e635",500:"#65a30d",600:"#4d7c0f",700:"#3f6212",800:"#365314",900:"#1a2e05"},green:{50:"#f0fdf4",100:"#dcfce7",200:"#bbf7d0",300:"#86efac",400:"#4ade80",500:"#16a34a",600:"#15803d",700:"#166534",800:"#14532d",900:"#052e16"},slate:{50:"#f8fafc",100:"#f1f5f9",200:"#e2e8f0",300:"#cbd5e1",400:"#94a3b8",500:"#475569",600:"#334155",700:"#1e293b",800:"#0f172a",900:"#020617"},stone:{50:"#fafaf9",100:"#f5f5f4",200:"#e7e5e4",300:"#d6d3d1",400:"#a8a29e",500:"#57534e",600:"#44403c",700:"#292524",800:"#1c1917",900:"#0c0a09"}},As=e=>{let t=parseInt(e.replace("#",""),16);return(t>>16&255)+","+(t>>8&255)+","+(t&255)},_a=(e,t)=>{let a=parseInt(e.slice(1,3),16),r=parseInt(e.slice(3,5),16),s=parseInt(e.slice(5,7),16);return a=Math.max(0,Math.min(255,a+t)),r=Math.max(0,Math.min(255,r+t)),s=Math.max(0,Math.min(255,s+t)),"#"+[a,r,s].map(o=>o.toString(16).padStart(2,"0")).join("")},yt=(e,t)=>{const a=e||localStorage.getItem("freshmart_ui_theme")||"emerald",r=Ye[a]||Ye.emerald;e&&localStorage.setItem("freshmart_ui_theme",a);const s=t||localStorage.getItem("freshmart_theme_color")||r[500];t&&localStorage.setItem("freshmart_theme_color",s);const o=As(s),i=_a(s,-30),l=_a(s,150);document.documentElement.style.setProperty("--color-primary",s),document.documentElement.style.setProperty("--color-primary-dark",i),document.documentElement.style.setProperty("--color-primary-light",l),document.documentElement.style.setProperty("--color-primary-rgb",o);let d=document.querySelector('meta[name="theme-color"]');return d||(d=document.createElement("meta"),d.setAttribute("name","theme-color"),document.head.appendChild(d)),d.setAttribute("content",s),r},ur=()=>{const e=localStorage.getItem("freshmart_theme"),t=window.matchMedia("(prefers-color-scheme: dark)").matches;(e==="dark"||!e&&t)&&document.documentElement.classList.add("dark")},fr=()=>{const e=document.documentElement.classList.toggle("dark");localStorage.setItem("freshmart_theme",e?"dark":"light");const t=document.getElementById("icon-theme")||document.getElementById("theme-toggle-icon");t&&(t.className=e?"fa-solid fa-sun text-sm text-amber-400":"fa-solid fa-moon text-sm text-slate-600 dark:text-slate-300")},br=()=>{const e=document.documentElement.classList.contains("dark"),t=document.getElementById("icon-theme")||document.getElementById("theme-toggle-icon");t&&(t.className=e?"fa-solid fa-sun text-sm text-amber-400":"fa-solid fa-moon text-sm text-slate-600 dark:text-slate-300")},kt=(e="minimalist",t="")=>{const a=e||localStorage.getItem("freshmart_bg_style")||"minimalist",r=t??(localStorage.getItem("freshmart_bg_custom_url")||"");e&&localStorage.setItem("freshmart_bg_style",a),t!=null&&localStorage.setItem("freshmart_bg_custom_url",r);const o=(p=>{if(!p||typeof p!="string")return"";const f=p.match(/drive\.google\.com.*(?:id=|\/d\/)([a-zA-Z0-9_-]+)/);return f?`https://lh3.googleusercontent.com/d/${f[1]}`:p.trim()})(r);document.documentElement.setAttribute("data-bg-style",a),document.body?.setAttribute("data-bg-style",a);const i=document.getElementById("app-container");i&&(i.setAttribute("data-bg-style",a),o?i.setAttribute("data-has-custom-bg","true"):i.removeAttribute("data-has-custom-bg"));const l=document.getElementById("dynamic-bg-container");if(!l)return;if(l.innerHTML="",l.className="pointer-events-none fixed inset-0 z-0 overflow-hidden",o){const p=document.createElement("div");p.className="absolute inset-0 z-0 bg-cover bg-center bg-no-repeat bg-fixed opacity-35 dark:opacity-25 pointer-events-none transition-all duration-500",p.style.backgroundImage=`url('${o}')`,l.appendChild(p);const f=document.createElement("div");f.className="absolute inset-0 z-0 bg-slate-50/70 dark:bg-[#0b1120]/80 pointer-events-none backdrop-blur-[0.5px]",l.appendChild(f)}let d="";if(a==="hero_arch"?d=`
    ...
    `,T("doc-paper-content",s);const i=m("doc-preview-modal");i&&i.classList.contains("hidden")&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("docPreview"),j("doc-preview-modal"),setTimeout(()=>{m("doc-preview-modal")&&m("doc-preview-modal").classList.remove("opacity-0"),m("doc-preview-modal-box")&&m("doc-preview-modal-box").classList.remove("scale-95"),fa()},10)},fa=()=>{const e=m("doc-paper-scroll-area"),t=m("doc-paper-content"),a=m("doc-paper-wrapper");if(!e||!t||!a)return;const r=794,o=e.clientWidth-16,i=Math.min(1,o/r);t.style.transform=`translateX(-50%) scale(${i})`,a.style.height=t.offsetHeight*i+"px"};window.addEventListener("resize",()=>{const e=m("doc-preview-modal");e&&!e.classList.contains("hidden")&&fa()});const Lr=(e=!1)=>{typeof window.requestCloseModal=="function"?window.requestCloseModal("docPreview",e,()=>{m("doc-preview-modal")&&m("doc-preview-modal").classList.add("opacity-0"),m("doc-preview-modal-box")&&m("doc-preview-modal-box").classList.add("scale-95"),setTimeout(()=>$("doc-preview-modal"),300)}):(m("doc-preview-modal")&&m("doc-preview-modal").classList.add("opacity-0"),m("doc-preview-modal-box")&&m("doc-preview-modal-box").classList.add("scale-95"),setTimeout(()=>$("doc-preview-modal"),300))},Ir=()=>{const e=m("doc-paper-content")?m("doc-paper-content").innerHTML:"",t=window.open("","_blank");if(!t){typeof window.showToast=="function"&&window.showToast("Gagal membuka tab baru. Izinkan pop-up di browser Anda!");return}t.document.write(`
        <html>
        <head>
    ...
    <div class="flex gap-4 overflow-x-auto hide-scrollbar snap-x pb-6 pt-2">
    ...
    </div>`;e.innerHTML=r};let Fa=null;const Br=()=>{clearTimeout(Fa),Fa=setTimeout(async()=>{const t=(window.normalizeWA||(s=>(s||"").replace(/\D/g,"").replace(/^0/,"62")))(L("cust-wa")),a=m("member-status-banner");if(!a)return;if(!t||t.length<10){$(a),$("payment-option-tempo"),ze(null),Ce(null);return}const r=zt.get(t);if(r&&Date.now()-r.timestamp<Fr){r.data?(ze(r.data),a.className="mt-3 p-4 rounded-2xl border border-[var(--color-primary)]/30 bg-[rgba(var(--color-primary-rgb),0.06)] dark:bg-[rgba(var(--color-primary-rgb),0.12)] flex items-center justify-between gap-3",a.innerHTML='<p class="text-[11px] font-bold text-[var(--color-primary)] leading-snug"><i class="fa-solid fa-circle-check mr-1"></i>Nomor Anda terdaftar sebagai pelanggan toko kami!</p><button type="button" onclick="openMemberModal()" class="shrink-0 bg-[var(--color-primary)] hover:opacity-90 text-white text-[10px] font-bold uppercase tracking-widest px-3.5 py-2.5 rounded-xl shadow-sm active:scale-95 transition-all whitespace-nowrap">Lihat Data Saya</button>',j(a),j("payment-option-tempo")):(ze(null),Ce(null),$(a),$("payment-option-tempo"));return}try{const s=await k.collection("freshmart").doc("cms_data").collection("customers").doc(t).get();if(s.exists){const o=s.data();zt.set(t,{data:o,timestamp:Date.now()}),ze(o),a.className="mt-3 p-4 rounded-2xl border border-[var(--color-primary)]/30 bg-[rgba(var(--color-primary-rgb),0.06)] dark:bg-[rgba(var(--color-primary-rgb),0.12)] flex items-center justify-between gap-3",a.innerHTML='<p class="text-[11px] font-bold text-[var(--color-primary)] leading-snug"><i class="fa-solid fa-circle-check mr-1"></i>Nomor Anda terdaftar sebagai pelanggan toko kami!</p><button type="button" onclick="openMemberModal()" class="shrink-0 bg-[var(--color-primary)] hover:opacity-90 text-white text-[10px] font-bold uppercase tracking-widest px-3.5 py-2.5 rounded-xl shadow-sm active:scale-95 transition-all whitespace-nowrap">Lihat Data Saya</button>',j(a),j("payment-option-tempo")}else zt.set(t,{data:null,timestamp:Date.now()}),ze(null),Ce(null),$(a),$("payment-option-tempo")}catch{}},500)},Or=()=>{typeof window.attachRewardsRealtime=="function"&&!window.unsubRewardsRealtime&&window.attachRewardsRealtime();let e=document.getElementById("member-modal");e||(e=document.createElement("div"),e.id="member-modal",e.className="fixed inset-0 z-[115] bg-slate-900/70 backdrop-blur-sm flex items-end sm:items-center justify-center p-0 sm:p-5",e.onclick=t=>{t.target===e&&Fs()},document.body.appendChild(e)),e.innerHTML=`
        <div class="bg-white dark:bg-slate-900 w-full max-w-lg rounded-t-[2rem] sm:rounded-[2rem] max-h-[85vh] flex flex-col shadow-2xl border border-slate-200 dark:border-slate-700">
            <div class="p-5 sm:p-6 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center shrink-0">
        ...
        </div>`}).join(""):'<p class="text-[11px] font-bold text-slate-400 text-center py-3">Belum ada program hadiah yang tersedia.</p>';$e?T("member-modal-body",`
        ...
        </div>`}).join("")+(Pe?`<div class="flex justify-between items-center bg-[rgba(var(--color-primary-rgb),0.06)] dark:bg-[rgba(var(--color-primary-rgb),0.12)] p-4 rounded-[1.25rem] border border-[var(--color-primary)]/30 shadow-sm min-w-0"><div class="flex items-center gap-3.5 min-w-0"><div class="w-12 h-12 rounded-xl bg-[var(--color-primary)] text-white flex items-center justify-center shrink-0"><i class="fa-solid fa-gift"></i></div><div class="min-w-0"><p class="text-sm font-bold text-[var(--color-primary)] truncate">${c(Pe.name)}</p><p class="text-[11px] text-[var(--color-primary)] font-bold mt-1"><i class="fa-solid fa-star mr-1"></i>Tukar ${Pe.pointsCost} Poin (Gratis)</p></div></div><button type="button" onclick="if(typeof deselectReward==='function') deselectReward(); rPay();" class="text-[10px] font-bold text-rose-500 uppercase shrink-0 ml-3">Batal</button></div>`:"")),B.note?(H("payment-note-text",`"${c(B.note)}"`),j("payment-note-preview")):$("payment-note-preview"),T("dynamic-banks-container",n.banks?.length?n.banks.map(h=>`<div class="bg-white dark:bg-slate-800 p-4 rounded-[1.25rem] border border-slate-200 dark:border-slate-700 shadow-sm"><p class="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1">Bank ${c(h.bankName)}</p><p class="text-lg font-bold text-[var(--color-primary)] tracking-wide">${c(h.bankAccount)}</p><p class="text-xs text-slate-500 dark:text-slate-400 font-medium mt-1.5">a.n <span class="font-bold text-slate-700 dark:text-white">${c(h.bankOwner)}</span></p></div>`).join(""):'<div class="bg-rose-50 dark:bg-rose-900/20 border border-rose-200 p-4 rounded-[1.25rem] text-center"><p class="text-sm text-rose-500 dark:text-rose-400 font-bold">Rekening belum diatur.</p></div>');const u=m("payment-option-cashier"),w=m("payment-option-cod");if(u&&w){if(B.deliveryMethod==="pickup"){if(j("payment-option-cashier"),$("payment-option-cod"),(document.querySelector('input[name="payment"]:checked')||{}).value==="cod"){const h=document.querySelector('input[value="cashier"]');h&&(h.checked=!0)}}else{$("payment-option-cashier"),j("payment-option-cod");const h=(document.querySelector('input[name="payment"]:checked')||{}).value;if(h==="cashier"||!h){const A=document.querySelector('input[value="cod"]');A&&(A.checked=!0)}}typeof window.togglePaymentDetails=="function"&&window.togglePaymentDetails()}const v=m("tnc-checkbox");v&&(v.checked=!1,Ns())},Jr=async()=>{if(!m("tnc-checkbox").checked||Ke)return;if(window.isAdm){typeof window.showToast=="function"&&window.showToast("Anda login sebagai Seller. Logout dulu untuk membuat pesanan.");return}const e=we("freshmart_last_order");if(e&&Date.now()-parseInt(e)<6e4){typeof window.showToast=="function"&&window.showToast("Tunggu 1 menit untuk pesanan baru!");return}const t=typeof window.getEffP=="function"?window.getEffP:o=>o.price||0,a=typeof window.getEffHpp=="function"?window.getEffHpp:()=>0,r=typeof window.getEffPoin=="function"?window.getEffPoin:()=>0;let s=!1;if(R.forEach(o=>{const i=n.products.find(d=>d.id===o.id);if(!i)return;const l=o.variantName?((i.variants||[]).find(d=>d.name===o.variantName)||{}).price??i.price:i.price;l!==void 0&&Math.abs(o.price-l)>1&&(o.price=l,s=!0),o.poin=r(o)}),s){te("freshmart_cart",JSON.stringify(R)),typeof window.renderCart=="function"&&window.renderCart(),Bs(),typeof window.showToast=="function"&&window.showToast("Harga produk telah diperbarui. Periksa kembali sebelum order.");return}ee(!0),O("Proses Pesanan...");try{const o=R.reduce((y,_)=>y+(parseFloat(t(_))||0)*(parseFloat(_.qty)||0),0);let i=0,l=0,d=0;B.deliveryMethod==="delivery"&&(i=Math.ceil((parseFloat(B.distance)||0)*(parseFloat(n.store.costPerKm)||0)/500)*500);const p=n.store.useStock===!0||n.store.useStock==="true";if(p)for(const y of R){const _=n.products.find(E=>E.id===y.id);if(!_)continue;const Y=parseFloat(y.qty)||0;if(y.variantName){const E=(_.variants||[]).find(Q=>Q.name===y.variantName),G=parseFloat(E&&E.stock!==void 0?E.stock:0);if(G<Y){ee(!1),D(),typeof window.showToast=="function"&&window.showToast(`Stok ${y.name} (${y.variantName}) tidak cukup! Sisa: ${G}`);return}}else{const E=parseFloat(_.stock!==void 0?_.stock:0);if(E<Y){ee(!1),D(),typeof window.showToast=="function"&&window.showToast(`Stok ${y.name} tidak cukup! Sisa: ${E}`);return}}}if(N){let y=o;if(N.targetProduct&&N.targetProduct!==""){const _=parseInt(N.targetProduct);y=R.filter(E=>E.id===_).reduce((E,G)=>E+(parseFloat(t(G))||0)*(parseFloat(G.qty)||0),0)}if(N.minPurchase&&parseFloat(N.minPurchase)>0&&o<parseFloat(N.minPurchase))xe(null);else if(N.targetProduct&&N.targetProduct!==""&&y===0)xe(null);else if(N.type&&N.type.includes("shipping")&&B.deliveryMethod!=="delivery")xe(null);else if(N.type==="shipping_free")l=i;else if(N.type==="shipping_flat")l=parseFloat(N.value)||0;else if(N.type==="percent"){let _=y*((parseFloat(N.value)||0)/100);N.maxDiscount&&parseFloat(N.maxDiscount)>0&&(_=Math.min(_,parseFloat(N.maxDiscount))),d=_}else d=parseFloat(N.value)||0,d=Math.min(d,y)}l=Math.min(l,i),d=Math.min(d,o);const f=Math.max(0,o-d+(i-l)),u=(typeof window.calcTaxDetails=="function"?window.calcTaxDetails:()=>({ppnEnabled:!1,ppnAmount:0,grandTotalAdd:0}))(f),w=u.ppnAmount,v=u.dppAmount,h=f+u.grandTotalAdd,A=(document.querySelector('input[name="payment"]:checked')||{}).value,C=A==="transfer"||A==="qris"||A==="tempo",P=window.buktiGDriveUploaded&&window.buktiPaymentUrl&&!window.buktiPaymentUrl.startsWith("data:");if(C&&!P){if(ee(!1),D(),!window.buktiPaymentFile){typeof window.showToast=="function"&&window.showToast("Upload bukti pembayaran terlebih dahulu!");return}typeof window.showToast=="function"&&window.showToast("Tunggu upload Google Drive selesai, atau coba lagi!");return}const q="ORD-"+Date.now().toString(36).toUpperCase()+"-"+Math.random().toString(36).substring(2,6).toUpperCase();if(window.buktiPaymentFile&&!window.buktiGDriveUploaded)try{O("Upload Bukti ke Google Drive...");const y=await window.uploadBuktiToFirebase(window.buktiPaymentFile,q);if(y&&!y.startsWith("data:"))window.buktiPaymentUrl=y,window.buktiGDriveUploaded=!0;else{ee(!1),D(),typeof window.showToast=="function"&&window.showToast("❌ Upload bukti ke Google Drive gagal. Coba pilih gambar lagi!");return}O("Proses Pesanan...")}catch{ee(!1),D(),typeof window.showToast=="function"&&window.showToast("❌ Gagal upload bukti. Periksa koneksi dan coba lagi!");return}const I={orderId:q,timestamp:ue.firestore.FieldValue.serverTimestamp(),dateString:new Date().toISOString(),customer:B,items:R.map(y=>({...y,qty:parseFloat(y.qty),effectivePrice:t(y),poTime:y.poTime||"",hpp:a(y),poin:r(y)})),payment:{method:A,subtotal:o,shippingCost:i,shippingDiscount:l,productDiscount:d,ppnAmount:w,dppAmount:v,ppnRate:u.ppnEnabled?u.ppnRate:0,ppnType:u.ppnEnabled?u.ppnType:"exclusive",grandTotal:h},status:"Baru",buktiPayment:window.buktiPaymentUrl||null};if(A==="tempo"){const y=document.getElementById("tempo-dp-input");let _=y&&parseFloat(y.value)||0;_>h&&(_=h),I.payment.tempoDp=_,I.payment.tempoBalance=h-_,I.payment.tempoDueDate=Date.now()+30*24*60*60*1e3,I.payment.paymentStatus="hutang"}const S=k.collection("freshmart_orders").doc(q),U=R.reduce((y,_)=>y+r(_)*(parseFloat(_.qty)||0),0),K=k.collection("freshmart").doc("cms_data"),ne=B.wa?K.collection("customers").doc(B.wa):null,he=!!Pe;let F=null;if(p){const y={};R.forEach(E=>{const G=E.id!=null?E.id.toString():null;if(!G)return;y[G]||(y[G]={main:0,variants:{}});const Q=parseFloat(E.qty)||0;E.variantName?y[G].variants[E.variantName]=(y[G].variants[E.variantName]||0)+Q:y[G].main+=Q});const _=Object.keys(y),Y=_.map(E=>k.collection("freshmart").doc("cms_data").collection("products").doc(E));await k.runTransaction(async E=>{const G=he?k.collection("freshmart").doc("cms_data").collection("rewards").doc(Pe.id.toString()):null,Q=await Promise.all(Y.map(be=>E.get(be))),X=ne?await E.get(ne):null,pt=X&&X.exists&&G?await E.get(G):null,Ee=[];if(Q.forEach((be,ve)=>{if(!be.exists)return;const Ue=be.data(),ye=y[_[ve]];if(ye.main>0){const z=parseFloat(Ue.stock!==void 0?Ue.stock:0);z<ye.main&&Ee.push(`${Ue.name} (sisa ${z})`)}Object.keys(ye.variants).forEach(z=>{const _e=(Ue.variants||[]).find(We=>We.name===z),ut=parseFloat(_e&&_e.stock!==void 0?_e.stock:0);ut<ye.variants[z]&&Ee.push(`${Ue.name} (${z}, sisa ${ut})`)})}),Ee.length)throw new Error("STOK_TIDAK_CUKUP: "+Ee.join(", "));let mt=null,At=null;if(X&&X.exists){let be=parseFloat(X.data().points)||0;if(he){if(!pt||!pt.exists)throw new Error("HADIAH_TIDAK_DITEMUKAN");const ve=pt.data();if(be<(parseFloat(ve.pointsCost)||0))throw new Error("POIN_TIDAK_CUKUP");if((parseFloat(ve.stock)||0)<=0)throw new Error("STOK_HADIAH_HABIS");mt=(parseFloat(ve.stock)||0)-1,be-=parseFloat(ve.pointsCost)||0,I.claimedReward={id:ve.id,name:ve.name,pointsCost:parseFloat(ve.pointsCost)||0,status:"pending",note:""}}be+=U,At=be,I.pointsEarned=U,I.customerPhone=B.wa,I.finalMemberPoints=be}else if(he)throw new Error("MEMBER_TIDAK_DITEMUKAN");Q.forEach((be,ve)=>{if(!be.exists)return;const Ue=_[ve],ye=y[Ue],z=JSON.parse(JSON.stringify(be.data())),_e={};ye.main>0&&(z.stock=Math.max(0,(parseFloat(z.stock)||0)-ye.main),_e.stock=z.stock,z.stock===0&&(z.isActive="false",_e.isActive="false"),z.totalSold=(parseFloat(z.totalSold)||0)+ye.main,_e.totalSold=z.totalSold),Object.keys(ye.variants).length>0&&z.variants&&(Object.keys(ye.variants).forEach(We=>{const Qe=(z.variants||[]).findIndex(rr=>rr.name===We);Qe>-1&&(z.variants[Qe].stock=Math.max(0,(parseFloat(z.variants[Qe].stock)||0)-ye.variants[We]),z.variants[Qe].stock===0&&(z.variants[Qe].isActive=!1),z.variants[Qe].totalSold=(parseFloat(z.variants[Qe].totalSold)||0)+ye.variants[We])}),_e.variants=z.variants);const ut=n.products.findIndex(We=>We.id.toString()===Ue);ut>-1&&(n.products[ut]=z),E.update(Y[ve],_e)}),E.set(S,I),At!==null&&(E.set(ne,{points:At},{merge:!0}),F=At),mt!==null&&E.set(G,{stock:mt},{merge:!0}),E.update(K,{lastUpdate:ue.firestore.FieldValue.increment(1),updateType:"stock_change",updatedProductIds:_})}),n.lastUpdate=(parseInt(we("freshmart_last_update"))||n.lastUpdate||0)+1,te("freshmart_last_update",n.lastUpdate.toString()),te("freshmart_products",JSON.stringify(n.products))}else ne?await k.runTransaction(async y=>{const _=he?k.collection("freshmart").doc("cms_data").collection("rewards").doc(Pe.id.toString()):null,Y=await y.get(ne),E=Y.exists&&_?await y.get(_):null;if(Y.exists){let G=parseFloat(Y.data().points)||0,Q=null;if(he){if(!E||!E.exists)throw new Error("HADIAH_TIDAK_DITEMUKAN");const X=E.data();if(G<(parseFloat(X.pointsCost)||0))throw new Error("POIN_TIDAK_CUKUP");if((parseFloat(X.stock)||0)<=0)throw new Error("STOK_HADIAH_HABIS");Q=(parseFloat(X.stock)||0)-1,G-=parseFloat(X.pointsCost)||0,I.claimedReward={id:X.id,name:X.name,pointsCost:parseFloat(X.pointsCost)||0,status:"pending",note:""}}G+=U,I.pointsEarned=U,I.customerPhone=B.wa,I.finalMemberPoints=G,y.set(S,I),y.set(ne,{points:G},{merge:!0}),F=G,Q!==null&&y.set(_,{stock:Q},{merge:!0})}else{if(he)throw new Error("MEMBER_TIDAK_DITEMUKAN");y.set(S,I)}}):await S.set(I);ie.unshift({orderId:q,date:new Date().toISOString(),total:h,itemCount:R.reduce((y,_)=>y+parseFloat(_.qty),0),status:"Baru",pointsEarned:I.pointsEarned||0,claimedReward:I.claimedReward||null,finalMemberPoints:F}),$t(ie);try{localStorage.setItem("freshmart_my_orders",JSON.stringify(ie)),localStorage.setItem("freshmart_last_order",Date.now().toString())}catch{}typeof analytics<"u"&&analytics.logEvent("purchase",{transaction_id:q,value:h,currency:"IDR"}),I.claimedReward&&F!==null?typeof window.showToast=="function"&&window.showToast(`✅ Hadiah "${I.claimedReward.name}" berhasil ditukar! Sisa poin Anda: ${F}`):typeof window.showToast=="function"&&window.showToast("✅ Pesanan berhasil dikirim ke admin!"),$e&&F!==null&&($e.points=F),setTimeout(()=>{it([]),se("cust-name",""),se("cust-address",""),se("cust-note",""),se("cust-wa",""),window.buktiPaymentUrl=null,window.buktiPaymentFile=null,window.buktiGDriveUploaded=!1;const y=m("bukti-preview-wrap"),_=m("bukti-placeholder");y&&y.classList.add("hidden"),_&&_.classList.remove("hidden"),$("bukti-uploading"),$("bukti-success"),$("bukti-gdrive-error");const Y=m("bukti-file-input");Y&&(Y.value=""),vr({name:"",address:"",lat:null,lng:null,deliveryMethod:"delivery",distance:0,note:"",wa:""}),xe(null),ze(null),Ce(null);const E=m("member-status-banner");E&&$(E),m("voucher-input")&&(m("voucher-input").value=""),$("voucher-msg-container"),$("location-status"),m("btn-location")&&j("btn-location");const G=document.querySelector('input[name="delivery-method"][value="delivery"]');G&&(G.checked=!0,ga());const Q=document.querySelector('input[name="payment"][value="transfer"]');Q&&(Q.checked=!0,typeof window.togglePaymentDetails=="function"&&window.togglePaymentDetails()),typeof window.updCart=="function"&&window.updCart(),typeof window.renderCart=="function"&&window.renderCart(),typeof window.changeView=="function"&&window.changeView("view-catalog"),typeof window.showToast=="function"&&window.showToast("Pesanan Dibuat! 🎉")},2e3)}catch(o){const i=o.message||"Error";i.startsWith("STOK_TIDAK_CUKUP:")?typeof window.showToast=="function"&&window.showToast("Maaf, stok berubah: "+i.replace("STOK_TIDAK_CUKUP: ","")):i==="POIN_TIDAK_CUKUP"?(typeof window.showToast=="function"&&window.showToast("Maaf, poin Anda ternyata tidak cukup untuk hadiah ini. Silakan cek lagi."),Ce(null)):i==="STOK_HADIAH_HABIS"?(typeof window.showToast=="function"&&window.showToast("Maaf, stok hadiah yang dipilih baru saja habis. Silakan pilih hadiah lain."),Ce(null)):i==="HADIAH_TIDAK_DITEMUKAN"?(typeof window.showToast=="function"&&window.showToast("Hadiah yang dipilih sudah tidak tersedia. Silakan pilih ulang."),Ce(null)):i==="MEMBER_TIDAK_DITEMUKAN"?(typeof window.showToast=="function"&&window.showToast("Data member tidak ditemukan, klaim hadiah dibatalkan. Pesanan bisa dicoba lagi tanpa hadiah."),Ce(null)):typeof window.showToast=="function"&&window.showToast(o.code==="resource-exhausted"?"Quota Server Penuh!":"Gagal proses: "+i)}finally{ee(!1),D()}};window.validateAndGoToPayment=zr;window.toggleDeliveryMethod=ga;window.toggleOrderButton=Ns;window.rPay=Bs;window.processOrder=Jr;const wt=()=>{const e=m("wishlist-badge");e&&(e.innerText=me.length,e.classList.toggle("scale-0",!me.length))},Yr=e=>{me.splice(e,1),te("freshmart_wishlist",JSON.stringify(me)),wt(),xa()},Xr=e=>{const t=me[e],a=n.products?.find(i=>i.id===t.id);if(!a||a.isActive==="false"||a.isActive===!1)return b(`${t.name} sudah tidak tersedia.`);const r=t.variantName?(a.variants||[]).find(i=>i.name===t.variantName):null;if(n.store?.useStock===!0||n.store?.useStock==="true"){if(t.variantName&&(!r||r.isActive===!1||r.isActive==="false"))return b(`Varian ${t.variantName} sudah tidak tersedia.`);const i=r?parseFloat(r.stock)||0:parseFloat(a.stock)||0,l=R.find(p=>p.id===t.id&&p.variantName===t.variantName),d=l&&parseFloat(l.qty)||0;if(i<=0||d>=i)return b(`Stok ${t.name} tidak mencukupi!`)}const o=R.find(i=>i.id===t.id&&i.variantName===t.variantName);if(o)o.qty=parseFloat((o.qty+1).toFixed(2));else{const i=r&&parseFloat(r.poin)>0?parseFloat(r.poin):parseFloat(a.poin)||0;R.push({id:a.id,name:a.name,variantName:t.variantName||"",price:r?r.price:a.price,img:r?.img||a.img,qty:1,unit:a.unit||"pcs",poTime:a.poTime||"",colorCode:r?.colorCode||"",poin:i})}Ae(),b("Ke Keranjang!"),typeof window.curViewName<"u"&&window.curViewName==="view-cart"&&Xe()},Zr=()=>{Le("Hapus Favorit","Yakin ingin menghapus semua?",()=>{me.length=0,te("freshmart_wishlist",JSON.stringify(me)),wt(),xa(),b("Dibersihkan")})},xa=()=>{if(!me.length){j("wishlist-empty-state"),$("btn-clear-wishlist"),j("spacer-wishlist"),T("wishlist-items-container","");return}$("wishlist-empty-state"),j("btn-clear-wishlist"),$("spacer-wishlist"),T("wishlist-items-container",me.map((e,t)=>{let a=e.colorCode?`<span class="w-3.5 h-3.5 rounded-full shadow-inner border border-slate-300 dark:border-slate-600 shrink-0" style="background-color: ${c(e.colorCode)};"></span>`:"";return`
        <div class="bg-white dark:bg-slate-800 p-4 rounded-[1.25rem] border border-slate-200 dark:border-slate-700 shadow-sm flex gap-4 relative overflow-hidden group min-w-0 hover:shadow-md hover:-translate-y-1 hover:border-rose-300 dark:hover:border-rose-600 transition-all duration-300">
            ...
            </div>`,r.classList.remove("hidden")}else r.innerHTML="",r.classList.add("hidden");let s=n.products.filter(l=>{if(l.isActive===!1||l.isActive==="false"||De!=="Semua Produk"&&l.category!==De||Se!=="Semua Merek"&&l.brand!==Se)return!1;if(!tt)return!0;let d=tt.toLowerCase();return(l.name||"").toLowerCase().includes(d)||(l.sku||"").toLowerCase().includes(d)||(l.category||"").toLowerCase().includes(d)||(l.brand||"").toLowerCase().includes(d)||l.variants&&l.variants.some(p=>(p.name||"").toLowerCase().includes(d)||(p.sku||"").toLowerCase().includes(d))}).sort((l,d)=>at==="cheapest"?(l.price||0)-(d.price||0):at==="expensive"?(d.price||0)-(l.price||0):at==="az"?(l.name||"").localeCompare(d.name||""):at==="za"?(d.name||"").localeCompare(l.name||""):at==="oldest"?(l.id||0)-(d.id||0):(d.id||0)-(l.id||0));const o=m("product-container");if(!o)return;if(o.className=Xt==="grid"?"grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-5 2xl:grid-cols-6 gap-4 sm:gap-6 lg:gap-8":"flex flex-col gap-3 sm:gap-4",!s.length){o.innerHTML='<div class="col-span-full text-center py-16 sm:py-24 text-slate-500 dark:text-slate-400 font-bold bg-slate-50 dark:bg-slate-800/50 rounded-[1.5rem] border border-slate-200 border-dashed dark:border-slate-700 text-sm sm:text-base flex flex-col items-center justify-center"><div class="w-20 h-20 bg-white dark:bg-slate-800 rounded-full flex items-center justify-center shadow-sm mb-4"><i class="fa-solid fa-box-open text-3xl sm:text-4xl text-slate-300 dark:text-slate-600"></i></div>Maaf, produk tidak ditemukan.<br><span class="text-xs font-medium text-slate-500 dark:text-slate-400 mt-2 font-normal">Coba gunakan kata kunci pencarian yang berbeda atau hapus filter.</span></div>',$("load-more-container");return}const i=s.slice(0,ca*hr);o.innerHTML=i.map(l=>{let d="";const p=n.store.useStock===!0||n.store.useStock==="true";let f="";if(p){const U=l.variants&&l.variants.length?l.variants.filter(K=>K.isActive!==!1&&K.isActive!=="false").reduce((K,ne)=>K+(parseFloat(ne.stock)||0),0):parseFloat(l.stock)||0;U<=0?d='<div class="absolute inset-0 bg-white/60 dark:bg-slate-900/60 backdrop-blur-[2px] z-20 flex items-center justify-center rounded-[1.25rem]"><span class="bg-slate-800 text-white text-[10px] font-bold px-3 py-1.5 rounded-xl shadow-lg uppercase tracking-widest"><i class="fa-solid fa-ban mr-1"></i> HABIS</span></div>':U<=5?f=`<span class="absolute top-2 left-2 z-10 bg-rose-500 text-white text-[8px] font-bold px-2 py-1 rounded-xl shadow uppercase tracking-wider"><i class="fa-solid fa-fire mr-0.5"></i> SISA ${U}</span>`:f=`<span class="absolute top-2 left-2 z-10 bg-slate-800/80 text-white text-[8px] font-bold px-2 py-1 rounded-xl shadow uppercase tracking-wider backdrop-blur-sm"><i class="fa-solid fa-box mr-0.5"></i> Stok ${U}</span>`}const g=!d,u=g?"cursor-pointer hover:shadow-md hover:-translate-y-1.5 hover:border-[var(--color-primary)]/40":"cursor-not-allowed",w=g?"cursor-pointer hover:shadow-md hover:-translate-y-1 hover:border-[var(--color-primary)]/40":"cursor-not-allowed";let v="",h="";l.priceNormal&&l.priceNormal>l.price&&(v=`<span class="bg-rose-500 text-white px-2 py-0.5 rounded-full text-[8px] font-bold flex items-center gap-1 whitespace-nowrap uppercase tracking-wider shadow-sm"><i class="fa-solid fa-tags"></i> -${Math.round((l.priceNormal-l.price)/l.priceNormal*100)}%</span>`,h=`<p class="text-[10px] text-slate-600 dark:text-slate-400 line-through mb-0.5 font-bold">${x(l.priceNormal)}</p>`);let A=l.poTime?`<span class="bg-amber-500 text-white px-2 py-0.5 rounded-full text-[8px] font-bold flex items-center gap-1 whitespace-nowrap uppercase tracking-wider shadow-sm"><i class="fa-solid fa-clock"></i> PO ${c(l.poTime)}</span>`:"",C="";if(l.variants&&l.variants.length){const U=l.variants.map(K=>parseFloat(K.poin)||0).filter(K=>K>0);if(U.length){const K=[...new Set(U)];C=K.length===1?`<span class="bg-[rgba(var(--color-primary-rgb),0.1)] text-[var(--color-primary)] px-2 py-0.5 rounded-full text-[8px] font-bold flex items-center gap-1 whitespace-nowrap uppercase tracking-wider"><i class="fa-solid fa-star"></i> +${K[0]} Poin</span>`:'<span class="bg-[rgba(var(--color-primary-rgb),0.1)] text-[var(--color-primary)] px-2 py-0.5 rounded-full text-[8px] font-bold flex items-center gap-1 whitespace-nowrap uppercase tracking-wider"><i class="fa-solid fa-star"></i> Dapat Poin</span>'}}else parseFloat(l.poin)>0&&(C=`<span class="bg-[rgba(var(--color-primary-rgb),0.1)] text-[var(--color-primary)] px-2 py-0.5 rounded-full text-[8px] font-bold flex items-center gap-1 whitespace-nowrap uppercase tracking-wider"><i class="fa-solid fa-star"></i> +${parseFloat(l.poin)} Poin</span>`);const P=l.variants&&l.variants.length?l.variants.reduce((U,K)=>U+(parseFloat(K.totalSold)||0),0):parseFloat(l.totalSold)||0,q=P>0?`<span class="bg-slate-200 text-slate-700 dark:bg-slate-700 dark:text-slate-300 px-2 py-0.5 rounded-full text-[8px] font-bold flex items-center gap-1 whitespace-nowrap uppercase tracking-wider"><i class="fa-solid fa-fire-flame-curved text-orange-400"></i> ${P} Terjual</span>`:"";let I=`<div class="mb-2.5 flex flex-wrap gap-1.5 items-center overflow-hidden shrink-0">
            ${v}
            ${A}
            ${C}
            ${q}
        ...
        `:s=`
            <div class="relative w-full aspect-square bg-white rounded-3xl overflow-hidden shadow-2xl border border-slate-200 dark:border-slate-800 flex items-center justify-center">
                <img loading="lazy" decoding="async" class="w-full h-full object-contain" src="${pe(M.img||"","w800-rw")}" alt="${c(M.name)}">
            </div>
            <div class="mt-5 text-center px-4 w-full">
                <h4 class="text-white font-extrabold text-lg md:text-xl tracking-wide uppercase break-words leading-tight">${c(t.name)}</h4>
                <p class="text-[var(--color-primary)] font-extrabold text-lg mt-1 tracking-tight">${o}</p>
        ...
        `,r.innerHTML=s,a.classList.contains("hidden")&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("variantPreview"),j("variant-preview-modal"),setTimeout(()=>{a.classList.remove("opacity-0"),r.classList.remove("scale-95")},10)},po=()=>{if(!M)return;const e=m("variant-preview-modal"),t=m("variant-preview-content");if(!e||!t)return;const a=M.variants&&ae!==null?M.variants[ae]:null,r=a?.img||M.img||"",s=a?`${c(M.name)} - ${c(a.name)}`:c(M.name),o=x(a?.price??M.price);let i=`
        <div class="relative w-full aspect-square bg-white rounded-3xl overflow-hidden shadow-2xl border border-slate-200 dark:border-slate-800 flex items-center justify-center">
    ...
    `;t.innerHTML=i,e.classList.contains("hidden")&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("variantPreview"),j("variant-preview-modal"),setTimeout(()=>{e.classList.remove("opacity-0"),t.classList.remove("scale-95")},10)},mo=(e=!1)=>{const t=m("variant-preview-modal"),a=m("variant-preview-content");if(t&&a){const r=()=>{t.classList.add("opacity-0"),a.classList.add("scale-95"),setTimeout(()=>{$("variant-preview-modal"),a.innerHTML=""},300)};typeof window.requestCloseModal=="function"?window.requestCloseModal("variantPreview",e,r):r()}},uo=e=>{Rt(M?.video)&&(window.cSlideIdx+=e,window.cSlideIdx>1&&(window.cSlideIdx=0),window.cSlideIdx<0&&(window.cSlideIdx=1),Ut())},Ut=()=>{if(!M)return;let e=M,t=e.isActive!=="false"&&e.isActive!==!1,a=e.variants?.length>0;const r=(e.name||"").toLowerCase(),s=(e.category||"").toLowerCase(),o=(e.tag||"").toLowerCase(),i=["cat","paint","warna","colour","color","putih","hitam","merah","biru","hijau","kuning","orange","abu","coklat","cream","krem","beige","ivory","mocca","rose","tosca","lavender","salmon","broken white","off white","natural","magnolia","primer","dasar","eksterior","exterior","interior","tembok","duco","gloss","matte","satin","semi gloss"],l=r.includes("cat")&&(r.includes("tembok")||r.includes("interior")||r.includes("eksterior")||r.includes("exterior"))||s.includes("cat")||s.includes("paint")||o.includes("cat")||o.includes("paint"),d=a&&e.variants.some(F=>{const y=(F.name||"").toLowerCase();return i.some(_=>y.includes(_))}),p=l||d,f=m("product-modal-paint-warning");f&&(p?f.classList.remove("hidden"):f.classList.add("hidden"));let g=a&&ae!==null?e.variants[ae]:null,u=g?.unit||e.unit||"Pcs";const w=m("product-modal-img"),v=m("product-modal-video-container"),h=Rt(e.video),A=g&&g.img,C=m("slide-prev"),P=m("slide-next"),q=m("slide-dots");if(h&&!A)if(C&&C.classList.remove("hidden"),P&&P.classList.remove("hidden"),q&&(q.classList.remove("hidden"),q.innerHTML=`
            ...
            `),window.cSlideIdx===1){w&&(w.style.display="none"),v&&(v.classList.remove("hidden"),v.innerHTML||(v.innerHTML=`<iframe class="w-full h-full pointer-events-none" src="https://www.youtube.com/embed/${h}?autoplay=1&mute=1&loop=1&playlist=${h}&enablejsapi=1&modestbranding=1&controls=0&rel=0&showinfo=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; compute-pressure"></iframe>`));const F=m("zoom-indicator");F&&F.classList.add("hidden")}else{v&&v.classList.add("hidden"),w&&(w.style.display="block",w.src=pe(g?.img||e.img||"","w600-rw"),w.style.opacity=1);const F=m("zoom-indicator");F&&F.classList.remove("hidden")}else{C&&C.classList.add("hidden"),P&&P.classList.add("hidden"),q&&q.classList.add("hidden"),v&&(v.innerHTML="",v.classList.add("hidden")),w&&(w.style.display="block",w.style.opacity=0,setTimeout(()=>{w.src=pe(g?.img||e.img||"","w600-rw"),w.style.opacity=1},150));const F=m("zoom-indicator");F&&F.classList.remove("hidden")}if(H("product-modal-title",e.name),a&&ae===null)T("product-modal-price",'<span class="text-base sm:text-lg text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider">Pilih Warna/Varian</span>');else{let F=g?.price??e.price,y=g?.priceNormal??e.priceNormal;const Y=(n.store.ppnEnabled===!0||n.store.ppnEnabled==="true")&&n.store.ppnType==="inclusive"?'<span class="text-[9px] font-bold text-amber-600 dark:text-amber-400 bg-amber-50 dark:bg-amber-900/30 px-1.5 py-0.5 rounded border border-amber-200 dark:border-amber-800 uppercase tracking-widest ml-2 align-middle inline-block">Inc. PPN</span>':"";let E="";if(y&&y>F){let G=Math.round((y-F)/y*100);E=`<div class="flex flex-col"><span class="text-[11px] text-rose-500 font-bold line-through mb-0.5 tracking-wide">${x(y)} <span class="bg-rose-100 text-rose-600 px-1.5 py-0.5 rounded ml-1 text-[9px] no-underline tracking-widest border border-rose-200">-${G}%</span></span><span>${x(F)} ${Y}</span></div>`}else E=`<span>${x(F)} ${Y}</span>`;T("product-modal-price",E)}const I=m("product-modal-desc");if(I){I.className="text-[13px] text-slate-600 dark:text-slate-400 font-medium leading-relaxed [&_ol]:list-decimal [&_ol]:pl-5 [&_ul]:list-disc [&_ul]:pl-5 [&_b]:font-bold [&_strong]:font-bold [&_img]:max-w-full [&_img]:rounded-xl [&_img]:my-2 [&_div]:my-1";const F=e.desc||"-";I.innerHTML=typeof DOMPurify<"u"?DOMPurify.sanitize(F,{ALLOWED_TAGS:["p","br","b","strong","i","em","u","s","span","div","h1","h2","h3","h4","ul","ol","li","a","img","table","thead","tbody","tr","th","td","blockquote","code","pre","hr"],ALLOWED_ATTR:["href","src","alt","title","class","style","target","rel","width","height","loading"],FORBID_TAGS:["script","iframe","object","embed","form","input"],FORBID_ATTR:["onclick","oninput","onload","onmouseover","onsubmit","onerror"]}):F}const S=m("product-modal-spec-table");if(S)if(e.specTable&&e.specTable.length>0){let F=`
            <div class="mt-5">
                ...
                <div class="overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm">
                    <table class="w-full text-[13px] spec-product-table">
                        <tbody>`;e.specTable.forEach((y,_)=>{const Y=_%2===0?"bg-white dark:bg-slate-900":"bg-slate-50/80 dark:bg-slate-800/60";F+=`<tr class="${Y}">
                ...
                </tr>`}),F+="</tbody></table></div></div>",S.innerHTML=typeof DOMPurify<"u"?DOMPurify.sanitize(F,{ALLOWED_TAGS:["div","p","i","table","tbody","tr","td","th","thead","br","span"],ALLOWED_ATTR:["class","style"]}):F,S.style.display=""}else S.innerHTML="",S.style.display="none";H("modal-unit-label",u);let U="";e.sku&&(U+=`<span class="bg-slate-200 text-slate-600 dark:bg-slate-800 dark:text-slate-400 px-2.5 py-1 rounded-full text-[9px] font-bold flex items-center gap-1.5 whitespace-nowrap tracking-wider"><i class="fa-solid fa-barcode"></i> ${c(e.sku)}</span>`),e.tag&&(U+=`<span class="accent-badge px-2.5 py-1 rounded-full text-[9px] font-bold flex items-center gap-1.5 whitespace-nowrap uppercase tracking-wider"><i class="fa-solid fa-hashtag"></i> ${c(e.tag)}</span>`),U+='<span class="accent-badge px-2.5 py-1 rounded-full text-[9px] font-bold flex items-center gap-1.5 whitespace-nowrap uppercase tracking-wider"><i class="fa-solid fa-circle-check"></i> Official</span>',e.brand&&(U+=`<span class="bg-slate-200 text-slate-700 dark:bg-slate-800 dark:text-slate-300 px-2.5 py-1 rounded-full text-[9px] font-bold flex items-center gap-1.5 whitespace-nowrap uppercase tracking-wider"><i class="fa-solid fa-tag"></i> ${c(e.brand)}</span>`),e.poTime&&(U+=`<span class="bg-amber-500 text-white px-2.5 py-1 rounded-full text-[9px] font-bold flex items-center gap-1.5 whitespace-nowrap uppercase tracking-wider shadow-sm"><i class="fa-solid fa-clock"></i> PO ${c(e.poTime)}</span>`);const K=g&&parseFloat(g.poin)>0?parseFloat(g.poin):parseFloat(e.poin)||0;K>0&&(!a||ae!==null)&&(U+=`<span class="bg-[var(--color-primary)] text-white px-2.5 py-1 rounded-full text-[9px] font-bold flex items-center gap-1.5 whitespace-nowrap uppercase tracking-wider shadow-sm"><i class="fa-solid fa-star"></i> +${K} Poin</span>`);const ne=a&&ae!==null?parseFloat(g?g.totalSold:0)||0:a?e.variants.reduce((F,y)=>F+(parseFloat(y.totalSold)||0),0):parseFloat(e.totalSold)||0;ne>0&&(U+=`<span class="bg-slate-200 text-slate-600 dark:bg-slate-800 dark:text-slate-400 px-2.5 py-1 rounded-full text-[9px] font-bold flex items-center gap-1.5 whitespace-nowrap uppercase tracking-wider"><i class="fa-solid fa-fire-flame-curved text-orange-400"></i> ${ne} Terjual</span>`),T("product-modal-badges",U),T("product-modal-wholesale-container",e.wholesale?.length&&!e.variants?.length?`
        <div class="mb-6 bg-amber-50 dark:bg-amber-900/10 rounded-2xl p-4 border border-amber-200 dark:border-amber-800/50 shadow-inner">
            ...
            <div class="space-y-2">${e.wholesale.slice().sort((F,y)=>F.minQty-y.minQty).map(F=>`
            ...
            <div class="mb-6 bg-[rgba(var(--color-primary-rgb),0.05)] dark:bg-[rgba(var(--color-primary-rgb),0.08)] rounded-2xl p-4 border border-[var(--color-primary)]/20">
            ...
            </div>`}else he.innerHTML="";if(t)if(a&&ae===null?($("modal-active-controls"),$("modal-inactive-controls")):(a?g.isActive!==!1&&g.isActive!=="false":!0)?(j("modal-active-controls"),$("modal-inactive-controls")):($("modal-active-controls"),j("modal-inactive-controls")),a){j("product-modal-options-container");let F='<div class="grid grid-cols-[repeat(auto-fill,minmax(80px,1fr))] sm:grid-cols-[repeat(auto-fill,minmax(95px,1fr))] gap-2 sm:gap-3 w-full">';F+=e.variants.map((y,_)=>{let Y=y.isActive!==!1&&y.isActive!=="false";const E=n.store.useStock===!0||n.store.useStock==="true",G=parseFloat(y.stock)||0,Q=E&&G<=0;let X=Y&&!Q,pt=y.colorCode?`<span class="w-10 h-10 sm:w-12 sm:h-12 rounded-full shadow-inner border border-slate-300 dark:border-slate-600 mb-2 shrink-0" style="background-color: ${c(y.colorCode)};"></span>`:"",Ee="";X?_===ae?Ee="bg-[rgba(var(--color-primary-rgb),0.08)] border-[var(--color-primary)] text-[var(--color-primary)] dark:bg-[rgba(var(--color-primary-rgb),0.12)] dark:text-[var(--color-primary)] shadow-sm":Ee="bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 text-slate-500 dark:text-slate-400 hover:border-[var(--color-primary)]/40 hover:shadow-sm":Ee="bg-slate-100 dark:bg-slate-800/50 border-slate-200 dark:border-slate-700 text-slate-500 dark:text-slate-400 opacity-60 cursor-not-allowed";const mt=X&&(y.colorCode||y.img)?`<span onclick="event.stopPropagation(); previewVariant(${_})" class="absolute top-1.5 right-1.5 w-5 h-5 rounded-full bg-white/90 dark:bg-slate-700/90 shadow-sm flex items-center justify-center text-slate-500 hover:text-[var(--color-primary)] hover:scale-110 active:scale-90 transition-all border border-slate-200/50 dark:border-slate-600/50" title="Perbesar"><i class="fa-solid fa-magnifying-glass-plus text-[9px]"></i></span>`:"";return`<button ${X?"":"disabled"} class="relative p-2.5 sm:p-3 rounded-xl text-[10px] sm:text-[11px] font-bold uppercase tracking-wide border-2 transition-all active:scale-95 flex flex-col items-center justify-start text-center h-full ${Ee}" ${X?`onclick="selectVariant(${_})"`:""}>
                    ${mt}
                    ${pt} 
                ...
                </button>`}).join(""),F+="</div>",T("product-modal-options",F)}else $("product-modal-options-container");else $("modal-active-controls"),j("modal-inactive-controls"),$("product-modal-options-container");Ht()},Ht=()=>{if(!M)return;if(M.variants?.length>0&&ae===null){H("btn-modal-price-preview","Rp 0");return}let e=(M.variants||[])[ae],a=e?.price??M.price;const r=e?.name||null;let s=0;r?s=parseFloat(R.find(i=>i.id===M.id&&i.variantName===r)?.qty||0):s=R.filter(i=>i.id===M.id).reduce((i,l)=>i+(parseFloat(l.qty)||0),0);let o=Te+s;if(M.wholesale?.length){for(let i of M.wholesale.slice().sort((l,d)=>d.minQty-l.minQty))if(o>=parseFloat(i.minQty)){a=i.price;break}}H("btn-modal-price-preview",x(a*Te))},fo=e=>{const t=n.store.useStock===!0||n.store.useStock==="true",a=M?.variants?.[ae],r=a?.name||null,s=t?r?parseFloat(a?.stock)||0:parseFloat(M?.stock)||0:1/0,o=parseFloat(Math.min(s,Math.max(.01,Te+e)).toFixed(2));ua(o),se("modal-qty-input",Te),Ht(),t&&s!==1/0&&Te>=s&&b(`Maks stok: ${s}`)},bo=e=>{const t=n.store.useStock===!0||n.store.useStock==="true",a=M?.variants?.[ae],r=a?.name||null,s=t?r?parseFloat(a?.stock)||0:parseFloat(M?.stock)||0:1/0;let o=parseFloat(e);(isNaN(o)||o<=0)&&(o=.01),o=Math.min(s,o);const i=parseFloat(o.toFixed(2));ua(i),se("modal-qty-input",Te),Ht()},go=e=>{Zt(e),Ut()},xo=()=>{if(M.variants?.length>0&&ae===null)return b("Pilih varian / warna terlebih dahulu!");if(n.store.useStock===!0||n.store.useStock==="true"){const o=M.variants?.[ae],i=o?.name||null,l=i?parseFloat(o.stock)||0:parseFloat(M.stock)||0,d=R.find(f=>f.id===M.id&&f.variantName===i),p=d&&parseFloat(d.qty)||0;if(Te+p>l)return b(`Stok tidak cukup! Tersisa: ${l}`)}const t=M.variants?.[ae],a=t?.name||null,r=R.find(o=>o.id===M.id&&o.variantName===a),s=t?.unit||M.unit||"pcs";if(r)r.qty=parseFloat((r.qty+Te).toFixed(2)),r.unit=s;else{const o=t&&parseFloat(t.poin)>0?parseFloat(t.poin):parseFloat(M.poin)||0;R.push({id:M.id,name:M.name,variantName:a,price:t?.price??M.price,img:t?.img||M.img,qty:Te,unit:s,poTime:M.poTime||"",colorCode:t?.colorCode||"",poin:o})}Ae(),typeof analytics<"u"&&analytics.logEvent("add_to_cart",{item_id:M.id,item_name:M.name,quantity:Te}),wa(),b("Berhasil Masuk Keranjang")},wo=()=>{if(M.variants?.length>0&&ae===null)return b("Pilih varian / warna terlebih dahulu!");const e=M.variants?.[ae],t=e?.name||null;if(me.find(a=>a.id===M.id&&a.variantName===t))return b("Sudah di Favorit!");me.push({id:M.id,name:M.name,variantName:t,price:e?.price??M.price,img:e?.img||M.img,colorCode:e?.colorCode||""}),te("freshmart_wishlist",JSON.stringify(me)),typeof window.updWish=="function"&&window.updWish(),wa(),b("Masuk Favorit ❤️")},ho=()=>{if(!M)return;const e=window.location.origin+window.location.pathname+"?p="+M.id,t=M.name,a=`Cek produk ${M.name} di ${n.store.name} sekarang!`;if(navigator.share)navigator.share({title:t,text:a,url:e}).catch(r=>{console.log("User membatalkan share",r)});else if(navigator.clipboard&&navigator.clipboard.writeText)navigator.clipboard.writeText(e).then(()=>b("Link produk berhasil disalin!")).catch(()=>b("Gagal menyalin link."));else{const r=document.createElement("textarea");r.value=e,r.style.position="fixed",r.style.opacity="0",document.body.appendChild(r),r.select(),document.execCommand("copy"),document.body.removeChild(r),b("Link produk berhasil disalin!")}};window.openProductModal=no;window.closeProductModal=wa;window.previewVariant=co;window.previewProductImage=po;window.closeVariantPreviewModal=mo;window.changeSlide=uo;window.rProdMod=Ut;window.uMPP=Ht;window.updateModalQty=fo;window.handleModalQtyChange=bo;window.selectVariant=go;window.confirmAddProductToCart=xo;window.confirmAddToWishlist=wo;window.shareProduct=ho;let ea=[];const Vt=()=>{try{localStorage.setItem("freshmart_my_orders",JSON.stringify(ie))}catch(e){console.warn("[MyOrders] Gagal menyimpan ke localStorage:",e)}},vo=()=>{try{const e=localStorage.getItem("freshmart_my_orders");if(e){const t=JSON.parse(e);Array.isArray(t)&&t.length>0&&$t(t)}}catch(e){console.warn("[MyOrders] Gagal memuat dari localStorage:",e)}return ie},Os=()=>{ea.forEach(e=>{try{typeof e=="function"&&e()}catch{}}),ea=[]},qs=()=>{Os(),ie.filter(a=>{const r=a.status==="Selesai"||a.status==="Dibatalkan",s=a.claimedReward&&(a.claimedReward.status==="Menunggu Persetujuan"||!a.claimedReward.status);return!r||s}).slice(0,10).forEach(a=>{const r=a.orderId;if(!r)return;const s=k.collection("freshmart_orders").doc(r).onSnapshot(o=>{if(!o.exists)return;const i=o.data(),l=i.status,d=i.claimedReward?i.claimedReward.status:null,p=i.claimedReward&&i.claimedReward.note||"";let f=!1,g="";const u=ie.find(w=>w.orderId===r);if(u){if(l&&u.status!==l){const w=u.status;u.status=l,f=!0,w!==void 0&&(g=`Pesanan #${r.split("-").pop()} kini: ${l}`)}u.claimedReward&&d&&(u.claimedReward.status!==d||u.claimedReward.note!==p)&&(u.claimedReward.status=d,u.claimedReward.note=p,f=!0),f&&(Vt(),window.curViewName==="view-orders"&&Pt(),g&&b(g))}},o=>{console.warn("[MyOrders Realtime] Snapshot error:",o.message)});ea.push(s)})},Pt=async()=>{if(vo(),!ie.length){j("orders-empty-state"),$("btn-clear-orders"),j("spacer-orders"),T("orders-items-container","");return}$("orders-empty-state"),j("btn-clear-orders"),$("spacer-orders"),qs(),T("orders-items-container",ie.map((e,t)=>{const a=new Date(e.date).toLocaleDateString("id-ID",{day:"numeric",month:"short",year:"numeric"});let r="text-slate-500 border-slate-200 bg-slate-50 dark:bg-slate-800 dark:border-slate-700",s="fa-clock";return e.status==="Baru"?(r="text-rose-600 border-rose-200 bg-rose-50 dark:bg-rose-900/30 dark:border-rose-800 dark:text-rose-400",s="fa-asterisk"):e.status==="Diproses"?(r="text-[var(--color-primary)] border-[var(--color-primary)]/30 bg-[rgba(var(--color-primary-rgb),0.08)] dark:bg-[rgba(var(--color-primary-rgb),0.15)] dark:border-[var(--color-primary)]/40",s="fa-spinner fa-spin"):e.status==="Selesai"?(r="text-[var(--color-primary)] border-[var(--color-primary)]/30 bg-[rgba(var(--color-primary-rgb),0.08)] dark:bg-[rgba(var(--color-primary-rgb),0.15)] dark:border-[var(--color-primary)]/40",s="fa-check-double"):e.status==="Dibatalkan"&&(r="text-slate-400 border-slate-200 bg-slate-100 dark:bg-slate-800 dark:border-slate-700 dark:text-slate-400",s="fa-xmark"),`
        <div class="bg-white dark:bg-slate-800 p-4 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm relative overflow-hidden group min-w-0 transition-all hover:border-[var(--color-primary)]/40">
            ...
            <div class="flex gap-3 items-center border-b border-slate-100 dark:border-slate-700/50 py-3 last:border-0">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    `:""}
                    <p class="text-[10px] font-medium text-slate-500 dark:text-slate-400">${U} ${c(S.unit||"pcs")} x ${x(K)}</p>
            ...
            `}).join("");let w="Tanggal Tidak Tersedia";try{let S;if(t.timestamp&&typeof t.timestamp.toDate=="function")S=t.timestamp.toDate();else{const U=t.timestamp||t.dateString||Date.now();if(typeof U=="number")S=new Date(U);else if(!isNaN(Number(U))&&String(U).trim()!=="")S=new Date(Number(U));else{const K=String(U).replace(/-/g,"/").replace("T"," ").replace(/\..*$/,"");S=new Date(U),isNaN(S.getTime())&&(S=new Date(K))}}S&&!isNaN(S.getTime())&&(w=S.toLocaleString("id-ID",{day:"numeric",month:"short",year:"numeric",hour:"2-digit",minute:"2-digit"}))}catch(S){console.error("Gagal memproses tanggal:",S)}const v=t.payment&&t.payment.subtotal?t.payment.subtotal:0,h=t.payment&&t.payment.shippingCost?t.payment.shippingCost:0,A=t.payment&&t.payment.productDiscount?t.payment.productDiscount:0,C=t.payment&&t.payment.shippingDiscount?t.payment.shippingDiscount:0,P=t.payment&&t.payment.ppnAmount?t.payment.ppnAmount:0,q=t.payment&&t.payment.ppnRate?t.payment.ppnRate:0,I=t.payment&&t.payment.grandTotal?t.payment.grandTotal:0;r.innerHTML=`
            <div class="bg-white dark:bg-slate-900 w-full max-w-lg rounded-t-3xl sm:rounded-2xl max-h-[88vh] flex flex-col shadow-2xl transform translate-y-full sm:translate-y-10 scale-100 transition-transform duration-300 border border-slate-200 dark:border-slate-700 overflow-hidden" id="order-detail-content">
                ...
                <div class="p-4 sm:p-5 overflow-y-auto flex-1 space-y-5 custom-scrollbar text-sm">
                    ...
                    <div class="bg-slate-100 dark:bg-slate-800 p-4 rounded-xl space-y-2 text-xs">
                        <div class="flex justify-between text-slate-600 dark:text-slate-400"><p>Subtotal Produk</p><p class="font-bold text-slate-800 dark:text-white">${x(v)}</p></div>
                        ...
                        ${A>0?`<div class="flex justify-between text-rose-500"><p>Diskon Promo</p><p class="font-bold">-${x(A)}</p></div>`:""}
                        ${(()=>{if(P<=0)return"";const S=t.payment?.ppnType==="inclusive",U=v-A+(h-C),K=t.payment?.dppAmount||(S?Math.round(U*100/(100+q)):Math.max(0,U));return`
                            ...
                            <div class="flex justify-between text-amber-600 dark:text-amber-400"><p>${S?"Termasuk PPN":"PPN"} (${q}%)</p><p class="font-bold">${S?"":"+"}${x(P)}</p></div>
                            `})()}
        ...
        `,r.classList.contains("opacity-0")&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("customerOrder"),r.classList.remove("opacity-0","pointer-events-none"),setTimeout(()=>{const S=document.getElementById("order-detail-content");S&&(S.classList.remove("translate-y-full","sm:translate-y-10"),S.classList.add("translate-y-0","sm:translate-y-0"))},50)}catch(r){console.error("Error Render HTML Modal:",r),b("Gagal menampilkan detail. Coba lagi.")}},So=(e=!1)=>{const t=()=>{const a=document.getElementById("order-detail-modal"),r=document.getElementById("order-detail-content");r&&(r.classList.remove("translate-y-0","sm:translate-y-0"),r.classList.add("translate-y-full","sm:translate-y-10")),setTimeout(()=>{a&&a.classList.add("opacity-0","pointer-events-none")},300)};typeof window.requestCloseModal=="function"?window.requestCloseModal("customerOrder",e,t):t()};window.attachMyOrdersRealtime=qs;window.detachMyOrdersRealtime=Os;window.renderMyOrders=Pt;window.checkOrderStatus=yo;window.trackOrderManual=ko;window.clearMyOrders=$o;window.openCustomerOrderDetail=ta;window.renderOrderDetailModal=Us;window.closeCustomerOrderDetailModal=So;window.reviewPhotoFile=null;window.reviewRating=0;const Po=(e,t,a,r,s)=>{const o=decodeURIComponent(a||""),i=decodeURIComponent(r||""),l=decodeURIComponent(s||"");let d=document.getElementById("review-modal");d||(d=document.createElement("div"),d.id="review-modal",d.className="fixed inset-0 z-[120] bg-slate-900/70 backdrop-blur-sm flex items-end sm:items-center justify-center p-0 sm:p-5",d.onclick=p=>{p.target===d&&ha()},document.body.appendChild(d)),window.reviewPhotoFile=null,window.reviewRating=0,d.innerHTML=`
        <div class="bg-white dark:bg-slate-900 w-full max-w-lg rounded-t-[2rem] sm:rounded-[2rem] max-h-[85vh] flex flex-col shadow-2xl border border-slate-200 dark:border-slate-700">
            <div class="p-5 sm:p-6 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center shrink-0">
                <div class="min-w-0">
        ...
        </div>`,m("review-submit-btn").onclick=()=>va(e,t,o,i,l),d.style.opacity="0",d.style.display="flex",requestAnimationFrame(()=>{d.style.transition="opacity 0.25s ease",d.style.opacity="1"}),typeof window.pushModalHistory=="function"&&window.pushModalHistory("review")},To=e=>{window.reviewRating=e,document.querySelectorAll(".review-star").forEach(t=>{const a=parseInt(t.dataset.star);t.classList.toggle("text-amber-400",a<=e),t.classList.toggle("text-slate-300",a>e),t.classList.toggle("dark:text-slate-600",a>e)})},Ao=e=>{const t=e.target.files[0];if(!t)return;if(!t.type.startsWith("image/")){b("Hanya file gambar yang diizinkan!");return}if(t.size>5*1024*1024){b("Ukuran gambar max 5MB!");return}window.reviewPhotoFile=t;const a=new FileReader;a.onload=r=>{m("review-photo-preview").src=r.target.result,j("review-photo-preview-wrap"),$("review-photo-btn")},a.readAsDataURL(t)},Mo=()=>{window.reviewPhotoFile=null,$("review-photo-preview-wrap"),j("review-photo-btn");const e=m("review-photo-input");e&&(e.value="")},ha=(e=!1)=>{const t=document.getElementById("review-modal");!t||t.style.display==="none"||(t.style.opacity="0",t.style.transition="opacity 0.25s ease",setTimeout(()=>{t.style.display="none",t.style.opacity="",t.style.transition=""},250),!e&&ke.length&&ke[ke.length-1]==="review"&&(ke.pop(),history.back()))},va=async(e,t,a,r,s)=>{if(!window.reviewRating||window.reviewRating<1)return b("Silakan beri bintang terlebih dahulu!");if(!Ke){ee(!0),O("Mengirim ulasan...");try{let o="";if(window.reviewPhotoFile&&typeof window.uploadBuktiToGDrive=="function"){const d=await window.uploadBuktiToGDrive(window.reviewPhotoFile,"review-"+e);d?o=d:b("Foto gagal diupload, ulasan tetap dikirim tanpa foto.")}const i=Date.now(),l={id:i,orderId:e||"",productId:t??0,variantName:a||"",productName:r||"",customerName:s||"Pelanggan",rating:window.reviewRating,text:L("review-text")||"",photoUrl:o||"",adminReply:"",isVisible:!0,createdAt:ue.firestore.FieldValue.serverTimestamp()};await k.collection("freshmart").doc("cms_data").collection("reviews").doc(i.toString()).set(l),aa.delete(t),ha(),b("✅ Terima kasih atas ulasan Anda!"),typeof window.openCustomerOrderDetail=="function"&&window.openCustomerOrderDetail(e)}catch(o){console.error("Gagal mengirim ulasan:",o),b("Gagal mengirim ulasan: "+(o.message||"Error tidak diketahui"))}finally{ee(!1),D()}}},aa=new Map,Do=5*60*1e3,Co=async e=>{if(!m("product-modal-reviews-container"))return;const a=s=>{const o=s.length?s.reduce((p,f)=>p+(parseFloat(f.rating)||0),0)/s.length:0,i=p=>Array.from({length:5},(f,g)=>`<i class="fa-solid fa-star ${g<Math.round(p)?"text-amber-400":"text-slate-200 dark:text-slate-700"}"></i>`).join("");let l=`
            <div class="flex items-center justify-between mb-4">
            ...
            </div>`;if(!s.length){T("product-modal-reviews-container",l+'<p class="text-[11px] font-bold text-slate-400 text-center py-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl">Belum ada ulasan untuk produk ini.</p>');return}const d=s.map(p=>{let f="";try{p.createdAt&&p.createdAt.toDate&&(f=p.createdAt.toDate().toLocaleDateString("id-ID",{day:"numeric",month:"short",year:"numeric"}))}catch{}return`
        ...
        `)},r=Ba.get(e);if(r&&Date.now()-r.timestamp<Io){a(r.data);return}T("admin-report-container",'<div class="text-center py-10"><i class="fa-solid fa-spinner fa-spin text-2xl text-slate-300"></i></div>');let s=null;const o=new Date;if(e==="today")s=new Date(o.getFullYear(),o.getMonth(),o.getDate());else if(e==="week"){const g=o.getDay(),u=g===0?6:g-1;s=new Date(o.getFullYear(),o.getMonth(),o.getDate()-u)}else e==="month"&&(s=new Date(o.getFullYear(),o.getMonth(),1));let i=0,l=0,d=0,p=0,f=!1;try{if(!ge.currentUser){T("admin-report-container",'<div class="text-center py-10 text-slate-400"><i class="fa-solid fa-lock text-2xl mb-3"></i><p class="text-xs font-bold">Login terlebih dahulu untuk melihat laporan.</p></div>');return}let g=k.collection("freshmart_orders");s&&(g=g.where("timestamp",">=",ue.firestore.Timestamp.fromDate(s)));const u=await g.limit(3e3).get();f=u.size>=3e3,u.forEach(v=>{const h=v.data();h.status!=="Dibatalkan"&&(p++,i+=parseFloat(h.payment?.subtotal)||0,d+=parseFloat(h.payment?.productDiscount)||0,(h.items||[]).forEach(A=>{const C=A.hpp!==void 0&&A.hpp!==null?parseFloat(A.hpp):typeof window.getEffHpp=="function"?window.getEffHpp(A):0;l+=(parseFloat(C)||0)*(parseFloat(A.qty)||0)}))});const w={totalPenjualan:i,totalHppTerjual:l,totalDiskonProduk:d,orderCount:p,truncated:f};Ba.set(e,{data:w,timestamp:Date.now()}),a(w)}catch(g){console.error("Gagal memuat laporan penjualan:",g)}},jo=async()=>{const e=L("login-username"),t=L("login-password");if(!e||!t)return b("Email & Password wajib diisi!");O("Verifikasi Login...");try{if(await ge.signInWithEmailAndPassword(e,t),!ge.currentUser||ge.currentUser.uid!==da){const a=ge.currentUser?ge.currentUser.uid:"null";throw await ge.signOut(),new Error("UID_MISMATCH: "+a)}window.isAdm=!0,history.replaceState({view:"view-admin"},"",window.location.href),typeof window.changeView=="function"&&window.changeView("view-admin",!0),Lt(),b("Login Berhasil!")}catch(a){if(console.error(a),a.message&&a.message.startsWith("UID_MISMATCH:")){const r=a.message.replace("UID_MISMATCH: ","");b("Login Ditolak: UID Anda ("+r+") tidak cocok dengan ADMIN_UID!")}else b("Login Ditolak: Email atau Password salah!")}finally{D()}},Vs=async()=>{O("Keluar...");try{await ge.signOut(),window.isAdm=!1,window.__localIsAdm=!1,window.isPro=!1,typeof window.updateProBadge=="function"&&window.updateProBadge(),qe&&(qe(),xt(null)),Re&&(Re(),ft(null)),Fe&&(Fe(),bt(null)),b("Berhasil Logout"),typeof window.changeView=="function"&&window.changeView("view-catalog")}catch{b("Gagal Logout")}finally{D()}},Eo=()=>{Le("Keluar Seller","Apakah anda akan keluar dari dashboard seller?",()=>{Vs()},"Ya, Keluar")};window.checkAdminAccess=Lo;window.openAdminMenu=Lt;window.toggleTaxMenuVisibility=ka;window.computeInventoryStats=Gt;window.loadAdminReport=Hs;window.processAdminLogin=jo;window.logoutAdmin=Vs;window.confirmLogoutAdmin=Eo;const _o=async()=>{if(!ce||ce.length===0)return b("Belum ada data pesanan!");O("Menyiapkan modul Excel...");try{await Ds("https://cdn.sheetjs.com/xlsx-0.20.3/package/dist/xlsx.full.min.js",()=>typeof XLSX<"u")}catch{D(),b("Gagal memuat modul Excel. Cek koneksi internet Anda.");return}D();let e=[];ce.forEach((o,i)=>{let l=o.dateString?new Date(o.dateString).toLocaleString("id-ID"):"-",d=o.customer?.name||"Anonim",p=o.customer?.deliveryMethod==="delivery"?"Dikirim":"Ambil di Toko",f=o.status||"-",g=o.items?o.items.reduce((w,v)=>w+(parseFloat(v.qty)||0),0):0,u=o.payment?.grandTotal||0;e.push({No:i+1,"ID Pesanan":o.orderId,Tanggal:l,"Nama Pelanggan":d,"Metode Kirim":p,Status:f,"Total Item":g,"Total Tagihan (Rp)":u})});const t=XLSX.utils.json_to_sheet(e),a=XLSX.utils.book_new();XLSX.utils.book_append_sheet(a,t,"Laporan Pesanan");const r=[{wch:5},{wch:25},{wch:22},{wch:25},{wch:15},{wch:15},{wch:12},{wch:20}];t["!cols"]=r;const s=new Date().toISOString().split("T")[0];XLSX.writeFile(a,`Laporan_Pesanan_${s}.xlsx`),b("Laporan Excel (.xlsx) berhasil diunduh!")},Ro=()=>{try{const e=new(window.AudioContext||window.webkitAudioContext),t=e.createOscillator(),a=e.createGain();t.connect(a),a.connect(e.destination),t.type="sine",t.frequency.setValueAtTime(800,e.currentTime),a.gain.setValueAtTime(1,e.currentTime),t.frequency.setValueAtTime(600,e.currentTime+.2),t.frequency.setValueAtTime(800,e.currentTime+.6),a.gain.setValueAtTime(1,e.currentTime+.6),t.frequency.setValueAtTime(600,e.currentTime+.8),a.gain.exponentialRampToValueAtTime(1e-5,e.currentTime+1.5),t.start(e.currentTime),t.stop(e.currentTime+1.5)}catch{}},Fo=()=>{T("admin-content",`
    ...
    `);const e=()=>{qe&&(qe(),xt(null));let t=!0;const a=k.collection("freshmart_orders").orderBy("timestamp","desc").limit(100).onSnapshot(r=>{if(Ra([]),!t){let o=!1;r.docChanges().forEach(i=>{i.type==="added"&&i.doc.data().status==="Baru"&&(o=!0)}),o&&(b("🔔 Pesanan Baru Masuk!"),Ro())}if(t=!1,r.empty){T("admin-orders-list",'<div class="flex flex-col items-center justify-center py-20 text-slate-400 font-bold bg-white dark:bg-slate-800 rounded-[1.5rem] border border-slate-200 dark:border-slate-700 shadow-sm text-center"><i class="fa-solid fa-receipt text-5xl mb-4 opacity-30"></i>Belum ada pesanan</div>'),H("stat-orders",0);return}H("stat-orders",r.size+(r.size===100?"+":""));const s=[];T("admin-orders-list",r.docs.map(o=>{const i=o.data();s.push(i);let l="text-slate-500 border-slate-200 dark:border-slate-600",d="fa-clock",p="bg-slate-50 dark:bg-slate-700/50",f="text-slate-400";i.status==="Baru"?(l="text-rose-500 border-rose-200 bg-rose-50 dark:bg-rose-900/20 dark:border-rose-800 animate-pulse",d="fa-asterisk",p="bg-rose-500",f="text-white shadow-md shadow-rose-500/30"):i.status==="Diproses"?(l="text-[var(--color-primary)] border-[var(--color-primary)]/30 bg-[rgba(var(--color-primary-rgb),0.06)] dark:bg-[rgba(var(--color-primary-rgb),0.10)] dark:border-[var(--color-primary)]/30",d="fa-spinner fa-spin",p="primary-bg",f="shadow-sm"):i.status==="Selesai"?(l="text-[var(--color-primary)] border-[var(--color-primary)]/30 bg-[rgba(var(--color-primary-rgb),0.06)] dark:bg-[rgba(var(--color-primary-rgb),0.10)] dark:border-[var(--color-primary)]/30",d="fa-check-double",p="primary-bg-soft",f="primary-text"):i.status==="Dibatalkan"&&(l="text-slate-400 border-slate-200 bg-slate-50 dark:bg-slate-800 dark:border-slate-700",d="fa-xmark",p="bg-slate-100 dark:bg-slate-800",f="text-slate-400");let g="fa-wallet text-slate-400",u=i.payment?.method||"";u==="transfer"?g="fa-building-columns text-[var(--color-primary)]":u==="qris"?g="fa-qrcode text-purple-500":u==="cod"?g="fa-hand-holding-dollar text-[var(--color-primary)]":u==="cashier"&&(g="fa-cash-register text-amber-500");let w=i.items?parseFloat(i.items.reduce((A,C)=>A+(parseFloat(C.qty)||0),0).toFixed(2)):0;const v=i.dateString?new Date(i.dateString).toLocaleDateString("id-ID",{day:"numeric",month:"short"}):"",h=(i.orderId||"").split("-").pop();return`
        ...
        </div>`);const r=m("admin-order-modal");r&&r.classList.contains("hidden")&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("adminOrder"),j("admin-order-modal"),setTimeout(()=>{m("admin-order-modal")&&m("admin-order-modal").classList.remove("opacity-0"),m("admin-order-modal-box")&&m("admin-order-modal-box").classList.remove("scale-95")},10)},No=async(e,t)=>{const r=(typeof window.normalizeWA=="function"?window.normalizeWA:s=>String(s||"").replace(/\D/g,"").replace(/^0/,"62"))(t);if(!r||r.length<10)return b("Nomor WA tidak valid!");O("Menyimpan...");try{const s=k.collection("freshmart").doc("cms_data").collection("customers").doc(r),o=await s.get();o.exists?(await s.set({name:e||o.data().name},{merge:!0}),b("Data pelanggan sudah ada, nama diperbarui.")):(await s.set({id:parseInt(r,10),name:e||"-",phone:r,points:0}),b("✅ Pelanggan baru disimpan ke database!"))}catch(s){console.error("Gagal simpan pelanggan:",s),b("Gagal menyimpan data pelanggan: "+(s.message||""))}finally{D()}},Bo=async(e,t)=>{if(t==="waiting_stock"&&typeof window.customPrompt=="function"){window.customPrompt("Catatan untuk pelanggan:","Stok hadiah kosong, akan kami kirim susulan begitu stok tersedia kembali.",async r=>{if(r!==null){O("Menyimpan...");try{await k.collection("freshmart_orders").doc(e).update({"claimedReward.status":t,"claimedReward.note":r||""}),b("Status klaim hadiah diperbarui!");let s=ce.findIndex(o=>o.orderId===e);s!==-1&&(ce[s].claimedReward||(ce[s].claimedReward={}),ce[s].claimedReward.status=t,ce[s].claimedReward.note=r||""),typeof window.openCustomerOrderDetail=="function"&&window.openCustomerOrderDetail(e)}catch(s){b("Gagal update klaim: "+s.message)}finally{D()}}});return}let a="";O("Menyimpan...");try{await k.collection("freshmart_orders").doc(e).update({"claimedReward.status":t,"claimedReward.note":a});const r=ce.find(s=>s.orderId===e);r&&(r.claimedReward.status=t,r.claimedReward.note=a,$a(e)),b("Status hadiah diperbarui!")}catch(r){console.error("Gagal update status hadiah:",r),b("Gagal update status hadiah: "+(r.message||""))}finally{D()}},Gs=(e=!1)=>{const t=()=>{m("admin-order-modal")&&m("admin-order-modal").classList.add("opacity-0"),m("admin-order-modal-box")&&m("admin-order-modal-box").classList.add("scale-95"),setTimeout(()=>$("admin-order-modal"),300)};typeof window.requestCloseModal=="function"?window.requestCloseModal("adminOrder",e,t):t()},Oo=async(e,t)=>{if(!Ke){ee(!0),O("Update...");try{await k.collection("freshmart_orders").doc(e).update({status:t});let a=ce.find(r=>r.orderId===e);a&&(a.status=t),$a(e),b("Status diupdate!")}catch{b("Gagal!")}finally{ee(!1),D()}}},qo=async e=>{if(!e)return b("ID pesanan tidak valid!");O("Memuat data...");try{const t=await k.collection("freshmart_orders").doc(e).get();if(D(),!t.exists)return b("Data pesanan tidak ditemukan!");const a=t.data(),r=a.customer&&a.customer.wa;if(!r)return b("Nomor WhatsApp pelanggan tidak tersedia!");const s=n&&n.store&&n.store.name?n.store.name:"Toko Kami",o=a.customer&&a.customer.name?a.customer.name:"Pelanggan",i=a.status||"Baru",l=a.payment&&a.payment.grandTotal?x(a.payment.grandTotal):"-",d=a.payment&&a.payment.method?a.payment.method.toUpperCase():"-",p=`Halo *${o}*! 👋
...
Kami akan segera memproses pesanan Anda. Terima kasih! 🙏`;window.open(`https://wa.me/${r}?text=${encodeURIComponent(p)}`,"_blank")}catch{D(),b("Gagal memuat data pesanan!")}},Uo=e=>{Le("Hapus Pesanan","Yakin ingin hapus permanen?",async()=>{if(!Ke){ee(!0),O("Menghapus...");try{await k.collection("freshmart_orders").doc(e).delete(),b("Terhapus!"),nt===e&&Gs()}catch{b("Gagal!")}finally{ee(!1),D()}}})};window.exportOrdersToExcel=_o;window.rAdmOrd=Fo;window.openOrderDetail=$a;window.saveOrderCustomerToDB=No;window.ackRewardClaim=Bo;window.closeOrderDetailModal=Gs;window.updateOrderStatus=Oo;window.konfirmasiKeWA=qo;window.deleteOrder=Uo;const Ho=()=>{const e=n.store.name||"Toko Grosir",t=n.store.themeColor||"#10b981",a=(o,i,l=!1)=>{let d=document.querySelector(`meta[${l?"property":"name"}="${o}"]`);d||(d=document.createElement("meta"),l?d.setAttribute("property",o):d.setAttribute("name",o),document.head.appendChild(d)),d.setAttribute("content",i)};a("theme-color",t),a("mobile-web-app-capable","yes"),a("apple-mobile-web-app-capable","yes"),a("apple-mobile-web-app-status-bar-style","black-translucent"),a("apple-mobile-web-app-title",e),a("application-name",e),a("msapplication-TileColor",t),document.title=e,localStorage.setItem("freshmart_theme_color",t),n.store.uiTheme&&n.store.uiTheme!==localStorage.getItem("freshmart_ui_theme")&&(localStorage.setItem("freshmart_ui_theme",n.store.uiTheme),yt(n.store.uiTheme));const r=n.store.bgStyle||localStorage.getItem("freshmart_bg_style")||"minimalist",s=n.store.bgCustomUrl!==void 0?n.store.bgCustomUrl:localStorage.getItem("freshmart_bg_custom_url")||"";kt(r,s)},Ks=()=>{T("admin-content",`
    ...
    `;if(T("admin-content",o),e==="profile"){const i=n.store.uiTheme||"",l=n.store.themeColor||"#10b981";(i==="custom"||!Ye?.[i])&&setTimeout(()=>{const p=document.getElementById("custom-color-chip");if(p){p.style.background=l;const f=p.querySelector("i");f&&(f.style.color="#fff")}},50)}},Wo=async e=>{if(!Ke){ee(!0),O("Menyimpan...");try{e==="profile"?(n.store.name=L("set-name"),n.store.slogan=L("set-slogan"),n.store.logo=W(L("set-logo")),n.store.description=L("set-description"),n.store.email=L("set-email"),n.store.showRewardCatalog=L("set-show-reward-catalog")==="true",n.store.operationalHours=L("set-hours"),n.store.footerCredit=L("set-credit"),n.store.themeColor=L("set-theme-color"),n.store.uiTheme=L("set-ui-theme"),n.store.bgStyle=L("set-bg-style")||"minimalist",n.store.bgCustomUrl=W(L("set-bg-custom-url")),localStorage.setItem("freshmart_theme_color",n.store.themeColor),localStorage.setItem("freshmart_ui_theme",n.store.uiTheme),localStorage.setItem("freshmart_bg_style",n.store.bgStyle),localStorage.setItem("freshmart_bg_custom_url",n.store.bgCustomUrl||""),yt(n.store.uiTheme,n.store.themeColor),kt(n.store.bgStyle,n.store.bgCustomUrl)):e==="catalog"?(n.store.categoryStyle=L("set-category-style"),n.store.brandStyle=L("set-brand-style"),n.store.showCategories=L("set-show-categories")==="true",n.store.showBrands=L("set-show-brands")==="true"):e==="shipping"?(n.store.wa=L("set-wa").replace(/\D/g,""),n.store.address=L("set-address"),n.store.costPerKm=L("set-cost"),n.store.isDeliveryEnabled=L("set-delivery-enabled")==="true",n.store.isPickupEnabled=L("set-pickup-enabled")==="true",n.store.lat=L("set-lat"),n.store.lng=L("set-lng")):e==="payment"?(n.payment||(n.payment={}),n.payment.qrisUrl=W(L("set-qris-url"))):e==="config"?(n.config||(n.config={}),n.config.gasUrl=L("set-gas-url"),b("Pengaturan GAS URL tersimpan.")):e==="operasional"&&(n.store.useStock=L("set-use-stock")==="true",n.store.ppnEnabled=L("set-ppn-enabled")==="true",n.store.ppnType=L("set-ppn-type")||"exclusive",n.store.ppnRate=parseFloat(L("set-ppn-rate"))||11,ka());const t={profile:"store",catalog:"store",shipping:"store",operasional:"store",payment:"payment",config:"config"};typeof window.saveApp=="function"&&await window.saveApp([t[e]||"store"]),e==="profile"||e==="config"?(b(e==="config"?"Sistem Diperbarui! Memuat Ulang...":"Warna Berubah! Memuat Ulang..."),setTimeout(()=>location.reload(),1500)):(b("Tersimpan!"),Ks())}catch{b("Gagal menyimpan pengaturan")}finally{ee(!1),D()}}},Qo=()=>{const e="data:text/json;charset=utf-8,"+encodeURIComponent(JSON.stringify(n,null,2)),t=document.createElement("a");t.href=e,t.download=`backup_freshmart_${new Date().toISOString().slice(0,10)}.json`,document.body.appendChild(t),t.click(),t.remove(),b("Backup diunduh!")},zo=e=>{const t=e.target.files[0];if(!t)return;const a=new FileReader;a.onload=async r=>{try{const s=JSON.parse(r.target.result);Object.assign(n,s),typeof window.saveApp=="function"&&await window.saveApp(),b("Data dipulihkan!"),setTimeout(()=>location.reload(),1e3)}catch{b("Gagal memulihkan data!")}},a.readAsText(t)};window.syncAppMeta=Ho;window.rAdmSet=Ks;window.selectPresetTheme=Vo;window.selectBgStyle=Go;window.openSettingForm=Ko;window.saveAdminSettings=Wo;window.backupData=Qo;window.restoreData=zo;let re=new Date().getFullYear(),oe=0,Ne="menu",Be=null;const Oe=["Jan","Feb","Mar","Apr","Mei","Jun","Jul","Agu","Sep","Okt","Nov","Des"],Jo=e=>{if(typeof window.getEffHpp=="function")return window.getEffHpp(e);const t=n.products?.find(a=>a.id===e.id);if(!t)return 0;if(e.variantName&&t.variants){const a=t.variants.find(r=>r.name===e.variantName);if(a&&a.hpp!=null)return parseFloat(a.hpp)||0}return parseFloat(t.hpp)||0},Oa=new Map,Yo=2*60*1e3,Sa=async e=>{const t=Oa.get(e);if(t&&Date.now()-t.timestamp<Yo)return t.data;const a={};for(let r=1;r<=12;r++)a[r]={omset:0,ppn:0,hpp:0,disc:0,orderCount:0};try{const r=new Date(e,0,1),s=new Date(e+1,0,1);(await k.collection("freshmart_orders").where("timestamp",">=",ue.firestore.Timestamp.fromDate(r)).where("timestamp","<",ue.firestore.Timestamp.fromDate(s)).limit(5e3).get()).forEach(l=>{const d=l.data();if(d.status==="Dibatalkan"||!d.timestamp||!d.timestamp.toDate)return;const p=d.timestamp.toDate().getMonth()+1;if(!a[p])return;const f=d.payment?.dppAmount!==void 0&&d.payment?.dppAmount!==null?parseFloat(d.payment.dppAmount):parseFloat(d.payment?.subtotal)||0;a[p].omset+=f,a[p].ppn+=parseFloat(d.payment?.ppnAmount)||0,a[p].disc+=parseFloat(d.payment?.productDiscount)||0,a[p].orderCount++,(d.items||[]).forEach(g=>{const u=g.hpp!==void 0&&g.hpp!==null?parseFloat(g.hpp):Jo(g);a[p].hpp+=(parseFloat(u)||0)*(parseFloat(g.qty)||0)})})}catch(r){console.error("Gagal memuat data pajak:",r),b("Gagal memuat data periode ini!")}return Oa.set(e,{data:a,timestamp:Date.now()}),a},ht=()=>Be?(oe===0?Object.keys(Be):[oe]).reduce((t,a)=>{const r=Be[a];return t.omset+=r.omset,t.ppn+=r.ppn,t.hpp+=r.hpp,t.disc+=r.disc,t.orderCount+=r.orderCount,t},{omset:0,ppn:0,hpp:0,disc:0,orderCount:0}):{omset:0,ppn:0,hpp:0,disc:0,orderCount:0},Pa=()=>{const e=n.taxSettings?.monthlyExpenses||{};return(oe===0?Array.from({length:12},(a,r)=>r+1):[oe]).reduce((a,r)=>a+(parseFloat(e[`${re}-${r}`])||0),0)},Xo=async()=>{T("admin-content",'<div class="text-center py-16"><i class="fa-solid fa-spinner fa-spin text-3xl text-slate-300"></i></div>'),Be=await Sa(re),Ta()},Ta=()=>{const e=Array.from({length:6},(r,s)=>new Date().getFullYear()-4+s),t=[{k:"summary",l:"Ringkasan PPN",i:"fa-receipt"},{k:"income",l:"Laba Rugi",i:"fa-chart-pie"},{k:"balance",l:"Neraca",i:"fa-scale-balanced"},{k:"settings",l:"Pengaturan",i:"fa-gear"}];Ne==="menu"&&(Ne="summary");const a=`
    ...
    </div>`),Kt()},Zo=e=>{Ne=e,Ta()},ei=async e=>{re=parseInt(e,10),T("tax-content",'<div class="text-center py-16"><i class="fa-solid fa-spinner fa-spin text-3xl text-slate-300"></i></div>'),Be=await Sa(re),Kt()},ti=e=>{oe=parseInt(e,10),Kt()},Kt=()=>{Ne==="summary"?Ws():Ne==="income"?Aa():Ne==="balance"?Ma():Ne==="settings"&&Qs()},Ws=()=>{const e=ht(),t=oe===0?`Tahun ${re}`:`${Oe[oe-1]} ${re}`,a=e.omset-e.disc,r=Array.from({length:12},(s,o)=>o+1).map(s=>{const o=Be?Be[s]:{omset:0,ppn:0,orderCount:0};return`<tr class="${oe===s?"bg-[rgba(var(--color-primary-rgb),0.08)] dark:bg-[rgba(var(--color-primary-rgb),0.14)] font-bold":"hover:bg-slate-50 dark:hover:bg-slate-700/30"} border-b border-slate-100 dark:border-slate-700/50 last:border-0 transition-colors">
    ...
    `)},Aa=()=>{const e=ht(),t=oe===0?`Tahun ${re}`:`${Oe[oe-1]} ${re}`,a=e.omset-e.disc-e.hpp,r=oe===0?null:`${re}-${oe}`,s=Pa(),o=a-s,i=n.taxSettings?.taxScheme||"umkm_final";let l,d,p;i==="umkm_final"?(l=.5,d=e.omset,p="PPh Final UMKM (0,5% × Omset)"):i==="badan_normal"?(l=22,d=Math.max(0,o),p="PPh Badan (22% × Laba Bersih)"):(l=parseFloat(n.taxSettings?.customTaxRate)||0,d=Math.max(0,o),p=`PPh Custom (${l}% × Laba Bersih)`);const f=d*(l/100),g=o-f;let u="";if(oe===0)u=Array.from({length:12},(w,v)=>v+1).map(w=>{const v=`${re}-${w}`,h=(n.taxSettings?.monthlyExpenses||{})[v]||0;return`<div class="flex items-center justify-between gap-2 py-2 border-b border-slate-100 dark:border-slate-700/50 last:border-0">
    ...
    `)},ai=async(e,t)=>{const a=parseFloat(t)||0;n.taxSettings||(n.taxSettings={}),n.taxSettings.monthlyExpenses||(n.taxSettings.monthlyExpenses={}),n.taxSettings.monthlyExpenses[e]=a;try{typeof window.saveApp=="function"&&await window.saveApp(["taxSettings"]),Aa()}catch{b("Gagal menyimpan biaya operasional!")}},Ma=()=>{const e=Gt(),t=n.taxSettings?.balanceSheet||{kas:0,piutang:0,hutang:0},a=(parseFloat(t.kas)||0)+(parseFloat(t.piutang)||0)+e.assetHpp,r=parseFloat(t.hutang)||0,s=a-r;T("tax-content",`
    ...
    `)},si=async(e,t)=>{const a=parseFloat(t)||0;n.taxSettings||(n.taxSettings={}),n.taxSettings.balanceSheet||(n.taxSettings.balanceSheet={kas:0,piutang:0,hutang:0,modalDisetor:0}),n.taxSettings.balanceSheet[e]=a;try{typeof window.saveApp=="function"&&await window.saveApp(["taxSettings"]),Ma()}catch{b("Gagal menyimpan data neraca!")}},Qs=()=>{const e=n.taxSettings||{};T("tax-content",`
    ...
    `)},ri=e=>{Z("tax-custom-rate-wrap","hidden",e!=="custom")},oi=async()=>{if(!Ke){ee(!0),O("Menyimpan...");try{n.taxSettings||(n.taxSettings={}),n.taxSettings.companyName=L("tax-company-name"),n.taxSettings.npwp=L("tax-npwp"),n.taxSettings.taxScheme=L("tax-scheme"),n.taxSettings.customTaxRate=parseFloat(L("tax-custom-rate"))||.5,typeof window.saveApp=="function"&&await window.saveApp(["taxSettings"]),b("Pengaturan pajak tersimpan!")}catch{b("Gagal menyimpan pengaturan pajak!")}finally{ee(!1),D()}}},ii=e=>{const t=oe===0?`Tahun ${re}`:`${Oe[oe-1]} ${re}`,a=n.taxSettings||{},r=new Date().toLocaleDateString("id-ID",{day:"2-digit",month:"long",year:"numeric"});let s="";n.store.logo&&(n.store.logo.includes("http")||n.store.logo.includes("data:"))?s=`<img loading="eager" src="${c(n.store.logo)}" class="w-16 h-16 object-contain">`:s='<div class="w-16 h-16 bg-slate-700 text-white flex items-center justify-center rounded-xl"><i class="fa-solid fa-store text-3xl"></i></div>';const i={summary:"LAPORAN PPN & OMSET",income:"LAPORAN LABA RUGI",balance:"NERACA"}[e]||"LAPORAN";let l=`
    <div class="flex justify-between items-start border-b-[3px] border-slate-800 pb-6 mb-6">
        <div class="flex items-center gap-4">
            ${s}
            <div>
    ...
    <div class="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-6 text-[11px] font-bold text-amber-700 leading-relaxed">
        ...
        <table class="w-full text-xs"><thead><tr class="bg-slate-100 text-left"><th class="py-2.5 px-3 font-bold text-slate-500 uppercase text-[9px]">Bulan</th><th class="py-2.5 px-3 font-bold text-slate-500 uppercase text-[9px] text-right">Omset</th><th class="py-2.5 px-3 font-bold text-slate-500 uppercase text-[9px] text-right">PPN Keluaran</th><th class="py-2.5 px-3 font-bold text-slate-500 uppercase text-[9px] text-right">Pesanan</th></tr></thead><tbody>${u}</tbody></table>`}else if(e==="income"){const f=ht(),g=f.omset-f.disc-f.hpp,u=Pa(),w=g-u,v=a.taxScheme||"umkm_final";let h,A,C;v==="umkm_final"?(h=.5,A=f.omset,C="PPh Final UMKM (0,5% × Omset)"):v==="badan_normal"?(h=22,A=Math.max(0,w),C="PPh Badan (22% × Laba Bersih)"):(h=parseFloat(a.customTaxRate)||0,A=Math.max(0,w),C=`PPh Custom (${h}% × Laba Bersih)`);const P=A*(h/100),q=w-P,I=(S,U,K,ne)=>`<div class="flex justify-between py-2 ${K?"border-t-2 border-slate-800 mt-1 pt-3":"border-b border-slate-100"}"><span class="${K?"font-bold text-slate-900":"font-bold text-slate-600"}">${S}</span><span class="font-bold ${ne||"text-slate-900"}">${U}</span></div>`;d=`<div class="max-w-xl">
            ...
            ${I("(−) Estimasi "+C,"-"+x(P),!1,"text-rose-600")}
            ${I("Laba Bersih Setelah Pajak (Estimasi)",x(q),!0)}
        </div>`}else if(e==="balance"){const f=Gt(),g=a.balanceSheet||{kas:0,piutang:0,hutang:0},u=(parseFloat(g.kas)||0)+(parseFloat(g.piutang)||0)+f.assetHpp,w=parseFloat(g.hutang)||0,v=u-w;d=`
        ...
        </div>`}H("doc-modal-title","Preview "+i),T("doc-paper-content",l+d);const p=m("doc-preview-modal");p&&p.classList.contains("hidden")&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("docPreview"),j("doc-preview-modal"),setTimeout(()=>{m("doc-preview-modal")&&m("doc-preview-modal").classList.remove("opacity-0"),m("doc-preview-modal-box")&&m("doc-preview-modal-box").classList.remove("scale-95"),typeof window.fitDocPreview=="function"&&window.fitDocPreview()},10)};window.fetchTaxPeriodData=Sa;window.getTaxPeriodTotals=ht;window.getTaxPeriodExpenses=Pa;window.rTaxPanel=Xo;window.rTaxRenderShell=Ta;window.switchTaxTab=Zo;window.changeTaxYear=ei;window.changeTaxMonth=ti;window.rTaxSubContent=Kt;window.rTaxSummary=Ws;window.rTaxIncome=Aa;window.saveMonthlyExpense=ai;window.rTaxBalance=Ma;window.saveBalanceField=si;window.rTaxSettingsPanel=Qs;window.toggleCustomTaxRateInput=ri;window.saveTaxSettingsPanel=oi;window.openTaxDocPreview=ii;window.MONTH_NAMES=Oe;window.editTempoPenalty=(e,t)=>{window.customPrompt("Persentase Denda Baru",t,async a=>{if(!a)return;let r=parseFloat(a.replace(",","."));if(isNaN(r)||r<0)return b("Persentase tidak valid!");O("Menyimpan...");try{await k.collection("freshmart_orders").doc(e).update({"payment.tempoPenaltyRate":r}),b("Persentase denda berhasil diubah!"),window.rAdmPiutang()}catch(s){b("Gagal mengubah denda: "+s.message)}D()})};window.stopTempoPenalty=(e,t,a)=>{let r="Konfirmasi Denda",s=a?"Lanjutkan perhitungan denda otomatis?":"Hentikan denda berjalan sekarang? (Nominal denda akan dibekukan di "+x(t)+")";Le(r,s,async()=>{O("Menyimpan...");try{await k.collection("freshmart_orders").doc(e).update({"payment.tempoPenaltyStopped":!a,"payment.tempoFixedPenalty":a?null:t}),b(a?"Denda dilanjutkan!":"Denda berhasil dibekukan!"),window.rAdmPiutang()}catch(i){b("Gagal mengubah status denda: "+i.message)}D()},a?"Lanjutkan":"Bekukan")};window.payTempoInstallment=e=>{window.customPrompt("Masukkan Nominal Cicilan (Rp)","",async t=>{if(!t)return;let a=parseFloat(t.replace(/[^0-9]/g,""));if(isNaN(a)||a<=0)return b("Nominal tidak valid!");O("Menyimpan cicilan...");try{const s=(await k.collection("freshmart_orders").doc(e).get()).data();let o=(s.payment.tempoBalance||0)-a,i=s.payment.installments||[];i.push({date:Date.now(),amount:a,note:"Cicilan"});let l={"payment.tempoBalance":Math.max(0,o),"payment.installments":i};o<=0&&(l["payment.paymentStatus"]="lunas",l.status="Selesai"),await k.collection("freshmart_orders").doc(e).update(l),b("Cicilan berhasil ditambahkan!"),window.rAdmPiutang&&window.rAdmPiutang()}catch(r){b("Gagal memproses cicilan: "+r.message)}D()})};window.previewTempoReceipt=async e=>{O("Memuat data struk...");try{const t=await k.collection("freshmart_orders").doc(e).get();if(!t.exists)return D(),b("Pesanan tidak ditemukan");const a=t.data();D();const r=a.dateString?new Date(a.dateString).toLocaleString("id-ID",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}):"",s=n.store.name||"Toko",o=n.store.wa||"",i=(P,q,I=32)=>{const S=I-P.length-q.length;return P+(S>0?" ".repeat(S):" ")+q};let l=`<div class="text-center font-bold" style="font-size:13px;margin-bottom:2px;">${c(s)}</div>`;o&&(l+=`<div class="text-center" style="margin-bottom:4px;">WA: ${c(o)}</div>`),l+=`<div class="text-center font-bold uppercase my-2" style="font-size:14px;border-bottom:1px solid #000;border-top:1px solid #000;padding:2px 0;">NOTA TEMPO${a.payment?.paymentStatus==="lunas"?" - LUNAS":""}</div>`,l+=`<div style="white-space:pre;">Order: #${a.orderId}</div><div style="white-space:pre;">Tgl  : ${r}</div><div style="white-space:pre;">Plg  : ${c(a.customer?.name||"Guest").substring(0,20)}</div>`,a.payment?.tempoDueDate&&(l+=`<div style="white-space:pre;">J.Tmp: ${new Date(a.payment.tempoDueDate).toLocaleDateString("id-ID")}</div>`),l+='<div class="border-b border-dashed border-black my-2"></div>';let d=0;if(a.items.forEach(P=>{let q=P.variantName?` (${c(P.variantName)}${P.colorCode?" "+c(P.colorCode):""})`:"";const I=(c(P.name)+q+(P.poTime?" [PO]":"")).substring(0,32),S=`${parseFloat(P.qty)} ${c(P.unit||"pcs")} x ${P.effectivePrice.toLocaleString("id-ID")}`,U=(parseFloat(P.qty)*P.effectivePrice).toLocaleString("id-ID");l+=`<div style="white-space:pre-wrap;font-weight:bold;word-break:break-all;">${I}</div><div style="white-space:pre;font-size:11px;">${i(S,U)}</div>`,P.poTime&&(l+=`<div style="white-space:pre;font-size:10px;font-style:italic;color:#4b5563;">* Estimasi PO: ${c(P.poTime)}</div>`),d+=parseFloat(P.qty)*P.effectivePrice}),l+='<div class="border-b border-dashed border-black my-2"></div>',l+=`<div style="white-space:pre;font-weight:bold;">${i("Subtotal",d.toLocaleString("id-ID"))}</div>`,a.payment?.grandTotal&&a.payment.grandTotal!==d){let P=a.payment.grandTotal-d;P>0?l+=`<div style="white-space:pre;">${i("Ongkir/Biaya",P.toLocaleString("id-ID"))}</div>`:l+=`<div style="white-space:pre;">${i("Diskon",Math.abs(P).toLocaleString("id-ID"))}</div>`}l+=`<div style="white-space:pre;font-weight:bold;margin-top:4px;">${i("TOTAL KREDIT",(a.payment?.grandTotal||d).toLocaleString("id-ID"))}</div>`,l+='<div class="border-b border-black my-2" style="border-width:1px;"></div>';let p=0;a.payment?.installments&&a.payment.installments.length>0&&(l+='<div style="white-space:pre;font-weight:bold;margin-bottom:2px;">HISTORI CICILAN:</div>',a.payment.installments.forEach((P,q)=>{let I=new Date(P.date).toLocaleDateString("id-ID",{day:"2-digit",month:"short"}),S=P.amount.toLocaleString("id-ID");l+=`<div style="white-space:pre;">${i(`${q+1}. ${I}`,S)}</div>`,p+=P.amount}),l+=`<div style="white-space:pre;font-weight:bold;margin-top:2px;">${i("TOTAL DIBAYAR",p.toLocaleString("id-ID"))}</div>`,l+='<div class="border-b border-dashed border-black my-2"></div>');let f=a.payment?.tempoBalance||0,g=0,u=a.payment?.tempoPenaltyStopped===!0,w=a.payment?.tempoDueDate||0,v=a.payment?.tempoPenaltyRate!==void 0?parseFloat(a.payment.tempoPenaltyRate):1;if(a.payment?.paymentStatus!=="lunas"){if(u)g=parseFloat(a.payment?.tempoFixedPenalty)||0;else if(Date.now()>w){let P=Math.floor((Date.now()-w)/864e5);P>0&&(g=v/100*f*P)}}l+=`<div style="white-space:pre;font-weight:bold;">${i("SISA POKOK",f.toLocaleString("id-ID"))}</div>`,g>0&&(l+=`<div style="white-space:pre;">${i("DENDA",Math.round(g).toLocaleString("id-ID"))}</div>`);let h=f+g;l+='<div class="border-b border-black my-2" style="border-width:1px;"></div>',l+=`<div style="white-space:pre;font-weight:black;">${i("SISA TAGIHAN",Math.round(h).toLocaleString("id-ID"))}</div>`,a.items.some(P=>P.poTime&&P.poTime!=="")&&(l+='<div class="border-b border-dashed border-black my-2"></div><div style="white-space:pre-wrap;font-size:9px;text-align:center;line-height:1.2;font-style:italic;color:#4b5563;margin-bottom:4px;">* Catatan: Untuk pesanan gabungan, produk PO akan dikirimkan menyusul (estimasi sesuai label) tanpa dikenakan biaya tambahan.</div>'),l+='<div class="border-b border-dashed border-black my-2"></div><div class="text-center my-2" style="font-size:10px;">Terima kasih atas kepercayaannya.</div><div class="border-b border-dashed border-black my-2"></div><div style="height:20px;"></div>',T("receipt-paper-content",l);const C=m("receipt-preview-modal");C&&C.classList.contains("hidden")&&pushModalHistory("receipt"),show("receipt-preview-modal"),setTimeout(()=>{m("receipt-preview-modal").classList.remove("opacity-0"),m("receipt-preview-modal-box").classList.remove("scale-95")},10)}catch(t){D(),b("Gagal memuat struk: "+t.message)}};window.markTempoPaid=async e=>{Le("Konfirmasi","Tandai tagihan tempo ini sebagai LUNAS?",async()=>{try{await k.collection("freshmart_orders").doc(e).update({"payment.paymentStatus":"lunas","payment.tempoBalance":0,status:"Selesai"}),b("Tagihan berhasil dilunasi!");let t=gOrds.findIndex(a=>a.orderId===e);t!==-1&&(gOrds[t].payment.paymentStatus="lunas",gOrds[t].payment.tempoBalance=0,gOrds[t].status="Selesai"),window.rAdmPiutang()}catch(t){b("Gagal mengubah status: "+t.message)}})};window.rAdmPiutang=async()=>{O("Memuat data piutang...");let e=[];try{(await k.collection("freshmart_orders").where("payment.method","==","tempo").where("payment.paymentStatus","==","hutang").get()).forEach(s=>{e.push(s.data())})}catch(r){D(),b("Gagal memuat piutang: "+r.message);return}D();let t=0,a=`
    ...
    `;e.length===0?a+=`<div class="bg-white dark:bg-slate-800 p-8 text-center rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm">
            ...
            </div>`}),a+="</div>"),a+="</div>",T("admin-content",a),setTimeout(()=>{m("total-piutang-header")&&(m("total-piutang-header").innerText=x(t))},100)};const li=e=>{Tr(e),zs()},zs=()=>{const e=Cs||"all",t=(Ot||[]).filter(o=>e==="visible"?o.isVisible!==!1:e==="hidden"?o.isVisible===!1:!0),a=`
        ...
        </div>`}).join("");T("admin-content",a+s)},ni=async e=>{const t=(Ot||[]).find(a=>a.id===e);t&&typeof window.customPrompt=="function"&&window.customPrompt("Tulis balasan untuk ulasan ini:",t.adminReply||"",async a=>{O("Menyimpan balasan...");try{await k.collection("freshmart").doc("cms_data").collection("reviews").doc(e.toString()).update({adminReply:a}),b("Balasan tersimpan!")}catch{b("Gagal menyimpan balasan!")}finally{D()}})},di=async e=>{const t=(Ot||[]).find(r=>r.id===e);if(!t)return;const a=t.isVisible===!1;O("Menyimpan...");try{await k.collection("freshmart").doc("cms_data").collection("reviews").doc(e.toString()).update({isVisible:a}),b(a?"Ulasan ditampilkan lagi!":"Ulasan disembunyikan dari halaman produk!")}catch{b("Gagal mengubah status ulasan!")}finally{D()}},ci=e=>{Le("Hapus Ulasan","Ulasan yang dihapus tidak bisa dikembalikan lagi.",async()=>{O("Menghapus...");try{await k.collection("freshmart").doc("cms_data").collection("reviews").doc(e.toString()).delete(),b("Ulasan dihapus!")}catch{b("Gagal menghapus ulasan!")}finally{D()}})};window.filterReviews=li;window.rAdmReviews=zs;window.replyToReview=ni;window.toggleReviewVisibility=di;window.deleteReview=ci;let ot=null,Jt=null;const sa=()=>{document.querySelectorAll("#banner-slider video.banner-video-element").forEach(e=>{e.dataset.init||(e.dataset.init="true",e.muted=!0,e.loop=!0,e.playsInline=!0,e.setAttribute("playsinline",""),e.setAttribute("loop",""),e.setAttribute("autoplay","")),e.dataset.loopAttached||(e.dataset.loopAttached="true",e.addEventListener("ended",()=>{e.currentTime=0,e.play().catch(()=>{})})),e.dataset.userUnmuted==="true"&&(e.muted=!1),e.play().catch(()=>{})})},pi=(e,t)=>{const a=m(`banner-slide-${t}`)||e&&e.closest(".banner-slide-item");if(!a)return;const r=a.querySelector("video.banner-video-element");if(r){r.muted?(r.muted=!1,r.volume=1,r.dataset.userUnmuted="true",r.play().catch(()=>{}),e&&(e.innerHTML='<i class="fa-solid fa-volume-high text-xs"></i> <span>Suara On</span>',e.className="banner-sound-toggle inline-flex items-center gap-1.5 px-3 py-1.5 primary-bg text-white text-[10px] sm:text-xs font-bold rounded-full shadow-lg border border-white/20 active:scale-95 transition-all cursor-pointer")):(r.muted=!0,r.dataset.userUnmuted="false",e&&(e.innerHTML='<i class="fa-solid fa-volume-xmark text-xs"></i> <span>Muted</span>',e.className="banner-sound-toggle inline-flex items-center gap-1.5 px-3 py-1.5 bg-slate-900/80 hover:bg-slate-900 text-white text-[10px] sm:text-xs font-bold rounded-full shadow-lg border border-white/20 active:scale-95 transition-all cursor-pointer"));return}const s=a.querySelector("iframe.banner-video-iframe");s&&(s.dataset.muted!=="false"?(s.dataset.muted="false",s.contentWindow?.postMessage('{"event":"command","func":"unMute","args":""}',"*"),s.contentWindow?.postMessage('{"event":"command","func":"setVolume","args":[100]}',"*"),e&&(e.innerHTML='<i class="fa-solid fa-volume-high text-xs"></i> <span>Suara On</span>',e.className="banner-sound-toggle inline-flex items-center gap-1.5 px-3 py-1.5 primary-bg text-white text-[10px] sm:text-xs font-bold rounded-full shadow-lg border border-white/20 active:scale-95 transition-all cursor-pointer")):(s.dataset.muted="true",s.contentWindow?.postMessage('{"event":"command","func":"mute","args":""}',"*"),e&&(e.innerHTML='<i class="fa-solid fa-volume-xmark text-xs"></i> <span>Muted</span>',e.className="banner-sound-toggle inline-flex items-center gap-1.5 px-3 py-1.5 bg-slate-900/80 hover:bg-slate-900 text-white text-[10px] sm:text-xs font-bold rounded-full shadow-lg border border-white/20 active:scale-95 transition-all cursor-pointer")))},dt=e=>{const t=m("banner-dots-container");if(!t)return;t.querySelectorAll(".banner-dot-item").forEach((r,s)=>{s===e?r.className="banner-dot-item h-2.5 rounded-full transition-all duration-300 bg-[var(--color-primary)] w-7 shadow-sm":r.className="banner-dot-item w-2.5 h-2.5 rounded-full transition-all duration-300 bg-slate-300 dark:bg-slate-700 hover:bg-slate-400"})},mi=()=>{Jt&&clearTimeout(Jt),Jt=setTimeout(()=>{const e=m("banner-slider");if(!e)return;const t=e.querySelectorAll(".banner-slide-item");if(!t||!t.length)return;let a=0,r=1/0;t.forEach((s,o)=>{const i=Math.abs(s.offsetLeft-e.scrollLeft);i<r&&(r=i,a=o)}),dt(a)},100)},ui=e=>{clearInterval(ot);const t=m("banner-slider");if(!t)return;const a=t.querySelectorAll(".banner-slide-item");a&&a[e]&&(t.scrollTo({left:a[e].offsetLeft-t.offsetLeft,behavior:"smooth"}),dt(e)),setTimeout(Tt,8e3)},fi=()=>{clearInterval(ot);const e=m("banner-slider");if(!e)return;const t=e.querySelectorAll(".banner-slide-item");if(!t||!t.length)return;let a=0,r=1/0;t.forEach((o,i)=>{const l=Math.abs(o.offsetLeft-e.scrollLeft);l<r&&(r=l,a=i)});const s=(a-1+t.length)%t.length;e.scrollTo({left:t[s].offsetLeft-e.offsetLeft,behavior:"smooth"}),dt(s),setTimeout(Tt,8e3)},bi=()=>{clearInterval(ot);const e=m("banner-slider");if(!e)return;const t=e.querySelectorAll(".banner-slide-item");if(!t||!t.length)return;let a=0,r=1/0;t.forEach((o,i)=>{const l=Math.abs(o.offsetLeft-e.scrollLeft);l<r&&(r=l,a=i)});const s=(a+1)%t.length;e.scrollTo({left:t[s].offsetLeft-e.offsetLeft,behavior:"smooth"}),dt(s),setTimeout(Tt,8e3)},Tt=()=>{if(clearInterval(ot),!m("banner-slider")||!n.banners||n.banners.length<=1)return;const t=()=>{sa()};t(),sa(),ot=setInterval(()=>{const a=m("banner-slider");if(!a)return clearInterval(ot);const r=a.querySelectorAll(".banner-slide-item");if(!r||r.length<=1){const s=a.scrollWidth-a.clientWidth;a.scrollLeft>=s-10?a.scrollTo({left:0,behavior:"smooth"}):a.scrollBy({left:a.clientWidth,behavior:"smooth"})}else{let s=0,o=1/0;r.forEach((d,p)=>{const f=Math.abs(d.offsetLeft-a.scrollLeft);f<o&&(o=f,s=p)});const i=(s+1)%r.length,l=r[i];a.scrollTo({left:l.offsetLeft-a.offsetLeft,behavior:"smooth"}),dt(i)}setTimeout(t,400)},8e3)};window.forcePlayBannerVideos=sa;window.toggleBannerVideoSound=pi;window.updateBannerDots=dt;window.onBannerScroll=mi;window.scrollToBanner=ui;window.scrollBannerPrev=fi;window.scrollBannerNext=bi;window.startBannerAutoSlide=Tt;const Da=()=>{const e=document.getElementById("storefront-footer-container");if(!e)return;const t=n.store||{},a=t.name||"Toko Putri",r=t.description||t.slogan||"Selamat datang di toko kami. Melayani pembelian online dan offline dengan kualitas terbaik.",s=t.email||"",o=t.operationalHours||"Buka Setiap Hari (08:00 - 17:00)",i=t.address||"",l=t.wa||"",d=t.footerCredit||"Seluruh hak cipta dilindungi undang-undang.",p=new Date().getFullYear();let f=(l||"").replace(/\D/g,"");f.startsWith("0")?f="62"+f.slice(1):!f.startsWith("62")&&f.length>0&&(f="62"+f);let g='<i class="fa-solid fa-store text-2xl text-[var(--color-primary)]"></i>';t.logo&&(t.logo.includes("http")||t.logo.includes("data:")?g=`<img src="${c(t.logo)}" alt="${c(a)}" class="h-full w-full max-h-10 max-w-10 object-contain" onerror="this.outerHTML='<i class=\\'fa-solid fa-store text-2xl text-[var(--color-primary)]\\'></i>'">`:g=`<i class="fa-solid ${c(t.logo)} text-2xl text-[var(--color-primary)]"></i>`);const u=f?`window.open('https://wa.me/${c(f)}', '_blank')`:"if(typeof window.showToast==='function') window.showToast('Nomor WhatsApp belum dikonfigurasi admin.');";e.innerHTML=`
    ...
    `},gi=()=>{let e=document.getElementById("guarantee-modal");e||(e=document.createElement("div"),e.id="guarantee-modal",e.className="fixed inset-0 z-[115] bg-slate-900/70 backdrop-blur-sm flex items-end sm:items-center justify-center p-0 sm:p-5",e.onclick=t=>{t.target===e&&Js()},document.body.appendChild(e)),e.innerHTML=`
        ...
        </div>`,e.style.opacity="0",e.style.display="flex",requestAnimationFrame(()=>{e.style.transition="opacity 0.25s ease",e.style.opacity="1"})},Ys=()=>{const e=document.getElementById("security-modal");!e||e.style.display==="none"||(e.style.opacity="0",e.style.transition="opacity 0.25s ease",setTimeout(()=>{e.style.display="none",e.style.opacity="",e.style.transition=""},250))};window.renderStorefrontFooter=Da;window.openQualityGuaranteeModal=gi;window.closeQualityGuaranteeModal=Js;window.openSecurityModal=xi;window.closeSecurityModal=Ys;const ra=()=>{if(Da(),H("dyn-store-name",n.store.name||"Toko Putri"),H("dyn-store-slogan",n.store.slogan||"Toko Online & Kasir Resmi"),n.store.logo){const i=m("dyn-store-logo-img"),l=m("dyn-store-logo-icon");n.store.logo.includes("http")||n.store.logo.includes("data:")?i&&(i.src=n.store.logo,i.onerror=()=>{i.onerror=null,i.src="https://placehold.co/100?text=Logo"},j("dyn-store-logo-img"),$("dyn-store-logo-icon")):l&&(l.className=`fa-solid ${c(n.store.logo)} text-xl text-[var(--color-primary)]`,j("dyn-store-logo-icon"),$("dyn-store-logo-img"))}let e=n.banners&&n.banners.length?`
    <div class="relative group/banner-wrapper w-full">
        <div id="banner-slider" class="flex overflow-x-auto gap-4 sm:gap-6 pb-4 pt-2 snap-x hide-scrollbar scroll-smooth" ontouchstart="clearInterval(bannerTmr)" ontouchend="setTimeout(startBannerAutoSlide, 8000)" onmouseenter="clearInterval(bannerTmr)" onmouseleave="startBannerAutoSlide()" onscroll="window.onBannerScroll && window.onBannerScroll()">
            ${n.banners.map((i,l)=>{const d=i.type==="video"&&i.videoUrl,p=!d&&i.link?`onclick="window.open('${c(i.link)}', '_self')"`:"";if(d){const f=Ft(i.videoUrl)||{type:"direct",directUrl:Nt(i.videoUrl),embedUrl:Ms(i.videoUrl)};let g="";return f.type==="youtube"?g=`
                <iframe
        ...
        `:""}
    </div>`:"";T("dynamic-banners-container",e),setTimeout(Tt,500);const t=(n.vouchers||[]).filter(i=>i.isShow==="true"||i.isShow===!0),a=m("dynamic-vouchers-container");if(t.length>0&&a){a.classList.remove("hidden");let i=`
        <div class="flex items-center justify-between mb-4">
            <h3 class="font-bold text-slate-800 dark:text-white text-sm sm:text-base tracking-tight flex items-center gap-2">
                <div class="w-8 h-8 rounded-xl bg-[var(--color-primary)] flex items-center justify-center text-white shadow-sm">
    ...
    `),rAdmItms(e)};window.rAdmItms=e=>{e&&(Ze=e,typeof window.setCTab=="function"&&window.setCTab(e),window.cTab=e);const t=m("admin-list-container"),a=t?t.closest(".scroll-content"):null,r=a?a.scrollTop:0;if(e==="products"&&m("admin-product-stats")){const i=Gt();T("admin-product-stats",`
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                <div class="card-modern p-5 sm:p-5">
        ...
        <div class="p-4 sm:p-5 md:p-6 lg:p-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4 rounded-[1.5rem] border shadow-sm cursor-pointer hover:shadow-md hover:-translate-y-1 hover:border-[var(--color-primary)]/40 dark:hover:border-[var(--color-primary)]/40 transition-all duration-300 ${p}" onclick="oAEd('${e}',${i.id})">
            <div class="flex items-start sm:items-center gap-4 min-w-0 w-full">
                ...
                <div class="min-w-0 flex flex-col justify-center py-1">
                    ...
                    ${l&&window.isAdm&&v?`<p class="text-[10px] font-bold mt-1 ${(i.variants&&i.variants.length?i.variants.reduce((q,I)=>q+(parseFloat(I.stock)||0),0):parseFloat(i.stock)||0)===0?"text-rose-500 animate-pulse":"text-blue-500"}"><i class="fa-solid fa-boxes-stacked mr-1"></i>Stok: ${i.variants&&i.variants.length?i.variants.reduce((q,I)=>q+(parseFloat(I.stock)||0),0).toFixed(2).replace(/\.?0+$/,""):parseFloat(i.stock)||0}</p>`:""}
                    ${l&&window.isAdm&&i.hpp?`<p class="text-[10px] font-bold text-amber-500 mt-0.5"><i class="fa-solid fa-coins mr-1"></i>HPP: ${x(i.hpp)}</p>`:""}
                    ${l?(()=>{const q=i.variants&&i.variants.length?i.variants.reduce((I,S)=>I+(parseFloat(S.totalSold)||0),0):parseFloat(i.totalSold)||0;return q>0?`<p class="text-[10px] font-bold text-orange-400 mt-0.5"><i class="fa-solid fa-fire-flame-curved mr-1"></i>Terjual: ${q}</p>`:""})():""}
...
></i>`,s+="</div>"}),s=`<div class="grid grid-cols-1 lg:grid-cols-2 gap-x-5 gap-y-5 items-start">${s}</div>`,T("admin-modal-form",s),e==="products"&&(rVarsB(),rWholB(),rSpecB());const d=m("admin-modal");d&&d.classList.contains("hidden")&&pushModalHistory("admin"),j("admin-modal"),setTimeout(()=>{m("admin-modal").classList.remove("opacity-0"),m("admin-modal-box").classList.remove("scale-95")},10)};window.rVarsB=()=>{const e=document.getElementById("af-category"),t=e?/\bcat\b/i.test(e.value):!1;let a=`<div class="space-y-5 mb-5">${je.map((r,s)=>{let o=r.isActive!==!1&&r.isActive!=="false";return`
    ...
    `;for(let r in t)a+=`<div>
        ...
        </div>`,a||rQpWhol(),s.style.opacity="0",s.style.display="flex",requestAnimationFrame(()=>{s.style.transition="opacity 0.25s ease",s.style.opacity="1"}),pushModalHistory("quickprice")};window.rQpWhol=()=>{T("qp-whol-container",vt.length?vt.map((e,t)=>`
        <div class="flex items-center gap-2">
        ...
        </div>`).join(""):'<p class="text-[11px] font-bold text-slate-400 text-center py-2">Belum ada tingkat harga grosir.</p>')};window.qpAddWhol=()=>{vt.push({minQty:0,price:0}),rQpWhol()};window.closeQuickPriceModal=(e=!1)=>{requestCloseModal("quickprice",e,()=>{const t=document.getElementById("quickprice-modal");!t||t.style.display==="none"||(t.style.opacity="0",t.style.transition="opacity 0.25s ease",setTimeout(()=>{t.style.display="none",t.style.opacity="",t.style.transition=""},250))})};window.processQuickPrice=async e=>{if(J)return;J=!0;const t=n.products.findIndex(s=>s.id===e);if(t<0){J=!1;return}const a=n.products[t],r=a.variants&&a.variants.length>0;O("Menyimpan Harga...");try{const s=typeof k<"u"&&k?k:window.db,o=typeof le=="function"?le:window.saveApp||(async()=>{});if(!s)throw new Error("Database Firebase belum terhubung");const i=s.collection("freshmart").doc("cms_data").collection("products").doc(e.toString());let l=null;await s.runTransaction(async d=>{const p=await d.get(i);if(!p.exists)throw new Error("Produk tidak ditemukan di server");const f=JSON.parse(JSON.stringify(p.data()));r?a.variants.forEach((g,u)=>{const w=(f.variants||[]).findIndex(P=>P.name===g.name);if(w<0)return;const v=parseFloat(document.getElementById("qp-var-hpp-"+u)?.value)||0,h=parseFloat(document.getElementById("qp-var-price-"+u)?.value)||0,A=parseFloat(document.getElementById("qp-var-normal-"+u)?.value)||0,C=parseFloat(document.getElementById("qp-var-poin-"+u)?.value)||0;f.variants[w].hpp=v,f.variants[w].price=h,f.variants[w].priceNormal=A,f.variants[w].poin=C}):(f.hpp=parseFloat(document.getElementById("qp-hpp")?.value)||0,f.price=parseFloat(document.getElementById("qp-price")?.value)||0,f.priceNormal=parseFloat(document.getElementById("qp-normal")?.value)||0,f.poin=parseFloat(document.getElementById("qp-poin")?.value)||0,f.wholesale=vt.filter(g=>parseFloat(g.minQty)>.01&&g.price>0)),d.set(i,f),l=f}),n.products[t]=l,await o([],{updateType:"stock_change",updatedProductIds:[e.toString()]}),closeQuickPriceModal(),rAdmItms("products"),b("✅ Harga berhasil diperbarui!")}catch(s){b("Gagal simpan harga: "+(s.message||""))}finally{J=!1,D()}};let de;window.openCameraScanner=async(e="search-input")=>{const t=m("scanner-modal");t&&t.classList.contains("hidden")&&pushModalHistory("scanner"),j("scanner-modal"),setTimeout(()=>{m("scanner-modal").classList.remove("opacity-0")},10);try{await Ds("https://cdnjs.cloudflare.com/ajax/libs/html5-qrcode/2.3.8/html5-qrcode.min.js",()=>typeof Html5Qrcode<"u")}catch{b("Gagal memuat modul kamera. Cek koneksi internet Anda."),closeCameraScanner();return}de||(de=new Html5Qrcode("reader"));const a={fps:10,qrbox:{width:250,height:250}};setTimeout(()=>{de&&de.start({facingMode:"environment"},a,r=>{let s=m(e);s&&(s.value=r,e==="search-input"?handleSearch(r):(s.dispatchEvent(new Event("input",{bubbles:!0})),s.dispatchEvent(new Event("change",{bubbles:!0})))),b("Barcode discan!"),closeCameraScanner()},r=>{}).catch(r=>{b("Akses kamera ditolak/gagal!"),closeCameraScanner()})},100)};window.closeCameraScanner=(e=!1)=>{requestCloseModal("scanner",e,()=>{if(m("scanner-modal").classList.add("opacity-0"),de)try{de.getState()===2||de.getState()===3?de.stop().then(()=>{de.clear(),de=null}).catch(t=>{de.clear(),de=null}):(de.clear(),de=null)}catch{de=null}setTimeout(()=>$("scanner-modal"),300)})};window.toggleProductStatus=async(e,t)=>{if(J)return;J=!0;const a=n.products.findIndex(r=>r.id===e);if(a>-1){n.products[a].isActive=t?"true":"false",O(t?"Mengaktifkan...":"Menonaktifkan...");try{const r=typeof k<"u"&&k?k:window.db,s=typeof le=="function"?le:window.saveApp||(async()=>{});if(!r)throw new Error("Database Firebase belum terhubung");await r.collection("freshmart").doc("cms_data").collection("products").doc(e.toString()).update({isActive:t?"true":"false"}),await s([],{updateType:"stock_change",updatedProductIds:[e.toString()]}),H("stat-products",n.products.filter(o=>o.isActive!=="false"&&o.isActive!==!1).length),b(t?"Produk Aktif!":"Stok Dikosongkan!")}catch(r){b("Gagal update status: "+(r.message||""))}finally{J=!1,D()}}};const vi=(e,t=!1)=>{const a=document.querySelector("#view-admin .scroll-content");if(a&&(a.scrollTop=0),!t){const s=history.state;s&&s.view==="view-admin"&&s.tab?history.replaceState({view:"view-admin",tab:e},"",window.location.href):history.pushState({view:"view-admin",tab:e},"",window.location.href)}if($("admin-dashboard-view"),j("admin-content-view"),j("btn-admin-back"),$("admin-logo-box"),H("admin-header-title",{orders:"Pesanan",settings:"Toko",products:"Produk",categories:"Kategori",brands:"Merek",banks:"Rekening",banners:"Banner",vouchers:"Voucher",customers:"Database Pelanggan",rewards:"Program Hadiah",reviews:"Ulasan Pelanggan",faqs:"Tanya Jawab / Q&A",tax:"Pajak & Keuangan",piutang:"Piutang Tempo",colors:"Database Warna"}[e]||"CMS"),e!=="orders"&&qe&&(qe(),xt(null)),e!=="customers"&&Re&&(Re(),ft(null)),e!=="reviews"&&Fe&&(Fe(),bt(null)),e==="settings")typeof window.rAdmSet=="function"&&window.rAdmSet();else if(e==="orders")typeof window.rAdmOrd=="function"&&window.rAdmOrd();else if(e==="tax")typeof window.rTaxPanel=="function"&&window.rTaxPanel();else if(e==="piutang")typeof window.rAdmPiutang=="function"&&window.rAdmPiutang();else if(e==="customers"){T("admin-content",'<div class="text-center py-16"><i class="fa-solid fa-spinner fa-spin text-3xl text-slate-300"></i></div>'),Re&&(Re(),ft(null));const s=k.collection("freshmart").doc("cms_data").collection("customers").onSnapshot(o=>{n.customers=o.docs.map(i=>i.data()),typeof window.rAdmL=="function"&&window.rAdmL("customers")},()=>{b("Gagal memuat data pelanggan!"),typeof window.rAdmL=="function"&&window.rAdmL("customers")});ft(s)}else if(e==="reviews"){T("admin-content",'<div class="text-center py-16"><i class="fa-solid fa-spinner fa-spin text-3xl text-slate-300"></i></div>'),Fe&&(Fe(),bt(null));const s=k.collection("freshmart").doc("cms_data").collection("reviews").onSnapshot(o=>{const i=o.docs.map(l=>l.data());i.sort((l,d)=>{const p=l.createdAt&&l.createdAt.toMillis?l.createdAt.toMillis():0;return(d.createdAt&&d.createdAt.toMillis?d.createdAt.toMillis():0)-p}),Sr(i),typeof window.rAdmReviews=="function"&&window.rAdmReviews()},()=>{b("Gagal memuat ulasan!")});bt(s)}else e==="faqs"?typeof window.rAdmFAQ=="function"&&window.rAdmFAQ():typeof window.rAdmL=="function"&&window.rAdmL(e)};window.openAdminTab=vi;let Ha=null;const Ca=()=>{if(!Ha)try{Ha=k.collection("freshmart").doc("cms_data").collection("faqs").onSnapshot(e=>{e&&e.docs&&(n.faqs=e.docs.map(t=>({id:t.id,...t.data()}))),typeof window.curViewName<"u"&&window.curViewName==="view-faq"&&lt(),window.isAdm&&typeof window.cTab<"u"&&window.cTab==="faqs"&&typeof window.rAdmFAQ=="function"&&window.rAdmFAQ()},e=>{console.warn("Sync sub-koleksi faqs dibatasi, menggunakan fallback cms_data.faqs:",e.message),typeof window.curViewName<"u"&&window.curViewName==="view-faq"&&lt(),window.isAdm&&typeof window.cTab<"u"&&window.cTab==="faqs"&&typeof window.rAdmFAQ=="function"&&window.rAdmFAQ()})}catch{console.warn("Fallback sync Q&A dari cms_data aktif")}};let Mt="Semua";const lt=()=>{Ca();const e=document.getElementById("storefront-faq-container"),t=document.getElementById("faq-category-pills");if(!e)return;const a=(n.faqs||[]).filter(i=>i.status==="published"),r=["Semua","Pemesanan","Pengiriman","Pembayaran","Garansi","Lainnya"];t&&(t.innerHTML=r.map(i=>`
    ...
    `,document.body.appendChild(r);const s=r.querySelector("div");La("prompt"),setTimeout(()=>{r.classList.remove("opacity-0"),s.classList.remove("scale-95")},10);const o=r.querySelector("#prompt-input");o.focus(),o.select(),window.closePrompt=(i=!1)=>{!r||!r.parentNode||Ia("prompt",i,()=>{r.classList.add("opacity-0"),s.classList.add("scale-95"),setTimeout(()=>r.remove(),300),window.closePrompt=null})},r.querySelector("#prompt-cancel").onclick=()=>window.closePrompt(),r.querySelector("#prompt-ok").onclick=()=>{let i=o.value;window.closePrompt(),a(i)}},Qi=()=>{typeof window.openReceiptPreview=="function"&&window.openReceiptPreview()};window.copyVoucher=qi;window.showToast=It;window.showToastLoading=Ui;window.hideToast=Hi;window.toggleTheme=Vi;window.showConfirm=Gi;window.closeConfirm=ar;window.executeConfirm=Ki;window.customPrompt=Wi;window.checkProPrint=Qi;tr();window.firebase=ue;window.db=k;window.DOMPurify=lr;window.uiPalettes=Ye;window.hexToRgb=As;window.applyUITheme=yt;window.toggleTheme=fr;window.applyBackgroundStyle=kt;ur();const zi=localStorage.getItem("freshmart_ui_theme")||"emerald";yt(zi,localStorage.getItem("freshmart_theme_color"));const Ga=()=>{br();const e=localStorage.getItem("freshmart_bg_style")||"minimalist",t=localStorage.getItem("freshmart_bg_custom_url")||"";kt(e,t),Da()};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Ga):Ga();window.onerror=function(e,t,a,r,s){return console.error("Global Error Caught:",e,"at",a,":",r),typeof showToast=="function"&&showToast("Ops, ada kendala sistem."),!1};window.addEventListener("unhandledrejection",function(e){console.warn("Promise Rejection Sentinel:",e.reason)});window.updateSEO=gr;window.injectJSONLD=xr;window.rewardStatusLabel=Bt;window.getYouTubeId=Rt;window.parseVideoUrl=Ft;window.fixDriveVideo=Nt;window.fixDriveVideoPreview=Ms;let Ka=qt;const sr=fe;window.calcTaxDetails=e=>{const t=rt.store.ppnEnabled===!0||rt.store.ppnEnabled==="true",a=parseFloat(rt.store.ppnRate)||11,r=rt.store.ppnType||"exclusive";if(!t||e<=0)return{ppnEnabled:!1,ppnRate:0,ppnType:r,ppnAmount:0,dppAmount:Math.max(0,e),grandTotalAdd:0};if(r==="inclusive"){const s=Math.round(e*100/(100+a)),o=e-s;return{ppnEnabled:!0,ppnRate:a,ppnType:"inclusive",ppnAmount:o,dppAmount:s,grandTotalAdd:0}}else{const s=Math.round(e*a/100);return{ppnEnabled:!0,ppnRate:a,ppnType:"exclusive",ppnAmount:s,dppAmount:Math.max(0,e),grandTotalAdd:s}}};typeof requestIdleCallback<"u"?requestIdleCallback(Ea,{timeout:5e3}):setTimeout(Ea,3e3);let Wa=null,rt=JSON.parse(JSON.stringify(sr));window.updateProBadge=()=>{};let jt=[],Et=[],_t=[],Qa={name:"",address:"",lat:null,lng:null,deliveryMethod:"delivery",distance:0,note:"",wa:""},za=null,Ja=null,Ya=null,Xa="Semua Produk",Za="Semua Merek",es="",ts="newest",as="grid",ss=1,rs=12,os="orders",is="",ls=null;window.isAdm=!1;window.isPro=!0;let ns=null,ds=0,cs=[],ps=[],ms=[],us=1,fs=[],bs=null,gs=null,xs=null,ws=[],hs=[],vs=null,ys=null,ks,$s=!1,Ss=null,Ps="all",Ts="today";try{jt=JSON.parse(we("freshmart_cart"))||[],it(jt)}catch{}try{Et=JSON.parse(we("freshmart_wishlist"))||[],Is(Et)}catch{}try{_t=JSON.parse(we("freshmart_my_orders"))||[],$t(_t)}catch{}history.replaceState({view:"view-catalog"},"","");const Ji=e=>{e&&H("loader-text",e);const t=m("global-loader");t&&(t.style.display="flex")},Yi=()=>{const e=m("global-loader");e&&(e.style.display="none")},Xi=()=>window.sanitizeCart();window.addEventListener("DOMContentLoaded",async()=>{await loadAppData(),syncAppMeta(),attachRealtimeStockSync(),ge.onAuthStateChanged(async e=>{if(e&&e.uid!==da){await ge.signOut();return}if(e){window.isAdm=!0,window.isPro=!0,localStorage.removeItem("isFreshmartPro"),localStorage.removeItem("freshmart_license_code"),window.updateProBadge&&window.updateProBadge();let t=document.getElementById("view-admin-login");t&&!t.classList.contains("hidden")&&(history.replaceState({view:"view-admin"},"",window.location.href),changeView("view-admin",!0),openAdminMenu(),showToast("Sesi Dipulihkan! Selamat Datang."))}else window.isAdm=!1,window.isPro=!1,window.updateProBadge&&window.updateProBadge(),localStorage.removeItem("isFreshmartPro"),localStorage.removeItem("freshmart_license_code")})});window.el=m;window.show=j;window.hide=$;window.toggleCls=Z;window.setIn=H;window.setH=T;window.setV=se;window.getV=L;window.esc=c;window.fixD=W;window.fCur=x;window.sL=we;window.ssL=te;window.defaultFbC=na;window.fbC=na;window.defApp=sr;window.ADMIN_UID=da;window.sLoad=Ji;window.hLoad=Yi;window.sanitizeCart=Xi;const V=(e,t,a)=>{try{Object.defineProperty(window,e,{get:t,set:a,configurable:!0})}catch{}};V("GAS_UPLOAD_URL",()=>Ka,e=>{Ka=e});V("confirmCb",()=>Wa,e=>{Wa=e});V("appData",()=>rt,e=>{rt=e});V("cart",()=>jt,e=>{jt=e,it(e)});V("wishlist",()=>Et,e=>{Et=e,Is(e)});V("myOrders",()=>_t,e=>{_t=e,$t(e)});V("cust",()=>Qa,e=>{Qa=e});V("currentMember",()=>za,e=>{za=e});V("selectedReward",()=>Ja,e=>{Ja=e});V("memberCheckTimer",()=>Ya,e=>{Ya=e});V("aCat",()=>Xa,e=>{Xa=e});V("aBrand",()=>Za,e=>{Za=e});V("sQ",()=>es,e=>{es=e});V("cSort",()=>ts,e=>{ts=e});V("cView",()=>as,e=>{as=e});V("cPage",()=>ss,e=>{ss=e});V("iPP",()=>rs,e=>{rs=e});V("cTab",()=>os,e=>{os=e});V("aSq",()=>is,e=>{is=e});V("eId",()=>ls,e=>{ls=e});V("cProd",()=>ns,e=>{ns=e});V("cVar",()=>ds,e=>{ds=e});V("tVars",()=>cs,e=>{cs=e});V("tWhol",()=>ps,e=>{ps=e});V("tSpec",()=>ms,e=>{ms=e});V("cQty",()=>us,e=>{us=e});V("oMods",()=>fs,e=>{fs=e});V("aOrdLst",()=>bs,e=>{bs=e});V("aCustLst",()=>gs,e=>{gs=e});V("aRevLst",()=>xs,e=>{xs=e});V("gOrds",()=>ws,e=>{ws=e});V("gReviews",()=>hs,e=>{hs=e});V("cVOrd",()=>vs,e=>{vs=e});V("vouch",()=>ys,e=>{ys=e});V("toastT",()=>ks,e=>{ks=e});V("isSaving",()=>$s,e=>{$s=e});V("bannerTmr",()=>Ss,e=>{Ss=e});V("reviewFilterMode",()=>Ps,e=>{Ps=e});V("lastReportPeriod",()=>Ts,e=>{Ts=e});
