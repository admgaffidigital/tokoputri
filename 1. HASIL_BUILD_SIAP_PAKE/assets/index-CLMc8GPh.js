...
import{f as ue}from"./vendor-firebase-core-D2OF5R23.js";import{p as Os,a as qs}from"./vendor-firebase-db-BHlQMNP0.js";import{p as Us}from"./vendor-utils-bRchjNq8.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&r(i)}).observe(document,{childList:!0,subtree:!0});function a(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(s){if(s.ep)return;s.ep=!0;const o=a(s);fetch(s.href,o)}})();const Hs="modulepreload",Vs=function(e){return"/"+e},_a={},Gs=function(t,a,r){let s=Promise.resolve();if(a&&a.length>0){document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),l=i?.nonce||i?.getAttribute("nonce");s=Promise.allSettled(a.map(d=>{if(d=Vs(d),d in _a)return;_a[d]=!0;const p=d.endsWith(".css"),u=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${u}`))return;const b=document.createElement("link");if(b.rel=p?"stylesheet":Hs,p||(b.as="script"),b.crossOrigin="",b.href=d,l&&b.setAttribute("nonce",l),document.head.appendChild(b),p)return new Promise((f,x)=>{b.addEventListener("load",f),b.addEventListener("error",()=>x(new Error(`Unable to preload CSS for ${d}`)))})}))}function o(i){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=i,window.dispatchEvent(l),!l.defaultPrevented)throw i}return s.then(i=>{for(const l of i||[])l.status==="rejected"&&o(l.reason);return t().catch(o)})},Ks={apiKey:"AIzaSyCOjrhMP52TGbiOyQLY92NDYE26N6d9hJM",authDomain:"restu-karya-utama.firebaseapp.com",databaseURL:"https://restu-karya-utama-default-rtdb.asia-southeast1.firebasedatabase.app",projectId:"restu-karya-utama",storageBucket:"restu-karya-utama.firebasestorage.app",messagingSenderId:"858310421352",appId:"1:858310421352:web:e20a833875e8d5c19944dd",measurementId:"G-PHDG2LJ8PM"};try{localStorage.removeItem("freshmart_fb_config")}catch{}const da=window.FIREBASE_CONFIG||Ks;ue.apps.length||ue.initializeApp(da);const k=ue.firestore(),we=ue.auth();typeof window<"u"&&(window.firebase=ue,window.db=k,window.auth=we);try{k.settings({localCache:Os({tabManager:qs()}),ignoreUndefinedProperties:!0,merge:!0,experimentalAutoDetectLongPolling:!0})}catch{try{k.settings({ignoreUndefinedProperties:!0,merge:!0,experimentalAutoDetectLongPolling:!0})}catch{}}let Ws=null;const Ra=()=>{Gs(()=>import("./vendor-firebase-analytics-Jm19L5g2.js"),__vite__mapDeps([0,1])).then(()=>{try{Ws=ue.analytics()}catch{}}).catch(()=>{})},ca="K2ijSERTT2dg27yYGTEgn6XHSnW2",tt={emerald:{50:"#ecfdf5",100:"#d1fae5",200:"#a7f3d0",300:"#6ee7b7",400:"#34d399",500:"#10b981",600:"#059669",700:"#047857",800:"#065f46",900:"#064e3b"},teal:{50:"#f0fdfa",100:"#ccfbf1",200:"#99f6e4",300:"#5eead4",400:"#2dd4bf",500:"#14b8a6",600:"#0d9488",700:"#0f766e",800:"#115e59",900:"#134e4a"},cyan:{50:"#ecfeff",100:"#cffafe",200:"#a5f3fc",300:"#67e8f9",400:"#22d3ee",500:"#06b6d4",600:"#0891b2",700:"#0e7490",800:"#155e75",900:"#164e63"},sky:{50:"#f0f9ff",100:"#e0f2fe",200:"#bae6fd",300:"#7dd3fc",400:"#38bdf8",500:"#0ea5e9",600:"#0284c7",700:"#0369a1",800:"#075985",900:"#0c4a6e"},blue:{50:"#eff6ff",100:"#dbeafe",200:"#bfdbfe",300:"#93c5fd",400:"#60a5fa",500:"#3b82f6",600:"#2563eb",700:"#1d4ed8",800:"#1e40af",900:"#1e3a8a"},indigo:{50:"#eef2ff",100:"#e0e7ff",200:"#c7d2fe",300:"#a5b4fc",400:"#818cf8",500:"#6366f1",600:"#4f46e5",700:"#4338ca",800:"#3730a3",900:"#312e81"},violet:{50:"#f5f3ff",100:"#ede9fe",200:"#ddd6fe",300:"#c4b5fd",400:"#a78bfa",500:"#8b5cf6",600:"#7c3aed",700:"#6d28d9",800:"#5b21b6",900:"#4c1d95"},purple:{50:"#faf5ff",100:"#f3e8ff",200:"#e9d5ff",300:"#d8b4fe",400:"#c084fc",500:"#a855f7",600:"#9333ea",700:"#7e22ce",800:"#6b21a8",900:"#581c87"},fuchsia:{50:"#fdf4ff",100:"#fae8ff",200:"#f5d0fe",300:"#f0abfc",400:"#e879f9",500:"#d946ef",600:"#c026d3",700:"#a21caf",800:"#86198f",900:"#701a75"},pink:{50:"#fdf2f8",100:"#fce7f3",200:"#fbcfe8",300:"#f9a8d4",400:"#f472b6",500:"#ec4899",600:"#db2777",700:"#be185d",800:"#9d174d",900:"#831843"},rose:{50:"#fff1f2",100:"#ffe4e6",200:"#fecdd3",300:"#fda4af",400:"#fb7185",500:"#f43f5e",600:"#e11d48",700:"#be123c",800:"#9f1239",900:"#881337"},red:{50:"#fef2f2",100:"#fee2e2",200:"#fecaca",300:"#fca5a5",400:"#f87171",500:"#dc2626",600:"#b91c1c",700:"#991b1b",800:"#7f1d1d",900:"#450a0a"},orange:{50:"#fff7ed",100:"#ffedd5",200:"#fed7aa",300:"#fdba74",400:"#fb923c",500:"#ea580c",600:"#c2410c",700:"#9a3412",800:"#7c2d12",900:"#431407"},amber:{50:"#fffbeb",100:"#fef3c7",200:"#fde68a",300:"#fcd34d",400:"#fbbf24",500:"#d97706",600:"#b45309",700:"#92400e",800:"#78350f",900:"#451a03"},yellow:{50:"#fefce8",100:"#fef9c3",200:"#fef08a",300:"#fde047",400:"#eab308",500:"#d97706",600:"#b45309",700:"#854d0e",800:"#713f12",900:"#3f1d0b"},lime:{50:"#f7fee7",100:"#ecfccb",200:"#d9f99d",300:"#bef264",400:"#a3e635",500:"#65a30d",600:"#4d7c0f",700:"#3f6212",800:"#365314",900:"#1a2e05"},green:{50:"#f0fdf4",100:"#dcfce7",200:"#bbf7d0",300:"#86efac",400:"#4ade80",500:"#16a34a",600:"#15803d",700:"#166534",800:"#14532d",900:"#052e16"},slate:{50:"#f8fafc",100:"#f1f5f9",200:"#e2e8f0",300:"#cbd5e1",400:"#94a3b8",500:"#475569",600:"#334155",700:"#1e293b",800:"#0f172a",900:"#020617"},stone:{50:"#fafaf9",100:"#f5f5f4",200:"#e7e5e4",300:"#d6d3d1",400:"#a8a29e",500:"#57534e",600:"#44403c",700:"#292524",800:"#1c1917",900:"#0c0a09"}},Wa=e=>{let t=parseInt(e.replace("#",""),16);return(t>>16&255)+","+(t>>8&255)+","+(t&255)},Fa=(e,t)=>{let a=parseInt(e.slice(1,3),16),r=parseInt(e.slice(3,5),16),s=parseInt(e.slice(5,7),16);return a=Math.max(0,Math.min(255,a+t)),r=Math.max(0,Math.min(255,r+t)),s=Math.max(0,Math.min(255,s+t)),"#"+[a,r,s].map(o=>o.toString(16).padStart(2,"0")).join("")},Qs=e=>{if(!e)return;try{document.querySelectorAll('meta[name="theme-color"]').forEach(d=>d.remove())}catch{}const t=document.createElement("meta");t.setAttribute("name","theme-color"),t.setAttribute("content",e),document.head.appendChild(t);try{document.querySelectorAll('meta[name="msapplication-navbutton-color"], meta[name="msapplication-TileColor"]').forEach(d=>d.remove())}catch{}const a=document.createElement("meta");a.setAttribute("name","msapplication-navbutton-color"),a.setAttribute("content",e),document.head.appendChild(a);const r=document.createElement("meta");r.setAttribute("name","msapplication-TileColor"),r.setAttribute("content",e),document.head.appendChild(r);let s=document.querySelector('meta[name="apple-mobile-web-app-capable"]');s||(s=document.createElement("meta"),s.setAttribute("name","apple-mobile-web-app-capable"),document.head.appendChild(s)),s.setAttribute("content","yes");let o=document.querySelector('meta[name="mobile-web-app-capable"]');o||(o=document.createElement("meta"),o.setAttribute("name","mobile-web-app-capable"),document.head.appendChild(o)),o.setAttribute("content","yes");let i=document.querySelector('meta[name="apple-mobile-web-app-status-bar-style"]');i||(i=document.createElement("meta"),i.setAttribute("name","apple-mobile-web-app-status-bar-style"),document.head.appendChild(i)),i.setAttribute("content","default"),typeof window.updatePwaManifest=="function"&&window.updatePwaManifest(e)},Ke=(e,t)=>{const a=e||localStorage.getItem("freshmart_ui_theme")||"emerald",r=tt[a]||tt.emerald;e&&localStorage.setItem("freshmart_ui_theme",a);const s=t||localStorage.getItem("freshmart_theme_color")||r[500];t&&localStorage.setItem("freshmart_theme_color",s);const o=Wa(s),i=Fa(s,-30),l=Fa(s,150);return document.documentElement.style.setProperty("--color-primary",s),document.documentElement.style.setProperty("--color-primary-dark",i),document.documentElement.style.setProperty("--color-primary-light",l),document.documentElement.style.setProperty("--color-primary-rgb",o),Qs(s),r},zs=()=>{const e=localStorage.getItem("freshmart_theme"),t=window.matchMedia("(prefers-color-scheme: dark)").matches;(e==="dark"||!e&&t)&&document.documentElement.classList.add("dark")},Js=()=>{const e=document.documentElement.classList.toggle("dark");localStorage.setItem("freshmart_theme",e?"dark":"light");const t=document.getElementById("icon-theme")||document.getElementById("theme-toggle-icon");t&&(t.className=e?"fa-solid fa-sun text-sm text-amber-400":"fa-solid fa-moon text-sm text-slate-600 dark:text-slate-300")},Ys=()=>{const e=document.documentElement.classList.contains("dark"),t=document.getElementById("icon-theme")||document.getElementById("theme-toggle-icon");t&&(t.className=e?"fa-solid fa-sun text-sm text-amber-400":"fa-solid fa-moon text-sm text-slate-600 dark:text-slate-300")},We=(e="minimalist",t="")=>{const a=e||localStorage.getItem("freshmart_bg_style")||"minimalist",r=t??(localStorage.getItem("freshmart_bg_custom_url")||"");e&&localStorage.setItem("freshmart_bg_style",a),t!=null&&localStorage.setItem("freshmart_bg_custom_url",r);const o=(p=>{if(!p||typeof p!="string")return"";const u=p.match(/drive\.google\.com.*(?:id=|\/d\/)([a-zA-Z0-9_-]+)/);return u?`https://lh3.googleusercontent.com/d/${u[1]}`:p.trim()})(r);document.documentElement.setAttribute("data-bg-style",a),document.body?.setAttribute("data-bg-style",a);const i=document.getElementById("app-container");i&&(i.setAttribute("data-bg-style",a),o?i.setAttribute("data-has-custom-bg","true"):i.removeAttribute("data-has-custom-bg"));const l=document.getElementById("dynamic-bg-container");if(!l)return;if(l.innerHTML="",l.className="pointer-events-none fixed inset-0 z-0 overflow-hidden",o){const p=document.createElement("div");p.className="absolute inset-0 z-0 bg-cover bg-center bg-no-repeat bg-fixed opacity-35 dark:opacity-25 pointer-events-none transition-all duration-500",p.style.backgroundImage=`url('${o}')`,l.appendChild(p);const u=document.createElement("div");u.className="absolute inset-0 z-0 bg-slate-50/70 dark:bg-[#0b1120]/80 pointer-events-none backdrop-blur-[0.5px]",l.appendChild(u)}let d="";if(a==="hero_arch"?d=`
    ...
    <div class="flex gap-4 overflow-x-auto hide-scrollbar snap-x pb-6 pt-2">
        ...
        </div>`,St(),e.style.opacity="0",e.style.display="flex",requestAnimationFrame(()=>{e.style.transition="opacity 0.25s ease",e.style.opacity="1"}),typeof window.pushModalHistory=="function"&&window.pushModalHistory("member")},St=()=>{const e=(n.rewards||[]).filter(r=>r.isActive!=="false"&&r.isActive!==!1),t=ke&&parseFloat(ke.points)||0,a=e.length?e.map(r=>{const s=(parseFloat(r.stock)||0)>0,o=ke&&t>=(parseFloat(r.pointsCost)||0)&&s,i=Se&&Se.id===r.id;return`
        ...
        </div>`,S=`<span class="text-[9px] text-slate-600 dark:text-slate-400 font-bold ml-0.5 mb-0.5 uppercase tracking-wide">/${c(l.unit||"PCS")}</span>`;return Ct==="grid"?`
    ...
    `;t.innerHTML=i,e.classList.contains("hidden")&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("variantPreview"),L("variant-preview-modal"),setTimeout(()=>{e.classList.remove("opacity-0"),t.classList.remove("scale-95")},10)},Jr=(e=!1)=>{const t=m("variant-preview-modal"),a=m("variant-preview-content");if(t&&a){const r=()=>{t.classList.add("opacity-0"),a.classList.add("scale-95"),setTimeout(()=>{$("variant-preview-modal"),a.innerHTML=""},300)};typeof window.requestCloseModal=="function"?window.requestCloseModal("variantPreview",e,r):r()}},Yr=e=>{Et(A?.video)&&(window.cSlideIdx+=e,window.cSlideIdx>1&&(window.cSlideIdx=0),window.cSlideIdx<0&&(window.cSlideIdx=1),Vt())},Vt=()=>{if(!A)return;let e=A,t=e.isActive!=="false"&&e.isActive!==!1,a=e.variants?.length>0;const r=(e.name||"").toLowerCase(),s=(e.category||"").toLowerCase(),o=(e.tag||"").toLowerCase(),i=["cat","paint","warna","colour","color","putih","hitam","merah","biru","hijau","kuning","orange","abu","coklat","cream","krem","beige","ivory","mocca","rose","tosca","lavender","salmon","broken white","off white","natural","magnolia","primer","dasar","eksterior","exterior","interior","tembok","duco","gloss","matte","satin","semi gloss"],l=r.includes("cat")&&(r.includes("tembok")||r.includes("interior")||r.includes("eksterior")||r.includes("exterior"))||s.includes("cat")||s.includes("paint")||o.includes("cat")||o.includes("paint"),d=a&&e.variants.some(F=>{const y=(F.name||"").toLowerCase();return i.some(R=>y.includes(R))}),p=l||d,u=m("product-modal-paint-warning");u&&(p?u.classList.remove("hidden"):u.classList.add("hidden"));let b=a&&te!==null?e.variants[te]:null,f=b?.unit||e.unit||"Pcs";const x=m("product-modal-img"),v=m("product-modal-video-container"),h=Et(e.video),T=b&&b.img,_=m("slide-prev"),M=m("slide-next"),V=m("slide-dots");if(h&&!T)if(_&&_.classList.remove("hidden"),M&&M.classList.remove("hidden"),V&&(V.classList.remove("hidden"),V.innerHTML=`
        ...
        <div class="mb-6 bg-amber-50 dark:bg-amber-900/10 rounded-2xl p-4 border border-amber-200 dark:border-amber-800/50 shadow-inner">
            ...
            <div class="mb-6 bg-[rgba(var(--color-primary-rgb),0.05)] dark:bg-[rgba(var(--color-primary-rgb),0.08)] rounded-2xl p-4 border border-[var(--color-primary)]/20">
                ...
                </button>`}).join(""),F+="</div>",P("product-modal-options",F)}else $("product-modal-options-container");else $("modal-active-controls"),L("modal-inactive-controls"),$("product-modal-options-container");Gt()},Gt=()=>{if(!A)return;if(A.variants?.length>0&&te===null){U("btn-modal-price-preview","Rp 0");return}let e=(A.variants||[])[te],a=e?.price??A.price;const r=e?.name||null;let s=0;r?s=parseFloat(E.find(i=>i.id===A.id&&i.variantName===r)?.qty||0):s=E.filter(i=>i.id===A.id).reduce((i,l)=>i+(parseFloat(l.qty)||0),0);let o=Pe+s;if(A.wholesale?.length){for(let i of A.wholesale.slice().sort((l,d)=>d.minQty-l.minQty))if(o>=parseFloat(i.minQty)){a=i.price;break}}U("btn-modal-price-preview",w(a*Pe))},Xr=e=>{const t=n.store.useStock===!0||n.store.useStock==="true",a=A?.variants?.[te],r=a?.name||null,s=t?r?parseFloat(a?.stock)||0:parseFloat(A?.stock)||0:1/0,o=parseFloat(Math.min(s,Math.max(.01,Pe+e)).toFixed(2));Ut(o),se("modal-qty-input",Pe),Gt(),t&&s!==1/0&&Pe>=s&&g(`Maks stok: ${s}`)},Zr=e=>{const t=n.store.useStock===!0||n.store.useStock==="true",a=A?.variants?.[te],r=a?.name||null,s=t?r?parseFloat(a?.stock)||0:parseFloat(A?.stock)||0:1/0;let o=parseFloat(e);(isNaN(o)||o<=0)&&(o=.01),o=Math.min(s,o);const i=parseFloat(o.toFixed(2));Ut(i),se("modal-qty-input",Pe),Gt()},eo=e=>{Lt(e),Vt()},to=()=>{if(A.variants?.length>0&&te===null)return g("Pilih varian / warna terlebih dahulu!");if(n.store.useStock===!0||n.store.useStock==="true"){const o=A.variants?.[te],i=o?.name||null,l=i?parseFloat(o.stock)||0:parseFloat(A.stock)||0,d=E.find(u=>u.id===A.id&&u.variantName===i),p=d&&parseFloat(d.qty)||0;if(Pe+p>l)return g(`Stok tidak cukup! Tersisa: ${l}`)}const t=A.variants?.[te],a=t?.name||null,r=E.find(o=>o.id===A.id&&o.variantName===a),s=t?.unit||A.unit||"pcs";if(r)r.qty=parseFloat((r.qty+Pe).toFixed(2)),r.unit=s;else{const o=t&&parseFloat(t.poin)>0?parseFloat(t.poin):parseFloat(A.poin)||0;E.push({id:A.id,name:A.name,variantName:a,price:t?.price??A.price,img:t?.img||A.img,qty:Pe,unit:s,poTime:A.poTime||"",colorCode:t?.colorCode||"",poin:o})}Me(),typeof analytics<"u"&&analytics.logEvent("add_to_cart",{item_id:A.id,item_name:A.name,quantity:Pe}),ha(),g("Berhasil Masuk Keranjang")},ao=()=>{if(A.variants?.length>0&&te===null)return g("Pilih varian / warna terlebih dahulu!");const e=A.variants?.[te],t=e?.name||null;if(ne.find(a=>a.id===A.id&&a.variantName===t))return g("Sudah di Favorit!");ne.push({id:A.id,name:A.name,variantName:t,price:e?.price??A.price,img:e?.img||A.img,colorCode:e?.colorCode||""}),ae("freshmart_wishlist",JSON.stringify(ne)),typeof window.updWish=="function"&&window.updWish(),ha(),g("Masuk Favorit ❤️")},so=()=>{if(!A)return;const e=window.location.origin+window.location.pathname+"?p="+A.id,t=A.name,a=`Cek produk ${A.name} di ${n.store.name} sekarang!`;if(navigator.share)navigator.share({title:t,text:a,url:e}).catch(r=>{console.log("User membatalkan share",r)});else if(navigator.clipboard&&navigator.clipboard.writeText)navigator.clipboard.writeText(e).then(()=>g("Link produk berhasil disalin!")).catch(()=>g("Gagal menyalin link."));else{const r=document.createElement("textarea");r.value=e,r.style.position="fixed",r.style.opacity="0",document.body.appendChild(r),r.select(),document.execCommand("copy"),document.body.removeChild(r),g("Link produk berhasil disalin!")}};window.openProductModal=Wr;window.closeProductModal=ha;window.previewVariant=Qr;window.previewProductImage=zr;window.closeVariantPreviewModal=Jr;window.changeSlide=Yr;window.rProdMod=Vt;window.uMPP=Gt;window.updateModalQty=Xr;window.handleModalQtyChange=Zr;window.selectVariant=eo;window.confirmAddProductToCart=to;window.confirmAddToWishlist=ao;window.shareProduct=so;let ta=[];const Kt=()=>{try{localStorage.setItem("freshmart_my_orders",JSON.stringify(re))}catch(e){console.warn("[MyOrders] Gagal menyimpan ke localStorage:",e)}},ro=()=>{try{const e=localStorage.getItem("freshmart_my_orders");if(e){const t=JSON.parse(e);Array.isArray(t)&&t.length>0&&Nt(t)}}catch(e){console.warn("[MyOrders] Gagal memuat dari localStorage:",e)}return re},ks=()=>{ta.forEach(e=>{try{typeof e=="function"&&e()}catch{}}),ta=[]},$s=()=>{ks(),re.filter(a=>{const r=a.status==="Selesai"||a.status==="Dibatalkan",s=a.claimedReward&&(a.claimedReward.status==="Menunggu Persetujuan"||!a.claimedReward.status);return!r||s}).slice(0,10).forEach(a=>{const r=a.orderId;if(!r)return;const s=k.collection("freshmart_orders").doc(r).onSnapshot(o=>{if(!o.exists)return;const i=o.data(),l=i.status,d=i.claimedReward?i.claimedReward.status:null,p=i.claimedReward&&i.claimedReward.note||"";let u=!1,b="";const f=re.find(x=>x.orderId===r);if(f){if(l&&f.status!==l){const x=f.status;f.status=l,u=!0,x!==void 0&&(b=`Pesanan #${r.split("-").pop()} kini: ${l}`)}f.claimedReward&&d&&(f.claimedReward.status!==d||f.claimedReward.note!==p)&&(f.claimedReward.status=d,f.claimedReward.note=p,u=!0),u&&(Kt(),window.curViewName==="view-orders"&&Pt(),b&&g(b))}},o=>{console.warn("[MyOrders Realtime] Snapshot error:",o.message)});ta.push(s)})},Pt=async()=>{if(ro(),!re.length){L("orders-empty-state"),$("btn-clear-orders"),L("spacer-orders"),P("orders-items-container","");return}$("orders-empty-state"),L("btn-clear-orders"),$("spacer-orders"),$s(),P("orders-items-container",re.map((e,t)=>{const a=new Date(e.date).toLocaleDateString("id-ID",{day:"numeric",month:"short",year:"numeric"});let r="text-slate-500 border-slate-200 bg-slate-50 dark:bg-slate-800 dark:border-slate-700",s="fa-clock";return e.status==="Baru"?(r="text-rose-600 border-rose-200 bg-rose-50 dark:bg-rose-900/30 dark:border-rose-800 dark:text-rose-400",s="fa-asterisk"):e.status==="Diproses"?(r="text-[var(--color-primary)] border-[var(--color-primary)]/30 bg-[rgba(var(--color-primary-rgb),0.08)] dark:bg-[rgba(var(--color-primary-rgb),0.15)] dark:border-[var(--color-primary)]/40",s="fa-spinner fa-spin"):e.status==="Selesai"?(r="text-[var(--color-primary)] border-[var(--color-primary)]/30 bg-[rgba(var(--color-primary-rgb),0.08)] dark:bg-[rgba(var(--color-primary-rgb),0.15)] dark:border-[var(--color-primary)]/40",s="fa-check-double"):e.status==="Dibatalkan"&&(r="text-slate-400 border-slate-200 bg-slate-100 dark:bg-slate-800 dark:border-slate-700 dark:text-slate-400",s="fa-xmark"),`
...
Kami akan segera memproses pesanan Anda. Terima kasih! 🙏`;window.open(`https://wa.me/${r}?text=${encodeURIComponent(p)}`,"_blank")}catch{D(),g("Gagal memuat data pesanan!")}},Ao=e=>{_e("Hapus Pesanan","Yakin ingin hapus permanen?",async()=>{if(!Ue){ee(!0),O("Menghapus...");try{await k.collection("freshmart_orders").doc(e).delete(),g("Terhapus!"),rt===e&&As()}catch{g("Gagal!")}finally{ee(!1),D()}}})};window.exportOrdersToExcel=vo;window.rAdmOrd=ko;window.openOrderDetail=Sa;window.saveOrderCustomerToDB=$o;window.ackRewardClaim=So;window.closeOrderDetailModal=As;window.updateOrderStatus=Po;window.konfirmasiKeWA=To;window.deleteOrder=Ao;const Mo=()=>{const e=n.store.name||"Toko Grosir",t=n.store.themeColor||"#10b981",a=(o,i,l=!1)=>{let d=document.querySelector(`meta[${l?"property":"name"}="${o}"]`);d||(d=document.createElement("meta"),l?d.setAttribute("property",o):d.setAttribute("name",o),document.head.appendChild(d)),d.setAttribute("content",i)};a("theme-color",t),a("mobile-web-app-capable","yes"),a("apple-mobile-web-app-capable","yes"),a("apple-mobile-web-app-status-bar-style","black-translucent"),a("apple-mobile-web-app-title",e),a("application-name",e),a("msapplication-TileColor",t),document.title=e,localStorage.setItem("freshmart_theme_color",t),n.store.uiTheme&&n.store.uiTheme!==localStorage.getItem("freshmart_ui_theme")&&(localStorage.setItem("freshmart_ui_theme",n.store.uiTheme),Ke(n.store.uiTheme));const r=n.store.bgStyle||localStorage.getItem("freshmart_bg_style")||"minimalist",s=n.store.bgCustomUrl!==void 0?n.store.bgCustomUrl:localStorage.getItem("freshmart_bg_custom_url")||"";We(r,s)},Ms=()=>{P("admin-content",`
    ...
    </div>`),Qt()},Bo=e=>{Ne=e,Aa()},No=async e=>{oe=parseInt(e,10),P("tax-content",'<div class="text-center py-16"><i class="fa-solid fa-spinner fa-spin text-3xl text-slate-300"></i></div>'),Oe=await Pa(oe),Qt()},Oo=e=>{ie=parseInt(e,10),Qt()},Qt=()=>{Ne==="summary"?Ds():Ne==="income"?Ma():Ne==="balance"?Da():Ne==="settings"&&Cs()},Ds=()=>{const e=yt(),t=ie===0?`Tahun ${oe}`:`${qe[ie-1]} ${oe}`,a=e.omset-e.disc,r=Array.from({length:12},(s,o)=>o+1).map(s=>{const o=Oe?Oe[s]:{omset:0,ppn:0,orderCount:0};return`<tr class="${ie===s?"bg-[rgba(var(--color-primary-rgb),0.08)] dark:bg-[rgba(var(--color-primary-rgb),0.14)] font-bold":"hover:bg-slate-50 dark:hover:bg-slate-700/30"} border-b border-slate-100 dark:border-slate-700/50 last:border-0 transition-colors">
    ...
    `)},Ma=()=>{const e=yt(),t=ie===0?`Tahun ${oe}`:`${qe[ie-1]} ${oe}`,a=e.omset-e.disc-e.hpp,r=ie===0?null:`${oe}-${ie}`,s=Ta(),o=a-s,i=n.taxSettings?.taxScheme||"umkm_final";let l,d,p;i==="umkm_final"?(l=.5,d=e.omset,p="PPh Final UMKM (0,5% × Omset)"):i==="badan_normal"?(l=22,d=Math.max(0,o),p="PPh Badan (22% × Laba Bersih)"):(l=parseFloat(n.taxSettings?.customTaxRate)||0,d=Math.max(0,o),p=`PPh Custom (${l}% × Laba Bersih)`);const u=d*(l/100),b=o-u;let f="";if(ie===0)f=Array.from({length:12},(x,v)=>v+1).map(x=>{const v=`${oe}-${x}`,h=(n.taxSettings?.monthlyExpenses||{})[v]||0;return`<div class="flex items-center justify-between gap-2 py-2 border-b border-slate-100 dark:border-slate-700/50 last:border-0">
    ...
    `;e.length===0?a+=`<div class="bg-white dark:bg-slate-800 p-8 text-center rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm">
            ...
            </div>`}),a+="</div>"),a+="</div>",P("admin-content",a),setTimeout(()=>{m("total-piutang-header")&&(m("total-piutang-header").innerText=w(t))},100)};const Ko=e=>{fs(e),Ls()},Ls=()=>{const e=ma||"all",t=($t||[]).filter(o=>e==="visible"?o.isVisible!==!1:e==="hidden"?o.isVisible===!1:!0),a=`
