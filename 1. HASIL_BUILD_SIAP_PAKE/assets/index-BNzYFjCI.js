...
import{f as ue}from"./vendor-firebase-core-D2OF5R23.js";import{p as Os,a as qs}from"./vendor-firebase-db-BHlQMNP0.js";import{p as Us}from"./vendor-utils-bRchjNq8.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&r(i)}).observe(document,{childList:!0,subtree:!0});function a(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(s){if(s.ep)return;s.ep=!0;const o=a(s);fetch(s.href,o)}})();const Hs="modulepreload",Vs=function(e){return"/"+e},_a={},Gs=function(t,a,r){let s=Promise.resolve();if(a&&a.length>0){document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),l=i?.nonce||i?.getAttribute("nonce");s=Promise.allSettled(a.map(d=>{if(d=Vs(d),d in _a)return;_a[d]=!0;const p=d.endsWith(".css"),f=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${f}`))return;const b=document.createElement("link");if(b.rel=p?"stylesheet":Hs,p||(b.as="script"),b.crossOrigin="",b.href=d,l&&b.setAttribute("nonce",l),document.head.appendChild(b),p)return new Promise((u,w)=>{b.addEventListener("load",u),b.addEventListener("error",()=>w(new Error(`Unable to preload CSS for ${d}`)))})}))}function o(i){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=i,window.dispatchEvent(l),!l.defaultPrevented)throw i}return s.then(i=>{for(const l of i||[])l.status==="rejected"&&o(l.reason);return t().catch(o)})},Ks={apiKey:"AIzaSyCOjrhMP52TGbiOyQLY92NDYE26N6d9hJM",authDomain:"restu-karya-utama.firebaseapp.com",databaseURL:"https://restu-karya-utama-default-rtdb.asia-southeast1.firebasedatabase.app",projectId:"restu-karya-utama",storageBucket:"restu-karya-utama.firebasestorage.app",messagingSenderId:"858310421352",appId:"1:858310421352:web:e20a833875e8d5c19944dd",measurementId:"G-PHDG2LJ8PM"};try{localStorage.removeItem("freshmart_fb_config")}catch{}const da=window.FIREBASE_CONFIG||Ks;ue.apps.length||ue.initializeApp(da);const k=ue.firestore(),we=ue.auth();typeof window<"u"&&(window.firebase=ue,window.db=k,window.auth=we);try{k.settings({localCache:Os({tabManager:qs()}),ignoreUndefinedProperties:!0,merge:!0,experimentalAutoDetectLongPolling:!0})}catch{try{k.settings({ignoreUndefinedProperties:!0,merge:!0,experimentalAutoDetectLongPolling:!0})}catch{}}let Ws=null;const Ra=()=>{Gs(()=>import("./vendor-firebase-analytics-Jm19L5g2.js"),__vite__mapDeps([0,1])).then(()=>{try{Ws=ue.analytics()}catch{}}).catch(()=>{})},ca="K2ijSERTT2dg27yYGTEgn6XHSnW2",tt={emerald:{50:"#ecfdf5",100:"#d1fae5",200:"#a7f3d0",300:"#6ee7b7",400:"#34d399",500:"#10b981",600:"#059669",700:"#047857",800:"#065f46",900:"#064e3b"},teal:{50:"#f0fdfa",100:"#ccfbf1",200:"#99f6e4",300:"#5eead4",400:"#2dd4bf",500:"#14b8a6",600:"#0d9488",700:"#0f766e",800:"#115e59",900:"#134e4a"},cyan:{50:"#ecfeff",100:"#cffafe",200:"#a5f3fc",300:"#67e8f9",400:"#22d3ee",500:"#06b6d4",600:"#0891b2",700:"#0e7490",800:"#155e75",900:"#164e63"},sky:{50:"#f0f9ff",100:"#e0f2fe",200:"#bae6fd",300:"#7dd3fc",400:"#38bdf8",500:"#0ea5e9",600:"#0284c7",700:"#0369a1",800:"#075985",900:"#0c4a6e"},blue:{50:"#eff6ff",100:"#dbeafe",200:"#bfdbfe",300:"#93c5fd",400:"#60a5fa",500:"#3b82f6",600:"#2563eb",700:"#1d4ed8",800:"#1e40af",900:"#1e3a8a"},indigo:{50:"#eef2ff",100:"#e0e7ff",200:"#c7d2fe",300:"#a5b4fc",400:"#818cf8",500:"#6366f1",600:"#4f46e5",700:"#4338ca",800:"#3730a3",900:"#312e81"},violet:{50:"#f5f3ff",100:"#ede9fe",200:"#ddd6fe",300:"#c4b5fd",400:"#a78bfa",500:"#8b5cf6",600:"#7c3aed",700:"#6d28d9",800:"#5b21b6",900:"#4c1d95"},purple:{50:"#faf5ff",100:"#f3e8ff",200:"#e9d5ff",300:"#d8b4fe",400:"#c084fc",500:"#a855f7",600:"#9333ea",700:"#7e22ce",800:"#6b21a8",900:"#581c87"},fuchsia:{50:"#fdf4ff",100:"#fae8ff",200:"#f5d0fe",300:"#f0abfc",400:"#e879f9",500:"#d946ef",600:"#c026d3",700:"#a21caf",800:"#86198f",900:"#701a75"},pink:{50:"#fdf2f8",100:"#fce7f3",200:"#fbcfe8",300:"#f9a8d4",400:"#f472b6",500:"#ec4899",600:"#db2777",700:"#be185d",800:"#9d174d",900:"#831843"},rose:{50:"#fff1f2",100:"#ffe4e6",200:"#fecdd3",300:"#fda4af",400:"#fb7185",500:"#f43f5e",600:"#e11d48",700:"#be123c",800:"#9f1239",900:"#881337"},red:{50:"#fef2f2",100:"#fee2e2",200:"#fecaca",300:"#fca5a5",400:"#f87171",500:"#dc2626",600:"#b91c1c",700:"#991b1b",800:"#7f1d1d",900:"#450a0a"},orange:{50:"#fff7ed",100:"#ffedd5",200:"#fed7aa",300:"#fdba74",400:"#fb923c",500:"#ea580c",600:"#c2410c",700:"#9a3412",800:"#7c2d12",900:"#431407"},amber:{50:"#fffbeb",100:"#fef3c7",200:"#fde68a",300:"#fcd34d",400:"#fbbf24",500:"#d97706",600:"#b45309",700:"#92400e",800:"#78350f",900:"#451a03"},yellow:{50:"#fefce8",100:"#fef9c3",200:"#fef08a",300:"#fde047",400:"#eab308",500:"#d97706",600:"#b45309",700:"#854d0e",800:"#713f12",900:"#3f1d0b"},lime:{50:"#f7fee7",100:"#ecfccb",200:"#d9f99d",300:"#bef264",400:"#a3e635",500:"#65a30d",600:"#4d7c0f",700:"#3f6212",800:"#365314",900:"#1a2e05"},green:{50:"#f0fdf4",100:"#dcfce7",200:"#bbf7d0",300:"#86efac",400:"#4ade80",500:"#16a34a",600:"#15803d",700:"#166534",800:"#14532d",900:"#052e16"},slate:{50:"#f8fafc",100:"#f1f5f9",200:"#e2e8f0",300:"#cbd5e1",400:"#94a3b8",500:"#475569",600:"#334155",700:"#1e293b",800:"#0f172a",900:"#020617"},stone:{50:"#fafaf9",100:"#f5f5f4",200:"#e7e5e4",300:"#d6d3d1",400:"#a8a29e",500:"#57534e",600:"#44403c",700:"#292524",800:"#1c1917",900:"#0c0a09"}},Wa=e=>{let t=parseInt(e.replace("#",""),16);return(t>>16&255)+","+(t>>8&255)+","+(t&255)},Fa=(e,t)=>{let a=parseInt(e.slice(1,3),16),r=parseInt(e.slice(3,5),16),s=parseInt(e.slice(5,7),16);return a=Math.max(0,Math.min(255,a+t)),r=Math.max(0,Math.min(255,r+t)),s=Math.max(0,Math.min(255,s+t)),"#"+[a,r,s].map(o=>o.toString(16).padStart(2,"0")).join("")},Qs=e=>{if(!e)return;try{document.querySelectorAll('meta[name="theme-color"]').forEach(d=>d.remove())}catch{}const t=document.createElement("meta");t.setAttribute("name","theme-color"),t.setAttribute("content",e),document.head.appendChild(t);try{document.querySelectorAll('meta[name="msapplication-navbutton-color"], meta[name="msapplication-TileColor"]').forEach(d=>d.remove())}catch{}const a=document.createElement("meta");a.setAttribute("name","msapplication-navbutton-color"),a.setAttribute("content",e),document.head.appendChild(a);const r=document.createElement("meta");r.setAttribute("name","msapplication-TileColor"),r.setAttribute("content",e),document.head.appendChild(r);let s=document.querySelector('meta[name="apple-mobile-web-app-capable"]');s||(s=document.createElement("meta"),s.setAttribute("name","apple-mobile-web-app-capable"),document.head.appendChild(s)),s.setAttribute("content","yes");let o=document.querySelector('meta[name="mobile-web-app-capable"]');o||(o=document.createElement("meta"),o.setAttribute("name","mobile-web-app-capable"),document.head.appendChild(o)),o.setAttribute("content","yes");let i=document.querySelector('meta[name="apple-mobile-web-app-status-bar-style"]');i||(i=document.createElement("meta"),i.setAttribute("name","apple-mobile-web-app-status-bar-style"),document.head.appendChild(i)),i.setAttribute("content","default"),typeof window.updatePwaManifest=="function"&&window.updatePwaManifest(e)},Ke=(e,t)=>{const a=e||localStorage.getItem("freshmart_ui_theme")||"emerald",r=tt[a]||tt.emerald;e&&localStorage.setItem("freshmart_ui_theme",a);const s=t||localStorage.getItem("freshmart_theme_color")||r[500];t&&localStorage.setItem("freshmart_theme_color",s);const o=Wa(s),i=Fa(s,-30),l=Fa(s,150);return document.documentElement.style.setProperty("--color-primary",s),document.documentElement.style.setProperty("--color-primary-dark",i),document.documentElement.style.setProperty("--color-primary-light",l),document.documentElement.style.setProperty("--color-primary-rgb",o),Qs(s),r},zs=()=>{const e=localStorage.getItem("freshmart_theme"),t=window.matchMedia("(prefers-color-scheme: dark)").matches;(e==="dark"||!e&&t)&&document.documentElement.classList.add("dark")},Js=()=>{const e=document.documentElement.classList.toggle("dark");localStorage.setItem("freshmart_theme",e?"dark":"light");const t=document.getElementById("icon-theme")||document.getElementById("theme-toggle-icon");t&&(t.className=e?"fa-solid fa-sun text-sm text-amber-400":"fa-solid fa-moon text-sm text-slate-600 dark:text-slate-300")},Ys=()=>{const e=document.documentElement.classList.contains("dark"),t=document.getElementById("icon-theme")||document.getElementById("theme-toggle-icon");t&&(t.className=e?"fa-solid fa-sun text-sm text-amber-400":"fa-solid fa-moon text-sm text-slate-600 dark:text-slate-300")},We=(e="minimalist",t="")=>{const a=e||localStorage.getItem("freshmart_bg_style")||"minimalist",r=t??(localStorage.getItem("freshmart_bg_custom_url")||"");e&&localStorage.setItem("freshmart_bg_style",a),t!=null&&localStorage.setItem("freshmart_bg_custom_url",r);const o=(p=>{if(!p||typeof p!="string")return"";const f=p.match(/drive\.google\.com.*(?:id=|\/d\/)([a-zA-Z0-9_-]+)/);return f?`https://lh3.googleusercontent.com/d/${f[1]}`:p.trim()})(r);document.documentElement.setAttribute("data-bg-style",a),document.body?.setAttribute("data-bg-style",a);const i=document.getElementById("app-container");i&&(i.setAttribute("data-bg-style",a),o?i.setAttribute("data-has-custom-bg","true"):i.removeAttribute("data-has-custom-bg"));const l=document.getElementById("dynamic-bg-container");if(!l)return;if(l.innerHTML="",l.className="pointer-events-none fixed inset-0 z-0 overflow-hidden",o){const p=document.createElement("div");p.className="absolute inset-0 z-0 bg-cover bg-center bg-no-repeat bg-fixed opacity-35 dark:opacity-25 pointer-events-none transition-all duration-500",p.style.backgroundImage=`url('${o}')`,l.appendChild(p);const f=document.createElement("div");f.className="absolute inset-0 z-0 bg-slate-50/70 dark:bg-[#0b1120]/80 pointer-events-none backdrop-blur-[0.5px]",l.appendChild(f)}let d="";if(a==="hero_arch"?d=`
    ...
    `;e.innerHTML=`
        ...
        </div>`,e.style.opacity="0",e.style.display="flex",requestAnimationFrame(()=>{e.style.transition="opacity 0.25s ease",e.style.opacity="1"}),typeof window.pushModalHistory=="function"&&window.pushModalHistory("voucher")},vr=e=>{navigator.clipboard&&navigator.clipboard.writeText?navigator.clipboard.writeText(e).then(()=>{typeof window.showToast=="function"&&window.showToast(`✅ Kode "${e}" disalin ke clipboard!`)}).catch(()=>{typeof window.showToast=="function"&&window.showToast(`Kode Kupon: ${e}`)}):typeof window.showToast=="function"&&window.showToast(`Kode Kupon: ${e}`)},yr=e=>{ga();const t=m("voucher-input");t&&(t.value=e,ws()),E.length>0?typeof window.changeView=="function"&&window.changeView("view-checkout"):(typeof window.showToast=="function"&&window.showToast(`Kode "${e}" siap digunakan saat checkout belanja!`),typeof window.changeView=="function"&&window.changeView("view-catalog"))},ga=()=>{const e=document.getElementById("voucher-modal");!e||e.style.display==="none"||(e.style.opacity="0",e.style.transition="opacity 0.25s ease",setTimeout(()=>{e.style.display="none",e.style.opacity="",e.style.transition=""},250))};window.applyVoucher=ws;window.openVoucherModal=hr;window.closeVoucherModal=ga;window.copyVoucherCode=vr;window.useVoucherCode=yr;const Yt=new Map,kr=3*60*1e3,$r=()=>{const e=m("reward-catalog-container");if(!e)return;const t=n.store.showRewardCatalog!==!1&&n.store.showRewardCatalog!=="false",a=(n.rewards||[]).filter(s=>s.isActive!=="false"&&s.isActive!==!1);if(!t||a.length===0){e.classList.add("hidden");return}typeof window.attachRewardsRealtime=="function"&&!window.unsubRewardsRealtime&&window.attachRewardsRealtime(),e.classList.remove("hidden");let r=`
    ...
    <div class="flex gap-4 overflow-x-auto hide-scrollbar snap-x pb-6 pt-2">
        ...
        </div>`,$t(),e.style.opacity="0",e.style.display="flex",requestAnimationFrame(()=>{e.style.transition="opacity 0.25s ease",e.style.opacity="1"}),typeof window.pushModalHistory=="function"&&window.pushModalHistory("member")},$t=()=>{const e=(n.rewards||[]).filter(r=>r.isActive!=="false"&&r.isActive!==!1),t=$e&&parseFloat($e.points)||0,a=e.length?e.map(r=>{const s=(parseFloat(r.stock)||0)>0,o=$e&&t>=(parseFloat(r.pointsCost)||0)&&s,i=Pe&&Pe.id===r.id;return`
        ...
        </div>`}).join("")),U("cart-subtotal",x(t))},Dr=(e,t)=>{let a=parseFloat(t);if(isNaN(a)||a<=0)E.splice(e,1);else{if(n.store.useStock===!0||n.store.useStock==="true"){const s=E[e],o=n.products.find(i=>i.id===s.id);if(o){const i=s.variantName?parseFloat(((o.variants||[]).find(l=>l.name===s.variantName)||{}).stock)||0:parseFloat(o.stock)||0;a>i&&(a=i,typeof window.showToast=="function"&&window.showToast(`Maks stok: ${i}`))}}E[e].qty=parseFloat(a.toFixed(2))}at(),De()},Cr=(e,t)=>{let a=parseFloat((parseFloat(E[e].qty)+t).toFixed(2));if(a<=0)E.splice(e,1);else{if((n.store.useStock===!0||n.store.useStock==="true")&&t>0){const s=E[e],o=n.products.find(i=>i.id===s.id);if(o){const i=s.variantName?parseFloat(((o.variants||[]).find(l=>l.name===s.variantName)||{}).stock)||0:parseFloat(o.stock)||0;a>i&&(a=i,typeof window.showToast=="function"&&window.showToast(`Maks stok: ${i}`))}}E[e].qty=a}at(),De()},Lr=e=>{E.splice(e,1),at(),De()},Ir=()=>{typeof window.showConfirm=="function"?window.showConfirm("Kosongkan Keranjang","Semua barang akan dihapus. Lanjutkan?",()=>{wt([]),De(),at(),typeof window.showToast=="function"&&window.showToast("Dibersihkan")}):(wt([]),De(),at())},jr=()=>{if(window.isAdm){typeof window.showConfirm=="function"&&window.showConfirm("Akses Ditolak","Anda sedang login sebagai Seller. Silakan logout terlebih dahulu untuk membuat pesanan sebagai pelanggan.",()=>{typeof window.logoutAdmin=="function"&&window.logoutAdmin()},"Logout Sekarang",!1);return}E.length&&typeof window.changeView=="function"&&window.changeView("view-checkout")};window.sanitizeCart=Lt;window.updCart=De;window.renderCart=at;window.setCQty=Dr;window.updCQty=Cr;window.rmCart=Lr;window.clearCart=Ir;window.validateCartToCheckout=jr;const Er=()=>{if(n.store.isDeliveryEnabled===!1&&n.store.isPickupEnabled===!1){typeof window.showToast=="function"&&window.showToast("Toko tutup!");return}const e=C("cust-name"),t=(document.querySelector('input[name="delivery-method"]:checked')||{}).value;if(!e||!t){typeof window.showToast=="function"&&window.showToast("Lengkapi form nama!");return}let a=C("cust-wa").replace(/\D/g,"");if(!a||a.length<9){typeof window.showToast=="function"&&window.showToast("Nomor WhatsApp wajib diisi! (min. 9 digit)");return}if(a.startsWith("0")?a="62"+a.substring(1):a.startsWith("62")||(a="62"+a),B.name=e,B.deliveryMethod=t,B.note=C("cust-note"),B.wa=a,t==="delivery"){if(B.address=C("cust-address"),!B.address||!B.lat||!B.lng){typeof window.showToast=="function"&&window.showToast("Alamat & GPS wajib!");return}const r=typeof window.getDist=="function"?window.getDist:()=>0;B.distance=r(parseFloat(n.store.lat||0),parseFloat(n.store.lng||0),B.lat,B.lng)||0}else B.address="Ambil di Toko",B.distance=0;N&&N.type&&N.type.includes("shipping")&&t!=="delivery"&&be(null),m("voucher-input")&&!N&&(m("voucher-input").value="",$("voucher-msg-container")),typeof window.changeView=="function"&&window.changeView("view-payment")},xa=()=>{Z("address-container","hidden",(document.querySelector('input[name="delivery-method"]:checked')||{}).value==="pickup")},vs=()=>{const e=m("tnc-checkbox"),t=m("btn-process-order");!e||!t||(e.checked?t.classList.remove("btn-disabled"):t.classList.add("btn-disabled"))},ys=()=>{if(!E.length){typeof window.showToast=="function"&&window.showToast("Keranjang belanja kosong!"),typeof window.changeView=="function"&&window.changeView("view-catalog",!0);return}if(!B.name){typeof window.showToast=="function"&&window.showToast("Lengkapi data pengiriman terlebih dahulu!"),typeof window.changeView=="function"&&window.changeView("view-checkout",!0);return}const e=typeof window.getEffP=="function"?window.getEffP:h=>h.price||0,t=E.reduce((h,T)=>h+(parseFloat(e(T))||0)*(parseFloat(T.qty)||0),0);let a=0,r=0,s=0;if(B.deliveryMethod==="delivery"&&(a=Math.ceil((parseFloat(B.distance)||0)*(parseFloat(n.store.costPerKm)||0)/500)*500),N&&(N.minPurchase&&parseFloat(N.minPurchase)>0&&t<parseFloat(N.minPurchase)?(be(null),$("voucher-msg-container"),typeof window.showToast=="function"&&window.showToast(`Voucher dibatalkan (min. belanja ${x(N.minPurchase)})`)):N.targetProduct&&!E.some(h=>h.id===parseInt(N.targetProduct))&&(be(null),$("voucher-msg-container"),typeof window.showToast=="function"&&window.showToast("Voucher dibatalkan (produk khusus dihapus)"))),N){let h=t;if(N.targetProduct&&N.targetProduct!==""){const T=parseInt(N.targetProduct);h=E.filter(M=>M.id===T).reduce((M,V)=>M+(parseFloat(e(V))||0)*(parseFloat(V.qty)||0),0)}if(N.type==="shipping_free")r=a;else if(N.type==="shipping_flat")r=parseFloat(N.value)||0;else if(N.type==="percent"){let T=h*((parseFloat(N.value)||0)/100);N.maxDiscount&&parseFloat(N.maxDiscount)>0&&(T=Math.min(T,parseFloat(N.maxDiscount))),s=T}else s=parseFloat(N.value)||0,s=Math.min(s,h)}r=Math.min(r,a),s=Math.min(s,t);const o=Math.max(0,t-s+(a-r)),l=(typeof window.calcTaxDetails=="function"?window.calcTaxDetails:()=>({ppnEnabled:!1,ppnAmount:0,grandTotalAdd:0}))(o),d=l.ppnAmount,p=o+l.grandTotalAdd;U("summary-subtotal",x(t)),Z("summary-shipping-row","hidden",B.deliveryMethod!=="delivery");const f=m("summary-discount-row");if(f)if(s>0||r>0){f.classList.remove("hidden");let h="";s>0&&(h+=`<div class="flex justify-between items-center w-full mt-1.5"><p class="text-xs font-bold text-slate-500">Diskon Promo</p><p class="text-[13px] font-bold text-rose-500">-${x(s)}</p></div>`),r>0&&(h+=`<div class="flex justify-between items-center w-full mt-1.5"><p class="text-xs font-bold text-slate-500">Diskon Ongkir</p><p class="text-[13px] font-bold text-rose-500">-${x(r)}</p></div>`),f.innerHTML=h}else f.classList.add("hidden");B.deliveryMethod==="delivery"&&(U("summary-shipping",x(a)),U("summary-distance",`(${B.distance.toFixed(1)}km)`)),U("summary-total",x(p)),m("btn-total-preview")&&U("btn-total-preview",x(p));const b=m("summary-ppn-row");b&&(l.ppnEnabled&&d>0?(b.classList.remove("hidden"),l.ppnType==="inclusive"?(U("summary-ppn-label",`Termasuk PPN (${l.ppnRate}%)`),U("summary-ppn",x(d))):(U("summary-ppn-label",`PPN (${l.ppnRate}%)`),U("summary-ppn",`+${x(d)}`))):b.classList.add("hidden")),U("payment-cust-name",B.name||"-"),m("payment-cust-wa")&&(m("payment-cust-wa").textContent=B.wa?"+"+B.wa:"-"),U("payment-cust-method",B.deliveryMethod==="delivery"?`Dikirim (${B.distance.toFixed(1)}km)`:"Ambil di Toko"),U("payment-cust-address",B.address||"-"),P("payment-items-preview",E.map(h=>{const T=h.variantName?`<span class="bg-slate-200 dark:bg-slate-700 text-slate-600 dark:text-slate-300 px-1.5 py-0.5 rounded-lg text-[9px] font-bold">${c(h.variantName)}</span>`:"",_=h.poTime?`<span class="amber-badge px-1.5 py-0.5 rounded-lg text-[8px] font-bold uppercase">PO ${c(h.poTime)}</span>`:"";return`
        ...
        </div>`}).join("")+(Pe?`<div class="flex justify-between items-center bg-[rgba(var(--color-primary-rgb),0.06)] dark:bg-[rgba(var(--color-primary-rgb),0.12)] p-4 rounded-[1.25rem] border border-[var(--color-primary)]/30 shadow-sm min-w-0"><div class="flex items-center gap-3.5 min-w-0"><div class="w-12 h-12 rounded-xl bg-[var(--color-primary)] text-white flex items-center justify-center shrink-0"><i class="fa-solid fa-gift"></i></div><div class="min-w-0"><p class="text-sm font-bold text-[var(--color-primary)] truncate">${c(Pe.name)}</p><p class="text-[11px] text-[var(--color-primary)] font-bold mt-1"><i class="fa-solid fa-star mr-1"></i>Tukar ${Pe.pointsCost} Poin (Gratis)</p></div></div><button type="button" onclick="if(typeof deselectReward==='function') deselectReward(); rPay();" class="text-[10px] font-bold text-rose-500 uppercase shrink-0 ml-3">Batal</button></div>`:"")),B.note?(U("payment-note-text",`"${c(B.note)}"`),L("payment-note-preview")):$("payment-note-preview"),P("dynamic-banks-container",n.banks?.length?n.banks.map(h=>`<div class="bg-white dark:bg-slate-800 p-4 rounded-[1.25rem] border border-slate-200 dark:border-slate-700 shadow-sm"><p class="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1">Bank ${c(h.bankName)}</p><p class="text-lg font-bold text-[var(--color-primary)] tracking-wide">${c(h.bankAccount)}</p><p class="text-xs text-slate-500 dark:text-slate-400 font-medium mt-1.5">a.n <span class="font-bold text-slate-700 dark:text-white">${c(h.bankOwner)}</span></p></div>`).join(""):'<div class="bg-rose-50 dark:bg-rose-900/20 border border-rose-200 p-4 rounded-[1.25rem] text-center"><p class="text-sm text-rose-500 dark:text-rose-400 font-bold">Rekening belum diatur.</p></div>');const u=m("payment-option-cashier"),w=m("payment-option-cod");if(u&&w){if(B.deliveryMethod==="pickup"){if(L("payment-option-cashier"),$("payment-option-cod"),(document.querySelector('input[name="payment"]:checked')||{}).value==="cod"){const h=document.querySelector('input[value="cashier"]');h&&(h.checked=!0)}}else{$("payment-option-cashier"),L("payment-option-cod");const h=(document.querySelector('input[name="payment"]:checked')||{}).value;if(h==="cashier"||!h){const T=document.querySelector('input[value="cod"]');T&&(T.checked=!0)}}typeof window.togglePaymentDetails=="function"&&window.togglePaymentDetails()}const y=m("tnc-checkbox");y&&(y.checked=!1,vs())},_r=async()=>{if(!m("tnc-checkbox").checked||Ue)return;if(window.isAdm){typeof window.showToast=="function"&&window.showToast("Anda login sebagai Seller. Logout dulu untuk membuat pesanan.");return}const e=he("freshmart_last_order");if(e&&Date.now()-parseInt(e)<6e4){typeof window.showToast=="function"&&window.showToast("Tunggu 1 menit untuk pesanan baru!");return}const t=typeof window.getEffP=="function"?window.getEffP:o=>o.price||0,a=typeof window.getEffHpp=="function"?window.getEffHpp:()=>0,r=typeof window.getEffPoin=="function"?window.getEffPoin:()=>0;let s=!1;if(E.forEach(o=>{const i=n.products.find(d=>d.id===o.id);if(!i)return;const l=o.variantName?((i.variants||[]).find(d=>d.name===o.variantName)||{}).price??i.price:i.price;l!==void 0&&Math.abs(o.price-l)>1&&(o.price=l,s=!0),o.poin=r(o)}),s){ae("freshmart_cart",JSON.stringify(E)),typeof window.renderCart=="function"&&window.renderCart(),ys(),typeof window.showToast=="function"&&window.showToast("Harga produk telah diperbarui. Periksa kembali sebelum order.");return}ee(!0),O("Proses Pesanan...");try{const o=E.reduce((v,R)=>v+(parseFloat(t(R))||0)*(parseFloat(R.qty)||0),0);let i=0,l=0,d=0;B.deliveryMethod==="delivery"&&(i=Math.ceil((parseFloat(B.distance)||0)*(parseFloat(n.store.costPerKm)||0)/500)*500);const p=n.store.useStock===!0||n.store.useStock==="true";if(p)for(const v of E){const R=n.products.find(j=>j.id===v.id);if(!R)continue;const Y=parseFloat(v.qty)||0;if(v.variantName){const j=(R.variants||[]).find(Q=>Q.name===v.variantName),G=parseFloat(j&&j.stock!==void 0?j.stock:0);if(G<Y){ee(!1),D(),typeof window.showToast=="function"&&window.showToast(`Stok ${v.name} (${v.variantName}) tidak cukup! Sisa: ${G}`);return}}else{const j=parseFloat(R.stock!==void 0?R.stock:0);if(j<Y){ee(!1),D(),typeof window.showToast=="function"&&window.showToast(`Stok ${v.name} tidak cukup! Sisa: ${j}`);return}}}if(N){let v=o;if(N.targetProduct&&N.targetProduct!==""){const R=parseInt(N.targetProduct);v=E.filter(j=>j.id===R).reduce((j,G)=>j+(parseFloat(t(G))||0)*(parseFloat(G.qty)||0),0)}if(N.minPurchase&&parseFloat(N.minPurchase)>0&&o<parseFloat(N.minPurchase))be(null);else if(N.targetProduct&&N.targetProduct!==""&&v===0)be(null);else if(N.type&&N.type.includes("shipping")&&B.deliveryMethod!=="delivery")be(null);else if(N.type==="shipping_free")l=i;else if(N.type==="shipping_flat")l=parseFloat(N.value)||0;else if(N.type==="percent"){let R=v*((parseFloat(N.value)||0)/100);N.maxDiscount&&parseFloat(N.maxDiscount)>0&&(R=Math.min(R,parseFloat(N.maxDiscount))),d=R}else d=parseFloat(N.value)||0,d=Math.min(d,v)}l=Math.min(l,i),d=Math.min(d,o);const f=Math.max(0,o-d+(i-l)),u=(typeof window.calcTaxDetails=="function"?window.calcTaxDetails:()=>({ppnEnabled:!1,ppnAmount:0,grandTotalAdd:0}))(f),w=u.ppnAmount,y=u.dppAmount,h=f+u.grandTotalAdd,T=(document.querySelector('input[name="payment"]:checked')||{}).value,_=T==="transfer"||T==="qris"||T==="tempo",M=window.buktiGDriveUploaded&&window.buktiPaymentUrl&&!window.buktiPaymentUrl.startsWith("data:");if(_&&!M){if(ee(!1),D(),!window.buktiPaymentFile){typeof window.showToast=="function"&&window.showToast("Upload bukti pembayaran terlebih dahulu!");return}typeof window.showToast=="function"&&window.showToast("Tunggu upload Google Drive selesai, atau coba lagi!");return}const V="ORD-"+Date.now().toString(36).toUpperCase()+"-"+Math.random().toString(36).substring(2,6).toUpperCase();if(window.buktiPaymentFile&&!window.buktiGDriveUploaded)try{O("Upload Bukti ke Google Drive...");const v=await window.uploadBuktiToFirebase(window.buktiPaymentFile,V);if(v&&!v.startsWith("data:"))window.buktiPaymentUrl=v,window.buktiGDriveUploaded=!0;else{ee(!1),D(),typeof window.showToast=="function"&&window.showToast("❌ Upload bukti ke Google Drive gagal. Coba pilih gambar lagi!");return}O("Proses Pesanan...")}catch{ee(!1),D(),typeof window.showToast=="function"&&window.showToast("❌ Gagal upload bukti. Periksa koneksi dan coba lagi!");return}const I={orderId:V,timestamp:ue.firestore.FieldValue.serverTimestamp(),dateString:new Date().toISOString(),customer:B,items:E.map(v=>({...v,qty:parseFloat(v.qty),effectivePrice:t(v),poTime:v.poTime||"",hpp:a(v),poin:r(v)})),payment:{method:T,subtotal:o,shippingCost:i,shippingDiscount:l,productDiscount:d,ppnAmount:w,dppAmount:y,ppnRate:u.ppnEnabled?u.ppnRate:0,ppnType:u.ppnEnabled?u.ppnType:"exclusive",grandTotal:h},status:"Baru",buktiPayment:window.buktiPaymentUrl||null};if(T==="tempo"){const v=document.getElementById("tempo-dp-input");let R=v&&parseFloat(v.value)||0;R>h&&(R=h),I.payment.tempoDp=R,I.payment.tempoBalance=h-R,I.payment.tempoDueDate=Date.now()+30*24*60*60*1e3,I.payment.paymentStatus="hutang"}const S=k.collection("freshmart_orders").doc(V),q=E.reduce((v,R)=>v+r(R)*(parseFloat(R.qty)||0),0),K=k.collection("freshmart").doc("cms_data"),ce=B.wa?K.collection("customers").doc(B.wa):null,ve=!!Pe;let F=null;if(p){const v={};E.forEach(j=>{const G=j.id!=null?j.id.toString():null;if(!G)return;v[G]||(v[G]={main:0,variants:{}});const Q=parseFloat(j.qty)||0;j.variantName?v[G].variants[j.variantName]=(v[G].variants[j.variantName]||0)+Q:v[G].main+=Q});const R=Object.keys(v),Y=R.map(j=>k.collection("freshmart").doc("cms_data").collection("products").doc(j));await k.runTransaction(async j=>{const G=ve?k.collection("freshmart").doc("cms_data").collection("rewards").doc(Pe.id.toString()):null,Q=await Promise.all(Y.map(xe=>j.get(xe))),X=ce?await j.get(ce):null,ft=X&&X.exists&&G?await j.get(G):null,Fe=[];if(Q.forEach((xe,ye)=>{if(!xe.exists)return;const He=xe.data(),ke=v[R[ye]];if(ke.main>0){const z=parseFloat(He.stock!==void 0?He.stock:0);z<ke.main&&Fe.push(`${He.name} (sisa ${z})`)}Object.keys(ke.variants).forEach(z=>{const Ne=(He.variants||[]).find(Je=>Je.name===z),gt=parseFloat(Ne&&Ne.stock!==void 0?Ne.stock:0);gt<ke.variants[z]&&Fe.push(`${He.name} (${z}, sisa ${gt})`)})}),Fe.length)throw new Error("STOK_TIDAK_CUKUP: "+Fe.join(", "));let bt=null,Tt=null;if(X&&X.exists){let xe=parseFloat(X.data().points)||0;if(ve){if(!ft||!ft.exists)throw new Error("HADIAH_TIDAK_DITEMUKAN");const ye=ft.data();if(xe<(parseFloat(ye.pointsCost)||0))throw new Error("POIN_TIDAK_CUKUP");if((parseFloat(ye.stock)||0)<=0)throw new Error("STOK_HADIAH_HABIS");bt=(parseFloat(ye.stock)||0)-1,xe-=parseFloat(ye.pointsCost)||0,I.claimedReward={id:ye.id,name:ye.name,pointsCost:parseFloat(ye.pointsCost)||0,status:"pending",note:""}}xe+=q,Tt=xe,I.pointsEarned=q,I.customerPhone=B.wa,I.finalMemberPoints=xe}else if(ve)throw new Error("MEMBER_TIDAK_DITEMUKAN");Q.forEach((xe,ye)=>{if(!xe.exists)return;const He=R[ye],ke=v[He],z=JSON.parse(JSON.stringify(xe.data())),Ne={};ke.main>0&&(z.stock=Math.max(0,(parseFloat(z.stock)||0)-ke.main),Ne.stock=z.stock,z.stock===0&&(z.isActive="false",Ne.isActive="false"),z.totalSold=(parseFloat(z.totalSold)||0)+ke.main,Ne.totalSold=z.totalSold),Object.keys(ke.variants).length>0&&z.variants&&(Object.keys(ke.variants).forEach(Je=>{const Ye=(z.variants||[]).findIndex(Bs=>Bs.name===Je);Ye>-1&&(z.variants[Ye].stock=Math.max(0,(parseFloat(z.variants[Ye].stock)||0)-ke.variants[Je]),z.variants[Ye].stock===0&&(z.variants[Ye].isActive=!1),z.variants[Ye].totalSold=(parseFloat(z.variants[Ye].totalSold)||0)+ke.variants[Je])}),Ne.variants=z.variants);const gt=n.products.findIndex(Je=>Je.id.toString()===He);gt>-1&&(n.products[gt]=z),j.update(Y[ye],Ne)}),j.set(S,I),Tt!==null&&(j.set(ce,{points:Tt},{merge:!0}),F=Tt),bt!==null&&j.set(G,{stock:bt},{merge:!0}),j.update(K,{lastUpdate:ue.firestore.FieldValue.increment(1),updateType:"stock_change",updatedProductIds:R})}),n.lastUpdate=(parseInt(he("freshmart_last_update"))||n.lastUpdate||0)+1,ae("freshmart_last_update",n.lastUpdate.toString()),ae("freshmart_products",JSON.stringify(n.products))}else ce?await k.runTransaction(async v=>{const R=ve?k.collection("freshmart").doc("cms_data").collection("rewards").doc(Pe.id.toString()):null,Y=await v.get(ce),j=Y.exists&&R?await v.get(R):null;if(Y.exists){let G=parseFloat(Y.data().points)||0,Q=null;if(ve){if(!j||!j.exists)throw new Error("HADIAH_TIDAK_DITEMUKAN");const X=j.data();if(G<(parseFloat(X.pointsCost)||0))throw new Error("POIN_TIDAK_CUKUP");if((parseFloat(X.stock)||0)<=0)throw new Error("STOK_HADIAH_HABIS");Q=(parseFloat(X.stock)||0)-1,G-=parseFloat(X.pointsCost)||0,I.claimedReward={id:X.id,name:X.name,pointsCost:parseFloat(X.pointsCost)||0,status:"pending",note:""}}G+=q,I.pointsEarned=q,I.customerPhone=B.wa,I.finalMemberPoints=G,v.set(S,I),v.set(ce,{points:G},{merge:!0}),F=G,Q!==null&&v.set(R,{stock:Q},{merge:!0})}else{if(ve)throw new Error("MEMBER_TIDAK_DITEMUKAN");v.set(S,I)}}):await S.set(I);re.unshift({orderId:V,date:new Date().toISOString(),total:h,itemCount:E.reduce((v,R)=>v+parseFloat(R.qty),0),status:"Baru",pointsEarned:I.pointsEarned||0,claimedReward:I.claimedReward||null,finalMemberPoints:F}),Bt(re);try{localStorage.setItem("freshmart_my_orders",JSON.stringify(re)),localStorage.setItem("freshmart_last_order",Date.now().toString())}catch{}typeof analytics<"u"&&analytics.logEvent("purchase",{transaction_id:V,value:h,currency:"IDR"}),I.claimedReward&&F!==null?typeof window.showToast=="function"&&window.showToast(`✅ Hadiah "${I.claimedReward.name}" berhasil ditukar! Sisa poin Anda: ${F}`):typeof window.showToast=="function"&&window.showToast("✅ Pesanan berhasil dikirim ke admin!"),$e&&F!==null&&($e.points=F),setTimeout(()=>{wt([]),se("cust-name",""),se("cust-address",""),se("cust-note",""),se("cust-wa",""),window.buktiPaymentUrl=null,window.buktiPaymentFile=null,window.buktiGDriveUploaded=!1;const v=m("bukti-preview-wrap"),R=m("bukti-placeholder");v&&v.classList.add("hidden"),R&&R.classList.remove("hidden"),$("bukti-uploading"),$("bukti-success"),$("bukti-gdrive-error");const Y=m("bukti-file-input");Y&&(Y.value=""),is({name:"",address:"",lat:null,lng:null,deliveryMethod:"delivery",distance:0,note:"",wa:""}),be(null),Ve(null),Me(null);const j=m("member-status-banner");j&&$(j),m("voucher-input")&&(m("voucher-input").value=""),$("voucher-msg-container"),$("location-status"),m("btn-location")&&L("btn-location");const G=document.querySelector('input[name="delivery-method"][value="delivery"]');G&&(G.checked=!0,xa());const Q=document.querySelector('input[name="payment"][value="transfer"]');Q&&(Q.checked=!0,typeof window.togglePaymentDetails=="function"&&window.togglePaymentDetails()),typeof window.updCart=="function"&&window.updCart(),typeof window.renderCart=="function"&&window.renderCart(),typeof window.changeView=="function"&&window.changeView("view-catalog"),typeof window.showToast=="function"&&window.showToast("Pesanan Dibuat! 🎉")},2e3)}catch(o){const i=o.message||"Error";i.startsWith("STOK_TIDAK_CUKUP:")?typeof window.showToast=="function"&&window.showToast("Maaf, stok berubah: "+i.replace("STOK_TIDAK_CUKUP: ","")):i==="POIN_TIDAK_CUKUP"?(typeof window.showToast=="function"&&window.showToast("Maaf, poin Anda ternyata tidak cukup untuk hadiah ini. Silakan cek lagi."),Me(null)):i==="STOK_HADIAH_HABIS"?(typeof window.showToast=="function"&&window.showToast("Maaf, stok hadiah yang dipilih baru saja habis. Silakan pilih hadiah lain."),Me(null)):i==="HADIAH_TIDAK_DITEMUKAN"?(typeof window.showToast=="function"&&window.showToast("Hadiah yang dipilih sudah tidak tersedia. Silakan pilih ulang."),Me(null)):i==="MEMBER_TIDAK_DITEMUKAN"?(typeof window.showToast=="function"&&window.showToast("Data member tidak ditemukan, klaim hadiah dibatalkan. Pesanan bisa dicoba lagi tanpa hadiah."),Me(null)):typeof window.showToast=="function"&&window.showToast(o.code==="resource-exhausted"?"Quota Server Penuh!":"Gagal proses: "+i)}finally{ee(!1),D()}};window.validateAndGoToPayment=Er;window.toggleDeliveryMethod=xa;window.toggleOrderButton=vs;window.rPay=ys;window.processOrder=_r;const ht=()=>{const e=m("wishlist-badge");e&&(e.innerText=ne.length,e.classList.toggle("scale-0",!ne.length))},Rr=e=>{ne.splice(e,1),ae("freshmart_wishlist",JSON.stringify(ne)),ht(),wa()},Fr=e=>{const t=ne[e],a=n.products?.find(i=>i.id===t.id);if(!a||a.isActive==="false"||a.isActive===!1)return g(`${t.name} sudah tidak tersedia.`);const r=t.variantName?(a.variants||[]).find(i=>i.name===t.variantName):null;if(n.store?.useStock===!0||n.store?.useStock==="true"){if(t.variantName&&(!r||r.isActive===!1||r.isActive==="false"))return g(`Varian ${t.variantName} sudah tidak tersedia.`);const i=r?parseFloat(r.stock)||0:parseFloat(a.stock)||0,l=E.find(p=>p.id===t.id&&p.variantName===t.variantName),d=l&&parseFloat(l.qty)||0;if(i<=0||d>=i)return g(`Stok ${t.name} tidak mencukupi!`)}const o=E.find(i=>i.id===t.id&&i.variantName===t.variantName);if(o)o.qty=parseFloat((o.qty+1).toFixed(2));else{const i=r&&parseFloat(r.poin)>0?parseFloat(r.poin):parseFloat(a.poin)||0;E.push({id:a.id,name:a.name,variantName:t.variantName||"",price:r?r.price:a.price,img:r?.img||a.img,qty:1,unit:a.unit||"pcs",poTime:a.poTime||"",colorCode:r?.colorCode||"",poin:i})}De(),g("Ke Keranjang!"),typeof window.curViewName<"u"&&window.curViewName==="view-cart"&&at()},Nr=()=>{_e("Hapus Favorit","Yakin ingin menghapus semua?",()=>{ne.length=0,ae("freshmart_wishlist",JSON.stringify(ne)),ht(),wa(),g("Dibersihkan")})},wa=()=>{if(!ne.length){L("wishlist-empty-state"),$("btn-clear-wishlist"),L("spacer-wishlist"),P("wishlist-items-container","");return}$("wishlist-empty-state"),L("btn-clear-wishlist"),$("spacer-wishlist"),P("wishlist-items-container",ne.map((e,t)=>{let a=e.colorCode?`<span class="w-3.5 h-3.5 rounded-full shadow-inner border border-slate-300 dark:border-slate-600 shrink-0" style="background-color: ${c(e.colorCode)};"></span>`:"";return`
        ...
        `,r.innerHTML=s,a.classList.contains("hidden")&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("variantPreview"),L("variant-preview-modal"),setTimeout(()=>{a.classList.remove("opacity-0"),r.classList.remove("scale-95")},10)},zr=()=>{if(!A)return;const e=m("variant-preview-modal"),t=m("variant-preview-content");if(!e||!t)return;const a=A.variants&&te!==null?A.variants[te]:null,r=a?.img||A.img||"",s=a?`${c(A.name)} - ${c(a.name)}`:c(A.name),o=x(a?.price??A.price);let i=`
        <div class="relative w-full aspect-square bg-white rounded-3xl overflow-hidden shadow-2xl border border-slate-200 dark:border-slate-800 flex items-center justify-center">
    ...
    `;t.innerHTML=i,e.classList.contains("hidden")&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("variantPreview"),L("variant-preview-modal"),setTimeout(()=>{e.classList.remove("opacity-0"),t.classList.remove("scale-95")},10)},Jr=(e=!1)=>{const t=m("variant-preview-modal"),a=m("variant-preview-content");if(t&&a){const r=()=>{t.classList.add("opacity-0"),a.classList.add("scale-95"),setTimeout(()=>{$("variant-preview-modal"),a.innerHTML=""},300)};typeof window.requestCloseModal=="function"?window.requestCloseModal("variantPreview",e,r):r()}},Yr=e=>{Et(A?.video)&&(window.cSlideIdx+=e,window.cSlideIdx>1&&(window.cSlideIdx=0),window.cSlideIdx<0&&(window.cSlideIdx=1),Vt())},Vt=()=>{if(!A)return;let e=A,t=e.isActive!=="false"&&e.isActive!==!1,a=e.variants?.length>0;const r=(e.name||"").toLowerCase(),s=(e.category||"").toLowerCase(),o=(e.tag||"").toLowerCase(),i=["cat","paint","warna","colour","color","putih","hitam","merah","biru","hijau","kuning","orange","abu","coklat","cream","krem","beige","ivory","mocca","rose","tosca","lavender","salmon","broken white","off white","natural","magnolia","primer","dasar","eksterior","exterior","interior","tembok","duco","gloss","matte","satin","semi gloss"],l=r.includes("cat")&&(r.includes("tembok")||r.includes("interior")||r.includes("eksterior")||r.includes("exterior"))||s.includes("cat")||s.includes("paint")||o.includes("cat")||o.includes("paint"),d=a&&e.variants.some(F=>{const v=(F.name||"").toLowerCase();return i.some(R=>v.includes(R))}),p=l||d,f=m("product-modal-paint-warning");f&&(p?f.classList.remove("hidden"):f.classList.add("hidden"));let b=a&&te!==null?e.variants[te]:null,u=b?.unit||e.unit||"Pcs";const w=m("product-modal-img"),y=m("product-modal-video-container"),h=Et(e.video),T=b&&b.img,_=m("slide-prev"),M=m("slide-next"),V=m("slide-dots");if(h&&!T)if(_&&_.classList.remove("hidden"),M&&M.classList.remove("hidden"),V&&(V.classList.remove("hidden"),V.innerHTML=`
            ...
            <div class="mt-5">
                ...
                <div class="overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm">
                    <table class="w-full text-[13px] spec-product-table">
                        <tbody>`;e.specTable.forEach((v,R)=>{const Y=R%2===0?"bg-white dark:bg-slate-900":"bg-slate-50/80 dark:bg-slate-800/60";F+=`<tr class="${Y}">
        ...
        <div class="mb-6 bg-amber-50 dark:bg-amber-900/10 rounded-2xl p-4 border border-amber-200 dark:border-amber-800/50 shadow-inner">
        ...
        </div>`:"");const ve=m("product-modal-admin-info");if(ve)if(window.isAdm&&window.curViewName==="view-admin"){const F=n.store.useStock===!0||n.store.useStock==="true",v=e.variants?.length>0,R=b?b.hpp||0:e.hpp||0;b?b.stock!==void 0&&b.stock:e.stock!==void 0&&e.stock;const Y=b?b.price||e.price||0:e.price||0,j=R>0?Math.round((Y-R)/Y*100):null;let G="";if(F)if(v)G=`<div class="col-span-2 space-y-1.5">${(e.variants||[]).map(Q=>{const X=parseFloat(Q.stock)||0;return`<div class="flex justify-between items-center text-[11px] font-bold bg-white dark:bg-slate-900 p-2 rounded-xl border border-slate-200 dark:border-slate-700">
            ...
            <div class="mb-6 bg-[rgba(var(--color-primary-rgb),0.05)] dark:bg-[rgba(var(--color-primary-rgb),0.08)] rounded-2xl p-4 border border-[var(--color-primary)]/20">
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div class="flex flex-col gap-1">
                        ...
                        <p class="font-bold text-lg text-amber-500">${x(R)}</p>
                    </div>
                    <div class="flex flex-col gap-1">
            ...
            </div>`}else ve.innerHTML="";if(t)if(a&&te===null?($("modal-active-controls"),$("modal-inactive-controls")):(a?b.isActive!==!1&&b.isActive!=="false":!0)?(L("modal-active-controls"),$("modal-inactive-controls")):($("modal-active-controls"),L("modal-inactive-controls")),a){L("product-modal-options-container");let F='<div class="grid grid-cols-[repeat(auto-fill,minmax(80px,1fr))] sm:grid-cols-[repeat(auto-fill,minmax(95px,1fr))] gap-2 sm:gap-3 w-full">';F+=e.variants.map((v,R)=>{let Y=v.isActive!==!1&&v.isActive!=="false";const j=n.store.useStock===!0||n.store.useStock==="true",G=parseFloat(v.stock)||0,Q=j&&G<=0;let X=Y&&!Q,ft=v.colorCode?`<span class="w-10 h-10 sm:w-12 sm:h-12 rounded-full shadow-inner border border-slate-300 dark:border-slate-600 mb-2 shrink-0" style="background-color: ${c(v.colorCode)};"></span>`:"",Fe="";X?R===te?Fe="bg-[rgba(var(--color-primary-rgb),0.08)] border-[var(--color-primary)] text-[var(--color-primary)] dark:bg-[rgba(var(--color-primary-rgb),0.12)] dark:text-[var(--color-primary)] shadow-sm":Fe="bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 text-slate-500 dark:text-slate-400 hover:border-[var(--color-primary)]/40 hover:shadow-sm":Fe="bg-slate-100 dark:bg-slate-800/50 border-slate-200 dark:border-slate-700 text-slate-500 dark:text-slate-400 opacity-60 cursor-not-allowed";const bt=X&&(v.colorCode||v.img)?`<span onclick="event.stopPropagation(); previewVariant(${R})" class="absolute top-1.5 right-1.5 w-5 h-5 rounded-full bg-white/90 dark:bg-slate-700/90 shadow-sm flex items-center justify-center text-slate-500 hover:text-[var(--color-primary)] hover:scale-110 active:scale-90 transition-all border border-slate-200/50 dark:border-slate-600/50" title="Perbesar"><i class="fa-solid fa-magnifying-glass-plus text-[9px]"></i></span>`:"";return`<button ${X?"":"disabled"} class="relative p-2.5 sm:p-3 rounded-xl text-[10px] sm:text-[11px] font-bold uppercase tracking-wide border-2 transition-all active:scale-95 flex flex-col items-center justify-start text-center h-full ${Fe}" ${X?`onclick="selectVariant(${R})"`:""}>
                    ${bt}
                    ${ft} 
                ...
                </button>`}).join(""),F+="</div>",P("product-modal-options",F)}else $("product-modal-options-container");else $("modal-active-controls"),L("modal-inactive-controls"),$("product-modal-options-container");Gt()},Gt=()=>{if(!A)return;if(A.variants?.length>0&&te===null){U("btn-modal-price-preview","Rp 0");return}let e=(A.variants||[])[te],a=e?.price??A.price;const r=e?.name||null;let s=0;r?s=parseFloat(E.find(i=>i.id===A.id&&i.variantName===r)?.qty||0):s=E.filter(i=>i.id===A.id).reduce((i,l)=>i+(parseFloat(l.qty)||0),0);let o=Te+s;if(A.wholesale?.length){for(let i of A.wholesale.slice().sort((l,d)=>d.minQty-l.minQty))if(o>=parseFloat(i.minQty)){a=i.price;break}}U("btn-modal-price-preview",x(a*Te))},Xr=e=>{const t=n.store.useStock===!0||n.store.useStock==="true",a=A?.variants?.[te],r=a?.name||null,s=t?r?parseFloat(a?.stock)||0:parseFloat(A?.stock)||0:1/0,o=parseFloat(Math.min(s,Math.max(.01,Te+e)).toFixed(2));Ut(o),se("modal-qty-input",Te),Gt(),t&&s!==1/0&&Te>=s&&g(`Maks stok: ${s}`)},Zr=e=>{const t=n.store.useStock===!0||n.store.useStock==="true",a=A?.variants?.[te],r=a?.name||null,s=t?r?parseFloat(a?.stock)||0:parseFloat(A?.stock)||0:1/0;let o=parseFloat(e);(isNaN(o)||o<=0)&&(o=.01),o=Math.min(s,o);const i=parseFloat(o.toFixed(2));Ut(i),se("modal-qty-input",Te),Gt()},eo=e=>{Ct(e),Vt()},to=()=>{if(A.variants?.length>0&&te===null)return g("Pilih varian / warna terlebih dahulu!");if(n.store.useStock===!0||n.store.useStock==="true"){const o=A.variants?.[te],i=o?.name||null,l=i?parseFloat(o.stock)||0:parseFloat(A.stock)||0,d=E.find(f=>f.id===A.id&&f.variantName===i),p=d&&parseFloat(d.qty)||0;if(Te+p>l)return g(`Stok tidak cukup! Tersisa: ${l}`)}const t=A.variants?.[te],a=t?.name||null,r=E.find(o=>o.id===A.id&&o.variantName===a),s=t?.unit||A.unit||"pcs";if(r)r.qty=parseFloat((r.qty+Te).toFixed(2)),r.unit=s;else{const o=t&&parseFloat(t.poin)>0?parseFloat(t.poin):parseFloat(A.poin)||0;E.push({id:A.id,name:A.name,variantName:a,price:t?.price??A.price,img:t?.img||A.img,qty:Te,unit:s,poTime:A.poTime||"",colorCode:t?.colorCode||"",poin:o})}De(),typeof analytics<"u"&&analytics.logEvent("add_to_cart",{item_id:A.id,item_name:A.name,quantity:Te}),ha(),g("Berhasil Masuk Keranjang")},ao=()=>{if(A.variants?.length>0&&te===null)return g("Pilih varian / warna terlebih dahulu!");const e=A.variants?.[te],t=e?.name||null;if(ne.find(a=>a.id===A.id&&a.variantName===t))return g("Sudah di Favorit!");ne.push({id:A.id,name:A.name,variantName:t,price:e?.price??A.price,img:e?.img||A.img,colorCode:e?.colorCode||""}),ae("freshmart_wishlist",JSON.stringify(ne)),typeof window.updWish=="function"&&window.updWish(),ha(),g("Masuk Favorit ❤️")},so=()=>{if(!A)return;const e=window.location.origin+window.location.pathname+"?p="+A.id,t=A.name,a=`Cek produk ${A.name} di ${n.store.name} sekarang!`;if(navigator.share)navigator.share({title:t,text:a,url:e}).catch(r=>{console.log("User membatalkan share",r)});else if(navigator.clipboard&&navigator.clipboard.writeText)navigator.clipboard.writeText(e).then(()=>g("Link produk berhasil disalin!")).catch(()=>g("Gagal menyalin link."));else{const r=document.createElement("textarea");r.value=e,r.style.position="fixed",r.style.opacity="0",document.body.appendChild(r),r.select(),document.execCommand("copy"),document.body.removeChild(r),g("Link produk berhasil disalin!")}};window.openProductModal=Wr;window.closeProductModal=ha;window.previewVariant=Qr;window.previewProductImage=zr;window.closeVariantPreviewModal=Jr;window.changeSlide=Yr;window.rProdMod=Vt;window.uMPP=Gt;window.updateModalQty=Xr;window.handleModalQtyChange=Zr;window.selectVariant=eo;window.confirmAddProductToCart=to;window.confirmAddToWishlist=ao;window.shareProduct=so;let ta=[];const Kt=()=>{try{localStorage.setItem("freshmart_my_orders",JSON.stringify(re))}catch(e){console.warn("[MyOrders] Gagal menyimpan ke localStorage:",e)}},ro=()=>{try{const e=localStorage.getItem("freshmart_my_orders");if(e){const t=JSON.parse(e);Array.isArray(t)&&t.length>0&&Bt(t)}}catch(e){console.warn("[MyOrders] Gagal memuat dari localStorage:",e)}return re},ks=()=>{ta.forEach(e=>{try{typeof e=="function"&&e()}catch{}}),ta=[]},$s=()=>{ks(),re.filter(a=>{const r=a.status==="Selesai"||a.status==="Dibatalkan",s=a.claimedReward&&(a.claimedReward.status==="Menunggu Persetujuan"||!a.claimedReward.status);return!r||s}).slice(0,10).forEach(a=>{const r=a.orderId;if(!r)return;const s=k.collection("freshmart_orders").doc(r).onSnapshot(o=>{if(!o.exists)return;const i=o.data(),l=i.status,d=i.claimedReward?i.claimedReward.status:null,p=i.claimedReward&&i.claimedReward.note||"";let f=!1,b="";const u=re.find(w=>w.orderId===r);if(u){if(l&&u.status!==l){const w=u.status;u.status=l,f=!0,w!==void 0&&(b=`Pesanan #${r.split("-").pop()} kini: ${l}`)}u.claimedReward&&d&&(u.claimedReward.status!==d||u.claimedReward.note!==p)&&(u.claimedReward.status=d,u.claimedReward.note=p,f=!0),f&&(Kt(),window.curViewName==="view-orders"&&St(),b&&g(b))}},o=>{console.warn("[MyOrders Realtime] Snapshot error:",o.message)});ta.push(s)})},St=async()=>{if(ro(),!re.length){L("orders-empty-state"),$("btn-clear-orders"),L("spacer-orders"),P("orders-items-container","");return}$("orders-empty-state"),L("btn-clear-orders"),$("spacer-orders"),$s(),P("orders-items-container",re.map((e,t)=>{const a=new Date(e.date).toLocaleDateString("id-ID",{day:"numeric",month:"short",year:"numeric"});let r="text-slate-500 border-slate-200 bg-slate-50 dark:bg-slate-800 dark:border-slate-700",s="fa-clock";return e.status==="Baru"?(r="text-rose-600 border-rose-200 bg-rose-50 dark:bg-rose-900/30 dark:border-rose-800 dark:text-rose-400",s="fa-asterisk"):e.status==="Diproses"?(r="text-[var(--color-primary)] border-[var(--color-primary)]/30 bg-[rgba(var(--color-primary-rgb),0.08)] dark:bg-[rgba(var(--color-primary-rgb),0.15)] dark:border-[var(--color-primary)]/40",s="fa-spinner fa-spin"):e.status==="Selesai"?(r="text-[var(--color-primary)] border-[var(--color-primary)]/30 bg-[rgba(var(--color-primary-rgb),0.08)] dark:bg-[rgba(var(--color-primary-rgb),0.15)] dark:border-[var(--color-primary)]/40",s="fa-check-double"):e.status==="Dibatalkan"&&(r="text-slate-400 border-slate-200 bg-slate-100 dark:bg-slate-800 dark:border-slate-700 dark:text-slate-400",s="fa-xmark"),`
        ...
        </div>`}).join(""))},oo=async(e,t)=>{O("Melacak Status...");try{const a=await k.collection("freshmart_orders").doc(e).get();if(a.exists){const r=a.data();if(re[t])re[t].status=r.status;else{const s=re.findIndex(o=>o.orderId===e);s>-1&&(re[s].status=r.status)}Kt(),St(),g(`✅ Status Pesanan: ${r.status}`)}else g("Pesanan tidak ditemukan di server.")}catch(a){console.error("Gagal cek status pesanan:",a),g("Gagal mengambil data sistem. Periksa koneksi.")}finally{D()}},io=async()=>{const e=m("order-tracking-input"),t=e?e.value.trim():"";if(!t){g("Masukkan ID Pesanan terlebih dahulu!");return}let a=t.replace(/^#/,"").trim();const r=re.find(s=>s.orderId===a||s.orderId.endsWith(a));if(r){aa(r.orderId);return}O("Mencari Pesanan...");try{let s=await k.collection("freshmart_orders").doc(a).get();if(!s.exists&&!a.startsWith("ORD-")){const o="ORD-"+a,i=await k.collection("freshmart_orders").doc(o).get();i.exists&&(s=i,a=o)}if(s.exists){const o=s.data();re.some(l=>l.orderId===a)||(re.unshift({orderId:a,date:o.dateString||(o.timestamp?o.timestamp.toDate().toISOString():new Date().toISOString()),total:o.payment&&o.payment.grandTotal?o.payment.grandTotal:0,itemCount:(o.items||[]).reduce((l,d)=>l+(parseFloat(d.qty)||0),0),status:o.status||"Baru",pointsEarned:o.pointsEarned||0,claimedReward:o.claimedReward||null,finalMemberPoints:o.finalMemberPoints||null}),Kt(),St()),e&&(e.value=""),g("✅ Pesanan berhasil ditemukan!"),aa(a)}else g("❌ Pesanan dengan ID tersebut tidak ditemukan.")}catch(s){console.error("Gagal melacak pesanan:",s),g("Gagal menghubungi server. Pastikan ID Pesanan sudah benar.")}finally{D()}},lo=()=>{_e("Hapus Riwayat","Riwayat pesanan di perangkat ini akan dihapus. Pesanan tetap tersimpan di sistem toko. Lanjutkan?",()=>{Bt([]),Kt(),St(),g("Riwayat lokal dibersihkan")})},aa=async e=>{O("Memuat Rincian...");try{const t=await k.collection("freshmart_orders").doc(e).get();if(!t.exists){g("Pesanan tidak ditemukan."),D();return}const a=t.data();let r=[];if(a.status==="Selesai")try{r=(await k.collection("freshmart").doc("cms_data").collection("reviews").where("orderId","==",e).get()).docs.map(o=>`${o.data().productId}::${o.data().variantName||""}`)}catch{}Ss(e,a,r)}catch(t){console.error("Gagal mengambil data pesanan:",t),g("Gagal memuat rincian pesanan. Coba beberapa saat lagi.")}finally{D()}},Ss=(e,t,a=[])=>{try{let r=document.getElementById("order-detail-modal");r||(r=document.createElement("div"),r.id="order-detail-modal",r.className="fixed inset-0 z-[100] flex justify-center items-end sm:items-center bg-slate-900/60 opacity-0 pointer-events-none transition-opacity duration-300",document.body.appendChild(r));const s=c(t.customer&&t.customer.name?t.customer.name:"-"),o=c(t.customer&&t.customer.wa?t.customer.wa:"-"),i=c(t.customer&&t.customer.address?t.customer.address:"-"),l=t.customer&&t.customer.deliveryMethod==="delivery"?"Dikirim ke Alamat":"Ambil di Toko (Pickup)",d=c(t.customer&&t.customer.note?t.customer.note:""),p=c(t.payment&&t.payment.method?t.payment.method:"Cash / COD"),f=t.items||[],b=f.some(S=>S.poTime&&S.poTime!==""),u=f.map(S=>{const q=parseFloat(S.qty)||0,K=parseFloat(S.effectivePrice||S.price)||0,ce=q*K,ve=`${S.id}::${S.variantName||""}`,F=t.status==="Selesai"&&!a.includes(ve)&&S.id!==void 0&&S.id!==null;return`
                ...
                <div class="p-4 sm:p-5 overflow-y-auto flex-1 space-y-5 custom-scrollbar text-sm">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="bg-[rgba(var(--color-primary-rgb),0.06)] p-3 rounded-xl border border-[var(--color-primary)]/20">
                            ...
                            <p class="text-[11px] font-semibold text-[var(--color-primary)] mt-1 ml-5">${Ft(t.claimedReward)}</p>
                    ...
                    <div class="bg-slate-100 dark:bg-slate-800 p-4 rounded-xl space-y-2 text-xs">
                        ...
                        ${_>0?`<div class="flex justify-between text-[var(--color-primary)]"><p>Diskon Ongkir</p><p class="font-bold">-${x(_)}</p></div>`:""}
                        ${T>0?`<div class="flex justify-between text-rose-500"><p>Diskon Promo</p><p class="font-bold">-${x(T)}</p></div>`:""}
                        ${(()=>{if(M<=0)return"";const S=t.payment?.ppnType==="inclusive",q=y-T+(h-_),K=t.payment?.dppAmount||(S?Math.round(q*100/(100+V)):Math.max(0,q));return`
        ...
        `,r.classList.contains("opacity-0")&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("customerOrder"),r.classList.remove("opacity-0","pointer-events-none"),setTimeout(()=>{const S=document.getElementById("order-detail-content");S&&(S.classList.remove("translate-y-full","sm:translate-y-10"),S.classList.add("translate-y-0","sm:translate-y-0"))},50)}catch(r){console.error("Error Render HTML Modal:",r),g("Gagal menampilkan detail. Coba lagi.")}},no=(e=!1)=>{const t=()=>{const a=document.getElementById("order-detail-modal"),r=document.getElementById("order-detail-content");r&&(r.classList.remove("translate-y-0","sm:translate-y-0"),r.classList.add("translate-y-full","sm:translate-y-10")),setTimeout(()=>{a&&a.classList.add("opacity-0","pointer-events-none")},300)};typeof window.requestCloseModal=="function"?window.requestCloseModal("customerOrder",e,t):t()};window.attachMyOrdersRealtime=$s;window.detachMyOrdersRealtime=ks;window.renderMyOrders=St;window.checkOrderStatus=oo;window.trackOrderManual=io;window.clearMyOrders=lo;window.openCustomerOrderDetail=aa;window.renderOrderDetailModal=Ss;window.closeCustomerOrderDetailModal=no;window.reviewPhotoFile=null;window.reviewRating=0;const co=(e,t,a,r,s)=>{const o=decodeURIComponent(a||""),i=decodeURIComponent(r||""),l=decodeURIComponent(s||"");let d=document.getElementById("review-modal");d||(d=document.createElement("div"),d.id="review-modal",d.className="fixed inset-0 z-[120] bg-slate-900/70 backdrop-blur-sm flex items-end sm:items-center justify-center p-0 sm:p-5",d.onclick=p=>{p.target===d&&va()},document.body.appendChild(d)),window.reviewPhotoFile=null,window.reviewRating=0,d.innerHTML=`
        <div class="bg-white dark:bg-slate-900 w-full max-w-lg rounded-t-[2rem] sm:rounded-[2rem] max-h-[85vh] flex flex-col shadow-2xl border border-slate-200 dark:border-slate-700">
            <div class="p-5 sm:p-6 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center shrink-0">
                <div class="min-w-0">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                ...
                <div class="card-modern p-5 sm:p-5">
                    ...
                    <p class="text-lg sm:text-xl font-bold truncate" style="color:var(--color-primary)">${x(_)}</p>
                    <p class="text-[10px] font-bold text-slate-400 mt-1">Laba Kotor − Diskon</p>
                </div>
            </div>
        `)},r=Oa.get(e);if(r&&Date.now()-r.timestamp<xo){a(r.data);return}P("admin-report-container",'<div class="text-center py-10"><i class="fa-solid fa-spinner fa-spin text-2xl text-slate-300"></i></div>');let s=null;const o=new Date;if(e==="today")s=new Date(o.getFullYear(),o.getMonth(),o.getDate());else if(e==="week"){const b=o.getDay(),u=b===0?6:b-1;s=new Date(o.getFullYear(),o.getMonth(),o.getDate()-u)}else e==="month"&&(s=new Date(o.getFullYear(),o.getMonth(),1));let i=0,l=0,d=0,p=0,f=!1;try{if(!we.currentUser){P("admin-report-container",'<div class="text-center py-10 text-slate-400"><i class="fa-solid fa-lock text-2xl mb-3"></i><p class="text-xs font-bold">Login terlebih dahulu untuk melihat laporan.</p></div>');return}let b=k.collection("freshmart_orders");s&&(b=b.where("timestamp",">=",ue.firestore.Timestamp.fromDate(s)));const u=await b.limit(3e3).get();f=u.size>=3e3,u.forEach(y=>{const h=y.data();h.status!=="Dibatalkan"&&(p++,i+=parseFloat(h.payment?.subtotal)||0,d+=parseFloat(h.payment?.productDiscount)||0,(h.items||[]).forEach(T=>{const _=T.hpp!==void 0&&T.hpp!==null?parseFloat(T.hpp):typeof window.getEffHpp=="function"?window.getEffHpp(T):0;l+=(parseFloat(_)||0)*(parseFloat(T.qty)||0)}))});const w={totalPenjualan:i,totalHppTerjual:l,totalDiskonProduk:d,orderCount:p,truncated:f};Oa.set(e,{data:w,timestamp:Date.now()}),a(w)}catch(b){console.error("Gagal memuat laporan penjualan:",b)}},wo=async()=>{const e=C("login-username"),t=C("login-password");if(!e||!t)return g("Email & Password wajib diisi!");O("Verifikasi Login...");try{if(await we.signInWithEmailAndPassword(e,t),!we.currentUser||we.currentUser.uid!==ca){const a=we.currentUser?we.currentUser.uid:"null";throw await we.signOut(),new Error("UID_MISMATCH: "+a)}window.isAdm=!0,history.replaceState({view:"view-admin"},"",window.location.href),typeof window.changeView=="function"&&window.changeView("view-admin",!0),It(),g("Login Berhasil!")}catch(a){if(console.error(a),a.message&&a.message.startsWith("UID_MISMATCH:")){const r=a.message.replace("UID_MISMATCH: ","");g("Login Ditolak: UID Anda ("+r+") tidak cocok dengan ADMIN_UID!")}else g("Login Ditolak: Email atau Password salah!")}finally{D()}},Ts=async()=>{O("Keluar...");try{await we.signOut(),window.isAdm=!1,window.__localIsAdm=!1,window.isPro=!1,typeof window.updateProBadge=="function"&&window.updateProBadge(),Ee&&(Ee(),ct(null)),Ie&&(Ie(),lt(null)),je&&(je(),nt(null)),g("Berhasil Logout"),typeof window.changeView=="function"&&window.changeView("view-catalog")}catch{g("Gagal Logout")}finally{D()}},ho=()=>{_e("Keluar Seller","Apakah anda akan keluar dari dashboard seller?",()=>{Ts()},"Ya, Keluar")};window.checkAdminAccess=go;window.openAdminMenu=It;window.toggleTaxMenuVisibility=$a;window.computeInventoryStats=Wt;window.loadAdminReport=Ps;window.processAdminLogin=wo;window.logoutAdmin=Ts;window.confirmLogoutAdmin=ho;const vo=async()=>{if(!le||le.length===0)return g("Belum ada data pesanan!");O("Menyiapkan modul Excel...");try{await za("https://cdn.sheetjs.com/xlsx-0.20.3/package/dist/xlsx.full.min.js",()=>typeof XLSX<"u")}catch{D(),g("Gagal memuat modul Excel. Cek koneksi internet Anda.");return}D();let e=[];le.forEach((o,i)=>{let l=o.dateString?new Date(o.dateString).toLocaleString("id-ID"):"-",d=o.customer?.name||"Anonim",p=o.customer?.deliveryMethod==="delivery"?"Dikirim":"Ambil di Toko",f=o.status||"-",b=o.items?o.items.reduce((w,y)=>w+(parseFloat(y.qty)||0),0):0,u=o.payment?.grandTotal||0;e.push({No:i+1,"ID Pesanan":o.orderId,Tanggal:l,"Nama Pelanggan":d,"Metode Kirim":p,Status:f,"Total Item":b,"Total Tagihan (Rp)":u})});const t=XLSX.utils.json_to_sheet(e),a=XLSX.utils.book_new();XLSX.utils.book_append_sheet(a,t,"Laporan Pesanan");const r=[{wch:5},{wch:25},{wch:22},{wch:25},{wch:15},{wch:15},{wch:12},{wch:20}];t["!cols"]=r;const s=new Date().toISOString().split("T")[0];XLSX.writeFile(a,`Laporan_Pesanan_${s}.xlsx`),g("Laporan Excel (.xlsx) berhasil diunduh!")},yo=()=>{try{const e=new(window.AudioContext||window.webkitAudioContext),t=e.createOscillator(),a=e.createGain();t.connect(a),a.connect(e.destination),t.type="sine",t.frequency.setValueAtTime(800,e.currentTime),a.gain.setValueAtTime(1,e.currentTime),t.frequency.setValueAtTime(600,e.currentTime+.2),t.frequency.setValueAtTime(800,e.currentTime+.6),a.gain.setValueAtTime(1,e.currentTime+.6),t.frequency.setValueAtTime(600,e.currentTime+.8),a.gain.exponentialRampToValueAtTime(1e-5,e.currentTime+1.5),t.start(e.currentTime),t.stop(e.currentTime+1.5)}catch{}},ko=()=>{P("admin-content",`
        ...
        <div class="flex flex-col gap-4 text-sm pb-2">
            ...
            <div class="bg-violet-50 dark:bg-violet-900/10 p-5 sm:p-6 rounded-[1.5rem] border border-violet-200 dark:border-violet-800 shadow-sm">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex justify-between items-center"><span class="text-slate-500 dark:text-slate-400 font-bold text-xs">Status</span><span class="font-bold text-xs px-2 py-1 rounded-xl ${t.claimedReward.status==="ready"?"bg-emerald-100 text-emerald-600":t.claimedReward.status==="waiting_stock"?"bg-amber-100 text-amber-600":"bg-slate-200 text-slate-600"}">${Ft(t.claimedReward)}</span></div>
...
Kami akan segera memproses pesanan Anda. Terima kasih! 🙏`;window.open(`https://wa.me/${r}?text=${encodeURIComponent(p)}`,"_blank")}catch{D(),g("Gagal memuat data pesanan!")}},Ao=e=>{_e("Hapus Pesanan","Yakin ingin hapus permanen?",async()=>{if(!Ue){ee(!0),O("Menghapus...");try{await k.collection("freshmart_orders").doc(e).delete(),g("Terhapus!"),rt===e&&As()}catch{g("Gagal!")}finally{ee(!1),D()}}})};window.exportOrdersToExcel=vo;window.rAdmOrd=ko;window.openOrderDetail=Sa;window.saveOrderCustomerToDB=$o;window.ackRewardClaim=So;window.closeOrderDetailModal=As;window.updateOrderStatus=Po;window.konfirmasiKeWA=To;window.deleteOrder=Ao;const Mo=()=>{const e=n.store.name||"Toko Grosir",t=n.store.themeColor||"#10b981",a=(o,i,l=!1)=>{let d=document.querySelector(`meta[${l?"property":"name"}="${o}"]`);d||(d=document.createElement("meta"),l?d.setAttribute("property",o):d.setAttribute("name",o),document.head.appendChild(d)),d.setAttribute("content",i)};a("theme-color",t),a("mobile-web-app-capable","yes"),a("apple-mobile-web-app-capable","yes"),a("apple-mobile-web-app-status-bar-style","black-translucent"),a("apple-mobile-web-app-title",e),a("application-name",e),a("msapplication-TileColor",t),document.title=e,localStorage.setItem("freshmart_theme_color",t),n.store.uiTheme&&n.store.uiTheme!==localStorage.getItem("freshmart_ui_theme")&&(localStorage.setItem("freshmart_ui_theme",n.store.uiTheme),Ke(n.store.uiTheme));const r=n.store.bgStyle||localStorage.getItem("freshmart_bg_style")||"minimalist",s=n.store.bgCustomUrl!==void 0?n.store.bgCustomUrl:localStorage.getItem("freshmart_bg_custom_url")||"";We(r,s)},Ms=()=>{P("admin-content",`
    ...
    `;if(P("admin-content",o),e==="profile"){const i=n.store.uiTheme||"",l=n.store.themeColor||"#10b981";(i==="custom"||!tt?.[i])&&setTimeout(()=>{const p=document.getElementById("custom-color-chip");if(p){p.style.background=l;const f=p.querySelector("i");f&&(f.style.color="#fff")}},50)}},Io=async e=>{if(!Ue){ee(!0),O("Menyimpan...");try{e==="profile"?(n.store.name=C("set-name"),n.store.slogan=C("set-slogan"),n.store.logo=W(C("set-logo")),n.store.description=C("set-description"),n.store.email=C("set-email"),n.store.showRewardCatalog=C("set-show-reward-catalog")==="true",n.store.operationalHours=C("set-hours"),n.store.footerCredit=C("set-credit"),n.store.themeColor=C("set-theme-color"),n.store.uiTheme=C("set-ui-theme"),n.store.bgStyle=C("set-bg-style")||"minimalist",n.store.bgCustomUrl=W(C("set-bg-custom-url")),localStorage.setItem("freshmart_theme_color",n.store.themeColor),localStorage.setItem("freshmart_ui_theme",n.store.uiTheme),localStorage.setItem("freshmart_bg_style",n.store.bgStyle),localStorage.setItem("freshmart_bg_custom_url",n.store.bgCustomUrl||""),Ke(n.store.uiTheme,n.store.themeColor),We(n.store.bgStyle,n.store.bgCustomUrl)):e==="catalog"?(n.store.categoryStyle=C("set-category-style"),n.store.brandStyle=C("set-brand-style"),n.store.showCategories=C("set-show-categories")==="true",n.store.showBrands=C("set-show-brands")==="true"):e==="shipping"?(n.store.wa=C("set-wa").replace(/\D/g,""),n.store.address=C("set-address"),n.store.costPerKm=C("set-cost"),n.store.isDeliveryEnabled=C("set-delivery-enabled")==="true",n.store.isPickupEnabled=C("set-pickup-enabled")==="true",n.store.lat=C("set-lat"),n.store.lng=C("set-lng")):e==="payment"?(n.payment||(n.payment={}),n.payment.qrisUrl=W(C("set-qris-url"))):e==="config"?(n.config||(n.config={}),n.config.gasUrl=C("set-gas-url"),g("Pengaturan GAS URL tersimpan.")):e==="operasional"&&(n.store.useStock=C("set-use-stock")==="true",n.store.ppnEnabled=C("set-ppn-enabled")==="true",n.store.ppnType=C("set-ppn-type")||"exclusive",n.store.ppnRate=parseFloat(C("set-ppn-rate"))||11,$a());const t={profile:"store",catalog:"store",shipping:"store",operasional:"store",payment:"payment",config:"config"};typeof window.saveApp=="function"&&await window.saveApp([t[e]||"store"]),e==="profile"||e==="config"?(g(e==="config"?"Sistem Diperbarui! Memuat Ulang...":"Warna Berubah! Memuat Ulang..."),setTimeout(()=>location.reload(),1500)):(g("Tersimpan!"),Ms())}catch{g("Gagal menyimpan pengaturan")}finally{ee(!1),D()}}},jo=()=>{const e="data:text/json;charset=utf-8,"+encodeURIComponent(JSON.stringify(n,null,2)),t=document.createElement("a");t.href=e,t.download=`backup_freshmart_${new Date().toISOString().slice(0,10)}.json`,document.body.appendChild(t),t.click(),t.remove(),g("Backup diunduh!")},Eo=e=>{const t=e.target.files[0];if(!t)return;const a=new FileReader;a.onload=async r=>{try{const s=JSON.parse(r.target.result);Object.assign(n,s),typeof window.saveApp=="function"&&await window.saveApp(),g("Data dipulihkan!"),setTimeout(()=>location.reload(),1e3)}catch{g("Gagal memulihkan data!")}},a.readAsText(t)};window.syncAppMeta=Mo;window.rAdmSet=Ms;window.selectPresetTheme=Do;window.selectBgStyle=Co;window.openSettingForm=Lo;window.saveAdminSettings=Io;window.backupData=jo;window.restoreData=Eo;let oe=new Date().getFullYear(),ie=0,Be="menu",Oe=null;const qe=["Jan","Feb","Mar","Apr","Mei","Jun","Jul","Agu","Sep","Okt","Nov","Des"],_o=e=>{if(typeof window.getEffHpp=="function")return window.getEffHpp(e);const t=n.products?.find(a=>a.id===e.id);if(!t)return 0;if(e.variantName&&t.variants){const a=t.variants.find(r=>r.name===e.variantName);if(a&&a.hpp!=null)return parseFloat(a.hpp)||0}return parseFloat(t.hpp)||0},qa=new Map,Ro=2*60*1e3,Pa=async e=>{const t=qa.get(e);if(t&&Date.now()-t.timestamp<Ro)return t.data;const a={};for(let r=1;r<=12;r++)a[r]={omset:0,ppn:0,hpp:0,disc:0,orderCount:0};try{const r=new Date(e,0,1),s=new Date(e+1,0,1);(await k.collection("freshmart_orders").where("timestamp",">=",ue.firestore.Timestamp.fromDate(r)).where("timestamp","<",ue.firestore.Timestamp.fromDate(s)).limit(5e3).get()).forEach(l=>{const d=l.data();if(d.status==="Dibatalkan"||!d.timestamp||!d.timestamp.toDate)return;const p=d.timestamp.toDate().getMonth()+1;if(!a[p])return;const f=d.payment?.dppAmount!==void 0&&d.payment?.dppAmount!==null?parseFloat(d.payment.dppAmount):parseFloat(d.payment?.subtotal)||0;a[p].omset+=f,a[p].ppn+=parseFloat(d.payment?.ppnAmount)||0,a[p].disc+=parseFloat(d.payment?.productDiscount)||0,a[p].orderCount++,(d.items||[]).forEach(b=>{const u=b.hpp!==void 0&&b.hpp!==null?parseFloat(b.hpp):_o(b);a[p].hpp+=(parseFloat(u)||0)*(parseFloat(b.qty)||0)})})}catch(r){console.error("Gagal memuat data pajak:",r),g("Gagal memuat data periode ini!")}return qa.set(e,{data:a,timestamp:Date.now()}),a},vt=()=>Oe?(ie===0?Object.keys(Oe):[ie]).reduce((t,a)=>{const r=Oe[a];return t.omset+=r.omset,t.ppn+=r.ppn,t.hpp+=r.hpp,t.disc+=r.disc,t.orderCount+=r.orderCount,t},{omset:0,ppn:0,hpp:0,disc:0,orderCount:0}):{omset:0,ppn:0,hpp:0,disc:0,orderCount:0},Ta=()=>{const e=n.taxSettings?.monthlyExpenses||{};return(ie===0?Array.from({length:12},(a,r)=>r+1):[ie]).reduce((a,r)=>a+(parseFloat(e[`${oe}-${r}`])||0),0)},Fo=async()=>{P("admin-content",'<div class="text-center py-16"><i class="fa-solid fa-spinner fa-spin text-3xl text-slate-300"></i></div>'),Oe=await Pa(oe),Aa()},Aa=()=>{const e=Array.from({length:6},(r,s)=>new Date().getFullYear()-4+s),t=[{k:"summary",l:"Ringkasan PPN",i:"fa-receipt"},{k:"income",l:"Laba Rugi",i:"fa-chart-pie"},{k:"balance",l:"Neraca",i:"fa-scale-balanced"},{k:"settings",l:"Pengaturan",i:"fa-gear"}];Be==="menu"&&(Be="summary");const a=`
    ...
    </div>`),Qt()},No=e=>{Be=e,Aa()},Bo=async e=>{oe=parseInt(e,10),P("tax-content",'<div class="text-center py-16"><i class="fa-solid fa-spinner fa-spin text-3xl text-slate-300"></i></div>'),Oe=await Pa(oe),Qt()},Oo=e=>{ie=parseInt(e,10),Qt()},Qt=()=>{Be==="summary"?Ds():Be==="income"?Ma():Be==="balance"?Da():Be==="settings"&&Cs()},Ds=()=>{const e=vt(),t=ie===0?`Tahun ${oe}`:`${qe[ie-1]} ${oe}`,a=e.omset-e.disc,r=Array.from({length:12},(s,o)=>o+1).map(s=>{const o=Oe?Oe[s]:{omset:0,ppn:0,orderCount:0};return`<tr class="${ie===s?"bg-[rgba(var(--color-primary-rgb),0.08)] dark:bg-[rgba(var(--color-primary-rgb),0.14)] font-bold":"hover:bg-slate-50 dark:hover:bg-slate-700/30"} border-b border-slate-100 dark:border-slate-700/50 last:border-0 transition-colors">
    ...
    `)},Ma=()=>{const e=vt(),t=ie===0?`Tahun ${oe}`:`${qe[ie-1]} ${oe}`,a=e.omset-e.disc-e.hpp,r=ie===0?null:`${oe}-${ie}`,s=Ta(),o=a-s,i=n.taxSettings?.taxScheme||"umkm_final";let l,d,p;i==="umkm_final"?(l=.5,d=e.omset,p="PPh Final UMKM (0,5% × Omset)"):i==="badan_normal"?(l=22,d=Math.max(0,o),p="PPh Badan (22% × Laba Bersih)"):(l=parseFloat(n.taxSettings?.customTaxRate)||0,d=Math.max(0,o),p=`PPh Custom (${l}% × Laba Bersih)`);const f=d*(l/100),b=o-f;let u="";if(ie===0)u=Array.from({length:12},(w,y)=>y+1).map(w=>{const y=`${oe}-${w}`,h=(n.taxSettings?.monthlyExpenses||{})[y]||0;return`<div class="flex items-center justify-between gap-2 py-2 border-b border-slate-100 dark:border-slate-700/50 last:border-0">
                <span class="text-xs font-bold text-slate-600 dark:text-slate-300">${qe[w-1]} ${oe}</span>
    ...
    `)},qo=async(e,t)=>{const a=parseFloat(t)||0;n.taxSettings||(n.taxSettings={}),n.taxSettings.monthlyExpenses||(n.taxSettings.monthlyExpenses={}),n.taxSettings.monthlyExpenses[e]=a;try{typeof window.saveApp=="function"&&await window.saveApp(["taxSettings"]),Ma()}catch{g("Gagal menyimpan biaya operasional!")}},Da=()=>{const e=Wt(),t=n.taxSettings?.balanceSheet||{kas:0,piutang:0,hutang:0},a=(parseFloat(t.kas)||0)+(parseFloat(t.piutang)||0)+e.assetHpp,r=parseFloat(t.hutang)||0,s=a-r;P("tax-content",`
    ...
    `)},Uo=async(e,t)=>{const a=parseFloat(t)||0;n.taxSettings||(n.taxSettings={}),n.taxSettings.balanceSheet||(n.taxSettings.balanceSheet={kas:0,piutang:0,hutang:0,modalDisetor:0}),n.taxSettings.balanceSheet[e]=a;try{typeof window.saveApp=="function"&&await window.saveApp(["taxSettings"]),Da()}catch{g("Gagal menyimpan data neraca!")}},Cs=()=>{const e=n.taxSettings||{};P("tax-content",`
    ...
    `)},Ho=e=>{Z("tax-custom-rate-wrap","hidden",e!=="custom")},Vo=async()=>{if(!Ue){ee(!0),O("Menyimpan...");try{n.taxSettings||(n.taxSettings={}),n.taxSettings.companyName=C("tax-company-name"),n.taxSettings.npwp=C("tax-npwp"),n.taxSettings.taxScheme=C("tax-scheme"),n.taxSettings.customTaxRate=parseFloat(C("tax-custom-rate"))||.5,typeof window.saveApp=="function"&&await window.saveApp(["taxSettings"]),g("Pengaturan pajak tersimpan!")}catch{g("Gagal menyimpan pengaturan pajak!")}finally{ee(!1),D()}}},Go=e=>{const t=ie===0?`Tahun ${oe}`:`${qe[ie-1]} ${oe}`,a=n.taxSettings||{},r=new Date().toLocaleDateString("id-ID",{day:"2-digit",month:"long",year:"numeric"});let s="";n.store.logo&&(n.store.logo.includes("http")||n.store.logo.includes("data:"))?s=`<img loading="eager" src="${c(n.store.logo)}" class="w-16 h-16 object-contain">`:s='<div class="w-16 h-16 bg-slate-700 text-white flex items-center justify-center rounded-xl"><i class="fa-solid fa-store text-3xl"></i></div>';const i={summary:"LAPORAN PPN & OMSET",income:"LAPORAN LABA RUGI",balance:"NERACA"}[e]||"LAPORAN";let l=`
    <div class="flex justify-between items-start border-b-[3px] border-slate-800 pb-6 mb-6">
        <div class="flex items-center gap-4">
            ${s}
            <div>
    ...
    <div class="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-6 text-[11px] font-bold text-amber-700 leading-relaxed">
    ...
    </div>`,d="";if(e==="summary"){const f=vt(),b=f.omset-f.disc,u=Array.from({length:12},(w,y)=>y+1).map(w=>{const y=Oe?Oe[w]:{omset:0,ppn:0,orderCount:0};return`<tr class="border-b border-slate-200"><td class="py-2.5 px-3 font-bold text-slate-700">${qe[w-1]} ${oe}</td><td class="py-2.5 px-3 text-right font-bold text-slate-700">${x(y.omset)}</td><td class="py-2.5 px-3 text-right font-bold text-slate-900">${x(y.ppn)}</td><td class="py-2.5 px-3 text-right font-bold text-slate-500">${y.orderCount}</td></tr>`}).join("");d=`
        ...
        <table class="w-full text-xs"><thead><tr class="bg-slate-100 text-left"><th class="py-2.5 px-3 font-bold text-slate-500 uppercase text-[9px]">Bulan</th><th class="py-2.5 px-3 font-bold text-slate-500 uppercase text-[9px] text-right">Omset</th><th class="py-2.5 px-3 font-bold text-slate-500 uppercase text-[9px] text-right">PPN Keluaran</th><th class="py-2.5 px-3 font-bold text-slate-500 uppercase text-[9px] text-right">Pesanan</th></tr></thead><tbody>${u}</tbody></table>`}else if(e==="income"){const f=vt(),b=f.omset-f.disc-f.hpp,u=Ta(),w=b-u,y=a.taxScheme||"umkm_final";let h,T,_;y==="umkm_final"?(h=.5,T=f.omset,_="PPh Final UMKM (0,5% × Omset)"):y==="badan_normal"?(h=22,T=Math.max(0,w),_="PPh Badan (22% × Laba Bersih)"):(h=parseFloat(a.customTaxRate)||0,T=Math.max(0,w),_=`PPh Custom (${h}% × Laba Bersih)`);const M=T*(h/100),V=w-M,I=(S,q,K,ce)=>`<div class="flex justify-between py-2 ${K?"border-t-2 border-slate-800 mt-1 pt-3":"border-b border-slate-100"}"><span class="${K?"font-bold text-slate-900":"font-bold text-slate-600"}">${S}</span><span class="font-bold ${ce||"text-slate-900"}">${q}</span></div>`;d=`<div class="max-w-xl">
            ...
            ${I("(−) Estimasi "+_,"-"+x(M),!1,"text-rose-600")}
            ${I("Laba Bersih Setelah Pajak (Estimasi)",x(V),!0)}
        </div>`}else if(e==="balance"){const f=Wt(),b=a.balanceSheet||{kas:0,piutang:0,hutang:0},u=(parseFloat(b.kas)||0)+(parseFloat(b.piutang)||0)+f.assetHpp,w=parseFloat(b.hutang)||0,y=u-w;d=`
    ...
    `;e.length===0?a+=`<div class="bg-white dark:bg-slate-800 p-8 text-center rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm">
            ...
            </div>`}),a+="</div>"),a+="</div>",P("admin-content",a),setTimeout(()=>{m("total-piutang-header")&&(m("total-piutang-header").innerText=x(t))},100)};const Ko=e=>{fs(e),Ls()},Ls=()=>{const e=ma||"all",t=(kt||[]).filter(o=>e==="visible"?o.isVisible!==!1:e==="hidden"?o.isVisible===!1:!0),a=`
        ...
        </div>`}).join("");P("admin-content",a+s)},Wo=async e=>{const t=(kt||[]).find(a=>a.id===e);t&&typeof window.customPrompt=="function"&&window.customPrompt("Tulis balasan untuk ulasan ini:",t.adminReply||"",async a=>{O("Menyimpan balasan...");try{await k.collection("freshmart").doc("cms_data").collection("reviews").doc(e.toString()).update({adminReply:a}),g("Balasan tersimpan!")}catch{g("Gagal menyimpan balasan!")}finally{D()}})},Qo=async e=>{const t=(kt||[]).find(r=>r.id===e);if(!t)return;const a=t.isVisible===!1;O("Menyimpan...");try{await k.collection("freshmart").doc("cms_data").collection("reviews").doc(e.toString()).update({isVisible:a}),g(a?"Ulasan ditampilkan lagi!":"Ulasan disembunyikan dari halaman produk!")}catch{g("Gagal mengubah status ulasan!")}finally{D()}},zo=e=>{_e("Hapus Ulasan","Ulasan yang dihapus tidak bisa dikembalikan lagi.",async()=>{O("Menghapus...");try{await k.collection("freshmart").doc("cms_data").collection("reviews").doc(e.toString()).delete(),g("Ulasan dihapus!")}catch{g("Gagal menghapus ulasan!")}finally{D()}})};window.filterReviews=Ko;window.rAdmReviews=Ls;window.replyToReview=Wo;window.toggleReviewVisibility=Qo;window.deleteReview=zo;let dt=null,Xt=null;const ra=()=>{document.querySelectorAll("#banner-slider video.banner-video-element").forEach(e=>{e.dataset.init||(e.dataset.init="true",e.muted=!0,e.loop=!0,e.playsInline=!0,e.setAttribute("playsinline",""),e.setAttribute("loop",""),e.setAttribute("autoplay","")),e.dataset.loopAttached||(e.dataset.loopAttached="true",e.addEventListener("ended",()=>{e.currentTime=0,e.play().catch(()=>{})})),e.dataset.userUnmuted==="true"&&(e.muted=!1),e.play().catch(()=>{})})},Jo=(e,t)=>{const a=m(`banner-slide-${t}`)||e&&e.closest(".banner-slide-item");if(!a)return;const r=a.querySelector("video.banner-video-element");if(r){r.muted?(r.muted=!1,r.volume=1,r.dataset.userUnmuted="true",r.play().catch(()=>{}),e&&(e.innerHTML='<i class="fa-solid fa-volume-high text-xs"></i> <span>Suara On</span>',e.className="banner-sound-toggle inline-flex items-center gap-1.5 px-3 py-1.5 primary-bg text-white text-[10px] sm:text-xs font-bold rounded-full shadow-lg border border-white/20 active:scale-95 transition-all cursor-pointer")):(r.muted=!0,r.dataset.userUnmuted="false",e&&(e.innerHTML='<i class="fa-solid fa-volume-xmark text-xs"></i> <span>Muted</span>',e.className="banner-sound-toggle inline-flex items-center gap-1.5 px-3 py-1.5 bg-slate-900/80 hover:bg-slate-900 text-white text-[10px] sm:text-xs font-bold rounded-full shadow-lg border border-white/20 active:scale-95 transition-all cursor-pointer"));return}const s=a.querySelector("iframe.banner-video-iframe");s&&(s.dataset.muted!=="false"?(s.dataset.muted="false",s.contentWindow?.postMessage('{"event":"command","func":"unMute","args":""}',"*"),s.contentWindow?.postMessage('{"event":"command","func":"setVolume","args":[100]}',"*"),e&&(e.innerHTML='<i class="fa-solid fa-volume-high text-xs"></i> <span>Suara On</span>',e.className="banner-sound-toggle inline-flex items-center gap-1.5 px-3 py-1.5 primary-bg text-white text-[10px] sm:text-xs font-bold rounded-full shadow-lg border border-white/20 active:scale-95 transition-all cursor-pointer")):(s.dataset.muted="true",s.contentWindow?.postMessage('{"event":"command","func":"mute","args":""}',"*"),e&&(e.innerHTML='<i class="fa-solid fa-volume-xmark text-xs"></i> <span>Muted</span>',e.className="banner-sound-toggle inline-flex items-center gap-1.5 px-3 py-1.5 bg-slate-900/80 hover:bg-slate-900 text-white text-[10px] sm:text-xs font-bold rounded-full shadow-lg border border-white/20 active:scale-95 transition-all cursor-pointer")))},mt=e=>{const t=m("banner-dots-container");if(!t)return;t.querySelectorAll(".banner-dot-item").forEach((r,s)=>{s===e?r.className="banner-dot-item h-2.5 rounded-full transition-all duration-300 bg-[var(--color-primary)] w-7 shadow-sm":r.className="banner-dot-item w-2.5 h-2.5 rounded-full transition-all duration-300 bg-slate-300 dark:bg-slate-700 hover:bg-slate-400"})},Yo=()=>{Xt&&clearTimeout(Xt),Xt=setTimeout(()=>{const e=m("banner-slider");if(!e)return;const t=e.querySelectorAll(".banner-slide-item");if(!t||!t.length)return;let a=0,r=1/0;t.forEach((s,o)=>{const i=Math.abs(s.offsetLeft-e.scrollLeft);i<r&&(r=i,a=o)}),mt(a)},100)},Xo=e=>{clearInterval(dt);const t=m("banner-slider");if(!t)return;const a=t.querySelectorAll(".banner-slide-item");a&&a[e]&&(t.scrollTo({left:a[e].offsetLeft-t.offsetLeft,behavior:"smooth"}),mt(e)),setTimeout(Pt,8e3)},Zo=()=>{clearInterval(dt);const e=m("banner-slider");if(!e)return;const t=e.querySelectorAll(".banner-slide-item");if(!t||!t.length)return;let a=0,r=1/0;t.forEach((o,i)=>{const l=Math.abs(o.offsetLeft-e.scrollLeft);l<r&&(r=l,a=i)});const s=(a-1+t.length)%t.length;e.scrollTo({left:t[s].offsetLeft-e.offsetLeft,behavior:"smooth"}),mt(s),setTimeout(Pt,8e3)},ei=()=>{clearInterval(dt);const e=m("banner-slider");if(!e)return;const t=e.querySelectorAll(".banner-slide-item");if(!t||!t.length)return;let a=0,r=1/0;t.forEach((o,i)=>{const l=Math.abs(o.offsetLeft-e.scrollLeft);l<r&&(r=l,a=i)});const s=(a+1)%t.length;e.scrollTo({left:t[s].offsetLeft-e.offsetLeft,behavior:"smooth"}),mt(s),setTimeout(Pt,8e3)},Pt=()=>{if(clearInterval(dt),!m("banner-slider")||!n.banners||n.banners.length<=1)return;const t=()=>{ra()};t(),ra(),dt=setInterval(()=>{const a=m("banner-slider");if(!a)return clearInterval(dt);const r=a.querySelectorAll(".banner-slide-item");if(!r||r.length<=1){const s=a.scrollWidth-a.clientWidth;a.scrollLeft>=s-10?a.scrollTo({left:0,behavior:"smooth"}):a.scrollBy({left:a.clientWidth,behavior:"smooth"})}else{let s=0,o=1/0;r.forEach((d,p)=>{const f=Math.abs(d.offsetLeft-a.scrollLeft);f<o&&(o=f,s=p)});const i=(s+1)%r.length,l=r[i];a.scrollTo({left:l.offsetLeft-a.offsetLeft,behavior:"smooth"}),mt(i)}setTimeout(t,400)},8e3)};window.forcePlayBannerVideos=ra;window.toggleBannerVideoSound=Jo;window.updateBannerDots=mt;window.onBannerScroll=Yo;window.scrollToBanner=Xo;window.scrollBannerPrev=Zo;window.scrollBannerNext=ei;window.startBannerAutoSlide=Pt;const Ca=()=>{const e=document.getElementById("storefront-footer-container");if(!e)return;const t=n.store||{},a=t.name||"Toko Putri",r=t.description||t.slogan||"Selamat datang di toko kami. Melayani pembelian online dan offline dengan kualitas terbaik.",s=t.email||"",o=t.operationalHours||"Buka Setiap Hari (08:00 - 17:00)",i=t.address||"",l=t.wa||"",d=t.footerCredit||"Seluruh hak cipta dilindungi undang-undang.",p=new Date().getFullYear();let f=(l||"").replace(/\D/g,"");f.startsWith("0")?f="62"+f.slice(1):!f.startsWith("62")&&f.length>0&&(f="62"+f);let b='<i class="fa-solid fa-store text-2xl text-[var(--color-primary)]"></i>';t.logo&&(t.logo.includes("http")||t.logo.includes("data:")?b=`<img src="${c(t.logo)}" alt="${c(a)}" class="h-full w-full max-h-10 max-w-10 object-contain" onerror="this.outerHTML='<i class=\\'fa-solid fa-store text-2xl text-[var(--color-primary)]\\'></i>'">`:b=`<i class="fa-solid ${c(t.logo)} text-2xl text-[var(--color-primary)]"></i>`);const u=f?`window.open('https://wa.me/${c(f)}', '_blank')`:"if(typeof window.showToast==='function') window.showToast('Nomor WhatsApp belum dikonfigurasi admin.');";e.innerHTML=`
    ...
    `},ti=()=>{let e=document.getElementById("guarantee-modal");e||(e=document.createElement("div"),e.id="guarantee-modal",e.className="fixed inset-0 z-[115] bg-slate-900/70 backdrop-blur-sm flex items-end sm:items-center justify-center p-0 sm:p-5",e.onclick=t=>{t.target===e&&Is()},document.body.appendChild(e)),e.innerHTML=`
        ...
        </div>`,e.style.opacity="0",e.style.display="flex",requestAnimationFrame(()=>{e.style.transition="opacity 0.25s ease",e.style.opacity="1"})},Is=()=>{const e=document.getElementById("guarantee-modal");!e||e.style.display==="none"||(e.style.opacity="0",e.style.transition="opacity 0.25s ease",setTimeout(()=>{e.style.display="none",e.style.opacity="",e.style.transition=""},250))},ai=()=>{let e=document.getElementById("security-modal");e||(e=document.createElement("div"),e.id="security-modal",e.className="fixed inset-0 z-[115] bg-slate-900/70 backdrop-blur-sm flex items-end sm:items-center justify-center p-0 sm:p-5",e.onclick=t=>{t.target===e&&js()},document.body.appendChild(e)),e.innerHTML=`
        <div class="bg-white dark:bg-slate-900 w-full max-w-md rounded-t-[2rem] sm:rounded-[2rem] p-6 shadow-2xl border border-slate-200 dark:border-slate-700 space-y-4">
            <div class="flex justify-between items-center border-b border-slate-100 dark:border-slate-800 pb-4">
                <h3 class="font-bold text-slate-800 dark:text-white text-base flex items-center gap-2">
    ...
    <div class="relative group/banner-wrapper w-full">
        <div id="banner-slider" class="flex overflow-x-auto gap-4 sm:gap-6 pb-4 pt-2 snap-x hide-scrollbar scroll-smooth" ontouchstart="clearInterval(bannerTmr)" ontouchend="setTimeout(startBannerAutoSlide, 8000)" onmouseenter="clearInterval(bannerTmr)" onmouseleave="startBannerAutoSlide()" onscroll="window.onBannerScroll && window.onBannerScroll()">
            ${n.banners.map((i,l)=>{const d=i.type==="video"&&i.videoUrl,p=!d&&i.link?`onclick="window.open('${c(i.link)}', '_self')"`:"";if(d){const f=_t(i.videoUrl)||{type:"direct",directUrl:Rt(i.videoUrl),embedUrl:Qa(i.videoUrl)};let b="";return f.type==="youtube"?b=`
                <iframe
    ...
    `),rAdmItms(e)};window.rAdmItms=e=>{e&&(st=e,typeof window.setCTab=="function"&&window.setCTab(e),window.cTab=e);const t=m("admin-list-container"),a=t?t.closest(".scroll-content"):null,r=a?a.scrollTop:0;if(e==="products"&&m("admin-product-stats")){const i=Wt();P("admin-product-stats",`
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                <div class="card-modern p-5 sm:p-5">
...
></i>`,s+="</div>"}),s=`<div class="grid grid-cols-1 lg:grid-cols-2 gap-x-5 gap-y-5 items-start">${s}</div>`,P("admin-modal-form",s),e==="products"&&(rVarsB(),rWholB(),rSpecB());const d=m("admin-modal");d&&d.classList.contains("hidden")&&pushModalHistory("admin"),L("admin-modal"),setTimeout(()=>{m("admin-modal").classList.remove("opacity-0"),m("admin-modal-box").classList.remove("scale-95")},10)};window.rVarsB=()=>{const e=document.getElementById("af-category"),t=e?/\bcat\b/i.test(e.value):!1;let a=`<div class="space-y-5 mb-5">${Re.map((r,s)=>{let o=r.isActive!==!1&&r.isActive!=="false";return`
    ...
    `).join("")},oi=e=>{At=e,pt()},ii=()=>{pt()},li=e=>{const t=document.getElementById(`faq-body-${e}`),a=document.getElementById(`faq-icon-${e}`);if(!t||!a)return;t.classList.contains("hidden")?(t.classList.remove("hidden"),a.classList.add("rotate-180")):(t.classList.add("hidden"),a.classList.remove("rotate-180"))},ni=()=>{const e=m("modal-ask-question");e&&(e.classList.contains("hidden")&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("askQuestion"),L("modal-ask-question"),setTimeout(()=>{m("modal-ask-question")&&m("modal-ask-question").classList.remove("opacity-0"),m("modal-ask-question-box")&&m("modal-ask-question-box").classList.remove("translate-y-full")},10))},Es=(e=!1)=>{const t=()=>{m("modal-ask-question")&&m("modal-ask-question").classList.add("opacity-0"),m("modal-ask-question-box")&&m("modal-ask-question-box").classList.add("translate-y-full"),setTimeout(()=>$("modal-ask-question"),300)};typeof window.requestCloseModal=="function"?window.requestCloseModal("askQuestion",e,t):t()},di=async()=>{const e=(C("ask-author-name")||"").trim()||"Pelanggan",t=C("ask-category")||"Pemesanan",a=(C("ask-question-text")||"").trim();if(!a)return g("Tuliskan pertanyaan Anda terlebih dahulu!");O("Mengirim pertanyaan...");const r="faq-"+Date.now().toString(36),s={id:r,question:a,answer:"",category:t,authorName:e,status:"pending_answer",createdAt:new Date().toISOString()};let o=!1;try{await k.collection("freshmart").doc("cms_data").collection("faqs").doc(r).set(s),o=!0}catch(i){console.warn("Penulisan sub-koleksi faqs dibatasi, mencoba fallback cms_data.faqs:",i)}if(!o)try{const i=[s,...(n.faqs||[]).filter(l=>l.id!==r)];await k.collection("freshmart").doc("cms_data").set({faqs:i},{merge:!0}),n.faqs=i,o=!0}catch(i){console.warn("Fallback cms_data.faqs juga gagal:",i)}D(),o?(Es(),se("ask-question-text",""),g("Pertanyaan terkirim! Admin akan menjawabnya segera."),pt()):g("Gagal mengirim pertanyaan. Coba lagi!")};let it="all";const zt=()=>{Ia();const e=n.faqs||[],t=e.filter(s=>it==="pending"?s.status==="pending_answer":it==="published"?s.status==="published":!0),a=e.filter(s=>s.status==="pending_answer").length;let r=`
    ...
    </button>`,n.categories.forEach(o=>{let i=Ae===o.name,l=o.img?`<img loading="lazy" src="${c(o.img)}" alt="${c(o.name)}" class="w-full h-full object-cover" onerror="this.onerror=null;this.src='https://placehold.co/100?text=Cat'">`:'<i class="fa-solid fa-box text-base sm:text-lg"></i>';e+=`
    ...
    `,document.body.appendChild(r);const s=r.querySelector("div");ja("prompt"),setTimeout(()=>{r.classList.remove("opacity-0"),s.classList.remove("scale-95")},10);const o=r.querySelector("#prompt-input");o.focus(),o.select(),window.closePrompt=(i=!1)=>{!r||!r.parentNode||Ea("prompt",i,()=>{r.classList.add("opacity-0"),s.classList.add("scale-95"),setTimeout(()=>r.remove(),300),window.closePrompt=null})},r.querySelector("#prompt-cancel").onclick=()=>window.closePrompt(),r.querySelector("#prompt-ok").onclick=()=>{let i=o.value;window.closePrompt(),a(i)}},Ii=()=>{typeof window.openReceiptPreview=="function"&&window.openReceiptPreview()};window.copyVoucher=Pi;window.showToast=jt;window.showToastLoading=Ti;window.hideToast=Ai;window.toggleTheme=Mi;window.showConfirm=Di;window.closeConfirm=Ns;window.executeConfirm=Ci;window.customPrompt=Li;window.checkProPrint=Ii;Fs();window.firebase=ue;window.db=k;window.DOMPurify=Us;window.uiPalettes=tt;window.hexToRgb=Wa;window.applyUITheme=Ke;window.toggleTheme=Js;window.applyBackgroundStyle=We;zs();const ji=localStorage.getItem("freshmart_ui_theme")||"emerald";Ke(ji,localStorage.getItem("freshmart_theme_color"));const Ga=()=>{Ys();const e=localStorage.getItem("freshmart_bg_style")||"minimalist",t=localStorage.getItem("freshmart_bg_custom_url")||"";We(e,t),Ca()};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Ga):Ga();window.onerror=function(e,t,a,r,s){return console.error("Global Error Caught:",e,"at",a,":",r),typeof showToast=="function"&&showToast("Ops, ada kendala sistem."),!1};window.addEventListener("unhandledrejection",function(e){console.warn("Promise Rejection Sentinel:",e.reason)});window.updateSEO=Xs;window.injectJSONLD=Zs;window.rewardStatusLabel=Ft;window.getYouTubeId=Et;window.parseVideoUrl=_t;window.fixDriveVideo=Rt;window.fixDriveVideoPreview=Qa;let Ka=Ht;window.calcTaxDetails=e=>{const t=n?.store||{},a=t.ppnEnabled===!0||t.ppnEnabled==="true",r=parseFloat(t.ppnRate)||11,s=t.ppnType||"exclusive";if(!a||e<=0)return{ppnEnabled:!1,ppnRate:0,ppnType:s,ppnAmount:0,dppAmount:Math.max(0,e),grandTotalAdd:0};if(s==="inclusive"){const o=Math.round(e*100/(100+r)),i=e-o;return{ppnEnabled:!0,ppnRate:r,ppnType:"inclusive",ppnAmount:i,dppAmount:o,grandTotalAdd:0}}else{const o=Math.round(e*r/100);return{ppnEnabled:!0,ppnRate:r,ppnType:"exclusive",ppnAmount:o,dppAmount:Math.max(0,e),grandTotalAdd:o}}};typeof requestIdleCallback<"u"?requestIdleCallback(Ra,{timeout:5e3}):setTimeout(Ra,3e3);window.updateProBadge=()=>{};window.isAdm=!1;window.isPro=!0;try{cart=JSON.parse(he("freshmart_cart"))||[],_setCart(cart)}catch{}try{wishlist=JSON.parse(he("freshmart_wishlist"))||[],_setWishlist(wishlist)}catch{}try{myOrders=JSON.parse(he("freshmart_my_orders"))||[],_setMyOrders(myOrders)}catch{}history.replaceState({view:"view-catalog"},"","");const Ei=e=>{e&&U("loader-text",e);const t=m("global-loader");t&&(t.style.display="flex")},_i=()=>{const e=m("global-loader");e&&(e.style.display="none")},Ri=()=>window.sanitizeCart();window.addEventListener("DOMContentLoaded",async()=>{await loadAppData(),syncAppMeta(),attachRealtimeStockSync(),we.onAuthStateChanged(async e=>{if(e&&e.uid!==ca){await we.signOut();return}if(e){window.isAdm=!0,window.isPro=!0,localStorage.removeItem("isFreshmartPro"),localStorage.removeItem("freshmart_license_code"),window.updateProBadge&&window.updateProBadge();let t=document.getElementById("view-admin-login");t&&!t.classList.contains("hidden")&&(history.replaceState({view:"view-admin"},"",window.location.href),changeView("view-admin",!0),openAdminMenu(),showToast("Sesi Dipulihkan! Selamat Datang."))}else window.isAdm=!1,window.isPro=!1,window.updateProBadge&&window.updateProBadge(),localStorage.removeItem("isFreshmartPro"),localStorage.removeItem("freshmart_license_code")})});window.el=m;window.show=L;window.hide=$;window.toggleCls=Z;window.setIn=U;window.setH=P;window.setV=se;window.getV=C;window.esc=c;window.fixD=W;window.fCur=x;window.sL=he;window.ssL=ae;window.defaultFbC=da;window.fbC=da;window.defApp=fe;window.ADMIN_UID=ca;window.sLoad=Ei;window.hLoad=_i;window.sanitizeCart=Ri;const H=(e,t,a)=>{try{Object.defineProperty(window,e,{get:t,set:a,configurable:!0})}catch{}};H("GAS_UPLOAD_URL",()=>Ka,e=>{Ka=e});H("confirmCb",()=>rs,e=>{tr(e)});H("appData",()=>n,e=>{ar(e)});H("cart",()=>E,e=>{wt(e)});H("wishlist",()=>ne,e=>{sr(e)});H("myOrders",()=>re,e=>{Bt(e)});H("cust",()=>B,e=>{is(e)});H("currentMember",()=>$e,e=>{Ve(e)});H("selectedReward",()=>Pe,e=>{Me(e)});H("memberCheckTimer",()=>Ja,e=>{rr(e)});H("aCat",()=>Ae,e=>{Ot(e)});H("aBrand",()=>Se,e=>{qt(e)});H("sQ",()=>Xe,e=>{fa(e)});H("cSort",()=>Ze,e=>{ls(e)});H("cView",()=>Dt,e=>{ns(e)});H("cPage",()=>Nt,e=>{Ce(e)});H("iPP",()=>pa,e=>{or(e)});H("cTab",()=>Ya,e=>{ds(e)});H("aSq",()=>Xa,e=>{cs(e)});H("eId",()=>Za,e=>{ir(e)});H("cProd",()=>A,e=>{ps(e)});H("cVar",()=>te,e=>{Ct(e)});H("tVars",()=>es,e=>{lr(e)});H("tWhol",()=>ts,e=>{nr(e)});H("tSpec",()=>as,e=>{dr(e)});H("cQty",()=>Te,e=>{Ut(e)});H("oMods",()=>ge,e=>{cr(e)});H("aOrdLst",()=>Ee,e=>{ct(e)});H("aCustLst",()=>Ie,e=>{lt(e)});H("aRevLst",()=>je,e=>{nt(e)});H("gOrds",()=>le,e=>{ea(e)});H("gReviews",()=>kt,e=>{ms(e)});H("cVOrd",()=>rt,e=>{us(e)});H("vouch",()=>N,e=>{be(e)});H("toastT",()=>os,e=>{mr(e)});H("isSaving",()=>Ue,e=>{ee(e)});H("bannerTmr",()=>ss,e=>{pr(e)});H("reviewFilterMode",()=>ma,e=>{fs(e)});H("lastReportPeriod",()=>ua,e=>{bs(e)});
