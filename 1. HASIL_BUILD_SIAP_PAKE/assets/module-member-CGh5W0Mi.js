...
import{e as l,o as M,g as q,a as f,s as I,c as D,b as k,f as $,d as ae,h as v,i as c,j as T,k as h,l as C,m as u,n as B}from"./module-print-DoqR8CYY.js";import{f as P}from"./vendor-firebase-core-D2OF5R23.js";import"./vendor-firebase-db-BIUZcnOd.js";const oe="modulepreload",ie=function(e){return"/"+e},O={},se=function(t,a,o){let i=Promise.resolve();if(a&&a.length>0){document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),n=r?.nonce||r?.getAttribute("nonce");i=Promise.allSettled(a.map(p=>{if(p=ie(p),p in O)return;O[p]=!0;const m=p.endsWith(".css"),y=m?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${p}"]${y}`))return;const d=document.createElement("link");if(d.rel=m?"stylesheet":oe,m||(d.as="script"),d.crossOrigin="",d.href=p,n&&d.setAttribute("nonce",n),document.head.appendChild(d),m)return new Promise((N,te)=>{d.addEventListener("load",N),d.addEventListener("error",()=>te(new Error(`Unable to preload CSS for ${p}`)))})}))}function s(r){const n=new Event("vite:preloadError",{cancelable:!0});if(n.payload=r,window.dispatchEvent(n),!n.defaultPrevented)throw r}return i.then(r=>{for(const n of r||[])n.status==="rejected"&&s(n.reason);return t().catch(s)})},re={apiKey:"AIzaSyCOjrhMP52TGbiOyQLY92NDYE26N6d9hJM",authDomain:"restu-karya-utama.firebaseapp.com",databaseURL:"https://restu-karya-utama-default-rtdb.asia-southeast1.firebasedatabase.app",projectId:"restu-karya-utama",storageBucket:"restu-karya-utama.firebasestorage.app",messagingSenderId:"858310421352",appId:"1:858310421352:web:e20a833875e8d5c19944dd",measurementId:"G-PHDG2LJ8PM"};try{localStorage.removeItem("freshmart_fb_config")}catch{}const ne=window.FIREBASE_CONFIG||re;P.apps.length||P.initializeApp(ne);const S=P.firestore(),le=P.auth();typeof window<"u"&&(window.firebase=P,window.db=S,window.auth=le);try{S.settings({ignoreUndefinedProperties:!0,experimentalForceLongPolling:!0,merge:!0})}catch{}let de=null;const $e=()=>{se(()=>import("./vendor-firebase-analytics-Jm19L5g2.js"),__vite__mapDeps([0,1])).then(()=>{try{de=P.analytics()}catch{}}).catch(()=>{})},Le="K2ijSERTT2dg27yYGTEgn6XHSnW2";let _={},w="view-catalog",A=!1,E=null,j=["view-catalog"];const U=e=>{history.pushState({modal:e},"",window.location.href),M.push(e)},L=(e,t,a)=>{if(!t){const o=M.lastIndexOf(e);o>-1&&M.splice(o,1),A=!0,E&&clearTimeout(E),E=setTimeout(()=>{A=!1},300);try{history.back()}catch{A=!1}}a()},x=(e,t=!1)=>{if(!e||e===w)return;t||(history.pushState({view:e},"",window.location.href),e==="view-catalog"?j=["view-catalog"]:j.push(e));const a=l(w);if(a){const i=a.querySelector(".scroll-content");i&&(_[w]=i.scrollTop)}w==="view-orders"&&e!=="view-orders"&&typeof window.detachMyOrdersRealtime=="function"&&window.detachMyOrdersRealtime();const o=l(e);if(o&&(o.classList.remove("hidden"),o.classList.add("flex")),document.querySelectorAll(".view-section").forEach(i=>{i!==o&&(i.classList.add("hidden"),i.classList.remove("flex"))}),o){e==="view-cart"&&typeof window.renderCart=="function"?window.renderCart():e==="view-checkout"&&typeof window.rChck=="function"?window.rChck():e==="view-payment"&&typeof window.rPay=="function"?window.rPay():e==="view-wishlist"&&typeof window.renderWish=="function"?window.renderWish():e==="view-orders"&&typeof window.renderMyOrders=="function"?window.renderMyOrders():e==="view-faq"&&typeof window.renderStorefrontFAQ=="function"&&window.renderStorefrontFAQ();const i=o.querySelector(".scroll-content");if(i)if(t){const s=_[e]||0;requestAnimationFrame(()=>requestAnimationFrame(()=>{i.scrollTop=s}))}else i.scrollTo(0,0)}w=e,W(e)},W=(e=w)=>{const t=l("bottom-nav-bar");if(!t)return;if(["view-cart","view-checkout","view-payment","view-admin-login","view-admin"].includes(e)){t.classList.add("bnav-hidden","translate-y-[250%]","opacity-0","pointer-events-none"),t.classList.remove("translate-y-0","opacity-100");return}if(t.classList.remove("bnav-hidden","translate-y-[250%]","opacity-0","pointer-events-none"),t.classList.add("translate-y-0","opacity-100"),document.querySelectorAll(".bnav-item").forEach(o=>o.classList.remove("active")),e==="view-catalog"){const o=l("bnav-home");o&&o.classList.add("active")}else if(e==="view-orders"){const o=l("bnav-orders");o&&o.classList.add("active")}else if(e==="view-wishlist"||e==="view-faq"){const o=l("bnav-menu");o&&o.classList.add("active")}},ce=e=>{if(typeof window.triggerHaptic=="function"&&window.triggerHaptic(e==="home"?"medium":"light"),e==="home")if(w==="view-catalog"){const t=document.querySelector("#view-catalog .scroll-content");t?t.scrollTo({top:0,behavior:"smooth"}):window.scrollTo({top:0,behavior:"smooth"})}else x("view-catalog");else e==="categories"?typeof window.openCategoryModal=="function"&&window.openCategoryModal():e==="cart"?x("view-cart"):e==="orders"?x("view-orders"):e==="menu"&&typeof window.openQuickMenuModal=="function"&&window.openQuickMenuModal()},z=()=>{const e=document.querySelector("#view-catalog .scroll-content"),t=l("pull-to-refresh-indicator"),a=l("ptr-icon"),o=l("ptr-text");if(!e||!t)return;let i=0,s=0,r=!1,n=!1;const p=65;e.addEventListener("touchstart",m=>{e.scrollTop<=5&&!n&&(i=m.touches[0].pageY,r=!0)},{passive:!0}),e.addEventListener("touchmove",m=>{if(!r||n)return;s=m.touches[0].pageY;const y=s-i;if(y>15&&e.scrollTop<=5){t.classList.add("visible");const d=Math.min(y/p,1.5);a&&(a.style.transform=`rotate(${d*240}deg)`),o&&(o.innerText=y>=p?"Lepaskan untuk segarkan":"Tarik ke bawah untuk refresh")}else t.classList.remove("visible")},{passive:!0}),e.addEventListener("touchend",async()=>{if(!r||n)return;if(r=!1,s-i>=p&&e.scrollTop<=5){n=!0,typeof window.triggerHaptic=="function"&&window.triggerHaptic("medium"),a&&(a.className="fa-solid fa-arrows-rotate fa-spin text-[var(--color-primary)]",a.style.transform=""),o&&(o.innerText="Menyinkronkan katalog...");try{typeof window.syncAppMeta=="function"?await window.syncAppMeta():typeof window.loadAppData=="function"&&await window.loadAppData(),typeof window.rCat=="function"&&window.rCat(),typeof window.rDyn=="function"&&window.rDyn(),o&&(o.innerText="Katalog Terkini Disinkron!"),a&&(a.className="fa-solid fa-circle-check text-emerald-500"),typeof window.triggerHaptic=="function"&&window.triggerHaptic("success")}catch{o&&(o.innerText="Gagal sinkron data")}setTimeout(()=>{t.classList.remove("visible"),setTimeout(()=>{n=!1,a&&(a.className="fa-solid fa-arrows-rotate text-[var(--color-primary)] transition-transform duration-300",a.style.transform=""),o&&(o.innerText="Tarik ke bawah untuk refresh")},300)},600)}else t.classList.remove("visible"),a&&(a.style.transform="")})},Q=e=>{e==="product"&&typeof window.closeProductModal=="function"?window.closeProductModal(!0):e==="category"&&typeof window.closeCategoryModal=="function"?window.closeCategoryModal(!0):e==="brand"&&typeof window.closeBrandModal=="function"?window.closeBrandModal(!0):e==="admin"&&typeof window.closeAdminModal=="function"?window.closeAdminModal(!0):e==="adminOrder"&&typeof window.closeOrderDetailModal=="function"?window.closeOrderDetailModal(!0):e==="receipt"&&typeof window.closeReceiptPreviewModal=="function"?window.closeReceiptPreviewModal(!0):e==="docPreview"&&typeof window.closeDocPreviewModal=="function"?window.closeDocPreviewModal(!0):e==="scanner"&&typeof window.closeCameraScanner=="function"?window.closeCameraScanner(!0):e==="confirm"&&typeof window.closeConfirm=="function"?window.closeConfirm(!0):e==="customerOrder"&&typeof window.closeCustomerOrderDetailModal=="function"?window.closeCustomerOrderDetailModal(!0):e==="restock"&&typeof window.closeRestockModal=="function"?window.closeRestockModal(!0):e==="quickprice"&&typeof window.closeQuickPriceModal=="function"?window.closeQuickPriceModal(!0):e==="member"&&typeof window.closeMemberModal=="function"?window.closeMemberModal(!0):e==="prompt"&&typeof window.closePrompt=="function"?window.closePrompt(!0):e==="review"&&typeof window.closeReviewModal=="function"?window.closeReviewModal(!0):e==="quickmenu"&&typeof window.closeQuickMenuModal=="function"?window.closeQuickMenuModal(!0):e==="variantPreview"&&typeof window.closeVariantPreviewModal=="function"?window.closeVariantPreviewModal(!0):e==="terms"&&typeof window.closeTermsModal=="function"?window.closeTermsModal(!0):e==="privacy"&&typeof window.closePrivacyModal=="function"?window.closePrivacyModal(!0):e==="askQuestion"&&typeof window.closeAskQuestionModal=="function"?window.closeAskQuestionModal(!0):e==="quickVariant"&&typeof window.closeQuickVariantSheet=="function"?window.closeQuickVariantSheet(!0):e==="adminFAQ"&&typeof window.closeAdminFAQModal=="function"?window.closeAdminFAQModal(!0):e==="printerSettings"&&typeof window.closePrinterSettingsModal=="function"?window.closePrinterSettingsModal(!0):e==="exitConfirm"&&typeof window.closeExitConfirmModal=="function"?window.closeExitConfirmModal(!0):e==="appDownload"&&typeof window.closeAppDownloadModal=="function"?window.closeAppDownloadModal(!0):e==="voucher"&&typeof window.closeVoucherModal=="function"?window.closeVoucherModal(!0):e==="guide"&&typeof window.closeShoppingGuideModal=="function"?window.closeShoppingGuideModal(!0):e==="changelog"&&typeof window.closeChangelogModal=="function"?window.closeChangelogModal(!0):e==="guarantee"&&typeof window.closeQualityGuaranteeModal=="function"?window.closeQualityGuaranteeModal(!0):e==="security"&&typeof window.closeSecurityModal=="function"&&window.closeSecurityModal(!0)},J=()=>{const e=l("exit-confirm-modal");e&&(e.classList.contains("hidden")&&U("exitConfirm"),e.classList.remove("hidden"),setTimeout(()=>{e.classList.remove("opacity-0");const t=l("exit-confirm-modal-box");t&&t.classList.remove("scale-95")},10),typeof window.triggerHaptic=="function"&&window.triggerHaptic("light"))},K=(e=!1)=>{L("exitConfirm",e,()=>{const t=l("exit-confirm-modal"),a=l("exit-confirm-modal-box");t&&t.classList.add("opacity-0"),a&&a.classList.add("scale-95"),setTimeout(()=>{t&&t.classList.add("hidden")},250)})},pe=()=>{K(!0),window.AndroidNativeApp&&typeof window.AndroidNativeApp.exitApp=="function"?window.AndroidNativeApp.exitApp():navigator.app&&typeof navigator.app.exitApp=="function"?navigator.app.exitApp():(typeof window.showToast=="function"&&window.showToast("Sampai jumpa kembali di Toko Putri! 🙏"),setTimeout(()=>{try{window.close()}catch{}},400))},me=()=>{if(M.length>0){try{window.history.back()}catch{const a=M.pop();Q(a)}return}if(w==="view-admin"){const t=l("admin-content-view"),a=l("admin-dashboard-view");if(!!(t&&!t.classList.contains("hidden")||a&&a.classList.contains("hidden")||window.history.state&&window.history.state.tab||typeof window.cTab<"u"&&window.cTab)){if(window.history.state&&window.history.state.tab&&window.history.length>1)try{window.history.back();return}catch{}typeof window.openAdminMenu=="function"&&window.openAdminMenu();try{window.history.replaceState({view:"view-admin"},"",window.location.href)}catch{}return}typeof window.showConfirm=="function"&&window.showConfirm("Keluar Seller","Apakah anda akan keluar dari dashboard seller?",()=>{typeof window.logoutAdmin=="function"&&window.logoutAdmin()},"Ya, Keluar",!0);return}if(w!=="view-catalog"){if(window.history.length>1)window.history.back();else{let t="view-catalog";w==="view-payment"?t="view-checkout":w==="view-checkout"&&(t="view-cart"),x(t)}return}const e=l("exit-confirm-modal");e&&!e.classList.contains("hidden")?K():J()},fe=()=>{z();try{(!history.state||!history.state.view)&&history.replaceState({view:"view-catalog"},"",window.location.href)}catch{}window.addEventListener("popstate",e=>{if(A){A=!1,E&&clearTimeout(E);return}if(M.length>0){const i=M.pop();Q(i);return}const t=e.state||{},a=t.view||null;if(window.isAdm||window.__localIsAdm)if(a==="view-admin")x("view-admin",!0),t.tab&&typeof window.openAdminTab=="function"?window.openAdminTab(t.tab,!0):typeof window.openAdminMenu=="function"&&window.openAdminMenu();else{const i=l("admin-content-view");if(i&&!i.classList.contains("hidden")){history.pushState({view:"view-admin"},"",window.location.href),x("view-admin",!0),typeof window.openAdminMenu=="function"&&window.openAdminMenu();return}history.pushState({view:"view-admin"},"",window.location.href),typeof window.showConfirm=="function"&&window.showConfirm("Keluar Seller","Apakah anda akan keluar dari dashboard seller?",()=>{typeof window.logoutAdmin=="function"&&window.logoutAdmin()},"Ya, Keluar",!0)}else if(a){let i=a;a==="view-admin"&&(i="view-admin-login"),x(i,!0)}else x("view-catalog",!0)})};window.pushModalHistory=U;window.requestCloseModal=L;window.changeView=x;window.setupHistoryRouter=fe;window.onBottomNavClick=ce;window.updateBottomNav=W;window.initPullToRefresh=z;window.handleAppBackButton=me;window.openExitConfirmModal=J;window.closeExitConfirmModal=K;window.confirmExitApp=pe;window.isProgrammaticModalClose=A;window.viewHistoryStack=j;try{Object.defineProperty(window,"curViewName",{get:()=>w,set:e=>{w=e},configurable:!0})}catch{}const Y=()=>{l("voucher-input");const e=(q("voucher-input")||"").toUpperCase().trim(),t=(f.vouchers||[]).find(i=>(i.code||"").toUpperCase()===e);I("voucher-msg-container");const a=typeof window.getEffP=="function"?window.getEffP:i=>i.effectivePrice||i.price||0,o=D.reduce((i,s)=>i+(parseFloat(a(s))||0)*(parseFloat(s.qty)||0),0);if(t){let i=!0;t.targetProduct&&t.targetProduct!==""&&(i=D.some(s=>s&&String(s.id)===String(t.targetProduct))),t.targetProduct&&t.targetProduct!==""&&!i?(T(null),k("voucher-msg",'<i class="fa-solid fa-box mr-1"></i> Khusus Produk Tertentu!'),l("voucher-msg")&&(l("voucher-msg").className="text-sm font-bold text-rose-500 dark:text-rose-400")):t.minPurchase&&parseFloat(t.minPurchase)>0&&o<parseFloat(t.minPurchase)?(T(null),k("voucher-msg",`<i class="fa-solid fa-circle-exclamation mr-1"></i> Minimal belanja ${$(t.minPurchase)}`),l("voucher-msg")&&(l("voucher-msg").className="text-sm font-bold text-amber-500 dark:text-amber-400")):t.type&&t.type.includes("shipping")&&ae.deliveryMethod!=="delivery"?(T(null),k("voucher-msg",'<i class="fa-solid fa-motorcycle mr-1"></i> Khusus pesanan dikirim kurir!'),l("voucher-msg")&&(l("voucher-msg").className="text-sm font-bold text-rose-500 dark:text-rose-400")):(T(t),k("voucher-msg",'<i class="fa-solid fa-check-circle mr-1"></i> Voucher Diterapkan!'),l("voucher-msg")&&(l("voucher-msg").className="text-sm font-bold text-[var(--color-primary)]"))}else e===""?(T(null),v("voucher-msg-container"),typeof window.rPay=="function"&&window.rPay()):(T(null),k("voucher-msg",'<i class="fa-solid fa-times-circle mr-1"></i> Kode Tidak Valid'),l("voucher-msg")&&(l("voucher-msg").className="text-sm font-bold text-rose-500 dark:text-rose-400"));typeof window.rPay=="function"&&window.rPay()},ue=()=>{let e=document.getElementById("voucher-modal");e||(e=document.createElement("div"),e.id="voucher-modal",e.className="fixed inset-0 z-[115] bg-slate-900/80 flex items-end sm:items-center justify-center p-0 sm:p-5",e.onclick=o=>{o.target===e&&H()},document.body.appendChild(e));const t=(f.vouchers||[]).filter(o=>o.isShow!==!1&&o.isShow!=="false"),a=t.length?t.map(o=>{let i="";o.type==="percent"?i=`Diskon ${o.value}%`:o.type==="shipping_free"?i="Gratis Ongkir":o.type==="shipping_flat"?i=`Diskon Ongkir ${$(o.value)}`:i=`Potongan ${$(o.value)}`;const s=o.minPurchase&&parseFloat(o.minPurchase)>0?`Min. belanja ${$(o.minPurchase)}`:"Tanpa minimal belanja";return`
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 p-4 rounded-2xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/80 hover:border-[var(--color-primary)] transition-all shadow-xs">
            <div class="flex items-start gap-3.5 min-w-0">
                ...
                <div class="min-w-0">
                    ...
                    <p class="text-[11px] font-medium text-slate-500 dark:text-slate-400 flex items-center gap-1.5"><i class="fa-solid fa-circle-check text-[var(--color-primary)] text-xs"></i> ${s}</p>
                </div>
            </div>
    ...
    <svg class="w-full h-11 bg-white rounded-lg px-2 py-1 shadow-inner border border-slate-200" viewBox="0 0 ${Math.max(o+10,240)} 40" xmlns="http://www.w3.org/2000/svg">
        ${a}
    </svg>`},F=e=>{const t=parseFloat(e?.points)||0,a=R(t),o=(f.store?.name||"Toko Putri").toUpperCase(),i=f.store?.logo&&f.store.logo!=="fa-store"?f.store.logo:xe,s=(e?.name||"PELANGGAN SETIA").toUpperCase(),r=(e?.phone||"81234567890").toString().replace(/\D/g,""),n=Z(r),p=f.store?.wa||r;return`
                ...
                <div class="relative z-10">
                    ...
                    <div class="flex items-end justify-between gap-2">
                        <div class="min-w-0 flex-1">
                            ...
                            <p class="text-[11px] sm:text-[13px] font-bold text-white tracking-wider truncate uppercase">${c(s)}</p>
                        </div>
                ...
                <div class="px-4 sm:px-5 py-1">
                    <div class="flex items-center gap-2">
                        <div class="flex-1 h-6 bg-white/90 rounded border border-slate-300 px-2 flex items-center justify-between">
                            <span class="text-[9px] font-mono font-bold text-slate-500 italic truncate">${c(s)}</span>
                    ...
                    <div class="mt-2 text-center">
                        ...
                        ${X(r)}
                        <p class="text-[9px] font-mono font-bold tracking-[0.2em] text-slate-300 mt-1">*${c(r)}*</p>
                    </div>
                </div>
    ...
    </div>`},ye=()=>{const e=document.getElementById("member-card-inner");e&&e.classList.toggle("is-flipped")},ve=async()=>{const e=document.getElementById("member-card-inner");e&&e.classList.contains("is-flipped")&&(e.classList.remove("is-flipped"),await new Promise(a=>setTimeout(a,450)));const t=document.getElementById("member-card-front-export");if(t){typeof window.showToast=="function"&&window.showToast("Menyiapkan file gambar Kartu Member HD...");try{if(typeof window.ensureScriptLoaded=="function"&&await window.ensureScriptLoaded("https://cdnjs.cloudflare.com/ajax/libs/html2canvas/1.4.1/html2canvas.min.js",()=>typeof html2canvas<"u"),typeof html2canvas>"u")throw new Error("Modul html2canvas belum siap dimuat.");const a=await html2canvas(t,{scale:3,useCORS:!0,allowTaint:!0,backgroundColor:null}),i=`Kartu_Member_TokoPutri_${(u?.name||"Pelanggan").replace(/[^a-zA-Z0-9]/g,"_")}.png`,s=a.toDataURL("image/png",1);if(window.AndroidNativeApp&&typeof window.AndroidNativeApp.saveOrShareFile=="function")window.AndroidNativeApp.saveOrShareFile(s,i,"image/png");else{const r=document.createElement("a");r.download=i,r.href=s,document.body.appendChild(r),r.click(),document.body.removeChild(r)}typeof window.showToast=="function"&&window.showToast("Kartu Member Berhasil Disimpan ke Galeri! 🎉")}catch(a){console.error("Gagal menyimpan kartu member:",a),typeof window.showToast=="function"&&window.showToast("Gagal menyimpan kartu. Silakan coba kembali.")}}},ke=()=>{const e=l("reward-catalog-container");if(!e)return;const t=f.store.showRewardCatalog!==!1&&f.store.showRewardCatalog!=="false";t&&typeof window.attachRewardsRealtime=="function"&&!window.unsubRewardsRealtime&&window.attachRewardsRealtime();const a=(f.rewards||[]).filter(i=>i.isActive!=="false"&&i.isActive!==!1);if(!t||a.length===0){e.classList.add("hidden"),e.innerHTML="";return}e.classList.remove("hidden");let o=`
    ...
    <div class="flex gap-2.5 sm:gap-3 overflow-x-auto hide-scrollbar snap-x pb-3 pt-1">
        ${a.map(i=>`
            <div class="w-[115px] sm:w-[130px] shrink-0 snap-start relative group cursor-pointer active:scale-95 transition-all duration-200" onclick="if(typeof window.openMemberModal==='function') window.openMemberModal(); else if(typeof window.showToast==='function') window.showToast('Tukarkan hadiah ini saat checkout menggunakan poin belanja Anda!');">
    ...
    </div>`;e.innerHTML=o};let G=null;const Me=()=>{clearTimeout(G),G=setTimeout(async()=>{const t=(window.normalizeWA||(s=>(s||"").replace(/\D/g,"").replace(/^0/,"62")))(q("cust-wa")),a=l("member-status-banner");if(!a)return;if(!t||t.length<10){v(a),v("payment-option-tempo"),h(null),C(null);const s=document.querySelector('input[name="payment"][value="tempo"]');if(s&&s.checked){const r=document.querySelector('input[name="payment"][value="transfer"]')||document.querySelector('input[name="payment"][value="cashier"]');r&&(r.checked=!0,typeof window.togglePaymentDetails=="function"&&window.togglePaymentDetails())}return}const o=s=>{const r=parseFloat(s.points)||0,n=R(r);a.className="mt-3 p-3 sm:p-4 rounded-2xl bg-gradient-to-r from-slate-950 via-slate-900 to-slate-950 text-white border border-amber-400/40 shadow-xl relative overflow-hidden flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3",a.innerHTML=`
                ...
                <div class="flex items-center gap-3 relative z-10 min-w-0">
                    ...
                    <div class="min-w-0">
                        <div class="flex items-center gap-2 flex-wrap">
                            ...
                            <span class="text-[10px] font-bold text-amber-300 flex items-center gap-1"><i class="fa-solid fa-star text-[9px]"></i>${r} Poin</span>
                        </div>
                        <p class="text-xs font-bold text-white mt-0.5 truncate flex items-center gap-1.5">
                            <span>${c(s.name||"Pelanggan")}</span>
                ...
                </button>`,I(a),I("payment-option-tempo")},i=b.get(t);if(i&&Date.now()-i.timestamp<he){if(i.data)h(i.data),o(i.data);else{h(null),C(null),v(a),v("payment-option-tempo");const s=document.querySelector('input[name="payment"][value="tempo"]');if(s&&s.checked){const r=document.querySelector('input[name="payment"][value="transfer"]')||document.querySelector('input[name="payment"][value="cashier"]');r&&(r.checked=!0,typeof window.togglePaymentDetails=="function"&&window.togglePaymentDetails())}}return}try{const s=await S.collection("freshmart").doc("cms_data").collection("customers").doc(t).get();if(s.exists){const r=s.data();b.set(t,{data:r,timestamp:Date.now()}),h(r),o(r)}else{b.set(t,{data:null,timestamp:Date.now()}),h(null),C(null),v(a),v("payment-option-tempo");const r=document.querySelector('input[name="payment"][value="tempo"]');if(r&&r.checked){const n=document.querySelector('input[name="payment"][value="transfer"]')||document.querySelector('input[name="payment"][value="cashier"]');n&&(n.checked=!0,typeof window.togglePaymentDetails=="function"&&window.togglePaymentDetails())}}}catch{}},500)},Te=()=>{if(!u)try{const o=localStorage.getItem("freshmart_current_member");if(o){const i=JSON.parse(o);i&&(i.id||i.phone||i.name)&&h(i)}}catch{}const e=u?.phone||u?.id||localStorage.getItem("freshmart_member_wa");if(e){let o=e.toString().replace(/\D/g,"");o.startsWith("0")?o="62"+o.substring(1):o.startsWith("62")||(o="62"+o),S.collection("freshmart").doc("cms_data").collection("customers").doc(o).get().then(async i=>{if(i.exists){let s=i.data();if((parseFloat(s.points)||0)===0){const n=await V(o,s.name);n&&(s=n)}b.set(o,{data:s,timestamp:Date.now()}),h(s);try{localStorage.setItem("freshmart_current_member",JSON.stringify(s)),localStorage.setItem("freshmart_member_wa",o)}catch{}document.getElementById("member-modal-body")&&g()}else{b.set(o,{data:null,timestamp:Date.now()}),h(null);try{localStorage.removeItem("freshmart_current_member"),localStorage.removeItem("freshmart_member_wa")}catch{}document.getElementById("member-modal-body")&&g()}}).catch(()=>{})}typeof window.attachRewardsRealtime=="function"&&!window.unsubRewardsRealtime&&window.attachRewardsRealtime();let t=document.getElementById("member-modal");t||(t=document.createElement("div"),t.id="member-modal",t.className="fixed inset-0 z-[115] bg-slate-900/60 flex items-end sm:items-center justify-center p-0 sm:p-5 backdrop-blur-xs",t.onclick=o=>{o.target===t&&ee()},document.body.appendChild(t));const a=t.style.display!=="none"&&t.style.opacity==="1";t.innerHTML=`
        ...
        </div>`,g(),t.style.opacity="0",t.style.display="flex",requestAnimationFrame(()=>{t.style.transition="opacity 0.25s ease",t.style.opacity="1"}),!a&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("member")},g=()=>{const e=(f.rewards||[]).filter(i=>i.isActive!=="false"&&i.isActive!==!1),t=u&&parseFloat(u.points)||0,a=R(t),o=e.length?e.map(i=>{const s=(parseFloat(i.stock)||0)>0,r=u&&t>=(parseFloat(i.pointsCost)||0)&&s,n=B&&B.id===i.id;return`
        <div class="flex items-center gap-3 p-3.5 rounded-2xl border ${n?"border-[var(--color-primary)] bg-[rgba(var(--color-primary-rgb),0.06)] dark:bg-[rgba(var(--color-primary-rgb),0.12)] shadow-xs":"border-slate-200 dark:border-slate-700/80 bg-slate-50/70 dark:bg-slate-800/40"} transition-all">
            ...
            <div class="min-w-0 flex-1">
                ...
                ${s?"":'<p class="text-[10px] font-bold text-rose-500 mt-0.5">Stok hadiah habis</p>'}
            </div>
            ${u?n?'<button type="button" onclick="deselectReward()" class="shrink-0 bg-rose-500 hover:bg-rose-600 text-white text-[10px] font-bold uppercase px-3 py-2 rounded-xl active:scale-95 transition-all whitespace-nowrap shadow-xs">Batal</button>':`<button type="button" ${r?"":"disabled"} onclick="selectReward(${i.id})" class="shrink-0 ${r?"primary-bg hover:opacity-90 text-white active:scale-95 shadow-xs":"bg-slate-200 dark:bg-slate-700 text-slate-400 cursor-not-allowed"} text-[10px] font-bold uppercase px-3 py-2 rounded-xl transition-all whitespace-nowrap">Pilih Hadiah</button>`:`<span class="text-[10px] font-bold text-slate-400 uppercase bg-slate-100 dark:bg-slate-800 px-2.5 py-1.5 rounded-lg">${parseFloat(i.pointsCost)||0} Poin</span>`}
        </div>`}).join(""):'<p class="text-[11px] font-bold text-slate-400 text-center py-3">Belum ada program hadiah yang tersedia.</p>';u?k("member-modal-body",`
            ...
            ${B?`<div class="bg-[rgba(var(--color-primary-rgb),0.06)] dark:bg-[rgba(var(--color-primary-rgb),0.12)] border border-[var(--color-primary)]/30 rounded-xl p-3.5 text-[11px] font-bold text-[var(--color-primary)] flex items-center gap-2"><i class="fa-solid fa-gift text-base shrink-0"></i><span>Hadiah "<b>${c(B.name)}</b>" telah dipilih dan akan otomatis diproses saat pesanan Anda selesai di checkout.</span></div>`:""}
        `):k("member-modal-body",`
        ...
        `)},Ae=async()=>{const e=document.getElementById("member-lookup-input"),t=document.getElementById("member-lookup-result");if(!e||!t)return;let a=e.value.replace(/\D/g,"");if(!a||a.length<9){t.className="text-xs font-bold text-rose-500 p-2.5 bg-rose-50 dark:bg-rose-900/20 rounded-xl",t.textContent="Masukkan minimal 9 digit nomor WhatsApp!",t.classList.remove("hidden");return}a.startsWith("0")?a="62"+a.substring(1):a.startsWith("62")||(a="62"+a),t.className="text-xs font-bold text-[var(--color-primary)] p-2.5 primary-bg-soft rounded-xl",t.textContent="Memuat data kartu member...",t.classList.remove("hidden");try{const o=await S.collection("freshmart").doc("cms_data").collection("customers").doc(a).get();if(o.exists){let i=o.data();if((parseFloat(i.points)||0)===0){const s=await V(a,i.name);s&&(i=s)}b.set(a,{data:i,timestamp:Date.now()}),h(i);try{localStorage.setItem("freshmart_current_member",JSON.stringify(i)),localStorage.setItem("freshmart_member_wa",a)}catch{}g(),typeof window.showToast=="function"&&window.showToast(`Selamat datang kembali, ${i.name||"Pelanggan"}! 💳`)}else{t.className="text-xs font-bold text-amber-700 dark:text-amber-300 p-3.5 bg-amber-50 dark:bg-amber-900/20 rounded-xl leading-relaxed border border-amber-200 dark:border-amber-800/40 space-y-1.5";const i=(f.store&&f.store.wa||"").replace(/\D/g,""),s=i?`https://wa.me/${i}?text=Halo%20Admin%20Toko%20Putri,%20saya%20ingin%20mendaftarkan%20nomor%20saya%20(${a})%20sebagai%20Member%20Resmi.`:"#";t.innerHTML=`
                ...
                ${i?`
                <div class="pt-1">
                    <a href="${s}" target="_blank" class="inline-flex items-center gap-1.5 text-[10px] font-bold text-emerald-600 dark:text-emerald-400 hover:underline">
                        <i class="fa-brands fa-whatsapp text-emerald-500"></i> Hubungi Admin untuk Pendaftaran Member
                    </a>
                </div>`:""}
            `}}catch{t.className="text-xs font-bold text-rose-500 p-2.5 bg-rose-50 dark:bg-rose-900/20 rounded-xl",t.textContent="Gagal mengecek data. Silakan periksa koneksi internet Anda."}},Pe=e=>{const t=(f.rewards||[]).find(o=>o.id===e);if(!t)return;if((parseFloat(u?.points)||0)<(parseFloat(t.pointsCost)||0)){typeof window.showToast=="function"&&window.showToast("Poin Anda belum cukup untuk hadiah ini!");return}if((parseFloat(t.stock)||0)<=0){typeof window.showToast=="function"&&window.showToast("Maaf, stok hadiah ini sedang kosong!");return}C({id:t.id,name:t.name,pointsCost:parseFloat(t.pointsCost)||0}),g(),typeof window.showToast=="function"&&window.showToast(`Hadiah "${t.name}" dipilih! Lanjutkan checkout untuk menukarnya.`)},Se=()=>{C(null),g()},ee=(e=!1)=>{const t=document.getElementById("member-modal");if(!t||t.style.display==="none")return;const a=()=>{t.style.opacity="0",t.style.transition="opacity 0.25s ease",setTimeout(()=>{t.style.display="none",t.style.opacity="",t.style.transition=""},250)};typeof window.requestCloseModal=="function"?window.requestCloseModal("member",e,a):a()};window.renderRewardCatalog=ke;window.checkMemberStatus=Me;window.openMemberModal=Te;window.rMemberModalBody=g;window.lookupMemberPoints=Ae;window.selectReward=Pe;window.deselectReward=Se;window.closeMemberModal=ee;window.flipMemberCard=ye;window.downloadMemberCard=ve;window.getMemberTier=R;window.formatMemberCardNumber=Z;window.generateBarcodeSVG=X;window.setCurrentMember=h;window.invalidateMemberCache=ge;window.reconcilePointsFromOrders=V;export{Le as A,se as _,le as a,x as b,w as c,S as d,ne as f,$e as l,U as p,L as r,fe as s};
