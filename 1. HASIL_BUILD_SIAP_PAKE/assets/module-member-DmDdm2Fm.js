...
import{e as l,o as M,g as q,a as u,s as I,c as D,b as k,f as B,d as oe,h as v,i as c,j as T,k as h,l as C,m as w,n as L}from"./module-print-DoqR8CYY.js";import{f as S}from"./vendor-firebase-core-D2OF5R23.js";import"./vendor-firebase-db-BIUZcnOd.js";const ie="modulepreload",se=function(e){return"/"+e},H={},U=function(t,a,o){let i=Promise.resolve();if(a&&a.length>0){document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),n=r?.nonce||r?.getAttribute("nonce");i=Promise.allSettled(a.map(p=>{if(p=se(p),p in H)return;H[p]=!0;const f=p.endsWith(".css"),y=f?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${p}"]${y}`))return;const d=document.createElement("link");if(d.rel=f?"stylesheet":ie,f||(d.as="script"),d.crossOrigin="",d.href=p,n&&d.setAttribute("nonce",n),document.head.appendChild(d),f)return new Promise((N,ae)=>{d.addEventListener("load",N),d.addEventListener("error",()=>ae(new Error(`Unable to preload CSS for ${p}`)))})}))}function s(r){const n=new Event("vite:preloadError",{cancelable:!0});if(n.payload=r,window.dispatchEvent(n),!n.defaultPrevented)throw r}return i.then(r=>{for(const n of r||[])n.status==="rejected"&&s(n.reason);return t().catch(s)})},re={apiKey:"AIzaSyCOjrhMP52TGbiOyQLY92NDYE26N6d9hJM",authDomain:"restu-karya-utama.firebaseapp.com",databaseURL:"https://restu-karya-utama-default-rtdb.asia-southeast1.firebasedatabase.app",projectId:"restu-karya-utama",storageBucket:"restu-karya-utama.firebasestorage.app",messagingSenderId:"858310421352",appId:"1:858310421352:web:e20a833875e8d5c19944dd",measurementId:"G-PHDG2LJ8PM"};try{localStorage.removeItem("freshmart_fb_config")}catch{}const ne=window.FIREBASE_CONFIG||re;S.apps.length||S.initializeApp(ne);const A=S.firestore(),le=S.auth();typeof window<"u"&&(window.firebase=S,window.db=A,window.auth=le);try{A.settings({ignoreUndefinedProperties:!0,experimentalForceLongPolling:!0,merge:!0})}catch{}let de=null;const Be=()=>{U(()=>import("./vendor-firebase-analytics-Jm19L5g2.js"),__vite__mapDeps([0,1])).then(()=>{try{de=S.analytics()}catch{}}).catch(()=>{})},$e="K2ijSERTT2dg27yYGTEgn6XHSnW2";let _={},m="view-catalog",P=!1,E=null,K=["view-catalog"];const W=e=>{history.pushState({modal:e},"",window.location.href),M.push(e)},$=(e,t,a)=>{if(!t){const o=M.lastIndexOf(e);o>-1&&M.splice(o,1),P=!0,E&&clearTimeout(E),E=setTimeout(()=>{P=!1},300);try{history.back()}catch{P=!1}}a()},x=(e,t=!1)=>{if(!e||e===m)return;t||(history.pushState({view:e},"",window.location.href),e==="view-catalog"?K=["view-catalog"]:K.push(e));const a=l(m);if(a){const i=a.querySelector(".scroll-content");i&&(_[m]=i.scrollTop)}m==="view-orders"&&e!=="view-orders"&&typeof window.detachMyOrdersRealtime=="function"&&window.detachMyOrdersRealtime(),m==="view-pos-cashier"&&e!=="view-pos-cashier"&&typeof window.destroyBarcodeListener=="function"&&window.destroyBarcodeListener();const o=l(e);if(o&&(o.classList.remove("hidden"),o.classList.add("flex")),document.querySelectorAll(".view-section").forEach(i=>{i!==o&&(i.classList.add("hidden"),i.classList.remove("flex"))}),o){e==="view-cart"&&typeof window.renderCart=="function"?window.renderCart():e==="view-checkout"&&typeof window.rChck=="function"?window.rChck():e==="view-payment"&&typeof window.rPay=="function"?window.rPay():e==="view-wishlist"&&typeof window.renderWish=="function"?window.renderWish():e==="view-orders"&&typeof window.renderMyOrders=="function"?window.renderMyOrders():e==="view-faq"&&typeof window.renderStorefrontFAQ=="function"?window.renderStorefrontFAQ():e==="view-pos-cashier"&&U(()=>import("./module-pos-rMZ0HYPq.js"),__vite__mapDeps([2,3,1,4])).then(s=>{typeof s.renderPOSStorefront=="function"&&s.renderPOSStorefront()}).catch(s=>console.error("[POS] Gagal memuat storefront:",s));const i=o.querySelector(".scroll-content");if(i)if(t){const s=_[e]||0;requestAnimationFrame(()=>requestAnimationFrame(()=>{i.scrollTop=s}))}else i.scrollTo(0,0)}m=e,z(e)},z=(e=m)=>{const t=l("bottom-nav-bar");if(!t)return;if(["view-cart","view-checkout","view-payment","view-admin-login","view-admin","view-pos-cashier"].includes(e)){t.classList.add("bnav-hidden","translate-y-[250%]","opacity-0","pointer-events-none"),t.classList.remove("translate-y-0","opacity-100");return}if(t.classList.remove("bnav-hidden","translate-y-[250%]","opacity-0","pointer-events-none"),t.classList.add("translate-y-0","opacity-100"),document.querySelectorAll(".bnav-item").forEach(o=>o.classList.remove("active")),e==="view-catalog"){const o=l("bnav-home");o&&o.classList.add("active")}else if(e==="view-orders"){const o=l("bnav-orders");o&&o.classList.add("active")}else if(e==="view-wishlist"||e==="view-faq"){const o=l("bnav-menu");o&&o.classList.add("active")}},ce=e=>{if(typeof window.triggerHaptic=="function"&&window.triggerHaptic(e==="home"?"medium":"light"),e==="home")if(m==="view-catalog"){const t=document.querySelector("#view-catalog .scroll-content");t?t.scrollTo({top:0,behavior:"smooth"}):window.scrollTo({top:0,behavior:"smooth"})}else x("view-catalog");else e==="categories"?typeof window.openCategoryModal=="function"&&window.openCategoryModal():e==="cart"?x("view-cart"):e==="orders"?x("view-orders"):e==="menu"&&typeof window.openQuickMenuModal=="function"&&window.openQuickMenuModal()},Q=()=>{const e=document.querySelector("#view-catalog .scroll-content"),t=l("pull-to-refresh-indicator"),a=l("ptr-icon"),o=l("ptr-text");if(!e||!t)return;let i=0,s=0,r=!1,n=!1;const p=65;e.addEventListener("touchstart",f=>{e.scrollTop<=5&&!n&&(i=f.touches[0].pageY,r=!0)},{passive:!0}),e.addEventListener("touchmove",f=>{if(!r||n)return;s=f.touches[0].pageY;const y=s-i;if(y>15&&e.scrollTop<=5){t.classList.add("visible");const d=Math.min(y/p,1.5);a&&(a.style.transform=`rotate(${d*240}deg)`),o&&(o.innerText=y>=p?"Lepaskan untuk segarkan":"Tarik ke bawah untuk refresh")}else t.classList.remove("visible")},{passive:!0}),e.addEventListener("touchend",async()=>{if(!r||n)return;if(r=!1,s-i>=p&&e.scrollTop<=5){n=!0,typeof window.triggerHaptic=="function"&&window.triggerHaptic("medium"),a&&(a.className="fa-solid fa-arrows-rotate fa-spin text-[var(--color-primary)]",a.style.transform=""),o&&(o.innerText="Menyinkronkan katalog...");try{typeof window.syncAppMeta=="function"?await window.syncAppMeta():typeof window.loadAppData=="function"&&await window.loadAppData(),typeof window.rCat=="function"&&window.rCat(),typeof window.rDyn=="function"&&window.rDyn(),o&&(o.innerText="Katalog Terkini Disinkron!"),a&&(a.className="fa-solid fa-circle-check text-emerald-500"),typeof window.triggerHaptic=="function"&&window.triggerHaptic("success")}catch{o&&(o.innerText="Gagal sinkron data")}setTimeout(()=>{t.classList.remove("visible"),setTimeout(()=>{n=!1,a&&(a.className="fa-solid fa-arrows-rotate text-[var(--color-primary)] transition-transform duration-300",a.style.transform=""),o&&(o.innerText="Tarik ke bawah untuk refresh")},300)},600)}else t.classList.remove("visible"),a&&(a.style.transform="")})},Y=e=>{e==="product"&&typeof window.closeProductModal=="function"?window.closeProductModal(!0):e==="category"&&typeof window.closeCategoryModal=="function"?window.closeCategoryModal(!0):e==="brand"&&typeof window.closeBrandModal=="function"?window.closeBrandModal(!0):e==="admin"&&typeof window.closeAdminModal=="function"?window.closeAdminModal(!0):e==="adminOrder"&&typeof window.closeOrderDetailModal=="function"?window.closeOrderDetailModal(!0):e==="receipt"&&typeof window.closeReceiptPreviewModal=="function"?window.closeReceiptPreviewModal(!0):e==="docPreview"&&typeof window.closeDocPreviewModal=="function"?window.closeDocPreviewModal(!0):e==="scanner"&&typeof window.closeCameraScanner=="function"?window.closeCameraScanner(!0):e==="confirm"&&typeof window.closeConfirm=="function"?window.closeConfirm(!0):e==="customerOrder"&&typeof window.closeCustomerOrderDetailModal=="function"?window.closeCustomerOrderDetailModal(!0):e==="restock"&&typeof window.closeRestockModal=="function"?window.closeRestockModal(!0):e==="quickprice"&&typeof window.closeQuickPriceModal=="function"?window.closeQuickPriceModal(!0):e==="member"&&typeof window.closeMemberModal=="function"?window.closeMemberModal(!0):e==="prompt"&&typeof window.closePrompt=="function"?window.closePrompt(!0):e==="review"&&typeof window.closeReviewModal=="function"?window.closeReviewModal(!0):e==="quickmenu"&&typeof window.closeQuickMenuModal=="function"?window.closeQuickMenuModal(!0):e==="variantPreview"&&typeof window.closeVariantPreviewModal=="function"?window.closeVariantPreviewModal(!0):e==="terms"&&typeof window.closeTermsModal=="function"?window.closeTermsModal(!0):e==="privacy"&&typeof window.closePrivacyModal=="function"?window.closePrivacyModal(!0):e==="askQuestion"&&typeof window.closeAskQuestionModal=="function"?window.closeAskQuestionModal(!0):e==="quickVariant"&&typeof window.closeQuickVariantSheet=="function"?window.closeQuickVariantSheet(!0):e==="adminFAQ"&&typeof window.closeAdminFAQModal=="function"?window.closeAdminFAQModal(!0):e==="printerSettings"&&typeof window.closePrinterSettingsModal=="function"?window.closePrinterSettingsModal(!0):e==="exitConfirm"&&typeof window.closeExitConfirmModal=="function"?window.closeExitConfirmModal(!0):e==="appDownload"&&typeof window.closeAppDownloadModal=="function"?window.closeAppDownloadModal(!0):e==="voucher"&&typeof window.closeVoucherModal=="function"?window.closeVoucherModal(!0):e==="guide"&&typeof window.closeShoppingGuideModal=="function"?window.closeShoppingGuideModal(!0):e==="changelog"&&typeof window.closeChangelogModal=="function"?window.closeChangelogModal(!0):e==="guarantee"&&typeof window.closeQualityGuaranteeModal=="function"?window.closeQualityGuaranteeModal(!0):e==="security"&&typeof window.closeSecurityModal=="function"?window.closeSecurityModal(!0):e==="posVariantSheet"&&typeof window.closePOSVariantSheet=="function"?window.closePOSVariantSheet(!0):e==="posLogin"&&typeof window.closePOSLoginModal=="function"&&window.closePOSLoginModal(!0)},J=()=>{const e=l("exit-confirm-modal");e&&(e.classList.contains("hidden")&&W("exitConfirm"),e.classList.remove("hidden"),setTimeout(()=>{e.classList.remove("opacity-0");const t=l("exit-confirm-modal-box");t&&t.classList.remove("scale-95")},10),typeof window.triggerHaptic=="function"&&window.triggerHaptic("light"))},j=(e=!1)=>{$("exitConfirm",e,()=>{const t=l("exit-confirm-modal"),a=l("exit-confirm-modal-box");t&&t.classList.add("opacity-0"),a&&a.classList.add("scale-95"),setTimeout(()=>{t&&t.classList.add("hidden")},250)})},pe=()=>{j(!0),window.AndroidNativeApp&&typeof window.AndroidNativeApp.exitApp=="function"?window.AndroidNativeApp.exitApp():navigator.app&&typeof navigator.app.exitApp=="function"?navigator.app.exitApp():(typeof window.showToast=="function"&&window.showToast("Sampai jumpa kembali di Toko Putri! 🙏"),setTimeout(()=>{try{window.close()}catch{}},400))},fe=()=>{if(M.length>0){try{window.history.back()}catch{const a=M.pop();Y(a)}return}if(m==="view-admin"){const t=l("admin-content-view"),a=l("admin-dashboard-view");if(!!(t&&!t.classList.contains("hidden")||a&&a.classList.contains("hidden")||window.history.state&&window.history.state.tab||typeof window.cTab<"u"&&window.cTab)){if(window.history.state&&window.history.state.tab&&window.history.length>1)try{window.history.back();return}catch{}typeof window.openAdminMenu=="function"&&window.openAdminMenu();try{window.history.replaceState({view:"view-admin"},"",window.location.href)}catch{}return}typeof window.showConfirm=="function"&&window.showConfirm("Keluar Seller","Apakah anda akan keluar dari dashboard seller?",()=>{typeof window.logoutAdmin=="function"&&window.logoutAdmin()},"Ya, Keluar",!0);return}if(m==="view-pos-cashier"){typeof window.showConfirm=="function"?window.showConfirm("Keluar Mode Kasir","Yakin keluar dari mode POS kasir?",()=>{typeof window.exitPOSMode=="function"?window.exitPOSMode():x("view-catalog")},"Ya, Keluar",!0):x("view-catalog");return}if(m!=="view-catalog"){if(window.history.length>1)window.history.back();else{let t="view-catalog";m==="view-payment"?t="view-checkout":m==="view-checkout"&&(t="view-cart"),x(t)}return}const e=l("exit-confirm-modal");e&&!e.classList.contains("hidden")?j():J()},me=()=>{Q();try{(!history.state||!history.state.view)&&history.replaceState({view:"view-catalog"},"",window.location.href)}catch{}window.addEventListener("popstate",e=>{if(P){P=!1,E&&clearTimeout(E);return}if(M.length>0){const i=M.pop();Y(i);return}const t=e.state||{},a=t.view||null;if(window.isAdm||window.__localIsAdm)if(a==="view-admin")x("view-admin",!0),t.tab&&typeof window.openAdminTab=="function"?window.openAdminTab(t.tab,!0):typeof window.openAdminMenu=="function"&&window.openAdminMenu();else{const i=l("admin-content-view");if(i&&!i.classList.contains("hidden")){history.pushState({view:"view-admin"},"",window.location.href),x("view-admin",!0),typeof window.openAdminMenu=="function"&&window.openAdminMenu();return}history.pushState({view:"view-admin"},"",window.location.href),typeof window.showConfirm=="function"&&window.showConfirm("Keluar Seller","Apakah anda akan keluar dari dashboard seller?",()=>{typeof window.logoutAdmin=="function"&&window.logoutAdmin()},"Ya, Keluar",!0)}else if(a){let i=a;a==="view-admin"&&(i="view-admin-login"),x(i,!0)}else x("view-catalog",!0)})};window.pushModalHistory=W;window.requestCloseModal=$;window.changeView=x;window.setupHistoryRouter=me;window.onBottomNavClick=ce;window.updateBottomNav=z;window.initPullToRefresh=Q;window.handleAppBackButton=fe;window.openExitConfirmModal=J;window.closeExitConfirmModal=j;window.confirmExitApp=pe;window.isProgrammaticModalClose=P;window.viewHistoryStack=K;try{Object.defineProperty(window,"curViewName",{get:()=>m,set:e=>{m=e},configurable:!0})}catch{}const Z=()=>{l("voucher-input");const e=(q("voucher-input")||"").toUpperCase().trim(),t=(u.vouchers||[]).find(i=>(i.code||"").toUpperCase()===e);I("voucher-msg-container");const a=typeof window.getEffP=="function"?window.getEffP:i=>i.effectivePrice||i.price||0,o=D.reduce((i,s)=>i+(parseFloat(a(s))||0)*(parseFloat(s.qty)||0),0);if(t){let i=!0;t.targetProduct&&t.targetProduct!==""&&(i=D.some(s=>s&&String(s.id)===String(t.targetProduct))),t.targetProduct&&t.targetProduct!==""&&!i?(T(null),k("voucher-msg",'<i class="fa-solid fa-box mr-1"></i> Khusus Produk Tertentu!'),l("voucher-msg")&&(l("voucher-msg").className="text-sm font-bold text-rose-500 dark:text-rose-400")):t.minPurchase&&parseFloat(t.minPurchase)>0&&o<parseFloat(t.minPurchase)?(T(null),k("voucher-msg",`<i class="fa-solid fa-circle-exclamation mr-1"></i> Minimal belanja ${B(t.minPurchase)}`),l("voucher-msg")&&(l("voucher-msg").className="text-sm font-bold text-amber-500 dark:text-amber-400")):t.type&&t.type.includes("shipping")&&oe.deliveryMethod!=="delivery"?(T(null),k("voucher-msg",'<i class="fa-solid fa-motorcycle mr-1"></i> Khusus pesanan dikirim kurir!'),l("voucher-msg")&&(l("voucher-msg").className="text-sm font-bold text-rose-500 dark:text-rose-400")):(T(t),k("voucher-msg",'<i class="fa-solid fa-check-circle mr-1"></i> Voucher Diterapkan!'),l("voucher-msg")&&(l("voucher-msg").className="text-sm font-bold text-[var(--color-primary)]"))}else e===""?(T(null),v("voucher-msg-container"),typeof window.rPay=="function"&&window.rPay()):(T(null),k("voucher-msg",'<i class="fa-solid fa-times-circle mr-1"></i> Kode Tidak Valid'),l("voucher-msg")&&(l("voucher-msg").className="text-sm font-bold text-rose-500 dark:text-rose-400"));typeof window.rPay=="function"&&window.rPay()},ue=()=>{let e=document.getElementById("voucher-modal");e||(e=document.createElement("div"),e.id="voucher-modal",e.className="fixed inset-0 z-[115] bg-slate-900/80 flex items-end sm:items-center justify-center p-0 sm:p-5",e.onclick=o=>{o.target===e&&O()},document.body.appendChild(e));const t=(u.vouchers||[]).filter(o=>o.isShow!==!1&&o.isShow!=="false"),a=t.length?t.map(o=>{let i="";o.type==="percent"?i=`Diskon ${o.value}%`:o.type==="shipping_free"?i="Gratis Ongkir":o.type==="shipping_flat"?i=`Diskon Ongkir ${B(o.value)}`:i=`Potongan ${B(o.value)}`;const s=o.minPurchase&&parseFloat(o.minPurchase)>0?`Min. belanja ${B(o.minPurchase)}`:"Tanpa minimal belanja";return`
    ...
    <svg class="w-full h-11 bg-white rounded-lg px-2 py-1 shadow-inner border border-slate-200" viewBox="0 0 ${Math.max(o+10,240)} 40" xmlns="http://www.w3.org/2000/svg">
        ${a}
    </svg>`},F=e=>{const t=parseFloat(e?.points)||0,a=R(t),o=(u.store?.name||"Toko Putri").toUpperCase(),i=u.store?.logo&&u.store.logo!=="fa-store"?u.store.logo:xe,s=(e?.name||"PELANGGAN SETIA").toUpperCase(),r=(e?.phone||"81234567890").toString().replace(/\D/g,""),n=X(r),p=u.store?.wa||r;return`
    ...
    <div class="flex gap-2.5 sm:gap-3 overflow-x-auto hide-scrollbar snap-x pb-3 pt-1">
        ...
        </div>`,g(),t.style.opacity="0",t.style.display="flex",requestAnimationFrame(()=>{t.style.transition="opacity 0.25s ease",t.style.opacity="1"}),!a&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("member")},g=()=>{const e=(u.rewards||[]).filter(i=>i.isActive!=="false"&&i.isActive!==!1),t=w&&parseFloat(w.points)||0,a=R(t),o=e.length?e.map(i=>{const s=(parseFloat(i.stock)||0)>0,r=w&&t>=(parseFloat(i.pointsCost)||0)&&s,n=L&&L.id===i.id;return`
        ...
        </div>`}).join(""):'<p class="text-[11px] font-bold text-slate-400 text-center py-3">Belum ada program hadiah yang tersedia.</p>';w?k("member-modal-body",`
