...
import{a as o,c as D,s as et,b as N,d as K,f as x,e as h,g as O,h as F,i as $,j as c,w as Z,k as u,l as ve,t as oe,m as Lt,n as sa,o as ge,p as be,q as fe,r as ie,u as Ce,v as Ie,x as At,y as Bt,z as _t,A as Et,B as ra,C as oa,D as te,E as y,F as A,G as P,H as pe,I as Be,J as de,K as je,L as ce,M as Me,N as ia,O as la,P as Q,Q as Rt,R as na,S as da,T as Ve,U as me,V as ca,W as Tt,X as I,Y as lt,Z as pa,_ as ma,$ as ua,a0 as ba,a1 as nt,a2 as le,a3 as z,a4 as fa,a5 as ga,a6 as xa}from"./module-print-DOgr66vg.js";import{f as G}from"./vendor-firebase-core-D2OF5R23.js";import"./vendor-firebase-db-BIUZcnOd.js";const ha="modulepreload",va=function(e){return"/"+e},Ct={},wa=function(t,a,r){let s=Promise.resolve();if(a&&a.length>0){document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),i=n?.nonce||n?.getAttribute("nonce");s=Promise.allSettled(a.map(d=>{if(d=va(d),d in Ct)return;Ct[d]=!0;const p=d.endsWith(".css"),m=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${m}`))return;const b=document.createElement("link");if(b.rel=p?"stylesheet":ha,p||(b.as="script"),b.crossOrigin="",b.href=d,i&&b.setAttribute("nonce",i),document.head.appendChild(b),p)return new Promise((g,v)=>{b.addEventListener("load",g),b.addEventListener("error",()=>v(new Error(`Unable to preload CSS for ${d}`)))})}))}function l(n){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=n,window.dispatchEvent(i),!i.defaultPrevented)throw n}return s.then(n=>{for(const i of n||[])i.status==="rejected"&&l(i.reason);return t().catch(l)})},ka={apiKey:"AIzaSyCOjrhMP52TGbiOyQLY92NDYE26N6d9hJM",authDomain:"restu-karya-utama.firebaseapp.com",databaseURL:"https://restu-karya-utama-default-rtdb.asia-southeast1.firebasedatabase.app",projectId:"restu-karya-utama",storageBucket:"restu-karya-utama.firebasestorage.app",messagingSenderId:"858310421352",appId:"1:858310421352:web:e20a833875e8d5c19944dd",measurementId:"G-PHDG2LJ8PM"};try{localStorage.removeItem("freshmart_fb_config")}catch{}const Nt=window.FIREBASE_CONFIG||ka;G.apps.length||G.initializeApp(Nt);const w=G.firestore(),q=G.auth();typeof window<"u"&&(window.firebase=G,window.db=w,window.auth=q);try{w.settings({ignoreUndefinedProperties:!0,experimentalAutoDetectLongPolling:!0,merge:!0})}catch{}let ya=null;const ir=()=>{wa(()=>import("./vendor-firebase-analytics-Jm19L5g2.js"),__vite__mapDeps([0,1])).then(()=>{try{ya=G.analytics()}catch{}}).catch(()=>{})},Sa="K2ijSERTT2dg27yYGTEgn6XHSnW2",Se={emerald:{50:"#ecfdf5",100:"#d1fae5",200:"#a7f3d0",300:"#6ee7b7",400:"#34d399",500:"#10b981",600:"#059669",700:"#047857",800:"#065f46",900:"#064e3b"},teal:{50:"#f0fdfa",100:"#ccfbf1",200:"#99f6e4",300:"#5eead4",400:"#2dd4bf",500:"#14b8a6",600:"#0d9488",700:"#0f766e",800:"#115e59",900:"#134e4a"},cyan:{50:"#ecfeff",100:"#cffafe",200:"#a5f3fc",300:"#67e8f9",400:"#22d3ee",500:"#06b6d4",600:"#0891b2",700:"#0e7490",800:"#155e75",900:"#164e63"},sky:{50:"#f0f9ff",100:"#e0f2fe",200:"#bae6fd",300:"#7dd3fc",400:"#38bdf8",500:"#0ea5e9",600:"#0284c7",700:"#0369a1",800:"#075985",900:"#0c4a6e"},blue:{50:"#eff6ff",100:"#dbeafe",200:"#bfdbfe",300:"#93c5fd",400:"#60a5fa",500:"#3b82f6",600:"#2563eb",700:"#1d4ed8",800:"#1e40af",900:"#1e3a8a"},indigo:{50:"#eef2ff",100:"#e0e7ff",200:"#c7d2fe",300:"#a5b4fc",400:"#818cf8",500:"#6366f1",600:"#4f46e5",700:"#4338ca",800:"#3730a3",900:"#312e81"},violet:{50:"#f5f3ff",100:"#ede9fe",200:"#ddd6fe",300:"#c4b5fd",400:"#a78bfa",500:"#8b5cf6",600:"#7c3aed",700:"#6d28d9",800:"#5b21b6",900:"#4c1d95"},purple:{50:"#faf5ff",100:"#f3e8ff",200:"#e9d5ff",300:"#d8b4fe",400:"#c084fc",500:"#a855f7",600:"#9333ea",700:"#7e22ce",800:"#6b21a8",900:"#581c87"},fuchsia:{50:"#fdf4ff",100:"#fae8ff",200:"#f5d0fe",300:"#f0abfc",400:"#e879f9",500:"#d946ef",600:"#c026d3",700:"#a21caf",800:"#86198f",900:"#701a75"},pink:{50:"#fdf2f8",100:"#fce7f3",200:"#fbcfe8",300:"#f9a8d4",400:"#f472b6",500:"#ec4899",600:"#db2777",700:"#be185d",800:"#9d174d",900:"#831843"},rose:{50:"#fff1f2",100:"#ffe4e6",200:"#fecdd3",300:"#fda4af",400:"#fb7185",500:"#f43f5e",600:"#e11d48",700:"#be123c",800:"#9f1239",900:"#881337"},red:{50:"#fef2f2",100:"#fee2e2",200:"#fecaca",300:"#fca5a5",400:"#f87171",500:"#dc2626",600:"#b91c1c",700:"#991b1b",800:"#7f1d1d",900:"#450a0a"},orange:{50:"#fff7ed",100:"#ffedd5",200:"#fed7aa",300:"#fdba74",400:"#fb923c",500:"#ea580c",600:"#c2410c",700:"#9a3412",800:"#7c2d12",900:"#431407"},amber:{50:"#fffbeb",100:"#fef3c7",200:"#fde68a",300:"#fcd34d",400:"#fbbf24",500:"#d97706",600:"#b45309",700:"#92400e",800:"#78350f",900:"#451a03"},yellow:{50:"#fefce8",100:"#fef9c3",200:"#fef08a",300:"#fde047",400:"#eab308",500:"#d97706",600:"#b45309",700:"#854d0e",800:"#713f12",900:"#3f1d0b"},lime:{50:"#f7fee7",100:"#ecfccb",200:"#d9f99d",300:"#bef264",400:"#a3e635",500:"#65a30d",600:"#4d7c0f",700:"#3f6212",800:"#365314",900:"#1a2e05"},green:{50:"#f0fdf4",100:"#dcfce7",200:"#bbf7d0",300:"#86efac",400:"#4ade80",500:"#16a34a",600:"#15803d",700:"#166534",800:"#14532d",900:"#052e16"},slate:{50:"#f8fafc",100:"#f1f5f9",200:"#e2e8f0",300:"#cbd5e1",400:"#94a3b8",500:"#475569",600:"#334155",700:"#1e293b",800:"#0f172a",900:"#020617"},stone:{50:"#fafaf9",100:"#f5f5f4",200:"#e7e5e4",300:"#d6d3d1",400:"#a8a29e",500:"#57534e",600:"#44403c",700:"#292524",800:"#1c1917",900:"#0c0a09"}},$a=e=>{let t=parseInt(e.replace("#",""),16);return(t>>16&255)+","+(t>>8&255)+","+(t&255)},It=(e,t)=>{let a=parseInt(e.slice(1,3),16),r=parseInt(e.slice(3,5),16),s=parseInt(e.slice(5,7),16);return a=Math.max(0,Math.min(255,a+t)),r=Math.max(0,Math.min(255,r+t)),s=Math.max(0,Math.min(255,s+t)),"#"+[a,r,s].map(l=>l.toString(16).padStart(2,"0")).join("")},Pa=e=>{if(!e)return;try{document.querySelectorAll('meta[name="theme-color"]').forEach(d=>d.remove())}catch{}const t=document.createElement("meta");t.setAttribute("name","theme-color"),t.setAttribute("content",e),document.head.appendChild(t);try{document.querySelectorAll('meta[name="msapplication-navbutton-color"], meta[name="msapplication-TileColor"]').forEach(d=>d.remove())}catch{}const a=document.createElement("meta");a.setAttribute("name","msapplication-navbutton-color"),a.setAttribute("content",e),document.head.appendChild(a);const r=document.createElement("meta");r.setAttribute("name","msapplication-TileColor"),r.setAttribute("content",e),document.head.appendChild(r);let s=document.querySelector('meta[name="apple-mobile-web-app-capable"]');s||(s=document.createElement("meta"),s.setAttribute("name","apple-mobile-web-app-capable"),document.head.appendChild(s)),s.setAttribute("content","yes");let l=document.querySelector('meta[name="mobile-web-app-capable"]');l||(l=document.createElement("meta"),l.setAttribute("name","mobile-web-app-capable"),document.head.appendChild(l)),l.setAttribute("content","yes");let n=document.querySelector('meta[name="apple-mobile-web-app-status-bar-style"]');n||(n=document.createElement("meta"),n.setAttribute("name","apple-mobile-web-app-status-bar-style"),document.head.appendChild(n)),n.setAttribute("content","default"),typeof window.updatePwaManifest=="function"&&window.updatePwaManifest(e)},Pe=(e,t)=>{const a=e||localStorage.getItem("freshmart_ui_theme")||"emerald",r=Se[a]||Se.emerald;e&&localStorage.setItem("freshmart_ui_theme",a);const s=t||localStorage.getItem("freshmart_theme_color")||r[500];t&&localStorage.setItem("freshmart_theme_color",s);const l=$a(s),n=It(s,-30),i=It(s,150);return document.documentElement.style.setProperty("--color-primary",s),document.documentElement.style.setProperty("--color-primary-dark",n),document.documentElement.style.setProperty("--color-primary-light",i),document.documentElement.style.setProperty("--color-primary-rgb",l),Pa(s),r},lr=()=>{const e=localStorage.getItem("freshmart_theme"),t=window.matchMedia("(prefers-color-scheme: dark)").matches;(e==="dark"||!e&&t)&&document.documentElement.classList.add("dark")},nr=()=>{const e=document.documentElement.classList.toggle("dark");localStorage.setItem("freshmart_theme",e?"dark":"light");const t=document.getElementById("icon-theme")||document.getElementById("theme-toggle-icon");t&&(t.className=e?"fa-solid fa-sun text-sm text-amber-400":"fa-solid fa-moon text-sm text-slate-600 dark:text-slate-300")},dr=()=>{const e=document.documentElement.classList.contains("dark"),t=document.getElementById("icon-theme")||document.getElementById("theme-toggle-icon");t&&(t.className=e?"fa-solid fa-sun text-sm text-amber-400":"fa-solid fa-moon text-sm text-slate-600 dark:text-slate-300")},Ae=(e="minimalist",t="")=>{const a=e||localStorage.getItem("freshmart_bg_style")||"minimalist",r=t??(localStorage.getItem("freshmart_bg_custom_url")||"");e&&localStorage.setItem("freshmart_bg_style",a),t!=null&&localStorage.setItem("freshmart_bg_custom_url",r);const l=(p=>{if(!p||typeof p!="string")return"";const m=p.match(/drive\.google\.com.*(?:id=|\/d\/)([a-zA-Z0-9_-]+)/);return m?`https://lh3.googleusercontent.com/d/${m[1]}`:p.trim()})(r);document.documentElement.setAttribute("data-bg-style",a),document.body?.setAttribute("data-bg-style",a);const n=document.getElementById("app-container");n&&(n.setAttribute("data-bg-style",a),l?n.setAttribute("data-has-custom-bg","true"):n.removeAttribute("data-has-custom-bg"));const i=document.getElementById("dynamic-bg-container");if(!i)return;if(i.innerHTML="",i.className="pointer-events-none fixed inset-0 z-0 overflow-hidden",l){const p=document.createElement("div");p.className="absolute inset-0 z-0 bg-cover bg-center bg-no-repeat bg-fixed opacity-35 dark:opacity-25 pointer-events-none transition-all duration-500",p.style.backgroundImage=`url('${l}')`,i.appendChild(p);const m=document.createElement("div");m.className="absolute inset-0 z-0 bg-slate-50/70 dark:bg-[#0b1120]/80 pointer-events-none backdrop-blur-[0.5px]",i.appendChild(m)}let d="";if(a==="hero_arch"?d=`
        ...
        <div class="bg-white dark:bg-slate-800 p-4 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm flex gap-4 relative overflow-hidden group min-w-0 hover:shadow-md hover:-translate-y-1 hover:border-[var(--color-primary)]/40 dark:hover:border-[var(--color-primary)]/40 transition-all duration-300">
            ...
            <div class="flex-1 flex flex-col min-w-0 relative">
                ...
                <div class="flex justify-between items-end mt-auto pt-1">
                    <div>
                        ${p?`<p class="text-[10px] line-through text-slate-400 font-bold mb-0.5">${x(l.price)}</p>`:""}
                    ...
                    <div class="flex bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl overflow-hidden shrink-0 shadow-sm h-9">
                        ...
                        <input type="number" step="0.01" class="w-10 h-full text-center text-xs font-bold bg-transparent text-slate-800 dark:text-white focus:outline-none border-x border-slate-200 dark:border-slate-700" value="${i}" onchange="setCQty(${n}, this.value)">
        ...
        </div>`}).join("")),K("cart-subtotal",x(a));const r=o.store.freeShippingMinSpendEnabled===!0||o.store.freeShippingMinSpendEnabled==="true",s=parseFloat(o.store.freeShippingMinSpendAmount)||0;if(e)if(r&&s>0){e.classList.remove("hidden");const l=Math.min(100,Math.round(a/s*100)),n=Math.max(0,s-a),i=a>=s;e.innerHTML=`
            <div class="p-4 rounded-2xl border transition-all duration-300 ${i?"bg-gradient-to-r from-emerald-500 via-teal-600 to-emerald-600 text-white border-emerald-400/50 shadow-md shadow-emerald-500/10":"bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 shadow-sm text-slate-800 dark:text-slate-100"}">
                <div class="flex items-center justify-between gap-3 mb-2.5">
                    <div class="flex items-center gap-2.5 min-w-0">
                        <span class="w-8 h-8 rounded-xl flex items-center justify-center text-sm shrink-0 ${i?"bg-white/20 text-white":"bg-emerald-50 dark:bg-emerald-950/60 text-emerald-600 dark:text-emerald-400 border border-emerald-100 dark:border-emerald-800/50"}">
                            <i class="fa-solid ${i?"fa-circle-check text-base":"fa-truck-fast"}"></i>
                        </span>
                        <div class="min-w-0">
                            <p class="text-xs font-bold leading-tight ${i?"text-white":"text-slate-800 dark:text-slate-100"}">
                                ${i?'Hore! Anda berhak mendapatkan <span class="underline decoration-wavy decoration-emerald-200 font-extrabold">Gratis Ongkir Otomatis</span>':`Belanja <span class="text-emerald-600 dark:text-emerald-400 font-extrabold">${x(n)}</span> lagi untuk <b>Gratis Ongkir</b>!`}
                            </p>
                            <p class="text-[10px] ${i?"text-white/80":"text-slate-400 dark:text-slate-500"} mt-0.5">
                                ${i?"Ongkos kirim otomatis dipotong Rp 0 saat checkout.":`Min. belanja ${x(s)} untuk pengiriman ke alamat.`}
                            </p>
                        </div>
                    </div>
                    <span class="text-[11px] font-black shrink-0 px-2.5 py-1 rounded-full ${i?"bg-white text-emerald-700 shadow-sm":"bg-emerald-50 dark:bg-emerald-950/80 text-emerald-600 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-800"}">
                        ${l}%
                    </span>
                </div>
                <div class="w-full h-2 rounded-full overflow-hidden ${i?"bg-black/20":"bg-slate-100 dark:bg-slate-700/60"}">
                    <div class="h-full rounded-full transition-all duration-500 ${i?"bg-white shadow-sm":"bg-gradient-to-r from-emerald-500 to-teal-500"}" style="width: ${l}%"></div>
                </div>
            </div>`}else e.classList.add("hidden"),e.innerHTML=""},Aa=(e,t)=>{let a=parseFloat(t);if(isNaN(a)||a<=0)D.splice(e,1);else{if(o.store.useStock===!0||o.store.useStock==="true"){const s=D[e],l=o.products.find(n=>n.id===s.id);if(l){const n=s.variantName?parseFloat(((l.variants||[]).find(i=>i.name===s.variantName)||{}).stock)||0:parseFloat(l.stock)||0;a>n&&(a=n,typeof window.showToast=="function"&&window.showToast(`Maks stok: ${n}`))}}D[e].qty=parseFloat(a.toFixed(2))}xe(),Y()},Ta=(e,t)=>{let a=parseFloat((parseFloat(D[e].qty)+t).toFixed(2));if(a<=0)D.splice(e,1);else{if((o.store.useStock===!0||o.store.useStock==="true")&&t>0){const s=D[e],l=o.products.find(n=>n.id===s.id);if(l){const n=s.variantName?parseFloat(((l.variants||[]).find(i=>i.name===s.variantName)||{}).stock)||0:parseFloat(l.stock)||0;a>n&&(a=n,typeof window.showToast=="function"&&window.showToast(`Maks stok: ${n}`))}}D[e].qty=a}xe(),Y()},Ca=e=>{D.splice(e,1),xe(),Y()},Ia=()=>{typeof window.showConfirm=="function"?window.showConfirm("Kosongkan Keranjang","Semua barang akan dihapus. Lanjutkan?",()=>{et([]),Y(),xe(),typeof window.showToast=="function"&&window.showToast("Dibersihkan")}):(et([]),Y(),xe())},ja=()=>{if(window.isAdm){typeof window.showConfirm=="function"&&window.showConfirm("Akses Ditolak","Anda sedang login sebagai Seller. Silakan logout terlebih dahulu untuk membuat pesanan sebagai pelanggan.",()=>{typeof window.logoutAdmin=="function"&&window.logoutAdmin()},"Logout Sekarang",!1);return}D.length&&typeof window.changeView=="function"&&window.changeView("view-checkout")};window.sanitizeCart=_e;window.updCart=Y;window.renderCart=xe;window.setCQty=Aa;window.updCQty=Ta;window.rmCart=Ca;window.clearCart=Ia;window.validateCartToCheckout=ja;const Ee=()=>{const e=h("wishlist-badge");e&&(e.innerText=Z.length,e.classList.toggle("scale-0",!Z.length))},Ma=e=>{Z.splice(e,1),N("freshmart_wishlist",JSON.stringify(Z)),Ee(),dt()},Da=e=>{const t=Z[e],a=o.products?.find(n=>n.id===t.id);if(!a||a.isActive==="false"||a.isActive===!1)return u(`${t.name} sudah tidak tersedia.`);const r=t.variantName?(a.variants||[]).find(n=>n.name===t.variantName):null;if(o.store?.useStock===!0||o.store?.useStock==="true"){if(t.variantName&&(!r||r.isActive===!1||r.isActive==="false"))return u(`Varian ${t.variantName} sudah tidak tersedia.`);const n=r?parseFloat(r.stock)||0:parseFloat(a.stock)||0,i=D.find(p=>p.id===t.id&&p.variantName===t.variantName),d=i&&parseFloat(i.qty)||0;if(n<=0||d>=n)return u(`Stok ${t.name} tidak mencukupi!`)}const l=D.find(n=>n.id===t.id&&n.variantName===t.variantName);if(l)l.qty=parseFloat((l.qty+1).toFixed(2));else{const n=r&&parseFloat(r.poin)>0?parseFloat(r.poin):parseFloat(a.poin)||0;D.push({id:a.id,name:a.name,variantName:t.variantName||"",price:r?r.price:a.price,img:r?.img||a.img,qty:1,unit:a.unit||"pcs",poTime:a.poTime||"",colorCode:r?.colorCode||"",poin:n})}Y(),u("Ke Keranjang!"),typeof window.curViewName<"u"&&window.curViewName==="view-cart"&&xe()},La=()=>{ve("Hapus Favorit","Yakin ingin menghapus semua?",()=>{Z.length=0,N("freshmart_wishlist",JSON.stringify(Z)),Ee(),dt(),u("Dibersihkan")})},dt=()=>{if(!Z.length){O("wishlist-empty-state"),F("btn-clear-wishlist"),O("spacer-wishlist"),$("wishlist-items-container","");return}F("wishlist-empty-state"),O("btn-clear-wishlist"),F("spacer-wishlist"),$("wishlist-items-container",Z.map((e,t)=>{let a=e.colorCode?`<span class="w-3.5 h-3.5 rounded-full shadow-inner border border-slate-300 dark:border-slate-600 shrink-0" style="background-color: ${c(e.colorCode)};"></span>`:"";return`
        <div class="bg-white dark:bg-slate-800 p-4 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm flex gap-4 relative overflow-hidden group min-w-0 hover:shadow-md hover:-translate-y-1 hover:border-rose-300 dark:hover:border-rose-600 transition-all duration-300">
        ...
        </div>`,B=`<span class="text-[9px] text-slate-600 dark:text-slate-400 font-bold ml-0.5 mb-0.5 uppercase tracking-wide">/${c(i.unit||"PCS")}</span>`;return At==="grid"?`
                ...
                <div class="flex-1 flex flex-col p-3 sm:p-4 min-w-0 bg-white dark:bg-slate-800 relative z-10">
                    ...
                    <div class="flex items-end justify-between mt-auto pt-1">
                        <div>
                            ...
                            ${i.variants&&i.variants.length>0?"":B}
                        </div>
            ...
            <a href="?p=${i.id}" class="w-full bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700/50 rounded-[1.5rem] shadow-soft ${v} transition-all duration-300 flex items-stretch p-2.5 sm:p-3 gap-3 sm:gap-4 group relative overflow-hidden text-left" onclick="event.preventDefault(); openProductModal(${i.id})">
                ${d}
...
Kami akan segera memproses pesanan Anda. Terima kasih! 🙏`;window.open(`https://wa.me/${r}?text=${encodeURIComponent(p)}`,"_blank")}catch{P(),u("Gagal memuat data pesanan!")}},es=e=>{ve("Hapus Pesanan","Yakin ingin hapus permanen?",async()=>{if(!Ve){me(!0),A("Menghapus...");try{await w.collection("freshmart_orders").doc(e).delete(),u("Terhapus!"),ca===e&&Vt()}catch{u("Gagal!")}finally{me(!1),P()}}})};window.exportOrdersToExcel=Wa;window.rAdmOrd=Ja;window.openOrderDetail=mt;window.saveOrderCustomerToDB=Qa;window.ackRewardClaim=Ya;window.closeOrderDetailModal=Vt;window.updateOrderStatus=Xa;window.konfirmasiKeWA=Za;window.deleteOrder=es;const ts=()=>{const e=o.store.name||"Toko Grosir",t=o.store.themeColor||"#10b981",a=(l,n,i=!1)=>{let d=document.querySelector(`meta[${i?"property":"name"}="${l}"]`);d||(d=document.createElement("meta"),i?d.setAttribute("property",l):d.setAttribute("name",l),document.head.appendChild(d)),d.setAttribute("content",n)};a("theme-color",t),a("mobile-web-app-capable","yes"),a("apple-mobile-web-app-capable","yes"),a("apple-mobile-web-app-status-bar-style","black-translucent"),a("apple-mobile-web-app-title",e),a("application-name",e),a("msapplication-TileColor",t),document.title=e,localStorage.setItem("freshmart_theme_color",t),o.store.uiTheme&&o.store.uiTheme!==localStorage.getItem("freshmart_ui_theme")&&(localStorage.setItem("freshmart_ui_theme",o.store.uiTheme),Pe(o.store.uiTheme));const r=o.store.bgStyle||localStorage.getItem("freshmart_bg_style")||"minimalist",s=o.store.bgCustomUrl!==void 0?o.store.bgCustomUrl:localStorage.getItem("freshmart_bg_custom_url")||"";Ae(r,s)},Gt=()=>{$("admin-content",`
    ...
    `)},as=e=>{const t=Se[e][500],a=document.getElementById("set-ui-theme"),r=document.getElementById("set-theme-color"),s=document.getElementById("set-theme-color-picker");a&&(a.value=e),r&&(r.value=t),s&&(s.value=t),document.querySelectorAll(".preset-color-chip").forEach(i=>{i.classList.remove("ring-4","ring-offset-2","ring-slate-400","dark:ring-slate-500","scale-110"),i.querySelector(".check-icon")?.classList.add("hidden")});const l=document.getElementById(`preset-chip-${e}`);l&&(l.classList.add("ring-4","ring-offset-2","ring-slate-400","dark:ring-slate-500","scale-110"),l.querySelector(".check-icon")?.classList.remove("hidden"));const n=document.getElementById("custom-color-chip");if(n){n.style.background="";const i=n.querySelector("i");i&&(i.style.color="")}Pe(e,t)},ss=e=>{const t=document.getElementById("set-bg-style");t&&(t.value=e);const a=document.getElementById("set-bg-custom-url")?.value||"";document.querySelectorAll(".bg-style-card").forEach(s=>{s.classList.remove("border-[var(--color-primary)]","shadow-md","ring-2","ring-[var(--color-primary)]/20"),s.classList.add("border-slate-200","dark:border-slate-700");const l=s.querySelector(".bg-icon-wrap");l&&(l.className="bg-icon-wrap w-10 h-10 rounded-xl flex items-center justify-center mb-2 text-base transition-transform bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300")});const r=document.getElementById(`bg-opt-${e}`);if(r){r.classList.add("border-[var(--color-primary)]","shadow-md","ring-2","ring-[var(--color-primary)]/20"),r.classList.remove("border-slate-200","dark:border-slate-700");const s=r.querySelector(".bg-icon-wrap");s&&(s.className="bg-icon-wrap w-10 h-10 rounded-xl flex items-center justify-center mb-2 text-base transition-transform bg-[var(--color-primary)] text-white shadow-sm")}Ae(e,a)},rs=e=>{let t,a,r,s,l;if(e==="profile"){t="Profil Toko & Tampilan Visual",a="Kelola identitas utama toko, palet warna tema, model layout background, dan informasi legal",r="fa-store",s={line:"bg-[var(--color-primary)]",box:"bg-[rgba(var(--color-primary-rgb),0.1)] text-[var(--color-primary)]"};const i=o.store.uiTheme||"emerald",d=o.store.bgStyle||localStorage.getItem("freshmart_bg_style")||"minimalist",p={emerald:"Emerald",teal:"Teal",lime:"Lime",cyan:"Cyan",sky:"Sky",blue:"Blue",indigo:"Indigo",violet:"Violet",purple:"Purple",fuchsia:"Fuchsia",pink:"Pink",rose:"Rose",red:"Red",orange:"Orange",amber:"Amber",yellow:"Yellow",green:"Green",slate:"Slate",stone:"Stone"},m=Object.keys(Se).map(b=>{const g=Se[b][500],v=p[b]||b,f=i===b;return`
        ...
        `):e==="operasional"&&(t="Operasional & Perpajakan",a="Konfigurasi pembatasan inventaris stok produk otomatis serta skema kalkulasi PPN transaksi",r="fa-sliders",s={line:"bg-violet-500",box:"bg-violet-50 dark:bg-violet-900/30 text-violet-500"},l=`
    ...
    <div class="mb-5 flex flex-wrap items-center justify-between gap-3 bg-white dark:bg-slate-800 p-4 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm">
        ...
        <div class="flex items-center gap-2">
            ...
            <select id="tax-month-select" onchange="changeTaxMonth(this.value)" class="admin-input !py-2 !px-3 text-xs font-bold bg-slate-50 dark:bg-slate-900 text-slate-800 dark:text-slate-100 border border-slate-200 dark:border-slate-700 rounded-xl focus:border-[var(--color-primary)] cursor-pointer">
                ...
                ${re.map((r,s)=>`<option value="${s+1}" ${R===s+1?"selected":""}>${r} ${E}</option>`).join("")}
            </select>
        </div>
        `}
    </div>
    ...
    `)},xt=()=>{const e=Re(),t=R===0?`Tahun ${E}`:`${re[R-1]} ${E}`,a=e.omset-e.disc-e.hpp,r=R===0?null:`${E}-${R}`,s=ft(),l=a-s,n=o.taxSettings?.taxScheme||"umkm_final";let i,d,p;n==="umkm_final"?(i=.5,d=e.omset,p="PPh Final UMKM (0,5% × Omset)"):n==="badan_normal"?(i=22,d=Math.max(0,l),p="PPh Badan (22% × Laba Bersih)"):(i=parseFloat(o.taxSettings?.customTaxRate)||0,d=Math.max(0,l),p=`PPh Custom (${i}% × Laba Bersih)`);const m=d*(i/100),b=l-m;let g="";if(R===0)g=Array.from({length:12},(v,f)=>f+1).map(v=>{const f=`${E}-${v}`,S=(o.taxSettings?.monthlyExpenses||{})[f]||0;return`<div class="flex items-center justify-between gap-2 py-2 border-b border-slate-100 dark:border-slate-700/50 last:border-0">
                <span class="text-xs font-bold text-slate-600 dark:text-slate-300">${re[v-1]} ${E}</span>
            ...
            </div>`}).join("");else{const v=(o.taxSettings?.monthlyExpenses||{})[r]||0;g=`<div class="flex items-center justify-between gap-2 py-2">
            <span class="text-xs font-bold text-slate-600 dark:text-slate-300">${re[R-1]} ${E}</span>
            <input type="number" min="0" value="${v}" onchange="saveMonthlyExpense('${r}', this.value)" class="admin-input !py-2 !px-3 text-xs w-36 text-right font-bold bg-slate-50 dark:bg-slate-900 text-slate-800 dark:text-slate-100 border border-slate-200 dark:border-slate-700 rounded-xl focus:border-[var(--color-primary)]">
        </div>`}$("tax-content",`
    ...
    `)},vs=async(e,t)=>{const a=parseFloat(t)||0;o.taxSettings||(o.taxSettings={}),o.taxSettings.balanceSheet||(o.taxSettings.balanceSheet={kas:0,piutang:0,hutang:0,modalDisetor:0}),o.taxSettings.balanceSheet[e]=a;try{typeof window.saveApp=="function"&&await window.saveApp(["taxSettings"]),ht()}catch{u("Gagal menyimpan data neraca!")}},Wt=()=>{const e=o.taxSettings||{};$("tax-content",`
    ...
    `)},ws=e=>{oe("tax-custom-rate-wrap","hidden",e!=="custom")},ks=async()=>{if(!Ve){me(!0),A("Menyimpan...");try{o.taxSettings||(o.taxSettings={}),o.taxSettings.companyName=y("tax-company-name"),o.taxSettings.npwp=y("tax-npwp"),o.taxSettings.taxScheme=y("tax-scheme"),o.taxSettings.customTaxRate=parseFloat(y("tax-custom-rate"))||.5,typeof window.saveApp=="function"&&await window.saveApp(["taxSettings"]),u("Pengaturan pajak tersimpan!")}catch{u("Gagal menyimpan pengaturan pajak!")}finally{me(!1),P()}}},ys=e=>{const t=R===0?`Tahun ${E}`:`${re[R-1]} ${E}`,a=o.taxSettings||{},r=new Date().toLocaleDateString("id-ID",{day:"2-digit",month:"long",year:"numeric"});let s="";o.store.logo&&(o.store.logo.includes("http")||o.store.logo.includes("data:"))?s=`<img loading="eager" src="${c(o.store.logo)}" class="w-16 h-16 object-contain">`:s='<div class="w-16 h-16 bg-slate-700 text-white flex items-center justify-center rounded-xl"><i class="fa-solid fa-store text-3xl"></i></div>';const n={summary:"LAPORAN PPN & OMSET",income:"LAPORAN LABA RUGI",balance:"NERACA"}[e]||"LAPORAN";let i=`
    ...
    <div class="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-6 text-[11px] font-bold text-amber-700 leading-relaxed">
    ...
    </div>`,d="";if(e==="summary"){const m=Re(),b=m.omset-m.disc,g=Array.from({length:12},(v,f)=>f+1).map(v=>{const f=se?se[v]:{omset:0,ppn:0,orderCount:0};return`<tr class="border-b border-slate-200"><td class="py-2.5 px-3 font-bold text-slate-700">${re[v-1]} ${E}</td><td class="py-2.5 px-3 text-right font-bold text-slate-700">${x(f.omset)}</td><td class="py-2.5 px-3 text-right font-bold text-slate-900">${x(f.ppn)}</td><td class="py-2.5 px-3 text-right font-bold text-slate-500">${f.orderCount}</td></tr>`}).join("");d=`
        ...
        <table class="w-full text-xs"><thead><tr class="bg-slate-100 text-left"><th class="py-2.5 px-3 font-bold text-slate-500 uppercase text-[9px]">Bulan</th><th class="py-2.5 px-3 font-bold text-slate-500 uppercase text-[9px] text-right">Omset</th><th class="py-2.5 px-3 font-bold text-slate-500 uppercase text-[9px] text-right">PPN Keluaran</th><th class="py-2.5 px-3 font-bold text-slate-500 uppercase text-[9px] text-right">Pesanan</th></tr></thead><tbody>${g}</tbody></table>`}else if(e==="income"){const m=Re(),b=m.omset-m.disc-m.hpp,g=ft(),v=b-g,f=a.taxScheme||"umkm_final";let S,C,T;f==="umkm_final"?(S=.5,C=m.omset,T="PPh Final UMKM (0,5% × Omset)"):f==="badan_normal"?(S=22,C=Math.max(0,v),T="PPh Badan (22% × Laba Bersih)"):(S=parseFloat(a.customTaxRate)||0,C=Math.max(0,v),T=`PPh Custom (${S}% × Laba Bersih)`);const k=C*(S/100),V=v-k,L=(B,j,_,Ye)=>`<div class="flex justify-between py-2 ${_?"border-t-2 border-slate-800 mt-1 pt-3":"border-b border-slate-100"}"><span class="${_?"font-bold text-slate-900":"font-bold text-slate-600"}">${B}</span><span class="font-bold ${Ye||"text-slate-900"}">${j}</span></div>`;d=`<div class="max-w-xl">
            ...
            ${L("Laba Bersih Sebelum Pajak",x(v),!0)}
            ${L("(−) Estimasi "+T,"-"+x(k),!1,"text-rose-600")}
            ${L("Laba Bersih Setelah Pajak (Estimasi)",x(V),!0)}
        </div>`}else if(e==="balance"){const m=We(),b=a.balanceSheet||{kas:0,piutang:0,hutang:0},g=(parseFloat(b.kas)||0)+(parseFloat(b.piutang)||0)+m.assetHpp,v=parseFloat(b.hutang)||0,f=g-v;d=`
        ...
        </div>`}K("doc-modal-title","Preview "+n),$("doc-paper-content",i+d);const p=h("doc-preview-modal");p&&p.classList.contains("hidden")&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("docPreview"),O("doc-preview-modal"),setTimeout(()=>{h("doc-preview-modal")&&h("doc-preview-modal").classList.remove("opacity-0"),h("doc-preview-modal-box")&&h("doc-preview-modal-box").classList.remove("scale-95"),typeof window.fitDocPreview=="function"&&window.fitDocPreview()},10)};window.fetchTaxPeriodData=bt;window.getTaxPeriodTotals=Re;window.getTaxPeriodExpenses=ft;window.rTaxPanel=bs;window.rTaxRenderShell=gt;window.switchTaxTab=fs;window.changeTaxYear=gs;window.changeTaxMonth=xs;window.rTaxSubContent=ze;window.rTaxSummary=qt;window.rTaxIncome=xt;window.saveMonthlyExpense=hs;window.rTaxBalance=ht;window.saveBalanceField=vs;window.rTaxSettingsPanel=Wt;window.toggleCustomTaxRateInput=ws;window.saveTaxSettingsPanel=ks;window.openTaxDocPreview=ys;window.MONTH_NAMES=re;window.editTempoPenalty=(e,t)=>{window.customPrompt("Persentase Denda Baru",t,async a=>{if(!a)return;let r=parseFloat(a.replace(",","."));if(isNaN(r)||r<0)return u("Persentase tidak valid!");A("Menyimpan...");try{await w.collection("freshmart_orders").doc(e).update({"payment.tempoPenaltyRate":r}),u("Persentase denda berhasil diubah!"),window.rAdmPiutang()}catch(s){u("Gagal mengubah denda: "+s.message)}P()})};window.stopTempoPenalty=(e,t,a)=>{let r="Konfirmasi Denda",s=a?"Lanjutkan perhitungan denda otomatis?":"Hentikan denda berjalan sekarang? (Nominal denda akan dibekukan di "+x(t)+")";ve(r,s,async()=>{A("Menyimpan...");try{await w.collection("freshmart_orders").doc(e).update({"payment.tempoPenaltyStopped":!a,"payment.tempoFixedPenalty":a?null:t}),u(a?"Denda dilanjutkan!":"Denda berhasil dibekukan!"),window.rAdmPiutang()}catch(n){u("Gagal mengubah status denda: "+n.message)}P()},a?"Lanjutkan":"Bekukan")};window.payTempoInstallment=e=>{window.customPrompt("Masukkan Nominal Cicilan (Rp)","",async t=>{if(!t)return;let a=parseFloat(t.replace(/[^0-9]/g,""));if(isNaN(a)||a<=0)return u("Nominal tidak valid!");A("Menyimpan cicilan...");try{const s=(await w.collection("freshmart_orders").doc(e).get()).data();let l=(s.payment.tempoBalance||0)-a,n=s.payment.installments||[];n.push({date:Date.now(),amount:a,note:"Cicilan"});let i={"payment.tempoBalance":Math.max(0,l),"payment.installments":n};l<=0&&(i["payment.paymentStatus"]="lunas",i.status="Selesai"),await w.collection("freshmart_orders").doc(e).update(i),u("Cicilan berhasil ditambahkan!"),window.rAdmPiutang&&window.rAdmPiutang()}catch(r){u("Gagal memproses cicilan: "+r.message)}P()})};window.previewTempoReceipt=async e=>{A("Memuat data struk...");try{const t=await w.collection("freshmart_orders").doc(e).get();if(!t.exists)return P(),u("Pesanan tidak ditemukan");const a=t.data();P();const r=a.dateString?new Date(a.dateString).toLocaleString("id-ID",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}):"",s=o.store.name||"Toko",l=o.store.wa||"",n=(k,V,L=32)=>{const B=L-k.length-V.length;return k+(B>0?" ".repeat(B):" ")+V};let i=`<div class="text-center font-bold" style="font-size:13px;margin-bottom:2px;">${c(s)}</div>`;l&&(i+=`<div class="text-center" style="margin-bottom:4px;">WA: ${c(l)}</div>`),i+=`<div class="text-center font-bold uppercase my-2" style="font-size:14px;border-bottom:1px solid #000;border-top:1px solid #000;padding:2px 0;">NOTA TEMPO${a.payment?.paymentStatus==="lunas"?" - LUNAS":""}</div>`,i+=`<div style="white-space:pre;">Order: #${a.orderId}</div><div style="white-space:pre;">Tgl  : ${r}</div><div style="white-space:pre;">Plg  : ${c(a.customer?.name||"Guest").substring(0,20)}</div>`,a.payment?.tempoDueDate&&(i+=`<div style="white-space:pre;">J.Tmp: ${new Date(a.payment.tempoDueDate).toLocaleDateString("id-ID")}</div>`),i+='<div class="border-b border-dashed border-black my-2"></div>';let d=0;if(a.items.forEach(k=>{let V=k.variantName?` (${c(k.variantName)}${k.colorCode?" "+c(k.colorCode):""})`:"";const L=(c(k.name)+V+(k.poTime?" [PO]":"")).substring(0,32),B=`${parseFloat(k.qty)} ${c(k.unit||"pcs")} x ${k.effectivePrice.toLocaleString("id-ID")}`,j=(parseFloat(k.qty)*k.effectivePrice).toLocaleString("id-ID");i+=`<div style="white-space:pre-wrap;font-weight:bold;word-break:break-all;">${L}</div><div style="white-space:pre;font-size:11px;">${n(B,j)}</div>`,k.poTime&&(i+=`<div style="white-space:pre;font-size:10px;font-style:italic;color:#4b5563;">* Estimasi PO: ${c(k.poTime)}</div>`),d+=parseFloat(k.qty)*k.effectivePrice}),i+='<div class="border-b border-dashed border-black my-2"></div>',i+=`<div style="white-space:pre;font-weight:bold;">${n("Subtotal",d.toLocaleString("id-ID"))}</div>`,a.payment?.grandTotal&&a.payment.grandTotal!==d){let k=a.payment.grandTotal-d;k>0?i+=`<div style="white-space:pre;">${n("Ongkir/Biaya",k.toLocaleString("id-ID"))}</div>`:i+=`<div style="white-space:pre;">${n("Diskon",Math.abs(k).toLocaleString("id-ID"))}</div>`}i+=`<div style="white-space:pre;font-weight:bold;margin-top:4px;">${n("TOTAL KREDIT",(a.payment?.grandTotal||d).toLocaleString("id-ID"))}</div>`,i+='<div class="border-b border-black my-2" style="border-width:1px;"></div>';let p=0;a.payment?.installments&&a.payment.installments.length>0&&(i+='<div style="white-space:pre;font-weight:bold;margin-bottom:2px;">HISTORI CICILAN:</div>',a.payment.installments.forEach((k,V)=>{let L=new Date(k.date).toLocaleDateString("id-ID",{day:"2-digit",month:"short"}),B=k.amount.toLocaleString("id-ID");i+=`<div style="white-space:pre;">${n(`${V+1}. ${L}`,B)}</div>`,p+=k.amount}),i+=`<div style="white-space:pre;font-weight:bold;margin-top:2px;">${n("TOTAL DIBAYAR",p.toLocaleString("id-ID"))}</div>`,i+='<div class="border-b border-dashed border-black my-2"></div>');let m=a.payment?.tempoBalance||0,b=0,g=a.payment?.tempoPenaltyStopped===!0,v=a.payment?.tempoDueDate||0,f=a.payment?.tempoPenaltyRate!==void 0?parseFloat(a.payment.tempoPenaltyRate):1;if(a.payment?.paymentStatus!=="lunas"){if(g)b=parseFloat(a.payment?.tempoFixedPenalty)||0;else if(Date.now()>v){let k=Math.floor((Date.now()-v)/864e5);k>0&&(b=f/100*m*k)}}i+=`<div style="white-space:pre;font-weight:bold;">${n("SISA POKOK",m.toLocaleString("id-ID"))}</div>`,b>0&&(i+=`<div style="white-space:pre;">${n("DENDA",Math.round(b).toLocaleString("id-ID"))}</div>`);let S=m+b;i+='<div class="border-b border-black my-2" style="border-width:1px;"></div>',i+=`<div style="white-space:pre;font-weight:black;">${n("SISA TAGIHAN",Math.round(S).toLocaleString("id-ID"))}</div>`,a.items.some(k=>k.poTime&&k.poTime!=="")&&(i+='<div class="border-b border-dashed border-black my-2"></div><div style="white-space:pre-wrap;font-size:9px;text-align:center;line-height:1.2;font-style:italic;color:#4b5563;margin-bottom:4px;">* Catatan: Untuk pesanan gabungan, produk PO akan dikirimkan menyusul (estimasi sesuai label) tanpa dikenakan biaya tambahan.</div>'),i+='<div class="border-b border-dashed border-black my-2"></div><div class="text-center my-2" style="font-size:10px;">Terima kasih atas kepercayaannya.</div><div class="border-b border-dashed border-black my-2"></div><div style="height:20px;"></div>',$("receipt-paper-content",i);const T=h("receipt-preview-modal");T&&T.classList.contains("hidden")&&pushModalHistory("receipt"),show("receipt-preview-modal"),setTimeout(()=>{h("receipt-preview-modal").classList.remove("opacity-0"),h("receipt-preview-modal-box").classList.remove("scale-95")},10)}catch(t){P(),u("Gagal memuat struk: "+t.message)}};window.markTempoPaid=async e=>{ve("Konfirmasi","Tandai tagihan tempo ini sebagai LUNAS?",async()=>{try{await w.collection("freshmart_orders").doc(e).update({"payment.paymentStatus":"lunas","payment.tempoBalance":0,status:"Selesai"}),u("Tagihan berhasil dilunasi!");let t=gOrds.findIndex(a=>a.orderId===e);t!==-1&&(gOrds[t].payment.paymentStatus="lunas",gOrds[t].payment.tempoBalance=0,gOrds[t].status="Selesai"),window.rAdmPiutang()}catch(t){u("Gagal mengubah status: "+t.message)}})};window.rAdmPiutang=async()=>{A("Memuat data piutang...");let e=[];try{(await w.collection("freshmart_orders").where("payment.method","==","tempo").where("payment.paymentStatus","==","hutang").get()).forEach(s=>{e.push(s.data())})}catch(r){P(),u("Gagal memuat piutang: "+r.message);return}P();let t=0,a=`
    ...
    `;e.length===0?a+=`<div class="bg-white dark:bg-slate-800 p-8 text-center rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm">
            ...
            <div class="bg-white dark:bg-slate-800 p-5 rounded-2xl border ${m?"border-rose-300 dark:border-rose-700 shadow-[0_0_15px_rgba(225,29,72,0.1)]":"border-slate-200 dark:border-slate-700 shadow-sm"} relative overflow-hidden group hover:-translate-y-1 transition-all">
                ...
                <div class="mb-3 space-y-1.5 bg-slate-50 dark:bg-slate-900/30 p-3 rounded-xl border border-slate-100 dark:border-slate-800">
                    <div class="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-2 flex justify-between">
                        ...
                        <span>Total: ${x(r.payment.installments.reduce((v,f)=>v+(parseFloat(f.amount)||0),0))}</span>
                    </div>
                    ${r.payment.installments.map(v=>`
        ...
        </div>`}).join("");$("admin-content",a+s)},$s=async e=>{const t=(lt||[]).find(a=>a.id===e);t&&typeof window.customPrompt=="function"&&window.customPrompt("Tulis balasan untuk ulasan ini:",t.adminReply||"",async a=>{A("Menyimpan balasan...");try{await w.collection("freshmart").doc("cms_data").collection("reviews").doc(e.toString()).update({adminReply:a}),u("Balasan tersimpan!")}catch{u("Gagal menyimpan balasan!")}finally{P()}})},Ps=async e=>{const t=(lt||[]).find(r=>r.id===e);if(!t)return;const a=t.isVisible===!1;A("Menyimpan...");try{await w.collection("freshmart").doc("cms_data").collection("reviews").doc(e.toString()).update({isVisible:a}),u(a?"Ulasan ditampilkan lagi!":"Ulasan disembunyikan dari halaman produk!")}catch{u("Gagal mengubah status ulasan!")}finally{P()}},As=e=>{ve("Hapus Ulasan","Ulasan yang dihapus tidak bisa dikembalikan lagi.",async()=>{A("Menghapus...");try{await w.collection("freshmart").doc("cms_data").collection("reviews").doc(e.toString()).delete(),u("Ulasan dihapus!")}catch{u("Gagal menghapus ulasan!")}finally{P()}})};window.filterReviews=Ss;window.rAdmReviews=zt;window.replyToReview=$s;window.toggleReviewVisibility=Ps;window.deleteReview=As;window.rAdmL=e=>{Je(e),typeof window.setCTab=="function"&&window.setCTab(e),window.cTab=e,$("admin-content",`
        ...
        <div class="p-4 sm:p-5 md:p-6 lg:p-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4 rounded-[1.5rem] border shadow-sm cursor-pointer hover:shadow-md hover:-translate-y-1 hover:border-[var(--color-primary)]/40 dark:hover:border-[var(--color-primary)]/40 transition-all duration-300 ${m}" onclick="oAEd('${e}','${i.id}')">
            <div class="flex items-start sm:items-center gap-4 min-w-0 w-full">
                ...
                <div class="min-w-0 flex flex-col justify-center py-1">
                    ...
                    ${d&&v&&C?`<p class="text-[10px] font-bold mt-1 ${(i.variants&&i.variants.length?i.variants.reduce((B,j)=>B+(parseFloat(j.stock)||0),0):parseFloat(i.stock)||0)===0?"text-rose-500 animate-pulse":"text-blue-500"}"><i class="fa-solid fa-boxes-stacked mr-1"></i>Stok: ${i.variants&&i.variants.length?i.variants.reduce((B,j)=>B+(parseFloat(j.stock)||0),0).toFixed(2).replace(/\.?0+$/,""):parseFloat(i.stock)||0}</p>`:""}
                    ${d&&v&&i.hpp?`<p class="text-[10px] font-bold text-amber-500 mt-0.5"><i class="fa-solid fa-coins mr-1"></i>HPP: ${x(i.hpp)}</p>`:""}
                    ${d?(()=>{const B=i.variants&&i.variants.length?i.variants.reduce((j,_)=>j+(parseFloat(_.totalSold)||0),0):parseFloat(i.totalSold)||0;return B>0?`<p class="text-[10px] font-bold text-orange-400 mt-0.5"><i class="fa-solid fa-fire-flame-curved mr-1"></i>Terjual: ${B}</p>`:""})():""}
...
>`,s+="</div>"}),s=`<div class="grid grid-cols-1 lg:grid-cols-2 gap-x-5 gap-y-5 items-start">${s}</div>`,$("admin-modal-form",s),e==="products"&&(window.rVarsB?.(),window.rWholB?.(),window.rSpecB?.());const d=h("admin-modal");d&&d.classList.contains("hidden")&&Fs("admin"),O("admin-modal"),setTimeout(()=>{h("admin-modal").classList.remove("opacity-0"),h("admin-modal-box").classList.remove("scale-95")},10)};window.submitAdminForm=async()=>{if(we)return;M(!0);const e=yt||window.cTab||"products";let t={},a=ct[e]||[];for(let s of a)if(s.type==="variants_builder")t.variants=W.filter(l=>l.name.trim()!=="");else if(s.type==="wholesale_builder")t.wholesale=ue.filter(l=>parseFloat(l.minQty)>.01&&l.price>0);else if(s.type==="spec_table_builder")t.specTable=ee.filter(l=>l.key.trim()!=="");else{let l="";if(s.type==="richtext"){const n=h(`af-${s.key}-editor`);l=n?n.innerHTML:""}else l=y(`af-${s.key}`);if(typeof l=="string"){if(l.startsWith("data:image/")&&l.length>3e5)return M(!1),u("Gambar Base64 terlalu besar! Upload file.");s.key==="img"&&(l=I(l))}t[s.key]=s.type==="number"?parseFloat(l)||0:l}if(!t.name&&!t.title&&!t.bankName&&!t.code)return M(!1),u("Judul/Nama/Kode wajib diisi!");if(e==="products"&&!t.sku&&(t.sku="SKU"+Date.now().toString().slice(-6)),e==="customers"){const s=window.normalizeWA?window.normalizeWA(t.phone):(t.phone||"").replace(/\D/g,"").replace(/^0/,"62");if(!s||s.length<10)return M(!1),u("Nomor WhatsApp tidak valid!");t.phone=s,t.points=parseFloat(t.points)||0,t.id=parseInt(s,10)}let r=null;if(e==="customers")if(o.customers||(o.customers=[]),X){r=X;let s=o.customers.findIndex(l=>l.id===X);s>-1?o.customers[s]=t:o.customers.unshift(t)}else o.customers.unshift(t);else if(e==="rewards")if(o.rewards||(o.rewards=[]),X){t.id=X;let s=o.rewards.findIndex(l=>l.id===X);s>-1&&(o.rewards[s]=t)}else t.id=Date.now(),o.rewards.unshift(t);else if(X){t.id=X,o[e]||(o[e]=[]);let s=o[e].findIndex(l=>l.id===X);if(e==="products"&&s>-1){const l=o[e][s];t.totalSold=l.totalSold||0,t.variants&&t.variants.length&&l.variants&&t.variants.forEach(n=>{const i=l.variants.find(d=>d.name===n.name);i&&i.totalSold&&(n.totalSold=i.totalSold)})}s>-1&&(o[e][s]=t)}else t.id=Date.now(),o[e]||(o[e]=[]),o[e].unshift(t);A("Menyimpan...");try{const s=typeof w<"u"&&w?w:window.db,l=typeof H=="function"?H:window.saveApp||(async()=>{});if(!s)throw new Error("Database Firebase belum terhubung");if(e==="products")await s.collection("freshmart").doc("cms_data").collection("products").doc(t.id.toString()).set(t),await l([],{updateType:"product_single",updatedProductIds:[t.id.toString()]});else if(e==="customers"){const n=s.collection("freshmart").doc("cms_data").collection("customers");r!==null&&r!==t.id&&await n.doc(r.toString()).delete().catch(()=>{}),await n.doc(t.phone).set(t,{merge:!0})}else e==="rewards"?await s.collection("freshmart").doc("cms_data").collection("rewards").doc(t.id.toString()).set(t):await l([e]);window.closeAdminModal?.(),window.rAdmItms?.(e),u("Tersimpan!")}catch(s){console.error("Gagal simpan admin data:",s),u("Gagal menyimpan: "+(s.message||""))}finally{M(!1),P()}};window.oADel=async(e,t)=>{window.showConfirm?.("Hapus Data","Data yang dihapus tidak bisa dikembalikan lagi.",async()=>{if(we)return;M(!0);const a=typeof w<"u"&&w?w:window.db,r=typeof H=="function"?H:window.saveApp||(async()=>{}),s=o[e]&&o[e].find(l=>l.id===t);o[e]=o[e].filter(l=>l.id!==t),A("Menghapus...");try{if(!a)throw new Error("Database Firebase belum terhubung");if(e==="products")await a.collection("freshmart").doc("cms_data").collection("products").doc(t.toString()).delete(),await r([],{updateType:"product_delete",updatedProductIds:[t.toString()]});else if(e==="customers"){const l=s?s.phone:t.toString();await a.collection("freshmart").doc("cms_data").collection("customers").doc(l).delete()}else e==="rewards"?await a.collection("freshmart").doc("cms_data").collection("rewards").doc(t.toString()).delete():await r([e]);window.rAdmItms?.(e),u("Berhasil Dihapus!")}catch(l){u("Gagal menghapus: "+(l.message||""))}finally{M(!1),P()}})};window.duplicateProduct=async e=>{window.showConfirm?.("Duplikat Produk","Menyalin data produk ini ke item baru?",async()=>{if(we)return;M(!0);const t=typeof w<"u"&&w?w:window.db,a=typeof H=="function"?H:window.saveApp||(async()=>{}),r=o.products.find(l=>l.id===e);if(!r){M(!1);return}let s=JSON.parse(JSON.stringify(r));s.id=Date.now()+Math.floor(Math.random()*1e3),s.name=s.name+" COPY",s.sku="",s.totalSold=0,s.variants&&s.variants.length>0&&(s.variants=s.variants.map(l=>(l.sku="",l.totalSold=0,l))),o.products.unshift(s),A("Menyalin...");try{if(!t)throw new Error("Database Firebase belum terhubung");await t.collection("freshmart").doc("cms_data").collection("products").doc(s.id.toString()).set(s),await a([],{updateType:"product_single",updatedProductIds:[s.id.toString()]}),window.rAdmItms?.("products"),u("Produk berhasil disalin!")}catch(l){u("Gagal menyalin: "+(l.message||""))}finally{M(!1),P()}},"Ya, Salin",!1)};window.rSpecB=()=>{const e=document.getElementById("spec-table-builder-container");if(!e)return;let t="";ee.length>0?t+=`<div class="overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm mb-4">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-4">
        ...
        </div>`)};window.confirmExportAllVariants=async()=>{const e=(document.getElementById("expall-catalog")?.value||"").trim(),t=W.filter(s=>s.name.trim());o.colors||(o.colors=[]);const a=new Set(o.colors.map(s=>s.name.toLowerCase()));let r=0;if(t.forEach(s=>{a.has(s.name.trim().toLowerCase())||(o.colors.push({id:Date.now()+r,name:s.name.trim(),hex:s.colorCode||"",catalog:e}),a.add(s.name.trim().toLowerCase()),r++)}),_closeColorFloatModal(),!r){u("Semua varian sudah ada di Database Warna!");return}A("Menyimpan...");try{await H(["colors"]),u(`${r} warna berhasil diekspor ke Database Warna! 🎨`)}catch{u("Gagal menyimpan!")}finally{P()}};window.openImportFromProductsModal=async()=>{const e=[];if((o.products||[]).forEach(l=>{(l.variants||[]).forEach(n=>{n.name&&n.name.trim()&&e.push({varName:n.name.trim(),hex:n.colorCode||"",prodName:l.name||""})})}),!e.length){u("Tidak ada varian produk yang ditemukan!");return}const t=new Set((o.colors||[]).map(l=>l.name.toLowerCase())),a=e.filter(l=>!t.has(l.varName.toLowerCase()));if(!a.length){u("Semua varian produk sudah ada di Database Warna!");return}let s=[...new Set((o.colors||[]).map(l=>l.catalog).filter(Boolean))].map(l=>`<option value="${c(l)}">${c(l)}</option>`).join("");window._pendingImportVariants=a,_openColorFloatModal(`
        <div class="p-6">
        ...
        </div>`,s.style.opacity="0",s.style.display="flex",requestAnimationFrame(()=>{s.style.transition="opacity 0.25s ease",s.style.opacity="1"}),Ks("restock")};window.closeRestockModal=(e=!1)=>{Xt("restock",e,()=>{const t=document.getElementById("restock-modal");!t||t.style.display==="none"||(t.style.opacity="0",t.style.transition="opacity 0.25s ease",setTimeout(()=>{t.style.display="none",t.style.opacity="",t.style.transition=""},250))})};window.processRestock=async e=>{if(we)return;M(!0);const t=o.products.findIndex(n=>n.id===e);if(t<0){M(!1);return}const a=o.products[t],r=a.variants&&a.variants.length>0;let s=JSON.parse(JSON.stringify(a)),l=0;if(r)s.variants=s.variants.map((i,d)=>{const p=parseFloat(document.getElementById("restock-var-"+d)?.value)||0;return p>0&&(i.stock=(parseFloat(i.stock)||0)+p,l+=p,i.stock>0&&(i.isActive===!1||i.isActive==="false")&&(i.isActive=!0)),i}),s.variants.some(i=>(parseFloat(i.stock)||0)>0&&i.isActive!==!1&&i.isActive!=="false")&&(s.isActive===!1||s.isActive==="false")&&(s.isActive="true");else{const n=parseFloat(document.getElementById("restock-main")?.value)||0;n>0&&(s.stock=(parseFloat(s.stock)||0)+n,l+=n,s.stock>0&&(s.isActive===!1||s.isActive==="false")&&(s.isActive="true"))}if(l<=0)return M(!1),u("Masukkan jumlah restock terlebih dahulu!");A("Menyimpan Restock...");try{const n=typeof w<"u"&&w?w:window.db,i=typeof H=="function"?H:window.saveApp||(async()=>{});if(!n)throw new Error("Database Firebase belum terhubung");const d=n.collection("freshmart").doc("cms_data").collection("products").doc(e.toString());let p=0;await n.runTransaction(async m=>{const b=await m.get(d);if(!b.exists)throw new Error("Produk tidak ditemukan di server");const g=JSON.parse(JSON.stringify(b.data()));if(r)a.variants.forEach((f,S)=>{const C=parseFloat(document.getElementById("restock-var-"+S)?.value)||0;if(C<=0)return;const T=(g.variants||[]).findIndex(k=>k.name===f.name);T>-1&&(g.variants[T].stock=(parseFloat(g.variants[T].stock)||0)+C,g.variants[T].stock>0&&(g.variants[T].isActive===!1||g.variants[T].isActive==="false")&&(g.variants[T].isActive=!0))}),g.variants.some(f=>(parseFloat(f.stock)||0)>0&&f.isActive!==!1&&f.isActive!=="false")&&(g.isActive===!1||g.isActive==="false")&&(g.isActive="true"),p=g.variants.reduce((f,S)=>f+(parseFloat(S.stock)||0),0);else{const v=parseFloat(document.getElementById("restock-main")?.value)||0;g.stock=(parseFloat(g.stock)||0)+v,g.stock>0&&(g.isActive===!1||g.isActive==="false")&&(g.isActive="true"),p=g.stock}m.set(d,g),Object.assign(s,g)}),o.products[t]=s,await i([],{updateType:"stock_change",updatedProductIds:[e.toString()]}),closeRestockModal(),window.rAdmItms?.("products"),K("stat-products",o.products.filter(m=>m.isActive!=="false"&&m.isActive!==!1).length),u(`✅ Restock +${l} berhasil! Total stok: ${p}`)}catch(n){u("Gagal restock: "+(n.message||""))}finally{M(!1),P()}};window.toggleProductStatus=async(e,t)=>{if(we)return;M(!0);const a=o.products.findIndex(r=>r.id!=null&&r.id.toString()===e.toString());if(a>-1){o.products[a].isActive=t?"true":"false",A(t?"Mengaktifkan...":"Menonaktifkan...");try{const r=typeof w<"u"&&w?w:window.db,s=typeof H=="function"?H:window.saveApp||(async()=>{});if(!r)throw new Error("Database Firebase belum terhubung");await r.collection("freshmart").doc("cms_data").collection("products").doc(e.toString()).update({isActive:t?"true":"false"}),await s([],{updateType:"stock_change",updatedProductIds:[e.toString()]}),K("stat-products",o.products.filter(l=>l.isActive!=="false"&&l.isActive!==!1).length),window.rAdmItms?.("products"),u(t?"Produk Aktif!":"Stok Dikosongkan!")}catch(r){u("Gagal update status: "+(r.message||""))}finally{M(!1),P()}}else M(!1)};window.closeAdminModal=(e=!1)=>{Xt("admin",e,()=>{h("admin-modal").classList.add("opacity-0"),h("admin-modal-box").classList.add("scale-95"),setTimeout(()=>F("admin-modal"),300)})};const Hs=e=>window.pushModalHistory?.(e),Us=(e,t,a)=>window.requestCloseModal?.(e,t,a);let U;window.openCameraScanner=async(e="search-input")=>{const t=h("scanner-modal");t&&t.classList.contains("hidden")&&Hs("scanner"),O("scanner-modal"),setTimeout(()=>{h("scanner-modal").classList.remove("opacity-0")},10);try{await Rt("https://cdnjs.cloudflare.com/ajax/libs/html5-qrcode/2.3.8/html5-qrcode.min.js",()=>typeof Html5Qrcode<"u")}catch{u("Gagal memuat modul kamera. Cek koneksi internet Anda."),closeCameraScanner();return}U||(U=new Html5Qrcode("reader"));const a={fps:10,qrbox:{width:250,height:250}};setTimeout(()=>{U&&U.start({facingMode:"environment"},a,r=>{let s=h(e);s&&(s.value=r,e==="search-input"?window.handleSearch?.(r):(s.dispatchEvent(new Event("input",{bubbles:!0})),s.dispatchEvent(new Event("change",{bubbles:!0})))),u("Barcode discan!"),closeCameraScanner()},r=>{}).catch(r=>{u("Akses kamera ditolak/gagal!"),closeCameraScanner()})},100)};window.closeCameraScanner=(e=!1)=>{Us("scanner",e,()=>{if(h("scanner-modal").classList.add("opacity-0"),U)try{U.getState()===2||U.getState()===3?U.stop().then(()=>{U.clear(),U=null}).catch(t=>{U.clear(),U=null}):(U.clear(),U=null)}catch{U=null}setTimeout(()=>F("scanner-modal"),300)})};const Vs=e=>window.pushModalHistory?.(e),Gs=(e,t,a)=>window.requestCloseModal?.(e,t,a);let Ne=[];window.openQuickPriceModal=e=>{const t=o.products.find(l=>l.id===e);if(!t)return;const a=t.variants&&t.variants.length>0;Ne=!a&&t.wholesale?JSON.parse(JSON.stringify(t.wholesale)):[];let r="";a?r=t.variants.map((l,n)=>`
        ...
        </div>`;return}let r="";a.forEach((s,l)=>{const n=l===0&&Le==="all",i=Js(s.category),d=zs(s.date),p=(s.items||[]).map(m=>`
...
`).map(i=>i.replace(/^[-*•]\s*/,"").trim()).filter(i=>i.length>0);if(l.length===0)return u("Rincian perubahan tidak boleh kosong!");A("Menyimpan catatan pembaruan...");const n={id:ye||"log-"+Date.now().toString(36),version:e.startsWith("v")?e:"v"+e,category:t,date:a,title:r,items:l,updatedAt:new Date().toISOString()};if(o.changelog=o.changelog||[],ye){const i=o.changelog.findIndex(d=>d.id===ye);i!==-1?o.changelog[i]=n:o.changelog.unshift(n)}else o.changelog.unshift(n);try{await H(["changelog"]),u("Catatan pembaruan berhasil dipublikasikan secara real-time!","success"),$e=!1,ye=null,Fe()}catch(i){u("Gagal menyimpan log pembaruan: "+i.message,"error")}finally{P()}},ar=e=>{const t=(o.changelog||[]).find(a=>a.id===e);t&&ve(`Hapus catatan pembaruan versi "${t.version}"?`,async()=>{A("Menghapus catatan..."),o.changelog=(o.changelog||[]).filter(a=>a.id!==e);try{await H(["changelog"]),u("Catatan berhasil dihapus!","success"),Fe()}catch(a){u("Gagal menghapus catatan: "+a.message,"error")}finally{P()}},"Ya, Hapus","Konfirmasi Hapus")};window.rAdmChangelog=Fe;window.toggleChangelogForm=Zs;window.editChangelogEntry=er;window.saveChangelogEntry=tr;window.deleteChangelogEntry=ar;export{Sa as A,Se as a,Pe as b,Ae as c,w as d,_s as e,Es as f,Rs as g,$a as h,lr as i,Ns as j,q as k,ir as l,Ot as m,Kt as n,qe as o,Ge as p,Nt as q,_e as r,ts as s,nr as t,Y as u,dr as v,Jt as w};
