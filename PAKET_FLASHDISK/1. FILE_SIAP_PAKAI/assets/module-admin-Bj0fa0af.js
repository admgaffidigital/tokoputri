...
import{a as r,c as D,s as Je,b as F,d as O,f as x,e as h,g as _,h as E,i as S,j as c,w as Y,k as u,l as he,t as re,m as St,n as Kt,o as ge,p as be,q as ue,r as oe,u as Te,v as Ae,x as xt,y as Pt,z as Tt,A as At,B as Gt,C as Wt,D as fe,E as $,F as T,G as P,H as ce,I as Me,J as ne,K as je,L as de,M as Ie,N as zt,O as Jt,P as z,Q as Ct,R as Qt,S as Yt,T as He,U as pe,V as Xt,W as ht,X as j,Y as Ze,Z as Zt,_ as ea,$ as ta,a0 as aa,a1 as et,a2 as le,a3 as G,a4 as sa,a5 as ra,a6 as oa}from"./module-print-BNRNvO6h.js";import{f as W}from"./vendor-firebase-core-D2OF5R23.js";import"./vendor-firebase-db-BIUZcnOd.js";const la="modulepreload",ia=function(e){return"/"+e},vt={},na=function(t,a,o){let s=Promise.resolve();if(a&&a.length>0){document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),l=n?.nonce||n?.getAttribute("nonce");s=Promise.allSettled(a.map(p=>{if(p=ia(p),p in vt)return;vt[p]=!0;const d=p.endsWith(".css"),m=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${p}"]${m}`))return;const b=document.createElement("link");if(b.rel=d?"stylesheet":la,d||(b.as="script"),b.crossOrigin="",b.href=p,l&&b.setAttribute("nonce",l),document.head.appendChild(b),d)return new Promise((g,v)=>{b.addEventListener("load",g),b.addEventListener("error",()=>v(new Error(`Unable to preload CSS for ${p}`)))})}))}function i(n){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=n,window.dispatchEvent(l),!l.defaultPrevented)throw n}return s.then(n=>{for(const l of n||[])l.status==="rejected"&&i(l.reason);return t().catch(i)})},da={apiKey:"AIzaSyCOjrhMP52TGbiOyQLY92NDYE26N6d9hJM",authDomain:"restu-karya-utama.firebaseapp.com",databaseURL:"https://restu-karya-utama-default-rtdb.asia-southeast1.firebasedatabase.app",projectId:"restu-karya-utama",storageBucket:"restu-karya-utama.firebasestorage.app",messagingSenderId:"858310421352",appId:"1:858310421352:web:e20a833875e8d5c19944dd",measurementId:"G-PHDG2LJ8PM"};try{localStorage.removeItem("freshmart_fb_config")}catch{}const jt=window.FIREBASE_CONFIG||da;W.apps.length||W.initializeApp(jt);const y=W.firestore(),J=W.auth();typeof window<"u"&&(window.firebase=W,window.db=y,window.auth=J);try{y.settings({ignoreUndefinedProperties:!0,experimentalAutoDetectLongPolling:!0,merge:!0})}catch{}let ca=null;const Hs=()=>{na(()=>import("./vendor-firebase-analytics-Jm19L5g2.js"),__vite__mapDeps([0,1])).then(()=>{try{ca=W.analytics()}catch{}}).catch(()=>{})},pa="K2ijSERTT2dg27yYGTEgn6XHSnW2",ke={emerald:{50:"#ecfdf5",100:"#d1fae5",200:"#a7f3d0",300:"#6ee7b7",400:"#34d399",500:"#10b981",600:"#059669",700:"#047857",800:"#065f46",900:"#064e3b"},teal:{50:"#f0fdfa",100:"#ccfbf1",200:"#99f6e4",300:"#5eead4",400:"#2dd4bf",500:"#14b8a6",600:"#0d9488",700:"#0f766e",800:"#115e59",900:"#134e4a"},cyan:{50:"#ecfeff",100:"#cffafe",200:"#a5f3fc",300:"#67e8f9",400:"#22d3ee",500:"#06b6d4",600:"#0891b2",700:"#0e7490",800:"#155e75",900:"#164e63"},sky:{50:"#f0f9ff",100:"#e0f2fe",200:"#bae6fd",300:"#7dd3fc",400:"#38bdf8",500:"#0ea5e9",600:"#0284c7",700:"#0369a1",800:"#075985",900:"#0c4a6e"},blue:{50:"#eff6ff",100:"#dbeafe",200:"#bfdbfe",300:"#93c5fd",400:"#60a5fa",500:"#3b82f6",600:"#2563eb",700:"#1d4ed8",800:"#1e40af",900:"#1e3a8a"},indigo:{50:"#eef2ff",100:"#e0e7ff",200:"#c7d2fe",300:"#a5b4fc",400:"#818cf8",500:"#6366f1",600:"#4f46e5",700:"#4338ca",800:"#3730a3",900:"#312e81"},violet:{50:"#f5f3ff",100:"#ede9fe",200:"#ddd6fe",300:"#c4b5fd",400:"#a78bfa",500:"#8b5cf6",600:"#7c3aed",700:"#6d28d9",800:"#5b21b6",900:"#4c1d95"},purple:{50:"#faf5ff",100:"#f3e8ff",200:"#e9d5ff",300:"#d8b4fe",400:"#c084fc",500:"#a855f7",600:"#9333ea",700:"#7e22ce",800:"#6b21a8",900:"#581c87"},fuchsia:{50:"#fdf4ff",100:"#fae8ff",200:"#f5d0fe",300:"#f0abfc",400:"#e879f9",500:"#d946ef",600:"#c026d3",700:"#a21caf",800:"#86198f",900:"#701a75"},pink:{50:"#fdf2f8",100:"#fce7f3",200:"#fbcfe8",300:"#f9a8d4",400:"#f472b6",500:"#ec4899",600:"#db2777",700:"#be185d",800:"#9d174d",900:"#831843"},rose:{50:"#fff1f2",100:"#ffe4e6",200:"#fecdd3",300:"#fda4af",400:"#fb7185",500:"#f43f5e",600:"#e11d48",700:"#be123c",800:"#9f1239",900:"#881337"},red:{50:"#fef2f2",100:"#fee2e2",200:"#fecaca",300:"#fca5a5",400:"#f87171",500:"#dc2626",600:"#b91c1c",700:"#991b1b",800:"#7f1d1d",900:"#450a0a"},orange:{50:"#fff7ed",100:"#ffedd5",200:"#fed7aa",300:"#fdba74",400:"#fb923c",500:"#ea580c",600:"#c2410c",700:"#9a3412",800:"#7c2d12",900:"#431407"},amber:{50:"#fffbeb",100:"#fef3c7",200:"#fde68a",300:"#fcd34d",400:"#fbbf24",500:"#d97706",600:"#b45309",700:"#92400e",800:"#78350f",900:"#451a03"},yellow:{50:"#fefce8",100:"#fef9c3",200:"#fef08a",300:"#fde047",400:"#eab308",500:"#d97706",600:"#b45309",700:"#854d0e",800:"#713f12",900:"#3f1d0b"},lime:{50:"#f7fee7",100:"#ecfccb",200:"#d9f99d",300:"#bef264",400:"#a3e635",500:"#65a30d",600:"#4d7c0f",700:"#3f6212",800:"#365314",900:"#1a2e05"},green:{50:"#f0fdf4",100:"#dcfce7",200:"#bbf7d0",300:"#86efac",400:"#4ade80",500:"#16a34a",600:"#15803d",700:"#166534",800:"#14532d",900:"#052e16"},slate:{50:"#f8fafc",100:"#f1f5f9",200:"#e2e8f0",300:"#cbd5e1",400:"#94a3b8",500:"#475569",600:"#334155",700:"#1e293b",800:"#0f172a",900:"#020617"},stone:{50:"#fafaf9",100:"#f5f5f4",200:"#e7e5e4",300:"#d6d3d1",400:"#a8a29e",500:"#57534e",600:"#44403c",700:"#292524",800:"#1c1917",900:"#0c0a09"}},ma=e=>{let t=parseInt(e.replace("#",""),16);return(t>>16&255)+","+(t>>8&255)+","+(t&255)},wt=(e,t)=>{let a=parseInt(e.slice(1,3),16),o=parseInt(e.slice(3,5),16),s=parseInt(e.slice(5,7),16);return a=Math.max(0,Math.min(255,a+t)),o=Math.max(0,Math.min(255,o+t)),s=Math.max(0,Math.min(255,s+t)),"#"+[a,o,s].map(i=>i.toString(16).padStart(2,"0")).join("")},ba=e=>{if(!e)return;try{document.querySelectorAll('meta[name="theme-color"]').forEach(p=>p.remove())}catch{}const t=document.createElement("meta");t.setAttribute("name","theme-color"),t.setAttribute("content",e),document.head.appendChild(t);try{document.querySelectorAll('meta[name="msapplication-navbutton-color"], meta[name="msapplication-TileColor"]').forEach(p=>p.remove())}catch{}const a=document.createElement("meta");a.setAttribute("name","msapplication-navbutton-color"),a.setAttribute("content",e),document.head.appendChild(a);const o=document.createElement("meta");o.setAttribute("name","msapplication-TileColor"),o.setAttribute("content",e),document.head.appendChild(o);let s=document.querySelector('meta[name="apple-mobile-web-app-capable"]');s||(s=document.createElement("meta"),s.setAttribute("name","apple-mobile-web-app-capable"),document.head.appendChild(s)),s.setAttribute("content","yes");let i=document.querySelector('meta[name="mobile-web-app-capable"]');i||(i=document.createElement("meta"),i.setAttribute("name","mobile-web-app-capable"),document.head.appendChild(i)),i.setAttribute("content","yes");let n=document.querySelector('meta[name="apple-mobile-web-app-status-bar-style"]');n||(n=document.createElement("meta"),n.setAttribute("name","apple-mobile-web-app-status-bar-style"),document.head.appendChild(n)),n.setAttribute("content","default"),typeof window.updatePwaManifest=="function"&&window.updatePwaManifest(e)},$e=(e,t)=>{const a=e||localStorage.getItem("freshmart_ui_theme")||"emerald",o=ke[a]||ke.emerald;e&&localStorage.setItem("freshmart_ui_theme",a);const s=t||localStorage.getItem("freshmart_theme_color")||o[500];t&&localStorage.setItem("freshmart_theme_color",s);const i=ma(s),n=wt(s,-30),l=wt(s,150);return document.documentElement.style.setProperty("--color-primary",s),document.documentElement.style.setProperty("--color-primary-dark",n),document.documentElement.style.setProperty("--color-primary-light",l),document.documentElement.style.setProperty("--color-primary-rgb",i),ba(s),o},Us=()=>{const e=localStorage.getItem("freshmart_theme"),t=window.matchMedia("(prefers-color-scheme: dark)").matches;(e==="dark"||!e&&t)&&document.documentElement.classList.add("dark")},Vs=()=>{const e=document.documentElement.classList.toggle("dark");localStorage.setItem("freshmart_theme",e?"dark":"light");const t=document.getElementById("icon-theme")||document.getElementById("theme-toggle-icon");t&&(t.className=e?"fa-solid fa-sun text-sm text-amber-400":"fa-solid fa-moon text-sm text-slate-600 dark:text-slate-300")},qs=()=>{const e=document.documentElement.classList.contains("dark"),t=document.getElementById("icon-theme")||document.getElementById("theme-toggle-icon");t&&(t.className=e?"fa-solid fa-sun text-sm text-amber-400":"fa-solid fa-moon text-sm text-slate-600 dark:text-slate-300")},Se=(e="minimalist",t="")=>{const a=e||localStorage.getItem("freshmart_bg_style")||"minimalist",o=t??(localStorage.getItem("freshmart_bg_custom_url")||"");e&&localStorage.setItem("freshmart_bg_style",a),t!=null&&localStorage.setItem("freshmart_bg_custom_url",o);const i=(d=>{if(!d||typeof d!="string")return"";const m=d.match(/drive\.google\.com.*(?:id=|\/d\/)([a-zA-Z0-9_-]+)/);return m?`https://lh3.googleusercontent.com/d/${m[1]}`:d.trim()})(o);document.documentElement.setAttribute("data-bg-style",a),document.body?.setAttribute("data-bg-style",a);const n=document.getElementById("app-container");n&&(n.setAttribute("data-bg-style",a),i?n.setAttribute("data-has-custom-bg","true"):n.removeAttribute("data-has-custom-bg"));const l=document.getElementById("dynamic-bg-container");if(!l)return;if(l.innerHTML="",l.className="pointer-events-none fixed inset-0 z-0 overflow-hidden",i){const d=document.createElement("div");d.className="absolute inset-0 z-0 bg-cover bg-center bg-no-repeat bg-fixed opacity-35 dark:opacity-25 pointer-events-none transition-all duration-500",d.style.backgroundImage=`url('${i}')`,l.appendChild(d);const m=document.createElement("div");m.className="absolute inset-0 z-0 bg-slate-50/70 dark:bg-[#0b1120]/80 pointer-events-none backdrop-blur-[0.5px]",l.appendChild(m)}let p="";if(a==="hero_arch"?p=`
        ...
        <div class="bg-white dark:bg-slate-800 p-4 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm flex gap-4 relative overflow-hidden group min-w-0 hover:shadow-md hover:-translate-y-1 hover:border-rose-300 dark:hover:border-rose-600 transition-all duration-300">
        ...
        </div>`}).join(""))};window.updWish=Le;window.rmWish=va;window.moveWish=wa;window.clearWishlist=ka;window.renderWish=tt;let kt=null;const Z=()=>{const e=ue!=="Semua Produk"||oe!=="Semua Merek"||Te!=="";re("dynamic-banners-container","hidden",e),re("reward-catalog-container","hidden",e),re("dynamic-vouchers-container","hidden",e),re("dynamic-categories-container","hidden",e),re("dynamic-brands-container","hidden",e);const t=r.store.showCategories!==!1&&r.store.showCategories!=="false",a=r.store.showBrands!==!1&&r.store.showBrands!=="false";re("sec-categories","hidden",e||!t),re("sec-brands","hidden",e||!a);let o=h("dynamic-active-filter");if(!o){let l=h("product-container");l&&(l.insertAdjacentHTML("beforebegin",'<div id="dynamic-active-filter" class="transition-all w-full"></div>'),o=h("dynamic-active-filter"))}if(o)if(e){let l="Menampilkan",p="",d="fa-filter",m="text-[var(--color-primary)] bg-[var(--color-primary-light)] dark:bg-[var(--color-primary-dark)]/30";Te!==""?(l="Hasil Pencarian",p=`"${Te}"`,d="fa-magnifying-glass",m="text-rose-500 bg-rose-50 dark:bg-rose-900/30"):ue!=="Semua Produk"?(l="Kategori Pilihan",p=ue,d="fa-layer-group",m="text-[var(--color-primary)] bg-[var(--color-primary-light)] dark:bg-[var(--color-primary-dark)]/30"):oe!=="Semua Merek"&&(l="Merek Pilihan",p=oe,d="fa-tag",m="text-[var(--color-primary)] bg-[var(--color-primary-light)] dark:bg-[var(--color-primary-dark)]/30"),o.innerHTML=`
            ...
            </div>`,o.classList.remove("hidden")}else o.innerHTML="",o.classList.add("hidden");let s=r.products.filter(l=>{if(l.isActive===!1||l.isActive==="false"||ue!=="Semua Produk"&&l.category!==ue||oe!=="Semua Merek"&&l.brand!==oe)return!1;if(!Te)return!0;let p=Te.toLowerCase();return(l.name||"").toLowerCase().includes(p)||(l.sku||"").toLowerCase().includes(p)||(l.category||"").toLowerCase().includes(p)||(l.brand||"").toLowerCase().includes(p)||l.variants&&l.variants.some(d=>(d.name||"").toLowerCase().includes(p)||(d.sku||"").toLowerCase().includes(p))}).sort((l,p)=>Ae==="cheapest"?(l.price||0)-(p.price||0):Ae==="expensive"?(p.price||0)-(l.price||0):Ae==="az"?(l.name||"").localeCompare(p.name||""):Ae==="za"?(p.name||"").localeCompare(l.name||""):Ae==="oldest"?(l.id||0)-(p.id||0):(p.id||0)-(l.id||0));const i=h("product-container");if(!i)return;if(i.className=xt==="grid"?"grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-5 2xl:grid-cols-6 gap-4 sm:gap-6 lg:gap-8":"flex flex-col gap-3 sm:gap-4",!s.length){i.innerHTML='<div class="col-span-full text-center py-16 sm:py-24 text-slate-500 dark:text-slate-400 font-bold bg-slate-50 dark:bg-slate-800/50 rounded-[1.5rem] border border-slate-200 border-dashed dark:border-slate-700 text-sm sm:text-base flex flex-col items-center justify-center"><div class="w-20 h-20 bg-white dark:bg-slate-800 rounded-full flex items-center justify-center shadow-sm mb-4"><i class="fa-solid fa-box-open text-3xl sm:text-4xl text-slate-300 dark:text-slate-600"></i></div>Maaf, produk tidak ditemukan.<br><span class="text-xs font-medium text-slate-500 dark:text-slate-400 mt-2 font-normal">Coba gunakan kata kunci pencarian yang berbeda atau hapus filter.</span></div>',E("load-more-container");return}const n=s.slice(0,St*Kt);i.innerHTML=n.map(l=>{let p="";const d=r.store.useStock===!0||r.store.useStock==="true";let m="";if(d){const H=l.variants&&l.variants.length?l.variants.filter(U=>U.isActive!==!1&&U.isActive!=="false").reduce((U,Ge)=>U+(parseFloat(Ge.stock)||0),0):parseFloat(l.stock)||0;H<=0?p='<div class="absolute inset-0 bg-white/60 dark:bg-slate-900/60 backdrop-blur-[2px] z-20 flex items-center justify-center rounded-2xl"><span class="bg-slate-800 text-white text-[10px] font-bold px-3 py-1.5 rounded-xl shadow-lg uppercase tracking-widest"><i class="fa-solid fa-ban mr-1"></i> HABIS</span></div>':H<=5?m=`<span class="absolute top-2 left-2 z-10 bg-rose-500 text-white text-[8px] font-bold px-2 py-1 rounded-xl shadow uppercase tracking-wider"><i class="fa-solid fa-fire mr-0.5"></i> SISA ${H}</span>`:m=`<span class="absolute top-2 left-2 z-10 bg-slate-800/80 text-white text-[8px] font-bold px-2 py-1 rounded-xl shadow uppercase tracking-wider backdrop-blur-sm"><i class="fa-solid fa-box mr-0.5"></i> Stok ${H}</span>`}const b=!p,g=b?"cursor-pointer hover:shadow-md hover:-translate-y-1.5 hover:border-[var(--color-primary)]/40":"cursor-not-allowed",v=b?"cursor-pointer hover:shadow-md hover:-translate-y-1 hover:border-[var(--color-primary)]/40":"cursor-not-allowed";let f="",k="";l.priceNormal&&l.priceNormal>l.price&&(f=`<span class="bg-rose-500 text-white px-2 py-0.5 rounded-full text-[8px] font-bold flex items-center gap-1 whitespace-nowrap uppercase tracking-wider shadow-sm"><i class="fa-solid fa-tags"></i> -${Math.round((l.priceNormal-l.price)/l.priceNormal*100)}%</span>`,k=`<p class="text-[10px] text-slate-600 dark:text-slate-400 line-through mb-0.5 font-bold">${x(l.priceNormal)}</p>`);let C=l.poTime?`<span class="bg-amber-500 text-white px-2 py-0.5 rounded-full text-[8px] font-bold flex items-center gap-1 whitespace-nowrap uppercase tracking-wider shadow-sm"><i class="fa-solid fa-clock"></i> PO ${c(l.poTime)}</span>`:"",A="";if(l.variants&&l.variants.length){const H=l.variants.map(U=>parseFloat(U.poin)||0).filter(U=>U>0);if(H.length){const U=[...new Set(H)];A=U.length===1?`<span class="bg-[rgba(var(--color-primary-rgb),0.1)] text-[var(--color-primary)] px-2 py-0.5 rounded-full text-[8px] font-bold flex items-center gap-1 whitespace-nowrap uppercase tracking-wider"><i class="fa-solid fa-star"></i> +${U[0]} Poin</span>`:'<span class="bg-[rgba(var(--color-primary-rgb),0.1)] text-[var(--color-primary)] px-2 py-0.5 rounded-full text-[8px] font-bold flex items-center gap-1 whitespace-nowrap uppercase tracking-wider"><i class="fa-solid fa-star"></i> Dapat Poin</span>'}}else parseFloat(l.poin)>0&&(A=`<span class="bg-[rgba(var(--color-primary-rgb),0.1)] text-[var(--color-primary)] px-2 py-0.5 rounded-full text-[8px] font-bold flex items-center gap-1 whitespace-nowrap uppercase tracking-wider"><i class="fa-solid fa-star"></i> +${parseFloat(l.poin)} Poin</span>`);const w=l.variants&&l.variants.length?l.variants.reduce((H,U)=>H+(parseFloat(U.totalSold)||0),0):parseFloat(l.totalSold)||0,q=w>0?`<span class="bg-slate-200 text-slate-700 dark:bg-slate-700 dark:text-slate-300 px-2 py-0.5 rounded-full text-[8px] font-bold flex items-center gap-1 whitespace-nowrap uppercase tracking-wider"><i class="fa-solid fa-fire-flame-curved text-orange-400"></i> ${w} Terjual</span>`:"";let I=`<div class="mb-2.5 flex flex-wrap gap-1.5 items-center overflow-hidden shrink-0">
            ${f}
            ${C}
            ${A}
            ${q}
            ...
            <a href="?p=${l.id}" class="w-full bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700/50 rounded-[1.5rem] shadow-soft ${g} transition-all duration-300 flex flex-col group relative overflow-hidden text-left" onclick="event.preventDefault(); openProductModal(${l.id})">
                ...
                <div class="relative aspect-square w-full bg-white flex items-center justify-center shrink-0 border-b border-slate-100 dark:border-slate-700/50">
                      ${m}
                      <img loading="lazy" decoding="async" src="${c(ge(l.img,"w300-rw"))}" onerror="this.onerror=null;this.src='https://placehold.co/400?text=No+Image'" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105 ${p?"grayscale opacity-50":""}">
                </div>
            ...
            <a href="?p=${l.id}" class="w-full bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700/50 rounded-[1.5rem] shadow-soft ${v} transition-all duration-300 flex items-stretch p-2.5 sm:p-3 gap-3 sm:gap-4 group relative overflow-hidden text-left" onclick="event.preventDefault(); openProductModal(${l.id})">
                ${p}
                <div class="relative w-24 h-24 sm:w-28 sm:h-28 shrink-0 bg-white dark:bg-slate-900 rounded-xl flex items-center justify-center p-2 border border-slate-100 dark:border-slate-700/50 overflow-hidden">
                    ${m}
                    <img loading="lazy" decoding="async" src="${c(ge(l.img,"w300-rw"))}" onerror="this.onerror=null;this.src='https://placehold.co/400?text=No+Image'" class="max-w-full max-h-full object-contain transition-transform duration-500 group-hover:scale-105 ${p?"grayscale opacity-50":""}">
                </div>
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                <div class="card-modern p-5 sm:p-5">
                    ...
                    <p class="text-[10px] font-bold text-slate-400 mt-1">${f} pesanan${k?" (≥3000, dibatasi)":""}</p>
                </div>
                <div class="card-modern p-5 sm:p-5">
        ...
        `)},o=yt.get(e);if(o&&Date.now()-o.timestamp<Ia){a(o.data);return}S("admin-report-container",'<div class="text-center py-10"><i class="fa-solid fa-spinner fa-spin text-2xl text-slate-300"></i></div>');let s=null;const i=new Date;if(e==="today")s=new Date(i.getFullYear(),i.getMonth(),i.getDate());else if(e==="week"){const b=i.getDay(),g=b===0?6:b-1;s=new Date(i.getFullYear(),i.getMonth(),i.getDate()-g)}else e==="month"&&(s=new Date(i.getFullYear(),i.getMonth(),1));let n=0,l=0,p=0,d=0,m=!1;try{if(!J.currentUser){S("admin-report-container",'<div class="text-center py-10 text-slate-400"><i class="fa-solid fa-lock text-2xl mb-3"></i><p class="text-xs font-bold">Login terlebih dahulu untuk melihat laporan.</p></div>');return}let b=y.collection("freshmart_orders");s&&(b=b.where("timestamp",">=",W.firestore.Timestamp.fromDate(s)));const g=await b.limit(3e3).get();m=g.size>=3e3,g.forEach(f=>{const k=f.data();k.status!=="Dibatalkan"&&(d++,n+=parseFloat(k.payment?.subtotal)||0,p+=parseFloat(k.payment?.productDiscount)||0,(k.items||[]).forEach(C=>{const A=C.hpp!==void 0&&C.hpp!==null?parseFloat(C.hpp):typeof window.getEffHpp=="function"?window.getEffHpp(C):0;l+=(parseFloat(A)||0)*(parseFloat(C.qty)||0)}))});const v={totalPenjualan:n,totalHppTerjual:l,totalDiskonProduk:p,orderCount:d,truncated:m};yt.set(e,{data:v,timestamp:Date.now()}),a(v)}catch(b){console.error("Gagal memuat laporan penjualan:",b)}},Da=async()=>{const e=$("login-username"),t=$("login-password");if(!e||!t)return u("Email & Password wajib diisi!");T("Verifikasi Login...");try{if(await J.signInWithEmailAndPassword(e,t),!J.currentUser||J.currentUser.uid!==pa){const a=J.currentUser?J.currentUser.uid:"null";throw await J.signOut(),new Error("UID_MISMATCH: "+a)}window.isAdm=!0,history.replaceState({view:"view-admin"},"",window.location.href),typeof window.changeView=="function"&&window.changeView("view-admin",!0),Oe(),u("Login Berhasil!")}catch(a){if(console.error(a),a.message&&a.message.startsWith("UID_MISMATCH:")){const o=a.message.replace("UID_MISMATCH: ","");u("Login Ditolak: UID Anda ("+o+") tidak cocok dengan ADMIN_UID!")}else u("Login Ditolak: Email atau Password salah!")}finally{P()}},Dt=async()=>{T("Keluar...");try{await J.signOut(),window.isAdm=!1,window.__localIsAdm=!1,window.isPro=!1,typeof window.updateProBadge=="function"&&window.updateProBadge(),ce&&(ce(),Me(null)),ne&&(ne(),je(null)),de&&(de(),Ie(null)),u("Berhasil Logout"),typeof window.changeView=="function"&&window.changeView("view-catalog")}catch{u("Gagal Logout")}finally{P()}},Ma=()=>{he("Keluar Seller","Apakah anda akan keluar dari dashboard seller?",()=>{Dt()},"Ya, Keluar")};window.checkAdminAccess=ja;window.openAdminMenu=Oe;window.toggleTaxMenuVisibility=st;window.computeInventoryStats=Ue;window.loadAdminReport=It;window.processAdminLogin=Da;window.logoutAdmin=Dt;window.confirmLogoutAdmin=Ma;const La=async()=>{if(!z||z.length===0)return u("Belum ada data pesanan!");T("Menyiapkan modul Excel...");try{await Ct("https://cdn.sheetjs.com/xlsx-0.20.3/package/dist/xlsx.full.min.js",()=>typeof XLSX<"u")}catch{P(),u("Gagal memuat modul Excel. Cek koneksi internet Anda.");return}P();let e=[];z.forEach((i,n)=>{let l=i.dateString?new Date(i.dateString).toLocaleString("id-ID"):"-",p=i.customer?.name||"Anonim",d=i.customer?.deliveryMethod==="delivery"?"Dikirim":"Ambil di Toko",m=i.status||"-",b=i.items?i.items.reduce((v,f)=>v+(parseFloat(f.qty)||0),0):0,g=i.payment?.grandTotal||0;e.push({No:n+1,"ID Pesanan":i.orderId,Tanggal:l,"Nama Pelanggan":p,"Metode Kirim":d,Status:m,"Total Item":b,"Total Tagihan (Rp)":g})});const t=XLSX.utils.json_to_sheet(e),a=XLSX.utils.book_new();XLSX.utils.book_append_sheet(a,t,"Laporan Pesanan");const o=[{wch:5},{wch:25},{wch:22},{wch:25},{wch:15},{wch:15},{wch:12},{wch:20}];t["!cols"]=o;const s=new Date().toISOString().split("T")[0];XLSX.writeFile(a,`Laporan_Pesanan_${s}.xlsx`),u("Laporan Excel (.xlsx) berhasil diunduh!")},Ba=()=>{try{const e=new(window.AudioContext||window.webkitAudioContext),t=e.createOscillator(),a=e.createGain();t.connect(a),a.connect(e.destination),t.type="sine",t.frequency.setValueAtTime(800,e.currentTime),a.gain.setValueAtTime(1,e.currentTime),t.frequency.setValueAtTime(600,e.currentTime+.2),t.frequency.setValueAtTime(800,e.currentTime+.6),a.gain.setValueAtTime(1,e.currentTime+.6),t.frequency.setValueAtTime(600,e.currentTime+.8),a.gain.exponentialRampToValueAtTime(1e-5,e.currentTime+1.5),t.start(e.currentTime),t.stop(e.currentTime+1.5)}catch{}},_a=()=>{S("admin-content",`
    ...
    `);const e=()=>{ce&&(ce(),Me(null));let t=!0;const a=y.collection("freshmart_orders").orderBy("timestamp","desc").limit(100).onSnapshot(o=>{if(ht([]),!t){let i=!1;o.docChanges().forEach(n=>{n.type==="added"&&n.doc.data().status==="Baru"&&(i=!0)}),i&&(u("🔔 Pesanan Baru Masuk!"),Ba())}if(t=!1,o.empty){S("admin-orders-list",'<div class="flex flex-col items-center justify-center py-20 text-slate-400 font-bold bg-white dark:bg-slate-800 rounded-[1.5rem] border border-slate-200 dark:border-slate-700 shadow-sm text-center"><i class="fa-solid fa-receipt text-5xl mb-4 opacity-30"></i>Belum ada pesanan</div>'),O("stat-orders",0);return}O("stat-orders",o.size+(o.size===100?"+":""));const s=[];S("admin-orders-list",o.docs.map(i=>{const n=i.data();s.push(n);let l="text-slate-500 border-slate-200 dark:border-slate-600",p="fa-clock",d="bg-slate-50 dark:bg-slate-700/50",m="text-slate-400";n.status==="Baru"?(l="text-rose-500 border-rose-200 bg-rose-50 dark:bg-rose-900/20 dark:border-rose-800 animate-pulse",p="fa-asterisk",d="bg-rose-500",m="text-white shadow-md shadow-rose-500/30"):n.status==="Diproses"?(l="text-[var(--color-primary)] border-[var(--color-primary)]/30 bg-[rgba(var(--color-primary-rgb),0.06)] dark:bg-[rgba(var(--color-primary-rgb),0.10)] dark:border-[var(--color-primary)]/30",p="fa-spinner fa-spin",d="primary-bg",m="shadow-sm"):n.status==="Selesai"?(l="text-[var(--color-primary)] border-[var(--color-primary)]/30 bg-[rgba(var(--color-primary-rgb),0.06)] dark:bg-[rgba(var(--color-primary-rgb),0.10)] dark:border-[var(--color-primary)]/30",p="fa-check-double",d="primary-bg-soft",m="primary-text"):n.status==="Dibatalkan"&&(l="text-slate-400 border-slate-200 bg-slate-50 dark:bg-slate-800 dark:border-slate-700",p="fa-xmark",d="bg-slate-100 dark:bg-slate-800",m="text-slate-400");let b="fa-wallet text-slate-400",g=n.payment?.method||"";g==="transfer"?b="fa-building-columns text-[var(--color-primary)]":g==="qris"?b="fa-qrcode text-purple-500":g==="cod"?b="fa-hand-holding-dollar text-[var(--color-primary)]":g==="cashier"&&(b="fa-cash-register text-amber-500");let v=n.items?parseFloat(n.items.reduce((C,A)=>C+(parseFloat(A.qty)||0),0).toFixed(2)):0;const f=n.dateString?new Date(n.dateString).toLocaleDateString("id-ID",{day:"numeric",month:"short"}):"",k=(n.orderId||"").split("-").pop();return`
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="flex items-center gap-2 mt-1.5">
                                ...
                                <span class="text-[9px] font-bold text-slate-500 bg-slate-100 dark:bg-slate-900 px-2 py-0.5 rounded-xl border border-slate-200 dark:border-slate-700 uppercase tracking-widest shrink-0">${v} Item</span>
        ...
        <div class="flex flex-col gap-4 text-sm pb-2">
            ...
            <div class="bg-violet-50 dark:bg-violet-900/10 p-5 sm:p-6 rounded-[1.5rem] border border-violet-200 dark:border-violet-800 shadow-sm">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex justify-between items-center"><span class="text-slate-500 dark:text-slate-400 font-bold text-xs">Status</span><span class="font-bold text-xs px-2 py-1 rounded-xl ${t.claimedReward.status==="ready"?"bg-emerald-100 text-emerald-600":t.claimedReward.status==="waiting_stock"?"bg-amber-100 text-amber-600":"bg-slate-200 text-slate-600"}">${Yt(t.claimedReward)}</span></div>
            ...
            <div class="bg-slate-900 p-6 sm:p-7 rounded-[1.5rem] text-white shadow-xl shadow-slate-900/20 border border-slate-700/60 relative overflow-hidden group mt-2">
                ...
                <div class="space-y-3 font-medium text-sm text-slate-300 relative z-10">
                    ...
                    ${(()=>{if(!t.payment?.ppnAmount||t.payment.ppnAmount<=0)return"";const s=t.payment.ppnType==="inclusive",i=t.payment.ppnRate||11,n=t.payment.ppnAmount,l=(t.payment.subtotal||0)-(t.payment.productDiscount||0)+(t.payment.shippingCost||0)-(t.payment.shippingDiscount||0),p=t.payment.dppAmount||(s?Math.round(l*100/(100+i)):Math.max(0,l));return`
                        <div class="flex justify-between items-center text-slate-400"><span>DPP (Dasar Pengenaan Pajak)</span><span class="font-bold text-white">${x(p)}</span></div>
        ...
        </div>`);const o=h("admin-order-modal");o&&o.classList.contains("hidden")&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("adminOrder"),_("admin-order-modal"),setTimeout(()=>{h("admin-order-modal")&&h("admin-order-modal").classList.remove("opacity-0"),h("admin-order-modal-box")&&h("admin-order-modal-box").classList.remove("scale-95")},10)},Ea=async(e,t)=>{const o=(typeof window.normalizeWA=="function"?window.normalizeWA:s=>String(s||"").replace(/\D/g,"").replace(/^0/,"62"))(t);if(!o||o.length<10)return u("Nomor WA tidak valid!");T("Menyimpan...");try{const s=y.collection("freshmart").doc("cms_data").collection("customers").doc(o),i=await s.get();i.exists?(await s.set({name:e||i.data().name},{merge:!0}),u("Data pelanggan sudah ada, nama diperbarui.")):(await s.set({id:parseInt(o,10),name:e||"-",phone:o,points:0}),u("✅ Pelanggan baru disimpan ke database!"))}catch(s){console.error("Gagal simpan pelanggan:",s),u("Gagal menyimpan data pelanggan: "+(s.message||""))}finally{P()}},Na=async(e,t)=>{if(t==="waiting_stock"&&typeof window.customPrompt=="function"){window.customPrompt("Catatan untuk pelanggan:","Stok hadiah kosong, akan kami kirim susulan begitu stok tersedia kembali.",async o=>{if(o!==null){T("Menyimpan...");try{await y.collection("freshmart_orders").doc(e).update({"claimedReward.status":t,"claimedReward.note":o||""}),u("Status klaim hadiah diperbarui!");let s=z.findIndex(i=>i.orderId===e);s!==-1&&(z[s].claimedReward||(z[s].claimedReward={}),z[s].claimedReward.status=t,z[s].claimedReward.note=o||""),typeof window.openCustomerOrderDetail=="function"&&window.openCustomerOrderDetail(e)}catch(s){u("Gagal update klaim: "+s.message)}finally{P()}}});return}let a="";T("Menyimpan...");try{await y.collection("freshmart_orders").doc(e).update({"claimedReward.status":t,"claimedReward.note":a});const o=z.find(s=>s.orderId===e);o&&(o.claimedReward.status=t,o.claimedReward.note=a,rt(e)),u("Status hadiah diperbarui!")}catch(o){console.error("Gagal update status hadiah:",o),u("Gagal update status hadiah: "+(o.message||""))}finally{P()}},Mt=(e=!1)=>{const t=()=>{h("admin-order-modal")&&h("admin-order-modal").classList.add("opacity-0"),h("admin-order-modal-box")&&h("admin-order-modal-box").classList.add("scale-95"),setTimeout(()=>E("admin-order-modal"),300)};typeof window.requestCloseModal=="function"?window.requestCloseModal("adminOrder",e,t):t()},Ra=async(e,t)=>{if(!He){pe(!0),T("Update...");try{await y.collection("freshmart_orders").doc(e).update({status:t});let a=z.find(o=>o.orderId===e);a&&(a.status=t),rt(e),u("Status diupdate!")}catch{u("Gagal!")}finally{pe(!1),P()}}},Fa=async e=>{if(!e)return u("ID pesanan tidak valid!");T("Memuat data...");try{const t=await y.collection("freshmart_orders").doc(e).get();if(P(),!t.exists)return u("Data pesanan tidak ditemukan!");const a=t.data(),o=a.customer&&a.customer.wa;if(!o)return u("Nomor WhatsApp pelanggan tidak tersedia!");const s=r&&r.store&&r.store.name?r.store.name:"Toko Kami",i=a.customer&&a.customer.name?a.customer.name:"Pelanggan",n=a.status||"Baru",l=a.payment&&a.payment.grandTotal?x(a.payment.grandTotal):"-",p=a.payment&&a.payment.method?a.payment.method.toUpperCase():"-",d=`Halo *${i}*! 👋
...
Kami akan segera memproses pesanan Anda. Terima kasih! 🙏`;window.open(`https://wa.me/${o}?text=${encodeURIComponent(d)}`,"_blank")}catch{P(),u("Gagal memuat data pesanan!")}},Oa=e=>{he("Hapus Pesanan","Yakin ingin hapus permanen?",async()=>{if(!He){pe(!0),T("Menghapus...");try{await y.collection("freshmart_orders").doc(e).delete(),u("Terhapus!"),Xt===e&&Mt()}catch{u("Gagal!")}finally{pe(!1),P()}}})};window.exportOrdersToExcel=La;window.rAdmOrd=_a;window.openOrderDetail=rt;window.saveOrderCustomerToDB=Ea;window.ackRewardClaim=Na;window.closeOrderDetailModal=Mt;window.updateOrderStatus=Ra;window.konfirmasiKeWA=Fa;window.deleteOrder=Oa;const Ha=()=>{const e=r.store.name||"Toko Grosir",t=r.store.themeColor||"#10b981",a=(i,n,l=!1)=>{let p=document.querySelector(`meta[${l?"property":"name"}="${i}"]`);p||(p=document.createElement("meta"),l?p.setAttribute("property",i):p.setAttribute("name",i),document.head.appendChild(p)),p.setAttribute("content",n)};a("theme-color",t),a("mobile-web-app-capable","yes"),a("apple-mobile-web-app-capable","yes"),a("apple-mobile-web-app-status-bar-style","black-translucent"),a("apple-mobile-web-app-title",e),a("application-name",e),a("msapplication-TileColor",t),document.title=e,localStorage.setItem("freshmart_theme_color",t),r.store.uiTheme&&r.store.uiTheme!==localStorage.getItem("freshmart_ui_theme")&&(localStorage.setItem("freshmart_ui_theme",r.store.uiTheme),$e(r.store.uiTheme));const o=r.store.bgStyle||localStorage.getItem("freshmart_bg_style")||"minimalist",s=r.store.bgCustomUrl!==void 0?r.store.bgCustomUrl:localStorage.getItem("freshmart_bg_custom_url")||"";Se(o,s)},Lt=()=>{S("admin-content",`
    ...
    `;if(S("admin-content",i),e==="profile"){const n=r.store.uiTheme||"",l=r.store.themeColor||"#10b981";(n==="custom"||!ke?.[n])&&setTimeout(()=>{const d=document.getElementById("custom-color-chip");if(d){d.style.background=l;const m=d.querySelector("i");m&&(m.style.color="#fff")}},50)}},Ka=async e=>{if(!He){pe(!0),T("Menyimpan...");try{e==="profile"?(r.store.name=$("set-name"),r.store.slogan=$("set-slogan"),r.store.logo=j($("set-logo")),r.store.description=$("set-description"),r.store.email=$("set-email"),r.store.showRewardCatalog=$("set-show-reward-catalog")==="true",r.store.operationalHours=$("set-hours"),r.store.footerCredit=$("set-credit"),r.store.themeColor=$("set-theme-color"),r.store.uiTheme=$("set-ui-theme"),r.store.bgStyle=$("set-bg-style")||"minimalist",r.store.bgCustomUrl=j($("set-bg-custom-url")),localStorage.setItem("freshmart_theme_color",r.store.themeColor),localStorage.setItem("freshmart_ui_theme",r.store.uiTheme),localStorage.setItem("freshmart_bg_style",r.store.bgStyle),localStorage.setItem("freshmart_bg_custom_url",r.store.bgCustomUrl||""),$e(r.store.uiTheme,r.store.themeColor),Se(r.store.bgStyle,r.store.bgCustomUrl)):e==="catalog"?(r.store.categoryStyle=$("set-category-style"),r.store.brandStyle=$("set-brand-style"),r.store.showCategories=$("set-show-categories")==="true",r.store.showBrands=$("set-show-brands")==="true"):e==="shipping"?(r.store.wa=$("set-wa").replace(/\D/g,""),r.store.address=$("set-address"),r.store.costPerKm=$("set-cost"),r.store.isDeliveryEnabled=$("set-delivery-enabled")==="true",r.store.isPickupEnabled=$("set-pickup-enabled")==="true",r.store.lat=$("set-lat"),r.store.lng=$("set-lng")):e==="payment"?(r.payment||(r.payment={}),r.payment.qrisUrl=j($("set-qris-url"))):e==="config"?(r.config||(r.config={}),r.config.gasUrl=$("set-gas-url"),u("Pengaturan GAS URL tersimpan.")):e==="operasional"&&(r.store.useStock=$("set-use-stock")==="true",r.store.ppnEnabled=$("set-ppn-enabled")==="true",r.store.ppnType=$("set-ppn-type")||"exclusive",r.store.ppnRate=parseFloat($("set-ppn-rate"))||11,st());const t={profile:"store",catalog:"store",shipping:"store",operasional:"store",payment:"payment",config:"config"};typeof window.saveApp=="function"&&await window.saveApp([t[e]||"store"]),e==="profile"||e==="config"?(u(e==="config"?"Sistem Diperbarui! Memuat Ulang...":"Warna Berubah! Memuat Ulang..."),setTimeout(()=>location.reload(),1500)):(u("Tersimpan!"),Lt())}catch{u("Gagal menyimpan pengaturan")}finally{pe(!1),P()}}},Ga=()=>{const e="data:text/json;charset=utf-8,"+encodeURIComponent(JSON.stringify(r,null,2)),t=document.createElement("a");t.href=e,t.download=`backup_freshmart_${new Date().toISOString().slice(0,10)}.json`,document.body.appendChild(t),t.click(),t.remove(),u("Backup diunduh!")},Wa=e=>{const t=e.target.files[0];if(!t)return;const a=new FileReader;a.onload=async o=>{try{const s=JSON.parse(o.target.result);Object.assign(r,s),typeof window.saveApp=="function"&&await window.saveApp(),u("Data dipulihkan!"),setTimeout(()=>location.reload(),1e3)}catch{u("Gagal memulihkan data!")}},a.readAsText(t)};window.syncAppMeta=Ha;window.rAdmSet=Lt;window.selectPresetTheme=Ua;window.selectBgStyle=Va;window.openSettingForm=qa;window.saveAdminSettings=Ka;window.backupData=Ga;window.restoreData=Wa;let L=new Date().getFullYear(),B=0,te="menu",ae=null;const se=["Jan","Feb","Mar","Apr","Mei","Jun","Jul","Agu","Sep","Okt","Nov","Des"],za=e=>{if(typeof window.getEffHpp=="function")return window.getEffHpp(e);const t=r.products?.find(a=>a.id===e.id);if(!t)return 0;if(e.variantName&&t.variants){const a=t.variants.find(o=>o.name===e.variantName);if(a&&a.hpp!=null)return parseFloat(a.hpp)||0}return parseFloat(t.hpp)||0},$t=new Map,Ja=2*60*1e3,ot=async e=>{const t=$t.get(e);if(t&&Date.now()-t.timestamp<Ja)return t.data;const a={};for(let o=1;o<=12;o++)a[o]={omset:0,ppn:0,hpp:0,disc:0,orderCount:0};try{const o=new Date(e,0,1),s=new Date(e+1,0,1);(await y.collection("freshmart_orders").where("timestamp",">=",W.firestore.Timestamp.fromDate(o)).where("timestamp","<",W.firestore.Timestamp.fromDate(s)).limit(5e3).get()).forEach(l=>{const p=l.data();if(p.status==="Dibatalkan"||!p.timestamp||!p.timestamp.toDate)return;const d=p.timestamp.toDate().getMonth()+1;if(!a[d])return;const m=p.payment?.dppAmount!==void 0&&p.payment?.dppAmount!==null?parseFloat(p.payment.dppAmount):parseFloat(p.payment?.subtotal)||0;a[d].omset+=m,a[d].ppn+=parseFloat(p.payment?.ppnAmount)||0,a[d].disc+=parseFloat(p.payment?.productDiscount)||0,a[d].orderCount++,(p.items||[]).forEach(b=>{const g=b.hpp!==void 0&&b.hpp!==null?parseFloat(b.hpp):za(b);a[d].hpp+=(parseFloat(g)||0)*(parseFloat(b.qty)||0)})})}catch(o){console.error("Gagal memuat data pajak:",o),u("Gagal memuat data periode ini!")}return $t.set(e,{data:a,timestamp:Date.now()}),a},Be=()=>ae?(B===0?Object.keys(ae):[B]).reduce((t,a)=>{const o=ae[a];return t.omset+=o.omset,t.ppn+=o.ppn,t.hpp+=o.hpp,t.disc+=o.disc,t.orderCount+=o.orderCount,t},{omset:0,ppn:0,hpp:0,disc:0,orderCount:0}):{omset:0,ppn:0,hpp:0,disc:0,orderCount:0},lt=()=>{const e=r.taxSettings?.monthlyExpenses||{};return(B===0?Array.from({length:12},(a,o)=>o+1):[B]).reduce((a,o)=>a+(parseFloat(e[`${L}-${o}`])||0),0)},Qa=async()=>{S("admin-content",'<div class="text-center py-16"><i class="fa-solid fa-spinner fa-spin text-3xl text-slate-300"></i></div>'),ae=await ot(L),it()},it=()=>{const e=Array.from({length:6},(o,s)=>new Date().getFullYear()-4+s),t=[{k:"summary",l:"Ringkasan PPN",i:"fa-receipt"},{k:"income",l:"Laba Rugi",i:"fa-chart-pie"},{k:"balance",l:"Neraca",i:"fa-scale-balanced"},{k:"settings",l:"Pengaturan",i:"fa-gear"}];te==="menu"&&(te="summary");const a=`
    <div class="mb-5 flex flex-wrap items-center justify-between gap-3 bg-white dark:bg-slate-800 p-4 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm">
        ...
        <div class="flex items-center gap-2">
            ...
            <select id="tax-month-select" onchange="changeTaxMonth(this.value)" class="admin-input !py-2 !px-3 text-xs font-bold bg-slate-50 dark:bg-slate-900 text-slate-800 dark:text-slate-100 border border-slate-200 dark:border-slate-700 rounded-xl focus:border-[var(--color-primary)] cursor-pointer">
                ...
                ${se.map((o,s)=>`<option value="${s+1}" ${B===s+1?"selected":""}>${o} ${L}</option>`).join("")}
            </select>
        </div>
        `}
    </div>
    ...
    </div>`),Ve()},Ya=e=>{te=e,it()},Xa=async e=>{L=parseInt(e,10),S("tax-content",'<div class="text-center py-16"><i class="fa-solid fa-spinner fa-spin text-3xl text-slate-300"></i></div>'),ae=await ot(L),Ve()},Za=e=>{B=parseInt(e,10),Ve()},Ve=()=>{te==="summary"?Bt():te==="income"?nt():te==="balance"?dt():te==="settings"&&_t()},Bt=()=>{const e=Be(),t=B===0?`Tahun ${L}`:`${se[B-1]} ${L}`,a=e.omset-e.disc,o=Array.from({length:12},(s,i)=>i+1).map(s=>{const i=ae?ae[s]:{omset:0,ppn:0,orderCount:0};return`<tr class="${B===s?"bg-[rgba(var(--color-primary-rgb),0.08)] dark:bg-[rgba(var(--color-primary-rgb),0.14)] font-bold":"hover:bg-slate-50 dark:hover:bg-slate-700/30"} border-b border-slate-100 dark:border-slate-700/50 last:border-0 transition-colors">
    ...
    `)},nt=()=>{const e=Be(),t=B===0?`Tahun ${L}`:`${se[B-1]} ${L}`,a=e.omset-e.disc-e.hpp,o=B===0?null:`${L}-${B}`,s=lt(),i=a-s,n=r.taxSettings?.taxScheme||"umkm_final";let l,p,d;n==="umkm_final"?(l=.5,p=e.omset,d="PPh Final UMKM (0,5% × Omset)"):n==="badan_normal"?(l=22,p=Math.max(0,i),d="PPh Badan (22% × Laba Bersih)"):(l=parseFloat(r.taxSettings?.customTaxRate)||0,p=Math.max(0,i),d=`PPh Custom (${l}% × Laba Bersih)`);const m=p*(l/100),b=i-m;let g="";if(B===0)g=Array.from({length:12},(v,f)=>f+1).map(v=>{const f=`${L}-${v}`,k=(r.taxSettings?.monthlyExpenses||{})[f]||0;return`<div class="flex items-center justify-between gap-2 py-2 border-b border-slate-100 dark:border-slate-700/50 last:border-0">
                <span class="text-xs font-bold text-slate-600 dark:text-slate-300">${se[v-1]} ${L}</span>
                <input type="number" min="0" value="${k}" onchange="saveMonthlyExpense('${f}', this.value)" class="admin-input !py-2 !px-3 text-xs w-36 text-right font-bold bg-slate-50 dark:bg-slate-900 text-slate-800 dark:text-slate-100 border border-slate-200 dark:border-slate-700 rounded-xl focus:border-[var(--color-primary)]">
            </div>`}).join("");else{const v=(r.taxSettings?.monthlyExpenses||{})[o]||0;g=`<div class="flex items-center justify-between gap-2 py-2">
            <span class="text-xs font-bold text-slate-600 dark:text-slate-300">${se[B-1]} ${L}</span>
            <input type="number" min="0" value="${v}" onchange="saveMonthlyExpense('${o}', this.value)" class="admin-input !py-2 !px-3 text-xs w-36 text-right font-bold bg-slate-50 dark:bg-slate-900 text-slate-800 dark:text-slate-100 border border-slate-200 dark:border-slate-700 rounded-xl focus:border-[var(--color-primary)]">
        </div>`}S("tax-content",`
        <div class="card-modern p-6 sm:p-8 space-y-4">
            ...
            <div class="space-y-3 text-xs sm:text-sm">
                ...
                <div class="flex justify-between py-1"><span class="font-bold text-slate-500 dark:text-slate-400">(−) Estimasi ${d}</span><span class="font-bold text-rose-500">-${x(m)}</span></div>
    ...
    `)},es=async(e,t)=>{const a=parseFloat(t)||0;r.taxSettings||(r.taxSettings={}),r.taxSettings.monthlyExpenses||(r.taxSettings.monthlyExpenses={}),r.taxSettings.monthlyExpenses[e]=a;try{typeof window.saveApp=="function"&&await window.saveApp(["taxSettings"]),nt()}catch{u("Gagal menyimpan biaya operasional!")}},dt=()=>{const e=Ue(),t=r.taxSettings?.balanceSheet||{kas:0,piutang:0,hutang:0},a=(parseFloat(t.kas)||0)+(parseFloat(t.piutang)||0)+e.assetHpp,o=parseFloat(t.hutang)||0,s=a-o;S("tax-content",`
    ...
    `)},ts=async(e,t)=>{const a=parseFloat(t)||0;r.taxSettings||(r.taxSettings={}),r.taxSettings.balanceSheet||(r.taxSettings.balanceSheet={kas:0,piutang:0,hutang:0,modalDisetor:0}),r.taxSettings.balanceSheet[e]=a;try{typeof window.saveApp=="function"&&await window.saveApp(["taxSettings"]),dt()}catch{u("Gagal menyimpan data neraca!")}},_t=()=>{const e=r.taxSettings||{};S("tax-content",`
    ...
    `)},as=e=>{re("tax-custom-rate-wrap","hidden",e!=="custom")},ss=async()=>{if(!He){pe(!0),T("Menyimpan...");try{r.taxSettings||(r.taxSettings={}),r.taxSettings.companyName=$("tax-company-name"),r.taxSettings.npwp=$("tax-npwp"),r.taxSettings.taxScheme=$("tax-scheme"),r.taxSettings.customTaxRate=parseFloat($("tax-custom-rate"))||.5,typeof window.saveApp=="function"&&await window.saveApp(["taxSettings"]),u("Pengaturan pajak tersimpan!")}catch{u("Gagal menyimpan pengaturan pajak!")}finally{pe(!1),P()}}},rs=e=>{const t=B===0?`Tahun ${L}`:`${se[B-1]} ${L}`,a=r.taxSettings||{},o=new Date().toLocaleDateString("id-ID",{day:"2-digit",month:"long",year:"numeric"});let s="";r.store.logo&&(r.store.logo.includes("http")||r.store.logo.includes("data:"))?s=`<img loading="eager" src="${c(r.store.logo)}" class="w-16 h-16 object-contain">`:s='<div class="w-16 h-16 bg-slate-700 text-white flex items-center justify-center rounded-xl"><i class="fa-solid fa-store text-3xl"></i></div>';const n={summary:"LAPORAN PPN & OMSET",income:"LAPORAN LABA RUGI",balance:"NERACA"}[e]||"LAPORAN";let l=`
    ...
    <div class="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-6 text-[11px] font-bold text-amber-700 leading-relaxed">
    ...
    </div>`,p="";if(e==="summary"){const m=Be(),b=m.omset-m.disc,g=Array.from({length:12},(v,f)=>f+1).map(v=>{const f=ae?ae[v]:{omset:0,ppn:0,orderCount:0};return`<tr class="border-b border-slate-200"><td class="py-2.5 px-3 font-bold text-slate-700">${se[v-1]} ${L}</td><td class="py-2.5 px-3 text-right font-bold text-slate-700">${x(f.omset)}</td><td class="py-2.5 px-3 text-right font-bold text-slate-900">${x(f.ppn)}</td><td class="py-2.5 px-3 text-right font-bold text-slate-500">${f.orderCount}</td></tr>`}).join("");p=`
        ...
        <table class="w-full text-xs"><thead><tr class="bg-slate-100 text-left"><th class="py-2.5 px-3 font-bold text-slate-500 uppercase text-[9px]">Bulan</th><th class="py-2.5 px-3 font-bold text-slate-500 uppercase text-[9px] text-right">Omset</th><th class="py-2.5 px-3 font-bold text-slate-500 uppercase text-[9px] text-right">PPN Keluaran</th><th class="py-2.5 px-3 font-bold text-slate-500 uppercase text-[9px] text-right">Pesanan</th></tr></thead><tbody>${g}</tbody></table>`}else if(e==="income"){const m=Be(),b=m.omset-m.disc-m.hpp,g=lt(),v=b-g,f=a.taxScheme||"umkm_final";let k,C,A;f==="umkm_final"?(k=.5,C=m.omset,A="PPh Final UMKM (0,5% × Omset)"):f==="badan_normal"?(k=22,C=Math.max(0,v),A="PPh Badan (22% × Laba Bersih)"):(k=parseFloat(a.customTaxRate)||0,C=Math.max(0,v),A=`PPh Custom (${k}% × Laba Bersih)`);const w=C*(k/100),q=v-w,I=(R,H,U,Ge)=>`<div class="flex justify-between py-2 ${U?"border-t-2 border-slate-800 mt-1 pt-3":"border-b border-slate-100"}"><span class="${U?"font-bold text-slate-900":"font-bold text-slate-600"}">${R}</span><span class="font-bold ${Ge||"text-slate-900"}">${H}</span></div>`;p=`<div class="max-w-xl">
            ${I("Omset Bruto",x(m.omset))}
            ${I("(−) Diskon Produk","-"+x(m.disc),!1,"text-rose-600")}
            ${I("(−) HPP","-"+x(m.hpp),!1,"text-rose-600")}
            ${I("Laba Kotor",x(b),!0,"text-emerald-600")}
            ${I("(−) Biaya Operasional","-"+x(g),!1,"text-rose-600")}
            ${I("Laba Bersih Sebelum Pajak",x(v),!0)}
            ${I("(−) Estimasi "+A,"-"+x(w),!1,"text-rose-600")}
            ${I("Laba Bersih Setelah Pajak (Estimasi)",x(q),!0)}
        </div>`}else if(e==="balance"){const m=Ue(),b=a.balanceSheet||{kas:0,piutang:0,hutang:0},g=(parseFloat(b.kas)||0)+(parseFloat(b.piutang)||0)+m.assetHpp,v=parseFloat(b.hutang)||0,f=g-v;p=`
        <div class="grid grid-cols-2 gap-8">
            ...
            <div>
                ...
                <div class="flex justify-between py-2 border-b border-slate-100"><span class="font-bold text-slate-600">Hutang Usaha</span><span class="font-bold text-slate-900">${x(v)}</span></div>
                ...
                <div class="flex justify-between py-2.5 border-t-2 border-slate-800 mt-1"><span class="font-bold text-slate-900">Total Kewajiban + Modal</span><span class="font-bold text-slate-900">${x(v+f)}</span></div>
            </div>
        </div>`}O("doc-modal-title","Preview "+n),S("doc-paper-content",l+p);const d=h("doc-preview-modal");d&&d.classList.contains("hidden")&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("docPreview"),_("doc-preview-modal"),setTimeout(()=>{h("doc-preview-modal")&&h("doc-preview-modal").classList.remove("opacity-0"),h("doc-preview-modal-box")&&h("doc-preview-modal-box").classList.remove("scale-95"),typeof window.fitDocPreview=="function"&&window.fitDocPreview()},10)};window.fetchTaxPeriodData=ot;window.getTaxPeriodTotals=Be;window.getTaxPeriodExpenses=lt;window.rTaxPanel=Qa;window.rTaxRenderShell=it;window.switchTaxTab=Ya;window.changeTaxYear=Xa;window.changeTaxMonth=Za;window.rTaxSubContent=Ve;window.rTaxSummary=Bt;window.rTaxIncome=nt;window.saveMonthlyExpense=es;window.rTaxBalance=dt;window.saveBalanceField=ts;window.rTaxSettingsPanel=_t;window.toggleCustomTaxRateInput=as;window.saveTaxSettingsPanel=ss;window.openTaxDocPreview=rs;window.MONTH_NAMES=se;window.editTempoPenalty=(e,t)=>{window.customPrompt("Persentase Denda Baru",t,async a=>{if(!a)return;let o=parseFloat(a.replace(",","."));if(isNaN(o)||o<0)return u("Persentase tidak valid!");T("Menyimpan...");try{await y.collection("freshmart_orders").doc(e).update({"payment.tempoPenaltyRate":o}),u("Persentase denda berhasil diubah!"),window.rAdmPiutang()}catch(s){u("Gagal mengubah denda: "+s.message)}P()})};window.stopTempoPenalty=(e,t,a)=>{let o="Konfirmasi Denda",s=a?"Lanjutkan perhitungan denda otomatis?":"Hentikan denda berjalan sekarang? (Nominal denda akan dibekukan di "+x(t)+")";he(o,s,async()=>{T("Menyimpan...");try{await y.collection("freshmart_orders").doc(e).update({"payment.tempoPenaltyStopped":!a,"payment.tempoFixedPenalty":a?null:t}),u(a?"Denda dilanjutkan!":"Denda berhasil dibekukan!"),window.rAdmPiutang()}catch(n){u("Gagal mengubah status denda: "+n.message)}P()},a?"Lanjutkan":"Bekukan")};window.payTempoInstallment=e=>{window.customPrompt("Masukkan Nominal Cicilan (Rp)","",async t=>{if(!t)return;let a=parseFloat(t.replace(/[^0-9]/g,""));if(isNaN(a)||a<=0)return u("Nominal tidak valid!");T("Menyimpan cicilan...");try{const s=(await y.collection("freshmart_orders").doc(e).get()).data();let i=(s.payment.tempoBalance||0)-a,n=s.payment.installments||[];n.push({date:Date.now(),amount:a,note:"Cicilan"});let l={"payment.tempoBalance":Math.max(0,i),"payment.installments":n};i<=0&&(l["payment.paymentStatus"]="lunas",l.status="Selesai"),await y.collection("freshmart_orders").doc(e).update(l),u("Cicilan berhasil ditambahkan!"),window.rAdmPiutang&&window.rAdmPiutang()}catch(o){u("Gagal memproses cicilan: "+o.message)}P()})};window.previewTempoReceipt=async e=>{T("Memuat data struk...");try{const t=await y.collection("freshmart_orders").doc(e).get();if(!t.exists)return P(),u("Pesanan tidak ditemukan");const a=t.data();P();const o=a.dateString?new Date(a.dateString).toLocaleString("id-ID",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}):"",s=r.store.name||"Toko",i=r.store.wa||"",n=(w,q,I=32)=>{const R=I-w.length-q.length;return w+(R>0?" ".repeat(R):" ")+q};let l=`<div class="text-center font-bold" style="font-size:13px;margin-bottom:2px;">${c(s)}</div>`;i&&(l+=`<div class="text-center" style="margin-bottom:4px;">WA: ${c(i)}</div>`),l+=`<div class="text-center font-bold uppercase my-2" style="font-size:14px;border-bottom:1px solid #000;border-top:1px solid #000;padding:2px 0;">NOTA TEMPO${a.payment?.paymentStatus==="lunas"?" - LUNAS":""}</div>`,l+=`<div style="white-space:pre;">Order: #${a.orderId}</div><div style="white-space:pre;">Tgl  : ${o}</div><div style="white-space:pre;">Plg  : ${c(a.customer?.name||"Guest").substring(0,20)}</div>`,a.payment?.tempoDueDate&&(l+=`<div style="white-space:pre;">J.Tmp: ${new Date(a.payment.tempoDueDate).toLocaleDateString("id-ID")}</div>`),l+='<div class="border-b border-dashed border-black my-2"></div>';let p=0;if(a.items.forEach(w=>{let q=w.variantName?` (${c(w.variantName)}${w.colorCode?" "+c(w.colorCode):""})`:"";const I=(c(w.name)+q+(w.poTime?" [PO]":"")).substring(0,32),R=`${parseFloat(w.qty)} ${c(w.unit||"pcs")} x ${w.effectivePrice.toLocaleString("id-ID")}`,H=(parseFloat(w.qty)*w.effectivePrice).toLocaleString("id-ID");l+=`<div style="white-space:pre-wrap;font-weight:bold;word-break:break-all;">${I}</div><div style="white-space:pre;font-size:11px;">${n(R,H)}</div>`,w.poTime&&(l+=`<div style="white-space:pre;font-size:10px;font-style:italic;color:#4b5563;">* Estimasi PO: ${c(w.poTime)}</div>`),p+=parseFloat(w.qty)*w.effectivePrice}),l+='<div class="border-b border-dashed border-black my-2"></div>',l+=`<div style="white-space:pre;font-weight:bold;">${n("Subtotal",p.toLocaleString("id-ID"))}</div>`,a.payment?.grandTotal&&a.payment.grandTotal!==p){let w=a.payment.grandTotal-p;w>0?l+=`<div style="white-space:pre;">${n("Ongkir/Biaya",w.toLocaleString("id-ID"))}</div>`:l+=`<div style="white-space:pre;">${n("Diskon",Math.abs(w).toLocaleString("id-ID"))}</div>`}l+=`<div style="white-space:pre;font-weight:bold;margin-top:4px;">${n("TOTAL KREDIT",(a.payment?.grandTotal||p).toLocaleString("id-ID"))}</div>`,l+='<div class="border-b border-black my-2" style="border-width:1px;"></div>';let d=0;a.payment?.installments&&a.payment.installments.length>0&&(l+='<div style="white-space:pre;font-weight:bold;margin-bottom:2px;">HISTORI CICILAN:</div>',a.payment.installments.forEach((w,q)=>{let I=new Date(w.date).toLocaleDateString("id-ID",{day:"2-digit",month:"short"}),R=w.amount.toLocaleString("id-ID");l+=`<div style="white-space:pre;">${n(`${q+1}. ${I}`,R)}</div>`,d+=w.amount}),l+=`<div style="white-space:pre;font-weight:bold;margin-top:2px;">${n("TOTAL DIBAYAR",d.toLocaleString("id-ID"))}</div>`,l+='<div class="border-b border-dashed border-black my-2"></div>');let m=a.payment?.tempoBalance||0,b=0,g=a.payment?.tempoPenaltyStopped===!0,v=a.payment?.tempoDueDate||0,f=a.payment?.tempoPenaltyRate!==void 0?parseFloat(a.payment.tempoPenaltyRate):1;if(a.payment?.paymentStatus!=="lunas"){if(g)b=parseFloat(a.payment?.tempoFixedPenalty)||0;else if(Date.now()>v){let w=Math.floor((Date.now()-v)/864e5);w>0&&(b=f/100*m*w)}}l+=`<div style="white-space:pre;font-weight:bold;">${n("SISA POKOK",m.toLocaleString("id-ID"))}</div>`,b>0&&(l+=`<div style="white-space:pre;">${n("DENDA",Math.round(b).toLocaleString("id-ID"))}</div>`);let k=m+b;l+='<div class="border-b border-black my-2" style="border-width:1px;"></div>',l+=`<div style="white-space:pre;font-weight:black;">${n("SISA TAGIHAN",Math.round(k).toLocaleString("id-ID"))}</div>`,a.items.some(w=>w.poTime&&w.poTime!=="")&&(l+='<div class="border-b border-dashed border-black my-2"></div><div style="white-space:pre-wrap;font-size:9px;text-align:center;line-height:1.2;font-style:italic;color:#4b5563;margin-bottom:4px;">* Catatan: Untuk pesanan gabungan, produk PO akan dikirimkan menyusul (estimasi sesuai label) tanpa dikenakan biaya tambahan.</div>'),l+='<div class="border-b border-dashed border-black my-2"></div><div class="text-center my-2" style="font-size:10px;">Terima kasih atas kepercayaannya.</div><div class="border-b border-dashed border-black my-2"></div><div style="height:20px;"></div>',S("receipt-paper-content",l);const A=h("receipt-preview-modal");A&&A.classList.contains("hidden")&&pushModalHistory("receipt"),show("receipt-preview-modal"),setTimeout(()=>{h("receipt-preview-modal").classList.remove("opacity-0"),h("receipt-preview-modal-box").classList.remove("scale-95")},10)}catch(t){P(),u("Gagal memuat struk: "+t.message)}};window.markTempoPaid=async e=>{he("Konfirmasi","Tandai tagihan tempo ini sebagai LUNAS?",async()=>{try{await y.collection("freshmart_orders").doc(e).update({"payment.paymentStatus":"lunas","payment.tempoBalance":0,status:"Selesai"}),u("Tagihan berhasil dilunasi!");let t=gOrds.findIndex(a=>a.orderId===e);t!==-1&&(gOrds[t].payment.paymentStatus="lunas",gOrds[t].payment.tempoBalance=0,gOrds[t].status="Selesai"),window.rAdmPiutang()}catch(t){u("Gagal mengubah status: "+t.message)}})};window.rAdmPiutang=async()=>{T("Memuat data piutang...");let e=[];try{(await y.collection("freshmart_orders").where("payment.method","==","tempo").where("payment.paymentStatus","==","hutang").get()).forEach(s=>{e.push(s.data())})}catch(o){P(),u("Gagal memuat piutang: "+o.message);return}P();let t=0,a=`
    ...
    `;e.length===0?a+=`<div class="bg-white dark:bg-slate-800 p-8 text-center rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm">
            ...
            <div class="bg-white dark:bg-slate-800 p-5 rounded-2xl border ${m?"border-rose-300 dark:border-rose-700 shadow-[0_0_15px_rgba(225,29,72,0.1)]":"border-slate-200 dark:border-slate-700 shadow-sm"} relative overflow-hidden group hover:-translate-y-1 transition-all">
                ...
                <div class="mb-3 space-y-1.5 bg-slate-50 dark:bg-slate-900/30 p-3 rounded-xl border border-slate-100 dark:border-slate-800">
                    <div class="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-2 flex justify-between">
                        ...
                        <span>Total: ${x(o.payment.installments.reduce((v,f)=>v+(parseFloat(f.amount)||0),0))}</span>
                    </div>
                    ${o.payment.installments.map(v=>`
                    <div class="flex justify-between items-center text-[10px]">
                        <span class="text-slate-500 dark:text-slate-400">${new Date(v.date).toLocaleDateString("id-ID")}</span>
                        <span class="font-bold text-[var(--color-primary)] font-mono">+${x(v.amount)}</span>
                    </div>
                    `).join("")}
                </div>`:""}
            ...
            </div>`}),a+="</div>"),a+="</div>",S("admin-content",a),setTimeout(()=>{h("total-piutang-header")&&(h("total-piutang-header").innerText=x(t))},100)};const os=e=>{ea(e),Et()},Et=()=>{const e=Zt||"all",t=(Ze||[]).filter(i=>e==="visible"?i.isVisible!==!1:e==="hidden"?i.isVisible===!1:!0),a=`
        ...
        </div>`}).join("");S("admin-content",a+s)},ls=async e=>{const t=(Ze||[]).find(a=>a.id===e);t&&typeof window.customPrompt=="function"&&window.customPrompt("Tulis balasan untuk ulasan ini:",t.adminReply||"",async a=>{T("Menyimpan balasan...");try{await y.collection("freshmart").doc("cms_data").collection("reviews").doc(e.toString()).update({adminReply:a}),u("Balasan tersimpan!")}catch{u("Gagal menyimpan balasan!")}finally{P()}})},is=async e=>{const t=(Ze||[]).find(o=>o.id===e);if(!t)return;const a=t.isVisible===!1;T("Menyimpan...");try{await y.collection("freshmart").doc("cms_data").collection("reviews").doc(e.toString()).update({isVisible:a}),u(a?"Ulasan ditampilkan lagi!":"Ulasan disembunyikan dari halaman produk!")}catch{u("Gagal mengubah status ulasan!")}finally{P()}},ns=e=>{he("Hapus Ulasan","Ulasan yang dihapus tidak bisa dikembalikan lagi.",async()=>{T("Menghapus...");try{await y.collection("freshmart").doc("cms_data").collection("reviews").doc(e.toString()).delete(),u("Ulasan dihapus!")}catch{u("Gagal menghapus ulasan!")}finally{P()}})};window.filterReviews=os;window.rAdmReviews=Et;window.replyToReview=ls;window.toggleReviewVisibility=is;window.deleteReview=ns;window.rAdmL=e=>{qe(e),typeof window.setCTab=="function"&&window.setCTab(e),window.cTab=e,S("admin-content",`
    ...
    `),rAdmItms(e)};window.rAdmItms=e=>{e&&(qe(e),typeof window.setCTab=="function"&&window.setCTab(e),window.cTab=e);const t=h("admin-list-container"),a=t?t.closest(".scroll-content"):null,o=a?a.scrollTop:0;if(e==="products"&&h("admin-product-stats")){const l=Ue();S("admin-product-stats",`
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                <div class="card-modern p-5 sm:p-5">
        ...
        <div class="p-4 sm:p-5 md:p-6 lg:p-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4 rounded-[1.5rem] border shadow-sm cursor-pointer hover:shadow-md hover:-translate-y-1 hover:border-[var(--color-primary)]/40 dark:hover:border-[var(--color-primary)]/40 transition-all duration-300 ${m}" onclick="oAEd('${e}',${l.id})">
            <div class="flex items-start sm:items-center gap-4 min-w-0 w-full">
                ...
                <div class="min-w-0 flex flex-col justify-center py-1">
                    ...
                    ${p?`<p class="text-sm sm:text-base font-bold text-[var(--color-primary)] tracking-tight">${x(l.price)}</p>`:""}
                    ...
                    ${p&&window.isAdm&&l.hpp?`<p class="text-[10px] font-bold text-amber-500 mt-0.5"><i class="fa-solid fa-coins mr-1"></i>HPP: ${x(l.hpp)}</p>`:""}
                    ${p?(()=>{const I=l.variants&&l.variants.length?l.variants.reduce((R,H)=>R+(parseFloat(H.totalSold)||0),0):parseFloat(l.totalSold)||0;return I>0?`<p class="text-[10px] font-bold text-orange-400 mt-0.5"><i class="fa-solid fa-fire-flame-curved mr-1"></i>Terjual: ${I}</p>`:""})():""}
    ...
    `},fs=()=>{let e=document.getElementById("guarantee-modal");e||(e=document.createElement("div"),e.id="guarantee-modal",e.className="fixed inset-0 z-[115] bg-slate-900/70 backdrop-blur-sm flex items-end sm:items-center justify-center p-0 sm:p-5",e.onclick=t=>{t.target===e&&Rt()},document.body.appendChild(e)),e.innerHTML=`
        ...
        </div>`,e.style.opacity="0",e.style.display="flex",requestAnimationFrame(()=>{e.style.transition="opacity 0.25s ease",e.style.opacity="1"})},Ft=()=>{const e=document.getElementById("security-modal");!e||e.style.display==="none"||(e.style.opacity="0",e.style.transition="opacity 0.25s ease",setTimeout(()=>{e.style.display="none",e.style.opacity="",e.style.transition=""},250))};window.renderStorefrontFooter=Nt;window.openQualityGuaranteeModal=fs;window.closeQualityGuaranteeModal=Rt;window.openSecurityModal=gs;window.closeSecurityModal=Ft;const _e=()=>{if(Nt(),O("dyn-store-name",r.store.name||"Toko Putri"),O("dyn-store-slogan",r.store.slogan||r.store.tagline||r.store.desc||r.store.description||"Toko Online & Kasir Resmi"),r.store.logo){const n=h("dyn-store-logo-img"),l=h("dyn-store-logo-icon");r.store.logo.includes("http")||r.store.logo.includes("data:")?n&&(n.src=r.store.logo,n.onerror=()=>{n.onerror=null,n.src="https://placehold.co/100?text=Logo"},_("dyn-store-logo-img"),E("dyn-store-logo-icon")):l&&(l.className=`fa-solid ${c(r.store.logo)} text-xl text-[var(--color-primary)]`,_("dyn-store-logo-icon"),E("dyn-store-logo-img"))}let e=r.banners&&r.banners.length?`
    <div class="relative group/banner-wrapper w-full">
        <div id="banner-slider" class="flex overflow-x-auto gap-4 sm:gap-6 pb-4 pt-2 snap-x hide-scrollbar scroll-smooth" ontouchstart="clearInterval(window.bannerTmr)" ontouchend="setTimeout(() => window.startBannerAutoSlide?.(), 8000)" onmouseenter="clearInterval(window.bannerTmr)" onmouseleave="window.startBannerAutoSlide?.()" onscroll="window.onBannerScroll && window.onBannerScroll()">
            ${r.banners.map((n,l)=>{const p=n.type==="video"&&n.videoUrl,d=!p&&n.link?`onclick="window.open('${c(n.link)}', '_self')"`:"";if(p){const m=ta(n.videoUrl)||{type:"direct",directUrl:et(n.videoUrl),embedUrl:aa(n.videoUrl)};let b="";return m.type==="youtube"?b=`
                <iframe
        ...
        <div class="flex gap-2.5 sm:gap-3 overflow-x-auto hide-scrollbar snap-x pb-3 pt-1">
            ${t.map(l=>{let p=l.type==="shipping_free"?"Gratis Ongkir":l.type==="percent"?`Diskon ${c(String(parseFloat(l.value)||0))}%`:`Diskon ${x(l.value)}`,d=[];l.minPurchase>0&&d.push(`Min. Blj ${x(l.minPurchase)}`),l.maxDiscount>0&&d.push(`Maks. ptg ${x(l.maxDiscount)}`),l.targetProduct&&d.push("Produk Khusus");let m=d.length>0?c(d.join(" • ")):"Tanpa min. belanja";return`
...
>`,s+="</div>"}),s=`<div class="grid grid-cols-1 lg:grid-cols-2 gap-x-5 gap-y-5 items-start">${s}</div>`,S("admin-modal-form",s),e==="products"&&(window.rVarsB?.(),window.rWholB?.(),window.rSpecB?.());const p=h("admin-modal");p&&p.classList.contains("hidden")&&ks("admin"),_("admin-modal"),setTimeout(()=>{h("admin-modal").classList.remove("opacity-0"),h("admin-modal-box").classList.remove("scale-95")},10)};window.submitAdminForm=async()=>{if(ve)return;M(!0);const e=bt||window.cTab||"products";let t={},a=at[e]||[];for(let s of a)if(s.type==="variants_builder")t.variants=K.filter(i=>i.name.trim()!=="");else if(s.type==="wholesale_builder")t.wholesale=me.filter(i=>parseFloat(i.minQty)>.01&&i.price>0);else if(s.type==="spec_table_builder")t.specTable=ee.filter(i=>i.key.trim()!=="");else{let i="";if(s.type==="richtext"){const n=h(`af-${s.key}-editor`);i=n?n.innerHTML:""}else i=$(`af-${s.key}`);if(typeof i=="string"){if(i.startsWith("data:image/")&&i.length>3e5)return M(!1),u("Gambar Base64 terlalu besar! Upload file.");s.key==="img"&&(i=j(i))}t[s.key]=s.type==="number"?parseFloat(i)||0:i}if(!t.name&&!t.title&&!t.bankName&&!t.code)return M(!1),u("Judul/Nama/Kode wajib diisi!");if(e==="products"&&!t.sku&&(t.sku="SKU"+Date.now().toString().slice(-6)),e==="customers"){const s=window.normalizeWA?window.normalizeWA(t.phone):(t.phone||"").replace(/\D/g,"").replace(/^0/,"62");if(!s||s.length<10)return M(!1),u("Nomor WhatsApp tidak valid!");t.phone=s,t.points=parseFloat(t.points)||0,t.id=parseInt(s,10)}let o=null;if(e==="customers")if(r.customers||(r.customers=[]),Q){o=Q;let s=r.customers.findIndex(i=>i.id===Q);s>-1?r.customers[s]=t:r.customers.unshift(t)}else r.customers.unshift(t);else if(e==="rewards")if(r.rewards||(r.rewards=[]),Q){t.id=Q;let s=r.rewards.findIndex(i=>i.id===Q);s>-1&&(r.rewards[s]=t)}else t.id=Date.now(),r.rewards.unshift(t);else if(Q){t.id=Q,r[e]||(r[e]=[]);let s=r[e].findIndex(i=>i.id===Q);if(e==="products"&&s>-1){const i=r[e][s];t.totalSold=i.totalSold||0,t.variants&&t.variants.length&&i.variants&&t.variants.forEach(n=>{const l=i.variants.find(p=>p.name===n.name);l&&l.totalSold&&(n.totalSold=l.totalSold)})}s>-1&&(r[e][s]=t)}else t.id=Date.now(),r[e]||(r[e]=[]),r[e].unshift(t);T("Menyimpan...");try{const s=typeof y<"u"&&y?y:window.db,i=typeof N=="function"?N:window.saveApp||(async()=>{});if(!s)throw new Error("Database Firebase belum terhubung");if(e==="products")await s.collection("freshmart").doc("cms_data").collection("products").doc(t.id.toString()).set(t),await i([],{updateType:"product_single",updatedProductIds:[t.id.toString()]});else if(e==="customers"){const n=s.collection("freshmart").doc("cms_data").collection("customers");o!==null&&o!==t.id&&await n.doc(o.toString()).delete().catch(()=>{}),await n.doc(t.phone).set(t,{merge:!0})}else e==="rewards"?await s.collection("freshmart").doc("cms_data").collection("rewards").doc(t.id.toString()).set(t):await i([e]);window.closeAdminModal?.(),window.rAdmItms?.(e),u("Tersimpan!")}catch(s){console.error("Gagal simpan admin data:",s),u("Gagal menyimpan: "+(s.message||""))}finally{M(!1),P()}};window.oADel=async(e,t)=>{window.showConfirm?.("Hapus Data","Data yang dihapus tidak bisa dikembalikan lagi.",async()=>{if(ve)return;M(!0);const a=typeof y<"u"&&y?y:window.db,o=typeof N=="function"?N:window.saveApp||(async()=>{}),s=r[e]&&r[e].find(i=>i.id===t);r[e]=r[e].filter(i=>i.id!==t),T("Menghapus...");try{if(!a)throw new Error("Database Firebase belum terhubung");if(e==="products")await a.collection("freshmart").doc("cms_data").collection("products").doc(t.toString()).delete(),await o([],{updateType:"product_delete",updatedProductIds:[t.toString()]});else if(e==="customers"){const i=s?s.phone:t.toString();await a.collection("freshmart").doc("cms_data").collection("customers").doc(i).delete()}else e==="rewards"?await a.collection("freshmart").doc("cms_data").collection("rewards").doc(t.toString()).delete():await o([e]);window.rAdmItms?.(e),u("Berhasil Dihapus!")}catch(i){u("Gagal menghapus: "+(i.message||""))}finally{M(!1),P()}})};window.duplicateProduct=async e=>{window.showConfirm?.("Duplikat Produk","Menyalin data produk ini ke item baru?",async()=>{if(ve)return;M(!0);const t=typeof y<"u"&&y?y:window.db,a=typeof N=="function"?N:window.saveApp||(async()=>{}),o=r.products.find(i=>i.id===e);if(!o){M(!1);return}let s=JSON.parse(JSON.stringify(o));s.id=Date.now()+Math.floor(Math.random()*1e3),s.name=s.name+" COPY",s.sku="",s.totalSold=0,s.variants&&s.variants.length>0&&(s.variants=s.variants.map(i=>(i.sku="",i.totalSold=0,i))),r.products.unshift(s),T("Menyalin...");try{if(!t)throw new Error("Database Firebase belum terhubung");await t.collection("freshmart").doc("cms_data").collection("products").doc(s.id.toString()).set(s),await a([],{updateType:"product_single",updatedProductIds:[s.id.toString()]}),window.rAdmItms?.("products"),u("Produk berhasil disalin!")}catch(i){u("Gagal menyalin: "+(i.message||""))}finally{M(!1),P()}},"Ya, Salin",!1)};window.rSpecB=()=>{const e=document.getElementById("spec-table-builder-container");if(!e)return;let t="";ee.length>0?t+=`<div class="overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm mb-4">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-4">
        ...
        </div>`,s.style.opacity="0",s.style.display="flex",requestAnimationFrame(()=>{s.style.transition="opacity 0.25s ease",s.style.opacity="1"}),ys("restock")};window.closeRestockModal=(e=!1)=>{Ot("restock",e,()=>{const t=document.getElementById("restock-modal");!t||t.style.display==="none"||(t.style.opacity="0",t.style.transition="opacity 0.25s ease",setTimeout(()=>{t.style.display="none",t.style.opacity="",t.style.transition=""},250))})};window.processRestock=async e=>{if(ve)return;M(!0);const t=r.products.findIndex(n=>n.id===e);if(t<0){M(!1);return}const a=r.products[t],o=a.variants&&a.variants.length>0;let s=JSON.parse(JSON.stringify(a)),i=0;if(o)s.variants=s.variants.map((l,p)=>{const d=parseFloat(document.getElementById("restock-var-"+p)?.value)||0;return d>0&&(l.stock=(parseFloat(l.stock)||0)+d,i+=d,l.stock>0&&(l.isActive===!1||l.isActive==="false")&&(l.isActive=!0)),l}),s.variants.some(l=>(parseFloat(l.stock)||0)>0&&l.isActive!==!1&&l.isActive!=="false")&&(s.isActive===!1||s.isActive==="false")&&(s.isActive="true");else{const n=parseFloat(document.getElementById("restock-main")?.value)||0;n>0&&(s.stock=(parseFloat(s.stock)||0)+n,i+=n,s.stock>0&&(s.isActive===!1||s.isActive==="false")&&(s.isActive="true"))}if(i<=0)return M(!1),u("Masukkan jumlah restock terlebih dahulu!");T("Menyimpan Restock...");try{const n=typeof y<"u"&&y?y:window.db,l=typeof N=="function"?N:window.saveApp||(async()=>{});if(!n)throw new Error("Database Firebase belum terhubung");const p=n.collection("freshmart").doc("cms_data").collection("products").doc(e.toString());let d=0;await n.runTransaction(async m=>{const b=await m.get(p);if(!b.exists)throw new Error("Produk tidak ditemukan di server");const g=JSON.parse(JSON.stringify(b.data()));if(o)a.variants.forEach((f,k)=>{const C=parseFloat(document.getElementById("restock-var-"+k)?.value)||0;if(C<=0)return;const A=(g.variants||[]).findIndex(w=>w.name===f.name);A>-1&&(g.variants[A].stock=(parseFloat(g.variants[A].stock)||0)+C,g.variants[A].stock>0&&(g.variants[A].isActive===!1||g.variants[A].isActive==="false")&&(g.variants[A].isActive=!0))}),g.variants.some(f=>(parseFloat(f.stock)||0)>0&&f.isActive!==!1&&f.isActive!=="false")&&(g.isActive===!1||g.isActive==="false")&&(g.isActive="true"),d=g.variants.reduce((f,k)=>f+(parseFloat(k.stock)||0),0);else{const v=parseFloat(document.getElementById("restock-main")?.value)||0;g.stock=(parseFloat(g.stock)||0)+v,g.stock>0&&(g.isActive===!1||g.isActive==="false")&&(g.isActive="true"),d=g.stock}m.set(p,g),Object.assign(s,g)}),r.products[t]=s,await l([],{updateType:"stock_change",updatedProductIds:[e.toString()]}),closeRestockModal(),window.rAdmItms?.("products"),O("stat-products",r.products.filter(m=>m.isActive!=="false"&&m.isActive!==!1).length),u(`✅ Restock +${i} berhasil! Total stok: ${d}`)}catch(n){u("Gagal restock: "+(n.message||""))}finally{M(!1),P()}};window.toggleProductStatus=async(e,t)=>{if(ve)return;M(!0);const a=r.products.findIndex(o=>o.id===e);if(a>-1){r.products[a].isActive=t?"true":"false",T(t?"Mengaktifkan...":"Menonaktifkan...");try{const o=typeof y<"u"&&y?y:window.db,s=typeof N=="function"?N:window.saveApp||(async()=>{});if(!o)throw new Error("Database Firebase belum terhubung");await o.collection("freshmart").doc("cms_data").collection("products").doc(e.toString()).update({isActive:t?"true":"false"}),await s([],{updateType:"stock_change",updatedProductIds:[e.toString()]}),O("stat-products",r.products.filter(i=>i.isActive!=="false"&&i.isActive!==!1).length),window.rAdmItms?.("products"),u(t?"Produk Aktif!":"Stok Dikosongkan!")}catch(o){u("Gagal update status: "+(o.message||""))}finally{M(!1),P()}}};window.closeAdminModal=(e=!1)=>{Ot("admin",e,()=>{h("admin-modal").classList.add("opacity-0"),h("admin-modal-box").classList.add("scale-95"),setTimeout(()=>E("admin-modal"),300)})};const $s=e=>window.pushModalHistory?.(e),Ss=(e,t,a)=>window.requestCloseModal?.(e,t,a);let V;window.openCameraScanner=async(e="search-input")=>{const t=h("scanner-modal");t&&t.classList.contains("hidden")&&$s("scanner"),_("scanner-modal"),setTimeout(()=>{h("scanner-modal").classList.remove("opacity-0")},10);try{await Ct("https://cdnjs.cloudflare.com/ajax/libs/html5-qrcode/2.3.8/html5-qrcode.min.js",()=>typeof Html5Qrcode<"u")}catch{u("Gagal memuat modul kamera. Cek koneksi internet Anda."),closeCameraScanner();return}V||(V=new Html5Qrcode("reader"));const a={fps:10,qrbox:{width:250,height:250}};setTimeout(()=>{V&&V.start({facingMode:"environment"},a,o=>{let s=h(e);s&&(s.value=o,e==="search-input"?window.handleSearch?.(o):(s.dispatchEvent(new Event("input",{bubbles:!0})),s.dispatchEvent(new Event("change",{bubbles:!0})))),u("Barcode discan!"),closeCameraScanner()},o=>{}).catch(o=>{u("Akses kamera ditolak/gagal!"),closeCameraScanner()})},100)};window.closeCameraScanner=(e=!1)=>{Ss("scanner",e,()=>{if(h("scanner-modal").classList.add("opacity-0"),V)try{V.getState()===2||V.getState()===3?V.stop().then(()=>{V.clear(),V=null}).catch(t=>{V.clear(),V=null}):(V.clear(),V=null)}catch{V=null}setTimeout(()=>E("scanner-modal"),300)})};const Ps=e=>window.pushModalHistory?.(e),Ts=(e,t,a)=>window.requestCloseModal?.(e,t,a);let Ee=[];window.openQuickPriceModal=e=>{const t=r.products.find(i=>i.id===e);if(!t)return;const a=t.variants&&t.variants.length>0;Ee=!a&&t.wholesale?JSON.parse(JSON.stringify(t.wholesale)):[];let o="";a?o=t.variants.map((i,n)=>`
        ...
        </div>`,a||rQpWhol(),s.style.opacity="0",s.style.display="flex",requestAnimationFrame(()=>{s.style.transition="opacity 0.25s ease",s.style.opacity="1"}),Ps("quickprice")};window.rQpWhol=()=>{S("qp-whol-container",Ee.length?Ee.map((e,t)=>`
        <div class="flex items-center gap-2">
        ...
        </div>`).join(""):'<p class="text-[11px] font-bold text-slate-400 text-center py-2">Belum ada tingkat harga grosir.</p>')};window.qpAddWhol=()=>{Ee.push({minQty:0,price:0}),rQpWhol()};window.closeQuickPriceModal=(e=!1)=>{Ts("quickprice",e,()=>{const t=document.getElementById("quickprice-modal");!t||t.style.display==="none"||(t.style.opacity="0",t.style.transition="opacity 0.25s ease",setTimeout(()=>{t.style.display="none",t.style.opacity="",t.style.transition=""},250))})};window.processQuickPrice=async e=>{if(ve)return;M(!0);const t=r.products.findIndex(s=>s.id===e);if(t<0){M(!1);return}const a=r.products[t],o=a.variants&&a.variants.length>0;T("Menyimpan Harga...");try{const s=typeof y<"u"&&y?y:window.db,i=typeof N=="function"?N:window.saveApp||(async()=>{});if(!s)throw new Error("Database Firebase belum terhubung");const n=s.collection("freshmart").doc("cms_data").collection("products").doc(e.toString());let l=null;await s.runTransaction(async p=>{const d=await p.get(n);if(!d.exists)throw new Error("Produk tidak ditemukan di server");const m=JSON.parse(JSON.stringify(d.data()));o?a.variants.forEach((b,g)=>{const v=(m.variants||[]).findIndex(f=>f.name===b.name);v<0||(m.variants[v].hpp=parseFloat(document.getElementById("qp-var-hpp-"+g)?.value)||0,m.variants[v].price=parseFloat(document.getElementById("qp-var-price-"+g)?.value)||0,m.variants[v].priceNormal=parseFloat(document.getElementById("qp-var-normal-"+g)?.value)||0,m.variants[v].poin=parseFloat(document.getElementById("qp-var-poin-"+g)?.value)||0)}):(m.hpp=parseFloat(document.getElementById("qp-hpp")?.value)||0,m.price=parseFloat(document.getElementById("qp-price")?.value)||0,m.priceNormal=parseFloat(document.getElementById("qp-normal")?.value)||0,m.poin=parseFloat(document.getElementById("qp-poin")?.value)||0,m.wholesale=Ee.filter(b=>parseFloat(b.minQty)>.01&&b.price>0)),p.set(n,m),l=m}),r.products[t]=l,await i([],{updateType:"stock_change",updatedProductIds:[e.toString()]}),closeQuickPriceModal(),window.rAdmItms?.("products"),u("✅ Harga berhasil diperbarui!")}catch(s){u("Gagal simpan harga: "+(s.message||""))}finally{M(!1),P()}};window.rWholB=()=>{let e=`<div class="space-y-4 mb-4">${me.map((a,o)=>`
        ...
        <button onclick="addWhol()" class="w-full py-4 bg-amber-50 dark:bg-amber-900/20 text-amber-600 font-bold rounded-[1.5rem] text-sm border-2 border-amber-200 border-dashed hover:bg-amber-100 transition-all flex items-center justify-center gap-2 active:scale-95 shadow-sm"><i class="fa-solid fa-tags"></i> Tambah Tingkatan Grosir</button>`;const t=document.getElementById("wholesale-builder-container");t&&(t.innerHTML=e)};window.addWhol=()=>{me.push({minQty:2,price:0}),ut(me),window.rWholB()};window.rmWhol=e=>{me.splice(e,1),ut(me),window.rWholB()};window.uWhol=(e,t,a)=>{me[e][t]=parseFloat(a)||0};let bt="products";const qe=e=>{bt=e,window.cTab=e};let Ht="";const As=e=>{Ht=e,window.aSq=e};let Q=null;const Ut=e=>{Q=e,window.eId=e};let ve=!1;const M=e=>{ve=e};let K=[];const Ke=e=>{K=e};let me=[];const ut=e=>{me=e};let ee=[];const ft=e=>{ee=e};window.setCTab=qe;window.setASq=As;window.setEId=Ut;const Cs=(e,t=!1)=>{const a=document.querySelector("#view-admin .scroll-content");if(a&&(a.scrollTop=0),ra(e),oa(""),!t){const s=history.state;s&&s.view==="view-admin"&&s.tab?history.replaceState({view:"view-admin",tab:e},"",window.location.href):history.pushState({view:"view-admin",tab:e},"",window.location.href)}if(E("admin-dashboard-view"),_("admin-content-view"),_("btn-admin-back"),E("admin-logo-box"),O("admin-header-title",{orders:"Pesanan",settings:"Toko",products:"Produk",categories:"Kategori",brands:"Merek",banks:"Rekening",banners:"Banner",vouchers:"Voucher",customers:"Database Pelanggan",rewards:"Program Hadiah",reviews:"Ulasan Pelanggan",faqs:"Tanya Jawab / Q&A",tax:"Pajak & Keuangan",piutang:"Piutang Tempo",colors:"Database Warna",changelog:"Log Pembaruan Sistem"}[e]||"CMS"),e!=="orders"&&ce&&(ce(),Me(null)),e!=="customers"&&ne&&(ne(),je(null)),e!=="reviews"&&de&&(de(),Ie(null)),e==="settings")typeof window.rAdmSet=="function"&&window.rAdmSet();else if(e==="orders")typeof window.rAdmOrd=="function"&&window.rAdmOrd();else if(e==="tax")typeof window.rTaxPanel=="function"&&window.rTaxPanel();else if(e==="piutang")typeof window.rAdmPiutang=="function"&&window.rAdmPiutang();else if(e==="customers"){S("admin-content",'<div class="text-center py-16"><i class="fa-solid fa-spinner fa-spin text-3xl text-slate-300"></i></div>'),ne&&(ne(),je(null));const s=y.collection("freshmart").doc("cms_data").collection("customers").onSnapshot(i=>{r.customers=i.docs.map(n=>n.data()),typeof window.rAdmL=="function"&&window.rAdmL("customers")},()=>{u("Gagal memuat data pelanggan!"),typeof window.rAdmL=="function"&&window.rAdmL("customers")});je(s)}else if(e==="reviews"){S("admin-content",'<div class="text-center py-16"><i class="fa-solid fa-spinner fa-spin text-3xl text-slate-300"></i></div>'),de&&(de(),Ie(null));const s=y.collection("freshmart").doc("cms_data").collection("reviews").onSnapshot(i=>{const n=i.docs.map(l=>l.data());n.sort((l,p)=>{const d=l.createdAt&&l.createdAt.toMillis?l.createdAt.toMillis():0;return(p.createdAt&&p.createdAt.toMillis?p.createdAt.toMillis():0)-d}),sa(n),typeof window.rAdmReviews=="function"&&window.rAdmReviews()},()=>{u("Gagal memuat ulasan!")});Ie(s)}else e==="faqs"?typeof window.rAdmFAQ=="function"&&window.rAdmFAQ():e==="changelog"?typeof window.rAdmChangelog=="function"&&window.rAdmChangelog():typeof window.rAdmL=="function"&&window.rAdmL(e)};window.openAdminTab=Cs;let De="all";const js=e=>{if(!e)return"";try{const t=e.split("-");return t.length===3?new Date(parseInt(t[0]),parseInt(t[1])-1,parseInt(t[2])).toLocaleDateString("id-ID",{day:"numeric",month:"short",year:"numeric"}):e}catch{return e}},Is=e=>{switch(e){case"feature":return{label:"Fitur Baru",icon:"fa-rocket",colorClass:"bg-slate-100 dark:bg-slate-800/90 text-slate-700 dark:text-slate-300 border-slate-200/80 dark:border-slate-700/80",iconColor:"text-[var(--color-primary)]"};case"optimization":return{label:"Optimasi",icon:"fa-bolt-lightning",colorClass:"bg-slate-100 dark:bg-slate-800/90 text-slate-700 dark:text-slate-300 border-slate-200/80 dark:border-slate-700/80",iconColor:"text-[var(--color-primary)]"};case"maintenance":return{label:"Maintenance",icon:"fa-wrench",colorClass:"bg-slate-100 dark:bg-slate-800/90 text-slate-700 dark:text-slate-300 border-slate-200/80 dark:border-slate-700/80",iconColor:"text-[var(--color-primary)]"};case"bugfix":return{label:"Perbaikan",icon:"fa-bug-slash",colorClass:"bg-slate-100 dark:bg-slate-800/90 text-slate-700 dark:text-slate-300 border-slate-200/80 dark:border-slate-700/80",iconColor:"text-[var(--color-primary)]"};default:return{label:"Update",icon:"fa-tag",colorClass:"bg-slate-100 dark:bg-slate-800/90 text-slate-700 dark:text-slate-300 border-slate-200/80 dark:border-slate-700/80",iconColor:"text-[var(--color-primary)]"}}},Ds=()=>{const e=h("changelog-items-container");if(!e)return;const t=ct(r),a=De==="all"?t:t.filter(s=>s.category===De);if(a.length===0){e.innerHTML=`
        ...
        </div>`;return}let o="";a.forEach((s,i)=>{const n=i===0&&De==="all",l=Is(s.category),p=js(s.date),d=(s.items||[]).map(m=>`
        ...
        </div>`,document.body.appendChild(t));const a=pt(r),o=h("changelog-header-ver");o&&(o.textContent=a),De=e,Vt(e),t.style.display="flex",requestAnimationFrame(()=>{t.classList.remove("opacity-0");const s=h("changelog-modal-box");s&&s.classList.remove("translate-y-full","sm:translate-y-8")})},qt=()=>{const e=h("changelog-modal");if(!e||e.style.display==="none")return;e.classList.add("opacity-0");const t=h("changelog-modal-box");t&&t.classList.add("translate-y-full","sm:translate-y-8"),setTimeout(()=>{e.style.display="none"},300)};window.openChangelogModal=Ms;window.closeChangelogModal=qt;window.filterChangelog=Vt;let ye=!1,we=null;const gt=()=>{const e=new Date,t=e.getFullYear(),a=String(e.getMonth()+1).padStart(2,"0"),o=String(e.getDate()).padStart(2,"0");return`${t}-${a}-${o}`},Ls=e=>{if(!e)return"";try{const t=e.split("-");return t.length===3?new Date(parseInt(t[0]),parseInt(t[1])-1,parseInt(t[2])).toLocaleDateString("id-ID",{day:"numeric",month:"short",year:"numeric"}):e}catch{return e}},Re=()=>{const e=h("admin-content");if(!e)return;const t=r.changelog||[],a=ct(r),o=pt(r);let s="";a.length===0?s=`
        <div class="text-center py-12 text-slate-400">
        ...
        </div>`:s=a.map(i=>{const n=t.some(b=>b.id===i.id),l=i.version===o,p=(i.items||[]).map(b=>`
            ...
            `).join("");let d="Update",m="fa-tag";return i.category==="feature"?(d="Fitur Baru",m="fa-rocket"):i.category==="optimization"?(d="Optimasi",m="fa-bolt-lightning"):i.category==="maintenance"?(d="Maintenance",m="fa-wrench"):i.category==="bugfix"&&(d="Perbaikan",m="fa-bug-slash"),`
                ...
                <div class="flex flex-wrap items-center justify-between gap-2 border-b border-slate-100 dark:border-slate-800 pb-3">
                    <div class="flex items-center gap-2 flex-wrap">
                        ...
                        <span class="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-md border border-slate-200/80 dark:border-slate-700/80 bg-slate-100 dark:bg-slate-800 text-[10px] font-bold text-slate-700 dark:text-slate-300">
                            <i class="fa-solid ${m} text-[9px] text-[var(--color-primary)]"></i> ${c(d)}
                        </span>
                    ...
                    <div class="flex items-center gap-2">
                        <span class="text-[10px] font-bold text-slate-400 dark:text-slate-500">
                            <i class="fa-regular fa-calendar mr-1"></i> ${c(Ls(i.date))}
                        </span>
                        ${n?`
    ...
    </div>`},Bs=(e=null)=>{ye=e!==null?e:!ye,ye||(we=null),Re()},_s=e=>{const t=(r.changelog||[]).find(s=>s.id===e);if(!t)return;we=e,ye=!0,Re(),fe("form-log-version",t.version||""),fe("form-log-category",t.category||"feature"),fe("form-log-date",t.date||gt()),fe("form-log-title",t.title||""),fe("form-log-items",(t.items||[]).join(`
`));const a=h("changelog-form-title");a&&(a.innerHTML=`<i class="fa-solid fa-pen text-[var(--color-primary)]"></i> Edit Catatan Pembaruan (${c(t.version)})`);const o=h("changelog-form-box");o&&o.scrollIntoView({behavior:"smooth"})},Es=async()=>{const e=($("form-log-version")||"").trim(),t=$("form-log-category")||"feature",a=$("form-log-date")||gt(),o=($("form-log-title")||"").trim(),s=($("form-log-items")||"").trim();if(!e)return u("Nomor versi harus diisi (contoh: v1.2.1)!");if(!o)return u("Judul pembaruan harus diisi!");if(!s)return u("Tuliskan minimal 1 poin rincian perubahan!");const i=s.split(`
`).map(l=>l.replace(/^[-*•]\s*/,"").trim()).filter(l=>l.length>0);if(i.length===0)return u("Rincian perubahan tidak boleh kosong!");T("Menyimpan catatan pembaruan...");const n={id:we||"log-"+Date.now().toString(36),version:e.startsWith("v")?e:"v"+e,category:t,date:a,title:o,items:i,updatedAt:new Date().toISOString()};if(r.changelog=r.changelog||[],we){const l=r.changelog.findIndex(p=>p.id===we);l!==-1?r.changelog[l]=n:r.changelog.unshift(n)}else r.changelog.unshift(n);try{await N(["changelog"]),u("Catatan pembaruan berhasil dipublikasikan secara real-time!","success"),ye=!1,we=null,Re()}catch(l){u("Gagal menyimpan log pembaruan: "+l.message,"error")}finally{P()}},Ns=e=>{const t=(r.changelog||[]).find(a=>a.id===e);t&&he(`Hapus catatan pembaruan versi "${t.version}"?`,async()=>{T("Menghapus catatan..."),r.changelog=(r.changelog||[]).filter(a=>a.id!==e);try{await N(["changelog"]),u("Catatan berhasil dihapus!","success"),Re()}catch(a){u("Gagal menghapus catatan: "+a.message,"error")}finally{P()}},"Ya, Hapus","Konfirmasi Hapus")};window.rAdmChangelog=Re;window.toggleChangelogForm=Bs;window.editChangelogEntry=_s;window.saveChangelogEntry=Es;window.deleteChangelogEntry=Ns;export{pa as A,ke as a,$e as b,Se as c,y as d,xs as e,hs as f,vs as g,ma as h,Us as i,J as j,jt as k,Hs as l,Fe as m,qs as n,Nt as r,Ha as s,Vs as t,X as u};
