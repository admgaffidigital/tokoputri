...
import{f as pe}from"./vendor-firebase-core-D2OF5R23.js";import{p as Js,a as Ys}from"./vendor-firebase-db-BHlQMNP0.js";import{p as Xs}from"./vendor-utils-bRchjNq8.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))o(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&o(i)}).observe(document,{childList:!0,subtree:!0});function a(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function o(s){if(s.ep)return;s.ep=!0;const r=a(s);fetch(s.href,r)}})();const Zs="modulepreload",eo=function(e){return"/"+e},Ma={},to=function(t,a,o){let s=Promise.resolve();if(a&&a.length>0){document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),l=i?.nonce||i?.getAttribute("nonce");s=Promise.allSettled(a.map(d=>{if(d=eo(d),d in Ma)return;Ma[d]=!0;const p=d.endsWith(".css"),f=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${f}`))return;const g=document.createElement("link");if(g.rel=p?"stylesheet":Zs,p||(g.as="script"),g.crossOrigin="",g.href=d,l&&g.setAttribute("nonce",l),document.head.appendChild(g),p)return new Promise((u,w)=>{g.addEventListener("load",u),g.addEventListener("error",()=>w(new Error(`Unable to preload CSS for ${d}`)))})}))}function r(i){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=i,window.dispatchEvent(l),!l.defaultPrevented)throw i}return s.then(i=>{for(const l of i||[])l.status==="rejected"&&r(l.reason);return t().catch(r)})},ao={apiKey:"AIzaSyCOjrhMP52TGbiOyQLY92NDYE26N6d9hJM",authDomain:"restu-karya-utama.firebaseapp.com",databaseURL:"https://restu-karya-utama-default-rtdb.asia-southeast1.firebasedatabase.app",projectId:"restu-karya-utama",storageBucket:"restu-karya-utama.firebasestorage.app",messagingSenderId:"858310421352",appId:"1:858310421352:web:e20a833875e8d5c19944dd",measurementId:"G-PHDG2LJ8PM"};try{localStorage.removeItem("freshmart_fb_config")}catch{}const oa=window.FIREBASE_CONFIG||ao;pe.apps.length||pe.initializeApp(oa);const $=pe.firestore(),fe=pe.auth();typeof window<"u"&&(window.firebase=pe,window.db=$,window.auth=fe);try{$.settings({localCache:Js({tabManager:Ys()}),ignoreUndefinedProperties:!0,merge:!0,experimentalForceLongPolling:!0,experimentalAutoDetectLongPolling:!1})}catch{try{$.settings({ignoreUndefinedProperties:!0,merge:!0,experimentalForceLongPolling:!0,experimentalAutoDetectLongPolling:!1})}catch{}}let so=null;const Da=()=>{to(()=>import("./vendor-firebase-analytics-Jm19L5g2.js"),__vite__mapDeps([0,1])).then(()=>{try{so=pe.analytics()}catch{}}).catch(()=>{})},ra="K2ijSERTT2dg27yYGTEgn6XHSnW2",Qe={emerald:{50:"#ecfdf5",100:"#d1fae5",200:"#a7f3d0",300:"#6ee7b7",400:"#34d399",500:"#10b981",600:"#059669",700:"#047857",800:"#065f46",900:"#064e3b"},teal:{50:"#f0fdfa",100:"#ccfbf1",200:"#99f6e4",300:"#5eead4",400:"#2dd4bf",500:"#14b8a6",600:"#0d9488",700:"#0f766e",800:"#115e59",900:"#134e4a"},cyan:{50:"#ecfeff",100:"#cffafe",200:"#a5f3fc",300:"#67e8f9",400:"#22d3ee",500:"#06b6d4",600:"#0891b2",700:"#0e7490",800:"#155e75",900:"#164e63"},sky:{50:"#f0f9ff",100:"#e0f2fe",200:"#bae6fd",300:"#7dd3fc",400:"#38bdf8",500:"#0ea5e9",600:"#0284c7",700:"#0369a1",800:"#075985",900:"#0c4a6e"},blue:{50:"#eff6ff",100:"#dbeafe",200:"#bfdbfe",300:"#93c5fd",400:"#60a5fa",500:"#3b82f6",600:"#2563eb",700:"#1d4ed8",800:"#1e40af",900:"#1e3a8a"},indigo:{50:"#eef2ff",100:"#e0e7ff",200:"#c7d2fe",300:"#a5b4fc",400:"#818cf8",500:"#6366f1",600:"#4f46e5",700:"#4338ca",800:"#3730a3",900:"#312e81"},violet:{50:"#f5f3ff",100:"#ede9fe",200:"#ddd6fe",300:"#c4b5fd",400:"#a78bfa",500:"#8b5cf6",600:"#7c3aed",700:"#6d28d9",800:"#5b21b6",900:"#4c1d95"},purple:{50:"#faf5ff",100:"#f3e8ff",200:"#e9d5ff",300:"#d8b4fe",400:"#c084fc",500:"#a855f7",600:"#9333ea",700:"#7e22ce",800:"#6b21a8",900:"#581c87"},fuchsia:{50:"#fdf4ff",100:"#fae8ff",200:"#f5d0fe",300:"#f0abfc",400:"#e879f9",500:"#d946ef",600:"#c026d3",700:"#a21caf",800:"#86198f",900:"#701a75"},pink:{50:"#fdf2f8",100:"#fce7f3",200:"#fbcfe8",300:"#f9a8d4",400:"#f472b6",500:"#ec4899",600:"#db2777",700:"#be185d",800:"#9d174d",900:"#831843"},rose:{50:"#fff1f2",100:"#ffe4e6",200:"#fecdd3",300:"#fda4af",400:"#fb7185",500:"#f43f5e",600:"#e11d48",700:"#be123c",800:"#9f1239",900:"#881337"},red:{50:"#fef2f2",100:"#fee2e2",200:"#fecaca",300:"#fca5a5",400:"#f87171",500:"#dc2626",600:"#b91c1c",700:"#991b1b",800:"#7f1d1d",900:"#450a0a"},orange:{50:"#fff7ed",100:"#ffedd5",200:"#fed7aa",300:"#fdba74",400:"#fb923c",500:"#ea580c",600:"#c2410c",700:"#9a3412",800:"#7c2d12",900:"#431407"},amber:{50:"#fffbeb",100:"#fef3c7",200:"#fde68a",300:"#fcd34d",400:"#fbbf24",500:"#d97706",600:"#b45309",700:"#92400e",800:"#78350f",900:"#451a03"},yellow:{50:"#fefce8",100:"#fef9c3",200:"#fef08a",300:"#fde047",400:"#eab308",500:"#d97706",600:"#b45309",700:"#854d0e",800:"#713f12",900:"#3f1d0b"},lime:{50:"#f7fee7",100:"#ecfccb",200:"#d9f99d",300:"#bef264",400:"#a3e635",500:"#65a30d",600:"#4d7c0f",700:"#3f6212",800:"#365314",900:"#1a2e05"},green:{50:"#f0fdf4",100:"#dcfce7",200:"#bbf7d0",300:"#86efac",400:"#4ade80",500:"#16a34a",600:"#15803d",700:"#166534",800:"#14532d",900:"#052e16"},slate:{50:"#f8fafc",100:"#f1f5f9",200:"#e2e8f0",300:"#cbd5e1",400:"#94a3b8",500:"#475569",600:"#334155",700:"#1e293b",800:"#0f172a",900:"#020617"},stone:{50:"#fafaf9",100:"#f5f5f4",200:"#e7e5e4",300:"#d6d3d1",400:"#a8a29e",500:"#57534e",600:"#44403c",700:"#292524",800:"#1c1917",900:"#0c0a09"}},ks=e=>{let t=parseInt(e.replace("#",""),16);return(t>>16&255)+","+(t>>8&255)+","+(t&255)},Ca=(e,t)=>{let a=parseInt(e.slice(1,3),16),o=parseInt(e.slice(3,5),16),s=parseInt(e.slice(5,7),16);return a=Math.max(0,Math.min(255,a+t)),o=Math.max(0,Math.min(255,o+t)),s=Math.max(0,Math.min(255,s+t)),"#"+[a,o,s].map(r=>r.toString(16).padStart(2,"0")).join("")},wt=(e,t)=>{const a=e||localStorage.getItem("freshmart_ui_theme")||"emerald",o=Qe[a]||Qe.emerald;e&&localStorage.setItem("freshmart_ui_theme",a);const s=t||localStorage.getItem("freshmart_theme_color")||o[500];t&&localStorage.setItem("freshmart_theme_color",s);const r=ks(s),i=Ca(s,-30),l=Ca(s,150);document.documentElement.style.setProperty("--color-primary",s),document.documentElement.style.setProperty("--color-primary-dark",i),document.documentElement.style.setProperty("--color-primary-light",l),document.documentElement.style.setProperty("--color-primary-rgb",r);let d=document.querySelector('meta[name="theme-color"]');return d||(d=document.createElement("meta"),d.setAttribute("name","theme-color"),document.head.appendChild(d)),d.setAttribute("content",s),o},oo=()=>{const e=localStorage.getItem("freshmart_theme"),t=window.matchMedia("(prefers-color-scheme: dark)").matches;(e==="dark"||!e&&t)&&document.documentElement.classList.add("dark")},ro=()=>{const e=document.documentElement.classList.toggle("dark");localStorage.setItem("freshmart_theme",e?"dark":"light");const t=document.getElementById("icon-theme")||document.getElementById("theme-toggle-icon");t&&(t.className=e?"fa-solid fa-sun text-sm text-amber-400":"fa-solid fa-moon text-sm text-slate-600 dark:text-slate-300")},io=()=>{const e=document.documentElement.classList.contains("dark"),t=document.getElementById("icon-theme")||document.getElementById("theme-toggle-icon");t&&(t.className=e?"fa-solid fa-sun text-sm text-amber-400":"fa-solid fa-moon text-sm text-slate-600 dark:text-slate-300")},ht=(e="minimalist",t="")=>{const a=e||localStorage.getItem("freshmart_bg_style")||"minimalist",o=t??(localStorage.getItem("freshmart_bg_custom_url")||"");e&&localStorage.setItem("freshmart_bg_style",a),t!=null&&localStorage.setItem("freshmart_bg_custom_url",o),document.documentElement.setAttribute("data-bg-style",a),document.body?.setAttribute("data-bg-style",a);const s=document.getElementById("app-container");s&&s.setAttribute("data-bg-style",a);const r=document.getElementById("dynamic-bg-container");if(!r)return;if(r.innerHTML="",r.className="pointer-events-none fixed inset-0 z-0 overflow-hidden",o&&typeof o=="string"&&o.trim()){const l=document.createElement("div");l.className="absolute inset-0 z-0 bg-cover bg-center bg-no-repeat opacity-20 dark:opacity-15 pointer-events-none",l.style.backgroundImage=`url('${o.trim()}')`,r.appendChild(l);const d=document.createElement("div");d.className="absolute inset-0 z-0 bg-slate-50/70 dark:bg-[#0b1120]/80 pointer-events-none",r.appendChild(d)}let i="";if(a==="hero_arch"?i=`
        ...
        `:i="",i){const l=document.createElement("div");l.className="absolute inset-0 z-0 pointer-events-none",l.innerHTML=i,r.appendChild(l)}},m=e=>document.getElementById(e),j=e=>{const t=m(e);t&&t.classList.remove("hidden")},k=e=>{const t=m(e);t&&t.classList.add("hidden")},ee=(e,t,a)=>{const o=m(e);o&&o.classList.toggle(t,a)},H=(e,t)=>{const a=m(e);a&&(a.innerText=t)},A=(e,t)=>{const a=m(e);a&&(a.innerHTML=t)},se=(e,t)=>{const a=m(e);a&&(a.value=t)},L=e=>{const t=m(e);return t?t.value:""},ge=e=>{try{return localStorage.getItem(e)}catch{return null}},J=(e,t)=>{try{localStorage.setItem(e,t)}catch{}},c=e=>e==null?"":e.toString().replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t]),x=e=>{const t=Number(e);return isNaN(t)||e===null?"Rp 0":new Intl.NumberFormat("id-ID",{style:"currency",currency:"IDR",minimumFractionDigits:0}).format(Math.abs(t)).replace(/^/,t<0?"-":"")},W=e=>{if(typeof e!="string")return e;const t=e.match(/drive\.google\.com.*(?:id=|\/d\/)([a-zA-Z0-9_-]+)/);return t?`https://lh3.googleusercontent.com/d/${t[1]}`:e},Dt=e=>{if(!e||typeof e!="string")return null;const t=e.trim();if(/^[a-zA-Z0-9_-]{11}$/.test(t))return t;const a=t.match(/(?:youtube\.com\/(?:[^\/]+\/.+\/|(?:v|e(?:mbed)?|shorts)\/|.*[?&]v=)|youtu\.be\/)([^"&?\/\s]{11})/i);return a?a[1]:null},Ct=e=>{if(typeof e!="string"||!e.trim())return null;const t=e.trim(),a=Dt(t);if(a)return{type:"youtube",id:a,embedUrl:`https://www.youtube.com/embed/${a}?autoplay=1&mute=1&muted=1&loop=1&playlist=${a}&controls=0&modestbranding=1&rel=0&enablejsapi=1&playsinline=1`};const o=t.match(/(?:drive\.google\.com.*(?:id=|\/d\/)|googleusercontent\.com\/d\/)([a-zA-Z0-9_-]+)/);if(o&&o[1]){const s=o[1];return{type:"gdrive",id:s,streamUrl:`https://drive.google.com/uc?export=download&id=${s}`,streamUrl2:`https://docs.google.com/uc?export=download&id=${s}`,directUrl:`https://drive.google.com/uc?export=download&id=${s}`,embedUrl:`https://drive.google.com/file/d/${s}/preview?autoplay=1`}}return{type:"direct",directUrl:t,embedUrl:t}},Lt=e=>{const t=Ct(e);return t?t.embedUrl:e},$s=e=>{const t=Ct(e);return t?t.embedUrl:e},ce=(e,t)=>typeof e!="string"?e:e.includes("lh3.googleusercontent.com/d/")?`${e.split("=")[0]}=${t}`:e,It=e=>e?e.status==="ready"?"(Dikirim Bersama Pesanan)":e.status==="waiting_stock"?"(Stok Kosong - Ditunda)":"(Menunggu Konfirmasi)":"",lo=(e,t,a,o)=>{document.title=e||"Toko Putri";const s=(r,i,l=!1)=>{const d=l?"property":"name";let p=document.querySelector(`meta[${d}="${r}"]`);p||(p=document.createElement("meta"),p.setAttribute(d,r),document.head.appendChild(p)),p.setAttribute("content",i)};t&&s("description",t),e&&s("og:title",e,!0),t&&s("og:description",t,!0),a&&s("og:image",a,!0),o&&s("og:url",o,!0)},no=(e,t)=>{let a=document.getElementById(e);a||(a=document.createElement("script"),a.id=e,a.type="application/ld+json",document.head.appendChild(a)),a.textContent=JSON.stringify(t)},U=e=>{e&&H("loader-text",e);const t=m("global-loader");t&&(t.style.display="flex")},D=()=>{const e=m("global-loader");e&&(e.style.display="none")},b=(e,t,a,o)=>{typeof window.showToast=="function"&&window.showToast(e,t,a,o)},De=(e,t,a,o)=>{typeof window.showConfirm=="function"&&window.showConfirm(e,t,a,o)},Xe={};window.loadedScripts=Xe;const Ss=(e,t)=>t&&t()?Promise.resolve():(Xe[e]||(Xe[e]=new Promise((a,o)=>{const s=document.createElement("script");s.src=e,s.onload=()=>a(),s.onerror=()=>{delete Xe[e],o(new Error("Gagal memuat: "+e))},document.head.appendChild(s)})),Xe[e]),co=e=>{let t=(e||"").toString().replace(/\D/g,"");return t?(t.startsWith("0")?t="62"+t.substring(1):t.startsWith("62")||(t="62"+t),t):""};window.normalizeWA=co;const me={store:{name:"Nama Toko Anda",slogan:"Slogan Toko",logo:"fa-store",wa:"",address:"",lat:"",lng:"",costPerKm:0,isDeliveryEnabled:!0,isPickupEnabled:!0,allProductsIcon:"",allBrandsIcon:"",categoryStyle:"text",brandStyle:"image",showCategories:!0,showBrands:!0,themeColor:"#10b981",uiTheme:"emerald",bgStyle:"hero_arch",bgCustomUrl:"",showRewardCatalog:!0,useStock:!1,ppnEnabled:!1,ppnType:"exclusive",ppnRate:11,terms:"",privacy:""},payment:{qrisUrl:""},config:{gasUrl:""},banks:[],banners:[],categories:[],brands:[],products:[],vouchers:[],colors:[],rewards:[],faqs:[],customers:[],taxSettings:{companyName:"",npwp:"",taxScheme:"umkm_final",customTaxRate:.5,monthlyExpenses:{},balanceSheet:{kas:0,piutang:0,hutang:0,modalDisetor:0}}};let n=JSON.parse(JSON.stringify(me)),F=[],xe=[],Pe=[],B={name:"",address:"",lat:null,lng:null,deliveryMethod:"delivery",distance:0,note:"",wa:""},Ee=null,$e=null,He="Semua Produk",ke="Semua Merek",Ze="",et="newest",Kt="grid",ia=1,po=12,M=null,ae=0,Se=1,ve=[],Oe=null,_e=null,Re=null,de=[],jt=[],it=null,N=null,Ke=!1,Ps="all",Ts="today";const Pt=e=>{F=e},mo=e=>{Pe=e},uo=e=>{B=e},tt=e=>{Ee=e},Me=e=>{$e=e},la=e=>{He=e},na=e=>{ke=e},As=e=>{Ze=e},fo=e=>{et=e},bo=e=>{Kt=e},Ce=e=>{ia=e},go=e=>{M=e},Wt=e=>{ae=e},da=e=>{Se=e},La=e=>{de=e},xo=e=>{jt=e},wo=e=>{it=e},be=e=>{N=e},te=e=>{Ke=e},ho=e=>{Ps=e},vo=e=>{Ts=e},ft=e=>{Oe=e},pt=e=>{_e=e},mt=e=>{Re=e};let Et="https://script.google.com/macros/s/AKfycbx3dW9rHcdoKNYjSOJ8PoH2k6fABe7XlBD9teNHsBlCBqJquq8jd4UvnfXZVsfKdFsC/exec";const Ms=()=>{const e=de.find(d=>d.orderId===it);if(!e)return;const t=e.dateString?new Date(e.dateString).toLocaleString("id-ID",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}):"",a=n.store.name||"Toko",o=n.store.wa||"",s=(d,p,f=32)=>{const g=f-d.length-p.length;return d+(g>0?" ".repeat(g):" ")+p};let r=`<div class="text-center font-bold" style="font-size:13px;margin-bottom:2px;">${c(a)}</div>`;if(o&&(r+=`<div class="text-center" style="margin-bottom:4px;">WA: ${c(o)}</div>`),r+=`<div class="border-b border-dashed border-black my-2"></div><div style="white-space:pre;">Order: #${e.orderId}</div><div style="white-space:pre;">Tgl  : ${t}</div><div style="white-space:pre;">Plg  : ${c(e.customer?.name||"Guest").substring(0,20)}</div><div style="white-space:pre;">Tipe : ${e.customer?.deliveryMethod==="delivery"?"Dikirim":"Ambil di Toko"}</div><div class="border-b border-dashed border-black my-2"></div>`,e.customer?.note&&(r+=`<div style="white-space:pre-wrap;word-break:break-all;">Cat: ${c(e.customer.note)}</div><div class="border-b border-dashed border-black my-2"></div>`),e.items.forEach(d=>{let p=d.variantName?` (${c(d.variantName)}${d.colorCode?" "+c(d.colorCode):""})`:"";const f=(c(d.name)+p+(d.poTime?" [PO]":"")).substring(0,32),g=`${parseFloat(d.qty)} ${c(d.unit||"pcs")} x ${d.effectivePrice.toLocaleString("id-ID")}`,u=(parseFloat(d.qty)*d.effectivePrice).toLocaleString("id-ID");r+=`<div style="white-space:pre-wrap;font-weight:bold;word-break:break-all;">${f}</div><div style="white-space:pre;font-size:11px;">${s(g,u)}</div>`,d.poTime&&(r+=`<div style="white-space:pre;font-size:10px;font-style:italic;color:#4b5563;">* Estimasi PO: ${c(d.poTime)}</div>`)}),r+=`<div class="border-b border-dashed border-black my-2"></div><div style="white-space:pre;">${s("Subtotal",(e.payment?.subtotal||0).toLocaleString("id-ID"))}</div>`,e.customer?.deliveryMethod==="delivery"&&(r+=`<div style="white-space:pre;">${s("Ongkir",(e.payment?.shippingCost||0).toLocaleString("id-ID"))}</div>`),e.payment?.shippingDiscount&&(r+=`<div style="white-space:pre;">${s("Pot.Ongkir",`-${e.payment.shippingDiscount.toLocaleString("id-ID")}`)}</div>`),e.payment?.productDiscount&&(r+=`<div style="white-space:pre;">${s("Pot.Harga",`-${e.payment.productDiscount.toLocaleString("id-ID")}`)}</div>`),e.payment?.ppnAmount&&e.payment.ppnAmount>0){const d=e.payment.ppnType==="inclusive",p=e.payment.ppnRate||11,f=e.payment.ppnAmount||0,g=(e.payment.subtotal||0)-(e.payment.productDiscount||0)+(e.payment.shippingCost||0)-(e.payment.shippingDiscount||0),u=e.payment.dppAmount||(d?Math.round(g*100/(100+p)):Math.max(0,g));r+=`<div style="white-space:pre;">${s("DPP",u.toLocaleString("id-ID"))}</div>`,r+=`<div style="white-space:pre;">${s(`${d?"Inc. PPN":"PPN"} (${p}%)`,(d?"":"+")+f.toLocaleString("id-ID"))}</div>`}r+=`<div class="border-b border-dashed border-black my-2"></div><div style="white-space:pre;font-weight:bold;font-size:12px;">${s("TOTAL","Rp "+(e.payment?.grandTotal||0).toLocaleString("id-ID"))}</div><div style="white-space:pre;">${s("Bayar:",String(e.payment?.method||"").toUpperCase())}</div>`,(e.pointsEarned>0||e.finalMemberPoints!==void 0)&&(r+='<div class="border-b border-dashed border-black my-2"></div>',e.pointsEarned>0&&(r+=`<div style="white-space:pre;">${s("Poin Didapat:","+"+e.pointsEarned)}</div>`),e.finalMemberPoints!==void 0&&e.finalMemberPoints!==null&&(r+=`<div style="white-space:pre;font-weight:bold;">${s("Saldo Poin:",String(e.finalMemberPoints))}</div>`),e.claimedReward&&(r+=`<div style="white-space:pre-wrap;font-weight:bold;word-break:break-all;margin-top:2px;">HADIAH: ${c(e.claimedReward.name)}</div><div style="white-space:pre;font-size:10px;">(${e.claimedReward.status==="ready"?"Kirim bersama pesanan":e.claimedReward.status==="waiting_stock"?"Stok kosong-ditunda":"Menunggu konfirmasi"})</div>`)),e.items.some(d=>d.poTime&&d.poTime!=="")&&(r+='<div class="border-b border-dashed border-black my-2"></div><div style="white-space:pre-wrap;font-size:9px;text-align:center;line-height:1.2;font-style:italic;color:#4b5563;margin-bottom:4px;">* Catatan: Untuk pesanan gabungan, produk PO akan dikirimkan menyusul tanpa tambahan biaya.</div>'),r+='<div class="border-b border-dashed border-black my-2"></div><div class="text-center my-2" style="font-size:10px;">Terima Kasih</div><div class="border-b border-dashed border-black my-2"></div><div style="height:15px;"></div>',A("receipt-paper-content",r);const l=m("receipt-preview-modal");l&&l.classList.contains("hidden")&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("receipt"),j("receipt-preview-modal"),setTimeout(()=>{m("receipt-preview-modal")&&m("receipt-preview-modal").classList.remove("opacity-0"),m("receipt-preview-modal-box")&&m("receipt-preview-modal-box").classList.remove("scale-95")},10)},yo=(e=!1)=>{typeof window.requestCloseModal=="function"?window.requestCloseModal("receipt",e,()=>{m("receipt-preview-modal")&&m("receipt-preview-modal").classList.add("opacity-0"),m("receipt-preview-modal-box")&&m("receipt-preview-modal-box").classList.add("scale-95"),setTimeout(()=>k("receipt-preview-modal"),300)}):(m("receipt-preview-modal")&&m("receipt-preview-modal").classList.add("opacity-0"),m("receipt-preview-modal-box")&&m("receipt-preview-modal-box").classList.add("scale-95"),setTimeout(()=>k("receipt-preview-modal"),300))},ko=()=>{if(!de.find(o=>o.orderId===it))return;const t=m("receipt-paper-content")?m("receipt-paper-content").innerHTML:"",a=m("thermal-print-section");a&&(a.innerHTML=t,window.print())};window.openReceiptPreview=Ms;window.closeReceiptPreviewModal=yo;window.executePrintReceipt=ko;window.checkProPrint=()=>{Ms()};let Ds="invoice";const $o=e=>{Ds=e;const t=de.find(l=>l.orderId===it);if(!t)return;H("doc-modal-title",e==="invoice"?"Preview Faktur Invoice":"Preview Surat Jalan");const a=t.dateString?new Date(t.dateString).toLocaleString("id-ID",{day:"2-digit",month:"2-digit",year:"numeric"}):"";let o="";n.store.logo&&(n.store.logo.includes("http")||n.store.logo.includes("data:"))?o=`<img loading="eager" src="${c(n.store.logo)}" class="w-16 h-16 object-contain">`:o='<div class="w-16 h-16 primary-bg flex items-center justify-center rounded-xl text-white"><i class="fa-solid fa-store text-3xl"></i></div>';let s=`
    ...
    `,A("doc-paper-content",s);const i=m("doc-preview-modal");i&&i.classList.contains("hidden")&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("docPreview"),j("doc-preview-modal"),setTimeout(()=>{m("doc-preview-modal")&&m("doc-preview-modal").classList.remove("opacity-0"),m("doc-preview-modal-box")&&m("doc-preview-modal-box").classList.remove("scale-95"),ca()},10)},ca=()=>{const e=m("doc-paper-scroll-area"),t=m("doc-paper-content"),a=m("doc-paper-wrapper");if(!e||!t||!a)return;const o=794,r=e.clientWidth-16,i=Math.min(1,r/o);t.style.transform=`translateX(-50%) scale(${i})`,a.style.height=t.offsetHeight*i+"px"};window.addEventListener("resize",()=>{const e=m("doc-preview-modal");e&&!e.classList.contains("hidden")&&ca()});const So=(e=!1)=>{typeof window.requestCloseModal=="function"?window.requestCloseModal("docPreview",e,()=>{m("doc-preview-modal")&&m("doc-preview-modal").classList.add("opacity-0"),m("doc-preview-modal-box")&&m("doc-preview-modal-box").classList.add("scale-95"),setTimeout(()=>k("doc-preview-modal"),300)}):(m("doc-preview-modal")&&m("doc-preview-modal").classList.add("opacity-0"),m("doc-preview-modal-box")&&m("doc-preview-modal-box").classList.add("scale-95"),setTimeout(()=>k("doc-preview-modal"),300))},Po=()=>{const e=m("doc-paper-content")?m("doc-paper-content").innerHTML:"",t=window.open("","_blank");if(!t){typeof window.showToast=="function"&&window.showToast("Gagal membuka tab baru. Izinkan pop-up di browser Anda!");return}t.document.write(`
        <html>
        <head>
    ...
    <div class="flex gap-4 overflow-x-auto hide-scrollbar snap-x pb-6 pt-2">
    ...
    </div>`;e.innerHTML=o};let Ia=null;const Co=()=>{clearTimeout(Ia),Ia=setTimeout(async()=>{const t=(window.normalizeWA||(s=>(s||"").replace(/\D/g,"").replace(/^0/,"62")))(L("cust-wa")),a=m("member-status-banner");if(!a)return;if(!t||t.length<10){k(a),k("payment-option-tempo"),tt(null),Me(null);return}const o=Ht.get(t);if(o&&Date.now()-o.timestamp<Mo){o.data?(tt(o.data),a.className="mt-3 p-4 rounded-2xl border border-[var(--color-primary)]/30 bg-[rgba(var(--color-primary-rgb),0.06)] dark:bg-[rgba(var(--color-primary-rgb),0.12)] flex items-center justify-between gap-3",a.innerHTML='<p class="text-[11px] font-bold text-[var(--color-primary)] leading-snug"><i class="fa-solid fa-circle-check mr-1"></i>Nomor Anda terdaftar sebagai pelanggan toko kami!</p><button type="button" onclick="openMemberModal()" class="shrink-0 bg-[var(--color-primary)] hover:opacity-90 text-white text-[10px] font-bold uppercase tracking-widest px-3.5 py-2.5 rounded-xl shadow-sm active:scale-95 transition-all whitespace-nowrap">Lihat Data Saya</button>',j(a),j("payment-option-tempo")):(tt(null),Me(null),k(a),k("payment-option-tempo"));return}try{const s=await $.collection("freshmart").doc("cms_data").collection("customers").doc(t).get();if(s.exists){const r=s.data();Ht.set(t,{data:r,timestamp:Date.now()}),tt(r),a.className="mt-3 p-4 rounded-2xl border border-[var(--color-primary)]/30 bg-[rgba(var(--color-primary-rgb),0.06)] dark:bg-[rgba(var(--color-primary-rgb),0.12)] flex items-center justify-between gap-3",a.innerHTML='<p class="text-[11px] font-bold text-[var(--color-primary)] leading-snug"><i class="fa-solid fa-circle-check mr-1"></i>Nomor Anda terdaftar sebagai pelanggan toko kami!</p><button type="button" onclick="openMemberModal()" class="shrink-0 bg-[var(--color-primary)] hover:opacity-90 text-white text-[10px] font-bold uppercase tracking-widest px-3.5 py-2.5 rounded-xl shadow-sm active:scale-95 transition-all whitespace-nowrap">Lihat Data Saya</button>',j(a),j("payment-option-tempo")}else Ht.set(t,{data:null,timestamp:Date.now()}),tt(null),Me(null),k(a),k("payment-option-tempo")}catch{}},500)},Lo=()=>{if(!Ee)return;typeof window.attachRewardsRealtime=="function"&&!window.unsubRewardsRealtime&&window.attachRewardsRealtime();let e=document.getElementById("member-modal");e||(e=document.createElement("div"),e.id="member-modal",e.className="fixed inset-0 z-[115] bg-slate-900/70 backdrop-blur-sm flex items-end sm:items-center justify-center p-0 sm:p-5",e.onclick=t=>{t.target===e&&Cs()},document.body.appendChild(e)),e.innerHTML=`
        ...
        </div>`,_t(),e.style.opacity="0",e.style.display="flex",requestAnimationFrame(()=>{e.style.transition="opacity 0.25s ease",e.style.opacity="1"}),typeof window.pushModalHistory=="function"&&window.pushModalHistory("member")},_t=()=>{if(!Ee)return;const e=(n.rewards||[]).filter(o=>o.isActive!=="false"&&o.isActive!==!1),t=parseFloat(Ee.points)||0,a=e.length?e.map(o=>{const s=(parseFloat(o.stock)||0)>0,r=t>=(parseFloat(o.pointsCost)||0)&&s,i=$e&&$e.id===o.id;return`
        <div class="flex items-center gap-3 p-4 rounded-[1.25rem] border ${i?"border-[var(--color-primary)] bg-[rgba(var(--color-primary-rgb),0.06)] dark:bg-[rgba(var(--color-primary-rgb),0.12)]":"border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900/50"}">
            ${o.img?`<img src="${c(o.img)}" class="w-14 h-14 rounded-xl object-cover border border-slate-200 dark:border-slate-700 shrink-0" onerror="this.style.display='none'" loading="lazy">`:'<div class="w-14 h-14 rounded-xl bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-slate-300 shrink-0"><i class="fa-solid fa-gift text-xl"></i></div>'}
            <div class="min-w-0 flex-1">
                <p class="text-xs font-bold text-slate-800 dark:text-white truncate">${c(o.name)}</p>
                <p class="text-[11px] font-bold text-[var(--color-primary)] mt-0.5"><i class="fa-solid fa-star mr-1"></i>${parseFloat(o.pointsCost)||0} Poin</p>
                ${s?"":'<p class="text-[10px] font-bold text-rose-500 mt-0.5">Stok hadiah kosong</p>'}
            </div>
            ${i?'<button type="button" onclick="deselectReward()" class="shrink-0 bg-rose-500 hover:bg-rose-600 text-white text-[10px] font-bold uppercase px-3 py-2.5 rounded-xl active:scale-95 transition-all whitespace-nowrap">Batal</button>':`<button type="button" ${r?"":"disabled"} onclick="selectReward(${o.id})" class="shrink-0 ${r?"bg-[var(--color-primary)] hover:opacity-90 text-white active:scale-95":"bg-slate-200 dark:bg-slate-700 text-slate-400 cursor-not-allowed"} text-[10px] font-bold uppercase px-3 py-2.5 rounded-xl transition-all whitespace-nowrap">Pilih</button>`}
    ...
    `)},Io=e=>{const t=(n.rewards||[]).find(o=>o.id===e);if(!t)return;if((parseFloat(Ee?.points)||0)<(parseFloat(t.pointsCost)||0)){typeof window.showToast=="function"&&window.showToast("Poin Anda belum cukup untuk hadiah ini!");return}if((parseFloat(t.stock)||0)<=0){typeof window.showToast=="function"&&window.showToast("Maaf, stok hadiah ini sedang kosong!");return}Me({id:t.id,name:t.name,pointsCost:parseFloat(t.pointsCost)||0}),_t(),typeof window.showToast=="function"&&window.showToast(`Hadiah "${t.name}" dipilih! Lanjutkan checkout untuk menukarnya.`)},jo=()=>{Me(null),_t()},Cs=(e=!1)=>{const t=document.getElementById("member-modal");!t||t.style.display==="none"||(t.style.opacity="0",t.style.transition="opacity 0.25s ease",setTimeout(()=>{t.style.display="none",t.style.opacity="",t.style.transition=""},250))};window.renderRewardCatalog=Do;window.checkMemberStatus=Co;window.openMemberModal=Lo;window.rMemberModalBody=_t;window.selectReward=Io;window.deselectReward=jo;window.closeMemberModal=Cs;const Tt=()=>{const e=n.store.useStock===!0||n.store.useStock==="true",t=F.filter(a=>{const o=n.products.find(s=>s.id===a.id);if(!o||o.isActive==="false"||o.isActive===!1)return!1;if(a.variantName){const s=(o.variants||[]).find(r=>r.name===a.variantName);if(!s||s.isActive===!1||s.isActive==="false"||e&&(parseFloat(s.stock)||0)<=0)return!1}else if(e&&(parseFloat(o.stock)||0)<=0)return!1;return!0});Pt(t),J("freshmart_cart",JSON.stringify(F))},Te=()=>{J("freshmart_cart",JSON.stringify(F));const e=typeof window.getEffP=="function"?window.getEffP:r=>r.price||0,t=parseFloat(F.reduce((r,i)=>r+(parseFloat(i.qty)||0),0).toFixed(2)),a=F.reduce((r,i)=>r+e(i)*(parseFloat(i.qty)||0),0);H("cart-badge",t.toString()),H("cart-total-preview",x(a));const o=m("cart-badge");o&&o.classList.toggle("scale-0",t<=0);const s=m("floating-cart-container");s&&(t>0?(s.classList.remove("scale-0","pointer-events-none"),s.classList.add("scale-100","pointer-events-auto")):(s.classList.remove("scale-100","pointer-events-auto"),s.classList.add("scale-0","pointer-events-none")))},ze=()=>{if(!F.length){j("cart-empty-state"),k("cart-bottom-bar"),k("btn-clear-cart"),j("spacer-cart"),A("cart-items-container","");return}k("cart-empty-state"),j("cart-bottom-bar"),j("btn-clear-cart"),k("spacer-cart");const e=typeof window.getEffP=="function"?window.getEffP:a=>a.price||0;let t=0;A("cart-items-container",F.map((a,o)=>{let s=parseFloat(a.qty)||0,r=e(a),i=r<a.price;t+=r*s;let l=a.colorCode?`<span class="w-3.5 h-3.5 rounded-full shadow-inner border border-slate-300 dark:border-slate-600 shrink-0" style="background-color: ${c(a.colorCode)};"></span>`:"";return`
                ...
                <div class="flex justify-between items-end mt-auto pt-1">
                    <div>
                        ...
                        <div class="flex items-baseline gap-1">
                            <p class="text-[var(--color-primary)] font-bold text-base sm:text-lg leading-none tracking-tight">${x(r)}</p>
        ...
        </div>`}).join("")+($e?`<div class="flex justify-between items-center bg-[rgba(var(--color-primary-rgb),0.06)] dark:bg-[rgba(var(--color-primary-rgb),0.12)] p-4 rounded-[1.25rem] border border-[var(--color-primary)]/30 shadow-sm min-w-0"><div class="flex items-center gap-3.5 min-w-0"><div class="w-12 h-12 rounded-xl bg-[var(--color-primary)] text-white flex items-center justify-center shrink-0"><i class="fa-solid fa-gift"></i></div><div class="min-w-0"><p class="text-sm font-bold text-[var(--color-primary)] truncate">${c($e.name)}</p><p class="text-[11px] text-[var(--color-primary)] font-bold mt-1"><i class="fa-solid fa-star mr-1"></i>Tukar ${$e.pointsCost} Poin (Gratis)</p></div></div><button type="button" onclick="if(typeof deselectReward==='function') deselectReward(); rPay();" class="text-[10px] font-bold text-rose-500 uppercase shrink-0 ml-3">Batal</button></div>`:"")),B.note?(H("payment-note-text",`"${c(B.note)}"`),j("payment-note-preview")):k("payment-note-preview"),A("dynamic-banks-container",n.banks?.length?n.banks.map(h=>`<div class="bg-white dark:bg-slate-800 p-4 rounded-[1.25rem] border border-slate-200 dark:border-slate-700 shadow-sm"><p class="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1">Bank ${c(h.bankName)}</p><p class="text-lg font-bold text-[var(--color-primary)] tracking-wide">${c(h.bankAccount)}</p><p class="text-xs text-slate-500 dark:text-slate-400 font-medium mt-1.5">a.n <span class="font-bold text-slate-700 dark:text-white">${c(h.bankOwner)}</span></p></div>`).join(""):'<div class="bg-rose-50 dark:bg-rose-900/20 border border-rose-200 p-4 rounded-[1.25rem] text-center"><p class="text-sm text-rose-500 dark:text-rose-400 font-bold">Rekening belum diatur.</p></div>');const u=m("payment-option-cashier"),w=m("payment-option-cod");if(u&&w){if(B.deliveryMethod==="pickup"){if(j("payment-option-cashier"),k("payment-option-cod"),(document.querySelector('input[name="payment"]:checked')||{}).value==="cod"){const h=document.querySelector('input[value="cashier"]');h&&(h.checked=!0)}}else{k("payment-option-cashier"),j("payment-option-cod");const h=(document.querySelector('input[name="payment"]:checked')||{}).value;if(h==="cashier"||!h){const S=document.querySelector('input[value="cod"]');S&&(S.checked=!0)}}typeof window.togglePaymentDetails=="function"&&window.togglePaymentDetails()}const v=m("tnc-checkbox");v&&(v.checked=!1,Ls())},Oo=async()=>{if(!m("tnc-checkbox").checked||Ke)return;if(window.isAdm){typeof window.showToast=="function"&&window.showToast("Anda login sebagai Seller. Logout dulu untuk membuat pesanan.");return}const e=ge("freshmart_last_order");if(e&&Date.now()-parseInt(e)<6e4){typeof window.showToast=="function"&&window.showToast("Tunggu 1 menit untuk pesanan baru!");return}const t=typeof window.getEffP=="function"?window.getEffP:r=>r.price||0,a=typeof window.getEffHpp=="function"?window.getEffHpp:()=>0,o=typeof window.getEffPoin=="function"?window.getEffPoin:()=>0;let s=!1;if(F.forEach(r=>{const i=n.products.find(d=>d.id===r.id);if(!i)return;const l=r.variantName?((i.variants||[]).find(d=>d.name===r.variantName)||{}).price??i.price:i.price;l!==void 0&&Math.abs(r.price-l)>1&&(r.price=l,s=!0),r.poin=o(r)}),s){J("freshmart_cart",JSON.stringify(F)),typeof window.renderCart=="function"&&window.renderCart(),Is(),typeof window.showToast=="function"&&window.showToast("Harga produk telah diperbarui. Periksa kembali sebelum order.");return}te(!0),U("Proses Pesanan...");try{const r=F.reduce((y,_)=>y+(parseFloat(t(_))||0)*(parseFloat(_.qty)||0),0);let i=0,l=0,d=0;B.deliveryMethod==="delivery"&&(i=Math.ceil((parseFloat(B.distance)||0)*(parseFloat(n.store.costPerKm)||0)/500)*500);const p=n.store.useStock===!0||n.store.useStock==="true";if(p)for(const y of F){const _=n.products.find(E=>E.id===y.id);if(!_)continue;const Y=parseFloat(y.qty)||0;if(y.variantName){const E=(_.variants||[]).find(Q=>Q.name===y.variantName),G=parseFloat(E&&E.stock!==void 0?E.stock:0);if(G<Y){te(!1),D(),typeof window.showToast=="function"&&window.showToast(`Stok ${y.name} (${y.variantName}) tidak cukup! Sisa: ${G}`);return}}else{const E=parseFloat(_.stock!==void 0?_.stock:0);if(E<Y){te(!1),D(),typeof window.showToast=="function"&&window.showToast(`Stok ${y.name} tidak cukup! Sisa: ${E}`);return}}}if(N){let y=r;if(N.targetProduct&&N.targetProduct!==""){const _=parseInt(N.targetProduct);y=F.filter(E=>E.id===_).reduce((E,G)=>E+(parseFloat(t(G))||0)*(parseFloat(G.qty)||0),0)}if(N.minPurchase&&parseFloat(N.minPurchase)>0&&r<parseFloat(N.minPurchase))be(null);else if(N.targetProduct&&N.targetProduct!==""&&y===0)be(null);else if(N.type&&N.type.includes("shipping")&&B.deliveryMethod!=="delivery")be(null);else if(N.type==="shipping_free")l=i;else if(N.type==="shipping_flat")l=parseFloat(N.value)||0;else if(N.type==="percent"){let _=y*((parseFloat(N.value)||0)/100);N.maxDiscount&&parseFloat(N.maxDiscount)>0&&(_=Math.min(_,parseFloat(N.maxDiscount))),d=_}else d=parseFloat(N.value)||0,d=Math.min(d,y)}l=Math.min(l,i),d=Math.min(d,r);const f=Math.max(0,r-d+(i-l)),u=(typeof window.calcTaxDetails=="function"?window.calcTaxDetails:()=>({ppnEnabled:!1,ppnAmount:0,grandTotalAdd:0}))(f),w=u.ppnAmount,v=u.dppAmount,h=f+u.grandTotalAdd,S=(document.querySelector('input[name="payment"]:checked')||{}).value,C=S==="transfer"||S==="qris"||S==="tempo",T=window.buktiGDriveUploaded&&window.buktiPaymentUrl&&!window.buktiPaymentUrl.startsWith("data:");if(C&&!T){if(te(!1),D(),!window.buktiPaymentFile){typeof window.showToast=="function"&&window.showToast("Upload bukti pembayaran terlebih dahulu!");return}typeof window.showToast=="function"&&window.showToast("Tunggu upload Google Drive selesai, atau coba lagi!");return}const O="ORD-"+Date.now().toString(36).toUpperCase()+"-"+Math.random().toString(36).substring(2,6).toUpperCase();if(window.buktiPaymentFile&&!window.buktiGDriveUploaded)try{U("Upload Bukti ke Google Drive...");const y=await window.uploadBuktiToFirebase(window.buktiPaymentFile,O);if(y&&!y.startsWith("data:"))window.buktiPaymentUrl=y,window.buktiGDriveUploaded=!0;else{te(!1),D(),typeof window.showToast=="function"&&window.showToast("❌ Upload bukti ke Google Drive gagal. Coba pilih gambar lagi!");return}U("Proses Pesanan...")}catch{te(!1),D(),typeof window.showToast=="function"&&window.showToast("❌ Gagal upload bukti. Periksa koneksi dan coba lagi!");return}const I={orderId:O,timestamp:pe.firestore.FieldValue.serverTimestamp(),dateString:new Date().toISOString(),customer:B,items:F.map(y=>({...y,qty:parseFloat(y.qty),effectivePrice:t(y),poTime:y.poTime||"",hpp:a(y),poin:o(y)})),payment:{method:S,subtotal:r,shippingCost:i,shippingDiscount:l,productDiscount:d,ppnAmount:w,dppAmount:v,ppnRate:u.ppnEnabled?u.ppnRate:0,ppnType:u.ppnEnabled?u.ppnType:"exclusive",grandTotal:h},status:"Baru",buktiPayment:window.buktiPaymentUrl||null};if(S==="tempo"){const y=document.getElementById("tempo-dp-input");let _=y&&parseFloat(y.value)||0;_>h&&(_=h),I.payment.tempoDp=_,I.payment.tempoBalance=h-_,I.payment.tempoDueDate=Date.now()+30*24*60*60*1e3,I.payment.paymentStatus="hutang"}const P=$.collection("freshmart_orders").doc(O),q=F.reduce((y,_)=>y+o(_)*(parseFloat(_.qty)||0),0),K=$.collection("freshmart").doc("cms_data"),le=B.wa?K.collection("customers").doc(B.wa):null,we=!!$e;let R=null;if(p){const y={};F.forEach(E=>{const G=E.id!=null?E.id.toString():null;if(!G)return;y[G]||(y[G]={main:0,variants:{}});const Q=parseFloat(E.qty)||0;E.variantName?y[G].variants[E.variantName]=(y[G].variants[E.variantName]||0)+Q:y[G].main+=Q});const _=Object.keys(y),Y=_.map(E=>$.collection("freshmart").doc("cms_data").collection("products").doc(E));await $.runTransaction(async E=>{const G=we?$.collection("freshmart").doc("cms_data").collection("rewards").doc($e.id.toString()):null,Q=await Promise.all(Y.map(ue=>E.get(ue))),X=le?await E.get(le):null,dt=X&&X.exists&&G?await E.get(G):null,Ie=[];if(Q.forEach((ue,he)=>{if(!ue.exists)return;const qe=ue.data(),ye=y[_[he]];if(ye.main>0){const Z=parseFloat(qe.stock!==void 0?qe.stock:0);Z<ye.main&&Ie.push(`${qe.name} (sisa ${Z})`)}Object.keys(ye.variants).forEach(Z=>{const Ye=(qe.variants||[]).find(je=>je.name===Z),Ue=parseFloat(Ye&&Ye.stock!==void 0?Ye.stock:0);Ue<ye.variants[Z]&&Ie.push(`${qe.name} (${Z}, sisa ${Ue})`)})}),Ie.length)throw new Error("STOK_TIDAK_CUKUP: "+Ie.join(", "));let ct=null,kt=null;if(X&&X.exists){let ue=parseFloat(X.data().points)||0;if(we){if(!dt||!dt.exists)throw new Error("HADIAH_TIDAK_DITEMUKAN");const he=dt.data();if(ue<(parseFloat(he.pointsCost)||0))throw new Error("POIN_TIDAK_CUKUP");if((parseFloat(he.stock)||0)<=0)throw new Error("STOK_HADIAH_HABIS");ct=(parseFloat(he.stock)||0)-1,ue-=parseFloat(he.pointsCost)||0,I.claimedReward={id:he.id,name:he.name,pointsCost:parseFloat(he.pointsCost)||0,status:"pending",note:""}}ue+=q,kt=ue,I.pointsEarned=q,I.customerPhone=B.wa,I.finalMemberPoints=ue}else if(we)throw new Error("MEMBER_TIDAK_DITEMUKAN");Q.forEach((ue,he)=>{if(!ue.exists)return;const qe=_[he],ye=y[qe],Z=JSON.parse(JSON.stringify(ue.data()));ye.main>0&&(Z.stock=Math.max(0,(parseFloat(Z.stock)||0)-ye.main),Z.stock===0&&(Z.isActive="false"),Z.totalSold=(parseFloat(Z.totalSold)||0)+ye.main),Object.keys(ye.variants).forEach(Ue=>{const je=(Z.variants||[]).findIndex(zs=>zs.name===Ue);je>-1&&(Z.variants[je].stock=Math.max(0,(parseFloat(Z.variants[je].stock)||0)-ye.variants[Ue]),Z.variants[je].stock===0&&(Z.variants[je].isActive=!1),Z.variants[je].totalSold=(parseFloat(Z.variants[je].totalSold)||0)+ye.variants[Ue])});const Ye=n.products.findIndex(Ue=>Ue.id.toString()===qe);Ye>-1&&(n.products[Ye]=Z),E.set(Y[he],Z)}),E.set(P,I),kt!==null&&(E.set(le,{points:kt},{merge:!0}),R=kt),ct!==null&&E.set(G,{stock:ct},{merge:!0}),E.update(K,{lastUpdate:pe.firestore.FieldValue.increment(1),updateType:"stock_change",updatedProductIds:_})}),n.lastUpdate=(parseInt(ge("freshmart_last_update"))||n.lastUpdate||0)+1,J("freshmart_last_update",n.lastUpdate.toString()),J("freshmart_products",JSON.stringify(n.products))}else le?await $.runTransaction(async y=>{const _=we?$.collection("freshmart").doc("cms_data").collection("rewards").doc($e.id.toString()):null,Y=await y.get(le),E=Y.exists&&_?await y.get(_):null;if(Y.exists){let G=parseFloat(Y.data().points)||0,Q=null;if(we){if(!E||!E.exists)throw new Error("HADIAH_TIDAK_DITEMUKAN");const X=E.data();if(G<(parseFloat(X.pointsCost)||0))throw new Error("POIN_TIDAK_CUKUP");if((parseFloat(X.stock)||0)<=0)throw new Error("STOK_HADIAH_HABIS");Q=(parseFloat(X.stock)||0)-1,G-=parseFloat(X.pointsCost)||0,I.claimedReward={id:X.id,name:X.name,pointsCost:parseFloat(X.pointsCost)||0,status:"pending",note:""}}G+=q,I.pointsEarned=q,I.customerPhone=B.wa,I.finalMemberPoints=G,y.set(P,I),y.set(le,{points:G},{merge:!0}),R=G,Q!==null&&y.set(_,{stock:Q},{merge:!0})}else{if(we)throw new Error("MEMBER_TIDAK_DITEMUKAN");y.set(P,I)}}):await P.set(I);Pe.unshift({orderId:O,date:new Date().toISOString(),total:h,itemCount:F.reduce((y,_)=>y+parseFloat(_.qty),0),status:"Baru",pointsEarned:I.pointsEarned||0,claimedReward:I.claimedReward||null,finalMemberPoints:R}),J("freshmart_my_orders",JSON.stringify(Pe)),J("freshmart_last_order",Date.now().toString()),typeof analytics<"u"&&analytics.logEvent("purchase",{transaction_id:O,value:h,currency:"IDR"}),I.claimedReward&&R!==null?typeof window.showToast=="function"&&window.showToast(`✅ Hadiah "${I.claimedReward.name}" berhasil ditukar! Sisa poin Anda: ${R}`):typeof window.showToast=="function"&&window.showToast("✅ Pesanan berhasil dikirim ke admin!"),Ee&&R!==null&&(Ee.points=R),setTimeout(()=>{Pt([]),se("cust-name",""),se("cust-address",""),se("cust-note",""),se("cust-wa",""),window.buktiPaymentUrl=null,window.buktiPaymentFile=null,window.buktiGDriveUploaded=!1;const y=m("bukti-preview-wrap"),_=m("bukti-placeholder");y&&y.classList.add("hidden"),_&&_.classList.remove("hidden"),k("bukti-uploading"),k("bukti-success"),k("bukti-gdrive-error");const Y=m("bukti-file-input");Y&&(Y.value=""),uo({name:"",address:"",lat:null,lng:null,deliveryMethod:"delivery",distance:0,note:"",wa:""}),be(null),tt(null),Me(null);const E=m("member-status-banner");E&&k(E),m("voucher-input")&&(m("voucher-input").value=""),k("voucher-msg-container"),k("location-status"),m("btn-location")&&j("btn-location");const G=document.querySelector('input[name="delivery-method"][value="delivery"]');G&&(G.checked=!0,pa());const Q=document.querySelector('input[name="payment"][value="transfer"]');Q&&(Q.checked=!0,typeof window.togglePaymentDetails=="function"&&window.togglePaymentDetails()),typeof window.updCart=="function"&&window.updCart(),typeof window.renderCart=="function"&&window.renderCart(),typeof window.changeView=="function"&&window.changeView("view-catalog"),typeof window.showToast=="function"&&window.showToast("Pesanan Dibuat! 🎉")},2e3)}catch(r){const i=r.message||"Error";i.startsWith("STOK_TIDAK_CUKUP:")?typeof window.showToast=="function"&&window.showToast("Maaf, stok berubah: "+i.replace("STOK_TIDAK_CUKUP: ","")):i==="POIN_TIDAK_CUKUP"?(typeof window.showToast=="function"&&window.showToast("Maaf, poin Anda ternyata tidak cukup untuk hadiah ini. Silakan cek lagi."),Me(null)):i==="STOK_HADIAH_HABIS"?(typeof window.showToast=="function"&&window.showToast("Maaf, stok hadiah yang dipilih baru saja habis. Silakan pilih hadiah lain."),Me(null)):i==="HADIAH_TIDAK_DITEMUKAN"?(typeof window.showToast=="function"&&window.showToast("Hadiah yang dipilih sudah tidak tersedia. Silakan pilih ulang."),Me(null)):i==="MEMBER_TIDAK_DITEMUKAN"?(typeof window.showToast=="function"&&window.showToast("Data member tidak ditemukan, klaim hadiah dibatalkan. Pesanan bisa dicoba lagi tanpa hadiah."),Me(null)):typeof window.showToast=="function"&&window.showToast(r.code==="resource-exhausted"?"Quota Server Penuh!":"Gagal proses: "+i)}finally{te(!1),D()}};window.validateAndGoToPayment=Bo;window.toggleDeliveryMethod=pa;window.toggleOrderButton=Ls;window.rPay=Is;window.processOrder=Oo;const bt=()=>{const e=m("wishlist-badge");e&&(e.innerText=xe.length,e.classList.toggle("scale-0",!xe.length))},qo=e=>{xe.splice(e,1),J("freshmart_wishlist",JSON.stringify(xe)),bt(),ma()},Uo=e=>{const t=xe[e],a=n.products?.find(i=>i.id===t.id);if(!a||a.isActive==="false"||a.isActive===!1)return b(`${t.name} sudah tidak tersedia.`);const o=t.variantName?(a.variants||[]).find(i=>i.name===t.variantName):null;if(n.store?.useStock===!0||n.store?.useStock==="true"){if(t.variantName&&(!o||o.isActive===!1||o.isActive==="false"))return b(`Varian ${t.variantName} sudah tidak tersedia.`);const i=o?parseFloat(o.stock)||0:parseFloat(a.stock)||0,l=F.find(p=>p.id===t.id&&p.variantName===t.variantName),d=l&&parseFloat(l.qty)||0;if(i<=0||d>=i)return b(`Stok ${t.name} tidak mencukupi!`)}const r=F.find(i=>i.id===t.id&&i.variantName===t.variantName);if(r)r.qty=parseFloat((r.qty+1).toFixed(2));else{const i=o&&parseFloat(o.poin)>0?parseFloat(o.poin):parseFloat(a.poin)||0;F.push({id:a.id,name:a.name,variantName:t.variantName||"",price:o?o.price:a.price,img:o?.img||a.img,qty:1,unit:a.unit||"pcs",poTime:a.poTime||"",colorCode:o?.colorCode||"",poin:i})}Te(),b("Ke Keranjang!"),typeof window.curViewName<"u"&&window.curViewName==="view-cart"&&ze()},Ho=()=>{De("Hapus Favorit","Yakin ingin menghapus semua?",()=>{xe.length=0,J("freshmart_wishlist",JSON.stringify(xe)),bt(),ma(),b("Dibersihkan")})},ma=()=>{if(!xe.length){j("wishlist-empty-state"),k("btn-clear-wishlist"),j("spacer-wishlist"),A("wishlist-items-container","");return}k("wishlist-empty-state"),j("btn-clear-wishlist"),k("spacer-wishlist"),A("wishlist-items-container",xe.map((e,t)=>{let a=e.colorCode?`<span class="w-3.5 h-3.5 rounded-full shadow-inner border border-slate-300 dark:border-slate-600 shrink-0" style="background-color: ${c(e.colorCode)};"></span>`:"";return`
        <div class="bg-white dark:bg-slate-800 p-4 rounded-[1.25rem] border border-slate-200 dark:border-slate-700 shadow-sm flex gap-4 relative overflow-hidden group min-w-0 hover:shadow-md hover:-translate-y-1 hover:border-rose-300 dark:hover:border-rose-600 transition-all duration-300">
        ...
        </div>`}).join(""))};window.updWish=bt;window.rmWish=qo;window.moveWish=Uo;window.clearWishlist=Ho;window.renderWish=ma;window.getLocation=()=>{if(!navigator.geolocation)return b("GPS tidak didukung");m("btn-location").innerHTML='<i class="fa-solid fa-spinner fa-spin text-sm"></i>',navigator.geolocation.getCurrentPosition(e=>{B.lat=e.coords.latitude,B.lng=e.coords.longitude,k("btn-location"),j("location-status"),m("location-status").classList.add("flex"),b("GPS Didapatkan")},e=>{m("btn-location").innerHTML='<i class="fa-solid fa-location-crosshairs text-[var(--color-primary)]"></i> Set GPS Maps',b("Gagal akses GPS")},{enableHighAccuracy:!0,timeout:15e3})};const Vo=()=>{const e=n.store.isDeliveryEnabled!==!1,t=n.store.isPickupEnabled!==!1;ee("delivery-option-container","hidden",!e),ee("pickup-option-container","hidden",!t),ee("no-delivery-warning","hidden",e||t),ee("delivery-methods-grid","hidden",!(e||t));const a=m("btn-checkout-next");if(a)if(e||t){a.removeAttribute("disabled"),a.classList.remove("opacity-50");const s=(B.deliveryMethod||"delivery")==="pickup"&&t?"pickup":e?"delivery":"pickup",r=document.querySelector(`input[value="${s}"]`);r&&(r.checked=!0)}else a.setAttribute("disabled","true"),a.classList.add("opacity-50");pa()};window.rChck=Vo;window.buktiPaymentUrl=null;window.buktiPaymentFile=null;window.buktiGDriveUploaded=!1;window.compressImageForUpload=(e,t=1600,a=.82)=>new Promise(o=>{const s=new FileReader;s.readAsDataURL(e),s.onload=r=>{const i=new Image;i.onload=()=>{let{width:l,height:d}=i;(l>t||d>t)&&(l>d?(d=Math.round(d*t/l),l=t):(l=Math.round(l*t/d),d=t));const p=document.createElement("canvas");p.width=l,p.height=d,p.getContext("2d").drawImage(i,0,0,l,d),p.toBlob(f=>{if(!f)return o(e);o(new File([f],e.name,{type:"image/jpeg",lastModified:Date.now()}))},"image/jpeg",a)},i.onerror=()=>o(e),i.src=r.target.result},s.onerror=()=>o(e)});window._doSingleGDriveUpload=async(e,t)=>{const a=new FileReader;return new Promise(o=>{a.readAsDataURL(e),a.onload=async()=>{try{const s=a.result.split(",")[1],r=(e.name||"bukti.jpg").replace(/[^a-zA-Z0-9.]/g,"_"),i={name:"BUKTI_"+t+"_"+Date.now()+"_"+r,mimeType:e.type||"image/jpeg",data:s,token:GAS_SECRET_TOKEN},l=await fetch(GAS_UPLOAD_URL,{method:"POST",body:JSON.stringify(i),headers:{"Content-Type":"text/plain;charset=utf-8"},redirect:"follow"});if(!l.ok)return console.warn("GDrive upload HTTP error:",l.status),o(null);const d=await l.text();let p;try{p=JSON.parse(d)}catch{return console.warn("GDrive response parse error"),o(null)}p&&p.status==="success"&&p.url?o(W(p.url)):(console.warn("GDrive upload gagal:",p&&p.message),o(null))}catch(s){console.warn("GDrive upload exception:",s),o(null)}},a.onerror=()=>o(null)})};window.uploadBuktiToGDrive=async(e,t)=>{if(!e)return null;if(!GAS_UPLOAD_URL||GAS_UPLOAD_URL.includes("ISI_DENGAN"))return console.error("GAS_UPLOAD_URL belum dikonfigurasi!"),null;let a=e;try{a=await window.compressImageForUpload(e)}catch{}const o=2,s=3e4;for(let r=1;r<=o;r++){const i=m("bukti-uploading-text");i&&(i.textContent=r>1?`Mencoba ulang ke Google Drive... (${r}/${o})`:"Mengupload ke Google Drive...");try{const l=await Promise.race([window._doSingleGDriveUpload(a,t),new Promise((d,p)=>setTimeout(()=>p(new Error("timeout")),s))]);if(l)return l}catch(l){console.warn(`Percobaan upload ${r} gagal:`,l.message)}r<o&&await new Promise(l=>setTimeout(l,1500*r))}return null};window.handleBuktiUpload=async e=>{const t=e.target.files[0];if(!t)return;if(!t.type.startsWith("image/"))return b("Hanya file gambar yang diizinkan!");if(t.size>5*1024*1024)return b("Ukuran gambar max 5MB!");window.buktiPaymentFile=t,window.buktiPaymentUrl=null,window.buktiGDriveUploaded=!1;const a=new FileReader;a.onload=i=>{const l=m("bukti-preview-img"),d=m("bukti-preview-wrap"),p=m("bukti-placeholder");l&&(l.src=i.target.result),d&&d.classList.remove("hidden"),p&&p.classList.add("hidden")},a.readAsDataURL(t),k("bukti-success"),k("bukti-gdrive-error");const o=m("bukti-uploading");o&&(o.classList.remove("hidden"),o.style.display="flex");const s="TEMP_"+Date.now().toString(36).toUpperCase(),r=await window.uploadBuktiToGDrive(t,s);if(k("bukti-uploading"),r){window.buktiPaymentUrl=r,window.buktiGDriveUploaded=!0;const i=m("bukti-success"),l=m("bukti-success-text"),d=m("bukti-storage-info");l&&(l.textContent="Bukti berhasil disimpan!"),d&&(d.textContent="(tersimpan di Google Drive ✓)"),i&&(i.classList.remove("hidden"),i.style.display="flex"),k("bukti-gdrive-error")}else{window.buktiPaymentUrl=null,window.buktiGDriveUploaded=!1;const i=m("bukti-gdrive-error");i&&(i.classList.remove("hidden"),i.style.display="flex"),k("bukti-success"),b("❌ Upload ke Google Drive gagal. Coba lagi!")}};window.retryBuktiUpload=async()=>{if(!window.buktiPaymentFile)return b("Pilih gambar terlebih dahulu!");k("bukti-gdrive-error"),k("bukti-success");const e=m("bukti-uploading");e&&(e.classList.remove("hidden"),e.style.display="flex");const t="RETRY_"+Date.now().toString(36).toUpperCase(),a=await window.uploadBuktiToGDrive(window.buktiPaymentFile,t);if(k("bukti-uploading"),a){window.buktiPaymentUrl=a,window.buktiGDriveUploaded=!0;const o=m("bukti-success"),s=m("bukti-success-text"),r=m("bukti-storage-info");s&&(s.textContent="Bukti berhasil disimpan!"),r&&(r.textContent="(tersimpan di Google Drive ✓)"),o&&(o.classList.remove("hidden"),o.style.display="flex"),b("✅ Upload berhasil!")}else{const o=m("bukti-gdrive-error");o&&(o.classList.remove("hidden"),o.style.display="flex"),b("❌ Masih gagal. Periksa koneksi internet Anda.")}};window.uploadBuktiToFirebase=async(e,t)=>{if(window.buktiGDriveUploaded&&window.buktiPaymentUrl)return window.buktiPaymentUrl;if(!e)return null;const a=await window.uploadBuktiToGDrive(e,t);return a&&(window.buktiPaymentUrl=a,window.buktiGDriveUploaded=!0),a};window.togglePaymentDetails=()=>{const e=(document.querySelector('input[name="payment"]:checked')||{}).value;ee("detail-transfer","hidden",e!=="transfer"),ee("detail-qris","hidden",e!=="qris"),ee("detail-cashier","hidden",e!=="cashier"),ee("detail-cod","hidden",e!=="cod"),ee("detail-tempo","hidden",e!=="tempo"),e==="tempo"&&window.calculateTempoBalance(),ee("bukti-payment-section","hidden",!(e==="transfer"||e==="qris"||e==="tempo"))};window.calculateTempoBalance=()=>{const e=document.getElementById("tempo-dp-input");let t=parseFloat(e?.value)||0;t<0&&(t=0,e&&(e.value=0));let a=F.reduce((w,v)=>w+(parseFloat(getEffP(v))||0)*(parseFloat(v.qty)||0),0),o=0,s=0,r=0;if(B.deliveryMethod==="delivery"&&(o=Math.ceil((parseFloat(B.distance)||0)*(parseFloat(n.store.costPerKm)||0)/500)*500),vouch){let w=a;if(vouch.targetProduct&&vouch.targetProduct!==""){const v=parseInt(vouch.targetProduct);w=F.filter(S=>S.id===v).reduce((S,C)=>S+(parseFloat(getEffP(C))||0)*(parseFloat(C.qty)||0),0)}if(vouch.type==="shipping_free")r=o;else if(vouch.type==="shipping_flat")r=parseFloat(vouch.value)||0;else if(vouch.type==="percent"){let v=w*((parseFloat(vouch.value)||0)/100);vouch.maxDiscount&&parseFloat(vouch.maxDiscount)>0&&(v=Math.min(v,parseFloat(vouch.maxDiscount))),s=v}else s=parseFloat(vouch.value)||0,s=Math.min(s,w)}r=Math.min(r,o),s=Math.min(s,a);let i=Math.max(0,a-s),l=Math.max(0,o-r);const d=window.calcTaxDetails(i+l);let p=0;window.useMemberPoints&&currentMember&&(p=Math.min(i+l+d.grandTotalAdd,parseFloat(currentMember.points)||0));let f=i+l+d.grandTotalAdd-p;t>f&&(t=f,e&&(e.value=t));let g=f-t;const u=document.getElementById("tempo-balance-display");u&&(u.innerText=x(g))};let ja=null;const vt=()=>{const e=He!=="Semua Produk"||ke!=="Semua Merek"||Ze!=="";ee("dynamic-banners-container","hidden",e),ee("reward-catalog-container","hidden",e),ee("dynamic-vouchers-container","hidden",e),ee("dynamic-categories-container","hidden",e),ee("dynamic-brands-container","hidden",e);const t=n.store.showCategories!==!1&&n.store.showCategories!=="false",a=n.store.showBrands!==!1&&n.store.showBrands!=="false";ee("sec-categories","hidden",e||!t),ee("sec-brands","hidden",e||!a);let o=m("dynamic-active-filter");if(!o){let l=m("product-container");l&&(l.insertAdjacentHTML("beforebegin",'<div id="dynamic-active-filter" class="transition-all w-full"></div>'),o=m("dynamic-active-filter"))}if(o)if(e){let l="Menampilkan",d="",p="fa-filter",f="text-[var(--color-primary)] bg-[var(--color-primary-light)] dark:bg-[var(--color-primary-dark)]/30";Ze!==""?(l="Hasil Pencarian",d=`"${Ze}"`,p="fa-magnifying-glass",f="text-rose-500 bg-rose-50 dark:bg-rose-900/30"):He!=="Semua Produk"?(l="Kategori Pilihan",d=He,p="fa-layer-group",f="text-[var(--color-primary)] bg-[var(--color-primary-light)] dark:bg-[var(--color-primary-dark)]/30"):ke!=="Semua Merek"&&(l="Merek Pilihan",d=ke,p="fa-tag",f="text-[var(--color-primary)] bg-[var(--color-primary-light)] dark:bg-[var(--color-primary-dark)]/30"),o.innerHTML=`
        ...
        </div>`,P=`<span class="text-[9px] text-slate-600 dark:text-slate-400 font-bold ml-0.5 mb-0.5 uppercase tracking-wide">/${c(l.unit||"PCS")}</span>`;return Kt==="grid"?`
            ...
            </a>`}).join(""),i.length<s.length?j("load-more-container"):k("load-more-container")},Go=e=>{la(He===e&&e!=="Semua Produk"?"Semua Produk":e),Ce(1),typeof window.rDyn=="function"&&window.rDyn();const t=document.querySelector("#view-catalog .scroll-content");t&&setTimeout(()=>t.scrollTo({top:0,behavior:"smooth"}),10)},Ko=e=>{na(ke===e&&e!=="Semua Merek"?"Semua Merek":e),Ce(1),typeof window.rDyn=="function"&&window.rDyn();const t=document.querySelector("#view-catalog .scroll-content");t&&setTimeout(()=>t.scrollTo({top:0,behavior:"smooth"}),10)},Wo=()=>{la("Semua Produk"),na("Semua Merek"),As(""),Ce(1),typeof window.rDyn=="function"&&window.rDyn()},Qo=e=>{clearTimeout(ja),ja=setTimeout(()=>{As(e),Ce(1),vt()},300)},zo=e=>{fo(e),Ce(1),vt()},Jo=e=>{bo(e),Ce(1),m("btn-view-grid")&&(m("btn-view-grid").className=e==="grid"?"w-8 h-8 rounded-xl flex items-center justify-center text-[var(--color-primary)] bg-white dark:bg-slate-700 shadow-sm transition-all":"w-8 h-8 rounded-xl flex items-center justify-center text-slate-400 hover:text-slate-700 dark:hover:text-slate-300 transition-all"),m("btn-view-list")&&(m("btn-view-list").className=e==="list"?"w-8 h-8 rounded-xl flex items-center justify-center text-[var(--color-primary)] bg-white dark:bg-slate-700 shadow-sm transition-all":"w-8 h-8 rounded-xl flex items-center justify-center text-slate-400 hover:text-slate-700 dark:hover:text-slate-300 transition-all"),vt()},Yo=()=>{Ce(ia+1),vt()};window.rCat=vt;window.filterCategory=Go;window.filterBrand=Ko;window.resetSemuaFilter=Wo;window.handleSearch=Qo;window.handleSort=zo;window.toggleView=Jo;window.loadMoreProducts=Yo;window.cSlideIdx=0;const Xo=e=>{window.cSlideIdx=0;const t=n.products.find(u=>u.id===e);if(!t)return;const a=t.isActive!=="false"&&t.isActive!==!1,o=n.store.useStock===!0||n.store.useStock==="true";let s=1/0;if(o&&(s=t.variants&&t.variants.length?t.variants.filter(u=>u.isActive!==!1&&u.isActive!=="false").reduce((u,w)=>u+(parseFloat(w.stock)||0),0):parseFloat(t.stock)||0),!a){b("Produk ini sedang tidak tersedia");return}if(o&&s<=0){b("Maaf, stok produk ini sedang kosong");return}go(t),da(1),t.variants&&t.variants.length>0?Wt(null):Wt(0),se("modal-qty-input",1),Rt();const r=t.desc?t.desc.replace(/<[^>]*>/g,"").substring(0,160):`Beli ${t.name} berkualitas dengan harga terbaik hanya di Toko Putri.`,i=window.location.origin+window.location.pathname+"?p="+t.id;typeof window.updateSEO=="function"&&window.updateSEO(`${t.name} - Toko Putri`,r,ce(t.img,"w500-rw"),i);const l=t.variants&&t.variants.length>0?Math.min(...t.variants.map(u=>parseFloat(u.price)||t.price)):t.price,d=s>0?"https://schema.org/InStock":"https://schema.org/OutOfStock",p={"@context":"https://schema.org","@type":"Product",name:t.name,image:[ce(t.img,"w500-rw")],description:r,sku:`PROD-${t.id}`,category:t.category||"",brand:{"@type":"Brand",name:t.brand||"Toko Putri"},offers:{"@type":"Offer",url:i,priceCurrency:"IDR",price:l,itemCondition:"https://schema.org/NewCondition",availability:d,priceValidUntil:"2030-12-31"}};t.variants&&t.variants.length>0&&(p.offers=t.variants.map(u=>({"@type":"Offer",name:u.name,priceCurrency:"IDR",price:parseFloat(u.price)||t.price,itemCondition:"https://schema.org/NewCondition",availability:(parseFloat(u.stock)||0)>0?"https://schema.org/InStock":"https://schema.org/OutOfStock"}))),typeof window.injectJSONLD=="function"&&window.injectJSONLD("seo-product",p);try{const u=m("product-modal-ad-container");u&&(n.store.adsEnabled===!0||n.store.adsEnabled==="true"?(u.classList.remove("hidden"),u.innerHTML='<ins class="adsbygoogle" style="display:block; text-align:center;" data-ad-layout="in-article" data-ad-format="fluid" data-ad-client="ca-pub-2636322336243340" data-ad-slot="8219064079"></ins>',(window.adsbygoogle=window.adsbygoogle||[]).push({})):(u.classList.add("hidden"),u.innerHTML=""))}catch(u){console.error("Gagal render iklan in-article:",u)}typeof window.loadProductReviews=="function"&&window.loadProductReviews(t.id);const f=m("product-modal"),g=m("product-modal-content");if(f&&g){if(f.classList.contains("hidden")){const u=new URLSearchParams(window.location.search);u.get("p")!==String(t.id)&&(u.set("p",t.id),window.history.pushState({modal:"product"},t.name,window.location.pathname+"?"+u.toString()),ve.push("product"))}j("product-modal"),g.scrollTo(0,0),setTimeout(()=>{f.classList.remove("opacity-0"),g.classList.remove("translate-y-full","sm:translate-y-10")},10)}},ua=(e=!1)=>{const t=m("product-modal"),a=m("product-modal-content");if(t&&a){const o=()=>{t.classList.add("opacity-0"),a.classList.add("translate-y-full","sm:translate-y-10"),setTimeout(()=>k("product-modal"),300);const s=m("product-modal-video-container");s&&(s.innerHTML="",s.classList.add("hidden"));const r=new URLSearchParams(window.location.search);r.delete("p");let i=window.location.pathname;r.toString()&&(i+="?"+r.toString()),window.history.replaceState({},"Toko Putri",i),typeof window.updateSEO=="function"&&window.updateSEO("Toko Putri","Toko Putri - Solusi grosir dan e-commerce terpercaya untuk alat teknik, perkakas, dan perlengkapan pertukangan berkualitas dengan harga terbaik.",ce(n.store.logo,"w300-rw"),window.location.origin+i);const l=document.getElementById("seo-product");l&&l.remove()};typeof window.requestCloseModal=="function"?window.requestCloseModal("product",e,o):o()}},Zo=e=>{if(!M||!M.variants||!M.variants[e])return;const t=M.variants[e],a=m("variant-preview-modal"),o=m("variant-preview-content");if(!a||!o)return;let s="";`${c(M.name)}${c(t.name)}`;const r=x(t.price||M.price);t.img?s=`
            ...
            <div class="mt-5 text-center px-4 w-full">
                ...
                <p class="text-[var(--color-primary)] font-extrabold text-lg mt-1 tracking-tight">${r}</p>
        ...
        `:t.colorCode?s=`
            <div class="w-full aspect-square rounded-3xl shadow-2xl border-4 border-white/20 flex flex-col items-center justify-center p-6 relative overflow-hidden" style="background-color: ${c(t.colorCode)};">
                <div class="absolute bottom-0 inset-x-0 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md p-6 flex flex-col items-center justify-center text-center border-t border-slate-200/50 dark:border-slate-800/50">
                    ...
                    <span class="text-[var(--color-primary)] font-extrabold text-lg mt-1">${r}</span>
                </div>
            </div>
            <div class="mt-5 text-center px-4 w-full">
                <p class="text-slate-400 font-semibold text-[11px] md:text-xs mt-1 uppercase tracking-widest break-words">${c(M.name)}</p>
        ...
        `,o.innerHTML=s,a.classList.contains("hidden")&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("variantPreview"),j("variant-preview-modal"),setTimeout(()=>{a.classList.remove("opacity-0"),o.classList.remove("scale-95")},10)},er=()=>{if(!M)return;const e=m("variant-preview-modal"),t=m("variant-preview-content");if(!e||!t)return;const a=M.variants&&ae!==null?M.variants[ae]:null,o=a?.img||M.img||"",s=a?`${c(M.name)} - ${c(a.name)}`:c(M.name),r=x(a?.price??M.price);let i=`
        <div class="relative w-full aspect-square bg-white rounded-3xl overflow-hidden shadow-2xl border border-slate-200 dark:border-slate-800 flex items-center justify-center">
            <img loading="lazy" decoding="async" class="w-full h-full object-contain" src="${ce(o,"w800-rw")}" alt="${s}">
    ...
    `;t.innerHTML=i,e.classList.contains("hidden")&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("variantPreview"),j("variant-preview-modal"),setTimeout(()=>{e.classList.remove("opacity-0"),t.classList.remove("scale-95")},10)},tr=(e=!1)=>{const t=m("variant-preview-modal"),a=m("variant-preview-content");if(t&&a){const o=()=>{t.classList.add("opacity-0"),a.classList.add("scale-95"),setTimeout(()=>{k("variant-preview-modal"),a.innerHTML=""},300)};typeof window.requestCloseModal=="function"?window.requestCloseModal("variantPreview",e,o):o()}},ar=e=>{Dt(M?.video)&&(window.cSlideIdx+=e,window.cSlideIdx>1&&(window.cSlideIdx=0),window.cSlideIdx<0&&(window.cSlideIdx=1),Rt())},Rt=()=>{if(!M)return;let e=M,t=e.isActive!=="false"&&e.isActive!==!1,a=e.variants?.length>0;const o=(e.name||"").toLowerCase(),s=(e.category||"").toLowerCase(),r=(e.tag||"").toLowerCase(),i=["cat","paint","warna","colour","color","putih","hitam","merah","biru","hijau","kuning","orange","abu","coklat","cream","krem","beige","ivory","mocca","rose","tosca","lavender","salmon","broken white","off white","natural","magnolia","primer","dasar","eksterior","exterior","interior","tembok","duco","gloss","matte","satin","semi gloss"],l=o.includes("cat")&&(o.includes("tembok")||o.includes("interior")||o.includes("eksterior")||o.includes("exterior"))||s.includes("cat")||s.includes("paint")||r.includes("cat")||r.includes("paint"),d=a&&e.variants.some(R=>{const y=(R.name||"").toLowerCase();return i.some(_=>y.includes(_))}),p=l||d,f=m("product-modal-paint-warning");f&&(p?f.classList.remove("hidden"):f.classList.add("hidden"));let g=a&&ae!==null?e.variants[ae]:null,u=g?.unit||e.unit||"Pcs";const w=m("product-modal-img"),v=m("product-modal-video-container"),h=Dt(e.video),S=g&&g.img,C=m("slide-prev"),T=m("slide-next"),O=m("slide-dots");if(h&&!S)if(C&&C.classList.remove("hidden"),T&&T.classList.remove("hidden"),O&&(O.classList.remove("hidden"),O.innerHTML=`
            ...
            <div class="mt-5">
                ...
                <div class="overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm">
                    <table class="w-full text-[13px] spec-product-table">
                        <tbody>`;e.specTable.forEach((y,_)=>{const Y=_%2===0?"bg-white dark:bg-slate-900":"bg-slate-50/80 dark:bg-slate-800/60";R+=`<tr class="${Y}">
        ...
        <div class="mb-6 bg-amber-50 dark:bg-amber-900/10 rounded-2xl p-4 border border-amber-200 dark:border-amber-800/50 shadow-inner">
        ...
        </div>`:"");const we=m("product-modal-admin-info");if(we)if(window.isAdm&&window.curViewName==="view-admin"){const R=n.store.useStock===!0||n.store.useStock==="true",y=e.variants?.length>0,_=g?g.hpp||0:e.hpp||0;g?g.stock!==void 0&&g.stock:e.stock!==void 0&&e.stock;const Y=g?g.price||e.price||0:e.price||0,E=_>0?Math.round((Y-_)/Y*100):null;let G="";if(R)if(y)G=`<div class="col-span-2 space-y-1.5">${(e.variants||[]).map(Q=>{const X=parseFloat(Q.stock)||0;return`<div class="flex justify-between items-center text-[11px] font-bold bg-white dark:bg-slate-900 p-2 rounded-xl border border-slate-200 dark:border-slate-700">
            ...
            <div class="mb-6 bg-[rgba(var(--color-primary-rgb),0.05)] dark:bg-[rgba(var(--color-primary-rgb),0.08)] rounded-2xl p-4 border border-[var(--color-primary)]/20">
                ...
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <p class="font-bold text-lg ${E===null?"text-slate-400":E>=30?"text-emerald-500":E>=10?"text-amber-500":"text-rose-500"}">${E!==null?E+"%":"—"}</p>
                    </div>
                    ${G}
                </div>
            ...
            </div>`}else we.innerHTML="";if(t)if(a&&ae===null?(k("modal-active-controls"),k("modal-inactive-controls")):(a?g.isActive!==!1&&g.isActive!=="false":!0)?(j("modal-active-controls"),k("modal-inactive-controls")):(k("modal-active-controls"),j("modal-inactive-controls")),a){j("product-modal-options-container");let R='<div class="grid grid-cols-[repeat(auto-fill,minmax(80px,1fr))] sm:grid-cols-[repeat(auto-fill,minmax(95px,1fr))] gap-2 sm:gap-3 w-full">';R+=e.variants.map((y,_)=>{let Y=y.isActive!==!1&&y.isActive!=="false";const E=n.store.useStock===!0||n.store.useStock==="true",G=parseFloat(y.stock)||0,Q=E&&G<=0;let X=Y&&!Q,dt=y.colorCode?`<span class="w-10 h-10 sm:w-12 sm:h-12 rounded-full shadow-inner border border-slate-300 dark:border-slate-600 mb-2 shrink-0" style="background-color: ${c(y.colorCode)};"></span>`:"",Ie="";X?_===ae?Ie="bg-[rgba(var(--color-primary-rgb),0.08)] border-[var(--color-primary)] text-[var(--color-primary)] dark:bg-[rgba(var(--color-primary-rgb),0.12)] dark:text-[var(--color-primary)] shadow-sm":Ie="bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 text-slate-500 dark:text-slate-400 hover:border-[var(--color-primary)]/40 hover:shadow-sm":Ie="bg-slate-100 dark:bg-slate-800/50 border-slate-200 dark:border-slate-700 text-slate-500 dark:text-slate-400 opacity-60 cursor-not-allowed";const ct=X&&(y.colorCode||y.img)?`<span onclick="event.stopPropagation(); previewVariant(${_})" class="absolute top-1.5 right-1.5 w-5 h-5 rounded-full bg-white/90 dark:bg-slate-700/90 shadow-sm flex items-center justify-center text-slate-500 hover:text-[var(--color-primary)] hover:scale-110 active:scale-90 transition-all border border-slate-200/50 dark:border-slate-600/50" title="Perbesar"><i class="fa-solid fa-magnifying-glass-plus text-[9px]"></i></span>`:"";return`<button ${X?"":"disabled"} class="relative p-2.5 sm:p-3 rounded-xl text-[10px] sm:text-[11px] font-bold uppercase tracking-wide border-2 transition-all active:scale-95 flex flex-col items-center justify-start text-center h-full ${Ie}" ${X?`onclick="selectVariant(${_})"`:""}>
                    ${ct}
                    ${dt} 
                ...
                </button>`}).join(""),R+="</div>",A("product-modal-options",R)}else k("product-modal-options-container");else k("modal-active-controls"),j("modal-inactive-controls"),k("product-modal-options-container");Ft()},Ft=()=>{if(!M)return;if(M.variants?.length>0&&ae===null){H("btn-modal-price-preview","Rp 0");return}let e=(M.variants||[])[ae],a=e?.price??M.price;const o=e?.name||null;let s=0;o?s=parseFloat(F.find(i=>i.id===M.id&&i.variantName===o)?.qty||0):s=F.filter(i=>i.id===M.id).reduce((i,l)=>i+(parseFloat(l.qty)||0),0);let r=Se+s;if(M.wholesale?.length){for(let i of M.wholesale.slice().sort((l,d)=>d.minQty-l.minQty))if(r>=parseFloat(i.minQty)){a=i.price;break}}H("btn-modal-price-preview",x(a*Se))},sr=e=>{const t=n.store.useStock===!0||n.store.useStock==="true",a=M?.variants?.[ae],o=a?.name||null,s=t?o?parseFloat(a?.stock)||0:parseFloat(M?.stock)||0:1/0,r=parseFloat(Math.min(s,Math.max(.01,Se+e)).toFixed(2));da(r),se("modal-qty-input",Se),Ft(),t&&s!==1/0&&Se>=s&&b(`Maks stok: ${s}`)},or=e=>{const t=n.store.useStock===!0||n.store.useStock==="true",a=M?.variants?.[ae],o=a?.name||null,s=t?o?parseFloat(a?.stock)||0:parseFloat(M?.stock)||0:1/0;let r=parseFloat(e);(isNaN(r)||r<=0)&&(r=.01),r=Math.min(s,r);const i=parseFloat(r.toFixed(2));da(i),se("modal-qty-input",Se),Ft()},rr=e=>{Wt(e),Rt()},ir=()=>{if(M.variants?.length>0&&ae===null)return b("Pilih varian / warna terlebih dahulu!");if(n.store.useStock===!0||n.store.useStock==="true"){const r=M.variants?.[ae],i=r?.name||null,l=i?parseFloat(r.stock)||0:parseFloat(M.stock)||0,d=F.find(f=>f.id===M.id&&f.variantName===i),p=d&&parseFloat(d.qty)||0;if(Se+p>l)return b(`Stok tidak cukup! Tersisa: ${l}`)}const t=M.variants?.[ae],a=t?.name||null,o=F.find(r=>r.id===M.id&&r.variantName===a),s=t?.unit||M.unit||"pcs";if(o)o.qty=parseFloat((o.qty+Se).toFixed(2)),o.unit=s;else{const r=t&&parseFloat(t.poin)>0?parseFloat(t.poin):parseFloat(M.poin)||0;F.push({id:M.id,name:M.name,variantName:a,price:t?.price??M.price,img:t?.img||M.img,qty:Se,unit:s,poTime:M.poTime||"",colorCode:t?.colorCode||"",poin:r})}Te(),typeof analytics<"u"&&analytics.logEvent("add_to_cart",{item_id:M.id,item_name:M.name,quantity:Se}),ua(),b("Berhasil Masuk Keranjang")},lr=()=>{if(M.variants?.length>0&&ae===null)return b("Pilih varian / warna terlebih dahulu!");const e=M.variants?.[ae],t=e?.name||null;if(xe.find(a=>a.id===M.id&&a.variantName===t))return b("Sudah di Favorit!");xe.push({id:M.id,name:M.name,variantName:t,price:e?.price??M.price,img:e?.img||M.img,colorCode:e?.colorCode||""}),J("freshmart_wishlist",JSON.stringify(xe)),typeof window.updWish=="function"&&window.updWish(),ua(),b("Masuk Favorit ❤️")},nr=()=>{if(!M)return;const e=window.location.origin+window.location.pathname+"?p="+M.id,t=M.name,a=`Cek produk ${M.name} di ${n.store.name} sekarang!`;if(navigator.share)navigator.share({title:t,text:a,url:e}).catch(o=>{console.log("User membatalkan share",o)});else if(navigator.clipboard&&navigator.clipboard.writeText)navigator.clipboard.writeText(e).then(()=>b("Link produk berhasil disalin!")).catch(()=>b("Gagal menyalin link."));else{const o=document.createElement("textarea");o.value=e,o.style.position="fixed",o.style.opacity="0",document.body.appendChild(o),o.select(),document.execCommand("copy"),document.body.removeChild(o),b("Link produk berhasil disalin!")}};window.openProductModal=Xo;window.closeProductModal=ua;window.previewVariant=Zo;window.previewProductImage=er;window.closeVariantPreviewModal=tr;window.changeSlide=ar;window.rProdMod=Rt;window.uMPP=Ft;window.updateModalQty=sr;window.handleModalQtyChange=or;window.selectVariant=rr;window.confirmAddProductToCart=ir;window.confirmAddToWishlist=lr;window.shareProduct=nr;let Qt=[];const js=()=>{Qt.forEach(e=>{try{typeof e=="function"&&e()}catch{}}),Qt=[]},Es=()=>{js(),Pe.filter(a=>{const o=a.status==="Selesai"||a.status==="Dibatalkan",s=a.claimedReward&&(a.claimedReward.status==="Menunggu Persetujuan"||!a.claimedReward.status);return!o||s}).slice(0,10).forEach(a=>{const o=a.orderId,s=$.collection("freshmart_orders").doc(o).onSnapshot(r=>{if(!r.exists)return;const i=r.data(),l=i.status,d=i.claimedReward?i.claimedReward.status:null,p=i.claimedReward&&i.claimedReward.note||"";let f=!1,g="";const u=Pe.find(w=>w.orderId===o);if(u){if(l&&u.status!==l){const w=u.status;u.status=l,f=!0,w!==void 0&&(g=`Pesanan #${o.split("-").pop()} kini: ${l}`)}u.claimedReward&&d&&(u.claimedReward.status!==d||u.claimedReward.note!==p)&&(u.claimedReward.status=d,u.claimedReward.note=p,f=!0),f&&(J("freshmart_my_orders",JSON.stringify(Pe)),window.curViewName==="view-orders"&&Nt(),g&&b(g))}},r=>{console.warn("[MyOrders Realtime] Snapshot error:",r.message)});Qt.push(s)})},Nt=async()=>{if(!Pe.length){j("orders-empty-state"),k("btn-clear-orders"),j("spacer-orders"),A("orders-items-container","");return}k("orders-empty-state"),j("btn-clear-orders"),k("spacer-orders"),Es(),A("orders-items-container",Pe.map((e,t)=>{const a=new Date(e.date).toLocaleDateString("id-ID",{day:"numeric",month:"short",year:"numeric"});let o="text-slate-500 border-slate-200",s="fa-clock";return e.status==="Baru"?(o="text-rose-500 border-rose-200 bg-rose-50 dark:bg-rose-900/20 dark:border-rose-800",s="fa-asterisk"):e.status==="Diproses"?(o="text-[var(--color-primary)] border-[var(--color-primary)]/30 bg-[rgba(var(--color-primary-rgb),0.06)] dark:bg-[rgba(var(--color-primary-rgb),0.10)] dark:border-[var(--color-primary)]/30",s="fa-spinner fa-spin"):e.status==="Selesai"?(o="text-[var(--color-primary)] border-[var(--color-primary)]/30 bg-[rgba(var(--color-primary-rgb),0.06)] dark:bg-[rgba(var(--color-primary-rgb),0.10)] dark:border-[var(--color-primary)]/30",s="fa-check-double"):e.status==="Dibatalkan"&&(o="text-slate-400 border-slate-200 bg-slate-50 dark:bg-slate-800 dark:border-slate-700",s="fa-xmark"),`
        <div class="bg-white dark:bg-slate-800 p-4 rounded-[1.25rem] border border-slate-200 dark:border-slate-700 shadow-sm relative overflow-hidden group min-w-0">
            <div class="flex justify-between items-start mb-3 border-b border-slate-100 dark:border-slate-700/50 pb-3">
                ...
                <span class="text-[9px] font-bold px-2 py-1 rounded border ${o} uppercase tracking-widest flex items-center"><i class="fa-solid ${s} mr-1"></i> ${c(e.status)}</span>
            </div>
        ...
        </div>`}).join(""))},dr=async(e,t)=>{U("Melacak Status...");try{const a=await $.collection("freshmart_orders").doc(e).get();a.exists?(Pe[t].status=a.data().status,J("freshmart_my_orders",JSON.stringify(Pe)),Nt(),b("Status Diperbarui!")):b("Pesanan tidak ditemukan.")}catch{b("Gagal mengambil data sistem.")}finally{D()}},cr=()=>{De("Hapus Riwayat","Riwayat pesanan di perangkat ini akan dihapus. Lanjutkan?",()=>{mo([]),J("freshmart_my_orders",JSON.stringify(Pe)),Nt(),b("Riwayat dibersihkan")})},pr=async e=>{U("Memuat Rincian...");try{const t=await $.collection("freshmart_orders").doc(e).get();if(!t.exists){b("Pesanan tidak ditemukan."),D();return}const a=t.data();let o=[];if(a.status==="Selesai")try{o=(await $.collection("freshmart").doc("cms_data").collection("reviews").where("orderId","==",e).get()).docs.map(r=>`${r.data().productId}::${r.data().variantName||""}`)}catch{}_s(e,a,o)}catch(t){console.error("Gagal mengambil data:",t),b("Gagal memuat data. Coba beberapa saat lagi.")}finally{D()}},_s=(e,t,a=[])=>{try{let o=document.getElementById("order-detail-modal");o||(o=document.createElement("div"),o.id="order-detail-modal",o.className="fixed inset-0 z-[100] flex justify-center items-end sm:items-center bg-slate-900/60 backdrop-blur-sm opacity-0 pointer-events-none transition-opacity duration-300",document.body.appendChild(o));const s=c(t.customer&&t.customer.name?t.customer.name:"-"),r=c(t.customer&&t.customer.wa?t.customer.wa:"-"),i=c(t.customer&&t.customer.address?t.customer.address:"-"),l=t.customer&&t.customer.deliveryMethod==="delivery"?"Dikirim":"Ambil di Toko",d=c(t.customer&&t.customer.note?t.customer.note:""),p=c(t.payment&&t.payment.method?t.payment.method:"Cash / COD"),f=t.items||[],g=f.some(P=>P.poTime&&P.poTime!==""),u=f.map(P=>{const q=parseFloat(P.qty)||0,K=parseFloat(P.effectivePrice||P.price)||0,le=q*K,we=`${P.id}::${P.variantName||""}`,R=t.status==="Selesai"&&!a.includes(we)&&P.id!==void 0&&P.id!==null;return`
                ...
                <div class="p-5 overflow-y-auto flex-1 space-y-6 custom-scrollbar text-sm">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div>
                            ...
                            <div class="space-y-1.5 text-xs">
                                ...
                                ${t.customer&&t.customer.wa?`<a href="https://wa.me/${r}" target="_blank" class="flex items-center gap-1.5 text-[var(--color-primary)] font-bold hover:underline"><i class="fa-brands fa-whatsapp"></i> +${r}</a>`:""}
                    ...
                    <div class="space-y-2.5">
                        ...
                        <div class="bg-[rgba(var(--color-primary-rgb),0.06)] p-3.5 rounded-xl border border-[var(--color-primary)]/15">
                            ...
                            <p class="text-[11px] font-bold text-[var(--color-primary)] mt-1.5 ml-6">${It(t.claimedReward)}</p>
        ...
        `,o.classList.contains("opacity-0")&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("customerOrder"),o.classList.remove("opacity-0","pointer-events-none"),setTimeout(()=>{const P=document.getElementById("order-detail-content");P&&(P.classList.remove("translate-y-full","sm:translate-y-10"),P.classList.add("translate-y-0","sm:translate-y-0"))},50)}catch(o){console.error("Error Render HTML Modal:",o),b("Gagal menampilkan detail. Coba lagi.")}},mr=(e=!1)=>{const t=()=>{const a=document.getElementById("order-detail-modal"),o=document.getElementById("order-detail-content");o&&(o.classList.remove("translate-y-0","sm:translate-y-0"),o.classList.add("translate-y-full","sm:translate-y-10")),setTimeout(()=>{a&&a.classList.add("opacity-0","pointer-events-none")},300)};typeof window.requestCloseModal=="function"?window.requestCloseModal("customerOrder",e,t):t()};window.attachMyOrdersRealtime=Es;window.detachMyOrdersRealtime=js;window.renderMyOrders=Nt;window.checkOrderStatus=dr;window.clearMyOrders=cr;window.openCustomerOrderDetail=pr;window.renderOrderDetailModal=_s;window.closeCustomerOrderDetailModal=mr;window.reviewPhotoFile=null;window.reviewRating=0;const ur=(e,t,a,o,s)=>{const r=decodeURIComponent(a||""),i=decodeURIComponent(o||""),l=decodeURIComponent(s||"");let d=document.getElementById("review-modal");d||(d=document.createElement("div"),d.id="review-modal",d.className="fixed inset-0 z-[120] bg-slate-900/70 backdrop-blur-sm flex items-end sm:items-center justify-center p-0 sm:p-5",d.onclick=p=>{p.target===d&&fa()},document.body.appendChild(d)),window.reviewPhotoFile=null,window.reviewRating=0,d.innerHTML=`
        <div class="bg-white dark:bg-slate-900 w-full max-w-lg rounded-t-[2rem] sm:rounded-[2rem] max-h-[85vh] flex flex-col shadow-2xl border border-slate-200 dark:border-slate-700">
            <div class="p-5 sm:p-6 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center shrink-0">
                <div class="min-w-0">
        ...
        </div>`,m("review-submit-btn").onclick=()=>ba(e,t,r,i,l),d.style.opacity="0",d.style.display="flex",requestAnimationFrame(()=>{d.style.transition="opacity 0.25s ease",d.style.opacity="1"}),typeof window.pushModalHistory=="function"&&window.pushModalHistory("review")},fr=e=>{window.reviewRating=e,document.querySelectorAll(".review-star").forEach(t=>{const a=parseInt(t.dataset.star);t.classList.toggle("text-amber-400",a<=e),t.classList.toggle("text-slate-300",a>e),t.classList.toggle("dark:text-slate-600",a>e)})},br=e=>{const t=e.target.files[0];if(!t)return;if(!t.type.startsWith("image/")){b("Hanya file gambar yang diizinkan!");return}if(t.size>5*1024*1024){b("Ukuran gambar max 5MB!");return}window.reviewPhotoFile=t;const a=new FileReader;a.onload=o=>{m("review-photo-preview").src=o.target.result,j("review-photo-preview-wrap"),k("review-photo-btn")},a.readAsDataURL(t)},gr=()=>{window.reviewPhotoFile=null,k("review-photo-preview-wrap"),j("review-photo-btn");const e=m("review-photo-input");e&&(e.value="")},fa=(e=!1)=>{const t=document.getElementById("review-modal");!t||t.style.display==="none"||(t.style.opacity="0",t.style.transition="opacity 0.25s ease",setTimeout(()=>{t.style.display="none",t.style.opacity="",t.style.transition=""},250),!e&&ve.length&&ve[ve.length-1]==="review"&&(ve.pop(),history.back()))},ba=async(e,t,a,o,s)=>{if(!window.reviewRating||window.reviewRating<1)return b("Silakan beri bintang terlebih dahulu!");if(!Ke){te(!0),U("Mengirim ulasan...");try{let r="";if(window.reviewPhotoFile&&typeof window.uploadBuktiToGDrive=="function"){const d=await window.uploadBuktiToGDrive(window.reviewPhotoFile,"review-"+e);d?r=d:b("Foto gagal diupload, ulasan tetap dikirim tanpa foto.")}const i=Date.now(),l={id:i,orderId:e||"",productId:t??0,variantName:a||"",productName:o||"",customerName:s||"Pelanggan",rating:window.reviewRating,text:L("review-text")||"",photoUrl:r||"",adminReply:"",isVisible:!0,createdAt:pe.firestore.FieldValue.serverTimestamp()};await $.collection("freshmart").doc("cms_data").collection("reviews").doc(i.toString()).set(l),zt.delete(t),fa(),b("✅ Terima kasih atas ulasan Anda!"),typeof window.openCustomerOrderDetail=="function"&&window.openCustomerOrderDetail(e)}catch(r){console.error("Gagal mengirim ulasan:",r),b("Gagal mengirim ulasan: "+(r.message||"Error tidak diketahui"))}finally{te(!1),D()}}},zt=new Map,xr=5*60*1e3,wr=async e=>{if(!m("product-modal-reviews-container"))return;const a=s=>{const r=s.length?s.reduce((p,f)=>p+(parseFloat(f.rating)||0),0)/s.length:0,i=p=>Array.from({length:5},(f,g)=>`<i class="fa-solid fa-star ${g<Math.round(p)?"text-amber-400":"text-slate-200 dark:text-slate-700"}"></i>`).join("");let l=`
            <div class="flex items-center justify-between mb-4">
                ...
                ${s.length?`<div class="flex items-center gap-1.5"><span class="flex text-xs">${i(r)}</span><span class="text-xs font-bold text-slate-600 dark:text-slate-300">${r.toFixed(1)}</span><span class="text-[10px] font-bold text-slate-400">(${s.length})</span></div>`:""}
        ...
        `)},o=Ea.get(e);if(o&&Date.now()-o.timestamp<vr){a(o.data);return}A("admin-report-container",'<div class="text-center py-10"><i class="fa-solid fa-spinner fa-spin text-2xl text-slate-300"></i></div>');let s=null;const r=new Date;if(e==="today")s=new Date(r.getFullYear(),r.getMonth(),r.getDate());else if(e==="week"){const g=r.getDay(),u=g===0?6:g-1;s=new Date(r.getFullYear(),r.getMonth(),r.getDate()-u)}else e==="month"&&(s=new Date(r.getFullYear(),r.getMonth(),1));let i=0,l=0,d=0,p=0,f=!1;try{if(!fe.currentUser){A("admin-report-container",'<div class="text-center py-10 text-slate-400"><i class="fa-solid fa-lock text-2xl mb-3"></i><p class="text-xs font-bold">Login terlebih dahulu untuk melihat laporan.</p></div>');return}let g=$.collection("freshmart_orders");s&&(g=g.where("timestamp",">=",pe.firestore.Timestamp.fromDate(s)));const u=await g.limit(3e3).get();f=u.size>=3e3,u.forEach(v=>{const h=v.data();h.status!=="Dibatalkan"&&(p++,i+=parseFloat(h.payment?.subtotal)||0,d+=parseFloat(h.payment?.productDiscount)||0,(h.items||[]).forEach(S=>{const C=S.hpp!==void 0&&S.hpp!==null?parseFloat(S.hpp):typeof window.getEffHpp=="function"?window.getEffHpp(S):0;l+=(parseFloat(C)||0)*(parseFloat(S.qty)||0)}))});const w={totalPenjualan:i,totalHppTerjual:l,totalDiskonProduk:d,orderCount:p,truncated:f};Ea.set(e,{data:w,timestamp:Date.now()}),a(w)}catch(g){console.error("Gagal memuat laporan penjualan:",g)}},yr=async()=>{const e=L("login-username"),t=L("login-password");if(!e||!t)return b("Email & Password wajib diisi!");U("Verifikasi Login...");try{if(await fe.signInWithEmailAndPassword(e,t),!fe.currentUser||fe.currentUser.uid!==ra){const a=fe.currentUser?fe.currentUser.uid:"null";throw await fe.signOut(),new Error("UID_MISMATCH: "+a)}window.isAdm=!0,history.replaceState({view:"view-admin"},"",window.location.href),typeof window.changeView=="function"&&window.changeView("view-admin",!0),At(),b("Login Berhasil!")}catch(a){if(console.error(a),a.message&&a.message.startsWith("UID_MISMATCH:")){const o=a.message.replace("UID_MISMATCH: ","");b("Login Ditolak: UID Anda ("+o+") tidak cocok dengan ADMIN_UID!")}else b("Login Ditolak: Email atau Password salah!")}finally{D()}},Fs=async()=>{U("Keluar...");try{await fe.signOut(),window.isAdm=!1,window.__localIsAdm=!1,window.isPro=!1,typeof window.updateProBadge=="function"&&window.updateProBadge(),Oe&&(Oe(),ft(null)),_e&&(_e(),pt(null)),Re&&(Re(),mt(null)),b("Berhasil Logout"),typeof window.changeView=="function"&&window.changeView("view-catalog")}catch{b("Gagal Logout")}finally{D()}},kr=()=>{De("Keluar Seller","Apakah anda akan keluar dari dashboard seller?",()=>{Fs()},"Ya, Keluar")};window.checkAdminAccess=hr;window.openAdminMenu=At;window.toggleTaxMenuVisibility=xa;window.computeInventoryStats=Bt;window.loadAdminReport=Rs;window.processAdminLogin=yr;window.logoutAdmin=Fs;window.confirmLogoutAdmin=kr;const $r=async()=>{if(!de||de.length===0)return b("Belum ada data pesanan!");U("Menyiapkan modul Excel...");try{await Ss("https://cdn.sheetjs.com/xlsx-0.20.3/package/dist/xlsx.full.min.js",()=>typeof XLSX<"u")}catch{D(),b("Gagal memuat modul Excel. Cek koneksi internet Anda.");return}D();let e=[];de.forEach((r,i)=>{let l=r.dateString?new Date(r.dateString).toLocaleString("id-ID"):"-",d=r.customer?.name||"Anonim",p=r.customer?.deliveryMethod==="delivery"?"Dikirim":"Ambil di Toko",f=r.status||"-",g=r.items?r.items.reduce((w,v)=>w+(parseFloat(v.qty)||0),0):0,u=r.payment?.grandTotal||0;e.push({No:i+1,"ID Pesanan":r.orderId,Tanggal:l,"Nama Pelanggan":d,"Metode Kirim":p,Status:f,"Total Item":g,"Total Tagihan (Rp)":u})});const t=XLSX.utils.json_to_sheet(e),a=XLSX.utils.book_new();XLSX.utils.book_append_sheet(a,t,"Laporan Pesanan");const o=[{wch:5},{wch:25},{wch:22},{wch:25},{wch:15},{wch:15},{wch:12},{wch:20}];t["!cols"]=o;const s=new Date().toISOString().split("T")[0];XLSX.writeFile(a,`Laporan_Pesanan_${s}.xlsx`),b("Laporan Excel (.xlsx) berhasil diunduh!")},Sr=()=>{try{const e=new(window.AudioContext||window.webkitAudioContext),t=e.createOscillator(),a=e.createGain();t.connect(a),a.connect(e.destination),t.type="sine",t.frequency.setValueAtTime(800,e.currentTime),a.gain.setValueAtTime(1,e.currentTime),t.frequency.setValueAtTime(600,e.currentTime+.2),t.frequency.setValueAtTime(800,e.currentTime+.6),a.gain.setValueAtTime(1,e.currentTime+.6),t.frequency.setValueAtTime(600,e.currentTime+.8),a.gain.exponentialRampToValueAtTime(1e-5,e.currentTime+1.5),t.start(e.currentTime),t.stop(e.currentTime+1.5)}catch{}},Pr=()=>{A("admin-content",`
    ...
    `);const e=()=>{Oe&&(Oe(),ft(null));let t=!0;const a=$.collection("freshmart_orders").orderBy("timestamp","desc").limit(100).onSnapshot(o=>{if(La([]),!t){let r=!1;o.docChanges().forEach(i=>{i.type==="added"&&i.doc.data().status==="Baru"&&(r=!0)}),r&&(b("🔔 Pesanan Baru Masuk!"),Sr())}if(t=!1,o.empty){A("admin-orders-list",'<div class="flex flex-col items-center justify-center py-20 text-slate-400 font-bold bg-white dark:bg-slate-800 rounded-[1.5rem] border border-slate-200 dark:border-slate-700 shadow-sm text-center"><i class="fa-solid fa-receipt text-5xl mb-4 opacity-30"></i>Belum ada pesanan</div>'),H("stat-orders",0);return}H("stat-orders",o.size+(o.size===100?"+":""));const s=[];A("admin-orders-list",o.docs.map(r=>{const i=r.data();s.push(i);let l="text-slate-500 border-slate-200 dark:border-slate-600",d="fa-clock",p="bg-slate-50 dark:bg-slate-700/50",f="text-slate-400";i.status==="Baru"?(l="text-rose-500 border-rose-200 bg-rose-50 dark:bg-rose-900/20 dark:border-rose-800 animate-pulse",d="fa-asterisk",p="bg-rose-500",f="text-white shadow-md shadow-rose-500/30"):i.status==="Diproses"?(l="text-[var(--color-primary)] border-[var(--color-primary)]/30 bg-[rgba(var(--color-primary-rgb),0.06)] dark:bg-[rgba(var(--color-primary-rgb),0.10)] dark:border-[var(--color-primary)]/30",d="fa-spinner fa-spin",p="primary-bg",f="shadow-sm"):i.status==="Selesai"?(l="text-[var(--color-primary)] border-[var(--color-primary)]/30 bg-[rgba(var(--color-primary-rgb),0.06)] dark:bg-[rgba(var(--color-primary-rgb),0.10)] dark:border-[var(--color-primary)]/30",d="fa-check-double",p="primary-bg-soft",f="primary-text"):i.status==="Dibatalkan"&&(l="text-slate-400 border-slate-200 bg-slate-50 dark:bg-slate-800 dark:border-slate-700",d="fa-xmark",p="bg-slate-100 dark:bg-slate-800",f="text-slate-400");let g="fa-wallet text-slate-400",u=i.payment?.method||"";u==="transfer"?g="fa-building-columns text-emerald-500":u==="qris"?g="fa-qrcode text-purple-500":u==="cod"?g="fa-hand-holding-dollar text-emerald-500":u==="cashier"&&(g="fa-cash-register text-amber-500");let w=i.items?parseFloat(i.items.reduce((S,C)=>S+(parseFloat(C.qty)||0),0).toFixed(2)):0;const v=i.dateString?new Date(i.dateString).toLocaleDateString("id-ID",{day:"numeric",month:"short"}):"",h=(i.orderId||"").split("-").pop();return`
        ...
        <div class="flex flex-col gap-4 text-sm pb-2">
            ...
            <div class="bg-violet-50 dark:bg-violet-900/10 p-5 sm:p-6 rounded-[1.5rem] border border-violet-200 dark:border-violet-800 shadow-sm">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex justify-between items-center"><span class="text-slate-500 dark:text-slate-400 font-bold text-xs">Status</span><span class="font-bold text-xs px-2 py-1 rounded-xl ${t.claimedReward.status==="ready"?"bg-emerald-100 text-emerald-600":t.claimedReward.status==="waiting_stock"?"bg-amber-100 text-amber-600":"bg-slate-200 text-slate-600"}">${It(t.claimedReward)}</span></div>
            ...
            <div class="bg-slate-900 p-6 sm:p-7 rounded-[1.5rem] text-white shadow-xl shadow-slate-900/20 border border-slate-700/60 relative overflow-hidden group mt-2">
                ...
                <div class="space-y-3 font-medium text-sm text-slate-300 relative z-10">
                    ...
                    ${(()=>{if(!t.payment?.ppnAmount||t.payment.ppnAmount<=0)return"";const s=t.payment.ppnType==="inclusive",r=t.payment.ppnRate||11,i=t.payment.ppnAmount,l=(t.payment.subtotal||0)-(t.payment.productDiscount||0)+(t.payment.shippingCost||0)-(t.payment.shippingDiscount||0),d=t.payment.dppAmount||(s?Math.round(l*100/(100+r)):Math.max(0,l));return`
                        ...
                        <div class="flex justify-between items-center text-amber-400 bg-amber-900/20 px-2 py-1 -mx-2 rounded-xl"><span>${s?"Termasuk PPN":"PPN"} (${r}%)</span><span class="font-bold">${s?"":"+"}${x(i)}</span></div>
                        `})()}
                </div>
        ...
        </div>`);const o=m("admin-order-modal");o&&o.classList.contains("hidden")&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("adminOrder"),j("admin-order-modal"),setTimeout(()=>{m("admin-order-modal")&&m("admin-order-modal").classList.remove("opacity-0"),m("admin-order-modal-box")&&m("admin-order-modal-box").classList.remove("scale-95")},10)},Tr=async(e,t)=>{const o=(typeof window.normalizeWA=="function"?window.normalizeWA:s=>String(s||"").replace(/\D/g,"").replace(/^0/,"62"))(t);if(!o||o.length<10)return b("Nomor WA tidak valid!");U("Menyimpan...");try{const s=$.collection("freshmart").doc("cms_data").collection("customers").doc(o),r=await s.get();r.exists?(await s.set({name:e||r.data().name},{merge:!0}),b("Data pelanggan sudah ada, nama diperbarui.")):(await s.set({id:parseInt(o,10),name:e||"-",phone:o,points:0}),b("✅ Pelanggan baru disimpan ke database!"))}catch(s){console.error("Gagal simpan pelanggan:",s),b("Gagal menyimpan data pelanggan: "+(s.message||""))}finally{D()}},Ar=async(e,t)=>{if(t==="waiting_stock"&&typeof window.customPrompt=="function"){window.customPrompt("Catatan untuk pelanggan:","Stok hadiah kosong, akan kami kirim susulan begitu stok tersedia kembali.",async o=>{if(o!==null){U("Menyimpan...");try{await $.collection("freshmart_orders").doc(e).update({"claimedReward.status":t,"claimedReward.note":o||""}),b("Status klaim hadiah diperbarui!");let s=de.findIndex(r=>r.orderId===e);s!==-1&&(de[s].claimedReward||(de[s].claimedReward={}),de[s].claimedReward.status=t,de[s].claimedReward.note=o||""),typeof window.openCustomerOrderDetail=="function"&&window.openCustomerOrderDetail(e)}catch(s){b("Gagal update klaim: "+s.message)}finally{D()}}});return}let a="";U("Menyimpan...");try{await $.collection("freshmart_orders").doc(e).update({"claimedReward.status":t,"claimedReward.note":a});const o=de.find(s=>s.orderId===e);o&&(o.claimedReward.status=t,o.claimedReward.note=a,wa(e)),b("Status hadiah diperbarui!")}catch(o){console.error("Gagal update status hadiah:",o),b("Gagal update status hadiah: "+(o.message||""))}finally{D()}},Ns=(e=!1)=>{const t=()=>{m("admin-order-modal")&&m("admin-order-modal").classList.add("opacity-0"),m("admin-order-modal-box")&&m("admin-order-modal-box").classList.add("scale-95"),setTimeout(()=>k("admin-order-modal"),300)};typeof window.requestCloseModal=="function"?window.requestCloseModal("adminOrder",e,t):t()},Mr=async(e,t)=>{if(!Ke){te(!0),U("Update...");try{await $.collection("freshmart_orders").doc(e).update({status:t});let a=de.find(o=>o.orderId===e);a&&(a.status=t),wa(e),b("Status diupdate!")}catch{b("Gagal!")}finally{te(!1),D()}}},Dr=async e=>{if(!e)return b("ID pesanan tidak valid!");U("Memuat data...");try{const t=await $.collection("freshmart_orders").doc(e).get();if(D(),!t.exists)return b("Data pesanan tidak ditemukan!");const a=t.data(),o=a.customer&&a.customer.wa;if(!o)return b("Nomor WhatsApp pelanggan tidak tersedia!");const s=n&&n.store&&n.store.name?n.store.name:"Toko Kami",r=a.customer&&a.customer.name?a.customer.name:"Pelanggan",i=a.status||"Baru",l=a.payment&&a.payment.grandTotal?x(a.payment.grandTotal):"-",d=a.payment&&a.payment.method?a.payment.method.toUpperCase():"-",p=`Halo *${r}*! 👋
...
Kami akan segera memproses pesanan Anda. Terima kasih! 🙏`;window.open(`https://wa.me/${o}?text=${encodeURIComponent(p)}`,"_blank")}catch{D(),b("Gagal memuat data pesanan!")}},Cr=e=>{De("Hapus Pesanan","Yakin ingin hapus permanen?",async()=>{if(!Ke){te(!0),U("Menghapus...");try{await $.collection("freshmart_orders").doc(e).delete(),b("Terhapus!"),it===e&&Ns()}catch{b("Gagal!")}finally{te(!1),D()}}})};window.exportOrdersToExcel=$r;window.rAdmOrd=Pr;window.openOrderDetail=wa;window.saveOrderCustomerToDB=Tr;window.ackRewardClaim=Ar;window.closeOrderDetailModal=Ns;window.updateOrderStatus=Mr;window.konfirmasiKeWA=Dr;window.deleteOrder=Cr;const Lr=()=>{const e=n.store.name||"Toko Grosir",t=n.store.themeColor||"#10b981",a=(r,i,l=!1)=>{let d=document.querySelector(`meta[${l?"property":"name"}="${r}"]`);d||(d=document.createElement("meta"),l?d.setAttribute("property",r):d.setAttribute("name",r),document.head.appendChild(d)),d.setAttribute("content",i)};a("theme-color",t),a("mobile-web-app-capable","yes"),a("apple-mobile-web-app-capable","yes"),a("apple-mobile-web-app-status-bar-style","black-translucent"),a("apple-mobile-web-app-title",e),a("application-name",e),a("msapplication-TileColor",t),document.title=e,localStorage.setItem("freshmart_theme_color",t),n.store.uiTheme&&n.store.uiTheme!==localStorage.getItem("freshmart_ui_theme")&&(localStorage.setItem("freshmart_ui_theme",n.store.uiTheme),wt(n.store.uiTheme));const o=n.store.bgStyle||localStorage.getItem("freshmart_bg_style")||"minimalist",s=n.store.bgCustomUrl!==void 0?n.store.bgCustomUrl:localStorage.getItem("freshmart_bg_custom_url")||"";ht(o,s)},Bs=()=>{A("admin-content",`
    ...
    `)},Ir=e=>{const t=Qe[e][500],a=document.getElementById("set-ui-theme"),o=document.getElementById("set-theme-color"),s=document.getElementById("set-theme-color-picker");a&&(a.value=e),o&&(o.value=t),s&&(s.value=t),document.querySelectorAll(".preset-color-chip").forEach(l=>{l.classList.remove("ring-4","ring-offset-2","ring-slate-400","dark:ring-slate-500","scale-110"),l.querySelector(".check-icon")?.classList.add("hidden")});const r=document.getElementById(`preset-chip-${e}`);r&&(r.classList.add("ring-4","ring-offset-2","ring-slate-400","dark:ring-slate-500","scale-110"),r.querySelector(".check-icon")?.classList.remove("hidden"));const i=document.getElementById("custom-color-chip");if(i){i.style.background="";const l=i.querySelector("i");l&&(l.style.color="")}wt(e,t)},jr=e=>{const t=document.getElementById("set-bg-style");t&&(t.value=e);const a=document.getElementById("set-bg-custom-url")?.value||"";document.querySelectorAll(".bg-style-card").forEach(s=>{s.classList.remove("border-[var(--color-primary)]","shadow-md","ring-2","ring-[var(--color-primary)]/20"),s.classList.add("border-slate-200","dark:border-slate-700");const r=s.querySelector(".bg-icon-wrap");r&&(r.className="bg-icon-wrap w-10 h-10 rounded-xl flex items-center justify-center mb-2 text-base transition-transform bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300")});const o=document.getElementById(`bg-opt-${e}`);if(o){o.classList.add("border-[var(--color-primary)]","shadow-md","ring-2","ring-[var(--color-primary)]/20"),o.classList.remove("border-slate-200","dark:border-slate-700");const s=o.querySelector(".bg-icon-wrap");s&&(s.className="bg-icon-wrap w-10 h-10 rounded-xl flex items-center justify-center mb-2 text-base transition-transform bg-[var(--color-primary)] text-white shadow-sm")}ht(e,a)},Er=e=>{let t,a,o,s;if(e==="profile"){t="Profil Toko & Tampilan Visual",a="fa-store",o={line:"bg-[var(--color-primary)]",box:"bg-[rgba(var(--color-primary-rgb),0.08)] text-[var(--color-primary)]"};const i=n.store.uiTheme||"emerald",l=n.store.bgStyle||localStorage.getItem("freshmart_bg_style")||"minimalist",d={emerald:"Emerald",teal:"Teal",lime:"Lime",cyan:"Cyan",sky:"Sky",blue:"Blue",indigo:"Indigo",violet:"Violet",purple:"Purple",fuchsia:"Fuchsia",pink:"Pink",rose:"Rose",red:"Red",orange:"Orange",amber:"Amber",yellow:"Yellow",green:"Green",slate:"Slate",stone:"Stone"},p=Object.keys(Qe).map(f=>{const g=Qe[f][500],u=d[f]||f,w=i===f;return`
    ...
    `;if(A("admin-content",r),e==="profile"){const i=n.store.uiTheme||"",l=n.store.themeColor||"#10b981";(i==="custom"||!Qe?.[i])&&setTimeout(()=>{const p=document.getElementById("custom-color-chip");if(p){p.style.background=l;const f=p.querySelector("i");f&&(f.style.color="#fff")}},50)}},_r=async e=>{if(!Ke){te(!0),U("Menyimpan...");try{e==="profile"?(n.store.name=L("set-name"),n.store.slogan=L("set-slogan"),n.store.logo=W(L("set-logo")),n.store.description=L("set-description"),n.store.email=L("set-email"),n.store.showRewardCatalog=L("set-show-reward-catalog")==="true",n.store.operationalHours=L("set-hours"),n.store.footerCredit=L("set-credit"),n.store.themeColor=L("set-theme-color"),n.store.uiTheme=L("set-ui-theme"),n.store.bgStyle=L("set-bg-style")||"hero_arch",n.store.bgCustomUrl=W(L("set-bg-custom-url")),localStorage.setItem("freshmart_theme_color",n.store.themeColor),localStorage.setItem("freshmart_ui_theme",n.store.uiTheme),localStorage.setItem("freshmart_bg_style",n.store.bgStyle),localStorage.setItem("freshmart_bg_custom_url",n.store.bgCustomUrl||""),wt(n.store.uiTheme,n.store.themeColor),ht(n.store.bgStyle,n.store.bgCustomUrl)):e==="catalog"?(n.store.categoryStyle=L("set-category-style"),n.store.brandStyle=L("set-brand-style"),n.store.showCategories=L("set-show-categories")==="true",n.store.showBrands=L("set-show-brands")==="true"):e==="shipping"?(n.store.wa=L("set-wa").replace(/\D/g,""),n.store.address=L("set-address"),n.store.costPerKm=L("set-cost"),n.store.isDeliveryEnabled=L("set-delivery-enabled")==="true",n.store.isPickupEnabled=L("set-pickup-enabled")==="true",n.store.lat=L("set-lat"),n.store.lng=L("set-lng")):e==="payment"?(n.payment||(n.payment={}),n.payment.qrisUrl=W(L("set-qris-url"))):e==="config"?(n.config||(n.config={}),n.config.gasUrl=L("set-gas-url"),b("Pengaturan GAS URL tersimpan.")):e==="operasional"&&(n.store.useStock=L("set-use-stock")==="true",n.store.ppnEnabled=L("set-ppn-enabled")==="true",n.store.ppnType=L("set-ppn-type")||"exclusive",n.store.ppnRate=parseFloat(L("set-ppn-rate"))||11,xa());const t={profile:"store",catalog:"store",shipping:"store",operasional:"store",payment:"payment",config:"config"};typeof window.saveApp=="function"&&await window.saveApp([t[e]||"store"]),e==="profile"||e==="config"?(b(e==="config"?"Sistem Diperbarui! Memuat Ulang...":"Warna Berubah! Memuat Ulang..."),setTimeout(()=>location.reload(),1500)):(b("Tersimpan!"),Bs())}catch{b("Gagal menyimpan pengaturan")}finally{te(!1),D()}}},Rr=()=>{const e="data:text/json;charset=utf-8,"+encodeURIComponent(JSON.stringify(n,null,2)),t=document.createElement("a");t.href=e,t.download=`backup_freshmart_${new Date().toISOString().slice(0,10)}.json`,document.body.appendChild(t),t.click(),t.remove(),b("Backup diunduh!")},Fr=e=>{const t=e.target.files[0];if(!t)return;const a=new FileReader;a.onload=async o=>{try{const s=JSON.parse(o.target.result);Object.assign(n,s),typeof window.saveApp=="function"&&await window.saveApp(),b("Data dipulihkan!"),setTimeout(()=>location.reload(),1e3)}catch{b("Gagal memulihkan data!")}},a.readAsText(t)};window.syncAppMeta=Lr;window.rAdmSet=Bs;window.selectPresetTheme=Ir;window.selectBgStyle=jr;window.openSettingForm=Er;window.saveAdminSettings=_r;window.backupData=Rr;window.restoreData=Fr;let oe=new Date().getFullYear(),re=0,Fe="menu",Ne=null;const Be=["Jan","Feb","Mar","Apr","Mei","Jun","Jul","Agu","Sep","Okt","Nov","Des"],Nr=e=>{if(typeof window.getEffHpp=="function")return window.getEffHpp(e);const t=n.products?.find(a=>a.id===e.id);if(!t)return 0;if(e.variantName&&t.variants){const a=t.variants.find(o=>o.name===e.variantName);if(a&&a.hpp!=null)return parseFloat(a.hpp)||0}return parseFloat(t.hpp)||0},_a=new Map,Br=2*60*1e3,ha=async e=>{const t=_a.get(e);if(t&&Date.now()-t.timestamp<Br)return t.data;const a={};for(let o=1;o<=12;o++)a[o]={omset:0,ppn:0,hpp:0,disc:0,orderCount:0};try{const o=new Date(e,0,1),s=new Date(e+1,0,1);(await $.collection("freshmart_orders").where("timestamp",">=",pe.firestore.Timestamp.fromDate(o)).where("timestamp","<",pe.firestore.Timestamp.fromDate(s)).limit(5e3).get()).forEach(l=>{const d=l.data();if(d.status==="Dibatalkan"||!d.timestamp||!d.timestamp.toDate)return;const p=d.timestamp.toDate().getMonth()+1;if(!a[p])return;const f=d.payment?.dppAmount!==void 0&&d.payment?.dppAmount!==null?parseFloat(d.payment.dppAmount):parseFloat(d.payment?.subtotal)||0;a[p].omset+=f,a[p].ppn+=parseFloat(d.payment?.ppnAmount)||0,a[p].disc+=parseFloat(d.payment?.productDiscount)||0,a[p].orderCount++,(d.items||[]).forEach(g=>{const u=g.hpp!==void 0&&g.hpp!==null?parseFloat(g.hpp):Nr(g);a[p].hpp+=(parseFloat(u)||0)*(parseFloat(g.qty)||0)})})}catch(o){console.error("Gagal memuat data pajak:",o),b("Gagal memuat data periode ini!")}return _a.set(e,{data:a,timestamp:Date.now()}),a},gt=()=>Ne?(re===0?Object.keys(Ne):[re]).reduce((t,a)=>{const o=Ne[a];return t.omset+=o.omset,t.ppn+=o.ppn,t.hpp+=o.hpp,t.disc+=o.disc,t.orderCount+=o.orderCount,t},{omset:0,ppn:0,hpp:0,disc:0,orderCount:0}):{omset:0,ppn:0,hpp:0,disc:0,orderCount:0},va=()=>{const e=n.taxSettings?.monthlyExpenses||{};return(re===0?Array.from({length:12},(a,o)=>o+1):[re]).reduce((a,o)=>a+(parseFloat(e[`${oe}-${o}`])||0),0)},Or=async()=>{A("admin-content",'<div class="text-center py-16"><i class="fa-solid fa-spinner fa-spin text-3xl text-slate-300"></i></div>'),Ne=await ha(oe),ya()},ya=()=>{const e=Array.from({length:6},(o,s)=>new Date().getFullYear()-4+s),t=[{k:"summary",l:"Ringkasan PPN",i:"fa-receipt"},{k:"income",l:"Laba Rugi",i:"fa-chart-pie"},{k:"balance",l:"Neraca",i:"fa-scale-balanced"},{k:"settings",l:"Pengaturan",i:"fa-gear"}];Fe==="menu"&&(Fe="summary");const a=`
    <div class="mb-5 flex flex-wrap items-center justify-between gap-3 bg-white dark:bg-slate-800 p-4 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm">
        ...
        <div class="flex items-center gap-2">
            <select id="tax-year-select" onchange="changeTaxYear(this.value)" class="admin-input !py-2 !px-3 text-xs font-bold bg-slate-50 dark:bg-slate-900 text-slate-800 dark:text-slate-100 border border-slate-200 dark:border-slate-700 rounded-xl focus:border-[var(--color-primary)] cursor-pointer">
                ${e.map(o=>`<option value="${o}" ${o===oe?"selected":""}>${o}</option>`).join("")}
            </select>
            <select id="tax-month-select" onchange="changeTaxMonth(this.value)" class="admin-input !py-2 !px-3 text-xs font-bold bg-slate-50 dark:bg-slate-900 text-slate-800 dark:text-slate-100 border border-slate-200 dark:border-slate-700 rounded-xl focus:border-[var(--color-primary)] cursor-pointer">
                <option value="0" ${re===0?"selected":""}>Setahun Penuh</option>
                ${Be.map((o,s)=>`<option value="${s+1}" ${re===s+1?"selected":""}>${o} ${oe}</option>`).join("")}
            </select>
        </div>
        `}
    </div>
    ...
    </div>`),Ot()},qr=e=>{Fe=e,ya()},Ur=async e=>{oe=parseInt(e,10),A("tax-content",'<div class="text-center py-16"><i class="fa-solid fa-spinner fa-spin text-3xl text-slate-300"></i></div>'),Ne=await ha(oe),Ot()},Hr=e=>{re=parseInt(e,10),Ot()},Ot=()=>{Fe==="summary"?Os():Fe==="income"?ka():Fe==="balance"?$a():Fe==="settings"&&qs()},Os=()=>{const e=gt(),t=re===0?`Tahun ${oe}`:`${Be[re-1]} ${oe}`,a=e.omset-e.disc,o=Array.from({length:12},(s,r)=>r+1).map(s=>{const r=Ne?Ne[s]:{omset:0,ppn:0,orderCount:0};return`<tr class="${re===s?"bg-[rgba(var(--color-primary-rgb),0.08)] dark:bg-[rgba(var(--color-primary-rgb),0.14)] font-bold":"hover:bg-slate-50 dark:hover:bg-slate-700/30"} border-b border-slate-100 dark:border-slate-700/50 last:border-0 transition-colors">
            <td class="py-3 px-4 text-xs font-bold text-slate-700 dark:text-slate-200">${Be[s-1]}</td>
            <td class="py-3 px-4 text-xs font-bold text-slate-800 dark:text-white text-right">${x(r.omset)}</td>
            <td class="py-3 px-4 text-xs font-bold text-right" style="color:var(--color-primary)">${x(r.ppn)}</td>
            <td class="py-3 px-4 text-xs font-bold text-slate-500 dark:text-slate-400 text-right">${r.orderCount}</td>
    ...
    `)},ka=()=>{const e=gt(),t=re===0?`Tahun ${oe}`:`${Be[re-1]} ${oe}`,a=e.omset-e.disc-e.hpp,o=re===0?null:`${oe}-${re}`,s=va(),r=a-s,i=n.taxSettings?.taxScheme||"umkm_final";let l,d,p;i==="umkm_final"?(l=.5,d=e.omset,p="PPh Final UMKM (0,5% × Omset)"):i==="badan_normal"?(l=22,d=Math.max(0,r),p="PPh Badan (22% × Laba Bersih)"):(l=parseFloat(n.taxSettings?.customTaxRate)||0,d=Math.max(0,r),p=`PPh Custom (${l}% × Laba Bersih)`);const f=d*(l/100),g=r-f;let u="";if(re===0)u=Array.from({length:12},(w,v)=>v+1).map(w=>{const v=`${oe}-${w}`,h=(n.taxSettings?.monthlyExpenses||{})[v]||0;return`<div class="flex items-center justify-between gap-2 py-2 border-b border-slate-100 dark:border-slate-700/50 last:border-0">
                <span class="text-xs font-bold text-slate-600 dark:text-slate-300">${Be[w-1]} ${oe}</span>
            ...
            </div>`}).join("");else{const w=(n.taxSettings?.monthlyExpenses||{})[o]||0;u=`<div class="flex items-center justify-between gap-2 py-2">
            <span class="text-xs font-bold text-slate-600 dark:text-slate-300">${Be[re-1]} ${oe}</span>
        ...
        <div class="card-modern p-6 sm:p-8 space-y-4">
            ...
            <div class="space-y-3 text-xs sm:text-sm">
                ...
                <div class="flex justify-between py-2.5 border-t border-slate-200 dark:border-slate-700"><span class="font-bold text-slate-700 dark:text-slate-200">Laba Bersih Sebelum Pajak</span><span class="font-bold" style="color:var(--color-primary)">${x(r)}</span></div>
    ...
    `)},Vr=async(e,t)=>{const a=parseFloat(t)||0;n.taxSettings||(n.taxSettings={}),n.taxSettings.monthlyExpenses||(n.taxSettings.monthlyExpenses={}),n.taxSettings.monthlyExpenses[e]=a;try{typeof window.saveApp=="function"&&await window.saveApp(["taxSettings"]),ka()}catch{b("Gagal menyimpan biaya operasional!")}},$a=()=>{const e=Bt(),t=n.taxSettings?.balanceSheet||{kas:0,piutang:0,hutang:0},a=(parseFloat(t.kas)||0)+(parseFloat(t.piutang)||0)+e.assetHpp,o=parseFloat(t.hutang)||0,s=a-o;A("tax-content",`
    ...
    `)},Gr=async(e,t)=>{const a=parseFloat(t)||0;n.taxSettings||(n.taxSettings={}),n.taxSettings.balanceSheet||(n.taxSettings.balanceSheet={kas:0,piutang:0,hutang:0,modalDisetor:0}),n.taxSettings.balanceSheet[e]=a;try{typeof window.saveApp=="function"&&await window.saveApp(["taxSettings"]),$a()}catch{b("Gagal menyimpan data neraca!")}},qs=()=>{const e=n.taxSettings||{};A("tax-content",`
        <div class="card-modern p-6 sm:p-8 max-w-2xl mx-auto space-y-5">
            <div>
                ...
                <input id="tax-company-name" type="text" value="${c(e.companyName||"")}" placeholder="Cth: PT/CV Restu Karya Utama" class="admin-input !py-3 bg-slate-50 dark:bg-slate-900 text-slate-800 dark:text-slate-100 border border-slate-200 dark:border-slate-700 rounded-xl focus:border-[var(--color-primary)]">
            </div>
            <div>
    ...
    `)},Kr=e=>{ee("tax-custom-rate-wrap","hidden",e!=="custom")},Wr=async()=>{if(!Ke){te(!0),U("Menyimpan...");try{n.taxSettings||(n.taxSettings={}),n.taxSettings.companyName=L("tax-company-name"),n.taxSettings.npwp=L("tax-npwp"),n.taxSettings.taxScheme=L("tax-scheme"),n.taxSettings.customTaxRate=parseFloat(L("tax-custom-rate"))||.5,typeof window.saveApp=="function"&&await window.saveApp(["taxSettings"]),b("Pengaturan pajak tersimpan!")}catch{b("Gagal menyimpan pengaturan pajak!")}finally{te(!1),D()}}},Qr=e=>{const t=re===0?`Tahun ${oe}`:`${Be[re-1]} ${oe}`,a=n.taxSettings||{},o=new Date().toLocaleDateString("id-ID",{day:"2-digit",month:"long",year:"numeric"});let s="";n.store.logo&&(n.store.logo.includes("http")||n.store.logo.includes("data:"))?s=`<img loading="eager" src="${c(n.store.logo)}" class="w-16 h-16 object-contain">`:s='<div class="w-16 h-16 bg-slate-700 text-white flex items-center justify-center rounded-xl"><i class="fa-solid fa-store text-3xl"></i></div>';const i={summary:"LAPORAN PPN & OMSET",income:"LAPORAN LABA RUGI",balance:"NERACA"}[e]||"LAPORAN";let l=`
    <div class="flex justify-between items-start border-b-[3px] border-slate-800 pb-6 mb-6">
        <div class="flex items-center gap-4">
            ${s}
            <div>
    ...
    <div class="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-6 text-[11px] font-bold text-amber-700 leading-relaxed">
    ...
    </div>`,d="";if(e==="summary"){const f=gt(),g=f.omset-f.disc,u=Array.from({length:12},(w,v)=>v+1).map(w=>{const v=Ne?Ne[w]:{omset:0,ppn:0,orderCount:0};return`<tr class="border-b border-slate-200"><td class="py-2.5 px-3 font-bold text-slate-700">${Be[w-1]} ${oe}</td><td class="py-2.5 px-3 text-right font-bold text-slate-700">${x(v.omset)}</td><td class="py-2.5 px-3 text-right font-bold text-slate-900">${x(v.ppn)}</td><td class="py-2.5 px-3 text-right font-bold text-slate-500">${v.orderCount}</td></tr>`}).join("");d=`
        ...
        </div>`}else if(e==="balance"){const f=Bt(),g=a.balanceSheet||{kas:0,piutang:0,hutang:0},u=(parseFloat(g.kas)||0)+(parseFloat(g.piutang)||0)+f.assetHpp,w=parseFloat(g.hutang)||0,v=u-w;d=`
    ...
    `;e.length===0?a+=`<div class="bg-white dark:bg-slate-800 p-8 text-center rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm">
              ...
              </div>`:(a+='<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">',e.forEach(o=>{let s=o.payment?.tempoBalance||0,r=o.payment?.tempoPenaltyRate!==void 0?parseFloat(o.payment.tempoPenaltyRate):1,i=o.payment?.tempoPenaltyStopped===!0,l=0,d=o.payment?.tempoDueDate||0,p=0,f=!1;i?(l=parseFloat(o.payment?.tempoFixedPenalty)||0,Date.now()>d&&(p=Math.floor((Date.now()-d)/(24*60*60*1e3)),p>0&&(f=!0))):Date.now()>d&&(p=Math.floor((Date.now()-d)/(24*60*60*1e3)),p>0&&(f=!0,l=r/100*s*p));let g=s+l;t+=g;let u=window.normalizeWA?window.normalizeWA(o.customer?.wa):o.customer?.wa||"";a+=`
            <div class="bg-white dark:bg-slate-800 p-5 rounded-2xl border ${f?"border-rose-300 dark:border-rose-700 shadow-[0_0_15px_rgba(225,29,72,0.1)]":"border-slate-200 dark:border-slate-700 shadow-sm"} relative overflow-hidden group hover:-translate-y-1 transition-all">
                ...
                <div class="space-y-2 mb-4 bg-slate-50 dark:bg-slate-900/50 p-3.5 rounded-xl border border-slate-100 dark:border-slate-700/50">
                    ...
                    <div class="flex justify-between items-center text-xs ${i?"text-slate-500":"text-rose-600"}">
                        <span class="font-bold">Denda (${r}%/hari) ${i?'<span class="text-[9px] bg-slate-200 dark:bg-slate-700 px-1 py-0.5 rounded ml-1">STOPPED</span>':""}</span>
                ...
                <div class="flex gap-2 mb-3">
                    <button onclick="editTempoPenalty('${o.orderId}', ${r})" class="flex-1 bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-600 text-slate-600 dark:text-slate-300 rounded-xl py-2 flex items-center justify-center gap-1.5 text-[10px] font-bold uppercase tracking-widest transition-all">
                        <i class="fa-solid fa-percent"></i> Edit Denda
                    </button>
                    <button onclick="stopTempoPenalty('${o.orderId}', ${l}, ${i})" class="flex-1 ${i?"bg-[rgba(var(--color-primary-rgb),0.08)] dark:bg-[rgba(var(--color-primary-rgb),0.12)] text-[var(--color-primary)] hover:bg-[rgba(var(--color-primary-rgb),0.15)]":"bg-rose-100 dark:bg-rose-900/30 text-rose-600 dark:text-rose-400 hover:bg-rose-200"} rounded-xl py-2 flex items-center justify-center gap-1.5 text-[10px] font-bold uppercase tracking-widest transition-all">
                ...
                <div class="mb-3 space-y-1.5 bg-slate-50 dark:bg-slate-900/30 p-3 rounded-xl border border-slate-100 dark:border-slate-800">
                    <div class="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-2 flex justify-between">
                        ...
                        <span>Total: ${x(o.payment.installments.reduce((w,v)=>w+(parseFloat(v.amount)||0),0))}</span>
                    </div>
                ...
                <div class="flex gap-2 mb-2">
                    <a href="https://wa.me/${u}?text=Halo%20kak%20${c(o.customer?.name||"")},%20mengingatkan%20bahwa%20sisa%20tagihan%20Tempo%20untuk%20pesanan%20${o.orderId}%20sebesar%20${x(g)}%20sudah%20jatuh%20tempo.%20Mohon%20segera%20dilunasi." target="_blank" class="flex-1 bg-[rgba(var(--color-primary-rgb),0.06)] dark:bg-[rgba(var(--color-primary-rgb),0.10)] hover:bg-[rgba(var(--color-primary-rgb),0.12)] dark:hover:bg-[rgba(var(--color-primary-rgb),0.16)] text-[var(--color-primary)] border border-[var(--color-primary)]/25 rounded-xl py-2 flex items-center justify-center gap-1.5 text-[10px] font-bold uppercase tracking-widest transition-all">
            ...
            </div>`}),a+="</div>"),a+="</div>",A("admin-content",a),setTimeout(()=>{m("total-piutang-header")&&(m("total-piutang-header").innerText=x(t))},100)};const zr=e=>{ho(e),Us()},Us=()=>{const e=Ps||"all",t=(jt||[]).filter(r=>e==="visible"?r.isVisible!==!1:e==="hidden"?r.isVisible===!1:!0),a=`
        <div class="flex gap-1.5 bg-slate-100 dark:bg-slate-800 p-1 rounded-xl mb-5 w-fit">
            ${[{k:"all",l:"Semua"},{k:"visible",l:"Ditampilkan"},{k:"hidden",l:"Disembunyikan"}].map(r=>`
                <button onclick="filterReviews('${r.k}')" class="px-3.5 py-1.5 rounded-xl text-[10px] font-bold uppercase tracking-widest transition-all ${e===r.k?"shadow-sm":"text-slate-500 dark:text-slate-400"}" style="${e===r.k?"background:var(--color-primary);color:#fff":""}">${r.l}</button>
            `).join("")}
        </div>`;if(!t.length){A("admin-content",a+'<div class="flex flex-col items-center justify-center py-20 text-slate-400 font-bold bg-white dark:bg-slate-800 rounded-[1.5rem] border border-slate-200 dark:border-slate-700 shadow-sm text-center"><i class="fa-solid fa-comment-slash text-5xl mb-4 opacity-30"></i>Belum ada ulasan</div>');return}const o=r=>Array.from({length:5},(i,l)=>`<i class="fa-solid fa-star ${l<Math.round(r)?"text-amber-400":"text-slate-200 dark:text-slate-700"}"></i>`).join(""),s=t.map(r=>{let i="";try{r.createdAt&&r.createdAt.toDate&&(i=r.createdAt.toDate().toLocaleDateString("id-ID",{day:"numeric",month:"short",year:"numeric",hour:"2-digit",minute:"2-digit"}))}catch{}const l=r.isVisible===!1;return`
        <div class="p-4 sm:p-5 md:p-6 lg:p-8 rounded-[1.5rem] border shadow-sm ${l?"border-rose-200 bg-rose-50/40 dark:border-rose-900/40 dark:bg-rose-900/10":"border-slate-200 bg-white dark:border-slate-700 dark:bg-slate-800"} mb-3">
            <div class="flex items-start justify-between gap-3 mb-2">
                <div class="min-w-0">
                    <p class="text-sm font-bold text-slate-800 dark:text-white truncate">${c(r.customerName||"Pelanggan")}</p>
                    <p class="text-[10px] font-bold text-slate-500 mt-0.5">${c(r.productName||"")}${r.variantName?" · "+c(r.variantName):""}</p>
                </div>
                <span class="text-[9px] font-bold text-slate-400 whitespace-nowrap">${i}</span>
            </div>
            <div class="flex text-xs mb-2.5">${o(r.rating)}</div>
            ${r.text?`<p class="text-xs text-slate-600 dark:text-slate-300 leading-relaxed mb-2.5">${c(r.text)}</p>`:""}
            ${r.photoUrl?`<img src="${c(r.photoUrl)}" onclick="window.open('${c(r.photoUrl)}','_blank')" class="w-20 h-20 rounded-xl object-cover border border-slate-200 dark:border-slate-700 cursor-pointer mb-2.5" onerror="this.style.display='none'" loading="lazy">`:""}
            ${r.adminReply?`<div class="bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 rounded-xl p-3 mb-2.5"><p class="text-[9px] font-bold text-[var(--color-primary)] uppercase tracking-widest mb-1"><i class="fa-solid fa-store mr-1"></i>Balasan Anda</p><p class="text-[11px] text-slate-600 dark:text-slate-300">${c(r.adminReply)}</p></div>`:""}
            <div class="flex flex-wrap gap-2 pt-2 border-t border-slate-100 dark:border-slate-700/60">
                ...
                <button onclick="toggleReviewVisibility(${r.id})" class="px-3 py-2 rounded-xl ${l?"bg-emerald-50 dark:bg-emerald-900/20 text-[var(--color-primary)] hover:bg-emerald-100":"bg-amber-50 dark:bg-amber-900/20 text-amber-600 dark:text-amber-400 hover:bg-amber-100"} text-[10px] font-bold uppercase tracking-widest flex items-center gap-1.5 transition-all"><i class="fa-solid ${l?"fa-eye":"fa-eye-slash"}"></i> ${l?"Tampilkan":"Sembunyikan"}</button>
        ...
        </div>`}).join("");A("admin-content",a+s)},Jr=async e=>{const t=(jt||[]).find(a=>a.id===e);t&&typeof window.customPrompt=="function"&&window.customPrompt("Tulis balasan untuk ulasan ini:",t.adminReply||"",async a=>{U("Menyimpan balasan...");try{await $.collection("freshmart").doc("cms_data").collection("reviews").doc(e.toString()).update({adminReply:a}),b("Balasan tersimpan!")}catch{b("Gagal menyimpan balasan!")}finally{D()}})},Yr=async e=>{const t=(jt||[]).find(o=>o.id===e);if(!t)return;const a=t.isVisible===!1;U("Menyimpan...");try{await $.collection("freshmart").doc("cms_data").collection("reviews").doc(e.toString()).update({isVisible:a}),b(a?"Ulasan ditampilkan lagi!":"Ulasan disembunyikan dari halaman produk!")}catch{b("Gagal mengubah status ulasan!")}finally{D()}},Xr=e=>{De("Hapus Ulasan","Ulasan yang dihapus tidak bisa dikembalikan lagi.",async()=>{U("Menghapus...");try{await $.collection("freshmart").doc("cms_data").collection("reviews").doc(e.toString()).delete(),b("Ulasan dihapus!")}catch{b("Gagal menghapus ulasan!")}finally{D()}})};window.filterReviews=zr;window.rAdmReviews=Us;window.replyToReview=Jr;window.toggleReviewVisibility=Yr;window.deleteReview=Xr;let ot=null,Vt=null;const Jt=()=>{document.querySelectorAll("#banner-slider video.banner-video-element").forEach(e=>{e.dataset.init||(e.dataset.init="true",e.muted=!0,e.loop=!0,e.playsInline=!0,e.setAttribute("playsinline",""),e.setAttribute("loop",""),e.setAttribute("autoplay","")),e.dataset.loopAttached||(e.dataset.loopAttached="true",e.addEventListener("ended",()=>{e.currentTime=0,e.play().catch(()=>{})})),e.dataset.userUnmuted==="true"&&(e.muted=!1),e.play().catch(()=>{})})},Zr=(e,t)=>{const a=m(`banner-slide-${t}`)||e&&e.closest(".banner-slide-item");if(!a)return;const o=a.querySelector("video.banner-video-element");if(o){o.muted?(o.muted=!1,o.volume=1,o.dataset.userUnmuted="true",o.play().catch(()=>{}),e&&(e.innerHTML='<i class="fa-solid fa-volume-high text-xs"></i> <span>Suara On</span>',e.className="banner-sound-toggle inline-flex items-center gap-1.5 px-3 py-1.5 bg-emerald-600 hover:bg-emerald-500 text-white text-[10px] sm:text-xs font-bold rounded-full shadow-lg border border-white/20 active:scale-95 transition-all cursor-pointer")):(o.muted=!0,o.dataset.userUnmuted="false",e&&(e.innerHTML='<i class="fa-solid fa-volume-xmark text-xs"></i> <span>Muted</span>',e.className="banner-sound-toggle inline-flex items-center gap-1.5 px-3 py-1.5 bg-slate-900/80 hover:bg-slate-900 text-white text-[10px] sm:text-xs font-bold rounded-full shadow-lg border border-white/20 active:scale-95 transition-all cursor-pointer"));return}const s=a.querySelector("iframe.banner-video-iframe");s&&(s.dataset.muted!=="false"?(s.dataset.muted="false",s.contentWindow?.postMessage('{"event":"command","func":"unMute","args":""}',"*"),s.contentWindow?.postMessage('{"event":"command","func":"setVolume","args":[100]}',"*"),e&&(e.innerHTML='<i class="fa-solid fa-volume-high text-xs"></i> <span>Suara On</span>',e.className="banner-sound-toggle inline-flex items-center gap-1.5 px-3 py-1.5 bg-emerald-600 hover:bg-emerald-500 text-white text-[10px] sm:text-xs font-bold rounded-full shadow-lg border border-white/20 active:scale-95 transition-all cursor-pointer")):(s.dataset.muted="true",s.contentWindow?.postMessage('{"event":"command","func":"mute","args":""}',"*"),e&&(e.innerHTML='<i class="fa-solid fa-volume-xmark text-xs"></i> <span>Muted</span>',e.className="banner-sound-toggle inline-flex items-center gap-1.5 px-3 py-1.5 bg-slate-900/80 hover:bg-slate-900 text-white text-[10px] sm:text-xs font-bold rounded-full shadow-lg border border-white/20 active:scale-95 transition-all cursor-pointer")))},lt=e=>{const t=m("banner-dots-container");if(!t)return;t.querySelectorAll(".banner-dot-item").forEach((o,s)=>{s===e?o.className="banner-dot-item h-2.5 rounded-full transition-all duration-300 bg-[var(--color-primary)] w-7 shadow-sm":o.className="banner-dot-item w-2.5 h-2.5 rounded-full transition-all duration-300 bg-slate-300 dark:bg-slate-700 hover:bg-slate-400"})},ei=()=>{Vt&&clearTimeout(Vt),Vt=setTimeout(()=>{const e=m("banner-slider");if(!e)return;const t=e.querySelectorAll(".banner-slide-item");if(!t||!t.length)return;let a=0,o=1/0;t.forEach((s,r)=>{const i=Math.abs(s.offsetLeft-e.scrollLeft);i<o&&(o=i,a=r)}),lt(a)},100)},ti=e=>{clearInterval(ot);const t=m("banner-slider");if(!t)return;const a=t.querySelectorAll(".banner-slide-item");a&&a[e]&&(t.scrollTo({left:a[e].offsetLeft-t.offsetLeft,behavior:"smooth"}),lt(e)),setTimeout(yt,8e3)},ai=()=>{clearInterval(ot);const e=m("banner-slider");if(!e)return;const t=e.querySelectorAll(".banner-slide-item");if(!t||!t.length)return;let a=0,o=1/0;t.forEach((r,i)=>{const l=Math.abs(r.offsetLeft-e.scrollLeft);l<o&&(o=l,a=i)});const s=(a-1+t.length)%t.length;e.scrollTo({left:t[s].offsetLeft-e.offsetLeft,behavior:"smooth"}),lt(s),setTimeout(yt,8e3)},si=()=>{clearInterval(ot);const e=m("banner-slider");if(!e)return;const t=e.querySelectorAll(".banner-slide-item");if(!t||!t.length)return;let a=0,o=1/0;t.forEach((r,i)=>{const l=Math.abs(r.offsetLeft-e.scrollLeft);l<o&&(o=l,a=i)});const s=(a+1)%t.length;e.scrollTo({left:t[s].offsetLeft-e.offsetLeft,behavior:"smooth"}),lt(s),setTimeout(yt,8e3)},yt=()=>{if(clearInterval(ot),!m("banner-slider")||!n.banners||n.banners.length<=1)return;const t=()=>{Jt()};t(),Jt(),ot=setInterval(()=>{const a=m("banner-slider");if(!a)return clearInterval(ot);const o=a.querySelectorAll(".banner-slide-item");if(!o||o.length<=1){const s=a.scrollWidth-a.clientWidth;a.scrollLeft>=s-10?a.scrollTo({left:0,behavior:"smooth"}):a.scrollBy({left:a.clientWidth,behavior:"smooth"})}else{let s=0,r=1/0;o.forEach((d,p)=>{const f=Math.abs(d.offsetLeft-a.scrollLeft);f<r&&(r=f,s=p)});const i=(s+1)%o.length,l=o[i];a.scrollTo({left:l.offsetLeft-a.offsetLeft,behavior:"smooth"}),lt(i)}setTimeout(t,400)},8e3)};window.forcePlayBannerVideos=Jt;window.toggleBannerVideoSound=Zr;window.updateBannerDots=lt;window.onBannerScroll=ei;window.scrollToBanner=ti;window.scrollBannerPrev=ai;window.scrollBannerNext=si;window.startBannerAutoSlide=yt;const Sa=()=>{const e=document.getElementById("storefront-footer-container");if(!e)return;const t=n.store||{},a=t.name||"CV RESTU KARYA UTAMA",o=t.description||t.slogan||"Toko Bahan Material Bangunan dan Perkakas Tukang. Melayani Pembelian secara Online dan Offline dengan jaminan kualitas terbaik.",s=t.email||"support@restukaryautama.com",r=t.operationalHours||"Buka Setiap Hari (08:00 - 17:00)",i=t.address||"",l=t.wa||"",d=t.footerCredit||"POWERED BY NOVAN RESTU UTOMO",p=new Date().getFullYear();let f='<i class="fa-solid fa-store text-2xl text-[var(--color-primary)]"></i>';t.logo&&(t.logo.includes("http")||t.logo.includes("data:")?f=`<img src="${c(t.logo)}" alt="Logo Toko" class="h-full w-full max-h-10 max-w-10 object-contain" onerror="this.outerHTML='<i class=\\'fa-solid fa-store text-2xl text-[var(--color-primary)]\\'></i>'">`:f=`<i class="fa-solid ${c(t.logo)} text-2xl text-[var(--color-primary)]"></i>`);const g=l?`window.open('https://wa.me/${c(l)}', '_blank')`:"if(typeof window.showToast==='function') window.showToast('Nomor WhatsApp belum dikonfigurasi admin.');";e.innerHTML=`
            ...
            <div class="w-full space-y-2.5">
              ...
              <div class="rounded-xl border border-white/20 bg-white/10 p-3 space-y-2.5 text-white shadow-none">
                ...
                <div class="flex items-center gap-2.5 text-white">
                  ...
                  <div class="min-w-0 text-left">
                    <p class="truncate text-xs font-bold text-white tracking-wide">${c(r)}</p>
    ...
    `};window.renderStorefrontFooter=Sa;const Yt=()=>{if(Sa(),H("dyn-store-name",n.store.name||"Nama Toko Anda"),H("dyn-store-slogan",n.store.slogan||"Slogan Toko"),n.store.logo){const i=m("dyn-store-logo-img"),l=m("dyn-store-logo-icon");n.store.logo.includes("http")||n.store.logo.includes("data:")?i&&(i.src=n.store.logo,i.onerror=()=>{i.onerror=null,i.src="https://placehold.co/100?text=Logo"},j("dyn-store-logo-img"),k("dyn-store-logo-icon")):l&&(l.className=`fa-solid ${c(n.store.logo)} text-xl text-[var(--color-primary)]`,j("dyn-store-logo-icon"),k("dyn-store-logo-img"))}let e=n.banners&&n.banners.length?`
    <div class="relative group/banner-wrapper w-full">
        <div id="banner-slider" class="flex overflow-x-auto gap-4 sm:gap-6 pb-4 pt-2 snap-x hide-scrollbar scroll-smooth" ontouchstart="clearInterval(bannerTmr)" ontouchend="setTimeout(startBannerAutoSlide, 8000)" onmouseenter="clearInterval(bannerTmr)" onmouseleave="startBannerAutoSlide()" onscroll="window.onBannerScroll && window.onBannerScroll()">
            ${n.banners.map((i,l)=>{const d=i.type==="video"&&i.videoUrl,p=!d&&i.link?`onclick="window.open('${c(i.link)}', '_self')"`:"";if(d){const f=Ct(i.videoUrl)||{type:"direct",directUrl:Lt(i.videoUrl),embedUrl:$s(i.videoUrl)};let g="";return f.type==="youtube"?g=`
                <iframe
        ...
        `:""}
    </div>`:"";A("dynamic-banners-container",e),setTimeout(yt,500);const t=(n.vouchers||[]).filter(i=>i.isShow==="true"||i.isShow===!0),a=m("dynamic-vouchers-container");if(t.length>0&&a){a.classList.remove("hidden");let i=`
        <div class="flex items-center justify-between mb-4">
            <h3 class="font-bold text-slate-800 dark:text-white text-sm sm:text-base tracking-tight flex items-center gap-2">
                <div class="w-8 h-8 rounded-xl bg-[var(--color-primary)] flex items-center justify-center text-white shadow-sm">
        ...
        </div>`;a.innerHTML=i}else a&&(a.classList.add("hidden"),a.innerHTML="");const o=[...n.categories||[]];A("dynamic-categories-container",o.map(i=>{const l=He===i.name,d=decodeURIComponent(encodeURIComponent(i.name).replace(/'/g,"%27"));return n.store.categoryStyle==="text"||!n.store.categoryStyle?`<div onclick="filterCategory('${d}')" class="cursor-pointer shrink-0 snap-start group py-1"><div class="px-5 py-2.5 rounded-[1.25rem] border-2 transition-all duration-300 flex items-center gap-3 ${l?"bg-[var(--color-primary)] border-transparent text-white shadow-md":"bg-white dark:bg-slate-800 border-slate-100 dark:border-slate-700 text-slate-600 dark:text-slate-300 hover:border-[var(--color-primary)] hover:shadow-md hover:-translate-y-1"}"><div class="w-6 h-6 rounded-full flex items-center justify-center ${l?"bg-white/20 text-white shadow-inner":"bg-slate-50 dark:bg-slate-700 text-slate-400 group-hover:bg-[var(--color-primary-light)] group-hover:text-[var(--color-primary)]"} transition-all duration-300"><i class="fa-solid fa-layer-group text-[10px]"></i></div><span class="font-bold text-[11px] sm:text-xs uppercase tracking-widest pr-2">${c(i.name)}</span></div></div>`:`<div onclick="filterCategory('${d}')" class="flex flex-col items-center gap-3 cursor-pointer shrink-0 w-[80px] sm:w-[95px] group snap-start py-1"><div class="relative w-16 h-16 sm:w-[72px] sm:h-[72px] rounded-[1.25rem] bg-slate-50 dark:bg-slate-800 flex items-center justify-center p-2 transition-all duration-300 ${l?"bg-[var(--color-primary-light)] border-2 border-[var(--color-primary)] shadow-glow dark:bg-[var(--color-primary-dark)]/20":"border border-slate-200 dark:border-slate-700 shadow-sm group-hover:border-[var(--color-primary)] group-hover:shadow-lg group-hover:-translate-y-1.5"} overflow-hidden"><img loading="lazy" src="${c(ce(i.img,"w150-rw"))}" alt="${c(i.name)}" onerror="this.onerror=null;this.src='https://placehold.co/150/10b981/ffffff?text=Cat'" class="w-full h-full object-cover rounded-xl transition-transform duration-500 group-hover:scale-110"></div><span class="text-[9px] sm:text-[10px] text-center w-full line-clamp-2 leading-tight px-1 ${l?"font-bold text-[var(--color-primary)]":"font-bold text-slate-600 dark:text-slate-300 group-hover:text-[var(--color-primary)]"} uppercase tracking-widest transition-colors">${c(i.name)}</span></div>`}).join(""));const s=[...n.brands||[]],r=[{name:"Semua Merek",img:n.store.allBrandsIcon||"https://placehold.co/150/10b981/ffffff?text=Semua+Merek"},...n.brands||[]];A("dynamic-brands-container",s.map(i=>{const l=ke===i.name,d=decodeURIComponent(encodeURIComponent(i.name).replace(/'/g,"%27"));return n.store.brandStyle==="text"?`<div onclick="filterBrand('${d}')" class="cursor-pointer shrink-0 snap-start group py-1"><div class="px-5 py-2.5 rounded-[1.25rem] border-2 transition-all duration-300 flex items-center gap-3 ${l?"bg-[var(--color-primary)] border-transparent text-white shadow-sm":"bg-white dark:bg-slate-800 border-slate-100 dark:border-slate-700 text-slate-600 dark:text-slate-300 hover:border-[var(--color-primary)]/40 hover:shadow-md hover:-translate-y-1"}"><div class="w-6 h-6 rounded-full flex items-center justify-center ${l?"bg-white/20 text-white shadow-inner":"bg-slate-50 dark:bg-slate-700 text-slate-400 group-hover:bg-[rgba(var(--color-primary-rgb),0.08)] group-hover:text-[var(--color-primary)]"} transition-all duration-300"><i class="fa-solid fa-copyright text-[10px]"></i></div><span class="font-bold text-[11px] sm:text-xs uppercase tracking-widest pr-2">${c(i.name)}</span></div></div>`:`<div onclick="filterBrand('${d}')" class="flex flex-col items-center gap-3 cursor-pointer shrink-0 w-[75px] sm:w-[85px] group snap-start py-1"><div class="relative w-16 h-16 sm:w-[68px] sm:h-[68px] rounded-2xl bg-white flex items-center justify-center overflow-hidden p-2 transition-all duration-500 ${l?"ring-4 ring-[var(--color-primary)] ring-offset-2 ring-offset-slate-50 dark:ring-offset-slate-800 shadow-md shadow-[rgba(var(--color-primary-rgb),0.25)]":"border border-slate-200 dark:border-slate-700 shadow-sm group-hover:border-[var(--color-primary)]/50 group-hover:shadow-md group-hover:-translate-y-1.5"}"><img loading="lazy" src="${c(ce(i.img,"w150-rw"))}" alt="${c(i.name)}" onerror="this.onerror=null;this.src='https://placehold.co/150/10b981/ffffff?text=Brand'" class="w-full h-full object-contain drop-shadow-sm transition-transform duration-500 group-hover:scale-110"></div><span class="text-[9px] sm:text-[10px] text-center w-full line-clamp-2 leading-tight px-1 ${l?"font-bold text-[var(--color-primary)]":"font-bold text-slate-600 dark:text-slate-300 group-hover:text-[var(--color-primary)]"} uppercase tracking-widest transition-colors">${c(i.name)}</span></div>`}).join("")),A("modal-brand-grid",r.map(i=>{const l=ke===i.name;return`<button onclick="filterBrand('${decodeURIComponent(encodeURIComponent(i.name).replace(/'/g,"%27"))}'); closeBrandModal();" class="flex flex-col items-center gap-3 p-4 rounded-[1.25rem] border ${l?"border-[var(--color-primary)] bg-[rgba(var(--color-primary-rgb),0.07)] dark:bg-[rgba(var(--color-primary-rgb),0.12)] shadow-sm":"border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 hover:border-[var(--color-primary)]/40 hover:shadow-sm"} transition-all active:scale-[0.96]"><div class="w-14 h-14 rounded-2xl flex items-center justify-center bg-white border border-slate-100 dark:border-slate-600 shadow-inner overflow-hidden p-1.5"><img loading="lazy" src="${c(ce(i.img,"w150-rw"))}" alt="${c(i.name)}" class="w-full h-full object-contain" onerror="this.src='https://placehold.co/100?text=Brand'"></div> <span class="text-[10px] sm:text-xs font-bold ${l?"text-[var(--color-primary)]":"text-slate-700 dark:text-slate-300"} text-center leading-tight line-clamp-2 uppercase tracking-widest">${c(i.name)}</span></button>`}).join("")),m("dyn-qris-img")&&n.payment&&(m("dyn-qris-img").src=n.payment.qrisUrl),typeof window.renderRewardCatalog=="function"&&window.renderRewardCatalog(),typeof window.applyBackgroundStyle=="function"&&window.applyBackgroundStyle(n.store.bgStyle,n.store.bgCustomUrl),Ce(1),typeof window.rCat=="function"&&window.rCat()};window.rDyn=Yt;const oi=async()=>{if(document.documentElement.classList.contains("dark")){const u=m("icon-theme");u&&(u.className="fa-solid fa-sun text-sm text-amber-500")}const e=()=>{n.products=n.products||[],n.categories=n.categories||[],n.brands=n.brands||[],n.vouchers=n.vouchers||[],n.products.forEach(u=>{u.img&&(u.img=W(u.img)),u.variants&&u.variants.forEach(w=>{w.img&&(w.img=W(w.img))})}),n.banners&&n.banners.forEach(u=>{u.img&&(u.img=W(u.img)),u.videoUrl&&(u.videoUrl=Lt(u.videoUrl))}),n.categories&&n.categories.forEach(u=>{u.img&&(u.img=W(u.img))}),n.brands&&n.brands.forEach(u=>{u.img&&(u.img=W(u.img))}),n.store.logo&&(n.store.logo=W(n.store.logo)),n.store.allProductsIcon&&(n.store.allProductsIcon=W(n.store.allProductsIcon)),n.store.allBrandsIcon&&(n.store.allBrandsIcon=W(n.store.allBrandsIcon)),n.payment.qrisUrl&&(n.payment.qrisUrl=W(n.payment.qrisUrl)),F.forEach(u=>{u.img&&(u.img=W(u.img))}),xe.forEach(u=>{u.img&&(u.img=W(u.img))})};let t=JSON.parse(ge("freshmart_cms_data")||"null"),a=JSON.parse(ge("freshmart_products")||"null"),o=JSON.parse(ge("freshmart_rewards")||"null");parseInt(ge("freshmart_last_update")||"0");let s=!1;if(t?(Object.assign(n,me,t),n.store={...me.store,...t.store||{}},n.payment={...me.payment,...t.payment||{}},n.config={...me.config,...t.config||{}},n.config&&n.config.gasUrl&&(window.GAS_UPLOAD_URL=n.config.gasUrl),a&&(n.products=a),o&&(n.rewards=o),e(),Tt(),Te(),bt(),Yt(),H("stat-products",n.products.filter(u=>u.isActive!=="false"&&u.isActive!==!1).length),D(),s=!0):U("Memuat Toko..."),!s)try{const u=await $.collection("freshmart").doc("cms_data").get();if(u.exists){const w=u.data(),v=w.lastUpdate||0;J("freshmart_cms_data",JSON.stringify(w)),Object.assign(n,me,w),n.store={...me.store,...w.store||{}},n.payment={...me.payment,...w.payment||{}},n.config={...me.config,...w.config||{}},n.config&&n.config.gasUrl&&(window.GAS_UPLOAD_URL=n.config.gasUrl);const h=await $.collection("freshmart").doc("cms_data").collection("products").get();n.products=h.docs.map(S=>S.data()).sort((S,C)=>(C.id||0)-(S.id||0)),J("freshmart_products",JSON.stringify(n.products)),J("freshmart_last_update",v.toString()),e(),Tt(),Te(),bt(),Yt(),H("stat-products",n.products.filter(S=>S.isActive!=="false"&&S.isActive!==!1).length)}}catch{b("Mode Offline (Data Lokal)")}finally{D()}H("stat-products",n.products.filter(u=>u.isActive!=="false"&&u.isActive!==!1).length);const r=m("loader-store-name"),i=m("loader-tagline");r&&(r.textContent=(n.store.name||"").toUpperCase()),i&&(i.textContent=n.store.tagline||n.store.desc||n.store.address||"");const l=m("loader-logo-icon"),d=m("loader-logo-img"),p=n.store.logo&&n.store.logo!=="fa-store"?n.store.logo:"";p&&(l&&(l.style.display="none"),d&&(d.src=p,d.style.display="block"));try{const u=n.store.name||"Toko Saya",w=n.store.logo||"",v=/^(https?:|data:)/i.test(w)?w:"https://placehold.co/192x192?text=Logo",h=document.documentElement.classList.contains("dark")?"#0f172a":"#ffffff",S=n.store.themeColor||localStorage.getItem("freshmart_theme_color")||"#10b981";let C=document.getElementById("dynamic-manifest");C||(C=document.createElement("link"),C.id="dynamic-manifest",C.rel="manifest",document.head.appendChild(C));let T=document.getElementById("dynamic-apple-icon");T||(T=document.createElement("link"),T.id="dynamic-apple-icon",T.rel="apple-touch-icon",document.head.appendChild(T)),T.href=v;let O=document.getElementById("dynamic-favicon");O||(O=document.createElement("link"),O.id="dynamic-favicon",O.rel="icon",document.head.appendChild(O)),O.href=v;const I={id:window.location.origin+"/",name:u,short_name:u,description:n.store.slogan||u+" - Belanja online lebih mudah",start_url:window.location.origin+"/",scope:window.location.origin+"/",lang:"id",dir:"ltr",display:"standalone",display_override:["standalone","minimal-ui"],orientation:"portrait",categories:["shopping","business"],background_color:h,theme_color:S,icons:[{src:v,sizes:"192x192",type:"image/png",purpose:"any"},{src:v,sizes:"512x512",type:"image/png",purpose:"any"}]};C.href=URL.createObjectURL(new Blob([JSON.stringify(I)],{type:"application/manifest+json"}))}catch(u){console.error("Manifest Error: ",u)}window.injectJSONLD("seo-website",{"@context":"https://schema.org","@type":"WebSite",name:"Toko Putri",url:window.location.origin}),window.injectJSONLD("seo-localbusiness",{"@context":"https://schema.org","@type":"HardwareStore",name:"Toko Putri",image:ce(n.store.logo,"w300-rw"),description:"Solusi grosir dan e-commerce terpercaya untuk alat teknik, perkakas, dan perlengkapan pertukangan berkualitas.",url:window.location.origin,telephone:n.store.phone||"",address:{"@type":"PostalAddress",streetAddress:n.store.address||"",addressCountry:"ID"}});const g=new URLSearchParams(window.location.search).get("p");if(g&&n.products.find(u=>u.id==parseInt(g))){const u=new URLSearchParams(window.location.search);u.delete("p");let w=window.location.pathname;u.toString()&&(w+="?"+u.toString()),window.history.replaceState({},document.title,w),setTimeout(()=>openProductModal(parseInt(g)),600)}D()},ie=async(e=null,t=null)=>{try{if(Array.isArray(e)){const o={lastUpdate:pe.firestore.FieldValue.increment(1),updateType:t?.updateType||(e.length?"settings_change":"full"),changedKeys:e};t?.updatedProductIds&&(o.updatedProductIds=t.updatedProductIds),e.forEach(s=>{s&&(o[s]=n[s])}),await $.collection("freshmart").doc("cms_data").set(o,{merge:!0})}else{const o={...n};delete o.products,delete o.auth,o.lastUpdate=pe.firestore.FieldValue.increment(1),o.updateType="full",await $.collection("freshmart").doc("cms_data").set(o)}n.lastUpdate=(parseInt(ge("freshmart_last_update"))||n.lastUpdate||0)+1;const a={...n};delete a.products,delete a.auth,J("freshmart_cms_data",JSON.stringify(a)),J("freshmart_last_update",n.lastUpdate.toString()),J("freshmart_products",JSON.stringify(n.products))}catch{b("Tersimpan secara Lokal")}};let Gt=!1,Ve=null,Ra=0;const ri=1e4;let Xt=typeof document<"u"?document.hidden:!1,Zt=!1;typeof document<"u"&&document.addEventListener("visibilitychange",()=>{if(Xt=document.hidden,!Xt&&Zt&&Ve){Zt=!1;const e=Ve;Ve=null,typeof window._doSyncCmsData=="function"&&window._doSyncCmsData(e)}});window.attachRealtimeStockSync=()=>{if(window.unsubCmsRealtime)return;const e=async t=>{if(!t.exists)return;const a=t.data(),o=a.lastUpdate||0,s=parseInt(ge("freshmart_last_update")||"0");if(Xt){Ve=t,Zt=!0;return}if(!(o<=s&&n.products&&n.products.length>0)){Gt=!0;try{const r=a.updateType||"full",i=Array.isArray(a.updatedProductIds)?a.updatedProductIds.map(String):[];if(n.store={...me.store,...a.store||{}},a.categories&&(n.categories=a.categories),a.vouchers&&(n.vouchers=a.vouchers),a.banners&&(n.banners=a.banners),a.brands&&(n.brands=a.brands),a.banks&&(n.banks=a.banks),a.faqs&&(n.faqs=a.faqs),n.payment={...me.payment,...a.payment||{}},n.config={...me.config,...a.config||{}},n.taxSettings={...me.taxSettings,...a.taxSettings||{}},n.config&&n.config.gasUrl&&(window.GAS_UPLOAD_URL=n.config.gasUrl),n.banners&&n.banners.forEach(l=>{l.img&&(l.img=W(l.img)),l.videoUrl&&(l.videoUrl=Lt(l.videoUrl))}),n.categories&&n.categories.forEach(l=>{l.img&&(l.img=W(l.img))}),n.brands&&n.brands.forEach(l=>{l.img&&(l.img=W(l.img))}),!(r==="settings_change"&&n.products&&n.products.length>0))if((r==="stock_change"||r==="product_single")&&i.length>0&&n.products&&n.products.length>0)(await Promise.all(i.map(d=>$.collection("freshmart").doc("cms_data").collection("products").doc(d).get().catch(()=>null)))).forEach(d=>{if(d&&d.exists){const p=d.data();p.img&&(p.img=W(p.img)),p.variants&&p.variants.forEach(g=>{g.img&&(g.img=W(g.img))});const f=n.products.findIndex(g=>g.id.toString()===d.id);f>-1?n.products[f]=p:n.products.unshift(p)}}),J("freshmart_products",JSON.stringify(n.products));else{const l=Date.now();if(l-Ra<ri&&n.products&&n.products.length>0)return;Ra=l;const d=await $.collection("freshmart").doc("cms_data").collection("products").get();n.products=d.docs.map(p=>p.data()).sort((p,f)=>(f.id||0)-(p.id||0)),n.products.forEach(p=>{p.img&&(p.img=W(p.img)),p.variants&&p.variants.forEach(f=>{f.img&&(f.img=W(f.img))})}),J("freshmart_products",JSON.stringify(n.products))}if(J("freshmart_cms_data",JSON.stringify(a)),J("freshmart_last_update",o.toString()),window.isAdm&&cTab&&["categories","vouchers","banners","brands","banks","products","colors"].includes(cTab)&&typeof window.rAdmItms=="function"&&window.rAdmItms(cTab),Tt(),Te(),typeof window.rDyn=="function"&&window.rDyn(),typeof window.rCat=="function"&&window.rCat(),cProd){const l=n.products.find(d=>d.id===cProd.id);if(l&&(cProd=l,typeof window.rProdMod=="function")){const d=document.getElementById("product-modal");d&&!d.classList.contains("hidden")&&!d.classList.contains("opacity-0")&&window.rProdMod()}}}catch(r){console.warn("Gagal sinkron realtime stok:",r)}finally{if(Gt=!1,Ve){const r=Ve;Ve=null,e(r)}}}};window._doSyncCmsData=e,window.unsubCmsRealtime=$.collection("freshmart").doc("cms_data").onSnapshot(async t=>{if(Gt){Ve=t;return}await e(t)},t=>{console.warn("Realtime listener error:",t)})};window.attachRewardsRealtime=()=>{if(!window.unsubRewardsRealtime){if(!n.rewards||!n.rewards.length)try{const e=JSON.parse(ge("freshmart_rewards")||"null");e&&Array.isArray(e)&&(n.rewards=e,n.rewards.forEach(t=>{t.img&&(t.img=W(t.img))}))}catch{}window.unsubRewardsRealtime=$.collection("freshmart").doc("cms_data").collection("rewards").onSnapshot(e=>{n.rewards=e.docs.map(a=>a.data()).sort((a,o)=>(o.id||0)-(a.id||0)),n.rewards.forEach(a=>{a.img&&(a.img=W(a.img))}),J("freshmart_rewards",JSON.stringify(n.rewards)),window.isAdm&&cTab==="rewards"&&typeof window.rAdmItms=="function"&&window.rAdmItms("rewards"),typeof window.renderRewardCatalog=="function"&&window.renderRewardCatalog();const t=document.getElementById("member-modal");t&&t.style.display==="flex"&&currentMember&&typeof window.rMemberModalBody=="function"&&window.rMemberModalBody()},e=>{console.warn("Realtime hadiah gagal:",e)})}};window.getEffP=e=>{const t=n.products.find(s=>s.id===e.id);let a=e.price||0;if(e.variantName&&t&&t.variants){const s=t.variants.find(r=>r.name===e.variantName);s&&s.price!=null&&(a=s.price)}if(e.variantName||!t||!t.wholesale||!t.wholesale.length)return a;const o=F.filter(s=>s.id===e.id).reduce((s,r)=>s+(parseFloat(r.qty)||0),0);for(let s of t.wholesale.slice().sort((r,i)=>i.minQty-r.minQty))if(o>=parseFloat(s.minQty))return s.price;return a};window.getEffHpp=e=>{const t=n.products.find(a=>a.id===e.id);if(!t)return 0;if(e.variantName&&t.variants){const a=t.variants.find(o=>o.name===e.variantName);if(a&&a.hpp!=null)return parseFloat(a.hpp)||0}return parseFloat(t.hpp)||0};window.getEffPoin=e=>{if(!e)return 0;const t=n.products.find(a=>a.id===e.id);if(!t)return parseFloat(e.poin)||0;if(e.variantName&&t.variants){const a=t.variants.find(o=>o.name===e.variantName);if(a&&a.poin!==void 0&&a.poin!==null&&a.poin!==""){const o=parseFloat(a.poin);if(!isNaN(o)&&o>0)return o}}return parseFloat(t.poin)||0};window.getDist=(e,t,a,o)=>{if(!e||!t||!a||!o)return 0;const s=6371,r=(a-e)*Math.PI/180,i=(o-t)*Math.PI/180,l=Math.sin(r/2)*Math.sin(r/2)+Math.cos(e*Math.PI/180)*Math.cos(a*Math.PI/180)*Math.sin(i/2)*Math.sin(i/2),d=2*Math.atan2(Math.sqrt(l),Math.sqrt(1-l));return s*d};window.autoParseCoords=e=>{const a=e.value.trim().split(",");if(a.length>=2){const o=parseFloat(a[0].trim()),s=parseFloat(a[1].trim());if(!isNaN(o)&&!isNaN(s)){setV("set-lat",o),setV("set-lng",s),b("Koordinat tersalin!");return}}b("Format salah! Coba: Lat, Lng")};window.loadAppData=oi;window.saveApp=ie;window.attachRealtimeStockSync=attachRealtimeStockSync;let z=!1,Je="products",Fa="",Ae=null,Le=[],nt=[],Ge=[];window.rAdmL=e=>{Je=e,typeof window.setCTab=="function"&&window.setCTab(e),window.cTab=e,A("admin-content",`
    ...
    `),rAdmItms(e)};window.rAdmItms=e=>{e&&(Je=e,typeof window.setCTab=="function"&&window.setCTab(e),window.cTab=e);const t=m("admin-list-container"),a=t?t.closest(".scroll-content"):null,o=a?a.scrollTop:0;if(e==="products"&&m("admin-product-stats")){const i=Bt();A("admin-product-stats",`
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                <div class="card-modern p-5 sm:p-5">
...
></i>`,s+="</div>"}),s=`<div class="grid grid-cols-1 lg:grid-cols-2 gap-x-5 gap-y-5 items-start">${s}</div>`,A("admin-modal-form",s),e==="products"&&(rVarsB(),rWholB(),rSpecB());const d=m("admin-modal");d&&d.classList.contains("hidden")&&pushModalHistory("admin"),j("admin-modal"),setTimeout(()=>{m("admin-modal").classList.remove("opacity-0"),m("admin-modal-box").classList.remove("scale-95")},10)};window.rVarsB=()=>{const e=document.getElementById("af-category"),t=e?/\bcat\b/i.test(e.value):!1;let a=`<div class="space-y-5 mb-5">${Le.map((o,s)=>{let r=o.isActive!==!1&&o.isActive!=="false";return`
        <div class="bg-slate-50 dark:bg-slate-900/50 p-5 sm:p-6 md:p-7 lg:p-8 rounded-[1.5rem] border border-slate-200 dark:border-slate-700 shadow-sm relative transition-all duration-300 hover:border-[var(--color-primary)]/40 dark:hover:border-[var(--color-primary)]/40 hover:shadow-md">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6 lg:gap-7">
                <div>
                    ...
                    <input autocomplete='off' placeholder="Cth: Hijau Tosca" class="admin-input !text-sm !py-3.5 bg-white dark:bg-slate-800 shadow-sm" value="${c(o.name)}" onchange="uVar(${s},'name',this.value)"></i>
                </div>
                <div>
                    ...
                    <input autocomplete='off' placeholder="Cth: Pcs / Liter" class="admin-input !text-sm !py-3.5 bg-white dark:bg-slate-800 shadow-sm" value="${c(o.unit||"")}" onchange="uVar(${s},'unit',this.value)"></i>
                </div>
                <div>
                    ...
                    <input autocomplete='off' placeholder="0" type="number" class="admin-input !text-sm !py-3.5 bg-white dark:bg-slate-800 shadow-sm" value="${o.price}" onchange="uVar(${s},'price',this.value)"></i>
                </div>
                <div>
                    ...
                    <input autocomplete='off' placeholder="0" type="number" class="admin-input !text-sm !py-3.5 bg-white dark:bg-slate-800 shadow-sm" value="${o.priceNormal||""}" onchange="uVar(${s},'priceNormal',this.value)"></i>
                </div>
                <div>
                    ...
                    <div class="flex gap-3 items-center bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-2 shadow-sm">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <input autocomplete='off' id="var-hex-${s}" placeholder="#RRGGBB (opsional)" class="w-full bg-transparent text-sm font-mono font-bold focus:outline-none dark:text-white uppercase" value="${c(o.colorCode||"")}" onchange="uVar(${s},'colorCode',this.value)"></i>
                        </div>
                ...
                <div>
                    ...
                    <div class="relative h-[48px]">
                        <input autocomplete='off' id="var-sku-${s}" placeholder="Auto (Bisa Kosong)" class="admin-input !text-sm h-full bg-white dark:bg-slate-800 shadow-sm !pr-12" value="${c(o.sku||"")}" onchange="uVar(${s},'sku',this.value)"></i>
                ...
                <div>
                    ...
                    <button type="button" onclick="tVars[${s}].isActive = ${!r}; rVarsB();" class="w-full py-3.5 px-4 rounded-xl text-[13px] font-bold uppercase tracking-wider transition-all shadow-sm flex items-center justify-center gap-2.5 border-2 active:scale-95 ${r?"primary-bg border-[var(--color-primary-dark)] shadow-md":"bg-slate-100 text-rose-500 border-rose-200 hover:bg-rose-50 dark:bg-slate-800 dark:border-rose-800"}">
                        ${r?'<i class="fa-solid fa-circle-check text-base"></i> STOK TERSEDIA':'<i class="fa-solid fa-ban text-base"></i> STOK HABIS'}
                    </button>
                </div>
                <div>
                    ...
                    <input autocomplete='off' placeholder="0" type="number" class="admin-input !text-sm !py-3.5 bg-white dark:bg-slate-800 shadow-sm" value="${o.hpp||0}" onchange="uVar(${s},'hpp',this.value)"></i>
                </div>
                <div>
                    ...
                    <input autocomplete='off' placeholder="0" type="number" class="admin-input !text-sm !py-3.5 bg-white dark:bg-slate-800 shadow-sm" value="${o.stock!==void 0?o.stock:""}" onchange="uVar(${s},'stock',this.value)"></i>
                </div>
                <div>
                    ...
                    <input autocomplete='off' placeholder="0" type="number" min="0" class="admin-input !text-sm !py-3.5 bg-white dark:bg-slate-800 shadow-sm" value="${o.poin||0}" onchange="uVar(${s},'poin',this.value)"></i>
                </div>
            </div>
        </div>`}).join("")}</div>
    ...
    </div>`;A("variants-builder-container",a)};window.addVar=()=>{Le.push({name:"",price:0,priceNormal:0,hpp:0,stock:0,sku:"",img:"",unit:"",colorCode:"",poin:0,isActive:!0}),rVarsB()};window.rmVar=e=>{Le.splice(e,1),rVarsB()};window.uVar=(e,t,a)=>{Le[e][t]=t==="price"||t==="priceNormal"||t==="hpp"||t==="stock"||t==="poin"?parseFloat(a)||0:t==="img"?W(a):a};window.openColorImportModal=()=>{let e=n.colors||[];if(!e.length){b("Database Warna masih kosong!");return}let t={};e.forEach(o=>{let s=o.catalog||"Tanpa Katalog";t[s]||(t[s]=[]),t[s].push(o)});let a=`<div class="p-6">
    ...
    `;for(let o in t)a+=`<div>
        ...
        </div>`)};window.confirmExportVariantToColorDB=async()=>{const e=(document.getElementById("exp-name")?.value||"").trim(),t=(document.getElementById("exp-hex")?.value||"").trim(),a=(document.getElementById("exp-catalog")?.value||"").trim();if(!e){b("Nama warna wajib diisi!");return}const o={id:Date.now(),name:e,hex:t,catalog:a};n.colors||(n.colors=[]),n.colors.push(o),_closeColorFloatModal(),U("Menyimpan ke Database Warna...");try{await ie(["colors"]),b(`"${e}" berhasil disimpan ke Database Warna! 🎨`)}catch{b("Gagal menyimpan!")}finally{D()}};window.exportAllVariantsToColorDB=async()=>{const e=Le.filter(o=>o.name.trim());if(!e.length){b("Tidak ada varian untuk diekspor!");return}n.colors||(n.colors=[]),new Set(n.colors.map(o=>o.name.toLowerCase()));let a=[...new Set(n.colors.map(o=>o.catalog).filter(Boolean))].map(o=>`<option value="${c(o)}">${c(o)}</option>`).join("");_openColorFloatModal(`
        <div class="p-6">
        ...
        </div>`)};window.confirmExportAllVariants=async()=>{const e=(document.getElementById("expall-catalog")?.value||"").trim(),t=Le.filter(s=>s.name.trim());n.colors||(n.colors=[]);const a=new Set(n.colors.map(s=>s.name.toLowerCase()));let o=0;if(t.forEach(s=>{a.has(s.name.trim().toLowerCase())||(n.colors.push({id:Date.now()+o,name:s.name.trim(),hex:s.colorCode||"",catalog:e}),a.add(s.name.trim().toLowerCase()),o++)}),_closeColorFloatModal(),!o){b("Semua varian sudah ada di Database Warna!");return}U("Menyimpan...");try{await ie(["colors"]),b(`${o} warna berhasil diekspor ke Database Warna! 🎨`)}catch{b("Gagal menyimpan!")}finally{D()}};window.openImportFromProductsModal=async()=>{const e=[];if((n.products||[]).forEach(r=>{(r.variants||[]).forEach(i=>{i.name&&i.name.trim()&&e.push({varName:i.name.trim(),hex:i.colorCode||"",prodName:r.name||""})})}),!e.length){b("Tidak ada varian produk yang ditemukan!");return}const t=new Set((n.colors||[]).map(r=>r.name.toLowerCase())),a=e.filter(r=>!t.has(r.varName.toLowerCase()));if(!a.length){b("Semua varian produk sudah ada di Database Warna!");return}let s=[...new Set((n.colors||[]).map(r=>r.catalog).filter(Boolean))].map(r=>`<option value="${c(r)}">${c(r)}</option>`).join("");window._pendingImportVariants=a,_openColorFloatModal(`
        <div class="p-6">
            ...
            <div class="max-h-48 overflow-y-auto mb-4 space-y-2">
                ${a.map((r,i)=>`
                    <label class="flex items-center gap-3 p-2.5 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 cursor-pointer hover:border-emerald-300 transition-all">
                        ...
                        <div class="w-5 h-5 rounded-full border border-slate-200 dark:border-slate-600 shrink-0" style="background-color:${c(r.hex||"transparent")}"></div>
                        <div class="min-w-0">
                            <p class="text-xs font-bold text-slate-700 dark:text-slate-200 truncate">${c(r.varName)}</p>
                            <p class="text-[10px] text-slate-400 truncate">dari: ${c(r.prodName)}</p>
                        </div>
                    </label>
                `).join("")}
            </div>
        ...
        </div>`)};window.confirmImportFromProducts=async()=>{const e=window._pendingImportVariants||[];window._pendingImportVariants=null;const t=(document.getElementById("impprod-catalog")?.value||"").trim();n.colors||(n.colors=[]);const a=new Set(n.colors.map(s=>s.name.toLowerCase()));let o=0;if(e.forEach((s,r)=>{const i=document.getElementById(`imp-chk-${r}`);i&&i.checked&&!a.has(s.varName.toLowerCase())&&(n.colors.push({id:Date.now()+o,name:s.varName,hex:s.hex||"",catalog:t}),a.add(s.varName.toLowerCase()),o++)}),_closeColorFloatModal(),!o){b("Tidak ada warna baru yang ditambahkan!");return}U("Menyimpan...");try{await ie(["colors"]),b(`${o} warna berhasil diimpor ke Database Warna! 🎨`),typeof Je<"u"&&Je==="colors"&&rAdmItms("colors")}catch{b("Gagal menyimpan!")}finally{D()}};window.rWholB=()=>{let e=`<div class="space-y-4 mb-4">${nt.map((t,a)=>`
        ...
        <button onclick="addWhol()" class="w-full py-4 bg-amber-50 dark:bg-amber-900/20 text-amber-600 font-bold rounded-[1.5rem] text-sm border-2 border-amber-200 border-dashed hover:bg-amber-100 transition-all flex items-center justify-center gap-2 active:scale-95 shadow-sm"><i class="fa-solid fa-tags"></i> Tambah Tingkatan Grosir</button>`;A("wholesale-builder-container",e)};window.addWhol=()=>{nt.push({minQty:2,price:0}),rWholB()};window.rmWhol=e=>{nt.splice(e,1),rWholB()};window.uWhol=(e,t,a)=>{nt[e][t]=parseFloat(a)||0};window.rSpecB=()=>{if(!m("spec-table-builder-container"))return;let t="";Ge.length>0?t+=`<div class="overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm mb-4">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
                    ...
                    <tr class="bg-white dark:bg-slate-900 group">
                        <td class="py-2 px-3">
                            <input autocomplete='off' placeholder="Cth: Berat" class="w-full bg-transparent text-[13px] font-semibold text-slate-700 dark:text-slate-200 focus:outline-none placeholder:text-slate-300" value="${c(a.key)}" oninput="uSpec(${o},'key',this.value)">
                        </td>
                        <td class="py-2 px-3">
                            <input autocomplete='off' placeholder="Cth: 2.5 kg" class="w-full bg-transparent text-[13px] text-slate-600 dark:text-slate-300 focus:outline-none placeholder:text-slate-300" value="${c(a.val)}" oninput="uSpec(${o},'val',this.value)">
                        </td>
                        <td class="py-2 px-2 text-center">
                            <button type="button" onclick="rmSpec(${o})" class="w-7 h-7 rounded-lg bg-rose-50 border border-rose-200 text-rose-400 hover:bg-rose-500 hover:text-white dark:bg-rose-900/30 dark:border-rose-800 transition-all flex items-center justify-center opacity-60 group-hover:opacity-100 active:scale-95" title="Hapus Baris"><i class="fa-solid fa-trash text-[10px]"></i></button>
                        </td>
                    </tr>`).join("")}
                </tbody>
            </table>
        </div>`:t+='<div class="text-center py-6 text-slate-400 dark:text-slate-600 text-[12px] font-medium"><i class="fa-solid fa-table-cells-large text-2xl mb-2 block opacity-30"></i>Belum ada spesifikasi. Klik tombol di bawah untuk menambahkan.</div>',t+='<button type="button" onclick="addSpec()" class="w-full py-4 bg-cyan-50 dark:bg-cyan-900/20 text-cyan-600 dark:text-cyan-400 font-bold rounded-[1.5rem] text-sm border-2 border-cyan-200 dark:border-cyan-800 border-dashed hover:bg-cyan-100 dark:hover:bg-cyan-900/30 transition-all flex items-center justify-center gap-2 active:scale-95 shadow-sm"><i class="fa-solid fa-plus-circle"></i> Tambah Baris Spesifikasi</button>',A("spec-table-builder-container",t)};window.addSpec=()=>{Ge.push({key:"",val:""}),rSpecB()};window.rmSpec=e=>{Ge.splice(e,1),rSpecB()};window.uSpec=(e,t,a)=>{Ge[e]&&(Ge[e][t]=a)};window.submitAdminForm=async()=>{if(z)return;z=!0;const e=Je||window.cTab||"products";let t={},a=ga[e]||[];for(let s of a)if(s.type==="variants_builder")t.variants=Le.filter(r=>r.name.trim()!=="");else if(s.type==="wholesale_builder")t.wholesale=nt.filter(r=>parseFloat(r.minQty)>.01&&r.price>0);else if(s.type==="spec_table_builder")t.specTable=Ge.filter(r=>r.key.trim()!=="");else{let r="";if(s.type==="richtext"){const i=m(`af-${s.key}-editor`);r=i?i.innerHTML:""}else r=L(`af-${s.key}`);if(typeof r=="string"){if(r.startsWith("data:image/")&&r.length>3e5)return z=!1,b("Gambar Base64 terlalu besar! Upload file.");s.key==="img"&&(r=W(r))}t[s.key]=s.type==="number"?parseFloat(r)||0:r}if(!t.name&&!t.title&&!t.bankName&&!t.code)return z=!1,b("Judul/Nama/Kode wajib diisi!");if(e==="products"&&!t.sku&&(t.sku="SKU"+Date.now().toString().slice(-6)),e==="customers"){const s=window.normalizeWA?window.normalizeWA(t.phone):(t.phone||"").replace(/\D/g,"").replace(/^0/,"62");if(!s||s.length<10)return z=!1,b("Nomor WhatsApp tidak valid!");t.phone=s,t.points=parseFloat(t.points)||0,t.id=parseInt(s,10)}let o=null;if(e==="customers")if(n.customers||(n.customers=[]),Ae){o=Ae;let s=n.customers.findIndex(r=>r.id===Ae);s>-1?n.customers[s]=t:n.customers.unshift(t)}else n.customers.unshift(t);else if(e==="rewards")if(n.rewards||(n.rewards=[]),Ae){t.id=Ae;let s=n.rewards.findIndex(r=>r.id===Ae);s>-1&&(n.rewards[s]=t)}else t.id=Date.now(),n.rewards.unshift(t);else if(Ae){t.id=Ae,n[e]||(n[e]=[]);let s=n[e].findIndex(r=>r.id===Ae);if(e==="products"&&s>-1){const r=n[e][s];t.totalSold=r.totalSold||0,t.variants&&t.variants.length&&r.variants&&t.variants.forEach(i=>{const l=r.variants.find(d=>d.name===i.name);l&&l.totalSold&&(i.totalSold=l.totalSold)})}s>-1&&(n[e][s]=t)}else t.id=Date.now(),n[e]||(n[e]=[]),n[e].unshift(t);U("Menyimpan...");try{const s=typeof $<"u"&&$?$:window.db,r=typeof ie=="function"?ie:window.saveApp||(async()=>{});if(!s)throw new Error("Database Firebase belum terhubung");if(e==="products")await s.collection("freshmart").doc("cms_data").collection("products").doc(t.id.toString()).set(t),await r([],{updateType:"product_single",updatedProductIds:[t.id.toString()]});else if(e==="customers"){const i=s.collection("freshmart").doc("cms_data").collection("customers");if(o!==null&&o!==t.id){const l=o.toString();await i.doc(l).delete().catch(()=>{})}await i.doc(t.phone).set(t,{merge:!0})}else e==="rewards"?await s.collection("freshmart").doc("cms_data").collection("rewards").doc(t.id.toString()).set(t):await r([e]);closeAdminModal(),rAdmItms(e),b("Tersimpan!")}catch(s){console.error("Gagal simpan admin data:",s),b("Gagal menyimpan: "+(s.message||""))}finally{z=!1,D()}};window.oADel=async(e,t)=>{De("Hapus Data","Data yang dihapus tidak bisa dikembalikan lagi.",async()=>{if(z)return;z=!0;const a=typeof $<"u"&&$?$:window.db,o=typeof ie=="function"?ie:window.saveApp||(async()=>{}),s=n[e]&&n[e].find(r=>r.id===t);n[e]=n[e].filter(r=>r.id!==t),U("Menghapus...");try{if(!a)throw new Error("Database Firebase belum terhubung");if(e==="products")await a.collection("freshmart").doc("cms_data").collection("products").doc(t.toString()).delete(),await o([]);else if(e==="customers"){const r=s?s.phone:t.toString();await a.collection("freshmart").doc("cms_data").collection("customers").doc(r).delete()}else e==="rewards"?await a.collection("freshmart").doc("cms_data").collection("rewards").doc(t.toString()).delete():await o([e]);rAdmItms(e),b("Berhasil Dihapus!")}catch(r){b("Gagal menghapus: "+(r.message||""))}finally{z=!1,D()}})};window.duplicateProduct=async e=>{De("Duplikat Produk","Menyalin data produk ini ke item baru?",async()=>{if(z)return;z=!0;const t=typeof $<"u"&&$?$:window.db,a=typeof ie=="function"?ie:window.saveApp||(async()=>{}),o=n.products.find(r=>r.id===e);if(!o){z=!1;return}let s=JSON.parse(JSON.stringify(o));s.id=Date.now()+Math.floor(Math.random()*1e3),s.name=s.name+" COPY",s.sku="",s.totalSold=0,s.variants&&s.variants.length>0&&(s.variants=s.variants.map(r=>(r.sku="",r.totalSold=0,r))),n.products.unshift(s),U("Menyalin...");try{if(!t)throw new Error("Database Firebase belum terhubung");await t.collection("freshmart").doc("cms_data").collection("products").doc(s.id.toString()).set(s),await a([],{updateType:"product_single",updatedProductIds:[s.id.toString()]}),rAdmItms("products"),b("Produk berhasil disalin!")}catch(r){b("Gagal menyalin: "+(r.message||""))}finally{z=!1,D()}},"Ya, Salin")};window.openRestockModal=e=>{const t=n.products.find(r=>r.id===e);if(!t)return;const a=t.variants&&t.variants.length>0;let o="";a?o=t.variants.map((r,i)=>`
            <div class="flex items-center justify-between gap-3 bg-slate-50 dark:bg-slate-900/50 p-4 rounded-[1.25rem] border border-slate-200 dark:border-slate-700">
                <div class="flex items-center gap-3 min-w-0 flex-1">
                    ${r.colorCode?`<span class="w-5 h-5 rounded-full shrink-0 shadow-sm border border-slate-300" style="background-color:${c(r.colorCode)}"></span>`:""}
                    <div class="min-w-0 flex-1">
                        <p class="text-xs font-bold text-slate-800 dark:text-white truncate">${c(r.name)}</p>
                        <p class="text-[10px] font-bold text-slate-500 mt-0.5">Stok saat ini: <span class="text-blue-500 font-bold">${parseFloat(r.stock)||0}</span></p>
                    </div>
                </div>
            ...
            </div>`;let s=document.getElementById("restock-modal");s||(s=document.createElement("div"),s.id="restock-modal",s.className="fixed inset-0 z-[110] bg-slate-900/70 backdrop-blur-sm flex items-end sm:items-center justify-center p-0 sm:p-5",s.onclick=r=>{r.target===s&&closeRestockModal()},document.body.appendChild(s)),s.innerHTML=`
        <div class="bg-white dark:bg-slate-900 w-full max-w-lg rounded-t-[2rem] sm:rounded-[2rem] max-h-[85vh] flex flex-col shadow-2xl border border-slate-200 dark:border-slate-700">
            <div class="p-5 sm:p-6 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center shrink-0">
                <div>
        ...
        </div>`,s.style.opacity="0",s.style.display="flex",requestAnimationFrame(()=>{s.style.transition="opacity 0.25s ease",s.style.opacity="1"}),pushModalHistory("restock")};window.closeRestockModal=(e=!1)=>{requestCloseModal("restock",e,()=>{const t=document.getElementById("restock-modal");!t||t.style.display==="none"||(t.style.opacity="0",t.style.transition="opacity 0.25s ease",setTimeout(()=>{t.style.display="none",t.style.opacity="",t.style.transition=""},250))})};window.processRestock=async e=>{if(z)return;z=!0;const t=n.products.findIndex(i=>i.id===e);if(t<0){z=!1;return}const a=n.products[t],o=a.variants&&a.variants.length>0;let s=JSON.parse(JSON.stringify(a)),r=0;if(o)s.variants=s.variants.map((l,d)=>{const p=parseFloat(document.getElementById("restock-var-"+d)?.value)||0;return p>0&&(l.stock=(parseFloat(l.stock)||0)+p,r+=p,l.stock>0&&(l.isActive===!1||l.isActive==="false")&&(l.isActive=!0)),l}),s.variants.some(l=>(parseFloat(l.stock)||0)>0&&l.isActive!==!1&&l.isActive!=="false")&&(s.isActive===!1||s.isActive==="false")&&(s.isActive="true");else{const i=parseFloat(document.getElementById("restock-main")?.value)||0;i>0&&(s.stock=(parseFloat(s.stock)||0)+i,r+=i,s.stock>0&&(s.isActive===!1||s.isActive==="false")&&(s.isActive="true"))}if(r<=0)return z=!1,b("Masukkan jumlah restock terlebih dahulu!");U("Menyimpan Restock...");try{const i=typeof $<"u"&&$?$:window.db,l=typeof ie=="function"?ie:window.saveApp||(async()=>{});if(!i)throw new Error("Database Firebase belum terhubung");const d=i.collection("freshmart").doc("cms_data").collection("products").doc(e.toString());let p=0;await i.runTransaction(async f=>{const g=await f.get(d);if(!g.exists)throw new Error("Produk tidak ditemukan di server");const u=JSON.parse(JSON.stringify(g.data()));if(o)a.variants.forEach((v,h)=>{const S=parseFloat(document.getElementById("restock-var-"+h)?.value)||0;if(S<=0)return;const C=(u.variants||[]).findIndex(T=>T.name===v.name);C>-1&&(u.variants[C].stock=(parseFloat(u.variants[C].stock)||0)+S,u.variants[C].stock>0&&(u.variants[C].isActive===!1||u.variants[C].isActive==="false")&&(u.variants[C].isActive=!0))}),u.variants.some(v=>(parseFloat(v.stock)||0)>0&&v.isActive!==!1&&v.isActive!=="false")&&(u.isActive===!1||u.isActive==="false")&&(u.isActive="true"),p=u.variants.reduce((v,h)=>v+(parseFloat(h.stock)||0),0);else{const w=parseFloat(document.getElementById("restock-main")?.value)||0;u.stock=(parseFloat(u.stock)||0)+w,u.stock>0&&(u.isActive===!1||u.isActive==="false")&&(u.isActive="true"),p=u.stock}f.set(d,u),Object.assign(s,u)}),n.products[t]=s,await l([],{updateType:"stock_change",updatedProductIds:[e.toString()]}),closeRestockModal(),rAdmItms("products"),H("stat-products",n.products.filter(f=>f.isActive!=="false"&&f.isActive!==!1).length),b(`✅ Restock +${r} berhasil! Total stok: ${p}`)}catch(i){b("Gagal restock: "+(i.message||""))}finally{z=!1,D()}};window.closeAdminModal=(e=!1)=>{requestCloseModal("admin",e,()=>{m("admin-modal").classList.add("opacity-0"),m("admin-modal-box").classList.add("scale-95"),setTimeout(()=>k("admin-modal"),300)})};let xt=[];window.openQuickPriceModal=e=>{const t=n.products.find(r=>r.id===e);if(!t)return;const a=t.variants&&t.variants.length>0;xt=!a&&t.wholesale?JSON.parse(JSON.stringify(t.wholesale)):[];let o="";a?o=t.variants.map((r,i)=>`
            <div class="bg-slate-50 dark:bg-slate-900/50 p-4 rounded-[1.25rem] border border-slate-200 dark:border-slate-700 space-y-3">
                <div class="flex items-center gap-2.5 min-w-0">
                    ${r.colorCode?`<span class="w-4 h-4 rounded-full shrink-0 shadow-sm border border-slate-300" style="background-color:${c(r.colorCode)}"></span>`:""}
                    <p class="text-xs font-bold text-slate-800 dark:text-white truncate">${c(r.name)}</p>
                </div>
                <div class="grid grid-cols-4 gap-2.5">
                    <div><label class="block text-[9px] font-bold text-amber-500 mb-1 uppercase tracking-widest">HPP</label><input type="number" id="qp-var-hpp-${i}" value="${r.hpp||0}" class="admin-input !py-2.5 !px-2.5 text-xs text-center bg-white dark:bg-slate-800"></i></div>
                    <div><label class="block text-[9px] font-bold text-emerald-500 mb-1 uppercase tracking-widest">Jual</label><input type="number" id="qp-var-price-${i}" value="${r.price||0}" class="admin-input !py-2.5 !px-2.5 text-xs text-center bg-white dark:bg-slate-800"></i></div>
                    <div><label class="block text-[9px] font-bold text-slate-400 mb-1 uppercase tracking-widest">Coret</label><input type="number" id="qp-var-normal-${i}" value="${r.priceNormal||0}" class="admin-input !py-2.5 !px-2.5 text-xs text-center bg-white dark:bg-slate-800"></i></div>
                    <div><label class="block text-[9px] font-bold text-violet-500 mb-1 uppercase tracking-widest"><i class="fa-solid fa-star"></i> Poin</label><input type="number" min="0" id="qp-var-poin-${i}" value="${r.poin||0}" class="admin-input !py-2.5 !px-2.5 text-xs text-center bg-white dark:bg-slate-800"></i></div>
                </div>
            </div>`).join(""):o=`
            <div class="grid grid-cols-4 gap-2.5">
            ...
            </div>`;let s=document.getElementById("quickprice-modal");s||(s=document.createElement("div"),s.id="quickprice-modal",s.className="fixed inset-0 z-[110] bg-slate-900/70 backdrop-blur-sm flex items-end sm:items-center justify-center p-0 sm:p-5",s.onclick=r=>{r.target===s&&closeQuickPriceModal()},document.body.appendChild(s)),s.innerHTML=`
        <div class="bg-white dark:bg-slate-900 w-full max-w-lg rounded-t-[2rem] sm:rounded-[2rem] max-h-[85vh] flex flex-col shadow-2xl border border-slate-200 dark:border-slate-700">
            <div class="p-5 sm:p-6 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center shrink-0">
                <div>
        ...
        </div>`,a||rQpWhol(),s.style.opacity="0",s.style.display="flex",requestAnimationFrame(()=>{s.style.transition="opacity 0.25s ease",s.style.opacity="1"}),pushModalHistory("quickprice")};window.rQpWhol=()=>{A("qp-whol-container",xt.length?xt.map((e,t)=>`
        <div class="flex items-center gap-2">
        ...
        </div>`).join(""):'<p class="text-[11px] font-bold text-slate-400 text-center py-2">Belum ada tingkat harga grosir.</p>')};window.qpAddWhol=()=>{xt.push({minQty:0,price:0}),rQpWhol()};window.closeQuickPriceModal=(e=!1)=>{requestCloseModal("quickprice",e,()=>{const t=document.getElementById("quickprice-modal");!t||t.style.display==="none"||(t.style.opacity="0",t.style.transition="opacity 0.25s ease",setTimeout(()=>{t.style.display="none",t.style.opacity="",t.style.transition=""},250))})};window.processQuickPrice=async e=>{if(z)return;z=!0;const t=n.products.findIndex(s=>s.id===e);if(t<0){z=!1;return}const a=n.products[t],o=a.variants&&a.variants.length>0;U("Menyimpan Harga...");try{const s=typeof $<"u"&&$?$:window.db,r=typeof ie=="function"?ie:window.saveApp||(async()=>{});if(!s)throw new Error("Database Firebase belum terhubung");const i=s.collection("freshmart").doc("cms_data").collection("products").doc(e.toString());let l=null;await s.runTransaction(async d=>{const p=await d.get(i);if(!p.exists)throw new Error("Produk tidak ditemukan di server");const f=JSON.parse(JSON.stringify(p.data()));o?a.variants.forEach((g,u)=>{const w=(f.variants||[]).findIndex(T=>T.name===g.name);if(w<0)return;const v=parseFloat(document.getElementById("qp-var-hpp-"+u)?.value)||0,h=parseFloat(document.getElementById("qp-var-price-"+u)?.value)||0,S=parseFloat(document.getElementById("qp-var-normal-"+u)?.value)||0,C=parseFloat(document.getElementById("qp-var-poin-"+u)?.value)||0;f.variants[w].hpp=v,f.variants[w].price=h,f.variants[w].priceNormal=S,f.variants[w].poin=C}):(f.hpp=parseFloat(document.getElementById("qp-hpp")?.value)||0,f.price=parseFloat(document.getElementById("qp-price")?.value)||0,f.priceNormal=parseFloat(document.getElementById("qp-normal")?.value)||0,f.poin=parseFloat(document.getElementById("qp-poin")?.value)||0,f.wholesale=xt.filter(g=>parseFloat(g.minQty)>.01&&g.price>0)),d.set(i,f),l=f}),n.products[t]=l,await r([],{updateType:"stock_change",updatedProductIds:[e.toString()]}),closeQuickPriceModal(),rAdmItms("products"),b("✅ Harga berhasil diperbarui!")}catch(s){b("Gagal simpan harga: "+(s.message||""))}finally{z=!1,D()}};let ne;window.openCameraScanner=async(e="search-input")=>{const t=m("scanner-modal");t&&t.classList.contains("hidden")&&pushModalHistory("scanner"),j("scanner-modal"),setTimeout(()=>{m("scanner-modal").classList.remove("opacity-0")},10);try{await Ss("https://cdnjs.cloudflare.com/ajax/libs/html5-qrcode/2.3.8/html5-qrcode.min.js",()=>typeof Html5Qrcode<"u")}catch{b("Gagal memuat modul kamera. Cek koneksi internet Anda."),closeCameraScanner();return}ne||(ne=new Html5Qrcode("reader"));const a={fps:10,qrbox:{width:250,height:250}};setTimeout(()=>{ne&&ne.start({facingMode:"environment"},a,o=>{let s=m(e);s&&(s.value=o,e==="search-input"?handleSearch(o):(s.dispatchEvent(new Event("input",{bubbles:!0})),s.dispatchEvent(new Event("change",{bubbles:!0})))),b("Barcode discan!"),closeCameraScanner()},o=>{}).catch(o=>{b("Akses kamera ditolak/gagal!"),closeCameraScanner()})},100)};window.closeCameraScanner=(e=!1)=>{requestCloseModal("scanner",e,()=>{if(m("scanner-modal").classList.add("opacity-0"),ne)try{ne.getState()===2||ne.getState()===3?ne.stop().then(()=>{ne.clear(),ne=null}).catch(t=>{ne.clear(),ne=null}):(ne.clear(),ne=null)}catch{ne=null}setTimeout(()=>k("scanner-modal"),300)})};window.toggleProductStatus=async(e,t)=>{if(z)return;z=!0;const a=n.products.findIndex(o=>o.id===e);if(a>-1){n.products[a].isActive=t?"true":"false",U(t?"Mengaktifkan...":"Menonaktifkan...");try{const o=typeof $<"u"&&$?$:window.db,s=typeof ie=="function"?ie:window.saveApp||(async()=>{});if(!o)throw new Error("Database Firebase belum terhubung");await o.collection("freshmart").doc("cms_data").collection("products").doc(e.toString()).update({isActive:t?"true":"false"}),await s([],{updateType:"stock_change",updatedProductIds:[e.toString()]}),H("stat-products",n.products.filter(r=>r.isActive!=="false"&&r.isActive!==!1).length),b(t?"Produk Aktif!":"Stok Dikosongkan!")}catch(o){b("Gagal update status: "+(o.message||""))}finally{z=!1,D()}}};const ii=(e,t=!1)=>{const a=document.querySelector("#view-admin .scroll-content");if(a&&(a.scrollTop=0),!t){const s=history.state;s&&s.view==="view-admin"&&s.tab?history.replaceState({view:"view-admin",tab:e},"",window.location.href):history.pushState({view:"view-admin",tab:e},"",window.location.href)}if(k("admin-dashboard-view"),j("admin-content-view"),j("btn-admin-back"),k("admin-logo-box"),H("admin-header-title",{orders:"Pesanan",settings:"Toko",products:"Produk",categories:"Kategori",brands:"Merek",banks:"Rekening",banners:"Banner",vouchers:"Voucher",customers:"Database Pelanggan",rewards:"Program Hadiah",reviews:"Ulasan Pelanggan",faqs:"Tanya Jawab / Q&A",tax:"Pajak & Keuangan",piutang:"Piutang Tempo",colors:"Database Warna"}[e]||"CMS"),e!=="orders"&&Oe&&(Oe(),ft(null)),e!=="customers"&&_e&&(_e(),pt(null)),e!=="reviews"&&Re&&(Re(),mt(null)),e==="settings")typeof window.rAdmSet=="function"&&window.rAdmSet();else if(e==="orders")typeof window.rAdmOrd=="function"&&window.rAdmOrd();else if(e==="tax")typeof window.rTaxPanel=="function"&&window.rTaxPanel();else if(e==="piutang")typeof window.rAdmPiutang=="function"&&window.rAdmPiutang();else if(e==="customers"){A("admin-content",'<div class="text-center py-16"><i class="fa-solid fa-spinner fa-spin text-3xl text-slate-300"></i></div>'),_e&&(_e(),pt(null));const s=$.collection("freshmart").doc("cms_data").collection("customers").onSnapshot(r=>{n.customers=r.docs.map(i=>i.data()),typeof window.rAdmL=="function"&&window.rAdmL("customers")},()=>{b("Gagal memuat data pelanggan!"),typeof window.rAdmL=="function"&&window.rAdmL("customers")});pt(s)}else if(e==="reviews"){A("admin-content",'<div class="text-center py-16"><i class="fa-solid fa-spinner fa-spin text-3xl text-slate-300"></i></div>'),Re&&(Re(),mt(null));const s=$.collection("freshmart").doc("cms_data").collection("reviews").onSnapshot(r=>{const i=r.docs.map(l=>l.data());i.sort((l,d)=>{const p=l.createdAt&&l.createdAt.toMillis?l.createdAt.toMillis():0;return(d.createdAt&&d.createdAt.toMillis?d.createdAt.toMillis():0)-p}),xo(i),typeof window.rAdmReviews=="function"&&window.rAdmReviews()},()=>{b("Gagal memuat ulasan!")});mt(s)}else e==="faqs"?typeof window.rAdmFAQ=="function"&&window.rAdmFAQ():typeof window.rAdmL=="function"&&window.rAdmL(e)};window.openAdminTab=ii;let Na=null;const Pa=()=>{if(!Na)try{Na=$.collection("freshmart").doc("cms_data").collection("faqs").onSnapshot(e=>{e&&e.docs&&(n.faqs=e.docs.map(t=>({id:t.id,...t.data()}))),typeof window.curViewName<"u"&&window.curViewName==="view-faq"&&rt(),window.isAdm&&typeof window.cTab<"u"&&window.cTab==="faqs"&&typeof window.rAdmFAQ=="function"&&window.rAdmFAQ()},e=>{console.warn("Sync sub-koleksi faqs dibatasi, menggunakan fallback cms_data.faqs:",e.message),typeof window.curViewName<"u"&&window.curViewName==="view-faq"&&rt(),window.isAdm&&typeof window.cTab<"u"&&window.cTab==="faqs"&&typeof window.rAdmFAQ=="function"&&window.rAdmFAQ()})}catch{console.warn("Fallback sync Q&A dari cms_data aktif")}};let $t="Semua";const rt=()=>{Pa();const e=document.getElementById("storefront-faq-container"),t=document.getElementById("faq-category-pills");if(!e)return;const a=(n.faqs||[]).filter(i=>i.status==="published"),o=["Semua","Pemesanan","Pengiriman","Pembayaran","Garansi","Lainnya"];t&&(t.innerHTML=o.map(i=>`
            <button onclick="selectFAQCategory('${i}')" class="px-3.5 py-1.5 rounded-xl text-xs font-bold transition-all whitespace-nowrap ${$t===i?"primary-bg text-white shadow-md":"bg-white dark:bg-slate-800 text-slate-600 dark:text-slate-300 border border-slate-200 dark:border-slate-700 hover:bg-slate-100"}">
                ${i}
            </button>
        `).join(""));const s=(document.getElementById("faq-search-input")?.value||"").toLowerCase().trim(),r=a.filter(i=>{const l=$t==="Semua"||i.category===$t,d=!s||(i.question||"").toLowerCase().includes(s)||(i.answer||"").toLowerCase().includes(s);return l&&d});if(!r.length){e.innerHTML=`
    ...
    `).join("")},li=e=>{$t=e,rt()},ni=()=>{rt()},di=e=>{const t=document.getElementById(`faq-body-${e}`),a=document.getElementById(`faq-icon-${e}`);if(!t||!a)return;t.classList.contains("hidden")?(t.classList.remove("hidden"),a.classList.add("rotate-180")):(t.classList.add("hidden"),a.classList.remove("rotate-180"))},ci=()=>{const e=m("modal-ask-question");e&&(e.classList.contains("hidden")&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("askQuestion"),j("modal-ask-question"),setTimeout(()=>{m("modal-ask-question")&&m("modal-ask-question").classList.remove("opacity-0"),m("modal-ask-question-box")&&m("modal-ask-question-box").classList.remove("translate-y-full")},10))},Hs=(e=!1)=>{const t=()=>{m("modal-ask-question")&&m("modal-ask-question").classList.add("opacity-0"),m("modal-ask-question-box")&&m("modal-ask-question-box").classList.add("translate-y-full"),setTimeout(()=>k("modal-ask-question"),300)};typeof window.requestCloseModal=="function"?window.requestCloseModal("askQuestion",e,t):t()},pi=async()=>{const e=(L("ask-author-name")||"").trim()||"Pelanggan",t=L("ask-category")||"Pemesanan",a=(L("ask-question-text")||"").trim();if(!a)return b("Tuliskan pertanyaan Anda terlebih dahulu!");U("Mengirim pertanyaan...");const o="faq-"+Date.now().toString(36),s={id:o,question:a,answer:"",category:t,authorName:e,status:"pending_answer",createdAt:new Date().toISOString()};let r=!1;try{await $.collection("freshmart").doc("cms_data").collection("faqs").doc(o).set(s),r=!0}catch(i){console.warn("Penulisan sub-koleksi faqs dibatasi, mencoba fallback cms_data.faqs:",i)}if(!r)try{const i=[s,...(n.faqs||[]).filter(l=>l.id!==o)];await $.collection("freshmart").doc("cms_data").set({faqs:i},{merge:!0}),n.faqs=i,r=!0}catch(i){console.warn("Fallback cms_data.faqs juga gagal:",i)}D(),r?(Hs(),se("ask-question-text",""),b("Pertanyaan terkirim! Admin akan menjawabnya segera."),rt()):b("Gagal mengirim pertanyaan. Coba lagi!")};let at="all";const qt=()=>{Pa();const e=n.faqs||[],t=e.filter(s=>at==="pending"?s.status==="pending_answer":at==="published"?s.status==="published":!0),a=e.filter(s=>s.status==="pending_answer").length;let o=`
        <div class="space-y-5 pb-12">
            ...
            <div class="flex items-center gap-2 overflow-x-auto pb-1.5 hide-scrollbar border-b border-slate-200 dark:border-slate-700">
                <button onclick="setAdminFAQFilter('all')" class="shrink-0 px-3.5 py-2 rounded-xl text-xs font-bold transition-all ${at==="all"?"primary-bg text-white shadow-md":"bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 hover:bg-slate-200"}">
                    Semua (${e.length})
                </button>
                <button onclick="setAdminFAQFilter('pending')" class="shrink-0 px-3.5 py-2 rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 ${at==="pending"?"primary-bg text-white shadow-md":"bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 hover:bg-slate-200"}">
                    <span>Belum Dijawab</span>
                    ${a>0?`<span class="bg-rose-500 text-white text-[9px] px-1.5 py-0.5 rounded-full font-bold">${a}</span>`:""}
                </button>
                <button onclick="setAdminFAQFilter('published')" class="shrink-0 px-3.5 py-2 rounded-xl text-xs font-bold transition-all ${at==="published"?"primary-bg text-white shadow-md":"bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 hover:bg-slate-200"}">
                    Terpublikasi
                </button>
            </div>
    ...
    `;setH("admin-content",o)},mi=e=>{at=e,qt()},ui=e=>{const t=(n.faqs||[]).find(o=>o.id===e)||{id:"",question:"",answer:"",category:"Pemesanan",authorName:"Admin",status:"published"};se("admin-faq-id",t.id),se("admin-faq-category",t.category||"Pemesanan"),se("admin-faq-author",t.authorName||"Admin"),se("admin-faq-question",t.question||""),se("admin-faq-answer",t.answer||""),se("admin-faq-status",t.status||"published"),H("admin-faq-modal-title",e?"Edit Q&A":"Tambah Q&A Baru");const a=m("modal-admin-faq");a&&(a.classList.contains("hidden")&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("adminFAQ"),j("modal-admin-faq"),setTimeout(()=>{m("modal-admin-faq")&&m("modal-admin-faq").classList.remove("opacity-0"),m("modal-admin-faq-box")&&m("modal-admin-faq-box").classList.remove("translate-y-full")},10))},Vs=(e=!1)=>{const t=()=>{m("modal-admin-faq")&&m("modal-admin-faq").classList.add("opacity-0"),m("modal-admin-faq-box")&&m("modal-admin-faq-box").classList.add("translate-y-full"),setTimeout(()=>k("modal-admin-faq"),300)};typeof window.requestCloseModal=="function"?window.requestCloseModal("adminFAQ",e,t):t()},fi=async()=>{const e=L("admin-faq-id")||"faq-"+Date.now().toString(36),t=L("admin-faq-category"),a=(L("admin-faq-author")||"").trim()||"Admin",o=(L("admin-faq-question")||"").trim(),s=(L("admin-faq-answer")||"").trim();let r=L("admin-faq-status");if(!o)return b("Pertanyaan tidak boleh kosong!");s&&r==="pending_answer"&&(r="published"),U("Menyimpan Q&A...");const i={id:e,question:o,answer:s,category:t,authorName:a,status:r,updatedAt:new Date().toISOString()};let l=[...n.faqs||[]];const d=l.findIndex(p=>p.id===e);d>-1?l[d]={...l[d],...i}:l.unshift(i),n.faqs=l;try{await $.collection("freshmart").doc("cms_data").collection("faqs").doc(e).set(i,{merge:!0})}catch(p){console.warn("Gagal set ke sub-koleksi faqs:",p)}try{await $.collection("freshmart").doc("cms_data").set({faqs:l},{merge:!0})}catch(p){console.warn("Gagal update cms_data.faqs:",p)}D(),Vs(),b("Q&A Berhasil Disimpan!"),qt()},bi=e=>{De("Hapus Q&A","Yakin ingin menghapus pertanyaan ini?",async()=>{U("Menghapus Q&A...");let t=(n.faqs||[]).filter(a=>a.id!==e);n.faqs=t;try{await $.collection("freshmart").doc("cms_data").collection("faqs").doc(e).delete()}catch(a){console.warn("Gagal delete dari sub-koleksi faqs:",a)}try{await $.collection("freshmart").doc("cms_data").set({faqs:t},{merge:!0})}catch(a){console.warn("Gagal update cms_data.faqs:",a)}D(),b("Q&A Berhasil Dihapus!"),qt()})};window.attachFAQRealtime=Pa;window.renderStorefrontFAQ=rt;window.selectFAQCategory=li;window.filterStorefrontFAQ=ni;window.toggleFAQAccordion=di;window.openAskQuestionModal=ci;window.closeAskQuestionModal=Hs;window.submitCustomerQuestion=pi;window.rAdmFAQ=qt;window.setAdminFAQFilter=mi;window.openFAQModal=ui;window.closeAdminFAQModal=Vs;window.saveAdminFAQ=fi;window.deleteAdminFAQ=bi;const Ut="B7qgwFQqtYLpBqdaK69HgtCfR7s5t67p",gi=20*1024*1024,xi=["video/mp4","video/webm","video/quicktime","video/x-msvideo","video/3gpp"],Gs=["image/jpeg","image/png","image/webp","image/gif"],wi=async(e,t,a=null)=>{const o=e.files[0];if(!o)return;if(!Gs.includes(o.type))return e.value="",b("Hanya file JPG, PNG, WEBP, atau GIF yang diizinkan!");if(o.size>3*1024*1024)return e.value="",b("Maksimal gambar 3MB!");const s=window.GAS_UPLOAD_URL||Et;if(s.includes("ISI_DENGAN"))return e.value="",b("URL Script Google belum diisi!");U("Upload Gambar...");const r=new FileReader;r.readAsDataURL(o),r.onload=async()=>{try{const i=r.result.split(",")[1],l=o.name.replace(/[^a-zA-Z0-9.]/g,"_"),d={name:"POS_"+Date.now()+"_"+l,mimeType:o.type,data:i,token:Ut},f=await(await fetch(s,{method:"POST",body:JSON.stringify(d),headers:{"Content-Type":"text/plain;charset=utf-8"},redirect:"follow"})).text();let g;try{g=JSON.parse(f)}catch{return b("Error Server!")}if(g.status==="success"){const u=W(g.url),w=m(t);w&&(w.value=u,w.dispatchEvent(new Event("input",{bubbles:!0})),w.dispatchEvent(new Event("change",{bubbles:!0})),a!==null&&typeof window.uVar=="function"&&window.uVar(a,"img",u),b("Gambar diupload!"))}else b("Gagal: "+(g.message||"Error"))}catch{b("Koneksi terputus saat upload.")}finally{D(),e.value=""}},r.onerror=()=>{b("Gagal membaca file!"),D(),e.value=""}},hi=async(e,t)=>{const a=e.files[0];if(!a)return;if(!xi.includes(a.type))return e.value="",b("Hanya file MP4, WEBM, MOV, atau AVI yang diizinkan!");if(a.size>gi)return e.value="",b("Video terlalu besar! Maksimal 20MB.");const o=window.GAS_UPLOAD_URL||Et;if(o.includes("ISI_DENGAN"))return e.value="",b("URL Script Google belum diisi di Pengaturan!");U("Upload Video... (harap tunggu)");const s=new FileReader;s.readAsDataURL(a),s.onload=async()=>{try{const r=s.result.split(",")[1],i=a.name.replace(/[^a-zA-Z0-9.]/g,"_"),l={name:"VID_"+Date.now()+"_"+i,mimeType:a.type,data:r,token:Ut},p=await(await fetch(o,{method:"POST",body:JSON.stringify(l),headers:{"Content-Type":"text/plain;charset=utf-8"},redirect:"follow"})).text();let f;try{f=JSON.parse(p)}catch{return b("Error Server GAS!")}if(f.status==="success"){const g="https://drive.google.com/file/d/"+f.fileId+"/preview",u=m(t);u&&(u.value=g,u.dispatchEvent(new Event("input",{bubbles:!0})),u.dispatchEvent(new Event("change",{bubbles:!0})),b("Video berhasil diupload ke Drive!"))}else b("Gagal upload: "+(f.message||"Error"))}catch{b("Koneksi terputus saat upload video.")}finally{D(),e.value=""}},s.onerror=()=>{b("Gagal membaca file video!"),D(),e.value=""}},vi=async(e,t)=>{const a=e.files[0];if(!a)return;if(!Gs.includes(a.type))return e.value="",b("Hanya file JPG, PNG, WEBP, atau GIF yang diizinkan!");if(a.size>3*1024*1024)return e.value="",b("Maksimal gambar 3MB!");const o=window.GAS_UPLOAD_URL||Et;if(o.includes("ISI_DENGAN"))return e.value="",b("URL Script Google belum diisi!");U("Menyisipkan Gambar...");const s=new FileReader;s.readAsDataURL(a),s.onload=async()=>{try{const r=s.result.split(",")[1],i=a.name.replace(/[^a-zA-Z0-9.]/g,"_"),l={name:"RTE_"+Date.now()+"_"+i,mimeType:a.type,data:r,token:Ut},p=await(await fetch(o,{method:"POST",body:JSON.stringify(l),headers:{"Content-Type":"text/plain;charset=utf-8"},redirect:"follow"})).text();let f;try{f=JSON.parse(p)}catch{return b("Error Server!")}if(f.status==="success"){const g=W(f.url),u=m(t);u&&(u.focus(),document.execCommand("insertHTML",!1,`<br><img loading="lazy" src="${g}" style="max-width:100%; border-radius:12px; margin: 10px 0; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1);" ><br>`)),b("Gambar berhasil disisipkan!")}else b("Gagal upload gambar.")}catch{b("Gagal koneksi.")}finally{D(),e.value=""}},s.onerror=()=>{b("Gagal membaca file!"),D(),e.value=""}};window.GAS_SECRET_TOKEN=Ut;window.handleImageUpload=wi;window.handleVideoUpload=hi;window.handleRTEditorImage=vi;let Ba={},We="view-catalog";const Ta=e=>{history.pushState({modal:e},"",window.location.href),ve.push(e)},Aa=(e,t,a)=>{if(!t){const o=ve.lastIndexOf(e);if(o>-1){ve.splice(o,1);try{history.back()}catch{}}}a()},ut=(e,t=!1)=>{t||history.pushState({view:e},"",window.location.href);const a=m(We);if(a){const s=a.querySelector(".scroll-content");s&&(Ba[We]=s.scrollTop)}We==="view-orders"&&e!=="view-orders"&&typeof window.detachMyOrdersRealtime=="function"&&window.detachMyOrdersRealtime(),document.querySelectorAll(".view-section").forEach(s=>{s.classList.add("hidden"),s.classList.remove("flex")});const o=m(e);if(o){o.classList.remove("hidden"),o.classList.add("flex"),e==="view-cart"&&typeof window.renderCart=="function"?window.renderCart():e==="view-checkout"&&typeof window.rChck=="function"?window.rChck():e==="view-payment"&&typeof window.rPay=="function"?window.rPay():e==="view-wishlist"&&typeof window.renderWish=="function"?window.renderWish():e==="view-orders"&&typeof window.renderMyOrders=="function"?window.renderMyOrders():e==="view-faq"&&typeof window.renderStorefrontFAQ=="function"&&window.renderStorefrontFAQ();const s=o.querySelector(".scroll-content");if(s)if(t){const r=Ba[e]||0;requestAnimationFrame(()=>requestAnimationFrame(()=>{s.scrollTop=r}))}else s.scrollTo(0,0)}We=e},Ks=()=>{window.addEventListener("popstate",e=>{if(ve.length){const t=ve.pop();t==="product"&&typeof window.closeProductModal=="function"?window.closeProductModal(!0):t==="category"&&typeof window.closeCategoryModal=="function"?window.closeCategoryModal(!0):t==="brand"&&typeof window.closeBrandModal=="function"?window.closeBrandModal(!0):t==="admin"&&typeof window.closeAdminModal=="function"?window.closeAdminModal(!0):t==="adminOrder"&&typeof window.closeOrderDetailModal=="function"?window.closeOrderDetailModal(!0):t==="receipt"&&typeof window.closeReceiptPreviewModal=="function"?window.closeReceiptPreviewModal(!0):t==="docPreview"&&typeof window.closeDocPreviewModal=="function"?window.closeDocPreviewModal(!0):t==="scanner"&&typeof window.closeCameraScanner=="function"?window.closeCameraScanner(!0):t==="confirm"&&typeof window.closeConfirm=="function"?window.closeConfirm(!0):t==="customerOrder"&&typeof window.closeCustomerOrderDetailModal=="function"?window.closeCustomerOrderDetailModal(!0):t==="restock"&&typeof window.closeRestockModal=="function"?window.closeRestockModal(!0):t==="quickprice"&&typeof window.closeQuickPriceModal=="function"?window.closeQuickPriceModal(!0):t==="member"&&typeof window.closeMemberModal=="function"?window.closeMemberModal(!0):t==="prompt"&&typeof window.closePrompt=="function"?window.closePrompt(!0):t==="review"&&typeof window.closeReviewModal=="function"?window.closeReviewModal(!0):t==="quickmenu"&&typeof window.closeQuickMenuModal=="function"?window.closeQuickMenuModal(!0):t==="variantPreview"&&typeof window.closeVariantPreviewModal=="function"?window.closeVariantPreviewModal(!0):t==="terms"&&typeof window.closeTermsModal=="function"?window.closeTermsModal(!0):t==="privacy"&&typeof window.closePrivacyModal=="function"?window.closePrivacyModal(!0):t==="askQuestion"&&typeof window.closeAskQuestionModal=="function"?window.closeAskQuestionModal(!0):t==="adminFAQ"&&typeof window.closeAdminFAQModal=="function"&&window.closeAdminFAQModal(!0)}else{const t=e.state||{},a=t.view||null;if(window.isAdm||window.__localIsAdm)a==="view-admin"?(ut("view-admin",!0),t.tab&&typeof window.openAdminTab=="function"?window.openAdminTab(t.tab,!0):typeof window.openAdminMenu=="function"&&window.openAdminMenu()):(history.pushState({view:"view-admin"},"",window.location.href),typeof window.showConfirm=="function"&&window.showConfirm("Keluar Seller","Apakah anda akan keluar dari dashboard seller?",()=>{typeof window.logoutAdmin=="function"&&window.logoutAdmin()},"Ya, Keluar",!0));else if(a){let s=a;a==="view-admin"&&(s="view-admin-login"),ut(s,!0)}else ut("view-catalog",!0)}})};window.pushModalHistory=Ta;window.requestCloseModal=Aa;window.changeView=ut;window.setupHistoryRouter=Ks;try{Object.defineProperty(window,"curViewName",{get:()=>We,set:e=>{We=e},configurable:!0})}catch{}window.setCat=e=>{la(e),Ce(1),typeof window.rCat=="function"&&window.rCat()};window.setBrand=e=>{na(e),Ce(1),typeof window.rCat=="function"&&window.rCat()};window.openBrandModal=()=>{let e="",t=ke==="Semua Merek";e+=`
    ...
    </button>`,n.brands.forEach(r=>{let i=ke===r.name,l=r.img?`<img loading="lazy" src="${c(r.img)}" alt="${c(r.name)}" class="w-full h-full object-contain p-1.5" >`:'<i class="fa-solid fa-tag text-lg sm:text-xl"></i>';e+=`
        <button onclick="setBrand('${c(r.name)}'); closeBrandModal()" class="flex flex-col items-center justify-start p-2.5 sm:p-3.5 rounded-[1.25rem] border transition-all ${i?"bg-[rgba(var(--color-primary-rgb),0.08)] border-[var(--color-primary)] dark:bg-[rgba(var(--color-primary-rgb),0.12)] dark:border-[var(--color-primary)] shadow-[0_0_0_1px_rgba(var(--color-primary-rgb),0.2)]":"bg-slate-50 border-slate-200 dark:bg-slate-800/50 dark:border-slate-700 hover:border-[var(--color-primary)]/40 dark:hover:border-[var(--color-primary)]/40"} group">
    ...
    `;A("privacy-modal-content-body",t.replace(/\n/g,"<br>"));const a=m("privacy-modal"),o=m("privacy-modal-content");a&&o&&(a.classList.contains("hidden")&&pushModalHistory("privacy"),j("privacy-modal"),setTimeout(()=>{a.classList.remove("opacity-0"),o.classList.remove("translate-y-full","sm:translate-y-10")},10))};window.closePrivacyModal=(e=!1)=>{const t=m("privacy-modal"),a=m("privacy-modal-content");t&&a&&requestCloseModal("privacy",e,()=>{t.classList.add("opacity-0"),a.classList.add("translate-y-full","sm:translate-y-10"),setTimeout(()=>k("privacy-modal"),300)})};window.closeQuickMenuModal=(e=!1)=>{const t=m("quickmenu-modal"),a=m("quickmenu-modal-content");t&&a&&requestCloseModal("quickmenu",e,()=>{t.classList.add("opacity-0"),a.classList.add("translate-y-full","sm:translate-y-10"),setTimeout(()=>k("quickmenu-modal"),300)})};window.navigateFromQuickMenu=e=>{closeQuickMenuModal(!0);const t=ve.indexOf("quickmenu");t>-1&&ve.splice(t,1),typeof e=="function"?(history.replaceState({view:We},"",window.location.href),e()):(history.replaceState({view:e},"",window.location.href),ut(e,!0))};const yi=e=>{const t=n.products?.find(s=>s.id===e.id);let a=e.price||0;if(e.variantName&&t&&t.variants){const s=t.variants.find(r=>r.name===e.variantName);s&&s.price!=null&&(a=s.price)}if(e.variantName||!t||!t.wholesale||!t.wholesale.length)return a;const o=F.filter(s=>s.id===e.id).reduce((s,r)=>s+(parseFloat(r.qty)||0),0);for(let s of t.wholesale.slice().sort((r,i)=>i.minQty-r.minQty))if(o>=parseFloat(s.minQty))return s.price;return a},ki=e=>{const t=n.products?.find(a=>a.id===e.id);if(!t)return 0;if(e.variantName&&t.variants){const a=t.variants.find(o=>o.name===e.variantName);if(a&&a.hpp!=null)return parseFloat(a.hpp)||0}return parseFloat(t.hpp)||0},$i=e=>{if(!e)return 0;const t=n.products?.find(a=>a.id===e.id);if(!t)return parseFloat(e.poin)||0;if(e.variantName&&t.variants){const a=t.variants.find(o=>o.name===e.variantName);if(a&&a.poin!==void 0&&a.poin!==null&&a.poin!==""){const o=parseFloat(a.poin);if(!isNaN(o)&&o>0)return o}}return parseFloat(t.poin)||0},Si=(e,t,a,o)=>{if(!e||!t||!a||!o)return 0;const s=6371,r=(a-e)*Math.PI/180,i=(o-t)*Math.PI/180,l=Math.sin(r/2)*Math.sin(r/2)+Math.cos(e*Math.PI/180)*Math.cos(a*Math.PI/180)*Math.sin(i/2)*Math.sin(i/2),d=2*Math.atan2(Math.sqrt(l),Math.sqrt(1-l));return s*d},Pi=e=>{const a=e.value.trim().split(",");if(a.length>=2){const o=parseFloat(a[0].trim()),s=parseFloat(a[1].trim());if(!isNaN(o)&&!isNaN(s)){se("set-lat",o),se("set-lng",s),b("Koordinat tersalin!");return}}b("Format salah! Coba: Lat, Lng")};window.getEffP=yi;window.getEffHpp=ki;window.getEffPoin=$i;window.getDist=Si;window.autoParseCoords=Pi;let ea=null,St=null;const Ti=async e=>{try{if(navigator.clipboard&&navigator.clipboard.writeText)await navigator.clipboard.writeText(e);else{const t=document.createElement("textarea");t.value=e,t.style.position="fixed",t.style.opacity="0",document.body.appendChild(t),t.select(),document.execCommand("copy"),document.body.removeChild(t)}Mt("Kode "+e+" berhasil disalin!")}catch{Mt("Gagal menyalin. Kode: "+e)}},Mt=(e,t,a,o)=>{const s=m("toast");if(!s)return;if(!t){const S=e.toLowerCase();/berhasil|sukses|selamat|✅|🎉|aktif|dikirim|disimpan|diupload|disalin|dipulihkan|login berhasil|restock|terhapus|diunduh|diperbarui/.test(S)?t="success":/gagal|error|tolak|❌|tidak valid|tidak ditemukan|tidak cukup|salah|ditolak|quota|koneksi|putus|izin|wajib/.test(S)?t="error":/tunggu|maks|hati|stok|coba|⚠️|pastikan/.test(S)?t="warning":/upload|proses|memuat|loading|sedang/.test(S)?t="loading":t="info"}const r=getComputedStyle(document.documentElement),i=r.getPropertyValue("--color-primary-rgb").trim()||"16,185,129",l=r.getPropertyValue("--color-primary").trim()||"#10b981",d=r.getPropertyValue("--color-primary-dark").trim()||"#047857",p={success:{icon:"fa-circle-check",label:"Berhasil",accent:l,iconBg:`rgba(${i},0.12)`,border:`rgba(${i},0.35)`},error:{icon:"fa-circle-xmark",label:"Gagal",accent:"#ef4444",iconBg:"rgba(239,68,68,0.12)",border:"rgba(239,68,68,0.35)"},warning:{icon:"fa-triangle-exclamation",label:"Perhatian",accent:"#f59e0b",iconBg:"rgba(245,158,11,0.12)",border:"rgba(245,158,11,0.35)"},loading:{icon:"fa-spinner fa-spin",label:"Memproses",accent:d,iconBg:`rgba(${i},0.12)`,border:`rgba(${i},0.35)`},info:{icon:"fa-circle-info",label:"Informasi",accent:"#3b82f6",iconBg:"rgba(59,130,246,0.12)",border:"rgba(59,130,246,0.35)"}},f=p[t]||p.info,g=m("toast-icon");g&&(g.className="fa-solid "+f.icon);const u=m("toast-title");u&&(u.textContent=a||f.label,u.style.display="block",u.style.color=f.accent);const w=m("toast-icon-wrap");w&&(w.style.background=f.iconBg,w.style.color=f.accent),H("toast-message",e.replace(/^[✅❌⚠️🎉🔔]\s*/,""));let v=m("toast-progress");v||(v=document.createElement("div"),v.id="toast-progress",s.appendChild(v)),v.style.background=f.accent,v.style.transition="none",v.style.width="100%",v.style.opacity="0.7",clearTimeout(ea),s.style.top="calc(max(env(safe-area-inset-top), 16px) + 8px)";const h=o||(t==="loading"?8e3:t==="error"?4500:3e3);requestAnimationFrame(()=>requestAnimationFrame(()=>{v.style.transition=`width ${h}ms linear`,v.style.width="0%"})),ea=setTimeout(()=>{s.style.top="-160px"},h)},Ai=e=>Mt(e,"loading","Memproses...",8e3),Mi=()=>{clearTimeout(ea);const e=m("toast");e&&(e.style.top="-160px")},Di=()=>{const e=document.documentElement.classList.toggle("dark");localStorage.setItem("freshmart_theme",e?"dark":"light");const t=document.getElementById("icon-theme")||document.getElementById("theme-toggle-icon");t&&(t.className=e?"fa-solid fa-sun text-sm text-amber-400":"fa-solid fa-moon text-sm text-slate-600 dark:text-slate-300")},Ci=(e,t,a,o="Ya, Hapus",s=!0)=>{H("confirm-title",e),H("confirm-msg",t);const r=m("confirm-yes-btn");r&&(r.innerText=o,s?(r.className="flex-1 py-3.5 bg-rose-600 text-white font-bold rounded-xl hover:bg-rose-700 active:scale-95 transition-all text-sm shadow-md shadow-rose-500/30",m("confirm-icon-box").className="w-16 h-16 bg-rose-50 dark:bg-rose-900/30 text-rose-500 dark:text-rose-400 rounded-2xl flex items-center justify-center text-3xl mx-auto mb-5 border border-rose-200 dark:border-rose-800",m("confirm-icon").className="fa-solid fa-triangle-exclamation"):(r.className="flex-1 py-3.5 bg-[var(--color-primary)] text-white font-bold rounded-xl hover:opacity-90 active:scale-95 transition-all text-sm shadow-sm",m("confirm-icon-box").className="w-16 h-16 bg-[rgba(var(--color-primary-rgb),0.08)] dark:bg-[rgba(var(--color-primary-rgb),0.15)] text-[var(--color-primary)] rounded-2xl flex items-center justify-center text-3xl mx-auto mb-5 border border-[var(--color-primary)]/20",m("confirm-icon").className="fa-solid fa-copy")),St=a;const i=m("custom-confirm-modal");i&&i.classList.contains("hidden")&&Ta("confirm"),j("custom-confirm-modal"),setTimeout(()=>{m("custom-confirm-modal").classList.remove("opacity-0"),m("custom-confirm-box").classList.remove("scale-95")},10)},Ws=(e=!1)=>{Aa("confirm",e,()=>{m("custom-confirm-modal").classList.add("opacity-0"),m("custom-confirm-box").classList.add("scale-95"),setTimeout(()=>k("custom-confirm-modal"),300)})},Li=()=>{if(St){const e=St;St=null,Ws(),setTimeout(()=>{e()},150)}},Ii=(e,t,a)=>{let o=document.createElement("div");o.className="fixed inset-0 z-[9999] bg-slate-900/80 flex items-center justify-center p-4 backdrop-blur-sm opacity-0 transition-opacity duration-300",o.innerHTML=`
    ...
    `,document.body.appendChild(o);const s=o.querySelector("div");Ta("prompt"),setTimeout(()=>{o.classList.remove("opacity-0"),s.classList.remove("scale-95")},10);const r=o.querySelector("#prompt-input");r.focus(),r.select(),window.closePrompt=(i=!1)=>{!o||!o.parentNode||Aa("prompt",i,()=>{o.classList.add("opacity-0"),s.classList.add("scale-95"),setTimeout(()=>o.remove(),300),window.closePrompt=null})},o.querySelector("#prompt-cancel").onclick=()=>window.closePrompt(),o.querySelector("#prompt-ok").onclick=()=>{let i=r.value;window.closePrompt(),a(i)}},ji=()=>{typeof window.openReceiptPreview=="function"&&window.openReceiptPreview()};window.copyVoucher=Ti;window.showToast=Mt;window.showToastLoading=Ai;window.hideToast=Mi;window.toggleTheme=Di;window.showConfirm=Ci;window.closeConfirm=Ws;window.executeConfirm=Li;window.customPrompt=Ii;window.checkProPrint=ji;Ks();window.firebase=pe;window.db=$;window.DOMPurify=Xs;window.uiPalettes=Qe;window.hexToRgb=ks;window.applyUITheme=wt;window.toggleTheme=ro;window.applyBackgroundStyle=ht;oo();const Ei=localStorage.getItem("freshmart_ui_theme")||"emerald";wt(Ei,localStorage.getItem("freshmart_theme_color"));const Oa=()=>{io();const e=localStorage.getItem("freshmart_bg_style")||"minimalist",t=localStorage.getItem("freshmart_bg_custom_url")||"";ht(e,t),Sa()};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Oa):Oa();window.onerror=function(e,t,a,o,s){return console.error("Global Error Caught:",e,"at",a,":",o),typeof showToast=="function"&&showToast("Ops, ada kendala sistem."),!1};window.addEventListener("unhandledrejection",function(e){console.warn("Promise Rejection Sentinel:",e.reason)});window.updateSEO=lo;window.injectJSONLD=no;window.rewardStatusLabel=It;window.getYouTubeId=Dt;window.parseVideoUrl=Ct;window.fixDriveVideo=Lt;window.fixDriveVideoPreview=$s;let qa=Et;const Qs=me;window.calcTaxDetails=e=>{const t=st.store.ppnEnabled===!0||st.store.ppnEnabled==="true",a=parseFloat(st.store.ppnRate)||11,o=st.store.ppnType||"exclusive";if(!t||e<=0)return{ppnEnabled:!1,ppnRate:0,ppnType:o,ppnAmount:0,dppAmount:Math.max(0,e),grandTotalAdd:0};if(o==="inclusive"){const s=Math.round(e*100/(100+a)),r=e-s;return{ppnEnabled:!0,ppnRate:a,ppnType:"inclusive",ppnAmount:r,dppAmount:s,grandTotalAdd:0}}else{const s=Math.round(e*a/100);return{ppnEnabled:!0,ppnRate:a,ppnType:"exclusive",ppnAmount:s,dppAmount:Math.max(0,e),grandTotalAdd:s}}};typeof requestIdleCallback<"u"?requestIdleCallback(Da,{timeout:5e3}):setTimeout(Da,3e3);let Ua=null,st=JSON.parse(JSON.stringify(Qs));window.updateProBadge=()=>{};let ta=[],aa=[],sa=[],Ha={name:"",address:"",lat:null,lng:null,deliveryMethod:"delivery",distance:0,note:"",wa:""},Va=null,Ga=null,Ka=null,Wa="Semua Produk",Qa="Semua Merek",za="",Ja="newest",Ya="grid",Xa=1,Za=12,es="orders",ts="",as=null;window.isAdm=!1;window.isPro=!0;let ss=null,os=0,rs=[],is=[],ls=[],ns=1,ds=[],cs=null,ps=null,ms=null,us=[],fs=[],bs=null,gs=null,xs,ws=!1,hs=null,vs="all",ys="today";try{ta=JSON.parse(ge("freshmart_cart"))||[]}catch{}try{aa=JSON.parse(ge("freshmart_wishlist"))||[]}catch{}try{sa=JSON.parse(ge("freshmart_my_orders"))||[]}catch{}history.replaceState({view:"view-catalog"},"","");const _i=e=>{e&&H("loader-text",e);const t=m("global-loader");t&&(t.style.display="flex")},Ri=()=>{const e=m("global-loader");e&&(e.style.display="none")},Fi=()=>window.sanitizeCart();window.addEventListener("DOMContentLoaded",async()=>{await loadAppData(),syncAppMeta(),attachRealtimeStockSync(),fe.onAuthStateChanged(async e=>{if(e&&e.uid!==ra){await fe.signOut();return}if(e){window.isAdm=!0,window.isPro=!0,localStorage.removeItem("isFreshmartPro"),localStorage.removeItem("freshmart_license_code"),window.updateProBadge&&window.updateProBadge();let t=document.getElementById("view-admin-login");t&&!t.classList.contains("hidden")&&(history.replaceState({view:"view-admin"},"",window.location.href),changeView("view-admin",!0),openAdminMenu(),showToast("Sesi Dipulihkan! Selamat Datang."))}else window.isAdm=!1,window.isPro=!1,window.updateProBadge&&window.updateProBadge(),localStorage.removeItem("isFreshmartPro"),localStorage.removeItem("freshmart_license_code")})});window.el=m;window.show=j;window.hide=k;window.toggleCls=ee;window.setIn=H;window.setH=A;window.setV=se;window.getV=L;window.esc=c;window.fixD=W;window.fCur=x;window.sL=ge;window.ssL=J;window.defaultFbC=oa;window.fbC=oa;window.defApp=Qs;window.ADMIN_UID=ra;window.sLoad=_i;window.hLoad=Ri;window.sanitizeCart=Fi;const V=(e,t,a)=>{try{Object.defineProperty(window,e,{get:t,set:a,configurable:!0})}catch{}};V("GAS_UPLOAD_URL",()=>qa,e=>{qa=e});V("confirmCb",()=>Ua,e=>{Ua=e});V("appData",()=>st,e=>{st=e});V("cart",()=>ta,e=>{ta=e});V("wishlist",()=>aa,e=>{aa=e});V("myOrders",()=>sa,e=>{sa=e});V("cust",()=>Ha,e=>{Ha=e});V("currentMember",()=>Va,e=>{Va=e});V("selectedReward",()=>Ga,e=>{Ga=e});V("memberCheckTimer",()=>Ka,e=>{Ka=e});V("aCat",()=>Wa,e=>{Wa=e});V("aBrand",()=>Qa,e=>{Qa=e});V("sQ",()=>za,e=>{za=e});V("cSort",()=>Ja,e=>{Ja=e});V("cView",()=>Ya,e=>{Ya=e});V("cPage",()=>Xa,e=>{Xa=e});V("iPP",()=>Za,e=>{Za=e});V("cTab",()=>es,e=>{es=e});V("aSq",()=>ts,e=>{ts=e});V("eId",()=>as,e=>{as=e});V("cProd",()=>ss,e=>{ss=e});V("cVar",()=>os,e=>{os=e});V("tVars",()=>rs,e=>{rs=e});V("tWhol",()=>is,e=>{is=e});V("tSpec",()=>ls,e=>{ls=e});V("cQty",()=>ns,e=>{ns=e});V("oMods",()=>ds,e=>{ds=e});V("aOrdLst",()=>cs,e=>{cs=e});V("aCustLst",()=>ps,e=>{ps=e});V("aRevLst",()=>ms,e=>{ms=e});V("gOrds",()=>us,e=>{us=e});V("gReviews",()=>fs,e=>{fs=e});V("cVOrd",()=>bs,e=>{bs=e});V("vouch",()=>gs,e=>{gs=e});V("toastT",()=>xs,e=>{xs=e});V("isSaving",()=>ws,e=>{ws=e});V("bannerTmr",()=>hs,e=>{hs=e});V("reviewFilterMode",()=>vs,e=>{vs=e});V("lastReportPeriod",()=>ys,e=>{ys=e});
