...
import{d as B,_ as E}from"./module-member-WXMTgvbk.js";import{a as m,e as c,t as h,i as d,b as H,f as le,x as F,u as je}from"./module-print-DoqR8CYY.js";import{f as ee}from"./vendor-firebase-core-D2OF5R23.js";import"./vendor-firebase-db-BIUZcnOd.js";let te=!1;const Le=()=>te?Promise.resolve():E(()=>import("./pos-variant-sheet-D2tC43LA.js"),__vite__mapDeps([0,1])).then(()=>{te=!0});let b=[],D="",j="",M="grid";try{const e=localStorage.getItem("pos_view_mode");(e==="list"||e==="grid")&&(M=e)}catch{}let w={name:"",phone:"",isMember:!1,memberId:null,isNewTempo:!1},f="cash",k=0,L=0,P="",ae=null,U=null;const z=e=>{M=e;try{localStorage.setItem("pos_view_mode",e)}catch{}const t=c("pos-view-btn-grid"),a=c("pos-view-btn-list");t&&a&&(e==="grid"?(t.style.background="var(--color-primary)",t.className="w-8 h-8 rounded-lg flex items-center justify-center text-xs transition-all cursor-pointer text-white shadow-xs",a.style.removeProperty("background"),a.className="w-8 h-8 rounded-lg flex items-center justify-center text-xs transition-all cursor-pointer text-slate-500 hover:text-slate-800 dark:text-slate-400"):(a.style.background="var(--color-primary)",a.className="w-8 h-8 rounded-lg flex items-center justify-center text-xs transition-all cursor-pointer text-white shadow-xs",t.style.removeProperty("background"),t.className="w-8 h-8 rounded-lg flex items-center justify-center text-xs transition-all cursor-pointer text-slate-500 hover:text-slate-800 dark:text-slate-400")),A()},T=e=>Math.max(0,parseInt(e)||0),x=e=>le(e),Q=()=>b.reduce((e,t)=>e+t.subtotal,0),g=()=>Math.max(0,Q()-T(L)),ie=()=>k-g(),O=()=>{try{const e=window.AudioContext||window.webkitAudioContext;if(!e)return;const t=new e,a=t.createOscillator(),o=t.createGain();a.type="sine",a.frequency.setValueAtTime(1400,t.currentTime),o.gain.setValueAtTime(.08,t.currentTime),o.gain.exponentialRampToValueAtTime(1e-4,t.currentTime+.08),a.connect(o),o.connect(t.destination),a.start(),a.stop(t.currentTime+.08),setTimeout(()=>{t.close().catch(()=>{})},150)}catch{}},Ae=(e,t)=>{if(!e||!e.wholesale||!e.wholesale.length)return null;const a=[...e.wholesale].sort((o,r)=>r.minQty-o.minQty);for(const o of a)if(t>=parseFloat(o.minQty))return parseFloat(o.price);return null},C=e=>{if(!e.isVariant){const t=(m.products||[]).find(o=>o&&String(o.id)===String(e.id)),a=t?Ae(t,e.qty):null;a!==null?(e.basePrice=e.basePrice||e.price,e.price=a,e.isWholesale=!0):(e.basePrice&&(e.price=e.basePrice),e.isWholesale=!1)}return e.subtotal=Math.max(0,e.price*e.qty-T(e.discount)),e},De=()=>{const e=new Date,t=a=>String(a).padStart(2,"0");return`POS-${e.getFullYear()}${t(e.getMonth()+1)}${t(e.getDate())}-${Date.now().toString(36).toUpperCase()}`},ne=()=>{U&&clearInterval(U);const e=()=>{const t=c("pos-live-clock");if(!t)return;const a=new Date;t.textContent=a.toLocaleTimeString("id-ID",{hour:"2-digit",minute:"2-digit",second:"2-digit"})+" WIB"};e(),U=setInterval(e,1e3)},V=()=>{window.__posBarcodeFn&&(document.removeEventListener("keydown",window.__posBarcodeFn),window.__posBarcodeFn=null)},de=()=>{V(),window.__posBarcodeFn=e=>{if(!e||typeof e.key!="string")return;const t=window.curViewName||"";if(!(t==="view-pos-cashier"||t==="view-admin"&&window.cTab==="pos"))return;const o=document.activeElement?.tagName?.toLowerCase();if(!(o==="input"||o==="textarea"||o==="select"))if(e.key==="Enter"){if(P&&P.length>=3){const r=P.trim().toLowerCase(),n=(m.products||[]).find(s=>s&&s.isActive!=="false"&&s.isActive!==!1&&(s.barcode&&s.barcode.toLowerCase()===r||s.sku&&s.sku.toLowerCase()===r||s.id&&String(s.id).toLowerCase()===r));if(n)G(n.id),O(),h(`Ditambahkan: ${n.name}`,"success");else{const s=c("pos-search-input");s&&(s.value=P,D=P,A()),h("Barcode tidak ditemukan di katalog","warning")}P=""}}else e.key&&e.key.length===1&&(P=(P||"")+e.key,clearTimeout(ae),ae=setTimeout(()=>{P=""},150))},document.addEventListener("keydown",window.__posBarcodeFn)},G=e=>{const t=(m.products||[]).find(r=>r&&String(r.id)===String(e));if(!t)return;if(t.variants&&t.variants.length>0){Le().then(()=>{typeof window.openPOSVariantSheet=="function"&&window.openPOSVariantSheet(e)});return}const o=b.find(r=>String(r.id)===String(e)&&!r.isVariant);if(o)o.qty+=1,C(o);else{const r=parseFloat(t.price)||0;b.push(C({id:t.id,name:t.name,price:r,basePrice:r,qty:1,discount:0,subtotal:r,isVariant:!1,isWholesale:!1}))}O(),typeof window.triggerHaptic=="function"&&window.triggerHaptic("light"),y()},ce=(e,t)=>{const a=(m.products||[]).find(r=>r&&String(r.id)===String(e));if(!a)return;const o=b.find(r=>String(r.id)===String(e)&&!r.isVariant);if(o)o.qty+=t,C(o);else{const r=parseFloat(a.price)||0,n=C({id:a.id,name:a.name,price:r,basePrice:r,qty:t,discount:0,subtotal:r*t,isVariant:!1,isWholesale:!1});b.push(n)}O(),typeof window.triggerHaptic=="function"&&window.triggerHaptic("light"),y()},pe=(e,t,a,o,r=1)=>{const n=`${e}__v${o}`,s=b.find(l=>l.cartKey===n);if(s)s.qty+=r,C(s);else{const i=`${(m.products||[]).find(p=>p&&String(p.id)===String(e))?.name||e} — ${t}`;b.push(C({id:e,cartKey:n,name:i,variantName:t,variantIdx:o,price:a,basePrice:a,qty:r,discount:0,subtotal:a*r,isVariant:!0,isWholesale:!1}))}O(),typeof window.triggerHaptic=="function"&&window.triggerHaptic("light"),y()},be=(e,t)=>{const a=b.find(o=>(o.cartKey||String(o.id))===String(e));a&&(a.qty=Math.max(1,a.qty+t),C(a),t>0&&O(),y())},xe=(e,t)=>{const a=b.find(o=>(o.cartKey||String(o.id))===String(e));a&&(a.qty=Math.max(1,T(t)),C(a),y())},ue=(e,t)=>{const a=b.find(o=>(o.cartKey||String(o.id))===String(e));a&&(a.discount=Math.min(T(t),a.price*a.qty),C(a),y())},me=e=>{b=b.filter(t=>(t.cartKey||String(t.id))!==String(e)),y(),typeof window.triggerHaptic=="function"&&window.triggerHaptic("light")},fe=()=>{if(b.length===0)return;const e=()=>{b=[],L=0,y(),h("Keranjang kasir dikosongkan.")};typeof window.showConfirm=="function"?window.showConfirm("Kosongkan Keranjang","Hapus semua item dari transaksi saat ini?",e,"Ya, Kosongkan",!0):e()},W=()=>{const e=c("pos-mobile-cart-drawer"),t=c("pos-mobile-cart-sheet");e&&t&&(e.classList.remove("opacity-0","pointer-events-none"),e.classList.add("opacity-100"),t.classList.remove("translate-y-full"),t.classList.add("translate-y-0"),typeof window.pushModalHistory=="function"&&window.pushModalHistory("posCartDrawer"),typeof window.triggerHaptic=="function"&&window.triggerHaptic("light"))},I=(e=!1)=>{const t=c("pos-mobile-cart-drawer"),a=c("pos-mobile-cart-sheet");if(t&&a){const o=()=>{a.classList.add("translate-y-full"),a.classList.remove("translate-y-0"),t.classList.add("opacity-0","pointer-events-none"),t.classList.remove("opacity-100")};!e&&typeof window.requestCloseModal=="function"?window.requestCloseModal("posCartDrawer",!1,o):o()}},He=e=>{if(e.img&&typeof e.img=="string")return F(e.img,"w150-rw");const t=(m.products||[]).find(a=>String(a.id)===String(e.id));return t&&t.img&&typeof t.img=="string"?F(t.img,"w150-rw"):""},A=()=>{const e=(m.products||[]).filter(s=>{if(!s||s.isActive==="false"||s.isActive===!1||j&&s.category!==j)return!1;if(D){const l=D.toLowerCase();return(s.name||"").toLowerCase().includes(l)||(s.barcode||"").toLowerCase().includes(l)||(s.sku||"").toLowerCase().includes(l)}return!0}),a=["Semua",...new Set((m.products||[]).filter(s=>s&&s.isActive!=="false"&&s.category).map(s=>s.category))].map(s=>{const l=s==="Semua",i=l?!j:j===s;return`<button onclick="window.posCatFilter('${d(l?"":s)}')" class="shrink-0 px-3.5 py-1.5 rounded-xl text-[11px] font-black uppercase tracking-wider border transition-all active:scale-95 shadow-2xs ${i?"text-white border-transparent":"bg-white dark:bg-slate-800 text-slate-600 dark:text-slate-300 border-slate-200 dark:border-slate-700 hover:border-[var(--color-primary)]/50"}" style="${i?"background:var(--color-primary)":""}">${d(s)}</button>`}).join(""),o=e.length===0?`<div class="col-span-full flex flex-col items-center justify-center py-20 text-slate-400 dark:text-slate-600">
           ...
           </div>`:e.map(s=>{const l=!!(s.img&&typeof s.img=="string"&&s.img.trim()),i=l?F(s.img,"w300-rw"):"",p=s.variants&&s.variants.length>0,v=s.wholesale&&s.wholesale.length>0,S=b.filter(q=>String(q.id)===String(s.id)).reduce((q,Oe)=>q+Oe.qty,0),_=d(String(s.id));return M==="list"?`
                <div class="pos-list-item${S>0?" in-cart":""}" onclick="window.posAddToCart('${_}')">
                    <div class="pos-list-thumb">
                        ${l?`<img width="52" height="52" loading="lazy" decoding="async" src="${d(i)}" alt="${d(s.name)}" onerror="this.onerror=null;this.style.display='none';this.nextElementSibling.style.display='flex';">
            ...
            </div>`}).join(""),r=c("pos-cat-filter"),n=c("pos-catalog-grid");r&&(r.innerHTML=a),n&&(M==="list"?n.className="flex flex-col gap-2 p-2.5 sm:p-3 overflow-y-auto flex-1 content-start pb-28 lg:pb-6":n.className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 xl:grid-cols-5 gap-2 sm:gap-2.5 p-2 sm:p-3 overflow-y-auto flex-1 content-start pb-28 lg:pb-6",n.innerHTML=o)},y=()=>{const e=b.reduce((l,i)=>l+i.qty,0),t=Q(),a=g(),o=x(a),r=x(t),n=b.length===0?`<div class="flex flex-col items-center justify-center h-full py-12 text-slate-300 dark:text-slate-600 select-none">
            <div class="w-16 h-16 rounded-3xl bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-slate-400 mb-3 shadow-inner">
            ...
            </div>`}).join("");document.querySelectorAll(".pos-cart-items-target").forEach(l=>l.innerHTML=n),document.querySelectorAll(".pos-subtotal-target").forEach(l=>l.textContent=r),document.querySelectorAll(".pos-total-target").forEach(l=>l.textContent=o),document.querySelectorAll(".pos-item-count-target").forEach(l=>l.textContent=String(e)),document.querySelectorAll(".pos-global-disc-target").forEach(l=>{document.activeElement!==l&&(l.value=L||"")}),document.querySelectorAll(".pos-pay-btn-target").forEach(l=>{l.disabled=b.length===0;const i=l.querySelector(".btn-text");i&&(i.textContent=b.length>0?`BAYAR — ${o}`:"PROSES PEMBAYARAN")});const s=c("pos-mobile-floating-bar");s&&(b.length>0?(s.classList.remove("translate-y-32","opacity-0","pointer-events-none"),s.classList.add("translate-y-0","opacity-100")):(s.classList.add("translate-y-32","opacity-0","pointer-events-none"),s.classList.remove("translate-y-0","opacity-100"),I(!0)))},ge=()=>{if(b.length===0){h("Keranjang masih kosong!","warning");return}typeof window.pushModalHistory=="function"&&window.pushModalHistory("posPayment"),w={name:"",phone:"",isMember:!1,memberId:null,isNewTempo:!1},f="cash",k=g(),document.body.insertAdjacentHTML("beforeend",`
    ...
    </div>`)},Se=e=>{document.getElementById("pos-success-modal")?.remove();const t=m.store?.name||"TOKO PUTRI",a=m.store?.wa||"",o=m.store?.address||"",r=new Date(e.dateMs).toLocaleString("id-ID"),n=(e.items||[]).map(l=>`<tr><td style="padding:2px 0;word-wrap:break-word">${d(l.name)}</td><td style="text-align:right;padding:2px 4px;white-space:nowrap">${l.qty}x ${x(l.price)}</td><td style="text-align:right;padding:2px 0;white-space:nowrap">${x(l.subtotal)}</td></tr>`).join(""),s=window.open("","_blank","width=420,height=720");if(!s){h("Izinkan popup untuk cetak struk","warning");return}s.document.write(`<!DOCTYPE html><html><head><meta charset="utf-8"><title>Struk POS</title>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4">
        ...
        <div class="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-3 text-center">
            ...
            <p class="text-base font-black text-slate-800 dark:text-white">${$.filter(i=>i.status!=="void").reduce((i,p)=>i+(p.items||[]).reduce((v,u)=>v+u.qty,0),0)}</p>
        </div>
        <div class="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-3 text-center">
    ...
    ${n?`<div class="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-3 mb-4 space-y-1.5">${n}</div>`:""}`,l=$.length===0?`<div class="flex flex-col items-center justify-center py-16 text-slate-400 dark:text-slate-600"><i class="fa-solid fa-receipt text-4xl mb-3"></i><p class="font-semibold text-sm">Belum ada transaksi</p><p class="text-xs mt-1">${R}</p></div>`:$.map(i=>{const p=i.status==="void",v={cash:"emerald",qris:"blue",transfer:"violet",tempo:"amber"}[i.payment?.method]||"slate",u={cash:"Tunai",qris:"QRIS",transfer:"Transfer",tempo:"Tempo"}[i.payment?.method]||i.payment?.method;return`<div class="bg-white dark:bg-slate-800 border ${p?"border-red-200 dark:border-red-800 opacity-60":"border-slate-200 dark:border-slate-700"} rounded-2xl p-3 space-y-2 ${p?"":"hover:shadow-sm"} transition-all">
                <div class="flex items-start justify-between gap-2">
                    ...
                    <div class="text-right shrink-0">
                        <p class="font-black text-sm ${p?"line-through text-slate-400":""}" style="${p?"":"color:var(--color-primary)"}">${K(i.total)}</p>
                        ${i.payment?.method==="cash"?`<p class="text-[10px] text-slate-400">Kembalian ${K(i.payment.change||0)}</p>`:""}
                    </div>
                </div>
            ...
            </div>`}).join("");H("pos-hist-rekap",s),H("pos-hist-list",l)},Me=e=>{je("Void Transaksi",`Void transaksi ${e}?
