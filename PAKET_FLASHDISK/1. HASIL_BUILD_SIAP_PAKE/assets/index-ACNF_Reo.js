import{f as _e}from"./vendor-firebase-core-D2OF5R23.js";import"./vendor-firebase-db-BIUZcnOd.js";import{p as Qt}from"./vendor-utils-Bszxp-Ae.js";import{r as te,d as D,p as we,g as ct,c as Wt,a as zt,b as Jt,s as Zt,u as Yt,h as Xt,e as ht,t as ea,f as vt,i as ta,l as pt,j as aa,k as sa,m as oa,n as ra,o as mt,q as He,v as ia,A as yt,w as na,x as ut,y as la,z as kt,B as da,C as ca,D as pa}from"./module-admin-BlIL7gvS.js";import{e as l,Q as _,a as f,g as G,c as R,i as N,f as S,al as c,h as T,j as u,am as W,an as J,ao as ne,ap as z,aq as le,ar as v,A as ee,d as L,a4 as tt,ah as Qe,b as Ie,a5 as ie,R as Z,S as I,as as O,at as Ne,s as Pt,m as H,au as Mt,k as b,a8 as je,a3 as at,l as Tt,o as Ae,p as ve,y as ye,K as At,D as st,M as St,F as We,E as ze,a1 as ma,av as ua,aw as fa,t as ba,ae as wa,ag as ga,af as xa,ai as ha,ax as va,ay as ya,az as ka,w as Pa,aA as Ma,N as Ta,G as Aa,O as Sa,I as Da,P as $a,J as Ca,B as Ea,aB as Ra,C as Ia,aC as La,aD as Fa,aE as _a,z as Ba,q as Na,x as ja,r as Oa,aF as Ua,aG as qa,aH as Ga,v as Ka,u as Ha,aI as Va,U as Qa,T as Wa,W as za,V as Ja,Y as Za,X as Ya,a7 as Xa,a0 as es,aj as ts,ab as as,a2 as ss,a6 as os,aJ as rs,ad as is,ac as ns,_ as ls,Z as ds,aK as cs,aL as ps,$ as ms,ak as us,aM as fs,aN as bs,aO as ws,aP as gs,aQ as xs}from"./module-print-DvZTTFpS.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))s(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function a(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(o){if(o.ep)return;o.ep=!0;const r=a(o);fetch(o.href,r)}})();let Oe="https://script.google.com/macros/s/AKfycbx3dW9rHcdoKNYjSOJ8PoH2k6fABe7XlBD9teNHsBlCBqJquq8jd4UvnfXZVsfKdFsC/exec";const Dt=()=>{l("voucher-input");const e=(_("voucher-input")||"").toUpperCase().trim(),t=(f.vouchers||[]).find(o=>(o.code||"").toUpperCase()===e);G("voucher-msg-container");const a=typeof window.getEffP=="function"?window.getEffP:o=>o.effectivePrice||o.price||0,s=R.reduce((o,r)=>o+(parseFloat(a(r))||0)*(parseFloat(r.qty)||0),0);if(t){let o=!0;t.targetProduct&&t.targetProduct!==""&&(o=R.some(r=>r&&String(r.id)===String(t.targetProduct))),t.targetProduct&&t.targetProduct!==""&&!o?(W(null),N("voucher-msg",'<i class="fa-solid fa-box mr-1"></i> Khusus Produk Tertentu!'),l("voucher-msg")&&(l("voucher-msg").className="text-sm font-bold text-rose-500 dark:text-rose-400")):t.minPurchase&&parseFloat(t.minPurchase)>0&&s<parseFloat(t.minPurchase)?(W(null),N("voucher-msg",`<i class="fa-solid fa-circle-exclamation mr-1"></i> Minimal belanja ${S(t.minPurchase)}`),l("voucher-msg")&&(l("voucher-msg").className="text-sm font-bold text-amber-500 dark:text-amber-400")):t.type&&t.type.includes("shipping")&&c.deliveryMethod!=="delivery"?(W(null),N("voucher-msg",'<i class="fa-solid fa-motorcycle mr-1"></i> Khusus pesanan dikirim kurir!'),l("voucher-msg")&&(l("voucher-msg").className="text-sm font-bold text-rose-500 dark:text-rose-400")):(W(t),N("voucher-msg",'<i class="fa-solid fa-check-circle mr-1"></i> Voucher Diterapkan!'),l("voucher-msg")&&(l("voucher-msg").className="text-sm font-bold text-[var(--color-primary)]"))}else e===""?(W(null),T("voucher-msg-container"),typeof window.rPay=="function"&&window.rPay()):(W(null),N("voucher-msg",'<i class="fa-solid fa-times-circle mr-1"></i> Kode Tidak Valid'),l("voucher-msg")&&(l("voucher-msg").className="text-sm font-bold text-rose-500 dark:text-rose-400"));typeof window.rPay=="function"&&window.rPay()},hs=()=>{let e=document.getElementById("voucher-modal");e||(e=document.createElement("div"),e.id="voucher-modal",e.className="fixed inset-0 z-[115] bg-slate-900/80 flex items-end sm:items-center justify-center p-0 sm:p-5",e.onclick=s=>{s.target===e&&ot()},document.body.appendChild(e));const t=(f.vouchers||[]).filter(s=>s.isShow!==!1&&s.isShow!=="false"),a=t.length?t.map(s=>{let o="";s.type==="percent"?o=`Diskon ${s.value}%`:s.type==="shipping_free"?o="Gratis Ongkir":s.type==="shipping_flat"?o=`Diskon Ongkir ${S(s.value)}`:o=`Potongan ${S(s.value)}`;const r=s.minPurchase&&parseFloat(s.minPurchase)>0?`Min. belanja ${S(s.minPurchase)}`:"Tanpa minimal belanja";return`
    ...
    <div class="flex gap-2.5 sm:gap-3 overflow-x-auto hide-scrollbar snap-x pb-3 pt-1">
        ...
        </div>`}).join("")+(le?`<div class="flex justify-between items-center bg-[rgba(var(--color-primary-rgb),0.06)] dark:bg-[rgba(var(--color-primary-rgb),0.12)] p-4 rounded-2xl border border-[var(--color-primary)]/30 shadow-sm min-w-0"><div class="flex items-center gap-3.5 min-w-0"><div class="w-12 h-12 rounded-xl bg-[var(--color-primary)] text-white flex items-center justify-center shrink-0"><i class="fa-solid fa-gift"></i></div><div class="min-w-0"><p class="text-sm font-bold text-[var(--color-primary)] truncate">${u(le.name)}</p><p class="text-[11px] text-[var(--color-primary)] font-bold mt-1"><i class="fa-solid fa-star mr-1"></i>Tukar ${le.pointsCost} Poin (Gratis)</p></div></div><button type="button" onclick="if(typeof deselectReward==='function') deselectReward(); rPay();" class="text-[10px] font-bold text-rose-500 uppercase shrink-0 ml-3">Batal</button></div>`:"")),c.note?(L("payment-note-text",`"${u(c.note)}"`),G("payment-note-preview")):T("payment-note-preview"),N("dynamic-banks-container",f.banks?.length?f.banks.map(w=>`<div class="bg-white dark:bg-slate-800 p-4 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm"><p class="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1">Bank ${u(w.bankName)}</p><p class="text-lg font-bold text-[var(--color-primary)] tracking-wide">${u(w.bankAccount)}</p><p class="text-xs text-slate-500 dark:text-slate-400 font-medium mt-1.5">a.n <span class="font-bold text-slate-700 dark:text-white">${u(w.bankOwner)}</span></p></div>`).join(""):'<div class="bg-rose-50 dark:bg-rose-900/20 border border-rose-200 p-4 rounded-2xl text-center"><p class="text-sm text-rose-500 dark:text-rose-400 font-bold">Rekening belum diatur.</p></div>');const K=l("payment-option-cashier"),F=l("payment-option-cod");if(K&&F){if(c.deliveryMethod==="pickup"){if(G("payment-option-cashier"),T("payment-option-cod"),(document.querySelector('input[name="payment"]:checked')||{}).value==="cod"){const w=document.querySelector('input[value="cashier"]');w&&(w.checked=!0)}}else{T("payment-option-cashier"),G("payment-option-cod");const w=(document.querySelector('input[name="payment"]:checked')||{}).value;if(w==="cashier"||!w){const C=document.querySelector('input[value="cod"]');C&&(C.checked=!0)}}typeof window.togglePaymentDetails=="function"&&window.togglePaymentDetails()}const V=l("tnc-checkbox");V&&(V.checked=!1,It())},Bs=async()=>{if(!l("tnc-checkbox").checked||tt)return;if(window.isAdm){typeof window.showToast=="function"&&window.showToast("Anda login sebagai Seller. Logout dulu untuk membuat pesanan.");return}const e=Qe("freshmart_last_order");if(e&&Date.now()-parseInt(e)<6e4){typeof window.showToast=="function"&&window.showToast("Tunggu 1 menit untuk pesanan baru!");return}const t=typeof window.getEffP=="function"?window.getEffP:r=>r.price||0,a=typeof window.getEffHpp=="function"?window.getEffHpp:()=>0,s=typeof window.getEffPoin=="function"?window.getEffPoin:()=>0;let o=!1;if(R.forEach(r=>{const i=f.products.find(d=>d.id===r.id);if(!i)return;const n=r.variantName?((i.variants||[]).find(d=>d.name===r.variantName)||{}).price??i.price:i.price;n!==void 0&&Math.abs(r.price-n)>1&&(r.price=n,o=!0),r.poin=s(r)}),o){Ie("freshmart_cart",JSON.stringify(R)),typeof window.renderCart=="function"&&window.renderCart(),Lt(),typeof window.showToast=="function"&&window.showToast("Harga produk telah diperbarui. Periksa kembali sebelum order.");return}ie(!0),Z("Proses Pesanan...");try{const r=R.reduce((x,A)=>x+(parseFloat(t(A))||0)*(parseFloat(A.qty)||0),0);let i=0,n=0,d=0;c.deliveryMethod==="delivery"&&(i=Math.ceil((parseFloat(c.distance)||0)*(parseFloat(f.store.costPerKm)||0)/500)*500);const p=f.store.useStock===!0||f.store.useStock==="true";if(p)for(const x of R){const A=f.products.find(M=>M.id===x.id);if(!A)continue;const ae=parseFloat(x.qty)||0;if(x.variantName){const M=(A.variants||[]).find(U=>U.name===x.variantName),E=parseFloat(M&&M.stock!==void 0?M.stock:0);if(E<ae){ie(!1),I(),typeof window.showToast=="function"&&window.showToast(`Stok ${x.name} (${x.variantName}) tidak cukup! Sisa: ${E}`);return}}else{const M=parseFloat(A.stock!==void 0?A.stock:0);if(M<ae){ie(!1),I(),typeof window.showToast=="function"&&window.showToast(`Stok ${x.name} tidak cukup! Sisa: ${M}`);return}}}if(v){let x=r;if(v.targetProduct&&v.targetProduct!==""){const A=parseInt(v.targetProduct);x=R.filter(M=>M.id===A).reduce((M,E)=>M+(parseFloat(t(E))||0)*(parseFloat(E.qty)||0),0)}if(v.minPurchase&&parseFloat(v.minPurchase)>0&&r<parseFloat(v.minPurchase))W(null);else if(v.targetProduct&&v.targetProduct!==""&&x===0)W(null);else if(v.type&&v.type.includes("shipping")&&c.deliveryMethod!=="delivery")W(null);else if(v.type==="shipping_free")n=i;else if(v.type==="shipping_flat")n=parseFloat(v.value)||0;else if(v.type==="percent"){let A=x*((parseFloat(v.value)||0)/100);v.maxDiscount&&parseFloat(v.maxDiscount)>0&&(A=Math.min(A,parseFloat(v.maxDiscount))),d=A}else d=parseFloat(v.value)||0,d=Math.min(d,x)}const h=(f.store.freeShippingMinSpendEnabled===!0||f.store.freeShippingMinSpendEnabled==="true")&&(parseFloat(f.store.freeShippingMinSpendAmount)||0)>0&&r>=(parseFloat(f.store.freeShippingMinSpendAmount)||0)&&c.deliveryMethod==="delivery";h&&(n=i),n=Math.min(n,i),d=Math.min(d,r);const g=Math.max(0,r-d+(i-n)),k=(typeof window.calcTaxDetails=="function"?window.calcTaxDetails:()=>({ppnEnabled:!1,ppnAmount:0,grandTotalAdd:0}))(g),K=k.ppnAmount,F=k.dppAmount,V=g+k.grandTotalAdd,w=(document.querySelector('input[name="payment"]:checked')||{}).value,C=w==="transfer"||w==="qris"||w==="tempo",ke=window.buktiGDriveUploaded&&window.buktiPaymentUrl&&!window.buktiPaymentUrl.startsWith("data:");if(C&&!ke){if(ie(!1),I(),!window.buktiPaymentFile){typeof window.showToast=="function"&&window.showToast("Upload bukti pembayaran terlebih dahulu!");return}typeof window.showToast=="function"&&window.showToast("Tunggu upload Google Drive selesai, atau coba lagi!");return}const oe="ORD-"+Date.now().toString(36).toUpperCase()+"-"+Math.random().toString(36).substring(2,6).toUpperCase();if(window.buktiPaymentFile&&!window.buktiGDriveUploaded)try{Z("Upload Bukti ke Google Drive...");const x=await window.uploadBuktiToFirebase(window.buktiPaymentFile,oe);if(x&&!x.startsWith("data:"))window.buktiPaymentUrl=x,window.buktiGDriveUploaded=!0;else{ie(!1),I(),typeof window.showToast=="function"&&window.showToast("❌ Upload bukti ke Google Drive gagal. Coba pilih gambar lagi!");return}Z("Proses Pesanan...")}catch{ie(!1),I(),typeof window.showToast=="function"&&window.showToast("❌ Gagal upload bukti. Periksa koneksi dan coba lagi!");return}const m={orderId:oe,timestamp:_e.firestore.FieldValue.serverTimestamp(),dateString:new Date().toISOString(),customer:c,isDropPoint:!!(c.dropPoint&&c.dropPoint.lat&&c.dropPoint.name),dropPoint:c.dropPoint&&c.dropPoint.lat&&c.dropPoint.name?{...c.dropPoint}:null,items:R.map(x=>({...x,qty:parseFloat(x.qty),effectivePrice:t(x),poTime:x.poTime||"",hpp:a(x),poin:s(x)})),payment:{method:w,subtotal:r,shippingCost:i,shippingDiscount:n,productDiscount:d,ppnAmount:K,dppAmount:F,ppnRate:k.ppnEnabled?k.ppnRate:0,ppnType:k.ppnEnabled?k.ppnType:"exclusive",grandTotal:V,isFreeShippingPromo:h||!1},status:"Baru",buktiPayment:window.buktiPaymentUrl||null};if(w==="tempo"){if(!c.wa){ie(!1),I(),typeof window.showToast=="function"&&window.showToast("Pembayaran Cash Tempo hanya untuk Member Resmi terdaftar!");return}const x=document.getElementById("tempo-dp-input");let A=x&&parseFloat(x.value)||0;A>V&&(A=V),m.payment.tempoDp=A,m.payment.tempoBalance=V-A,m.payment.tempoDueDate=Date.now()+30*24*60*60*1e3,m.payment.paymentStatus="hutang"}const j=D.collection("freshmart_orders").doc(oe),de=typeof window.calculateCartPoints=="function"?window.calculateCartPoints(R,f.store):{totalPoints:0,directPoints:0,spendPoints:0},me=de.totalPoints;m.pointsEarned=me,m.pointsBreakdown={direct:de.directPoints,spend:de.spendPoints};const Re=D.collection("freshmart").doc("cms_data"),ue=c.wa?Re.collection("customers").doc(c.wa):null,Se=!!le;let ge=null;if(p){const x={};R.forEach(M=>{const E=M.id!=null?M.id.toString():null;if(!E)return;x[E]||(x[E]={main:0,variants:{}});const U=parseFloat(M.qty)||0;M.variantName?x[E].variants[M.variantName]=(x[E].variants[M.variantName]||0)+U:x[E].main+=U});const A=Object.keys(x),ae=A.map(M=>D.collection("freshmart").doc("cms_data").collection("products").doc(M));await D.runTransaction(async M=>{const E=await Promise.all(ae.map(q=>M.get(q))),U=ue?await M.get(ue):null,re=!!(U&&U.exists),fe=re&&Se?D.collection("freshmart").doc("cms_data").collection("rewards").doc(le.id.toString()):null,ce=fe?await M.get(fe):null,pe=[];if(E.forEach((q,Y)=>{if(!q.exists)return;const B=q.data(),X=x[A[Y]];if(X.main>0){const $=parseFloat(B.stock!==void 0?B.stock:0);$<X.main&&pe.push(`${B.name} (sisa ${$})`)}Object.keys(X.variants).forEach($=>{const be=(B.variants||[]).find(Pe=>Pe.name===$),Ce=parseFloat(be&&be.stock!==void 0?be.stock:0);Ce<X.variants[$]&&pe.push(`${B.name} (${$}, sisa ${Ce})`)})}),pe.length)throw new Error("STOK_TIDAK_CUKUP: "+pe.join(", "));let Q=null,xe=null;if(re){const q=parseFloat(U.data().points)||0;let Y=q;if(Se){if(!ce||!ce.exists)throw new Error("HADIAH_TIDAK_DITEMUKAN");const B=ce.data();if(q<(parseFloat(B.pointsCost)||0))throw new Error("POIN_TIDAK_CUKUP");if((parseFloat(B.stock)||0)<=0)throw new Error("STOK_HADIAH_HABIS");Q=(parseFloat(B.stock)||0)-1,Y-=parseFloat(B.pointsCost)||0,m.claimedReward={id:B.id,name:B.name,pointsCost:parseFloat(B.pointsCost)||0,status:"pending",note:""}}Y+=me,xe=Y,m.pointsEarned=me,m.customerPhone=c.wa,m.finalMemberPoints=xe,m.customerType="Member"}else{if(w==="tempo")throw new Error("TEMPO_KHUSUS_MEMBER");if(Se)throw new Error("MEMBER_TIDAK_DITEMUKAN");m.pointsEarned=0,m.pointsBreakdown={direct:0,spend:0},m.finalMemberPoints=null,m.customerType="Pelanggan Umum"}if(E.forEach((q,Y)=>{if(!q.exists)return;const B=A[Y],X=x[B],$=JSON.parse(JSON.stringify(q.data())),be={};X.main>0&&($.stock=Math.max(0,(parseFloat($.stock)||0)-X.main),be.stock=$.stock,$.stock===0&&($.isActive="false",be.isActive="false"),$.totalSold=(parseFloat($.totalSold)||0)+X.main,be.totalSold=$.totalSold),Object.keys(X.variants).length>0&&$.variants&&(Object.keys(X.variants).forEach(Pe=>{const Me=($.variants||[]).findIndex(Vt=>Vt.name===Pe);Me>-1&&($.variants[Me].stock=Math.max(0,(parseFloat($.variants[Me].stock)||0)-X.variants[Pe]),$.variants[Me].stock===0&&($.variants[Me].isActive=!1),$.variants[Me].totalSold=(parseFloat($.variants[Me].totalSold)||0)+X.variants[Pe])}),be.variants=$.variants);const Ce=f.products.findIndex(Pe=>Pe.id.toString()===B);Ce>-1&&(f.products[Ce]=$),M.update(ae[Y],be)}),M.set(j,m),re&&ue&&xe!==null){const q=U.data().name||c.name||"Pelanggan Setia";m.customer&&(m.customer.name=q);const Y={points:xe,name:q,lastOrderAt:Date.now()};M.set(ue,Y,{merge:!0}),ge=xe}Q!==null&&M.set(fe,{stock:Q},{merge:!0}),M.update(Re,{lastUpdate:_e.firestore.FieldValue.increment(1),updateType:"stock_change",updatedProductIds:A})}),f.lastUpdate=(parseInt(Qe("freshmart_last_update"))||f.lastUpdate||0)+1,Ie("freshmart_last_update",f.lastUpdate.toString()),Ie("freshmart_products",JSON.stringify(f.products))}else if(ue)await D.runTransaction(async x=>{const A=await x.get(ue),ae=A.exists,M=ae&&Se?D.collection("freshmart").doc("cms_data").collection("rewards").doc(le.id.toString()):null,E=M?await x.get(M):null;let U=null,re=null;if(ae){const fe=parseFloat(A.data().points)||0;let ce=fe;if(Se){if(!E||!E.exists)throw new Error("HADIAH_TIDAK_DITEMUKAN");const Q=E.data();if(fe<(parseFloat(Q.pointsCost)||0))throw new Error("POIN_TIDAK_CUKUP");if((parseFloat(Q.stock)||0)<=0)throw new Error("STOK_HADIAH_HABIS");U=(parseFloat(Q.stock)||0)-1,ce-=parseFloat(Q.pointsCost)||0,m.claimedReward={id:Q.id,name:Q.name,pointsCost:parseFloat(Q.pointsCost)||0,status:"pending",note:""}}ce+=me,re=ce,m.pointsEarned=me,m.customerPhone=c.wa,m.finalMemberPoints=re,m.customerType="Member";const pe=A.data().name||c.name||"Pelanggan Setia";m.customer&&(m.customer.name=pe),x.set(ue,{points:re,name:pe,lastOrderAt:Date.now()},{merge:!0}),ge=re,U!==null&&x.set(M,{stock:U},{merge:!0})}else{if(w==="tempo")throw new Error("TEMPO_KHUSUS_MEMBER");if(Se)throw new Error("MEMBER_TIDAK_DITEMUKAN");m.pointsEarned=0,m.pointsBreakdown={direct:0,spend:0},m.finalMemberPoints=null,m.customerType="Pelanggan Umum"}x.set(j,m)});else{if(m.pointsEarned=0,m.pointsBreakdown={direct:0,spend:0},m.finalMemberPoints=null,m.customerType="Pelanggan Umum",w==="tempo")throw new Error("TEMPO_KHUSUS_MEMBER");await j.set(m)}O.unshift({orderId:oe,date:new Date().toISOString(),total:V,itemCount:R.reduce((x,A)=>x+parseFloat(A.qty),0),status:"Baru",pointsEarned:m.pointsEarned||0,claimedReward:m.claimedReward||null,finalMemberPoints:ge,customerType:m.customerType||"Pelanggan Umum"}),Ne(O);try{localStorage.setItem("freshmart_my_orders",JSON.stringify(O)),localStorage.setItem("freshmart_last_order",Date.now().toString())}catch{}if(typeof analytics<"u"&&analytics.logEvent("purchase",{transaction_id:oe,value:V,currency:"IDR"}),c.wa&&ge!==null){const x={id:c.wa,phone:c.wa,name:c.name||"Pelanggan Setia",points:ge};J(x);try{localStorage.setItem("freshmart_current_member",JSON.stringify(x)),localStorage.setItem("freshmart_member_wa",c.wa)}catch{}typeof window.invalidateMemberCache=="function"&&window.invalidateMemberCache(c.wa)}else{J(null);try{localStorage.removeItem("freshmart_current_member")}catch{}}m.claimedReward&&ge!==null?typeof window.showToast=="function"&&window.showToast(`✅ Hadiah "${m.claimedReward.name}" berhasil ditukar! Sisa poin Anda: ${ge}`):ge!==null&&me>0?typeof window.showToast=="function"&&window.showToast(`✅ Pesanan berhasil dikirim ke admin! (+${me} Poin Member didapat!)`):typeof window.showToast=="function"&&window.showToast("✅ Pesanan berhasil dikirim ke admin!"),setTimeout(()=>{Pt([]),H("cust-name",""),H("cust-address",""),H("cust-maps-input",""),H("cust-note",""),H("cust-wa",""),window.buktiPaymentUrl=null,window.buktiPaymentFile=null,window.buktiGDriveUploaded=!1;const x=l("bukti-preview-wrap"),A=l("bukti-placeholder");x&&x.classList.add("hidden"),A&&A.classList.remove("hidden"),T("bukti-uploading"),T("bukti-success"),T("bukti-gdrive-error");const ae=l("bukti-file-input");ae&&(ae.value=""),Mt({name:"",address:"",lat:null,lng:null,deliveryMethod:"delivery",distance:0,note:"",wa:"",dropPoint:null}),W(null),ne(null);const M=l("toggle-droppoint"),E=l("droppoint-form");M&&(M.checked=!1),E&&E.classList.add("hidden");const U=l("dp-location-status");U&&U.classList.add("hidden");const re=l("payment-droppoint-info");re&&re.classList.add("hidden");const fe=l("dp-receiver-name");fe&&(fe.value="");const ce=l("dp-receiver-wa");ce&&(ce.value="");const pe=l("dp-address");pe&&(pe.value="");const Q=l("dp-maps-input");Q&&(Q.value="");const xe=l("btn-dp-location");xe&&(xe.innerHTML='<i class="fa-solid fa-location-crosshairs text-sm text-rose-500"></i> <span id="text-dp-location">Sematkan GPS Lokasi Tujuan</span>');const q=l("member-status-banner");q&&T(q),T("payment-option-tempo"),l("voucher-input")&&(l("voucher-input").value=""),T("voucher-msg-container"),T("location-status"),l("btn-location")&&G("btn-location");const Y=document.querySelector('input[name="delivery-method"][value="delivery"]');Y&&(Y.checked=!0,it());const B=document.querySelector('input[name="payment"][value="transfer"]');B&&(B.checked=!0,typeof window.togglePaymentDetails=="function"&&window.togglePaymentDetails()),typeof window.updCart=="function"&&window.updCart(),typeof window.renderCart=="function"&&window.renderCart();try{window.history.replaceState({view:"view-catalog"},"",window.location.pathname)}catch{}typeof window.changeView=="function"&&window.changeView("view-catalog",!0),typeof window.showToast=="function"&&window.showToast("Pesanan Dibuat! 🎉")},2e3)}catch(r){const i=r.message||"Error";i.startsWith("STOK_TIDAK_CUKUP:")?typeof window.showToast=="function"&&window.showToast("Maaf, stok berubah: "+i.replace("STOK_TIDAK_CUKUP: ","")):i==="TEMPO_KHUSUS_MEMBER"?typeof window.showToast=="function"&&window.showToast("Pembayaran Cash Tempo hanya untuk Member Resmi yang telah didaftarkan Admin!"):i==="POIN_TIDAK_CUKUP"?(typeof window.showToast=="function"&&window.showToast("Maaf, poin Anda ternyata tidak cukup untuk hadiah ini. Silakan cek lagi."),ne(null)):i==="STOK_HADIAH_HABIS"?(typeof window.showToast=="function"&&window.showToast("Maaf, stok hadiah yang dipilih baru saja habis. Silakan pilih hadiah lain."),ne(null)):i==="HADIAH_TIDAK_DITEMUKAN"?(typeof window.showToast=="function"&&window.showToast("Hadiah yang dipilih sudah tidak tersedia. Silakan pilih ulang."),ne(null)):i==="MEMBER_TIDAK_DITEMUKAN"?(typeof window.showToast=="function"&&window.showToast("Data member tidak ditemukan, klaim hadiah dibatalkan. Pesanan bisa dicoba lagi tanpa hadiah."),ne(null)):typeof window.showToast=="function"&&window.showToast(r.code==="resource-exhausted"?"Quota Server Penuh!":"Gagal proses: "+i)}finally{ie(!1),I()}};window.validateAndGoToPayment=_s;window.toggleDeliveryMethod=it;window.toggleDropPoint=Is;window.getDPLocation=Ls;window.handleDPMapsInput=Rt;window.pasteDPMapsInput=Fs;window.toggleOrderButton=It;window.rPay=Lt;window.processOrder=Bs;window.getLocation=()=>{if(!navigator.geolocation)return b("GPS tidak didukung");l("btn-location").innerHTML='<i class="fa-solid fa-spinner fa-spin text-sm"></i>',navigator.geolocation.getCurrentPosition(e=>{c.lat=e.coords.latitude,c.lng=e.coords.longitude,T("btn-location"),G("location-status"),l("location-status").classList.add("flex"),b("GPS Didapatkan")},e=>{l("btn-location").innerHTML='<i class="fa-solid fa-location-crosshairs text-[var(--color-primary)]"></i> Set GPS Maps',b("Gagal akses GPS")},{enableHighAccuracy:!0,timeout:15e3})};window.handleCustomerMapsInput=e=>{const t=typeof window.parseGeoCoordinates=="function"?window.parseGeoCoordinates:null,a=t?t(e):null;if(a){c.lat=parseFloat(a.lat),c.lng=parseFloat(a.lng),T("btn-location"),G("location-status");const s=l("location-status");return s&&(s.classList.add("flex"),s.innerHTML=`
        ...
        <div class="bg-white dark:bg-slate-800 p-4 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm relative overflow-hidden group min-w-0 transition-all hover:border-[var(--color-primary)]/40">
            ...
            <div class="flex gap-3 items-center border-b border-slate-100 dark:border-slate-700/50 py-3 last:border-0">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    ${ue?`<button type="button" onclick="openReviewModal('${e}',${m.id},'${encodeURIComponent(m.variantName||"")}','${encodeURIComponent(m.name||"")}','${encodeURIComponent(t.customer?.name||"")}')" class="mt-1.5 text-[10px] font-bold text-amber-500 hover:text-amber-600 flex items-center gap-1 transition-colors"><i class="fa-solid fa-star"></i> Berikan Ulasan</button>`:""}
                </div>
                <div class="text-right shrink-0">
                    <p class="text-xs font-bold text-slate-800 dark:text-[var(--color-primary)]">${S(me)}</p>
                </div>
            </div>
            `}).join("");let k="Tanggal Tidak Tersedia";try{let m;if(t.timestamp&&typeof t.timestamp.toDate=="function")m=t.timestamp.toDate();else{const j=t.timestamp||t.dateString||Date.now();if(typeof j=="number")m=new Date(j);else if(!isNaN(Number(j))&&String(j).trim()!=="")m=new Date(Number(j));else{const de=String(j).replace(/-/g,"/").replace("T"," ").replace(/\..*$/,"");m=new Date(j),isNaN(m.getTime())&&(m=new Date(de))}}m&&!isNaN(m.getTime())&&(k=m.toLocaleString("id-ID",{day:"numeric",month:"short",year:"numeric",hour:"2-digit",minute:"2-digit"}))}catch(m){console.error("Gagal memproses tanggal:",m)}const K=t.payment&&t.payment.subtotal?t.payment.subtotal:0,F=t.payment&&t.payment.shippingCost?t.payment.shippingCost:0,V=t.payment&&t.payment.productDiscount?t.payment.productDiscount:0,w=t.payment&&t.payment.shippingDiscount?t.payment.shippingDiscount:0,C=t.payment&&t.payment.ppnAmount?t.payment.ppnAmount:0,ke=t.payment&&t.payment.ppnRate?t.payment.ppnRate:0,oe=t.payment&&t.payment.grandTotal?t.payment.grandTotal:0;s.innerHTML=`
            <div class="bg-white dark:bg-slate-900 w-full max-w-lg rounded-t-3xl sm:rounded-2xl max-h-[88vh] flex flex-col shadow-2xl transform translate-y-full sm:translate-y-10 scale-100 transition-transform duration-300 border border-slate-200 dark:border-slate-700 overflow-hidden" id="order-detail-content">
                ...
                <div class="p-4 sm:p-5 overflow-y-auto flex-1 space-y-5 custom-scrollbar text-sm">
                    ...
                    <div class="bg-slate-100 dark:bg-slate-800 p-4 rounded-xl space-y-2 text-xs">
                        <div class="flex justify-between text-slate-600 dark:text-slate-400"><p>Subtotal Produk</p><p class="font-bold text-slate-800 dark:text-white">${S(K)}</p></div>
                        ...
                        ${V>0?`<div class="flex justify-between text-rose-500"><p>Diskon Promo</p><p class="font-bold">-${S(V)}</p></div>`:""}
                        ${(()=>{if(C<=0)return"";const m=t.payment?.ppnType==="inclusive",j=K-V+(F-w),de=t.payment?.dppAmount||(m?Math.round(j*100/(100+ke)):Math.max(0,j));return`
                            ...
                            <div class="flex justify-between text-amber-600 dark:text-amber-400"><p>${m?"Termasuk PPN":"PPN"} (${ke}%)</p><p class="font-bold">${m?"":"+"}${S(C)}</p></div>
                            `})()}
                        <div class="flex justify-between items-center border-t border-dashed border-slate-300 dark:border-slate-700 pt-3 mt-2">
                            ...
                            <p class="text-lg font-bold text-[var(--color-primary)]">${S(oe)}</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    `;setH("admin-content",s)},to=e=>{De=e,Ge()},ao=e=>{const t=(f.faqs||[]).find(o=>o.id===e)||{id:"",question:"",answer:"",category:"Pemesanan",authorName:"Admin",status:"published"};H("admin-faq-id",t.id),H("admin-faq-category",t.category||"Pemesanan"),H("admin-faq-author",t.authorName||"Admin"),H("admin-faq-question",t.question||""),H("admin-faq-answer",t.answer||""),H("admin-faq-status",t.status||"published"),L("admin-faq-modal-title",e?"Edit Q&A":"Tambah Q&A Baru");const a=l("modal-admin-faq"),s=l("modal-admin-faq-box");a&&(a.classList.contains("hidden")&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("adminFAQ"),ve(a,s))},jt=(e=!1)=>{const t=()=>{ye("modal-admin-faq","modal-admin-faq-box")};typeof window.requestCloseModal=="function"?window.requestCloseModal("adminFAQ",e,t):t()},so=async()=>{const e=_("admin-faq-id")||"faq-"+Date.now().toString(36),t=_("admin-faq-category"),a=(_("admin-faq-author")||"").trim()||"Admin",s=(_("admin-faq-question")||"").trim(),o=(_("admin-faq-answer")||"").trim();let r=_("admin-faq-status");if(!s)return b("Pertanyaan tidak boleh kosong!");o&&r==="pending_answer"&&(r="published"),Z("Menyimpan Q&A...");const i={id:e,question:s,answer:o,category:t,authorName:a,status:r,updatedAt:new Date().toISOString()};let n=[...f.faqs||[]];const d=n.findIndex(p=>p.id===e);d>-1?n[d]={...n[d],...i}:n.unshift(i),f.faqs=n;try{await D.collection("freshmart").doc("cms_data").collection("faqs").doc(e).set(i,{merge:!0})}catch(p){console.warn("Gagal set ke sub-koleksi faqs:",p)}try{await D.collection("freshmart").doc("cms_data").set({faqs:n},{merge:!0})}catch(p){console.warn("Gagal update cms_data.faqs:",p)}I(),jt(),b("Q&A Berhasil Disimpan!"),Ge()},oo=e=>{Tt("Hapus Q&A","Yakin ingin menghapus pertanyaan ini?",async()=>{Z("Menghapus Q&A...");let t=(f.faqs||[]).filter(a=>a.id!==e);f.faqs=t;try{await D.collection("freshmart").doc("cms_data").collection("faqs").doc(e).delete()}catch(a){console.warn("Gagal delete dari sub-koleksi faqs:",a)}try{await D.collection("freshmart").doc("cms_data").set({faqs:t},{merge:!0})}catch(a){console.warn("Gagal update cms_data.faqs:",a)}I(),b("Q&A Berhasil Dihapus!"),Ge()})};window.attachFAQRealtime=dt;window.renderStorefrontFAQ=$e;window.selectFAQCategory=Js;window.filterStorefrontFAQ=Zs;window.toggleFAQAccordion=Ys;window.openAskQuestionModal=Xs;window.closeAskQuestionModal=Nt;window.submitCustomerQuestion=eo;window.rAdmFAQ=Ge;window.setAdminFAQFilter=to;window.openFAQModal=ao;window.closeAdminFAQModal=jt;window.saveAdminFAQ=so;window.deleteAdminFAQ=oo;const ro="admgaffidigital/tokoputri",io=`https://api.github.com/repos/${ro}/releases/latest`,Xe="https://github.com/admgaffidigital/tokoputri/releases/latest/download/TokoPutri.apk";let Te=null,Ve=!1;const no=e=>!e||isNaN(e)?"8.0 MB":`${(e/(1024*1024)).toFixed(1)} MB`,lo=e=>{if(!e)return"Terbaru";try{return new Date(e).toLocaleDateString("id-ID",{day:"numeric",month:"short",year:"numeric"})}catch{return"Terbaru"}},co=async()=>{if(Te)return Te;if(Ve)return null;const e=ct(f)||"v1.8.7";Ve=!0;try{const t=await fetch(io,{headers:{Accept:"application/vnd.github.v3+json"},cache:"no-store"});if(t.ok){const a=await t.json(),s=a.assets?.find(n=>n.name?.toLowerCase().endsWith(".apk"))||a.assets?.[0],o=a.tag_name||e,r=Wt(o,e)>0,i=r?e:o;Te={tagName:i,name:`Toko Putri ${i}`,publishedAt:r?"19 Sep 2026":lo(a.published_at),fileSize:s?no(s.size):"8.0 MB",downloadUrl:s?.browser_download_url||Xe,notes:a.body||"",isLiveFetched:!0}}else throw new Error(`GitHub API HTTP ${t.status}`)}catch{const a=ct(f)||"v1.8.7";Te={tagName:a,name:`Toko Putri ${a}`,publishedAt:"19 Sep 2026",fileSize:"8.0 MB",downloadUrl:Xe,notes:"",isLiveFetched:!1}}finally{Ve=!1}return Te},po=()=>{let e=l("app-download-modal");return e||(e=document.createElement("div"),e.id="app-download-modal",e.className="fixed inset-0 z-[125] bg-slate-950/80 backdrop-blur-xs flex items-end sm:items-center justify-center p-0 sm:p-4 opacity-0 transition-opacity duration-300",e.onclick=t=>{t.target===e&&Ot()},e.innerHTML=`
    ...
    <button onclick="setCat('Semua Produk'); closeCategoryModal()" class="w-full flex items-center gap-3.5 p-3 sm:p-3.5 rounded-2xl border transition-all active:scale-[0.98] ${t?"bg-[rgba(var(--color-primary-rgb),0.08)] border-[var(--color-primary)] dark:bg-[rgba(var(--color-primary-rgb),0.12)] dark:border-[var(--color-primary)] shadow-[0_0_0_1px_rgba(var(--color-primary-rgb),0.2)]":"bg-slate-50 border-slate-200 dark:bg-slate-800/50 dark:border-slate-700 hover:border-[var(--color-primary)]/40 dark:hover:border-[var(--color-primary)]/40"} group">
        ...
        </button>`});const a=l("modal-category-list");a&&(a.innerHTML=`<div class="flex flex-col gap-2.5 pb-6 w-full">${e}</div>`);const s=l("category-modal"),o=l("category-modal-content");s&&o&&(s.classList.contains("hidden")&&we("category"),ve(s,o))};window.openCategoryModal=ho;window.openBrandModal=()=>{let e="",t=We==="Semua Merek";e+=`
    <button onclick="setBrand('Semua Merek'); closeBrandModal()" class="flex flex-col items-center justify-start p-2.5 sm:p-3.5 rounded-2xl border transition-all ${t?"bg-[rgba(var(--color-primary-rgb),0.08)] border-[var(--color-primary)] dark:bg-[rgba(var(--color-primary-rgb),0.12)] dark:border-[var(--color-primary)] shadow-[0_0_0_1px_rgba(var(--color-primary-rgb),0.2)]":"bg-slate-50 border-slate-200 dark:bg-slate-800/50 dark:border-slate-700 hover:border-[var(--color-primary)]/40 dark:hover:border-[var(--color-primary)]/40"} group">
        ...
        </button>`});const a=l("modal-brand-grid");a&&(a.innerHTML=e);const s=l("brand-modal"),o=l("brand-modal-content");s&&o&&(s.classList.contains("hidden")&&we("brand"),ve(s,o))};window.closeCategoryModal=(e=!1)=>{const t=l("category-modal"),a=l("category-modal-content");t&&a&&te("category",e,()=>{ye(t,a)})};window.closeBrandModal=(e=!1)=>{const t=l("brand-modal"),a=l("brand-modal-content");t&&a&&te("brand",e,()=>{ye(t,a)})};window.openQuickMenuModal=()=>{const e=l("quickmenu-modal"),t=l("quickmenu-modal-content");e&&t&&(e.classList.contains("hidden")&&we("quickmenu"),ve(e,t))};window.openTermsModal=()=>{const e=`
      <div class="space-y-3">
    ...
    `,t=f?.store?.terms,a=t?t.includes("<")?t:`<div class="p-4 rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50/60 dark:bg-slate-800/40 leading-relaxed text-xs sm:text-sm text-slate-600 dark:text-slate-300 whitespace-pre-line">${t}</div>`:e;N("terms-modal-content-body",a);const s=l("terms-modal"),o=l("terms-modal-content");s&&o&&(s.classList.contains("hidden")&&we("terms"),ve(s,o))};window.closeTermsModal=(e=!1)=>{const t=l("terms-modal"),a=l("terms-modal-content");t&&a&&te("terms",e,()=>{ye(t,a)})};window.openPrivacyModal=()=>{const e=`
      <div class="space-y-3">
        <div class="p-3.5 rounded-2xl bg-[rgba(var(--color-primary-rgb),0.06)] border border-[rgba(var(--color-primary-rgb),0.2)] flex items-start gap-3">
