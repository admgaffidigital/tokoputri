import{d as p}from"./module-member-Cvflw9kg.js";import{a2 as S,a as o,a0 as f,t as i,e as d,b as L,u as P,i as N}from"./module-print-C2-MjUR_.js";import"./vendor-firebase-core-D2OF5R23.js";import"./vendor-firebase-db-BIUZcnOd.js";let C=localStorage.getItem("tokoputri_last_sync")||new Date().toISOString(),D=!1,u={products:0,categories:0,orders:0,customers:0,cashiers:0,shifts:0};const w=e=>{if(!e)return"-";try{return new Date(e).toLocaleDateString("id-ID",{day:"numeric",month:"short",year:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit"})+" WIB"}catch{return e}},T=async()=>{d("admin-content")&&(u.products=(o.products||[]).length,u.categories=(o.categories||[]).length,L("admin-content",`
            ...
            <div class="p-5 space-y-4 text-xs">
                <div class="p-3.5 rounded-2xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200/80 dark:border-slate-700 space-y-2">
                    <div class="flex justify-between items-center text-slate-500">
                        ...
                        <span class="font-bold text-slate-800 dark:text-slate-100 truncate max-w-[200px]">${N(e)}</span>
                    </div>
                    <div class="flex justify-between items-center text-slate-500">
                        <span>Waktu Cadangan:</span>
                        <span class="font-bold text-slate-800 dark:text-slate-100">${N(t)}</span>
                    </div>
                    <div class="flex justify-between items-center text-slate-500">
