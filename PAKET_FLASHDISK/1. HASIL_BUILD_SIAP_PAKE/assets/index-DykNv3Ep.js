import{f as Be}from"./vendor-firebase-core-D2OF5R23.js";import"./vendor-firebase-db-BIUZcnOd.js";import{p as ta}from"./vendor-utils-Bszxp-Ae.js";import{d as C,g as aa,u as sa,h as oa,a as Mt,t as ra,b as Pt,i as ia,l as ft,c as na,s as la,e as da,f as ca,j as wt,k as We,m as pa,A as At,n as ma,o as bt,p as ua,q as Tt,r as fa,v as wa,w as ba}from"./module-admin-BIcYrQUy.js";import{e as l,Q as N,a as m,g as K,c as L,i as B,f as D,aj as w,h as A,j as p,ak as W,al as Y,am as se,an as V,ao as oe,ap as v,A as Z,d as _,a3 as ot,ae as Je,b as Fe,a4 as me,R as J,S as I,aq as U,ar as je,s as St,m as Q,as as Dt,k as b,a7 as Ue,a2 as rt,l as Ct,z,o as he,x as ve,K as $t,D as it,M as Rt,F as Ye,E as Ze,a0 as ga,at as xa,au as ha,r as va,ab as ya,ad as ka,ac as Ma,af as Pa,av as Aa,aw as Ta,ax as Sa,w as Da,ay as Ca,N as $a,G as Ra,O as La,I as Ea,P as Ia,J as Fa,B as _a,az as Na,C as Ba,aA as Oa,aB as ja,aC as Ua,y as qa,p as Ga,v as Ka,q as Ha,aD as Va,aE as Qa,aF as Wa,u as za,t as Ja,aG as Ya,U as Za,T as Xa,W as es,V as ts,Y as as,X as ss,a6 as os,$ as rs,ag as is,a8 as ns,a1 as ls,a5 as ds,aH as cs,aa as ps,a9 as ms,_ as us,Z as fs,aI as ws,aJ as bs,ah as gs,ai as xs,aK as hs,aL as vs,aM as ys,aN as ks,aO as Ms}from"./module-print-CDLpN0fO.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))s(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function a(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(o){if(o.ep)return;o.ep=!0;const r=a(o);fetch(o.href,r)}})();let qe="https://script.google.com/macros/s/AKfycbx3dW9rHcdoKNYjSOJ8PoH2k6fABe7XlBD9teNHsBlCBqJquq8jd4UvnfXZVsfKdFsC/exec";const Lt=()=>{l("voucher-input");const e=(N("voucher-input")||"").toUpperCase().trim(),t=(m.vouchers||[]).find(o=>(o.code||"").toUpperCase()===e);K("voucher-msg-container");const a=typeof window.getEffP=="function"?window.getEffP:o=>o.effectivePrice||o.price||0,s=L.reduce((o,r)=>o+(parseFloat(a(r))||0)*(parseFloat(r.qty)||0),0);if(t){let o=!0;t.targetProduct&&t.targetProduct!==""&&(o=L.some(r=>r&&String(r.id)===String(t.targetProduct))),t.targetProduct&&t.targetProduct!==""&&!o?(W(null),B("voucher-msg",'<i class="fa-solid fa-box mr-1"></i> Khusus Produk Tertentu!'),l("voucher-msg")&&(l("voucher-msg").className="text-sm font-bold text-rose-500 dark:text-rose-400")):t.minPurchase&&parseFloat(t.minPurchase)>0&&s<parseFloat(t.minPurchase)?(W(null),B("voucher-msg",`<i class="fa-solid fa-circle-exclamation mr-1"></i> Minimal belanja ${D(t.minPurchase)}`),l("voucher-msg")&&(l("voucher-msg").className="text-sm font-bold text-amber-500 dark:text-amber-400")):t.type&&t.type.includes("shipping")&&w.deliveryMethod!=="delivery"?(W(null),B("voucher-msg",'<i class="fa-solid fa-motorcycle mr-1"></i> Khusus pesanan dikirim kurir!'),l("voucher-msg")&&(l("voucher-msg").className="text-sm font-bold text-rose-500 dark:text-rose-400")):(W(t),B("voucher-msg",'<i class="fa-solid fa-check-circle mr-1"></i> Voucher Diterapkan!'),l("voucher-msg")&&(l("voucher-msg").className="text-sm font-bold text-[var(--color-primary)]"))}else e===""?(W(null),A("voucher-msg-container"),typeof window.rPay=="function"&&window.rPay()):(W(null),B("voucher-msg",'<i class="fa-solid fa-times-circle mr-1"></i> Kode Tidak Valid'),l("voucher-msg")&&(l("voucher-msg").className="text-sm font-bold text-rose-500 dark:text-rose-400"));typeof window.rPay=="function"&&window.rPay()},Ps=()=>{let e=document.getElementById("voucher-modal");e||(e=document.createElement("div"),e.id="voucher-modal",e.className="fixed inset-0 z-[115] bg-slate-900/80 flex items-end sm:items-center justify-center p-0 sm:p-5",e.onclick=s=>{s.target===e&&nt()},document.body.appendChild(e));const t=(m.vouchers||[]).filter(s=>s.isShow!==!1&&s.isShow!=="false"),a=t.length?t.map(s=>{let o="";s.type==="percent"?o=`Diskon ${s.value}%`:s.type==="shipping_free"?o="Gratis Ongkir":s.type==="shipping_flat"?o=`Diskon Ongkir ${D(s.value)}`:o=`Potongan ${D(s.value)}`;const r=s.minPurchase&&parseFloat(s.minPurchase)>0?`Min. belanja ${D(s.minPurchase)}`:"Tanpa minimal belanja";return`
    ...
    <div class="flex gap-2.5 sm:gap-3 overflow-x-auto hide-scrollbar snap-x pb-3 pt-1">
        ...
        </div>`,xe(),t.style.opacity="0",t.style.display="flex",requestAnimationFrame(()=>{t.style.transition="opacity 0.25s ease",t.style.opacity="1"}),!a&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("member")},xe=()=>{const e=(m.rewards||[]).filter(o=>o.isActive!=="false"&&o.isActive!==!1),t=V&&parseFloat(V.points)||0,a=Ge(t),s=e.length?e.map(o=>{const r=(parseFloat(o.stock)||0)>0,i=V&&t>=(parseFloat(o.pointsCost)||0)&&r,n=oe&&oe.id===o.id;return`
        ...
        </div>`}).join(""):'<p class="text-[11px] font-bold text-slate-400 text-center py-3">Belum ada program hadiah yang tersedia.</p>';V?B("member-modal-body",`
        ...
        </div>`}).join("")+(oe?`<div class="flex justify-between items-center bg-[rgba(var(--color-primary-rgb),0.06)] dark:bg-[rgba(var(--color-primary-rgb),0.12)] p-4 rounded-2xl border border-[var(--color-primary)]/30 shadow-sm min-w-0"><div class="flex items-center gap-3.5 min-w-0"><div class="w-12 h-12 rounded-xl bg-[var(--color-primary)] text-white flex items-center justify-center shrink-0"><i class="fa-solid fa-gift"></i></div><div class="min-w-0"><p class="text-sm font-bold text-[var(--color-primary)] truncate">${p(oe.name)}</p><p class="text-[11px] text-[var(--color-primary)] font-bold mt-1"><i class="fa-solid fa-star mr-1"></i>Tukar ${oe.pointsCost} Poin (Gratis)</p></div></div><button type="button" onclick="if(typeof deselectReward==='function') deselectReward(); rPay();" class="text-[10px] font-bold text-rose-500 uppercase shrink-0 ml-3">Batal</button></div>`:"")),w.note?(_("payment-note-text",`"${p(w.note)}"`),K("payment-note-preview")):A("payment-note-preview"),B("dynamic-banks-container",m.banks?.length?m.banks.map(x=>`<div class="bg-white dark:bg-slate-800 p-4 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm"><p class="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1">Bank ${p(x.bankName)}</p><p class="text-lg font-bold text-[var(--color-primary)] tracking-wide">${p(x.bankAccount)}</p><p class="text-xs text-slate-500 dark:text-slate-400 font-medium mt-1.5">a.n <span class="font-bold text-slate-700 dark:text-white">${p(x.bankOwner)}</span></p></div>`).join(""):'<div class="bg-rose-50 dark:bg-rose-900/20 border border-rose-200 p-4 rounded-2xl text-center"><p class="text-sm text-rose-500 dark:text-rose-400 font-bold">Rekening belum diatur.</p></div>');const P=l("payment-option-cashier"),H=l("payment-option-cod");if(P&&H){if(w.deliveryMethod==="pickup"){if(K("payment-option-cashier"),A("payment-option-cod"),(document.querySelector('input[name="payment"]:checked')||{}).value==="cod"){const x=document.querySelector('input[value="cashier"]');x&&(x.checked=!0)}}else{A("payment-option-cashier"),K("payment-option-cod");const x=(document.querySelector('input[name="payment"]:checked')||{}).value;if(x==="cashier"||!x){const S=document.querySelector('input[value="cod"]');S&&(S.checked=!0)}}typeof window.togglePaymentDetails=="function"&&window.togglePaymentDetails()}const E=l("tnc-checkbox");E&&(E.checked=!1,_t())},Os=async()=>{if(!l("tnc-checkbox").checked||ot)return;if(window.isAdm){typeof window.showToast=="function"&&window.showToast("Anda login sebagai Seller. Logout dulu untuk membuat pesanan.");return}const e=Je("freshmart_last_order");if(e&&Date.now()-parseInt(e)<6e4){typeof window.showToast=="function"&&window.showToast("Tunggu 1 menit untuk pesanan baru!");return}const t=typeof window.getEffP=="function"?window.getEffP:r=>r.price||0,a=typeof window.getEffHpp=="function"?window.getEffHpp:()=>0,s=typeof window.getEffPoin=="function"?window.getEffPoin:()=>0;let o=!1;if(L.forEach(r=>{const i=m.products.find(d=>d.id===r.id);if(!i)return;const n=r.variantName?((i.variants||[]).find(d=>d.name===r.variantName)||{}).price??i.price:i.price;n!==void 0&&Math.abs(r.price-n)>1&&(r.price=n,o=!0),r.poin=s(r)}),o){Fe("freshmart_cart",JSON.stringify(L)),typeof window.renderCart=="function"&&window.renderCart(),Nt(),typeof window.showToast=="function"&&window.showToast("Harga produk telah diperbarui. Periksa kembali sebelum order.");return}me(!0),J("Proses Pesanan...");try{const r=L.reduce((g,T)=>g+(parseFloat(t(T))||0)*(parseFloat(T.qty)||0),0);let i=0,n=0,d=0;w.deliveryMethod==="delivery"&&(i=Math.ceil((parseFloat(w.distance)||0)*(parseFloat(m.store.costPerKm)||0)/500)*500);const c=m.store.useStock===!0||m.store.useStock==="true";if(c)for(const g of L){const T=m.products.find(y=>y.id===g.id);if(!T)continue;const q=parseFloat(g.qty)||0;if(g.variantName){const y=(T.variants||[]).find(F=>F.name===g.variantName),R=parseFloat(y&&y.stock!==void 0?y.stock:0);if(R<q){me(!1),I(),typeof window.showToast=="function"&&window.showToast(`Stok ${g.name} (${g.variantName}) tidak cukup! Sisa: ${R}`);return}}else{const y=parseFloat(T.stock!==void 0?T.stock:0);if(y<q){me(!1),I(),typeof window.showToast=="function"&&window.showToast(`Stok ${g.name} tidak cukup! Sisa: ${y}`);return}}}if(v){let g=r;if(v.targetProduct&&v.targetProduct!==""){const T=parseInt(v.targetProduct);g=L.filter(y=>y.id===T).reduce((y,R)=>y+(parseFloat(t(R))||0)*(parseFloat(R.qty)||0),0)}if(v.minPurchase&&parseFloat(v.minPurchase)>0&&r<parseFloat(v.minPurchase))W(null);else if(v.targetProduct&&v.targetProduct!==""&&g===0)W(null);else if(v.type&&v.type.includes("shipping")&&w.deliveryMethod!=="delivery")W(null);else if(v.type==="shipping_free")n=i;else if(v.type==="shipping_flat")n=parseFloat(v.value)||0;else if(v.type==="percent"){let T=g*((parseFloat(v.value)||0)/100);v.maxDiscount&&parseFloat(v.maxDiscount)>0&&(T=Math.min(T,parseFloat(v.maxDiscount))),d=T}else d=parseFloat(v.value)||0,d=Math.min(d,g)}const u=(m.store.freeShippingMinSpendEnabled===!0||m.store.freeShippingMinSpendEnabled==="true")&&(parseFloat(m.store.freeShippingMinSpendAmount)||0)>0&&r>=(parseFloat(m.store.freeShippingMinSpendAmount)||0)&&w.deliveryMethod==="delivery";u&&(n=i),n=Math.min(n,i),d=Math.min(d,r);const h=Math.max(0,r-d+(i-n)),P=(typeof window.calcTaxDetails=="function"?window.calcTaxDetails:()=>({ppnEnabled:!1,ppnAmount:0,grandTotalAdd:0}))(h),H=P.ppnAmount,E=P.dppAmount,x=h+P.grandTotalAdd,S=(document.querySelector('input[name="payment"]:checked')||{}).value,le=S==="transfer"||S==="qris"||S==="tempo",we=window.buktiGDriveUploaded&&window.buktiPaymentUrl&&!window.buktiPaymentUrl.startsWith("data:");if(le&&!we){if(me(!1),I(),!window.buktiPaymentFile){typeof window.showToast=="function"&&window.showToast("Upload bukti pembayaran terlebih dahulu!");return}typeof window.showToast=="function"&&window.showToast("Tunggu upload Google Drive selesai, atau coba lagi!");return}const de="ORD-"+Date.now().toString(36).toUpperCase()+"-"+Math.random().toString(36).substring(2,6).toUpperCase();if(window.buktiPaymentFile&&!window.buktiGDriveUploaded)try{J("Upload Bukti ke Google Drive...");const g=await window.uploadBuktiToFirebase(window.buktiPaymentFile,de);if(g&&!g.startsWith("data:"))window.buktiPaymentUrl=g,window.buktiGDriveUploaded=!0;else{me(!1),I(),typeof window.showToast=="function"&&window.showToast("❌ Upload bukti ke Google Drive gagal. Coba pilih gambar lagi!");return}J("Proses Pesanan...")}catch{me(!1),I(),typeof window.showToast=="function"&&window.showToast("❌ Gagal upload bukti. Periksa koneksi dan coba lagi!");return}const f={orderId:de,timestamp:Be.firestore.FieldValue.serverTimestamp(),dateString:new Date().toISOString(),customer:w,items:L.map(g=>({...g,qty:parseFloat(g.qty),effectivePrice:t(g),poTime:g.poTime||"",hpp:a(g),poin:s(g)})),payment:{method:S,subtotal:r,shippingCost:i,shippingDiscount:n,productDiscount:d,ppnAmount:H,dppAmount:E,ppnRate:P.ppnEnabled?P.ppnRate:0,ppnType:P.ppnEnabled?P.ppnType:"exclusive",grandTotal:x,isFreeShippingPromo:u||!1},status:"Baru",buktiPayment:window.buktiPaymentUrl||null};if(S==="tempo"){const g=document.getElementById("tempo-dp-input");let T=g&&parseFloat(g.value)||0;T>x&&(T=x),f.payment.tempoDp=T,f.payment.tempoBalance=x-T,f.payment.tempoDueDate=Date.now()+30*24*60*60*1e3,f.payment.paymentStatus="hutang"}const O=C.collection("freshmart_orders").doc(de),ce=typeof window.calculateCartPoints=="function"?window.calculateCartPoints(L,m.store):{totalPoints:0,directPoints:0,spendPoints:0},pe=ce.totalPoints;f.pointsEarned=pe,f.pointsBreakdown={direct:ce.directPoints,spend:ce.spendPoints};const $e=C.collection("freshmart").doc("cms_data"),te=w.wa?$e.collection("customers").doc(w.wa):null,Re=!!oe;let be=null;if(c){const g={};L.forEach(y=>{const R=y.id!=null?y.id.toString():null;if(!R)return;g[R]||(g[R]={main:0,variants:{}});const F=parseFloat(y.qty)||0;y.variantName?g[R].variants[y.variantName]=(g[R].variants[y.variantName]||0)+F:g[R].main+=F});const T=Object.keys(g),q=T.map(y=>C.collection("freshmart").doc("cms_data").collection("products").doc(y));await C.runTransaction(async y=>{const R=Re?C.collection("freshmart").doc("cms_data").collection("rewards").doc(oe.id.toString()):null,F=await Promise.all(q.map(j=>y.get(j))),G=te?await y.get(te):null,ae=G&&G.exists&&R?await y.get(R):null,Le=[];if(F.forEach((j,Ie)=>{if(!j.exists)return;const ge=j.data(),X=g[T[Ie]];if(X.main>0){const $=parseFloat(ge.stock!==void 0?ge.stock:0);$<X.main&&Le.push(`${ge.name} (sisa ${$})`)}Object.keys(X.variants).forEach($=>{const ue=(ge.variants||[]).find(ye=>ye.name===$),De=parseFloat(ue&&ue.stock!==void 0?ue.stock:0);De<X.variants[$]&&Le.push(`${ge.name} (${$}, sisa ${De})`)})}),Le.length)throw new Error("STOK_TIDAK_CUKUP: "+Le.join(", "));let Qe=null,Se=null;const ut=G&&G.exists&&parseFloat(G.data().points)||0;let Ee=ut;if(Re){if(!G||!G.exists)throw new Error("MEMBER_TIDAK_DITEMUKAN");if(!ae||!ae.exists)throw new Error("HADIAH_TIDAK_DITEMUKAN");const j=ae.data();if(ut<(parseFloat(j.pointsCost)||0))throw new Error("POIN_TIDAK_CUKUP");if((parseFloat(j.stock)||0)<=0)throw new Error("STOK_HADIAH_HABIS");Qe=(parseFloat(j.stock)||0)-1,Ee-=parseFloat(j.pointsCost)||0,f.claimedReward={id:j.id,name:j.name,pointsCost:parseFloat(j.pointsCost)||0,status:"pending",note:""}}if(Ee+=pe,Se=Ee,f.pointsEarned=pe,f.customerPhone=w.wa,f.finalMemberPoints=Ee,F.forEach((j,Ie)=>{if(!j.exists)return;const ge=T[Ie],X=g[ge],$=JSON.parse(JSON.stringify(j.data())),ue={};X.main>0&&($.stock=Math.max(0,(parseFloat($.stock)||0)-X.main),ue.stock=$.stock,$.stock===0&&($.isActive="false",ue.isActive="false"),$.totalSold=(parseFloat($.totalSold)||0)+X.main,ue.totalSold=$.totalSold),Object.keys(X.variants).length>0&&$.variants&&(Object.keys(X.variants).forEach(ye=>{const ke=($.variants||[]).findIndex(ea=>ea.name===ye);ke>-1&&($.variants[ke].stock=Math.max(0,(parseFloat($.variants[ke].stock)||0)-X.variants[ye]),$.variants[ke].stock===0&&($.variants[ke].isActive=!1),$.variants[ke].totalSold=(parseFloat($.variants[ke].totalSold)||0)+X.variants[ye])}),ue.variants=$.variants);const De=m.products.findIndex(ye=>ye.id.toString()===ge);De>-1&&(m.products[De]=$),y.update(q[Ie],ue)}),y.set(O,f),te&&Se!==null){const j={points:Se,name:w.name||(G&&G.exists?G.data().name:"Pelanggan Setia"),lastOrderAt:Date.now()};G&&G.exists?y.set(te,j,{merge:!0}):y.set(te,{id:w.wa,phone:w.wa,name:w.name||"Pelanggan Setia",points:Se,createdAt:Date.now(),lastOrderAt:Date.now(),totalOrders:1},{merge:!0}),be=Se}Qe!==null&&y.set(R,{stock:Qe},{merge:!0}),y.update($e,{lastUpdate:Be.firestore.FieldValue.increment(1),updateType:"stock_change",updatedProductIds:T})}),m.lastUpdate=(parseInt(Je("freshmart_last_update"))||m.lastUpdate||0)+1,Fe("freshmart_last_update",m.lastUpdate.toString()),Fe("freshmart_products",JSON.stringify(m.products))}else te?await C.runTransaction(async g=>{const T=Re?C.collection("freshmart").doc("cms_data").collection("rewards").doc(oe.id.toString()):null,q=await g.get(te),y=q.exists&&T?await g.get(T):null,R=q.exists&&parseFloat(q.data().points)||0;let F=R,G=null;if(Re){if(!q.exists)throw new Error("MEMBER_TIDAK_DITEMUKAN");if(!y||!y.exists)throw new Error("HADIAH_TIDAK_DITEMUKAN");const ae=y.data();if(R<(parseFloat(ae.pointsCost)||0))throw new Error("POIN_TIDAK_CUKUP");if((parseFloat(ae.stock)||0)<=0)throw new Error("STOK_HADIAH_HABIS");G=(parseFloat(ae.stock)||0)-1,F-=parseFloat(ae.pointsCost)||0,f.claimedReward={id:ae.id,name:ae.name,pointsCost:parseFloat(ae.pointsCost)||0,status:"pending",note:""}}F+=pe,memberPointsUpdated=F,f.pointsEarned=pe,f.customerPhone=w.wa,f.finalMemberPoints=F,g.set(O,f),q.exists?g.set(te,{points:F,name:w.name||q.data().name||"Pelanggan Setia",lastOrderAt:Date.now()},{merge:!0}):g.set(te,{id:w.wa,phone:w.wa,name:w.name||"Pelanggan Setia",points:F,createdAt:Date.now(),lastOrderAt:Date.now(),totalOrders:1},{merge:!0}),be=F,G!==null&&g.set(T,{stock:G},{merge:!0})}):await O.set(f);U.unshift({orderId:de,date:new Date().toISOString(),total:x,itemCount:L.reduce((g,T)=>g+parseFloat(T.qty),0),status:"Baru",pointsEarned:f.pointsEarned||0,claimedReward:f.claimedReward||null,finalMemberPoints:be}),je(U);try{localStorage.setItem("freshmart_my_orders",JSON.stringify(U)),localStorage.setItem("freshmart_last_order",Date.now().toString())}catch{}if(typeof analytics<"u"&&analytics.logEvent("purchase",{transaction_id:de,value:x,currency:"IDR"}),be===null&&(be=pe),w.wa){const g={id:w.wa,phone:w.wa,name:w.name||"Pelanggan Setia",points:be};Y(g);try{localStorage.setItem("freshmart_current_member",JSON.stringify(g)),localStorage.setItem("freshmart_member_wa",w.wa)}catch{}typeof window.invalidateMemberCache=="function"&&window.invalidateMemberCache(w.wa)}if(f.claimedReward&&be!==null)typeof window.showToast=="function"&&window.showToast(`✅ Hadiah "${f.claimedReward.name}" berhasil ditukar! Sisa poin Anda: ${be}`);else{const g=pe>0?` (+${pe} Poin Member didapat!)`:"";typeof window.showToast=="function"&&window.showToast(`✅ Pesanan berhasil dikirim ke admin!${g}`)}setTimeout(()=>{St([]),Q("cust-name",""),Q("cust-address",""),Q("cust-maps-input",""),Q("cust-note",""),Q("cust-wa",""),window.buktiPaymentUrl=null,window.buktiPaymentFile=null,window.buktiGDriveUploaded=!1;const g=l("bukti-preview-wrap"),T=l("bukti-placeholder");g&&g.classList.add("hidden"),T&&T.classList.remove("hidden"),A("bukti-uploading"),A("bukti-success"),A("bukti-gdrive-error");const q=l("bukti-file-input");q&&(q.value=""),Dt({name:"",address:"",lat:null,lng:null,deliveryMethod:"delivery",distance:0,note:"",wa:""}),W(null),se(null);const y=l("member-status-banner");y&&A(y),l("voucher-input")&&(l("voucher-input").value=""),A("voucher-msg-container"),A("location-status"),l("btn-location")&&K("btn-location");const R=document.querySelector('input[name="delivery-method"][value="delivery"]');R&&(R.checked=!0,lt());const F=document.querySelector('input[name="payment"][value="transfer"]');F&&(F.checked=!0,typeof window.togglePaymentDetails=="function"&&window.togglePaymentDetails()),typeof window.updCart=="function"&&window.updCart(),typeof window.renderCart=="function"&&window.renderCart(),typeof window.changeView=="function"&&window.changeView("view-catalog"),typeof window.showToast=="function"&&window.showToast("Pesanan Dibuat! 🎉")},2e3)}catch(r){const i=r.message||"Error";i.startsWith("STOK_TIDAK_CUKUP:")?typeof window.showToast=="function"&&window.showToast("Maaf, stok berubah: "+i.replace("STOK_TIDAK_CUKUP: ","")):i==="POIN_TIDAK_CUKUP"?(typeof window.showToast=="function"&&window.showToast("Maaf, poin Anda ternyata tidak cukup untuk hadiah ini. Silakan cek lagi."),se(null)):i==="STOK_HADIAH_HABIS"?(typeof window.showToast=="function"&&window.showToast("Maaf, stok hadiah yang dipilih baru saja habis. Silakan pilih hadiah lain."),se(null)):i==="HADIAH_TIDAK_DITEMUKAN"?(typeof window.showToast=="function"&&window.showToast("Hadiah yang dipilih sudah tidak tersedia. Silakan pilih ulang."),se(null)):i==="MEMBER_TIDAK_DITEMUKAN"?(typeof window.showToast=="function"&&window.showToast("Data member tidak ditemukan, klaim hadiah dibatalkan. Pesanan bisa dicoba lagi tanpa hadiah."),se(null)):typeof window.showToast=="function"&&window.showToast(r.code==="resource-exhausted"?"Quota Server Penuh!":"Gagal proses: "+i)}finally{me(!1),I()}};window.validateAndGoToPayment=Bs;window.toggleDeliveryMethod=lt;window.toggleOrderButton=_t;window.rPay=Nt;window.processOrder=Os;window.getLocation=()=>{if(!navigator.geolocation)return b("GPS tidak didukung");l("btn-location").innerHTML='<i class="fa-solid fa-spinner fa-spin text-sm"></i>',navigator.geolocation.getCurrentPosition(e=>{w.lat=e.coords.latitude,w.lng=e.coords.longitude,A("btn-location"),K("location-status"),l("location-status").classList.add("flex"),b("GPS Didapatkan")},e=>{l("btn-location").innerHTML='<i class="fa-solid fa-location-crosshairs text-[var(--color-primary)]"></i> Set GPS Maps',b("Gagal akses GPS")},{enableHighAccuracy:!0,timeout:15e3})};window.handleCustomerMapsInput=e=>{const t=typeof window.parseGeoCoordinates=="function"?window.parseGeoCoordinates:null,a=t?t(e):null;if(a){w.lat=parseFloat(a.lat),w.lng=parseFloat(a.lng),A("btn-location"),K("location-status");const s=l("location-status");return s&&(s.classList.add("flex"),s.innerHTML=`
        ...
        <div class="bg-white dark:bg-slate-800 p-4 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm relative overflow-hidden group min-w-0 transition-all hover:border-[var(--color-primary)]/40">
            ...
            <div class="flex gap-3 items-center border-b border-slate-100 dark:border-slate-700/50 py-3 last:border-0">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    `:""}
                    <p class="text-[10px] font-medium text-slate-500 dark:text-slate-400">${O} ${p(f.unit||"pcs")} x ${D(ce)}</p>
            ...
            `}).join("");let P="Tanggal Tidak Tersedia";try{let f;if(t.timestamp&&typeof t.timestamp.toDate=="function")f=t.timestamp.toDate();else{const O=t.timestamp||t.dateString||Date.now();if(typeof O=="number")f=new Date(O);else if(!isNaN(Number(O))&&String(O).trim()!=="")f=new Date(Number(O));else{const ce=String(O).replace(/-/g,"/").replace("T"," ").replace(/\..*$/,"");f=new Date(O),isNaN(f.getTime())&&(f=new Date(ce))}}f&&!isNaN(f.getTime())&&(P=f.toLocaleString("id-ID",{day:"numeric",month:"short",year:"numeric",hour:"2-digit",minute:"2-digit"}))}catch(f){console.error("Gagal memproses tanggal:",f)}const H=t.payment&&t.payment.subtotal?t.payment.subtotal:0,E=t.payment&&t.payment.shippingCost?t.payment.shippingCost:0,x=t.payment&&t.payment.productDiscount?t.payment.productDiscount:0,S=t.payment&&t.payment.shippingDiscount?t.payment.shippingDiscount:0,le=t.payment&&t.payment.ppnAmount?t.payment.ppnAmount:0,we=t.payment&&t.payment.ppnRate?t.payment.ppnRate:0,de=t.payment&&t.payment.grandTotal?t.payment.grandTotal:0;s.innerHTML=`
            <div class="bg-white dark:bg-slate-900 w-full max-w-lg rounded-t-3xl sm:rounded-2xl max-h-[88vh] flex flex-col shadow-2xl transform translate-y-full sm:translate-y-10 scale-100 transition-transform duration-300 border border-slate-200 dark:border-slate-700 overflow-hidden" id="order-detail-content">
                ...
                <div class="p-4 sm:p-5 overflow-y-auto flex-1 space-y-5 custom-scrollbar text-sm">
                    ...
                    <div class="bg-slate-100 dark:bg-slate-800 p-4 rounded-xl space-y-2 text-xs">
                        ...
                        ${(()=>{if(le<=0)return"";const f=t.payment?.ppnType==="inclusive",O=H-x+(E-S),ce=t.payment?.dppAmount||(f?Math.round(O*100/(100+we)):Math.max(0,O));return`
        ...
        <div class="bg-white dark:bg-slate-900 w-full max-w-lg rounded-t-3xl sm:rounded-2xl max-h-[85vh] flex flex-col shadow-2xl border border-slate-200 dark:border-slate-700">
            ...
            </div>`;if(!o.length){B("product-modal-reviews-container",n+'<p class="text-[11px] font-bold text-slate-400 text-center py-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl">Belum ada ulasan untuk produk ini.</p>');return}const d=o.map(c=>{let u="";try{c.createdAt&&c.createdAt.toDate&&(u=c.createdAt.toDate().toLocaleDateString("id-ID",{day:"numeric",month:"short",year:"numeric"}))}catch{}return`
            ...
            </div>`}).join("");B("product-modal-reviews-container",n+`<div class="space-y-3">${d}</div>`)},s=tt.get(e);if(s&&Date.now()-s.timestamp<Js){a(s.data);return}B("product-modal-reviews-container",'<div class="text-center py-6"><i class="fa-solid fa-spinner fa-spin text-xl text-slate-300"></i></div>');try{let r=(await C.collection("freshmart").doc("cms_data").collection("reviews").where("productId","==",e).get()).docs.map(i=>i.data()).filter(i=>i.isVisible!==!1);r.sort((i,n)=>{const d=i.createdAt&&i.createdAt.toMillis?i.createdAt.toMillis():0;return(n.createdAt&&n.createdAt.toMillis?n.createdAt.toMillis():0)-d}),tt.set(e,{data:r,timestamp:Date.now()}),a(r)}catch(o){console.warn("Gagal memuat ulasan:",o),B("product-modal-reviews-container",'<p class="text-[11px] text-slate-400 text-center py-4">Belum ada ulasan yang dapat dimuat.</p>')}};window.openReviewModal=Vs;window.setReviewRating=Qs;window.handleReviewPhotoSelect=Ws;window.removeReviewPhoto=zs;window.closeReviewModal=dt;window.submitReview=ct;window.submitProductReview=ct;window.loadProductReviews=Ys;let ht=null;const pt=()=>{if(!ht)try{ht=C.collection("freshmart").doc("cms_data").collection("faqs").onSnapshot(e=>{e&&e.docs&&(m.faqs=e.docs.map(t=>({id:t.id,...t.data()}))),typeof window.curViewName<"u"&&window.curViewName==="view-faq"&&Te(),window.isAdm&&typeof window.cTab<"u"&&window.cTab==="faqs"&&typeof window.rAdmFAQ=="function"&&window.rAdmFAQ()},e=>{console.warn("Sync sub-koleksi faqs dibatasi, menggunakan fallback cms_data.faqs:",e.message),typeof window.curViewName<"u"&&window.curViewName==="view-faq"&&Te(),window.isAdm&&typeof window.cTab<"u"&&window.cTab==="faqs"&&typeof window.rAdmFAQ=="function"&&window.rAdmFAQ()})}catch{console.warn("Fallback sync Q&A dari cms_data aktif")}};let _e="Semua";const Te=()=>{pt();const e=document.getElementById("storefront-faq-container"),t=document.getElementById("faq-category-pills");if(!e)return;const a=(m.faqs||[]).filter(i=>i.status==="published"),s=["Semua","Pemesanan","Pengiriman","Pembayaran","Garansi","Lainnya"];t&&(t.innerHTML=s.map(i=>`
    ...
    `).join("")},Zs=e=>{_e=e,Te()},Xs=()=>{Te()},eo=e=>{const t=document.getElementById(`faq-body-${e}`),a=document.getElementById(`faq-icon-${e}`);if(!t||!a)return;t.classList.contains("hidden")?(t.classList.remove("hidden"),a.classList.add("rotate-180")):(t.classList.add("hidden"),a.classList.remove("rotate-180"))},to=()=>{const e=l("modal-ask-question"),t=l("modal-ask-question-box");e&&(e.classList.contains("hidden")&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("askQuestion"),he(e,t))},Ut=(e=!1)=>{const t=()=>{ve("modal-ask-question","modal-ask-question-box")};typeof window.requestCloseModal=="function"?window.requestCloseModal("askQuestion",e,t):t()},ao=async()=>{const e=(N("ask-author-name")||"").trim()||"Pelanggan",t=N("ask-category")||"Pemesanan",a=(N("ask-question-text")||"").trim();if(!a)return b("Tuliskan pertanyaan Anda terlebih dahulu!");J("Mengirim pertanyaan...");const s="faq-"+Date.now().toString(36),o={id:s,question:a,answer:"",category:t,authorName:e,status:"pending_answer",createdAt:new Date().toISOString()};let r=!1;try{await C.collection("freshmart").doc("cms_data").collection("faqs").doc(s).set(o),r=!0}catch(i){console.warn("Penulisan sub-koleksi faqs dibatasi, mencoba fallback cms_data.faqs:",i)}if(!r)try{const i=[o,...(m.faqs||[]).filter(n=>n.id!==s)];await C.collection("freshmart").doc("cms_data").set({faqs:i},{merge:!0}),m.faqs=i,r=!0}catch(i){console.warn("Fallback cms_data.faqs juga gagal:",i)}I(),r?(Ut(),Q("ask-question-text",""),b("Pertanyaan terkirim! Admin akan menjawabnya segera."),Te()):b("Gagal mengirim pertanyaan. Coba lagi!")};let Pe="all";const He=()=>{pt();const e=m.faqs||[],t=e.filter(o=>Pe==="pending"?o.status==="pending_answer":Pe==="published"?o.status==="published":!0),a=e.filter(o=>o.status==="pending_answer").length;let s=`
        <div class="space-y-5 pb-12">
            ...
            <div class="flex items-center gap-2 overflow-x-auto pb-1.5 hide-scrollbar border-b border-slate-200 dark:border-slate-700">
                <button onclick="setAdminFAQFilter('all')" class="shrink-0 px-3.5 py-2 rounded-xl text-xs font-bold transition-all ${Pe==="all"?"primary-bg text-white shadow-md":"bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 hover:bg-slate-200"}">
                    Semua (${e.length})
                </button>
                <button onclick="setAdminFAQFilter('pending')" class="shrink-0 px-3.5 py-2 rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 ${Pe==="pending"?"primary-bg text-white shadow-md":"bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 hover:bg-slate-200"}">
                    <span>Belum Dijawab</span>
                    ${a>0?`<span class="bg-rose-500 text-white text-[9px] px-1.5 py-0.5 rounded-full font-bold">${a}</span>`:""}
                </button>
                <button onclick="setAdminFAQFilter('published')" class="shrink-0 px-3.5 py-2 rounded-xl text-xs font-bold transition-all ${Pe==="published"?"primary-bg text-white shadow-md":"bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 hover:bg-slate-200"}">
                    Terpublikasi
                </button>
            </div>
    ...
    <button onclick="setCat('Semua Produk'); closeCategoryModal()" class="w-full flex items-center gap-3.5 p-3 sm:p-3.5 rounded-2xl border transition-all active:scale-[0.98] ${t?"bg-[rgba(var(--color-primary-rgb),0.08)] border-[var(--color-primary)] dark:bg-[rgba(var(--color-primary-rgb),0.12)] dark:border-[var(--color-primary)] shadow-[0_0_0_1px_rgba(var(--color-primary-rgb),0.2)]":"bg-slate-50 border-slate-200 dark:bg-slate-800/50 dark:border-slate-700 hover:border-[var(--color-primary)]/40 dark:hover:border-[var(--color-primary)]/40"} group">
        ...
        </button>`});const a=l("modal-category-list");a&&(a.innerHTML=`<div class="flex flex-col gap-2.5 pb-6 w-full">${e}</div>`);const s=l("category-modal"),o=l("category-modal-content");s&&o&&(s.classList.contains("hidden")&&ie("category"),he(s,o))};window.openCategoryModal=Po;window.openBrandModal=()=>{let e="",t=Ye==="Semua Merek";e+=`
    <button onclick="setBrand('Semua Merek'); closeBrandModal()" class="flex flex-col items-center justify-start p-2.5 sm:p-3.5 rounded-2xl border transition-all ${t?"bg-[rgba(var(--color-primary-rgb),0.08)] border-[var(--color-primary)] dark:bg-[rgba(var(--color-primary-rgb),0.12)] dark:border-[var(--color-primary)] shadow-[0_0_0_1px_rgba(var(--color-primary-rgb),0.2)]":"bg-slate-50 border-slate-200 dark:bg-slate-800/50 dark:border-slate-700 hover:border-[var(--color-primary)]/40 dark:hover:border-[var(--color-primary)]/40"} group">
        ...
        </button>`});const a=l("modal-brand-grid");a&&(a.innerHTML=e);const s=l("brand-modal"),o=l("brand-modal-content");s&&o&&(s.classList.contains("hidden")&&ie("brand"),he(s,o))};window.closeCategoryModal=(e=!1)=>{const t=l("category-modal"),a=l("category-modal-content");t&&a&&ne("category",e,()=>{ve(t,a)})};window.closeBrandModal=(e=!1)=>{const t=l("brand-modal"),a=l("brand-modal-content");t&&a&&ne("brand",e,()=>{ve(t,a)})};window.openQuickMenuModal=()=>{const e=l("quickmenu-modal"),t=l("quickmenu-modal-content");e&&t&&(e.classList.contains("hidden")&&ie("quickmenu"),he(e,t))};window.openTermsModal=()=>{const e=`
      <div class="space-y-3">
    ...
    `,t=m?.store?.terms,a=t?t.includes("<")?t:`<div class="p-4 rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50/60 dark:bg-slate-800/40 leading-relaxed text-xs sm:text-sm text-slate-600 dark:text-slate-300 whitespace-pre-line">${t}</div>`:e;B("terms-modal-content-body",a);const s=l("terms-modal"),o=l("terms-modal-content");s&&o&&(s.classList.contains("hidden")&&ie("terms"),he(s,o))};window.closeTermsModal=(e=!1)=>{const t=l("terms-modal"),a=l("terms-modal-content");t&&a&&ne("terms",e,()=>{ve(t,a)})};window.openPrivacyModal=()=>{const e=`
      <div class="space-y-3">
        <div class="p-3.5 rounded-2xl bg-[rgba(var(--color-primary-rgb),0.06)] border border-[rgba(var(--color-primary-rgb),0.2)] flex items-start gap-3">
