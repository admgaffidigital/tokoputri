const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/pos-variant-sheet-Booa4qy5.js","assets/module-print-B6xAfF9T.js","assets/module-member-CuoFUCa5.js","assets/vendor-firebase-core-D2OF5R23.js","assets/vendor-firebase-db-BIUZcnOd.js"])))=>i.map(i=>d[i]);
import{a as W,A as ja,d as A,_ as Ia}from"./module-member-CuoFUCa5.js";import{a as b,c as Qt,v as Et,t as m,e as l,i as u,ar as ne,u as Fa,x as rt,b as Da,f as Na}from"./module-print-B6xAfF9T.js";import{f as st}from"./vendor-firebase-core-D2OF5R23.js";const Gt=e=>{const t=b.products?.find(r=>r&&r.id!=null&&String(r.id)===String(e.id));let a=e.price||0;if(e.variantName&&t&&t.variants){const r=t.variants.find(n=>n.name===e.variantName);r&&r.price!=null&&(a=r.price)}if(e.variantName||!t||!t.wholesale||!t.wholesale.length)return a;const s=Qt.filter(r=>r.id!=null&&String(r.id)===String(e.id)).reduce((r,n)=>r+(parseFloat(n.qty)||0),0);for(let r of t.wholesale.slice().sort((n,o)=>o.minQty-n.minQty))if(s>=parseFloat(r.minQty))return r.price;return a},Te=e=>{const t=b.products?.find(a=>a&&a.id!=null&&String(a.id)===String(e.id));if(!t)return 0;if(e.variantName&&t.variants){const a=t.variants.find(s=>s.name===e.variantName);if(a&&a.hpp!=null)return parseFloat(a.hpp)||0}return parseFloat(t.hpp)||0},zt=e=>{if(!e)return 0;const t=b.products?.find(a=>a&&a.id!=null&&String(a.id)===String(e.id));if(!t)return parseFloat(e.poin)||0;if(e.variantName&&t.variants){const a=t.variants.find(s=>s.name===e.variantName);if(a&&a.poin!==void 0&&a.poin!==null&&a.poin!==""){const s=parseFloat(a.poin);if(!isNaN(s)&&s>0)return s}}return parseFloat(t.poin)||0},Ba=(e,t,a,s)=>{if(!e||!t||!a||!s)return 0;const r=6371,n=(a-e)*Math.PI/180,o=(s-t)*Math.PI/180,i=Math.sin(n/2)*Math.sin(n/2)+Math.cos(e*Math.PI/180)*Math.cos(a*Math.PI/180)*Math.sin(o/2)*Math.sin(o/2),d=2*Math.atan2(Math.sqrt(i),Math.sqrt(1-i));return r*d},Wt=e=>{if(!e||typeof e!="string")return null;let t=e.trim();try{t=decodeURIComponent(t)}catch{}const a=t.match(/@(-?\d{1,3}\.\d+)[,\s]+(-?\d{1,3}\.\d+)/);if(a){const o=parseFloat(a[1]),i=parseFloat(a[2]);if(!isNaN(o)&&!isNaN(i)&&Math.abs(o)<=90&&Math.abs(i)<=180)return{lat:a[1],lng:a[2]}}const s=t.match(/[?&](?:q|ll|query|loc|center)=(-?\d{1,3}\.\d+)[,\s]+(-?\d{1,3}\.\d+)/i);if(s){const o=parseFloat(s[1]),i=parseFloat(s[2]);if(!isNaN(o)&&!isNaN(i)&&Math.abs(o)<=90&&Math.abs(i)<=180)return{lat:s[1],lng:s[2]}}const r=t.match(/(\d+)[°\s]+(\d+)['\s]+([\d.]+)"?\s*([NSns])[,\s]+(\d+)[°\s]+(\d+)['\s]+([\d.]+)"?\s*([EWew])/);if(r){let o=parseInt(r[1],10)+parseInt(r[2],10)/60+parseFloat(r[3])/3600;r[4].toUpperCase()==="S"&&(o=-o);let i=parseInt(r[5],10)+parseInt(r[6],10)/60+parseFloat(r[7])/3600;return r[8].toUpperCase()==="W"&&(i=-i),{lat:o.toFixed(8),lng:i.toFixed(8)}}const n=t.match(/(-?\d{1,3}\.\d{3,20})[,\s;\t]+(-?\d{1,3}\.\d{3,20})/);if(n){const o=parseFloat(n[1]),i=parseFloat(n[2]);if(!isNaN(o)&&!isNaN(i)&&Math.abs(o)<=90&&Math.abs(i)<=180)return{lat:n[1],lng:n[2]}}return null},Ra=e=>{const t=(typeof e=="string"?e:e?.value||"").trim(),a=Wt(t);return a?(Et("set-lat",a.lat),Et("set-lng",a.lng),m("Koordinat GPS berhasil disalin!"),a):(m("Format tidak dikenali! Tempel koordinat: Lat, Lng atau link Google Maps"),null)},Ea=(e=Qt,t=b.store)=>{if(!e||!e.length)return{totalPoints:0,directPoints:0,spendPoints:0,nonPointSpend:0,threshold:1e5,pointsPerThreshold:1,isSpendPointsActive:!1,remainingToNextPoint:0,progressPercent:0};let a=0,s=0;e.forEach(f=>{const v=zt(f),k=parseFloat(f.qty)||0;if(v>0)a+=v*k;else{const C=Gt(f);s+=C*k}});let r=0,n=0,o=0;const i=t?t.spendPointsEnabled===!0||t.spendPointsEnabled==="true":!1,d=Math.max(1,parseFloat(t?.spendPointsThreshold)||1e5),p=Math.max(1,parseFloat(t?.spendPointsPerThreshold)||1);if(i&&s>0){const f=Math.floor(s/d);r=f*p;const v=s%d;n=v>0?d-v:d,o=Math.min(100,Math.round((v||(f>0?d:0))/d*100))}return{totalPoints:a+r,directPoints:a,spendPoints:r,nonPointSpend:s,threshold:d,pointsPerThreshold:p,isSpendPointsActive:i,remainingToNextPoint:n,progressPercent:o}};window.getEffP=Gt;window.getEffHpp=Te;window.getEffPoin=zt;window.calculateCartPoints=Ea;window.getDist=Ba;window.parseGeoCoordinates=Wt;window.autoParseCoords=Ra;let we=null;const se=()=>{if(we)return we;try{const e=sessionStorage.getItem("pos_cashier_session");if(e)return we=JSON.parse(e),we}catch{}return null},_a=e=>{we=e;try{e?sessionStorage.setItem("pos_cashier_session",JSON.stringify(e)):sessionStorage.removeItem("pos_cashier_session")}catch{}},Jt=()=>{we=null;try{sessionStorage.removeItem("pos_cashier_session")}catch{}},Yt=()=>!!se(),Xt=async()=>{if(se()||window.isAdm||window.__localIsAdm||b&&(b.hasCashier===!0||b.store?.posEnabled===!0))return!0;const e=localStorage.getItem("pos_has_cashier");if(e==="true")return!0;const t=!!(window.isAdm||window.__localIsAdm||W.currentUser&&W.currentUser.uid===ja);try{if(t){const s=!(await A.collection("freshmart").doc("cms_data").collection("cashier_accounts").where("isActive","==",!0).limit(1).get()).empty;try{localStorage.setItem("pos_has_cashier",s?"true":"false"),A.collection("freshmart").doc("cms_data").set({hasCashier:s},{merge:!0}).catch(()=>{})}catch{}return s}else{const a=await A.collection("freshmart").doc("cms_data").get();if(a.exists){const s=a.data();if(s.hasCashier!==void 0){const r=!!s.hasCashier;try{localStorage.setItem("pos_has_cashier",r?"true":"false")}catch{}return r}}return e!=="false"}}catch{return e!=="false"}},Qe=async()=>{const e=l("pos-cashier-header-btn");if(!e)return;const t=!!se(),a=!!(window.isAdm||window.__localIsAdm),s=localStorage.getItem("pos_has_cashier"),r=b?b.hasCashier??!0:!0;t||a||s==="true"||s===null&&r!==!1?e.classList.remove("hidden"):s==="false"&&e.classList.add("hidden");try{await Xt()||t||a?e.classList.remove("hidden"):e.classList.add("hidden")}catch{(t||a||s!=="false")&&e.classList.remove("hidden")}},Zt=async()=>{typeof window.triggerHaptic=="function"&&window.triggerHaptic("medium"),se()?(typeof window.changeView=="function"&&window.changeView("view-pos-cashier"),typeof window.renderPOSStorefront=="function"&&window.renderPOSStorefront()):it()},it=()=>{const e=l("pos-login-modal");e&&(e.classList.remove("hidden"),setTimeout(()=>{e.classList.remove("opacity-0");const t=l("pos-login-modal-box");t&&t.classList.remove("translate-y-full","scale-95")},10),setTimeout(()=>{const t=l("pos-login-email");t&&t.focus()},300),typeof window.triggerHaptic=="function"&&window.triggerHaptic("light"))},lt=()=>{const e=l("pos-login-modal"),t=l("pos-login-modal-box");e&&e.classList.add("opacity-0"),t&&t.classList.add("translate-y-full"),setTimeout(()=>{e&&e.classList.add("hidden");const a=l("pos-login-email"),s=l("pos-login-password"),r=l("pos-login-error");a&&(a.value=""),s&&(s.value=""),r&&(r.textContent="",r.classList.add("hidden"))},300)},ea=async()=>{const e=l("pos-login-email"),t=l("pos-login-password"),a=l("pos-login-error"),s=l("pos-login-btn"),r=e?.value?.trim()||"",n=t?.value||"",o=d=>{if(a){a.classList.remove("hidden");const p=a.querySelector("span");p?p.textContent=d:a.textContent=d}typeof window.triggerHaptic=="function"&&window.triggerHaptic("error")};if((()=>{if(a){a.classList.add("hidden");const d=a.querySelector("span");d&&(d.textContent="")}})(),!r||!n){o("Email dan password wajib diisi.");return}s&&(s.disabled=!0,s.innerHTML='<i class="fa-solid fa-spinner fa-spin mr-2"></i>Memverifikasi...');try{const p=(await W.signInWithEmailAndPassword(r,n)).user?.uid;if(!p)throw new Error("UID tidak ditemukan");const v=await A.collection("freshmart").doc("cms_data").collection("cashier_accounts").doc(p).get();if(!v.exists){await W.signOut(),o("Akun ini bukan akun kasir yang terdaftar di toko ini.");return}const k=v.data();if(k.role!=="cashier"){await W.signOut(),o("Akun ini tidak memiliki akses kasir.");return}if(!k.isActive){await W.signOut(),o("Akun kasir ini telah dinonaktifkan. Hubungi admin toko.");return}_a({uid:p,name:k.name||r,email:k.email||r,role:"cashier"});try{localStorage.setItem("pos_has_cashier","true")}catch{}Qe(),typeof window.syncActiveShiftFromCloud=="function"&&window.syncActiveShiftFromCloud().catch(()=>{}),lt(),m(`Selamat datang, ${k.name||"Kasir"}! 👋`,"success"),typeof window.changeView=="function"&&window.changeView("view-pos-cashier"),setTimeout(()=>{typeof window.renderPOSStorefront=="function"&&window.renderPOSStorefront()},100),typeof window.triggerHaptic=="function"&&window.triggerHaptic("success")}catch(d){console.error("[POS Auth] Login error:",d);const p=d.code||"";o(p==="auth/user-not-found"||p==="auth/wrong-password"||p==="auth/invalid-credential"?"Email atau password salah.":p==="auth/too-many-requests"?"Terlalu banyak percobaan. Coba lagi beberapa saat.":p==="auth/network-request-failed"?"Koneksi gagal. Periksa jaringan internet.":"Login gagal: "+(d.message||"Kesalahan tidak diketahui"))}finally{s&&(s.disabled=!1,s.innerHTML='<i class="fa-solid fa-right-to-bracket mr-2"></i>Masuk Kasir')}},dt=async(e=!1)=>{if(!e&&typeof window.getActiveShift=="function"){const a=window.getActiveShift();if(a&&a.status==="open"){document.getElementById("pos-logout-shift-modal")?.remove();const s=typeof window.fRp=="function"?window.fRp(a.startingCash):"Rp "+a.startingCash;document.body.insertAdjacentHTML("beforeend",`
            ...
            </div>`);return}}se(),typeof window.detachPOSHistoryListener=="function"&&window.detachPOSHistoryListener(),typeof window.detachActiveShiftListener=="function"&&window.detachActiveShiftListener(),typeof window.clearActiveShift=="function"&&window.clearActiveShift();try{if(!window.isAdm&&!window.__localIsAdm)try{await W.signOut()}catch{}}catch{}Jt();const t=l("view-pos-cashier");t&&(t.innerHTML=""),typeof window.destroyBarcodeListener=="function"&&window.destroyBarcodeListener(),typeof window.stopPOSClock=="function"&&window.stopPOSClock(),m("Sesi kasir berakhir. Sampai jumpa! 👋"),typeof window.changeView=="function"&&window.changeView("view-catalog"),typeof window.triggerHaptic=="function"&&window.triggerHaptic("medium"),typeof window.updatePOSHeaderIcon=="function"&&window.updatePOSHeaderIcon()},ta=async()=>{await Qe()};window.openPOSCashierMode=Zt;window.openPOSLoginModal=it;window.closePOSLoginModal=lt;window.processCashierLogin=ea;window.cashierLogout=dt;window.exitPOSMode=dt;window.getCashierSession=se;window.isCashierLoggedIn=Yt;window.initPOSAuth=ta;window.updatePOSHeaderIcon=Qe;const ns=Object.freeze(Object.defineProperty({__proto__:null,cashierLogout:dt,checkCashierExists:Xt,clearCashierSession:Jt,closePOSLoginModal:lt,getCashierSession:se,initPOSAuth:ta,isCashierLoggedIn:Yt,openPOSCashierMode:Zt,openPOSLoginModal:it,processCashierLogin:ea,updatePOSHeaderIcon:Qe},Symbol.toStringTag,{value:"Module"})),S=e=>"Rp "+Math.round(parseFloat(e)||0).toLocaleString("id-ID"),aa=e=>parseFloat((parseFloat(e)||0).toFixed(3)).toString(),Ke="pos_active_shift",sa="pos_last_closed_shift";let ke=null,_e=null;const Ve=()=>{if(typeof _e=="function"){try{_e()}catch{}_e=null}},Me=()=>{const e=typeof se=="function"?se():null,t=!!(window.isAdm||window.__localIsAdm||window.__currentAdminUid),a=W?.currentUser?.uid,s=e?.uid||(t?window.__currentAdminUid||a||"admin":a||"cashier-anon"),r=e?.name||(t?"Admin Seller":"Kasir Toko"),n=e?.email||t&&W?.currentUser?.email||"";return{uid:s,name:r,email:n,isAdm:t}},Se=(e,t=Me())=>{if(!e)return!1;const a=e.cashierUid;return!!(a&&t.uid&&a===t.uid||t.isAdm&&(a==="admin"||a==="ADMIN_UID"||a===window.__currentAdminUid||W?.currentUser&&a===W.currentUser.uid))},_=()=>{if(ke)return ke;try{const e=localStorage.getItem(Ke);if(e)return ke=JSON.parse(e),ke}catch(e){console.warn("[POS Shift] Gagal membaca active shift:",e)}return null},ie=e=>{ke=e;try{e?localStorage.setItem(Ke,JSON.stringify(e)):localStorage.removeItem(Ke)}catch{}},Oe=()=>{ke=null;try{localStorage.removeItem(Ke)}catch{}},qa=()=>{try{const e=localStorage.getItem(sa);if(e)return JSON.parse(e)}catch{}return null},ct=e=>{try{localStorage.setItem(sa,JSON.stringify(e))}catch{}},le=()=>{const e=_();return!!(e&&e.status==="open")},Ge=async(e=null)=>{const t=Me();try{const a=await A.collection("freshmart").doc("cms_data").collection("pos_shifts").where("status","==","open").get();if(!a.empty){const s=[];if(a.forEach(r=>{const n={id:r.id,...r.data()};Se(n,t)&&s.push(n)}),s.length>0)return s.sort((r,n)=>(n.startTime||0)-(r.startTime||0)),s[0]}}catch(a){console.warn("[POS Shift] Cek open shift cms_data:",a)}try{const a=await A.collection("pos_shifts").where("status","==","open").get();if(!a.empty){const s=[];if(a.forEach(r=>{const n={id:r.id,...r.data()};Se(n,t)&&s.push(n)}),s.length>0)return s.sort((r,n)=>(n.startTime||0)-(r.startTime||0)),s[0]}}catch(a){console.warn("[POS Shift] Cek open shift root pos_shifts:",a)}return null},xe=e=>{if(e){Ve();try{_e=A.collection("freshmart").doc("cms_data").collection("pos_shifts").doc(e).onSnapshot(a=>{if(!a.exists)return;const s={id:a.id,...a.data()};if(s.status==="closed"){Ve(),Oe(),ct(s),ze(),je(),Pe(),m("Shift kasir telah ditutup dari perangkat lain.","info"),typeof window.renderShiftHeaderBadge=="function"&&window.renderShiftHeaderBadge();return}if(s.status==="open"){ie(s),typeof window.renderShiftHeaderBadge=="function"&&window.renderShiftHeaderBadge();const r=l("pos-shift-summary-modal");r&&!r.classList.contains("opacity-0")&&G()}},a=>{console.warn("[POS Shift] Snapshot listener cms_data error:",a)})}catch(t){console.warn("[POS Shift] Gagal attach snapshot listener:",t)}}},re=async()=>{const e=Me(),t=_();if(t&&t.status==="open"&&Se(t,e))try{const a=await A.collection("freshmart").doc("cms_data").collection("pos_shifts").doc(t.id).get();if(a.exists){const s={id:a.id,...a.data()};if(s.status==="closed")Oe(),ct(s),typeof window.renderShiftHeaderBadge=="function"&&window.renderShiftHeaderBadge();else return ie(s),xe(s.id),typeof window.renderShiftHeaderBadge=="function"&&window.renderShiftHeaderBadge(),s}}catch(a){return console.warn("[POS Shift] Gagal verifikasi local shift ke cloud:",a),xe(t.id),t}try{const a=await Ge(e.uid);if(a)return ie(a),xe(a.id),typeof window.renderShiftHeaderBadge=="function"&&window.renderShiftHeaderBadge(),a;t&&!Se(t,e)&&(Oe(),typeof window.renderShiftHeaderBadge=="function"&&window.renderShiftHeaderBadge())}catch(a){console.warn("[POS Shift] Gagal cari shift open di cloud:",a)}return _()},ra=(e="open")=>{try{const t=window.AudioContext||window.webkitAudioContext;if(!t)return;const a=new t,s=a.currentTime;e==="open"?([523.25,659.25,783.99,1046.5].forEach((n,o)=>{const i=a.createOscillator(),d=a.createGain(),p=s+o*.07;i.type="sine",i.frequency.setValueAtTime(n,p),d.gain.setValueAtTime(.09,p),d.gain.exponentialRampToValueAtTime(1e-4,p+.16),i.connect(d),d.connect(a.destination),i.start(p),i.stop(p+.16)}),setTimeout(()=>{a.close().catch(()=>{})},600)):([{f:[783.99,987.77],t:s,d:.14},{f:[1046.5,1318.51],t:s+.12,d:.35}].forEach(n=>{n.f.forEach(o=>{const i=a.createOscillator(),d=a.createGain();i.type="triangle",i.frequency.setValueAtTime(o,n.t),d.gain.setValueAtTime(.08,n.t),d.gain.exponentialRampToValueAtTime(1e-4,n.t+n.d),i.connect(d),d.connect(a.destination),i.start(n.t),i.stop(n.t+n.d)})}),setTimeout(()=>{a.close().catch(()=>{})},700))}catch{}},pt=(e,t=Date.now())=>{if(!e)return"-";const a=Math.max(0,t-e),s=Math.floor(a/6e4),r=Math.floor(s/60),n=s%60;return r>0?`${r} Jam ${n} Menit`:`${n} Menit`},Ka=()=>{const e=new Date,t=e.getFullYear(),a=String(e.getMonth()+1).padStart(2,"0"),s=String(e.getDate()).padStart(2,"0"),r=Math.floor(100+Math.random()*900);return`SHF-${t}${a}${s}-${r}`},K=async()=>{const e=Me(),t=_();if(t&&t.status==="open"&&Se(t,e)){m(`Shift kasir #${t.shiftNo||t.id} sedang aktif. Menampilkan ringkasan shift.`,"info"),G();return}try{const i=await Ge(e.uid);if(i){ie(i),xe(i.id),typeof window.renderShiftHeaderBadge=="function"&&window.renderShiftHeaderBadge(),m(`Melanjutkan shift aktif (#${i.shiftNo||i.id}) dari perangkat lain! 👋`,"success"),G();return}}catch(i){console.warn("[POS Shift] Cek cloud saat buka modal:",i)}const a=e.name,s=new Date().toLocaleString("id-ID",{dateStyle:"full",timeStyle:"short"});document.getElementById("pos-open-shift-modal")?.remove();const r=`
            ...
            <div class="p-5 space-y-4 overflow-y-auto flex-1">
                ...
                <div class="grid grid-cols-2 gap-2.5">
                    ...
                    <div class="p-3 rounded-2xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200/60 dark:border-slate-700/60">
                        ...
                        <span class="text-[10px] text-slate-500 mt-0.5 block">${e.txCount||0} Struk / ${aa(e.itemCount||0)} Item</span>
                    </div>
                </div>
    ...
    <div id="pos-shift-receipt-modal" class="fixed inset-0 z-[10003] flex items-center justify-center p-3 sm:p-4" style="background:rgba(15,23,42,0.7);backdrop-filter:blur(4px)">
        <div class="bg-white dark:bg-slate-900 rounded-3xl shadow-2xl w-full ${s?"max-w-md":"max-w-sm"} border border-slate-200 dark:border-slate-800 overflow-hidden flex flex-col max-h-[90vh]">
            ...
            <div id="pos-shift-receipt-paper-box" class="p-4 overflow-y-auto flex-1 font-mono text-[11px] bg-slate-50/60 dark:bg-slate-950 text-slate-800 dark:text-slate-200 space-y-1.5 select-text">
                ...
                <div class="flex justify-between"><span>Total Barang</span><span>${aa(e.itemCount||0)} Item</span></div>
            ...
            <div class="p-3 border-t border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/40 flex gap-2">
                ...
                </button>`)})},Wa=async e=>{const t=typeof e=="string"?l(e):e;t&&(t.innerHTML=`
    <div class="space-y-4">
    ...
    </div>`,await xt())},xt=async()=>{const e=l("admin-shift-list-target");if(e)try{const t=await A.collection("freshmart").doc("cms_data").collection("pos_shifts").orderBy("startTime","desc").limit(50).get();if(t.empty){e.innerHTML=`
        ...
        <div class="text-center py-10 text-rose-500 text-xs">
        ...
        </div>`}},Ja=(e,t)=>{Fa("Hapus Data Shift",`Hapus shift #${t}? Data akan dihapus permanen dari cloud dan tidak bisa dikembalikan.`,async()=>{try{await A.collection("freshmart").doc("cms_data").collection("pos_shifts").doc(e).delete(),m("Data shift berhasil dihapus.","success"),await xt()}catch(a){console.error("[POS Shift] Gagal menghapus shift:",a),m("Gagal menghapus: "+a.message,"error")}},"Ya, Hapus")};window.getActiveShift=_;window.saveActiveShift=ie;window.clearActiveShift=Oe;window.getLastClosedShift=qa;window.isShiftActive=le;window.getCurrentCashierIdentity=Me;window.isShiftOwnedByCashier=Se;window.findActiveShiftInCloud=Ge;window.syncActiveShiftFromCloud=re;window.listenActiveShiftCloud=xe;window.detachActiveShiftListener=Ve;window.openPOSOpenShiftModal=K;window.closePOSOpenShiftModal=Pe;window.posSetStartCashPreset=Va;window.posUpdateStartCashChips=oa;window.confirmStartPOSShift=Ua;window.recordTransactionToShift=na;window.openPOSShiftModal=G;window.openPOSShiftSummaryModal=G;window.closePOSShiftSummaryModal=ze;window.openPOSCloseShiftModal=ut;window.closePOSCloseShiftModal=je;window.setPOSCountMode=Qa;window.calcPOSDenominations=ia;window.updatePOSShiftDiscrepancy=la;window.confirmClosePOSShift=Ga;window.printShiftSettlementReceipt=ft;window.executeShiftPrintDirect=bt;window.renderShiftHeaderBadge=Ie;window.renderAdminShiftReportView=Wa;window.loadAdminShiftReports=xt;window.deleteShiftRecord=Ja;let _t=!1;const da=()=>_t?Promise.resolve():Ia(()=>import("./pos-variant-sheet-Booa4qy5.js"),__vite__mapDeps([0,1,2,3,4])).then(()=>{_t=!0});let g=[],te="",be="",ee="grid";try{const e=localStorage.getItem("pos_view_mode");(e==="list"||e==="grid")&&(ee=e)}catch{}let h={name:"",phone:"",isMember:!1,memberId:null,isNewTempo:!1},E="cash",U=0,Q=0,R="rp",N=0,Z="",qt=null,ve=null,me=null,Ee=null,ye=null,qe=!0,ot="environment",Ae=!1,oe=null,Kt="",Vt=0;const mt=e=>{ee=e;try{localStorage.setItem("pos_view_mode",e)}catch{}document.querySelectorAll("#pos-view-btn-grid").forEach(t=>{e==="grid"?(t.style.background="var(--color-primary)",t.className="w-8 h-8 rounded-lg flex items-center justify-center text-xs transition-all cursor-pointer text-white shadow-xs"):(t.style.removeProperty("background"),t.className="w-8 h-8 rounded-lg flex items-center justify-center text-xs transition-all cursor-pointer text-slate-500 hover:text-slate-800 dark:text-slate-400")}),document.querySelectorAll("#pos-view-btn-list").forEach(t=>{e==="list"?(t.style.background="var(--color-primary)",t.className="w-8 h-8 rounded-lg flex items-center justify-center text-xs transition-all cursor-pointer text-white shadow-xs"):(t.style.removeProperty("background"),t.className="w-8 h-8 rounded-lg flex items-center justify-center text-xs transition-all cursor-pointer text-slate-500 hover:text-slate-800 dark:text-slate-400")}),q()},ae=e=>Math.max(0,parseInt(e)||0),He=e=>{if(e==null)return 0;typeof e=="string"&&(e=e.replace(",",".").trim());const t=parseFloat(e);return isNaN(t)?0:Math.max(0,parseFloat(t.toFixed(3)))},j=e=>{const t=parseFloat(e)||0;return parseFloat(t.toFixed(3)).toString()},x=e=>Na(e),de=()=>g.reduce((e,t)=>e+t.subtotal,0),ce=()=>g.reduce((e,t)=>{const a=t.hpp!=null?parseFloat(t.hpp):Te(t)||0;return e+(parseFloat(a)||0)*(parseFloat(t.qty)||0)},0),pe=()=>{const e=de();let t=0;if(R==="percent"){const s=Math.min(100,Math.max(0,parseFloat(N)||0));t=Math.round(e*s/100)}else t=Math.min(e,ae(N||Q));const a=ce();if(a>0){const s=Math.max(0,e-a);t>s&&(t=s)}return t},L=()=>Math.max(0,de()-pe()),ca=()=>U-L(),Ce=e=>{if(!e)return{isManaged:!1,totalStock:0,isOutOfStock:!0,isLowStock:!1,isInactive:!0,isPreorder:!1,poTime:""};if(!(e.isActive!=="false"&&e.isActive!==!1))return{isManaged:!0,totalStock:0,isOutOfStock:!0,isLowStock:!1,isInactive:!0,isPreorder:!1,poTime:""};const a=b?.store?.useStock===!0||b?.store?.useStock==="true",s=!!(e.poTime&&String(e.poTime).trim()),r=s?String(e.poTime).trim():"";if(!a)return{isManaged:!1,totalStock:999999,isOutOfStock:!1,isLowStock:!1,isInactive:!1,isPreorder:s,poTime:r};let n=0;return Array.isArray(e.variants)&&e.variants.length>0?n=e.variants.filter(o=>o&&o.isActive!==!1&&o.isActive!=="false").reduce((o,i)=>o+(i.stock!=null&&parseFloat(i.stock)||0),0):n=parseFloat(e.stock)||0,{isManaged:!0,totalStock:n,isOutOfStock:n<=0,isLowStock:n>0&&n<=5,isInactive:!1,isPreorder:s,poTime:r}},X=()=>{try{const e=window.AudioContext||window.webkitAudioContext;if(!e)return;const t=new e,a=t.createOscillator(),s=t.createGain();a.type="sine",a.frequency.setValueAtTime(1400,t.currentTime),s.gain.setValueAtTime(.08,t.currentTime),s.gain.exponentialRampToValueAtTime(1e-4,t.currentTime+.08),a.connect(s),s.connect(t.destination),a.start(),a.stop(t.currentTime+.08),setTimeout(()=>{t.close().catch(()=>{})},150)}catch{}},Ya=(e,t)=>{if(!e||!e.wholesale||!e.wholesale.length)return null;const a=[...e.wholesale].sort((s,r)=>r.minQty-s.minQty);for(const s of a)if(t>=parseFloat(s.minQty))return parseFloat(s.price);return null},Y=e=>{if(!e.isVariant){const a=(b.products||[]).find(r=>r&&String(r.id)===String(e.id)),s=a?Ya(a,e.qty):null;s!==null?(e.basePrice=e.basePrice||e.price,e.price=s,e.isWholesale=!0):(e.basePrice&&(e.price=e.basePrice),e.isWholesale=!1)}e.hpp==null&&(e.hpp=Te(e)||0);const t=parseFloat(e.hpp)||0;if(t>0){const a=Math.max(0,Math.round((e.price-t)*e.qty));ae(e.discount)>a&&(e.discount=a)}else e.discount=Math.min(ae(e.discount),e.price*e.qty);return e.subtotal=Math.max(0,e.price*e.qty-ae(e.discount)),e},Xa=()=>{const e=new Date,t=a=>String(a).padStart(2,"0");return`POS-${e.getFullYear()}${t(e.getMonth()+1)}${t(e.getDate())}-${Date.now().toString(36).toUpperCase()}`},pa=()=>{ve&&clearInterval(ve);const e=()=>{const a=new Date().toLocaleTimeString("id-ID",{hour:"2-digit",minute:"2-digit",second:"2-digit"})+" WIB";document.querySelectorAll("#pos-live-clock").forEach(s=>{s.textContent=a})};e(),ve=setInterval(e,1e3)},ua=()=>{ve&&(clearInterval(ve),ve=null)};window.stopPOSClock=ua;const We=()=>{window.__posBarcodeFn&&(document.removeEventListener("keydown",window.__posBarcodeFn),window.__posBarcodeFn=null)},fa=()=>{We(),window.__posBarcodeFn=e=>{if(!e||typeof e.key!="string")return;const t=window.curViewName||"";if(!(t==="view-pos-cashier"||t==="view-admin"&&window.cTab==="pos"))return;if(e.key==="F4"){e.preventDefault();const r=l("pos-search-input");r&&(r.focus(),r.select());return}if(e.key==="F6"||e.key==="F7"){e.preventDefault(),Ze();return}if(e.key==="F8"){e.preventDefault(),De();return}if(e.key==="F9"){e.preventDefault(),l("pos-camera-scanner-modal")?he():at();return}if(e.key==="F10"){e.preventDefault(),le()?G():typeof re=="function"?re().then(r=>{r&&r.status==="open"?G():K()}).catch(()=>K()):K();return}const s=document.activeElement?.tagName?.toLowerCase();if(!(s==="input"||s==="textarea"||s==="select"))if(e.key==="Enter"){if(Z&&Z.length>=3){const r=Z.trim().toLowerCase(),n=(b.products||[]).find(o=>o&&o.isActive!=="false"&&o.isActive!==!1&&(o.barcode&&o.barcode.toLowerCase()===r||o.sku&&o.sku.toLowerCase()===r||o.id&&String(o.id).toLowerCase()===r));if(n)Je(n.id)&&(X(),m(`Ditambahkan: ${n.name}`,"success"));else{const o=l("pos-search-input");o&&(o.value=Z,te=Z,q()),m("Barcode tidak ditemukan di katalog","warning")}Z=""}}else e.key&&e.key.length===1&&(Z=(Z||"")+e.key,clearTimeout(qt),qt=setTimeout(()=>{Z=""},150))},document.addEventListener("keydown",window.__posBarcodeFn)},Je=e=>{const t=(b.products||[]).find(o=>o&&String(o.id)===String(e));if(!t)return!1;if(!(t.isActive!=="false"&&t.isActive!==!1))return m("Produk ini sedang tidak tersedia","warning"),!1;if(t.variants&&t.variants.length>0)return da().then(()=>{typeof window.openPOSVariantSheet=="function"&&window.openPOSVariantSheet(e)}),!0;const r=Ce(t);if(r.isManaged&&r.isOutOfStock)return m(`Maaf, stok "${t.name}" sedang kosong!`,"warning"),!1;const n=g.find(o=>String(o.id)===String(e)&&!o.isVariant);if(n){const o=parseFloat((n.qty+1).toFixed(3));if(r.isManaged&&o>r.totalStock)return m(`Stok tidak cukup! Tersisa: ${j(r.totalStock)} ${t.unit||"pcs"}`,"warning"),!1;n.qty=o,Y(n)}else{const o=parseFloat(t.price)||0;g.push(Y({id:t.id,name:t.name,price:o,basePrice:o,hpp:parseFloat(t.hpp)||0,qty:1,unit:t.unit||"pcs",poTime:t.poTime||"",discount:0,subtotal:o,isVariant:!1,isWholesale:!1}))}return X(),typeof window.triggerHaptic=="function"&&window.triggerHaptic("light"),D(),!0},ba=(e,t)=>{const a=(b.products||[]).find(i=>i&&String(i.id)===String(e));if(!a)return!1;if(!(a.isActive!=="false"&&a.isActive!==!1))return m("Produk ini sedang tidak tersedia","warning"),!1;const r=Ce(a);if(r.isManaged&&r.isOutOfStock)return m(`Maaf, stok "${a.name}" sedang kosong!`,"warning"),!1;const n=He(t)||1,o=g.find(i=>String(i.id)===String(e)&&!i.isVariant);if(o){const i=parseFloat((o.qty+n).toFixed(3));if(r.isManaged&&i>r.totalStock)return m(`Stok tidak cukup! Tersisa: ${j(r.totalStock)} ${a.unit||"pcs"}`,"warning"),!1;o.qty=i,Y(o)}else{if(r.isManaged&&n>r.totalStock)return m(`Stok tidak cukup! Tersisa: ${j(r.totalStock)} ${a.unit||"pcs"}`,"warning"),!1;const i=parseFloat(a.price)||0,d=Y({id:a.id,name:a.name,price:i,basePrice:i,hpp:parseFloat(a.hpp)||0,qty:n,unit:a.unit||"pcs",poTime:a.poTime||"",discount:0,subtotal:i*n,isVariant:!1,isWholesale:!1});g.push(d)}return X(),typeof window.triggerHaptic=="function"&&window.triggerHaptic("light"),D(),!0},xa=(e,t,a,s,r=1)=>{const n=(b.products||[]).find(v=>v&&String(v.id)===String(e));if(!n)return!1;if(!(n.isActive!=="false"&&n.isActive!==!1))return m("Produk ini sedang tidak tersedia","warning"),!1;const i=n.variants?.[s];if(i){if(!(i.isActive!==!1&&i.isActive!=="false"))return m("Varian ini sedang tidak tersedia","warning"),!1;if(b.store?.useStock===!0||b.store?.useStock==="true"){const C=parseFloat(i.stock)||0,w=`${e}__v${s}`,I=g.find(P=>P.cartKey===w),z=I&&parseFloat(I.qty)||0,c=He(r)||1;if(C<=0)return m(`Maaf, stok varian "${i.name}" sedang kosong!`,"warning"),!1;if(z+c>C)return m(`Stok varian "${i.name}" tidak cukup! Sisa: ${j(C)}`,"warning"),!1}}const d=`${e}__v${s}`,p=He(r)||1,f=g.find(v=>v.cartKey===d);if(f)f.qty=parseFloat((f.qty+p).toFixed(3)),Y(f);else{const v=`${n.name} — ${t}`,k=parseFloat(i?.hpp!=null?i.hpp:n.hpp)||0;g.push(Y({id:e,cartKey:d,name:v,variantName:t,variantIdx:s,price:a,basePrice:a,hpp:k,qty:p,unit:i?.unit||n.unit||"pcs",poTime:n.poTime||"",discount:0,subtotal:a*p,isVariant:!0,isWholesale:!1}))}return X(),typeof window.triggerHaptic=="function"&&window.triggerHaptic("light"),D(),!0},ma=(e,t)=>{const a=g.find(r=>(r.cartKey||String(r.id))===String(e));if(!a)return;const s=parseFloat((a.qty+t).toFixed(3));if(s<=0){Ye(e);return}if(t>0){const r=(b.products||[]).find(n=>n&&String(n.id)===String(a.id));if(r&&(b.store?.useStock===!0||b.store?.useStock==="true"))if(a.isVariant&&r.variants){const o=r.variants.find(d=>d.name===a.variantName),i=parseFloat(o?.stock)||0;if(s>i){m(`Stok maksimal "${a.name}" hanya ${j(i)}`,"warning");return}}else{const o=Ce(r);if(o.isManaged&&s>o.totalStock){m(`Stok maksimal tersedia: ${j(o.totalStock)} ${r.unit||"pcs"}`,"warning");return}}}a.qty=s,Y(a),t>0&&X(),D()},ha=(e,t)=>{const a=g.find(n=>(n.cartKey||String(n.id))===String(e));if(!a)return;let s=He(t);if(s<=0){Ye(e);return}const r=(b.products||[]).find(n=>n&&String(n.id)===String(a.id));if(r&&(b.store?.useStock===!0||b.store?.useStock==="true"))if(a.isVariant&&r.variants){const o=r.variants.find(d=>d.name===a.variantName),i=parseFloat(o?.stock)||0;s>i&&(m(`Stok maksimal "${a.name}" hanya ${j(i)}`,"warning"),s=i)}else{const o=Ce(r);o.isManaged&&s>o.totalStock&&(m(`Stok maksimal tersedia: ${j(o.totalStock)} ${r.unit||"pcs"}`,"warning"),s=o.totalStock)}a.qty=s,Y(a),D()},ga=(e,t)=>{const a=g.find(n=>(n.cartKey||String(n.id))===String(e));if(!a)return;const s=ae(t),r=a.hpp!=null?parseFloat(a.hpp):Te(a)||0;if(r>0){const n=Math.max(0,Math.round((a.price-r)*a.qty));if(s>n){m(`Diskon ditolak! Tidak boleh di bawah harga modal (HPP ${x(r)}). Maksimal diskon: ${x(n)}`,"warning"),a.discount=n,Y(a),D(),typeof window.triggerHaptic=="function"&&window.triggerHaptic("heavy");return}}a.discount=Math.min(s,a.price*a.qty),Y(a),D()},Ye=e=>{g=g.filter(t=>(t.cartKey||String(t.id))!==String(e)),D(),typeof window.triggerHaptic=="function"&&window.triggerHaptic("light")},wa=()=>{if(g.length===0)return;const e=()=>{g=[],Q=0,N=0,R="rp",D(),m("Keranjang kasir dikosongkan.")};typeof window.showConfirm=="function"?window.showConfirm("Kosongkan Keranjang","Hapus semua item dari transaksi saat ini?",e,"Ya, Kosongkan",!0):e()},Fe=(e="hold")=>{try{const t=window.AudioContext||window.webkitAudioContext;if(!t)return;const a=new t,s=a.createOscillator(),r=a.createGain();s.type="sine";const n=a.currentTime;e==="hold"?(s.frequency.setValueAtTime(659.25,n),s.frequency.exponentialRampToValueAtTime(880,n+.1)):(s.frequency.setValueAtTime(880,n),s.frequency.exponentialRampToValueAtTime(1174.66,n+.1)),r.gain.setValueAtTime(.08,n),r.gain.exponentialRampToValueAtTime(1e-4,n+.16),s.connect(r),r.connect(a.destination),s.start(),s.stop(n+.16),setTimeout(()=>{a.close().catch(()=>{})},200)}catch{}},Za=e=>{if(!e)return"";const t=Math.floor((Date.now()-e)/1e3);if(t<45)return"Baru saja";const a=Math.floor(t/60);if(a<60)return`${a} mnt lalu`;const s=Math.floor(a/60);return s<24?`${s} jam lalu`:new Date(e).toLocaleDateString("id-ID",{day:"numeric",month:"short",hour:"2-digit",minute:"2-digit"})};let O=[];try{const e=localStorage.getItem("pos_held_carts");if(e){const t=JSON.parse(e);Array.isArray(t)&&(O=t)}}catch{O=[]}const Xe=()=>{try{localStorage.setItem("pos_held_carts",JSON.stringify(O))}catch{}ge()},ge=()=>{const e=O.length,t=l("pos-held-btn-storefront"),a=l("pos-held-btn-admin");t&&(e>0?t.innerHTML=`
            ...
            </button>`)},Ze=()=>{if(g.length===0){m("Keranjang masih kosong, tidak ada transaksi untuk ditahan.","warning");return}const e=h?.name?`Antrean #${O.length+1} — ${h.name}`:`Antrean #${O.length+1}`,t=parseFloat(g.reduce((s,r)=>s+(parseFloat(r.qty)||0),0).toFixed(3)),a=L();$e(!0),typeof window.pushModalHistory=="function"&&window.pushModalHistory("posHoldPrompt"),document.getElementById("pos-hold-prompt-modal")?.remove(),document.body.insertAdjacentHTML("beforeend",`
    ...
    </div>`),setTimeout(()=>{const s=l("pos-hold-note-input");s&&(s.focus(),s.select())},50)},et=(e=!1)=>{const t=l("pos-hold-prompt-modal");t&&(!e&&typeof window.requestCloseModal=="function"?window.requestCloseModal("posHoldPrompt",!1,()=>t.remove()):t.remove())},ht=()=>{if(g.length===0)return;const t=(l("pos-hold-note-input")?.value||"").trim()||`Antrean #${O.length+1}`,a={id:`HELD-${Date.now().toString(36).toUpperCase()}`,time:Date.now(),note:t,cart:JSON.parse(JSON.stringify(g)),globalDisc:pe(),discountType:R,discountVal:N,customer:{...h},total:L(),subtotal:de(),itemCount:parseFloat(g.reduce((s,r)=>s+(parseFloat(r.qty)||0),0).toFixed(3))};O.unshift(a),Xe(),g=[],Q=0,N=0,R="rp",h={name:"",phone:"",isMember:!1,memberId:null,isNewTempo:!1},et(),D(),q(),Fe("hold"),m(`Antrean "${t}" berhasil diparkir!`,"success")},De=(e=!1)=>{!e&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("posHeldModal"),document.getElementById("pos-held-list-modal")?.remove();const t=O.length,a=t===0?`
                ...
                <div class="p-3.5 sm:p-4 hover:bg-slate-50/80 dark:hover:bg-slate-800/40 transition-colors flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    <div class="min-w-0 flex-1">
                        <div class="flex items-center gap-2 mb-1 flex-wrap">
                            ...
                            <span class="text-[10px] text-slate-400">• ${Za(s.time)}</span>
                        </div>
    ...
    <div id="pos-held-list-modal" class="fixed inset-0 z-[9999] flex items-end sm:items-center justify-center p-0 sm:p-4" style="background:rgba(15,23,42,0.65);backdrop-filter:blur(4px)">
    ...
    </div>`)},Ne=(e=!1)=>{const t=l("pos-held-list-modal");t&&(!e&&typeof window.requestCloseModal=="function"?window.requestCloseModal("posHeldModal",!1,()=>t.remove()):t.remove())},gt=e=>{const t=O.findIndex(a=>a.id===e);if(t===-1){m("Transaksi tertahan tidak ditemukan.","warning");return}if(g.length>0){document.getElementById("pos-recall-confirm-modal")?.remove(),document.body.insertAdjacentHTML("beforeend",`
        ...
        </div>`);return}wt(t)},wt=e=>{const t=O[e];t&&(g=JSON.parse(JSON.stringify(t.cart||[])),R=t.discountType||"rp",N=t.discountVal!==void 0?t.discountVal:t.globalDisc||0,Q=pe(),h=t.customer?{...t.customer}:{name:"",phone:"",isMember:!1,memberId:null,isNewTempo:!1},O.splice(e,1),Xe(),Ne(),D(),q(),Fe("recall"),m(`Antrean "${t.note}" berhasil dipanggil kembali!`,"success"))},kt=e=>{document.getElementById("pos-recall-confirm-modal")?.remove();const t=h?.name?`Antrean #${O.length+1} — ${h.name}`:`Antrean #${O.length+1}`,a={id:`HELD-${Date.now().toString(36).toUpperCase()}`,time:Date.now(),note:t,cart:JSON.parse(JSON.stringify(g)),globalDisc:pe(),discountType:R,discountVal:N,customer:{...h},total:L(),subtotal:de(),itemCount:parseFloat(g.reduce((r,n)=>r+(parseFloat(n.qty)||0),0).toFixed(3))};O.unshift(a);const s=O.findIndex(r=>r.id===e);s!==-1?wt(s):(Xe(),Ne())},vt=e=>{document.getElementById("pos-recall-confirm-modal")?.remove();const t=O.findIndex(a=>a.id===e);t!==-1&&wt(t)},yt=e=>{const t=O.find(a=>a.id===e);t&&(document.getElementById("pos-delete-confirm-modal")?.remove(),document.body.insertAdjacentHTML("beforeend",`
    <div id="pos-delete-confirm-modal" class="fixed inset-0 z-[10005] flex items-center justify-center p-4" style="background:rgba(15,23,42,0.75);backdrop-filter:blur(4px)">
        <div class="bg-white dark:bg-slate-900 rounded-3xl shadow-2xl w-full max-w-xs border border-slate-200 dark:border-slate-800 p-6 text-center transform transition-all">
            ...
            <div class="flex gap-2.5">
    ...
    </div>`))},St=e=>{document.getElementById("pos-delete-confirm-modal")?.remove();const t=O.find(a=>a.id===e);O=O.filter(a=>a.id!==e),Xe(),m(`Antrean "${t?.note||""}" berhasil dihapus.`,"info"),De(!0)},Pt=()=>{const e=l("pos-mobile-cart-drawer"),t=l("pos-mobile-cart-sheet");e&&t&&(e.classList.remove("opacity-0","pointer-events-none"),e.classList.add("opacity-100"),t.classList.remove("translate-y-full"),t.classList.add("translate-y-0"),typeof window.pushModalHistory=="function"&&window.pushModalHistory("posCartDrawer"),typeof window.triggerHaptic=="function"&&window.triggerHaptic("light"))},$e=(e=!1)=>{const t=l("pos-mobile-cart-drawer"),a=l("pos-mobile-cart-sheet");if(t&&a){const s=()=>{a.classList.add("translate-y-full"),a.classList.remove("translate-y-0"),t.classList.add("opacity-0","pointer-events-none"),t.classList.remove("opacity-100")};!e&&typeof window.requestCloseModal=="function"?window.requestCloseModal("posCartDrawer",!1,s):s()}},es=e=>{if(!e)return"";if(e.img&&typeof e.img=="string")return rt(e.img,"w150-rw");const t=(b?.products||[]).find(a=>a&&String(a.id)===String(e.id));return t&&t.img&&typeof t.img=="string"?rt(t.img,"w150-rw"):""},q=()=>{try{if(!b?.products||!b.products.length)try{const o=JSON.parse(localStorage.getItem("freshmart_products")||"null");Array.isArray(o)&&o.length>0&&(b||(window.appData={}),b.products=o)}catch{}const e=Array.isArray(b?.products)?b.products:[],t=e.filter(o=>{if(!o||o.isActive==="false"||o.isActive===!1||be&&o.category!==be)return!1;if(te){const i=String(te).toLowerCase(),d=String(o.name||"").toLowerCase(),p=String(o.barcode||"").toLowerCase(),f=String(o.sku||"").toLowerCase(),v=String(o.category||"").toLowerCase(),k=String(o.subCategory||"").toLowerCase(),C=String(o.brand||"").toLowerCase(),w=Array.isArray(o.variants)&&o.variants.some(I=>(I.name||"").toLowerCase().includes(i)||(I.sku||"").toLowerCase().includes(i)||(I.barcode||"").toLowerCase().includes(i));return d.includes(i)||p.includes(i)||f.includes(i)||v.includes(i)||k.includes(i)||C.includes(i)||w}return!0}),a=e.filter(o=>o&&o.isActive!=="false"&&o.isActive!==!1&&o.category).map(o=>String(o.category).trim()).filter(o=>o.length>0),r=["Semua",...new Set(a)].map(o=>{const i=o==="Semua",d=i?!be:be===o;return`<button onclick="window.posCatFilter('${u(i?"":o)}')" class="shrink-0 px-3.5 py-1.5 rounded-xl text-[11px] font-black uppercase tracking-wider border transition-all active:scale-95 shadow-2xs ${d?"text-white border-transparent":"bg-white dark:bg-slate-800 text-slate-600 dark:text-slate-300 border-slate-200 dark:border-slate-700 hover:border-[var(--color-primary)]/50"}" style="${d?"background:var(--color-primary)":""}">${u(o)}</button>`}).join(""),n=t.length===0?`<div class="col-span-full flex flex-col items-center justify-center py-20 text-slate-400 dark:text-slate-600">
               ...
               </div>`:t.map(o=>{if(!o)return"";const i=!!(o.img&&typeof o.img=="string"&&o.img.trim()),d=i?rt(o.img,"w300-rw"):"",p=Array.isArray(o.variants)&&o.variants.length>0,f=Array.isArray(o.wholesale)&&o.wholesale.length>0,v=g.filter(F=>F&&String(F.id)===String(o.id)),k=parseFloat(v.reduce((F,B)=>F+(B&&B.qty&&parseFloat(B.qty)||0),0).toFixed(3)),C=u(String(o.id!=null?o.id:"")),w=Ce(o),I=u(String(o.name||"Produk")),z=u(String(o.category||"")),c=parseFloat(o.price)||0;let P="",y="";o.priceNormal&&parseFloat(o.priceNormal)>c&&(P=`<span class="pos-badge pos-badge-promo"><i class="fa-solid fa-tags" style="font-size:6px"></i> -${Math.round((parseFloat(o.priceNormal)-c)/parseFloat(o.priceNormal)*100)}%</span>`,y=`<span class="text-[10px] text-slate-400 line-through font-bold">${x(parseFloat(o.priceNormal))}</span>`);const J=w.isPreorder?`<span class="pos-badge pos-badge-po"><i class="fa-solid fa-clock" style="font-size:6px"></i> PO ${u(w.poTime)}</span>`:"",H=`${z||"Produk"}${o.brand?` · ${u(o.brand)}`:""}`;let M=0,$="";if(p){const F=(o.variants||[]).map(B=>B.hpp!=null?parseFloat(B.hpp)||0:parseFloat(o.hpp)||0).filter(B=>B>0);if(F.length>0){const B=Math.min(...F),V=Math.max(...F);M=B,$=B===V?x(B):`${x(B)} - ${x(V)}`}else o.hpp!=null&&parseFloat(o.hpp)>0&&(M=parseFloat(o.hpp),$=x(M))}else o.hpp!=null&&parseFloat(o.hpp)>0&&(M=parseFloat(o.hpp),$=x(M));const T=`<span class="pos-hpp-tag" title="Harga Pokok Penjualan (Modal Kasir)"><i class="fa-solid fa-coins text-[8px]"></i> Modal: <b>${$||(o.hpp?x(parseFloat(o.hpp)):"Rp 0")}</b></span>`;return ee==="list"?`
                    <div class="pos-list-item${k>0?" in-cart":""}${w.isOutOfStock?" is-out-of-stock cursor-not-allowed":" cursor-pointer"}" onclick="window.posAddToCart('${C}')">
                        ...
                        <div style="flex:1;min-width:0" class="flex flex-col justify-center">
                            ...
                            <div class="flex items-center gap-1.5 flex-wrap">
                                <span class="text-[9px] uppercase tracking-wider font-bold text-slate-400 dark:text-slate-500 truncate max-w-[130px]">${H}</span>
                ...
                <div class="pos-product-card${k>0?" in-cart":""}${w.isOutOfStock?" is-out-of-stock cursor-not-allowed":" cursor-pointer"}" onclick="window.posAddToCart('${C}')">
                    ...
                    <div class="pos-card-info">
                        <p class="pos-card-cat truncate">${H}</p>
                ...
                </div>`})}},D=()=>{const e=parseFloat(g.reduce((c,P)=>c+(parseFloat(P.qty)||0),0).toFixed(3)),t=de(),a=L(),s=x(a),r=x(t),n=g.length===0?`<div class="flex flex-col items-center justify-center h-full py-12 text-slate-300 dark:text-slate-600 select-none">
            <div class="w-16 h-16 rounded-3xl bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-slate-400 mb-3 shadow-inner">
           ...
           </div>`:g.map(c=>{const P=u(String(c.cartKey||c.id)),y=es(c),J=c.isVariant&&c.variantName?u(c.name.replace(` — ${c.variantName}`,"")):u(c.name),H=c.hpp!=null?parseFloat(c.hpp):Te(c)||0,M=H>0?Math.max(0,Math.round((c.price-H)*c.qty)):Math.round(c.price*c.qty),$=Math.round(c.subtotal-H*c.qty);return`
            <div class="group flex items-start gap-2.5 p-2.5 bg-white dark:bg-slate-800/90 rounded-2xl border border-slate-200/90 dark:border-slate-700/80 shadow-xs hover:border-[var(--color-primary)] transition-all">
                ...
                <div class="flex-1 min-w-0 pr-1">
                    ...
                    <div class="flex items-center gap-1.5 mt-0.5 flex-wrap">
                        ...
                        ${H>0?`<span class="inline-flex items-center gap-1 text-[8px] font-black px-1.5 py-0.5 rounded text-amber-950 bg-amber-100 dark:bg-amber-950/60 dark:text-amber-300 border border-amber-300/80 dark:border-amber-700 shadow-2xs" title="Harga Modal (HPP)"><i class="fa-solid fa-coins text-[7px] text-amber-600 dark:text-amber-400"></i>HPP: ${x(H)}</span>`:""}
                    ...
                    <div class="flex items-center gap-1.5 mt-1.5 flex-wrap">
                        ...
                        <input type="number" min="0" ${H>0?`max="${M}"`:""} placeholder="0" value="${c.discount||""}" onchange="window.posSetItemDisc('${P}',this.value)"
                        ...
                        ${H>0?`<span class="text-[9px] text-amber-600 dark:text-amber-400 font-bold whitespace-nowrap" title="Maksimal diskon agar tidak di bawah harga modal HPP">(Maks: ${x(M)})</span>`:""}
                    </div>
                </div>
                <!-- Stepper & Subtotal -->
    ...
    <div id="pos-pay-modal" class="fixed inset-0 z-[9999] flex items-end sm:items-center justify-center p-0 sm:p-4" style="background:rgba(15,23,42,0.65);backdrop-filter:blur(4px)">
      ...
      <div class="p-3 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-100 dark:border-slate-700/60 mb-2.5 text-xs space-y-1.5">
        ...
        `}else if(e==="qris"){const o=b.payment?.qrisUrl||"";t.innerHTML=`
          ...
          <input id="pos-dp-input" type="number" min="0" placeholder="0" value="0" class="w-full border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2 text-xs font-black text-right bg-white dark:bg-slate-800 focus:outline-none focus:border-[var(--color-primary)]">`)},ya=e=>{h.isMember=e==="member",h.isNewTempo=e==="tempo",va("pos-ctype",e,["umum","member","tempo"]);const t=l("pos-customer-fields");t&&(e==="umum"?(h.name="",h.phone="",h.memberId=null,h.points=0,t.innerHTML='<input id="pos-cust-name" type="text" placeholder="Nama pembeli (opsional)" class="w-full border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2 text-xs bg-slate-50 dark:bg-slate-800 text-slate-800 dark:text-slate-100 focus:outline-none focus:border-[var(--color-primary)] focus:bg-white">'):e==="member"?(t.innerHTML=`
          <div class="space-y-2">
          ...
          </div>`,ue().then(()=>{l("pos-cust-phone")?.value?.trim()&&Re()})):e==="tempo"&&(h.isMember=!1,Mt("tempo"),t.innerHTML=`
          <div class="space-y-2">
          ...
          </div>`))},Mt=e=>{E=e,va("pos-pay",e,["cash","qris","transfer","tempo"]),nt(e),e==="transfer"&&(!b.banks||!b.banks.length)&&Be().then(t=>{E==="transfer"&&t&&t.length>0&&nt("transfer")})},Ct=e=>{U=ae(e);const t=L(),a=U-t,s=l("pos-change-display"),r=l("pos-change-label"),n=l("pos-change-box"),o=l("pos-process-btn");s&&(s.textContent=x(Math.abs(a))),r&&(r.textContent=a>=0?"Kembalian Uang Pembeli:":"Uang Masih Kurang:"),s&&(s.className=`text-base font-black ${a>=0?"text-emerald-700 dark:text-emerald-400":"text-rose-600 dark:text-rose-400"}`),n&&(n.className=`mt-2.5 p-3 rounded-2xl border transition-all flex items-center justify-between ${a>=0?"bg-emerald-50 dark:bg-emerald-950/30 border-emerald-200 dark:border-emerald-800":"bg-rose-50 dark:bg-rose-950/30 border-rose-200 dark:border-rose-800"}`),o&&E==="cash"&&(o.disabled=a<0,o.classList.toggle("opacity-50",a<0))},$t=e=>{const t=l("pos-paid-input");t&&(t.value=e,Ct(e),typeof window.triggerHaptic=="function"&&window.triggerHaptic("light"))},Be=async()=>{if(Array.isArray(b.banks)&&b.banks.length>0)return b.banks;try{const e=await A.collection("freshmart").doc("cms_data").get();if(e.exists){const t=e.data();if(Array.isArray(t?.banks)&&t.banks.length>0)return b.banks=t.banks,b.banks}}catch{}return b.banks||[]},ue=async()=>{if(b.customers&&b.customers.length>0)return b.customers;try{const e=await A.collection("freshmart").doc("cms_data").collection("customers").get();return b.customers=e.docs.map(t=>({...t.data(),id:t.id,_docId:t.id})),b.customers}catch{return b.customers||[]}},Sa=(e,t)=>{if(!e||!t||!t.length)return[];const a=e.trim().toLowerCase(),s=a.replace(/\D/g,"");let r=s;r.startsWith("62")?r=r.slice(2):r.startsWith("0")&&(r=r.slice(1));const n=[],o=new Set;return t.forEach(i=>{if(!i)return;const d=String(i.id||i._docId||i.phone||"");if(o.has(d))return;const p=String(i.phone||"").replace(/\D/g,"");let f=p;f.startsWith("62")?f=f.slice(2):f.startsWith("0")&&(f=f.slice(1));const v=String(i.name||"").toLowerCase();let k=!1;r.length>=4&&f&&(f===r||f.endsWith(r)||r.endsWith(f)||p.includes(s))&&(k=!0),!k&&(d.toLowerCase()===a||d===s)&&(k=!0),!k&&a.length>=2&&v.includes(a)&&(k=!0),k&&(o.add(d),n.push(i))}),n},ts=async e=>{if(!e)return null;const t=e.trim(),a=t.replace(/\D/g,"");let s=a;s.startsWith("62")?s=s.slice(2):s.startsWith("0")&&(s=s.slice(1));const r=A.collection("freshmart").doc("cms_data").collection("customers"),o=Array.from(new Set([s?"62"+s:null,s?"0"+s:null,s||null,s?"+62"+s:null,a||null,t].filter(Boolean))).map(async p=>{try{const f=await r.doc(p).get();if(f&&f.exists)return{...f.data(),id:f.id,_docId:f.id}}catch{}return null}),d=(await Promise.all(o)).find(Boolean);if(d){b.customers||(b.customers=[]);const p=b.customers.findIndex(f=>String(f.id||f.phone)===String(d.id||d.phone));return p>-1?b.customers[p]=d:b.customers.push(d),d}try{const p=await r.limit(300).get();if(!p.empty){b.customers=p.docs.map(v=>({...v.data(),id:v.id,_docId:v.id}));const f=Sa(e,b.customers);if(f.length>0)return f[0]}}catch{}return null},Ue=e=>{h.isMember=!0,h.name=e.name||"Member Toko",h.phone=e.phone||"",h.memberId=e.id||e._docId||e.phone,h.points=parseFloat(e.points)||0;const t=l("pos-cust-phone");t&&(t.value=e.phone||e.name||"");const a=h.points,s=typeof window.getMemberTier=="function"?window.getMemberTier(a):{badge:"MEMBER RESMI"},r=l("pos-member-result");r&&(r.innerHTML=`
        <div class="p-3 bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-950/40 dark:to-teal-950/30 rounded-2xl border border-emerald-300 dark:border-emerald-700/60 shadow-xs flex items-center justify-between gap-2.5">
          ...
          <button onclick="window.resetPosMember()" type="button" class="shrink-0 px-2.5 py-1.5 rounded-xl text-[10px] font-bold text-slate-600 hover:text-rose-600 dark:text-slate-300 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 transition-all cursor-pointer" title="Ganti Member">
        ...
        </div>`),m(`Member terdeteksi: ${e.name} (${a} Poin)`,"success")},At=e=>{const a=(b.customers||[]).find(s=>s&&String(s.id||s._docId||s.phone)===String(e));a&&Ue(a)},Ot=()=>{h.isMember=!1,h.name="",h.phone="",h.memberId=null,h.points=0;const e=l("pos-cust-phone");e&&(e.value="",e.focus());const t=l("pos-member-result");t&&(t.innerHTML="")};let Ut=null;const Ht=()=>{clearTimeout(Ut);const e=l("pos-cust-phone")?.value?.trim()||"";if(!e){if(!h.memberId){const s=l("pos-member-result");s&&(s.innerHTML="")}return}const t=e.replace(/\D/g,"");!(Array.isArray(b.customers)&&b.customers.length>0)&&t.length<10&&e.length<8||(Ut=setTimeout(()=>{Re()},350))},Re=async()=>{const t=l("pos-cust-phone")?.value?.trim()||"";if(!t){m("Masukkan nomor HP atau nama member","warning");return}const a=l("pos-member-result"),s=l("pos-member-lookup-btn");s&&(s.disabled=!0,s.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>'),a&&(a.innerHTML='<div class="p-2.5 text-center text-xs text-slate-400"><i class="fa-solid fa-spinner fa-spin mr-1.5"></i>Memeriksa database member...</div>');try{await ue();const r=Sa(t,b.customers||[]);if(r.length===1)Ue(r[0]);else if(r.length>1)a.innerHTML=`
            ...
            `;else{const n=await ts(t);if(n)Ue(n);else{h.isMember=!1,h.name="",h.memberId=null,h.points=0;const i=t.replace(/\D/g,"").length>=8;a.innerHTML=`
                  <div class="p-3 bg-amber-50 dark:bg-amber-950/30 rounded-xl border border-amber-200 dark:border-amber-800 text-amber-800 dark:text-amber-300 text-xs space-y-1">
                    ...
                    `}
                  </div>`}}}catch(r){console.error("[POS] Error lookupPosMember:",r),a&&(a.innerHTML=`<p class="text-xs text-rose-500 p-2">Gagal memeriksa data: ${u(r.message||"Koneksi error")}</p>`)}finally{s&&(s.disabled=!1,s.innerHTML='<i class="fa-solid fa-magnifying-glass mr-1.5"></i><span>Cek</span>')}},Pa=async()=>{if(g.length===0){m("Keranjang kosong!","warning");return}const e=ce();if(e>0&&L()<e){m(`Transaksi ditolak! Total transaksi (${x(L())}) tidak boleh di bawah total harga modal HPP (${x(e)})!`,"error"),typeof window.triggerHaptic=="function"&&window.triggerHaptic("heavy");return}const t=h.isMember?h.name||"Member Toko":l("pos-cust-name")?.value?.trim()||"Pelanggan Umum",a=h.isMember?h.phone||l("pos-cust-phone")?.value?.trim()||"":l("pos-cust-phone")?.value?.trim()||"";if(h.isNewTempo&&!a){m("No. HP wajib diisi untuk tempo!","warning");return}if(E==="cash"&&(U=ae(l("pos-paid-input")?.value||0),U<L())){m(`Uang kurang! Minimal ${x(L())}`,"warning");return}h.name=t,h.phone=a;const s=E==="tempo"?ae(l("pos-dp-input")?.value||0):0,r=E==="transfer"&&l("pos-bank-sel")?.value||"",n=l("pos-process-btn");n&&(n.disabled=!0,n.innerHTML='<i class="fa-solid fa-spinner fa-spin mr-2"></i>Memproses...');const o=b.store?.useStock===!0||b.store?.useStock==="true";if(o)for(const i of g){const d=(b.products||[]).find(f=>String(f.id)===String(i.id));if(!d)continue;const p=parseFloat(i.qty)||0;if(i.variantName&&d.variants){const f=(d.variants||[]).find(k=>k.name===i.variantName),v=parseFloat(f&&f.stock!==void 0?f.stock:0);if(v<p){m(`Stok ${i.name} (${i.variantName}) tidak cukup! Sisa: ${v}`,"warning"),n&&(n.disabled=!1,n.innerHTML='<i class="fa-solid fa-check-circle mr-2"></i>Selesaikan Transaksi');return}}else{const f=parseFloat(d.stock!==void 0?d.stock:0);if(f<p){m(`Stok ${i.name} tidak cukup! Sisa: ${f}`,"warning"),n&&(n.disabled=!1,n.innerHTML='<i class="fa-solid fa-check-circle mr-2"></i>Selesaikan Transaksi');return}}}try{const i=Xa(),d=typeof window.getCashierSession=="function"?window.getCashierSession():null,p=d?.name||b.store?.name||"Kasir",f=d?.uid||window.__currentAdminUid||"admin",v=new Date().toISOString(),k=st.firestore.FieldValue.serverTimestamp(),C=E==="tempo"?"Diproses":"Selesai",w=_(),I=w&&w.status==="open"?w.id:null,z=w&&w.status==="open"?w.shiftNo||w.id:null,c={orderId:i,txId:i,source:"pos",channel:"pos",status:C,timestamp:k,dateString:v,dateMs:Date.now(),shiftId:I,shiftNo:z,cashier:f,cashierName:p,customer:{name:t,phone:a,wa:a,address:"Beli Langsung di Kasir (POS)",deliveryMethod:"takeaway",isMember:!!h.isMember,memberId:h.memberId||null},customerName:t,customerPhone:a,customerType:h.isMember?"Member":"Pelanggan Umum",items:g.map(y=>({id:y.id,name:y.name,price:parseFloat(y.price)||0,basePrice:parseFloat(y.basePrice||y.price)||0,hpp:y.hpp!=null?parseFloat(y.hpp):Te(y)||0,qty:parseFloat(y.qty)||1,discount:parseFloat(y.discount)||0,subtotal:parseFloat(y.subtotal)||0,variantName:y.variantName||"",isVariant:!!y.isVariant,isWholesale:!!y.isWholesale,effectivePrice:parseFloat(y.price)||0,poTime:y.poTime||"",unit:y.unit||"pcs"})),hasPO:g.some(y=>y.poTime&&String(y.poTime).trim()!==""),payment:{method:E,subtotal:de(),productDiscount:ae(Q),shippingCost:0,grandTotal:L(),paid:E==="cash"?U:E==="tempo"?s:L(),change:E==="cash"?ca():0,bank:r,paymentStatus:E==="tempo"?"hutang":"lunas",tempoDp:s,tempoBalance:E==="tempo"?L()-s:0,tempoDueDate:Date.now()+30*24*60*60*1e3,tempoPenaltyRate:1,tempoPenaltyStopped:!1},subtotal:de(),globalDiscount:pe(),discountType:R,discountVal:N,totalHpp:e,grossProfit:Math.max(0,L()-e),total:L(),isTempo:E==="tempo",pointsEarned:0,notes:""};if(h.isMember&&a){const J=(typeof window.calculateCartPoints=="function"?window.calculateCartPoints(g,b.store):{totalPoints:0}).totalPoints||0;if(J>0){c.pointsEarned=J;try{const H=a.replace(/\D/g,""),M=String(h.memberId||H);if(await A.collection("freshmart").doc("cms_data").collection("customers").doc(M).set({points:st.firestore.FieldValue.increment(J),lastOrderAt:v},{merge:!0}),b.customers){const T=b.customers.find(F=>F&&(String(F.id)===M||String(F.phone).replace(/\D/g,"")===H));T&&(T.points=(parseFloat(T.points)||0)+J)}}catch(H){console.warn("[POS] Gagal update poin member:",H)}}}if(await A.collection("freshmart_orders").doc(i).set(c),na(c),o){const y={};g.forEach(M=>{const $=M.id!=null?M.id.toString():null;if(!$)return;y[$]||(y[$]={main:0,variants:{}});const T=parseFloat(M.qty)||0;M.variantName?y[$].variants[M.variantName]=(y[$].variants[M.variantName]||0)+T:y[$].main+=T});const J=Object.keys(y),H=[];for(const M of J){const $=y[M],T=(b.products||[]).find(V=>String(V.id)===M);if(!T)continue;const F={};$.main>0&&(T.stock=Math.max(0,(parseFloat(T.stock)||0)-$.main),F.stock=T.stock,T.stock===0&&(T.isActive="false",F.isActive="false"),T.totalSold=(parseFloat(T.totalSold)||0)+$.main,F.totalSold=T.totalSold),Object.keys($.variants).length>0&&T.variants&&(Object.keys($.variants).forEach(V=>{const fe=T.variants.findIndex(La=>La.name===V);fe>-1&&(T.variants[fe].stock=Math.max(0,(parseFloat(T.variants[fe].stock)||0)-$.variants[V]),T.variants[fe].stock===0&&(T.variants[fe].isActive=!1),T.variants[fe].totalSold=(parseFloat(T.variants[fe].totalSold)||0)+$.variants[V])}),F.variants=T.variants);const B=(b.products||[]).findIndex(V=>String(V.id)===M);B>-1&&(b.products[B]=T);try{await A.collection("freshmart").doc("cms_data").collection("products").doc(M).update(F),H.push(M)}catch(V){console.warn("[POS] Gagal update stok produk di Firestore:",M,V)}}if(H.length>0)try{await A.collection("freshmart").doc("cms_data").update({lastUpdate:st.firestore.FieldValue.increment(1),updateType:"stock_change",updatedProductIds:H})}catch{}}Tt(),$e(!0);const P={...c};g=[],Q=0,N=0,R="rp",D(),q(),as(P)}catch(i){console.error("[POS] Error:",i),m("Gagal menyimpan transaksi. Coba lagi.","error"),n&&(n.disabled=!1,n.innerHTML='<i class="fa-solid fa-check-circle mr-2"></i>Selesaikan Transaksi')}},as=e=>{const t=e.payment.method==="cash"?`<p class="text-sm text-slate-500">Kembalian: <span class="font-black text-emerald-600">${x(e.payment.change)}</span></p>`:e.payment.method==="tempo"?'<p class="text-sm text-amber-600 font-semibold">⚠️ Dicatat sebagai Piutang Tempo</p>':`<p class="text-sm text-slate-500">Metode: ${e.payment.method.toUpperCase()}</p>`,a=JSON.stringify(e).replace(/"/g,"&quot;"),s=!!document.getElementById("pos-admin-container")||typeof window.cTab=="function"&&window.cTab()==="pos";document.body.insertAdjacentHTML("beforeend",`
    ...
    </div>`)},Ta=e=>{document.getElementById("pos-success-modal")?.remove(),tt(e)},tt=e=>{const t=typeof ne=="function"?ne():{paperSize:"58mm"},a=t.paperSize==="80mm",s=t.headerText||b.store?.name||"TOKO PUTRI",r=b.store?.wa||"",n=b.store?.address||"",o=t.footerText||"Terima Kasih Atas Kunjungan Anda!",i=new Date(e.dateMs||Date.now()).toLocaleString("id-ID"),d=(e.items||[]).map(f=>`<tr><td style="padding:2px 0;word-wrap:break-word">${u(f.name)}</td><td style="text-align:right;padding:2px 4px;white-space:nowrap">${j(f.qty)}x ${x(f.price)}</td><td style="text-align:right;padding:2px 0;white-space:nowrap;font-weight:bold">${x(f.subtotal)}</td></tr>`).join(""),p=e.discountType==="percent"&&e.discountVal?`Diskon (${e.discountVal}%)`:"Diskon";document.getElementById("pos-receipt-fallback-modal")?.remove(),document.body.insertAdjacentHTML("beforeend",`
    ...
    </div>`)},Lt=()=>{const e=typeof ne=="function"?ne():{paperSize:"58mm",deviceType:"system"},t=l("pos-receipt-paper-box");if(!t)return;let a=l("thermal-print-section");a||(a=document.createElement("div"),a.id="thermal-print-section",document.body.appendChild(a));const s=e.paperSize==="80mm";if(a.innerHTML=`<div style="width:${s?"80mm":"58mm"};font-family:'Courier New',Courier,monospace;font-size:11px;line-height:1.2;color:#000;background:#fff;padding:4px;">${t.innerHTML}</div>`,e.deviceType==="rawbt"&&window.AndroidNativeApp&&typeof window.AndroidNativeApp.printRawBT=="function"){const r=t.innerText,n=btoa(unescape(encodeURIComponent(r)));window.AndroidNativeApp.printRawBT(n)}else window.AndroidNativeApp&&typeof window.AndroidNativeApp.print=="function"?window.AndroidNativeApp.print():window.print()},Ma=({isStorefront:e})=>{const a=(typeof window.getCashierSession=="function"?window.getCashierSession():null)?.name||(e?"Kasir":"Admin Seller"),s=u(b.store?.name||"Toko Putri");return`
    ...
    `},Ca=()=>{try{te="",be="",g=[],Q=0;const e=l("view-pos-cashier");if(!e)return;const t=l("admin-content"),a=l("view-admin");t&&a?.classList.contains("admin-pos-mode")&&(t.innerHTML="",a.classList.remove("admin-pos-mode")),e.innerHTML=Ma({isStorefront:!0}),q(),D(),ge(),Ie(),fa(),pa(),ue(),Aa(),typeof re=="function"?re().then(s=>{(!s||s.status!=="open")&&K()}).catch(()=>{le()||K()}):setTimeout(()=>{le()||K()},350)}catch(e){console.error("Gagal render POS Storefront:",e)}},$a=()=>{try{te="",be="";const e=l("view-admin");e&&e.classList.add("admin-pos-mode");const t=l("view-pos-cashier");if(t&&(t.innerHTML=""),!l("admin-content"))return;Da("admin-content",`
        ...
        `),q(),D(),ge(),Ie(),fa(),pa(),ue(),Aa(),typeof re=="function"?re().then(s=>{(!s||s.status!=="open")&&K()}).catch(()=>{le()||K()}):setTimeout(()=>{le()||K()},350)}catch(e){console.error("Gagal render POS Admin:",e);const t=l("admin-content");t&&(t.innerHTML=`
            ...
            `)}},Aa=()=>{window.setPOSViewMode=mt,window.posAddToCart=Je,window.posAddToCartQty=ba,window.addToCartPOSWithVariant=xa,window.posUpdateQty=ma,window.posSetQty=ha,window.posFormatQty=j,window.posFQty=He,window.posSetItemDisc=ga,window.posRemoveItem=Ye,window.posClearCart=wa,window.openPayModal=ka,window.closePayModal=Tt,window.getPOSCart=()=>g,window.getCartTotalHpp=ce,window.setPosCustomerType=ya,window.setPosPayMethod=Mt,window.updatePosChange=Ct,window.posSetQuickCash=$t,window.ensureCustomersLoaded=ue,window.ensureBanksLoaded=Be,window.lookupPosMember=Re,window.debouncedLookupPosMember=Ht,window.selectPosMember=At,window.resetPosMember=Ot,window.processPOSTx=Pa,window.printPOSReceipt=Ta,window.previewPOSReceiptThenPrint=tt,window.posSetGlobalDisc=e=>{Le(e)},window.posSetDiscountType=jt,window.posSetDiscountVal=Le,window.posApplyQuickDiscount=It,window.openPOSCameraScanner=at,window.closePOSCameraScanner=he,window.togglePOSScannerFacing=Dt,window.togglePOSScannerTorch=Ft,window.togglePOSScannerMode=Nt,window.posProcessManualBarcode=Bt,window.posSearchScannedCode=Rt,window.executePOSPrintDirect=Lt,window.getActiveShift=_,window.isShiftActive=le,window.syncActiveShiftFromCloud=re,window.openPOSOpenShiftModal=K,window.closePOSOpenShiftModal=Pe,window.openPOSShiftModal=G,window.openPOSShiftSummaryModal=G,window.closePOSShiftSummaryModal=ze,window.openPOSCloseShiftModal=ut,window.closePOSCloseShiftModal=je,window.renderShiftHeaderBadge=Ie,window.printShiftSettlementReceipt=ft,window.executeShiftPrintDirect=bt,window.posCatFilter=e=>{be=e,q()},window.posSearchFn=e=>{te=typeof e=="string"?e:e?.value||"",document.querySelectorAll("#pos-search-input").forEach(t=>{t.value!==te&&(t.value=te)}),q()},window.posRenderCatalog=q,window.posRenderCart=D,window.refreshPOSCatalog=()=>{try{q()}catch(e){console.warn("refreshPOSCatalog error:",e)}},window.openPOSCartDrawer=Pt,window.closePOSCartDrawer=$e,window.playCashierBeep=X,window.openPOSHistory=()=>{typeof window.openAdminTab=="function"?window.openAdminTab("orders"):typeof window.showToast=="function"&&window.showToast("Semua transaksi kasir terpusat di menu Pesanan CMS Admin")},window.destroyBarcodeListener=We,window.playCashierChime=Fe,window.posHoldCurrentCart=Ze,window.closePOSHoldPrompt=et,window.posConfirmHoldCart=ht,window.openPOSHeldModal=De,window.closePOSHeldModal=Ne,window.posRecallHeldCart=gt,window.posHoldCurrentAndRecall=kt,window.posOverwriteAndRecall=vt,window.posDeleteHeldCart=yt,window.posExecuteDeleteHeld=St,window.renderHeldBadges=ge},jt=e=>{R=e==="percent"?"percent":"rp",Q=pe(),D()},Le=e=>{const t=Math.max(0,parseFloat(e)||0),a=ce(),s=de(),r=a>0?Math.max(0,s-a):s;if(R==="percent"){const n=Math.min(100,t),o=Math.round(s*n/100);if(a>0&&o>r){const i=s>0?Math.floor(r/s*100):0;m(`Diskon ${n}% ditolak karena melebihi modal (Total HPP ${x(a)})! Diskon maksimal: ${i}% (${x(r)})`,"warning"),N=i,Q=Math.round(s*i/100),D(),typeof window.triggerHaptic=="function"&&window.triggerHaptic("heavy");return}N=n,Q=o}else{const n=t;if(a>0&&n>r){m(`Diskon ditolak! Total transaksi tidak boleh di bawah harga modal (Total HPP ${x(a)}). Maksimal diskon: ${x(r)}`,"warning"),N=r,Q=r,D(),typeof window.triggerHaptic=="function"&&window.triggerHaptic("heavy");return}N=n,Q=n}D()},It=(e,t)=>{t&&(R=t),Le(e),X()},at=async()=>{if(l("pos-camera-scanner-modal"))return;typeof window.pushModalHistory=="function"&&window.pushModalHistory("posCameraScanner"),document.body.insertAdjacentHTML("beforeend",`
    ...
    </div>`),await Oa()},Oa=async()=>{const e=l("pos-camera-video");if(e)try{const t={video:{facingMode:{ideal:ot},width:{ideal:1280},height:{ideal:720}},audio:!1},a=await navigator.mediaDevices.getUserMedia(t);me=a,e.srcObject=a,await e.play();const s=a.getVideoTracks();if(s.length>0){oe=s[0];const r=oe.getCapabilities?oe.getCapabilities():{},n=l("pos-scanner-torch-btn");n&&(r.torch?n.classList.remove("hidden"):n.classList.add("opacity-40"))}if(typeof window.BarcodeDetector<"u")try{Ee=new BarcodeDetector({formats:["ean_13","ean_8","upc_a","upc_e","code_128","code_39","code_93","qr_code","data_matrix"]})}catch{Ee=null}ye&&clearInterval(ye),ye=setInterval(async()=>{if(!(!Ee||!e||e.readyState<2))try{const r=await Ee.detect(e);if(r&&r.length>0){const n=r[0].rawValue?.trim();n&&Ha(n)}}catch{}},180)}catch(t){console.warn("[POS Scanner] Gagal akses kamera:",t);const a=l("pos-scanner-status-pill");a&&(a.innerHTML='<span class="text-rose-400 font-bold"><i class="fa-solid fa-triangle-exclamation mr-1"></i>Kamera tidak dapat diakses</span>'),m("Izin kamera ditolak atau kamera sedang digunakan aplikasi lain.","warning")}},Ha=e=>{const t=Date.now();if(e===Kt&&t-Vt<1800)return;Kt=e,Vt=t;const a=e.toLowerCase(),s=(b.products||[]).find(p=>p&&p.isActive!=="false"&&p.isActive!==!1&&(p.barcode&&p.barcode.toLowerCase()===a||p.sku&&p.sku.toLowerCase()===a||p.id&&String(p.id).toLowerCase()===a)),r=l("pos-scanner-reticle"),n=l("pos-scanner-status-pill"),o=l("pos-last-scanned-banner"),i=l("pos-last-scanned-text"),d=l("pos-last-scanned-price");if(s){if(r&&(r.classList.add("border-emerald-300","scale-105","bg-emerald-500/20"),setTimeout(()=>{r.classList.remove("border-emerald-300","scale-105","bg-emerald-500/20")},300)),X(),s.variants&&s.variants.length>0){n&&(n.innerHTML='<span class="text-amber-300 font-bold">Buka pilihan varian...</span>'),he(),da().then(()=>{typeof window.openPOSVariantSheet=="function"&&window.openPOSVariantSheet(s.id)});return}Je(s.id)?(o&&i&&d&&(i.textContent=s.name,d.textContent=x(parseFloat(s.price)||0),o.classList.remove("hidden")),n&&(n.innerHTML=`<span class="text-emerald-300 font-black"><i class="fa-solid fa-check mr-1"></i>${u(s.name)} (+1)</span>`,setTimeout(()=>{n&&(n.innerHTML='<span class="w-2 h-2 rounded-full bg-emerald-400 animate-ping"></span><span>Menunggu barcode...</span>')},1500)),qe||(he(),m(`Ditambahkan: ${s.name}`,"success"))):n&&(n.innerHTML=`<span class="text-rose-400 font-bold"><i class="fa-solid fa-ban mr-1"></i>Stok "${u(s.name)}" Habis</span>`,setTimeout(()=>{n&&(n.innerHTML='<span class="w-2 h-2 rounded-full bg-emerald-400 animate-ping"></span><span>Menunggu barcode...</span>')},2e3))}else r&&(r.classList.add("border-rose-500","bg-rose-500/20"),setTimeout(()=>{r.classList.remove("border-rose-500","bg-rose-500/20")},400)),n&&(n.innerHTML=`<span class="text-rose-400 font-bold"><i class="fa-solid fa-xmark mr-1"></i>Barcode "${e}" tidak ditemukan</span>`)},he=(e=!1)=>{if(ye&&(clearInterval(ye),ye=null),me){try{me.getTracks().forEach(a=>a.stop())}catch{}me=null}oe=null,Ae=!1;const t=l("pos-camera-scanner-modal");t&&(!e&&typeof window.requestCloseModal=="function"?window.requestCloseModal("posCameraScanner",!1,()=>t.remove()):t.remove())},Ft=async()=>{if(oe)try{if(!(oe.getCapabilities?oe.getCapabilities():{}).torch){m("Lampu senter (torch) tidak didukung kamera ini.");return}Ae=!Ae,await oe.applyConstraints({advanced:[{torch:Ae}]});const t=l("pos-scanner-torch-btn");t&&(Ae?(t.classList.add("bg-amber-500","text-white"),t.classList.remove("bg-slate-800","text-slate-300")):(t.classList.remove("bg-amber-500","text-white"),t.classList.add("bg-slate-800","text-slate-300")))}catch(e){console.warn("Gagal toggle torch:",e)}},Dt=async()=>{ot=ot==="environment"?"user":"environment",me&&(me.getTracks().forEach(e=>e.stop()),me=null),await Oa()},Nt=()=>{qe=!qe;const e=l("pos-scanner-mode-btn");e&&(qe?(e.textContent="Terus-menerus",e.className="px-2.5 py-1 rounded-lg bg-emerald-950/60 border border-emerald-600/60 text-emerald-400 text-[10px] font-black tracking-wider uppercase transition-all cursor-pointer"):(e.textContent="Scan Sekali",e.className="px-2.5 py-1 rounded-lg bg-slate-800 border border-slate-700 text-slate-300 text-[10px] font-black tracking-wider uppercase transition-all cursor-pointer"))},Bt=e=>{if(!e||!e.trim())return;Ha(e.trim());const t=l("pos-manual-barcode-input");t&&(t.value="")},Rt=e=>{he();const t=l("pos-search-input");t&&(t.value=e,te=e,q())};window.setPOSViewMode=mt;window.renderPOSStorefront=Ca;window.renderPOS=$a;window.destroyBarcodeListener=We;window.openPOSCartDrawer=Pt;window.closePOSCartDrawer=$e;window.posSetQuickCash=$t;window.playCashierBeep=X;window.playCashierChime=Fe;window.posHoldCurrentCart=Ze;window.closePOSHoldPrompt=et;window.posConfirmHoldCart=ht;window.openPOSHeldModal=De;window.closePOSHeldModal=Ne;window.posRecallHeldCart=gt;window.posHoldCurrentAndRecall=kt;window.posOverwriteAndRecall=vt;window.posDeleteHeldCart=yt;window.posExecuteDeleteHeld=St;window.renderHeldBadges=ge;window.ensureCustomersLoaded=ue;window.ensureBanksLoaded=Be;window.lookupPosMember=Re;window.debouncedLookupPosMember=Ht;window.selectPosMember=At;window.resetPosMember=Ot;window.posSetDiscountType=jt;window.posSetDiscountVal=Le;window.posApplyQuickDiscount=It;window.openPOSCameraScanner=at;window.closePOSCameraScanner=he;window.togglePOSScannerFacing=Dt;window.togglePOSScannerTorch=Ft;window.togglePOSScannerMode=Nt;window.posProcessManualBarcode=Bt;window.posSearchScannedCode=Rt;window.executePOSPrintDirect=Lt;window.previewPOSReceiptThenPrint=tt;window.getActiveShift=_;window.isShiftActive=le;window.syncActiveShiftFromCloud=re;window.openPOSOpenShiftModal=K;window.closePOSOpenShiftModal=Pe;window.openPOSShiftModal=G;window.openPOSShiftSummaryModal=G;window.closePOSShiftSummaryModal=ze;window.openPOSCloseShiftModal=ut;window.closePOSCloseShiftModal=je;window.renderShiftHeaderBadge=Ie;window.printShiftSettlementReceipt=ft;window.executeShiftPrintDirect=bt;window.getPOSCart=()=>g;const is=Object.freeze(Object.defineProperty({__proto__:null,addToCart:Je,addToCartWithVariant:xa,applyMemberToPos:Ue,clearCart:wa,closePOSCameraScanner:he,closePOSCartDrawer:$e,closePOSHeldModal:Ne,closePOSHoldPrompt:et,closePayModal:Tt,debouncedLookupPosMember:Ht,destroyBarcodeListener:We,ensureBanksLoaded:Be,ensureCustomersLoaded:ue,executePOSPrintDirect:Lt,formatQty:j,getCartTotalHpp:ce,getProductStockInfo:Ce,lookupPosMember:Re,openPOSCameraScanner:at,openPOSCartDrawer:Pt,openPOSHeldModal:De,openPayModal:ka,playCashierBeep:X,playCashierChime:Fe,posAddToCartQty:ba,posApplyQuickDiscount:It,posConfirmHoldCart:ht,posDeleteHeldCart:yt,posDiscountAmount:pe,posExecuteDeleteHeld:St,posHoldCurrentAndRecall:kt,posHoldCurrentCart:Ze,posOverwriteAndRecall:vt,posProcessManualBarcode:Bt,posRecallHeldCart:gt,posSearchScannedCode:Rt,posSetDiscountType:jt,posSetDiscountVal:Le,posSetQuickCash:$t,previewPOSReceiptThenPrint:tt,printPOSReceipt:Ta,processPOSTx:Pa,removeFromCart:Ye,renderCatalog:q,renderHeldBadges:ge,renderPOS:$a,renderPOSStorefront:Ca,resetPosMember:Ot,selectPosMember:At,setItemDisc:ga,setPOSViewMode:mt,setPosCustomerType:ya,setPosPayMethod:Mt,setQty:ha,stopClock:ua,togglePOSScannerFacing:Dt,togglePOSScannerMode:Nt,togglePOSScannerTorch:Ft,updatePosChange:Ct,updateQty:ma},Symbol.toStringTag,{value:"Module"}));export{is as a,ns as p,Wa as r};
