...
import{a as i,c as I,s as wt,b as U,d as N,f as k,e as x,g as _,h as B,i as T,j as c,w as te,k as g,l as we,m as ne,n as Q,o as v,p as H,q as oa,r as Z,t as jt,u as yt,v as Ra,x as Na,y as Se,z as na,A as Fa,B as ye,C as xe,D as Pe,E as Ge,F as pe,G as We,H as Xt,I as la,J as Lt,K as da,L as ca,M as Oa,N as Ha,O as $,P as j,Q as C,R as Me,S as Xe,T as Te,U as ze,V as Ce,W as Qe,X as Ka,Y as Va,Z as me,_ as pa,$ as Ua,a0 as qa,a1 as dt,a2 as Ie,a3 as Ga,a4 as Zt,a5 as R,a6 as Bt,a7 as Wa,a8 as za,a9 as Qa,aa as Ja,ab as Dt,ac as $e,ad as oe,ae as Ya,af as Xa,ag as Za}from"./module-print-gYWGiX83.js";import{f as X}from"./vendor-firebase-core-D2OF5R23.js";import"./vendor-firebase-db-BIUZcnOd.js";const es="modulepreload",ts=function(e){return"/"+e},ea={},as=function(t,a,r){let s=Promise.resolve();if(a&&a.length>0){document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),l=n?.nonce||n?.getAttribute("nonce");s=Promise.allSettled(a.map(d=>{if(d=ts(d),d in ea)return;ea[d]=!0;const p=d.endsWith(".css"),m=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${m}`))return;const u=document.createElement("link");if(u.rel=p?"stylesheet":es,p||(u.as="script"),u.crossOrigin="",u.href=d,l&&u.setAttribute("nonce",l),document.head.appendChild(u),p)return new Promise((b,h)=>{u.addEventListener("load",b),u.addEventListener("error",()=>h(new Error(`Unable to preload CSS for ${d}`)))})}))}function o(n){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=n,window.dispatchEvent(l),!l.defaultPrevented)throw n}return s.then(n=>{for(const l of n||[])l.status==="rejected"&&o(l.reason);return t().catch(o)})},ss={apiKey:"AIzaSyCOjrhMP52TGbiOyQLY92NDYE26N6d9hJM",authDomain:"restu-karya-utama.firebaseapp.com",databaseURL:"https://restu-karya-utama-default-rtdb.asia-southeast1.firebasedatabase.app",projectId:"restu-karya-utama",storageBucket:"restu-karya-utama.firebasestorage.app",messagingSenderId:"858310421352",appId:"1:858310421352:web:e20a833875e8d5c19944dd",measurementId:"G-PHDG2LJ8PM"};try{localStorage.removeItem("freshmart_fb_config")}catch{}const ma=window.FIREBASE_CONFIG||ss;X.apps.length||X.initializeApp(ma);const y=X.firestore(),ee=X.auth();typeof window<"u"&&(window.firebase=X,window.db=y,window.auth=ee);try{y.settings({ignoreUndefinedProperties:!0,experimentalAutoDetectLongPolling:!0,merge:!0})}catch{}let rs=null;const di=()=>{as(()=>import("./vendor-firebase-analytics-Jm19L5g2.js"),__vite__mapDeps([0,1])).then(()=>{try{rs=X.analytics()}catch{}}).catch(()=>{})},is="K2ijSERTT2dg27yYGTEgn6XHSnW2",Oe={emerald:{50:"#ecfdf5",100:"#d1fae5",200:"#a7f3d0",300:"#6ee7b7",400:"#34d399",500:"#10b981",600:"#059669",700:"#047857",800:"#065f46",900:"#064e3b"},teal:{50:"#f0fdfa",100:"#ccfbf1",200:"#99f6e4",300:"#5eead4",400:"#2dd4bf",500:"#14b8a6",600:"#0d9488",700:"#0f766e",800:"#115e59",900:"#134e4a"},cyan:{50:"#ecfeff",100:"#cffafe",200:"#a5f3fc",300:"#67e8f9",400:"#22d3ee",500:"#06b6d4",600:"#0891b2",700:"#0e7490",800:"#155e75",900:"#164e63"},sky:{50:"#f0f9ff",100:"#e0f2fe",200:"#bae6fd",300:"#7dd3fc",400:"#38bdf8",500:"#0ea5e9",600:"#0284c7",700:"#0369a1",800:"#075985",900:"#0c4a6e"},blue:{50:"#eff6ff",100:"#dbeafe",200:"#bfdbfe",300:"#93c5fd",400:"#60a5fa",500:"#3b82f6",600:"#2563eb",700:"#1d4ed8",800:"#1e40af",900:"#1e3a8a"},indigo:{50:"#eef2ff",100:"#e0e7ff",200:"#c7d2fe",300:"#a5b4fc",400:"#818cf8",500:"#6366f1",600:"#4f46e5",700:"#4338ca",800:"#3730a3",900:"#312e81"},violet:{50:"#f5f3ff",100:"#ede9fe",200:"#ddd6fe",300:"#c4b5fd",400:"#a78bfa",500:"#8b5cf6",600:"#7c3aed",700:"#6d28d9",800:"#5b21b6",900:"#4c1d95"},purple:{50:"#faf5ff",100:"#f3e8ff",200:"#e9d5ff",300:"#d8b4fe",400:"#c084fc",500:"#a855f7",600:"#9333ea",700:"#7e22ce",800:"#6b21a8",900:"#581c87"},fuchsia:{50:"#fdf4ff",100:"#fae8ff",200:"#f5d0fe",300:"#f0abfc",400:"#e879f9",500:"#d946ef",600:"#c026d3",700:"#a21caf",800:"#86198f",900:"#701a75"},pink:{50:"#fdf2f8",100:"#fce7f3",200:"#fbcfe8",300:"#f9a8d4",400:"#f472b6",500:"#ec4899",600:"#db2777",700:"#be185d",800:"#9d174d",900:"#831843"},rose:{50:"#fff1f2",100:"#ffe4e6",200:"#fecdd3",300:"#fda4af",400:"#fb7185",500:"#f43f5e",600:"#e11d48",700:"#be123c",800:"#9f1239",900:"#881337"},red:{50:"#fef2f2",100:"#fee2e2",200:"#fecaca",300:"#fca5a5",400:"#f87171",500:"#dc2626",600:"#b91c1c",700:"#991b1b",800:"#7f1d1d",900:"#450a0a"},orange:{50:"#fff7ed",100:"#ffedd5",200:"#fed7aa",300:"#fdba74",400:"#fb923c",500:"#ea580c",600:"#c2410c",700:"#9a3412",800:"#7c2d12",900:"#431407"},amber:{50:"#fffbeb",100:"#fef3c7",200:"#fde68a",300:"#fcd34d",400:"#fbbf24",500:"#d97706",600:"#b45309",700:"#92400e",800:"#78350f",900:"#451a03"},yellow:{50:"#fefce8",100:"#fef9c3",200:"#fef08a",300:"#fde047",400:"#eab308",500:"#d97706",600:"#b45309",700:"#854d0e",800:"#713f12",900:"#3f1d0b"},lime:{50:"#f7fee7",100:"#ecfccb",200:"#d9f99d",300:"#bef264",400:"#a3e635",500:"#65a30d",600:"#4d7c0f",700:"#3f6212",800:"#365314",900:"#1a2e05"},green:{50:"#f0fdf4",100:"#dcfce7",200:"#bbf7d0",300:"#86efac",400:"#4ade80",500:"#16a34a",600:"#15803d",700:"#166534",800:"#14532d",900:"#052e16"},slate:{50:"#f8fafc",100:"#f1f5f9",200:"#e2e8f0",300:"#cbd5e1",400:"#94a3b8",500:"#475569",600:"#334155",700:"#1e293b",800:"#0f172a",900:"#020617"},stone:{50:"#fafaf9",100:"#f5f5f4",200:"#e7e5e4",300:"#d6d3d1",400:"#a8a29e",500:"#57534e",600:"#44403c",700:"#292524",800:"#1c1917",900:"#0c0a09"}},os=e=>{let t=parseInt(e.replace("#",""),16);return(t>>16&255)+","+(t>>8&255)+","+(t&255)},ta=(e,t)=>{let a=parseInt(e.slice(1,3),16),r=parseInt(e.slice(3,5),16),s=parseInt(e.slice(5,7),16);return a=Math.max(0,Math.min(255,a+t)),r=Math.max(0,Math.min(255,r+t)),s=Math.max(0,Math.min(255,s+t)),"#"+[a,r,s].map(o=>o.toString(16).padStart(2,"0")).join("")},ns=e=>{if(!e)return;try{document.querySelectorAll('meta[name="theme-color"]').forEach(d=>d.remove())}catch{}const t=document.createElement("meta");t.setAttribute("name","theme-color"),t.setAttribute("content",e),document.head.appendChild(t);try{document.querySelectorAll('meta[name="msapplication-navbutton-color"], meta[name="msapplication-TileColor"]').forEach(d=>d.remove())}catch{}const a=document.createElement("meta");a.setAttribute("name","msapplication-navbutton-color"),a.setAttribute("content",e),document.head.appendChild(a);const r=document.createElement("meta");r.setAttribute("name","msapplication-TileColor"),r.setAttribute("content",e),document.head.appendChild(r);let s=document.querySelector('meta[name="apple-mobile-web-app-capable"]');s||(s=document.createElement("meta"),s.setAttribute("name","apple-mobile-web-app-capable"),document.head.appendChild(s)),s.setAttribute("content","yes");let o=document.querySelector('meta[name="mobile-web-app-capable"]');o||(o=document.createElement("meta"),o.setAttribute("name","mobile-web-app-capable"),document.head.appendChild(o)),o.setAttribute("content","yes");let n=document.querySelector('meta[name="apple-mobile-web-app-status-bar-style"]');n||(n=document.createElement("meta"),n.setAttribute("name","apple-mobile-web-app-status-bar-style"),document.head.appendChild(n)),n.setAttribute("content","default"),typeof window.updatePwaManifest=="function"&&window.updatePwaManifest(e)},Ke=(e,t)=>{const a=e||localStorage.getItem("freshmart_ui_theme")||"emerald",r=Oe[a]||Oe.emerald;e&&localStorage.setItem("freshmart_ui_theme",a);const s=t||localStorage.getItem("freshmart_theme_color")||r[500];t&&localStorage.setItem("freshmart_theme_color",s);const o=os(s),n=ta(s,-30),l=ta(s,150);return document.documentElement.style.setProperty("--color-primary",s),document.documentElement.style.setProperty("--color-primary-dark",n),document.documentElement.style.setProperty("--color-primary-light",l),document.documentElement.style.setProperty("--color-primary-rgb",o),ns(s),r},ci=()=>{const e=localStorage.getItem("freshmart_theme"),t=window.matchMedia("(prefers-color-scheme: dark)").matches;(e==="dark"||!e&&t)&&document.documentElement.classList.add("dark")},pi=()=>{const e=document.documentElement.classList.toggle("dark");localStorage.setItem("freshmart_theme",e?"dark":"light");const t=document.getElementById("icon-theme")||document.getElementById("theme-toggle-icon");t&&(t.className=e?"fa-solid fa-sun text-sm text-amber-400":"fa-solid fa-moon text-sm text-slate-600 dark:text-slate-300")},mi=()=>{const e=document.documentElement.classList.contains("dark"),t=document.getElementById("icon-theme")||document.getElementById("theme-toggle-icon");t&&(t.className=e?"fa-solid fa-sun text-sm text-amber-400":"fa-solid fa-moon text-sm text-slate-600 dark:text-slate-300")},Ve=(e="minimalist",t="")=>{let a=e||localStorage.getItem("freshmart_bg_style")||"minimalist";a==="dual_tone"&&(a="aurora_glow"),a==="geometric_3d"&&(a="tech_grid"),a==="diagonal_skew"&&(a="glass_studio");const r=t??(localStorage.getItem("freshmart_bg_custom_url")||"");e&&localStorage.setItem("freshmart_bg_style",a),t!=null&&localStorage.setItem("freshmart_bg_custom_url",r);const o=(p=>{if(!p||typeof p!="string")return"";const m=p.match(/drive\.google\.com.*(?:id=|\/d\/)([a-zA-Z0-9_-]+)/);return m?`https://lh3.googleusercontent.com/d/${m[1]}`:p.trim()})(r);document.documentElement.setAttribute("data-bg-style",a),document.body?.setAttribute("data-bg-style",a);const n=document.getElementById("app-container");n&&(n.setAttribute("data-bg-style",a),o?n.setAttribute("data-has-custom-bg","true"):n.removeAttribute("data-has-custom-bg"));const l=document.getElementById("dynamic-bg-container");if(!l)return;if(l.innerHTML="",l.className="pointer-events-none fixed inset-0 z-0 overflow-hidden",o){const p=document.createElement("div");p.className="absolute inset-0 z-0 bg-cover bg-center bg-no-repeat bg-fixed opacity-35 dark:opacity-25 pointer-events-none transition-all duration-500",p.style.backgroundImage=`url('${o}')`,l.appendChild(p);const m=document.createElement("div");m.className="absolute inset-0 z-0 bg-slate-50/70 dark:bg-[#0b1120]/80 pointer-events-none",l.appendChild(m)}let d="";if(a==="hero_arch"?d=`
        ...
        `,r.innerHTML=s,a.classList.contains("hidden")&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("variantPreview"),_("variant-preview-modal"),setTimeout(()=>{a.classList.remove("opacity-0"),r.classList.remove("scale-95")},10)},xs=()=>{if(!v)return;const e=x("variant-preview-modal"),t=x("variant-preview-content");if(!e||!t)return;const a=v.variants&&H!==null?v.variants[H]:null,r=a?.img||v.img||"",s=a?`${c(v.name)} - ${c(a.name)}`:c(v.name),o=k(a?.price??v.price);let n=`
        <div class="relative w-full aspect-square bg-white rounded-3xl overflow-hidden shadow-2xl border border-slate-200 dark:border-slate-800 flex items-center justify-center">
    ...
    `;t.innerHTML=n,e.classList.contains("hidden")&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("variantPreview"),_("variant-preview-modal"),setTimeout(()=>{e.classList.remove("opacity-0"),t.classList.remove("scale-95")},10)},hs=(e=!1)=>{const t=x("variant-preview-modal"),a=x("variant-preview-content");if(t&&a){const r=()=>{t.classList.add("opacity-0"),a.classList.add("scale-95"),setTimeout(()=>{B("variant-preview-modal"),a.innerHTML=""},300)};typeof window.requestCloseModal=="function"?window.requestCloseModal("variantPreview",e,r):r()}},ks=e=>{oa(v?.video)&&(window.cSlideIdx+=e,window.cSlideIdx>1&&(window.cSlideIdx=0),window.cSlideIdx<0&&(window.cSlideIdx=1),pt())},pt=()=>{if(!v)return;let e=v,t=e.isActive!=="false"&&e.isActive!==!1,a=e.variants?.length>0;const r=(e.name||"").toLowerCase(),s=(e.category||"").toLowerCase(),o=(e.tag||"").toLowerCase(),n=["cat","paint","warna","colour","color","putih","hitam","merah","biru","hijau","kuning","orange","abu","coklat","cream","krem","beige","ivory","mocca","rose","tosca","lavender","salmon","broken white","off white","natural","magnolia","primer","dasar","eksterior","exterior","interior","tembok","duco","gloss","matte","satin","semi gloss"],l=r.includes("cat")&&(r.includes("tembok")||r.includes("interior")||r.includes("eksterior")||r.includes("exterior"))||s.includes("cat")||s.includes("paint")||o.includes("cat")||o.includes("paint"),d=a&&e.variants.some(M=>{const E=(M.name||"").toLowerCase();return n.some(re=>E.includes(re))}),p=l||d,m=x("product-modal-paint-warning");m&&(p?m.classList.remove("hidden"):m.classList.add("hidden"));let u=a&&H!==null?e.variants[H]:null,b=u?.unit||e.unit||"Pcs";const h=x("product-modal-img"),f=x("product-modal-video-container"),S=oa(e.video),P=u&&u.img,A=x("slide-prev"),w=x("slide-next"),D=x("slide-dots");if(S&&!P)if(A&&A.classList.remove("hidden"),w&&w.classList.remove("hidden"),D&&(D.classList.remove("hidden"),D.innerHTML=`
        ...
        <div class="mb-6 bg-amber-50 dark:bg-amber-900/10 rounded-2xl p-4 border border-amber-200 dark:border-amber-800/50 shadow-inner">
            ...
            <div class="space-y-2">${e.wholesale.slice().sort((M,E)=>M.minQty-E.minQty).map(M=>`
        ...
        </div>`:"");const qe=x("product-modal-admin-info");if(qe)if(window.isAdm&&window.curViewName==="view-admin"){const M=i.store.useStock===!0||i.store.useStock==="true",E=e.variants?.length>0,re=u?u.hpp||0:e.hpp||0;u?u.stock!==void 0&&u.stock:e.stock!==void 0&&e.stock;const ue=u?u.price||e.price||0:e.price||0,ce=re>0?Math.round((ue-re)/ue*100):null;let Le="";if(M)if(E)Le=`<div class="col-span-2 space-y-1.5">${(e.variants||[]).map(ie=>{const fe=parseFloat(ie.stock)||0;return`<div class="flex justify-between items-center text-[11px] font-bold bg-white dark:bg-slate-900 p-2 rounded-xl border border-slate-200 dark:border-slate-700">
    ...
    <div class="flex gap-2.5 overflow-x-auto pb-2 pt-1 hide-scrollbar -mx-1 px-1 snap-x snap-mandatory">
        ${p}
    </div>`};let de=null,De=0,le=1;const St=e=>{const t=i.products.find(n=>String(n.id)===String(e));if(!t)return;de=t,le=1;const a=i.store.useStock===!0||i.store.useStock==="true";let r=0;if(t.variants&&t.variants.length>0){const n=t.variants.findIndex(l=>{const d=l.isActive!==!1&&l.isActive!=="false",p=parseFloat(l.stock)||0;return d&&(!a||p>0)});r=n>=0?n:0}De=r,ga();const s=x("quick-variant-modal"),o=x("quick-variant-content");s&&o&&(s.classList.contains("hidden")&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("quickVariant"),_("quick-variant-modal"),setTimeout(()=>{s.classList.remove("opacity-0"),o.classList.remove("translate-y-full","sm:translate-y-10")},10)),typeof window.triggerHaptic=="function"&&window.triggerHaptic("light")},_t=(e=!1)=>{const t=x("quick-variant-modal"),a=x("quick-variant-content");if(t&&a){const r=()=>{t.classList.add("opacity-0"),a.classList.add("translate-y-full","sm:translate-y-10"),setTimeout(()=>B("quick-variant-modal"),300)};typeof window.requestCloseModal=="function"?window.requestCloseModal("quickVariant",e,r):r()}},Cs=e=>{!de||!de.variants||!de.variants[e]||(De=e,ga(),typeof window.triggerHaptic=="function"&&window.triggerHaptic("light"))},Ms=e=>{if(!de)return;const t=i.store.useStock===!0||i.store.useStock==="true",a=de.variants?.[De],r=t?parseFloat(a?.stock)||0:1/0;le=Math.min(r,Math.max(1,le+e));const o=x("quick-variant-qty-input");o&&(o.value=le),typeof window.triggerHaptic=="function"&&window.triggerHaptic("light")},ga=()=>{if(!de)return;const e=de,t=e.variants?.[De],a=i.store.useStock===!0||i.store.useStock==="true",r=x("quick-variant-img");r&&(r.src=Q(t?.img||e.img||"","w300-rw")),N("quick-variant-title",e.name);const s=t?.price??e.price;N("quick-variant-price",k(s));const o=parseFloat(t?.stock)||0,n=x("quick-variant-stock");n&&(a?(n.innerText=o>0?`Sisa: ${o} ${t?.unit||e.unit||"pcs"}`:"Stok Habis",n.className=`text-[10px] font-bold ${o>0?"text-slate-400 dark:text-slate-500":"text-rose-500"}`):(n.innerText="Tersedia",n.className="text-[10px] font-bold text-emerald-500"));const l=x("quick-variant-selected-name");l&&(l.innerText=t?`Varian: ${t.name}`:"Pilih Varian");const d=x("quick-variant-qty-input");d&&(d.value=le);const p=x("quick-variant-options");p&&e.variants&&(p.innerHTML=e.variants.map((h,f)=>{const S=h.isActive!==!1&&h.isActive!=="false",P=parseFloat(h.stock)||0,A=a&&P<=0,w=S&&!A,D=f===De;let L="";w?D?L="bg-[rgba(var(--color-primary-rgb),0.1)] border-[var(--color-primary)] text-[var(--color-primary)] font-black shadow-xs ring-1 ring-[var(--color-primary)]/40":L="bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 hover:border-[var(--color-primary)]/40":L="bg-slate-100 dark:bg-slate-800/40 border-slate-200 dark:border-slate-700 text-slate-400 opacity-50 cursor-not-allowed";const K=h.colorCode?`<span class="w-3.5 h-3.5 rounded-full shrink-0 border border-black/10 shadow-xs" style="background-color: ${c(h.colorCode)}"></span>`:"";return`
            ...
            </a>`}).join(""),l.length<o.length?_("load-more-container"):B("load-more-container")},Ls=(e,t)=>{e&&(e.preventDefault(),e.stopPropagation());const a=i.products.find(d=>String(d.id)===String(t));if(!a)return;if(a.variants&&a.variants.length>0){typeof St=="function"?St(t):typeof window.openQuickVariantSheet=="function"?window.openQuickVariantSheet(t):ua(t);return}const r=i.store.useStock===!0||i.store.useStock==="true",s=parseFloat(a.stock)||0;if(r&&s<=0)return g("Stok produk ini sedang kosong");const o=I.find(d=>d.id===a.id&&!d.variantName),n=o&&parseFloat(o.qty)||0;if(r&&n+1>s)return g(`Maksimal stok tercapai: ${s}`);if(o)o.qty=parseFloat((o.qty+1).toFixed(2));else{const d=parseFloat(a.poin)>0?parseFloat(a.poin):0;I.push({id:a.id,name:a.name,variantName:null,price:a.price,img:a.img,qty:1,unit:a.unit||"pcs",poTime:a.poTime||"",colorCode:"",poin:d})}J();const l=e?.currentTarget||e?.target;typeof window.flyToCartAnimation=="function"?window.flyToCartAnimation(l,"#bnav-cart",a.img):typeof window.triggerHaptic=="function"&&window.triggerHaptic("medium"),g(`+1 ${a.name} Masuk Keranjang`,"success")},Bs=()=>{const e=x("product-container");if(!e)return;const t=6;let a="";for(let r=0;r<t;r++)a+=`
    ...
    `,t.style.display="flex",t.style.opacity="1";const a=document.getElementById("btn-session-kicked-ok");a&&(a.onclick=()=>{t.style.opacity="0",setTimeout(()=>{t.style.display="none"},250)})},ut=()=>{if(Je)return;const e=typeof y<"u"&&y?y:window.db;!e||!localStorage.getItem("freshmart_admin_session_id")||(ot=!1,Je=e.collection("freshmart").doc("cms_data").collection("admin_session").doc("active").onSnapshot(async a=>{if(!a.exists)return;const r=a.data(),s=r.sessionId,o=localStorage.getItem("freshmart_admin_session_id");if(s&&o&&s!==o){if(ot)return;ot=!0,bt(),localStorage.removeItem("freshmart_admin_session_id");const n=r.deviceName||"Perangkat Lain";try{window.isAdm=!1,window.__localIsAdm=!1,window.isPro=!1,ee&&typeof ee.signOut=="function"&&await ee.signOut()}catch{}typeof window.changeView=="function"&&window.changeView("view-catalog"),Vs(n)}},a=>{console.warn("Admin session guard listener error:",a)}))},bt=()=>{Je&&(Je(),Je=null)},ha=async()=>{if(fa())return!0;const e=typeof y<"u"&&y?y:window.db;if(!e)return!0;const t=localStorage.getItem("freshmart_admin_session_id");if(!t)try{return!(await e.collection("freshmart").doc("cms_data").collection("admin_session").doc("active").get()).exists}catch{return!0}try{const a=await e.collection("freshmart").doc("cms_data").collection("admin_session").doc("active").get();return a.exists?a.data().sessionId===t:!0}catch{return!0}};typeof window<"u"&&(window.claimAdminSession=xa,window.attachAdminSessionGuard=ut,window.detachAdminSessionGuard=bt,window.isCurrentSessionActive=ha,window.setLoggingIn=$t,window.isLoggingIn=fa);const Us=async()=>{const e=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1";if(window.isAdm||e){if(!await ha()&&ee.currentUser){bt(),localStorage.removeItem("freshmart_admin_session_id"),await ee.signOut(),window.isAdm=!1,window.__localIsAdm=!1,g("Sesi Admin telah diambil alih oleh perangkat lain."),ne("login-username",""),ne("login-password",""),typeof window.changeView=="function"&&window.changeView("view-admin-login");return}if(window.__localIsAdm=!0,typeof window.changeView=="function"&&window.changeView("view-admin"),ut(),ee.currentUser)nt();else{const a=ee.onAuthStateChanged(()=>{a(),nt()})}}else ne("login-username",""),ne("login-password",""),typeof window.changeView=="function"&&window.changeView("view-admin-login")},nt=()=>{ut();const e=document.querySelector("#view-admin .scroll-content");e&&(e.scrollTop=0),_("admin-dashboard-view"),B("admin-content-view"),B("btn-admin-back"),_("admin-logo-box"),N("admin-header-title","CMS SELLER"),Me&&(Me(),Xe(null)),Te&&(Te(),ze(null)),Ce&&(Ce(),Qe(null)),ka(Ka),Nt()},Nt=()=>{const e=x("admin-menu-tax-btn");if(!e)return;i.store.ppnEnabled===!0||i.store.ppnEnabled==="true"?(e.classList.remove("hidden"),e.classList.add("flex")):(e.classList.add("hidden"),e.classList.remove("flex"))},gt=()=>{const e=i.store.useStock===!0||i.store.useStock==="true";let t=0,a=0,r=0,s=0,o=0,n=0;return(i.products||[]).forEach(l=>{if(l.variants&&l.variants.length)l.variants.forEach(d=>{const p=d.isActive!==!1&&d.isActive!=="false",m=parseFloat(d.stock)||0;p&&(!e||m>0)?r++:s++,o+=(parseFloat(d.hpp)||0)*m,n+=(parseFloat(d.price)||0)*m});else{const d=l.isActive!==!1&&l.isActive!=="false",p=parseFloat(l.stock)||0;d&&(!e||p>0)?t++:a++,o+=(parseFloat(l.hpp)||0)*p,n+=(parseFloat(l.price)||0)*p}}),{activeProd:t,inactiveProd:a,activeVar:r,inactiveVar:s,assetHpp:o,assetJual:n}},sa=new Map,qs=2*60*1e3,ka=async(e="month")=>{if(Va(e),document.querySelectorAll(".report-period-btn").forEach(u=>{const b=u.dataset.period===e;u.style.background=b?"var(--color-primary)":"transparent",u.style.color=b?"var(--color-primary-contrast, #fff)":"",u.style.boxShadow=b?"0 2px 8px rgba(var(--color-primary-rgb),0.35)":"none"}),!x("admin-report-container"))return;const a=({totalPenjualan:u,totalHppTerjual:b,totalDiskonProduk:h,orderCount:f,truncated:S})=>{const P=u-b,A=P-h,w={today:"Hari Ini",week:"Minggu Ini",month:"Bulan Ini",all:"Sepanjang Waktu"}[e]||"";T("admin-report-container",`
        ...
        `)},r=sa.get(e);if(r&&Date.now()-r.timestamp<qs){a(r.data);return}T("admin-report-container",'<div class="text-center py-10"><i class="fa-solid fa-spinner fa-spin text-2xl text-slate-300"></i></div>');let s=null;const o=new Date;if(e==="today")s=new Date(o.getFullYear(),o.getMonth(),o.getDate());else if(e==="week"){const u=o.getDay(),b=u===0?6:u-1;s=new Date(o.getFullYear(),o.getMonth(),o.getDate()-b)}else e==="month"&&(s=new Date(o.getFullYear(),o.getMonth(),1));let n=0,l=0,d=0,p=0,m=!1;try{if(!ee.currentUser){T("admin-report-container",'<div class="text-center py-10 text-slate-400"><i class="fa-solid fa-lock text-2xl mb-3"></i><p class="text-xs font-bold">Login terlebih dahulu untuk melihat laporan.</p></div>');return}let u=y.collection("freshmart_orders");s&&(u=u.where("timestamp",">=",X.firestore.Timestamp.fromDate(s)));const b=await u.limit(3e3).get();m=b.size>=3e3,b.forEach(f=>{const S=f.data();S.status!=="Dibatalkan"&&(p++,n+=parseFloat(S.payment?.subtotal)||0,d+=parseFloat(S.payment?.productDiscount)||0,(S.items||[]).forEach(P=>{const A=P.hpp!==void 0&&P.hpp!==null?parseFloat(P.hpp):typeof window.getEffHpp=="function"?window.getEffHpp(P):0;l+=(parseFloat(A)||0)*(parseFloat(P.qty)||0)}))});const h={totalPenjualan:n,totalHppTerjual:l,totalDiskonProduk:d,orderCount:p,truncated:m};sa.set(e,{data:h,timestamp:Date.now()}),a(h)}catch(u){console.error("Gagal memuat laporan penjualan:",u)}},Gs=async()=>{const e=$("login-username"),t=$("login-password");if(!e||!t)return g("Email & Password wajib diisi!");$t(!0),j("Verifikasi Login...");try{const a="sess_"+Date.now()+"_"+Math.random().toString(36).substring(2,9);localStorage.setItem("freshmart_admin_session_id",a);const s=(await ee.signInWithEmailAndPassword(e,t)).user||ee.currentUser;if(!s||s.uid!==is){const o=s?s.uid:"null";throw await ee.signOut(),localStorage.removeItem("freshmart_admin_session_id"),new Error("UID_MISMATCH: "+o)}await xa(a),ut(),window.isAdm=!0,history.replaceState({view:"view-admin"},"",window.location.href),typeof window.changeView=="function"&&window.changeView("view-admin",!0),nt(),g("Login Berhasil!")}catch(a){if(console.error(a),localStorage.removeItem("freshmart_admin_session_id"),a.message&&a.message.startsWith("UID_MISMATCH:")){const r=a.message.replace("UID_MISMATCH: ","");g("Login Ditolak: UID Anda ("+r+") tidak cocok dengan ADMIN_UID!")}else g("Login Ditolak: Email atau Password salah!")}finally{$t(!1),C()}},va=async()=>{j("Keluar...");try{bt(),localStorage.removeItem("freshmart_admin_session_id"),await ee.signOut(),window.isAdm=!1,window.__localIsAdm=!1,window.isPro=!1,typeof window.updateProBadge=="function"&&window.updateProBadge(),Me&&(Me(),Xe(null)),Te&&(Te(),ze(null)),Ce&&(Ce(),Qe(null)),g("Berhasil Logout"),typeof window.changeView=="function"&&window.changeView("view-catalog")}catch{g("Gagal Logout")}finally{C()}},Ws=()=>{we("Keluar Seller","Apakah anda akan keluar dari dashboard seller?",()=>{va()},"Ya, Keluar")};window.checkAdminAccess=Us;window.openAdminMenu=nt;window.toggleTaxMenuVisibility=Nt;window.computeInventoryStats=gt;window.loadAdminReport=ka;window.processAdminLogin=Gs;window.logoutAdmin=va;window.confirmLogoutAdmin=Ws;const zs=async()=>{if(!me||me.length===0)return g("Belum ada data pesanan!");j("Menyiapkan modul Excel...");try{await pa("https://cdn.sheetjs.com/xlsx-0.20.3/package/dist/xlsx.full.min.js",()=>typeof XLSX<"u")}catch{C(),g("Gagal memuat modul Excel. Cek koneksi internet Anda.");return}C();let e=[];me.forEach((n,l)=>{let d=n.dateString?new Date(n.dateString).toLocaleString("id-ID"):"-",p=n.customer?.name||"Anonim",m=n.customer?.deliveryMethod==="delivery"?"Dikirim":"Ambil di Toko",u=n.status||"-",b=n.items?n.items.reduce((f,S)=>f+(parseFloat(S.qty)||0),0):0,h=n.payment?.grandTotal||0;e.push({No:l+1,"ID Pesanan":n.orderId,Tanggal:d,"Nama Pelanggan":p,"Metode Kirim":m,Status:u,"Total Item":b,"Total Tagihan (Rp)":h})});const t=XLSX.utils.json_to_sheet(e),a=XLSX.utils.book_new();XLSX.utils.book_append_sheet(a,t,"Laporan Pesanan");const r=[{wch:5},{wch:25},{wch:22},{wch:25},{wch:15},{wch:15},{wch:12},{wch:20}];t["!cols"]=r;const o=`Laporan_Pesanan_${new Date().toISOString().split("T")[0]}.xlsx`;if(window.AndroidNativeApp&&typeof window.AndroidNativeApp.saveOrShareFile=="function"){const n=XLSX.write(a,{bookType:"xlsx",type:"base64"});window.AndroidNativeApp.saveOrShareFile(n,o,"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet")}else XLSX.writeFile(a,o);g("Laporan Excel (.xlsx) berhasil diunduh!")},Qs=()=>{try{const e=new(window.AudioContext||window.webkitAudioContext),t=e.createOscillator(),a=e.createGain();t.connect(a),a.connect(e.destination),t.type="sine",t.frequency.setValueAtTime(800,e.currentTime),a.gain.setValueAtTime(1,e.currentTime),t.frequency.setValueAtTime(600,e.currentTime+.2),t.frequency.setValueAtTime(800,e.currentTime+.6),a.gain.setValueAtTime(1,e.currentTime+.6),t.frequency.setValueAtTime(600,e.currentTime+.8),a.gain.exponentialRampToValueAtTime(1e-5,e.currentTime+1.5),t.start(e.currentTime),t.stop(e.currentTime+1.5)}catch{}},Js=()=>{T("admin-content",`
        ...
        <div class="flex flex-col gap-4 text-sm pb-2">
            ...
            <div class="bg-violet-50 dark:bg-violet-900/10 p-5 sm:p-6 rounded-[1.5rem] border border-violet-200 dark:border-violet-800 shadow-sm">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex justify-between items-center"><span class="text-slate-500 dark:text-slate-400 font-bold text-xs">Status</span><span class="font-bold text-xs px-2 py-1 rounded-xl ${t.claimedReward.status==="ready"?"bg-emerald-100 text-emerald-600":t.claimedReward.status==="waiting_stock"?"bg-amber-100 text-amber-600":"bg-slate-200 text-slate-600"}">${qa(t.claimedReward)}</span></div>
...
Kami akan segera memproses pesanan Anda. Terima kasih! 🙏`;typeof window.openWhatsApp=="function"?window.openWhatsApp(r,p):window.open(`https://wa.me/${r}?text=${encodeURIComponent(p)}`,"_blank","noopener,noreferrer")}catch{C(),g("Gagal memuat data pesanan!")}},tr=e=>{we("Hapus Pesanan","Yakin ingin hapus permanen?",async()=>{if(!dt){Ie(!0),j("Menghapus...");try{await y.collection("freshmart_orders").doc(e).delete(),g("Terhapus!"),Ga===e&&wa()}catch{g("Gagal!")}finally{Ie(!1),C()}}})};window.exportOrdersToExcel=zs;window.rAdmOrd=Js;window.openOrderDetail=Ft;window.saveOrderCustomerToDB=Ys;window.ackRewardClaim=Xs;window.closeOrderDetailModal=wa;window.updateOrderStatus=Zs;window.konfirmasiKeWA=er;window.deleteOrder=tr;const ar=()=>{const e=i.store.name||"Toko Grosir",t=i.store.themeColor||"#10b981",a=(o,n,l=!1)=>{let d=document.querySelector(`meta[${l?"property":"name"}="${o}"]`);d||(d=document.createElement("meta"),l?d.setAttribute("property",o):d.setAttribute("name",o),document.head.appendChild(d)),d.setAttribute("content",n)};a("theme-color",t),a("mobile-web-app-capable","yes"),a("apple-mobile-web-app-capable","yes"),a("apple-mobile-web-app-status-bar-style","black-translucent"),a("apple-mobile-web-app-title",e),a("application-name",e),a("msapplication-TileColor",t),document.title=e,localStorage.setItem("freshmart_theme_color",t),i.store.uiTheme&&i.store.uiTheme!==localStorage.getItem("freshmart_ui_theme")&&(localStorage.setItem("freshmart_ui_theme",i.store.uiTheme),Ke(i.store.uiTheme));const r=i.store.bgStyle||localStorage.getItem("freshmart_bg_style")||"minimalist",s=i.store.bgCustomUrl!==void 0?i.store.bgCustomUrl:localStorage.getItem("freshmart_bg_custom_url")||"";Ve(r,s)},ya=()=>{T("admin-content",`
    ...
    `;if(T("admin-content",n),e==="profile"){const l=i.store.uiTheme||"",d=i.store.themeColor||"#10b981";(l==="custom"||!Oe?.[l])&&setTimeout(()=>{const m=document.getElementById("custom-color-chip");if(m){m.style.background=d;const u=m.querySelector("i");u&&(u.style.color="#fff")}},50)}},or=async e=>{if(!dt){Ie(!0),j("Menyimpan...");try{if(e==="profile")i.store.name=$("set-name"),i.store.slogan=$("set-slogan"),i.store.logo=R($("set-logo")),i.store.description=$("set-description"),i.store.email=$("set-email"),i.store.showRewardCatalog=$("set-show-reward-catalog")==="true",i.store.operationalHours=$("set-hours"),i.store.footerCredit=$("set-credit"),i.store.themeColor=$("set-theme-color"),i.store.uiTheme=$("set-ui-theme"),i.store.bgStyle=$("set-bg-style")||"minimalist",i.store.bgCustomUrl=R($("set-bg-custom-url")),localStorage.setItem("freshmart_theme_color",i.store.themeColor),localStorage.setItem("freshmart_ui_theme",i.store.uiTheme),localStorage.setItem("freshmart_bg_style",i.store.bgStyle),localStorage.setItem("freshmart_bg_custom_url",i.store.bgCustomUrl||""),Ke(i.store.uiTheme,i.store.themeColor),Ve(i.store.bgStyle,i.store.bgCustomUrl);else if(e==="catalog")i.store.categoryStyle=$("set-category-style"),i.store.brandStyle=$("set-brand-style"),i.store.showCategories=$("set-show-categories")==="true",i.store.showBrands=$("set-show-brands")==="true";else if(e==="shipping"){i.store.wa=$("set-wa").replace(/\D/g,""),i.store.address=$("set-address"),i.store.costPerKm=$("set-cost"),i.store.isDeliveryEnabled=$("set-delivery-enabled")==="true",i.store.isPickupEnabled=$("set-pickup-enabled")==="true",i.store.freeShippingMinSpendEnabled=$("set-free-shipping-enabled")==="true",i.store.freeShippingMinSpendAmount=Math.max(0,parseFloat($("set-free-shipping-amount"))||0);let a=($("set-lat")||"").trim(),r=($("set-lng")||"").trim();const s=($("set-maps-smart-input")||"").trim();if(s&&typeof window.parseGeoCoordinates=="function"){const o=window.parseGeoCoordinates(s);o&&(a=o.lat,r=o.lng)}(!a||!r)&&(a="-7.82308507053985",r="112.0988374794464"),i.store.lat=a,i.store.lng=r}else e==="payment"?(i.payment||(i.payment={}),i.payment.qrisUrl=R($("set-qris-url"))):e==="config"?(i.config||(i.config={}),i.config.gasUrl=$("set-gas-url"),g("Pengaturan GAS URL tersimpan.")):e==="operasional"&&(i.store.useStock=$("set-use-stock")==="true",i.store.ppnEnabled=$("set-ppn-enabled")==="true",i.store.ppnType=$("set-ppn-type")||"exclusive",i.store.ppnRate=parseFloat($("set-ppn-rate"))||11,i.store.spendPointsEnabled=$("set-spend-points-enabled")==="true",i.store.spendPointsThreshold=Math.max(1,parseFloat($("set-spend-points-threshold"))||1e5),i.store.spendPointsPerThreshold=Math.max(1,parseFloat($("set-spend-points-per-threshold"))||1),Nt());const t={profile:"store",catalog:"store",shipping:"store",operasional:"store",payment:"payment",config:"config"};typeof window.saveApp=="function"&&await window.saveApp([t[e]||"store"]),e==="profile"||e==="config"?(g(e==="config"?"Sistem Diperbarui! Memuat Ulang...":"Warna Berubah! Memuat Ulang..."),setTimeout(()=>location.reload(),1500)):(g("Tersimpan!"),ya())}catch{g("Gagal menyimpan pengaturan")}finally{Ie(!1),C()}}},Ot=e=>{const t=typeof window.parseGeoCoordinates=="function"?window.parseGeoCoordinates:null,a=t?t(e):null,r=document.getElementById("maps-smart-feedback"),s=document.getElementById("set-lat"),o=document.getElementById("set-lng");a?(s&&(s.value=a.lat),o&&(o.value=a.lng),r&&(r.className="text-[10px] mt-1.5 font-bold text-emerald-600 dark:text-emerald-400 flex items-center gap-1.5",r.innerHTML=`<i class="fa-solid fa-circle-check text-xs"></i> <span>Akurat! Koordinat terdeteksi: <b>${a.lat}, ${a.lng}</b></span>`)):e&&e.trim().length>3?r&&(r.className="text-[10px] mt-1.5 font-medium text-amber-600 dark:text-amber-400 flex items-center gap-1.5",r.innerHTML='<i class="fa-solid fa-triangle-exclamation text-xs"></i> <span>Pola belum terbaca. Coba tempel format: <code>-7.823085, 112.098837</code> atau link Google Maps</span>'):r&&(r.className="text-[10px] mt-1.5 font-medium text-slate-500 dark:text-slate-400 flex items-center gap-1.5",r.innerHTML='<i class="fa-solid fa-circle-info text-blue-500"></i> <span>Tempel tautan Maps atau angka koordinat dari Google Maps</span>')},nr=()=>{const e=document.getElementById("set-lat"),t=document.getElementById("set-lng"),a=document.getElementById("set-maps-smart-input");e&&t&&a&&e.value&&t.value&&(a.value=`${e.value.trim()}, ${t.value.trim()}`)},lr=async()=>{const e=document.getElementById("set-maps-smart-input");if(e){try{if(navigator.clipboard&&navigator.clipboard.readText){const t=await navigator.clipboard.readText();if(t){e.value=t,Ot(t),g("Teks berhasil ditempel dari clipboard!");return}}}catch{}e.focus(),g("Silakan tekan Ctrl+V atau tahan untuk menempel")}},dr=()=>{const e=document.getElementById("set-lat"),t=document.getElementById("set-lng");let a=e?e.value.trim():"",r=t?t.value.trim():"";if(!a||!r){const s=document.getElementById("set-maps-smart-input");if(s&&s.value&&typeof window.parseGeoCoordinates=="function"){const o=window.parseGeoCoordinates(s.value);o&&(a=o.lat,r=o.lng)}}a&&r?window.open(`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(`${a},${r}`)}`,"_blank"):g("Masukkan koordinat toko terlebih dahulu")},cr=()=>{if(!navigator.geolocation){g("Browser tidak mendukung sensor GPS");return}g("Sedang mendeteksi lokasi GPS..."),navigator.geolocation.getCurrentPosition(e=>{const t=e.coords.latitude.toString(),a=e.coords.longitude.toString(),r=document.getElementById("set-maps-smart-input");r&&(r.value=`${t}, ${a}`),Ot(`${t}, ${a}`),g("Lokasi GPS berhasil didapatkan!")},()=>{g("Gagal mengambil GPS perangkat. Pastikan izin lokasi aktif.")},{enableHighAccuracy:!0,timeout:15e3})},pr=()=>{const e=JSON.stringify(i,null,2),t=`backup_tokoputri_${new Date().toISOString().slice(0,10)}.json`;if(window.AndroidNativeApp&&typeof window.AndroidNativeApp.saveOrShareFile=="function"){const a=btoa(unescape(encodeURIComponent(e)));window.AndroidNativeApp.saveOrShareFile(a,t,"application/json")}else{const a="data:text/json;charset=utf-8,"+encodeURIComponent(e),r=document.createElement("a");r.href=a,r.download=t,document.body.appendChild(r),r.click(),r.remove()}g("Backup berhasil disimpan!")},mr=e=>{const t=e.target.files[0];if(!t)return;const a=new FileReader;a.onload=async r=>{try{const s=JSON.parse(r.target.result);Object.assign(i,s),typeof window.saveApp=="function"&&await window.saveApp(),g("Data dipulihkan!"),setTimeout(()=>location.reload(),1e3)}catch{g("Gagal memulihkan data!")}},a.readAsText(t)};window.syncAppMeta=ar;window.rAdmSet=ya;window.selectPresetTheme=sr;window.selectBgStyle=rr;window.openSettingForm=ir;window.saveAdminSettings=or;window.backupData=pr;window.restoreData=mr;window.handleSmartMapsInput=Ot;window.handleManualCoordChange=nr;window.pasteFromClipboardToMapsInput=lr;window.previewStoreOnMaps=dr;window.detectAdminGPS=cr;let W=new Date().getFullYear(),z=0,he="menu",ke=null;const ve=["Jan","Feb","Mar","Apr","Mei","Jun","Jul","Agu","Sep","Okt","Nov","Des"],ur=e=>{if(typeof window.getEffHpp=="function")return window.getEffHpp(e);const t=i.products?.find(a=>a&&a.id!=null&&String(a.id)===String(e.id));if(!t)return 0;if(e.variantName&&t.variants){const a=t.variants.find(r=>r.name===e.variantName);if(a&&a.hpp!=null)return parseFloat(a.hpp)||0}return parseFloat(t.hpp)||0},ra=new Map,br=2*60*1e3,Ht=async e=>{const t=ra.get(e);if(t&&Date.now()-t.timestamp<br)return t.data;const a={};for(let r=1;r<=12;r++)a[r]={omset:0,ppn:0,hpp:0,disc:0,orderCount:0};try{const r=new Date(e,0,1),s=new Date(e+1,0,1);(await y.collection("freshmart_orders").where("timestamp",">=",X.firestore.Timestamp.fromDate(r)).where("timestamp","<",X.firestore.Timestamp.fromDate(s)).limit(5e3).get()).forEach(l=>{const d=l.data();if(d.status==="Dibatalkan"||!d.timestamp||!d.timestamp.toDate)return;const p=d.timestamp.toDate().getMonth()+1;if(!a[p])return;const m=d.payment?.dppAmount!==void 0&&d.payment?.dppAmount!==null?parseFloat(d.payment.dppAmount):parseFloat(d.payment?.subtotal)||0;a[p].omset+=m,a[p].ppn+=parseFloat(d.payment?.ppnAmount)||0,a[p].disc+=parseFloat(d.payment?.productDiscount)||0,a[p].orderCount++,(d.items||[]).forEach(u=>{const b=u.hpp!==void 0&&u.hpp!==null?parseFloat(u.hpp):ur(u);a[p].hpp+=(parseFloat(b)||0)*(parseFloat(u.qty)||0)})})}catch(r){console.error("Gagal memuat data pajak:",r),g("Gagal memuat data periode ini!")}return ra.set(e,{data:a,timestamp:Date.now()}),a},tt=()=>ke?(z===0?Object.keys(ke):[z]).reduce((t,a)=>{const r=ke[a];return t.omset+=r.omset,t.ppn+=r.ppn,t.hpp+=r.hpp,t.disc+=r.disc,t.orderCount+=r.orderCount,t},{omset:0,ppn:0,hpp:0,disc:0,orderCount:0}):{omset:0,ppn:0,hpp:0,disc:0,orderCount:0},Kt=()=>{const e=i.taxSettings?.monthlyExpenses||{};return(z===0?Array.from({length:12},(a,r)=>r+1):[z]).reduce((a,r)=>a+(parseFloat(e[`${W}-${r}`])||0),0)},gr=async()=>{T("admin-content",'<div class="text-center py-16"><i class="fa-solid fa-spinner fa-spin text-3xl text-slate-300"></i></div>'),ke=await Ht(W),Vt()},Vt=()=>{const e=Array.from({length:6},(r,s)=>new Date().getFullYear()-4+s),t=[{k:"summary",l:"Ringkasan PPN",i:"fa-receipt"},{k:"income",l:"Laba Rugi",i:"fa-chart-pie"},{k:"balance",l:"Neraca",i:"fa-scale-balanced"},{k:"settings",l:"Pengaturan",i:"fa-gear"}];he==="menu"&&(he="summary");const a=`
    ...
    </div>`),ft()},fr=e=>{he=e,Vt()},xr=async e=>{W=parseInt(e,10),T("tax-content",'<div class="text-center py-16"><i class="fa-solid fa-spinner fa-spin text-3xl text-slate-300"></i></div>'),ke=await Ht(W),ft()},hr=e=>{z=parseInt(e,10),ft()},ft=()=>{he==="summary"?Sa():he==="income"?Ut():he==="balance"?qt():he==="settings"&&Pa()},Sa=()=>{const e=tt(),t=z===0?`Tahun ${W}`:`${ve[z-1]} ${W}`,a=e.omset-e.disc,r=Array.from({length:12},(s,o)=>o+1).map(s=>{const o=ke?ke[s]:{omset:0,ppn:0,orderCount:0};return`<tr class="${z===s?"bg-[rgba(var(--color-primary-rgb),0.08)] dark:bg-[rgba(var(--color-primary-rgb),0.14)] font-bold":"hover:bg-slate-50 dark:hover:bg-slate-700/30"} border-b border-slate-100 dark:border-slate-700/50 last:border-0 transition-colors">
    ...
    `)},vr=async(e,t)=>{const a=parseFloat(t)||0;i.taxSettings||(i.taxSettings={}),i.taxSettings.balanceSheet||(i.taxSettings.balanceSheet={kas:0,piutang:0,hutang:0,modalDisetor:0}),i.taxSettings.balanceSheet[e]=a;try{typeof window.saveApp=="function"&&await window.saveApp(["taxSettings"]),qt()}catch{g("Gagal menyimpan data neraca!")}},Pa=()=>{const e=i.taxSettings||{};T("tax-content",`
    ...
    `)},wr=e=>{Se("tax-custom-rate-wrap","hidden",e!=="custom")},yr=async()=>{if(!dt){Ie(!0),j("Menyimpan...");try{i.taxSettings||(i.taxSettings={}),i.taxSettings.companyName=$("tax-company-name"),i.taxSettings.npwp=$("tax-npwp"),i.taxSettings.taxScheme=$("tax-scheme"),i.taxSettings.customTaxRate=parseFloat($("tax-custom-rate"))||.5,typeof window.saveApp=="function"&&await window.saveApp(["taxSettings"]),g("Pengaturan pajak tersimpan!")}catch{g("Gagal menyimpan pengaturan pajak!")}finally{Ie(!1),C()}}},Sr=e=>{const t=z===0?`Tahun ${W}`:`${ve[z-1]} ${W}`,a=i.taxSettings||{},r=new Date().toLocaleDateString("id-ID",{day:"2-digit",month:"long",year:"numeric"});let s="";i.store.logo&&(i.store.logo.includes("http")||i.store.logo.includes("data:"))?s=`<img loading="eager" src="${c(i.store.logo)}" class="w-16 h-16 object-contain">`:s='<div class="w-16 h-16 bg-slate-700 text-white flex items-center justify-center rounded-xl"><i class="fa-solid fa-store text-3xl"></i></div>';const n={summary:"LAPORAN PPN & OMSET",income:"LAPORAN LABA RUGI",balance:"NERACA"}[e]||"LAPORAN";let l=`
    ...
    `;e.length===0?a+=`<div class="bg-white dark:bg-slate-800 p-8 text-center rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm">
            ...
            </div>`}),a+="</div>"),a+="</div>",T("admin-content",a),setTimeout(()=>{x("total-piutang-header")&&(x("total-piutang-header").innerText=k(t))},100)};const $r=e=>{za(e),$a()},$a=()=>{const e=Wa||"all",t=(Bt||[]).filter(o=>e==="visible"?o.isVisible!==!1:e==="hidden"?o.isVisible===!1:!0),a=`
        <div class="mb-5 flex justify-between items-center bg-white dark:bg-slate-800 p-4 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm">
            <div class="flex items-center gap-3">
                <div class="w-10 h-10 rounded-xl flex items-center justify-center shrink-0" style="background: rgba(var(--color-primary-rgb),0.1); color: var(--color-primary)">
        ...
        </div>`}).join("");T("admin-content",'<div class="max-w-full pb-10 text-sm fade-in-scale">'+a+s+"</div>")},Ar=async e=>{const t=(Bt||[]).find(a=>a&&a.id!=null&&String(a.id)===String(e));t&&typeof window.customPrompt=="function"&&window.customPrompt("Tulis balasan untuk ulasan ini:",t.adminReply||"",async a=>{j("Menyimpan balasan...");try{await y.collection("freshmart").doc("cms_data").collection("reviews").doc(e.toString()).update({adminReply:a}),g("Balasan tersimpan!")}catch{g("Gagal menyimpan balasan!")}finally{C()}})},Tr=async e=>{const t=(Bt||[]).find(r=>r&&r.id!=null&&String(r.id)===String(e));if(!t)return;const a=t.isVisible===!1;j("Menyimpan...");try{await y.collection("freshmart").doc("cms_data").collection("reviews").doc(e.toString()).update({isVisible:a}),g(a?"Ulasan ditampilkan lagi!":"Ulasan disembunyikan dari halaman produk!")}catch{g("Gagal mengubah status ulasan!")}finally{C()}},Cr=e=>{we("Hapus Ulasan","Ulasan yang dihapus tidak bisa dikembalikan lagi.",async()=>{j("Menghapus...");try{await y.collection("freshmart").doc("cms_data").collection("reviews").doc(e.toString()).delete(),g("Ulasan dihapus!")}catch{g("Gagal menghapus ulasan!")}finally{C()}})};window.filterReviews=$r;window.rAdmReviews=$a;window.replyToReview=Ar;window.toggleReviewVisibility=Tr;window.deleteReview=Cr;window.rAdmL=e=>{xt(e),typeof window.setCTab=="function"&&window.setCTab(e),window.cTab=e,T("admin-content",`
    ...
    `},Dr=()=>{let e=document.getElementById("guarantee-modal");e||(e=document.createElement("div"),e.id="guarantee-modal",e.className="fixed inset-0 z-[115] bg-slate-900/80 flex items-end sm:items-center justify-center p-0 sm:p-5",e.onclick=t=>{t.target===e&&Ca()},document.body.appendChild(e)),e.innerHTML=`
        ...
        </div>`,e.style.opacity="0",e.style.display="flex",requestAnimationFrame(()=>{e.style.transition="opacity 0.25s ease",e.style.opacity="1"})},Ca=()=>{const e=document.getElementById("guarantee-modal");!e||e.style.display==="none"||(e.style.opacity="0",e.style.transition="opacity 0.25s ease",setTimeout(()=>{e.style.display="none",e.style.opacity="",e.style.transition=""},250))},Er=()=>{let e=document.getElementById("security-modal");e||(e=document.createElement("div"),e.id="security-modal",e.className="fixed inset-0 z-[115] bg-slate-900/80 flex items-end sm:items-center justify-center p-0 sm:p-5",e.onclick=t=>{t.target===e&&Ma()},document.body.appendChild(e)),e.innerHTML=`
        <div class="bg-white dark:bg-slate-900 w-full max-w-md rounded-t-3xl sm:rounded-2xl p-6 shadow-2xl border border-slate-200 dark:border-slate-700 space-y-4">
            <div class="flex justify-between items-center border-b border-slate-100 dark:border-slate-800 pb-4">
                <h3 class="font-bold text-slate-800 dark:text-white text-base flex items-center gap-2">
        ...
        </div>`,e.style.opacity="0",e.style.display="flex",requestAnimationFrame(()=>{e.style.transition="opacity 0.25s ease",e.style.opacity="1"})},Ma=()=>{const e=document.getElementById("security-modal");!e||e.style.display==="none"||(e.style.opacity="0",e.style.transition="opacity 0.25s ease",setTimeout(()=>{e.style.display="none",e.style.opacity="",e.style.transition=""},250))};window.renderStorefrontFooter=Ta;window.openQualityGuaranteeModal=Dr;window.closeQualityGuaranteeModal=Ca;window.openSecurityModal=Er;window.closeSecurityModal=Ma;const Ee=()=>{if(Ta(),N("dyn-store-name",i.store.name||"Toko Putri"),N("dyn-store-slogan",i.store.slogan||i.store.tagline||i.store.desc||i.store.description||"Toko Online & Kasir Resmi"),i.store.logo){const n=x("dyn-store-logo-img"),l=x("dyn-store-logo-icon");i.store.logo.includes("http")||i.store.logo.includes("data:")?n&&(n.src=i.store.logo,n.onerror=()=>{n.onerror=null,n.src="https://placehold.co/100?text=Logo"},_("dyn-store-logo-img"),B("dyn-store-logo-icon")):l&&(l.className=`fa-solid ${c(i.store.logo)} text-xl text-[var(--color-primary)]`,_("dyn-store-logo-icon"),B("dyn-store-logo-img"))}let e=i.banners&&i.banners.length?`
    <div class="relative group/banner-wrapper w-full">
        <div id="banner-slider" class="flex overflow-x-auto gap-4 sm:gap-6 pb-4 pt-2 snap-x hide-scrollbar scroll-smooth" ontouchstart="clearInterval(window.bannerTmr)" ontouchend="setTimeout(() => window.startBannerAutoSlide?.(), 8000)" onmouseenter="clearInterval(window.bannerTmr)" onmouseleave="window.startBannerAutoSlide?.()" onscroll="window.onBannerScroll && window.onBannerScroll()">
            ${i.banners.map((n,l)=>{const d=n.type==="video"&&n.videoUrl,p=!d&&n.link?`onclick="window.open('${c(n.link)}', '_self')"`:"";if(d){const m=Qa(n.videoUrl)||{type:"direct",directUrl:Dt(n.videoUrl),embedUrl:Ja(n.videoUrl)};let u="";return m.type==="youtube"?u=`
                <iframe
        ...
        <div class="flex gap-2.5 sm:gap-3 overflow-x-auto hide-scrollbar snap-x pb-3 pt-1">
            ${t.map(l=>{let d=l.type==="shipping_free"?"Gratis Ongkir":l.type==="percent"?`Diskon ${c(String(parseFloat(l.value)||0))}%`:`Diskon ${k(l.value)}`,p=[];l.minPurchase>0&&p.push(`Min. Blj ${k(l.minPurchase)}`),l.maxDiscount>0&&p.push(`Maks. ptg ${k(l.maxDiscount)}`),l.targetProduct&&p.push("Produk Khusus");let m=p.length>0?c(p.join(" • ")):"Tanpa min. belanja";return`
                ...
                ${m?`<div class="rounded-xl overflow-hidden border border-slate-200 dark:border-slate-700 bg-black aspect-video w-full max-w-xs"><iframe src="${c(Or(m))}" class="w-full h-full" frameborder="0" allow="autoplay; fullscreen" loading="lazy"></iframe></div>`:""}
...
>`;s+="</div>"}),s=`<div class="grid grid-cols-1 lg:grid-cols-2 gap-x-5 gap-y-5 items-start">${s}</div>`,T("admin-modal-form",s),e==="products"&&(window.rVarsB?.(),window.rWholB?.(),window.rSpecB?.());const d=x("admin-modal");d&&d.classList.contains("hidden")&&Hr("admin"),_("admin-modal"),setTimeout(()=>{x("admin-modal").classList.remove("opacity-0"),x("admin-modal-box").classList.remove("scale-95")},10)};window.submitAdminForm=async()=>{if(_e)return;q(!0);const e=zt||window.cTab||"products";let t={},a=Rt[e]||[];for(let s of a)if(s.type==="variants_builder")t.variants=se.filter(o=>o.name.trim()!=="");else if(s.type==="wholesale_builder")t.wholesale=je.filter(o=>parseFloat(o.minQty)>.01&&o.price>0);else if(s.type==="spec_table_builder")t.specTable=ge.filter(o=>o.key.trim()!=="");else{let o="";if(s.type==="richtext"){const n=x(`af-${s.key}-editor`);o=n?n.innerHTML:""}else o=$(`af-${s.key}`);if(typeof o=="string"){if(o.startsWith("data:image/")&&o.length>3e5)return q(!1),g("Gambar Base64 terlalu besar! Upload file.");s.key==="img"&&(o=R(o))}t[s.key]=s.type==="number"?parseFloat(o)||0:o}if(!t.name&&!t.title&&!t.bankName&&!t.code)return q(!1),g("Judul/Nama/Kode wajib diisi!");if(e==="products"&&!t.sku&&(t.sku="SKU"+Date.now().toString().slice(-6)),e==="customers"){const s=window.normalizeWA?window.normalizeWA(t.phone):(t.phone||"").replace(/\D/g,"").replace(/^0/,"62");if(!s||s.length<10)return q(!1),g("Nomor WhatsApp tidak valid!");t.phone=s,t.points=parseFloat(t.points)||0,t.id=parseInt(s,10)}let r=null;if(e==="customers")if(i.customers||(i.customers=[]),be){r=be;let s=i.customers.findIndex(o=>o&&o.id!=null&&String(o.id)===String(be));s>-1?i.customers[s]=t:i.customers.unshift(t)}else i.customers.unshift(t);else if(e==="rewards")if(i.rewards||(i.rewards=[]),be){let s=i.rewards.findIndex(o=>o&&o.id!=null&&String(o.id)===String(be));s>-1?(t.id=i.rewards[s].id,i.rewards[s]=t):t.id=be}else t.id=Date.now(),i.rewards.unshift(t);else if(be){i[e]||(i[e]=[]);let s=i[e].findIndex(o=>o&&o.id!=null&&String(o.id)===String(be));if(s>-1){if(t.id=i[e][s].id,e==="products"){const o=i[e][s];t.totalSold=o.totalSold||0,t.variants&&t.variants.length&&o.variants&&t.variants.forEach(n=>{const l=o.variants.find(d=>d.name===n.name);l&&l.totalSold&&(n.totalSold=l.totalSold)})}i[e][s]=t}else t.id=be,i[e].push(t)}else t.id=Date.now(),i[e]||(i[e]=[]),i[e].unshift(t);j("Menyimpan...");try{const s=typeof y<"u"&&y?y:window.db,o=typeof G=="function"?G:window.saveApp||(async()=>{});if(!s)throw new Error("Database Firebase belum terhubung");if(e==="products")await s.collection("freshmart").doc("cms_data").collection("products").doc(t.id.toString()).set(t),await o([],{updateType:"product_single",updatedProductIds:[t.id.toString()]});else if(e==="customers"){const n=s.collection("freshmart").doc("cms_data").collection("customers");r!==null&&r!==t.id&&await n.doc(r.toString()).delete().catch(()=>{}),await n.doc(t.phone).set(t,{merge:!0})}else if(e==="rewards"){await s.collection("freshmart").doc("cms_data").collection("rewards").doc(t.id.toString()).set(t);try{localStorage.setItem("freshmart_rewards",JSON.stringify(i.rewards))}catch{}typeof window.renderRewardCatalog=="function"&&window.renderRewardCatalog()}else await o([e]);window.closeAdminModal?.(),window.rAdmItms?.(e),g("Tersimpan!")}catch(s){console.error("Gagal simpan admin data:",s),g("Gagal menyimpan: "+(s.message||""))}finally{q(!1),C()}};window.oADel=async(e,t)=>{window.showConfirm?.("Hapus Data","Data yang dihapus tidak bisa dikembalikan lagi.",async()=>{if(_e)return;q(!0);const a=typeof y<"u"&&y?y:window.db,r=typeof G=="function"?G:window.saveApp||(async()=>{}),s=i[e]&&i[e].find(o=>o&&o.id!=null&&String(o.id)===String(t));i[e]=(i[e]||[]).filter(o=>!o||o.id==null||String(o.id)!==String(t)),j("Menghapus...");try{if(!a)throw new Error("Database Firebase belum terhubung");if(e==="products")await a.collection("freshmart").doc("cms_data").collection("products").doc(t.toString()).delete(),await r([],{updateType:"product_delete",updatedProductIds:[t.toString()]});else if(e==="customers"){const o=s?s.phone:t.toString();await a.collection("freshmart").doc("cms_data").collection("customers").doc(o).delete()}else if(e==="rewards"){await a.collection("freshmart").doc("cms_data").collection("rewards").doc(t.toString()).delete();try{localStorage.setItem("freshmart_rewards",JSON.stringify(i.rewards))}catch{}typeof window.renderRewardCatalog=="function"&&window.renderRewardCatalog()}else await r([e]);window.rAdmItms?.(e),g("Berhasil Dihapus!")}catch(o){g("Gagal menghapus: "+(o.message||""))}finally{q(!1),C()}})};window.duplicateProduct=async e=>{window.showConfirm?.("Duplikat Produk","Menyalin data produk ini ke item baru?",async()=>{if(_e)return;q(!0);const t=typeof y<"u"&&y?y:window.db,a=typeof G=="function"?G:window.saveApp||(async()=>{}),r=i.products.find(o=>o&&o.id!=null&&String(o.id)===String(e));if(!r){q(!1);return}let s=JSON.parse(JSON.stringify(r));s.id=Date.now()+Math.floor(Math.random()*1e3),s.name=s.name+" COPY",s.sku="",s.totalSold=0,s.variants&&s.variants.length>0&&(s.variants=s.variants.map(o=>(o.sku="",o.totalSold=0,o))),i.products.unshift(s),j("Menyalin...");try{if(!t)throw new Error("Database Firebase belum terhubung");await t.collection("freshmart").doc("cms_data").collection("products").doc(s.id.toString()).set(s),await a([],{updateType:"product_single",updatedProductIds:[s.id.toString()]}),window.rAdmItms?.("products"),g("Produk berhasil disalin!")}catch(o){g("Gagal menyalin: "+(o.message||""))}finally{q(!1),C()}},"Ya, Salin",!1)};window.rSpecB=()=>{const e=document.getElementById("spec-table-builder-container");if(!e)return;let t="";ge.length>0?t+=`<div class="overflow-hidden rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm mb-3">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-4">
        ...
        </div>`,a||rQpWhol(),s.style.opacity="0",s.style.display="flex",requestAnimationFrame(()=>{s.style.transition="opacity 0.25s ease",s.style.opacity="1"}),qr("quickprice")};window.rQpWhol=()=>{T("qp-whol-container",at.length?at.map((e,t)=>`
        <div class="flex items-center gap-2">
        ...
        </div>`;return}let r="";a.forEach((s,o)=>{const n=o===0&&Ye==="all",l=Jr(s.category),d=Qr(s.date),p=(s.items||[]).map(m=>`
        ...
        </div>`,document.body.appendChild(t));const a=Gt(i),r=x("changelog-header-ver");r&&(r.textContent=a),Ye=e,Ba(e),t.style.display="flex",requestAnimationFrame(()=>{t.classList.remove("opacity-0");const s=x("changelog-modal-box");s&&s.classList.remove("translate-y-full","sm:translate-y-8")})},Da=()=>{const e=x("changelog-modal");if(!e||e.style.display==="none")return;e.classList.add("opacity-0");const t=x("changelog-modal-box");t&&t.classList.add("translate-y-full","sm:translate-y-8"),setTimeout(()=>{e.style.display="none"},300)};window.openChangelogModal=Xr;window.closeChangelogModal=Da;window.filterChangelog=Ba;let He=!1,Fe=null;const Yt=()=>{const e=new Date,t=e.getFullYear(),a=String(e.getMonth()+1).padStart(2,"0"),r=String(e.getDate()).padStart(2,"0");return`${t}-${a}-${r}`},Zr=e=>{if(!e)return"";try{const t=e.split("-");return t.length===3?new Date(parseInt(t[0]),parseInt(t[1])-1,parseInt(t[2])).toLocaleDateString("id-ID",{day:"numeric",month:"short",year:"numeric"}):e}catch{return e}},Re=()=>{const e=x("admin-content");if(!e)return;const t=i.changelog||[],a=rt(i),r=Gt(i),s=(i.deletedChangelogIds||[]).length;let o="";a.length===0?o=`
                ...
                <div class="flex flex-wrap items-center justify-between gap-2 border-b border-slate-100 dark:border-slate-800 pb-3">
                    ...
                    <div class="flex items-center gap-2">
                        <span class="text-[10px] font-bold text-slate-400 dark:text-slate-500">
                            <i class="fa-regular fa-calendar mr-1"></i> ${c(Zr(n.date))}
                        </span>
                        ${l?`
