...
import{d as z,_ as ct}from"./module-member-B2CiQy_U.js";import{a as p,t as h,e as d,i,ar as ne,x as me,b as pt,f as bt}from"./module-print-C2-MjUR_.js";import{f as ue}from"./vendor-firebase-core-D2OF5R23.js";import"./vendor-firebase-db-BIUZcnOd.js";let Te=!1;const He=()=>Te?Promise.resolve():ct(()=>import("./pos-variant-sheet-DWhoZtix.js"),__vite__mapDeps([0,1])).then(()=>{Te=!0});let m=[],q="",W="",E="grid";try{const e=localStorage.getItem("pos_view_mode");(e==="list"||e==="grid")&&(E=e)}catch{}let u={name:"",phone:"",isMember:!1,memberId:null,isNewTempo:!1},$="cash",L=0,I=0,A="rp",C=0,N="",$e=null,Y=null,G=null,re=null,X=null,oe=!0,xe="environment",te=!1,_=null,Me="",Ce=0;const Le=e=>{E=e;try{localStorage.setItem("pos_view_mode",e)}catch{}document.querySelectorAll("#pos-view-btn-grid").forEach(t=>{e==="grid"?(t.style.background="var(--color-primary)",t.className="w-8 h-8 rounded-lg flex items-center justify-center text-xs transition-all cursor-pointer text-white shadow-xs"):(t.style.removeProperty("background"),t.className="w-8 h-8 rounded-lg flex items-center justify-center text-xs transition-all cursor-pointer text-slate-500 hover:text-slate-800 dark:text-slate-400")}),document.querySelectorAll("#pos-view-btn-list").forEach(t=>{e==="list"?(t.style.background="var(--color-primary)",t.className="w-8 h-8 rounded-lg flex items-center justify-center text-xs transition-all cursor-pointer text-white shadow-xs"):(t.style.removeProperty("background"),t.className="w-8 h-8 rounded-lg flex items-center justify-center text-xs transition-all cursor-pointer text-slate-500 hover:text-slate-800 dark:text-slate-400")}),D()},Q=e=>Math.max(0,parseInt(e)||0),f=e=>bt(e),U=()=>m.reduce((e,t)=>e+t.subtotal,0),K=()=>{if(A==="percent"){const e=Math.min(100,Math.max(0,parseFloat(C)||0));return Math.round(U()*e/100)}return Math.min(U(),Q(C||I))},M=()=>Math.max(0,U()-K()),De=()=>L-M(),ae=e=>{if(!e)return{isManaged:!1,totalStock:0,isOutOfStock:!0,isLowStock:!1};if(!(p?.store?.useStock!==!1))return{isManaged:!1,totalStock:9999,isOutOfStock:!1,isLowStock:!1};let a=0;return Array.isArray(e.variants)&&e.variants.length>0?a=e.variants.reduce((s,r)=>s+(r&&r.stock!=null&&parseFloat(r.stock)||0),0):a=parseFloat(e.stock)||0,{isManaged:!0,totalStock:a,isOutOfStock:a<=0,isLowStock:a>0&&a<=5}},V=()=>{try{const e=window.AudioContext||window.webkitAudioContext;if(!e)return;const t=new e,a=t.createOscillator(),s=t.createGain();a.type="sine",a.frequency.setValueAtTime(1400,t.currentTime),s.gain.setValueAtTime(.08,t.currentTime),s.gain.exponentialRampToValueAtTime(1e-4,t.currentTime+.08),a.connect(s),s.connect(t.destination),a.start(),a.stop(t.currentTime+.08),setTimeout(()=>{t.close().catch(()=>{})},150)}catch{}},ut=(e,t)=>{if(!e||!e.wholesale||!e.wholesale.length)return null;const a=[...e.wholesale].sort((s,r)=>r.minQty-s.minQty);for(const s of a)if(t>=parseFloat(s.minQty))return parseFloat(s.price);return null},F=e=>{if(!e.isVariant){const t=(p.products||[]).find(s=>s&&String(s.id)===String(e.id)),a=t?ut(t,e.qty):null;a!==null?(e.basePrice=e.basePrice||e.price,e.price=a,e.isWholesale=!0):(e.basePrice&&(e.price=e.basePrice),e.isWholesale=!1)}return e.subtotal=Math.max(0,e.price*e.qty-Q(e.discount)),e},mt=()=>{const e=new Date,t=a=>String(a).padStart(2,"0");return`POS-${e.getFullYear()}${t(e.getMonth()+1)}${t(e.getDate())}-${Date.now().toString(36).toUpperCase()}`},Oe=()=>{Y&&clearInterval(Y);const e=()=>{const a=new Date().toLocaleTimeString("id-ID",{hour:"2-digit",minute:"2-digit",second:"2-digit"})+" WIB";document.querySelectorAll("#pos-live-clock").forEach(s=>{s.textContent=a})};e(),Y=setInterval(e,1e3)},xt=()=>{Y&&(clearInterval(Y),Y=null)};window.stopPOSClock=xt;const he=()=>{window.__posBarcodeFn&&(document.removeEventListener("keydown",window.__posBarcodeFn),window.__posBarcodeFn=null)},je=()=>{he(),window.__posBarcodeFn=e=>{if(!e||typeof e.key!="string")return;const t=window.curViewName||"";if(!(t==="view-pos-cashier"||t==="view-admin"&&window.cTab==="pos"))return;if(e.key==="F4"){e.preventDefault();const r=d("pos-search-input");r&&(r.focus(),r.select());return}if(e.key==="F6"||e.key==="F7"){e.preventDefault(),ve();return}if(e.key==="F8"){e.preventDefault(),de();return}if(e.key==="F9"){e.preventDefault(),d("pos-camera-scanner-modal")?Z():Pe();return}const s=document.activeElement?.tagName?.toLowerCase();if(!(s==="input"||s==="textarea"||s==="select"))if(e.key==="Enter"){if(N&&N.length>=3){const r=N.trim().toLowerCase(),l=(p.products||[]).find(o=>o&&o.isActive!=="false"&&o.isActive!==!1&&(o.barcode&&o.barcode.toLowerCase()===r||o.sku&&o.sku.toLowerCase()===r||o.id&&String(o.id).toLowerCase()===r));if(l)ke(l.id),V(),h(`Ditambahkan: ${l.name}`,"success");else{const o=d("pos-search-input");o&&(o.value=N,q=N,D()),h("Barcode tidak ditemukan di katalog","warning")}N=""}}else e.key&&e.key.length===1&&(N=(N||"")+e.key,clearTimeout($e),$e=setTimeout(()=>{N=""},150))},document.addEventListener("keydown",window.__posBarcodeFn)},ke=e=>{const t=(p.products||[]).find(l=>l&&String(l.id)===String(e));if(!t)return;if(t.variants&&t.variants.length>0){He().then(()=>{typeof window.openPOSVariantSheet=="function"&&window.openPOSVariantSheet(e)});return}const s=ae(t);s.isManaged&&s.isOutOfStock&&h(`Peringatan: Stok "${t.name}" habis di etalase/gudang!`,"warning");const r=m.find(l=>String(l.id)===String(e)&&!l.isVariant);if(r){if(s.isManaged&&r.qty+1>s.totalStock){h(`Stok maksimal "${t.name}" hanya ${s.totalStock} ${t.unit||"pcs"}`,"warning");return}r.qty+=1,F(r)}else{const l=parseFloat(t.price)||0;m.push(F({id:t.id,name:t.name,price:l,basePrice:l,qty:1,discount:0,subtotal:l,isVariant:!1,isWholesale:!1}))}V(),typeof window.triggerHaptic=="function"&&window.triggerHaptic("light"),S()},ft=(e,t)=>{const a=(p.products||[]).find(l=>l&&String(l.id)===String(e));if(!a)return;const s=ae(a),r=m.find(l=>String(l.id)===String(e)&&!l.isVariant);if(r){if(s.isManaged&&r.qty+t>s.totalStock){h(`Stok maksimal "${a.name}" hanya ${s.totalStock} ${a.unit||"pcs"}`,"warning");return}r.qty+=t,F(r)}else{const l=parseFloat(a.price)||0,o=F({id:a.id,name:a.name,price:l,basePrice:l,qty:t,discount:0,subtotal:l*t,isVariant:!1,isWholesale:!1});m.push(o)}V(),typeof window.triggerHaptic=="function"&&window.triggerHaptic("light"),S()},gt=(e,t,a,s,r=1)=>{const l=`${e}__v${s}`,o=m.find(c=>c.cartKey===l);if(o)o.qty+=r,F(o);else{const x=`${(p.products||[]).find(b=>b&&String(b.id)===String(e))?.name||e} — ${t}`;m.push(F({id:e,cartKey:l,name:x,variantName:t,variantIdx:s,price:a,basePrice:a,qty:r,discount:0,subtotal:a*r,isVariant:!0,isWholesale:!1}))}V(),typeof window.triggerHaptic=="function"&&window.triggerHaptic("light"),S()},wt=(e,t)=>{const a=m.find(s=>(s.cartKey||String(s.id))===String(e));if(a){if(t>0&&!a.isVariant){const s=(p.products||[]).find(r=>r&&String(r.id)===String(a.id));if(s){const r=ae(s);if(r.isManaged&&a.qty+t>r.totalStock){h(`Stok maksimal tersedia: ${r.totalStock} ${s.unit||"pcs"}`,"warning");return}}}a.qty=Math.max(1,a.qty+t),F(a),t>0&&V(),S()}},ht=(e,t)=>{const a=m.find(r=>(r.cartKey||String(r.id))===String(e));if(!a)return;let s=Math.max(1,Q(t));if(!a.isVariant){const r=(p.products||[]).find(l=>l&&String(l.id)===String(a.id));if(r){const l=ae(r);l.isManaged&&s>l.totalStock&&(h(`Stok maksimal tersedia: ${l.totalStock} ${r.unit||"pcs"}`,"warning"),s=l.totalStock)}}a.qty=s,F(a),S()},kt=(e,t)=>{const a=m.find(s=>(s.cartKey||String(s.id))===String(e));a&&(a.discount=Math.min(Q(t),a.price*a.qty),F(a),S())},vt=e=>{m=m.filter(t=>(t.cartKey||String(t.id))!==String(e)),S(),typeof window.triggerHaptic=="function"&&window.triggerHaptic("light")},yt=()=>{if(m.length===0)return;const e=()=>{m=[],I=0,C=0,A="rp",S(),h("Keranjang kasir dikosongkan.")};typeof window.showConfirm=="function"?window.showConfirm("Kosongkan Keranjang","Hapus semua item dari transaksi saat ini?",e,"Ya, Kosongkan",!0):e()},le=(e="hold")=>{try{const t=window.AudioContext||window.webkitAudioContext;if(!t)return;const a=new t,s=a.createOscillator(),r=a.createGain();s.type="sine";const l=a.currentTime;e==="hold"?(s.frequency.setValueAtTime(659.25,l),s.frequency.exponentialRampToValueAtTime(880,l+.1)):(s.frequency.setValueAtTime(880,l),s.frequency.exponentialRampToValueAtTime(1174.66,l+.1)),r.gain.setValueAtTime(.08,l),r.gain.exponentialRampToValueAtTime(1e-4,l+.16),s.connect(r),r.connect(a.destination),s.start(),s.stop(l+.16),setTimeout(()=>{a.close().catch(()=>{})},200)}catch{}},St=e=>{if(!e)return"";const t=Math.floor((Date.now()-e)/1e3);if(t<45)return"Baru saja";const a=Math.floor(t/60);if(a<60)return`${a} mnt lalu`;const s=Math.floor(a/60);return s<24?`${s} jam lalu`:new Date(e).toLocaleDateString("id-ID",{day:"numeric",month:"short",hour:"2-digit",minute:"2-digit"})};let v=[];try{const e=localStorage.getItem("pos_held_carts");if(e){const t=JSON.parse(e);Array.isArray(t)&&(v=t)}}catch{v=[]}const ie=()=>{try{localStorage.setItem("pos_held_carts",JSON.stringify(v))}catch{}ee()},ee=()=>{const e=v.length,t=d("pos-held-btn-storefront"),a=d("pos-held-btn-admin");t&&(e>0?t.innerHTML=`
            ...
            <button onclick="window.openPOSHeldModal()" class="px-2 py-1 rounded-lg bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 text-slate-600 dark:text-slate-300 text-[10px] font-bold flex items-center gap-1 hover:bg-slate-50 dark:hover:bg-slate-800 transition-all cursor-pointer" title="Daftar Transaksi Tertahan (F8)">
                <i class="fa-solid fa-hourglass-half"></i>
                <span>Parkir</span>
            </button>`)},ve=()=>{if(m.length===0){h("Keranjang masih kosong, tidak ada transaksi untuk ditahan.","warning");return}const e=u?.name?`Antrean #${v.length+1} — ${u.name}`:`Antrean #${v.length+1}`,t=m.reduce((s,r)=>s+(r.qty||1),0),a=M();se(!0),typeof window.pushModalHistory=="function"&&window.pushModalHistory("posHoldPrompt"),document.getElementById("pos-hold-prompt-modal")?.remove(),document.body.insertAdjacentHTML("beforeend",`
                ...
                <div class="p-3.5 sm:p-4 hover:bg-slate-50/80 dark:hover:bg-slate-800/40 transition-colors flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    <div class="min-w-0 flex-1">
                        <div class="flex items-center gap-2 mb-1 flex-wrap">
                            ...
                            <span class="text-[10px] text-slate-400">• ${St(s.time)}</span>
                        </div>
    ...
    <div id="pos-delete-confirm-modal" class="fixed inset-0 z-[10005] flex items-center justify-center p-4" style="background:rgba(15,23,42,0.75);backdrop-filter:blur(4px)">
        <div class="bg-white dark:bg-slate-900 rounded-3xl shadow-2xl w-full max-w-xs border border-slate-200 dark:border-slate-800 p-6 text-center transform transition-all">
            ...
            <div class="flex gap-2.5">
               ...
               </div>`:t.map(o=>{if(!o)return"";const c=!!(o.img&&typeof o.img=="string"&&o.img.trim()),x=c?me(o.img,"w300-rw"):"",b=Array.isArray(o.variants)&&o.variants.length>0,n=Array.isArray(o.wholesale)&&o.wholesale.length>0,y=m.filter(w=>w&&String(w.id)===String(o.id)).reduce((w,B)=>w+(B&&B.qty?B.qty:0),0),O=i(String(o.id!=null?o.id:"")),j=ae(o),k=i(String(o.name||"Produk")),P=i(String(o.category||"")),H=parseFloat(o.price)||0;return E==="list"?`
           ...
           </div>`:m.map(n=>{const g=i(String(n.cartKey||n.id)),y=Pt(n),O=n.isVariant&&n.variantName?i(n.name.replace(` — ${n.variantName}`,"")):i(n.name);return`
    ...
    <div id="pos-pay-modal" class="fixed inset-0 z-[9999] flex items-end sm:items-center justify-center p-0 sm:p-4" style="background:rgba(15,23,42,0.65);backdrop-filter:blur(4px)">
      ...
      <div class="flex justify-between items-center py-2 px-3 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-100 dark:border-slate-700/60 mb-2.5 text-xs">
        ...
        `}else if(e==="qris"){const r=p.payment?.qrisUrl||"";t.innerHTML=`
          ...
          </div>`,J().then(()=>{d("pos-cust-phone")?.value?.trim()&&be()})):e==="tempo"&&(u.isMember=!1,_e("tempo"),t.innerHTML=`
          <div class="space-y-2">
          ...
          </div>`))},_e=e=>{$=e,Ve("pos-pay",e,["cash","qris","transfer","tempo"]),fe(e),e==="transfer"&&(!p.banks||!p.banks.length)&&pe().then(t=>{$==="transfer"&&t&&t.length>0&&fe("transfer")})},Qe=e=>{L=Q(e);const t=M(),a=L-t,s=d("pos-change-display"),r=d("pos-change-label"),l=d("pos-change-box"),o=d("pos-process-btn");s&&(s.textContent=f(Math.abs(a))),r&&(r.textContent=a>=0?"Kembalian Uang Pembeli:":"Uang Masih Kurang:"),s&&(s.className=`text-base font-black ${a>=0?"text-emerald-700 dark:text-emerald-400":"text-rose-600 dark:text-rose-400"}`),l&&(l.className=`mt-2.5 p-3 rounded-2xl border transition-all flex items-center justify-between ${a>=0?"bg-emerald-50 dark:bg-emerald-950/30 border-emerald-200 dark:border-emerald-800":"bg-rose-50 dark:bg-rose-950/30 border-rose-200 dark:border-rose-800"}`),o&&$==="cash"&&(o.disabled=a<0,o.classList.toggle("opacity-50",a<0))},Ue=e=>{const t=d("pos-paid-input");t&&(t.value=e,Qe(e),typeof window.triggerHaptic=="function"&&window.triggerHaptic("light"))},pe=async()=>{if(Array.isArray(p.banks)&&p.banks.length>0)return p.banks;try{const e=await z.collection("freshmart").doc("cms_data").get();if(e.exists){const t=e.data();if(Array.isArray(t?.banks)&&t.banks.length>0)return p.banks=t.banks,p.banks}}catch{}return p.banks||[]},J=async()=>{if(p.customers&&p.customers.length>0)return p.customers;try{const e=await z.collection("freshmart").doc("cms_data").collection("customers").get();return p.customers=e.docs.map(t=>({...t.data(),id:t.id,_docId:t.id})),p.customers}catch{return p.customers||[]}},ze=(e,t)=>{if(!e||!t||!t.length)return[];const a=e.trim().toLowerCase(),s=a.replace(/\D/g,"");let r=s;r.startsWith("62")?r=r.slice(2):r.startsWith("0")&&(r=r.slice(1));const l=[],o=new Set;return t.forEach(c=>{if(!c)return;const x=String(c.id||c._docId||c.phone||"");if(o.has(x))return;const b=String(c.phone||"").replace(/\D/g,"");let n=b;n.startsWith("62")?n=n.slice(2):n.startsWith("0")&&(n=n.slice(1));const g=String(c.name||"").toLowerCase();let y=!1;r.length>=4&&n&&(n===r||n.endsWith(r)||r.endsWith(n)||b.includes(s))&&(y=!0),!y&&(x.toLowerCase()===a||x===s)&&(y=!0),!y&&a.length>=2&&g.includes(a)&&(y=!0),y&&(o.add(x),l.push(c))}),l},Mt=async e=>{if(!e)return null;const t=e.trim(),a=t.replace(/\D/g,"");let s=a;s.startsWith("62")?s=s.slice(2):s.startsWith("0")&&(s=s.slice(1));const r=z.collection("freshmart").doc("cms_data").collection("customers"),o=Array.from(new Set([s?"62"+s:null,s?"0"+s:null,s||null,s?"+62"+s:null,a||null,t].filter(Boolean))).map(async b=>{try{const n=await r.doc(b).get();if(n&&n.exists)return{...n.data(),id:n.id,_docId:n.id}}catch{}return null}),x=(await Promise.all(o)).find(Boolean);if(x){p.customers||(p.customers=[]);const b=p.customers.findIndex(n=>String(n.id||n.phone)===String(x.id||x.phone));return b>-1?p.customers[b]=x:p.customers.push(x),x}try{const b=await r.limit(300).get();if(!b.empty){p.customers=b.docs.map(g=>({...g.data(),id:g.id,_docId:g.id}));const n=ze(e,p.customers);if(n.length>0)return n[0]}}catch{}return null},ge=e=>{u.isMember=!0,u.name=e.name||"Member Toko",u.phone=e.phone||"",u.memberId=e.id||e._docId||e.phone,u.points=parseFloat(e.points)||0;const t=d("pos-cust-phone");t&&(t.value=e.phone||e.name||"");const a=u.points,s=typeof window.getMemberTier=="function"?window.getMemberTier(a):{badge:"MEMBER RESMI"},r=d("pos-member-result");r&&(r.innerHTML=`
        <div class="p-3 bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-950/40 dark:to-teal-950/30 rounded-2xl border border-emerald-300 dark:border-emerald-700/60 shadow-xs flex items-center justify-between gap-2.5">
          ...
          <button onclick="window.resetPosMember()" type="button" class="shrink-0 px-2.5 py-1.5 rounded-xl text-[10px] font-bold text-slate-600 hover:text-rose-600 dark:text-slate-300 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 transition-all cursor-pointer" title="Ganti Member">
            ...
            `;else{const l=await Mt(t);if(l)ge(l);else{u.isMember=!1,u.name="",u.memberId=null,u.points=0;const c=t.replace(/\D/g,"").length>=8;a.innerHTML=`
    ...
    `},Lt=()=>{try{q="",W="",m=[],I=0;const e=d("view-pos-cashier");if(!e)return;const t=d("admin-content"),a=d("view-admin");t&&a?.classList.contains("admin-pos-mode")&&(t.innerHTML="",a.classList.remove("admin-pos-mode")),e.innerHTML=Xe({isStorefront:!0}),D(),S(),ee(),je(),Oe(),J(),Ze()}catch(e){console.error("Gagal render POS Storefront:",e)}},Dt=()=>{try{q="",W="";const e=d("view-admin");e&&e.classList.add("admin-pos-mode");const t=d("view-pos-cashier");if(t&&(t.innerHTML=""),!d("admin-content"))return;pt("admin-content",`<div class="h-full w-full flex flex-col overflow-hidden">${Xe({isStorefront:!1})}</div>`),D(),S(),ee(),je(),Oe(),J(),Ze()}catch(e){console.error("Gagal render POS Admin:",e);const t=d("admin-content");t&&(t.innerHTML=`
            ...
            `)}},Ze=()=>{window.setPOSViewMode=Le,window.posAddToCart=ke,window.posAddToCartQty=ft,window.addToCartPOSWithVariant=gt,window.posUpdateQty=wt,window.posSetQty=ht,window.posSetItemDisc=kt,window.posRemoveItem=vt,window.posClearCart=yt,window.openPayModal=Tt,window.closePayModal=Ke,window.setPosCustomerType=$t,window.setPosPayMethod=_e,window.updatePosChange=Qe,window.posSetQuickCash=Ue,window.ensureCustomersLoaded=J,window.ensureBanksLoaded=pe,window.lookupPosMember=be,window.debouncedLookupPosMember=Je,window.selectPosMember=We,window.resetPosMember=Ge,window.processPOSTx=Ct,window.printPOSReceipt=Ht,window.posSetGlobalDisc=e=>{we(e)},window.posSetDiscountType=et,window.posSetDiscountVal=we,window.posApplyQuickDiscount=tt,window.openPOSCameraScanner=Pe,window.closePOSCameraScanner=Z,window.togglePOSScannerFacing=ot,window.togglePOSScannerTorch=rt,window.togglePOSScannerMode=nt,window.posProcessManualBarcode=lt,window.posSearchScannedCode=it,window.executePOSPrintDirect=Ye,window.posCatFilter=e=>{W=e,D()},window.posSearchFn=e=>{q=typeof e=="string"?e:e?.value||"",document.querySelectorAll("#pos-search-input").forEach(t=>{t.value!==q&&(t.value=q)}),D()},window.renderCatalog=D,window.renderCart=S,window.refreshPOSCatalog=()=>{try{D()}catch(e){console.warn("refreshPOSCatalog error:",e)}},window.openPOSCartDrawer=Fe,window.closePOSCartDrawer=se,window.playCashierBeep=V,window.openPOSHistory=()=>{typeof window.openAdminTab=="function"?window.openAdminTab("orders"):typeof window.showToast=="function"&&window.showToast("Semua transaksi kasir terpusat di menu Pesanan CMS Admin")},window.destroyBarcodeListener=he,window.playCashierChime=le,window.posHoldCurrentCart=ve,window.closePOSHoldPrompt=ye,window.posConfirmHoldCart=Ie,window.openPOSHeldModal=de,window.closePOSHeldModal=ce,window.posRecallHeldCart=Be,window.posHoldCurrentAndRecall=Re,window.posOverwriteAndRecall=Ne,window.posDeleteHeldCart=Ee,window.posExecuteDeleteHeld=qe,window.renderHeldBadges=ee},et=e=>{A=e==="percent"?"percent":"rp",I=K(),S()},we=e=>{C=Math.max(0,parseFloat(e)||0),I=K(),S()},tt=(e,t)=>{t&&(A=t),C=e,I=K(),S(),V()},Pe=async()=>{if(d("pos-camera-scanner-modal"))return;typeof window.pushModalHistory=="function"&&window.pushModalHistory("posCameraScanner"),document.body.insertAdjacentHTML("beforeend",`
    ...
    </div>`),await at()},at=async()=>{const e=d("pos-camera-video");if(e)try{const t={video:{facingMode:{ideal:xe},width:{ideal:1280},height:{ideal:720}},audio:!1},a=await navigator.mediaDevices.getUserMedia(t);G=a,e.srcObject=a,await e.play();const s=a.getVideoTracks();if(s.length>0){_=s[0];const r=_.getCapabilities?_.getCapabilities():{},l=d("pos-scanner-torch-btn");l&&(r.torch?l.classList.remove("hidden"):l.classList.add("opacity-40"))}if(typeof window.BarcodeDetector<"u")try{re=new BarcodeDetector({formats:["ean_13","ean_8","upc_a","upc_e","code_128","code_39","code_93","qr_code","data_matrix"]})}catch{re=null}X&&clearInterval(X),X=setInterval(async()=>{if(!(!re||!e||e.readyState<2))try{const r=await re.detect(e);if(r&&r.length>0){const l=r[0].rawValue?.trim();l&&st(l)}}catch{}},180)}catch(t){console.warn("[POS Scanner] Gagal akses kamera:",t);const a=d("pos-scanner-status-pill");a&&(a.innerHTML='<span class="text-rose-400 font-bold"><i class="fa-solid fa-triangle-exclamation mr-1"></i>Kamera tidak dapat diakses</span>'),h("Izin kamera ditolak atau kamera sedang digunakan aplikasi lain.","warning")}},st=e=>{const t=Date.now();if(e===Me&&t-Ce<1800)return;Me=e,Ce=t;const a=e.toLowerCase(),s=(p.products||[]).find(b=>b&&b.isActive!=="false"&&b.isActive!==!1&&(b.barcode&&b.barcode.toLowerCase()===a||b.sku&&b.sku.toLowerCase()===a||b.id&&String(b.id).toLowerCase()===a)),r=d("pos-scanner-reticle"),l=d("pos-scanner-status-pill"),o=d("pos-last-scanned-banner"),c=d("pos-last-scanned-text"),x=d("pos-last-scanned-price");if(s){if(r&&(r.classList.add("border-emerald-300","scale-105","bg-emerald-500/20"),setTimeout(()=>{r.classList.remove("border-emerald-300","scale-105","bg-emerald-500/20")},300)),V(),s.variants&&s.variants.length>0){l&&(l.innerHTML='<span class="text-amber-300 font-bold">Buka pilihan varian...</span>'),Z(),He().then(()=>{typeof window.openPOSVariantSheet=="function"&&window.openPOSVariantSheet(s.id)});return}ke(s.id),o&&c&&x&&(c.textContent=s.name,x.textContent=f(parseFloat(s.price)||0),o.classList.remove("hidden")),l&&(l.innerHTML=`<span class="text-emerald-300 font-black"><i class="fa-solid fa-check mr-1"></i>${i(s.name)} (+1)</span>`,setTimeout(()=>{l&&(l.innerHTML='<span class="w-2 h-2 rounded-full bg-emerald-400 animate-ping"></span><span>Menunggu barcode...</span>')},1500)),oe||(Z(),h(`Ditambahkan: ${s.name}`,"success"))}else r&&(r.classList.add("border-rose-500","bg-rose-500/20"),setTimeout(()=>{r.classList.remove("border-rose-500","bg-rose-500/20")},400)),l&&(l.innerHTML=`<span class="text-rose-400 font-bold"><i class="fa-solid fa-xmark mr-1"></i>Barcode "${e}" tidak ditemukan</span>`)},Z=(e=!1)=>{if(X&&(clearInterval(X),X=null),G){try{G.getTracks().forEach(a=>a.stop())}catch{}G=null}_=null,te=!1;const t=d("pos-camera-scanner-modal");t&&(!e&&typeof window.requestCloseModal=="function"?window.requestCloseModal("posCameraScanner",!1,()=>t.remove()):t.remove())},rt=async()=>{if(_)try{if(!(_.getCapabilities?_.getCapabilities():{}).torch){h("Lampu senter (torch) tidak didukung kamera ini.");return}te=!te,await _.applyConstraints({advanced:[{torch:te}]});const t=d("pos-scanner-torch-btn");t&&(te?(t.classList.add("bg-amber-500","text-white"),t.classList.remove("bg-slate-800","text-slate-300")):(t.classList.remove("bg-amber-500","text-white"),t.classList.add("bg-slate-800","text-slate-300")))}catch(e){console.warn("Gagal toggle torch:",e)}},ot=async()=>{xe=xe==="environment"?"user":"environment",G&&(G.getTracks().forEach(e=>e.stop()),G=null),await at()},nt=()=>{oe=!oe;const e=d("pos-scanner-mode-btn");e&&(oe?(e.textContent="Terus-menerus",e.className="px-2.5 py-1 rounded-lg bg-emerald-950/60 border border-emerald-600/60 text-emerald-400 text-[10px] font-black tracking-wider uppercase transition-all cursor-pointer"):(e.textContent="Scan Sekali",e.className="px-2.5 py-1 rounded-lg bg-slate-800 border border-slate-700 text-slate-300 text-[10px] font-black tracking-wider uppercase transition-all cursor-pointer"))},lt=e=>{if(!e||!e.trim())return;st(e.trim());const t=d("pos-manual-barcode-input");t&&(t.value="")},it=e=>{Z();const t=d("pos-search-input");t&&(t.value=e,q=e,D())};window.setPOSViewMode=Le;window.renderPOSStorefront=Lt;window.renderPOS=Dt;window.destroyBarcodeListener=he;window.openPOSCartDrawer=Fe;window.closePOSCartDrawer=se;window.posSetQuickCash=Ue;window.playCashierBeep=V;window.playCashierChime=le;window.posHoldCurrentCart=ve;window.closePOSHoldPrompt=ye;window.posConfirmHoldCart=Ie;window.openPOSHeldModal=de;window.closePOSHeldModal=ce;window.posRecallHeldCart=Be;window.posHoldCurrentAndRecall=Re;window.posOverwriteAndRecall=Ne;window.posDeleteHeldCart=Ee;window.posExecuteDeleteHeld=qe;window.renderHeldBadges=ee;window.ensureCustomersLoaded=J;window.ensureBanksLoaded=pe;window.lookupPosMember=be;window.debouncedLookupPosMember=Je;window.selectPosMember=We;window.resetPosMember=Ge;window.posSetDiscountType=et;window.posSetDiscountVal=we;window.posApplyQuickDiscount=tt;window.openPOSCameraScanner=Pe;window.closePOSCameraScanner=Z;window.togglePOSScannerFacing=ot;window.togglePOSScannerTorch=rt;window.togglePOSScannerMode=nt;window.posProcessManualBarcode=lt;window.posSearchScannedCode=it;window.executePOSPrintDirect=Ye;export{ke as addToCart,gt as addToCartWithVariant,ge as applyMemberToPos,yt as clearCart,Z as closePOSCameraScanner,se as closePOSCartDrawer,ce as closePOSHeldModal,ye as closePOSHoldPrompt,Ke as closePayModal,Je as debouncedLookupPosMember,he as destroyBarcodeListener,pe as ensureBanksLoaded,J as ensureCustomersLoaded,Ye as executePOSPrintDirect,ae as getProductStockInfo,be as lookupPosMember,Pe as openPOSCameraScanner,Fe as openPOSCartDrawer,de as openPOSHeldModal,Tt as openPayModal,V as playCashierBeep,le as playCashierChime,ft as posAddToCartQty,tt as posApplyQuickDiscount,Ie as posConfirmHoldCart,Ee as posDeleteHeldCart,K as posDiscountAmount,qe as posExecuteDeleteHeld,Re as posHoldCurrentAndRecall,ve as posHoldCurrentCart,Ne as posOverwriteAndRecall,lt as posProcessManualBarcode,Be as posRecallHeldCart,it as posSearchScannedCode,et as posSetDiscountType,we as posSetDiscountVal,Ue as posSetQuickCash,Ht as printPOSReceipt,Ct as processPOSTx,vt as removeFromCart,D as renderCatalog,ee as renderHeldBadges,Dt as renderPOS,Lt as renderPOSStorefront,Ge as resetPosMember,We as selectPosMember,kt as setItemDisc,Le as setPOSViewMode,$t as setPosCustomerType,_e as setPosPayMethod,ht as setQty,xt as stopClock,ot as togglePOSScannerFacing,nt as togglePOSScannerMode,rt as togglePOSScannerTorch,Qe as updatePosChange,wt as updateQty};
