...
import{a as r,c as D,s as Je,b as F,d as O,f as g,e as h,g as _,h as E,i as S,j as c,w as Y,k as u,l as he,t as re,m as St,n as Kt,o as xe,p as be,q as ue,r as oe,u as Te,v as Ae,x as gt,y as Pt,z as Tt,A as At,B as Wt,C as Gt,D as fe,E as $,F as T,G as P,H as ce,I as Me,J as ne,K as je,L as de,M as Ie,N as zt,O as Jt,P as z,Q as Ct,R as Qt,S as Yt,T as Ue,U as pe,V as Xt,W as ht,X as j,Y as Ze,Z as Zt,_ as ea,$ as ta,a0 as aa,a1 as et,a2 as le,a3 as W,a4 as sa,a5 as ra,a6 as oa}from"./module-print-BNRNvO6h.js";import{f as G}from"./vendor-firebase-core-D2OF5R23.js";import{p as la,a as ia}from"./vendor-firebase-db-BHlQMNP0.js";const na="modulepreload",da=function(e){return"/"+e},wt={},ca=function(t,a,o){let s=Promise.resolve();if(a&&a.length>0){document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),l=n?.nonce||n?.getAttribute("nonce");s=Promise.allSettled(a.map(p=>{if(p=da(p),p in wt)return;wt[p]=!0;const d=p.endsWith(".css"),m=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${p}"]${m}`))return;const b=document.createElement("link");if(b.rel=d?"stylesheet":na,d||(b.as="script"),b.crossOrigin="",b.href=p,l&&b.setAttribute("nonce",l),document.head.appendChild(b),d)return new Promise((f,w)=>{b.addEventListener("load",f),b.addEventListener("error",()=>w(new Error(`Unable to preload CSS for ${p}`)))})}))}function i(n){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=n,window.dispatchEvent(l),!l.defaultPrevented)throw n}return s.then(n=>{for(const l of n||[])l.status==="rejected"&&i(l.reason);return t().catch(i)})},pa={apiKey:"AIzaSyCOjrhMP52TGbiOyQLY92NDYE26N6d9hJM",authDomain:"restu-karya-utama.firebaseapp.com",databaseURL:"https://restu-karya-utama-default-rtdb.asia-southeast1.firebasedatabase.app",projectId:"restu-karya-utama",storageBucket:"restu-karya-utama.firebasestorage.app",messagingSenderId:"858310421352",appId:"1:858310421352:web:e20a833875e8d5c19944dd",measurementId:"G-PHDG2LJ8PM"};try{localStorage.removeItem("freshmart_fb_config")}catch{}const jt=window.FIREBASE_CONFIG||pa;G.apps.length||G.initializeApp(jt);const y=G.firestore(),J=G.auth();typeof window<"u"&&(window.firebase=G,window.db=y,window.auth=J);try{y.settings({localCache:la({tabManager:ia()}),ignoreUndefinedProperties:!0,merge:!0,experimentalAutoDetectLongPolling:!0})}catch{try{y.settings({ignoreUndefinedProperties:!0,merge:!0,experimentalAutoDetectLongPolling:!0})}catch{}}let ma=null;const Vs=()=>{ca(()=>import("./vendor-firebase-analytics-Jm19L5g2.js"),__vite__mapDeps([0,1])).then(()=>{try{ma=G.analytics()}catch{}}).catch(()=>{})},ba="K2ijSERTT2dg27yYGTEgn6XHSnW2",ke={emerald:{50:"#ecfdf5",100:"#d1fae5",200:"#a7f3d0",300:"#6ee7b7",400:"#34d399",500:"#10b981",600:"#059669",700:"#047857",800:"#065f46",900:"#064e3b"},teal:{50:"#f0fdfa",100:"#ccfbf1",200:"#99f6e4",300:"#5eead4",400:"#2dd4bf",500:"#14b8a6",600:"#0d9488",700:"#0f766e",800:"#115e59",900:"#134e4a"},cyan:{50:"#ecfeff",100:"#cffafe",200:"#a5f3fc",300:"#67e8f9",400:"#22d3ee",500:"#06b6d4",600:"#0891b2",700:"#0e7490",800:"#155e75",900:"#164e63"},sky:{50:"#f0f9ff",100:"#e0f2fe",200:"#bae6fd",300:"#7dd3fc",400:"#38bdf8",500:"#0ea5e9",600:"#0284c7",700:"#0369a1",800:"#075985",900:"#0c4a6e"},blue:{50:"#eff6ff",100:"#dbeafe",200:"#bfdbfe",300:"#93c5fd",400:"#60a5fa",500:"#3b82f6",600:"#2563eb",700:"#1d4ed8",800:"#1e40af",900:"#1e3a8a"},indigo:{50:"#eef2ff",100:"#e0e7ff",200:"#c7d2fe",300:"#a5b4fc",400:"#818cf8",500:"#6366f1",600:"#4f46e5",700:"#4338ca",800:"#3730a3",900:"#312e81"},violet:{50:"#f5f3ff",100:"#ede9fe",200:"#ddd6fe",300:"#c4b5fd",400:"#a78bfa",500:"#8b5cf6",600:"#7c3aed",700:"#6d28d9",800:"#5b21b6",900:"#4c1d95"},purple:{50:"#faf5ff",100:"#f3e8ff",200:"#e9d5ff",300:"#d8b4fe",400:"#c084fc",500:"#a855f7",600:"#9333ea",700:"#7e22ce",800:"#6b21a8",900:"#581c87"},fuchsia:{50:"#fdf4ff",100:"#fae8ff",200:"#f5d0fe",300:"#f0abfc",400:"#e879f9",500:"#d946ef",600:"#c026d3",700:"#a21caf",800:"#86198f",900:"#701a75"},pink:{50:"#fdf2f8",100:"#fce7f3",200:"#fbcfe8",300:"#f9a8d4",400:"#f472b6",500:"#ec4899",600:"#db2777",700:"#be185d",800:"#9d174d",900:"#831843"},rose:{50:"#fff1f2",100:"#ffe4e6",200:"#fecdd3",300:"#fda4af",400:"#fb7185",500:"#f43f5e",600:"#e11d48",700:"#be123c",800:"#9f1239",900:"#881337"},red:{50:"#fef2f2",100:"#fee2e2",200:"#fecaca",300:"#fca5a5",400:"#f87171",500:"#dc2626",600:"#b91c1c",700:"#991b1b",800:"#7f1d1d",900:"#450a0a"},orange:{50:"#fff7ed",100:"#ffedd5",200:"#fed7aa",300:"#fdba74",400:"#fb923c",500:"#ea580c",600:"#c2410c",700:"#9a3412",800:"#7c2d12",900:"#431407"},amber:{50:"#fffbeb",100:"#fef3c7",200:"#fde68a",300:"#fcd34d",400:"#fbbf24",500:"#d97706",600:"#b45309",700:"#92400e",800:"#78350f",900:"#451a03"},yellow:{50:"#fefce8",100:"#fef9c3",200:"#fef08a",300:"#fde047",400:"#eab308",500:"#d97706",600:"#b45309",700:"#854d0e",800:"#713f12",900:"#3f1d0b"},lime:{50:"#f7fee7",100:"#ecfccb",200:"#d9f99d",300:"#bef264",400:"#a3e635",500:"#65a30d",600:"#4d7c0f",700:"#3f6212",800:"#365314",900:"#1a2e05"},green:{50:"#f0fdf4",100:"#dcfce7",200:"#bbf7d0",300:"#86efac",400:"#4ade80",500:"#16a34a",600:"#15803d",700:"#166534",800:"#14532d",900:"#052e16"},slate:{50:"#f8fafc",100:"#f1f5f9",200:"#e2e8f0",300:"#cbd5e1",400:"#94a3b8",500:"#475569",600:"#334155",700:"#1e293b",800:"#0f172a",900:"#020617"},stone:{50:"#fafaf9",100:"#f5f5f4",200:"#e7e5e4",300:"#d6d3d1",400:"#a8a29e",500:"#57534e",600:"#44403c",700:"#292524",800:"#1c1917",900:"#0c0a09"}},ua=e=>{let t=parseInt(e.replace("#",""),16);return(t>>16&255)+","+(t>>8&255)+","+(t&255)},vt=(e,t)=>{let a=parseInt(e.slice(1,3),16),o=parseInt(e.slice(3,5),16),s=parseInt(e.slice(5,7),16);return a=Math.max(0,Math.min(255,a+t)),o=Math.max(0,Math.min(255,o+t)),s=Math.max(0,Math.min(255,s+t)),"#"+[a,o,s].map(i=>i.toString(16).padStart(2,"0")).join("")},fa=e=>{if(!e)return;try{document.querySelectorAll('meta[name="theme-color"]').forEach(p=>p.remove())}catch{}const t=document.createElement("meta");t.setAttribute("name","theme-color"),t.setAttribute("content",e),document.head.appendChild(t);try{document.querySelectorAll('meta[name="msapplication-navbutton-color"], meta[name="msapplication-TileColor"]').forEach(p=>p.remove())}catch{}const a=document.createElement("meta");a.setAttribute("name","msapplication-navbutton-color"),a.setAttribute("content",e),document.head.appendChild(a);const o=document.createElement("meta");o.setAttribute("name","msapplication-TileColor"),o.setAttribute("content",e),document.head.appendChild(o);let s=document.querySelector('meta[name="apple-mobile-web-app-capable"]');s||(s=document.createElement("meta"),s.setAttribute("name","apple-mobile-web-app-capable"),document.head.appendChild(s)),s.setAttribute("content","yes");let i=document.querySelector('meta[name="mobile-web-app-capable"]');i||(i=document.createElement("meta"),i.setAttribute("name","mobile-web-app-capable"),document.head.appendChild(i)),i.setAttribute("content","yes");let n=document.querySelector('meta[name="apple-mobile-web-app-status-bar-style"]');n||(n=document.createElement("meta"),n.setAttribute("name","apple-mobile-web-app-status-bar-style"),document.head.appendChild(n)),n.setAttribute("content","default"),typeof window.updatePwaManifest=="function"&&window.updatePwaManifest(e)},$e=(e,t)=>{const a=e||localStorage.getItem("freshmart_ui_theme")||"emerald",o=ke[a]||ke.emerald;e&&localStorage.setItem("freshmart_ui_theme",a);const s=t||localStorage.getItem("freshmart_theme_color")||o[500];t&&localStorage.setItem("freshmart_theme_color",s);const i=ua(s),n=vt(s,-30),l=vt(s,150);return document.documentElement.style.setProperty("--color-primary",s),document.documentElement.style.setProperty("--color-primary-dark",n),document.documentElement.style.setProperty("--color-primary-light",l),document.documentElement.style.setProperty("--color-primary-rgb",i),fa(s),o},qs=()=>{const e=localStorage.getItem("freshmart_theme"),t=window.matchMedia("(prefers-color-scheme: dark)").matches;(e==="dark"||!e&&t)&&document.documentElement.classList.add("dark")},Ks=()=>{const e=document.documentElement.classList.toggle("dark");localStorage.setItem("freshmart_theme",e?"dark":"light");const t=document.getElementById("icon-theme")||document.getElementById("theme-toggle-icon");t&&(t.className=e?"fa-solid fa-sun text-sm text-amber-400":"fa-solid fa-moon text-sm text-slate-600 dark:text-slate-300")},Ws=()=>{const e=document.documentElement.classList.contains("dark"),t=document.getElementById("icon-theme")||document.getElementById("theme-toggle-icon");t&&(t.className=e?"fa-solid fa-sun text-sm text-amber-400":"fa-solid fa-moon text-sm text-slate-600 dark:text-slate-300")},Se=(e="minimalist",t="")=>{const a=e||localStorage.getItem("freshmart_bg_style")||"minimalist",o=t??(localStorage.getItem("freshmart_bg_custom_url")||"");e&&localStorage.setItem("freshmart_bg_style",a),t!=null&&localStorage.setItem("freshmart_bg_custom_url",o);const i=(d=>{if(!d||typeof d!="string")return"";const m=d.match(/drive\.google\.com.*(?:id=|\/d\/)([a-zA-Z0-9_-]+)/);return m?`https://lh3.googleusercontent.com/d/${m[1]}`:d.trim()})(o);document.documentElement.setAttribute("data-bg-style",a),document.body?.setAttribute("data-bg-style",a);const n=document.getElementById("app-container");n&&(n.setAttribute("data-bg-style",a),i?n.setAttribute("data-has-custom-bg","true"):n.removeAttribute("data-has-custom-bg"));const l=document.getElementById("dynamic-bg-container");if(!l)return;if(l.innerHTML="",l.className="pointer-events-none fixed inset-0 z-0 overflow-hidden",i){const d=document.createElement("div");d.className="absolute inset-0 z-0 bg-cover bg-center bg-no-repeat bg-fixed opacity-35 dark:opacity-25 pointer-events-none transition-all duration-500",d.style.backgroundImage=`url('${i}')`,l.appendChild(d);const m=document.createElement("div");m.className="absolute inset-0 z-0 bg-slate-50/70 dark:bg-[#0b1120]/80 pointer-events-none backdrop-blur-[0.5px]",l.appendChild(m)}let p="";if(a==="hero_arch"?p=`
        ...
        </div>`,R=`<span class="text-[9px] text-slate-600 dark:text-slate-400 font-bold ml-0.5 mb-0.5 uppercase tracking-wide">/${c(l.unit||"PCS")}</span>`;return gt==="grid"?`
...
Kami akan segera memproses pesanan Anda. Terima kasih! 🙏`;window.open(`https://wa.me/${o}?text=${encodeURIComponent(d)}`,"_blank")}catch{P(),u("Gagal memuat data pesanan!")}},Ha=e=>{he("Hapus Pesanan","Yakin ingin hapus permanen?",async()=>{if(!Ue){pe(!0),T("Menghapus...");try{await y.collection("freshmart_orders").doc(e).delete(),u("Terhapus!"),Xt===e&&Mt()}catch{u("Gagal!")}finally{pe(!1),P()}}})};window.exportOrdersToExcel=_a;window.rAdmOrd=Na;window.openOrderDetail=rt;window.saveOrderCustomerToDB=Ra;window.ackRewardClaim=Fa;window.closeOrderDetailModal=Mt;window.updateOrderStatus=Oa;window.konfirmasiKeWA=Ua;window.deleteOrder=Ha;const Va=()=>{const e=r.store.name||"Toko Grosir",t=r.store.themeColor||"#10b981",a=(i,n,l=!1)=>{let p=document.querySelector(`meta[${l?"property":"name"}="${i}"]`);p||(p=document.createElement("meta"),l?p.setAttribute("property",i):p.setAttribute("name",i),document.head.appendChild(p)),p.setAttribute("content",n)};a("theme-color",t),a("mobile-web-app-capable","yes"),a("apple-mobile-web-app-capable","yes"),a("apple-mobile-web-app-status-bar-style","black-translucent"),a("apple-mobile-web-app-title",e),a("application-name",e),a("msapplication-TileColor",t),document.title=e,localStorage.setItem("freshmart_theme_color",t),r.store.uiTheme&&r.store.uiTheme!==localStorage.getItem("freshmart_ui_theme")&&(localStorage.setItem("freshmart_ui_theme",r.store.uiTheme),$e(r.store.uiTheme));const o=r.store.bgStyle||localStorage.getItem("freshmart_bg_style")||"minimalist",s=r.store.bgCustomUrl!==void 0?r.store.bgCustomUrl:localStorage.getItem("freshmart_bg_custom_url")||"";Se(o,s)},Lt=()=>{S("admin-content",`
    ...
    </div>`),Ve()},Za=e=>{te=e,it()},es=async e=>{L=parseInt(e,10),S("tax-content",'<div class="text-center py-16"><i class="fa-solid fa-spinner fa-spin text-3xl text-slate-300"></i></div>'),ae=await ot(L),Ve()},ts=e=>{B=parseInt(e,10),Ve()},Ve=()=>{te==="summary"?Bt():te==="income"?nt():te==="balance"?dt():te==="settings"&&_t()},Bt=()=>{const e=Be(),t=B===0?`Tahun ${L}`:`${se[B-1]} ${L}`,a=e.omset-e.disc,o=Array.from({length:12},(s,i)=>i+1).map(s=>{const i=ae?ae[s]:{omset:0,ppn:0,orderCount:0};return`<tr class="${B===s?"bg-[rgba(var(--color-primary-rgb),0.08)] dark:bg-[rgba(var(--color-primary-rgb),0.14)] font-bold":"hover:bg-slate-50 dark:hover:bg-slate-700/30"} border-b border-slate-100 dark:border-slate-700/50 last:border-0 transition-colors">
    ...
    `)},nt=()=>{const e=Be(),t=B===0?`Tahun ${L}`:`${se[B-1]} ${L}`,a=e.omset-e.disc-e.hpp,o=B===0?null:`${L}-${B}`,s=lt(),i=a-s,n=r.taxSettings?.taxScheme||"umkm_final";let l,p,d;n==="umkm_final"?(l=.5,p=e.omset,d="PPh Final UMKM (0,5% × Omset)"):n==="badan_normal"?(l=22,p=Math.max(0,i),d="PPh Badan (22% × Laba Bersih)"):(l=parseFloat(r.taxSettings?.customTaxRate)||0,p=Math.max(0,i),d=`PPh Custom (${l}% × Laba Bersih)`);const m=p*(l/100),b=i-m;let f="";if(B===0)f=Array.from({length:12},(w,x)=>x+1).map(w=>{const x=`${L}-${w}`,k=(r.taxSettings?.monthlyExpenses||{})[x]||0;return`<div class="flex items-center justify-between gap-2 py-2 border-b border-slate-100 dark:border-slate-700/50 last:border-0">
                <span class="text-xs font-bold text-slate-600 dark:text-slate-300">${se[w-1]} ${L}</span>
    ...
    `)},as=async(e,t)=>{const a=parseFloat(t)||0;r.taxSettings||(r.taxSettings={}),r.taxSettings.monthlyExpenses||(r.taxSettings.monthlyExpenses={}),r.taxSettings.monthlyExpenses[e]=a;try{typeof window.saveApp=="function"&&await window.saveApp(["taxSettings"]),nt()}catch{u("Gagal menyimpan biaya operasional!")}},dt=()=>{const e=He(),t=r.taxSettings?.balanceSheet||{kas:0,piutang:0,hutang:0},a=(parseFloat(t.kas)||0)+(parseFloat(t.piutang)||0)+e.assetHpp,o=parseFloat(t.hutang)||0,s=a-o;S("tax-content",`
    ...
    `)},rs=e=>{re("tax-custom-rate-wrap","hidden",e!=="custom")},os=async()=>{if(!Ue){pe(!0),T("Menyimpan...");try{r.taxSettings||(r.taxSettings={}),r.taxSettings.companyName=$("tax-company-name"),r.taxSettings.npwp=$("tax-npwp"),r.taxSettings.taxScheme=$("tax-scheme"),r.taxSettings.customTaxRate=parseFloat($("tax-custom-rate"))||.5,typeof window.saveApp=="function"&&await window.saveApp(["taxSettings"]),u("Pengaturan pajak tersimpan!")}catch{u("Gagal menyimpan pengaturan pajak!")}finally{pe(!1),P()}}},ls=e=>{const t=B===0?`Tahun ${L}`:`${se[B-1]} ${L}`,a=r.taxSettings||{},o=new Date().toLocaleDateString("id-ID",{day:"2-digit",month:"long",year:"numeric"});let s="";r.store.logo&&(r.store.logo.includes("http")||r.store.logo.includes("data:"))?s=`<img loading="eager" src="${c(r.store.logo)}" class="w-16 h-16 object-contain">`:s='<div class="w-16 h-16 bg-slate-700 text-white flex items-center justify-center rounded-xl"><i class="fa-solid fa-store text-3xl"></i></div>';const n={summary:"LAPORAN PPN & OMSET",income:"LAPORAN LABA RUGI",balance:"NERACA"}[e]||"LAPORAN";let l=`
    ...
    <div class="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-6 text-[11px] font-bold text-amber-700 leading-relaxed">
    ...
    </div>`,p="";if(e==="summary"){const m=Be(),b=m.omset-m.disc,f=Array.from({length:12},(w,x)=>x+1).map(w=>{const x=ae?ae[w]:{omset:0,ppn:0,orderCount:0};return`<tr class="border-b border-slate-200"><td class="py-2.5 px-3 font-bold text-slate-700">${se[w-1]} ${L}</td><td class="py-2.5 px-3 text-right font-bold text-slate-700">${g(x.omset)}</td><td class="py-2.5 px-3 text-right font-bold text-slate-900">${g(x.ppn)}</td><td class="py-2.5 px-3 text-right font-bold text-slate-500">${x.orderCount}</td></tr>`}).join("");p=`
        ...
        <table class="w-full text-xs"><thead><tr class="bg-slate-100 text-left"><th class="py-2.5 px-3 font-bold text-slate-500 uppercase text-[9px]">Bulan</th><th class="py-2.5 px-3 font-bold text-slate-500 uppercase text-[9px] text-right">Omset</th><th class="py-2.5 px-3 font-bold text-slate-500 uppercase text-[9px] text-right">PPN Keluaran</th><th class="py-2.5 px-3 font-bold text-slate-500 uppercase text-[9px] text-right">Pesanan</th></tr></thead><tbody>${f}</tbody></table>`}else if(e==="income"){const m=Be(),b=m.omset-m.disc-m.hpp,f=lt(),w=b-f,x=a.taxScheme||"umkm_final";let k,C,A;x==="umkm_final"?(k=.5,C=m.omset,A="PPh Final UMKM (0,5% × Omset)"):x==="badan_normal"?(k=22,C=Math.max(0,w),A="PPh Badan (22% × Laba Bersih)"):(k=parseFloat(a.customTaxRate)||0,C=Math.max(0,w),A=`PPh Custom (${k}% × Laba Bersih)`);const v=C*(k/100),q=w-v,I=(R,U,H,We)=>`<div class="flex justify-between py-2 ${H?"border-t-2 border-slate-800 mt-1 pt-3":"border-b border-slate-100"}"><span class="${H?"font-bold text-slate-900":"font-bold text-slate-600"}">${R}</span><span class="font-bold ${We||"text-slate-900"}">${U}</span></div>`;p=`<div class="max-w-xl">
        ...
        </div>`}else if(e==="balance"){const m=He(),b=a.balanceSheet||{kas:0,piutang:0,hutang:0},f=(parseFloat(b.kas)||0)+(parseFloat(b.piutang)||0)+m.assetHpp,w=parseFloat(b.hutang)||0,x=f-w;p=`
    ...
    `;e.length===0?a+=`<div class="bg-white dark:bg-slate-800 p-8 text-center rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm">
            ...
            </div>`}),a+="</div>"),a+="</div>",S("admin-content",a),setTimeout(()=>{h("total-piutang-header")&&(h("total-piutang-header").innerText=g(t))},100)};const is=e=>{ea(e),Et()},Et=()=>{const e=Zt||"all",t=(Ze||[]).filter(i=>e==="visible"?i.isVisible!==!1:e==="hidden"?i.isVisible===!1:!0),a=`
        ...
        </div>`}).join("");S("admin-content",a+s)},ns=async e=>{const t=(Ze||[]).find(a=>a.id===e);t&&typeof window.customPrompt=="function"&&window.customPrompt("Tulis balasan untuk ulasan ini:",t.adminReply||"",async a=>{T("Menyimpan balasan...");try{await y.collection("freshmart").doc("cms_data").collection("reviews").doc(e.toString()).update({adminReply:a}),u("Balasan tersimpan!")}catch{u("Gagal menyimpan balasan!")}finally{P()}})},ds=async e=>{const t=(Ze||[]).find(o=>o.id===e);if(!t)return;const a=t.isVisible===!1;T("Menyimpan...");try{await y.collection("freshmart").doc("cms_data").collection("reviews").doc(e.toString()).update({isVisible:a}),u(a?"Ulasan ditampilkan lagi!":"Ulasan disembunyikan dari halaman produk!")}catch{u("Gagal mengubah status ulasan!")}finally{P()}},cs=e=>{he("Hapus Ulasan","Ulasan yang dihapus tidak bisa dikembalikan lagi.",async()=>{T("Menghapus...");try{await y.collection("freshmart").doc("cms_data").collection("reviews").doc(e.toString()).delete(),u("Ulasan dihapus!")}catch{u("Gagal menghapus ulasan!")}finally{P()}})};window.filterReviews=is;window.rAdmReviews=Et;window.replyToReview=ns;window.toggleReviewVisibility=ds;window.deleteReview=cs;window.rAdmL=e=>{qe(e),typeof window.setCTab=="function"&&window.setCTab(e),window.cTab=e,S("admin-content",`
    ...
    `),rAdmItms(e)};window.rAdmItms=e=>{e&&(qe(e),typeof window.setCTab=="function"&&window.setCTab(e),window.cTab=e);const t=h("admin-list-container"),a=t?t.closest(".scroll-content"):null,o=a?a.scrollTop:0;if(e==="products"&&h("admin-product-stats")){const l=He();S("admin-product-stats",`
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                <div class="card-modern p-5 sm:p-5">
        ...
        <div class="p-4 sm:p-5 md:p-6 lg:p-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4 rounded-[1.5rem] border shadow-sm cursor-pointer hover:shadow-md hover:-translate-y-1 hover:border-[var(--color-primary)]/40 dark:hover:border-[var(--color-primary)]/40 transition-all duration-300 ${m}" onclick="oAEd('${e}',${l.id})">
            <div class="flex items-start sm:items-center gap-4 min-w-0 w-full">
                ...
                <div class="min-w-0 flex flex-col justify-center py-1">
                    ...
                    ${p?(()=>{const I=l.variants&&l.variants.length?l.variants.reduce((R,U)=>R+(parseFloat(U.totalSold)||0),0):parseFloat(l.totalSold)||0;return I>0?`<p class="text-[10px] font-bold text-orange-400 mt-0.5"><i class="fa-solid fa-fire-flame-curved mr-1"></i>Terjual: ${I}</p>`:""})():""}
    ...
    `},gs=()=>{let e=document.getElementById("guarantee-modal");e||(e=document.createElement("div"),e.id="guarantee-modal",e.className="fixed inset-0 z-[115] bg-slate-900/70 backdrop-blur-sm flex items-end sm:items-center justify-center p-0 sm:p-5",e.onclick=t=>{t.target===e&&Rt()},document.body.appendChild(e)),e.innerHTML=`
    ...
    <div class="relative group/banner-wrapper w-full">
        ...
        <div class="flex gap-2.5 sm:gap-3 overflow-x-auto hide-scrollbar snap-x pb-3 pt-1">
            ${t.map(l=>{let p=l.type==="shipping_free"?"Gratis Ongkir":l.type==="percent"?`Diskon ${c(String(parseFloat(l.value)||0))}%`:`Diskon ${g(l.value)}`,d=[];l.minPurchase>0&&d.push(`Min. Blj ${g(l.minPurchase)}`),l.maxDiscount>0&&d.push(`Maks. ptg ${g(l.maxDiscount)}`),l.targetProduct&&d.push("Produk Khusus");let m=d.length>0?c(d.join(" • ")):"Tanpa min. belanja";return`
                ...
                ${m?`<div class="rounded-xl overflow-hidden border border-slate-200 dark:border-slate-700 bg-black aspect-video w-full max-w-xs"><iframe src="${c(ys(m))}" class="w-full h-full" frameborder="0" allow="autoplay; fullscreen" loading="lazy"></iframe></div>`:""}
...
>`,s+="</div>"}),s=`<div class="grid grid-cols-1 lg:grid-cols-2 gap-x-5 gap-y-5 items-start">${s}</div>`,S("admin-modal-form",s),e==="products"&&(window.rVarsB?.(),window.rWholB?.(),window.rSpecB?.());const p=h("admin-modal");p&&p.classList.contains("hidden")&&$s("admin"),_("admin-modal"),setTimeout(()=>{h("admin-modal").classList.remove("opacity-0"),h("admin-modal-box").classList.remove("scale-95")},10)};window.submitAdminForm=async()=>{if(we)return;M(!0);const e=bt||window.cTab||"products";let t={},a=at[e]||[];for(let s of a)if(s.type==="variants_builder")t.variants=K.filter(i=>i.name.trim()!=="");else if(s.type==="wholesale_builder")t.wholesale=me.filter(i=>parseFloat(i.minQty)>.01&&i.price>0);else if(s.type==="spec_table_builder")t.specTable=ee.filter(i=>i.key.trim()!=="");else{let i="";if(s.type==="richtext"){const n=h(`af-${s.key}-editor`);i=n?n.innerHTML:""}else i=$(`af-${s.key}`);if(typeof i=="string"){if(i.startsWith("data:image/")&&i.length>3e5)return M(!1),u("Gambar Base64 terlalu besar! Upload file.");s.key==="img"&&(i=j(i))}t[s.key]=s.type==="number"?parseFloat(i)||0:i}if(!t.name&&!t.title&&!t.bankName&&!t.code)return M(!1),u("Judul/Nama/Kode wajib diisi!");if(e==="products"&&!t.sku&&(t.sku="SKU"+Date.now().toString().slice(-6)),e==="customers"){const s=window.normalizeWA?window.normalizeWA(t.phone):(t.phone||"").replace(/\D/g,"").replace(/^0/,"62");if(!s||s.length<10)return M(!1),u("Nomor WhatsApp tidak valid!");t.phone=s,t.points=parseFloat(t.points)||0,t.id=parseInt(s,10)}let o=null;if(e==="customers")if(r.customers||(r.customers=[]),Q){o=Q;let s=r.customers.findIndex(i=>i.id===Q);s>-1?r.customers[s]=t:r.customers.unshift(t)}else r.customers.unshift(t);else if(e==="rewards")if(r.rewards||(r.rewards=[]),Q){t.id=Q;let s=r.rewards.findIndex(i=>i.id===Q);s>-1&&(r.rewards[s]=t)}else t.id=Date.now(),r.rewards.unshift(t);else if(Q){t.id=Q,r[e]||(r[e]=[]);let s=r[e].findIndex(i=>i.id===Q);if(e==="products"&&s>-1){const i=r[e][s];t.totalSold=i.totalSold||0,t.variants&&t.variants.length&&i.variants&&t.variants.forEach(n=>{const l=i.variants.find(p=>p.name===n.name);l&&l.totalSold&&(n.totalSold=l.totalSold)})}s>-1&&(r[e][s]=t)}else t.id=Date.now(),r[e]||(r[e]=[]),r[e].unshift(t);T("Menyimpan...");try{const s=typeof y<"u"&&y?y:window.db,i=typeof N=="function"?N:window.saveApp||(async()=>{});if(!s)throw new Error("Database Firebase belum terhubung");if(e==="products")await s.collection("freshmart").doc("cms_data").collection("products").doc(t.id.toString()).set(t),await i([],{updateType:"product_single",updatedProductIds:[t.id.toString()]});else if(e==="customers"){const n=s.collection("freshmart").doc("cms_data").collection("customers");o!==null&&o!==t.id&&await n.doc(o.toString()).delete().catch(()=>{}),await n.doc(t.phone).set(t,{merge:!0})}else e==="rewards"?await s.collection("freshmart").doc("cms_data").collection("rewards").doc(t.id.toString()).set(t):await i([e]);window.closeAdminModal?.(),window.rAdmItms?.(e),u("Tersimpan!")}catch(s){console.error("Gagal simpan admin data:",s),u("Gagal menyimpan: "+(s.message||""))}finally{M(!1),P()}};window.oADel=async(e,t)=>{window.showConfirm?.("Hapus Data","Data yang dihapus tidak bisa dikembalikan lagi.",async()=>{if(we)return;M(!0);const a=typeof y<"u"&&y?y:window.db,o=typeof N=="function"?N:window.saveApp||(async()=>{}),s=r[e]&&r[e].find(i=>i.id===t);r[e]=r[e].filter(i=>i.id!==t),T("Menghapus...");try{if(!a)throw new Error("Database Firebase belum terhubung");if(e==="products")await a.collection("freshmart").doc("cms_data").collection("products").doc(t.toString()).delete(),await o([],{updateType:"product_delete",updatedProductIds:[t.toString()]});else if(e==="customers"){const i=s?s.phone:t.toString();await a.collection("freshmart").doc("cms_data").collection("customers").doc(i).delete()}else e==="rewards"?await a.collection("freshmart").doc("cms_data").collection("rewards").doc(t.toString()).delete():await o([e]);window.rAdmItms?.(e),u("Berhasil Dihapus!")}catch(i){u("Gagal menghapus: "+(i.message||""))}finally{M(!1),P()}})};window.duplicateProduct=async e=>{window.showConfirm?.("Duplikat Produk","Menyalin data produk ini ke item baru?",async()=>{if(we)return;M(!0);const t=typeof y<"u"&&y?y:window.db,a=typeof N=="function"?N:window.saveApp||(async()=>{}),o=r.products.find(i=>i.id===e);if(!o){M(!1);return}let s=JSON.parse(JSON.stringify(o));s.id=Date.now()+Math.floor(Math.random()*1e3),s.name=s.name+" COPY",s.sku="",s.totalSold=0,s.variants&&s.variants.length>0&&(s.variants=s.variants.map(i=>(i.sku="",i.totalSold=0,i))),r.products.unshift(s),T("Menyalin...");try{if(!t)throw new Error("Database Firebase belum terhubung");await t.collection("freshmart").doc("cms_data").collection("products").doc(s.id.toString()).set(s),await a([],{updateType:"product_single",updatedProductIds:[s.id.toString()]}),window.rAdmItms?.("products"),u("Produk berhasil disalin!")}catch(i){u("Gagal menyalin: "+(i.message||""))}finally{M(!1),P()}},"Ya, Salin",!1)};window.rSpecB=()=>{const e=document.getElementById("spec-table-builder-container");if(!e)return;let t="";ee.length>0?t+=`<div class="overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm mb-4">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-4">
        ...
        </div>`,a||rQpWhol(),s.style.opacity="0",s.style.display="flex",requestAnimationFrame(()=>{s.style.transition="opacity 0.25s ease",s.style.opacity="1"}),As("quickprice")};window.rQpWhol=()=>{S("qp-whol-container",Ee.length?Ee.map((e,t)=>`
        <div class="flex items-center gap-2">
        ...
        </div>`;return}let o="";a.forEach((s,i)=>{const n=i===0&&De==="all",l=Ms(s.category),p=Ds(s.date),d=(s.items||[]).map(m=>`
        ...
        </div>`,document.body.appendChild(t));const a=pt(r),o=h("changelog-header-ver");o&&(o.textContent=a),De=e,Vt(e),t.style.display="flex",requestAnimationFrame(()=>{t.classList.remove("opacity-0");const s=h("changelog-modal-box");s&&s.classList.remove("translate-y-full","sm:translate-y-8")})},qt=()=>{const e=h("changelog-modal");if(!e||e.style.display==="none")return;e.classList.add("opacity-0");const t=h("changelog-modal-box");t&&t.classList.add("translate-y-full","sm:translate-y-8"),setTimeout(()=>{e.style.display="none"},300)};window.openChangelogModal=Bs;window.closeChangelogModal=qt;window.filterChangelog=Vt;let ye=!1,ve=null;const xt=()=>{const e=new Date,t=e.getFullYear(),a=String(e.getMonth()+1).padStart(2,"0"),o=String(e.getDate()).padStart(2,"0");return`${t}-${a}-${o}`},_s=e=>{if(!e)return"";try{const t=e.split("-");return t.length===3?new Date(parseInt(t[0]),parseInt(t[1])-1,parseInt(t[2])).toLocaleDateString("id-ID",{day:"numeric",month:"short",year:"numeric"}):e}catch{return e}},Re=()=>{const e=h("admin-content");if(!e)return;const t=r.changelog||[],a=ct(r),o=pt(r);let s="";a.length===0?s=`
                ...
                <div class="flex flex-wrap items-center justify-between gap-2 border-b border-slate-100 dark:border-slate-800 pb-3">
                    ...
                    <div class="flex items-center gap-2">
                        <span class="text-[10px] font-bold text-slate-400 dark:text-slate-500">
                            <i class="fa-regular fa-calendar mr-1"></i> ${c(_s(i.date))}
                        </span>
                        ${n?`
        ...
        <div id="changelog-form-box" class="${ye?"block":"hidden"} p-5 sm:p-6 rounded-2xl bg-white dark:bg-slate-900 border-2 border-[var(--color-primary)]/40 shadow-lg space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3.5">
                ...
                <div>
                    ...
                    <input id="form-log-date" type="date" value="${xt()}" class="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-xs font-bold text-slate-800 dark:text-white focus:border-[var(--color-primary)] focus:outline-none" />
                </div>
            </div>
    ...
    </div>`},Es=(e=null)=>{ye=e!==null?e:!ye,ye||(ve=null),Re()},Ns=e=>{const t=(r.changelog||[]).find(s=>s.id===e);if(!t)return;ve=e,ye=!0,Re(),fe("form-log-version",t.version||""),fe("form-log-category",t.category||"feature"),fe("form-log-date",t.date||xt()),fe("form-log-title",t.title||""),fe("form-log-items",(t.items||[]).join(`
`));const a=h("changelog-form-title");a&&(a.innerHTML=`<i class="fa-solid fa-pen text-[var(--color-primary)]"></i> Edit Catatan Pembaruan (${c(t.version)})`);const o=h("changelog-form-box");o&&o.scrollIntoView({behavior:"smooth"})},Rs=async()=>{const e=($("form-log-version")||"").trim(),t=$("form-log-category")||"feature",a=$("form-log-date")||xt(),o=($("form-log-title")||"").trim(),s=($("form-log-items")||"").trim();if(!e)return u("Nomor versi harus diisi (contoh: v1.2.1)!");if(!o)return u("Judul pembaruan harus diisi!");if(!s)return u("Tuliskan minimal 1 poin rincian perubahan!");const i=s.split(`
`).map(l=>l.replace(/^[-*•]\s*/,"").trim()).filter(l=>l.length>0);if(i.length===0)return u("Rincian perubahan tidak boleh kosong!");T("Menyimpan catatan pembaruan...");const n={id:ve||"log-"+Date.now().toString(36),version:e.startsWith("v")?e:"v"+e,category:t,date:a,title:o,items:i,updatedAt:new Date().toISOString()};if(r.changelog=r.changelog||[],ve){const l=r.changelog.findIndex(p=>p.id===ve);l!==-1?r.changelog[l]=n:r.changelog.unshift(n)}else r.changelog.unshift(n);try{await N(["changelog"]),u("Catatan pembaruan berhasil dipublikasikan secara real-time!","success"),ye=!1,ve=null,Re()}catch(l){u("Gagal menyimpan log pembaruan: "+l.message,"error")}finally{P()}},Fs=e=>{const t=(r.changelog||[]).find(a=>a.id===e);t&&he(`Hapus catatan pembaruan versi "${t.version}"?`,async()=>{T("Menghapus catatan..."),r.changelog=(r.changelog||[]).filter(a=>a.id!==e);try{await N(["changelog"]),u("Catatan berhasil dihapus!","success"),Re()}catch(a){u("Gagal menghapus catatan: "+a.message,"error")}finally{P()}},"Ya, Hapus","Konfirmasi Hapus")};window.rAdmChangelog=Re;window.toggleChangelogForm=Es;window.editChangelogEntry=Ns;window.saveChangelogEntry=Rs;window.deleteChangelogEntry=Fs;export{ba as A,ke as a,$e as b,Se as c,y as d,ws as e,vs as f,ks as g,ua as h,qs as i,J as j,jt as k,Vs as l,Ws as m,Nt as r,Fe as s,Ks as t,X as u};
