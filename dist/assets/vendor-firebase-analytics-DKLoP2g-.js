import{r as S,_ as v,C as y,h as z,E as Y,o as Ce,F as J,L as Ee,g as T,j as X,e as Q,v as Z,k as N,l as ee,f as te}from"./vendor-firebase-core-BQNTUsNh.js";const ne="@firebase/installations",$="0.6.9";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function qt(){if(Q())try{await Z()}catch(e){return u.warn(d.create("indexeddb-unavailable",{errorInfo:e==null?void 0:e.toString()}).message),!1}else return u.warn(d.create("indexeddb-unavailable",{errorInfo:"IndexedDB is not available in this environment."}).message),!1;return!0}async function Vt(e,t,n,i,a,r,s){var o;const c=Dt(e);c.then(g=>{n[g.measurementId]=g.appId,e.options.measurementId&&g.measurementId!==e.options.measurementId&&u.warn(`The measurement ID in the local Firebase config (${e.options.measurementId}) does not match the measurement ID fetched from the server (${g.measurementId}). To ensure analytics events are always sent to the correct Analytics property, update the measurement ID field in the local config or remove it from the local config.`)}).catch(g=>u.error(g)),t.push(c);const l=qt().then(g=>{if(g)return i.getId()}),[f,h]=await Promise.all([c,l]);Ct(r)||Tt(r,f.measurementId),a("js",new Date);const _=(o=s==null?void 0:s.config)!==null&&o!==void 0?o:{};return _[gt]="firebase",_.update=!0,h!=null&&(_[pt]=h),a("config",f.measurementId,_),f.measurementId}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
