const o=e=>document.getElementById(e),P=e=>{const t=o(e);t&&t.classList.remove("hidden")},g=e=>{const t=o(e);t&&t.classList.add("hidden")},E=(e,t,s)=>{const n=o(e);n&&n.classList.toggle(t,s)},$=(e,t)=>{const s=o(e);s&&(s.innerText=t)},S=(e,t)=>{const s=o(e);s&&(s.innerHTML=t)},O=(e,t)=>{const s=o(e);s&&(s.value=t)},N=e=>{const t=o(e);return t?t.value:""},U=e=>{try{return localStorage.getItem(e)}catch{return null}},H=(e,t)=>{try{localStorage.setItem(e,t)}catch{}},d=e=>e==null?"":e.toString().replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t]),f=e=>{const t=Number(e);return isNaN(t)||e===null?"Rp 0":new Intl.NumberFormat("id-ID",{style:"currency",currency:"IDR",minimumFractionDigits:0}).format(Math.abs(t)).replace(/^/,t<0?"-":"")},G=e=>{if(typeof e!="string")return e;const t=e.match(/drive\.google\.com.*(?:id=|\/d\/)([a-zA-Z0-9_-]+)/);return t?`https://lh3.googleusercontent.com/d/${t[1]}`:e},F=e=>{if(!e||typeof e!="string")return null;const t=e.trim();if(/^[a-zA-Z0-9_-]{11}$/.test(t))return t;const s=t.match(/(?:youtube\.com\/(?:[^\/]+\/.+\/|(?:v|e(?:mbed)?|shorts)\/|.*[?&]v=)|youtu\.be\/)([^"&?\/\s]{11})/i);return s?s[1]:null},T=e=>{if(typeof e!="string"||!e.trim())return null;const t=e.trim(),s=F(t);if(s)return{type:"youtube",id:s,embedUrl:`https://www.youtube.com/embed/${s}?autoplay=1&mute=1&muted=1&loop=1&playlist=${s}&controls=0&modestbranding=1&rel=0&enablejsapi=1&playsinline=1`};const n=t.match(/(?:drive\.google\.com.*(?:id=|\/d\/)|googleusercontent\.com\/d\/)([a-zA-Z0-9_-]+)/);if(n&&n[1]){const r=n[1];return{type:"gdrive",id:r,streamUrl:`https://drive.google.com/uc?export=download&id=${r}`,streamUrl2:`https://docs.google.com/uc?export=download&id=${r}`,directUrl:`https://drive.google.com/uc?export=download&id=${r}`,embedUrl:`https://drive.google.com/file/d/${r}/preview?autoplay=1`}}return{type:"direct",directUrl:t,embedUrl:t}},Te=e=>{const t=T(e);return t?t.embedUrl:e},Ce=e=>{const t=T(e);return t?t.embedUrl:e},Le=(e,t)=>typeof e!="string"?e:e.includes("lh3.googleusercontent.com/d/")?`${e.split("=")[0]}=${t}`:e,Me=e=>e?e.status==="ready"?"(Dikirim Bersama Pesanan)":e.status==="waiting_stock"?"(Stok Kosong - Ditunda)":"(Menunggu Konfirmasi)":"",Ie=(e,t,s,n)=>{document.title=e||"Toko Putri";const r=(l,p,i=!1)=>{const a=i?"property":"name";let c=document.querySelector(`meta[${a}="${l}"]`);c||(c=document.createElement("meta"),c.setAttribute(a,l),document.head.appendChild(c)),c.setAttribute("content",p)};t&&r("description",t),e&&r("og:title",e,!0),t&&r("og:description",t,!0),s&&r("og:image",s,!0),n&&r("og:url",n,!0)},Ae=(e,t)=>{let s=document.getElementById(e);s||(s=document.createElement("script"),s.id=e,s.type="application/ld+json",document.head.appendChild(s)),s.textContent=JSON.stringify(t)},C=e=>{e&&$("loader-text",e);const t=o("global-loader");t&&(t.style.display="flex")},k=()=>{const e=o("global-loader");e&&(e.style.display="none")},Re=(e,t,s,n)=>{typeof window.showToast=="function"&&window.showToast(e,t,s,n)},je=(e,t,s,n)=>{typeof window.showConfirm=="function"&&window.showConfirm(e,t,s,n)},x={};window.loadedScripts=x;const Ee=(e,t)=>t&&t()?Promise.resolve():(x[e]||(x[e]=new Promise((s,n)=>{const r=document.createElement("script");r.src=e,r.onload=()=>s(),r.onerror=()=>{delete x[e],n(new Error("Gagal memuat: "+e))},document.head.appendChild(r)})),x[e]),K=e=>{let t=(e||"").toString().replace(/\D/g,"");return t?(t.startsWith("0")?t="62"+t.substring(1):t.startsWith("62")||(t="62"+t),t):""};window.normalizeWA=K;window.sLoad=C;window.hLoad=k;window.el=o;window.show=P;window.hide=g;window.toggleCls=E;window.setIn=$;window.setH=S;window.setV=O;window.getV=N;window.esc=d;window.fixD=G;window.fCur=f;window.sL=U;window.ssL=H;const W={store:{name:"Toko Putri",slogan:"Toko Online & Kasir Resmi",logo:"fa-store",wa:"",address:"",lat:"-7.82308507053985",lng:"112.0988374794464",costPerKm:0,isDeliveryEnabled:!0,isPickupEnabled:!0,freeShippingMinSpendEnabled:!1,freeShippingMinSpendAmount:0,allProductsIcon:"",allBrandsIcon:"",categoryStyle:"text",brandStyle:"image",showCategories:!0,showBrands:!0,themeColor:"#10b981",uiTheme:"emerald",bgStyle:"minimalist",bgCustomUrl:"",showRewardCatalog:!0,useStock:!1,ppnEnabled:!1,ppnType:"exclusive",ppnRate:11,spendPointsEnabled:!1,spendPointsThreshold:1e5,spendPointsPerThreshold:1,terms:"",privacy:""},payment:{qrisUrl:""},config:{gasUrl:""},banks:[],banners:[],categories:[],brands:[],products:[],vouchers:[],colors:[],rewards:[],faqs:[],customers:[],changelog:[],deletedChangelogIds:[],taxSettings:{companyName:"",npwp:"",taxScheme:"umkm_final",customTaxRate:.5,monthlyExpenses:{},balanceSheet:{kas:0,piutang:0,hutang:0,modalDisetor:0}}};let b=JSON.parse(JSON.stringify(W)),L=[],M=[],I=[];try{const e=localStorage.getItem("freshmart_cart");e&&(L=JSON.parse(e)||[])}catch{}try{const e=localStorage.getItem("freshmart_wishlist");e&&(M=JSON.parse(e)||[])}catch{}try{const e=localStorage.getItem("freshmart_my_orders");e&&(I=JSON.parse(e)||[])}catch{}let B={name:"",address:"",lat:null,lng:null,deliveryMethod:"delivery",distance:0,note:"",wa:""},V=null,q=null,_=null,z="Semua Produk",J="Semua Jenis",Q="Semua Merek",Z="",X="newest",Y="grid",ee=1,te=12,se="orders",ae="",oe=null,ne=null,ie=0,re=[],de=[],le=[],ce=1,pe=[],me=null,ue=null,fe=null,v=[],be=[],h=null,we=null,A=!1,xe="all",ge="today",he=null,ve=null;const Oe=e=>{he=e},Ne=e=>{b=e},Ue=e=>{L=e},He=e=>{M=e},Ge=e=>{I=e},Fe=e=>{B=e},Ke=e=>{V=e},We=e=>{q=e},Be=e=>{_=e},Ve=e=>{z=e},qe=e=>{J=e},_e=e=>{Q=e},ze=e=>{Z=e},Je=e=>{X=e},Qe=e=>{Y=e},Ze=e=>{ee=e},Xe=e=>{te=e},Ye=e=>{se=e},et=e=>{ae=e},tt=e=>{oe=e},st=e=>{ne=e},at=e=>{ie=e},ot=e=>{re=e},nt=e=>{de=e},it=e=>{le=e},rt=e=>{ce=e},dt=e=>{pe=e},lt=e=>{v=e},ct=e=>{be=e},pt=e=>{h=e},mt=e=>{we=e},y=e=>{A=e},ut=e=>{ve=e},ft=e=>{xe=e},bt=e=>{ge=e},wt=e=>{me=e},xt=e=>{ue=e},gt=e=>{fe=e},R=()=>{const e=v.find(a=>a.orderId===h);if(!e)return;const t=e.dateString?new Date(e.dateString).toLocaleString("id-ID",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}):"",s=b.store.name||"Toko",n=b.store.wa||"",r=(a,c,u=32)=>{const m=u-a.length-c.length;return a+(m>0?" ".repeat(m):" ")+c};let l=`<div class="text-center font-bold" style="font-size:13px;margin-bottom:2px;">${d(s)}</div>`;if(n&&(l+=`<div class="text-center" style="margin-bottom:4px;">WA: ${d(n)}</div>`),l+=`<div class="border-b border-dashed border-black my-2"></div><div style="white-space:pre;">Order: #${e.orderId}</div><div style="white-space:pre;">Tgl  : ${t}</div><div style="white-space:pre;">Plg  : ${d(e.customer?.name||"Guest").substring(0,20)}</div><div style="white-space:pre;">Tipe : ${e.customer?.deliveryMethod==="delivery"?"Dikirim":"Ambil di Toko"}</div><div class="border-b border-dashed border-black my-2"></div>`,e.customer?.note&&(l+=`<div style="white-space:pre-wrap;word-break:break-all;">Cat: ${d(e.customer.note)}</div><div class="border-b border-dashed border-black my-2"></div>`),e.items.forEach(a=>{let c=a.variantName?` (${d(a.variantName)}${a.colorCode?" "+d(a.colorCode):""})`:"";const u=(d(a.name)+c+(a.poTime?" [PO]":"")).substring(0,32),m=`${parseFloat(a.qty)} ${d(a.unit||"pcs")} x ${a.effectivePrice.toLocaleString("id-ID")}`,w=(parseFloat(a.qty)*a.effectivePrice).toLocaleString("id-ID");l+=`<div style="white-space:pre-wrap;font-weight:bold;word-break:break-all;">${u}</div><div style="white-space:pre;font-size:11px;">${r(m,w)}</div>`,a.poTime&&(l+=`<div style="white-space:pre;font-size:10px;font-style:italic;color:#4b5563;">* Estimasi PO: ${d(a.poTime)}</div>`)}),l+=`<div class="border-b border-dashed border-black my-2"></div><div style="white-space:pre;">${r("Subtotal",(e.payment?.subtotal||0).toLocaleString("id-ID"))}</div>`,e.customer?.deliveryMethod==="delivery"&&(l+=`<div style="white-space:pre;">${r("Ongkir",(e.payment?.shippingCost||0).toLocaleString("id-ID"))}</div>`),e.payment?.shippingDiscount&&(l+=`<div style="white-space:pre;">${r("Pot.Ongkir",`-${e.payment.shippingDiscount.toLocaleString("id-ID")}`)}</div>`),e.payment?.productDiscount&&(l+=`<div style="white-space:pre;">${r("Pot.Harga",`-${e.payment.productDiscount.toLocaleString("id-ID")}`)}</div>`),e.payment?.ppnAmount&&e.payment.ppnAmount>0){const a=e.payment.ppnType==="inclusive",c=e.payment.ppnRate||11,u=e.payment.ppnAmount||0,m=(e.payment.subtotal||0)-(e.payment.productDiscount||0)+(e.payment.shippingCost||0)-(e.payment.shippingDiscount||0),w=e.payment.dppAmount||(a?Math.round(m*100/(100+c)):Math.max(0,m));l+=`<div style="white-space:pre;">${r("DPP",w.toLocaleString("id-ID"))}</div>`,l+=`<div style="white-space:pre;">${r(`${a?"Inc. PPN":"PPN"} (${c}%)`,(a?"":"+")+u.toLocaleString("id-ID"))}</div>`}l+=`<div class="border-b border-dashed border-black my-2"></div><div style="white-space:pre;font-weight:bold;font-size:12px;">${r("TOTAL","Rp "+(e.payment?.grandTotal||0).toLocaleString("id-ID"))}</div><div style="white-space:pre;">${r("Bayar:",String(e.payment?.method||"").toUpperCase())}</div>`,(e.pointsEarned>0||e.finalMemberPoints!==void 0)&&(l+='<div class="border-b border-dashed border-black my-2"></div>',e.pointsEarned>0&&(l+=`<div style="white-space:pre;">${r("Poin Didapat:","+"+e.pointsEarned)}</div>`),e.finalMemberPoints!==void 0&&e.finalMemberPoints!==null&&(l+=`<div style="white-space:pre;font-weight:bold;">${r("Saldo Poin:",String(e.finalMemberPoints))}</div>`),e.claimedReward&&(l+=`<div style="white-space:pre-wrap;font-weight:bold;word-break:break-all;margin-top:2px;">HADIAH: ${d(e.claimedReward.name)}</div><div style="white-space:pre;font-size:10px;">(${e.claimedReward.status==="ready"?"Kirim bersama pesanan":e.claimedReward.status==="waiting_stock"?"Stok kosong-ditunda":"Menunggu konfirmasi"})</div>`)),e.items.some(a=>a.poTime&&a.poTime!=="")&&(l+='<div class="border-b border-dashed border-black my-2"></div><div style="white-space:pre-wrap;font-size:9px;text-align:center;line-height:1.2;font-style:italic;color:#4b5563;margin-bottom:4px;">* Catatan: Untuk pesanan gabungan, produk PO akan dikirimkan menyusul tanpa tambahan biaya.</div>'),l+='<div class="border-b border-dashed border-black my-2"></div><div class="text-center my-2" style="font-size:10px;">Terima Kasih</div><div class="border-b border-dashed border-black my-2"></div><div style="height:15px;"></div>',S("receipt-paper-content",l);const i=o("receipt-preview-modal");i&&i.classList.contains("hidden")&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("receipt"),P("receipt-preview-modal"),setTimeout(()=>{o("receipt-preview-modal")&&o("receipt-preview-modal").classList.remove("opacity-0"),o("receipt-preview-modal-box")&&o("receipt-preview-modal-box").classList.remove("scale-95")},10)},ye=(e=!1)=>{typeof window.requestCloseModal=="function"?window.requestCloseModal("receipt",e,()=>{o("receipt-preview-modal")&&o("receipt-preview-modal").classList.add("opacity-0"),o("receipt-preview-modal-box")&&o("receipt-preview-modal-box").classList.add("scale-95"),setTimeout(()=>g("receipt-preview-modal"),300)}):(o("receipt-preview-modal")&&o("receipt-preview-modal").classList.add("opacity-0"),o("receipt-preview-modal-box")&&o("receipt-preview-modal-box").classList.add("scale-95"),setTimeout(()=>g("receipt-preview-modal"),300))},ke=()=>{if(!v.find(n=>n.orderId===h))return;const t=o("receipt-paper-content")?o("receipt-paper-content").innerHTML:"",s=o("thermal-print-section");s&&(s.innerHTML=t,window.print())};window.openReceiptPreview=R;window.closeReceiptPreviewModal=ye;window.executePrintReceipt=ke;window.checkProPrint=()=>{R()};let j="invoice";const Pe=e=>{j=e;const t=v.find(i=>i.orderId===h);if(!t)return;$("doc-modal-title",e==="invoice"?"Preview Faktur Invoice":"Preview Surat Jalan");const s=t.dateString?new Date(t.dateString).toLocaleString("id-ID",{day:"2-digit",month:"2-digit",year:"numeric"}):"";let n="";b.store.logo&&(b.store.logo.includes("http")||b.store.logo.includes("data:"))?n=`<img loading="eager" src="${d(b.store.logo)}" class="w-16 h-16 object-contain">`:n='<div class="w-16 h-16 primary-bg flex items-center justify-center rounded-xl text-white"><i class="fa-solid fa-store text-3xl"></i></div>';let r=`
    ...
    `,S("doc-paper-content",r);const p=o("doc-preview-modal");p&&p.classList.contains("hidden")&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("docPreview"),P("doc-preview-modal"),setTimeout(()=>{o("doc-preview-modal")&&o("doc-preview-modal").classList.remove("opacity-0"),o("doc-preview-modal-box")&&o("doc-preview-modal-box").classList.remove("scale-95"),D()},10)},D=()=>{const e=o("doc-paper-scroll-area"),t=o("doc-paper-content"),s=o("doc-paper-wrapper");if(!e||!t||!s)return;const n=794,l=e.clientWidth-16,p=Math.min(1,l/n);t.style.transform=`translateX(-50%) scale(${p})`,s.style.height=t.offsetHeight*p+"px"};window.addEventListener("resize",()=>{const e=o("doc-preview-modal");e&&!e.classList.contains("hidden")&&D()});const $e=(e=!1)=>{typeof window.requestCloseModal=="function"?window.requestCloseModal("docPreview",e,()=>{o("doc-preview-modal")&&o("doc-preview-modal").classList.add("opacity-0"),o("doc-preview-modal-box")&&o("doc-preview-modal-box").classList.add("scale-95"),setTimeout(()=>g("doc-preview-modal"),300)}):(o("doc-preview-modal")&&o("doc-preview-modal").classList.add("opacity-0"),o("doc-preview-modal-box")&&o("doc-preview-modal-box").classList.add("scale-95"),setTimeout(()=>g("doc-preview-modal"),300))},Se=()=>{const e=o("doc-paper-content")?o("doc-paper-content").innerHTML:"",t=window.open("","_blank");if(!t){typeof window.showToast=="function"&&window.showToast("Gagal membuka tab baru. Izinkan pop-up di browser Anda!");return}t.document.write(`
        <html>
        <head>
