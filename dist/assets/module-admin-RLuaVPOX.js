        ...
        <div class="bg-white dark:bg-slate-800 p-4 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm flex gap-4 relative overflow-hidden group min-w-0 hover:shadow-md hover:-translate-y-1 hover:border-rose-300 dark:hover:border-rose-600 transition-all duration-300">
            ...
            <a href="?p=${i.id}" class="w-full bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700/50 rounded-[1.5rem] shadow-soft ${f} transition-all duration-300 flex flex-col group relative overflow-hidden text-left" onclick="event.preventDefault(); openProductModal(${i.id})">
                ...
                <div class="relative aspect-square w-full bg-white flex items-center justify-center shrink-0 border-b border-slate-100 dark:border-slate-700/50">
                      ${m}
                      <img loading="lazy" decoding="async" src="${c(fe(i.img,"w300-rw"))}" onerror="this.onerror=null;this.src='https://placehold.co/400?text=No+Image'" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105 ${d?"grayscale opacity-50":""}">
                </div>
            ...
            <a href="?p=${i.id}" class="w-full bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700/50 rounded-[1.5rem] shadow-soft ${v} transition-all duration-300 flex items-stretch p-2.5 sm:p-3 gap-3 sm:gap-4 group relative overflow-hidden text-left" onclick="event.preventDefault(); openProductModal(${i.id})">
                ...
                <div class="relative w-24 h-24 sm:w-28 sm:h-28 shrink-0 bg-white dark:bg-slate-900 rounded-xl flex items-center justify-center p-2 border border-slate-100 dark:border-slate-700/50 overflow-hidden">
                    ${m}
                    <img loading="lazy" decoding="async" src="${c(fe(i.img,"w300-rw"))}" onerror="this.onerror=null;this.src='https://placehold.co/400?text=No+Image'" class="max-w-full max-h-full object-contain transition-transform duration-500 group-hover:scale-105 ${d?"grayscale opacity-50":""}">
                </div>
    ...
    `,t.style.display="flex",t.style.opacity="1";const a=document.getElementById("btn-session-kicked-ok");a&&(a.onclick=()=>{t.style.opacity="0",setTimeout(()=>{t.style.display="none"},250)})},Ge=()=>{if(Be)return;const e=typeof k<"u"&&k?k:window.db;!e||!localStorage.getItem("freshmart_admin_session_id")||(Ke=!1,Be=e.collection("freshmart").doc("cms_data").collection("admin_session").doc("active").onSnapshot(async a=>{if(!a.exists)return;const r=a.data(),s=r.sessionId,l=localStorage.getItem("freshmart_admin_session_id");if(s&&l&&s!==l){if(Ke)return;Ke=!0,qe(),localStorage.removeItem("freshmart_admin_session_id");const n=r.deviceName||"Perangkat Lain";try{window.isAdm=!1,window.__localIsAdm=!1,window.isPro=!1,q&&typeof q.signOut=="function"&&await q.signOut()}catch{}typeof window.changeView=="function"&&window.changeView("view-catalog"),Ha(n)}},a=>{console.warn("Admin session guard listener error:",a)}))},qe=()=>{Be&&(Be(),Be=null)},Kt=async()=>{if(Ot())return!0;const e=typeof k<"u"&&k?k:window.db;if(!e)return!0;const t=localStorage.getItem("freshmart_admin_session_id");if(!t)try{return!(await e.collection("freshmart").doc("cms_data").collection("admin_session").doc("active").get()).exists}catch{return!0}try{const a=await e.collection("freshmart").doc("cms_data").collection("admin_session").doc("active").get();return a.exists?a.data().sessionId===t:!0}catch{return!0}};typeof window<"u"&&(window.claimAdminSession=Ft,window.attachAdminSessionGuard=Ge,window.detachAdminSessionGuard=qe,window.isCurrentSessionActive=Kt,window.setLoggingIn=at,window.isLoggingIn=Ot);const Ua=async()=>{if(window.isAdm||window.location.hostname==="localhost"){if(!await Kt()&&q.currentUser){qe(),localStorage.removeItem("freshmart_admin_session_id"),await q.signOut(),window.isAdm=!1,window.__localIsAdm=!1,u("Sesi Admin telah diambil alih oleh perangkat lain."),te("login-username",""),te("login-password",""),typeof window.changeView=="function"&&window.changeView("view-admin-login");return}if(window.__localIsAdm=!0,typeof window.changeView=="function"&&window.changeView("view-admin"),Ge(),q.currentUser)He();else{const t=q.onAuthStateChanged(()=>{t(),He()})}}else te("login-username",""),te("login-password",""),typeof window.changeView=="function"&&window.changeView("view-admin-login")},He=()=>{Ge();const e=document.querySelector("#view-admin .scroll-content");e&&(e.scrollTop=0),O("admin-dashboard-view"),F("admin-content-view"),F("btn-admin-back"),O("admin-logo-box"),K("admin-header-title","CMS SELLER"),pe&&(pe(),De(null)),de&&(de(),je(null)),ce&&(ce(),Me(null)),Ht(ia),pt()},pt=()=>{const e=h("admin-menu-tax-btn");if(!e)return;o.store.ppnEnabled===!0||o.store.ppnEnabled==="true"?(e.classList.remove("hidden"),e.classList.add("flex")):(e.classList.add("hidden"),e.classList.remove("flex"))},We=()=>{const e=o.store.useStock===!0||o.store.useStock==="true";let t=0,a=0,r=0,s=0,l=0,n=0;return(o.products||[]).forEach(i=>{if(i.variants&&i.variants.length)i.variants.forEach(d=>{const p=d.isActive!==!1&&d.isActive!=="false",m=parseFloat(d.stock)||0;p&&(!e||m>0)?r++:s++,l+=(parseFloat(d.hpp)||0)*m,n+=(parseFloat(d.price)||0)*m});else{const d=i.isActive!==!1&&i.isActive!=="false",p=parseFloat(i.stock)||0;d&&(!e||p>0)?t++:a++,l+=(parseFloat(i.hpp)||0)*p,n+=(parseFloat(i.price)||0)*p}}),{activeProd:t,inactiveProd:a,activeVar:r,inactiveVar:s,assetHpp:l,assetJual:n}},Mt=new Map,Va=2*60*1e3,Ht=async(e="month")=>{if(la(e),document.querySelectorAll(".report-period-btn").forEach(b=>{const f=b.dataset.period===e;b.style.background=f?"var(--color-primary)":"transparent",b.style.color=f?"var(--color-primary-contrast, #fff)":"",b.style.boxShadow=f?"0 2px 8px rgba(var(--color-primary-rgb),0.35)":"none"}),!h("admin-report-container"))return;const a=({totalPenjualan:b,totalHppTerjual:f,totalDiskonProduk:v,orderCount:g,truncated:S})=>{const T=b-f,A=T-v,w={today:"Hari Ini",week:"Minggu Ini",month:"Bulan Ini",all:"Sepanjang Waktu"}[e]||"";$("admin-report-container",`
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                <div class="card-modern p-5 sm:p-5">
                    ...
                    <p class="text-[10px] font-bold text-slate-400 mt-1">${g} pesanan${S?" (≥3000, dibatasi)":""}</p>
                </div>
                <div class="card-modern p-5 sm:p-5">
...
Kami akan segera memproses pesanan Anda. Terima kasih! 🙏`;window.open(`https://wa.me/${r}?text=${encodeURIComponent(p)}`,"_blank")}catch{P(),u("Gagal memuat data pesanan!")}},es=e=>{ve("Hapus Pesanan","Yakin ingin hapus permanen?",async()=>{if(!Ve){me(!0),C("Menghapus...");try{await k.collection("freshmart_orders").doc(e).delete(),u("Terhapus!"),ca===e&&Vt()}catch{u("Gagal!")}finally{me(!1),P()}}})};window.exportOrdersToExcel=Wa;window.rAdmOrd=Ja;window.openOrderDetail=mt;window.saveOrderCustomerToDB=Qa;window.ackRewardClaim=Ya;window.closeOrderDetailModal=Vt;window.updateOrderStatus=Xa;window.konfirmasiKeWA=Za;window.deleteOrder=es;const ts=()=>{const e=o.store.name||"Toko Grosir",t=o.store.themeColor||"#10b981",a=(l,n,i=!1)=>{let d=document.querySelector(`meta[${i?"property":"name"}="${l}"]`);d||(d=document.createElement("meta"),i?d.setAttribute("property",l):d.setAttribute("name",l),document.head.appendChild(d)),d.setAttribute("content",n)};a("theme-color",t),a("mobile-web-app-capable","yes"),a("apple-mobile-web-app-capable","yes"),a("apple-mobile-web-app-status-bar-style","black-translucent"),a("apple-mobile-web-app-title",e),a("application-name",e),a("msapplication-TileColor",t),document.title=e,localStorage.setItem("freshmart_theme_color",t),o.store.uiTheme&&o.store.uiTheme!==localStorage.getItem("freshmart_ui_theme")&&(localStorage.setItem("freshmart_ui_theme",o.store.uiTheme),Pe(o.store.uiTheme));const r=o.store.bgStyle||localStorage.getItem("freshmart_bg_style")||"minimalist",s=o.store.bgCustomUrl!==void 0?o.store.bgCustomUrl:localStorage.getItem("freshmart_bg_custom_url")||"";Ae(r,s)},Gt=()=>{$("admin-content",`
    ...
    `)},xt=()=>{const e=Re(),t=R===0?`Tahun ${_}`:`${re[R-1]} ${_}`,a=e.omset-e.disc-e.hpp,r=R===0?null:`${_}-${R}`,s=gt(),l=a-s,n=o.taxSettings?.taxScheme||"umkm_final";let i,d,p;n==="umkm_final"?(i=.5,d=e.omset,p="PPh Final UMKM (0,5% × Omset)"):n==="badan_normal"?(i=22,d=Math.max(0,l),p="PPh Badan (22% × Laba Bersih)"):(i=parseFloat(o.taxSettings?.customTaxRate)||0,d=Math.max(0,l),p=`PPh Custom (${i}% × Laba Bersih)`);const m=d*(i/100),b=l-m;let f="";if(R===0)f=Array.from({length:12},(v,g)=>g+1).map(v=>{const g=`${_}-${v}`,S=(o.taxSettings?.monthlyExpenses||{})[g]||0;return`<div class="flex items-center justify-between gap-2 py-2 border-b border-slate-100 dark:border-slate-700/50 last:border-0">
                <span class="text-xs font-bold text-slate-600 dark:text-slate-300">${re[v-1]} ${_}</span>
                <input type="number" min="0" value="${S}" onchange="saveMonthlyExpense('${g}', this.value)" class="admin-input !py-2 !px-3 text-xs w-36 text-right font-bold bg-slate-50 dark:bg-slate-900 text-slate-800 dark:text-slate-100 border border-slate-200 dark:border-slate-700 rounded-xl focus:border-[var(--color-primary)]">
            </div>`}).join("");else{const v=(o.taxSettings?.monthlyExpenses||{})[r]||0;f=`<div class="flex items-center justify-between gap-2 py-2">
    ...
    <div class="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-6 text-[11px] font-bold text-amber-700 leading-relaxed">
    ...
    </div>`,d="";if(e==="summary"){const m=Re(),b=m.omset-m.disc,f=Array.from({length:12},(v,g)=>g+1).map(v=>{const g=se?se[v]:{omset:0,ppn:0,orderCount:0};return`<tr class="border-b border-slate-200"><td class="py-2.5 px-3 font-bold text-slate-700">${re[v-1]} ${_}</td><td class="py-2.5 px-3 text-right font-bold text-slate-700">${x(g.omset)}</td><td class="py-2.5 px-3 text-right font-bold text-slate-900">${x(g.ppn)}</td><td class="py-2.5 px-3 text-right font-bold text-slate-500">${g.orderCount}</td></tr>`}).join("");d=`
        ...
        <table class="w-full text-xs"><thead><tr class="bg-slate-100 text-left"><th class="py-2.5 px-3 font-bold text-slate-500 uppercase text-[9px]">Bulan</th><th class="py-2.5 px-3 font-bold text-slate-500 uppercase text-[9px] text-right">Omset</th><th class="py-2.5 px-3 font-bold text-slate-500 uppercase text-[9px] text-right">PPN Keluaran</th><th class="py-2.5 px-3 font-bold text-slate-500 uppercase text-[9px] text-right">Pesanan</th></tr></thead><tbody>${f}</tbody></table>`}else if(e==="income"){const m=Re(),b=m.omset-m.disc-m.hpp,f=gt(),v=b-f,g=a.taxScheme||"umkm_final";let S,T,A;g==="umkm_final"?(S=.5,T=m.omset,A="PPh Final UMKM (0,5% × Omset)"):g==="badan_normal"?(S=22,T=Math.max(0,v),A="PPh Badan (22% × Laba Bersih)"):(S=parseFloat(a.customTaxRate)||0,T=Math.max(0,v),A=`PPh Custom (${S}% × Laba Bersih)`);const w=T*(S/100),V=v-w,L=(D,M,E,Ye)=>`<div class="flex justify-between py-2 ${E?"border-t-2 border-slate-800 mt-1 pt-3":"border-b border-slate-100"}"><span class="${E?"font-bold text-slate-900":"font-bold text-slate-600"}">${D}</span><span class="font-bold ${Ye||"text-slate-900"}">${M}</span></div>`;d=`<div class="max-w-xl">
            ...
            ${L("(−) Estimasi "+A,"-"+x(w),!1,"text-rose-600")}
            ${L("Laba Bersih Setelah Pajak (Estimasi)",x(V),!0)}
        </div>`}else if(e==="balance"){const m=We(),b=a.balanceSheet||{kas:0,piutang:0,hutang:0},f=(parseFloat(b.kas)||0)+(parseFloat(b.piutang)||0)+m.assetHpp,v=parseFloat(b.hutang)||0,g=f-v;d=`
        ...
        </div>`}K("doc-modal-title","Preview "+n),$("doc-paper-content",i+d);const p=h("doc-preview-modal");p&&p.classList.contains("hidden")&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("docPreview"),O("doc-preview-modal"),setTimeout(()=>{h("doc-preview-modal")&&h("doc-preview-modal").classList.remove("opacity-0"),h("doc-preview-modal-box")&&h("doc-preview-modal-box").classList.remove("scale-95"),typeof window.fitDocPreview=="function"&&window.fitDocPreview()},10)};window.fetchTaxPeriodData=bt;window.getTaxPeriodTotals=Re;window.getTaxPeriodExpenses=gt;window.rTaxPanel=bs;window.rTaxRenderShell=ft;window.switchTaxTab=gs;window.changeTaxYear=fs;window.changeTaxMonth=xs;window.rTaxSubContent=ze;window.rTaxSummary=qt;window.rTaxIncome=xt;window.saveMonthlyExpense=hs;window.rTaxBalance=ht;window.saveBalanceField=vs;window.rTaxSettingsPanel=Wt;window.toggleCustomTaxRateInput=ks;window.saveTaxSettingsPanel=ws;window.openTaxDocPreview=ys;window.MONTH_NAMES=re;window.editTempoPenalty=(e,t)=>{window.customPrompt("Persentase Denda Baru",t,async a=>{if(!a)return;let r=parseFloat(a.replace(",","."));if(isNaN(r)||r<0)return u("Persentase tidak valid!");C("Menyimpan...");try{await k.collection("freshmart_orders").doc(e).update({"payment.tempoPenaltyRate":r}),u("Persentase denda berhasil diubah!"),window.rAdmPiutang()}catch(s){u("Gagal mengubah denda: "+s.message)}P()})};window.stopTempoPenalty=(e,t,a)=>{let r="Konfirmasi Denda",s=a?"Lanjutkan perhitungan denda otomatis?":"Hentikan denda berjalan sekarang? (Nominal denda akan dibekukan di "+x(t)+")";ve(r,s,async()=>{C("Menyimpan...");try{await k.collection("freshmart_orders").doc(e).update({"payment.tempoPenaltyStopped":!a,"payment.tempoFixedPenalty":a?null:t}),u(a?"Denda dilanjutkan!":"Denda berhasil dibekukan!"),window.rAdmPiutang()}catch(n){u("Gagal mengubah status denda: "+n.message)}P()},a?"Lanjutkan":"Bekukan")};window.payTempoInstallment=e=>{window.customPrompt("Masukkan Nominal Cicilan (Rp)","",async t=>{if(!t)return;let a=parseFloat(t.replace(/[^0-9]/g,""));if(isNaN(a)||a<=0)return u("Nominal tidak valid!");C("Menyimpan cicilan...");try{const s=(await k.collection("freshmart_orders").doc(e).get()).data();let l=(s.payment.tempoBalance||0)-a,n=s.payment.installments||[];n.push({date:Date.now(),amount:a,note:"Cicilan"});let i={"payment.tempoBalance":Math.max(0,l),"payment.installments":n};l<=0&&(i["payment.paymentStatus"]="lunas",i.status="Selesai"),await k.collection("freshmart_orders").doc(e).update(i),u("Cicilan berhasil ditambahkan!"),window.rAdmPiutang&&window.rAdmPiutang()}catch(r){u("Gagal memproses cicilan: "+r.message)}P()})};window.previewTempoReceipt=async e=>{C("Memuat data struk...");try{const t=await k.collection("freshmart_orders").doc(e).get();if(!t.exists)return P(),u("Pesanan tidak ditemukan");const a=t.data();P();const r=a.dateString?new Date(a.dateString).toLocaleString("id-ID",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}):"",s=o.store.name||"Toko",l=o.store.wa||"",n=(w,V,L=32)=>{const D=L-w.length-V.length;return w+(D>0?" ".repeat(D):" ")+V};let i=`<div class="text-center font-bold" style="font-size:13px;margin-bottom:2px;">${c(s)}</div>`;l&&(i+=`<div class="text-center" style="margin-bottom:4px;">WA: ${c(l)}</div>`),i+=`<div class="text-center font-bold uppercase my-2" style="font-size:14px;border-bottom:1px solid #000;border-top:1px solid #000;padding:2px 0;">NOTA TEMPO${a.payment?.paymentStatus==="lunas"?" - LUNAS":""}</div>`,i+=`<div style="white-space:pre;">Order: #${a.orderId}</div><div style="white-space:pre;">Tgl  : ${r}</div><div style="white-space:pre;">Plg  : ${c(a.customer?.name||"Guest").substring(0,20)}</div>`,a.payment?.tempoDueDate&&(i+=`<div style="white-space:pre;">J.Tmp: ${new Date(a.payment.tempoDueDate).toLocaleDateString("id-ID")}</div>`),i+='<div class="border-b border-dashed border-black my-2"></div>';let d=0;if(a.items.forEach(w=>{let V=w.variantName?` (${c(w.variantName)}${w.colorCode?" "+c(w.colorCode):""})`:"";const L=(c(w.name)+V+(w.poTime?" [PO]":"")).substring(0,32),D=`${parseFloat(w.qty)} ${c(w.unit||"pcs")} x ${w.effectivePrice.toLocaleString("id-ID")}`,M=(parseFloat(w.qty)*w.effectivePrice).toLocaleString("id-ID");i+=`<div style="white-space:pre-wrap;font-weight:bold;word-break:break-all;">${L}</div><div style="white-space:pre;font-size:11px;">${n(D,M)}</div>`,w.poTime&&(i+=`<div style="white-space:pre;font-size:10px;font-style:italic;color:#4b5563;">* Estimasi PO: ${c(w.poTime)}</div>`),d+=parseFloat(w.qty)*w.effectivePrice}),i+='<div class="border-b border-dashed border-black my-2"></div>',i+=`<div style="white-space:pre;font-weight:bold;">${n("Subtotal",d.toLocaleString("id-ID"))}</div>`,a.payment?.grandTotal&&a.payment.grandTotal!==d){let w=a.payment.grandTotal-d;w>0?i+=`<div style="white-space:pre;">${n("Ongkir/Biaya",w.toLocaleString("id-ID"))}</div>`:i+=`<div style="white-space:pre;">${n("Diskon",Math.abs(w).toLocaleString("id-ID"))}</div>`}i+=`<div style="white-space:pre;font-weight:bold;margin-top:4px;">${n("TOTAL KREDIT",(a.payment?.grandTotal||d).toLocaleString("id-ID"))}</div>`,i+='<div class="border-b border-black my-2" style="border-width:1px;"></div>';let p=0;a.payment?.installments&&a.payment.installments.length>0&&(i+='<div style="white-space:pre;font-weight:bold;margin-bottom:2px;">HISTORI CICILAN:</div>',a.payment.installments.forEach((w,V)=>{let L=new Date(w.date).toLocaleDateString("id-ID",{day:"2-digit",month:"short"}),D=w.amount.toLocaleString("id-ID");i+=`<div style="white-space:pre;">${n(`${V+1}. ${L}`,D)}</div>`,p+=w.amount}),i+=`<div style="white-space:pre;font-weight:bold;margin-top:2px;">${n("TOTAL DIBAYAR",p.toLocaleString("id-ID"))}</div>`,i+='<div class="border-b border-dashed border-black my-2"></div>');let m=a.payment?.tempoBalance||0,b=0,f=a.payment?.tempoPenaltyStopped===!0,v=a.payment?.tempoDueDate||0,g=a.payment?.tempoPenaltyRate!==void 0?parseFloat(a.payment.tempoPenaltyRate):1;if(a.payment?.paymentStatus!=="lunas"){if(f)b=parseFloat(a.payment?.tempoFixedPenalty)||0;else if(Date.now()>v){let w=Math.floor((Date.now()-v)/864e5);w>0&&(b=g/100*m*w)}}i+=`<div style="white-space:pre;font-weight:bold;">${n("SISA POKOK",m.toLocaleString("id-ID"))}</div>`,b>0&&(i+=`<div style="white-space:pre;">${n("DENDA",Math.round(b).toLocaleString("id-ID"))}</div>`);let S=m+b;i+='<div class="border-b border-black my-2" style="border-width:1px;"></div>',i+=`<div style="white-space:pre;font-weight:black;">${n("SISA TAGIHAN",Math.round(S).toLocaleString("id-ID"))}</div>`,a.items.some(w=>w.poTime&&w.poTime!=="")&&(i+='<div class="border-b border-dashed border-black my-2"></div><div style="white-space:pre-wrap;font-size:9px;text-align:center;line-height:1.2;font-style:italic;color:#4b5563;margin-bottom:4px;">* Catatan: Untuk pesanan gabungan, produk PO akan dikirimkan menyusul (estimasi sesuai label) tanpa dikenakan biaya tambahan.</div>'),i+='<div class="border-b border-dashed border-black my-2"></div><div class="text-center my-2" style="font-size:10px;">Terima kasih atas kepercayaannya.</div><div class="border-b border-dashed border-black my-2"></div><div style="height:20px;"></div>',$("receipt-paper-content",i);const A=h("receipt-preview-modal");A&&A.classList.contains("hidden")&&pushModalHistory("receipt"),show("receipt-preview-modal"),setTimeout(()=>{h("receipt-preview-modal").classList.remove("opacity-0"),h("receipt-preview-modal-box").classList.remove("scale-95")},10)}catch(t){P(),u("Gagal memuat struk: "+t.message)}};window.markTempoPaid=async e=>{ve("Konfirmasi","Tandai tagihan tempo ini sebagai LUNAS?",async()=>{try{await k.collection("freshmart_orders").doc(e).update({"payment.paymentStatus":"lunas","payment.tempoBalance":0,status:"Selesai"}),u("Tagihan berhasil dilunasi!");let t=gOrds.findIndex(a=>a.orderId===e);t!==-1&&(gOrds[t].payment.paymentStatus="lunas",gOrds[t].payment.tempoBalance=0,gOrds[t].status="Selesai"),window.rAdmPiutang()}catch(t){u("Gagal mengubah status: "+t.message)}})};window.rAdmPiutang=async()=>{C("Memuat data piutang...");let e=[];try{(await k.collection("freshmart_orders").where("payment.method","==","tempo").where("payment.paymentStatus","==","hutang").get()).forEach(s=>{e.push(s.data())})}catch(r){P(),u("Gagal memuat piutang: "+r.message);return}P();let t=0,a=`
    ...
    `;e.length===0?a+=`<div class="bg-white dark:bg-slate-800 p-8 text-center rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm">
            ...
            <div class="bg-white dark:bg-slate-800 p-5 rounded-2xl border ${m?"border-rose-300 dark:border-rose-700 shadow-[0_0_15px_rgba(225,29,72,0.1)]":"border-slate-200 dark:border-slate-700 shadow-sm"} relative overflow-hidden group hover:-translate-y-1 transition-all">
                ...
                <div class="mb-3 space-y-1.5 bg-slate-50 dark:bg-slate-900/30 p-3 rounded-xl border border-slate-100 dark:border-slate-800">
                    <div class="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-2 flex justify-between">
                        ...
                        <span>Total: ${x(r.payment.installments.reduce((v,g)=>v+(parseFloat(g.amount)||0),0))}</span>
                    </div>
        ...
        </div>`}).join("");$("admin-content",'<div class="max-w-full pb-10 text-sm fade-in-scale">'+a+s+"</div>")},$s=async e=>{const t=(lt||[]).find(a=>a&&a.id!=null&&String(a.id)===String(e));t&&typeof window.customPrompt=="function"&&window.customPrompt("Tulis balasan untuk ulasan ini:",t.adminReply||"",async a=>{C("Menyimpan balasan...");try{await k.collection("freshmart").doc("cms_data").collection("reviews").doc(e.toString()).update({adminReply:a}),u("Balasan tersimpan!")}catch{u("Gagal menyimpan balasan!")}finally{P()}})},Ps=async e=>{const t=(lt||[]).find(r=>r&&r.id!=null&&String(r.id)===String(e));if(!t)return;const a=t.isVisible===!1;C("Menyimpan...");try{await k.collection("freshmart").doc("cms_data").collection("reviews").doc(e.toString()).update({isVisible:a}),u(a?"Ulasan ditampilkan lagi!":"Ulasan disembunyikan dari halaman produk!")}catch{u("Gagal mengubah status ulasan!")}finally{P()}},As=e=>{ve("Hapus Ulasan","Ulasan yang dihapus tidak bisa dikembalikan lagi.",async()=>{C("Menghapus...");try{await k.collection("freshmart").doc("cms_data").collection("reviews").doc(e.toString()).delete(),u("Ulasan dihapus!")}catch{u("Gagal menghapus ulasan!")}finally{P()}})};window.filterReviews=Ss;window.rAdmReviews=zt;window.replyToReview=$s;window.toggleReviewVisibility=Ps;window.deleteReview=As;window.rAdmL=e=>{Je(e),typeof window.setCTab=="function"&&window.setCTab(e),window.cTab=e,$("admin-content",`
        ...
        <div class="p-4 sm:p-5 md:p-6 lg:p-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4 rounded-[1.5rem] border shadow-sm cursor-pointer hover:shadow-md hover:-translate-y-1 hover:border-[var(--color-primary)]/40 dark:hover:border-[var(--color-primary)]/40 transition-all duration-300 ${m}" onclick="oAEd('${e}','${i.id}')">
            <div class="flex items-start sm:items-center gap-4 min-w-0 w-full">
                ...
                <div class="min-w-0 flex flex-col justify-center py-1">
                    ...
                    ${d&&v&&T?`<p class="text-[10px] font-bold mt-1 ${(i.variants&&i.variants.length?i.variants.reduce((D,M)=>D+(parseFloat(M.stock)||0),0):parseFloat(i.stock)||0)===0?"text-rose-500 animate-pulse":"text-blue-500"}"><i class="fa-solid fa-boxes-stacked mr-1"></i>Stok: ${i.variants&&i.variants.length?i.variants.reduce((D,M)=>D+(parseFloat(M.stock)||0),0).toFixed(2).replace(/\.?0+$/,""):parseFloat(i.stock)||0}</p>`:""}
    ...
    `},Ls=()=>{let e=document.getElementById("guarantee-modal");e||(e=document.createElement("div"),e.id="guarantee-modal",e.className="fixed inset-0 z-[115] bg-slate-900/80 flex items-end sm:items-center justify-center p-0 sm:p-5",e.onclick=t=>{t.target===e&&Qt()},document.body.appendChild(e)),e.innerHTML=`
        ...
        <div ${p} class="banner-slide-item w-[88vw] sm:w-[480px] min-h-[180px] sm:min-h-[220px] snap-center shrink-0 rounded-3xl relative overflow-hidden group cursor-pointer bg-[var(--color-primary)] text-white shadow-none hover:-translate-y-1 hover:scale-[1.01] hover:shadow-none transition-all duration-300 border border-white/15 flex flex-col">
            ...
            <div class="flex flex-1 w-full relative z-10">
                ...
                <div class="w-[40%] relative z-10 flex items-center justify-center p-2 sm:p-4 pr-4 sm:pr-6">
                    ${n.img?`<img loading="lazy" src="${c(fe(n.img,"w800-rw"))}" alt="${c(n.title||"Promo Banner")}" class="w-full h-full object-contain drop-shadow-md transition-transform duration-500 group-hover:scale-105" onerror="this.style.display='none'">`:`
...
>`,s+="</div>"}),s=`<div class="grid grid-cols-1 lg:grid-cols-2 gap-x-5 gap-y-5 items-start">${s}</div>`,$("admin-modal-form",s),e==="products"&&(window.rVarsB?.(),window.rWholB?.(),window.rSpecB?.());const d=h("admin-modal");d&&d.classList.contains("hidden")&&Fs("admin"),O("admin-modal"),setTimeout(()=>{h("admin-modal").classList.remove("opacity-0"),h("admin-modal-box").classList.remove("scale-95")},10)};window.submitAdminForm=async()=>{if(ke)return;B(!0);const e=yt||window.cTab||"products";let t={},a=ct[e]||[];for(let s of a)if(s.type==="variants_builder")t.variants=W.filter(l=>l.name.trim()!=="");else if(s.type==="wholesale_builder")t.wholesale=ue.filter(l=>parseFloat(l.minQty)>.01&&l.price>0);else if(s.type==="spec_table_builder")t.specTable=ee.filter(l=>l.key.trim()!=="");else{let l="";if(s.type==="richtext"){const n=h(`af-${s.key}-editor`);l=n?n.innerHTML:""}else l=y(`af-${s.key}`);if(typeof l=="string"){if(l.startsWith("data:image/")&&l.length>3e5)return B(!1),u("Gambar Base64 terlalu besar! Upload file.");s.key==="img"&&(l=I(l))}t[s.key]=s.type==="number"?parseFloat(l)||0:l}if(!t.name&&!t.title&&!t.bankName&&!t.code)return B(!1),u("Judul/Nama/Kode wajib diisi!");if(e==="products"&&!t.sku&&(t.sku="SKU"+Date.now().toString().slice(-6)),e==="customers"){const s=window.normalizeWA?window.normalizeWA(t.phone):(t.phone||"").replace(/\D/g,"").replace(/^0/,"62");if(!s||s.length<10)return B(!1),u("Nomor WhatsApp tidak valid!");t.phone=s,t.points=parseFloat(t.points)||0,t.id=parseInt(s,10)}let r=null;if(e==="customers")if(o.customers||(o.customers=[]),X){r=X;let s=o.customers.findIndex(l=>l&&l.id!=null&&String(l.id)===String(X));s>-1?o.customers[s]=t:o.customers.unshift(t)}else o.customers.unshift(t);else if(e==="rewards")if(o.rewards||(o.rewards=[]),X){let s=o.rewards.findIndex(l=>l&&l.id!=null&&String(l.id)===String(X));s>-1?(t.id=o.rewards[s].id,o.rewards[s]=t):t.id=X}else t.id=Date.now(),o.rewards.unshift(t);else if(X){o[e]||(o[e]=[]);let s=o[e].findIndex(l=>l&&l.id!=null&&String(l.id)===String(X));if(s>-1){if(t.id=o[e][s].id,e==="products"){const l=o[e][s];t.totalSold=l.totalSold||0,t.variants&&t.variants.length&&l.variants&&t.variants.forEach(n=>{const i=l.variants.find(d=>d.name===n.name);i&&i.totalSold&&(n.totalSold=i.totalSold)})}o[e][s]=t}else t.id=X,o[e].push(t)}else t.id=Date.now(),o[e]||(o[e]=[]),o[e].unshift(t);C("Menyimpan...");try{const s=typeof k<"u"&&k?k:window.db,l=typeof H=="function"?H:window.saveApp||(async()=>{});if(!s)throw new Error("Database Firebase belum terhubung");if(e==="products")await s.collection("freshmart").doc("cms_data").collection("products").doc(t.id.toString()).set(t),await l([],{updateType:"product_single",updatedProductIds:[t.id.toString()]});else if(e==="customers"){const n=s.collection("freshmart").doc("cms_data").collection("customers");r!==null&&r!==t.id&&await n.doc(r.toString()).delete().catch(()=>{}),await n.doc(t.phone).set(t,{merge:!0})}else e==="rewards"?await s.collection("freshmart").doc("cms_data").collection("rewards").doc(t.id.toString()).set(t):await l([e]);window.closeAdminModal?.(),window.rAdmItms?.(e),u("Tersimpan!")}catch(s){console.error("Gagal simpan admin data:",s),u("Gagal menyimpan: "+(s.message||""))}finally{B(!1),P()}};window.oADel=async(e,t)=>{window.showConfirm?.("Hapus Data","Data yang dihapus tidak bisa dikembalikan lagi.",async()=>{if(ke)return;B(!0);const a=typeof k<"u"&&k?k:window.db,r=typeof H=="function"?H:window.saveApp||(async()=>{}),s=o[e]&&o[e].find(l=>l&&l.id!=null&&String(l.id)===String(t));o[e]=(o[e]||[]).filter(l=>!l||l.id==null||String(l.id)!==String(t)),C("Menghapus...");try{if(!a)throw new Error("Database Firebase belum terhubung");if(e==="products")await a.collection("freshmart").doc("cms_data").collection("products").doc(t.toString()).delete(),await r([],{updateType:"product_delete",updatedProductIds:[t.toString()]});else if(e==="customers"){const l=s?s.phone:t.toString();await a.collection("freshmart").doc("cms_data").collection("customers").doc(l).delete()}else e==="rewards"?await a.collection("freshmart").doc("cms_data").collection("rewards").doc(t.toString()).delete():await r([e]);window.rAdmItms?.(e),u("Berhasil Dihapus!")}catch(l){u("Gagal menghapus: "+(l.message||""))}finally{B(!1),P()}})};window.duplicateProduct=async e=>{window.showConfirm?.("Duplikat Produk","Menyalin data produk ini ke item baru?",async()=>{if(ke)return;B(!0);const t=typeof k<"u"&&k?k:window.db,a=typeof H=="function"?H:window.saveApp||(async()=>{}),r=o.products.find(l=>l&&l.id!=null&&String(l.id)===String(e));if(!r){B(!1);return}let s=JSON.parse(JSON.stringify(r));s.id=Date.now()+Math.floor(Math.random()*1e3),s.name=s.name+" COPY",s.sku="",s.totalSold=0,s.variants&&s.variants.length>0&&(s.variants=s.variants.map(l=>(l.sku="",l.totalSold=0,l))),o.products.unshift(s),C("Menyalin...");try{if(!t)throw new Error("Database Firebase belum terhubung");await t.collection("freshmart").doc("cms_data").collection("products").doc(s.id.toString()).set(s),await a([],{updateType:"product_single",updatedProductIds:[s.id.toString()]}),window.rAdmItms?.("products"),u("Produk berhasil disalin!")}catch(l){u("Gagal menyalin: "+(l.message||""))}finally{B(!1),P()}},"Ya, Salin",!1)};window.rSpecB=()=>{const e=document.getElementById("spec-table-builder-container");if(!e)return;let t="";ee.length>0?t+=`<div class="overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm mb-4">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-4">
        ...
        </div>`)};window.confirmExportAllVariants=async()=>{const e=(document.getElementById("expall-catalog")?.value||"").trim(),t=W.filter(s=>s.name.trim());o.colors||(o.colors=[]);const a=new Set(o.colors.map(s=>s.name.toLowerCase()));let r=0;if(t.forEach(s=>{a.has(s.name.trim().toLowerCase())||(o.colors.push({id:Date.now()+r,name:s.name.trim(),hex:s.colorCode||"",catalog:e}),a.add(s.name.trim().toLowerCase()),r++)}),_closeColorFloatModal(),!r){u("Semua varian sudah ada di Database Warna!");return}C("Menyimpan...");try{await H(["colors"]),u(`${r} warna berhasil diekspor ke Database Warna! 🎨`)}catch{u("Gagal menyimpan!")}finally{P()}};window.openImportFromProductsModal=async()=>{const e=[];if((o.products||[]).forEach(l=>{(l.variants||[]).forEach(n=>{n.name&&n.name.trim()&&e.push({varName:n.name.trim(),hex:n.colorCode||"",prodName:l.name||""})})}),!e.length){u("Tidak ada varian produk yang ditemukan!");return}const t=new Set((o.colors||[]).map(l=>l.name.toLowerCase())),a=e.filter(l=>!t.has(l.varName.toLowerCase()));if(!a.length){u("Semua varian produk sudah ada di Database Warna!");return}let s=[...new Set((o.colors||[]).map(l=>l.catalog).filter(Boolean))].map(l=>`<option value="${c(l)}">${c(l)}</option>`).join("");window._pendingImportVariants=a,_openColorFloatModal(`
        <div class="p-6">
        ...
        </div>`).join(""):'<p class="text-[11px] font-bold text-slate-400 text-center py-2">Belum ada tingkat harga grosir.</p>')};window.qpAddWhol=()=>{Ne.push({minQty:0,price:0}),rQpWhol()};window.closeQuickPriceModal=(e=!1)=>{Gs("quickprice",e,()=>{const t=document.getElementById("quickprice-modal");!t||t.style.display==="none"||(t.style.opacity="0",t.style.transition="opacity 0.25s ease",setTimeout(()=>{t.style.display="none",t.style.opacity="",t.style.transition=""},250))})};window.processQuickPrice=async e=>{if(ke)return;B(!0);const t=o.products.findIndex(s=>s&&s.id!=null&&String(s.id)===String(e));if(t<0){B(!1);return}const a=o.products[t],r=a.variants&&a.variants.length>0;C("Menyimpan Harga...");try{const s=typeof k<"u"&&k?k:window.db,l=typeof H=="function"?H:window.saveApp||(async()=>{});if(!s)throw new Error("Database Firebase belum terhubung");const n=s.collection("freshmart").doc("cms_data").collection("products").doc(e.toString());let i=null;await s.runTransaction(async d=>{const p=await d.get(n);if(!p.exists)throw new Error("Produk tidak ditemukan di server");const m=JSON.parse(JSON.stringify(p.data()));r?a.variants.forEach((b,f)=>{const v=(m.variants||[]).findIndex(g=>g.name===b.name);v<0||(m.variants[v].hpp=parseFloat(document.getElementById("qp-var-hpp-"+f)?.value)||0,m.variants[v].price=parseFloat(document.getElementById("qp-var-price-"+f)?.value)||0,m.variants[v].priceNormal=parseFloat(document.getElementById("qp-var-normal-"+f)?.value)||0,m.variants[v].poin=parseFloat(document.getElementById("qp-var-poin-"+f)?.value)||0)}):(m.hpp=parseFloat(document.getElementById("qp-hpp")?.value)||0,m.price=parseFloat(document.getElementById("qp-price")?.value)||0,m.priceNormal=parseFloat(document.getElementById("qp-normal")?.value)||0,m.poin=parseFloat(document.getElementById("qp-poin")?.value)||0,m.wholesale=Ne.filter(b=>parseFloat(b.minQty)>.01&&b.price>0)),d.set(n,m),i=m}),o.products[t]=i,await l([],{updateType:"stock_change",updatedProductIds:[e.toString()]}),closeQuickPriceModal(),window.rAdmItms?.("products"),u("✅ Harga berhasil diperbarui!")}catch(s){u("Gagal simpan harga: "+(s.message||""))}finally{B(!1),P()}};window.rWholB=()=>{let e=`<div class="space-y-4 mb-4">${ue.map((a,r)=>`
...
`).map(i=>i.replace(/^[-*•]\s*/,"").trim()).filter(i=>i.length>0);if(l.length===0)return u("Rincian perubahan tidak boleh kosong!");C("Menyimpan catatan pembaruan...");const n={id:ye||"log-"+Date.now().toString(36),version:e.startsWith("v")?e:"v"+e,category:t,date:a,title:r,items:l,updatedAt:new Date().toISOString()};if(o.changelog=o.changelog||[],ye){const i=o.changelog.findIndex(d=>d.id===ye);i!==-1?o.changelog[i]=n:o.changelog.unshift(n)}else o.changelog.unshift(n);try{await H(["changelog"]),u("Catatan pembaruan berhasil dipublikasikan secara real-time!","success"),$e=!1,ye=null,Fe()}catch(i){u("Gagal menyimpan log pembaruan: "+i.message,"error")}finally{P()}},ar=e=>{const t=(o.changelog||[]).find(a=>a.id===e);t&&ve(`Hapus catatan pembaruan versi "${t.version}"?`,async()=>{C("Menghapus catatan..."),o.changelog=(o.changelog||[]).filter(a=>a.id!==e);try{await H(["changelog"]),u("Catatan berhasil dihapus!","success"),Fe()}catch(a){u("Gagal menghapus catatan: "+a.message,"error")}finally{P()}},"Ya, Hapus","Konfirmasi Hapus")};window.rAdmChangelog=Fe;window.toggleChangelogForm=Zs;window.editChangelogEntry=er;window.saveChangelogEntry=tr;window.deleteChangelogEntry=ar;export{Sa as A,Se as a,Pe as b,Ae as c,k as d,Es as e,_s as f,Rs as g,$a as h,lr as i,Ns as j,q as k,ir as l,Ot as m,Kt as n,qe as o,Ge as p,Nt as q,Ee as r,ts as s,nr as t,Y as u,dr as v,Jt as w};
