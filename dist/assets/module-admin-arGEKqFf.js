...
import{a as o,c as I,s as tt,b as N,d as K,f as x,e as k,g as O,h as F,i as $,j as c,w as ee,k as b,l as ve,t as ne,m as Et,n as oa,o as xe,p as le,q as ae,r as de,u as je,v as Q,x as Ie,y as Ct,z as _t,A as nt,B as Rt,C as Nt,D as ia,E as la,F as se,G as S,H as C,I as P,J as be,K as Ee,L as me,M as Me,N as ue,O as Be,P as na,Q as da,R as Y,S as Ot,T as ca,U as pa,V as Ge,W as ge,X as ma,Y as jt,Z as j,_ as dt,$ as ua,a0 as ba,a1 as ga,a2 as fa,a3 as ct,a4 as ce,a5 as J,a6 as xa,a7 as ha,a8 as ka}from"./module-print-CQkot418.js";import{f as G}from"./vendor-firebase-core-D2OF5R23.js";import"./vendor-firebase-db-BIUZcnOd.js";const va="modulepreload",wa=function(e){return"/"+e},It={},ya=function(t,a,r){let s=Promise.resolve();if(a&&a.length>0){document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),i=n?.nonce||n?.getAttribute("nonce");s=Promise.allSettled(a.map(d=>{if(d=wa(d),d in It)return;It[d]=!0;const p=d.endsWith(".css"),m=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${m}`))return;const u=document.createElement("link");if(u.rel=p?"stylesheet":va,p||(u.as="script"),u.crossOrigin="",u.href=d,i&&u.setAttribute("nonce",i),document.head.appendChild(u),p)return new Promise((f,h)=>{u.addEventListener("load",f),u.addEventListener("error",()=>h(new Error(`Unable to preload CSS for ${d}`)))})}))}function l(n){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=n,window.dispatchEvent(i),!i.defaultPrevented)throw n}return s.then(n=>{for(const i of n||[])i.status==="rejected"&&l(i.reason);return t().catch(l)})},Sa={apiKey:"AIzaSyCOjrhMP52TGbiOyQLY92NDYE26N6d9hJM",authDomain:"restu-karya-utama.firebaseapp.com",databaseURL:"https://restu-karya-utama-default-rtdb.asia-southeast1.firebasedatabase.app",projectId:"restu-karya-utama",storageBucket:"restu-karya-utama.firebasestorage.app",messagingSenderId:"858310421352",appId:"1:858310421352:web:e20a833875e8d5c19944dd",measurementId:"G-PHDG2LJ8PM"};try{localStorage.removeItem("freshmart_fb_config")}catch{}const Ft=window.FIREBASE_CONFIG||Sa;G.apps.length||G.initializeApp(Ft);const w=G.firestore(),q=G.auth();typeof window<"u"&&(window.firebase=G,window.db=w,window.auth=q);try{w.settings({ignoreUndefinedProperties:!0,experimentalAutoDetectLongPolling:!0,merge:!0})}catch{}let $a=null;const dr=()=>{ya(()=>import("./vendor-firebase-analytics-Jm19L5g2.js"),__vite__mapDeps([0,1])).then(()=>{try{$a=G.analytics()}catch{}}).catch(()=>{})},Pa="K2ijSERTT2dg27yYGTEgn6XHSnW2",$e={emerald:{50:"#ecfdf5",100:"#d1fae5",200:"#a7f3d0",300:"#6ee7b7",400:"#34d399",500:"#10b981",600:"#059669",700:"#047857",800:"#065f46",900:"#064e3b"},teal:{50:"#f0fdfa",100:"#ccfbf1",200:"#99f6e4",300:"#5eead4",400:"#2dd4bf",500:"#14b8a6",600:"#0d9488",700:"#0f766e",800:"#115e59",900:"#134e4a"},cyan:{50:"#ecfeff",100:"#cffafe",200:"#a5f3fc",300:"#67e8f9",400:"#22d3ee",500:"#06b6d4",600:"#0891b2",700:"#0e7490",800:"#155e75",900:"#164e63"},sky:{50:"#f0f9ff",100:"#e0f2fe",200:"#bae6fd",300:"#7dd3fc",400:"#38bdf8",500:"#0ea5e9",600:"#0284c7",700:"#0369a1",800:"#075985",900:"#0c4a6e"},blue:{50:"#eff6ff",100:"#dbeafe",200:"#bfdbfe",300:"#93c5fd",400:"#60a5fa",500:"#3b82f6",600:"#2563eb",700:"#1d4ed8",800:"#1e40af",900:"#1e3a8a"},indigo:{50:"#eef2ff",100:"#e0e7ff",200:"#c7d2fe",300:"#a5b4fc",400:"#818cf8",500:"#6366f1",600:"#4f46e5",700:"#4338ca",800:"#3730a3",900:"#312e81"},violet:{50:"#f5f3ff",100:"#ede9fe",200:"#ddd6fe",300:"#c4b5fd",400:"#a78bfa",500:"#8b5cf6",600:"#7c3aed",700:"#6d28d9",800:"#5b21b6",900:"#4c1d95"},purple:{50:"#faf5ff",100:"#f3e8ff",200:"#e9d5ff",300:"#d8b4fe",400:"#c084fc",500:"#a855f7",600:"#9333ea",700:"#7e22ce",800:"#6b21a8",900:"#581c87"},fuchsia:{50:"#fdf4ff",100:"#fae8ff",200:"#f5d0fe",300:"#f0abfc",400:"#e879f9",500:"#d946ef",600:"#c026d3",700:"#a21caf",800:"#86198f",900:"#701a75"},pink:{50:"#fdf2f8",100:"#fce7f3",200:"#fbcfe8",300:"#f9a8d4",400:"#f472b6",500:"#ec4899",600:"#db2777",700:"#be185d",800:"#9d174d",900:"#831843"},rose:{50:"#fff1f2",100:"#ffe4e6",200:"#fecdd3",300:"#fda4af",400:"#fb7185",500:"#f43f5e",600:"#e11d48",700:"#be123c",800:"#9f1239",900:"#881337"},red:{50:"#fef2f2",100:"#fee2e2",200:"#fecaca",300:"#fca5a5",400:"#f87171",500:"#dc2626",600:"#b91c1c",700:"#991b1b",800:"#7f1d1d",900:"#450a0a"},orange:{50:"#fff7ed",100:"#ffedd5",200:"#fed7aa",300:"#fdba74",400:"#fb923c",500:"#ea580c",600:"#c2410c",700:"#9a3412",800:"#7c2d12",900:"#431407"},amber:{50:"#fffbeb",100:"#fef3c7",200:"#fde68a",300:"#fcd34d",400:"#fbbf24",500:"#d97706",600:"#b45309",700:"#92400e",800:"#78350f",900:"#451a03"},yellow:{50:"#fefce8",100:"#fef9c3",200:"#fef08a",300:"#fde047",400:"#eab308",500:"#d97706",600:"#b45309",700:"#854d0e",800:"#713f12",900:"#3f1d0b"},lime:{50:"#f7fee7",100:"#ecfccb",200:"#d9f99d",300:"#bef264",400:"#a3e635",500:"#65a30d",600:"#4d7c0f",700:"#3f6212",800:"#365314",900:"#1a2e05"},green:{50:"#f0fdf4",100:"#dcfce7",200:"#bbf7d0",300:"#86efac",400:"#4ade80",500:"#16a34a",600:"#15803d",700:"#166534",800:"#14532d",900:"#052e16"},slate:{50:"#f8fafc",100:"#f1f5f9",200:"#e2e8f0",300:"#cbd5e1",400:"#94a3b8",500:"#475569",600:"#334155",700:"#1e293b",800:"#0f172a",900:"#020617"},stone:{50:"#fafaf9",100:"#f5f5f4",200:"#e7e5e4",300:"#d6d3d1",400:"#a8a29e",500:"#57534e",600:"#44403c",700:"#292524",800:"#1c1917",900:"#0c0a09"}},Aa=e=>{let t=parseInt(e.replace("#",""),16);return(t>>16&255)+","+(t>>8&255)+","+(t&255)},Mt=(e,t)=>{let a=parseInt(e.slice(1,3),16),r=parseInt(e.slice(3,5),16),s=parseInt(e.slice(5,7),16);return a=Math.max(0,Math.min(255,a+t)),r=Math.max(0,Math.min(255,r+t)),s=Math.max(0,Math.min(255,s+t)),"#"+[a,r,s].map(l=>l.toString(16).padStart(2,"0")).join("")},Ta=e=>{if(!e)return;try{document.querySelectorAll('meta[name="theme-color"]').forEach(d=>d.remove())}catch{}const t=document.createElement("meta");t.setAttribute("name","theme-color"),t.setAttribute("content",e),document.head.appendChild(t);try{document.querySelectorAll('meta[name="msapplication-navbutton-color"], meta[name="msapplication-TileColor"]').forEach(d=>d.remove())}catch{}const a=document.createElement("meta");a.setAttribute("name","msapplication-navbutton-color"),a.setAttribute("content",e),document.head.appendChild(a);const r=document.createElement("meta");r.setAttribute("name","msapplication-TileColor"),r.setAttribute("content",e),document.head.appendChild(r);let s=document.querySelector('meta[name="apple-mobile-web-app-capable"]');s||(s=document.createElement("meta"),s.setAttribute("name","apple-mobile-web-app-capable"),document.head.appendChild(s)),s.setAttribute("content","yes");let l=document.querySelector('meta[name="mobile-web-app-capable"]');l||(l=document.createElement("meta"),l.setAttribute("name","mobile-web-app-capable"),document.head.appendChild(l)),l.setAttribute("content","yes");let n=document.querySelector('meta[name="apple-mobile-web-app-status-bar-style"]');n||(n=document.createElement("meta"),n.setAttribute("name","apple-mobile-web-app-status-bar-style"),document.head.appendChild(n)),n.setAttribute("content","default"),typeof window.updatePwaManifest=="function"&&window.updatePwaManifest(e)},Ae=(e,t)=>{const a=e||localStorage.getItem("freshmart_ui_theme")||"emerald",r=$e[a]||$e.emerald;e&&localStorage.setItem("freshmart_ui_theme",a);const s=t||localStorage.getItem("freshmart_theme_color")||r[500];t&&localStorage.setItem("freshmart_theme_color",s);const l=Aa(s),n=Mt(s,-30),i=Mt(s,150);return document.documentElement.style.setProperty("--color-primary",s),document.documentElement.style.setProperty("--color-primary-dark",n),document.documentElement.style.setProperty("--color-primary-light",i),document.documentElement.style.setProperty("--color-primary-rgb",l),Ta(s),r},cr=()=>{const e=localStorage.getItem("freshmart_theme"),t=window.matchMedia("(prefers-color-scheme: dark)").matches;(e==="dark"||!e&&t)&&document.documentElement.classList.add("dark")},pr=()=>{const e=document.documentElement.classList.toggle("dark");localStorage.setItem("freshmart_theme",e?"dark":"light");const t=document.getElementById("icon-theme")||document.getElementById("theme-toggle-icon");t&&(t.className=e?"fa-solid fa-sun text-sm text-amber-400":"fa-solid fa-moon text-sm text-slate-600 dark:text-slate-300")},mr=()=>{const e=document.documentElement.classList.contains("dark"),t=document.getElementById("icon-theme")||document.getElementById("theme-toggle-icon");t&&(t.className=e?"fa-solid fa-sun text-sm text-amber-400":"fa-solid fa-moon text-sm text-slate-600 dark:text-slate-300")},Te=(e="minimalist",t="")=>{const a=e||localStorage.getItem("freshmart_bg_style")||"minimalist",r=t??(localStorage.getItem("freshmart_bg_custom_url")||"");e&&localStorage.setItem("freshmart_bg_style",a),t!=null&&localStorage.setItem("freshmart_bg_custom_url",r);const l=(p=>{if(!p||typeof p!="string")return"";const m=p.match(/drive\.google\.com.*(?:id=|\/d\/)([a-zA-Z0-9_-]+)/);return m?`https://lh3.googleusercontent.com/d/${m[1]}`:p.trim()})(r);document.documentElement.setAttribute("data-bg-style",a),document.body?.setAttribute("data-bg-style",a);const n=document.getElementById("app-container");n&&(n.setAttribute("data-bg-style",a),l?n.setAttribute("data-has-custom-bg","true"):n.removeAttribute("data-has-custom-bg"));const i=document.getElementById("dynamic-bg-container");if(!i)return;if(i.innerHTML="",i.className="pointer-events-none fixed inset-0 z-0 overflow-hidden",l){const p=document.createElement("div");p.className="absolute inset-0 z-0 bg-cover bg-center bg-no-repeat bg-fixed opacity-35 dark:opacity-25 pointer-events-none transition-all duration-500",p.style.backgroundImage=`url('${l}')`,i.appendChild(p);const m=document.createElement("div");m.className="absolute inset-0 z-0 bg-slate-50/70 dark:bg-[#0b1120]/80 pointer-events-none",i.appendChild(m)}let d="";if(a==="hero_arch"?d=`
        ...
        <div class="bg-white dark:bg-slate-800 p-4 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm flex gap-4 relative overflow-hidden group min-w-0 hover:shadow-md hover:-translate-y-1 hover:border-[var(--color-primary)]/40 dark:hover:border-[var(--color-primary)]/40 transition-all duration-300">
        ...
        </div>`}).join("")),K("cart-subtotal",x(r));const s=o.store.freeShippingMinSpendEnabled===!0||o.store.freeShippingMinSpendEnabled==="true",l=parseFloat(o.store.freeShippingMinSpendAmount)||0;if(e)if(s&&l>0){e.classList.remove("hidden");const n=Math.min(100,Math.round(r/l*100)),i=Math.max(0,l-r),d=r>=l;e.innerHTML=`
            ...
            <div class="p-4 rounded-2xl border transition-all duration-300 ${i>0?"bg-gradient-to-r from-amber-500/10 via-amber-400/5 to-amber-500/10 border-amber-200 dark:border-amber-700/60 dark:bg-amber-950/20":"bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 shadow-sm"}">
                ...
                `:""}
            </div>`}else t.classList.add("hidden"),t.innerHTML=""}},Ca=(e,t)=>{let a=parseFloat(t);if(isNaN(a)||a<=0)I.splice(e,1);else{if(o.store.useStock===!0||o.store.useStock==="true"){const s=I[e],l=o.products.find(n=>n&&n.id!=null&&String(n.id)===String(s.id));if(l){const n=s.variantName?parseFloat(((l.variants||[]).find(i=>i.name===s.variantName)||{}).stock)||0:parseFloat(l.stock)||0;a>n&&(a=n,typeof window.showToast=="function"&&window.showToast(`Maks stok: ${n}`))}}I[e].qty=parseFloat(a.toFixed(2))}he(),X()},ja=(e,t)=>{let a=parseFloat((parseFloat(I[e].qty)+t).toFixed(2));if(a<=0)I.splice(e,1);else{if((o.store.useStock===!0||o.store.useStock==="true")&&t>0){const s=I[e],l=o.products.find(n=>n&&n.id!=null&&String(n.id)===String(s.id));if(l){const n=s.variantName?parseFloat(((l.variants||[]).find(i=>i.name===s.variantName)||{}).stock)||0:parseFloat(l.stock)||0;a>n&&(a=n,typeof window.showToast=="function"&&window.showToast(`Maks stok: ${n}`))}}I[e].qty=a}he(),X()},Ia=e=>{I.splice(e,1),he(),X()},Ma=()=>{typeof window.showConfirm=="function"?window.showConfirm("Kosongkan Keranjang","Semua barang akan dihapus. Lanjutkan?",()=>{tt([]),X(),he(),typeof window.showToast=="function"&&window.showToast("Dibersihkan")}):(tt([]),X(),he())},Ba=()=>{if(window.isAdm){typeof window.showConfirm=="function"&&window.showConfirm("Akses Ditolak","Anda sedang login sebagai Seller. Silakan logout terlebih dahulu untuk membuat pesanan sebagai pelanggan.",()=>{typeof window.logoutAdmin=="function"&&window.logoutAdmin()},"Logout Sekarang",!1);return}I.length&&typeof window.changeView=="function"&&window.changeView("view-checkout")};window.sanitizeCart=_e;window.updCart=X;window.renderCart=he;window.setCQty=Ca;window.updCQty=ja;window.rmCart=Ia;window.clearCart=Ma;window.validateCartToCheckout=Ba;const Re=()=>{const e=k("wishlist-badge");e&&(e.innerText=ee.length,e.classList.toggle("scale-0",!ee.length))},La=e=>{ee.splice(e,1),N("freshmart_wishlist",JSON.stringify(ee)),Re(),pt()},Da=e=>{const t=ee[e],a=o.products?.find(n=>n.id===t.id);if(!a||a.isActive==="false"||a.isActive===!1)return b(`${t.name} sudah tidak tersedia.`);const r=t.variantName?(a.variants||[]).find(n=>n.name===t.variantName):null;if(o.store?.useStock===!0||o.store?.useStock==="true"){if(t.variantName&&(!r||r.isActive===!1||r.isActive==="false"))return b(`Varian ${t.variantName} sudah tidak tersedia.`);const n=r?parseFloat(r.stock)||0:parseFloat(a.stock)||0,i=I.find(p=>p.id===t.id&&p.variantName===t.variantName),d=i&&parseFloat(i.qty)||0;if(n<=0||d>=n)return b(`Stok ${t.name} tidak mencukupi!`)}const l=I.find(n=>n.id===t.id&&n.variantName===t.variantName);if(l)l.qty=parseFloat((l.qty+1).toFixed(2));else{const n=r&&parseFloat(r.poin)>0?parseFloat(r.poin):parseFloat(a.poin)||0;I.push({id:a.id,name:a.name,variantName:t.variantName||"",price:r?r.price:a.price,img:r?.img||a.img,qty:1,unit:a.unit||"pcs",poTime:a.poTime||"",colorCode:r?.colorCode||"",poin:n})}X(),b("Ke Keranjang!"),typeof window.curViewName<"u"&&window.curViewName==="view-cart"&&he()},Ea=()=>{ve("Hapus Favorit","Yakin ingin menghapus semua?",()=>{ee.length=0,N("freshmart_wishlist",JSON.stringify(ee)),Re(),pt(),b("Dibersihkan")})},pt=()=>{if(!ee.length){O("wishlist-empty-state"),F("btn-clear-wishlist"),O("spacer-wishlist"),$("wishlist-items-container","");return}F("wishlist-empty-state"),O("btn-clear-wishlist"),F("spacer-wishlist"),$("wishlist-items-container",ee.map((e,t)=>{let a=e.colorCode?`<span class="w-3.5 h-3.5 rounded-full shadow-inner border border-slate-300 dark:border-slate-600 shrink-0" style="background-color: ${c(e.colorCode)};"></span>`:"";return`
        <div class="bg-white dark:bg-slate-800 p-4 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm flex gap-4 relative overflow-hidden group min-w-0 hover:shadow-md hover:-translate-y-1 hover:border-rose-300 dark:hover:border-rose-600 transition-all duration-300">
        ...
        </div>`}).join(""))};window.updWish=Re;window.rmWish=La;window.moveWish=Da;window.clearWishlist=Ea;window.renderWish=pt;let Bt=null;const W=()=>{const e=ae!=="Semua Produk"||de!=="Semua Merek"||je!==""||Q!=="Semua Jenis";ne("dynamic-banners-container","hidden",e),ne("reward-catalog-container","hidden",e),ne("dynamic-vouchers-container","hidden",e),ne("dynamic-categories-container","hidden",e),ne("dynamic-brands-container","hidden",e);const t=o.store.showCategories!==!1&&o.store.showCategories!=="false",a=o.store.showBrands!==!1&&o.store.showBrands!=="false";ne("sec-categories","hidden",e||!t),ne("sec-brands","hidden",e||!a);let r=k("dynamic-active-filter");if(!r){let i=k("product-container");i&&(i.insertAdjacentHTML("beforebegin",'<div id="dynamic-active-filter" class="transition-all w-full"></div>'),r=k("dynamic-active-filter"))}if(r)if(e){let i="Menampilkan",d="",p="fa-filter",m="text-[var(--color-primary)] bg-[var(--color-primary-light)] dark:bg-[var(--color-primary-dark)]/30";je!==""?(i="Hasil Pencarian",d=`"${je}"`,p="fa-magnifying-glass",m="text-rose-500 bg-rose-50 dark:bg-rose-900/30"):ae!=="Semua Produk"?(i="Kategori Pilihan",d=ae+(Q!=="Semua Jenis"?` • ${Q}`:""),p="fa-layer-group",m="text-[var(--color-primary)] bg-[var(--color-primary-light)] dark:bg-[var(--color-primary-dark)]/30"):de!=="Semua Merek"?(i="Merek Pilihan",d=de,p="fa-tag",m="text-[var(--color-primary)] bg-[var(--color-primary-light)] dark:bg-[var(--color-primary-dark)]/30"):Q!=="Semua Jenis"&&(i="Sub-Kategori",d=Q,p="fa-shapes",m="text-[var(--color-primary)] bg-[var(--color-primary-light)] dark:bg-[var(--color-primary-dark)]/30");let u="";if(ae!=="Semua Produk"){const f=o.products.filter(v=>v.isActive!==!1&&v.isActive!=="false"&&v.category===ae),h={};f.forEach(v=>{const A=(v.subCategory||"").trim();A&&(h[A]=(h[A]||0)+1)});const g=Object.keys(h).sort().map(v=>({name:v,count:h[v]}));g.length>0&&(u=`
        ...
        </div>`,D=`<span class="text-[9px] text-slate-600 dark:text-slate-400 font-bold ml-0.5 mb-0.5 uppercase tracking-wide">/${c(i.unit||"PCS")}</span>`;return Ct==="grid"?`
            <a href="?p=${i.id}" class="w-full bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700/50 rounded-[1.5rem] shadow-soft ${f} transition-all duration-300 flex flex-col group relative overflow-hidden text-left" onclick="event.preventDefault(); openProductModal(${i.id})">
                ...
                <div class="relative aspect-square w-full bg-white flex items-center justify-center shrink-0 border-b border-slate-100 dark:border-slate-700/50">
                      ${m}
                      <img loading="lazy" decoding="async" src="${c(xe(i.img,"w300-rw"))}" onerror="this.onerror=null;this.src='https://placehold.co/400?text=No+Image'" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105 ${d?"grayscale opacity-50":""}">
                </div>
            ...
            <a href="?p=${i.id}" class="w-full bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700/50 rounded-[1.5rem] shadow-soft ${h} transition-all duration-300 flex items-stretch p-2.5 sm:p-3 gap-3 sm:gap-4 group relative overflow-hidden text-left" onclick="event.preventDefault(); openProductModal(${i.id})">
                ${d}
                <div class="relative w-24 h-24 sm:w-28 sm:h-28 shrink-0 bg-white dark:bg-slate-900 rounded-xl flex items-center justify-center p-2 border border-slate-100 dark:border-slate-700/50 overflow-hidden">
                    ${m}
                    <img loading="lazy" decoding="async" src="${c(xe(i.img,"w300-rw"))}" onerror="this.onerror=null;this.src='https://placehold.co/400?text=No+Image'" class="max-w-full max-h-full object-contain transition-transform duration-500 group-hover:scale-105 ${d?"grayscale opacity-50":""}">
                </div>
    ...
    `,t.style.display="flex",t.style.opacity="1";const a=document.getElementById("btn-session-kicked-ok");a&&(a.onclick=()=>{t.style.opacity="0",setTimeout(()=>{t.style.display="none"},250)})},qe=()=>{if(Le)return;const e=typeof w<"u"&&w?w:window.db;!e||!localStorage.getItem("freshmart_admin_session_id")||(He=!1,Le=e.collection("freshmart").doc("cms_data").collection("admin_session").doc("active").onSnapshot(async a=>{if(!a.exists)return;const r=a.data(),s=r.sessionId,l=localStorage.getItem("freshmart_admin_session_id");if(s&&l&&s!==l){if(He)return;He=!0,We(),localStorage.removeItem("freshmart_admin_session_id");const n=r.deviceName||"Perangkat Lain";try{window.isAdm=!1,window.__localIsAdm=!1,window.isPro=!1,q&&typeof q.signOut=="function"&&await q.signOut()}catch{}typeof window.changeView=="function"&&window.changeView("view-catalog"),Ga(n)}},a=>{console.warn("Admin session guard listener error:",a)}))},We=()=>{Le&&(Le(),Le=null)},Ut=async()=>{if(Kt())return!0;const e=typeof w<"u"&&w?w:window.db;if(!e)return!0;const t=localStorage.getItem("freshmart_admin_session_id");if(!t)try{return!(await e.collection("freshmart").doc("cms_data").collection("admin_session").doc("active").get()).exists}catch{return!0}try{const a=await e.collection("freshmart").doc("cms_data").collection("admin_session").doc("active").get();return a.exists?a.data().sessionId===t:!0}catch{return!0}};typeof window<"u"&&(window.claimAdminSession=Ht,window.attachAdminSessionGuard=qe,window.detachAdminSessionGuard=We,window.isCurrentSessionActive=Ut,window.setLoggingIn=st,window.isLoggingIn=Kt);const qa=async()=>{if(window.isAdm||window.location.hostname==="localhost"){if(!await Ut()&&q.currentUser){We(),localStorage.removeItem("freshmart_admin_session_id"),await q.signOut(),window.isAdm=!1,window.__localIsAdm=!1,b("Sesi Admin telah diambil alih oleh perangkat lain."),se("login-username",""),se("login-password",""),typeof window.changeView=="function"&&window.changeView("view-admin-login");return}if(window.__localIsAdm=!0,typeof window.changeView=="function"&&window.changeView("view-admin"),qe(),q.currentUser)Ue();else{const t=q.onAuthStateChanged(()=>{t(),Ue()})}}else se("login-username",""),se("login-password",""),typeof window.changeView=="function"&&window.changeView("view-admin-login")},Ue=()=>{qe();const e=document.querySelector("#view-admin .scroll-content");e&&(e.scrollTop=0),O("admin-dashboard-view"),F("admin-content-view"),F("btn-admin-back"),O("admin-logo-box"),K("admin-header-title","CMS SELLER"),be&&(be(),Ee(null)),me&&(me(),Me(null)),ue&&(ue(),Be(null)),Vt(na),ut()},ut=()=>{const e=k("admin-menu-tax-btn");if(!e)return;o.store.ppnEnabled===!0||o.store.ppnEnabled==="true"?(e.classList.remove("hidden"),e.classList.add("flex")):(e.classList.add("hidden"),e.classList.remove("flex"))},ze=()=>{const e=o.store.useStock===!0||o.store.useStock==="true";let t=0,a=0,r=0,s=0,l=0,n=0;return(o.products||[]).forEach(i=>{if(i.variants&&i.variants.length)i.variants.forEach(d=>{const p=d.isActive!==!1&&d.isActive!=="false",m=parseFloat(d.stock)||0;p&&(!e||m>0)?r++:s++,l+=(parseFloat(d.hpp)||0)*m,n+=(parseFloat(d.price)||0)*m});else{const d=i.isActive!==!1&&i.isActive!=="false",p=parseFloat(i.stock)||0;d&&(!e||p>0)?t++:a++,l+=(parseFloat(i.hpp)||0)*p,n+=(parseFloat(i.price)||0)*p}}),{activeProd:t,inactiveProd:a,activeVar:r,inactiveVar:s,assetHpp:l,assetJual:n}},Lt=new Map,Wa=2*60*1e3,Vt=async(e="month")=>{if(da(e),document.querySelectorAll(".report-period-btn").forEach(u=>{const f=u.dataset.period===e;u.style.background=f?"var(--color-primary)":"transparent",u.style.color=f?"var(--color-primary-contrast, #fff)":"",u.style.boxShadow=f?"0 2px 8px rgba(var(--color-primary-rgb),0.35)":"none"}),!k("admin-report-container"))return;const a=({totalPenjualan:u,totalHppTerjual:f,totalDiskonProduk:h,orderCount:g,truncated:v})=>{const A=u-f,T=A-h,y={today:"Hari Ini",week:"Minggu Ini",month:"Bulan Ini",all:"Sepanjang Waktu"}[e]||"";$("admin-report-container",`
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                <div class="card-modern p-5 sm:p-5">
                    ...
                    <p class="text-lg sm:text-xl font-bold text-slate-800 dark:text-white truncate">${x(u)}</p>
        ...
        `)},r=Lt.get(e);if(r&&Date.now()-r.timestamp<Wa){a(r.data);return}$("admin-report-container",'<div class="text-center py-10"><i class="fa-solid fa-spinner fa-spin text-2xl text-slate-300"></i></div>');let s=null;const l=new Date;if(e==="today")s=new Date(l.getFullYear(),l.getMonth(),l.getDate());else if(e==="week"){const u=l.getDay(),f=u===0?6:u-1;s=new Date(l.getFullYear(),l.getMonth(),l.getDate()-f)}else e==="month"&&(s=new Date(l.getFullYear(),l.getMonth(),1));let n=0,i=0,d=0,p=0,m=!1;try{if(!q.currentUser){$("admin-report-container",'<div class="text-center py-10 text-slate-400"><i class="fa-solid fa-lock text-2xl mb-3"></i><p class="text-xs font-bold">Login terlebih dahulu untuk melihat laporan.</p></div>');return}let u=w.collection("freshmart_orders");s&&(u=u.where("timestamp",">=",G.firestore.Timestamp.fromDate(s)));const f=await u.limit(3e3).get();m=f.size>=3e3,f.forEach(g=>{const v=g.data();v.status!=="Dibatalkan"&&(p++,n+=parseFloat(v.payment?.subtotal)||0,d+=parseFloat(v.payment?.productDiscount)||0,(v.items||[]).forEach(A=>{const T=A.hpp!==void 0&&A.hpp!==null?parseFloat(A.hpp):typeof window.getEffHpp=="function"?window.getEffHpp(A):0;i+=(parseFloat(T)||0)*(parseFloat(A.qty)||0)}))});const h={totalPenjualan:n,totalHppTerjual:i,totalDiskonProduk:d,orderCount:p,truncated:m};Lt.set(e,{data:h,timestamp:Date.now()}),a(h)}catch(u){console.error("Gagal memuat laporan penjualan:",u)}},za=async()=>{const e=S("login-username"),t=S("login-password");if(!e||!t)return b("Email & Password wajib diisi!");st(!0),C("Verifikasi Login...");try{const a="sess_"+Date.now()+"_"+Math.random().toString(36).substring(2,9);localStorage.setItem("freshmart_admin_session_id",a);const s=(await q.signInWithEmailAndPassword(e,t)).user||q.currentUser;if(!s||s.uid!==Pa){const l=s?s.uid:"null";throw await q.signOut(),localStorage.removeItem("freshmart_admin_session_id"),new Error("UID_MISMATCH: "+l)}await Ht(a),qe(),window.isAdm=!0,history.replaceState({view:"view-admin"},"",window.location.href),typeof window.changeView=="function"&&window.changeView("view-admin",!0),Ue(),b("Login Berhasil!")}catch(a){if(console.error(a),localStorage.removeItem("freshmart_admin_session_id"),a.message&&a.message.startsWith("UID_MISMATCH:")){const r=a.message.replace("UID_MISMATCH: ","");b("Login Ditolak: UID Anda ("+r+") tidak cocok dengan ADMIN_UID!")}else b("Login Ditolak: Email atau Password salah!")}finally{st(!1),P()}},Gt=async()=>{C("Keluar...");try{We(),localStorage.removeItem("freshmart_admin_session_id"),await q.signOut(),window.isAdm=!1,window.__localIsAdm=!1,window.isPro=!1,typeof window.updateProBadge=="function"&&window.updateProBadge(),be&&(be(),Ee(null)),me&&(me(),Me(null)),ue&&(ue(),Be(null)),b("Berhasil Logout"),typeof window.changeView=="function"&&window.changeView("view-catalog")}catch{b("Gagal Logout")}finally{P()}},Ja=()=>{ve("Keluar Seller","Apakah anda akan keluar dari dashboard seller?",()=>{Gt()},"Ya, Keluar")};window.checkAdminAccess=qa;window.openAdminMenu=Ue;window.toggleTaxMenuVisibility=ut;window.computeInventoryStats=ze;window.loadAdminReport=Vt;window.processAdminLogin=za;window.logoutAdmin=Gt;window.confirmLogoutAdmin=Ja;const Qa=async()=>{if(!Y||Y.length===0)return b("Belum ada data pesanan!");C("Menyiapkan modul Excel...");try{await Ot("https://cdn.sheetjs.com/xlsx-0.20.3/package/dist/xlsx.full.min.js",()=>typeof XLSX<"u")}catch{P(),b("Gagal memuat modul Excel. Cek koneksi internet Anda.");return}P();let e=[];Y.forEach((l,n)=>{let i=l.dateString?new Date(l.dateString).toLocaleString("id-ID"):"-",d=l.customer?.name||"Anonim",p=l.customer?.deliveryMethod==="delivery"?"Dikirim":"Ambil di Toko",m=l.status||"-",u=l.items?l.items.reduce((h,g)=>h+(parseFloat(g.qty)||0),0):0,f=l.payment?.grandTotal||0;e.push({No:n+1,"ID Pesanan":l.orderId,Tanggal:i,"Nama Pelanggan":d,"Metode Kirim":p,Status:m,"Total Item":u,"Total Tagihan (Rp)":f})});const t=XLSX.utils.json_to_sheet(e),a=XLSX.utils.book_new();XLSX.utils.book_append_sheet(a,t,"Laporan Pesanan");const r=[{wch:5},{wch:25},{wch:22},{wch:25},{wch:15},{wch:15},{wch:12},{wch:20}];t["!cols"]=r;const s=new Date().toISOString().split("T")[0];XLSX.writeFile(a,`Laporan_Pesanan_${s}.xlsx`),b("Laporan Excel (.xlsx) berhasil diunduh!")},Ya=()=>{try{const e=new(window.AudioContext||window.webkitAudioContext),t=e.createOscillator(),a=e.createGain();t.connect(a),a.connect(e.destination),t.type="sine",t.frequency.setValueAtTime(800,e.currentTime),a.gain.setValueAtTime(1,e.currentTime),t.frequency.setValueAtTime(600,e.currentTime+.2),t.frequency.setValueAtTime(800,e.currentTime+.6),a.gain.setValueAtTime(1,e.currentTime+.6),t.frequency.setValueAtTime(600,e.currentTime+.8),a.gain.exponentialRampToValueAtTime(1e-5,e.currentTime+1.5),t.start(e.currentTime),t.stop(e.currentTime+1.5)}catch{}},Xa=()=>{$("admin-content",`
    ...
    `);const e=()=>{be&&(be(),Ee(null));let t=!0;const a=w.collection("freshmart_orders").orderBy("timestamp","desc").limit(100).onSnapshot(r=>{if(jt([]),!t){let l=!1;r.docChanges().forEach(n=>{n.type==="added"&&n.doc.data().status==="Baru"&&(l=!0)}),l&&(b("🔔 Pesanan Baru Masuk!"),Ya())}if(t=!1,r.empty){$("admin-orders-list",'<div class="flex flex-col items-center justify-center py-20 text-slate-400 font-bold bg-white dark:bg-slate-800 rounded-[1.5rem] border border-slate-200 dark:border-slate-700 shadow-sm text-center"><i class="fa-solid fa-receipt text-5xl mb-4 opacity-30"></i>Belum ada pesanan</div>'),K("stat-orders",0);return}K("stat-orders",r.size+(r.size===100?"+":""));const s=[];$("admin-orders-list",r.docs.map(l=>{const n=l.data();s.push(n);let i="text-slate-500 border-slate-200 dark:border-slate-600",d="fa-clock",p="bg-slate-50 dark:bg-slate-700/50",m="text-slate-400";n.status==="Baru"?(i="text-rose-500 border-rose-200 bg-rose-50 dark:bg-rose-900/20 dark:border-rose-800 animate-pulse",d="fa-asterisk",p="bg-rose-500",m="text-white shadow-md shadow-rose-500/30"):n.status==="Diproses"?(i="text-[var(--color-primary)] border-[var(--color-primary)]/30 bg-[rgba(var(--color-primary-rgb),0.06)] dark:bg-[rgba(var(--color-primary-rgb),0.10)] dark:border-[var(--color-primary)]/30",d="fa-spinner fa-spin",p="primary-bg",m="shadow-sm"):n.status==="Selesai"?(i="text-[var(--color-primary)] border-[var(--color-primary)]/30 bg-[rgba(var(--color-primary-rgb),0.06)] dark:bg-[rgba(var(--color-primary-rgb),0.10)] dark:border-[var(--color-primary)]/30",d="fa-check-double",p="primary-bg-soft",m="primary-text"):n.status==="Dibatalkan"&&(i="text-slate-400 border-slate-200 bg-slate-50 dark:bg-slate-800 dark:border-slate-700",d="fa-xmark",p="bg-slate-100 dark:bg-slate-800",m="text-slate-400");let u="fa-wallet text-slate-400",f=n.payment?.method||"";f==="transfer"?u="fa-building-columns text-[var(--color-primary)]":f==="qris"?u="fa-qrcode text-purple-500":f==="cod"?u="fa-hand-holding-dollar text-[var(--color-primary)]":f==="cashier"&&(u="fa-cash-register text-amber-500");let h=n.items?parseFloat(n.items.reduce((A,T)=>A+(parseFloat(T.qty)||0),0).toFixed(2)):0;const g=n.dateString?new Date(n.dateString).toLocaleDateString("id-ID",{day:"numeric",month:"short"}):"",v=(n.orderId||"").split("-").pop();return`
        ...
        </div>`);const r=k("admin-order-modal");r&&r.classList.contains("hidden")&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("adminOrder"),O("admin-order-modal"),setTimeout(()=>{k("admin-order-modal")&&k("admin-order-modal").classList.remove("opacity-0"),k("admin-order-modal-box")&&k("admin-order-modal-box").classList.remove("scale-95")},10)},Za=async(e,t)=>{const r=(typeof window.normalizeWA=="function"?window.normalizeWA:s=>String(s||"").replace(/\D/g,"").replace(/^0/,"62"))(t);if(!r||r.length<10)return b("Nomor WA tidak valid!");C("Menyimpan...");try{const s=w.collection("freshmart").doc("cms_data").collection("customers").doc(r),l=await s.get();l.exists?(await s.set({name:e||l.data().name},{merge:!0}),b("Data pelanggan sudah ada, nama diperbarui.")):(await s.set({id:parseInt(r,10),name:e||"-",phone:r,points:0}),b("✅ Pelanggan baru disimpan ke database!"))}catch(s){console.error("Gagal simpan pelanggan:",s),b("Gagal menyimpan data pelanggan: "+(s.message||""))}finally{P()}},es=async(e,t)=>{if(t==="waiting_stock"&&typeof window.customPrompt=="function"){window.customPrompt("Catatan untuk pelanggan:","Stok hadiah kosong, akan kami kirim susulan begitu stok tersedia kembali.",async r=>{if(r!==null){C("Menyimpan...");try{await w.collection("freshmart_orders").doc(e).update({"claimedReward.status":t,"claimedReward.note":r||""}),b("Status klaim hadiah diperbarui!");let s=Y.findIndex(l=>l.orderId===e);s!==-1&&(Y[s].claimedReward||(Y[s].claimedReward={}),Y[s].claimedReward.status=t,Y[s].claimedReward.note=r||""),typeof window.openCustomerOrderDetail=="function"&&window.openCustomerOrderDetail(e)}catch(s){b("Gagal update klaim: "+s.message)}finally{P()}}});return}let a="";C("Menyimpan...");try{await w.collection("freshmart_orders").doc(e).update({"claimedReward.status":t,"claimedReward.note":a});const r=Y.find(s=>s.orderId===e);r&&(r.claimedReward.status=t,r.claimedReward.note=a,bt(e)),b("Status hadiah diperbarui!")}catch(r){console.error("Gagal update status hadiah:",r),b("Gagal update status hadiah: "+(r.message||""))}finally{P()}},qt=(e=!1)=>{const t=()=>{k("admin-order-modal")&&k("admin-order-modal").classList.add("opacity-0"),k("admin-order-modal-box")&&k("admin-order-modal-box").classList.add("scale-95"),setTimeout(()=>F("admin-order-modal"),300)};typeof window.requestCloseModal=="function"?window.requestCloseModal("adminOrder",e,t):t()},ts=async(e,t)=>{if(!Ge){ge(!0),C("Update...");try{await w.collection("freshmart_orders").doc(e).update({status:t});let a=Y.find(r=>r.orderId===e);a&&(a.status=t),bt(e),b("Status diupdate!")}catch{b("Gagal!")}finally{ge(!1),P()}}},as=async e=>{if(!e)return b("ID pesanan tidak valid!");C("Memuat data...");try{const t=await w.collection("freshmart_orders").doc(e).get();if(P(),!t.exists)return b("Data pesanan tidak ditemukan!");const a=t.data(),r=a.customer&&a.customer.wa;if(!r)return b("Nomor WhatsApp pelanggan tidak tersedia!");const s=o&&o.store&&o.store.name?o.store.name:"Toko Kami",l=a.customer&&a.customer.name?a.customer.name:"Pelanggan",n=a.status||"Baru",i=a.payment&&a.payment.grandTotal?x(a.payment.grandTotal):"-",d=a.payment&&a.payment.method?a.payment.method.toUpperCase():"-",p=`Halo *${l}*! 👋
...
Kami akan segera memproses pesanan Anda. Terima kasih! 🙏`;window.open(`https://wa.me/${r}?text=${encodeURIComponent(p)}`,"_blank")}catch{P(),b("Gagal memuat data pesanan!")}},ss=e=>{ve("Hapus Pesanan","Yakin ingin hapus permanen?",async()=>{if(!Ge){ge(!0),C("Menghapus...");try{await w.collection("freshmart_orders").doc(e).delete(),b("Terhapus!"),ma===e&&qt()}catch{b("Gagal!")}finally{ge(!1),P()}}})};window.exportOrdersToExcel=Qa;window.rAdmOrd=Xa;window.openOrderDetail=bt;window.saveOrderCustomerToDB=Za;window.ackRewardClaim=es;window.closeOrderDetailModal=qt;window.updateOrderStatus=ts;window.konfirmasiKeWA=as;window.deleteOrder=ss;const rs=()=>{const e=o.store.name||"Toko Grosir",t=o.store.themeColor||"#10b981",a=(l,n,i=!1)=>{let d=document.querySelector(`meta[${i?"property":"name"}="${l}"]`);d||(d=document.createElement("meta"),i?d.setAttribute("property",l):d.setAttribute("name",l),document.head.appendChild(d)),d.setAttribute("content",n)};a("theme-color",t),a("mobile-web-app-capable","yes"),a("apple-mobile-web-app-capable","yes"),a("apple-mobile-web-app-status-bar-style","black-translucent"),a("apple-mobile-web-app-title",e),a("application-name",e),a("msapplication-TileColor",t),document.title=e,localStorage.setItem("freshmart_theme_color",t),o.store.uiTheme&&o.store.uiTheme!==localStorage.getItem("freshmart_ui_theme")&&(localStorage.setItem("freshmart_ui_theme",o.store.uiTheme),Ae(o.store.uiTheme));const r=o.store.bgStyle||localStorage.getItem("freshmart_bg_style")||"minimalist",s=o.store.bgCustomUrl!==void 0?o.store.bgCustomUrl:localStorage.getItem("freshmart_bg_custom_url")||"";Te(r,s)},Wt=()=>{$("admin-content",`
    ...
    `;if($("admin-content",n),e==="profile"){const i=o.store.uiTheme||"",d=o.store.themeColor||"#10b981";(i==="custom"||!$e?.[i])&&setTimeout(()=>{const m=document.getElementById("custom-color-chip");if(m){m.style.background=d;const u=m.querySelector("i");u&&(u.style.color="#fff")}},50)}},ns=async e=>{if(!Ge){ge(!0),C("Menyimpan...");try{if(e==="profile")o.store.name=S("set-name"),o.store.slogan=S("set-slogan"),o.store.logo=j(S("set-logo")),o.store.description=S("set-description"),o.store.email=S("set-email"),o.store.showRewardCatalog=S("set-show-reward-catalog")==="true",o.store.operationalHours=S("set-hours"),o.store.footerCredit=S("set-credit"),o.store.themeColor=S("set-theme-color"),o.store.uiTheme=S("set-ui-theme"),o.store.bgStyle=S("set-bg-style")||"minimalist",o.store.bgCustomUrl=j(S("set-bg-custom-url")),localStorage.setItem("freshmart_theme_color",o.store.themeColor),localStorage.setItem("freshmart_ui_theme",o.store.uiTheme),localStorage.setItem("freshmart_bg_style",o.store.bgStyle),localStorage.setItem("freshmart_bg_custom_url",o.store.bgCustomUrl||""),Ae(o.store.uiTheme,o.store.themeColor),Te(o.store.bgStyle,o.store.bgCustomUrl);else if(e==="catalog")o.store.categoryStyle=S("set-category-style"),o.store.brandStyle=S("set-brand-style"),o.store.showCategories=S("set-show-categories")==="true",o.store.showBrands=S("set-show-brands")==="true";else if(e==="shipping"){o.store.wa=S("set-wa").replace(/\D/g,""),o.store.address=S("set-address"),o.store.costPerKm=S("set-cost"),o.store.isDeliveryEnabled=S("set-delivery-enabled")==="true",o.store.isPickupEnabled=S("set-pickup-enabled")==="true",o.store.freeShippingMinSpendEnabled=S("set-free-shipping-enabled")==="true",o.store.freeShippingMinSpendAmount=Math.max(0,parseFloat(S("set-free-shipping-amount"))||0);let a=(S("set-lat")||"").trim(),r=(S("set-lng")||"").trim();const s=(S("set-maps-smart-input")||"").trim();if(s&&typeof window.parseGeoCoordinates=="function"){const l=window.parseGeoCoordinates(s);l&&(a=l.lat,r=l.lng)}(!a||!r)&&(a="-7.82308507053985",r="112.0988374794464"),o.store.lat=a,o.store.lng=r}else e==="payment"?(o.payment||(o.payment={}),o.payment.qrisUrl=j(S("set-qris-url"))):e==="config"?(o.config||(o.config={}),o.config.gasUrl=S("set-gas-url"),b("Pengaturan GAS URL tersimpan.")):e==="operasional"&&(o.store.useStock=S("set-use-stock")==="true",o.store.ppnEnabled=S("set-ppn-enabled")==="true",o.store.ppnType=S("set-ppn-type")||"exclusive",o.store.ppnRate=parseFloat(S("set-ppn-rate"))||11,o.store.spendPointsEnabled=S("set-spend-points-enabled")==="true",o.store.spendPointsThreshold=Math.max(1,parseFloat(S("set-spend-points-threshold"))||1e5),o.store.spendPointsPerThreshold=Math.max(1,parseFloat(S("set-spend-points-per-threshold"))||1),ut());const t={profile:"store",catalog:"store",shipping:"store",operasional:"store",payment:"payment",config:"config"};typeof window.saveApp=="function"&&await window.saveApp([t[e]||"store"]),e==="profile"||e==="config"?(b(e==="config"?"Sistem Diperbarui! Memuat Ulang...":"Warna Berubah! Memuat Ulang..."),setTimeout(()=>location.reload(),1500)):(b("Tersimpan!"),Wt())}catch{b("Gagal menyimpan pengaturan")}finally{ge(!1),P()}}},gt=e=>{const t=typeof window.parseGeoCoordinates=="function"?window.parseGeoCoordinates:null,a=t?t(e):null,r=document.getElementById("maps-smart-feedback"),s=document.getElementById("set-lat"),l=document.getElementById("set-lng");a?(s&&(s.value=a.lat),l&&(l.value=a.lng),r&&(r.className="text-[10px] mt-1.5 font-bold text-emerald-600 dark:text-emerald-400 flex items-center gap-1.5",r.innerHTML=`<i class="fa-solid fa-circle-check text-xs"></i> <span>Akurat! Koordinat terdeteksi: <b>${a.lat}, ${a.lng}</b></span>`)):e&&e.trim().length>3?r&&(r.className="text-[10px] mt-1.5 font-medium text-amber-600 dark:text-amber-400 flex items-center gap-1.5",r.innerHTML='<i class="fa-solid fa-triangle-exclamation text-xs"></i> <span>Pola belum terbaca. Coba tempel format: <code>-7.823085, 112.098837</code> atau link Google Maps</span>'):r&&(r.className="text-[10px] mt-1.5 font-medium text-slate-500 dark:text-slate-400 flex items-center gap-1.5",r.innerHTML='<i class="fa-solid fa-circle-info text-blue-500"></i> <span>Tempel tautan Maps atau angka koordinat dari Google Maps</span>')},ds=()=>{const e=document.getElementById("set-lat"),t=document.getElementById("set-lng"),a=document.getElementById("set-maps-smart-input");e&&t&&a&&e.value&&t.value&&(a.value=`${e.value.trim()}, ${t.value.trim()}`)},cs=async()=>{const e=document.getElementById("set-maps-smart-input");if(e){try{if(navigator.clipboard&&navigator.clipboard.readText){const t=await navigator.clipboard.readText();if(t){e.value=t,gt(t),b("Teks berhasil ditempel dari clipboard!");return}}}catch{}e.focus(),b("Silakan tekan Ctrl+V atau tahan untuk menempel")}},ps=()=>{const e=document.getElementById("set-lat"),t=document.getElementById("set-lng");let a=e?e.value.trim():"",r=t?t.value.trim():"";if(!a||!r){const s=document.getElementById("set-maps-smart-input");if(s&&s.value&&typeof window.parseGeoCoordinates=="function"){const l=window.parseGeoCoordinates(s.value);l&&(a=l.lat,r=l.lng)}}a&&r?window.open(`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(`${a},${r}`)}`,"_blank"):b("Masukkan koordinat toko terlebih dahulu")},ms=()=>{if(!navigator.geolocation){b("Browser tidak mendukung sensor GPS");return}b("Sedang mendeteksi lokasi GPS..."),navigator.geolocation.getCurrentPosition(e=>{const t=e.coords.latitude.toString(),a=e.coords.longitude.toString(),r=document.getElementById("set-maps-smart-input");r&&(r.value=`${t}, ${a}`),gt(`${t}, ${a}`),b("Lokasi GPS berhasil didapatkan!")},()=>{b("Gagal mengambil GPS perangkat. Pastikan izin lokasi aktif.")},{enableHighAccuracy:!0,timeout:15e3})},us=()=>{const e="data:text/json;charset=utf-8,"+encodeURIComponent(JSON.stringify(o,null,2)),t=document.createElement("a");t.href=e,t.download=`backup_freshmart_${new Date().toISOString().slice(0,10)}.json`,document.body.appendChild(t),t.click(),t.remove(),b("Backup diunduh!")},bs=e=>{const t=e.target.files[0];if(!t)return;const a=new FileReader;a.onload=async r=>{try{const s=JSON.parse(r.target.result);Object.assign(o,s),typeof window.saveApp=="function"&&await window.saveApp(),b("Data dipulihkan!"),setTimeout(()=>location.reload(),1e3)}catch{b("Gagal memulihkan data!")}},a.readAsText(t)};window.syncAppMeta=rs;window.rAdmSet=Wt;window.selectPresetTheme=os;window.selectBgStyle=is;window.openSettingForm=ls;window.saveAdminSettings=ns;window.backupData=us;window.restoreData=bs;window.handleSmartMapsInput=gt;window.handleManualCoordChange=ds;window.pasteFromClipboardToMapsInput=cs;window.previewStoreOnMaps=ps;window.detectAdminGPS=ms;let _=new Date().getFullYear(),R=0,re="menu",oe=null;const ie=["Jan","Feb","Mar","Apr","Mei","Jun","Jul","Agu","Sep","Okt","Nov","Des"],gs=e=>{if(typeof window.getEffHpp=="function")return window.getEffHpp(e);const t=o.products?.find(a=>a&&a.id!=null&&String(a.id)===String(e.id));if(!t)return 0;if(e.variantName&&t.variants){const a=t.variants.find(r=>r.name===e.variantName);if(a&&a.hpp!=null)return parseFloat(a.hpp)||0}return parseFloat(t.hpp)||0},Dt=new Map,fs=2*60*1e3,ft=async e=>{const t=Dt.get(e);if(t&&Date.now()-t.timestamp<fs)return t.data;const a={};for(let r=1;r<=12;r++)a[r]={omset:0,ppn:0,hpp:0,disc:0,orderCount:0};try{const r=new Date(e,0,1),s=new Date(e+1,0,1);(await w.collection("freshmart_orders").where("timestamp",">=",G.firestore.Timestamp.fromDate(r)).where("timestamp","<",G.firestore.Timestamp.fromDate(s)).limit(5e3).get()).forEach(i=>{const d=i.data();if(d.status==="Dibatalkan"||!d.timestamp||!d.timestamp.toDate)return;const p=d.timestamp.toDate().getMonth()+1;if(!a[p])return;const m=d.payment?.dppAmount!==void 0&&d.payment?.dppAmount!==null?parseFloat(d.payment.dppAmount):parseFloat(d.payment?.subtotal)||0;a[p].omset+=m,a[p].ppn+=parseFloat(d.payment?.ppnAmount)||0,a[p].disc+=parseFloat(d.payment?.productDiscount)||0,a[p].orderCount++,(d.items||[]).forEach(u=>{const f=u.hpp!==void 0&&u.hpp!==null?parseFloat(u.hpp):gs(u);a[p].hpp+=(parseFloat(f)||0)*(parseFloat(u.qty)||0)})})}catch(r){console.error("Gagal memuat data pajak:",r),b("Gagal memuat data periode ini!")}return Dt.set(e,{data:a,timestamp:Date.now()}),a},Ne=()=>oe?(R===0?Object.keys(oe):[R]).reduce((t,a)=>{const r=oe[a];return t.omset+=r.omset,t.ppn+=r.ppn,t.hpp+=r.hpp,t.disc+=r.disc,t.orderCount+=r.orderCount,t},{omset:0,ppn:0,hpp:0,disc:0,orderCount:0}):{omset:0,ppn:0,hpp:0,disc:0,orderCount:0},xt=()=>{const e=o.taxSettings?.monthlyExpenses||{};return(R===0?Array.from({length:12},(a,r)=>r+1):[R]).reduce((a,r)=>a+(parseFloat(e[`${_}-${r}`])||0),0)},xs=async()=>{$("admin-content",'<div class="text-center py-16"><i class="fa-solid fa-spinner fa-spin text-3xl text-slate-300"></i></div>'),oe=await ft(_),ht()},ht=()=>{const e=Array.from({length:6},(r,s)=>new Date().getFullYear()-4+s),t=[{k:"summary",l:"Ringkasan PPN",i:"fa-receipt"},{k:"income",l:"Laba Rugi",i:"fa-chart-pie"},{k:"balance",l:"Neraca",i:"fa-scale-balanced"},{k:"settings",l:"Pengaturan",i:"fa-gear"}];re==="menu"&&(re="summary");const a=`
    <div class="mb-5 flex flex-wrap items-center justify-between gap-3 bg-white dark:bg-slate-800 p-4 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm">
        ...
        <div class="flex items-center gap-2">
            ...
            <select id="tax-month-select" onchange="changeTaxMonth(this.value)" class="admin-input !py-2 !px-3 text-xs font-bold bg-slate-50 dark:bg-slate-900 text-slate-800 dark:text-slate-100 border border-slate-200 dark:border-slate-700 rounded-xl focus:border-[var(--color-primary)] cursor-pointer">
                ...
                ${ie.map((r,s)=>`<option value="${s+1}" ${R===s+1?"selected":""}>${r} ${_}</option>`).join("")}
            </select>
        </div>
        `}
    </div>
    ...
    </div>`),Je()},hs=e=>{re=e,ht()},ks=async e=>{_=parseInt(e,10),$("tax-content",'<div class="text-center py-16"><i class="fa-solid fa-spinner fa-spin text-3xl text-slate-300"></i></div>'),oe=await ft(_),Je()},vs=e=>{R=parseInt(e,10),Je()},Je=()=>{re==="summary"?zt():re==="income"?kt():re==="balance"?vt():re==="settings"&&Jt()},zt=()=>{const e=Ne(),t=R===0?`Tahun ${_}`:`${ie[R-1]} ${_}`,a=e.omset-e.disc,r=Array.from({length:12},(s,l)=>l+1).map(s=>{const l=oe?oe[s]:{omset:0,ppn:0,orderCount:0};return`<tr class="${R===s?"bg-[rgba(var(--color-primary-rgb),0.08)] dark:bg-[rgba(var(--color-primary-rgb),0.14)] font-bold":"hover:bg-slate-50 dark:hover:bg-slate-700/30"} border-b border-slate-100 dark:border-slate-700/50 last:border-0 transition-colors">
    ...
    `)},kt=()=>{const e=Ne(),t=R===0?`Tahun ${_}`:`${ie[R-1]} ${_}`,a=e.omset-e.disc-e.hpp,r=R===0?null:`${_}-${R}`,s=xt(),l=a-s,n=o.taxSettings?.taxScheme||"umkm_final";let i,d,p;n==="umkm_final"?(i=.5,d=e.omset,p="PPh Final UMKM (0,5% × Omset)"):n==="badan_normal"?(i=22,d=Math.max(0,l),p="PPh Badan (22% × Laba Bersih)"):(i=parseFloat(o.taxSettings?.customTaxRate)||0,d=Math.max(0,l),p=`PPh Custom (${i}% × Laba Bersih)`);const m=d*(i/100),u=l-m;let f="";if(R===0)f=Array.from({length:12},(h,g)=>g+1).map(h=>{const g=`${_}-${h}`,v=(o.taxSettings?.monthlyExpenses||{})[g]||0;return`<div class="flex items-center justify-between gap-2 py-2 border-b border-slate-100 dark:border-slate-700/50 last:border-0">
                <span class="text-xs font-bold text-slate-600 dark:text-slate-300">${ie[h-1]} ${_}</span>
            ...
            </div>`}).join("");else{const h=(o.taxSettings?.monthlyExpenses||{})[r]||0;f=`<div class="flex items-center justify-between gap-2 py-2">
            <span class="text-xs font-bold text-slate-600 dark:text-slate-300">${ie[R-1]} ${_}</span>
        ...
        <div class="card-modern p-6 sm:p-8 space-y-4">
            ...
            <div class="space-y-3 text-xs sm:text-sm">
                ...
                <div class="flex justify-between py-3 border-t-2 border-slate-800 dark:border-slate-200 mt-2"><span class="font-bold text-slate-900 dark:text-white text-sm sm:text-base">Laba Bersih Setelah Pajak (Estimasi)</span><span class="font-extrabold text-sm sm:text-base" style="color:var(--color-primary)">${x(u)}</span></div>
            </div>
    ...
    `)},ws=async(e,t)=>{const a=parseFloat(t)||0;o.taxSettings||(o.taxSettings={}),o.taxSettings.monthlyExpenses||(o.taxSettings.monthlyExpenses={}),o.taxSettings.monthlyExpenses[e]=a;try{typeof window.saveApp=="function"&&await window.saveApp(["taxSettings"]),kt()}catch{b("Gagal menyimpan biaya operasional!")}},vt=()=>{const e=ze(),t=o.taxSettings?.balanceSheet||{kas:0,piutang:0,hutang:0},a=(parseFloat(t.kas)||0)+(parseFloat(t.piutang)||0)+e.assetHpp,r=parseFloat(t.hutang)||0,s=a-r;$("tax-content",`
    ...
    `)},ys=async(e,t)=>{const a=parseFloat(t)||0;o.taxSettings||(o.taxSettings={}),o.taxSettings.balanceSheet||(o.taxSettings.balanceSheet={kas:0,piutang:0,hutang:0,modalDisetor:0}),o.taxSettings.balanceSheet[e]=a;try{typeof window.saveApp=="function"&&await window.saveApp(["taxSettings"]),vt()}catch{b("Gagal menyimpan data neraca!")}},Jt=()=>{const e=o.taxSettings||{};$("tax-content",`
    ...
    `)},Ss=e=>{ne("tax-custom-rate-wrap","hidden",e!=="custom")},$s=async()=>{if(!Ge){ge(!0),C("Menyimpan...");try{o.taxSettings||(o.taxSettings={}),o.taxSettings.companyName=S("tax-company-name"),o.taxSettings.npwp=S("tax-npwp"),o.taxSettings.taxScheme=S("tax-scheme"),o.taxSettings.customTaxRate=parseFloat(S("tax-custom-rate"))||.5,typeof window.saveApp=="function"&&await window.saveApp(["taxSettings"]),b("Pengaturan pajak tersimpan!")}catch{b("Gagal menyimpan pengaturan pajak!")}finally{ge(!1),P()}}},Ps=e=>{const t=R===0?`Tahun ${_}`:`${ie[R-1]} ${_}`,a=o.taxSettings||{},r=new Date().toLocaleDateString("id-ID",{day:"2-digit",month:"long",year:"numeric"});let s="";o.store.logo&&(o.store.logo.includes("http")||o.store.logo.includes("data:"))?s=`<img loading="eager" src="${c(o.store.logo)}" class="w-16 h-16 object-contain">`:s='<div class="w-16 h-16 bg-slate-700 text-white flex items-center justify-center rounded-xl"><i class="fa-solid fa-store text-3xl"></i></div>';const n={summary:"LAPORAN PPN & OMSET",income:"LAPORAN LABA RUGI",balance:"NERACA"}[e]||"LAPORAN";let i=`
    ...
    <div class="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-6 text-[11px] font-bold text-amber-700 leading-relaxed">
    ...
    </div>`,d="";if(e==="summary"){const m=Ne(),u=m.omset-m.disc,f=Array.from({length:12},(h,g)=>g+1).map(h=>{const g=oe?oe[h]:{omset:0,ppn:0,orderCount:0};return`<tr class="border-b border-slate-200"><td class="py-2.5 px-3 font-bold text-slate-700">${ie[h-1]} ${_}</td><td class="py-2.5 px-3 text-right font-bold text-slate-700">${x(g.omset)}</td><td class="py-2.5 px-3 text-right font-bold text-slate-900">${x(g.ppn)}</td><td class="py-2.5 px-3 text-right font-bold text-slate-500">${g.orderCount}</td></tr>`}).join("");d=`
        <div class="grid grid-cols-4 gap-4 mb-8">
            ...
            <div class="bg-slate-50 border border-slate-200 rounded-xl p-4"><p class="text-[9px] font-bold text-slate-400 uppercase mb-1">DPP</p><p class="font-bold text-slate-900">${x(u)}</p></div>
        ...
        <table class="w-full text-xs"><thead><tr class="bg-slate-100 text-left"><th class="py-2.5 px-3 font-bold text-slate-500 uppercase text-[9px]">Bulan</th><th class="py-2.5 px-3 font-bold text-slate-500 uppercase text-[9px] text-right">Omset</th><th class="py-2.5 px-3 font-bold text-slate-500 uppercase text-[9px] text-right">PPN Keluaran</th><th class="py-2.5 px-3 font-bold text-slate-500 uppercase text-[9px] text-right">Pesanan</th></tr></thead><tbody>${f}</tbody></table>`}else if(e==="income"){const m=Ne(),u=m.omset-m.disc-m.hpp,f=xt(),h=u-f,g=a.taxScheme||"umkm_final";let v,A,T;g==="umkm_final"?(v=.5,A=m.omset,T="PPh Final UMKM (0,5% × Omset)"):g==="badan_normal"?(v=22,A=Math.max(0,h),T="PPh Badan (22% × Laba Bersih)"):(v=parseFloat(a.customTaxRate)||0,A=Math.max(0,h),T=`PPh Custom (${v}% × Laba Bersih)`);const y=A*(v/100),V=h-y,L=(D,M,E,Xe)=>`<div class="flex justify-between py-2 ${E?"border-t-2 border-slate-800 mt-1 pt-3":"border-b border-slate-100"}"><span class="${E?"font-bold text-slate-900":"font-bold text-slate-600"}">${D}</span><span class="font-bold ${Xe||"text-slate-900"}">${M}</span></div>`;d=`<div class="max-w-xl">
            ${L("Omset Bruto",x(m.omset))}
            ${L("(−) Diskon Produk","-"+x(m.disc),!1,"text-rose-600")}
            ${L("(−) HPP","-"+x(m.hpp),!1,"text-rose-600")}
            ${L("Laba Kotor",x(u),!0,"text-emerald-600")}
            ${L("(−) Biaya Operasional","-"+x(f),!1,"text-rose-600")}
            ${L("Laba Bersih Sebelum Pajak",x(h),!0)}
            ${L("(−) Estimasi "+T,"-"+x(y),!1,"text-rose-600")}
            ${L("Laba Bersih Setelah Pajak (Estimasi)",x(V),!0)}
        </div>`}else if(e==="balance"){const m=ze(),u=a.balanceSheet||{kas:0,piutang:0,hutang:0},f=(parseFloat(u.kas)||0)+(parseFloat(u.piutang)||0)+m.assetHpp,h=parseFloat(u.hutang)||0,g=f-h;d=`
        <div class="grid grid-cols-2 gap-8">
            <div>
                <h3 class="font-bold text-slate-800 uppercase text-xs tracking-widest mb-3 pb-2 border-b-2 border-slate-800">Aset</h3>
                <div class="flex justify-between py-2 border-b border-slate-100"><span class="font-bold text-slate-600">Kas &amp; Bank</span><span class="font-bold text-slate-900">${x(u.kas||0)}</span></div>
                <div class="flex justify-between py-2 border-b border-slate-100"><span class="font-bold text-slate-600">Piutang Usaha</span><span class="font-bold text-slate-900">${x(u.piutang||0)}</span></div>
        ...
        </div>`}K("doc-modal-title","Preview "+n),$("doc-paper-content",i+d);const p=k("doc-preview-modal");p&&p.classList.contains("hidden")&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("docPreview"),O("doc-preview-modal"),setTimeout(()=>{k("doc-preview-modal")&&k("doc-preview-modal").classList.remove("opacity-0"),k("doc-preview-modal-box")&&k("doc-preview-modal-box").classList.remove("scale-95"),typeof window.fitDocPreview=="function"&&window.fitDocPreview()},10)};window.fetchTaxPeriodData=ft;window.getTaxPeriodTotals=Ne;window.getTaxPeriodExpenses=xt;window.rTaxPanel=xs;window.rTaxRenderShell=ht;window.switchTaxTab=hs;window.changeTaxYear=ks;window.changeTaxMonth=vs;window.rTaxSubContent=Je;window.rTaxSummary=zt;window.rTaxIncome=kt;window.saveMonthlyExpense=ws;window.rTaxBalance=vt;window.saveBalanceField=ys;window.rTaxSettingsPanel=Jt;window.toggleCustomTaxRateInput=Ss;window.saveTaxSettingsPanel=$s;window.openTaxDocPreview=Ps;window.MONTH_NAMES=ie;window.editTempoPenalty=(e,t)=>{window.customPrompt("Persentase Denda Baru",t,async a=>{if(!a)return;let r=parseFloat(a.replace(",","."));if(isNaN(r)||r<0)return b("Persentase tidak valid!");C("Menyimpan...");try{await w.collection("freshmart_orders").doc(e).update({"payment.tempoPenaltyRate":r}),b("Persentase denda berhasil diubah!"),window.rAdmPiutang()}catch(s){b("Gagal mengubah denda: "+s.message)}P()})};window.stopTempoPenalty=(e,t,a)=>{let r="Konfirmasi Denda",s=a?"Lanjutkan perhitungan denda otomatis?":"Hentikan denda berjalan sekarang? (Nominal denda akan dibekukan di "+x(t)+")";ve(r,s,async()=>{C("Menyimpan...");try{await w.collection("freshmart_orders").doc(e).update({"payment.tempoPenaltyStopped":!a,"payment.tempoFixedPenalty":a?null:t}),b(a?"Denda dilanjutkan!":"Denda berhasil dibekukan!"),window.rAdmPiutang()}catch(n){b("Gagal mengubah status denda: "+n.message)}P()},a?"Lanjutkan":"Bekukan")};window.payTempoInstallment=e=>{window.customPrompt("Masukkan Nominal Cicilan (Rp)","",async t=>{if(!t)return;let a=parseFloat(t.replace(/[^0-9]/g,""));if(isNaN(a)||a<=0)return b("Nominal tidak valid!");C("Menyimpan cicilan...");try{const s=(await w.collection("freshmart_orders").doc(e).get()).data();let l=(s.payment.tempoBalance||0)-a,n=s.payment.installments||[];n.push({date:Date.now(),amount:a,note:"Cicilan"});let i={"payment.tempoBalance":Math.max(0,l),"payment.installments":n};l<=0&&(i["payment.paymentStatus"]="lunas",i.status="Selesai"),await w.collection("freshmart_orders").doc(e).update(i),b("Cicilan berhasil ditambahkan!"),window.rAdmPiutang&&window.rAdmPiutang()}catch(r){b("Gagal memproses cicilan: "+r.message)}P()})};window.previewTempoReceipt=async e=>{C("Memuat data struk...");try{const t=await w.collection("freshmart_orders").doc(e).get();if(!t.exists)return P(),b("Pesanan tidak ditemukan");const a=t.data();P();const r=a.dateString?new Date(a.dateString).toLocaleString("id-ID",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}):"",s=o.store.name||"Toko",l=o.store.wa||"",n=(y,V,L=32)=>{const D=L-y.length-V.length;return y+(D>0?" ".repeat(D):" ")+V};let i=`<div class="text-center font-bold" style="font-size:13px;margin-bottom:2px;">${c(s)}</div>`;l&&(i+=`<div class="text-center" style="margin-bottom:4px;">WA: ${c(l)}</div>`),i+=`<div class="text-center font-bold uppercase my-2" style="font-size:14px;border-bottom:1px solid #000;border-top:1px solid #000;padding:2px 0;">NOTA TEMPO${a.payment?.paymentStatus==="lunas"?" - LUNAS":""}</div>`,i+=`<div style="white-space:pre;">Order: #${a.orderId}</div><div style="white-space:pre;">Tgl  : ${r}</div><div style="white-space:pre;">Plg  : ${c(a.customer?.name||"Guest").substring(0,20)}</div>`,a.payment?.tempoDueDate&&(i+=`<div style="white-space:pre;">J.Tmp: ${new Date(a.payment.tempoDueDate).toLocaleDateString("id-ID")}</div>`),i+='<div class="border-b border-dashed border-black my-2"></div>';let d=0;if(a.items.forEach(y=>{let V=y.variantName?` (${c(y.variantName)}${y.colorCode?" "+c(y.colorCode):""})`:"";const L=(c(y.name)+V+(y.poTime?" [PO]":"")).substring(0,32),D=`${parseFloat(y.qty)} ${c(y.unit||"pcs")} x ${y.effectivePrice.toLocaleString("id-ID")}`,M=(parseFloat(y.qty)*y.effectivePrice).toLocaleString("id-ID");i+=`<div style="white-space:pre-wrap;font-weight:bold;word-break:break-all;">${L}</div><div style="white-space:pre;font-size:11px;">${n(D,M)}</div>`,y.poTime&&(i+=`<div style="white-space:pre;font-size:10px;font-style:italic;color:#4b5563;">* Estimasi PO: ${c(y.poTime)}</div>`),d+=parseFloat(y.qty)*y.effectivePrice}),i+='<div class="border-b border-dashed border-black my-2"></div>',i+=`<div style="white-space:pre;font-weight:bold;">${n("Subtotal",d.toLocaleString("id-ID"))}</div>`,a.payment?.grandTotal&&a.payment.grandTotal!==d){let y=a.payment.grandTotal-d;y>0?i+=`<div style="white-space:pre;">${n("Ongkir/Biaya",y.toLocaleString("id-ID"))}</div>`:i+=`<div style="white-space:pre;">${n("Diskon",Math.abs(y).toLocaleString("id-ID"))}</div>`}i+=`<div style="white-space:pre;font-weight:bold;margin-top:4px;">${n("TOTAL KREDIT",(a.payment?.grandTotal||d).toLocaleString("id-ID"))}</div>`,i+='<div class="border-b border-black my-2" style="border-width:1px;"></div>';let p=0;a.payment?.installments&&a.payment.installments.length>0&&(i+='<div style="white-space:pre;font-weight:bold;margin-bottom:2px;">HISTORI CICILAN:</div>',a.payment.installments.forEach((y,V)=>{let L=new Date(y.date).toLocaleDateString("id-ID",{day:"2-digit",month:"short"}),D=y.amount.toLocaleString("id-ID");i+=`<div style="white-space:pre;">${n(`${V+1}. ${L}`,D)}</div>`,p+=y.amount}),i+=`<div style="white-space:pre;font-weight:bold;margin-top:2px;">${n("TOTAL DIBAYAR",p.toLocaleString("id-ID"))}</div>`,i+='<div class="border-b border-dashed border-black my-2"></div>');let m=a.payment?.tempoBalance||0,u=0,f=a.payment?.tempoPenaltyStopped===!0,h=a.payment?.tempoDueDate||0,g=a.payment?.tempoPenaltyRate!==void 0?parseFloat(a.payment.tempoPenaltyRate):1;if(a.payment?.paymentStatus!=="lunas"){if(f)u=parseFloat(a.payment?.tempoFixedPenalty)||0;else if(Date.now()>h){let y=Math.floor((Date.now()-h)/864e5);y>0&&(u=g/100*m*y)}}i+=`<div style="white-space:pre;font-weight:bold;">${n("SISA POKOK",m.toLocaleString("id-ID"))}</div>`,u>0&&(i+=`<div style="white-space:pre;">${n("DENDA",Math.round(u).toLocaleString("id-ID"))}</div>`);let v=m+u;i+='<div class="border-b border-black my-2" style="border-width:1px;"></div>',i+=`<div style="white-space:pre;font-weight:black;">${n("SISA TAGIHAN",Math.round(v).toLocaleString("id-ID"))}</div>`,a.items.some(y=>y.poTime&&y.poTime!=="")&&(i+='<div class="border-b border-dashed border-black my-2"></div><div style="white-space:pre-wrap;font-size:9px;text-align:center;line-height:1.2;font-style:italic;color:#4b5563;margin-bottom:4px;">* Catatan: Untuk pesanan gabungan, produk PO akan dikirimkan menyusul (estimasi sesuai label) tanpa dikenakan biaya tambahan.</div>'),i+='<div class="border-b border-dashed border-black my-2"></div><div class="text-center my-2" style="font-size:10px;">Terima kasih atas kepercayaannya.</div><div class="border-b border-dashed border-black my-2"></div><div style="height:20px;"></div>',$("receipt-paper-content",i);const T=k("receipt-preview-modal");T&&T.classList.contains("hidden")&&pushModalHistory("receipt"),show("receipt-preview-modal"),setTimeout(()=>{k("receipt-preview-modal").classList.remove("opacity-0"),k("receipt-preview-modal-box").classList.remove("scale-95")},10)}catch(t){P(),b("Gagal memuat struk: "+t.message)}};window.markTempoPaid=async e=>{ve("Konfirmasi","Tandai tagihan tempo ini sebagai LUNAS?",async()=>{try{await w.collection("freshmart_orders").doc(e).update({"payment.paymentStatus":"lunas","payment.tempoBalance":0,status:"Selesai"}),b("Tagihan berhasil dilunasi!");let t=gOrds.findIndex(a=>a.orderId===e);t!==-1&&(gOrds[t].payment.paymentStatus="lunas",gOrds[t].payment.tempoBalance=0,gOrds[t].status="Selesai"),window.rAdmPiutang()}catch(t){b("Gagal mengubah status: "+t.message)}})};window.rAdmPiutang=async()=>{C("Memuat data piutang...");let e=[];try{(await w.collection("freshmart_orders").where("payment.method","==","tempo").where("payment.paymentStatus","==","hutang").get()).forEach(s=>{e.push(s.data())})}catch(r){P(),b("Gagal memuat piutang: "+r.message);return}P();let t=0,a=`
    ...
    `;e.length===0?a+=`<div class="bg-white dark:bg-slate-800 p-8 text-center rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm">
            ...
            <div class="bg-white dark:bg-slate-800 p-5 rounded-2xl border ${m?"border-rose-300 dark:border-rose-700 shadow-[0_0_15px_rgba(225,29,72,0.1)]":"border-slate-200 dark:border-slate-700 shadow-sm"} relative overflow-hidden group hover:-translate-y-1 transition-all">
                ...
                <div class="flex justify-between items-center bg-rose-50 text-rose-600 dark:bg-rose-900/20 dark:text-rose-400 p-3.5 rounded-xl border border-rose-100 dark:border-rose-900/30 mb-3">
                    ...
                    <span class="text-sm font-bold font-mono tracking-tight">${x(u)}</span>
                </div>
                ...
                <div class="mb-3 space-y-1.5 bg-slate-50 dark:bg-slate-900/30 p-3 rounded-xl border border-slate-100 dark:border-slate-800">
                    <div class="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-2 flex justify-between">
                        ...
                        <span>Total: ${x(r.payment.installments.reduce((h,g)=>h+(parseFloat(g.amount)||0),0))}</span>
                    </div>
                ...
                <div class="flex gap-2 mb-2">
                    <a href="https://wa.me/${f}?text=Halo%20kak%20${c(r.customer?.name||"")},%20mengingatkan%20bahwa%20sisa%20tagihan%20Tempo%20untuk%20pesanan%20${r.orderId}%20sebesar%20${x(u)}%20sudah%20jatuh%20tempo.%20Mohon%20segera%20dilunasi." target="_blank" class="flex-1 bg-[rgba(var(--color-primary-rgb),0.06)] dark:bg-[rgba(var(--color-primary-rgb),0.10)] hover:bg-[rgba(var(--color-primary-rgb),0.12)] dark:hover:bg-[rgba(var(--color-primary-rgb),0.16)] text-[var(--color-primary)] border border-[var(--color-primary)]/25 rounded-xl py-2 flex items-center justify-center gap-1.5 text-[10px] font-bold uppercase tracking-widest transition-all">
            ...
            </div>`}),a+="</div>"),a+="</div>",$("admin-content",a),setTimeout(()=>{k("total-piutang-header")&&(k("total-piutang-header").innerText=x(t))},100)};const As=e=>{ba(e),Qt()},Qt=()=>{const e=ua||"all",t=(dt||[]).filter(l=>e==="visible"?l.isVisible!==!1:e==="hidden"?l.isVisible===!1:!0),a=`
        <div class="mb-5 flex justify-between items-center bg-white dark:bg-slate-800 p-4 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm">
            <div class="flex items-center gap-3">
                <div class="w-10 h-10 rounded-xl flex items-center justify-center shrink-0" style="background: rgba(var(--color-primary-rgb),0.1); color: var(--color-primary)">
        ...
        </div>`}).join("");$("admin-content",'<div class="max-w-full pb-10 text-sm fade-in-scale">'+a+s+"</div>")},Ts=async e=>{const t=(dt||[]).find(a=>a&&a.id!=null&&String(a.id)===String(e));t&&typeof window.customPrompt=="function"&&window.customPrompt("Tulis balasan untuk ulasan ini:",t.adminReply||"",async a=>{C("Menyimpan balasan...");try{await w.collection("freshmart").doc("cms_data").collection("reviews").doc(e.toString()).update({adminReply:a}),b("Balasan tersimpan!")}catch{b("Gagal menyimpan balasan!")}finally{P()}})},Cs=async e=>{const t=(dt||[]).find(r=>r&&r.id!=null&&String(r.id)===String(e));if(!t)return;const a=t.isVisible===!1;C("Menyimpan...");try{await w.collection("freshmart").doc("cms_data").collection("reviews").doc(e.toString()).update({isVisible:a}),b(a?"Ulasan ditampilkan lagi!":"Ulasan disembunyikan dari halaman produk!")}catch{b("Gagal mengubah status ulasan!")}finally{P()}},js=e=>{ve("Hapus Ulasan","Ulasan yang dihapus tidak bisa dikembalikan lagi.",async()=>{C("Menghapus...");try{await w.collection("freshmart").doc("cms_data").collection("reviews").doc(e.toString()).delete(),b("Ulasan dihapus!")}catch{b("Gagal menghapus ulasan!")}finally{P()}})};window.filterReviews=As;window.rAdmReviews=Qt;window.replyToReview=Ts;window.toggleReviewVisibility=Cs;window.deleteReview=js;window.rAdmL=e=>{Qe(e),typeof window.setCTab=="function"&&window.setCTab(e),window.cTab=e,$("admin-content",`
    ...
    `),rAdmItms(e)};window.rAdmItms=e=>{e&&(Qe(e),typeof window.setCTab=="function"&&window.setCTab(e),window.cTab=e);const t=k("admin-list-container"),a=t?t.closest(".scroll-content"):null,r=a?a.scrollTop:0;if(e==="products"&&k("admin-product-stats")){const i=ze();$("admin-product-stats",`
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                <div class="card-modern p-5 sm:p-5">
        ...
        <div class="p-4 sm:p-5 md:p-6 lg:p-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4 rounded-[1.5rem] border shadow-sm cursor-pointer hover:shadow-md hover:-translate-y-1 hover:border-[var(--color-primary)]/40 dark:hover:border-[var(--color-primary)]/40 transition-all duration-300 ${m}" onclick="oAEd('${e}','${i.id}')">
            <div class="flex items-start sm:items-center gap-4 min-w-0 w-full">
                ...
                <div class="min-w-0 flex flex-col justify-center py-1">
                    ...
                    ${d&&h&&A?`<p class="text-[10px] font-bold mt-1 ${(i.variants&&i.variants.length?i.variants.reduce((D,M)=>D+(parseFloat(M.stock)||0),0):parseFloat(i.stock)||0)===0?"text-rose-500 animate-pulse":"text-blue-500"}"><i class="fa-solid fa-boxes-stacked mr-1"></i>Stok: ${i.variants&&i.variants.length?i.variants.reduce((D,M)=>D+(parseFloat(M.stock)||0),0).toFixed(2).replace(/\.?0+$/,""):parseFloat(i.stock)||0}</p>`:""}
    ...
    `},_s=()=>{let e=document.getElementById("guarantee-modal");e||(e=document.createElement("div"),e.id="guarantee-modal",e.className="fixed inset-0 z-[115] bg-slate-900/80 flex items-end sm:items-center justify-center p-0 sm:p-5",e.onclick=t=>{t.target===e&&Xt()},document.body.appendChild(e)),e.innerHTML=`
        ...
        </div>`,e.style.opacity="0",e.style.display="flex",requestAnimationFrame(()=>{e.style.transition="opacity 0.25s ease",e.style.opacity="1"})},Zt=()=>{const e=document.getElementById("security-modal");!e||e.style.display==="none"||(e.style.opacity="0",e.style.transition="opacity 0.25s ease",setTimeout(()=>{e.style.display="none",e.style.opacity="",e.style.transition=""},250))};window.renderStorefrontFooter=Yt;window.openQualityGuaranteeModal=_s;window.closeQualityGuaranteeModal=Xt;window.openSecurityModal=Rs;window.closeSecurityModal=Zt;const ke=()=>{if(Yt(),K("dyn-store-name",o.store.name||"Toko Putri"),K("dyn-store-slogan",o.store.slogan||o.store.tagline||o.store.desc||o.store.description||"Toko Online & Kasir Resmi"),o.store.logo){const n=k("dyn-store-logo-img"),i=k("dyn-store-logo-icon");o.store.logo.includes("http")||o.store.logo.includes("data:")?n&&(n.src=o.store.logo,n.onerror=()=>{n.onerror=null,n.src="https://placehold.co/100?text=Logo"},O("dyn-store-logo-img"),F("dyn-store-logo-icon")):i&&(i.className=`fa-solid ${c(o.store.logo)} text-xl text-[var(--color-primary)]`,O("dyn-store-logo-icon"),F("dyn-store-logo-img"))}let e=o.banners&&o.banners.length?`
    <div class="relative group/banner-wrapper w-full">
        <div id="banner-slider" class="flex overflow-x-auto gap-4 sm:gap-6 pb-4 pt-2 snap-x hide-scrollbar scroll-smooth" ontouchstart="clearInterval(window.bannerTmr)" ontouchend="setTimeout(() => window.startBannerAutoSlide?.(), 8000)" onmouseenter="clearInterval(window.bannerTmr)" onmouseleave="window.startBannerAutoSlide?.()" onscroll="window.onBannerScroll && window.onBannerScroll()">
            ${o.banners.map((n,i)=>{const d=n.type==="video"&&n.videoUrl,p=!d&&n.link?`onclick="window.open('${c(n.link)}', '_self')"`:"";if(d){const m=ga(n.videoUrl)||{type:"direct",directUrl:ct(n.videoUrl),embedUrl:fa(n.videoUrl)};let u="";return m.type==="youtube"?u=`
                <iframe
        ...
        `:""}
    </div>`:"";$("dynamic-banners-container",e),setTimeout(Fe,500);const t=(o.vouchers||[]).filter(n=>n.isShow==="true"||n.isShow===!0),a=k("dynamic-vouchers-container");if(t.length>0&&a){a.classList.remove("hidden");let n=`
        ...
        <div class="flex gap-2.5 sm:gap-3 overflow-x-auto hide-scrollbar snap-x pb-3 pt-1">
            ${t.map(i=>{let d=i.type==="shipping_free"?"Gratis Ongkir":i.type==="percent"?`Diskon ${c(String(parseFloat(i.value)||0))}%`:`Diskon ${x(i.value)}`,p=[];i.minPurchase>0&&p.push(`Min. Blj ${x(i.minPurchase)}`),i.maxDiscount>0&&p.push(`Maks. ptg ${x(i.maxDiscount)}`),i.targetProduct&&p.push("Produk Khusus");let m=p.length>0?c(p.join(" • ")):"Tanpa min. belanja";return`
        ...
        </div>`;a.innerHTML=n}else a&&(a.classList.add("hidden"),a.innerHTML="");const r=[...o.categories||[]];$("dynamic-categories-container",r.map(n=>{const i=ae===n.name,d=decodeURIComponent(encodeURIComponent(n.name).replace(/'/g,"%27"));if(o.store.categoryStyle==="text"||!o.store.categoryStyle)return`<div onclick="filterCategory('${d}')" class="cursor-pointer shrink-0 snap-start group py-0.5"><div class="px-3.5 py-1.5 rounded-xl border transition-all duration-200 flex items-center gap-2 ${i?"bg-[var(--color-primary)] border-transparent text-white shadow-xs":"bg-slate-50 dark:bg-slate-800/90 border-slate-200/80 dark:border-slate-700 text-slate-700 dark:text-slate-300 hover:border-[var(--color-primary)]/50 hover:bg-white dark:hover:bg-slate-800"}"><div class="w-5 h-5 rounded-md flex items-center justify-center ${i?"bg-white/20 text-white":"bg-white dark:bg-slate-700 text-slate-400 group-hover:text-[var(--color-primary)]"} transition-colors"><i class="fa-solid fa-layer-group text-[9px]"></i></div><span class="font-bold text-[10px] sm:text-[11px] uppercase tracking-wider">${c(n.name)}</span></div></div>`;{const p=n.img&&!n.img.includes("10b981")?xe(n.img,"w150-rw"):"https://placehold.co/150/f1f5f9/64748b?text=Cat";return`<div onclick="filterCategory('${d}')" class="flex flex-col items-center gap-1.5 cursor-pointer shrink-0 w-[64px] sm:w-[72px] group snap-start py-0.5"><div class="relative w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-slate-50 dark:bg-slate-800 flex items-center justify-center p-1.5 transition-all duration-200 ${i?"bg-[var(--color-primary-light)] border-2 border-[var(--color-primary)] shadow-xs dark:bg-[var(--color-primary-dark)]/20":"border border-slate-200 dark:border-slate-700 shadow-2xs group-hover:border-[var(--color-primary)] group-hover:-translate-y-0.5"} overflow-hidden"><img loading="lazy" src="${c(p)}" alt="${c(n.name)}" onerror="this.onerror=null;this.src='https://placehold.co/150/f1f5f9/64748b?text=Cat'" class="w-full h-full object-cover rounded-lg transition-transform duration-300 group-hover:scale-105"></div><span class="text-[8.5px] sm:text-[9px] text-center w-full line-clamp-1 leading-tight px-0.5 ${i?"font-bold text-[var(--color-primary)]":"font-semibold text-slate-600 dark:text-slate-300 group-hover:text-[var(--color-primary)]"} uppercase tracking-wider transition-colors">${c(n.name)}</span></div>`}}).join(""));const s=[...o.brands||[]],l=[{name:"Semua Merek",img:o.store.allBrandsIcon&&!o.store.allBrandsIcon.includes("10b981")?o.store.allBrandsIcon:"https://placehold.co/150/f1f5f9/475569?text=Semua+Merek"},...o.brands||[]];$("dynamic-brands-container",s.map(n=>{const i=de===n.name,d=decodeURIComponent(encodeURIComponent(n.name).replace(/'/g,"%27"));if(o.store.brandStyle==="text")return`<div onclick="filterBrand('${d}')" class="cursor-pointer shrink-0 snap-start group py-0.5"><div class="px-3.5 py-1.5 rounded-xl border transition-all duration-200 flex items-center gap-2 ${i?"bg-[var(--color-primary)] border-transparent text-white shadow-xs":"bg-slate-50 dark:bg-slate-800/90 border-slate-200/80 dark:border-slate-700 text-slate-700 dark:text-slate-300 hover:border-[var(--color-primary)]/50 hover:bg-white dark:hover:bg-slate-800"}"><div class="w-5 h-5 rounded-md flex items-center justify-center ${i?"bg-white/20 text-white":"bg-white dark:bg-slate-700 text-slate-400 group-hover:text-[var(--color-primary)]"} transition-colors"><i class="fa-solid fa-copyright text-[9px]"></i></div><span class="font-bold text-[10px] sm:text-[11px] uppercase tracking-wider">${c(n.name)}</span></div></div>`;{const p=n.img&&!n.img.includes("10b981")?xe(n.img,"w150-rw"):"https://placehold.co/150/f1f5f9/64748b?text=Brand";return`<div onclick="filterBrand('${d}')" class="flex flex-col items-center gap-1.5 cursor-pointer shrink-0 w-[64px] sm:w-[72px] group snap-start py-0.5"><div class="relative w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-white flex items-center justify-center overflow-hidden p-1.5 transition-all duration-200 ${i?"ring-2 ring-[var(--color-primary)] ring-offset-1 ring-offset-slate-50 dark:ring-offset-slate-800 shadow-xs":"border border-slate-200 dark:border-slate-700 shadow-2xs group-hover:border-[var(--color-primary)]/50 group-hover:-translate-y-0.5"}"><img loading="lazy" src="${c(p)}" alt="${c(n.name)}" onerror="this.onerror=null;this.src='https://placehold.co/150/f1f5f9/64748b?text=Brand'" class="w-full h-full object-contain transition-transform duration-300 group-hover:scale-105"></div><span class="text-[8.5px] sm:text-[9px] text-center w-full line-clamp-1 leading-tight px-0.5 ${i?"font-bold text-[var(--color-primary)]":"font-semibold text-slate-600 dark:text-slate-300 group-hover:text-[var(--color-primary)]"} uppercase tracking-wider transition-colors">${c(n.name)}</span></div>`}}).join("")),$("modal-brand-grid",l.map(n=>{const i=de===n.name,d=decodeURIComponent(encodeURIComponent(n.name).replace(/'/g,"%27")),p=n.img&&!n.img.includes("10b981")?xe(n.img,"w150-rw"):"https://placehold.co/150/f1f5f9/64748b?text=Brand";return`<button onclick="filterBrand('${d}'); closeBrandModal();" class="flex flex-col items-center gap-3 p-4 rounded-2xl border ${i?"border-[var(--color-primary)] bg-[rgba(var(--color-primary-rgb),0.07)] dark:bg-[rgba(var(--color-primary-rgb),0.12)] shadow-sm":"border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 hover:border-[var(--color-primary)]/40 hover:shadow-sm"} transition-all active:scale-[0.96]"><div class="w-14 h-14 rounded-2xl flex items-center justify-center bg-white border border-slate-100 dark:border-slate-600 shadow-inner overflow-hidden p-1.5"><img loading="lazy" src="${c(p)}" alt="${c(n.name)}" class="w-full h-full object-contain" onerror="this.src='https://placehold.co/150/f1f5f9/64748b?text=Brand'"></div> <span class="text-[10px] sm:text-xs font-bold ${i?"text-[var(--color-primary)]":"text-slate-700 dark:text-slate-300"} text-center leading-tight line-clamp-2 uppercase tracking-widest">${c(n.name)}</span></button>`}).join("")),k("dyn-qris-img")&&o.payment&&(k("dyn-qris-img").src=o.payment.qrisUrl),typeof window.renderRewardCatalog=="function"&&window.renderRewardCatalog(),typeof window.applyBackgroundStyle=="function"&&window.applyBackgroundStyle(o.store.bgStyle,o.store.bgCustomUrl),le(1),W()};window.rDyn=ke;const Ns=async()=>{if(document.documentElement.classList.contains("dark")){const g=k("icon-theme");g&&(g.className="fa-solid fa-sun text-sm text-amber-500")}const e=()=>{o.products=o.products||[],o.categories=o.categories||[],o.brands=o.brands||[],o.vouchers=o.vouchers||[],o.changelog=o.changelog||[],o.products.forEach(g=>{g.img&&(g.img=j(g.img)),g.variants&&g.variants.forEach(v=>{v.img&&(v.img=j(v.img))})}),o.banners&&o.banners.forEach(g=>{g.img&&(g.img=j(g.img)),g.videoUrl&&(g.videoUrl=ct(g.videoUrl))}),o.categories&&o.categories.forEach(g=>{g.img&&(g.img=j(g.img),g.img.includes("10b981")&&(g.img="https://placehold.co/150/f1f5f9/64748b?text=Cat"))}),o.brands&&o.brands.forEach(g=>{g.img&&(g.img=j(g.img),g.img.includes("10b981")&&(g.img="https://placehold.co/150/f1f5f9/64748b?text=Brand"))}),o.store.logo&&(o.store.logo=j(o.store.logo)),o.store.allProductsIcon&&(o.store.allProductsIcon=j(o.store.allProductsIcon)),o.store.allBrandsIcon&&(o.store.allBrandsIcon=j(o.store.allBrandsIcon),o.store.allBrandsIcon.includes("10b981")&&(o.store.allBrandsIcon="https://placehold.co/150/f1f5f9/475569?text=Semua+Merek")),o.payment.qrisUrl&&(o.payment.qrisUrl=j(o.payment.qrisUrl)),I.forEach(g=>{g.img&&(g.img=j(g.img))}),ee.forEach(g=>{g.img&&(g.img=j(g.img))})},t=Ft?.projectId||"default",a=ce("freshmart_active_project");if(a&&a!==t)try{localStorage.removeItem("freshmart_cms_data"),localStorage.removeItem("freshmart_products"),localStorage.removeItem("freshmart_rewards"),localStorage.removeItem("freshmart_last_update"),localStorage.removeItem("freshmart_cart"),localStorage.removeItem("freshmart_wishlist")}catch{}N("freshmart_active_project",t);let r=JSON.parse(ce("freshmart_cms_data")||"null"),s=JSON.parse(ce("freshmart_products")||"null"),l=JSON.parse(ce("freshmart_rewards")||"null");parseInt(ce("freshmart_last_update")||"0");let n=!1;if(r?(Object.assign(o,J,r),o.store={...J.store,...r.store||{}},o.payment={...J.payment,...r.payment||{}},o.config={...J.config,...r.config||{}},o.config&&o.config.gasUrl&&(window.GAS_UPLOAD_URL=o.config.gasUrl),s&&(o.products=s),l&&(o.rewards=l),e(),o.store&&(Ae(o.store.uiTheme,o.store.themeColor),Te(o.store.bgStyle,o.store.bgCustomUrl)),_e(),X(),Re(),ke(),W(),K("stat-products",o.products.filter(g=>g.isActive!=="false"&&g.isActive!==!1).length),P(),n=!0):C("Memuat Toko..."),!n)try{const g=await w.collection("freshmart").doc("cms_data").get();if(g.exists){const v=g.data(),A=v.lastUpdate||0;N("freshmart_cms_data",JSON.stringify(v)),Object.assign(o,J,v),o.store={...J.store,...v.store||{}},o.payment={...J.payment,...v.payment||{}},o.config={...J.config,...v.config||{}},o.config&&o.config.gasUrl&&(window.GAS_UPLOAD_URL=o.config.gasUrl);const T=await w.collection("freshmart").doc("cms_data").collection("products").get();o.products=T.docs.map(y=>y.data()).sort((y,V)=>(V.id||0)-(y.id||0)),N("freshmart_products",JSON.stringify(o.products)),N("freshmart_last_update",A.toString()),e(),o.store&&(Ae(o.store.uiTheme,o.store.themeColor),Te(o.store.bgStyle,o.store.bgCustomUrl)),_e(),X(),Re(),ke(),W(),K("stat-products",o.products.filter(y=>y.isActive!=="false"&&y.isActive!==!1).length)}}catch{b("Mode Offline (Data Lokal)")}finally{P()}K("stat-products",o.products.filter(g=>g.isActive!=="false"&&g.isActive!==!1).length);const i=k("loader-store-name"),d=k("loader-tagline");i&&(i.textContent=(o.store.name||"").toUpperCase()),d&&(d.textContent=o.store.tagline||o.store.desc||o.store.address||"");const p=k("loader-logo-icon"),m=k("loader-logo-img"),u=o.store.logo&&o.store.logo!=="fa-store"?o.store.logo:"";u&&(p&&(p.style.display="none"),m&&(m.src=u,m.style.display="block")),St(),window.injectJSONLD("seo-website",{"@context":"https://schema.org","@type":"WebSite",name:"Toko Putri",url:window.location.origin}),window.injectJSONLD("seo-localbusiness",{"@context":"https://schema.org","@type":"HardwareStore",name:"Toko Putri",image:xe(o.store.logo,"w300-rw"),description:"Solusi grosir dan e-commerce terpercaya untuk alat teknik, perkakas, dan perlengkapan pertukangan berkualitas.",url:window.location.origin,telephone:o.store.phone||"",address:{"@type":"PostalAddress",streetAddress:o.store.address||"",addressCountry:"ID"}});const h=new URLSearchParams(window.location.search).get("p");if(h&&o.products.find(g=>g.id==parseInt(h))){const g=new URLSearchParams(window.location.search);g.delete("p");let v=window.location.pathname;g.toString()&&(v+="?"+g.toString()),window.history.replaceState({},document.title,v),setTimeout(()=>openProductModal(parseInt(h)),600)}P()},H=async(e=null,t=null)=>{try{if(Array.isArray(e)){const r={lastUpdate:G.firestore.FieldValue.increment(1),updateType:t?.updateType||(e.length?"settings_change":"full"),changedKeys:e};t?.updatedProductIds&&Array.isArray(t.updatedProductIds)?r.updatedProductIds=t.updatedProductIds:r.updatedProductIds=G.firestore.FieldValue.delete(),e.forEach(s=>{s&&(r[s]=o[s])}),await w.collection("freshmart").doc("cms_data").set(r,{merge:!0})}else{const r={...o};delete r.products,delete r.auth,r.lastUpdate=G.firestore.FieldValue.increment(1),r.updateType="full",await w.collection("freshmart").doc("cms_data").set(r)}o.lastUpdate=(parseInt(ce("freshmart_last_update"))||o.lastUpdate||0)+1;const a={...o};delete a.products,delete a.auth,N("freshmart_cms_data",JSON.stringify(a)),N("freshmart_last_update",o.lastUpdate.toString()),N("freshmart_products",JSON.stringify(o.products))}catch{b("Tersimpan secara Lokal")}};let et=!1,pe=null,ot=typeof document<"u"?document.hidden:!1,it=!1,ye=!1;typeof document<"u"&&document.addEventListener("visibilitychange",()=>{if(ot=document.hidden,!ot&&it&&pe){it=!1;const e=pe;pe=null,typeof window._doSyncCmsData=="function"&&window._doSyncCmsData(e)}});const lt=e=>{if(!e)return e;const t={...e};return t.id==null&&(t.id=0),typeof t.id=="string"&&!isNaN(t.id)&&(t.id=Number(t.id)),t.img&&(t.img=j(t.img)),t.variants&&t.variants.forEach(a=>{a.img&&(a.img=j(a.img))}),t},Ve=()=>{if(K("stat-products",o.products.filter(a=>a.isActive!=="false"&&a.isActive!==!1).length),_e(),X(),typeof ke=="function"?ke():typeof window.rDyn=="function"&&window.rDyn(),typeof W=="function"?W():typeof window.rCat=="function"&&window.rCat(),document.getElementById("admin-list-container")&&typeof window.rAdmItms=="function"){const a=window.cTab||"products";["products","colors"].includes(a)&&window.rAdmItms(a)}const t=window.cProd;if(t){const a=o.products.find(r=>r.id===t.id);if(a&&(window.cProd=a,typeof window.rProdMod=="function")){const r=document.getElementById("product-modal");r&&!r.classList.contains("hidden")&&!r.classList.contains("opacity-0")&&window.rProdMod()}}},Os=()=>{if(window.unsubCmsRealtime)return;const e=async t=>{if(!t.exists)return;const a=t.data(),r=a.lastUpdate||0,s=parseInt(ce("freshmart_last_update")||"0");if(ot){pe=t,it=!0;return}if(!(r===s&&r>0&&ye&&o.products&&o.products.length>0)){et=!0;try{const l=a.updateType||"full",n=Array.isArray(a.updatedProductIds)?a.updatedProductIds.map(String):[];if(o.store={...J.store,...a.store||{}},a.categories&&(o.categories=a.categories),a.vouchers&&(o.vouchers=a.vouchers),a.banners&&(o.banners=a.banners),a.brands&&(o.brands=a.brands),a.banks&&(o.banks=a.banks),a.faqs&&(o.faqs=a.faqs),o.payment={...J.payment,...a.payment||{}},o.config={...J.config,...a.config||{}},o.taxSettings={...J.taxSettings,...a.taxSettings||{}},o.config&&o.config.gasUrl&&(window.GAS_UPLOAD_URL=o.config.gasUrl),o.banners&&o.banners.forEach(d=>{d.img&&(d.img=j(d.img)),d.videoUrl&&(d.videoUrl=ct(d.videoUrl))}),o.categories&&o.categories.forEach(d=>{d.img&&(d.img=j(d.img),d.img.includes("10b981")&&(d.img="https://placehold.co/150/f1f5f9/64748b?text=Cat"))}),o.brands&&o.brands.forEach(d=>{d.img&&(d.img=j(d.img),d.img.includes("10b981")&&(d.img="https://placehold.co/150/f1f5f9/64748b?text=Brand"))}),l==="product_delete"&&n.length>0)n.forEach(d=>{const p=o.products.findIndex(m=>(m.id!=null?m.id.toString():"")===d);p>-1&&o.products.splice(p,1)}),N("freshmart_products",JSON.stringify(o.products)),ye=!0,Ve();else if(!ye&&(!o.products||o.products.length===0)){const d=await w.collection("freshmart").doc("cms_data").collection("products").get();o.products=d.docs.map(p=>lt(p.data())).sort((p,m)=>(m.id||0)-(p.id||0)),N("freshmart_products",JSON.stringify(o.products)),ye=!0,Ve()}else ye=!0;if(N("freshmart_cms_data",JSON.stringify(a)),N("freshmart_last_update",r.toString()),o.store&&(Ae(o.store.uiTheme,o.store.themeColor),Te(o.store.bgStyle,o.store.bgCustomUrl)),St(),K("stat-products",o.products.filter(d=>d.isActive!=="false"&&d.isActive!==!1).length),typeof ke=="function"?ke():typeof window.rDyn=="function"&&window.rDyn(),typeof W=="function"?W():typeof window.rCat=="function"&&window.rCat(),_e(),X(),(window.isAdm||window.__localIsAdm)&&typeof window.rAdmItms=="function"){const d=window.cTab||"products";["categories","vouchers","banners","brands","banks","colors"].includes(d)&&window.rAdmItms(d)}}catch(l){console.error("Gagal sinkron realtime settings:",l)}finally{if(et=!1,pe){const l=pe;pe=null,e(l)}}}};window._doSyncCmsData=e,window.unsubCmsRealtime=w.collection("freshmart").doc("cms_data").onSnapshot(async t=>{if(et){pe=t;return}await e(t)},t=>{console.warn("Realtime listener error:",t)})},Fs=()=>{if(window.unsubProductsRealtime)return;let e=!0;window.unsubProductsRealtime=w.collection("freshmart").doc("cms_data").collection("products").onSnapshot(t=>{if(e){e=!1,ye=!0,o.products=t.docs.map(r=>lt(r.data())).sort((r,s)=>(s.id||0)-(r.id||0)),N("freshmart_products",JSON.stringify(o.products)),Ve();return}let a=!1;t.docChanges().forEach(r=>{const s=lt(r.doc.data()),l=r.doc.id;if(r.type==="added"||r.type==="modified"){const n=o.products.findIndex(i=>(i.id!=null?i.id.toString():"")===l);n>-1?o.products[n]=s:(o.products.unshift(s),o.products.sort((i,d)=>(d.id||0)-(i.id||0))),a=!0}else if(r.type==="removed"){const n=o.products.findIndex(i=>(i.id!=null?i.id.toString():"")===l);n>-1&&(o.products.splice(n,1),a=!0)}}),a&&(N("freshmart_products",JSON.stringify(o.products)),Ve())},t=>{console.warn("Realtime products listener error:",t)})},Ks=()=>{if(!window.unsubRewardsRealtime){if(!o.rewards||!o.rewards.length)try{const e=JSON.parse(ce("freshmart_rewards")||"null");e&&Array.isArray(e)&&(o.rewards=e,o.rewards.forEach(t=>{t.img&&(t.img=j(t.img))}))}catch{}window.unsubRewardsRealtime=w.collection("freshmart").doc("cms_data").collection("rewards").onSnapshot(e=>{o.rewards=e.docs.map(a=>a.data()).sort((a,r)=>(r.id||0)-(a.id||0)),o.rewards.forEach(a=>{a.img&&(a.img=j(a.img))}),N("freshmart_rewards",JSON.stringify(o.rewards)),window.isAdm&&window.cTab==="rewards"&&typeof window.rAdmItms=="function"&&window.rAdmItms("rewards"),typeof window.renderRewardCatalog=="function"&&window.renderRewardCatalog();const t=document.getElementById("member-modal");t&&t.style.display==="flex"&&currentMember&&typeof window.rMemberModalBody=="function"&&window.rMemberModalBody()},e=>{console.warn("Realtime hadiah gagal:",e)})}},St=e=>{try{const t=o.store?.name||"Toko Putri",a=o.store?.logo||"",r=/^(https?:|data:)/i.test(a)?a:"https://placehold.co/192x192?text=Logo",s=document.documentElement.classList.contains("dark")?"#0b1120":"#ffffff",l=e||o.store?.themeColor||localStorage.getItem("freshmart_theme_color")||"#10b981";let n=document.getElementById("dynamic-manifest");n||(n=document.createElement("link"),n.id="dynamic-manifest",n.rel="manifest",document.head.appendChild(n));let i=document.getElementById("dynamic-apple-icon");i||(i=document.createElement("link"),i.id="dynamic-apple-icon",i.rel="apple-touch-icon",document.head.appendChild(i)),i.href=r;let d=document.getElementById("dynamic-favicon");d||(d=document.createElement("link"),d.id="dynamic-favicon",d.rel="icon",document.head.appendChild(d)),d.href=r;const p={id:window.location.origin+"/",name:t,short_name:t,description:o.store?.slogan||t+" - Belanja online lebih mudah",start_url:window.location.origin+"/",scope:window.location.origin+"/",lang:"id",dir:"ltr",display:"standalone",display_override:["standalone","minimal-ui"],orientation:"portrait",categories:["shopping","business"],background_color:s,theme_color:l,icons:[{src:r,sizes:"192x192",type:"image/png",purpose:"any"},{src:r,sizes:"512x512",type:"image/png",purpose:"any"}]};if(n.dataset.blobUrl)try{URL.revokeObjectURL(n.dataset.blobUrl)}catch{}const m=URL.createObjectURL(new Blob([JSON.stringify(p)],{type:"application/manifest+json"}));n.dataset.blobUrl=m,n.href=m}catch(t){console.error("PWA Manifest Update Error: ",t)}};window.loadAppData=Ns;window.saveApp=H;window.attachRealtimeStockSync=Os;window.attachRealtimeProductsSync=Fs;window.attachRewardsRealtime=Ks;window.updatePwaManifest=St;function Hs(e){if(!e)return"";const t=e.match(/\/d\/([a-zA-Z0-9_-]+)/);return t?`https://drive.google.com/file/d/${t[1]}/preview`:e}const Us=e=>window.pushModalHistory?.(e);window.oAAdd=()=>{window.oAEd($t||window.cTab||"products",null)};window.oAEd=(e,t)=>{Qe(e),typeof window.setCTab=="function"&&window.setCTab(e),window.cTab=e,aa(t),typeof window.setEId=="function"&&window.setEId(t),window.eId=t;let a=t!=null&&t!==""?(o[e]||[]).find(p=>p&&p.id!=null&&String(p.id)===String(t)):null;K("admin-modal-title",t?"Edit Data":"Tambah Data");let r=mt[e]||[],s="";e==="products"&&(Ye(a&&a.variants?JSON.parse(JSON.stringify(a.variants)):[]),Pt(a&&a.wholesale?JSON.parse(JSON.stringify(a.wholesale)):[]),At(a&&a.specTable?JSON.parse(JSON.stringify(a.specTable)):[]));const l=["textarea","richtext","variants_builder","wholesale_builder","spec_table_builder"],n=["img","desc","name","isActive","tag","poTime","video"],i=p=>l.includes(p.type)||n.includes(p.key);r.forEach(p=>{let m=a?p.type==="number"&&a[p.key]!==void 0?a[p.key]:a[p.key]||"":"";const u=i(p)?"lg:col-span-2":"";if(s+=`<div class="flex flex-col gap-1.5 ${u}"><label class="block text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest flex items-center gap-1.5">${p.label}</label>`,p.type==="textarea")s+=`<textarea autocomplete='off' id="af-${p.key}" class="admin-input resize-none shadow-sm bg-slate-50 dark:bg-slate-900" rows="3">${c(m)}</textarea>`;else if(p.type==="select")s+=`<div class="relative"><select id="af-${p.key}" class="admin-input shadow-sm cursor-pointer appearance-none pr-10 bg-slate-50 dark:bg-slate-900" onchange="if(window.rVarsB) window.rVarsB();">`,p.options.forEach(f=>{const h=String(m)===String(f.val);s+=`<option value="${f.val}" ${h?"selected":""} class="font-bold">${f.text}</option>`}),s+='</select><i class="fa-solid fa-chevron-down absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 pointer-events-none text-[10px]"></i></div>';else if(p.type==="dynamic_select_category")s+=`<div class="relative"><select id="af-${p.key}" class="admin-input shadow-sm cursor-pointer appearance-none pr-10 bg-slate-50 dark:bg-slate-900" onchange="if(window.rVarsB) window.rVarsB();"><option value="" class="font-bold">Pilih Kategori</option>`,o.categories.forEach(f=>{s+=`<option value="${c(f.name)}" ${m===f.name?"selected":""} class="font-bold">${c(f.name)}</option>`}),s+='</select><i class="fa-solid fa-chevron-down absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 pointer-events-none text-[10px]"></i></div>';else if(p.type==="dynamic_select_brand")s+=`<div class="relative"><select id="af-${p.key}" class="admin-input shadow-sm cursor-pointer appearance-none pr-10 bg-slate-50 dark:bg-slate-900" onchange="if(window.rVarsB) window.rVarsB();"><option value="" class="font-bold">Tanpa Merek</option>`,(o.brands||[]).forEach(f=>{s+=`<option value="${c(f.name)}" ${m===f.name?"selected":""} class="font-bold">${c(f.name)}</option>`}),s+='</select><i class="fa-solid fa-chevron-down absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 pointer-events-none text-[10px]"></i></div>';else if(p.type==="dynamic_select_products")s+=`<div class="relative"><select id="af-${p.key}" class="admin-input shadow-sm cursor-pointer appearance-none pr-10 bg-slate-50 dark:bg-slate-900" onchange="if(window.rVarsB) window.rVarsB();"><option value="" class="font-bold primary-text">-- Semua Produk (Tanpa Batasan) --</option>`,(o.products||[]).forEach(f=>{s+=`<option value="${f.id}" ${m==f.id?"selected":""} class="font-bold">${c(f.name)}</option>`}),s+='</select><i class="fa-solid fa-chevron-down absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 pointer-events-none text-[10px]"></i></div>';else if(p.type==="variants_builder")s+='<div id="variants-builder-container" class="bg-slate-50/50 dark:bg-slate-900/30 p-4 sm:p-5 md:p-6 lg:p-8 lg:p-6 rounded-[1.5rem] border border-slate-200 dark:border-slate-700 shadow-inner min-h-[60px]"></div>';else if(p.type==="wholesale_builder")s+='<div id="wholesale-builder-container" class="bg-slate-50/50 dark:bg-slate-900/30 p-4 sm:p-5 md:p-6 lg:p-8 lg:p-6 rounded-[1.5rem] border border-slate-200 dark:border-slate-700 shadow-inner min-h-[60px]"></div>';else if(p.type==="spec_table_builder")s+='<div id="spec-table-builder-container" class="bg-slate-50/50 dark:bg-slate-900/30 p-4 sm:p-5 md:p-6 rounded-[1.5rem] border border-slate-200 dark:border-slate-700 shadow-inner min-h-[60px]"></div>';else if(p.key==="subCategory"){const f=[...new Set((o.products||[]).map(h=>(h.subCategory||"").trim()).filter(Boolean))].sort();s+=`<div class="relative flex items-center">
                ...
                ${m?`<div class="rounded-xl overflow-hidden border border-slate-200 dark:border-slate-700 bg-black aspect-video w-full max-w-xs"><iframe src="${c(Hs(m))}" class="w-full h-full" frameborder="0" allow="autoplay; fullscreen" loading="lazy"></iframe></div>`:""}
...
>`;s+="</div>"}),s=`<div class="grid grid-cols-1 lg:grid-cols-2 gap-x-5 gap-y-5 items-start">${s}</div>`,$("admin-modal-form",s),e==="products"&&(window.rVarsB?.(),window.rWholB?.(),window.rSpecB?.());const d=k("admin-modal");d&&d.classList.contains("hidden")&&Us("admin"),O("admin-modal"),setTimeout(()=>{k("admin-modal").classList.remove("opacity-0"),k("admin-modal-box").classList.remove("scale-95")},10)};window.submitAdminForm=async()=>{if(we)return;B(!0);const e=$t||window.cTab||"products";let t={},a=mt[e]||[];for(let s of a)if(s.type==="variants_builder")t.variants=z.filter(l=>l.name.trim()!=="");else if(s.type==="wholesale_builder")t.wholesale=fe.filter(l=>parseFloat(l.minQty)>.01&&l.price>0);else if(s.type==="spec_table_builder")t.specTable=te.filter(l=>l.key.trim()!=="");else{let l="";if(s.type==="richtext"){const n=k(`af-${s.key}-editor`);l=n?n.innerHTML:""}else l=S(`af-${s.key}`);if(typeof l=="string"){if(l.startsWith("data:image/")&&l.length>3e5)return B(!1),b("Gambar Base64 terlalu besar! Upload file.");s.key==="img"&&(l=j(l))}t[s.key]=s.type==="number"?parseFloat(l)||0:l}if(!t.name&&!t.title&&!t.bankName&&!t.code)return B(!1),b("Judul/Nama/Kode wajib diisi!");if(e==="products"&&!t.sku&&(t.sku="SKU"+Date.now().toString().slice(-6)),e==="customers"){const s=window.normalizeWA?window.normalizeWA(t.phone):(t.phone||"").replace(/\D/g,"").replace(/^0/,"62");if(!s||s.length<10)return B(!1),b("Nomor WhatsApp tidak valid!");t.phone=s,t.points=parseFloat(t.points)||0,t.id=parseInt(s,10)}let r=null;if(e==="customers")if(o.customers||(o.customers=[]),Z){r=Z;let s=o.customers.findIndex(l=>l&&l.id!=null&&String(l.id)===String(Z));s>-1?o.customers[s]=t:o.customers.unshift(t)}else o.customers.unshift(t);else if(e==="rewards")if(o.rewards||(o.rewards=[]),Z){let s=o.rewards.findIndex(l=>l&&l.id!=null&&String(l.id)===String(Z));s>-1?(t.id=o.rewards[s].id,o.rewards[s]=t):t.id=Z}else t.id=Date.now(),o.rewards.unshift(t);else if(Z){o[e]||(o[e]=[]);let s=o[e].findIndex(l=>l&&l.id!=null&&String(l.id)===String(Z));if(s>-1){if(t.id=o[e][s].id,e==="products"){const l=o[e][s];t.totalSold=l.totalSold||0,t.variants&&t.variants.length&&l.variants&&t.variants.forEach(n=>{const i=l.variants.find(d=>d.name===n.name);i&&i.totalSold&&(n.totalSold=i.totalSold)})}o[e][s]=t}else t.id=Z,o[e].push(t)}else t.id=Date.now(),o[e]||(o[e]=[]),o[e].unshift(t);C("Menyimpan...");try{const s=typeof w<"u"&&w?w:window.db,l=typeof H=="function"?H:window.saveApp||(async()=>{});if(!s)throw new Error("Database Firebase belum terhubung");if(e==="products")await s.collection("freshmart").doc("cms_data").collection("products").doc(t.id.toString()).set(t),await l([],{updateType:"product_single",updatedProductIds:[t.id.toString()]});else if(e==="customers"){const n=s.collection("freshmart").doc("cms_data").collection("customers");r!==null&&r!==t.id&&await n.doc(r.toString()).delete().catch(()=>{}),await n.doc(t.phone).set(t,{merge:!0})}else e==="rewards"?await s.collection("freshmart").doc("cms_data").collection("rewards").doc(t.id.toString()).set(t):await l([e]);window.closeAdminModal?.(),window.rAdmItms?.(e),b("Tersimpan!")}catch(s){console.error("Gagal simpan admin data:",s),b("Gagal menyimpan: "+(s.message||""))}finally{B(!1),P()}};window.oADel=async(e,t)=>{window.showConfirm?.("Hapus Data","Data yang dihapus tidak bisa dikembalikan lagi.",async()=>{if(we)return;B(!0);const a=typeof w<"u"&&w?w:window.db,r=typeof H=="function"?H:window.saveApp||(async()=>{}),s=o[e]&&o[e].find(l=>l&&l.id!=null&&String(l.id)===String(t));o[e]=(o[e]||[]).filter(l=>!l||l.id==null||String(l.id)!==String(t)),C("Menghapus...");try{if(!a)throw new Error("Database Firebase belum terhubung");if(e==="products")await a.collection("freshmart").doc("cms_data").collection("products").doc(t.toString()).delete(),await r([],{updateType:"product_delete",updatedProductIds:[t.toString()]});else if(e==="customers"){const l=s?s.phone:t.toString();await a.collection("freshmart").doc("cms_data").collection("customers").doc(l).delete()}else e==="rewards"?await a.collection("freshmart").doc("cms_data").collection("rewards").doc(t.toString()).delete():await r([e]);window.rAdmItms?.(e),b("Berhasil Dihapus!")}catch(l){b("Gagal menghapus: "+(l.message||""))}finally{B(!1),P()}})};window.duplicateProduct=async e=>{window.showConfirm?.("Duplikat Produk","Menyalin data produk ini ke item baru?",async()=>{if(we)return;B(!0);const t=typeof w<"u"&&w?w:window.db,a=typeof H=="function"?H:window.saveApp||(async()=>{}),r=o.products.find(l=>l&&l.id!=null&&String(l.id)===String(e));if(!r){B(!1);return}let s=JSON.parse(JSON.stringify(r));s.id=Date.now()+Math.floor(Math.random()*1e3),s.name=s.name+" COPY",s.sku="",s.totalSold=0,s.variants&&s.variants.length>0&&(s.variants=s.variants.map(l=>(l.sku="",l.totalSold=0,l))),o.products.unshift(s),C("Menyalin...");try{if(!t)throw new Error("Database Firebase belum terhubung");await t.collection("freshmart").doc("cms_data").collection("products").doc(s.id.toString()).set(s),await a([],{updateType:"product_single",updatedProductIds:[s.id.toString()]}),window.rAdmItms?.("products"),b("Produk berhasil disalin!")}catch(l){b("Gagal menyalin: "+(l.message||""))}finally{B(!1),P()}},"Ya, Salin",!1)};window.rSpecB=()=>{const e=document.getElementById("spec-table-builder-container");if(!e)return;let t="";te.length>0?t+=`<div class="overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm mb-4">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-4">
        ...
        </div>`;a+="</div></div>",_openColorFloatModal(a)};window.importColorToVariant=(e,t)=>{z.push({name:e,price:0,priceNormal:0,hpp:0,stock:0,sku:"",img:"",unit:"",colorCode:t||"",poin:0,isActive:!0}),Ye(z),window.rVarsB(),_closeColorFloatModal(),b("Warna ditambahkan!")};window.exportVariantToColorDB=async e=>{const t=z[e];if(!t||!t.name.trim()){b("Nama varian kosong!");return}if((o.colors||[]).find(l=>l.name.toLowerCase()===t.name.trim().toLowerCase())){b(`"${t.name}" sudah ada di Database Warna.`);return}let s=[...new Set((o.colors||[]).map(l=>l.catalog).filter(Boolean))].map(l=>`<option value="${c(l)}">${c(l)}</option>`).join("");_openColorFloatModal(`
        <div class="p-6">
        ...
        </div>`)};window.confirmExportVariantToColorDB=async()=>{const e=(document.getElementById("exp-name")?.value||"").trim(),t=(document.getElementById("exp-hex")?.value||"").trim(),a=(document.getElementById("exp-catalog")?.value||"").trim();if(!e){b("Nama warna wajib diisi!");return}const r={id:Date.now(),name:e,hex:t,catalog:a};o.colors||(o.colors=[]),o.colors.push(r),_closeColorFloatModal(),C("Menyimpan ke Database Warna...");try{await H(["colors"]),b(`"${e}" berhasil disimpan ke Database Warna! 🎨`)}catch{b("Gagal menyimpan!")}finally{P()}};window.exportAllVariantsToColorDB=async()=>{const e=z.filter(r=>r.name.trim());if(!e.length){b("Tidak ada varian untuk diekspor!");return}o.colors||(o.colors=[]);let a=[...new Set(o.colors.map(r=>r.catalog).filter(Boolean))].map(r=>`<option value="${c(r)}">${c(r)}</option>`).join("");_openColorFloatModal(`
        <div class="p-6">
        ...
        </div>`)};window.confirmExportAllVariants=async()=>{const e=(document.getElementById("expall-catalog")?.value||"").trim(),t=z.filter(s=>s.name.trim());o.colors||(o.colors=[]);const a=new Set(o.colors.map(s=>s.name.toLowerCase()));let r=0;if(t.forEach(s=>{a.has(s.name.trim().toLowerCase())||(o.colors.push({id:Date.now()+r,name:s.name.trim(),hex:s.colorCode||"",catalog:e}),a.add(s.name.trim().toLowerCase()),r++)}),_closeColorFloatModal(),!r){b("Semua varian sudah ada di Database Warna!");return}C("Menyimpan...");try{await H(["colors"]),b(`${r} warna berhasil diekspor ke Database Warna! 🎨`)}catch{b("Gagal menyimpan!")}finally{P()}};window.openImportFromProductsModal=async()=>{const e=[];if((o.products||[]).forEach(l=>{(l.variants||[]).forEach(n=>{n.name&&n.name.trim()&&e.push({varName:n.name.trim(),hex:n.colorCode||"",prodName:l.name||""})})}),!e.length){b("Tidak ada varian produk yang ditemukan!");return}const t=new Set((o.colors||[]).map(l=>l.name.toLowerCase())),a=e.filter(l=>!t.has(l.varName.toLowerCase()));if(!a.length){b("Semua varian produk sudah ada di Database Warna!");return}let s=[...new Set((o.colors||[]).map(l=>l.catalog).filter(Boolean))].map(l=>`<option value="${c(l)}">${c(l)}</option>`).join("");window._pendingImportVariants=a,_openColorFloatModal(`
        <div class="p-6">
        ...
        </div>`)};window.confirmImportFromProducts=async()=>{const e=window._pendingImportVariants||[];window._pendingImportVariants=null;const t=(document.getElementById("impprod-catalog")?.value||"").trim();o.colors||(o.colors=[]);const a=new Set(o.colors.map(s=>s.name.toLowerCase()));let r=0;if(e.forEach((s,l)=>{const n=document.getElementById(`imp-chk-${l}`);n&&n.checked&&!a.has(s.varName.toLowerCase())&&(o.colors.push({id:Date.now()+r,name:s.varName,hex:s.hex||"",catalog:t}),a.add(s.varName.toLowerCase()),r++)}),_closeColorFloatModal(),!r){b("Tidak ada warna baru yang ditambahkan!");return}C("Menyimpan...");try{await H(["colors"]),b(`${r} warna berhasil diimpor ke Database Warna! 🎨`),window.cTab==="colors"&&window.rAdmItms?.("colors")}catch{b("Gagal menyimpan!")}finally{P()}};const Vs=e=>window.pushModalHistory?.(e),ea=(e,t,a)=>window.requestCloseModal?.(e,t,a);window.openRestockModal=e=>{const t=o.products.find(l=>l&&l.id!=null&&String(l.id)===String(e));if(!t)return;const a=t.variants&&t.variants.length>0;let r="";a?r=t.variants.map((l,n)=>`
        ...
        </div>`,s.style.opacity="0",s.style.display="flex",requestAnimationFrame(()=>{s.style.transition="opacity 0.25s ease",s.style.opacity="1"}),Vs("restock")};window.closeRestockModal=(e=!1)=>{ea("restock",e,()=>{const t=document.getElementById("restock-modal");!t||t.style.display==="none"||(t.style.opacity="0",t.style.transition="opacity 0.25s ease",setTimeout(()=>{t.style.display="none",t.style.opacity="",t.style.transition=""},250))})};window.processRestock=async e=>{if(we)return;B(!0);const t=o.products.findIndex(n=>n&&n.id!=null&&String(n.id)===String(e));if(t<0){B(!1);return}const a=o.products[t],r=a.variants&&a.variants.length>0;let s=JSON.parse(JSON.stringify(a)),l=0;if(r)s.variants=s.variants.map((i,d)=>{const p=parseFloat(document.getElementById("restock-var-"+d)?.value)||0;return p>0&&(i.stock=(parseFloat(i.stock)||0)+p,l+=p,i.stock>0&&(i.isActive===!1||i.isActive==="false")&&(i.isActive=!0)),i}),s.variants.some(i=>(parseFloat(i.stock)||0)>0&&i.isActive!==!1&&i.isActive!=="false")&&(s.isActive===!1||s.isActive==="false")&&(s.isActive="true");else{const n=parseFloat(document.getElementById("restock-main")?.value)||0;n>0&&(s.stock=(parseFloat(s.stock)||0)+n,l+=n,s.stock>0&&(s.isActive===!1||s.isActive==="false")&&(s.isActive="true"))}if(l<=0)return B(!1),b("Masukkan jumlah restock terlebih dahulu!");C("Menyimpan Restock...");try{const n=typeof w<"u"&&w?w:window.db,i=typeof H=="function"?H:window.saveApp||(async()=>{});if(!n)throw new Error("Database Firebase belum terhubung");const d=n.collection("freshmart").doc("cms_data").collection("products").doc(e.toString());let p=0;await n.runTransaction(async m=>{const u=await m.get(d);if(!u.exists)throw new Error("Produk tidak ditemukan di server");const f=JSON.parse(JSON.stringify(u.data()));if(r)a.variants.forEach((g,v)=>{const A=parseFloat(document.getElementById("restock-var-"+v)?.value)||0;if(A<=0)return;const T=(f.variants||[]).findIndex(y=>y.name===g.name);T>-1&&(f.variants[T].stock=(parseFloat(f.variants[T].stock)||0)+A,f.variants[T].stock>0&&(f.variants[T].isActive===!1||f.variants[T].isActive==="false")&&(f.variants[T].isActive=!0))}),f.variants.some(g=>(parseFloat(g.stock)||0)>0&&g.isActive!==!1&&g.isActive!=="false")&&(f.isActive===!1||f.isActive==="false")&&(f.isActive="true"),p=f.variants.reduce((g,v)=>g+(parseFloat(v.stock)||0),0);else{const h=parseFloat(document.getElementById("restock-main")?.value)||0;f.stock=(parseFloat(f.stock)||0)+h,f.stock>0&&(f.isActive===!1||f.isActive==="false")&&(f.isActive="true"),p=f.stock}m.set(d,f),Object.assign(s,f)}),o.products[t]=s,await i([],{updateType:"stock_change",updatedProductIds:[e.toString()]}),closeRestockModal(),window.rAdmItms?.("products"),K("stat-products",o.products.filter(m=>m.isActive!=="false"&&m.isActive!==!1).length),b(`✅ Restock +${l} berhasil! Total stok: ${p}`)}catch(n){b("Gagal restock: "+(n.message||""))}finally{B(!1),P()}};window.toggleProductStatus=async(e,t)=>{if(we)return;B(!0);const a=o.products.findIndex(r=>r.id!=null&&r.id.toString()===e.toString());if(a>-1){o.products[a].isActive=t?"true":"false",C(t?"Mengaktifkan...":"Menonaktifkan...");try{const r=typeof w<"u"&&w?w:window.db,s=typeof H=="function"?H:window.saveApp||(async()=>{});if(!r)throw new Error("Database Firebase belum terhubung");await r.collection("freshmart").doc("cms_data").collection("products").doc(e.toString()).update({isActive:t?"true":"false"}),await s([],{updateType:"stock_change",updatedProductIds:[e.toString()]}),K("stat-products",o.products.filter(l=>l.isActive!=="false"&&l.isActive!==!1).length),window.rAdmItms?.("products"),b(t?"Produk Aktif!":"Stok Dikosongkan!")}catch(r){b("Gagal update status: "+(r.message||""))}finally{B(!1),P()}}else B(!1)};window.closeAdminModal=(e=!1)=>{ea("admin",e,()=>{k("admin-modal").classList.add("opacity-0"),k("admin-modal-box").classList.add("scale-95"),setTimeout(()=>F("admin-modal"),300)})};const Gs=e=>window.pushModalHistory?.(e),qs=(e,t,a)=>window.requestCloseModal?.(e,t,a);let U;window.openCameraScanner=async(e="search-input")=>{const t=k("scanner-modal");t&&t.classList.contains("hidden")&&Gs("scanner"),O("scanner-modal"),setTimeout(()=>{k("scanner-modal").classList.remove("opacity-0")},10);try{await Ot("https://cdnjs.cloudflare.com/ajax/libs/html5-qrcode/2.3.8/html5-qrcode.min.js",()=>typeof Html5Qrcode<"u")}catch{b("Gagal memuat modul kamera. Cek koneksi internet Anda."),closeCameraScanner();return}U||(U=new Html5Qrcode("reader"));const a={fps:10,qrbox:{width:250,height:250}};setTimeout(()=>{U&&U.start({facingMode:"environment"},a,r=>{let s=k(e);s&&(s.value=r,e==="search-input"?window.handleSearch?.(r):(s.dispatchEvent(new Event("input",{bubbles:!0})),s.dispatchEvent(new Event("change",{bubbles:!0})))),b("Barcode discan!"),closeCameraScanner()},r=>{}).catch(r=>{b("Akses kamera ditolak/gagal!"),closeCameraScanner()})},100)};window.closeCameraScanner=(e=!1)=>{qs("scanner",e,()=>{if(k("scanner-modal").classList.add("opacity-0"),U)try{U.getState()===2||U.getState()===3?U.stop().then(()=>{U.clear(),U=null}).catch(t=>{U.clear(),U=null}):(U.clear(),U=null)}catch{U=null}setTimeout(()=>F("scanner-modal"),300)})};const Ws=e=>window.pushModalHistory?.(e),zs=(e,t,a)=>window.requestCloseModal?.(e,t,a);let Oe=[];window.openQuickPriceModal=e=>{const t=o.products.find(l=>l&&l.id!=null&&String(l.id)===String(e));if(!t)return;const a=t.variants&&t.variants.length>0;Oe=!a&&t.wholesale?JSON.parse(JSON.stringify(t.wholesale)):[];let r="";a?r=t.variants.map((l,n)=>`
        ...
        </div>`,a||rQpWhol(),s.style.opacity="0",s.style.display="flex",requestAnimationFrame(()=>{s.style.transition="opacity 0.25s ease",s.style.opacity="1"}),Ws("quickprice")};window.rQpWhol=()=>{$("qp-whol-container",Oe.length?Oe.map((e,t)=>`
        <div class="flex items-center gap-2">
        ...
        </div>`).join(""):'<p class="text-[11px] font-bold text-slate-400 text-center py-2">Belum ada tingkat harga grosir.</p>')};window.qpAddWhol=()=>{Oe.push({minQty:0,price:0}),rQpWhol()};window.closeQuickPriceModal=(e=!1)=>{zs("quickprice",e,()=>{const t=document.getElementById("quickprice-modal");!t||t.style.display==="none"||(t.style.opacity="0",t.style.transition="opacity 0.25s ease",setTimeout(()=>{t.style.display="none",t.style.opacity="",t.style.transition=""},250))})};window.processQuickPrice=async e=>{if(we)return;B(!0);const t=o.products.findIndex(s=>s&&s.id!=null&&String(s.id)===String(e));if(t<0){B(!1);return}const a=o.products[t],r=a.variants&&a.variants.length>0;C("Menyimpan Harga...");try{const s=typeof w<"u"&&w?w:window.db,l=typeof H=="function"?H:window.saveApp||(async()=>{});if(!s)throw new Error("Database Firebase belum terhubung");const n=s.collection("freshmart").doc("cms_data").collection("products").doc(e.toString());let i=null;await s.runTransaction(async d=>{const p=await d.get(n);if(!p.exists)throw new Error("Produk tidak ditemukan di server");const m=JSON.parse(JSON.stringify(p.data()));r?a.variants.forEach((u,f)=>{const h=(m.variants||[]).findIndex(g=>g.name===u.name);h<0||(m.variants[h].hpp=parseFloat(document.getElementById("qp-var-hpp-"+f)?.value)||0,m.variants[h].price=parseFloat(document.getElementById("qp-var-price-"+f)?.value)||0,m.variants[h].priceNormal=parseFloat(document.getElementById("qp-var-normal-"+f)?.value)||0,m.variants[h].poin=parseFloat(document.getElementById("qp-var-poin-"+f)?.value)||0)}):(m.hpp=parseFloat(document.getElementById("qp-hpp")?.value)||0,m.price=parseFloat(document.getElementById("qp-price")?.value)||0,m.priceNormal=parseFloat(document.getElementById("qp-normal")?.value)||0,m.poin=parseFloat(document.getElementById("qp-poin")?.value)||0,m.wholesale=Oe.filter(u=>parseFloat(u.minQty)>.01&&u.price>0)),d.set(n,m),i=m}),o.products[t]=i,await l([],{updateType:"stock_change",updatedProductIds:[e.toString()]}),closeQuickPriceModal(),window.rAdmItms?.("products"),b("✅ Harga berhasil diperbarui!")}catch(s){b("Gagal simpan harga: "+(s.message||""))}finally{B(!1),P()}};window.rWholB=()=>{let e=`<div class="space-y-4 mb-4">${fe.map((a,r)=>`
        ...
        <button onclick="addWhol()" class="w-full py-4 bg-amber-50 dark:bg-amber-900/20 text-amber-600 font-bold rounded-[1.5rem] text-sm border-2 border-amber-200 border-dashed hover:bg-amber-100 transition-all flex items-center justify-center gap-2 active:scale-95 shadow-sm"><i class="fa-solid fa-tags"></i> Tambah Tingkatan Grosir</button>`;const t=document.getElementById("wholesale-builder-container");t&&(t.innerHTML=e)};window.addWhol=()=>{fe.push({minQty:2,price:0}),Pt(fe),window.rWholB()};window.rmWhol=e=>{fe.splice(e,1),Pt(fe),window.rWholB()};window.uWhol=(e,t,a)=>{fe[e][t]=parseFloat(a)||0};let $t="products";const Qe=e=>{$t=e,window.cTab=e};let ta="";const Js=e=>{ta=e,window.aSq=e};let Z=null;const aa=e=>{Z=e,window.eId=e};let we=!1;const B=e=>{we=e};let z=[];const Ye=e=>{z=e};let fe=[];const Pt=e=>{fe=e};let te=[];const At=e=>{te=e};window.setCTab=Qe;window.setASq=Js;window.setEId=aa;const Qs=(e,t=!1)=>{const a=document.querySelector("#view-admin .scroll-content");if(a&&(a.scrollTop=0),ha(e),ka(""),!t){const s=history.state;s&&s.view==="view-admin"&&s.tab?history.replaceState({view:"view-admin",tab:e},"",window.location.href):history.pushState({view:"view-admin",tab:e},"",window.location.href)}if(F("admin-dashboard-view"),O("admin-content-view"),O("btn-admin-back"),F("admin-logo-box"),K("admin-header-title",{orders:"Pesanan",settings:"Toko",products:"Produk",categories:"Kategori",brands:"Merek",banks:"Rekening",banners:"Banner",vouchers:"Voucher",customers:"Database Pelanggan",rewards:"Program Hadiah",reviews:"Ulasan Pelanggan",faqs:"Tanya Jawab / Q&A",tax:"Pajak & Keuangan",piutang:"Piutang Tempo",colors:"Database Warna",changelog:"Log Pembaruan Sistem"}[e]||"CMS"),e!=="orders"&&be&&(be(),Ee(null)),e!=="customers"&&me&&(me(),Me(null)),e!=="reviews"&&ue&&(ue(),Be(null)),e==="settings")typeof window.rAdmSet=="function"&&window.rAdmSet();else if(e==="orders")typeof window.rAdmOrd=="function"&&window.rAdmOrd();else if(e==="tax")typeof window.rTaxPanel=="function"&&window.rTaxPanel();else if(e==="piutang")typeof window.rAdmPiutang=="function"&&window.rAdmPiutang();else if(e==="customers"){$("admin-content",'<div class="text-center py-16"><i class="fa-solid fa-spinner fa-spin text-3xl text-slate-300"></i></div>'),me&&(me(),Me(null));const s=w.collection("freshmart").doc("cms_data").collection("customers").onSnapshot(l=>{o.customers=l.docs.map(n=>n.data()),typeof window.rAdmL=="function"&&window.rAdmL("customers")},()=>{b("Gagal memuat data pelanggan!"),typeof window.rAdmL=="function"&&window.rAdmL("customers")});Me(s)}else if(e==="reviews"){$("admin-content",'<div class="text-center py-16"><i class="fa-solid fa-spinner fa-spin text-3xl text-slate-300"></i></div>'),ue&&(ue(),Be(null));const s=w.collection("freshmart").doc("cms_data").collection("reviews").onSnapshot(l=>{const n=l.docs.map(i=>i.data());n.sort((i,d)=>{const p=i.createdAt&&i.createdAt.toMillis?i.createdAt.toMillis():0;return(d.createdAt&&d.createdAt.toMillis?d.createdAt.toMillis():0)-p}),xa(n),typeof window.rAdmReviews=="function"&&window.rAdmReviews()},()=>{b("Gagal memuat ulasan!")});Be(s)}else e==="faqs"?typeof window.rAdmFAQ=="function"&&window.rAdmFAQ():e==="changelog"?typeof window.rAdmChangelog=="function"&&window.rAdmChangelog():typeof window.rAdmL=="function"&&window.rAdmL(e)};window.openAdminTab=Qs;let De="all";const Ys=e=>{if(!e)return"";try{const t=e.split("-");return t.length===3?new Date(parseInt(t[0]),parseInt(t[1])-1,parseInt(t[2])).toLocaleDateString("id-ID",{day:"numeric",month:"short",year:"numeric"}):e}catch{return e}},Xs=e=>{switch(e){case"feature":return{label:"Fitur Baru",icon:"fa-rocket",colorClass:"bg-slate-100 dark:bg-slate-800/90 text-slate-700 dark:text-slate-300 border-slate-200/80 dark:border-slate-700/80",iconColor:"text-[var(--color-primary)]"};case"optimization":return{label:"Optimasi",icon:"fa-bolt-lightning",colorClass:"bg-slate-100 dark:bg-slate-800/90 text-slate-700 dark:text-slate-300 border-slate-200/80 dark:border-slate-700/80",iconColor:"text-[var(--color-primary)]"};case"maintenance":return{label:"Maintenance",icon:"fa-wrench",colorClass:"bg-slate-100 dark:bg-slate-800/90 text-slate-700 dark:text-slate-300 border-slate-200/80 dark:border-slate-700/80",iconColor:"text-[var(--color-primary)]"};case"bugfix":return{label:"Perbaikan",icon:"fa-bug-slash",colorClass:"bg-slate-100 dark:bg-slate-800/90 text-slate-700 dark:text-slate-300 border-slate-200/80 dark:border-slate-700/80",iconColor:"text-[var(--color-primary)]"};default:return{label:"Update",icon:"fa-tag",colorClass:"bg-slate-100 dark:bg-slate-800/90 text-slate-700 dark:text-slate-300 border-slate-200/80 dark:border-slate-700/80",iconColor:"text-[var(--color-primary)]"}}},Zs=()=>{const e=k("changelog-items-container");if(!e)return;const t=wt(o),a=De==="all"?t:t.filter(s=>s.category===De);if(a.length===0){e.innerHTML=`
        ...
        </div>`;return}let r="";a.forEach((s,l)=>{const n=l===0&&De==="all",i=Xs(s.category),d=Ys(s.date),p=(s.items||[]).map(m=>`
        ...
        </div>`,document.body.appendChild(t));const a=yt(o),r=k("changelog-header-ver");r&&(r.textContent=a),De=e,sa(e),t.style.display="flex",requestAnimationFrame(()=>{t.classList.remove("opacity-0");const s=k("changelog-modal-box");s&&s.classList.remove("translate-y-full","sm:translate-y-8")})},ra=()=>{const e=k("changelog-modal");if(!e||e.style.display==="none")return;e.classList.add("opacity-0");const t=k("changelog-modal-box");t&&t.classList.add("translate-y-full","sm:translate-y-8"),setTimeout(()=>{e.style.display="none"},300)};window.openChangelogModal=er;window.closeChangelogModal=ra;window.filterChangelog=sa;let Pe=!1,Se=null;const Tt=()=>{const e=new Date,t=e.getFullYear(),a=String(e.getMonth()+1).padStart(2,"0"),r=String(e.getDate()).padStart(2,"0");return`${t}-${a}-${r}`},tr=e=>{if(!e)return"";try{const t=e.split("-");return t.length===3?new Date(parseInt(t[0]),parseInt(t[1])-1,parseInt(t[2])).toLocaleDateString("id-ID",{day:"numeric",month:"short",year:"numeric"}):e}catch{return e}},Ke=()=>{const e=k("admin-content");if(!e)return;const t=o.changelog||[],a=wt(o),r=yt(o);let s="";a.length===0?s=`
        ...
        </div>`:s=a.map(l=>{const n=t.some(u=>u.id===l.id),i=l.version===r,d=(l.items||[]).map(u=>`
                ...
                <div class="flex flex-wrap items-center justify-between gap-2 border-b border-slate-100 dark:border-slate-800 pb-3">
                    ...
                    <div class="flex items-center gap-2">
                        <span class="text-[10px] font-bold text-slate-400 dark:text-slate-500">
                            <i class="fa-regular fa-calendar mr-1"></i> ${c(tr(l.date))}
                        </span>
                        ${n?`
    ...
    <div class="max-w-4xl mx-auto space-y-6 pb-12">
        ...
        <div id="changelog-form-box" class="${Pe?"block":"hidden"} p-5 sm:p-6 rounded-2xl bg-white dark:bg-slate-900 border-2 border-[var(--color-primary)]/40 shadow-lg space-y-4">
    ...
    </div>`},ar=(e=null)=>{Pe=e!==null?e:!Pe,Pe||(Se=null),Ke()},sr=e=>{const t=(o.changelog||[]).find(s=>s.id===e);if(!t)return;Se=e,Pe=!0,Ke(),se("form-log-version",t.version||""),se("form-log-category",t.category||"feature"),se("form-log-date",t.date||Tt()),se("form-log-title",t.title||""),se("form-log-items",(t.items||[]).join(`
`));const a=k("changelog-form-title");a&&(a.innerHTML=`<i class="fa-solid fa-pen text-[var(--color-primary)]"></i> Edit Catatan Pembaruan (${c(t.version)})`);const r=k("changelog-form-box");r&&r.scrollIntoView({behavior:"smooth"})},rr=async()=>{const e=(S("form-log-version")||"").trim(),t=S("form-log-category")||"feature",a=S("form-log-date")||Tt(),r=(S("form-log-title")||"").trim(),s=(S("form-log-items")||"").trim();if(!e)return b("Nomor versi harus diisi (contoh: v1.2.1)!");if(!r)return b("Judul pembaruan harus diisi!");if(!s)return b("Tuliskan minimal 1 poin rincian perubahan!");const l=s.split(`
`).map(i=>i.replace(/^[-*•]\s*/,"").trim()).filter(i=>i.length>0);if(l.length===0)return b("Rincian perubahan tidak boleh kosong!");C("Menyimpan catatan pembaruan...");const n={id:Se||"log-"+Date.now().toString(36),version:e.startsWith("v")?e:"v"+e,category:t,date:a,title:r,items:l,updatedAt:new Date().toISOString()};if(o.changelog=o.changelog||[],Se){const i=o.changelog.findIndex(d=>d.id===Se);i!==-1?o.changelog[i]=n:o.changelog.unshift(n)}else o.changelog.unshift(n);try{await H(["changelog"]),b("Catatan pembaruan berhasil dipublikasikan secara real-time!","success"),Pe=!1,Se=null,Ke()}catch(i){b("Gagal menyimpan log pembaruan: "+i.message,"error")}finally{P()}},or=e=>{const t=(o.changelog||[]).find(a=>a.id===e);t&&ve(`Hapus catatan pembaruan versi "${t.version}"?`,async()=>{C("Menghapus catatan..."),o.changelog=(o.changelog||[]).filter(a=>a.id!==e);try{await H(["changelog"]),b("Catatan berhasil dihapus!","success"),Ke()}catch(a){b("Gagal menghapus catatan: "+a.message,"error")}finally{P()}},"Ya, Hapus","Konfirmasi Hapus")};window.rAdmChangelog=Ke;window.toggleChangelogForm=ar;window.editChangelogEntry=sr;window.saveChangelogEntry=rr;window.deleteChangelogEntry=or;export{Pa as A,$e as a,Ae as b,Te as c,w as d,Ns as e,Os as f,Fs as g,Aa as h,cr as i,Ks as j,q as k,dr as l,Kt as m,Ut as n,We as o,qe as p,Ft as q,_e as r,rs as s,pr as t,X as u,mr as v,Yt as w};
