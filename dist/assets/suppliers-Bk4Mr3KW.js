import"./module-member-HotrGCGL.js";import{a as p,e as c,b as $,f as x,i as s,al as T,am as B,z as P,G as D,a3 as M,a1 as g,u as f,v as E,t as R}from"./module-print-DdyfBoO_.js";import{o as j}from"./module-admin-DRwfDrQA.js";import"./vendor-firebase-core-D2OF5R23.js";import"./vendor-firebase-db-BIUZcnOd.js";import"./module-faq-BYruayZT.js";const A=()=>{const e=document.querySelector("#admin-content #modal-supplier-detail");e&&e.remove();const r=document.querySelector("#admin-content #modal-supplier-form");if(r&&r.remove(),!c("modal-supplier-detail")){const a=document.createElement("div");a.id="modal-supplier-detail",a.className="fixed inset-0 z-[150] flex hidden items-end sm:items-center justify-center p-0 sm:p-4 bg-slate-950/40 backdrop-blur-sm opacity-0 transition-opacity duration-300",a.onclick=t=>{t.target===a&&window.closeSupplierDetailModal?.()},a.innerHTML=`
        ...
        `,document.body.appendChild(a)}if(!c("modal-supplier-form")){const a=document.createElement("div");a.id="modal-supplier-form",a.className="fixed inset-0 z-[150] flex hidden items-end sm:items-center justify-center p-0 sm:p-4 bg-slate-950/40 backdrop-blur-sm opacity-0 transition-opacity duration-300",a.onclick=t=>{t.target===a&&window.closeSupplierFormModal?.()},a.innerHTML=`
        ...
        `,document.body.appendChild(a)}};let S="",k="all",N=null,m="products";const O=e=>{if(!e)return"-";try{return new Date(e).toLocaleDateString("id-ID",{day:"numeric",month:"short",year:"numeric"})}catch{return e}},C=()=>{const e=p.suppliers||[],r=p.products||[],a=p.purchases||[],t=e.length,l=r.filter(d=>d.supplierId&&e.some(n=>String(n.id)===String(d.supplierId))).length,o=a.reduce((d,n)=>{if(n.paymentType==="tempo"&&n.paymentStatus!=="lunas"){const b=(parseFloat(n.total)||0)-(parseFloat(n.amountPaid)||0);return d+(b>0?b:0)}return d},0),i=a.filter(d=>d.status==="ordered").length;return{totalSuppliers:t,linkedProductsCount:l,totalOutstandingDebt:o,activePurchasesCount:i}},v=()=>{if(A(),!c("admin-content"))return;const r=C(),a=p.suppliers||[],t=S.toLowerCase().trim();let l=a.filter(o=>!t||(o.name||"").toLowerCase().includes(t)||(o.code||"").toLowerCase().includes(t)||(o.salesName||"").toLowerCase().includes(t)||(o.phone||"").includes(t)||(o.address||"").toLowerCase().includes(t)?k==="has_debt"?(p.purchases||[]).some(n=>String(n.supplierId)===String(o.id)&&n.paymentType==="tempo"&&n.paymentStatus!=="lunas"&&(parseFloat(n.total)||0)-(parseFloat(n.amountPaid)||0)>0):!0:!1);$("admin-content",`
            ...
            <div class="relative overflow-hidden p-5 sm:p-7 rounded-2xl sm:rounded-3xl border border-[rgba(var(--color-primary-rgb),0.2)] bg-gradient-to-br from-white via-white to-[rgba(var(--color-primary-rgb),0.05)] dark:from-slate-900 dark:via-slate-900/90 dark:to-slate-800 shadow-xs">
                ...
                <div class="mt-6 pt-5 border-t border-[rgba(var(--color-primary-rgb),0.15)] dark:border-slate-700/60 grid grid-cols-2 lg:grid-cols-4 gap-3">
                    ...
                    <div class="p-3.5 sm:p-4 rounded-2xl bg-white/95 dark:bg-slate-800/80 border border-slate-200/90 dark:border-slate-700/80 shadow-2xs backdrop-blur-xs flex flex-col justify-between">
                        ...
                        <p class="text-lg sm:text-xl font-black text-amber-600 dark:text-amber-400 tracking-tight">${x(r.totalOutstandingDebt)}</p>
    ...
    `)},I=e=>{const r=p.products||[],a=p.purchases||[],t=r.filter(n=>String(n.supplierId)===String(e.id)),o=a.filter(n=>String(n.supplierId)===String(e.id)).reduce((n,b)=>{if(b.paymentType==="tempo"&&b.paymentStatus!=="lunas"){const u=(parseFloat(b.total)||0)-(parseFloat(b.amountPaid)||0);return n+(u>0?u:0)}return n},0),i={cash:"Cash / Tunai",tempo_7:"Tempo 7 Hari",tempo_14:"Tempo 14 Hari",tempo_30:"Tempo 30 Hari",tempo_60:"Tempo 60 Hari",konsinyasi:"Konsinyasi (Titip Jual)"},d=e.phone?T(e.phone):"";return`
                    ...
                    <div class="flex items-center gap-4 text-right">
                        <div class="text-left md:text-right">
                            ...
                            <span class="text-xs sm:text-sm font-black text-slate-700 dark:text-slate-200">
                                <b class="text-teal-600 dark:text-teal-400">${t.length}</b> Macam
                            </span>
                        </div>
    ...
    `};window.handleSupplierSearch=e=>{S=e||"",v()};window.toggleSupplierFilter=()=>{k=k==="all"?"has_debt":"all",v()};window.openSupplierWhatsApp=(e,r,a)=>{const l=`${a?`Halo Pak/Bu ${a}`:`Halo Tim Sales ${r}`} dari *${p.store?.name||"Toko Putri"}*.
Kami ingin menanyakan ketersediaan stok & mengajukan order barang. Mohon info update pricelist / ketersediaan barang ya. Terima kasih! 🙏`;B(e,l)};window.openSupplierFormModal=(e=null)=>{A();const r=p.suppliers||[],a=!!e,t=a?r.find(d=>String(d.id)===String(e))||{}:{code:"SUP-"+Math.floor(100+Math.random()*900),defaultTerms:"tempo_14"},l=c("modal-supplier-form"),o=c("modal-supplier-form-box"),i=c("modal-supplier-form-content");!l||!i||($("modal-supplier-form-content",`
        ...
        <div class="px-5 sm:px-6 pt-3 sm:pt-5 pb-4 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between shrink-0 bg-slate-50/70 dark:bg-slate-900/60">
            <div class="flex items-center gap-3">
                <div class="w-11 h-11 rounded-2xl flex items-center justify-center text-lg shrink-0 aspect-square shadow-xs" style="background: rgba(var(--color-primary-rgb), 0.12); color: var(--color-primary); border: 1px solid rgba(var(--color-primary-rgb), 0.25);">
                    <i class="fa-solid ${a?"fa-pen-to-square":"fa-truck-field"}"></i>
                </div>
                <div>
                    <h3 class="font-black text-base sm:text-lg text-slate-800 dark:text-white tracking-tight">${a?"Edit Data Rekanan / Supplier":"Daftarkan Supplier Baru"}</h3>
        ...
        <form id="supplier-editor-form" onsubmit="window.saveSupplierForm(event, '${a?t.id:""}')" class="flex-1 flex flex-col overflow-hidden">
            <div class="hide-scrollbar p-5 sm:p-6 overflow-y-auto flex-1 space-y-4">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" id="sf-name" required value="${s(t.name||"")}" placeholder="Contoh: PT Semen Gresik Abadi" class="admin-input bg-slate-50/90 dark:bg-slate-800/60 border border-slate-200/90 dark:border-slate-700/80 rounded-xl">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="sf-code" value="${s(t.code||"")}" placeholder="Contoh: SUP-SGA" class="admin-input bg-slate-50/90 dark:bg-slate-800/60 border border-slate-200/90 dark:border-slate-700/80 rounded-xl font-mono">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="sf-salesName" value="${s(t.salesName||"")}" placeholder="Nama kontak sales lapangan" class="admin-input bg-slate-50/90 dark:bg-slate-800/60 border border-slate-200/90 dark:border-slate-700/80 rounded-xl">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="tel" id="sf-phone" required value="${s(t.phone||"")}" placeholder="Contoh: 081234567890" class="admin-input bg-slate-50/90 dark:bg-slate-800/60 border border-slate-200/90 dark:border-slate-700/80 rounded-xl">
                    </div>
                    ...
                    <div>
                        ...
                        <select id="sf-defaultTerms" class="admin-input bg-slate-50/90 dark:bg-slate-800/60 border border-slate-200/90 dark:border-slate-700/80 rounded-xl cursor-pointer font-bold">
                            <option value="cash" ${t.defaultTerms==="cash"?"selected":""}>Cash / Tunai Saat Kirim</option>
                            <option value="tempo_7" ${t.defaultTerms==="tempo_7"?"selected":""}>Tempo 7 Hari</option>
                            <option value="tempo_14" ${t.defaultTerms==="tempo_14"?"selected":""}>Tempo 14 Hari (2 Minggu)</option>
                            <option value="tempo_30" ${t.defaultTerms==="tempo_30"?"selected":""}>Tempo 30 Hari (1 Bulan)</option>
                            <option value="tempo_60" ${t.defaultTerms==="tempo_60"?"selected":""}>Tempo 60 Hari</option>
                            <option value="konsinyasi" ${t.defaultTerms==="konsinyasi"?"selected":""}>Konsinyasi (Titip Jual Laku Bayar)</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="email" id="sf-email" value="${s(t.email||"")}" placeholder="sales@perusahaan.com" class="admin-input bg-slate-50/90 dark:bg-slate-800/60 border border-slate-200/90 dark:border-slate-700/80 rounded-xl">
                    </div>
                </div>
                ...
                <div class="p-4 rounded-2xl bg-slate-50/80 dark:bg-slate-800/40 border border-slate-200/90 dark:border-slate-700/60 space-y-3">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                        <div>
                            ...
                            <input type="text" id="sf-bankName" value="${s(t.bankName||"")}" placeholder="BCA / Mandiri / BRI" class="admin-input bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl">
                        </div>
                        <div>
                            <label class="block text-[9px] font-bold uppercase text-slate-400 mb-1">Nomor Rekening</label>
                            <input type="text" id="sf-bankAccount" value="${s(t.bankAccount||"")}" placeholder="1234567890" class="admin-input bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl font-mono">
                        </div>
                        <div>
                            <label class="block text-[9px] font-bold uppercase text-slate-400 mb-1">Atas Nama (A/N)</label>
                            <input type="text" id="sf-bankHolder" value="${s(t.bankHolder||"")}" placeholder="PT / Nama Pemilik" class="admin-input bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl">
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea id="sf-address" rows="2" placeholder="Alamat lengkap supplier..." class="admin-input bg-slate-50/90 dark:bg-slate-800/60 border border-slate-200/90 dark:border-slate-700/80 rounded-xl resize-none">${s(t.address||"")}</textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea id="sf-notes" rows="2" placeholder="Minimal order 50 sak, jadwal kirim tiap hari Selasa & Kamis..." class="admin-input bg-slate-50/90 dark:bg-slate-800/60 border border-slate-200/90 dark:border-slate-700/80 rounded-xl resize-none">${s(t.notes||"")}</textarea>
                </div>
            </div>
    ...
    `),P(l,o))};window.closeSupplierFormModal=()=>{const e=c("modal-supplier-form"),r=c("modal-supplier-form-box");e&&D(e,r)};window.saveSupplierForm=async(e,r)=>{e.preventDefault(),M("Menyimpan Data Supplier...");try{const a=(c("sf-name")?.value||"").trim(),t=(c("sf-code")?.value||"").trim(),l=(c("sf-salesName")?.value||"").trim();let o=(c("sf-phone")?.value||"").trim();const i=c("sf-defaultTerms")?.value||"tempo_14",d=(c("sf-email")?.value||"").trim(),n=(c("sf-bankName")?.value||"").trim(),b=(c("sf-bankAccount")?.value||"").trim(),u=(c("sf-bankHolder")?.value||"").trim(),h=(c("sf-address")?.value||"").trim(),L=(c("sf-notes")?.value||"").trim();if(!a)return g(),f("Nama supplier wajib diisi!");o&&(o=T(o)),p.suppliers||(p.suppliers=[]);const w={id:r||"sup_"+Date.now().toString(36)+"_"+Math.random().toString(36).substring(2,6),name:a,code:t,salesName:l,phone:o,defaultTerms:i,email:d,bankName:n,bankAccount:b,bankHolder:u,address:h,notes:L,updatedAt:new Date().toISOString()};if(!r)w.createdAt=new Date().toISOString(),p.suppliers.unshift(w);else{const y=p.suppliers.findIndex(F=>String(F.id)===String(r));y>-1?p.suppliers[y]={...p.suppliers[y],...w}:p.suppliers.push(w)}await j(["suppliers"]),g(),window.closeSupplierFormModal(),f(r?"Data supplier diperbarui! ✨":"Supplier baru berhasil ditambahkan! 🎉"),v()}catch(a){g(),console.error("Gagal menyimpan supplier:",a),f("Gagal menyimpan: "+(a.message||""))}};window.deleteSupplier=e=>{const a=(p.suppliers||[]).find(i=>String(i.id)===String(e));if(!a)return;const t=(p.products||[]).filter(i=>String(i.supplierId)===String(e)),l=(p.purchases||[]).filter(i=>String(i.supplierId)===String(e));let o=`Hapus supplier <b>${s(a.name)}</b>?`;t.length>0&&(o+=`<br><span class="text-amber-500 font-bold text-xs mt-1 block">Perhatian: Ada ${t.length} produk di etalase yang terhubung ke supplier ini. Link supplier pada produk tersebut akan dilepas.</span>`),l.length>0&&(o+=`<br><span class="text-rose-500 font-bold text-xs mt-1 block">Terdapat ${l.length} riwayat pesanan kulakan (PO) terkait supplier ini.</span>`),E("Hapus Supplier",o,async()=>{M("Menghapus...");try{p.suppliers=(p.suppliers||[]).filter(d=>String(d.id)!==String(e));let i=!1;(p.products||[]).forEach(d=>{String(d.supplierId)===String(e)&&(delete d.supplierId,i=!0)}),await j(i?["suppliers","products"]:["suppliers"]),g(),f("Supplier berhasil dihapus."),v()}catch(i){g(),console.error("Gagal menghapus supplier:",i),f("Gagal menghapus: "+i.message)}},"Hapus Permanen")};window.openSupplierDetailModal=(e,r="products")=>{A(),N=e,m=r;const t=(p.suppliers||[]).find(d=>String(d.id)===String(e));if(!t)return f("Supplier tidak ditemukan!");const l=c("modal-supplier-detail"),o=c("modal-supplier-detail-box"),i=c("modal-supplier-detail-content");!l||!i||(H(t),P(l,o))};window.closeSupplierDetailModal=()=>{const e=c("modal-supplier-detail"),r=c("modal-supplier-detail-box");e&&D(e,r)};window.switchSupplierDetailTab=e=>{m=e;const a=(p.suppliers||[]).find(t=>String(t.id)===String(N));a&&H(a)};const H=e=>{if(!c("modal-supplier-detail-content"))return;const a=p.products||[],t=p.purchases||[],l=a.filter(b=>String(b.supplierId)===String(e.id)),o=t.filter(b=>String(b.supplierId)===String(e.id));o.sort((b,u)=>new Date(u.date||u.createdAt||0)-new Date(b.date||b.createdAt||0));const i=o.filter(b=>b.paymentType==="tempo"),d=i.reduce((b,u)=>{if(u.paymentStatus!=="lunas"){const h=(parseFloat(u.total)||0)-(parseFloat(u.amountPaid)||0);return b+(h>0?h:0)}return b},0),n=e.phone?T(e.phone):"";$("modal-supplier-detail-content",`
        ...
        <div class="p-5 sm:p-7 border-b border-slate-100 dark:border-slate-800 bg-slate-50/70 dark:bg-slate-900/60 shrink-0">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <div class="flex items-center gap-2 self-end sm:self-center">
                    <button onclick="window.quickCreatePOForSupplier('${e.id}')" class="px-4 py-2.5 rounded-xl text-white font-bold text-xs flex items-center gap-2 shadow-glow active:scale-95 transition-all cursor-pointer" style="background: var(--color-primary); box-shadow: 0 4px 14px rgba(var(--color-primary-rgb), 0.35);">
                        <i class="fa-solid fa-plus text-xs"></i>
            ...
            <div class="flex items-center gap-2 mt-6 border-b border-slate-200 dark:border-slate-700 overflow-x-auto hide-scrollbar">
                <button 
                    ...
                    style="${m==="products"?"border-color: var(--color-primary); color: var(--color-primary); background: rgba(var(--color-primary-rgb), 0.08);":"border-color: transparent; color: #64748b;"}"
                >
                    <i class="fa-solid fa-boxes-stacked"></i>
                ...
                <button 
                    ...
                    class="px-4 py-2.5 font-bold text-xs border-b-2 transition-all flex items-center gap-2 whitespace-nowrap cursor-pointer rounded-t-xl"
                    style="${m==="orders"?"border-color: var(--color-primary); color: var(--color-primary); background: rgba(var(--color-primary-rgb), 0.08);":"border-color: transparent; color: #64748b;"}"
                >
                    <i class="fa-solid fa-cart-flatbed"></i>
                ...
                <button 
                    ...
                    class="px-4 py-2.5 font-bold text-xs border-b-2 transition-all flex items-center gap-2 whitespace-nowrap cursor-pointer rounded-t-xl"
                    style="${m==="debt"?"border-color: var(--color-primary); color: var(--color-primary); background: rgba(var(--color-primary-rgb), 0.08);":"border-color: transparent; color: #64748b;"}"
                >
                    <i class="fa-solid fa-file-invoice-dollar"></i>
    ...
    `)},K=(e,r)=>e.length===0?`
        ...
        <div class="space-y-4">
            ...
            <div class="divide-y divide-slate-100 dark:divide-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl overflow-hidden bg-white dark:bg-slate-800">
                ${e.map(a=>{const t=R(a,{size:"thumb"}),l=a.img?`<img src="${s(a.img)}" alt="${s(a.name)}" class="w-12 h-12 object-contain rounded-xl p-1 bg-white border border-slate-100 dark:border-slate-700" onerror="this.onerror=null;this.style.display='none';if(this.nextElementSibling)this.nextElementSibling.style.display='flex';"><div class="w-12 h-12" style="display:none">${t}</div>`:`<div class="w-12 h-12">${t}</div>`,o=a.variants&&a.variants.length?a.variants.reduce((n,b)=>n+(parseFloat(b.stock)||0),0):parseFloat(a.stock)||0,i=a.price&&a.hpp?a.price-a.hpp:0,d=a.price&&a.hpp&&a.hpp>0?Math.round(i/a.hpp*100):0;return`
                        <div class="p-3.5 sm:p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3 hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors">
                            <div class="flex items-center gap-3 min-w-0">
                                ...
                                <div class="min-w-0">
                                    <h5 class="font-bold text-xs sm:text-sm text-slate-800 dark:text-slate-100 truncate">${s(a.name)}</h5>
                                    <div class="flex items-center gap-2 text-[10px] text-slate-400 mt-0.5 flex-wrap">
                                        ${a.sku?`<span class="font-mono bg-slate-100 dark:bg-slate-700 px-1.5 py-0.5 rounded text-slate-600 dark:text-slate-300">SKU: ${s(a.sku)}</span>`:""}
                                        ${a.category?`<span>${s(a.category)}</span>`:""}
                            ...
                            <div class="flex items-center justify-between sm:justify-end gap-5 text-right pl-15 sm:pl-0">
                                <div>
                                    ...
                                    <span class="text-xs font-bold text-amber-600 dark:text-amber-400">${a.hpp?x(a.hpp):'<span class="text-slate-300">-</span>'}</span>
                                </div>

                                <div>
                                    <span class="block text-[9px] font-bold uppercase text-slate-400">Harga Jual</span>
                                    <span class="text-xs font-bold text-[var(--color-primary)]">${x(a.price)}</span>
                                </div>
                                ...
                                <button onclick="window.closeSupplierDetailModal(); if(window.oAEd) window.oAEd('products', '${a.id}');" class="w-8 h-8 rounded-lg bg-slate-100 hover:bg-slate-200 dark:bg-slate-700 dark:hover:bg-slate-600 text-slate-600 dark:text-slate-300 flex items-center justify-center transition-all" title="Edit Produk">
                                    <i class="fa-solid fa-pen text-xs"></i>
                                </button>
                            </div>
                        </div>
        ...
        <div class="space-y-3">
            ${e.map(a=>{const t={ordered:'<span class="px-2.5 py-1 rounded-full bg-blue-50 dark:bg-blue-950/40 text-blue-600 dark:text-blue-300 text-[10px] font-bold border border-blue-200 dark:border-blue-800"><i class="fa-solid fa-clock mr-1"></i>Dipesan</span>',received:'<span class="px-2.5 py-1 rounded-full bg-teal-50 dark:bg-teal-950/40 text-teal-600 dark:text-teal-300 text-[10px] font-bold border border-teal-200 dark:border-teal-800"><i class="fa-solid fa-boxes-stacked mr-1"></i>Barang Diterima</span>',completed:'<span class="px-2.5 py-1 rounded-full bg-emerald-50 dark:bg-emerald-950/40 text-emerald-600 dark:text-emerald-300 text-[10px] font-bold border border-emerald-200 dark:border-emerald-800"><i class="fa-solid fa-check-double mr-1"></i>Selesai / Lunas</span>',cancelled:'<span class="px-2.5 py-1 rounded-full bg-rose-50 dark:bg-rose-950/40 text-rose-600 dark:text-rose-300 text-[10px] font-bold border border-rose-200 dark:border-rose-800"><i class="fa-solid fa-ban mr-1"></i>Dibatalkan</span>'}[a.status||"ordered"],l=a.paymentType==="tempo"?`
                    <span class="px-2 py-0.5 rounded bg-amber-50 dark:bg-amber-950/40 text-amber-600 dark:text-amber-400 text-[10px] font-bold border border-amber-200 dark:border-amber-800">
                        Tempo ${a.tempoDays?`${a.tempoDays} Hari`:""} (${a.paymentStatus==="lunas"?"Lunas":"Belum Lunas"})
                    </span>
                `:`<span class="px-2 py-0.5 rounded bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300 text-[10px] font-bold uppercase">${s(a.paymentType||"Cash")}</span>`;return`
                    <div class="bg-white/95 dark:bg-slate-800/90 p-4 border border-slate-200/90 dark:border-slate-700/80 hover:border-[var(--color-primary)]/40 transition-all rounded-2xl flex flex-col sm:flex-row sm:items-center justify-between gap-3 shadow-2xs">
                        <div>
                            <div class="flex items-center gap-2 flex-wrap">
                                <span class="font-mono font-black text-xs text-slate-800 dark:text-white">${s(a.poNumber||a.id)}</span>
                                ${t}
                                ${l}
                            </div>
                            <p class="text-[11px] text-slate-400 mt-1 flex items-center gap-3">
                                <span><i class="fa-regular fa-calendar mr-1"></i>${O(a.date||a.createdAt)}</span>
                                <span><i class="fa-solid fa-box mr-1"></i>${(a.items||[]).length} Item Barang</span>
                            </p>
                        </div>
                        ...
                        <div class="flex items-center justify-between sm:justify-end gap-4">
                            <div class="text-right">
                                ...
                                <span class="text-sm font-black text-slate-800 dark:text-slate-100">${x(a.total)}</span>
                            </div>

                            <button onclick="window.closeSupplierDetailModal(); if(window.openAdminTab) window.openAdminTab('purchases'); setTimeout(() => { window.openPurchaseDetailModal?.('${a.id}'); }, 200);" class="px-3 py-1.5 rounded-xl font-bold text-xs transition-all border cursor-pointer active:scale-95" style="background: rgba(var(--color-primary-rgb), 0.1); color: var(--color-primary); border-color: rgba(var(--color-primary-rgb), 0.25);">
    ...
    `,U=(e,r,a)=>{const t=e.filter(l=>(parseFloat(l.total)||0)-(parseFloat(l.amountPaid)||0)>0&&l.paymentStatus!=="lunas");return`
        <div class="space-y-4">
            ...
            <div class="p-4 sm:p-5 rounded-2xl ${r>0?"bg-amber-50/70 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-800/60":"bg-emerald-50/70 dark:bg-emerald-950/20 border border-emerald-200 dark:border-emerald-800/60"} flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p class="text-2xl font-black ${r>0?"text-amber-600 dark:text-amber-400":"text-emerald-600 dark:text-emerald-400"} tracking-tight">${x(r)}</p>
                    <p class="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                        ${r>0?`Ada <b>${t.length}</b> nota order pembelian tempo yang belum lunas ke supplier ini.`:"Semua tagihan pembelian ke supplier ini sudah lunas sempurna! ✨"}
                    </p>
                </div>
                ...
                ${a.bankAccount?`
                    <div class="p-3 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 text-xs shrink-0">
                        ...
                        <p class="font-bold text-slate-800 dark:text-white mt-0.5">${s(a.bankName)}: <b class="font-mono text-base">${s(a.bankAccount)}</b></p>
                        <p class="text-[10px] text-slate-400">a/n ${s(a.bankHolder||a.name)}</p>
                    </div>
                `:""}
            </div>
            ...
            <div class="space-y-3">
                ...
                `:t.map(l=>{const o=(parseFloat(l.total)||0)-(parseFloat(l.amountPaid)||0),i=parseFloat(l.amountPaid)||0,d=l.tempoDueDate?O(l.tempoDueDate):"-";return`
