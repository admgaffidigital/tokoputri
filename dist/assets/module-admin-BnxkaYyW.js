...
>`;s+="</div>"}),s=`<div class="grid grid-cols-1 lg:grid-cols-2 gap-x-5 gap-y-5 items-start">${s}</div>`,$("admin-modal-form",s),e==="products"&&(window.rVarsB?.(),window.rWholB?.(),window.rSpecB?.());const d=k("admin-modal");d&&d.classList.contains("hidden")&&Vs("admin"),F("admin-modal"),setTimeout(()=>{k("admin-modal").classList.remove("opacity-0"),k("admin-modal-box").classList.remove("scale-95")},10)};window.submitAdminForm=async()=>{if(we)return;B(!0);const e=$t||window.cTab||"products";let t={},a=mt[e]||[];for(let s of a)if(s.type==="variants_builder")t.variants=z.filter(l=>l.name.trim()!=="");else if(s.type==="wholesale_builder")t.wholesale=fe.filter(l=>parseFloat(l.minQty)>.01&&l.price>0);else if(s.type==="spec_table_builder")t.specTable=te.filter(l=>l.key.trim()!=="");else{let l="";if(s.type==="richtext"){const n=k(`af-${s.key}-editor`);l=n?n.innerHTML:""}else l=S(`af-${s.key}`);if(typeof l=="string"){if(l.startsWith("data:image/")&&l.length>3e5)return B(!1),b("Gambar Base64 terlalu besar! Upload file.");s.key==="img"&&(l=M(l))}t[s.key]=s.type==="number"?parseFloat(l)||0:l}if(!t.name&&!t.title&&!t.bankName&&!t.code)return B(!1),b("Judul/Nama/Kode wajib diisi!");if(e==="products"&&!t.sku&&(t.sku="SKU"+Date.now().toString().slice(-6)),e==="customers"){const s=window.normalizeWA?window.normalizeWA(t.phone):(t.phone||"").replace(/\D/g,"").replace(/^0/,"62");if(!s||s.length<10)return B(!1),b("Nomor WhatsApp tidak valid!");t.phone=s,t.points=parseFloat(t.points)||0,t.id=parseInt(s,10)}let r=null;if(e==="customers")if(o.customers||(o.customers=[]),Z){r=Z;let s=o.customers.findIndex(l=>l&&l.id!=null&&String(l.id)===String(Z));s>-1?o.customers[s]=t:o.customers.unshift(t)}else o.customers.unshift(t);else if(e==="rewards")if(o.rewards||(o.rewards=[]),Z){let s=o.rewards.findIndex(l=>l&&l.id!=null&&String(l.id)===String(Z));s>-1?(t.id=o.rewards[s].id,o.rewards[s]=t):t.id=Z}else t.id=Date.now(),o.rewards.unshift(t);else if(Z){o[e]||(o[e]=[]);let s=o[e].findIndex(l=>l&&l.id!=null&&String(l.id)===String(Z));if(s>-1){if(t.id=o[e][s].id,e==="products"){const l=o[e][s];t.totalSold=l.totalSold||0,t.variants&&t.variants.length&&l.variants&&t.variants.forEach(n=>{const i=l.variants.find(d=>d.name===n.name);i&&i.totalSold&&(n.totalSold=i.totalSold)})}o[e][s]=t}else t.id=Z,o[e].push(t)}else t.id=Date.now(),o[e]||(o[e]=[]),o[e].unshift(t);C("Menyimpan...");try{const s=typeof w<"u"&&w?w:window.db,l=typeof H=="function"?H:window.saveApp||(async()=>{});if(!s)throw new Error("Database Firebase belum terhubung");if(e==="products")await s.collection("freshmart").doc("cms_data").collection("products").doc(t.id.toString()).set(t),await l([],{updateType:"product_single",updatedProductIds:[t.id.toString()]});else if(e==="customers"){const n=s.collection("freshmart").doc("cms_data").collection("customers");r!==null&&r!==t.id&&await n.doc(r.toString()).delete().catch(()=>{}),await n.doc(t.phone).set(t,{merge:!0})}else e==="rewards"?await s.collection("freshmart").doc("cms_data").collection("rewards").doc(t.id.toString()).set(t):await l([e]);window.closeAdminModal?.(),window.rAdmItms?.(e),b("Tersimpan!")}catch(s){console.error("Gagal simpan admin data:",s),b("Gagal menyimpan: "+(s.message||""))}finally{B(!1),P()}};window.oADel=async(e,t)=>{window.showConfirm?.("Hapus Data","Data yang dihapus tidak bisa dikembalikan lagi.",async()=>{if(we)return;B(!0);const a=typeof w<"u"&&w?w:window.db,r=typeof H=="function"?H:window.saveApp||(async()=>{}),s=o[e]&&o[e].find(l=>l&&l.id!=null&&String(l.id)===String(t));o[e]=(o[e]||[]).filter(l=>!l||l.id==null||String(l.id)!==String(t)),C("Menghapus...");try{if(!a)throw new Error("Database Firebase belum terhubung");if(e==="products")await a.collection("freshmart").doc("cms_data").collection("products").doc(t.toString()).delete(),await r([],{updateType:"product_delete",updatedProductIds:[t.toString()]});else if(e==="customers"){const l=s?s.phone:t.toString();await a.collection("freshmart").doc("cms_data").collection("customers").doc(l).delete()}else e==="rewards"?await a.collection("freshmart").doc("cms_data").collection("rewards").doc(t.toString()).delete():await r([e]);window.rAdmItms?.(e),b("Berhasil Dihapus!")}catch(l){b("Gagal menghapus: "+(l.message||""))}finally{B(!1),P()}})};window.duplicateProduct=async e=>{window.showConfirm?.("Duplikat Produk","Menyalin data produk ini ke item baru?",async()=>{if(we)return;B(!0);const t=typeof w<"u"&&w?w:window.db,a=typeof H=="function"?H:window.saveApp||(async()=>{}),r=o.products.find(l=>l&&l.id!=null&&String(l.id)===String(e));if(!r){B(!1);return}let s=JSON.parse(JSON.stringify(r));s.id=Date.now()+Math.floor(Math.random()*1e3),s.name=s.name+" COPY",s.sku="",s.totalSold=0,s.variants&&s.variants.length>0&&(s.variants=s.variants.map(l=>(l.sku="",l.totalSold=0,l))),o.products.unshift(s),C("Menyalin...");try{if(!t)throw new Error("Database Firebase belum terhubung");await t.collection("freshmart").doc("cms_data").collection("products").doc(s.id.toString()).set(s),await a([],{updateType:"product_single",updatedProductIds:[s.id.toString()]}),window.rAdmItms?.("products"),b("Produk berhasil disalin!")}catch(l){b("Gagal menyalin: "+(l.message||""))}finally{B(!1),P()}},"Ya, Salin",!1)};window.rSpecB=()=>{const e=document.getElementById("spec-table-builder-container");if(!e)return;let t="";te.length>0?t+=`<div class="overflow-hidden rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm mb-3">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-4">
        ...
        </div>`;return}let r="";a.forEach((s,l)=>{const n=l===0&&De==="all",i=Zs(s.category),d=Xs(s.date),p=(s.items||[]).map(m=>`
