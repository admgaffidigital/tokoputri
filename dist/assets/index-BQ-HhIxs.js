import{f as Be}from"./vendor-firebase-core-D2OF5R23.js";import"./vendor-firebase-db-BIUZcnOd.js";import{p as ea}from"./vendor-utils-Bszxp-Ae.js";import{d as C,g as ta,u as aa,h as sa,a as kt,t as oa,b as Mt,i as ra,l as ut,c as ia,s as na,e as la,f as da,j as ft,k as Qe,m as ca,A as Pt,n as pa,o as wt,p as ma,q as Tt,r as ua,v as fa,w as wa}from"./module-admin-DnwATXyJ.js";import{e as l,Q as N,a as u,g as q,c as E,i as _,f as D,aj as b,h as T,j as m,ak as H,al as Q,am as se,an as V,ao as oe,ap as y,A as J,d as F,a3 as st,ae as ze,b as Le,a4 as ae,R as z,S as I,aq as O,ar as Oe,s as At,m as K,as as St,k as f,a7 as je,a2 as ot,l as Dt,z as W,o as ye,x as ve,K as Ct,D as rt,M as $t,F as Je,E as Ye,a0 as ba,at as ga,au as xa,r as ha,ab as ya,ad as va,ac as ka,af as Ma,av as Pa,aw as Ta,ax as Aa,w as Sa,ay as Da,N as Ca,G as $a,O as Ra,I as Ea,P as Ia,J as La,B as Fa,az as _a,C as Ba,aA as Na,aB as Oa,aC as ja,y as Ua,p as qa,v as Ga,q as Ka,aD as Ha,aE as Va,aF as Qa,u as Wa,t as za,aG as Ja,U as Ya,T as Za,W as Xa,V as es,Y as ts,X as as,a6 as ss,$ as os,ag as rs,a8 as is,a1 as ns,a5 as ls,aH as ds,aa as cs,a9 as ps,_ as ms,Z as us,aI as fs,aJ as ws,ah as bs,ai as gs,aK as xs,aL as hs,aM as ys,aN as vs,aO as ks}from"./module-print-CDLpN0fO.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))s(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function a(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(o){if(o.ep)return;o.ep=!0;const r=a(o);fetch(o.href,r)}})();let Ue="https://script.google.com/macros/s/AKfycbx3dW9rHcdoKNYjSOJ8PoH2k6fABe7XlBD9teNHsBlCBqJquq8jd4UvnfXZVsfKdFsC/exec";const Rt=()=>{l("voucher-input");const e=(N("voucher-input")||"").toUpperCase().trim(),t=(u.vouchers||[]).find(o=>(o.code||"").toUpperCase()===e);q("voucher-msg-container");const a=typeof window.getEffP=="function"?window.getEffP:o=>o.effectivePrice||o.price||0,s=E.reduce((o,r)=>o+(parseFloat(a(r))||0)*(parseFloat(r.qty)||0),0);if(t){let o=!0;t.targetProduct&&t.targetProduct!==""&&(o=E.some(r=>r&&String(r.id)===String(t.targetProduct))),t.targetProduct&&t.targetProduct!==""&&!o?(H(null),_("voucher-msg",'<i class="fa-solid fa-box mr-1"></i> Khusus Produk Tertentu!'),l("voucher-msg")&&(l("voucher-msg").className="text-sm font-bold text-rose-500 dark:text-rose-400")):t.minPurchase&&parseFloat(t.minPurchase)>0&&s<parseFloat(t.minPurchase)?(H(null),_("voucher-msg",`<i class="fa-solid fa-circle-exclamation mr-1"></i> Minimal belanja ${D(t.minPurchase)}`),l("voucher-msg")&&(l("voucher-msg").className="text-sm font-bold text-amber-500 dark:text-amber-400")):t.type&&t.type.includes("shipping")&&b.deliveryMethod!=="delivery"?(H(null),_("voucher-msg",'<i class="fa-solid fa-motorcycle mr-1"></i> Khusus pesanan dikirim kurir!'),l("voucher-msg")&&(l("voucher-msg").className="text-sm font-bold text-rose-500 dark:text-rose-400")):(H(t),_("voucher-msg",'<i class="fa-solid fa-check-circle mr-1"></i> Voucher Diterapkan!'),l("voucher-msg")&&(l("voucher-msg").className="text-sm font-bold text-[var(--color-primary)]"))}else e===""?(H(null),T("voucher-msg-container"),typeof window.rPay=="function"&&window.rPay()):(H(null),_("voucher-msg",'<i class="fa-solid fa-times-circle mr-1"></i> Kode Tidak Valid'),l("voucher-msg")&&(l("voucher-msg").className="text-sm font-bold text-rose-500 dark:text-rose-400"));typeof window.rPay=="function"&&window.rPay()},Ms=()=>{let e=document.getElementById("voucher-modal");e||(e=document.createElement("div"),e.id="voucher-modal",e.className="fixed inset-0 z-[115] bg-slate-900/80 flex items-end sm:items-center justify-center p-0 sm:p-5",e.onclick=s=>{s.target===e&&it()},document.body.appendChild(e));const t=(u.vouchers||[]).filter(s=>s.isShow!==!1&&s.isShow!=="false"),a=t.length?t.map(s=>{let o="";s.type==="percent"?o=`Diskon ${s.value}%`:s.type==="shipping_free"?o="Gratis Ongkir":s.type==="shipping_flat"?o=`Diskon Ongkir ${D(s.value)}`:o=`Potongan ${D(s.value)}`;const r=s.minPurchase&&parseFloat(s.minPurchase)>0?`Min. belanja ${D(s.minPurchase)}`:"Tanpa minimal belanja";return`
    ...
    <svg class="w-full h-11 bg-white rounded-lg px-2 py-1 shadow-inner border border-slate-200" viewBox="0 0 ${Math.max(s+10,240)} 40" xmlns="http://www.w3.org/2000/svg">
        ${a}
    </svg>`},bt=e=>{const t=parseFloat(e?.points)||0,a=qe(t),s=(u.store?.name||"Toko Putri").toUpperCase(),o=u.store?.logo&&u.store.logo!=="fa-store"?u.store.logo:Ss,r=(e?.name||"PELANGGAN SETIA").toUpperCase(),i=(e?.phone||"81234567890").toString().replace(/\D/g,""),n=Et(i),d=u.store?.wa||i;return`
    ...
    <div class="flex gap-2.5 sm:gap-3 overflow-x-auto hide-scrollbar snap-x pb-3 pt-1">
        ...
        `):_("member-modal-body",`
            ...
            <div class="opacity-90">
                ${bt({name:"NAMA ANDA",phone:"81234567890",points:0})}
            </div>
            ...
            <div class="bg-white dark:bg-slate-900 w-full max-w-lg rounded-t-3xl sm:rounded-2xl max-h-[88vh] flex flex-col shadow-2xl transform translate-y-full sm:translate-y-10 scale-100 transition-transform duration-300 border border-slate-200 dark:border-slate-700 overflow-hidden" id="order-detail-content">
                ...
                <div class="p-4 sm:p-5 overflow-y-auto flex-1 space-y-5 custom-scrollbar text-sm">
                    ...
                    <div class="bg-slate-100 dark:bg-slate-800 p-4 rounded-xl space-y-2 text-xs">
                        ...
                        <div class="flex justify-between text-slate-600 dark:text-slate-400"><p>Ongkos Kirim</p><p class="font-bold text-slate-800 dark:text-white">${D(L)}</p></div>
                        ...
                        ${(()=>{if(le<=0)return"";const p=t.payment?.ppnType==="inclusive",B=G-h+(L-S),ce=t.payment?.dppAmount||(p?Math.round(B*100/(100+we)):Math.max(0,B));return`
        ...
        `,s.classList.contains("opacity-0")&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("customerOrder"),s.classList.remove("opacity-0","pointer-events-none"),s.offsetWidth,requestAnimationFrame(()=>{const p=document.getElementById("order-detail-content");p&&(p.classList.remove("translate-y-full","sm:translate-y-10"),p.classList.add("translate-y-0","sm:translate-y-0"))})}catch(s){console.error("Error Render HTML Modal:",s),f("Gagal menampilkan detail. Coba lagi.")}},Ks=(e=!1)=>{const t=()=>{const a=document.getElementById("order-detail-modal"),s=document.getElementById("order-detail-content");s&&(s.classList.remove("translate-y-0","sm:translate-y-0"),s.classList.add("translate-y-full","sm:translate-y-10")),setTimeout(()=>{a&&a.classList.add("opacity-0","pointer-events-none")},300)};typeof window.requestCloseModal=="function"?window.requestCloseModal("customerOrder",e,t):t()};window.attachMyOrdersRealtime=Nt;window.detachMyOrdersRealtime=Bt;window.renderMyOrders=Ee;window.checkOrderStatus=Us;window.trackOrderManual=qs;window.clearMyOrders=Gs;window.openCustomerOrderDetail=Xe;window.renderOrderDetailModal=Ot;window.closeCustomerOrderDetailModal=Ks;window.reviewPhotoFile=null;window.reviewRating=0;const Hs=(e,t,a,s,o)=>{const r=decodeURIComponent(a||""),i=decodeURIComponent(s||""),n=decodeURIComponent(o||"");let d=document.getElementById("review-modal");d||(d=document.createElement("div"),d.id="review-modal",d.className="fixed inset-0 z-[120] bg-slate-900/80 flex items-end sm:items-center justify-center p-0 sm:p-5",d.onclick=c=>{c.target===d&&dt()},document.body.appendChild(d)),window.reviewPhotoFile=null,window.reviewRating=0,d.innerHTML=`
        <div class="bg-white dark:bg-slate-900 w-full max-w-lg rounded-t-3xl sm:rounded-2xl max-h-[85vh] flex flex-col shadow-2xl border border-slate-200 dark:border-slate-700">
            <div class="p-5 sm:p-6 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center shrink-0">
                <div class="min-w-0">
    ...
    `).join("")},Ys=e=>{Fe=e,Ce()},Zs=()=>{Ce()},Xs=e=>{const t=document.getElementById(`faq-body-${e}`),a=document.getElementById(`faq-icon-${e}`);if(!t||!a)return;t.classList.contains("hidden")?(t.classList.remove("hidden"),a.classList.add("rotate-180")):(t.classList.add("hidden"),a.classList.remove("rotate-180"))},eo=()=>{const e=l("modal-ask-question"),t=l("modal-ask-question-box");e&&(e.classList.contains("hidden")&&typeof window.pushModalHistory=="function"&&window.pushModalHistory("askQuestion"),ye(e,t))},jt=(e=!1)=>{const t=()=>{ve("modal-ask-question","modal-ask-question-box")};typeof window.requestCloseModal=="function"?window.requestCloseModal("askQuestion",e,t):t()},to=async()=>{const e=(N("ask-author-name")||"").trim()||"Pelanggan",t=N("ask-category")||"Pemesanan",a=(N("ask-question-text")||"").trim();if(!a)return f("Tuliskan pertanyaan Anda terlebih dahulu!");z("Mengirim pertanyaan...");const s="faq-"+Date.now().toString(36),o={id:s,question:a,answer:"",category:t,authorName:e,status:"pending_answer",createdAt:new Date().toISOString()};let r=!1;try{await C.collection("freshmart").doc("cms_data").collection("faqs").doc(s).set(o),r=!0}catch(i){console.warn("Penulisan sub-koleksi faqs dibatasi, mencoba fallback cms_data.faqs:",i)}if(!r)try{const i=[o,...(u.faqs||[]).filter(n=>n.id!==s)];await C.collection("freshmart").doc("cms_data").set({faqs:i},{merge:!0}),u.faqs=i,r=!0}catch(i){console.warn("Fallback cms_data.faqs juga gagal:",i)}I(),r?(jt(),K("ask-question-text",""),f("Pertanyaan terkirim! Admin akan menjawabnya segera."),Ce()):f("Gagal mengirim pertanyaan. Coba lagi!")};let De="all";const Ke=()=>{pt();const e=u.faqs||[],t=e.filter(o=>De==="pending"?o.status==="pending_answer":De==="published"?o.status==="published":!0),a=e.filter(o=>o.status==="pending_answer").length;let s=`
    ...
    <button onclick="setCat('Semua Produk'); closeCategoryModal()" class="w-full flex items-center gap-3.5 p-3 sm:p-3.5 rounded-2xl border transition-all active:scale-[0.98] ${t?"bg-[rgba(var(--color-primary-rgb),0.08)] border-[var(--color-primary)] dark:bg-[rgba(var(--color-primary-rgb),0.12)] dark:border-[var(--color-primary)] shadow-[0_0_0_1px_rgba(var(--color-primary-rgb),0.2)]":"bg-slate-50 border-slate-200 dark:bg-slate-800/50 dark:border-slate-700 hover:border-[var(--color-primary)]/40 dark:hover:border-[var(--color-primary)]/40"} group">
        ...
        </button>`});const a=l("modal-category-list");a&&(a.innerHTML=`<div class="flex flex-col gap-2.5 pb-6 w-full">${e}</div>`);const s=l("category-modal"),o=l("category-modal-content");s&&o&&(s.classList.contains("hidden")&&ie("category"),ye(s,o))};window.openCategoryModal=Mo;window.openBrandModal=()=>{let e="",t=Je==="Semua Merek";e+=`
    ...
    `,document.body.appendChild(s);const o=s.querySelector("div");ie("prompt"),setTimeout(()=>{s.classList.remove("opacity-0"),o.classList.remove("scale-95")},10);const r=s.querySelector("#prompt-input");r.focus(),r.select(),window.closePrompt=(i=!1)=>{!s||!s.parentNode||ne("prompt",i,()=>{s.classList.add("opacity-0"),o.classList.add("scale-95"),setTimeout(()=>s.remove(),300),window.closePrompt=null})},s.querySelector("#prompt-cancel").onclick=()=>window.closePrompt(),s.querySelector("#prompt-ok").onclick=()=>{let i=r.value;window.closePrompt(),a(i)}},Fo=()=>{typeof window.openReceiptPreview=="function"&&window.openReceiptPreview()};window.copyVoucher=Do;window.showToast=Ne;window.showToastLoading=Co;window.hideToast=$o;window.toggleTheme=Ro;window.showConfirm=Eo;window.closeConfirm=Zt;window.executeConfirm=Io;window.customPrompt=Lo;window.checkProPrint=Fo;typeof history<"u"&&"scrollRestoration"in history&&(history.scrollRestoration="manual");window.scrollTo(0,0);document.documentElement&&(document.documentElement.scrollTop=0);document.body&&(document.body.scrollTop=0);Vt();window.firebase=Be;window.db=C;window.DOMPurify=ea;window.ensureScriptLoaded=ba;if(typeof window<"u"){const e=window.print?window.print.bind(window):null;window.print=function(){window.AndroidNativeApp&&typeof window.AndroidNativeApp.print=="function"?window.AndroidNativeApp.print():e&&e()}}window.uiPalettes=aa;window.hexToRgb=sa;window.applyUITheme=kt;window.toggleTheme=oa;window.applyBackgroundStyle=Mt;ra();const _o=localStorage.getItem("freshmart_ui_theme")||"emerald";kt(_o,localStorage.getItem("freshmart_theme_color"));const yt=()=>{fa();const e=localStorage.getItem("freshmart_bg_style")||"minimalist",t=localStorage.getItem("freshmart_bg_custom_url")||"";Mt(e,t),wa()};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",yt):yt();window.onerror=function(e,t,a,s,o){return console.error("Global Error Caught:",e,"at",a,":",s),typeof showToast=="function"&&showToast("Ops, ada kendala sistem."),!1};window.addEventListener("unhandledrejection",function(e){console.warn("Promise Rejection Sentinel:",e.reason)});window.updateSEO=ga;window.injectJSONLD=xa;window.rewardStatusLabel=ot;window.getYouTubeId=ha;window.parseVideoUrl=ya;window.fixDriveVideo=va;window.fixDriveVideoPreview=ka;let vt=Ue;window.calcTaxDetails=e=>{const t=u?.store||{},a=t.ppnEnabled===!0||t.ppnEnabled==="true",s=parseFloat(t.ppnRate)||11,o=t.ppnType||"exclusive";if(!a||e<=0)return{ppnEnabled:!1,ppnRate:0,ppnType:o,ppnAmount:0,dppAmount:Math.max(0,e),grandTotalAdd:0};if(o==="inclusive"){const r=Math.round(e*100/(100+s)),i=e-r;return{ppnEnabled:!0,ppnRate:s,ppnType:"inclusive",ppnAmount:i,dppAmount:r,grandTotalAdd:0}}else{const r=Math.round(e*s/100);return{ppnEnabled:!0,ppnRate:s,ppnType:"exclusive",ppnAmount:r,dppAmount:Math.max(0,e),grandTotalAdd:r}}};typeof requestIdleCallback<"u"?requestIdleCallback(ut,{timeout:5e3}):setTimeout(ut,3e3);window.updateProBadge=()=>{};window.isAdm=!1;window.isPro=!0;history.replaceState({view:"view-catalog"},"","");window.addEventListener("DOMContentLoaded",async()=>{await ia();try{na()}catch(e){console.warn("[syncAppMeta] Error:",e)}la(),da(),ft(),window.attachRewardsRealtime=ft,Qe.onAuthStateChanged(async e=>{if(!ca()){if(e&&e.uid!==Pt){await Qe.signOut();return}if(e){if(!await pa()){console.log("[Auth] Sesi admin lokal sudah tidak aktif (diambil alih perangkat lain)."),wt(),localStorage.removeItem("freshmart_admin_session_id"),window.isAdm=!1,window.__localIsAdm=!1,window.isPro=!1,window.updateProBadge&&window.updateProBadge(),await Qe.signOut();return}ma(),window.isAdm=!0,window.isPro=!0,localStorage.removeItem("isFreshmartPro"),localStorage.removeItem("freshmart_license_code"),window.updateProBadge&&window.updateProBadge();let a=document.getElementById("view-admin-login");a&&!a.classList.contains("hidden")&&(history.replaceState({view:"view-admin"},"",window.location.href),changeView("view-admin",!0),openAdminMenu(),showToast("Sesi Dipulihkan! Selamat Datang."))}else wt(),localStorage.removeItem("freshmart_admin_session_id"),window.isAdm=!1,window.__localIsAdm=!1,window.isPro=!1,window.updateProBadge&&window.updateProBadge(),localStorage.removeItem("isFreshmartPro"),localStorage.removeItem("freshmart_license_code")}})});window.el=l;window.show=q;window.hide=T;window.toggleCls=J;window.setIn=F;window.setH=_;window.setV=K;window.getV=N;window.esc=m;window.fixD=je;window.fCur=D;window.sL=ze;window.ssL=Le;window.defaultFbC=Tt;window.fbC=Tt;window.defApp=Ma;window.ADMIN_UID=Pt;window.sLoad=z;window.hLoad=I;window.sanitizeCart=ua;const k=(e,t,a)=>{try{Object.defineProperty(window,e,{get:t,set:a,configurable:!0})}catch{}};k("GAS_UPLOAD_URL",()=>vt,e=>{vt=e});k("confirmCb",()=>Pa,e=>{fs(e)});k("appData",()=>u,e=>{Ta(e)});k("cart",()=>E,e=>{At(e)});k("wishlist",()=>Sa,e=>{Aa(e)});k("myOrders",()=>O,e=>{Oe(e)});k("cust",()=>b,e=>{St(e)});k("currentMember",()=>V,e=>{Q(e)});k("selectedReward",()=>oe,e=>{se(e)});k("memberCheckTimer",()=>Da,e=>{ws(e)});k("aCat",()=>Ye,e=>{Ct(e)});k("aBrand",()=>Je,e=>{$t(e)});k("sQ",()=>$a,e=>{Ca(e)});k("cSort",()=>Ea,e=>{Ra(e)});k("cView",()=>La,e=>{Ia(e)});k("cPage",()=>Fa,e=>{rt(e)});k("iPP",()=>Ba,e=>{_a(e)});k("cTab",()=>Na,e=>{bs(e)});k("aSq",()=>Oa,e=>{gs(e)});k("eId",()=>ja,e=>{xs(e)});k("cProd",()=>qa,e=>{Ua(e)});k("cVar",()=>Ka,e=>{Ga(e)});k("tVars",()=>Ha,e=>{hs(e)});k("tWhol",()=>Va,e=>{ys(e)});k("tSpec",()=>Qa,e=>{vs(e)});k("cQty",()=>za,e=>{Wa(e)});k("oMods",()=>W,e=>{Ja(e)});k("aOrdLst",()=>Za,e=>{Ya(e)});k("aCustLst",()=>es,e=>{Xa(e)});k("aRevLst",()=>as,e=>{ts(e)});k("gOrds",()=>os,e=>{ss(e)});k("gReviews",()=>is,e=>{rs(e)});k("cVOrd",()=>ls,e=>{ns(e)});k("vouch",()=>y,e=>{H(e)});k("toastT",()=>ds,e=>{ks(e)});k("isSaving",()=>st,e=>{ae(e)});k("reviewFilterMode",()=>ps,e=>{cs(e)});k("lastReportPeriod",()=>us,e=>{ms(e)});
