...
import{d as D,_ as F}from"./module-member-C8EXASIq.js";import{a as u,e as c,i as d,t as w,b as E,f as fe,x as J,u as Ke}from"./module-print-DoqR8CYY.js";import{f as Q}from"./vendor-firebase-core-D2OF5R23.js";import"./vendor-firebase-db-BIUZcnOd.js";let ce=!1;const Ne=()=>ce?Promise.resolve():F(()=>import("./pos-variant-sheet-D2tC43LA.js"),__vite__mapDeps([0,1])).then(()=>{ce=!0});let m=[],_="",I="",M="grid";try{const e=localStorage.getItem("pos_view_mode");(e==="list"||e==="grid")&&(M=e)}catch{}let b={name:"",phone:"",isMember:!1,memberId:null,isNewTempo:!1},k="cash",v=0,A=0,$="",pe=null,Y=null;const X=e=>{M=e;try{localStorage.setItem("pos_view_mode",e)}catch{}const t=c("pos-view-btn-grid"),s=c("pos-view-btn-list");t&&s&&(e==="grid"?(t.style.background="var(--color-primary)",t.className="w-8 h-8 rounded-lg flex items-center justify-center text-xs transition-all cursor-pointer text-white shadow-xs",s.style.removeProperty("background"),s.className="w-8 h-8 rounded-lg flex items-center justify-center text-xs transition-all cursor-pointer text-slate-500 hover:text-slate-800 dark:text-slate-400"):(s.style.background="var(--color-primary)",s.className="w-8 h-8 rounded-lg flex items-center justify-center text-xs transition-all cursor-pointer text-white shadow-xs",t.style.removeProperty("background"),t.className="w-8 h-8 rounded-lg flex items-center justify-center text-xs transition-all cursor-pointer text-slate-500 hover:text-slate-800 dark:text-slate-400")),H()},C=e=>Math.max(0,parseInt(e)||0),f=e=>fe(e),Z=()=>m.reduce((e,t)=>e+t.subtotal,0),y=()=>Math.max(0,Z()-C(A)),ge=()=>v-y(),O=()=>{try{const e=window.AudioContext||window.webkitAudioContext;if(!e)return;const t=new e,s=t.createOscillator(),a=t.createGain();s.type="sine",s.frequency.setValueAtTime(1400,t.currentTime),a.gain.setValueAtTime(.08,t.currentTime),a.gain.exponentialRampToValueAtTime(1e-4,t.currentTime+.08),s.connect(a),a.connect(t.destination),s.start(),s.stop(t.currentTime+.08),setTimeout(()=>{t.close().catch(()=>{})},150)}catch{}},Be=(e,t)=>{if(!e||!e.wholesale||!e.wholesale.length)return null;const s=[...e.wholesale].sort((a,r)=>r.minQty-a.minQty);for(const a of s)if(t>=parseFloat(a.minQty))return parseFloat(a.price);return null},L=e=>{if(!e.isVariant){const t=(u.products||[]).find(a=>a&&String(a.id)===String(e.id)),s=t?Be(t,e.qty):null;s!==null?(e.basePrice=e.basePrice||e.price,e.price=s,e.isWholesale=!0):(e.basePrice&&(e.price=e.basePrice),e.isWholesale=!1)}return e.subtotal=Math.max(0,e.price*e.qty-C(e.discount)),e},qe=()=>{const e=new Date,t=s=>String(s).padStart(2,"0");return`POS-${e.getFullYear()}${t(e.getMonth()+1)}${t(e.getDate())}-${Date.now().toString(36).toUpperCase()}`},he=()=>{Y&&clearInterval(Y);const e=()=>{const t=c("pos-live-clock");if(!t)return;const s=new Date;t.textContent=s.toLocaleTimeString("id-ID",{hour:"2-digit",minute:"2-digit",second:"2-digit"})+" WIB"};e(),Y=setInterval(e,1e3)},z=()=>{window.__posBarcodeFn&&(document.removeEventListener("keydown",window.__posBarcodeFn),window.__posBarcodeFn=null)},we=()=>{z(),window.__posBarcodeFn=e=>{if(!e||typeof e.key!="string")return;const t=window.curViewName||"";if(!(t==="view-pos-cashier"||t==="view-admin"&&window.cTab==="pos"))return;const a=document.activeElement?.tagName?.toLowerCase();if(!(a==="input"||a==="textarea"||a==="select"))if(e.key==="Enter"){if($&&$.length>=3){const r=$.trim().toLowerCase(),l=(u.products||[]).find(o=>o&&o.isActive!=="false"&&o.isActive!==!1&&(o.barcode&&o.barcode.toLowerCase()===r||o.sku&&o.sku.toLowerCase()===r||o.id&&String(o.id).toLowerCase()===r));if(l)ee(l.id),O(),w(`Ditambahkan: ${l.name}`,"success");else{const o=c("pos-search-input");o&&(o.value=$,_=$,H()),w("Barcode tidak ditemukan di katalog","warning")}$=""}}else e.key&&e.key.length===1&&($=($||"")+e.key,clearTimeout(pe),pe=setTimeout(()=>{$=""},150))},document.addEventListener("keydown",window.__posBarcodeFn)},ee=e=>{const t=(u.products||[]).find(r=>r&&String(r.id)===String(e));if(!t)return;if(t.variants&&t.variants.length>0){Ne().then(()=>{typeof window.openPOSVariantSheet=="function"&&window.openPOSVariantSheet(e)});return}const a=m.find(r=>String(r.id)===String(e)&&!r.isVariant);if(a)a.qty+=1,L(a);else{const r=parseFloat(t.price)||0;m.push(L({id:t.id,name:t.name,price:r,basePrice:r,qty:1,discount:0,subtotal:r,isVariant:!1,isWholesale:!1}))}O(),typeof window.triggerHaptic=="function"&&window.triggerHaptic("light"),S()},ke=(e,t)=>{const s=(u.products||[]).find(r=>r&&String(r.id)===String(e));if(!s)return;const a=m.find(r=>String(r.id)===String(e)&&!r.isVariant);if(a)a.qty+=t,L(a);else{const r=parseFloat(s.price)||0,l=L({id:s.id,name:s.name,price:r,basePrice:r,qty:t,discount:0,subtotal:r*t,isVariant:!1,isWholesale:!1});m.push(l)}O(),typeof window.triggerHaptic=="function"&&window.triggerHaptic("light"),S()},ye=(e,t,s,a,r=1)=>{const l=`${e}__v${a}`,o=m.find(i=>i.cartKey===l);if(o)o.qty+=r,L(o);else{const n=`${(u.products||[]).find(p=>p&&String(p.id)===String(e))?.name||e} — ${t}`;m.push(L({id:e,cartKey:l,name:n,variantName:t,variantIdx:a,price:s,basePrice:s,qty:r,discount:0,subtotal:s*r,isVariant:!0,isWholesale:!1}))}O(),typeof window.triggerHaptic=="function"&&window.triggerHaptic("light"),S()},ve=(e,t)=>{const s=m.find(a=>(a.cartKey||String(a.id))===String(e));s&&(s.qty=Math.max(1,s.qty+t),L(s),t>0&&O(),S())},Se=(e,t)=>{const s=m.find(a=>(a.cartKey||String(a.id))===String(e));s&&(s.qty=Math.max(1,C(t)),L(s),S())},Pe=(e,t)=>{const s=m.find(a=>(a.cartKey||String(a.id))===String(e));s&&(s.discount=Math.min(C(t),s.price*s.qty),L(s),S())},$e=e=>{m=m.filter(t=>(t.cartKey||String(t.id))!==String(e)),S(),typeof window.triggerHaptic=="function"&&window.triggerHaptic("light")},Te=()=>{if(m.length===0)return;const e=()=>{m=[],A=0,S(),w("Keranjang kasir dikosongkan.")};typeof window.showConfirm=="function"?window.showConfirm("Kosongkan Keranjang","Hapus semua item dari transaksi saat ini?",e,"Ya, Kosongkan",!0):e()},te=()=>{const e=c("pos-mobile-cart-drawer"),t=c("pos-mobile-cart-sheet");e&&t&&(e.classList.remove("opacity-0","pointer-events-none"),e.classList.add("opacity-100"),t.classList.remove("translate-y-full"),t.classList.add("translate-y-0"),typeof window.pushModalHistory=="function"&&window.pushModalHistory("posCartDrawer"),typeof window.triggerHaptic=="function"&&window.triggerHaptic("light"))},N=(e=!1)=>{const t=c("pos-mobile-cart-drawer"),s=c("pos-mobile-cart-sheet");if(t&&s){const a=()=>{s.classList.add("translate-y-full"),s.classList.remove("translate-y-0"),t.classList.add("opacity-0","pointer-events-none"),t.classList.remove("opacity-100")};!e&&typeof window.requestCloseModal=="function"?window.requestCloseModal("posCartDrawer",!1,a):a()}},Ve=e=>{if(e.img&&typeof e.img=="string")return J(e.img,"w150-rw");const t=(u.products||[]).find(s=>String(s.id)===String(e.id));return t&&t.img&&typeof t.img=="string"?J(t.img,"w150-rw"):""},H=()=>{const e=(u.products||[]).filter(o=>{if(!o||o.isActive==="false"||o.isActive===!1||I&&o.category!==I)return!1;if(_){const i=_.toLowerCase();return(o.name||"").toLowerCase().includes(i)||(o.barcode||"").toLowerCase().includes(i)||(o.sku||"").toLowerCase().includes(i)}return!0}),s=["Semua",...new Set((u.products||[]).filter(o=>o&&o.isActive!=="false"&&o.category).map(o=>o.category))].map(o=>{const i=o==="Semua",n=i?!I:I===o;return`<button onclick="window.posCatFilter('${d(i?"":o)}')" class="shrink-0 px-3.5 py-1.5 rounded-xl text-[11px] font-black uppercase tracking-wider border transition-all active:scale-95 shadow-2xs ${n?"text-white border-transparent":"bg-white dark:bg-slate-800 text-slate-600 dark:text-slate-300 border-slate-200 dark:border-slate-700 hover:border-[var(--color-primary)]/50"}" style="${n?"background:var(--color-primary)":""}">${d(o)}</button>`}).join(""),a=e.length===0?`<div class="col-span-full flex flex-col items-center justify-center py-20 text-slate-400 dark:text-slate-600">
           ...
           </div>`:e.map(o=>{const i=!!(o.img&&typeof o.img=="string"&&o.img.trim()),n=i?J(o.img,"w300-rw"):"",p=o.variants&&o.variants.length>0,x=o.wholesale&&o.wholesale.length>0,h=m.filter(R=>String(R.id)===String(o.id)).reduce((R,de)=>R+de.qty,0),P=d(String(o.id));return M==="list"?`
            ...
            </div>`}).join(""),r=c("pos-cat-filter"),l=c("pos-catalog-grid");r&&(r.innerHTML=s),l&&(l.className=M==="list"?"pos-catalog-list-mode":"pos-catalog-grid-mode",l.innerHTML=a)},S=()=>{const e=m.reduce((i,n)=>i+n.qty,0),t=Z(),s=y(),a=f(s),r=f(t),l=m.length===0?`<div class="flex flex-col items-center justify-center h-full py-12 text-slate-300 dark:text-slate-600 select-none">
            <div class="w-16 h-16 rounded-3xl bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-slate-400 mb-3 shadow-inner">
           ...
           </div>`:m.map(i=>{const n=d(String(i.cartKey||i.id)),p=Ve(i);return`
            <div class="group flex items-center gap-2.5 p-2 sm:p-2.5 bg-white dark:bg-slate-800/90 rounded-2xl border border-slate-200/90 dark:border-slate-700/80 shadow-xs hover:border-[var(--color-primary)] transition-all">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <div class="flex items-center gap-1.5 mt-0.5 flex-wrap">
                        ...
                        <span class="text-[10px] text-slate-500 font-medium">
                            ${i.isWholesale&&i.basePrice?`<span class="line-through text-slate-400">${f(i.basePrice)}</span> <span class="font-bold" style="color:var(--color-primary)">${f(i.price)}</span>`:f(i.price)}
                        </span>
                    </div>
                ...
                <div class="flex flex-col items-end gap-1 shrink-0">
                    ...
                    <p class="text-xs font-black" style="color:var(--color-primary)">${f(i.subtotal)}</p>
            ...
            </div>`}).join("");document.querySelectorAll(".pos-cart-items-target").forEach(i=>i.innerHTML=l),document.querySelectorAll(".pos-subtotal-target").forEach(i=>i.textContent=r),document.querySelectorAll(".pos-total-target").forEach(i=>i.textContent=a),document.querySelectorAll(".pos-item-count-target").forEach(i=>i.textContent=String(e)),document.querySelectorAll(".pos-global-disc-target").forEach(i=>{document.activeElement!==i&&(i.value=A||"")}),document.querySelectorAll(".pos-pay-btn-target").forEach(i=>{i.disabled=m.length===0;const n=i.querySelector(".btn-text");n&&(n.textContent=m.length>0?`BAYAR — ${a}`:"PROSES PEMBAYARAN")});const o=c("pos-mobile-floating-bar");o&&(m.length>0?(o.classList.remove("translate-y-32","opacity-0","pointer-events-none"),o.classList.add("translate-y-0","opacity-100")):(o.classList.add("translate-y-32","opacity-0","pointer-events-none"),o.classList.remove("translate-y-0","opacity-100"),N(!0)))},Me=()=>{if(m.length===0){w("Keranjang masih kosong!","warning");return}typeof window.pushModalHistory=="function"&&window.pushModalHistory("posPayment"),b={name:"",phone:"",isMember:!1,memberId:null,isNewTempo:!1},k="cash",v=y(),j(),document.body.insertAdjacentHTML("beforeend",`
    <div id="pos-pay-modal" class="fixed inset-0 z-[9999] flex items-end sm:items-center justify-center p-0 sm:p-4" style="background:rgba(15,23,42,0.65);backdrop-filter:blur(4px)">
      <div class="bg-white dark:bg-slate-900 rounded-t-3xl sm:rounded-3xl shadow-2xl w-full sm:max-w-md max-h-[94vh] flex flex-col overflow-hidden border border-slate-200/80 dark:border-slate-800">
        ...
        <div class="p-4 sm:p-5 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center shrink-0 bg-slate-50/60 dark:bg-slate-800/40">
          <div>
            ...
            <p class="text-xs text-slate-500 mt-0.5">Total Tagihan: <span class="font-black text-sm" style="color:var(--color-primary)">${f(y())}</span></p>
          </div>
    ...
    </div>`),Le("cash")},se=(e=!1)=>{const t=c("pos-pay-modal");t&&(!e&&typeof window.requestCloseModal=="function"?window.requestCloseModal("posPayment",!1,()=>t.remove()):t.remove())},Ce=(e,t,s)=>{s.forEach(a=>{const r=c(`${e}-${a}`);r&&(a===t?(r.style.background="var(--color-primary)",r.style.color="white",r.style.borderColor="var(--color-primary)",r.classList.add("shadow-xs")):(r.style.removeProperty("background"),r.style.removeProperty("color"),r.style.removeProperty("border-color"),r.classList.remove("shadow-xs")))})},Le=e=>{const t=c("pos-pay-detail");if(!t)return;const s=y(),a=`
      <div class="flex justify-between items-center py-2 px-3 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-100 dark:border-slate-700/60 mb-2.5 text-xs">
        ...
        <span class="font-black text-sm" style="color:var(--color-primary)">${f(s)}</span>
        ...
        `}else if(e==="qris"){const r=u.payment?.qrisUrl||"";t.innerHTML=`
          ...
          <input id="pos-dp-input" type="number" min="0" placeholder="0" value="0" class="w-full border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2 text-xs font-black text-right bg-white dark:bg-slate-800 focus:outline-none focus:border-[var(--color-primary)]">`)},Oe=e=>{b.isMember=e==="member",b.isNewTempo=e==="tempo",Ce("pos-ctype",e,["umum","member","tempo"]);const t=c("pos-customer-fields");t&&(e==="umum"?(b.name="",b.phone="",b.memberId=null,b.points=0,t.innerHTML='<input id="pos-cust-name" type="text" placeholder="Nama pembeli (opsional)" class="w-full border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2 text-xs bg-slate-50 dark:bg-slate-800 text-slate-800 dark:text-slate-100 focus:outline-none focus:border-[var(--color-primary)] focus:bg-white">'):e==="member"?(t.innerHTML=`
          <div class="space-y-2">
          ...
          </div>`,j().then(()=>{c("pos-cust-phone")?.value?.trim()&&B()})):e==="tempo"&&(b.isMember=!1,ae("tempo"),t.innerHTML=`
          <div class="space-y-2">
          ...
          </div>`))},ae=e=>{k=e,Ce("pos-pay",e,["cash","qris","transfer","tempo"]),Le(e)},re=e=>{v=C(e);const t=y(),s=v-t,a=c("pos-change-display"),r=c("pos-change-label"),l=c("pos-change-box"),o=c("pos-process-btn");a&&(a.textContent=f(Math.abs(s))),r&&(r.textContent=s>=0?"Kembalian Uang Pembeli:":"Uang Masih Kurang:"),a&&(a.className=`text-base font-black ${s>=0?"text-emerald-700 dark:text-emerald-400":"text-rose-600 dark:text-rose-400"}`),l&&(l.className=`mt-2.5 p-3 rounded-2xl border transition-all flex items-center justify-between ${s>=0?"bg-emerald-50 dark:bg-emerald-950/30 border-emerald-200 dark:border-emerald-800":"bg-rose-50 dark:bg-rose-950/30 border-rose-200 dark:border-rose-800"}`),o&&k==="cash"&&(o.disabled=s<0,o.classList.toggle("opacity-50",s<0))},oe=e=>{const t=c("pos-paid-input");t&&(t.value=e,re(e),typeof window.triggerHaptic=="function"&&window.triggerHaptic("light"))},j=async()=>{if(u.customers&&u.customers.length>0)return u.customers;try{const e=await D.collection("freshmart").doc("cms_data").collection("customers").get();return u.customers=e.docs.map(t=>({...t.data(),id:t.id,_docId:t.id})),u.customers}catch(e){return console.warn("[POS] Gagal load collection customers:",e),u.customers||[]}},je=(e,t)=>{if(!e||!t||!t.length)return[];const s=e.trim().toLowerCase(),a=s.replace(/\D/g,"");let r=a;r.startsWith("62")?r=r.slice(2):r.startsWith("0")&&(r=r.slice(1));const l=[],o=new Set;return t.forEach(i=>{if(!i)return;const n=String(i.id||i._docId||i.phone||"");if(o.has(n))return;const p=String(i.phone||"").replace(/\D/g,"");let x=p;x.startsWith("62")?x=x.slice(2):x.startsWith("0")&&(x=x.slice(1));const g=String(i.name||"").toLowerCase();let h=!1;r.length>=4&&x&&(x===r||x.endsWith(r)||r.endsWith(x)||p.includes(a))&&(h=!0),!h&&(n.toLowerCase()===s||n===a)&&(h=!0),!h&&s.length>=2&&g.includes(s)&&(h=!0),h&&(o.add(n),l.push(i))}),l},Fe=async e=>{const t=e.trim(),s=t.replace(/\D/g,"");let a=s;a.startsWith("62")?a=a.slice(2):a.startsWith("0")&&(a=a.slice(1));const r=D.collection("freshmart").doc("cms_data").collection("customers"),l=Array.from(new Set([t,s,a?"62"+a:null,a?"0"+a:null,a].filter(Boolean)));for(const o of l)try{const i=await r.doc(o).get();if(i.exists){const n={...i.data(),id:i.id,_docId:i.id};u.customers||(u.customers=[]);const p=u.customers.findIndex(x=>String(x.id)===String(n.id));return p>-1?u.customers[p]=n:u.customers.push(n),n}}catch{}if(a.length>=5)for(const o of["62"+a,"0"+a,s])try{const i=await r.where("phone","==",o).limit(1).get();if(!i.empty){const n=i.docs[0],p={...n.data(),id:n.id,_docId:n.id};return u.customers||(u.customers=[]),u.customers.push(p),p}}catch{}try{const o=await r.limit(300).get();if(!o.empty){u.customers=o.docs.map(n=>({...n.data(),id:n.id,_docId:n.id}));const i=je(e,u.customers);if(i.length>0)return i[0]}}catch{}return null},U=e=>{b.isMember=!0,b.name=e.name||"Member Toko",b.phone=e.phone||"",b.memberId=e.id||e._docId||e.phone,b.points=parseFloat(e.points)||0;const t=c("pos-cust-phone");t&&(t.value=e.phone||e.name||"");const s=b.points,a=typeof window.getMemberTier=="function"?window.getMemberTier(s):{badge:"MEMBER RESMI"},r=c("pos-member-result");r&&(r.innerHTML=`
        <div class="p-3 bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-950/40 dark:to-teal-950/30 rounded-2xl border border-emerald-300 dark:border-emerald-700/60 shadow-xs flex items-center justify-between gap-2.5">
          ...
          <button onclick="window.resetPosMember()" type="button" class="shrink-0 px-2.5 py-1.5 rounded-xl text-[10px] font-bold text-slate-600 hover:text-rose-600 dark:text-slate-300 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 transition-all cursor-pointer" title="Ganti Member">
        ...
        </div>`),w(`Member terdeteksi: ${e.name} (${s} Poin)`,"success")},ie=e=>{const s=(u.customers||[]).find(a=>a&&String(a.id||a._docId||a.phone)===String(e));s&&U(s)},ne=()=>{b.isMember=!1,b.name="",b.phone="",b.memberId=null,b.points=0;const e=c("pos-cust-phone");e&&(e.value="",e.focus());const t=c("pos-member-result");t&&(t.innerHTML="")};let be=null;const le=()=>{clearTimeout(be);const e=c("pos-cust-phone")?.value?.trim();if(!e||e.length<3){if(!b.memberId){const t=c("pos-member-result");t&&(t.innerHTML="")}return}be=setTimeout(()=>{B()},300)},B=async()=>{const t=c("pos-cust-phone")?.value?.trim()||"";if(!t){w("Masukkan nomor HP atau nama member","warning");return}const s=c("pos-member-result"),a=c("pos-member-lookup-btn");a&&(a.disabled=!0,a.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>'),s&&(s.innerHTML='<div class="p-2.5 text-center text-xs text-slate-400"><i class="fa-solid fa-spinner fa-spin mr-1.5"></i>Memeriksa database member...</div>');try{await j();const r=je(t,u.customers||[]);if(r.length===1)U(r[0]);else if(r.length>1)s.innerHTML=`
            ...
            `;else{const l=await Fe(t);l?U(l):(b.isMember=!1,b.name="",b.memberId=null,b.points=0,s.innerHTML=`
                  <div class="p-2.5 bg-rose-50 dark:bg-rose-950/30 rounded-xl border border-rose-200 dark:border-rose-800 text-rose-600 dark:text-rose-400 text-xs">
                    ...
                    <p class="text-[10px] text-rose-500/90 mt-0.5">Tidak ada member terdaftar untuk "<b>${d(t)}</b>". Pastikan nomor HP atau nama sesuai database.</p>
                  </div>`)}}catch(r){console.error("[POS] Error lookupPosMember:",r),s&&(s.innerHTML=`<p class="text-xs text-rose-500 p-2">Gagal memeriksa data: ${d(r.message||"Koneksi error")}</p>`)}finally{a&&(a.disabled=!1,a.innerHTML='<i class="fa-solid fa-magnifying-glass"></i><span>Cek</span>')}},Ie=async()=>{if(m.length===0){w("Keranjang kosong!","warning");return}const e=b.isMember?b.name||"Member Toko":c("pos-cust-name")?.value?.trim()||"Pelanggan Umum",t=b.isMember?b.phone||c("pos-cust-phone")?.value?.trim()||"":c("pos-cust-phone")?.value?.trim()||"";if(b.isNewTempo&&!t){w("No. HP wajib diisi untuk tempo!","warning");return}if(k==="cash"&&(v=C(c("pos-paid-input")?.value||0),v<y())){w(`Uang kurang! Minimal ${f(y())}`,"warning");return}b.name=e,b.phone=t;const s=k==="tempo"?C(c("pos-dp-input")?.value||0):0,a=k==="transfer"&&c("pos-bank-sel")?.value||"",r=c("pos-process-btn");r&&(r.disabled=!0,r.innerHTML='<i class="fa-solid fa-spinner fa-spin mr-2"></i>Memproses...');try{const l=qe(),o=typeof window.getCashierSession=="function"?window.getCashierSession():null,i=o?.name||u.store?.name||"Kasir",n=o?.uid||window.__currentAdminUid||"admin",p={txId:l,date:Q.firestore.FieldValue.serverTimestamp(),dateMs:Date.now(),cashier:n,cashierName:i,customer:{name:e,phone:t,isMember:!!b.isMember,memberId:b.memberId||null,points:b.points||0},items:m.map(g=>({id:g.id,name:g.name,price:g.price,qty:g.qty,discount:g.discount||0,subtotal:g.subtotal,variantName:g.variantName||"",isVariant:g.isVariant||!1,isWholesale:g.isWholesale||!1})),subtotal:Z(),globalDiscount:C(A),total:y(),payment:{method:k,paid:k==="cash"?v:k==="tempo"?s:y(),change:k==="cash"?ge():0,bank:a,dp:s,tempoBalance:k==="tempo"?y()-s:0},status:k==="tempo"?"tempo":"paid",notes:"",source:"pos"};if(b.isMember&&t){const h=(typeof window.calculateCartPoints=="function"?window.calculateCartPoints(m,u.store):{totalPoints:0}).totalPoints||0;if(h>0){p.pointsEarned=h;try{const P=t.replace(/\D/g,""),R=String(b.memberId||P);if(await D.collection("freshmart").doc("cms_data").collection("customers").doc(R).set({points:Q.firestore.FieldValue.increment(h),lastOrderAt:new Date().toISOString()},{merge:!0}),u.customers){const G=u.customers.find(W=>W&&(String(W.id)===R||String(W.phone).replace(/\D/g,"")===P));G&&(G.points=(parseFloat(G.points)||0)+h)}}catch(P){console.warn("[POS] Gagal update poin member:",P)}}}await D.collection("freshmart").doc("cms_data").collection("pos_transactions").doc(l).set(p),k==="tempo"&&await D.collection("freshmart_orders").doc(l).set({orderId:l,source:"pos",dateString:new Date().toISOString(),customerName:p.customer.name,customerPhone:p.customer.phone,items:m.map(g=>({id:g.id,name:g.name,price:g.price,qty:g.qty})),total:y(),payment:{method:"tempo",paymentStatus:"hutang",paid:s,tempoBalance:y()-s,tempoDueDate:Date.now()+7*864e5,tempoPenaltyRate:1,tempoPenaltyStopped:!1},status:"Diproses",isTempo:!0,timestamp:Q.firestore.FieldValue.serverTimestamp()}),se(),N(!0);const x={...p};m=[],A=0,S(),H(),Ue(x)}catch(l){console.error("[POS] Error:",l),w("Gagal menyimpan transaksi. Coba lagi.","error"),r&&(r.disabled=!1,r.innerHTML='<i class="fa-solid fa-check-circle mr-2"></i>Selesaikan Transaksi')}},Ue=e=>{const t=e.payment.method==="cash"?`<p class="text-sm text-slate-500">Kembalian: <span class="font-black text-emerald-600">${f(e.payment.change)}</span></p>`:e.payment.method==="tempo"?'<p class="text-sm text-amber-600 font-semibold">⚠️ Dicatat sebagai Piutang Tempo</p>':`<p class="text-sm text-slate-500">Metode: ${e.payment.method.toUpperCase()}</p>`,s=JSON.stringify(e).replace(/"/g,"&quot;");document.body.insertAdjacentHTML("beforeend",`
    ...
    </div>`)},De=e=>{document.getElementById("pos-success-modal")?.remove();const t=u.store?.name||"TOKO PUTRI",s=u.store?.wa||"",a=u.store?.address||"",r=new Date(e.dateMs).toLocaleString("id-ID"),l=(e.items||[]).map(i=>`<tr><td style="padding:2px 0;word-wrap:break-word">${d(i.name)}</td><td style="text-align:right;padding:2px 4px;white-space:nowrap">${i.qty}x ${f(i.price)}</td><td style="text-align:right;padding:2px 0;white-space:nowrap">${f(i.subtotal)}</td></tr>`).join(""),o=window.open("","_blank","width=420,height=720");if(!o){w("Izinkan popup untuk cetak struk","warning");return}o.document.write(`<!DOCTYPE html><html><head><meta charset="utf-8"><title>Struk POS</title>
    ...
    </body></html>`),o.document.close()},Ae=({isStorefront:e})=>{const s=(typeof window.getCashierSession=="function"?window.getCashierSession():null)?.name||(e?"Kasir":"Admin Seller"),a=d(u.store?.name||"Toko Putri");return`
    ...
    `},He=()=>{_="",I="",m=[],A=0;const e=c("view-pos-cashier");e&&(e.innerHTML=Ae({isStorefront:!0}),H(),S(),we(),he(),j(),_e())},Re=()=>{_="",I="",c("admin-content")&&(E("admin-content",`<div style="height:calc(100vh - 105px)">${Ae({isStorefront:!1})}</div>`),H(),S(),we(),he(),j(),_e())},_e=()=>{window.setPOSViewMode=X,window.posAddToCart=ee,window.posAddToCartQty=ke,window.addToCartPOSWithVariant=ye,window.posUpdateQty=ve,window.posSetQty=Se,window.posSetItemDisc=Pe,window.posRemoveItem=$e,window.posClearCart=Te,window.openPayModal=Me,window.closePayModal=se,window.setPosCustomerType=Oe,window.setPosPayMethod=ae,window.updatePosChange=re,window.posSetQuickCash=oe,window.ensureCustomersLoaded=j,window.lookupPosMember=B,window.debouncedLookupPosMember=le,window.selectPosMember=ie,window.resetPosMember=ne,window.processPOSTx=Ie,window.printPOSReceipt=De,window.posSetGlobalDisc=e=>{A=C(e),S()},window.posCatFilter=e=>{I=e,H()},window.posSearchFn=e=>{_=e,H()},window.openPOSCartDrawer=te,window.closePOSCartDrawer=N,window.playCashierBeep=O,window.openPOSHistory=()=>F(()=>Promise.resolve().then(()=>We),void 0).then(e=>e.renderPOSHistory()),window.destroyBarcodeListener=z};window.setPOSViewMode=X;window.renderPOSStorefront=He;window.renderPOS=Re;window.destroyBarcodeListener=z;window.openPOSCartDrawer=te;window.closePOSCartDrawer=N;window.posSetQuickCash=oe;window.playCashierBeep=O;window.ensureCustomersLoaded=j;window.lookupPosMember=B;window.debouncedLookupPosMember=le;window.selectPosMember=ie;window.resetPosMember=ne;const ue=Object.freeze(Object.defineProperty({__proto__:null,addToCart:ee,addToCartWithVariant:ye,applyMemberToPos:U,clearCart:Te,closePOSCartDrawer:N,closePayModal:se,debouncedLookupPosMember:le,destroyBarcodeListener:z,ensureCustomersLoaded:j,lookupPosMember:B,openPOSCartDrawer:te,openPayModal:Me,playCashierBeep:O,posAddToCartQty:ke,posSetQuickCash:oe,printPOSReceipt:De,processPOSTx:Ie,removeFromCart:$e,renderPOS:Re,renderPOSStorefront:He,resetPosMember:ne,selectPosMember:ie,setItemDisc:Pe,setPOSViewMode:X,setPosCustomerType:Oe,setPosPayMethod:ae,setQty:Se,updatePosChange:re,updateQty:ve},Symbol.toStringTag,{value:"Module"})),q=e=>fe(e),ze=e=>new Date(e).toLocaleString("id-ID",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"});let K=new Date().toISOString().slice(0,10),T=[],V=null;const me=()=>{c("pos-hist-list")&&E("pos-hist-list",'<div class="flex justify-center py-12"><i class="fa-solid fa-spinner fa-spin text-3xl text-slate-300"></i></div>'),V&&(V(),V=null);const t=new Date(K);t.setHours(0,0,0,0);const s=new Date(K);s.setHours(23,59,59,999),V=D.collection("freshmart").doc("cms_data").collection("pos_transactions").where("dateMs",">=",t.getTime()).where("dateMs","<=",s.getTime()).onSnapshot(a=>{T=a.docs.map(r=>r.data()).sort((r,l)=>(l.dateMs||0)-(r.dateMs||0)),xe()},a=>{console.error("[POS History]",a),w("Gagal memuat riwayat kasir","error"),T=[],xe()})},xe=()=>{const e=T.reduce((n,p)=>n+(p.status!=="void"&&p.total||0),0),t=T.filter(n=>n.status!=="void").length,s=T.filter(n=>n.status==="void").length,a={};T.filter(n=>n.status!=="void").forEach(n=>{const p=n.payment?.method||"other";a[p]=(a[p]||0)+(n.total||0)});const r={cash:"Tunai",qris:"QRIS",transfer:"Transfer",tempo:"Tempo"},l=Object.entries(a).map(([n,p])=>`<div class="flex justify-between text-xs"><span class="text-slate-500">${r[n]||n}</span><span class="font-bold text-slate-700 dark:text-slate-200">${q(p)}</span></div>`).join(""),o=`
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4">
        ...
        <div class="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-3 text-center">
            ...
            <p class="text-base font-black text-slate-800 dark:text-white">${T.filter(n=>n.status!=="void").reduce((n,p)=>n+(p.items||[]).reduce((x,g)=>x+g.qty,0),0)}</p>
        </div>
        <div class="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-3 text-center">
    ...
    ${l?`<div class="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-3 mb-4 space-y-1.5">${l}</div>`:""}`,i=T.length===0?`<div class="flex flex-col items-center justify-center py-16 text-slate-400 dark:text-slate-600"><i class="fa-solid fa-receipt text-4xl mb-3"></i><p class="font-semibold text-sm">Belum ada transaksi</p><p class="text-xs mt-1">${K}</p></div>`:T.map(n=>{const p=n.status==="void",x={cash:"emerald",qris:"blue",transfer:"violet",tempo:"amber"}[n.payment?.method]||"slate",g={cash:"Tunai",qris:"QRIS",transfer:"Transfer",tempo:"Tempo"}[n.payment?.method]||n.payment?.method;return`<div class="bg-white dark:bg-slate-800 border ${p?"border-red-200 dark:border-red-800 opacity-60":"border-slate-200 dark:border-slate-700"} rounded-2xl p-3 space-y-2 ${p?"":"hover:shadow-sm"} transition-all">
                <div class="flex items-start justify-between gap-2">
                    ...
                    <div class="text-right shrink-0">
                        <p class="font-black text-sm ${p?"line-through text-slate-400":""}" style="${p?"":"color:var(--color-primary)"}">${q(n.total)}</p>
            ...
            </div>`}).join("");E("pos-hist-rekap",o),E("pos-hist-list",i)},Ee=e=>{Ke("Void Transaksi",`Void transaksi ${e}?
Transaksi akan ditandai batal dan tidak dihitung dalam laporan.`,async()=>{try{await D.collection("freshmart").doc("cms_data").collection("pos_transactions").doc(e).update({status:"void"}),w("Transaksi berhasil divoid","success")}catch{w("Gagal void transaksi","error")}},"Ya, Void")},Ge=()=>{E("admin-content",`
    ...
    </div>`),window.posHistChangDate=e=>{K=e;const t=c("pos-hist-date");t&&(t.value=e),me()},window.voidPOSTx=Ee,window.printPOSReceiptFromHist=e=>{F(()=>Promise.resolve().then(()=>ue),void 0).then(t=>t.printPOSReceipt(e))},window.__openPOSMain=()=>F(()=>Promise.resolve().then(()=>ue),void 0).then(e=>e.renderPOS()),me()},We=Object.freeze(Object.defineProperty({__proto__:null,renderPOSHistory:Ge,voidPOSTx:Ee},Symbol.toStringTag,{value:"Module"}));export{ee as addToCart,ye as addToCartWithVariant,U as applyMemberToPos,Te as clearCart,N as closePOSCartDrawer,se as closePayModal,le as debouncedLookupPosMember,z as destroyBarcodeListener,j as ensureCustomersLoaded,B as lookupPosMember,te as openPOSCartDrawer,Me as openPayModal,O as playCashierBeep,ke as posAddToCartQty,oe as posSetQuickCash,De as printPOSReceipt,Ie as processPOSTx,$e as removeFromCart,Re as renderPOS,He as renderPOSStorefront,ne as resetPosMember,ie as selectPosMember,Pe as setItemDisc,X as setPOSViewMode,Oe as setPosCustomerType,ae as setPosPayMethod,Se as setQty,re as updatePosChange,ve as updateQty};
