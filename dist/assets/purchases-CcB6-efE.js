import"./module-member-HotrGCGL.js";import{a as x,e as n,b as S,f as u,i as p,al as H,u as f,v as F,a3 as I,a1 as v,z as B,G as C,t as G,am as q}from"./module-print-DdyfBoO_.js";import{o as N}from"./module-admin-DRwfDrQA.js";import"./vendor-firebase-core-D2OF5R23.js";import"./vendor-firebase-db-BIUZcnOd.js";import"./module-faq-BYruayZT.js";const j=()=>{if(["modal-po-form","modal-po-detail","modal-po-payment"].forEach(e=>{const r=document.querySelector(`#admin-content #${e}`);r&&r.remove()}),!n("modal-po-form")){const e=document.createElement("div");e.id="modal-po-form",e.className="fixed inset-0 z-[150] flex hidden items-end sm:items-center justify-center p-0 sm:p-4 bg-slate-950/40 backdrop-blur-sm opacity-0 transition-opacity duration-300",e.onclick=r=>{r.target===e&&window.closePOFormModal?.()},e.innerHTML=`
...
Mohon dicek ketersediaan stok & jadwal armada pengirimannya. Terima kasih atas kerja samanya! 🙏`;q(a,i)};window.printPurchaseOrder=e=>{const t=(x.purchases||[]).find(l=>String(l.id)===String(e));if(!t)return f("Data PO tidak ditemukan!");const a=x.store||{};if(!n("po-print-container"))return;const o=t.paymentType==="tempo"?`Tempo ${t.tempoDays||14} Hari (Jatuh Tempo: ${$(t.tempoDueDate)})`:t.paymentType==="konsinyasi"?"Konsinyasi":"Cash / Tunai",c=`
    ...
    `),i.close(),setTimeout(()=>{d.contentWindow.focus(),d.contentWindow.print()},300)};window.renderPurchasesView=O;window.computePurchaseMetrics=K;export{K as computePurchaseMetrics,j as ensurePurchaseModals,O as renderPurchasesView};
