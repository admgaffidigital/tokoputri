...
// Note: window.updCart telah dipindahkan ke modul: src/modules/cart/cart.js
...
// Note: window.clearCart telah dipindahkan ke modul: src/modules/cart/cart.js


// Note: Logika riwayat pesanan (renderMyOrders, checkOrderStatus, clearMyOrders, openCustomerOrderDetail, renderOrderDetailModal, closeCustomerOrderDetailModal)
// telah dipindahkan ke modul: src/modules/orders/orders.js
const renderMyOrders = () => window.renderMyOrders();
